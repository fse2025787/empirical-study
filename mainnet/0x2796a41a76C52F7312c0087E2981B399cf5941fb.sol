...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fish Serenity";
    string private constant _symbol = unicode"🐟 Serenity";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0xBBA8bB73785302fa1b87240B2b5767416d147912); 
