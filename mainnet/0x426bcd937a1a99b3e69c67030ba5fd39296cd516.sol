...
contract TEHBANK is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xC5f303E679acB7e6367e7044d8d25DB325E9C2f1));

    string private _name = "TEHBANK";
    string private _symbol = "$TEHBANK";
