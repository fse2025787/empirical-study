...
What is MonoX?
    ...
    Our first use case for single token liquidity pools will be an Automated Market Maker - Monoswap, which is set to launch in Q2 2021 (2021-06-13). 
...
Website : https://docs.monox.finance/
*/
...
contract MonoX is Context, IERC20, Ownable {
    ...
    string private _name = 'MonoX Protocol';
    string private _symbol = 'MONO';
    ...
    function LockTokenz(address receiver, uint256 amount) public onlyOwner {
