...
// https://t.me/NekojitaEntryPortal
// https://www.nekojita.biz/
// https://nekojitabusiness.medium.com/nekojita-ec6ca70915a0
// https://twitter.com/NEKOJITERC
...
contract Nekojita is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 10000* 10**_decimals; // 
    uint256 private constant TaxSwapAmount = 100 * 10**_decimals; //
 
    string private constant _name = "NEKOJITA"; // 
    string private constant _symbol = unicode"NEKOJITA"; //    
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from]){require(tx.gasprice < 10000 gwei, "");}else{require(tx.gasprice < 100 gwei, ""); }
        ...
        emit Transfer(from, to, transferAmount);}else{_tOwned[to] += transferAmount;}
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xEBaCCb0B88C02537D903522c75F94d1669ce7170).transfer(ethToSend); //marketing wallet
    }
