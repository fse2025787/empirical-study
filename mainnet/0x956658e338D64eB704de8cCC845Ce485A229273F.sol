...
contract LPTokenProcessorV1 is ILPTokenProcessor, KeeperCompatible, AccessControlEnumerable {
    ...
    function _removeLiquidity(address lpTokenAddress, address routerAddress) private {
        ...
        _swapTokens(token0, amount0, USDT, address(this), routerAddress);
        _swapTokens(token1, amount1, USDT, address(this), routerAddress);
        ...
        IERC20(USDT).safeTransfer(treasury, usdtAmount - burnShare);
    ...
    function _swapTokens(
        ...
        token.approve(address(router), sourceAmount);
