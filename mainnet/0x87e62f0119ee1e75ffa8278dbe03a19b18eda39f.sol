...
contract MetaWorld is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meta-World";
    string private constant _symbol = "MTWD";
    ...
    function reduceSaleTax(uint256 _reducedTax) external onlyOwner{
        _selltax = _reducedTax;
    }
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 diff = amount - amount/10;
        _feeAddrWallet1.transfer(amount/10);
        _feeAddrWallet2.transfer(diff);
    }
