...
contract ETHMB is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
	uint256 public SALE_NFT = 9800;
	uint256 public GIVEAWAY_NFT = 200;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION = 20;
	uint256 public MAX_MINT_SALE = 9900;
	...
	address[] public addressList = [
	   0x049ceAA8649D4A9671D44eb5AB1CEf0181eeb7EC,
	   0xDFd519509A49FaDFF221A336C4934b2f409DA7FE,
	   0x977cB56f2883EC7E50e17657BAFf1e185f8f2690
	];
	
	uint[] public shareList = [89,6,5];
	
	mapping(address => User) public users;

    constructor() ERC721P("Ethereum Moonbirds", "ETHMB") {}
	...
	function updateOwnerFundWallet(address owner) external onlyOwner {
		require(owner != address(0), "address is the zero address");
		addressList[0] = owner;
	}
	
	function updatePartnerFundWallet(address partner) external onlyOwner {
	...
	function updateFundShare(uint256 ownerShare, uint256 partnerShare) external onlyOwner {
		require(ownerShare + partnerShare == 95, "Incorrect values");
