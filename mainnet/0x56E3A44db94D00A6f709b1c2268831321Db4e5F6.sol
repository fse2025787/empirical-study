...
contract WIKICAT is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "WKC"; 
    ...
    address payable private _developmentWalletAddress = payable(0x0A5698A7e3A44b2a5dfbA0b64CaD68b78c0f2E4A);
    address payable private _marketingWalletAddress = payable(0x0A5698A7e3A44b2a5dfbA0b64CaD68b78c0f2E4A);
