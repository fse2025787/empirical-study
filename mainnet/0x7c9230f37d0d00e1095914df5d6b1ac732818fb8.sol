...
/*
《呂氏春秋》有言: 石可磨也，而不可奪堅。丹可磨也，而不可奪赤。

The power of nature is with me, so that man and God can be one, heaven and earth can be one, and the law of nature can be followed.

https://medium.com/@TenDenChiHi/ten-den-chi-hi-916b46b39f3f
*/
...
contract TenDenChiHi is Context, IERC20, Ownable {
    ...
    string private _name = "Ten Den Chi Hi";
    string private _symbol = unicode"天雷地火";
    ...
    address public marketingTokenFeeWallet = 0xd3b98149407C1C555107BEebaE98E6AD8aA8dcFA;
    address public marketingETHFeeWallet = 0xd3b98149407C1C555107BEebaE98E6AD8aA8dcFA;
    ...
    uint256 public _maxTxAmount = 100 * 10**7 * 10**9;//1% maxTxAmount
    uint256 public _maxWallet = 300 * 10**7 * 10**9;//3% maxWallet
