...
VaporRISE  | https://t.me/VaporRISE
...
💪 Ownership Renounce after Launch
...
contract VaporRISE is Context, IERC20, Ownable {
    ...
    string private  _name = 'VaporRISE'; 
    string private _symbol = '🧛🏽‍♂️VaporRISE';
    uint8 private _decimals = 18;
    
    uint256 private _maxBotFee = 35 * 10**9 * 10**18;
    uint256 private _minBotFee = 5 * 10**6 * 10**18;
