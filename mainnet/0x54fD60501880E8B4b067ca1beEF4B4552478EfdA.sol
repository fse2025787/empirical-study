...
contract TVMan is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    function smint(uint256 amount) internal {
        require(amount == 1 
    ...
    constructor() ERC721A("Lives of TV-Man", "TV") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmZ3BT48aAx8k3dXSQPmZK5Xn8jQmXThxDMnBPSFVrhqFd/", _toString(tokenId), ".json"));
    }
