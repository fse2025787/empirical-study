...
/**
/*
FOR THE SHIBA LGBQT COMMUNITY!

$SHIBALGBQT

https://t.me/shibalgbqt
*/
// 
...
contract SHIBALGBQT is Context,IERC20, Ownable{
using Address for address;
string private _name = "SHIBALGBQT\xF0\x9F\x8C\x88";
string private _symbol = "SHIBALGBQT\xF0\x9F\x8C\x88";
...
address _owner;
address payable public marketingAddress = payable(0x5aAb39251D2A06A87B76d098Ac414d52c7Da50b4);
...
uint256 SHIBALGBQTCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > SHIBALGBQTCOINDaycooldown, "You cant call SHIBALGBQTCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function SHIBALGBQTCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    SHIBALGBQTCOINDaycooldown = block.timestamp + 86400;
}
