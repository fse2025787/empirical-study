...
contract QUETZALCOATLUS is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0xA4d3325B71A937FA8e7Ac49a26d5A73b7FDC3a49));

    string private _name = "QUETZALCOATLUS";
    string private _symbol = "AVES";
