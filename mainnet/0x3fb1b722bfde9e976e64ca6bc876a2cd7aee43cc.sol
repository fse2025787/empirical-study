...
Curated by a Terra victim on behalf of all our Terra victims who got rekt.

Please create a community. Giveaways will be run if the community runs a successful TG.
...
contract CTERRA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Community Terra", "CTERRA") {
    ...
    function HoldHands(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
