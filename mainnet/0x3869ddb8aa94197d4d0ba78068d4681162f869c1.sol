...
| |   | '__/ _ \/ _` | __/ _ \ | '_ \| | | |  / __| '_ \|  /| |
| \__/\ | |  __/ (_| | ||  __/ | |_) | |_| | | (__| | | \ |_/ /
 \____/_|  \___|\__,_|\__\___| |_.__/ \__, |  \___|_| |_|\___/ 
                                       __/ |                   
                                      |___/                    
...
// File: contracts/Createbych0.sol
...
contract Createbych0 is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmQ6tK6Uf3TtnJMShhvSDARLa1TWYs2kdN4PHuM8L2AZ5E/";
  uint256  public  maxSupply = 405;
  uint256 public  MAX_MINTS_PER_TX = 1;
  uint256 public  PUBLIC_SALE_PRICE = 0.0 ether;
  uint256 public  NUM_FREE_MINTS = 405;
