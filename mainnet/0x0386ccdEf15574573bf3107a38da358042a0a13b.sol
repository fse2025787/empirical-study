...
contract ReindeerShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Reindeer Shiba";
    string private constant _symbol = "DEERSHIB";
