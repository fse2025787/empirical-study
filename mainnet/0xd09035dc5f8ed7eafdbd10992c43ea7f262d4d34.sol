...
contract SantaGoneBroke is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SantaGoneBroke", "SGB") {
    setHiddenMetadataUri("ipfs://QmTh3nwCPVjAS72fK87A7onAoQYneTWUu3u2dtn1aDPRe7/hidden.json");
  }
