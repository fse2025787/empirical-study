...
The first Shiba protocol, mixing the great meme with THE great idea. $SHIPRO

   https://theshibaprotocol.com/
   https://twitter.com/ShibaProtocolETH
   https://t.me/TheShibaProtocol_
...
contract TheShibaProtocol is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xe9c9f40a6B4c10590198407B96DFe8C26A85b861); 
    address payable public devWallet = payable(0x2d43a415305398190528F379DCCc54553173227a);
    ...
    constructor() ERC20("The Shiba Protocol", "SHIPRO") {
