...
// File: contracts/CyCloudCoin.sol
...
/**
 * @title CloudCoin contract
 */
contract CloudCoin is ERC20Capped, ERC20Detailed {
    uint noOfTokens = 10_000_000_000;
     ...
     *
     * Cap the mintable amount to 99,000,000,000
     *
     */
    constructor (string memory _symbol, string memory _name, address _owner,
        address _admin, address _vault) ERC20Detailed(_name, _symbol, 9) ERC20Capped(99_000_000_000_000_000_000)
    public {
    ...
    function getOneCloudCoin() public view returns (uint) {
