...
contract ERC6969 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVV4V8nfBXh7uFY21AJrmw58yWXzT8ELhPQRnAxCPnWp4";
    ...
    uint256 public MAX_SUPPLY = 2929;
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("Busty Pixel Girls", "BPG69", 100, MAX_SUPPLY) {
    }
