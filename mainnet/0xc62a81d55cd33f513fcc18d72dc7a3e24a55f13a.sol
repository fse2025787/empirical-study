...
// ComradeToken, ComradeToken.com
// Telegram: https://t.me/ComradeToken
// A Token For The People
// A Fair Blockchain For One And All.

// Check ComradeToken.com for the LP Lock after launch.
// Ownership will be rescinded 30 minutes after launch.

// Slippage Recommended: 26-30% (40% at launch due to quickly changing prices)
// 22% Reflection, 3% Minister of Propaganda (Marketing Wallet)
// 0.1% Max buy / Max sell at launch.
// Will be increased to 1% Buy / 0.3% Sell prior to ownership being rescinded.

// Snipers beware: This token employs anti-snipe scripting.
// This will be a fair launch, by and for the people.
...
contract ComradeToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Comrade Token | ComradeToken.com';
    string private _symbol = 'COMMIE';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 22;
    uint256 private _marketingFee = 3;
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousMarketingFee = _marketingFee;

    address payable private _marketingWalletAddress = payable(0x7174840719660dC266EA93950bef7A1fB49a132c);
    ...
    uint256 public _maxTxAmountSell = 1000000000000000000;
    uint256 private _numOfTokensToExchangeForMarketing = 5000000000000000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient == address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D))
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tCharity) = _getTValues(tAmount, _taxFee, _marketingFee);
        uint256 currentRate =  _getRate();
    ...
    function _removeInitialTradeLimits() external onlyOwner() {
        _maxTxAmount = 10000000000000000000;
        _maxTxAmountSell = 3000000000000000000;
    }
