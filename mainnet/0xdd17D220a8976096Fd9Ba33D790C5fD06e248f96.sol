...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x94e92d2eeBA44AFd36BdE8Ae91c13288D0d3D6Dd];
  address public erc20Payable = 0x94e92d2eeBA44AFd36BdE8Ae91c13288D0d3D6Dd;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 343) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicagoteo4uy5adklta6qofwjsesyzlgir26rb3g4idk2vlt2dt5f4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/if0vVlUFFnjNQsplT1iM/contract-metadata";
  }
...
// File: contracts/StreamByLsdContract.sol
//

pragma solidity ^0.8.0;

contract StreamByLsdContract is RamppERC721A {
    constructor() RamppERC721A("StreamByLSD", "SBL"){}
}
