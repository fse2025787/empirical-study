...
/**
 * 
 * The ultimate trial, exhausting human history until the journey to the other side. 
 * The plan of someone who called himself the Magic King, the Backlight Canal / Creation Light Year, ended in failure. 
 * Congratulations to all of you, you have done your best to solve the incident of the burning of the human reason, 
 * to complete the trial, to reclaim the daily life, the human reason is no longer shaken, and the future survives. However, 
 * a fatal point was left out. The confrontation with the distant God's generation, with the past, had ended. 
 * Then, what appears afterwards is only a small puzzle before that big event occurs, before the grand battle, 
 * so to speak, like a prophetic break.
 * 
 * Missed $LAIKI?
 *
 * Missed $TSUKA?
 ...
 * Missed $SHIB?
 *
 * Missed all of the moonshots, and you're just sick and tired of people forwarding bobby buy bots of 
 * coins you saw at 20k that are at 5-500M?
 * 
 * This is the coin for you, for all the FATE
 *
 * Create contract init fee: 
 * total buy 5%
 * total sell 5%
 * 
 * Web: https://www.fate-go.jp/
 * twitter:  https://twitter.com/fgoproject
 */
...
contract BaseSetTaxERC20Token is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "FATE GO";
    string private _symbol = "FATE";
