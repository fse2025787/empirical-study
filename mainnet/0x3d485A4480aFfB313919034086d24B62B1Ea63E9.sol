...
//*********************************************************************//
//
//    ____       _____   __       __   ______      __    ___    _____
//    / __ \____ /__  /  / /____  / /  / ____/___  / /_  / (_)__/__  /
//   / /_/ / __ `/ / /  / __/ _ \/ /  / / __/ __ \/ __ \/ / / __ \/ / 
//  / ____/ /_/ / / /__/ /_/  __/ /  / /_/ / /_/ / /_/ / / / / / / /__
// /_/    \__,_/ /____/\__/\___/_/   \____/\____/_.___/_/_/_/ /_/____/
//                                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0d8B122fFD7401238070bfbD5Cfb0d067fd3E5E4];
  address public erc20Payable = 0x0d8B122fFD7401238070bfbD5Cfb0d067fd3E5E4;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibbl5lrphe6yarkdf3a7awnpznxlzssoyzzswpeoxlmnihvg4qjum/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NvDrnYfQIig9s0QbLnM8/contract-metadata";
  }
...
// File: contracts/PaZtelGoblinZContract.sol
//

pragma solidity ^0.8.0;

contract PaZtelGoblinZContract is RamppERC721A {
    constructor() RamppERC721A("PaZtel GoblinZ", "PZG"){}
}