...
contract InariOkami is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x9B8059b5206724AA629F60b7c00a6C48B7E30Cb0));

    string private _name = "Inari Okami";
    string private _symbol = "INKM";
