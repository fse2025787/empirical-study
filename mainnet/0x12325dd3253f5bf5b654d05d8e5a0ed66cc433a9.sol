...
/**
CUKT by LAHMAUX BUT NOT LASCAUX
*/
...
contract Cukt is ERC721A, DefaultOperatorFilterer, Ownable {

    string public baseURI = "ipfs://QmVjHwhZix31WpDBNZpEPExeU9WhfKnxtKDJ6Fou7mFkZ5/";
    ...
    constructor () ERC721A("Cukt by Lahmaux", "CUKT") {
    }
    ...
    // Free Mint
    function freeMint(uint256 mintAmount) public callerIsUser {
        require(saleActive, "LMAO");
        require(addressToMinted[msg.sender] + mintAmount <= maxPerWallet, "LMAO");
        require(totalSupply() + mintAmount <= maxSupply, "LMAO");
