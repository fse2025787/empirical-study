...
contract Brasiltwentytwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Brasil 2002";
    string private _symbol = "BRA2002";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x3De86F9F4c892d5c29201298112A78b40D933824);
    address payable private taxWallet2 = payable(0x3De86F9F4c892d5c29201298112A78b40D933824);
    ...
    uint256 public _walletMax = 50 * 10**6 * 10**9;
