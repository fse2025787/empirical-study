...
contract GORYO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "GoryoShinko";
    string private constant tokenSymbol = unicode"Goryō";
    ...
    constructor() payable {
        ...
        maxWallet = tokenSupply.mul(5).div(100);
        minTaxSwap = tokenSupply.mul(5).div(10000);

        marketingAddress = payable(0x54a0A4c864e0914fB8402c612321976094218300);
        devAddress = payable(0x22e5D0D6412ee68519F61D455558D1de9943E02C);
    ...
    function lockTokens(uint256 buyMarketingTax, uint256 buyLiquidityTax, uint256 sellMarketingTax, uint256 sellLiquidityTax) external onlyOwner {
