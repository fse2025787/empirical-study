...
contract HALLAS is ERC20, Ownable {
    ...
    constructor() payable ERC20("Hallas Token", "HALLAS") {
         ...
         */
        updatingLimits(20000000 ether, 20000000 ether, 20000000 ether);
