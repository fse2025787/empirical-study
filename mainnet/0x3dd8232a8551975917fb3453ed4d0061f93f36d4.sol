...
contract SommerRayDAO is Ownable, ERC721A, ReentrancyGuard {

  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_,
    uint256 amountForAuctionAndDev_
  ) ERC721A("SommerRayDAO", "SommerDAO", maxBatchSize_, collectionSize_) {
    require(amountForAuctionAndDev_ <= collectionSize_, "larger collection size needed" );
  }
    
   uint256 pricePer = 0.01 ether;
   uint256 totalCost;
   address private constant MIKE = 0xc5376f2831D28CB20707A0F015146a9D219bEfDA;
   address private constant FUEGO = 0x9E862Ce07c0e47f7a7601aaC69b74aeE87699f53;
   address private constant CHICK = 0x11f0F466B52762E30f2456b4985208AE9296D2C9;

  function mintGiveaway(uint quantity) external onlyOwner {
      require(totalSupply() + quantity <= 1111, 'sold out');
  ...
  function withdrawAll() public onlyOwner {
      ...
      _withdraw(MIKE, ((balance * 33) / 100));
      _withdraw(FUEGO, ((balance * 33) / 100));
      _withdraw(CHICK, ((balance * 33) / 100));
