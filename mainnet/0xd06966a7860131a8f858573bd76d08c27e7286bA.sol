...
contract GoldenTicketNFTClub is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  address addC;
  address addD;
  uint256 addAN = 50; // prize
  uint256 addBN = 10; //dev and artist
  uint256 addCN = 35; //team
  uint256 addDN = 4; //legal wallet
