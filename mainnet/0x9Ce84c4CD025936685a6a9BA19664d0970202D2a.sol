...
contract DB is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Fade Me";
    string private constant _symbol = "FADOR";
    ...
    address payable private _developmentAddress = payable(0x10aa8dDb61e218aF5C30b6A82e0479808a98678f);
    address payable private _marketingAddress = payable(0x10aa8dDb61e218aF5C30b6A82e0479808a98678f);
