...
contract StackByMrStacks is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable supply = 123;
    ...
    address[] public withdrawAddresses = [0x4Be196b15A6194b903b9605d7C1ddbd345C9C6C5, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x6f4e1bd514162048431fd1580e779f3c1129b461237f23a654357d3b1543ba04;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x4Be196b15A6194b903b9605d7C1ddbd345C9C6C5, _royaltyAmount);
    }
