...
/*TELEGRAM  https://t.me/JIRAIYAIINUETH 10ETH MARKETING BUDGET AFTER LAUNCH
*/
...
contract JIRAIYAIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "JIRAIYAI INU";
    string private constant _symbol = "$JRN";
