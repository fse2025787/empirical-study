...
/*
$ NAKIME $  Nakime  Inu  
Nakime (鸣なき女め Nakime) is a supporting character in Demon Slayer's Infinite Castle Arc Kimetsu no Yaiba.
Originally a demon who summoned other demons into Infinite City by the order of Mufo Wushan, 
but after the death of Mantengu, she was promoted to the position of the top four (Jōgen no Shi)

👉Join us TG:t.me/NakimeInu_ERC20

👉Twitter:twitter.com/NakimeInu_ERC20
...
contract NakimeInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Nakime Inu";
    string private constant _symbol = " NAKIME";
