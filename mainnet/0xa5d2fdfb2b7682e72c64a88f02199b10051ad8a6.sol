...
// Bringing back the OG’s! 

// $OSC is a 0 tax coin. Lp will be burnt & contract renounced. 

// Telegram: Https://T.me/OSCETH
...
contract OSC is Context, IERC20, Ownable {///////////////////////////////////////////////////////////
    ...
    string private constant _name = "Old School Crypto";//////////////////////////
    ...
    address payable private _developmentAddress = payable(0x1b0d2F2759f8923462fD1c08c870D231C7F9c7e9);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x1b0d2F2759f8923462fD1c08c870D231C7F9c7e9);///////////////////////////////////////////////////
