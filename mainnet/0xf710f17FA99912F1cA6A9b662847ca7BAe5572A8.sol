...
contract AmberHeard is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x032849F109a3039ADb24a0f19e8968E5dB34eb2D);
    address payable private _marketingAddress = payable(0xe1eccd02B2bC703CA85dae29bDe924DF75a4ae0A);
    
    string private constant _name = "Amber Heard";
    string private constant _symbol = "AMBERHEARD";
