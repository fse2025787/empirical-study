...
/*
World Cup Reward Inu

The World Cup in Qatar is coming soon. For the competition between the United States and Iran, we will open voting in the community and draw 5 winners from the supporters of the winning team, and reward them with 10X holdings

https://t.me/WorldCupRewardInu
https://twitter.com/WCRI_ETH
*/
...
contract WorldCupRewardInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"World Cup Reward Inu";
    string private constant _symbol = unicode"WCRI";
