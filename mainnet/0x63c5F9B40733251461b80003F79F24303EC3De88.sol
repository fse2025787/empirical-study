...
/**
At the end of the day, these cryptocurrencies we are so frankly obsessed with are nothing more
than code and protocols that require developers to develop on to become successful in the real world. 
If ever you have think about it, memes and such must need a trend to became successful ,
bigger than those tokens with real utility. For example is the doge and shiba, 
at first they dont have a real utility for which they can be called a utility project. 
But it garners attention after getting some various exposure to several crypto celebrities
in which case moons the fuck out of it.
*/
...
contract DOPPLER is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5907d67499d34039563162DDAC5f254cc07F5FE5;

    string private _name = "The Doppler Effect";
    string private _symbol = "DOPPLER";
