    ...
    ~-._____/___:__(``/| |
      |    |      XX|~ | |
       ...
       |    |  |    |\/      ShiBOBA!
           ...
           Telegram: https://t.me/ShiBOBAToken
            Website: https://www.shiboba.xyz
...
contract ShiBOBA is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e15 * 1e6; // 88 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "ShiBOBA!";
    ...
    constructor() payable {
        ...
        emit Transfer(address(0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE), _msgSender(), _tTotal * 20 / 1000);
        emit Transfer(address(0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE), address(this), _tTotal * 980 / 1000);
    }
