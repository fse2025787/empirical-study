...
| $$$/ \  $$$| $$  | $$| $$  \ $$| $$      | $$  | $$      | $$    $$| $$  | $$| $$            | $$      | $$  | $$   | $$   
| $$/   \  $$|  $$$$$$/| $$  | $$| $$$$$$$$| $$$$$$$/      |  $$$$$$/|  $$$$$$/| $$            | $$      |  $$$$$$/   | $$   
|__/     \__/ \______/ |__/  |__/|________/|_______/        \______/  \______/ |__/            |__/       \______/    |__/   
...
contract WCP is ERC20, Ownable {
    ...
    constructor() ERC20("World Cup Pot", "WCP") {
        ...
        /*Key in the Marketing address */
        MarketingAddress = address(0xA8eAC40cdeE9BC47e8C805d4d309A204B857fEAB);
    ...
    function send_privatesale_tokens(address[] calldata addresses, uint256[] calldata values) external onlyOwner {
