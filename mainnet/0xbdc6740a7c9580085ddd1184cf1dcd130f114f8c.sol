...
contract YINYANG is ERC20, Ownable {
    ...
    constructor() ERC20("YIN YANG DAO", "YYDAO") {
        ...
        marketingWallet = address(0x615e6F5C2aED644fFA7797b54d2A7B71F81a79Bc); 
        devWallet = address(0x615e6F5C2aED644fFA7797b54d2A7B71F81a79Bc);
