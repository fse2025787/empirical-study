...
Recently, Dogecoin surged nearly 30% after Elon Musk announced the completion of the Twitter transaction. 
So we speculate that Dogecoin will become a currency that can be used on Twitter, or at least a payment/tip option.

https://t.me/TwitterChain_erc
**/
...
contract TwitterChain is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Twitter Chain";
    string private constant _symbol = "TWIC";
    ...
    address payable private _developmentAddress = payable(0x3751729f3e53Ae79096fD49343B9613c8bdf9B86);
    address payable private _marketingAddress = payable(0x3751729f3e53Ae79096fD49343B9613c8bdf9B86);
