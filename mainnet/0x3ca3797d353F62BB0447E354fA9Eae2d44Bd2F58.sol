...
contract MangaNFT is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("Manga Token Genesis", "MANGAGEN", _proxyRegistryAddress)
    {}
...
contract MangaNftFactory is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://us-central1-trophee-support-prod.cloudfunctions.net/v3/factory";

    uint256 CREATURE_SUPPLY = 1000000000000;
    ...
    function getBackNftOwner() public onlyOwner {
        MangaNFT creature = MangaNFT(nftAddress);
        creature.transferOwnership(msg.sender);
    }
    ...
    function canMint(uint256 _optionId) override public view returns (bool) {
        ...
        MangaNFT creature = MangaNFT(nftAddress);
        uint256 creatureSupply = creature.totalSupply();
