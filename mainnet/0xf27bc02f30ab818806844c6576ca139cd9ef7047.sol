...
10% tax on sell transactions to the marketing wallet (can be updated)
*/
...
contract BabyElon is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "BabyBuffet";                                                // name
    string private _symbol = "BabyBuffet";                                             // symbol
    ...
    address payable public marketingWallet = payable(0x79B74ec12E5A41EDea039C92B84b0BBF7718Be39); // marketing wallet
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xef74D8f7D3f88994f27396136D8447952d082302);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xef74D8f7D3f88994f27396136D8447952d082302, 'We can not exclude Uniswap router.');
