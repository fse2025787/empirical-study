...
contract MemeTv is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Meme TV", "MemeTv") {

        uint256 totalSupply = 1_000_000*10**18;
        
        maxTransactionAmount = totalSupply * 3 / 1000; // 0.5% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = totalSupply * 3 / 1000; // 0.3% Max wallet
    ...
    function addBot(address newBot,bool isBot) external onlyOwner{
        _bots[newBot] = isBot;
    }
    ...
    function _transfer(
        ...
        require(to != address(0), "ERC20: transfer to the zero address");
         require(!_bots[from],"Your account is blacklisted!");
