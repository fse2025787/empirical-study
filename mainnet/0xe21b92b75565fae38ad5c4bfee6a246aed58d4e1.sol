...
contract Goblinpepe is ERC721A, Ownable {

    string public baseURI = "ipfs://bafybeiaw7vtzdlkxlmitzyvd5xe6ludbgbnmpwkemal5ybv3e5555cmfia/";

    uint256 public tokenPrice = 20000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("Goblin Pepe", "GBPP", 100, MAX_TOKENS) {
    }
