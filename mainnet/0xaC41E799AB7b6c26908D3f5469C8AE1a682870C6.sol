...
contract ArtRocksByTaik0N is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable supply = 1200;
    ...
    address[] public withdrawAddresses = [0x725E6fA7A261b78880b9C04F48dB3d503b4ed68A, 0xD0736D44Dc402AA29C706f8f162E1624E2EC3ee7, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [47, 48, 5];

    bytes32 public merkleRoot = 0x88b23649731da4d2e1d5a0e7f69ebcf95b7caa65fd9a5dab8a25e44fe0726be3;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xD0736D44Dc402AA29C706f8f162E1624E2EC3ee7, _royaltyAmount);
    }
