...
Be careful where you venture, and hold your tokens tight…
...
contract Yamamba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yamamba";
    string private constant _symbol ="WITCH";
