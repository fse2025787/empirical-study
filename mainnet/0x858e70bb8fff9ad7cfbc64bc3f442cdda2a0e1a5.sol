...
/**
    ...
    Missed TINU launch in the morning ? 

    12% Tax seriously ? and no Auto Lp from Tax

    and No website, wtf, probably you all got caught up in Some Callers own Made up Token on Elon's Tweet

    We are here with an anonymous launch, locked LP, Renounced, Better Contract, Lower Tax and No 
    Team Tokens and by a based dev


    https://t.me/anontitter

    https://anontitter.com/
...
contract anontitterelon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Anon Titter", "Anon Titter") {
