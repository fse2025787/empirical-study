...
contract VOYAGERINU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Voyager Inu";//
    string private constant _symbol = "VOYAGER";//
    ...
    address payable private _developmentAddress = payable(0xFf5A101851a4929CE50896Ff8935EFB226f9DDe6);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 10, "Buy tax must be between 0% and 12%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 4, "Sell rewards must be between 0% and 2%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 10, "Sell tax must be between 0% and 12%");
