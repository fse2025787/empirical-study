...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    } //telegram https://t.me/TsukaRebornETH 
}     // 
...
contract TsukaReborn  is Context, IERC20, Ownable {
    ...
    string private constant _name = "@TsukaRebornETH";
    string private constant _symbol = "$TRE";
