...
contract BorteToken is BurnableToken,FreezeToken, DetailedERC20, ERC20Token,Pausable{
    using SafeMath for uint256;
    ...
    string  private _symbol = "BORTE";
    string  private _name = "BORTE";
    uint8  private _decimals = 18;
    uint256 private TOTAL_SUPPLY = 30*(10**8)*(10**uint256(_decimals));
