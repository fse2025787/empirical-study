...
contract RoboDawgz is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    {
        require(mintIsOpen , "ROBOD isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "ROBOD Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"ROBOD Soldout !");
        require(msg.value >= qty * price,"ROBOD Insufficient Funds !");
