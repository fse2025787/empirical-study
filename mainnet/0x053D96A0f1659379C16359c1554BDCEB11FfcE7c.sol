...
contract DelphiaCredit is Ownable {
    ...
    CoordinationToken public immutable coordinationToken;
    ...
    constructor (CoordinationToken token) {
    ...
    function deposit(uint256 amount) external {
        ...
        require(coordinationToken.transferFrom(msg.sender, address (this), amount),
            "DelphiaCredit.deposit: Cannot transfer token to the Escrow");
    ...
    */
    function withdraw(address payee) external {
        ...
        require(coordinationToken.transfer(payee, balance),
            "Failed to transfer CoordinationTokens");
