...
contract  AiTsuka  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'AI Tsuka';
    string private constant _symbol = 'AITSUKA';
    ...
    address internal constant development_receiver = 0x7f678F1F9048143d7F279aF9B6a9B393d0C97A64; 
    address internal constant marketing_receiver = 0x84D488e888e53C881e0aDa552099131F455e6633;
    address internal constant liquidity_receiver = 0x7f678F1F9048143d7F279aF9B6a9B393d0C97A64;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(1) && sellFee <= denominator.div(2), "totalFee and sellFee cannot be more than 10%");
    }
