...
contract EthFive is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ETH Five";
    string private constant _symbol = "ETH5";
    ...
    uint256 private sellReflections = 5;
    ...
    address payable private _marketingAddress = payable(0x49798A96F7A5041FC8D76B37c70cAba8Dd5E9493);
    address payable private _devAddress = payable(0x78dD6e1CA9eE10ce634539347c40DA6D0cCf0fED);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _devAddress);
        require (maxWalletSize > 30000 * 10**9);
