...
/*
 ...
 Join the new HORUS INU ecosystem | $HORUS

 Website | www.horusinu.xyz
 Twitter | www.twitter.com/horusinu
...
contract HORUSINU is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 125000 * (10**18);
    ...
    uint256 public liquidityPercent = 55; // 55% of total collected tax
    uint256 public marketingPercent = 25; // 25% of total collected tax
    uint256 public devPercent = 20; // 20% of total collected tax


    address payable public marketingWallet = payable(0x970d8137cA5EdBeb94893573fe38b9dED52B7C09);
    address payable public devWallet = payable(0xF19978648abf3244c28301Ed33E080E3828b93DF);
    ...
    constructor() ERC20("Horus Inu", "HORUS") {
        ...
        */
        _createInitialSupply(owner(), 10000000 * (10**18));
    }
