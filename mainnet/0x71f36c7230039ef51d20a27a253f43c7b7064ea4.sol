...
/**
TG: https://t.me/SHIBAPUNKZ
Website https://www.shibapunkz.com/
*/
...
contract SPUNK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _buySPUNKFee;
    
    uint256 public sellTotalFees;
    uint256 private _sellMarketingFee;
    uint256 private _sellLiquidityFee;
    uint256 private _sellSPUNKFee;
    ...
    constructor() ERC20("SHIBA PUNKZ", "SPUNK") {
        ...
        uint256 buySPUNKFee = 7; // Total Buy Fees: 12%

        uint256 sellMarketingFee = 4;
        uint256 sellLiquidityFee = 1;
        uint256 sellSPUNKFee = 7; // Total Sell Fees: 12%
        
        uint256 totalSupply = 1e11 * 1e9;
        ...
        _buySPUNKFee = buySPUNKFee;
        buyTotalFees = _buyMarketingFee + _buyLiquidityFee + _buySPUNKFee;
        
        _sellMarketingFee = sellMarketingFee;
        _sellLiquidityFee = sellLiquidityFee;
        _sellSPUNKFee = sellSPUNKFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee + _sellSPUNKFee;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                _tokensForDev += fees * _sellSPUNKFee / sellTotalFees;
            ...
            // on buy
                ...
                _tokensForDev += fees * _buySPUNKFee / buyTotalFees;
