...
t.me/GelatoBearPortal
https://gelatobear.site/
...
contract GELBEAR is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000 * 10**8;
    ...
    string private constant _name = "Gelato Bear";
    string private constant _symbol = "GELBEAR";
    ...
    uint256 public _maxTxAmount = 20000000000000 * 10**8;
    uint256 public _maxWalletSize = 20000000000000 * 10**8;
