...
contract ERC20 is Context, Ownable, IERC20 {
    ...
    address public marketingWallet = 0x61100a8729A53754F657Bb930af8b524a2B14f79;
    uint8 public marketingTax = 2;
    ...
    function changeMarketingFeePercent(uint8 _tax) external onlyOwner
    {
        marketingTax = _tax;
    }
...
contract AEZAI is ERC20, ERC20Detailed {
  ...
  constructor () ERC20Detailed("AEZAI", "AI", 18) {
    _owner = msg.sender;
