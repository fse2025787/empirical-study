...
contract Strategy is CurveVoterProxy {
    ...
    constructor(address _vault) public CurveVoterProxy(_vault) {
        ...
        gauge = address(0x11137B10C210b579405c21A07489e28F3c040AB1);
        keepCRV = 1000;
    }
        ...
        )
    {
        ...
        IVoterProxy(proxy).claimRewards(gauge, bor);
        uint256 _bor = IERC20(bor).balanceOf(address(this));
        if (_bor > 0) {
            IERC20(bor).safeApprove(sushiswap, 0);
            IERC20(bor).safeApprove(sushiswap, _bor);
