...
contract DannoUra is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"Dan no Ura 浦の戦い";
    string private constant _symbol = "DAN NO URA";
    ...
    address payable private _developmentAddress = payable(0xE0D9C293118a40cb0A50e680Be68931642A3bBAA); 
    address payable private _marketingAddress = payable(0xE0D9C293118a40cb0A50e680Be68931642A3bBAA);
