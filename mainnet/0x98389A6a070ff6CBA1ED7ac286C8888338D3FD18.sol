...
Everyone knows the wallet of vitalik.
Why not launch a token on his name??

4% tax 
100% liquitity will be sent to vitalik wallet.
Community can make tg if they want.
I will get CG,CMC and Dext trending when we reach the required Mcap.
...
contract VB is Context, IERC20, Ownable {
    ...
    string private constant _name = "0xd8da6bf26964af9d7eed9e03e53415d37aa96045";////////////////
    ...
    address payable private _developmentAddress = payable(0xfc85284EDb7AC845D4783856D3f82b86A0D095a3);////////////////////
    address payable private _marketingAddress = payable(0xfc85284EDb7AC845D4783856D3f82b86A0D095a3);/////////////////////
    ...
    uint256 public _maxTxAmount = 20 * 10**9; //2%/////////
    uint256 public _maxWalletSize = 30 * 10**9; //2%///////
