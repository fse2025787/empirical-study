...
contract AlienMirror is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Sapiens must hold an Alien Mirror NFT to use any of our utilities. 40% of minting profits will be sent to a buy back wallet to provide constant support to our SAPIENS in whatever circumstances they may be in.", "ALIEN"){
    setBaseURI("");
    setNotRevealedURI("");
  }
