...
contract PumpkInu is BEP20, Ownable { //
    using SafeMath for uint256;
    ...
    constructor() BEP20("Pumpk Inu", "$PUMP") { // 
        marketingWallet = payable(0xf58227A05F8FD373d51Ab294aE0D28Ba84f6aE1D); // 
        devWallet = payable(0x0eA86B569b07039D9B3c755081DA486B1102505c); // 
