...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xEBA33B3a0C498B2b46e92FDb8C498e3d1A6D0AF4];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xEBA33B3a0C498B2b46e92FDb8C498e3d1A6D0AF4;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 308) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmU3hZiPSHBsuFBGnLiq36KbbfGCrRixw7wv5YfXqpBNVj/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 308");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 308");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 308");
...
// File: contracts/RobotApeContract.sol
//

pragma solidity ^0.8.0;

contract RobotApeContract is RamppERC721A {
    constructor() RamppERC721A("RobotApe", "METAL"){}
}
