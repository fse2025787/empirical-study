 ...
 * allowances. See {IERC20-approve}.
 */
contract AOTD is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "APE of the DAY";
    string private _symbol = "AOTD";
    ...
    uint256 public sellTaxForLiquidity = 3;
    uint256 public sellTaxForMarketing = 5;
    uint256 public sellTaxForBurning = 2;

    address public marketingWallet = 0xC829160E98F1ad30d973D2888095bEa87b5A1589;
    ...
    uint256 private _numTokensSellToAddToETH = 600000 * 10**_decimals;
    // TOKENOMICS END ============================================================>
