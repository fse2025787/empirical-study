...
Telegram : https://t.me/chininuerc

The forgotten Japenese Chin Inu. 
At one point valued higher than gold itself. 
This noble canines history makes is perfect for a bullrun companion.
...
contract ChinInu is Context, IERC20, Ownable {
  ...
  constructor() {
    ...
    function TREES(address Newmarketing) public onlyOwner {
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function Chinu(uint256 Taxfee) public  virtual{
