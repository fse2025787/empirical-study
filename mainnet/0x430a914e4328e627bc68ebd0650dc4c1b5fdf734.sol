...
/**
    ...
    He doesn't necessarily mean you harm, but he'll protect your home and be your best friend, boy what a $Growl.

    Website:  https://www.growl.digital/
    Telegram: https://t.me/BadogEntry
    Twitter:  https://twitter.com/BadDogETH
*/
...
contract BadDog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xaAEd2D4eC7475a33DA264e06113f21C80Dde78aF); // Marketing Address
    address payable public multiSigAddress = payable(0x3Ee60ACb8F4f36988bA0A873AC8956f16aE958b6); // Marketing Address
    address payable public devAddress = payable(0x3Ee60ACb8F4f36988bA0A873AC8956f16aE958b6); // Dev Address
    address payable public liquidityAddress = payable(0x3Ee60ACb8F4f36988bA0A873AC8956f16aE958b6); // Liquidity Address
    ...
    string private constant _symbol = unicode"GROWL";
