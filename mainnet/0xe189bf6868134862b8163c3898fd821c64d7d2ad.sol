...
contract BoardroomToken is ERC20, Ownable {
    using SafeMath for uint256;
    bool public rewardPoolDistributed = false;

    function initialize() public initializer {
        Ownable.__Ownable_init();
        ERC20.__ERC20_init("Boardroom Cash", "BDR");

		// 5M for initial liquidity provider, (21M-5M) for the liquidity farm.
        _mint(msg.sender, 5000000 * 1e18);
    }

    function distributeReward(address _farmPool) external onlyOwner {
        require(!rewardPoolDistributed, "only can distribute once");
        require(_farmPool != address(0), "!_farmPool");
        rewardPoolDistributed = true;
        _mint(_farmPool, (21000000-5000000) * 1e18);
    }
