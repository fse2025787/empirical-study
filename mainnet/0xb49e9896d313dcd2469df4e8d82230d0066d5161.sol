...
contract PunkGirls is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Punk Girls", "Punks") {
        setHiddenMetadataUri("http://ipfs.punkgirls.world/");
        setBaseURI("http://ipfs.punkgirls.world/");
    }
