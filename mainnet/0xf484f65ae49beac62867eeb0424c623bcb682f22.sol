...
contract A5BLOCKS is IERC20, Auth {
	string _name = "A5BLOCKS";
	string _symbol = "ABLOCK";
	...
	uint16 private _ethTaxShares1  = 600;
	...
	address payable private _ethTaxWallet1 = payable(0x0B0DDac05AC9c78D32DD9AE58D5EC9dF2f481b51); 
	address payable private _ethTaxWallet2 = payable(0x0B0DDac05AC9c78D32DD9AE58D5EC9dF2f481b51); 
	address payable private _ethTaxWallet3 = payable(0x0B0DDac05AC9c78D32DD9AE58D5EC9dF2f481b51); 
	address private _tokenTaxWallet = address(0x8a46636c0f61859d4a08aB943D788633c8B2C984); 
