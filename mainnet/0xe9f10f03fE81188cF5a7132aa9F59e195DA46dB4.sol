...
https://www.jeetcat.guru/

TWITTER:

https://twitter.com/JeetCat
...
contract jeetcatZ is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Jeet Cat";
    string private constant _symbol = unicode"MEOWSER";
