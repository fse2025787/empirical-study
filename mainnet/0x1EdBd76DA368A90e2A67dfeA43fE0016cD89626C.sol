...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1000, 1500 ) {}
...
contract FaceConesNftContract is RamppERC721A {
    constructor() RamppERC721A("Face Cones NFT", "FCNTD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/fCjC0skqaSp50rNYCQeW/contract-metadata";
    }
}
