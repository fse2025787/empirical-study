...
contract Pixelgobblers is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Pixel Gobblers", "PGBR") {
  ...
  function patrick() public onlyOwner {
    paused = !paused;
  }
