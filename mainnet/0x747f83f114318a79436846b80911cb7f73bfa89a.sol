...
contract InvisibleFrenz is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // mint price
    uint256 public _price = 6900000000000000;
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return 'ipfs://QmNwiiGgrnstTNLFUUgZvS72SqH2xSJfNuBFv6nY5D4P8r/';
    }
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = InvisibleFrenz.ownerOf(tokenId);
    ...
    function reserve(address to, uint256 quantity) external  {
        require(msg.sender == _owner);
        require(currentIndex + quantity <= 2929);
