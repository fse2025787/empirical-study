...
contract koinu is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x5f31F0A47A4A1eCcccd7cedf49a837EE165Ed72C);
    ...
    constructor() ERC20("Koinu", "$KOINU") {
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // 0.3% maxTransactionAmountTxn
