...
// File: contracts/Alpha_Collective.sol
...
contract AlphaCollective is ERC721, Ownable {
  ...
  uint256 public cost = 1.25 ether; //1.25 ETH
  ...
  constructor() ERC721("Alpha Collective", "AC") {
