...
/**
 ...
 🦁 https://mohatu.net (website)
 🦁 https://twitter.com/mohatueth (twitter)
 🦁 https://mohatu.net/images/mohatuwp.pdf (whitepaper)
...
contract MOHATU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address[] memory e) ERC20("Mohatu Token", "Mohatu") {
        ...
        marketingWallet = address(0x97eE191eaB356C24F8DA9FF5E0Bf45c234e2FFaF);
        devWallet = address(0x2e563692Eb06Fe89B4565818C4E74B47907A2F2A);
