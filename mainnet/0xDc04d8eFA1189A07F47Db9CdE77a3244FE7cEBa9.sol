...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe9d019676dDF2d143b67599F88dB5cE3609FdC7E];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 4444 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdWAVg4PytLPi4kRuqe7eCXJABCdvpAgcH6ExwXjGC3yV/";
...
// File: contracts/BuythisNfTandullsavebunContract.sol
//

pragma solidity ^0.8.0;

contract BuythisNfTandullsavebunContract is RamppERC721A {
    constructor() RamppERC721A("Buy this NFT and ull save bun", "HBN"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/w556nUNbTg3Jb9WdBlfC/contract-metadata";
    }
}
