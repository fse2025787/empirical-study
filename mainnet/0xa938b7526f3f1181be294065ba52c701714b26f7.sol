...
contract DeaDAO is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 500000*10**18;
    string public _name = "Dea DAO";
    string public _symbol= "DEA";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x36B412835900598d0cFCB6C096d110FA364eAdf5);
