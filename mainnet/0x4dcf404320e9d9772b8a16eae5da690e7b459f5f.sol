...
contract $WYD is ERC20, Ownable {
    ...
    constructor() ERC20( "You Up?", "WYD") {
        ...
        operationsAddress = address(0x0178Da41386Be4C6fE156f22723e3000DbCCF19f); // change this address to wallet u want for operations   
        TaxAddress = address(0x0178Da41386Be4C6fE156f22723e3000DbCCF19f);  // change this address to the one for tax 
