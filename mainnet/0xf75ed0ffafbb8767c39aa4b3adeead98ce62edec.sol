...
contract EOTW is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "End of The World";
    ...
    address payable private _developmentAddress = payable(0x8bF4fA0d2a62C4d9B85385F84A1694EeF04cc628); 
    address payable private _marketingAddress = payable(0x8bF4fA0d2a62C4d9B85385F84A1694EeF04cc628);
