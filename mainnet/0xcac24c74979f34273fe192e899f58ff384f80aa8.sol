...
/**
    Mobile Pets ERC Token
    Telegram: https://t.me/MobilePetsERC
*/
...
contract MobilePets is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x951d105e8c616657181C98062909E230562B75D3); // Marketing Address
    address payable public multiSigAddress = payable(0x951d105e8c616657181C98062909E230562B75D3); // Marketing Address
    address payable public devAddress = payable(0x951d105e8c616657181C98062909E230562B75D3); // Dev Address
    address payable public liquidityAddress = payable(0x951d105e8c616657181C98062909E230562B75D3); // Liquidity Address
    ...
    string private constant _name = unicode"Mobile Pets";
    string private constant _symbol = unicode"mPETS";
