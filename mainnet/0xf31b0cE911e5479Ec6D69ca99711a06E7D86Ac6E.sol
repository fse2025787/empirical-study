...
// TG: https://t.me/hanumaninu , SLIPPAGE 14-17%
...
contract HANUMANINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 100 * 10**10 * 10**9; // supply : 1,000,000,000,000 $HANUMANINU
    uint256 public _maxbuy = 4 * 10**10 * 10**9; // maxtransaction 4% 
    uint256 public _maxwallet = 5 * 10**10 * 10**9; //maxwallet 5% 
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    address payable public marketingWallet = payable(0x82A5bA4803b00D41Fe130cB3836B8D3E9d6517a4); 
    address payable public rewardsWallet = payable(0xd636B2F7794Ab4eBE3d384b581774B3A4A6EABD4); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "HANUMAN INU";
    string private _symbol = "$HANUMANINU";
    uint8 private _decimals = 9;

    uint256 public _autoliquidity = 2;
    uint256 public _marketing = 6;
    uint256 public _developer = 5;     
    uint256 public _antidump = 4;  
