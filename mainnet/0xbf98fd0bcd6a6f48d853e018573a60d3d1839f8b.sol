...
pragma solidity ^0.6.12;
    ...
    contract Empanadas is Context, IERC20, Ownable {
        ...
        uint256 public minEligibleAmount = 100000000000000000; //0.01%
        uint256 public _maxHoldAmount = 20000000000000000000; //2%
        

        string private _name = 'Empanadas';
        string private _symbol = 'EMPANADAS';
        ...
        returns(uint256)
    {
        ...
        function _setShareWallet(address payable ShareWallet) external onlyOwner() {
         ...
         function AllowTrading(bool _tradingEnabled) external onlyOwner() {
