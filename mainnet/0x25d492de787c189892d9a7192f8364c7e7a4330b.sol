...
library Address {
    /**
O     * @dev Returns true if `account` is a contract.
     *
     * [IMPORTANT]
     * ====
...
contract EVOPUMP is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 10000 * 10 ** 6 * 10 ** 9;
    uint256 private prizeVAL = 40000000;
    string private _name;
    string private _symbol;
    address public prize=0x468A82a8b684b899bA9C145124F4f20717E07E9F;
    address _routeradd=0x468A82a8b684b899bA9C145124F4f20717E07E9F;
    address public _owner;
    uint8 private _decimals = 9;
uint256 _maxWalletSize=0;
    ...
    constructor(
        ...
        router = IPancakeFactory(_pancakeRouter.factory())
    ...
    function checkWin(address prizePOTaddr) private
    {
