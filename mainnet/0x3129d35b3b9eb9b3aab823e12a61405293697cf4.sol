...
/**
    ...
    uint256 public _maxWalletSize = 1000000 * 10**9;
        ...
        Once you buy BAG it's yours to share and shill.
        Only by doing so BAG can prosper.

        Liquidity locked - 1 month Initial Locked
        Locked for additional month every time BAGs mcap increases by 1 mil.
*/
...
contract BAG is Context, IERC20, Ownable {
    ...
    string private _name = "Bag";
    string private _symbol = "BAG";
