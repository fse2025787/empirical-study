...
// Telegram: https://t.me/AcidArabInu
...
contract AcidArabInu is Context, IERC20, Ownable {
    ...
    string private _name = "Acid Arab Inu";
    string private _symbol = "ABI";
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 1000000, "Swap Threshold Amount cannot be less than 69 Million");
