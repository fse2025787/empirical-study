...
contract ThePakis is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmap9m1utdpVKeRtUJsckx4XqJWZf4Nq1TPSYKvKieaTE";
    ...
    constructor(
    ) ERC721A("The Pakis", "EID", 100, maxSupply) {
    }
