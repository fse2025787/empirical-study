...
//  ___  _   _  ____  ____  ____  _  _     ___  _____  _    _  ___ 
// / __)( )_( )(_  _)(_  _)(_  _)( \/ )   / __)(  _  )( \/\/ )/ __)
// \__ \ ) _ (  _)(_   )(    )(   \  /   ( (__  )(_)(  )    ( \__ \
// (___/(_) (_)(____) (__)  (__)  (__)    \___)(_____)(__/\__)(___/
//
...
contract ShittyCows is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("ShittyCows", "SC") {
        setBaseURI("");
    ...
    function FreeMooMoo(uint256 _mintAmount) public payable nonReentrant{
    ...
    function ManyMooMoo(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
    ...
    function MooMooGift(uint256[] calldata quantity, address[] calldata recipient)
        external
        onlyOwner
    {
        require(
