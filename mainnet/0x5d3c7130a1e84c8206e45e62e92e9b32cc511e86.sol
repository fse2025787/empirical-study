...
/**
 ...
 +-+-+-+-+ +-+-+-+-+ +-+-+-+-+-+ +-+-+-+-+-+
 |M|A|K|E| |A|P|E|S| |G|R|E|A|T| |A|G|A|I|N|
 +-+-+-+-+ +-+-+-+-+ +-+-+-+-+-+ +-+-+-+-+-+
...
contract MAGA is Context, IERC20, Ownable {
    ...
    string private _name = "Make Apes Great Again"; // Insert Name Here
    string private _symbol = "MAGA"; // Symbol
    uint256 private _tTotal = 10 * 10**9 * 10**uint256(_decimals); // Supply Total . Remember uint256
   
    uint256 public defaultTaxFee = 0; // Keep zero
    uint256 public _taxFee = defaultTaxFee;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public defaultMarketingFee = 7; // Your Buying Tax
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _marketingFee4Sellers = 7; // Your Selling Tax
    ...
    address payable public marketingWallet = payable(0xC8725Be0Fda6eda3362D4Efb46CF57215a766683); // Receving Address
