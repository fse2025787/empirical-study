...
contract SCROOB is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Scroobius Apes", "SCROOB"){}
  ...
  function ownerMintToAddress(uint256 amt, address mintTo) external onlyOwner
  {
    require(totalSupply() + amt < maxSupply + 1,"too many!");

    _safeMint(mintTo, amt);
  }
  ...
  function _baseURI() internal view virtual override returns (string memory) {
   ...
   address private constant payoutAddress1 =
        0xce5F5003F7A9352e58D22dAF644EE12Ed9071431;
