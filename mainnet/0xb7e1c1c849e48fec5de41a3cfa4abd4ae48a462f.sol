...
contract Distributor is Ownable {
    function distributeEth(address payable[] memory winners) public payable onlyOwner {
    ...
    function distributeNfts(address contractAddress, address[] memory winners, uint256[] memory nfts) public onlyOwner {
