...
contract Queueing is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("The Queueing", "Queueing") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.0015 ether;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmfSPifhdPRBXKhsGGQWxTonr2QMLuE7WDBQE6xPwYkSjN/", _toString(tokenId), ".json"));
    }
