...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Homecoming";
    string private constant _symbol = "Kisei";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x7af1189a243a0cE6aCA185bad07716dB9b162b53); 
