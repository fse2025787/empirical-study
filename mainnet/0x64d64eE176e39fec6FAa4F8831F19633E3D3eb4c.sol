...
contract thePies is ERC721EnumerableB, Ownable {
    ...
    constructor() ERC721B("thePies", "Pies") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= maxMintAmount, "Max mint per transaction exceeded");
    ...
    function setMaxMintAmount(uint256 newMaxMint) external onlyOwner {
