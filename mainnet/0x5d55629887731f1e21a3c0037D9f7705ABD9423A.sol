...
// https://t.me/SquidMasERC

// https://twitter.com/SquidMasERC

// https://medium.com/@SquidMasERC

// 

/*

The SquidMas token ERC20 Staking Utility is a smart contract-based technology that enables users to stake their ERC20 
tokens in order to earn rewards. The rewards are distributed based on the amount of tokens staked, the amount of time the 
tokens are staked, and the type of token used. This system helps to incentivize users to hold their tokens for an extended 
period of time, while also providing a way to earn rewards. This utility can be used by both individuals and businesses, 
allowing them to easily stake their ERC20 tokens and earn rewards.
...
contract SquidMasERC is Ownable, IERC20 {
    ...
    string constant private _name = "SquidMas ERC";
    string constant private _symbol = "SMASERC";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xF76ac22d0e6deb5EaDB4aA2EF1b464418f765b58;
        devWallet = 0xF76ac22d0e6deb5EaDB4aA2EF1b464418f765b58;
