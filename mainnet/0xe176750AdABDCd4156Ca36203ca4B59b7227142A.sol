...
contract UTSKINCORE is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_MINTS = 2000;
    string public baseURI = "https://unknownmetaverse.games/nft/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("UNKNOWNMETAVERSESKINS", "UTNFT", MAX_MINTS, MAX_SUPPLY) {  
    }
