    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 444) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmWG3iTJofyehJDYmtJeENtCGH8XpZ4H828qsX4LkfqwSH/";
...
// File: contracts/TheButterflyEffectContract.sol
//

pragma solidity ^0.8.0;

contract TheButterflyEffectContract is RamppERC721A {
    constructor() RamppERC721A("The Butterfly Effect", "BEFFECT"){}
}
