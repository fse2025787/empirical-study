...
// Zen Art by Kanji : First Phase 2D Art 
// 1 Free Mint 
// Rest 0.002
...
contract ZenArtbyKanji is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.002 ether;
    uint   public maxTx             = 800;
    ...
    constructor() ERC721A("Zen Art by Kanji", "ZAK1") {}
