...
$KEK is the definition of a “whales playground”. We have Shinja, volt & other big Inu whales backing us. 

We have a strong starting liquidity pool of 7 ETH. 

Taxes are 3/3% with a 2% max wallet + TX. 

Team will be pushing this throughout to 1M+ marketcap. Marketing has been planned and will be taking place immediately after launch. 


Website: https://Kekinu.site

Telegram Portal: Https://T.me/KekInu
...
contract Kekinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Kek Inu";
    string private _symbol = "KEK";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x273Aefe629E9435f69Ae0dF53B8F27177969e612);
    address payable private taxWallet2 = payable(0x273Aefe629E9435f69Ae0dF53B8F27177969e612);
    ...
    uint256 public _marketingShares = 6;
