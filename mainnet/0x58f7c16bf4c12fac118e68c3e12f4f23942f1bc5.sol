...
contract SantaClausInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Santa Claus Inu";
    string private _symbol = "SANTA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x7Cba6762d1c4AB917F5f0926EDeF4F544C953645);
    address payable private taxWallet2 = payable(0xd9520fe2AE66159fd2C849CBCeF13387F5206164);
