...
contract FatBits is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUFNoz9bFvztQjMoU3CAUSVxNZXy86P2mvZKaKxfxM6XK";
    ...
    constructor(
    ) ERC721A("FatBits", "FATBITS", 1111, maxSupply) {
    }
