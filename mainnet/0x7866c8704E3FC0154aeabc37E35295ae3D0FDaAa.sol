...
$SHIMOON is a decentralized meme token on the Ethereum blockchain. Its mission is to give back to the crypto community, give to charity, and win the heart of $SHI, because we are all here to make money and only money bring happiness.

https://t.me/shimoonerc

https://twitter.com/shimoonerc_
...
contract ShimoonERC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shi Moon";
    string private constant _symbol = unicode"SHIMOON";
