...
contract BBElon is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmUL5NzuLXmtVWAEPb8dUYiwSpaVCw5zqSmqg2k3WHHtTL/";
  ...
  constructor() ERC721("BBElon", "BBEL") {
    setHiddenMetadataUri("ipfs://QmXEQgHewxNja4ER3v4mesgMgwCqSDd23X9QspzedhJ2iU/NotRevealed.json");
  }
