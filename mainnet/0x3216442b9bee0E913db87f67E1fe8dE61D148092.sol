...
https://www.fuckfloki.com/
https://t.me/FckFloki

At the end of the day, 5-10 people will get a split of the dev tax. We will do a poll in the Telegram to decide this.

1M tokens = 1 ticket

1. Must hold $FFLOKI
2. Entries double if holding original Floki before 7/7/2021
3. Entries tripled if no sells on $FFLOKI

DRAWS HAPPEN EVERY 6 HOURS ON RANDOM.
...
pragma solidity ^0.6.12;
    ...
    contract FFLOKI is Context, IERC20, Ownable {
        ...
        string private _name = 'FUCKFLOKI'; 
        string private _symbol = 'FFLOKI';
