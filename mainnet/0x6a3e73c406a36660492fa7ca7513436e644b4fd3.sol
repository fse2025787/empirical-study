...
// File: https://github.com/ssccrypto/eth/blob/feb00f61a229fe38c8717f9a4708fc8b3f907abb/badbunny
...
contract BADBUNNY is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'BAD BUNNY';
    ...
    uint256 swapThreshold = ( _totalSupply * 550 ) / 100000;
    ...
    function setInternalAddresses(address _marketing, address _alpha, address _delta, address _stake, address _token, address _default) external onlyOwner {
    ...
    function addLiquidityUSDC(uint256 tokenAmount, uint256 USDCAmount) public {
        _approve(address(this), address(router), tokenAmount);
