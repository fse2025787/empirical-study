...
contract Chonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chonk";
    string private _symbol = "CHONKZ";
    uint8 private _decimals = 9;

    address payable public Marketing = payable(0x30448BFD11A081ba66D2EF5ACF0b39bc709D1C37);
    address payable public Dev = payable(0x4B1B54db076ee3ca99f8B565567F7a9f212be81c);
