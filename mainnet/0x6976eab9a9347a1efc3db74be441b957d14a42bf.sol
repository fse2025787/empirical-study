...
/**
Website https://ryzertoken.xyz
Telegram https://t.me/Rizertoken
Twitter https://twitter.com/Rizertoken
*/ 
...
contract Token is ERC20, Ownable {
    ...
    // TODO FIXME     
    uint256 public swapTokensAtAmount = 500_000 * 1e18; // 0.05% wallet
	uint256 public maxTxAmount = 5_000_000 * 1e18; // 1% from total supply maxTransactionAmountTxn

    // Project wallets
	address public gameDevelopmentFeeAddress = 0x59cd2A3a2BE5b31B96Cfc4e41f92092dcf481A5E;
	address public marketingFeeAddress = 0x59cd2A3a2BE5b31B96Cfc4e41f92092dcf481A5E;
    ...
    constructor(string memory name, string memory symbol, address payable routerAddress) ERC20(name, symbol) {
        //Uniswap router 
