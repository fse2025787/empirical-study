...
contract FLAKE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"FLOKI CAKE";
    ...
    address payable private _developmentAddress = payable(0xCd3FDF1a24A5E5c5A9f64Ce02Bc5Dd61239880f9); 
    address payable private _marketingAddress = payable(0xCd3FDF1a24A5E5c5A9f64Ce02Bc5Dd61239880f9);
