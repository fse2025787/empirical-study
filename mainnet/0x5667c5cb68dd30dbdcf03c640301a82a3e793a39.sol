...
contract FuckMatrixSamurai is Context, IERC20, Ownable {
    ...
    string private _name = 'Fuck Matrix Samurai';
    string private _symbol = 'FMXS🖕';
    ...
    uint256 private _projectDevelopmentFee = 7; // 10% project development
