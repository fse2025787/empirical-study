...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 6; //  change it to what you want 
    uint256 private _previousTaxFee = _taxFee;
    
	//this is what gets added in the liquidity pool. Change it to what you want 
    uint256 public _liquidityFee = 3; //   change it to what you want 
    ...
    uint256 public _burnFee = 6; //  change it to what you want 
