...
/*
    Telegram: https://t.me/shibuinuentrance
    Website: https://shibutoken.com
    Twitter:  https://twitter.com/shibuinueth
*/
...
contract ShibuInu is Context, IERC20, Ownable {
    ...
    uint256 public _tokensFee = 2;
    uint256 public _tokensFeeFirst12h = 2;
    ...
    string private constant _name = "ShibuInu";
    string private constant _symbol = "ShibuInu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xF031E884607A39014345C0EB97b8BC0E18d43eE4);
        _feeAddrWallet2 = payable(0xf80bE502D46df75e6488682af862e0e4Aec82A6a);
        _feeAddrWallet3 = payable(0x71F96F47eeedffb581be69A4A4c1BDd4b1B3C597);
