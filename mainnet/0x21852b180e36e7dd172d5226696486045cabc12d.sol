...
contract HumanOfNFTs is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdHzgy93SKBuUSHqXvsULjmQjnkxNzc4DNU9fEhoTaML7";
    ...
    constructor(
    ) ERC721A("Human Of NFTs", "HON", 100, maxSupply) {
    }
