...
contract ANT is BEP20, Ownable { // 
    ...
    constructor() BEP20("ANT", "ANT") { // 
        marketingWallet = payable(0x0197604EC551a311c68Ec69bB8fDEC517aa41C80); // 
        devWallet = payable(0x0197604EC551a311c68Ec69bB8fDEC517aa41C80); // 
        address router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

        //INITIAL FEE VALUES HERE
        buyMarketingFees = 2;
        sellMarketingFees = 14;
        buyBurnFee = 0;
        sellBurnFee = 0;
        buyDevFee = 0;
        sellDevFee = 0;
