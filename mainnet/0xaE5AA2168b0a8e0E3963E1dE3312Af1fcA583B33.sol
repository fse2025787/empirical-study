...
contract NSHIB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Nyan Shib";//
    string private constant _symbol = "NSHIB";//
    ...
    address payable private _developmentAddress = payable(0x53E50B8852e8DD28670D330b6A382e392C92B67b);//
    address payable private _marketingAddress = payable(0x6051b162bE14c0e11Cf6B7389B7B17DDE8A5de70);//
    ...
    uint256 public _maxTxAmount = 20000000000000 * 10**9; // 2
    uint256 public _maxWalletSize = 40000000000000 * 10**9; // 4
