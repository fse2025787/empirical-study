...
|   USDC PIGGY BANK
|
|   TOKENOMICS : 16% USDC REFLECTIONS (8% BUY, 8% SELL)
|   WEBSITE    : piggy.quest
|   TELEGRAM   : t.me/usdcpiggy
*/
...
contract USDCPIGGYBANK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("USDC Piggy Bank", "PBANK") {
    ...
    function enableTradingForAll() external onlyOwner {
