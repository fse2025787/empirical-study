...
contract HydrogenSonata is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666666666666666 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "The Hydrogen Sonata";
    string private _symbol = "$HYDROGEN";
