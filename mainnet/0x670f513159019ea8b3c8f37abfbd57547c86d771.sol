...
// https://t.me/BabyDBIPortal

// https://twitter.com/BabyDontBuyInu

// 2% max tx

// 2% of every transaction gets sent to $DBI deployer to support our daddy dev!
...
contract BabyDontBuyInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Dont Buy Inu", "BDBI") {
        ...
        devOpsWallet = address(0x3c4d94bBe07fE04B76B4Aff3407A9899cfd92244); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x3c4d94bBe07fE04B76B4Aff3407A9899cfd92244), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x3c4d94bBe07fE04B76B4Aff3407A9899cfd92244), true);
