...
// File: contracts/Botanical Machines.sol
...
contract Botanical_Machines is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://TCHPHFWTR3A7F68B7ASZ5N9IFVKKR1PSKS";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Botanical Machines", "BOTM") { }
