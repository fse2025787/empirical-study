...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return 0x7DE76101ce7b1454556F28D932f61FDc4d8BeD9B; //owener Address
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x7DE76101ce7b1454556F28D932f61FDc4d8BeD9B; //  Owner Address
...
contract BJINU is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x3BA8B0f69098cb4A27d8019ddf375146bb1B1d2A; // Charity address
    ...
    string private _name = "Basenji Inu";
    string private _symbol = "BJINU";
