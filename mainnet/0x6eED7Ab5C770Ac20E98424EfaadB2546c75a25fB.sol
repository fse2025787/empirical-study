...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x0d9273da0729DF230890CA3d0147d78636339E5d];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x0d9273da0729DF230890CA3d0147d78636339E5d;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmVxDGkYACGG5XHSEBtmYD6sLywrwrYRWcsvVw26hF7doh/";
...
// File: contracts/X3DPepeMfersContract.sol
//

pragma solidity ^0.8.0;

contract X3DPepeMfersContract is RamppERC721A {
    constructor() RamppERC721A("3D Pepe Mfers", "3DPepeMfer"){}
}