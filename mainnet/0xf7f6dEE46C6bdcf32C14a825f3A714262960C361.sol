...
// 
// Identical to openzeppelin ERC721Enumerable.sol, but allows for function overrides and has _importTransfer
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /* To only be used when importing a v1 token via the bridge */
    function _importTransfer(
        address from,
        address to,
        uint256 tokenId
    ) internal virtual {
...
// 
// Identical to openzeppelin ERC721Enumerable.sol, but with visibility changed from private to internal for some functions
