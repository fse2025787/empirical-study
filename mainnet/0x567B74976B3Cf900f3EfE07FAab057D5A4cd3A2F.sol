...
contract SOFTGHETTO is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;
    uint256 public price = 80000000000000000; 
    uint256 public constant maxSupply = 3333; //total NFTs available
    address public royaltyAddress = 0x9B69bcfd24dCDE9a137d7b83C7dAb6E3BDd6C10B; //need to update before deploying
    uint96 public royaltyFee = 1000; //10% royalty
    string public _baseTokenURI = "ipfs://QmW9hNThixZodwfaon74rE48iZX6eSMiC8XiBGYKi43am5/"; // IPFS link
    string public _baseTokenEXT = ""; 
   
    constructor() ERC721A("SOFT GHETTO", "SG") {
    ...
    function mint(uint256 nTokens) external payable {
        ...
        require(supply + nTokens <= maxSupply , "Exceeds max supply");
        require(msg.value >= price*(nTokens), "Value below price");
