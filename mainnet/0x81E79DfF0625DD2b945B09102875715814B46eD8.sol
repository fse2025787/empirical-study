...
abstract contract BasicResolver is Events, DSMath, Basic {
    ...
    /**
     * @notice This will be used when transfer amount is unknown. It will be 
     *         majorly used in connext flow.
     *
     * @param erc20 Token address 
     * @param setId Used for communication to pass information to other connector. 
     */
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        _eventName = "LogDeposit(address,uint256,uint256,uint256)";
        _eventParam = abi.encode(erc20, amt, 0, setId);
    }
