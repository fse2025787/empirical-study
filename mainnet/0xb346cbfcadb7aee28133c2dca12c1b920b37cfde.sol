...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xde65429480a3eb54911d2C6399b39CDd16071B96;
...
contract MEME is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 40000 * 10**_decimals;
    uint256 public _maxTxAmount = 2000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Meme Inu";
    string private _symbol = unicode"MINU";
