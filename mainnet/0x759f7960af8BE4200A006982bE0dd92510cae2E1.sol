...
contract DuckRunners is ERC721, Ownable {

    uint public mintPrice = 0.05 ether; // Mutable by owner
    ...
    uint public startTimestamp = 1634994000; // October 23st, 2021 at 1 PM GMT
    

    event Mint(address indexed owner, uint indexed tokenId);

    constructor() ERC721("DuckRunners", "DUCKRUNNER") {}
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        return string(abi.encodePacked(_baseTokenURI, Strings.toString(_tokenId), baseExtension));
    }
