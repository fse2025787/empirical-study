...
contract BanditsInMetaverse is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 9735;
    uint256 public MAX_MINTS = 50;
    string public baseURI = "https://api.banditsinthemetaverse.com/api/tokens/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("Bandits In Metaverse", "BM", MAX_MINTS, MAX_SUPPLY) {  
    }
