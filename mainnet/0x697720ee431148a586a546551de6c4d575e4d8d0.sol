...
// 
// File: contracts/FreethePixel.sol
...
contract FreethePixel is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6020;
    uint256 public MAX_MINTS = 2;
    string public baseURI = "ipfs:///";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Free.the.Pixel", "FREEPXL", MAX_MINTS, MAX_SUPPLY) {  
    }
