...
contract CopyCats is ERC721Enumerable, Ownable {
    string _baseTokenURI;
    uint256 private _maxMint = 20;
    uint256 private _price = 5 * 10**16; //0.05 ETH;
    bool public _paused = true;
    uint public constant MAX_ENTRIES = 9999;

    constructor(string memory baseURI) ERC721("CopyCats", "COPYCATS")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require( num < (_maxMint+1),"You can mint a maximum of _maxMint CopyCats" );
