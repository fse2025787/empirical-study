...
contract SupermetaStore is OwnableUpgradeable, ERC1155Upgradeable, RevokableDefaultOperatorFiltererUpgradeable {
    ...
    function mintBatch(address _to, uint256[] memory _ids, uint256[] memory _amounts) external onlyController {
        _mintBatch(_to, _ids, _amounts, "");
    }

    function burnBatch(address _to, uint256[] memory _ids, uint256[] memory _amounts) external onlyController {
