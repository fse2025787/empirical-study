...
contract ServeThePeopleInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Serve the People Inu";
    string private constant _symbol = "ServeInu";
