...
// File: contracts/liquidity-bridge/Util.sol
...
// File: contracts/liquidity-bridge/LiquidityBridgeERC.sol
...
contract LiquidityBridgeERC {
  ...
  function depositEth(string calldata cardanoAddress) external payable {
  ...
  function depositERC(address token, string calldata cardanoAddress) external payable {
    require(msg.value == feeAmount, "Invalid fee");
