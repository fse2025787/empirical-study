...
https://www.shitfuckinu.com
https://t.me/shitfuckinuerc20                                                
...
contract ShitFuckInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ShitFuck Inu";
    string private constant _symbol = "SFI";
    ...
    address payable private _developmentAddress = payable(0x6853A33fe99dfbF2b91597693091abad31C4Ae8F); 
    address payable private _marketingAddress = payable(0x6853A33fe99dfbF2b91597693091abad31C4Ae8F);
    ...
    uint256 public _maxTxAmount = 630000 * 10**9; 
    uint256 public _maxWalletSize = 630000 * 10**9; 
