...
// Snorlax is huge and magnificent. It’s the heaviest normal type in pokemon world. Snorlax wakes up only to eat and rest. Snorlax is docile enough to let children and small Pokémon bounce on its large stomach.
 
// This snorlax project is to encourage everyone in the world to become one of the Snorlax. Let’s just eat, sleep and rest meanwhile earning passive income with the force of crypto, web3 and all other blockchain technologies. 
 
// Snorlax is a deflationary and rewarding token, allow all holders to generate passive income while sleeping.
 
// Tokenomics:
// Tax: 6%
// Reflection: 3%
// Burn: 1%
// Team and Marketing: 2%

// https://snorlaxtoken.club/
// https://t.me/snorlaxeth
// https://twitter.com/Snorlaxtoken
...
contract SNORLAX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Snorlax";
    string private constant _symbol = "SNORLAX";
    ...
    address payable private _marketingAddress = payable(0x96ab142E3bf0a61aA3687276DEc3fd9d20736dD0);
