...
#LUNATICS - God of lunatics

1% Liquidity Fee / OWNERSHIP RENOUNCED

FROM A LUNATIC LUNA HOLDER
...
contract LUNATICS is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"LUNATICS"; ////
    string public constant symbol = unicode"LUNATICS"; ////
