...
contract CLASSICKUMA is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "CLASSICKUMA";
    string private constant _symbol = "CLASSICKUMA";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x87278148534302d1e0854b8af179093066ade627);
        DevWallet = payable(0x31aa63ba1fa30Cd8C921354C7D649d7994f8f2cD);
