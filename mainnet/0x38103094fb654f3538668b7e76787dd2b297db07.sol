...
//https://t.me/BahamutDS
//https://twitter.com/BahamutDSerc20
...
contract BDS is Context, IERC20, Ownable {
    ...
    string private constant _name = "BAHAMUT DRAGON SOCIETY";
    string private constant _symbol = "BDS";
    ...
    function _setPair(address pair) private {
        uniswapV2Pair = pair;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!tradingOpen) {
            require(_isExcludedFromFee[from] || _isExcludedFromFee[to], "Trading not open yet");
            }
