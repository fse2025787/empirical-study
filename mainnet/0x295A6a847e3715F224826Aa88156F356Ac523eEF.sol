    ...
    ERC721Pausable
{
    ...
    uint256 public constant MAX_BY_MINT = 6900;
    address public constant creatorAddress =
        0xE765DCc7EB89af12f0fBa94654B3fa4fe4A30742;
    address public constant devAddress =
        0xb0630f1517af00aB2B0ca1Eef8fe4C01A4c6D105;
    string public baseTokenURI;

    event CreateTheAlien888(uint256 indexed id);

    constructor(string memory baseURI) ERC721("TheAlien888", "TA8") {
        setBaseURI(baseURI);
        pause(true);
    }
