...
// File: contracts/azuki4people.sol
...
contract Azuki4People is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQFkLSQysj94s5GvTHPyzTxrawwtjgiiYS2TBLgrvw8CW";
    ...
    constructor(
    ) ERC721A("Azuki For People", "Azuki", 100, maxSupply) {
    }
