...
contract xMfersStakingContract is Ownable {
    ...
    constructor(address _nftAddress, address _rewardTokenAddress, uint256 _rewardTokenPerBlock) {
        require (_nftAddress != address(0), "NFT token can't be address (0)");
        require (_rewardTokenAddress != address(0), "Reward token can't be address (0)");
