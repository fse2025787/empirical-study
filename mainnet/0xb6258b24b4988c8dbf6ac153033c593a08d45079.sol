...
contract WAAU is Ownable, ERC721A {
    uint256 public maxSupply                    = 1501;
    uint256 public maxFreeSupply                = 1501;
    
    uint256 public maxPerTxDuringMint           = 10;
    uint256 public maxPerAddressDuringMint      = 101;
    uint256 public maxPerAddressDuringFreeMint  = 1;
    
    uint256 public price                        = 0.004 ether;
    bool    public saleIsActive                 = false;

    address constant internal TEAM_ADDRESS = 0x0b1f9E8Ef1C1Da1a90feE15f8859E79DA11745B2;
    ...
    constructor() ERC721A("We Are All Unemployed", "WAAU") {
