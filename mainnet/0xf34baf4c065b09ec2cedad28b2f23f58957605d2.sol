...
/**
    BIg Eyes ERC Token
    Telegram:  https://t.me/Bigeyeserc
    Twitter :  https://twitter.com/BigEyesToken
*/
...
contract BigEyes is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x98a2bCE58aea155129bdb86c6BdbDCF3BF200cEB); // Marketing Address
    address payable public multiSigAddress = payable(0x98a2bCE58aea155129bdb86c6BdbDCF3BF200cEB); // Marketing Address
    address payable public devAddress = payable(0x98a2bCE58aea155129bdb86c6BdbDCF3BF200cEB); // Dev Address
    address payable public liquidityAddress = payable(0x98a2bCE58aea155129bdb86c6BdbDCF3BF200cEB); // Liquidity Address
    ...
    string private constant _name = unicode"Big Eyes";
    string private constant _symbol = unicode"BIG👀";
