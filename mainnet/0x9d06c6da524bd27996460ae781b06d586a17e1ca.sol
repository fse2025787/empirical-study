...
/*    .                                                               .x+=:.   
  .x88888x.                                                          z`    ^%  
 :8**888888X.  :>               u.    u.                                .   <k 
 f    `888888x./       .u     [email protected] [email protected]      uL           u        [email protected]" 
'       `*88888~    ud8888.  ^"8888""8888"  .ue888Nc..    us888u.   [email protected]^%8888"  
 \.    .  `?)X.   :888'8888.   8888  888R  d88E`"888E` [email protected] "8888" x88:  `)8b. 
...
contract Jengas is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("https://jengas.io/nfts/jenga.json") {
        _mint(LockedAddress, 0, 10360, "");
        _mint(TradableAddress, 0, 1000, "");
		TotalSupply += 11360;
    }
	...
	receive() external payable {
		...
		require((Quantity + TotalSupply) <= MaxSupply, "unable to mint more, maxsupply reached");
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 withdrawalAmount = getBalance();
    ...
    function contractURI() public pure returns (string memory) {
        return "https://jengas.io/nfts/jnga.json";
    }
    ...
    {
        if(from == LockedAddress && block.timestamp < LockEndEpoch) {
            require(block.timestamp >= LockEndEpoch, "Tokens locked: block.timestamp is less than LockEndEpoch");
        }
