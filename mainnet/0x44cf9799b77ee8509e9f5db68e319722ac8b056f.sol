...
contract BitchGoblin is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6969;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmPuTKAz9hxQ4mizuMfkwBZ3mXCtfTXoSuGY2DcTNhP7LK/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("BitchGoblin", "BTG", MAX_MINTS, MAX_SUPPLY) {  
    }
