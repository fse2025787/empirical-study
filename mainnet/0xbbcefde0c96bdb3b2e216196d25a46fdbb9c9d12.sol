...
- Hey, Top G! Join hustlers university or be a brokey! 
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("TateBurn", "TateBurn") {
        ...
        devWallet = 0x4bbCbbCDE6f6337500db6eEb91cf29be5D9AcB23;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyBurnFee + buyDevFee;
        require(buyTotalFees <= 18, "Must keep fees at 20% or less");
    }
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellTotalFees <= 18, "Must keep fees at 25% or less");
    }
