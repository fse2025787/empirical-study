...
contract Treksters is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmeXDz1JHXq73jmkmLqLKgEPAEZjifddSNWJQUExb4zWTK/";
  ...
  constructor() ERC721("Treksters", "Trekster") {
