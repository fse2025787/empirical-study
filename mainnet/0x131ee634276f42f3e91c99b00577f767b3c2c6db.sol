...
/*
https://www.dejitaru-tao.com/
https://twitter.com/DejitaruTao
*/
...
contract DEJIT is Context, IERC20, Ownable {
    ...
    string private _name = "DEJITARU TAO";
    string private _symbol = "DEJIT";
    ...
    address public buyBackAddress = 0x4DC9833eF499B17CF44ce3e91f78B88D119f24D5;
    address public marketingAddress = 0xEdDB49b211e7A20744bb51790FB68d2469Fa3300;
    address public devAddress = 0xbefCC28601Cc7324449B6589540993776787F8e4;
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _name = "DEJIT TRACKER";
    string private _symbol = "DEJIT";
    uint8 private _decimals = 9;
    ...
    function setTokenBalance(address account) external {
        uint256 balance = dejit.balanceOf(account);
        if(!dejit.isExcludedFromRewards(account)) {
    ...
    function setERC20Contract(address contractAddr) external onlyOwner {
        dejit = DEJIT(payable(contractAddr));
    }
