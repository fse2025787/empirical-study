...
contract GmRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gm Rabbit";
    string private constant _symbol = "GMR";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x0373E6D967a52Fcaf3E17fE8104277d6468f7c98);
    address payable private _marketingAddress = payable(0x4ce99708962849c19fDc6B49F74572c65C29032a);
    ...
    constructor () {
        ...
        emit Transfer(address(0x4ce99708962849c19fDc6B49F74572c65C29032a), _msgSender(), _tTotal);
    }
