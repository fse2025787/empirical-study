...
// 
contract SHiELDAGE is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  string public MAX_NON_INCREASING_SUPPLY = '850';
  string public STARTING_MINT_PRICE = '0.005 ETH';
  string public MAX_MINT_PRICE = '0.1 ETH';
  string public Public_Auction_Live = 'True';
  ...
  function exhibitionMint(uint256 _mintAmount, address _receiver) public onlyOwner {
