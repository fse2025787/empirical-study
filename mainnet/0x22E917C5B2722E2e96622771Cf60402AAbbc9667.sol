...
contract TreeHouseRootUpgradeable is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, ERC721PausableUpgradeable, AccessControlMixinUpgradeable, NativeMetaTransactionUpgradeable, IMintableERC721, ContextMixinUpgradeable {

    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    function __TreeHouseRoot_init(
        string memory name_,
        string memory symbol_
    ) public initializer {
        __ERC721_init(name_, symbol_);
        __ERC721Pausable_init();
        _setupContractId("TreeHouseRootUpgradeable");
