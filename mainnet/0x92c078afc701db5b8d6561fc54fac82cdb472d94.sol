...
/* 
For The Dogs $FTD
Government of the Dogs, by the dogs, for the dogs, shall not perish from the coins
...
contract FTD is ERC20, Ownable {
    ...
    constructor() ERC20("For The Dogs", "FTD") {
        ...
        swapTokensAtAmount = totalSupply * 100 / 10000; // 0.1% swap wallet
