...
/**
/*
Wednesday Addams Fan Token 
For the dark and spooky among us!
https://t.me/wednesdayaddamseth
https://www.wednesdayfantoken.com/
https://www.twitter.com/wednesdayA_ETH
*/
// 
...
contract WEDNESDAYADDAMS is Context,IERC20, Ownable{
using Address for address;
string private _name = "WEDNESDAYADDAMS";
string private _symbol = "WEDNESDAY";
...
address _owner;
address payable public marketingAddress = payable(0x8432f1C8ae8A9F8a56E6164c37584d55cE28c844);
...
function COINDay() public onlyOwner{
    require(block.timestamp > WednesdayAddamsCOINDaycooldown, "You cant call WednesdayAddamsCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function WednesdayAddamsCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    WednesdayAddamsCOINDaycooldown = block.timestamp + 86400;
}
