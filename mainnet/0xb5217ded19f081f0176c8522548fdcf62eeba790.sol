...
contract MadMangaFOMOStone is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(address payable _owner) ERC721("MadMangaFOMOStone-TEST", "MMFS-TEST") {
        ...
        saleConfig.FOMO_total = 4200;//發行4200
        saleConfig.round_total = 1500;//每階段最多mint個數
        saleConfig.startTime = 1651314600;//2022-04-30 18:30
        saleConfig.endTime = 1651365000;//2022-05-01 08:30
