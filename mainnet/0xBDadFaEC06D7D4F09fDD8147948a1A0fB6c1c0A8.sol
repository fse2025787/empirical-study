...
// U | __")uU  /"\  u U /"___|U /"___| |"|   U |"|u| |U | __")u 
//  \|  _ \/ \/ _ \/  \| | u  \| | u U | | u  \| |\| | \|  _ \/ 
//   | |_) | / ___ \   | |/__  | |/__ \| |/__  | |_| |  | |_) | 
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x00D4C228fd3536a67145a78d6d69d6020c0B9A6F];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x00D4C228fd3536a67145a78d6d69d6020c0B9A6F;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih3pqohsu77fkiti7cmrhzbw3fhdaqya6x7fobin5cerpqns6bhp4/";
...
// File: contracts/BoredApeCircusClubContract.sol
//

pragma solidity ^0.8.0;

contract BoredApeCircusClubContract is RamppERC721A {
    constructor() RamppERC721A("Bored Ape Circus Club ", "BACClub"){}
}
