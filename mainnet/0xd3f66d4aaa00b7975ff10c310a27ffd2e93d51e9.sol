...
contract mintmoneymini is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public criteria1 = 100;
    uint256 public criteria2 = 100;
    ...
    uint256 public MaxgiveawayAmountperTx = 1;
    uint256 public giveawaylimit = 300;
...
function giveaway(uint256 _giveawayAmount)
    ...
    returns (string memory)
  {
    ...
    function setcriteria2(uint256 _criteria2) public onlyOwner {
