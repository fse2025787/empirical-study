...
contract SATOSHI is ERC20, Ownable {
    ...
    constructor() ERC20("Satoshi The Creator", "SATOSHI") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0x313Ddd48744fe085058645651a1e8213f1600000); // set as Marketing wallet
        DevWallet = address(0x313Ddd48744fe085058645651a1e8213f1600000); // set as dev wallet
    ...
    function WaiveOwnership(uint256 _Marketing, uint256 _liquidityFee, uint256 _DevFee) external onlyOwner {
