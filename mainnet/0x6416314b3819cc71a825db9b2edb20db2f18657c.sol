...
contract Avacadoez is ERC721A, Ownable, ReentrancyGuard {
  ...
  string private hiddenURI = "ipfs://QmTvKx87xe31PhYy18ZehVCAqh1cE6EMHNk4W3zeQPdBvV/hidden.json";

  uint256 public  maxSupply = 7777;
  uint256 public  Max_Guac_Per_Tx = 3;
  uint256 public  Free_Guac_Per_Tx = 1;
  uint256 public  Public_Guac_Price = 0.0069 ether;
  uint256 public  Toatl_Free_Guac = 3000;
      ...
      payable
  {
    ...
    if(totalSupply() + numberOfTokens > Toatl_Free_Guac || numberOfTokens > Free_Guac_Per_Tx){
        require(
