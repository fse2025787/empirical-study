...
contract ODOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Osaku Doge";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xadA2302be7112E6E12871440f8A84D0dF5581b93);
    ...
    function openTrading() external onlyOwner() {
        ...
        tradingOpen = true;
        _maxWalletAmount = _tTotal * 2 / 1000;
        _maxTxAmount = _tTotal * 2 / 1000;
