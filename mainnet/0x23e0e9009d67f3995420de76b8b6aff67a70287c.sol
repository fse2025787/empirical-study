...
// File: contracts/reward/SportReward.sol
...
contract SportReward is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    bool private initialized;

    address public _lp = address(0x0);
    address public _reward = address(0x0);
        ...
        nonReentrant
    {
        ...
        IERC20(_lp).safeTransferFrom(msg.sender, address(this), amount);
        ...
        nonReentrant
    {
        ...
        IERC20(_lp).safeTransfer( msg.sender, amount);
    ...
    modifier checkHalve() {
        if (block.timestamp >= _periodFinish) {
            ...
            // IERC20(_reward).mint(address(this), _initReward);
