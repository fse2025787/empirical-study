...
contract FIFAPE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "FIFA Ape";
    string private constant _symbol = "FIFAPE";
    ...
    address payable private _developmentAddress = payable(0x5fE21965b3E24CBFA74Db04fe4561beFD44045a9);
    address payable private _marketingAddress = payable(0x5fE21965b3E24CBFA74Db04fe4561beFD44045a9);
