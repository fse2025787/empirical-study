...
//** Funky Trend incoming, believe it or not
...
Tax: 4/4 all to LP because we are not poor to need for marketing.
There will be max wallet until 30k after that it will be removed.
3% supply for dev wallet which will be used for some reasons that you will see in advance.
Twitter: https://twitter.com/FunkyApeErc20
Telegram: https://t.me/funkyapeerc20
Website: https://www.funkyape.info
*/
...
contract FunkyApe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Funky Ape", "FAPE") {
    ...
    function FAPEMODE() external onlyOwner returns (bool){
