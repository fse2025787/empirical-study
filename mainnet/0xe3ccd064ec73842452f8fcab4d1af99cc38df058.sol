...
contract ELONSCUM is Context,IERC20, Ownable{
using Address for address;
string private _name = "ELONSCUM";
string private _symbol = "ELONSCUM";
...
address _owner;
address payable public marketingAddress = payable(0x44490bF6bfD3DA6F6EdE2e2d7Cfc231760bEACEe);
...
uint256 private buymktFee = 5;//5
uint256 private buyPrevmktFee = 5;
uint256 ELONSCUMCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > ELONSCUMCOINDaycooldown, "You cant call ELONSCUMCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function ELONSCUMCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    ELONSCUMCOINDaycooldown = block.timestamp + 86400;
}
