...
https://t.me/BoredInuErc

Lets not get bored anymore
*/
...
contract BoredInu is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "BoredInu";
    string private constant tokenSymbol = "BORED";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xEbE539697194740dB720eB319D033Ec3276E9d89);
        devAddress = payable(0xEbE539697194740dB720eB319D033Ec3276E9d89);
