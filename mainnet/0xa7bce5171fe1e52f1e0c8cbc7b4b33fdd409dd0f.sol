...
contract FUNDSNOTSAFU is Context, IERC20, Ownable {

    using SafeMath for uint256;
    //naming
    string private constant _name = "FUNDS NOT SAFU";
    string private constant _symbol = "GG FTX";
    ...
    address payable private _developmentAddress = payable(0xBbdBC9deb7E9b46F668aAa963Ac84eeAE222cdA5);
    address payable private _marketingAddress = payable(0xBbdBC9deb7E9b46F668aAa963Ac84eeAE222cdA5);
    ...
    bool private swappingEnable = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (canSwap && !inSwap && from != uniswapV2Pair && swappingEnable && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
