...
// $EverKong
// Telegram: https://t.me/EverKongToken
// With thanks and major props to the EverTop team!
// Check them out at evertop.finance!
...
/**
 * KONG NEVER BOWS DOWN TO ANYONE!
 * 
 *                 ."`".
 *             .-./ _=_ \.-.
 *            {  (,(oYo),) }}
...
contract EverKong is Context, IERC20, Ownable {
    ...
    string private constant _name = "EverKong";
    string private constant _symbol = unicode'EverKong 🦍';
