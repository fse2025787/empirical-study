 ...
 * allowances. See {IERC20-approve}.
 */
contract Dodgeball is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Dodgeball Inu";
    string private _symbol = "Dodgeball";
    ...
    address public marketingWallet = 0x2401d582F401F6f75E524BE73A0E6D06300B3ab6;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 35000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 25000 * 10**_decimals;
