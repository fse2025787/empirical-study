...
contract TrumpOnTwitter is ERC20, Ownable {
    ...
    constructor() ERC20("TrumpOnTwitter", "TOT") {
        ...
        devWallet = address(0x50f1aC1d7B8511871354a8e874902d9a0BA5DD30); // set as dev wallet
