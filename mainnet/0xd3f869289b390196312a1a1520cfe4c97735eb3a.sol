...
contract KekKoin is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "KekKoin";
    ...
    uint256 public _maxTxAmount = (_totalSupply * 1) / 80; //1.25%
    uint256 public _maxWalletSize = (_totalSupply * 1) / 40; //2.5%
