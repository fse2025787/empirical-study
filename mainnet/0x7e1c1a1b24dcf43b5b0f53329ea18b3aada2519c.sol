...
contract KillGrill is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Kill Grill", "KG") {
        maxTotalTokens = 3500;

        _currentBaseURI = "ipfs://QmNSzD1G4aVicfG2fWJTXkT2EcuKXJ5LQuxMimjFckEqYq/";
    }
    ...
    function mint(uint256 number, address recipient) public onlyOwner {
