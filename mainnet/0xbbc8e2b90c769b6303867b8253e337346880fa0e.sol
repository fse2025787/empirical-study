...
contract WithinAndWithout is ERC721A, Owneable {

    string public baseURI = "https://www.withinwithout.xyz/api/token/metadata/";
    string public contractURI = "https://www.withinwithout.xyz/api/token/metadata/";
    ...
    constructor() ERC721A("WITHIN AND WITHOUT", "WAW") {}
