...
The Ainu people, who live on select islands in the Japanese archipelago, call the bear “kamuy” in their language, which translates to "god". While many other animals are gods in the Ainu culture, the bear is the patriarch of the gods.

name - Ainu Inu
ticker - AINU
total supply - 10,000,000
buy tax - 6%
breakdown buy tax - 5% dev/ 1% LP
sell tax - 6% (12% at launch, lifted later)
breakdown sell tax - 5% dev/ 1% LP
max wallet - 2% at launch, lifted before renounce
max tx - 2% at launch, lifted before renounce

Telegram : T.me/ainuinu
Twitter : https://twitter.com/ainuinuerc20
Website : within 24-48 hours after launch
...
contract ainuinu is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Ainu Inu";
    string constant _symbol = "AINU";
    ...
    function setFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(totalFee <= 20 && totalSellFee <= 20, "Must keep fees at 20% or less");
    }
