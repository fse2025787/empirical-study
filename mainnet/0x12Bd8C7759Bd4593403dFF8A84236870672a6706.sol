...
/**
                  _-_=-=-->>=--"~-~--=<=->.
               ,,[email protected]@im_                  'c   _gmmmm.
             ,v\[email protected]@@@@@mA,[email protected]                 GA*~`    `
            v`[email protected]@@@@@@[email protected]@A               ,Zft
          ,([email protected]@@@@@@@@[email protected]_.             -f  'c   gZ***i
        ,[email protected]@@@@[email protected]@@@f`,@@@@`                   \eA~
       [email protected]@@@@@[email protected]@A  [email protected]@@@`                      '=__.
     ,[email protected]@@@@@[email protected]@@@[email protected]@@@tg                          '~\=c_.
    [email protected]@@@@@@@@@@[email protected]@@@@@@[email protected]              _.              '~~=c.
   ,[email protected]@@@@@@@@@@f,@@@@@@@@@@[            ,[email protected]@                   '~=c.
   @@@@@@@@@@A\[email protected]@@@@@@[email protected]@@ i          ,[email protected]@P    gm.                 '\c.
  @@@@@@@@@@@@@@@@@@@@@@ @@[]           [email protected]@f    [email protected]@[                   'c
 [email protected]@@@@@@@@@@@@@@@@@@@@\[email protected]`/           V*`    [email protected]@A                      \.
 @@@@@@@@@@@@@@@@@@@@@@@`,!/                 ]@@f                          \
{@@@@@@@@@@@@@@@@@@@@@@@@!/                   ~`                            )
{@@@@@@@@@@@@@@@@@@@@@@f /                                                  ]
{@@@@@@@@@@@@@@@@@@@@A`,/                                                   [
...
contract SnoopyInu is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Snoopy", "SNOOPY") {
        ...
        maxTransactionAmount = 11500000 * 1e18;
        ...
        marketingWallet = address(0xE2262Da3c5b0a12736c0281be890a8Fa1c347AbF);
