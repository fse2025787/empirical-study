...
- Born as a mutant having two elements. 90% water power and 10% burn power. His right arm is flaming while the rest are composition of water elements. 

HYDRO means water
Water is a liquid
Liquid is in the word of LIQUIDITY
...
TOKEN NAME: HydroMatic
TICKER: HYDRO
SUPPLY 1M
MAX WALLET 1% AT LAUNCH
MAX LIFT 5%

We will be 100/100 token sniffer for noobs happiness. 

All auto liquidity will be burnt forever. 

Our initial liquidity will just be locked.

Twitter Account: https://twitter.com/hydronomicserc
***Official Webiste and TG is posted in our twitter account***
*/
...
contract HydroMaticSmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "HydroMatic";
    string private constant _symbol = "HYDRO";
    ...
    uint256 public sellAutoLiquidityFee = 300;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x3cBEf2f7854e6eBFEE03b34C7EBBeCA965c2f21F); 
