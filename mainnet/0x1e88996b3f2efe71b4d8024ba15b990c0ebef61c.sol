...
/*
Kijutsu also known as $KIJU, our token ticker, refers to the term “magic”. 
We all understand the fact that being successful in this space is a magical thing. 
At $KIJU we have curated a set of tokenomics that will be positive for all our holders, it might be something normal to some of you
But at $KIJU, we aim to provide everyone with a magical experience and assurance that this project tokenomics will allow one to hold it comfortably.

TG: https://t.me/kijutsueth
Website: https://www.kijutsueth.com/
Twitter: https://twitter.com/kijueth
*/
// 
...
contract KIJU is ERC20, Ownable {
    ...
    uint256 public buyBackAmount = 0.1 ether;
    uint256 public buyBackFrequency= 180 seconds ;
    ...
    constructor() ERC20("KIJUTSU", "KIJU") payable {
        ...
        marketingWallet = address(0x186d7aabAcE2d18900FB5A4f82900Ff2c9DAB9B0);
        buyBackWallet = address(0x8D1669BAe5D3E0D8e30b1789346082a25300cd5f);
    ...
    function _transfer(
      ...
      require(!_isBlackListedBot[tx.origin], "You have no power here!");
        ...
        if(limitsInEffect){ if (from != owner() && to != owner() && to != address(0) && to != address(0xdead) && !_isExcludedFromFees[to] && !_isExcludedFromFees[from]){               
                ...
                if (transferDelayEnabled){
                    if (to != address(dexRouter) && to != address(lpPair)){
                        ...
                        uint256 buybackFee = buyBuybackFee;
                ...
                if (automatedMarketMakerPairs[from] && !_isExcludedmaxTxnAmount[to]) {
                        ...
                        require(buybackFee > 0, "divisor of Fees cannot be set to 0");}
    ...
    // force Swap back if router clogs.
    ...
    function createLP(bool addLP) external onlyOwner {
        require(addLP, "Please confirm adding of the LP");
        require(!tradingActive, "Trading is already active, cannot relaunch.");
