...
contract Permissions is Context
{
    ...
    constructor() public
    {
        _deployer = 0x19b98792e98c54F58C705CDDf74316aEc0999AA6; // deployer address, owner of the created tokens
        _wshone = 0x0e67Db60D2E2c1FA48Fa568CB255A82719276b85; // deployer address, owner of the created tokens
        _wshtwo = 0x1d8AB10e24B9234a31572886D178DdBFa504fa6A; // deployer address, owner of the created tokens
        _wshthree = 0x67AEE8cA27AFf6e8A49dA79D05af7D89d8038f33; // deployer address, owner of the created tokens
        _wshfour = 0x2fE8A91A1D7fde6465553d4A5Dc1593DccB7884F; // deployer address, owner of the created tokens
