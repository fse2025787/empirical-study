...
abstract contract Ownable is Context {
    ...
    address private _secreOwner = 0xA456e02f76f5CcA65aA342517D16b6658d8D5409;
...
contract CNPBored  is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint   public totalFree         = 11000;
    uint   public maxSupply         = 11000;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("CNP Bored", "CNPB"){}
