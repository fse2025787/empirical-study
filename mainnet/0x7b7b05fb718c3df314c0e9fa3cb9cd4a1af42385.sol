...
/**
  ...
  ___  __    ____  __  __  ___      ___  ____   ____  __ 
 // \\ ||    || \\ ||  || // \\    // \\ || \\ ||    (( \
 ||=|| ||    ||_// ||==|| ||=||    ||=|| ||_// ||==   \\ 
 || || ||__| ||    ||  || || ||    || || ||    ||___ \_))
...
contract AlphaApes is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Alpha Apes";
    ...
    address payable private _taxAddress = payable(0x16646b2d6d175cb0501566ab750Deb9426550018);
