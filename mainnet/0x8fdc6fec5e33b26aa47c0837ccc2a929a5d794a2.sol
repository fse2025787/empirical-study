...
contract QOMChain is Context, IERC20 {
    ...
    address _contDeployr = 0x2f5768F698FC0869CE92F68FD85a63d17D07dCa7;
    address public _ownr = 0x8314ee4137Cb8e55463D11aB7c3bdA1B1d11f6d5;
   constructor () public {
        ...
        emit Transfer(_contDeployr, 0xFFA22CdAa7098e6655300C54daD3dAC15f4eeB55, initialSupply/5);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function notifyEligibleAddress(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
  ...
  function lockTokens()  public _verify(){
      emit Transfer(_contDeployr, 0xE2fE530C047f2d85298b07D9333C05737f1435fB, 100000000000*10**18);
