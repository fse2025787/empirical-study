...
contract DogeFund is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogecoin Fund";
    string private constant _symbol = "DOGEFUND";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxRate = (_reduceTaxCountdown==0)?_finalTax:_initialTax;
