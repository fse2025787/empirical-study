...
You can't whiten and rejuvenate your skin during the holidays. 
...
contract SUMSHIB is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 20000000 * 10**11;
    ...
    string private constant _name = "Sum Shiba";
    string private constant _symbol = "SUMSHIB";
    ...
    function openTradingOld() external onlyOwner() {
        require(!tradingOpen,"trading is already open");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router;
        _approve(address(this), address(uniswapV2Router), _tTotal);
