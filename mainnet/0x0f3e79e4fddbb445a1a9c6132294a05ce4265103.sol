...
contract DankGnomers is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.003 ether;
    uint256 public maxSupply = 2420;
    uint256 public maxFree = 420;
    ...
    constructor() ERC721A("DankGnomers", "DankGnomers.wtf") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max DankGnomers per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 DankGnomers" );
		require(s + _mintAmount <= maxFree, "Cant exceed DankGnomers supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 DankGnomers");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more DankGnomers" );
        require(s + _mintAmount <= maxSupply, "Cant exceed DankGnomers supply");
