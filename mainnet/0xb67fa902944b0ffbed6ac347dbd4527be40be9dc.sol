...
contract moonfrens is Ownable, ERC721A, ReentrancyGuard {
    ...
    string public notRevealedUri = "ipfs://QmRxjkiMnzhDSC157y417h21Jf6hMRF3hyo95PLStbVJPh/";
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        if(numberMinted(msg.sender) >= 2){
            require(msg.value >= price * quantity, "INVALID_ETH");
        }else if(numberMinted(msg.sender) + quantity < 3){
             require(msg.value == 0, "INVALID_ETH");
        }else{
            require(msg.value == price * ( quantity - 2), "INVALID_ETH");
        }
