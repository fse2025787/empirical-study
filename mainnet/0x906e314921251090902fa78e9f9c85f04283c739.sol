...
contract Kirawaka is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KIRAWAKA", "WAKO") {
    ...
    ; uint256 totalSupply = 777 * 10**6 * 10**9;
