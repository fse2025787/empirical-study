...
KINTAMA token is an erc20 token 
Supply 1000000000
Decimal 18
Max tx 2%
...
contract KINTAMA is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("KINTAMA", "KINTAMA") { // 
        marketingWallet = payable(0x6662ff1f73048cB89687d8B6A248CB64a198eD4A); // 
        devWallet = payable(0x6662ff1f73048cB89687d8B6A248CB64a198eD4A); // 
