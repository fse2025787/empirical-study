...
contract MediaVerseAdvancedGallery is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Media Verse Advanced Gallery", "MED") {
        cardSpecs[Level.TeamCard] = CardSpec(20, 1);
        cardSpecs[Level.NCard] = CardSpec(1350, 21);
    }
