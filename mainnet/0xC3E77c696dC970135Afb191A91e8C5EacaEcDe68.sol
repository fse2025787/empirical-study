...
| __  |   __|   __|  |  |   __|     |_   _|     |     |   | |   __|
|    -|   __|   __|  |__|   __|   --| | | |-   -|  |  | | | |__   |
|__|__|_____|__|  |_____|_____|_____| |_| |_____|_____|_|___|_____|
333 WL at .01 E Max 2
444 Public at .03 E Max 5
*/
...
// File: undead-ape-yacht-club.sol
...
contract ReflectionAbstraction is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    uint64 public publicMaxSupply = 777;
    uint64 public publicTotalSupply = 0;
    uint64 public presaleMaxSupply = 333;
    uint64 public presaleTotalSupply = 0;

    uint64 public maxMintAmountPerPresaleAccount = 2;
    uint64 public maxMintAmountPerPublicAccount = 5;

    bool public presaleActive = false;
    bool public publicSaleActive = false;

    constructor() ERC721A("Reflection by anon", "REFLECT"){}
