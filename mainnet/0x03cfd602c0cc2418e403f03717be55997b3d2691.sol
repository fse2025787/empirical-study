...
contract TheReturn is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "The Return";
    ...
    address payable public liquidityFeeReceiver = payable(0x8FD2Bc5F825570B1070198A8BBf69bd604CD15f1);
    address payable public marketingFeeReceiver = payable(0x8FD2Bc5F825570B1070198A8BBf69bd604CD15f1);
