...
Throughout history, people's attitude toward minerals has been somewhat mixed. Some stones were believed to be sacred, the others were considered cursed.

Ancient Mexicans were making mirrors from the ideally polished facets of pyrite. According to their beliefs, those mirrors were able to show the future and fulfill their wishes.
Power is in it.

https://t.me/TheFoolsGold                             
...
contract PYRITE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Fool’s Gold";
    string private constant _symbol = unicode"PYRITE";
