...
/*
Zinja NFT Collection
https://t.me/ZINJA_ETH
https://twitter.com/Zinja_ETH
*/
...
contract ZinjaNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address payable dev;
    address payable project = payable(0xB07B3d85aac55034e90bAAD28b2C1AE622517749);
    uint256 devFee = 10;
    
    uint256 public mintingLimit = 112;
    uint256 public price = 2 * 10**17;
    uint256 public whitelistPrice = 2 * 10**17;
    mapping(address => bool) feeWhitelist;
    mapping(address => bool) public whitelist;
    bool public whitelistEnabled = true;
    uint256 public maxMint = 1;
    string baseURI = "ipfs://QmaE8yTNZAWkyjc9xGVkwYX2Dxj1xRDdrJrHDdfFBB856d/";
    string placeholderURI;
    uint256 public revealedTo = 112;
    string constant baseExtension = ".json";

    constructor(address _dev) ERC721("Zinja NFT", "Zinja NFT") {
        dev = payable(_dev);
    }
    ...
    function setFeeWhitelistPrice(uint256 _price) external onlyOwner {
   ...
   function mint(uint256 amount) external payable whenNotPaused {
        require(amount <= maxMint && amount > 0 && balanceOf(msg.sender) < maxMint, "Minting limits exceeded");
        if(whitelistEnabled) require(whitelist[msg.sender], "Sorry, whitelist minting only");
