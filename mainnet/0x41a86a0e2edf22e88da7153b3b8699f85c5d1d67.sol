...
It's Sunday y'all
And we've got one more day before the start of the new week!

Let's rock and roll
and get some good times going
On this fine Sunday Funday
...
contract GSV is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Good Sunday Vibes", "GSV") {
        ...
        uint256 totalSupply = 7000000 * 1e18;

        maxTransactionAmount = 70000 * 1e18;
        maxWallet = 140000 * 1e18;
        ...
        marketingWallet = address(0x4dF51187EA4Be93B85BE808e2801051973D8d4ca);
