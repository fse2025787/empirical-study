...
// 
/*
tax 6% (2% marketing 4% real burn)

Liquidity will be locked immediately after launch

web http://www.mrburns.org/

tg https://t.me/MrBurnsToken
...
contract MRBURN is ERC20, Ownable {
    using SafeMath for uint256;
 
    mapping (address => uint256) private _rOwned;
    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 1 * 1e6 * 1e6;
    ...
    constructor() ERC20("Mr Burns", "MRBURNS") {
        ...
        Treasury = 0x7ccaF98654D7fD3ff49Bf8e1571bfB0E4F90C4b6;
