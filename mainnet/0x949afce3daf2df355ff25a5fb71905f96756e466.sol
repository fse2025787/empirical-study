...
contract GenesisSkullWalkers is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmXLjmLbUbijrPfu9Mmk5UqwzBb3CnU6VJLxFYC2HUMTQg";
  uint256  public  maxSupply = 4040;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.004 ether;
  uint256 public  NUM_FREE_MINTS = 4040;
  ...
  ) ERC721A("Genesis Skull Walkers", "GSW") {
