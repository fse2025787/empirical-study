...
contract Rookiez is Ownable, ERC721A {
  ...
  constructor() ERC721A("Rookiez", "RKZ")  {
    setHiddenMetadataUri("ipfs://QmboDCzQTXRR42sN4of1VKkFSSJDuRhVXUMejBe3JNYBLv/");
  }
  ...
  function mintWhiteList(uint256 _mintAmount, bytes32[] memory _merkleProof) public payable mintCompliance(_mintAmount) {
    require(onlyWhitelisted, "The presale ended!");
