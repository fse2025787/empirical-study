...
contract KINTSUGI is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Bloom of Seasons";
    string private constant tokenSymbol = "KINTSUGI";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x6A7AA3F6A9FBebdf03b94cFfa08C5109EEDA24d9);
        devAddress = payable(0x6A7AA3F6A9FBebdf03b94cFfa08C5109EEDA24d9);
