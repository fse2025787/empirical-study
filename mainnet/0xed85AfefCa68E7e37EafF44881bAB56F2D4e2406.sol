...
// The perfect token is out, the combination of the two most hyped token of the day
// FLUFFY + CLIFFORD
...
// web: fluffyclifford.com

// ~ THE NEXY MOONSHOT, DON'T MISS IT ~
...
contract FluffyClifford is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0x3AD3d779A35fAf92A262403213cAE42BfBC868c9);
    ...
    string private _name = "FluffyClifford";
    string private _symbol = "$FC";
