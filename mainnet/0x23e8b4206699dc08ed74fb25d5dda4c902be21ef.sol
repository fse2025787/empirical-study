...
/**
    AI Metaverse ERC20 Token

    https://t.me/AIMetaverseERC
...
contract AIMeta is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0xfa2E703DD743af8D973088629d8d267eb0155feF); // Dev Address
    address payable public liquidityAddress = payable(0xfa2E703DD743af8D973088629d8d267eb0155feF); // Liquidity Address
    ...
    string private constant _name = unicode"AI Metaverse";
    string private constant _symbol = unicode"AIMETA";
