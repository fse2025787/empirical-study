...
// File: contracts/pondfriends.sol
...
contract POND_FRENS is ERC721A, IERC2981, Ownable  {
    ...
    constructor() ERC721A("Pond Frens", "PFRENS") IERC2981() {
        _mint(0x6283E53de1da3C7bAf0Cc64fb4CD5fBd64C42808, 10);
        _mint(0xce20A87DD581539782126E43b35Ce66D6eEdb1A2, 10);
        _mint(0x8f2d2B92cB7917C9354ecF3983b13Bd0550441bB, 10);
    }

    function fm() private {
        mintedFreeWallets[msg.sender]++;
        _mint(msg.sender, 1);
        freeSupply += 1;
    }   
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/QmaVnyDB18jhT3Nv4Kzqtge42d8dxzbB3744HquTH3r5in/";
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual override(IERC2981) returns (address, uint256) {
        _tokenId; // Go Away Compiler Error
