...
contract Auction is IAuction, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function resolveAuction(address pool, bool resolution) external onlyOwner {
        require(block.timestamp >= auctionInfo[pool].end, "ANF");
        require(auctionInfo[pool].lastBidder != address(0), "NAE");
        ...
        if (resolution) {
            ...
            // In case of rejection, distribute remaining cash between lenders and refund bid
