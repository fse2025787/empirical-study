...
contract ERC721PackedStruct is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function hasAlreadyMinted(address owner) public view returns (bool) {
        require(owner != address(0), "ERC721: mint status query for the zero address");
        return _balances[owner].minted;
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721PackedStruct.ownerOf(tokenId);
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        Account storage account = _balances[to];
        account.minted = true;
        account.balance += 1;
    ...
    function _transfer(
        ...
        require(ERC721PackedStruct.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721PackedStruct.ownerOf(tokenId), to, tokenId);
    }
