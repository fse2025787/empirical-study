...
//*********************************************************************//
//
//    _____ __  ________________ __  ______ _       __
//   / ___// / / <  /_  __/ ___// / / / __ \ |     / /
//   \__ \/ /_/ // / / /  \__ \/ /_/ / / / / | /| / / 
//  ___/ / __  // / / /  ___/ / __  / /_/ /| |/ |/ /  
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xE064d8D1516B9507619B989beE6F4425F279E303];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xE064d8D1516B9507619B989beE6F4425F279E303;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.018 ether;
  uint256 public earlyMintTokenIdCap = 555;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXfLhzYs2LP1GC7vKuB3ysbGD9DvzxMJN3Qiin32uhUnQ/";
...
// File: contracts/Sh1TshowContract.sol
//

pragma solidity ^0.8.0;

contract Sh1TshowContract is RamppERC721A {
    constructor() RamppERC721A("SH1TSHOW", "S1S"){}
}
