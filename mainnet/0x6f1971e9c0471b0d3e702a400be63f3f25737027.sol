...
/**
 * MR BURNS - NUCLEAR BURNS ON ETHEREUM!
 * 
...
contract MRBURNS is ERC20, Ownable {
    ...
    constructor() ERC20("@MrBurnsToken", "MRBURNS") {
    	...
    	marketingWallet = address(0xCe1e611D969D3Cc944bbfB775E5C3cD2a323d896); // set as marketing wallet
    	devWallet = address(0x0933074c49D9eFDe356Cb5E6D0ed68DA4a48302e); // set as dev wallet
