...
contract AInalBot is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AInal";
    string private constant _symbol = unicode"ANAL";
