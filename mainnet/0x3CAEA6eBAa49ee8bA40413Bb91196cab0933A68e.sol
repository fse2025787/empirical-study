...
/**
    ...
    https://twitter.com/NotMoonBears

 * @title NotMoonBears contract
...
contract NMB is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Not Moonbears", "NMB"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Monkeys");
    require(mintEnabled, "Minting is not live yet, hold on Monkey.");
    require(numberMinted(msg.sender) + amt <= maxPerWallet,"Too many Monkeys per wallet!");
