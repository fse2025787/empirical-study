...
// BLOCKCHAIN420 Token contract based on the full ERC 20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Symbol: TLCC
// Status: ERC20 Verified

contract BLOCKCHAIN420Token { 
...
/**
 * BLOCKCHAIN420 Token Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract TlccStandardToken is BLOCKCHAIN420Token, Ownable {
    
    using TLCMaths for uint256;
...
contract BLOCKCHAIN420 is TlccStandardToken {
    ...
    */
    ...
    uint256 public totalSupply = 4200000000 * 10**8 ; 
    string constant public name = "The Love Care Coin"; //fancy name: eg BLOCKCHAIN420
