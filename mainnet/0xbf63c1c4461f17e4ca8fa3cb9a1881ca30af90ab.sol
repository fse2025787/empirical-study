...
contract MiniWCI is Context, IERC20 {
    ...
    string private _name = "Mini WCI";
    string private _symbol = "MWCI";
//==========================
    // FEES
    struct taxes {
    uint buyFee;
...
//==========================
    ...
    address payable public _DeveloperWallet = payable(0x477fDD0C1D9C7870Bf8292df6d89227621fEedC4);
    address payable public _developerWallet = payable(0x477fDD0C1D9C7870Bf8292df6d89227621fEedC4);
