...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xFb3808F85BAb21cbbE9827Dc5227D41336929B1b,0xa98C84779Ad7aFb5a7996e56A85FA5C239201FEc];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 15, 9999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUV3x8HZhXhzzPkDyxJ4fEMyM2mTm8jreTRDCKjBfrsSw/";
...
// File: contracts/grafittiBearsContract.sol
//

pragma solidity ^0.8.0;

contract GrafittiBearsContract is RamppERC721A {
    constructor() RamppERC721A("Grafitti Bears", "BEARS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/bH5WHba0p21dz1blyjV4/contract-metadata";
    }
}