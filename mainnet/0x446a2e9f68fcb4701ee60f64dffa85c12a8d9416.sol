...
contract PrincessPeachToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PrincessPeachToken", "PEACH") {
    	...
    	marketingWallet = address(0x54528f22729AE990984A6Eb25C387107CDA44Af9); // set as marketing wallet
    	devWallet = address(0x99C3D53A67c63788a01ee0FFf043af614e674bF9); // set as dev wallet
