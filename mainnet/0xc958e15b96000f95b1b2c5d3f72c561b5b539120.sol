...
contract Jovial is IERC721A { 
    ...
    uint256 public MAX_FREE = 2600;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Jovial";
    string private constant _symbol = "JOVIAL";
    string private constant _contractURI = "Qmdh6chW3FqGfHAfXfa1Nq61YMB5zbcA47AnDu2w2oRAMN";
    string private _baseURI = "QmSPdKg6torfjFS7CWqo7HxAichRkWxmaURc9Z1S75NQUq";
    ...
    function setMintData(uint256 _MAX_FREE, uint _COST) external onlyOwner{
        MAX_FREE = _MAX_FREE;
        COST = _COST;
    }
