...
contract crAPEtobysifu is ERC721A, DefaultOperatorFilterer, Ownable {

    mapping (address => bool) public minterAddress;
    string public baseURI = "ipfs://bafybeiegxse7daxkwdb7vulmmkq3pon72chd3olueeoniqbhffwyg4zwjq/";  
    ...
    constructor () ERC721A("crAPEto by sifu", "crAPEto") {
    }
    ...
    function reserves(uint256 numberOfTokens) external onlyOwner {
