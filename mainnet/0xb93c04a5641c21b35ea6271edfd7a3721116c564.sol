...
// File: contracts/CryptoHansW.sol
...
contract CryptoHans is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 0 ether;  //цена за минт 1 нфт
  uint256 public maxSupply = 7777; // количество нфт в вашей коллекции
  uint256 public maxMintAmount = 7; //количество нфт которое будет сминчено при деплое смарт контракта
