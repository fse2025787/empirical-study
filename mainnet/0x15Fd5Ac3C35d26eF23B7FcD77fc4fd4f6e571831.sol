...
contract PUDEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Puden Token", "PUDEN") {
        ...
        marketingWallet = address(0xb5BE13d2e2eAB1b6d4DA21ecd45eD9bED490b9e2); // set as marketing wallet
        developmentWallet = address(0xb5BE13d2e2eAB1b6d4DA21ecd45eD9bED490b9e2); // set as development wallet
