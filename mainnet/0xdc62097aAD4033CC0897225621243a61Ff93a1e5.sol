...
// Part: OpenZeppelin/[email protected]/ERC721Pausable
...
// Part: OpenZeppelin/[email protected]/ERC721PresetMinterPauserAutoId
...
// File: PigsAndPencils.sol

contract PigsAndPencils is ERC721PresetMinterPauserAutoId, Ownable {

    uint256 private _cap;

    constructor(string memory name, string memory symbol, string memory baseUrl, uint256 cap) ERC721PresetMinterPauserAutoId(name, symbol, baseUrl) public {
        require(cap > 0, "Max supply cap must be greater than 0");
        _cap = cap;
    }

    function mint(address to) public override {
        require(totalSupply() < _cap, "Max supply cap reached");
        super.mint(to);
    }
}