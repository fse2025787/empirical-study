...
Introducing DexSpy, the  tool that will revolutionize the crypto trading landscape by providing unparalleled transparency and insight into #Defi.
Uncover the Truth, Trade with Confidence:

https://twitter.com/DexSpyDeFi
...
contract DexSpy  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dex Spy";
    string private constant _symbol = "SPY";
