...
contract Euphorai is ERC721Enumerable, Ownable {
    ...
    address private core1Address;
    uint256 private core1Shares;
    
    address private core2Address;
    uint256 private core2Shares;
    
    address private core3Address;
    ...
    modifier onlyOwnerOrTeam() {
        require(
            core1Address == msg.sender || core2Address == msg.sender || 
            core3Address == msg.sender || teamAddress == msg.sender || owner() == msg.sender,
    ...
    function setPrice(uint256 newPrice) external onlyOwnerOrTeam {
        price = newPrice;
    }

    function setBuyLimit(uint256 newBuyLimit) external onlyOwnerOrTeam {
    ...
    function _splitAll(uint256 _amount) private {
        ...
        _withdraw(teamAddress, singleShare * teamShares);
    }
