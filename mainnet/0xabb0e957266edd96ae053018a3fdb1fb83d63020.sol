...
contract TheMusks is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUSqvW2fWD3fDZLMqxu3d9abGeQSn1qc7kiE69R9Y9c5z";
    ...
    constructor(
    ) ERC721A("The Musks", "MUSKS", 100, maxSupply) {
    }
