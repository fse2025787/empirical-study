...
contract RUN is Context, IERC20, Ownable {
    ...
    address public marketing = 0x94c80eEe836A4d1279e689009ae0800974aF9454;
    ...
    constructor () {
        ...
        _transfer(_msgSender(), address(0), 1500000000 * 10**6 * 10**18);
