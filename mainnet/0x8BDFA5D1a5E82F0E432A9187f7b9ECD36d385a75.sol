...
/*
The Merge
As we merge, we do so for the greater of defi. In the eyes of our DefiFathers, our deeds will not go unnoticed. The Merge is upon us. 
Forever burnt is our liquid, a team of none watch. Renounced is the code, forever locked. Till the end you gain rewards given in rhythm. 
Long Live Defi 
...
contract TheMerge is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 2 / 100000; // 0.005% swap wallet
    uint256 public tax = 2;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address private alpha; //account 5 test wallet
