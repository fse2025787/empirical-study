...
contract TeraKey is MintableToken {
  string public constant name = "Terraforming Mars Key"; // solium-disable-line uppercase
  string public constant symbol = "TERAKEY"; // solium-disable-line uppercase
