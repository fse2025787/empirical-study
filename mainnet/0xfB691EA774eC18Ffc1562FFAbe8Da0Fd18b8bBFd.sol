...
╚═════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚══╝░░░░░░╚══════╝░╚════╝░╚═╝░░╚══╝░╚═════╝░
    ...
    I make #SHENLONG to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/Shenlongcommunity

   Great features:

   I will burn liquidity LPs to lock the pool forever.
   I will renounce the ownership to transfer #SHENLONG to the community, make sure it's 100% safe.
   I will release a medium article about this project via etherscan, as soon as #SHENLONG got 100 Holders.

   I will add 2.69 ETH and 100% of the supply to the pool.
   Can you make #SHENLONG 10000000X? 
...
contract SHENLONG is ERC20, Ownable {
    ...
    constructor() ERC20 ("SHENLONG", "SHENLONG") {
        ...
        marketingWallet = payable(0xe046db2EB709Ca8602b139cae36D454eE4F75e22);
        devWallet = payable(0xe046db2EB709Ca8602b139cae36D454eE4F75e22);
