...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0xa11C43E1022bad9937ed03D1E35caf9b147CEe37 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
...
contract Sakura is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("Sakura", "SKA") {
