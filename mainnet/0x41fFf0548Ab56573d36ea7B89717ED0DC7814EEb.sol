...
/*
           ...
           88                                  88
           88                                  88
 ,adPPYba, 88  ,adPPYba,  88       88  ,adPPYb,88
a8"     "" 88 a8"     "8a 88       88 a8"    `Y88
8b         88 8b       d8 88       88 8b       88
"8a,   ,aa 88 "8a,   ,a8" "8a,   ,a88 "8a,   ,d88
 `"Ybbd8"' 88  `"YbbdP"'   `"YbbdP'Y8  `"8bbdP"Y8
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _internalRemoveLimit(address _addr) internal {
...
contract Cloud is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CLOUD", _symbol) {
        ...
        uint256 totalSupply = 333_333_333 * 1e18; 
        
        maxTransactionAmount = ~uint256(0); // no max tx limit
        maxWallet = ~uint256(0); // no max wallet limit
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 2 / 1000)/1e18, "Cannot set maxWallet lower than 0.5%");
    ...
    function updateTaxAddress(address newWallet) external onlyOwner {
