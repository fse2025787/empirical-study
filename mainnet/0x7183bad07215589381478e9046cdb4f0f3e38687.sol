...
contract GorillaApt is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x049050F3E61Cd8c80F7122085653098A499E4E6d));

    string private _name = "GorillaApt";
    string private _symbol = "GOATP";
