...
pragma solidity ^0.8.13;
abstract contract NFT is ERC721A, DefaultOperatorFilterer {
...
using Strings for address;
  ...
  constructor() ERC721A("Testing movie", "TME")   {
    ...
    supplyPerRarity[2] = 5;
    setWhitelistRoot(0x0099a2f058fb774cd0453e0bdedb3934afa20cf781cecb52fe70d1c87a7ef2b1, 2, true);
    setWhitelistRoot(0x40f0df655e3ced40e661d1906b5954c102c4a2c7e91df02ae956e904fa096070, 1, false);
    status = 1;
    setPrice(10000000000000000);
