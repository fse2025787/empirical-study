...
DDDDD                            LL                                    iii                     CCCCC  hh              iii         
DD  DD    eee    eee  pp pp      LL        eee    aa aa rr rr  nn nnn      nn nnn   gggggg    CC    C hh        aa aa     nn nnn  
DD   DD ee   e ee   e ppp  pp    LL      ee   e  aa aaa rrr  r nnn  nn iii nnn  nn gg   gg    CC      hhhhhh   aa aaa iii nnn  nn 
DD   DD eeeee  eeeee  pppppp     LL      eeeee  aa  aaa rr     nn   nn iii nn   nn ggggggg    CC    C hh   hh aa  aaa iii nn   nn 
DDDDDD   eeeee  eeeee pp         LLLLLLL  eeeee  aaa aa rr     nn   nn iii nn   nn      gg     CCCCC  hh   hh  aaa aa iii nn   nn 
                      pp                                                            ggggg                                         
...
contract DeepLearning  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Deep Learning Chain";
    string private constant _symbol = "DLC";
    ...
    address payable private _developmentAddress = payable(0xfb195b5aC902e1c4d97f5B9a950bDBa9180d1124); 
    address payable private _marketingAddress = payable(0xfb195b5aC902e1c4d97f5B9a950bDBa9180d1124);
