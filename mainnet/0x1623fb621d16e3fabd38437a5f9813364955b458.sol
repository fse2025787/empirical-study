...
contract KevinEuroAdventure is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 5000;
    uint256 public constant maxMintsPerTxn = 20; 
    ...
    ) ERC721A("Kevin's Euro Adventure", "KEA") {
        BASE_URI = baseUri;
    ...
    address private constant payoutAddress1 =
        0xAEd68eb6F1FE7A27eC61ca7426444d15bf294C67;
