...
contract RoboPunks is ERC721Enumerable, Ownable
{
 using SafeMath for uint256;
 using Strings for uint256;

 uint public constant _TOTALSUPPLY =2222;
 ...
 constructor(string memory baseURI) ERC721("RoboPunks", "RP") {
 setBaseURI(baseURI);
 }
