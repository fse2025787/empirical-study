...
contract TBINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Block Inu", "TBINU") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x11BD44E7028790cE5B8D424154FC550b9e81D93E); // set as Marketing wallet
        DevWallet = address(0x11BD44E7028790cE5B8D424154FC550b9e81D93E); // set as dev wallet
