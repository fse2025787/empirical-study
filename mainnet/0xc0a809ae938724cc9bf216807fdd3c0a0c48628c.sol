...
contract Ownable is Context {
    ...
    function lockLpToken(uint256 time) public virtual onlyOwner {
    ...
    function unlock() public virtual {
        ...
        require(now > _lockTime , "Contract is locked until 365 days");
...
contract YABALO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "YABALO COIN";
    string private _symbol = "YABALO";
    ...
    uint256 public _maxTxAmount = 100 * 10**1 * 10**9;
