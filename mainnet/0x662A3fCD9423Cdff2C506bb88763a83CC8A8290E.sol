...
contract DEGENOBI is Context, IERC20, Ownable {
    ...
    address private feeaddress = payable(0xef2B2C384B4C2D38C96BC7eAd4C875952D9a18ae);

    string private _name = "DEGENOBI";
    string private _symbol = "DEGENOBI";
