...
Liquid Fire intends to solve one of the major issues facing new tokens launches.

With relatively low starting liquidity, early buyers who sell tend to have a huge impact on the chart.  
This dip causes general panic and a loss of momentum which few tokens ever recover from.  
Liquid Fire addresses this by constantly building up a large amount of Burned Liquidity.  
By the time those early buyers sell, they are selling into a much larger Pool and therefore the price impact is reduced.  
This will allow us to maintain momentum even as people take profits.  

We are Liquid Fire

Website:  https://www.liquidfiretoken.com/
Telegram: https://t.me/liquidfiretoken
Twitter:  https://twitter.com/liquidfiretoken
Medium:   https://medium.com/@liquidfire/liquid-fire-5a9041c2f6c3
...
contract LiquidFire is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    
    address payable public burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address
    address payable public marketingAddress = payable(0x8f20bF71b0CaD0946ab13FB65e1B69BcD1dB9239); // Marketing Address
    address payable public devAddress = payable(0x8f20bF71b0CaD0946ab13FB65e1B69BcD1dB9239); // Dev Address
   ...
   // mapping (address => bool) private _isBlacklisted;
    ...
    string private _name = "Liquid Fire";
    ...
    uint256 public autoLpDivisor = 30; // 3% liquidity
    ...
    uint256 public _maxTxAmount = 10000000001 * 10**18; // 10 billion
    uint256 private minimumTokensBeforeSwap = 150 * 10**6 * 10**18; // 150 million
    ...
    constructor () {        
        ...
        _isExcludedFromFee[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true; // uniswap router excluded from fee 
        _isExcludedFromFee[0x8f20bF71b0CaD0946ab13FB65e1B69BcD1dB9239] = true; // marketing wallet excluded from fee
        _isExcludedFromFee[0xA5644E29708357803b5A882D272c41cC0dF92B34] = true; // uniswap v3 migrator excluded from fee
