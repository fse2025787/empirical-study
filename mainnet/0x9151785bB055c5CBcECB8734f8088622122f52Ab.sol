...
contract DiversityOfMermaid is ERC721A, Ownable {
    
    uint256 public immutable mintPrice = 0.0005 ether;
    uint32 public immutable maxSupply = 4300;
    ...
    constructor()
    ERC721A ("DiversityOfMermaid", "DOM") {
    }
