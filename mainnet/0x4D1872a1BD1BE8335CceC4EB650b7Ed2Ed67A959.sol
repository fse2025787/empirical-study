...
contract BlackBoxCollectiveAccessPass is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor() ERC721("BLACK BOX COLLECTIVE", "ACCESS PASS") Ownable() {
    }
    ...
    function reserveMintPass(uint256 reserveAmount, address mintAddress) public onlyOwnerOrManager {
        require(totalSupply() + reserveAmount <= MAX_ACCESS_PASS, "Access Pass Sold Out");
