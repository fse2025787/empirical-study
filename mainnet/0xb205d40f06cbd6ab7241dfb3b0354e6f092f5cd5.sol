...
contract IceDragon is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ice Dragon";
    string private constant _symbol = "Ice Dragon";
    ...
    address payable private _developmentAddress = payable(0x4fAB132b5B0e2D8246e72a2A8a5784Bb70F100AF);
    address payable private _marketingAddress = payable(0x4fAB132b5B0e2D8246e72a2A8a5784Bb70F100AF);
