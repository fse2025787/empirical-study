    ...
    
{
  constructor(
     ...
     */
     function mintToDeployer(address _to, uint256 _qty) public onlyTeamOrOwner{
    ...
    * @param _to address of the future owner of the token
    */
    function revealMint(address _to) public payable {
    ...
    */
    function revealMintMultiple(address _to, uint256 _amount) public payable {
...
contract adidasOriginals is RamppERC721A {
    constructor() RamppERC721A("adidas Originals Into the Metaverse Phase 3", "ADI"){}
}