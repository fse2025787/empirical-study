...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x12AC05341F56119c884F7F91aB6F97c738bAdD3e];
  address public erc20Payable = 0x12AC05341F56119c884F7F91aB6F97c738bAdD3e;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 10000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXVUCo2Ye5ReTvdi7GFY44JDHDoq4E1wmjQw9qzQNfTfs/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7iSsfhfuQn0Hos8JkMpj/contract-metadata";
  }
...
// File: contracts/BelgianFrensContract.sol
//

pragma solidity ^0.8.0;

contract BelgianFrensContract is RamppERC721A {
    constructor() RamppERC721A("BelgianFrens", "BF"){}
}
