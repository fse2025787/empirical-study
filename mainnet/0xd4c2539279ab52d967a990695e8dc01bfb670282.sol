...
// File contracts/LPRewards/Dependencies/Address.sol
...
// File contracts/LPRewards/Dependencies/SafeERC20.sol
...
// File contracts/LPRewards/Interfaces/ILPTokenWrapper.sol
...
// File contracts/LPRewards/Interfaces/IUnipool.sol
...
// File contracts/LPRewards/Unipool.sol
...
/*
 * On deployment a new Uniswap pool will be created for the pair XUSD/ETH and its token will be set here.
...
contract Unipool is LPTokenWrapper, Ownable, CheckContract, IUnipool {
    ...
    function _updatePeriodFinish() internal {
        if (totalSupply() == 0) {
            require(periodFinish > 0, "period finish is less or equal than zero");
            /*
