...
contract InsidorCall is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xc04590D843f4f431fFcf19DB8eD5E5FAC8644Eef));
    address payable public _devwallet =
        payable(address(0xF336534Cd6F5f2B2181f82F5E76bbadFce612cC2));
    ...
    string private _name = "Insider Caller";
    string private _symbol = "IC";
