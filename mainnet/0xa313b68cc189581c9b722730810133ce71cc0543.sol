...
contract NAUGHTY is Context, IERC20, Ownable {
    ...
    string private constant _name = "NaughtyList"; // 
    string private constant _symbol = unicode"NAUGHTY"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x3C169DdA8d47806a59851CB46Ad211bc271c78dE).transfer(ethToSend); //marketing wallet
    }
