...
/**
 *Etherscan.io varificiation 2022-12-15
*/
...
contract BIGBANG is Context, IERC20, Ownable {
    ...
    address private feeOne = 0xA23b3785d5F4DA74304384Ae81D774fB4e4dCa85;
    address private feeTwo = 0x6f8DFE7A16Aa9f766850bf9369bB193220440D7C;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "BIGBANG";
    string private _symbol = "BIGBANG";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 999_999 * 10 ** _decimals;
    uint256 public _maxWalletAmount = 15_000 * 10 ** _decimals;
    ...
    uint256 public burnRateInBasePoints = 50;  //100 = 1%
