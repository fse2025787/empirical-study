...
// Wolthereum, the ultimate meme currency.
...
contract Wolthereum is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Wolthereum";
    string private constant _symbol = "WOLTHER";
    ...
    address payable public marketingWallet = payable(0x420C2d2A075607ae5Ec011040Cb9e53187842cFf);
    address payable public treasury = payable(0x420C2d2A075607ae5Ec011040Cb9e53187842cFf);
