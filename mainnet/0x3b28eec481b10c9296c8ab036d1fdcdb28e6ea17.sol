...
contract HayyaQatar  is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xB949284EEae8d271Ff1398d421B7e8DD311E5F0d); // Marketing Address
    address payable public multiSigAddress = payable(0xB949284EEae8d271Ff1398d421B7e8DD311E5F0d); // Marketing Address
    address payable public devAddress = payable(0x8806f64805d0190227a0278700d0348e48f313b7); // Dev Address
    address payable public liquidityAddress = payable(0x8806f64805d0190227a0278700d0348e48f313b7); // Liquidity Address
