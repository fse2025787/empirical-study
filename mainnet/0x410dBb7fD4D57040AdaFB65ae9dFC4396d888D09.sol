...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xD75F3709E9549d124cA6e462d898eb228596d284];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xD75F3709E9549d124cA6e462d898eb228596d284;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPPkt6F7juDeQShXEvyBAmFAJGeoNjgDkrPXKsmdFh7C7/";
...
// File: contracts/Ididntmakethey00TlistContract.sol
//

pragma solidity ^0.8.0;

contract Ididntmakethey00TlistContract is RamppERC721A {
    constructor() RamppERC721A("I didnt make the y00tlist", "YOOT"){}
}
