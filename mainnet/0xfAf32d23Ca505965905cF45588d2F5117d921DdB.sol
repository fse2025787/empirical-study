...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1667206800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1667030400;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xCf8eB3bb0F7545ef872ca8baA8c59d4f9C325a73];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xCf8eB3bb0F7545ef872ca8baA8c59d4f9C325a73;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeief7nnduc5atn2fiuv4zeoe4ksbriczcn6tc3h4wrhdr2rcg3q6we/";
...
// File: contracts/PattyPalsNftContract.sol
//

pragma solidity ^0.8.0;

contract PattyPalsNftContract is RamppERC721A {
    constructor() RamppERC721A("Patty Pals NFT", "PP"){}
}
