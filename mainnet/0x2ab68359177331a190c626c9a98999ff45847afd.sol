...
contract Wenurs is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPaL42HMi2oFrY2X7AP9SAmYnwhgvJmPJkqF6XoHCZVKf";
    ...
    constructor(
    ) ERC721A("Wenurs", "ween", 100, maxSupply) {
    }
