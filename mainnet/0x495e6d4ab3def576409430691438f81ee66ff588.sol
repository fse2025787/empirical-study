...
contract XCOPEPEPE is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("XCOPEPE PE", "XCOPEPEPE") {
        owner = msg.sender;
        maxPerTx = 6;
        price = 0.002 ether;
        maxSupply = 666;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibwfh25ag6wuzkfxphkewygr5c5nct4o6gxvuuvk2djkypn5qzag4/", _toString(tokenId), ".json"));
    }
