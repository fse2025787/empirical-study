...
contract CHAINSCAN is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0xc87F2400653F058114888c7B0c21f8B7EA68980b));
    address payable _devWallet = payable(address(0x8621dba74CF0B897C74624e1Fd855213ce78155B));
    ...
    constructor() ERC20("Chainscan", "LINKS") {
        marketingBuyFee = 5;
        liquidityBuyFee = 1;
