...
/*
The Next Gems Society

Each new gems excels the previous
...
contract TNGS is Context, IERC20, Ownable { 
    ...
    string private constant _name = "The Next Gems Society";
    string private constant _symbol = "TNGS";
