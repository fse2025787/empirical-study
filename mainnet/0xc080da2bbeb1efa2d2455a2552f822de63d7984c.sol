...
contract GodRipTheQueen is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "ipfs://bafybeibwfyoywmyyyohyv2rfr5wbcpahngn3tmpz272wqdwx76coar2cue/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("God Rip The Queen", "QUEEN") {
        setHiddenMetadataUri("ipfs://bafybeiek2aifngfdhumrussp2yir3hhbb2qznrotbbvhqafriq62sxwpie/hidden.json");
    }
