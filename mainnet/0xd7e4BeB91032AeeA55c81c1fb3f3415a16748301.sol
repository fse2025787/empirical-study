...
//        /:–:/::'i      ,. -,     /.-:;:::';        /:'     '`:/::;‘    /:: :: : : : : : :::/::'/            /;:-·~·-:;':::',          /·*'`·´¯'`^·-~·:–-'::;:::'`;     /:-·:;:-·~·';/:::::::::`·-.           /;:·–– :;:::::_ ;: – .,/::;i'‘         /::;:-·^*'*'^~-;:/::/`;   '       /:–:/::'i      ,. -,     /.-:;:::';        /:·*'`·:/:::::' , /·´'`;/::';' 
//     ,'      ';::';    '/::::/';   ;    '`;:',        ;         ';:';‘  ,´¯ '` * ^ * ´' ¯   '`;/    ‘       ,'´          '`:;::`,        '\                       '`;::'i‘   ';           '`~-:;:::::::::'`,       /´          ¯¯           ';::/          /:´    ,. –.,_,.'´::/:::';' '    ,'      ';::';    '/::::/';   ;    '`;:',      ,'         `:;::::'`i    ';:::'; 
//    /       'i::::\  '/:–;/:::;_;     ';::i        |         'i::i   '`,                  ,·'   '         /                `;::\         '`;        ,– .,        'i:'/     ',.                 '`·-:;:::::'i'‘  ,:                          ,:/         ,/    ,:´';         ;'´¯`,:::'i'    /       'i::::\  '/:–;/:::;_;     ';::i      ;            '`;:::'i    'i::::i 
//   ;        ';:::::'/     ';::/:;:      ';:;'        ';        ;'::i      '`*^*'´;       .´         ‘    ,'                   '`,::;         i       i':/:::';       ;/'        `'i      ,_            '`;:::'¦‘  ';_,..–-.,_     _    _,.·´‘       ' ,'     ';:::`,       ,:     ';::i‘   ;        ';:::::'/     ';::/:;:      ';:;'      i               `;:';    'i:::i' 
//  'i          \:::;'      ',/:::;'       i:'i' '‘      'i        'i::i'           .´     .'      _   ' ‘   i'       ,';´'`;         '\:::', ‘     i       i/:·'´       ,:''           'i      ;::/`:,          i'::/            ,·´'    '`·;'i¯               ;      ';:::/:`::^*:´;      i::';'‘ 'i          \:::;'      ',/:::;'       i:'i' '‘    i      ,          \|     '|:::i°
//  'i           `-'´        '`-·´       ,':/'  °       ;       'i::;'        .´      ,'´~:~/:::/`:,  ,'        ;' /´:`';         ';:::'i‘     '; '    ,:,     ~;'´:::'`:,       _;     ;:/;;;;:';        ¦'/              i         'i:i'       ’        i       `;/::::::::,·´      ';:/'‘  'i           `-'´        '`-·´       ,':/'  °    |     ,'`,                i:;'' ‚
//  ';                                  ;/            ';       i:/'       .´      ,'´::::::/:::/:::'i‘ ;        ;/:;::;:';         ',:::;     'i      i:/\       `;::::/:'`;'   /::';   ,':/::::::;'       ,´               ';        ';:i'     ’          ';         '` *^*'´         .'/‘    ';                                  ;/         'i    'i:::i',             ';/'   
//   ';              ,.                /               ';     ;/ °     ,'        '*^~·~*'´¯'`·;:/ 'i        '´        `'         'i::'/      ;     ;/   \       '`:/::::/',/-:;_i  ,'/::::;·´        ,'´                 i        i:/'                 '\                         /       ';              ,.                /           'i     ;::/ \           ;/'     
//    '\            '/ '\              /                 ';   / °      /                        ,'/  ¦       '/`' *^~-·'´\         ';'/'‚      ';   ,'       \         '`;/' '`·.     `'¯¯     '   , ·'´                     ;      i/    °                `·,                ,-·´ '         '\            '/ '\              /             \    'i/    '`·,      ,''       
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf8B0C9E3C9d5854E71EF0ADA4E8A858E8c84e252];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmfQS3SQU8AtwzDWDMHYuEBujV3Bez6XErqKsPWMnv1QEs/";
...
// File: contracts/WizardtownxyzContract.sol
//

pragma solidity ^0.8.0;

contract WizardtownxyzContract is RamppERC721A {
    constructor() RamppERC721A("Wizardtownxyz", "WZRD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/KqwnlM1jfQtAmJoweJx3/contract-metadata";
    }
}
