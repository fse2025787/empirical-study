...
contract GENERATIVELAND is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmW9UEoMGhUrRTBSiXUuuqB1zyjQ4damdNnaBroscymjAN";
    ...
    constructor(
    ) ERC721A("GENERATIVE LAND", "LAND", 100, maxSupply) {
    }
