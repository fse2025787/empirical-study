...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _melogameset() internal {
        _currentIndex = _startTokenId();
    }
...
contract Melon  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmUXurzcTQQcEYoYCrfAqy4SXNG9vLaBw1GrEtpm8bUjQj/";
    ...
    function cutSupply(uint256 amount) public onlyOwner {
        _burn0(amount);
    }

    function melogameset() public onlyOwner {
        _melogameset();
    }
