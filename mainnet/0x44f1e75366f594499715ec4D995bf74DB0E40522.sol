...
CryptoRocks Socials:
Telegram: https://t.me/cryptorockstoken
Twitter: https://twitter.com/nft_CryptoRocks
Website: https://www.cryptorocks.com
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x72C4429607c930c4e112b747ff8B5A3E2F29d535), 7200);
		setTaxAlloc(payable(0x22B0c35c707A5a12616a5Eb54b79386658C7f83A), 800);
        m_DidDeploy = true;
    }
...
contract CryptoRocks is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 5000000000 * 10**9;
    string private m_Name = "CryptoRocks";
    string private m_Symbol = "Rocks";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(30 days), msg.sender);
        m_Liquidity = true;
    }
