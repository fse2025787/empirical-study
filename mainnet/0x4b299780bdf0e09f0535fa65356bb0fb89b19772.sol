...
/**
OniDragon || Fade Into the Mist おに

OniDragon are the great rulers of the underworld.

Good devs united to awaken OniDragons wrath, and challenge jeets to a final battle for crypto supremacy.

With the destructive power of lightning and thunder, and a massive appetite for human flesh, OniDragon can eat a person in a single gulp. They are said to suck in a human’s vital energy and devour them whole.

Multiple NFT OniDragon masks (samples below) will be produced and distributed to max bag holders to bring together our Chad army for the final showdown.

OniDragon will help us all, before they fade into the mist and bull market returns to the realm.

Telegram : http://t.me/OniDragonERC20
*/
...
// 
    ...
    contract oni is ERC20 {
        ...
        constructor () ERC20("Fade Into the Mist", "$OniDragon"){

            numTokensSellToSendEthToDev = 4000000 * 10 ** decimals();
            _devWalletAddress = 0x26674d90EB3E4815Da30A0b19E93C2d1fb4CB5dF;
