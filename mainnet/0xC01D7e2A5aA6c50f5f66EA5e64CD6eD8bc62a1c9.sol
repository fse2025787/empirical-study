...
// community token for people who like to receive and give
                    // at the same time
...
contract sixnine is Context, IERC20 {
    ...
    uint256 private startingSupply = 69;

    string private _name = "nice";
    string private _symbol = "69";
//==========================
    // FEES
    struct taxes {
    uint buyFee;
    ...
    {buyFee: 400, sellFee: 400, transferFee: 400, antiDumpLT: 700});
//==========================
    // Maxima
    ...
    {maxBuy: 400, maxSell: 400, maxTransfer: 400, maxAntiDump: 2000});
//==========================    
    ...
    { liquidity: 100, burn: 0, operations: 150, developer: 150});
//==========================
    // Anti-Dump
...
//==========================
    ...
    address payable public _operationsWallet = payable(0x015BBf0650b23f6EB73Fd8b10f1D0265D3B807A5);
    address payable public _developerWallet = payable(0x015BBf0650b23f6EB73Fd8b10f1D0265D3B807A5);
