...
/**
We are a fan club and we aim to pump USYK vs AJ no matter the outcome of their boxing match.

Please note this is a short term project, i will lock it for 7 days and renounce, if by any chance community gets super hyped i will extend the lock to a month.
...
contract USYKvsAJ is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "USYKvsAJ";
    string private constant _symbol = "USYKvsAJ";
