...
contract cryptosanta is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Crypto Santa";
    string private constant _symbol = unicode"CSANTA";
