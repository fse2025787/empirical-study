...
contract Yori is ERC20, Ownable {
    ...
    constructor() ERC20("Yori", "$YORI") payable {
    	...
    	marketingWallet = address(0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d); // set as Marketing wallet
        devWallet = address(0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d, true);
        excludeFromFees(0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d, true);
        excludeFromMaxTransaction(0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xBc5aeF1ab244638bD3E2c5B90bCB92ECC5bDbb2d,
            block.timestamp
        );
    }
