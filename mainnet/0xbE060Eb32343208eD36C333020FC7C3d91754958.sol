...
contract Metatate is Context, ERC20, Ownable {
    ...
    uint256 private constant _tSupply = 1e11 * (10**18);
    ...
    event SetBuyFee(uint256 buyBBCEFee, uint256 buyOpsFee, uint256 buyDevFee, uint256 buyLiqFee);
	event SetSellFee(uint256 sellBBCEFee, uint256 sellOpsFee, uint256 sellDevFee, uint256 sellLiqFee);
    
    constructor (address payable bbCEWallet, address payable opsWallet, address payable devWallet1, address payable devWallet2, address payable liqWallet) ERC20("Metatate", "CHI") {
        require(bbCEWallet != ZERO, "bbCEWallet address cannot be 0");
        require(opsWallet != ZERO, "opsWallet address cannot be 0");
        require(devWallet1 != ZERO, "devWallet1 address cannot be 0");
        require(devWallet2 != ZERO, "devWallet2 address cannot be 0");
        require(liqWallet != ZERO, "liqWallet address cannot be 0");
    ...
    function setBuyFee(uint256 _buyBBCEFee, uint256 _buyOpsFee, uint256 _buyDevFee, uint256 _buyLiqFee) public onlyOwner {
        ...
        emit SetBuyFee(buyBBCEFee, buyOpsFee, buyDevFee, buyLiqFee);
    }
    ...
    function setSellFee(uint256 _sellBBCEFee, uint256 _sellOpsFee, uint256 _sellDevFee, uint256 _sellLiqFee) public onlyOwner {
        ...
        emit SetSellFee(sellBBCEFee, sellOpsFee, sellDevFee, sellLiqFee);
    }
