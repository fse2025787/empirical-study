...
// File: contracts/LockProxyBridge.sol
...
interface EthCrossChainManager {
...
contract LockProxyBridge {
    ...
    address public polyCCMC;

    constructor(address _want, address _xvault, address _lockproxy, address _ccmc) public {
        want = _want;
        xvault = _xvault;
        governance = msg.sender;
        polyLockProxy = _lockproxy;
        polyCCMC = _ccmc;
    }
    ...
    // _toAddress need to be little endian and start with 0x fef: https://peterlinx.github.io/DataTransformationTools/
    ...
    function unlock(bytes memory proof,
...
// File: contracts/instances/LockProxyBridgeUSDT.sol


pragma solidity ^0.6.2;


contract LockProxyBridgeUSDT is LockProxyBridge {
    constructor(address _xvault)
        public
        LockProxyBridge(
            address(0xdAC17F958D2ee523a2206206994597C13D831ec7), // https://etherscan.io/address/0xdac17f958d2ee523a2206206994597c13d831ec7
            _xvault,
            address(0x250e76987d838a75310c34bf422ea9f1AC4Cc906), // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum Lock Proxy
            address(0x838bf9E95CB12Dd76a54C9f9D2E3082EAF928270)  // https://github.com/polynetwork/docs/blob/master/config/README.md#ethereum ECCM
        )
    {}
}