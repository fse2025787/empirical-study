...
// File: contracts/Factories/ZEUSBANK.sol

// https://www.zeus10000.com/


contract ZEUSBANK is Factory {
    constructor() {
        price = 7e16;
        withdrawAddress = 0xBb1387D72934734b5192224445bdf0aa147e6789;
    }
    ...
    function mint(address to, uint256 count) external payable {
        require(msg.value >= price * count, "not enough ethereum");
