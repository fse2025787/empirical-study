...
contract ArmoredTigerClub is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function mintReserve(uint256 _mintAmount, address _receiver) public mintComplianceForOwner(_mintAmount) onlyOwner {
    _safeMint(_receiver, _mintAmount);
  }
