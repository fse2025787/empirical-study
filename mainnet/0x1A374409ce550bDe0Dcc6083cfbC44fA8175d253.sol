...
contract RoyalCorgi is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "Royal Corgi";
    string private m_Symbol = "ROYALC";
    ...
    uint256 private m_WalletLimit = m_TxLimit.mul(10);
    ...
    address private m_AntibotSvcAddress = 0x29CB711c24ae2458A6B4fBcd530d9Fca6Ab6474D;
    ...
    function _checkTX() private view returns (uint256){
        if(block.timestamp <= m_Launched.add(3 minutes))
