...
contract SnuggleBuddiesUnleashed is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3333;
    uint256 public MAX_MINTS = 1000;
    string public baseURI = "https://api-mint.snugglebuddiesnft.com/token/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("Snuggle BuddiesUnleashed", "Unleashed", MAX_MINTS, MAX_SUPPLY) {  
    }
