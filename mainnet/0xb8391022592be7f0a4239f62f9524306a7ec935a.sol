...
interface ILWXP{
    function claimedByTokenId(uint256) external view returns(bool);
    function claimById(uint256) external;
...
interface ILootStats{
    function smithUpgrade(uint256 tokenId, uint256 amount) external;
    function mintFromSmith(uint256 tokenId, address _newOwner) external;
    function getWeapon(uint256 tokenId) external returns (uint256);
    function getAttack(uint256 tokenId) external returns (uint256);
    function getDefense(uint256 tokenId) external returns (uint256);
    function getDurability(uint256 tokenId) external returns (uint256);
    function getWeight(uint256 tokenId) external returns (uint256);
    function getMagic(uint256 tokenId) external returns (uint256);
    function getTotalPower(uint256 tokenId) external returns (uint256);
}
