...
pragma solidity ^0.6.12;
    ...
    contract TeaFinance is Context, IERC20, Ownable {
      ...
      uint256 private _tTotal = 1500000000 * 10**9;
      uint256 private _rTotal = (MAX - (MAX % _tTotal));
      uint256 private _tFeeTotal;

      string private _name = 'TeaFinance';
      string private _symbol = 'TeaFI';
      ...
      uint256 private _maxTxAmount = 7500000 * 10**9;
      uint256 private _numOfTokensToExchangeForTeam = 10000 * 10**9;
      ...
      constructor (address payable fundWalletAddress, address payable marketingWalletAddress) public {
      ...
      function _transfer(address sender, address recipient, uint256 amount) private {
          ...
          require(!_isBlackListedBot[recipient], "You are blacklisted");
