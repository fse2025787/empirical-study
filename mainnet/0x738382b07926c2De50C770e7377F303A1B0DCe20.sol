...
/**                                                                     
  sSSs   .S    S.    .S   .S_SSSs     .S_SSSs    sdSS_SSSSSSbs    sSSs_sSSs      sSSs_sSSs    S.        sSSs  
 d%%SP  .SS    SS.  .SS  .SS~SSSSS   .SS~SSSSS   YSSS~S%SSSSSP   d%%SP~YS%%b    d%%SP~YS%%b   SS.      d%%SP  
d%S'    S%S    S%S  S%S  S%S   SSSS  S%S   SSSS       S%S       d%S'     `S%b  d%S'     `S%b  S%S     d%S'    
S%|     S%S    S%S  S%S  S%S    S%S  S%S    S%S       S%S       S%S       S%S  S%S       S%S  S%S     S%|     
S&S     S%S SSSS%S  S&S  S%S SSSS%P  S%S SSSS%S       S&S       S&S       S&S  S&S       S&S  S&S     S&S     
Y&Ss    S&S  SSS&S  S&S  S&S  SSSY   S&S  SSS%S       S&S       S&S       S&S  S&S       S&S  S&S     Y&Ss    
`S&&S   S&S    S&S  S&S  S&S    S&S  S&S    S&S       S&S       S&S       S&S  S&S       S&S  S&S     `S&&S   
  `S*S  S&S    S&S  S&S  S&S    S&S  S&S    S&S       S&S       S&S       S&S  S&S       S&S  S&S       `S*S  
   l*S  S*S    S*S  S*S  S*S    S&S  S*S    S&S       S*S       S*b       d*S  S*b       d*S  S*b        l*S  
  .S*P  S*S    S*S  S*S  S*S    S*S  S*S    S*S       S*S       S*S.     .S*S  S*S.     .S*S  S*S.      .S*P  
sSS*S   S*S    S*S  S*S  S*S SSSSP   S*S    S*S       S*S        SSSbs_sdSSS    SSSbs_sdSSS    SSSbs  sSS*S   
YSS'    SSS    S*S  S*S  S*S  SSY    SSS    S*S       S*S         YSSP~YSSY      YSSP~YSSY      YSSP  YSS'    
               SP   SP   SP                 SP        SP                                                      
               Y    Y    Y                  Y         Y                                                       



        Website: https://shibatools.ai
        Telegram: https://t.me/shibatools_ai
...
contract ShibaTools is IERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ShibaTools";
