...
contract OmegabloxbyNeoNova is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 10000;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.009 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x59589644c5ef16b36b09984d8d93d6deb22f43242d8c6183d618939cbd6c3014;
    bool public publicPaused = false;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmbALazUVye9J9bgbYrYLvGXaVh9yRhKQXxUvCVf3JpyxG";

    constructor()
        public
        ERC721A("Omegablox by NeoNova", "OMEGA", 10000, 10000)
    {}
