...
// ACAB Token: Anti-Corruption & Brutality
//                                                 
// Telegram: https://t.me/acabtokenofficial
// Website: https://acabtoken.org
// 
...
contract ACAB is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'ACAB Token';
    string  private constant _SYMBOL = 'ACAB';
    ...
    uint256 private     _TAX_FEE = 120; // 1.2% BACK TO HOLDERS
    uint256 private    _BURN_FEE = 120; // 1.2% BURNED
    uint256 private _CHARITY_FEE = 120; // 1.2% TO CHARITY WALLET
