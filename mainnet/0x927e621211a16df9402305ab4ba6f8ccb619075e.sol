...
// Telegram: https://t.me/justapeinu
...
contract APEI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69e6 * 10**9;
    uint256 private _rTotal = (_MAX - (_MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Just Ape Inu";
    string private constant _symbol = "APEI";
    ...
    function setTeamFee(uint256 fee) external onlyOwner() {
        require(fee <= 11, "not larger than 11%");
        _teamFee = fee;
    }
