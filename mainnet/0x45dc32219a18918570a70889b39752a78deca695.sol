...
// Telegram: https://t.me/jesuscryptoportal
// Website:https://jesuscry-pto.com
...
contract EASTER is Context, IERC20, Ownable {
    ...
    string private constant _name = "JESUSCRY";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            if (from == _uniswapV2Pair && to != address(_uniswapV2Router) && _initialLimitDuration > block.timestamp) {
                ...
                require(amount <= _tTotal.mul(6).div(1000));
                require(amount.add(walletBalance) <= _tTotal.mul(18).div(1000));
            }
    ...
    function setTeamFee(uint256 tfee) external onlyOwner() {
        _teamFee = tfee;
    }
