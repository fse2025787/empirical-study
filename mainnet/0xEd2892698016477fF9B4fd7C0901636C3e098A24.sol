...
contract SpinalFoxes is ERC721A("SpinalFoxes", "SF"), Ownable, ERC721ABurnable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    string public notRevealedUri;
    uint256 public cost = 0.06 * 1e18;
    uint256 public maxSupply = 6000;
    uint256 public reservedSupply = 700;
    uint256 public maxMintAmount = 15;
    uint256 public publicmintActiveTime = 1651086000;
    ...
    uint256 public presaleActiveTime = 1650999600;
    uint256 public presaleMaxMint = 3;
    bytes32 public whitelistMerkleRoot;
    uint256 public itemPricePresale = 0.04 * 1e18;
