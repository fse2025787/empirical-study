...
contract Lovemyself is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public currentPhaseMintMaxAmount = 1000;
  ...
  function setcurrentPhaseMintMaxAmount(uint256 _newPhaseAmount) public onlyOwner {
