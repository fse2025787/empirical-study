...
/**
Welcome to Dynamic Labs!

Dynamic Labs is personal saving software built on the world's top decentralized markets.

WEBSITE: https://www.dynamiclabs.app
TWITTER: https://twitter.com/DynamicLabsETH
MEDIUM: https://medium.com/@dynamiclabs
*/
...
contract DynamicLabs is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _name = "DYNAMIC LABS";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x12398cf12531a5099A9987b6D35B51f4f29a1C13);
        TreasuryWallet = payable(0x12398cf12531a5099A9987b6D35B51f4f29a1C13);
        DevWallet = payable(0x739E3016DEf12FB22adc2d877DEba532353bBF99);
