...
Master Izo was a powerful founding member of the Hand in Japan several hundred years ago.
Izo appears to be immortal and possesses a valuable sense of radar.
He trains his martial arts every day. 

Launching with 0.5% max TX/Wallet and I will uplift to 2% slowly after launch.

Website: https://master-izo.com
Twitter: https://twitter.com/MasterIzoETH
Telegram: https://t.me/MasterIzo
...
contract IZO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Master Izo";
    string private constant _symbol = "IZO";
    ...
    uint256 private _maxTxAmount = 5_000_000_000 * 10**9;
    uint256 private _maxWalletAmount = 10_000_000_000 * 10**9;
