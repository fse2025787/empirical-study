...
/*
No doubt that even in this bear market $SHIK & $BONK have both been outperforming every other token by quickly gaining the top ranks. 
We have combined the power of these two tokens to create a one true beast that will stampede way past every jeet who dares 
tries to stop it. Join the strong warriors who hold the floor, and defeat every obstacle by burning its supply.  
Fight alongside the new succesor, "Shibonkinu"!! Missed Shik and Bonk Do not fade!

 TELEGRAM :- https://t.me/shibonkinu_portal
 TWITTER :-  https://twitter.com/ShibonkERC20
 WEBSITE :-  https://www.shibonkinu.com/
...
contract BONK  is ERC20, Ownable {
    ...
    constructor() ERC20("Shibonk Inu", "Shibonk") {
        ...
        devWallet = 0x89186d9013e4c9123802A850F9a8361d42C0FfCB;
