...
contract THECHAIN is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 500; // 1% of supply
    ...
    string private constant _name = "THE CHAIN";
    string private constant _symbol = "THECHAIN";
