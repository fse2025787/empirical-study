...
/**
The world is revolving. Different races, including humans with new-found abilities are rising.
Will this power bring upon pain, destruction, and swallow them up whole?
Will it takeover them and create new heartless souls? Humans especially, are very cruel, power hungry creatures.
One innocent can turn to become a monster. No restrictions are chaining them up.
-Revolver
*/
...
contract Revolve is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Revolve", "REVOLVE") {
