...
https://t.me/oliverroganinu

https://oliverrogan.com

Oliver Rogan Inu - Not to be outdone by Marshall, Oliver is here and will be the next of Joe's pets to jump onto the Blockchain.

Props to Marshall Rogan Inu and their team for starting the challenge. We will join you in the Octagon.
...
contract ORI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Oliver Rogan Inu";//
    string private constant _symbol = "ORI";//
    ...
    address payable private _developmentAddress = payable(0xe2c1cA67abD8af4538Bc2B06980748c8E8C590DF);//
    address payable private _marketingAddress = payable(0x7A869Ec53d176ACE2346f5640298CFB1D9aa0B52);//
