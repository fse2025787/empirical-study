...
/*http://T.me/ongodthisthetg

On god this is a bullish message in the contract
...
contract ONGOD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OnGOD";
    string private _symbol = "OG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x0527D61228E51740A8CaD5E5e26e9Dd66a874993);
    address payable private taxWallet2 = payable(0x0527D61228E51740A8CaD5E5e26e9Dd66a874993);
