...
COMMUNITY TO TAKE THE LEAD, CREATE SOCIALS AS YOU WISH
...
contract SHICA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Community Inu";
    string private constant _symbol = unicode"SHICA";
