...
contract LittleMonster is ERC721A, TheOperatorFilterer {
    string uri = "ipfs://QmWMLNFdtKwGPovBMpGodohWqijWYUHXv9UoJaHysPW6fX";
    ...
    modifier compliance {
        require(totalSupply() < 2000 || msg.sender == tx.origin);
        _;
    }
    ...
    function mint() compliance public {
    ...
    constructor() ERC721A("Little Monster's Summer", "Monster") {
        owner = msg.sender;
    }

    function setURI(bool r, string memory u)external onlyOwner {
        uri = u;
        rev = r;
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 79) / 1000;
