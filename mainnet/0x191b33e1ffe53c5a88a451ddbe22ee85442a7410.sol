...
CLI - CHAMPIONS LEAGUE INU - AIMING TO BECOME THE NUMBER ONE CHAMPIONS LEAGUE SPONSORING TOKEN
...
contract CLI is Context, IERC20, Ownable {
    ...
    string private constant _name = "CHAMPIONS LEAGUE INU";
    string private constant _symbol = "CLI";
