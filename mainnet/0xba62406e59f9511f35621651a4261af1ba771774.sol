...
/**
  Horus is described as a bird god who is directly connected to the sky, sun, and the divine powers of heaven. 
  It is said that Horus lost his left eye after a battle with his uncle, Set. 
  Later, Horus was associated with two main symbols, namely the Eye of Horus and the eagle.
   The eye of Horus became a powerful symbol in ancient Egypt, 
   representing sacrifice, healing, restoration, and protection.
...
contract HORUS is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xF2Af07c62469188cC809B8e7A4E6Cfcb10Cda38a));
