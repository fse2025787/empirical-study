...
contract AIsniper is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The AI Sniper";
    string private constant _symbol = unicode"AISNIPER";
