...
/**
https://www.vervetoken.com
https://t.me/vervetoken
*/
// 
...
contract VERVE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _tTotal = 20 * 10**9 * 10**9;                         // 20 billion = Total Supply
    uint256 public swapAtAmount = _tTotal.mul(10).div(10000);       // 0.10% of total supply
    uint256 public maxTxLimit = _tTotal.mul(50).div(10000);         // 0.50% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(100).div(10000);    // 1.00% of total supply
    ...
    constructor(address _dev) public ERC20("VERVE", "VERVE") {
    ...
    function LetsGetActive() external onlyOwner() {
