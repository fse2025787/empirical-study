...
Tax 6% for buybacks to build BIG GREEN DILDOS on chart.
Total supply 100000000
Max wallet 2000000
Max txn 1000000
After 10 minutes increase max wallet and max txn to 3%

https://t.me/VitalikMandingo
https://twitter.com/VitalikMandingo
...
contract VitalikMandingo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Vitalik Mandingo";
    string private constant _symbol = "Mandingo";
    ...
    address payable private _developmentAddress = payable(0xe0032a5Fe699d14484A19579E75a91bC72E1c626);
    ...
    uint256 public _maxTxAmount = 1e6 * 10**9; //
    uint256 public _maxWalletSize = 2e6 * 10**9; //
