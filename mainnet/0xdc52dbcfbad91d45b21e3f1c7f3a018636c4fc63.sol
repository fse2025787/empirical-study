...
Initial buy: 2100000000    

TAX: 4%

Telegram: https://t.me/PartyERC20
*/
...
contract HappyHour is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy_Hour";
    ...
    uint256 private maxWalletAmount = 2100000001 * 10**9;
    uint256 private maxTxAmount = 2100000001 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x1C6fe95C287D288DED176bC1DeBbEC2C8e769480); 
        ...
        maxTxAmount = 2100000001 * 10**9;
        maxWalletAmount = 2100000001 * 10**9;
