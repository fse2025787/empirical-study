...
// WokongToken with Governance.
contract WokongToken is BEP20 {
    // Transfer tax rate in basis points. (default 1%)
    uint16 public transferTaxRate = 100;
    // NFT fee (total 0.8%)
    uint16 public nftFeeRate1 = 10;
    uint16 public nftFeeRate2 = 12;
    uint16 public nftFeeRate3 = 13;
    uint16 public nftFeeRate4 = 15;
    uint16 public nftFeeRate5 = 30;

    address public nftFeeAddr1 = 0xC05EB95844601306CEEd32A3BA6239f71F358935;
    address public nftFeeAddr2 = 0x7dA93a373531D5E6905D4933C7AB9178BAf81748;
    address public nftFeeAddr3 = 0x297224E8780c1DE0990aAa05229B5F9d952C6111;
    address public nftFeeAddr4 = 0xae39f521c74CAEa03C950f6D289fCe946ECEaD2F;
    address public nftFeeAddr5 = 0x94Ce8261De7887E0fAf6251e2f80dA084C592A1F;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override antiWhale(sender, recipient, amount) {
        ...
        if (recipient == BURN_ADDRESS || transferTaxRate == 0) {
            ...
            // nft fee
            uint256 nftFee1 = amount.mul(nftFeeRate1).div(10000);
            uint256 nftFee2 = amount.mul(nftFeeRate2).div(10000);
            uint256 nftFee3 = amount.mul(nftFeeRate3).div(10000);
            uint256 nftFee4 = amount.mul(nftFeeRate4).div(10000);
            uint256 nftFee5 = amount.mul(nftFeeRate5).div(10000);
            require(taxAmount == burnAmount + liquidityAmount, "WUKONG::transfer: Burn value invalid");

            // default 95% of transfer sent to recipient
            uint256 sendAmount = amount.sub(taxAmount + nftFee1 + nftFee2 + nftFee3 + nftFee4 + nftFee5);
            require(amount == sendAmount + taxAmount + nftFee1 + nftFee2 + nftFee3 + nftFee4 + nftFee5, "WUKONG::transfer: Tax value invalid");

            super._transfer(sender, BURN_ADDRESS, burnAmount);
            super._transfer(sender, address(this), liquidityAmount);
            super._transfer(sender, recipient, sendAmount);
            super._transfer(sender, nftFeeAddr1, nftFee1);
            super._transfer(sender, nftFeeAddr2, nftFee2);
            super._transfer(sender, nftFeeAddr3, nftFee3);
            super._transfer(sender, nftFeeAddr4, nftFee4);
            super._transfer(sender, nftFeeAddr5, nftFee5);
            amount = sendAmount;
        }
    }
    ...
    */
    ...
    function addNftOperator(address _addNftOperator) public onlyOwner returns (bool) {
        require(_addNftOperator != address(0), "WUKONG: _addNftOperator is the zero address");
    ...
    function delNftOperator(address _delNftOperator) public onlyOwner returns (bool) {
        require(_delNftOperator != address(0), "WUKONG: _delNftOperator is the zero address");
    ...
    function getNftOperator(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getNftOperatorLength() - 1, "WUKONG: index out of bounds");
    ...
    function updateNftFeeRate1(uint16 _nftFeeRate1) public onlyOwner {
        require(_nftFeeRate1 <= 100, "WUKONG::updateNftFeeRate: nft fee rate must not exceed 1%.");
        require(_nftFeeRate1 > 0, "WUKONG::updateNftFeeRate: nft fee rate must be greater than 0.");
        nftFeeRate1 = _nftFeeRate1;
    }
    function updateNftFeeRate2(uint16 _nftFeeRate2) public onlyOwner {
        require(_nftFeeRate2 <= 100, "WUKONG::updateNftFeeRate: nft fee rate must not exceed 1%.");
        require(_nftFeeRate2 > 0, "WUKONG::updateNftFeeRate: nft fee rate must be greater than 0.");
        nftFeeRate2 = _nftFeeRate2;
    }
    function updateNftFeeRate3(uint16 _nftFeeRate3) public onlyOwner {
        require(_nftFeeRate3 <= 100, "WUKONG::updateNftFeeRate: nft fee rate must not exceed 1%.");
        require(_nftFeeRate3 > 0, "WUKONG::updateNftFeeRate: nft fee rate must be greater than 0.");
        nftFeeRate3 = _nftFeeRate3;
    }
    function updateNftFeeRate4(uint16 _nftFeeRate4) public onlyOwner {
        require(_nftFeeRate4 <= 100, "WUKONG::updateNftFeeRate: nft fee rate must not exceed 1%.");
        require(_nftFeeRate4 > 0, "WUKONG::updateNftFeeRate: nft fee rate must be greater than 0.");
        nftFeeRate4 = _nftFeeRate4;
    }
    function updateNftFeeRate5(uint16 _nftFeeRate5) public onlyOwner {
        require(_nftFeeRate5 <= 100, "WUKONG::updateNftFeeRate: nft fee rate must not exceed 1%.");
        require(_nftFeeRate5 > 0, "WUKONG::updateNftFeeRate: nft fee rate must be greater than 0.");
