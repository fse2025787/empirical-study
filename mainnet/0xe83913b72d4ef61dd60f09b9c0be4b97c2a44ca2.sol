...
/**
// TeleGram | https://t.me/slinkyinu
// website | https://slinkydoginu.com - will update in tg when website is live before we launch
//
//
//              ,═"``└└^▀
//           ╓É─-   ,▄▄▄▓▀▀▀▀ªæ▄,
...
contract BOING is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Slinky Dog Inu";
    string private constant _symbol = "BOING";
    ...
    uint256 public _swapTokensAtAmount = 55000000000 * 10**_decimals;
