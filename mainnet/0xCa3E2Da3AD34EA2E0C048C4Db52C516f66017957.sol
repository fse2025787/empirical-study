...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xafA7C1239546bFA07831aF5b04a68051AC573508];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xafA7C1239546bFA07831aF5b04a68051AC573508;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUsSiNVhk89JxSQaE3uJvrMPru5KUPPQWeioLBvefMEhV/";
...
// File: contracts/ExsiliumContract.sol
//

pragma solidity ^0.8.0;

contract ExsiliumContract is RamppERC721A {
    constructor() RamppERC721A("Exsilium", "Exsilium"){}
}
