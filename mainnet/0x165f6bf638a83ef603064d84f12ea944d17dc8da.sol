...
contract TheAmericans is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUFexEeyXEX2yYAhFQ99BcpRTLB2RYeJ7vgWvGZxpPESf";
    ...
    constructor(
    ) ERC721A("The Americans", "AMERICA", 100, maxSupply) {
    }
