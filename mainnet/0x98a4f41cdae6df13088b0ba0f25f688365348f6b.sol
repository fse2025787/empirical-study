...
// File: contracts/NaughtyMonsters.sol
...
contract NaughtyMonsters is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeicliwnyryvytrhq6z2bbjy2j22g7kizpyabant5atof3zgoajbrzi/";
  uint256  public  maxSupply = 7777;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.0035 ether;
  uint256 public  NUM_FREE_MINTS = 7777;
  ...
  ) ERC721A("NaughtyMonsters", "NMONSTA") {
