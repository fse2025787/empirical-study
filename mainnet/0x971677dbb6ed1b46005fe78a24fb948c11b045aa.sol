...
contract WhiteList is OwnableUpgradeable {
    ...
    function addWhiteList(address _user) public onlyOwner {
        require(_user != address(0),"Can't be zero");
        require(!whiteList[_user],"Registered");
    ...
    function removeWhiteList(address _user) public onlyOwner{
        require(_user != address(0),"Can't be zero");
        require(whiteList[_user],"Not Registered");
...
// File contracts/RektToken.sol

pragma solidity 0.8.12;

contract RektToken is ERC20Upgradeable, WhiteList {


    uint256 constant public INITIAL_SUPPLY = 100000000;
    address public feeCollector;

    function initialize() public initializer {
        __ERC20_init("RektSkulls", "REKT");
        __Ownable_init();
        addWhiteList(msg.sender);
        super._mint(msg.sender, INITIAL_SUPPLY * (10 ** 18));
    }

    function burn(uint256 amount) public {
        require(amount <= balanceOf(msg.sender), "Amount smaller than");
    ...
    function setFeeCollector(address _collector) public onlyOwner {
        require(_collector != address(0), "Address can't be zero");
