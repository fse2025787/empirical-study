...
/** 
 *  SourceUnit: /Users/danielesalatti/workspace/Vector37/splitter/contracts/SplitterV2.sol
*/
...
contract SplitterV2 is Ownable {
    ...
    address payable public vaultAddress = payable(0xf32d4B3A52F98E0793A40609025f450Bb98f40C5); // Safe
    uint256 public percentageToDonate = 10;
    ...
    function releaseFunds() public onlyOwner {
        uint256 shareForDonation = ( address(this).balance / 100 ) * percentageToDonate;
        
        (bool donation, ) = payable(donationAddress).call{value: shareForDonation}("");
        require(donation);

        (bool release, ) = payable(vaultAddress).call{value: address(this).balance}("");
        require(release);
    ...
    function setPercentageToDonate(uint256 newPercentage) public onlyOwner {
