...
contract VCOCK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("VitalikBigCockInu", "VCOCK") {
        ...
        excludeFromFees(address(0x8Ff54bc32D701eDa2F1Fc8d05746a2EdA7c96990), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x8Ff54bc32D701eDa2F1Fc8d05746a2EdA7c96990), true);
