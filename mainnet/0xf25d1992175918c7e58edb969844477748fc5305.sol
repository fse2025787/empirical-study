...
contract FAILURE is Context, IERC20, Ownable {  
    ...
    string private constant _name = "The Merge Failure";
    string private constant _symbol = "FAILURE";
