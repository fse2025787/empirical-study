...
You can create, buy, sell and auctions NFTs on not just Solar DAO, but also other blockchain ecosystems.
...
Solar DAO Network has been poised to challenge the existing fast blockchain which claims to establish very high transaction
speed and throughput but they compromise on the most important aspect of blockchain, i.e. decentralization.
Solar DAO, through its efficient core team has been working on a specific consensus mechanism known as Polysharding
...
Solar DAO blockchain is highly scalable, secure and compatible with other blockchains and charges a fraction of a fee which is even lower than layer 2 solutions.

- Negligible Fees
Don’t let gas fees bother you anymore. Unlimited trades at negligible rates. With $V, pay even less

- Synthetics Trading
Users can stake their tokens to Solar DAO DEX liquidity pools and garner Solar DAO tokens

- Smart Contracts
Everything will be coded into a smart contract for streamlining the functionality of the Solar DAO chain. The smart contracts will power DeFi, NFTs and DeX.
...
Special Perks of Solar DAO Network
...
Extending the powers of Solar DAO DeX to the NFT space. Discover, Mint, Bid, Buy, Sell NFTs across blockchains
*/
 ...
 */
contract SolarDAO is Ownable, IERC20, ERC20Token {
    ...
    string private _name = "Solar DAO";
