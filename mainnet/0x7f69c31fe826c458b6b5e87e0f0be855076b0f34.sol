...
If you see this, you're ready to exit the matrix. 

Understand, if you can. Only if you're ready you will.
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 10000 minutes;
...
contract $0010110 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "0010110";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "0010110";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets justa djust 3. 
    ...
    uint256 public liquidityFee    = 0; //fees.
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xa57368B89A7a98B87f4364824293BB3A80594256;
        marketingFeeReceiver = 0xa57368B89A7a98B87f4364824293BB3A80594256;
