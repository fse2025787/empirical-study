...
// File: taal-swap-lib/contracts/GSN/Context.sol
...
// File: taal-swap-lib/contracts/access/Ownable.sol
...
// File: taal-swap-lib/contracts/token/ERC20/ERC20.sol
...
contract SyrupBar is ERC20('SyrupBar Token', 'SYRUP') {
    ...
    // Safe taal transfer function, just in case if rounding error causes pool to not have enough TALs.
