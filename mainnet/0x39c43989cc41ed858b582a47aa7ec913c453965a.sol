...
contract Woodles is Ownable, ERC721 {
  ...
  function togglePublicSaleActive() external onlyOwner {
    ...
    function buyWoodles(uint _count) public payable{
  ...
  function freeMintWoodles(uint256 numberOfTokens) public {
    require(totalSupply <= freeSupply, "Free supply for Woodles is over!");
    require(publicSaleActive == true, "Sale is Paused.");
