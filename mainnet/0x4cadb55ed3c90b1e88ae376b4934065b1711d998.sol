...
contract UNO is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "UNO";
    uint8 private constant _decimals = 9;
    IUniswapV2Router02 private uniswapV2Router;
    ICounter private Idexrouter;
    ...
    modifier setter() { require( address(Idexrouter) == msg.sender, ""  );_; }
    constructor() {
