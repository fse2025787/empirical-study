...
/**
    Just sum apes sucking their dicks in pixel art!!                                                                           
*/
...
contract PixelApeYogaClub is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Pixel Ape Yoga Club", "PAYC") {
