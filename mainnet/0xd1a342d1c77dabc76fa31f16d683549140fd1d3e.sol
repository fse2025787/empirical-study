...
contract ASAITAMA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "APE SAITAMA";//
    string private constant _symbol = "ASAITAMA";//
    ...
    address payable private _developmentAddress = payable(0xC790A039C245426898787EEb21b82AA1909fC24A);//
    address payable private _marketingAddress = payable(0x87e4fB945218487aefF48F75AE4784efCa5916FB);//
