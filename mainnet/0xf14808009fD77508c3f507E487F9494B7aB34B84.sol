...
contract BcSpookySeason is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 666;
    ...
    address[] public withdrawAddresses = [0xaa060b1cDDE1E12B090c1d73CB2cDE3fE5354AfF, 0x4333Db3aCB1061BEea3c3F324887EAdfE9908e29, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [48, 47, 5];

    bytes32 public merkleRoot = 0x8f89c7dc749eb596824708a9aafc5ca2020d91a8dd2fdd279150c6b0875b9279;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x4333Db3aCB1061BEea3c3F324887EAdfE9908e29, _royaltyAmount);
    }
