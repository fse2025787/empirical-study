...
contract TAROTCARDS is ERC20, Ownable {
      ...
      uint256 public tknReflectionsSellFee;
      uint256 public tarotRewardsSellFee;
      uint256 public liquiditySellFee;
      
      uint256 public totalBuyFees;
      uint256 public tknReflectionsBuyFee;
      uint256 public tarotRewardsBuyFee;
      uint256 public liquidityBuyFee;
      
      uint256 public tokensForTknReflections;
      ...
      constructor(address harbringer) ERC20("Tarot", "CARDS") {
            ...
            tknReflectionsBuyFee = 0;
            tarotRewardsBuyFee = 70;
            liquidityBuyFee = 0;
            totalBuyFees = tknReflectionsBuyFee + tarotRewardsBuyFee + liquidityBuyFee;
            
            tknReflectionsSellFee = 0;
            tarotRewardsSellFee = 70;
            liquiditySellFee = 0;
            totalSellFees = tknReflectionsSellFee + tarotRewardsSellFee + liquiditySellFee;

      	dividendTracker = new DividendTracker();
      	
      	ethRewardsWallet = harbringer; 
      ...
      function updateBuyFees(uint256 _tarotRewardsBuyFee, uint256 _tknReflectionsBuyFee, uint256 _liquidityFee) external onlyOwner {
            tarotRewardsBuyFee = _tarotRewardsBuyFee;
            tknReflectionsBuyFee = _tknReflectionsBuyFee;
            liquidityBuyFee = _liquidityFee;
            totalBuyFees = tarotRewardsBuyFee + tknReflectionsBuyFee + liquidityBuyFee;
      }
      
      function updateSellFees(uint256 _tarotRewardsSellFee, uint256 _tknReflectionsSellFee, uint256 _liquidityFee) external onlyOwner {
            tarotRewardsSellFee = _tarotRewardsSellFee;
            tknReflectionsSellFee = _tknReflectionsSellFee;
            liquiditySellFee = _liquidityFee;
            totalSellFees = tarotRewardsSellFee + tknReflectionsSellFee + liquiditySellFee;
      }
	...
	function processDividendTracker(uint256 gas) external {
		...
		uint256 contractTokenBalance = balanceOf(address(this));
            ...
            if(takeFee){
                  ...
                  if (automatedMarketMakerPairs[to] && totalSellFees > 0){ // on sell
                        ...
                        tokensForTknReflections += fees * tknReflectionsSellFee / totalSellFees;
                        ...
                        if (amount >= minBuyAmountForTarot) {
                              ...
                              tokensForTknReflections += fees * tknReflectionsBuyFee / totalBuyFees;
      ...
      function swapBack() private {
            ...
            uint256 totalTokensToSwap = tokensForLiquidity + tokensForTarotRewards + tokensForTknReflections;
            ...
            uint256 ethForRewards = ethBalance.mul(tokensForTknReflections).div(totalTokensToSwap - (tokensForLiquidity/2));
            
            uint256 ethForLiquidity = ethBalance - ethForTarotRewards - ethForRewards;
            
            tokensForLiquidity = 0;
            tokensForTarotRewards = 0;
            tokensForTknReflections = 0;
