...
contract KINA is ERC20, Ownable {
    ...
    constructor() ERC20("Kina Inu", "KINA") {
        ...
        mktgWallet = address(0x626C272b8B41eA87A702262db656459046001554); 
        devWallet = address(0x626C272b8B41eA87A702262db656459046001554); 
        liqWallet = address(0x0251b662Eac316E0a0101bACa37658875087d965); 
        operationsWallet = address(0x626C272b8B41eA87A702262db656459046001554);
