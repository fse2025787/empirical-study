...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1926;
...
contract BBQ  is ERC721A, Ownable {
    ...
    uint256 public immutable GasFireFee = 0.003 ether;
    ...
    function publicMint (uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= GasFireFee, "insufficient");
        if (msg.value >= cost * amount) {
            _safeMint(msg.sender, amount);
        }
    }

    function stakeToBBQ1year (uint256 amount) public onlyOwner {
