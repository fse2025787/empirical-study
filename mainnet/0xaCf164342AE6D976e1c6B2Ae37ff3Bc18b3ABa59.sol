...
contract MadRobots is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant TOKEN_PRICE = 70000000000000000; //0.07ETH in wei
   ...
   */
  constructor() ERC721("MadRobots","MADS") {
    //setBaseURI(baseURI);
  }
  ...
  function mint(uint256 numTokens) external payable nonReentrant {
    ...
    require(numTokens > 0 && numTokens <= 10, "Must mint from 1 to 10 NFTs");
