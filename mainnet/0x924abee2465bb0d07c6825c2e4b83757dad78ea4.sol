...
https://t.me/EtherDeltaPro_ERC
https://twitter.com/EDprotocol_erc
https://etherdeltaprotocol.com/
...
contract EDP is ERC20, Ownable {
    ...
    constructor() ERC20("EtherDelta Protocol", "EDP") {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xDED4E66fBa192B369CD459966DC21F9E93Cd29Bb,
            block.timestamp
        );
    }
