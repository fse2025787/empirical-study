...
/*
    ...
    Supply : 1,000,000,000 DRAGONKING
    Max Buy : 2% (0.04 ETH)
    Max Wallet : 3.5%
    INITIAL LP : 2 ETH

    TOKENOMICS (TOTALTAX : 10% )
    AutoLiquidity = 2% , Marketing = 5% ,Development = 3% 
...
contract DEGENDRAGONKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEGEN DRAGON KING";

    string private _symbol = "DEGENKING";

    uint8 private _decimals = 9;

    uint256 private _totalSupply = 1000000000 * 10**9;

    uint256 public maxbuy = 20000000* 10**9;  

    uint256 public maxwallet = 35000000 * 10**9;  
    ...
    address payable public marketingwallet = payable(0x188625dd55403Bd73f8b7c520068b3E662c6E78F); 
    address payable public developmentwallet = payable(0x6DACd4D4801D7B4373532364476B1e84302B0db7); 
