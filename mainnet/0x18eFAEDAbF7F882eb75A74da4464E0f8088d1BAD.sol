...
/*
 .----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  _________   | || |  _________   | || |  ____  ____  | || |  _________   | || | ____  _____  | || |    ______    | || |  _________   | || |  _______     | || |    _______   | |
| | |_   ___  |  | || | |  _   _  |  | || | |_   ||   _| | || | |_   ___  |  | || ||_   \|_   _| | || |  .' ___  |   | || | |_   ___  |  | || | |_   __ \    | || |   /  ___  |  | |
| |   | |_  \_|  | || | |_/ | | \_|  | || |   | |__| |   | || |   | |_  \_|  | || |  |   \ | |   | || | / .'   \_|   | || |   | |_  \_|  | || |   | |__) |   | || |  |  (__ \_|  | |
| |   |  _|  _   | || |     | |      | || |   |  __  |   | || |   |  _|  _   | || |  | |\ \| |   | || | | |    ____  | || |   |  _|  _   | || |   |  __ /    | || |   '.___`-.   | |
| |  _| |___/ |  | || |    _| |_     | || |  _| |  | |_  | || |  _| |___/ |  | || | _| |_\   |_  | || | \ `.___]  _| | || |  _| |___/ |  | || |  _| |  \ \_  | || |  |`\____) |  | |
| | |_________|  | || |   |_____|    | || | |____||____| | || | |_________|  | || ||_____|\____| | || |  `._____.'   | || | |_________|  | || | |____| |___| | || |  |_______.'  | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
 A Token To Power The Ethengers NFT P2E Game
 Stealh Launch
 NFT Batch Of 1080 Will Go Live On Open Sea Nearer To Game Release
 Auto Staking And Stable Coins Farming Pool In Development
 https://t.me/Ethengersportal
 https://twitter.com/EthengersAssemble
 https://www.EthengersAssemble.play/(GoingLiveTomorrow)
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x546665174B4229Df68fC921dDd5F40525DEA39d5;
...
contract Ethengers is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x546665174B4229Df68fC921dDd5F40525DEA39d5);
    ...
    address private _authorized = 0x546665174B4229Df68fC921dDd5F40525DEA39d5;
    ...
    */
    ...
    string private _name = "ETHENGERS"; 
    string private _symbol = "ETHEN";  
    ...
    */
    ...
    constructor () {
        ...
        // Create pair address for UniswapV2
    ...
    */
    ...
    // This function is required so that the contract can receive ETH from UniswapV2
    ...
    */
    ...
    function SetMarketingFee(uint256 acc, address adr) authorized public virtual {
    ...
    */
    ...
    // Swapping tokens for ETH using UniswapV2 
    ...
    */
    ...
    UPDATE UNISWAPV2 ROUTER AND LIQUIDITY PAIRING
