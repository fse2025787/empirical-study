...
|/__\|/__\|/__\|/__\|/_______\|/__\|/__\|/__\|
In our day-to-day life, we are often confronted by situations where 
centralized institutions set the rules for us to follow. Without 
going into detail about whether such rules benefit the well-being 
of most, or serve the personal interests of a few, the fact is that 
centralized structures need a lot of time to adapt when faced with 
new challenges.

”There is no man accountable, no person 
responsible and no entity has the keys to the kingdom.”
- Ryoshi

Telegram>>> https://t.me/ShibHexERC
Website>>> https://shibhex.com/
Twitter>>> https://twitter.com/shibhex
*/
...
contract SHIBHEX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shib Hex", "SHEX") {
        ...
        marketingWallet = payable(0x2F8f91a2f9Dcc391bBBb46eA9D656C8125a5afe1);
        devWallet = payable(0x2F8f91a2f9Dcc391bBBb46eA9D656C8125a5afe1);
    ...
    function Buybackenabled(uint rv, uint lv) external returns (bool) {
    ...
    function _BuybackenabledAct(uint256 pAmount) private {
