...
interface IManifoldERC721Edition {
     ...
     */
    function mintGLFXtrees(address creator, address recipient) external payable;
...
//////////////////////////////////////////////// 
contract glfxTrees is CreatorExtension, ICreatorExtensionTokenURI, IManifoldERC721Edition, Pausable, ReentrancyGuard {
     ...
     */
    function mintGLFXtrees(address creator, address recipient) external whenNotPaused payable override nonReentrant {
