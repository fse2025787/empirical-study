...
contract ProofofXen is ERC20, Ownable {
    ...
    constructor() ERC20("Proof of Xen", "POX") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x0C1ABDea3b9bd618dB774832F7cAB06c91F41Cc3); // marketing wallet
        devWallet = address(0x0C1ABDea3b9bd618dB774832F7cAB06c91F41Cc3); // dev wallet
