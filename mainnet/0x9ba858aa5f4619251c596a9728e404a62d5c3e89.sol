...
contract ABYSS is Context, IERC20, Ownable {
    ...
    string private constant _name = "ABYSS";
    string private constant _symbol = "ABYSS";
    ...
    address payable private _developmentAddress = payable(0x88059Ca5c60D4A709C40D6e5F8995A788Fe5bC9D);
    address payable private _marketingAddress = payable(0x88059Ca5c60D4A709C40D6e5F8995A788Fe5bC9D);
    ...
    uint256 public _maxTxAmount = 6666 * 10**9; //1
    uint256 public _maxWalletSize = 6666 * 10**9; //1
    uint256 public _swapTokensAtAmount = 6666 * 10**9; //1
