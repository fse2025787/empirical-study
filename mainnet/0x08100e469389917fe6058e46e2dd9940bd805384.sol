...
contract OGSHIB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shib Origin";
    ...
    address payable private _developmentAddress = payable(0x49466a1688CC8E27da6f74fE7A0335e249415009); 
    address payable private _marketingAddress = payable(0x49466a1688CC8E27da6f74fE7A0335e249415009);
