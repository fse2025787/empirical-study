...
/**
Shiboku is the next big shiba to join the family!
This is meant to be a full community driven token with only 2% buyback and burn fee.
Holders are free to create a community on social channels and partecipate to make this the ultimate community driven low tax token.
*/
