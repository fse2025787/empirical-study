...
/**
Iori is fully decentralized and owned by its fun, vibrant community. Our enthusiast volunteers welcome and embrace diverse perspectives to build Iori into the best community in crypto.
...
contract Ioritama is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 560000000000 * 10**18;
	uint256 private _maxWallet= 560000000000 * 10**18;
	...
	string private constant _name = "Iori Tama";
	string private constant _symbol = "IORI";
