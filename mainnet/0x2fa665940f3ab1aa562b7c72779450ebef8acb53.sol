...
contract Lino is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Lino";
    string private constant _symbol = "Lino";
    ...
    address payable private _developmentAddress = payable(0x3590334E013aDcFF9e635ae0b776c2EAeFd9d0a6); 
    address payable private _marketingAddress = payable(0x3590334E013aDcFF9e635ae0b776c2EAeFd9d0a6);
