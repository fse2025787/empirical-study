...
contract Xmas is ERC20, Ownable {
    ...
    uint256 private _totalSupply = 100_000_000_000_000 * 10 ** 9;
    uint256 public _maxWalletAmount =  1_500_000_000_000 * 10 ** 9;
    uint256 public buyFee = 98;
    uint256 public sellFee = 98;
    bool inSwapAndLiquify;
    uint256 public ethPriceToSwap = 100000000000000000; 
    address private _santaSac = 0x8A3306FdFa44fAbCA27eF11F915294a0eC9ef59c;
    address private _team = 0x114eE7F6432d49477Eb10054912fD9C94A3E3230;
    address private _charity = 0x89c25aCAFd69E9305634Ffe713966df9E2152c84;
    uint256 public _santaSacAmount = 30;
    uint256 public _teamAmount = 30;
    uint256 public _charityAmount = 10;
    uint256 public _lpShareAmount = 15; //the other half will be ETH
    address public deployer;
    uint256 public lastChosenRandomNumber = 0;
    
    constructor() ERC20("XMAS", "XMA$") {
   ...
   function swapTokensForEth(uint256 tokenAmount) private {
        ...
        uint256 santaSac = balance.mul(_santaSacAmount).div(100);
        uint256 team = balance.mul(_teamAmount).div(100);
        uint256 charity = balance.mul(_charityAmount).div(100);
        uint256 liquidityEth = balance.mul(_lpShareAmount).div(100);
        payable(_santaSac).transfer(santaSac);  
        payable(_team).transfer(team);  
        payable(_charity).transfer(charity);  
    ...
    function setWalletAddresses(address santaSac, address team, address charity) external onlyOwner {
        _santaSac = santaSac;
        _team = team;
        _charity = charity;
    }

    function setShare(uint256 santaSac, uint256 team, uint256 charity, uint256 lpShare) external onlyOwner {
        _santaSacAmount = santaSac;
        _teamAmount = team;
        _charityAmount = charity;
