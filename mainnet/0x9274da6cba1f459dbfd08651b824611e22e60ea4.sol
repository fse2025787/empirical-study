...
contract STAR is ERC20, Ownable {
    ...
    constructor() ERC20("The Ancient Star", "STAR") {
        ...
        treasuryWallet = address(0xD220E5d475877a94360eFc85f58567eDc4000349); // set as treasury wallet
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyTreasuryFee + buyLiquidityFee;
        require(buyTotalFees <= 99, "Must keep fees at 100% or less");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellTreasuryFee + sellLiquidityFee;
        require(sellTotalFees <= 99, "Must keep fees at 100% or less");
    }
