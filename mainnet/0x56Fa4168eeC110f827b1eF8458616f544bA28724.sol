 ...
 * @notice This contract handles minting Women's entrance Key Pass tokens.
 */
contract LaunchpadWomensEntranceKeyPass is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x40773F02A7BE411b24cb4d475eE2C787A0702e92;
    address public royaltyAddress = 0xCe83A5553e4848127D5a8d99dbf4e2271Ae668a4;
    address[] public payoutAddresses = [
        0x56A4508698AdBb8AdAAE0B5ca063d0D66E1b9912,
        0xCe83A5553e4848127D5a8d99dbf4e2271Ae668a4,
        0xEDa68DA3f67D6C4e0426e4dA71B96d1985FBeA50
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeieu7ng7cszx5iwdf7f4o3fr4aakfb2rxchrmnqqtwvbewkt3xvomq/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 2300;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 2300;
    uint256 public presaleMintsAllowedPerAddress = 2300;
    uint256 public presaleMintsAllowedPerTransaction = 2300;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 2300;
    uint256 public publicMintsAllowedPerTransaction = 2300;
    ...
    uint256[] public payoutBasisPoints = [700, 8600, 700];
    uint96 public royaltyFee = 700;

    constructor() ERC721A("Women's entrance Key Pass", "KEY PASS") {
