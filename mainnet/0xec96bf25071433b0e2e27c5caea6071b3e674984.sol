...
contract MainContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Nabla";
    string private constant _symbol = "999";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0xce3FA5CC0C47c2E850B3c7148d6eb8b6bd9d7a46); 
