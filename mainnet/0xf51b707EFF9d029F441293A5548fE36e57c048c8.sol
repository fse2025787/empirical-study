...
contract LockerToken is ERC20, Ownable {
    ...
    constructor() payable ERC20("LOCKER", "LOCKER") {
        ...
        _createInitialSupply(address(this), (totalSupply * 5) / 100); // Tokens for liquidity
        _createInitialSupply(newOwner, (totalSupply * 20) / 100); // Airdrop old holders
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        ...
        require(
            ...
            "Cannot set max wallet amount higher than 4%"
        );
