...
//*********************************************************************//
//
//   ________            ___                        _                     ______      __    ___           
//  /_  __/ /_  ___     /   |  ____ ___  ___  _____(_)________ _____     / ____/___  / /_  / (_)___  _____
//   / / / __ \/ _ \   / /| | / __ `__ \/ _ \/ ___/ / ___/ __ `/ __ \   / / __/ __ \/ __ \/ / / __ \/ ___/
//  / / / / / /  __/  / ___ |/ / / / / /  __/ /  / / /__/ /_/ / / / /  / /_/ / /_/ / /_/ / / / / / (__  ) 
// /_/ /_/ /_/\___/  /_/  |_/_/ /_/ /_/\___/_/  /_/\___/\__,_/_/ /_/   \____/\____/_.___/_/_/_/ /_/____/  
//                                                                                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x057e059eCB60A2012b75513e79B99Ad2fEd30259];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x057e059eCB60A2012b75513e79B99Ad2fEd30259;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 1776) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZJEBCnvVJSrc2JyJFTAVzoYkQA7hwop3noBY63V2YDnP/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1776");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1776");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1776");
...
// File: contracts/TheAmericanGoblinsContract.sol
//

pragma solidity ^0.8.0;

contract TheAmericanGoblinsContract is RamppERC721A {
    constructor() RamppERC721A("The American Goblins", "AMGB"){}
}
