...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xe8802dbb0e2bEB56b87c5a530fc01A997B17f903] = _marketingwallet;
    }
...
contract LaTortuga is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("La Tortuga", "SLWNSTDY") {
        ...
        excludeFromFees(address(0xe8802dbb0e2bEB56b87c5a530fc01A997B17f903), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xe8802dbb0e2bEB56b87c5a530fc01A997B17f903), true);
