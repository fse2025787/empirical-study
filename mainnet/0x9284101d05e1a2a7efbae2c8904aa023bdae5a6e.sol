...
contract DegenGamersClub is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit {
    constructor()
        ERC20("Degen Gamers Club", "DGC")
        ERC20Permit("Degen Gamers Club")
    {
