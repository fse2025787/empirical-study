...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/utils/Strings.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/utils/EnumerableMap.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/utils/EnumerableSet.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC721/IERC721Receiver.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC721/ERC721Holder.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC721/IERC721.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC721/IERC721Enumerable.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC721/IERC721Metadata.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/token/ERC721/ERC721.sol
...
contract Dvision_721dvi is ERC721, ERC721Holder, Ownable
{
    using SafeMath for uint256;
    
    constructor(address _erc20, address payable _fee_addr, string memory _uri) ERC721("DVI 721", "DVI721") Ownable() ERC721Holder() public {
    ...
    function MintTo(address _to) public onlyOwner returns(uint256, address)
    {
        Item memory _Item = Item({
            price : 0,
            currency : 0,
    ...
    function Sell_Item(address _marketaddress, uint _tokenId, uint256 _price, uint8 _currency) public 
    {
        require(ownerOf(_tokenId) == msg.sender, "you are not owner of this token.");
        
        if(_items[_tokenId].forSale == false)
        {
            _currentSaleAmount++;
        }
    ...
    function Transaction_Item(address _to, uint _tokenId) external payable {
        ...
        require(_items[_tokenId].forSale == true, "This token is not for sale.");
        ...
        {
            owner.transfer(_items[_tokenId].price * (1 - fee_percent / 100));
            fee_addr.transfer(_items[_tokenId].price * (fee_percent / 100));
        }
    ...
    //_to : buyer
    function Transaction_Item_WithToken(address _to, uint _tokenId, uint256 _price) external {
    ...
    function Get_Items(uint _tokenId) 
    public
    view 
    returns(uint _id, uint256 _price, uint8 _currency, bool _forSale, address _owner)
    {
        _id = _tokenId;
    ...
    function Get_SellingItems() public view returns(uint[] memory, uint[] memory, uint[] memory)
    {
        ...
        for(_tokenId = 1; _tokenId < _maxTokenId + 1; _tokenId++)
        {
            if(_items[_tokenId].forSale == true)
            {
    ...
    function Change_Owner(address _addr) public onlyOwner returns(address)
    {
    ...
    function Set_BaseURI(string memory _new) onlyOwner public returns(string memory)
    {
        _setBaseURI(_new);
        return baseURI();
    }
