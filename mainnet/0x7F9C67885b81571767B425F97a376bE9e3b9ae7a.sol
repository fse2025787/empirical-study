...
contract VarenRouter is ReentrancyGuard {
    ...
    function swap(
        ...
        if (burnToken == address(0)) {
            ...
            burnRenToken(vars.swappedAmount, burnAmount, burnToken, burnSendTo);
        }
    }
    ...
    function burnRenToken(
        ...
        uint256 amountToBurn = swappedAmount > 0 ? swappedAmount : burnAmount;
        registry.getGatewayByToken(burnToken).burn(burnSendTo, amountToBurn);
