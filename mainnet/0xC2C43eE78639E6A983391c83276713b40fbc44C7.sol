...
contract NOBU is Context, IERC20Upgradeable {
    ...
    uint256 private maxReflectFee = 25;
    uint256 private maxLiquidityFee = 25;
    uint256 private maxMarketingFee = 25;

    uint256 public _liquidityRatio = 0;
    uint256 public _marketingRatio = 0;

    uint256 private masterTaxDivisor = 100;
    ...
    function intializeContract(address payable setMarketWallet, address payable setDevWallet, string memory _tokenname, string memory _tokensymbol) external onlyOwner {
        ...
        if (startingSupply < 1000000000000) {
            _decimals = 18;
        ...
        _maxWalletSize = (_tTotal * 30) / 1000;
        maxWalletSizeUI = (startingSupply * 30) / 1000;
