...
contract RealPig is ERC721A, Ownable {
    using Strings for uint256;

    address private constant TEAM_ADDRESS = 0x38c06d604226d5e92393CB4e9B94BE43f54dcB77;

    uint256 public constant maxSupply = 516;
    uint256 public constant TEAM_CLAIM_AMOUNT = 11;

    uint256 public TOTAL_FREE_SUPPLY = 36;

    uint256 public  MAX_PUBLIC_PER_TX = 5;
    uint256 public  MAX_PUBLIC_MINT_PER_WALLET = 15;
    ...
    constructor() ERC721A("RealPig", "PIG") {
    ...
    function advisorDeliver(address[] calldata boardAddresses, uint256 _quantity) external onlyOwner {
