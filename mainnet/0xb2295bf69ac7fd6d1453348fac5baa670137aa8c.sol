...
contract pathoftime is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Path Of Time", "POT") {
    ...
    function limitsLifted() external onlyOwner returns (bool){
