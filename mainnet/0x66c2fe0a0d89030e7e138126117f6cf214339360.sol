...
contract DegenHumanoids is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 265;
    string public baseURI = "https://nftstorage.link/ipfs/QmSZhwUbjVpS8VABYSUDmQthHxbb8QrjNkVs9LHNdGeWoc/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Degen Humanoid", "DH", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function SuperMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
