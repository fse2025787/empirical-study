...
contract ComfortCoin is Context, IERC20, Ownable {
    ...
    string private _name = 'Comfort Coin';
    string private _symbol = 'Comfort';
    ...
    address payable public _marketingWalletAddress = payable(0xd2435BecA24b42Aa473815eDB4AB1f919aE542dB);
    ...
    uint256 private _numOfTokensToExchangeForMarketing = 1000000000 * 10**9;
