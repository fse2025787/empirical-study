...
interface IMutantmoneysociety is IERC721Enumerable {
...
contract Mutantmoneysociety is Context,Ownable, ERC165,IMutantmoneysociety, IERC721Metadata {
    ...
    uint256 public  MAX_NFT_SUPPLY_PRESALE = 3333 ;
    uint256 public  MAX_NFT_SUPPLY_FULLSALE = 9999 ;
    uint256 public VIP_WHITELISTING_SUPPLY = 500;


    uint256 public  MAX_NFT_ATONCE_PRESALE = 4;
    uint256 public  MAX_NFT_ATONCE_FULLSALE = 6;

    uint256 public WLtracker = 0;
    uint256 public VIP_WHITELISTING_SUPPLY_counter = 0;


    uint256 public MMSNFTPrice =       88000000000000000; // 0.088 ETH
    uint256 public VIPAccessPrice =    10000000000000000; // 0.010 ETH
   ...
   */
     ...
     * @dev Initializes the contract by setting a `name` and a `symbol` to the token collection.
     ...
     _baseURI = "https://mutantmoney.herokuapp.com/api/v1/arts/";
     _baseURI = "https://www.mutantmoney.art/api/v1/arts/";
       ...
       public payable

        {
         ...
         require(FullSaleOK, "Sale is not active");
          ...
          require(MMSNFTPrice.mul(numberOfNfts) == msg.value, "Ether value sent is not correct - wow" );
    ...
    function BulkManualMint(address to, uint256 msize) public onlyOwner {
        ...
        require(totalSupply().add(msize) <= MAX_NFT_SUPPLY_FULLSALE, "Exceeded collection size supply");
   ...
   function getSum(uint256[] memory arr) public view returns(uint)
   {
    ...
    function BulkManualMintFromList(address[] memory addresses, uint256[] memory msizes) public onlyOwner {
        ...
        require(totalSupply().add(sumarray) <= MAX_NFT_SUPPLY_FULLSALE, "The sum of tokens added exceeds current supply");
