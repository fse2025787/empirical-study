...
contract DegenBrickers is ERC721A, Ownable {
	...
	constructor() ERC721A("Degen Brickers", "DegenBrickers") {
		setBaseURI("http://api.degenbrickers.com/degen/");
	}
