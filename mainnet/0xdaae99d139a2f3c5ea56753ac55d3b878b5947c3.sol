 ...
 * allowances. See {IERC20-approve}.
 */
contract DeFIFA is ERC20, Ownable {
    string private constant _name = "DeFIFA WORLD CUP";
    string private constant _symbol = "DeFIFA";
    uint8 private constant _decimals = 18;
    uint256 private constant _supply = 100000;

    uint256 public buyTaxForLiquidity = 2;
    uint256 public buyTaxForMarketing = 2;
    uint256 public buyTaxForGiveaway = 2;
    uint256 public sellTaxForLiquidity = 2;
    uint256 public sellTaxForMarketing = 10;
    uint256 public sellTaxForGiveaway = 10;

    uint256 public maxTxAmount = 1000 * 10**_decimals;
    uint256 public maxWalletAmount = 1000 * 10**_decimals;
    address public marketingWallet = 0x2Ea07bE80B43a9751420b2b905a821DeF7F5EEe5;
    address public giveawayWallet = 0x10084c0f07494Cc5145e841050334F392d68a446;
    uint256 private _numTokensSellToAddToLiquidity = 100 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 50* 10**_decimals;
