...
contract EvilSquid is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Evil Squid Game";
    string private constant _symbol = "EvilSquid";
    ...
    address payable private _developmentAddress = payable(0x7355E81b7921a34d6d149283Ee5d4bf6203904AC); 
    address payable private _marketingAddress = payable(0x7355E81b7921a34d6d149283Ee5d4bf6203904AC);
