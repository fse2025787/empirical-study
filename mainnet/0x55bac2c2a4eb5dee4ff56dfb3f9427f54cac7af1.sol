...
contract MetaCraftInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "MetaCraftInu";
    string private _symbol = "MCI";
    ...
    uint256 public _taxFee = 1; // means 1% which distribute to all holders
    uint256 public _liquidityFee = 8; // means 8% add liquidity on each buy and sell
    uint256 public _burnFee = 0; // means 0% it means burn 0%
    
    
    address liquidityWallet=0x076066CE006ab94Ab1Aba5072b95A42017c6fE36;
