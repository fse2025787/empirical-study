...
{
    using SafeERC20Upgradeable for IChronosUpgradeable;
    IAdventurer public adventurerContract;
    IChronosUpgradeable public chronosContract;
    ...
    function initialize(
        ...
        IChronosUpgradeable _chronosContract,
        address _adminAddress
    ) external payable initializer {
        if (
            (_adventurerContract == IAdventurer(address(0))) ||
            (_chronosContract == IChronosUpgradeable(address(0))) ||
        ...
        SHARED_SUMMON_REWARD = 150 ether;
        grantChronos = true;
    }
    ...
    function _summon(
        ...
        if (selectedOption == SummonOption.HoldingUnclaimed) {
            ...
            chronosContract.safeTransferFrom(msg.sender, address(this), cost);
            adventurerContract.summon(token1, token2, true);
        }
