...
https://t.me/HibakushaToken

Token Name: The Burn Community

Ticker: Hibakusha

Supply: 1,000,000

Initial ETH liquidity: 4 eth
...
note: LP will be lock before we open trade to ensure that your liquidity is safe,
        renouncing is not an issue because tax is fixed and no way to change... 
        we dont have fee modifier in the code.
        C.A will be verified for your assurance.
        please join our official TG for more updates...
...
contract Hibakusha is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Burn Community";
    string private constant _symbol = "Hibakusha";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 1000000 * 10 ** _decimals;
    uint256 private maxTxAmount = 25000 * 10 ** _decimals; //Max Tx 2.5%
    uint256 private maxWalletAmount = 50000 * 10** _decimals; //Max Wallet 5%
    ...
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD; //for burning of supply
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x3FA402E306fE1eF1eA0402f18F41c3FC805FcFe2); 
    ...
    // set max Tx and max Wallet = to total supply
    function removeLimits() external onlyOwner {
         maxTxAmount = _tTotal;
        maxWalletAmount = _tTotal;
    } 

    // lift max Tx and max Wallet to specific amount 
