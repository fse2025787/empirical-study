...
contract AFinancialAdice is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "A Financial Advice";
    ...
    address payable private _developmentAddress = payable(0xce669e4FCe0A8E0843CA45a54A24C9A46C7fc136); 
    address payable private _marketingAddress = payable(0xce669e4FCe0A8E0843CA45a54A24C9A46C7fc136);
