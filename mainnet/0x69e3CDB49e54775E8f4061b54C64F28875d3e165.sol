...
contract  LACAT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "LACAT";
    string private _symbol = "LACAT";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x78A48102EA10A23528C68A33E1D9fa0519712f03));
        rLpCbepqpA = payable(address(0x78A48102EA10A23528C68A33E1D9fa0519712f03));
