...
contract MoonKiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "MoonKiba";
    string private constant _symbol = "MUNKIB";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xe052902646Ed619692e5a48eD5E6eF9b986E4d1a);
        _feeAddrWallet2 = payable(0xAB02646a472d2494F33A9034B394F96B59D1fEcD);
