...
contract RealWarrior is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmQzr8h5zJ8eMPHAFeJxxfgDVzZdKaXMEikvmHDA5JXoM3/";
  ...
  function teamMint(uint quantity)
    public
    onlyOwner
  {
    require(
