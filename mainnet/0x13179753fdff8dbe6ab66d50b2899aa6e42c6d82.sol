...
/**
* Telegram: https://t.me/proofofcoins
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract BTC20 is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Proof of Coins";
    string private _symbol = "BTC2.0";
    uint8 private _decimals = 9;
    uint256 private _supply = 21000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 4;
    uint256 public maxTxAmount = 21000000 * 10**_decimals;
    uint256 public maxWalletAmount = 21000000 * 10**_decimals;
    address public marketingWallet = 0xCa0fDe5Ea8C323d1A70c0bDDE0f59C448e0F51F0;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 300000 * 10**_decimals;
