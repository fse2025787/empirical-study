...
contract RoP is Ownable, IERC20 {
    ...
    string private _name = "One Ring to rule them all, One Ring to find them, One Ring to bring them all and in the darkness bind them.";
    string private _symbol = "Ring of Power";
