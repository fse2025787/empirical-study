...
contract KujiraFund is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KujiraFund() {
        ...
        name = "KujiraFund";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "KUJI";                                             // Set the symbol for display purposes (CHANGE THIS)
