...
/*
    https://t.me/blackdragonai
    The next great dragon has taken flight
*/
...
contract BDAI is ERC20, Ownable {
    ...
    constructor() ERC20("Black Dragon AI", "BDAI") {
        ...
        maxTransactionAmount = 15 * 1e4 * 1e18; // 1.5% from total supply maxTransactionAmountTxn
        maxWallet = 20 * 1e4 * 1e18; // 2% from total supply maxWallet
        ...
        devWallet = address(0x5Fbe89d37b42b3870bf36d1149B821Ae47fC16a3);
        marketingWallet = address(0x5a9eFE75FCfe6bAc0FB6e060728C46fCA60a6F02);
