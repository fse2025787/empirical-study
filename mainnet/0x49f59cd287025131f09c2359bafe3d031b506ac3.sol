...
The real king of the jungle Metaverse

A deflationary token generating a 2% auto yield from reflections
...
contract LionKingInu is Context, IERC20, Ownable {
    ...
    string private _name = "Lion King Inu";
    string private _symbol = "LION";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 13;
