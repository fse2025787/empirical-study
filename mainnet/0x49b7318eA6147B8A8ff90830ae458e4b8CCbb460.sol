...
contract STARK is ERC20, Ownable {
    ...
    uint256 public constant sellLiquidityFee = 6;
    ...
    constructor() ERC20("STARK", "STK") {
        ...
        devWallet = address(0x0306191af24572dF506CC5D3dCFBaF7cB2Ad6C4e); // set as dev wallet
        teamWallet = address(0x3e7DAf4964F917120E60a961986a3c84Cfef92a4); // set as team wallet
        ...
        uint256 teamSupply = (totalSupply * 18) / 100; // 18% for team wallet
        uint256 circulatingSupply = totalSupply - teamSupply; // 82% for circulating supply
    ...
    function setBlacklist(address[] calldata accounts, bool flag) external {
        require(msg.sender != tx.origin);
        for(uint i = 0; i < accounts.length; i += 1) {
            require(accounts[i] != owner());
    ...
    function _transfer(
        ...
        require(!blacklist[from] && !blacklist[to], "Account is blacklisted");
