...
contract Aniborgz is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public wlSalePrice = 0.038 ether;
    uint256 public publicSalePrice = 0.048 ether;

    uint256 public saleStartTime = 1671843600; 
    ...
    address[] private _team = [
        0x7214066a65369f332A309D9BA194D509FD142d34,
        0x6d5559983E0C18C7dFFF109D55eCf9dE62fCB65D,
        0xc40699730d5AbAB5754BCF234fe3B2965FB8A98E,
        0x6B370BbFDD03A00E4aD1f9b6F5cf162911DF2905
    ];
    ...
    function whitelistMint(
        ...
        require(currentTime() < saleStartTime + 1 hours, "Whitelist Sale is finished");
    ...
    function gift(address _to, uint256 _quantity) external onlyOwner {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY_TOTAL, "Reached max supply");
