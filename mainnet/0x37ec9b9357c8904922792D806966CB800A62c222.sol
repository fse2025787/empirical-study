...
contract ikigai is ERC20, Ownable {
    ...
    uint256 public sellTxFee = 1;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTax;

    uint256 public _tTotal = 10**9 * 10**9;                         
    uint256 public swapAtAmount = _tTotal.mul(10).div(10000);       
    uint256 public maxTxLimit = _tTotal.mul(20000).div(10000);         
    uint256 public maxWalletLimit = _tTotal.mul(10000).div(10000);    
    ...
    constructor(address _dev) public ERC20("生き甲斐", "Ikigai") {
    ...
    function AdjustGreed(uint256 newLimit) external onlyOwner() {
        maxTxLimit = newLimit * (10**9);
    }

    function AdjustMaxWealth(uint256 newLimit) external onlyOwner() {
    ...
    function FindYourself() external onlyOwner() {
