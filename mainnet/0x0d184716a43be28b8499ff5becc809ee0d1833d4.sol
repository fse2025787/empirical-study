...
// “Degen isn’t a community, degen is a way of life”  @homeofdegen 
...
contract HOMEOFDEGEN is Context, IERC20, Ownable {
    ...
    uint256 public _maxwallet = 7 * 10**10 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    address payable public marketingWallet = payable(0x1f2173dC52e978523A54C3Ab36ec3AA4A9628988); 
    address payable public rewardsWallet = payable(0x1f2173dC52e978523A54C3Ab36ec3AA4A9628988); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "HOME OF DEGEN";
    string private _symbol = "HOD";
