...
/**
* telegram : https://t.me/vagabondinuentry
* twitter  : https://twitter.com/DevBushi
* website  : https://vagabondinu.com/
* Faith shall be rewarded, keep your Eyes open and you shall see past the appearances
*/
...
contract vainu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Vagabond Inu", "vainu") {
        ...
        marketingWallet = 0xF77F6066d7077B02d9f1c0B70C82fF557F32e051; // set as marketing wallet
    ...
    function enableTrading(uint256 deadBlocks) external onlyOwner {
        ...
        blockForPenaltyEnd = launchedAt + deadBlocks;
    }
