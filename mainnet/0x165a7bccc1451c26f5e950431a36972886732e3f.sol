...
contract THEHEARTOFDEFI is ERC20, Ownable {
    ...
    uint256 public buyDefiFee;
    uint256 public buyTotalFees;

    uint256 public sellBurnFee;
    uint256 public sellDefiFee;
    ...
    constructor() ERC20("The Hearth of DeFi", "HEARTH") {
        ...
        uint256 _buyDefiFee = 4;

        uint256 _sellBurnFee = 2;
        uint256 _sellDefiFee = 4;
        ...
        buyDefiFee = _buyDefiFee;
        buyTotalFees = buyBurnFee + buyDefiFee;
        
        sellBurnFee = _sellBurnFee;
        sellDefiFee = _sellDefiFee;
        sellTotalFees = sellBurnFee + sellDefiFee;
        
        devWallet = 0xFFb4e39EE7Aa34EcaeEeffcDa9C0042F7f18F17E;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _defiFee) external onlyOwner {
        buyBurnFee = _burnFee;
        buyDefiFee = _defiFee;
        buyTotalFees = buyBurnFee + buyDefiFee;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _defiFee) external onlyOwner {
        sellBurnFee = _burnFee;
        sellDefiFee = _defiFee;
        sellTotalFees = sellBurnFee + sellDefiFee;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellDefiFee / sellTotalFees;
            }
            ...
            // on buy
                ...
                tokensForDev += fees * buyDefiFee / buyTotalFees;
            }
