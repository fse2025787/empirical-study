...
contract MW is Context, IERC20, Ownable {
    ...
    string private constant _name = "MoonWalker";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5b074450d3Fa2A7900212CDA7f201F3023AaB7bB);
        _feeAddrWallet2 = payable(0x5b074450d3Fa2A7900212CDA7f201F3023AaB7bB);
