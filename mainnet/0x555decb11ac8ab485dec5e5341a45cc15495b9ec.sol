...
contract HajimeNoIppo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hajime No Ippo";
    string private constant _symbol = unicode"IPPO";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x99498C3Bf412E6674e089a985A7e9C5cf703DDC4);
        _feeAddrWallet2 = payable(0x99498C3Bf412E6674e089a985A7e9C5cf703DDC4);
