...
// https://t.me/sportsinueth
// https://sportsinueth.com
...
contract SportsInu is ERC20, Ownable {
    ...
    constructor() ERC20("Sports Inu", "SportsInu") {
        ...
        theBank = payable(0x4758F75c162AdcEC2169D59B13Edaca0E9fb3713); 
        liqOwner = payable(0x5e33B433B0ec727Fa17D3c63DD90B3882D5d5205);
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x5e33B433B0ec727Fa17D3c63DD90B3882D5d5205) &&
                !inTheZone
            ){
