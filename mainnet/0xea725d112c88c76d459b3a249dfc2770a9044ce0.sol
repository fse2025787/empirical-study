...
contract Exmachina is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xCAFc0fCeb0eB41ACA9F05E37d2f611ED82408AdC); // Marketing Address

    address payable public teamAddress =
        payable(0x51Df48b181A1d58F1840B617149373De3035212d); //  Development Address

    address payable public liquidityAddress =
        payable(0x51Df48b181A1d58F1840B617149373De3035212d); // Liquidity Address
    ...
    uint256 private constant _tTotal = 1 * 1e7 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "EXMACHINA";
    string private constant _symbol = "EXMACHINA";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 10 / 1000; // 1% maxWalletToken
        ...
        // Testnet
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
        //     0x347e2a75e99174d46D94B5D7b4BE8f294bc2F5Fc
        // );
    ...
    // Clear stucked Balance and send to _charityWalletAddress
    ...
    function enableTrading() external onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 30 minutes;
        }
    ...
    function setMinimumTokensBeforeSwapAmount(uint256 _minimum) external onlyOwner {
        minimumTokensBeforeSwap = _minimum;
    }
    function setMaxWallet(uint256 _maximum) external onlyOwner {
        maxWalletAmount = _maximum;
    }
    function setMaxTransaction(uint256 _maximum) external onlyOwner {
        maxTransactionAmount = _maximum;
    }
     ...
     if(limitsInEffect){
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // triple tax if bought in the same block as trading active for 30 minutes
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 40, "Must keep taxes below 40%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 40, "Must keep taxes below 40%");
