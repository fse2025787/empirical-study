...
contract MOKU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ICHIMOKU INU";
    string private constant _symbol = unicode"MOKU";
