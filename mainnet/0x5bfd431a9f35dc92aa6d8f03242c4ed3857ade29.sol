...
contract Anubis is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9C79603792A632bB6323a6bA928380D06D29AF97); 
    address payable public Wallet_Team = payable(0x9C79603792A632bB6323a6bA928380D06D29AF97);
    ...
    string private constant _name = "Anubis"; 
    string private constant _symbol = unicode"$ANUBIS"; 
    ...
    constructor () {
        ...
        _owner = 0x9C79603792A632bB6323a6bA928380D06D29AF97;
