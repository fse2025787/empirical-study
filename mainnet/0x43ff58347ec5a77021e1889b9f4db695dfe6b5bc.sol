...
https://twitter.com/randizuckerberg/status/1498425277734690816?s=20&t=HsXWl39j9Thhr-JzgCrr-A
...
contract RandiZuckerberg is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Randi Zuckerberg";
    string constant _symbol = "ZUCK";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x4cE6a3A958fd9F5D2Abd2eF508b21f7a06f995c7);
    ...
    function launchMode() internal view returns(bool) {
        return launchedAt !=0 && launchedAt + 3 < block.number && launchedTime + 10 minutes >= block.timestamp ;
    }
