...
contract GHC is ERC20, Ownable {
    ...
    constructor() ERC20("Galaxy Hero Creator", "$GHC") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        maxTransactionAmount = 1 * 10 ** 5 * 10 ** decimals(); 
        maxWallet = 1 * 10 ** 5 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xF9aF291A1F8Aa4afDf68692BB8b14f480Bb14758); // set as Marketing wallet
        DevWallet = address(0xF9aF291A1F8Aa4afDf68692BB8b14f480Bb14758); // set as dev wallet
