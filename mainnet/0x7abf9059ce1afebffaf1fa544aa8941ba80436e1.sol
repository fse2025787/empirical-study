 ...
 *
 *        
 *   $SHUNFU - Kung Fu Shiba
 *
 *   "To hit a target… is to exercise the inner strength."
 *
 *   https://www.shunfutoken.com/
 *   https://twitter.com/ShunFuOfficial
 *
 * 
 *                                                                           
 *                                                                           
...
contract SHUNFU is Context, IERC20, Ownable {
    ...
    address private devAndMarketingWallet;

    string private _name = "Kung Fu Shiba";
    string private _symbol = "SHUNFU";
    ...
    uint256 public _maxTxAmount = 1090000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 690000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 1990000000000000000000 * 10**9;
    ...
    function setDevAndMarketingWallet(address walletAddress) public onlyOwner {
        devAndMarketingWallet = walletAddress;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(devAndMarketingWallet).transfer(marketingshare);
