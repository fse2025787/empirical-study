...
/**
 * @title Goats with Hats contract
...
contract GoatsWithHats is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public          maxSupply         = 1220;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Goats With Hats", "GWH"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Goats...");
