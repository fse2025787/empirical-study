...
//  Just EGG | $JEGG
//
//  Totally an EGGsplosive Stealth Launch.
//
//    EGGsceptional!
//    TAX 7% (Reflection, buybacks, marketing, development)
//
//    Total supply is EGGsactly 100000000!
//    Max wallet 4000000
//    Max txn 2000000
//
...
//    https://just-egg.info/
//
//  You can’t buy happiness, but you can buy $JEGG which is basically the same thing.
//
//  DAPP & Utility to be revealed...
//
// 
...
contract JustEGG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Just EGG";
    string private constant _symbol = "JEGG";
    ...
    address payable private _developmentAddress = payable(0x308FBf6Ac2F4E797D6807E1cF2Ad068227cc0357);
