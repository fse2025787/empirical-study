...
Squid Bull ($SQB) is a meme token with clear and simple utility 
that the community might invest in with conviction. We are assembled
here with the confirmed moment of the bullrun next to us.

Telegram: https://t.me/squidbullcoin
Website: http://squidbull.com/
...
contract SquidBullERC20 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Squid Bull", "SQB") {
