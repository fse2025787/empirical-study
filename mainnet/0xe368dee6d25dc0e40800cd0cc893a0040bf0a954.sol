...
contract GenesisOfAngels is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://bafybeifvqxphmfooyigg35yg3vxmndpexvcqfe5422cdczm33v36n5qgty/";
    ...
    constructor(
    ) ERC721A("GenesisOfAngels", "ANGEL", 100, maxSupply) {
    }
