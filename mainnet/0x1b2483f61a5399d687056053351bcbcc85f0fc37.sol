...
Twitter: https://twitter.com/wreggtoken_
*/
...
contract WORLDRECORDEGG    is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 50* 10**6* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = '  WORLD RECORD EGG';
    string private _symbol = '$WREGG  ';
