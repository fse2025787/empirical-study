...
contract WTFDidIBuy is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmW9GKRvoE3iG58z1bY3fAosQbeTJPxxzoDTskX6fLBnGh/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0;
  uint256 public maxSupply = 5000;
  uint256 public maxMintAmountPerTx = 1;
  uint256 public freeUntil = 5000;
  ...
  constructor() ERC721A("WTFDidIBuy", "WTF") {
  }
