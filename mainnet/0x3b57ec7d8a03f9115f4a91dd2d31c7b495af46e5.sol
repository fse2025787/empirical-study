...
contract SWIFT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Swift Inu", "SWIFT") {
     ...
     uint256 totalSupply = 5 * 10 ** 5 * 10 ** decimals();
        ...
        MarketingWallet = address(0xeFA6FB0FB26bdC554F85e6969E21a1E3cF0D74e7); // set as Marketing wallet
        DevWallet = address(0xeFA6FB0FB26bdC554F85e6969E21a1E3cF0D74e7); // set as dev wallet
