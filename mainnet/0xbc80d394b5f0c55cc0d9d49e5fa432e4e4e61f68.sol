...
contract BoredApes444 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTq9BvJfDn3aR3jiyXtbqYbJ5FJGLYwSjbGtxFqk9Bn2M";
    ...
    constructor(
    ) ERC721A("BoredApes444", "444", 100, maxSupply) {
    }
