 ...
 * allowances. See {IERC20-approve}.
 */
contract YourKeysYourCoins is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Your Keys Your Coins";
    string private _symbol = "YOURS";
    uint8 private _decimals = 18;
    uint256 private _supply = 15000000;

    uint256 public buyTaxForLiquidity = 1;
    uint256 public buyTaxForMarketing = 3;
    uint256 public buyTaxForBurning = 0;
    uint256 public sellTaxForLiquidity = 1;
    uint256 public sellTaxForMarketing = 3;
    uint256 public sellTaxForBurning = 0;

    address public marketingWallet = 0x07FE1cd6945AbF464c7Fb37c4AEb894ff0C79D9e;

    uint256 public maxTxAmount = 450000 * 10**_decimals;
    uint256 public maxWalletAmount = 450000 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 150000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 75000 * 10**_decimals;
    // TOKENOMICS END ============================================================>
