...
**              CRIM PROTOCOL
**
**              Website:    https://www.crimprotocol.xyz/
**             
**              Database:   https://github.com/CRIM-PROTOCOL/CrimTracker
**
**              Manifest:   https://medium.com/@Crim_Protocol/crim-protocol-v-0-5-def-60dd5f307f2f
**
**              Twitter:    https://twitter.com/CrimProtocol
**
*/
...
contract CRIM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CRIM_PROTOCOL", "CRIM") {
        ...
        uint256 totalSupply = 25 * 1e12 * 1e18;
