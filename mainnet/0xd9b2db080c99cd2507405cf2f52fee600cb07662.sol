...
// Introducing $SNOW - Snowflake ! ❄

// Even in the most intense blizzards, each snowflake manages to be unique. We think 
// this sort of individuality is an extremely beautiful concept, and want to translate this
// through creating our own ERC-20 token. Amongst the massive quantity of other projects we're
// hoping to approach the market with our own, unique view. Join us as we slowly fall
// and start covering the ground of the meme-coin market!
