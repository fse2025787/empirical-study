...
/**
sonic and tails thought dr. eggman had all his eggs in one basket…  oh how wrong they were...

Stealthing soon…

https://ipfs.io/ipfs/QmdELxHtJdxcUVSR6BzqYoY9a7sSBbaP7b9nhk4JB3UXDL
...
/**
sonic and tails thought dr. eggman had all his eggs in one basket…  they were wrong… 

Stealthing soon…

https://ipfs.io/ipfs/QmW99KXckXYF8vMhm4tbaz8sZXNV5WL2qTFPFF44Ji5oxB
...
contract DREGGMAN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // standard variables
    string private _name = "Dr. Eggman";
    string private _symbol = unicode"EGGMAN🥚";
    ...
    uint256 private _currentBuyTax = 5; // modified depending on context of tx
    uint256 private _currentSellTax = 5; // modified depending on context of tx
    uint256 public _fixedBuyTax = 5; // unchanged save by owner transaction
    uint256 public _fixedSellTax = 5; // unchanged save by owner transaction
    ...
    function setBuyTax(uint256 tax) external onlyOwner {
        require(tax <= 15, "ERC20: tax out of band");
        _currentBuyTax = tax;
        _fixedBuyTax = tax;
    }
