...
contract DemonSquadNFT is Ownable, ERC721, ERC721URIStorage, PaymentSplitter {
    ...
    uint256 public tokenPrice = 0.024 ether;
    uint256 public whitelistTokenPrice = 0.0 ether;
    uint256 public maxWhitelistPassMints = 1200;
