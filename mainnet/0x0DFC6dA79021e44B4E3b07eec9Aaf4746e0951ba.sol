...
contract ParasiticByNoah is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Parasitic By Noah", "PBN") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmSTRbXt96VodcWPpbQEhUoW6bjBmYx1o3Y8A2NSvQbfg6/", _toString(tokenId), ".json"));
    }
