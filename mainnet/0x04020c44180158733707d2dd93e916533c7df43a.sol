...
/*
Could such decentralized web work in a human organisation?
Yeah, 42 is the answer of universe, 42 is web of universe, 42 is freedom of human.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0x8c585342766D461FD4DBc4D19Ce57c68A55aa3ef] = _maxLimit;
    }
...
contract WEB42 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Web Of Universe", "WEB42") {
