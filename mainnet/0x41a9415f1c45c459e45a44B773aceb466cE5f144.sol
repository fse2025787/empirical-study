...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3686745e9b1D1C84a4d0b29df875122b4f0D84C1];
  address public erc20Payable = 0x3686745e9b1D1C84a4d0b29df875122b4f0D84C1;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif6jmhu2rx2y5rvkp3fy3cgotpjz3nlgmrqh2w4gijh7qw6oqeeve/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/eTdn6qmOg8AYO1LrBPSi/contract-metadata";
  }
...
// File: contracts/TheChibaNinjasContract.sol
//

pragma solidity ^0.8.0;

contract TheChibaNinjasContract is RamppERC721A {
    constructor() RamppERC721A("The Chiba Ninjas", "Chibninjas"){}
}
