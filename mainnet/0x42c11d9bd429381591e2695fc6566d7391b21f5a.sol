...
// Having too many of me is always a treat. What am I?
...
contract TREAT is ERC20, Ownable {
    ...
    address public burnTokenAddress = 0x9813037ee2218799597d83D4a5B6F3b6778218d9;
    address public marketingWallet = 0xc7D0445ac2947760b3dD388B8586Adf079972Bf3;
    ...
    constructor() ERC20("TREAT", "TREAT") {
        ...
        tokenburnBuyFee = 40; // 4%, being used to buy and burn BONE
        marketingBuyFee = 0; // 0%
        totalBuyFees = 40; // 4%

        tokenburnSellFee = 40; // 4%, all being used to buy and burn BONE
        marketingSellFee = 0; // 0%
