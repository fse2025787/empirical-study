...
interface CurvePool {
    ...
    function add_liquidity(uint256[] memory amounts, uint256 _min_mint_amount, bool _use_underlying) external returns (uint256);
}
...
contract YVIBLevSwapperV1 {
    ...
    function swap(
        ...
        uint256[] memory amountsAdded = new uint256[](3);

        amountsAdded[2] = amountIntermediate;
