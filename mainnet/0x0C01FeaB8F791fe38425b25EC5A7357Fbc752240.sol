...
contract CosmicGundam is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public immutable MAX_SUPPLY = 444;
    uint16 public immutable MAX_PER_TX = 4;
    uint256 public PRICE = 0.004 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmVDw3pgrA6mFWGhB2SQPXHrGkDbJ7Ft3JDY2ftWJsoQ4T/";
