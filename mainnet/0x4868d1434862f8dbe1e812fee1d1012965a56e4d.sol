...
/*
    ...
    On the brink of WWIII. Modern nations invading one another and the world on edge.. Nuclear powers pitted against each other..
...
contract EndOfDays is Context, IERC20, Ownable {
    ...
    string private _name = "End Of Days";
    string private _symbol = "EOD";
