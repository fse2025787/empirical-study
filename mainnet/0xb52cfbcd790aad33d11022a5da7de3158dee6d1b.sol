...
// File: contracts/Artistocratsbycm.sol
...
contract Artistocratsbycm is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost_wl = 0.45 ether;
  ...
  constructor() ERC721("The Aristocrats", "WATA") {
    setHiddenMetadataUri("ipfs://bafybeifr2637auccqjejjhar3unsngijj7n7qde4v6wmtphxdtnjnvliji/hidden.json");
  }
  ...
  function mintWL(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(!paused, "The contract is paused!");
    require(msg.value >= cost_wl * _mintAmount, "Insufficient funds!");
  ...
  function crossmint(address _receiver) public payable mintCompliance(1) {
  ...
  function withdraw() public onlyOwner {
    // =============================================================================
    (bool hs, ) = payable(0x4F63dCDBcC06C86bBF84742A0bE479e6d934c40D).call{value: address(this).balance * 7 / 100}("");
    require(hs);
    // =============================================================================
