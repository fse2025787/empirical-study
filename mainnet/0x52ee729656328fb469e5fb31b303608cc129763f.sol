...
contract odds  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("1315", "1315") { //Left token name, right is symbol
        ...
        uint256 totalSupply = 1315 * 10**18;
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 10 / 1000)/10**18, "Cannot set maxTransactionAmount lower than 1.0%");
        maxTransactionAmount = newNum * (10**18);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 10 / 1000)/10**18, "Cannot set maxWallet lower than 1.0%");
