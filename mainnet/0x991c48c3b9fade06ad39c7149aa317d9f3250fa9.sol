...
contract Java is Context, IERC20, Ownable {
    ...
    string private constant _name = "Java Token / https://t.me/JavaERC20";
    string private constant _symbol = "JAVA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x420EE563936EEd9dA1757e3959E7535001680f47);
        _feeAddrWallet2 = payable(0x420EE563936EEd9dA1757e3959E7535001680f47);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xA28B49DD0dC0731A13e20197d9190699754340D4), _msgSender(), _tTotal);
    }
