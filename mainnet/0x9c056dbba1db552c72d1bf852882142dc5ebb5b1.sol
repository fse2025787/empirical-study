...
// File contracts/tokens/Lever.sol
...
contract Lever is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        __Pausable_init();
        __Ownable_init();
        __ERC20Permit_init("Lever");
        __UUPSUpgradeable_init();

        _mint(msg.sender, 35_000_000_000 * 10 ** decimals());
    }
