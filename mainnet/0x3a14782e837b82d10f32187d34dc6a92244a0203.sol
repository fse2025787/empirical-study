...
contract MonoVerse is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mono Verse";
    string private constant _symbol = unicode"MV";
