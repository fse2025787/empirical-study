...
contract Akumuai is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Akumuai", "Ak") {
        setBaseURI("");
    ...
    function getfreeAkumuai(uint256 _mintAmount) public payable nonReentrant{
    ...
    function getmanyakumuai(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
    ...
    function akumuaigift(uint256[] calldata quantity, address[] calldata recipient)
        external
        onlyOwner
    {
        require(
