...
Fable of Kijimuna 木の精 $KIJI 🌺

We're here to prove that crypto is not dead and that no matter how big or small your bank account is, if we're together, we are an unstoppable force of nature just like the 木の精  kijimuna.

Final tax will be 3/3 , with LP burned and renounced.

Social group will be updated in etherscan.
...
contract KIJI is Context, IERC20 { 
    ...
    address payable public Cam_Wallet = payable(0x4E1FF906D74ea5dd4A631F87AAa77F7B48b70EB2); 
    address payable public Dev_Wallet = payable(0x5d1734EE9aCA9b3B368F011Cb991a27Ef7580514);
    ...
    string private constant _name = unicode"Fable of Kijimuna 木の精"; 
    string private constant _symbol = unicode"$KIJI";
    ...
    uint256 public _Tax_On_Sell = 15;
    ...
    constructor () {
        ...
        _owner = 0x5d1734EE9aCA9b3B368F011Cb991a27Ef7580514;
