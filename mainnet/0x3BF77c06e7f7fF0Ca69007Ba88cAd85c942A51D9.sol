...
Website:
http://www.shinjimongoose.com

Twitter:
https://twitter.com/ShinjiMoongose

Telegram:
@ShinjiMongooseToken_Portal
...
contract SHINGOOSE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shinji Mongoose";//
    string private constant _symbol = "SHINGOOSE";//
    ...
    address payable private _developmentAddress = payable(0x66f1a8B4450780a53AF847606993a14c389B3797);//
    address payable private _marketingAddress = payable(0x66f1a8B4450780a53AF847606993a14c389B3797);//
    ...
    uint256 public _maxWalletSize = 700000 * 10**9; //
