...
contract AKINU2 is Context, IERC20, Ownable {
    ...
    string private  _name = "Akira Inu V2";
    string private  _symbol = "AKINU v2";
    uint8 private  _decimals = 9;

    //Taxes set higher during launch to hurt bots, adjusted down with afterpresale() 
    ...
    function _transfer(
        ...
        require(_antibot[from] != true,"ANTI BOT PROTECTION!");
