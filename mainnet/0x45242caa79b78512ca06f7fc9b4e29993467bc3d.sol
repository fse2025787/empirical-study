...
/**
    Solana Shiba ETH Token
    https://t.me/SolanaShibaERC20
*/
...
contract SolanaShiba  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x5CCaf835ea1feb615F874Cf50Bb7E2DbF5aDCCf0); // Marketing Address
    address payable public multiSigAddress = payable(0x6fFeC299CbD889Cd7Ad0e89ee17e834189343d7d); // Marketing Address
    address payable public devAddress = payable(0xD90cE773FD7FD91464c1d93655bA3CE6Bffe29C6); // Dev Address
    address payable public liquidityAddress = payable(0xD90cE773FD7FD91464c1d93655bA3CE6Bffe29C6); // Liquidity Address
    ...
    string private constant _name = unicode"Solana Shiba";
    string private constant _symbol = unicode"SolShib";
