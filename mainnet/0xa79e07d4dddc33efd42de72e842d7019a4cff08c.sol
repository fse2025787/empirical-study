...
// File: contracts/toRefuseMerge.sol
...
contract toRefuseMerge is ERC721A, Ownable {
    
    uint256 public maxSupply = 1994;
    ...
    constructor(string memory initBaseURI) ERC721A("toRefuseMerge", "tRM") {
        baseURI = initBaseURI;
    }
    ...
    function mintStateToggle() external onlyOwner {
