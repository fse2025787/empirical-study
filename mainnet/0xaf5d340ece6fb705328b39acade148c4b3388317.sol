...
contract NewMuskOrder is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x58e0aa9c87A100E9358Cb458028aE3f2fFa25383); // Marketing Address
    address payable public multiSigAddress = payable(0xc9E909043afD9a928125377835536174e796E48d); // Marketing Address
    address payable public devAddress = payable(0xB093AC7801F2d27225E74dff6DEb1D138428161E); // Dev Address
    address payable public liquidityAddress = payable(0xB093AC7801F2d27225E74dff6DEb1D138428161E); // Liquidity Address
    ...
    string private constant _name = unicode"New Musk Order";
