...
$KARAJISHI, Last project hit 1.2M MCAP! (Check recent tx to confirm in deployer)

BUY / SELL TAX - 3%

OUR TELEGRAM: https://t.me/Karajishiportal
...
contract KARAJISHI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Karajishi";
    string private constant _symbol = unicode"KARAJISHI";
    ...
    uint256 public _maxTaxSwap=50 * 10**_decimals;
