...
In this renewed tale of Captain Ahab, our feindish foe, the white whale, even Moby Dick, will once and for all be captured,
and terrorize the wayfinders and whalers no longer.

Join the Whalers, a community hellbent on avenging our captains death, reap the rewards of Moby Dicks' capture, and return the victor
in this saga that will unfold...

Create a community of Ahab's Whalers, and our fearless captain will join, to show us the way and reveal all.

---Diary of Ishmael, the lone survivor---
...
contract CaptainAhab is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Captain Ahab", "AHAB") {
