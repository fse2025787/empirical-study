...
/*
Telegram: https://t.me/RoninuToken
*/
...
contract Roninu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = payable(0xFbD12e2A20b4fD8Cc08ACBCaC4A15443F4e6B5eb);
	address public devWallet = payable(0xFbD12e2A20b4fD8Cc08ACBCaC4A15443F4e6B5eb);
    ...
    uint256 public maxWalletamount = 4000000 * 10**18;
    uint256 public launchTime;
    
    string private _name = "RONINU";
    string private _symbol = "RONINU";
    ...
    function setMaxWalletAmount(uint256 _maxwalletamount) public onlyOwner {
        require(_maxwalletamount > 500000 * 10**18, "Max wallet amount should be greater than 0.5% of the total supply");
