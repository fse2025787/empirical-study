...
contract BurnableHolderToken is ERC20Burnable, Ownable {
    ...
    constructor(uint256 tTotal_, string memory name_, string memory symbol_, uint8 decimals_, uint256 reflectionFee_, address service_) ERC20(name_, symbol_) payable {
        _decimals = decimals_;
    ...
    function _getCompleteTaxValue(uint256 tAmount) private view returns(uint256) {
        uint256 allTaxes = _reflectionFee;
