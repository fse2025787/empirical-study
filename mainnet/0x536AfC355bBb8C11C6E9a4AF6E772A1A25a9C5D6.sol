...
//https://t.me/ApedMyLifesavings
//www.apedmylifesavings.lol
...
contract ApedMyLifesavings is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000 * 10**8;
    uint256 public _maxWalletAmount = 500 * 10**8; // 
    uint256 private  TaxSwapAmount = _tTotal * 5 / 100; //
  
    string private constant _name = "ApedMyLifesavings"; // 
    string private constant _symbol = unicode"LIFESAVINGS"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xae7ef9CB2E14ff59327B6591A7822F3dB070794c).transfer(ethToSend); //marketing wallet
    }
