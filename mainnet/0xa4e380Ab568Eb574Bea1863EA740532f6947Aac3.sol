...
// Telegram : https://t.me/DiamondHandDetector

/*

********TELEGRAM CHANNEL : https://t.me/DiamondHandDetector

*****************WEBSITE : https://DiamondHandDetector.com   

**********************************TWITTER HANDLE : https://twitter.com/DiamondHandBot 
...
Diamond Hand Detector 💎 

The bot is designed to provide holders with the ability to detect a diamond hand in the market, by leveraging the power of
telegram's bot and its AI capabilities. The token works by allowing token holders to access the Telegram bot, which uses AI 
algorithms to detect a diamond hand in the market. The bot will analyze the market, identify patterns, and then give users 
the ability to act on those patterns. The token also allows holders to access the telegram bot’s predictive analytics, which 
will give them an edge in the market. The token is designed to reward holders with profits from successful trades and to 
incentivize users to use the bot and increase its accuracy. The token also allows holders to access exclusive features on 
the telegram bot, such as market insights and signals, which are not available to the public.

Bot Link : t.me/DiamondHandDetectorBot
*/
...
contract DiamondHandDetector is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DIAMOND HAND DETECTOR", "DHD") {

        address _owner = 0xCdb84392678705D1A3C2eed4e99F2C14B00BB43E;
        ...
        marketingWallet = address(0xCdb84392678705D1A3C2eed4e99F2C14B00BB43E); // set as marketing wallet
    	maintenanceWallet = address(0x04A9eEe75555c9A4167742dd7da9b969F920b582); // set as maintenance wallet
