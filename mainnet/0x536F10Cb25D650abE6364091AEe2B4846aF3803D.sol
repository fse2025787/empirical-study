...
contract RainbowDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Rainbow Doge";
    string private constant _symbol = "RDOGE";
    ...
    address payable private _marketingAddress = payable(0x5ad4E456ffaE407983F7b006e8D30CbC70E71eF8);
    ...
    function enableTrading(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
