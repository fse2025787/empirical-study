...
contract  ForeverProtocol  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Forever Protocol"; // 
    string private constant _symbol = unicode"FOREVER"; //    
    ...
    address public  _marketingWallet = 0x31448731158bC7E8434a596801829792CcB3a779;
