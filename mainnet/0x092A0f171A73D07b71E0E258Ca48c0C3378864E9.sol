...
contract MewnRun is Context, IERC20, Ownable {
    ...
    string private constant _name = "MewnRun"; //
    string private constant _symbol = unicode"MEWN"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA05Bf0aEdF79Ad4710dc9B5944510329F9DD96AC;
