...
contract TailgateFanClub is ERC721A, Ownable{
    using Strings for uint256;
    ...
    // Prices
    uint256 public PrivateSalePrice = 0.04 ether;
    ...
    // Name and symbol
    constructor() ERC721A("Tailgate Fan Club", "TFC"){
    ...
    function setPlaceHolderUri(string memory _placeholderTokenUri) external onlyOwner{
     ...
     function setPrivateSalePrice(uint256 _newPrivateSalePrice) public onlyOwner {
    PrivateSalePrice = _newPrivateSalePrice;
    }
