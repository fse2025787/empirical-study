...
// File: contracts/theCivilianz.sol

pragma solidity ^0.8.4;

contract theCivilianz is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "https://thecivilianz.s3.amazonaws.com/metadata/";
    ...
    constructor() ERC721A("The Civilianz", "CIVILIANZ") {
        _mint(msg.sender, 1);
    }
    ...
    function mintPublic(uint256 _amount) external payable {
        ...
        require(_amount <= maxPerTx, "You may only mint a max of 20 civilianz per transaction.");
