...
/**
 * @title How to Paint the Joker ERC721A Smart Contract
 */

contract HowToPaintTheJoker is Ownable, ReentrancyGuard, ERC721A {
    event PaymentReceived(address from, uint256 amount);

    constructor(address authorizerAddress_, address distributorAddress_)
        ERC721A("How to Paint the Joker", "JOKER")
    {
    ...
    uint256 public constant MAX_SUPPLY = 164;
