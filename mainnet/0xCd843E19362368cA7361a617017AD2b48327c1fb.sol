...
//
//
// d ss    d sss   d s.   d ss.       d ss      sSSSs   d ss.    sSSSs     sss. 
// S   ~o  S       S  ~O  S    b      S   ~o   S     S  S    b  S     S  d      
// S     b S       S   `b S    P      S     b S       S S    P S         Y      
// S     S S sSSs  S sSSO S sS'       S     S S       S S sS'  S           ss.  
// S     P S       S    O S   S       S     P S       S S   S  S    ssSb      b 
// S    S  S       S    O S    S      S    S   S     S  S    S  S     S       P 
// P ss"   P sSSss P    P P    P      P ss"     "sss"   P    P   "sss"   ` ss'  
//     Thank you for supporting a CC0 project! - mfer #2567                                                                     
//
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1659758400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1659746400;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x61DC881Df155Cc9Fd9ef72f39fA4E7cD3b8d7548];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x61DC881Df155Cc9Fd9ef72f39fA4E7cD3b8d7548;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  uint256 public PRICE = 0.012369 ether;
  uint256 public EARLY_MINT_PRICE = 0 ether;
  uint256 public earlyMintTokenIdCap = 40;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifyudoqhymjn7uzsfuf4liji6u6cg74urfdqtyhcs4exegpwgfoa4/";
...
// File: contracts/DearDorgsContract.sol
//

pragma solidity ^0.8.0;

contract DearDorgsContract is RamppERC721A {
    constructor() RamppERC721A("Dear Dorgs", "DORGIES"){}
}