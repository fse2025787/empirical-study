...
contract KubbyInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Kubby Inu";
    string private constant _symbol = unicode"$KUI";
    ...
    address payable private _developmentAddress = payable(0x835B4B9796F8E803485F81542C56A6015079E04B);
    address payable private _marketingAddress = payable(0x835B4B9796F8E803485F81542C56A6015079E04B);
