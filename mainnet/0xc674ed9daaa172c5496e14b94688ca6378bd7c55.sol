...
// File contracts/ETHGirlfriends.sol


contract ETHGirlfriends is ERC721A, Ownable {

    string public baseURI = "ipfs://QmaZ4azFHfNorhYSs9vNAJRFxpG8UfWjTUcqokP67RKACr/";
    string public contractURI = "ipfs://QmP8CgL6cFnaQLGq22T1m4KexJKQvE3vSNP5grSxJxeGTA";
    ...
    uint256 public constant MAX_SUPPLY = 1113;
    uint256 public price = 0.002 ether;
    mapping(address => uint256) public freeMinted;

    bool public paused = true;

    constructor() ERC721A("ETH Girlfriends", "ETHGF") {}

    /**
     * @dev 5 per tx free until 100 | 20 per tx - 0.04 max mint
     */
