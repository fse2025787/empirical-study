...
contract Slime_Boyz is ERC721A, Ownable {
    uint256 MAX_MINTS = 100;
    uint256 MAX_SUPPLY = 3000;
    uint256 public mintRate = 0.002 ether;

    string public baseURI = "ipfs://QmU5Hkhevw6gkKiFDz8UiVRBubhsLDz2BSujmY2j5UV46o/";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri;

    constructor() ERC721A("Slime Boyz Collectible", "Slime_Boyz_Collectible") {}
