                  ...
                  (      (        _-~    _--_    ~-_     _/   |
                   \      ~-____-~    _-~    ~-_    ~-_-~    /
                     ~-_           _-~          ~-_       _-~   
                        ~--______-~                ~-___-~
*/          
/*          -     SLITHER.FUN $SLITEHER     -
 *          - slither.io for ERC20 Ethereum - 
 *
 *        JOIN THE FUN: https://slither.fun/soon
 *        TELEGRAM : https://t.me/slitherfun
 */
...
contract SlitherFun is ERC20, Ownable {
    ...
    uint256 public percentForLPBurn = 40; //  .40%
    ...
    constructor() ERC20("SLITHER.FUN", "SLITHER") {
