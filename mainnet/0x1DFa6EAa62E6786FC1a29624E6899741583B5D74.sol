...
/* 
Tanuki o kamisama. Teh most kawaii creature.
Tax 4/4
Ownership renounced !
100% LP Burned !                                                                   
...
contract Tanuki is Context, IERC20, Ownable {
    ...
    string private _name = "Tanuki O Kamisama";
    string private _symbol = "TANUKI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xa3E71DdA61eA175378d2361769AbC412197AeBCE);
    address payable private taxWallet2 = payable(0xa3E71DdA61eA175378d2361769AbC412197AeBCE);
