...
contract OkayTigers is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("Okay Tigers", "OKAY T", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("https://bafybeia737e3bpzusnxxn36alotv2fwviezjm44e5rx4fnuvmpfgcfh3ha.ipfs.nftstorage.link/", (tokenId+1).toString()));
    }
