...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new crpcns01User721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        crpcns01User721Token token = crpcns01User721Token(address(addr));
...
contract crpcns01User721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
