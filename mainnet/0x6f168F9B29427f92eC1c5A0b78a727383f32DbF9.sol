...
contract kishimotoETHBridgeContract is Ownable {
    ...
    address payable public system = payable(0x0220d0F578784e40720A286B8Ca1A64785EF19e1);
    ...
    constructor(address _kishimoto) {
        ...
        _processFees[56] = 0.002 ether;
        supportedTargetChains[56] = true;

        kishimoto = IERC20(_kishimoto);
    ...
    function bridge(
        ...
        kishimoto.safeTransferFrom(_msgSender(), address(this), _amount);
    ...
    function bridgeBack(
        ...
        if(serviceFee > 0) {
            kishimoto.safeTransfer(bridgeFeesAddress, serviceFee);
        }
        kishimoto.safeTransfer(_receiver, transferAmount);
