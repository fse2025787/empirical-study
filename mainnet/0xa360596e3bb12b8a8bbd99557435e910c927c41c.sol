...
Queen of the Banshees Is Here...
WE                 WILL                  SEND                  IT
Goddess of love and beauty
彼女は愛と美の女神であり、素晴らしい歌ですべての病気を治すことができる鳥に囲まれていました。 歌を聞いた人は深い眠りに落ち、目を覚ますと病気が治っていた
https://t.me/Cliodhnaportal
*/
...
contract CLIODHNA is ERC20, Ownable {
    ...
    constructor() ERC20("CLIODHNA", unicode"女王") payable {
    	...
    	marketingWallet = address(0xE9F916Ef48f9B73DFc63684c3dD38549b76BA55D); // set as Marketing wallet
        devWallet = address(0x5288dc7ec51f1F95Dff51f2AA25FcCf2Bc19aB37); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x5288dc7ec51f1F95Dff51f2AA25FcCf2Bc19aB37, true);
        excludeFromFees(0x305df6e57C289b6954519410d53c5F0E410AD700, true);
        excludeFromFees(0xE9F916Ef48f9B73DFc63684c3dD38549b76BA55D, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x5288dc7ec51f1F95Dff51f2AA25FcCf2Bc19aB37, true);
        excludeFromMaxTransaction(0xE9F916Ef48f9B73DFc63684c3dD38549b76BA55D, true);
        ...
        */
        ...
        _createInitialSupply(0x5288dc7ec51f1F95Dff51f2AA25FcCf2Bc19aB37, totalSupply*2/100);
        _createInitialSupply(0x305df6e57C289b6954519410d53c5F0E410AD700, totalSupply*2/100);
        _createInitialSupply(address(this), totalSupply*96/100);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xE9F916Ef48f9B73DFc63684c3dD38549b76BA55D,
            block.timestamp
        );
    }
