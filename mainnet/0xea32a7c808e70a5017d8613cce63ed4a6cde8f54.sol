...
/**
 ____                   ___               ____              _        
|  _ \  ___   __ _  ___|_ _|_ __  _   _  |  _ \ _   _ _ __ | | _____ 
| | | |/ _ \ / _` |/ _ \| || '_ \| | | | | |_) | | | | '_ \| |/ / __|
| |_| | (_) | (_| |  __/| || | | | |_| | |  __/| |_| | | | |   <\__ \
|____/ \___/ \__, |\___|___|_| |_|\__,_| |_|    \__,_|_| |_|_|\_\___/
             |___/                                                   
*/
...
contract DogeInuPunks is ERC721, Ownable, RandomlyAssigned{
    using Strings for uint256;
    ...
    {   
      ...
      require( tokenCount() + 1 <= totalSupply(), "max NFT limit exceeded");
      require( availableTokenCount() - 1 >= 0, "need to mint at least 1 NFT");
