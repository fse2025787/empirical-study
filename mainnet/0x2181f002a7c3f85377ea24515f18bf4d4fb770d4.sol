...
contract b0tverse is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeidmiawxdynorefwkxosmtzxw54ezivdozac66d75dd2pdxx7rtx7i/";
  uint256 public  maxSupply = 1500;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.0069 ether; //like to game?
  uint256 public  NUM_FREE_MINTS = 500;
  uint256 public  MAX_FREE_PER_WALLET = 2;
  uint256 public freeAlreadyMinted = 0;
  bool public isPublicSaleActive = false;
  constructor() ERC721A("b0tverse", "b0t") {
  }
