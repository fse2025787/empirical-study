...
contract BabyAPT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BabyAPT";
    string private constant _symbol = unicode"BabyAPT";
    uint256 public _maxTxAmount =   100000000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 100000000000000 * 10**_decimals;
    uint256 public _taxSwap=100000000000 * 10**_decimals;
