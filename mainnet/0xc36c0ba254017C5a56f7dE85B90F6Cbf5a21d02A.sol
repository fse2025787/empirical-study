...
contract AstroInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Astro Inu";                                           // name
    string private _symbol = "ASTROINU";                                            // symbol
    ...
    uint256 public _marketingFee4Sellers = 99;

    bool public feesOnSellersAndBuyers = true;

    uint256 public _maxTxAmount = _tTotal.div(1).div(20);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0xf95D64E72dB2B003D8145fdEe4938CCEA9188e33);
