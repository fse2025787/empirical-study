...
contract Charipump is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Charipump";
    string private constant _symbol = "CHARIPUMP";
    ...
    uint256 public _maxWalletSize = 140000 * 10**9;
