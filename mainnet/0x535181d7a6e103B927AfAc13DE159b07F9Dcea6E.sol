...
contract TheGreeks is ERC721AQueryable, Ownable {
    ...
    address public signer = 0x18F2a76f0B9846B3045151102309cAA96436EA71;
    ...
    constructor(uint8 maxPerWallet, uint16 maxSupply, uint112 price, address royaltyAddress, uint256 royaltyPercentage, string memory baseURI) ERC721A("TheGreeks", "GREEK") {
    ...
    function whitelistMint(bytes calldata signature) external {
        ...
        Slot memory token = tokenInfo;
        require(totalSupply() + 2 <= token.maxSupply, "MAX_SUPPLY");
