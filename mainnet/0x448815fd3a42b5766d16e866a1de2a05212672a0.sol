...
/**
 * @title KABOSU token contract
 * @dev The KABOSU token has modular systems for tax and treasury handler capabilities.
 */
contract KABOSU is IERC20, Ownable {
    ...
    function totalSupply() public pure override returns (uint256) {
        // 2010年 02月 13日- 20,100,213 tokens.
        return 20100213 * 1e18;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "KABOSU:transferFrom:ALLOWANCE_EXCEEDED: Transfer amount exceeds allowance."
        );
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external returns (bool) {
        ...
        require(
            ...
            "KABOSU:decreaseAllowance:ALLOWANCE_UNDERFLOW: Subtraction results in sub-zero allowance."
        );
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "KABOSU:_approve:OWNER_ZERO: Cannot approve for the zero address.");
        require(spender != address(0), "KABOSU:_approve:SPENDER_ZERO: Cannot approve to the zero address.");
    ...
    function _transfer(
        ...
        require(from != address(0), "KABOSU:_transfer:FROM_ZERO: Cannot transfer from the zero address.");
        require(to != address(0), "KABOSU:_transfer:TO_ZERO: Cannot transfer to the zero address.");
        require(amount > 0, "KABOSU:_transfer:ZERO_AMOUNT: Transfer amount must be greater than zero.");
        require(amount <= _balances[from], "KABOSU:_transfer:INSUFFICIENT_BALANCE: Transfer amount exceeds balance.");
