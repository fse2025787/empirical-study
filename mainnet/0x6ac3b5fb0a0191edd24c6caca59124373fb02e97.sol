...
contract penguintown is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRHAT8NushzgLYqu8vW7S6pe4QUmejiJnr4VHdTgQDjvT";
    ...
    constructor(
    ) ERC721A("penguintown.wtf", "peng", 100, maxSupply) {
    }
