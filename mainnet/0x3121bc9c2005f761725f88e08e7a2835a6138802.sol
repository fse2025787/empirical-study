...
contract degenY00ts is ERC721A, Ownable {
    ...
    constructor() ERC721A("degen y00ts", "Dgn00", MAX_MINTS, MAX_SUPPLY) {  
        _safeMint(_msgSender(), 1);
    }
    

    function MintFromwebsite(uint256 numTokens) public payable {
