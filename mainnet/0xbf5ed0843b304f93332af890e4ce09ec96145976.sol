...
pragma solidity ^0.6.12;
    ...
    contract PittysToken is Context, IERC20, Ownable {
        ...
        string private constant _name = 'Pittys';
        string private constant _symbol = 'PITTYS';
        ...
        address payable public _rescueWalletAddress;
        ...
        uint256 private constant _numOfTokensToExchangeForTax = 5000 * 10**18;
        uint256 private _maxWalletSize = 15000000 * 10**18;
        ...
        constructor (address payable devWalletAddress, address payable marketingWalletAddress, address payable rescueWalletAddress) public {
        ...
        function removeAllFee() private {
            if(_returnFee == 0 && _taxFee == 0) return;

            _previousReturnFee = _returnFee;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            // also, don't get caught in a circular tax event.
            ...
            bool overMinTokenBalance = contractTokenBalance >= _numOfTokensToExchangeForTax;
            ...
            //transfer amount, it will take return and tax fee
        ...
        function sendETHToTax(uint256 amount) private {
            ...
            _marketingWalletAddress.transfer(amount.div(10).mul(3));
            _rescueWalletAddress.transfer(amount.div(2));
        }
        ...
        (uint256 tTransferAmount, uint256 tFee, uint256 tTax) = _getTValues(tAmount, _returnFee, _taxFee);
        uint256 currentRate = _getRate();
        ...
        function _getTValues(uint256 tAmount, uint256 returnFee, uint256 taxFee) private pure returns (uint256, uint256, uint256) {
            uint256 tFee = tAmount.mul(returnFee).div(100);
        ...
        function _getReturnFee() public view returns(uint256) {
            return _returnFee;
        }
        ...
        function _setReturnFee(uint256 returnFee) external onlyOwner() {
            require(returnFee >= 1 && returnFee <= 25, 'returnFee should be in 1 - 25');
