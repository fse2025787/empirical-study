...
// File contracts/MigratableTransmuterV2.sol
 ...
 */
contract MigratableTransmuterV2 is Context {
    using SafeMath for uint256;
    ...
    constructor(address _WaToken, address _Token, address _governance) public {
        require(_governance != ZERO_ADDRESS, "MigratableTransmuterV2: 0 gov");
    ...
    modifier onlyWhitelisted() {
        require(whiteList[msg.sender], "MigratableTransmuterV2: !whitelisted");
        _;
    }
    ...
    ///
    modifier onlyGov() {
        require(msg.sender == governance, "MigratableTransmuterV2: !governance");
        _;
    }
    ...
    function unstake(uint256 amount) public updateAccount(msg.sender) {
        ...
        address sender = msg.sender;
        require(depositedWaTokens[sender] >= amount,"MigratableTransmuterV2: unstake amount exceeds deposited amount");
        ...
        updateAccount(toTransmute)
    {
        ...
        require(
            ...
            "MigratableTransmuterV2: !overflow"
        );
    ...
    function setPendingGovernance(address _pendingGovernance) external onlyGov {
        require(_pendingGovernance != ZERO_ADDRESS, "MigratableTransmuterV2: 0 gov");
