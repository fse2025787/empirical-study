...
https://medium.com/@SHIBOKIETH

https://medium.com/@SHIBOKIETH/the-beginning-of-the-shiboki-ecosystem-1beb488479dd
...
contract SHIBOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiboki";
    string private constant _symbol = "Shiboki";
    ...
    address payable private _developmentAddress = payable(0x016749034a864C3ed1394CC6171048F90F0D6aCc);
    address payable private _marketingAddress = payable(0x016749034a864C3ed1394CC6171048F90F0D6aCc);
