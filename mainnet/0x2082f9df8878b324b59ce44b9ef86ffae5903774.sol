...
contract FutureCalls is ERC721A, Ownable {
    string  public baseURI = "ipfs://QmZ2XgjLYXKCqYv86CgfaGASHNcthMHTYsSRNqQQFmcb9g/";

    uint256 public immutable _mintPrice = 0.03 ether;
    uint32 public immutable _txLimit = 1;
    uint32 public immutable _maxSupply = 500;
    uint32 public immutable _walletLimit = 2;
    ...
    constructor()
    ERC721A ("Future Calls", "FutureCalls") {
