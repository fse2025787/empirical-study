...
contract SHILLER is Context,IERC20, Ownable{
...
address _owner;
address payable public marketingAddress = payable(0x6169B9A6573418a203A712dBA9022f3fc0E34d32);
...
uint256 SHILLERCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > SHILLERCOINDaycooldown, "You cant call SHILLERCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function SHILLERCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    SHILLERCOINDaycooldown = block.timestamp + 86400;
}
