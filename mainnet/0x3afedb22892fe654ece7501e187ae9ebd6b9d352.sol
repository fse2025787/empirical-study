...
contract FISTDAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x982b4C94955F6B566C0a46f8DD65B00bF61897c5; 
    address public receiveSellFeeWallet = 0x54Db7B1e507ae8B7AAF9f25be8ba474Fe4Df927b; 
    IWrap public wrap = IWrap(0x8BA97EFD33D1a8cD7B4fe0100EC4c74BaAfaDd1C);
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("FIST Coin DAO", "FISTDAO", 8, 5000 * 10 ** 8){
        address msgSender = _msgSender();
    ...
    function _transfer(address sender, address recipient, uint amount) internal override {
        ...
        if (!freeOfCharge) {
            bool isSwap = sender == uniswapPair || recipient == uniswapPair;
            require(!isSwap || swap, "swap not start");
            uint256 feeAmount = 0;
            ...
            if (currentBalance > 0 && !swaping && sender != uniswapPair) {
                swaping = true; 
                if(_buyFeeAmount > 0) {
                    _swapTokensForEther(_buyFeeAmount, receiveBuyFeeWallet);
                }
                if(_sellFeeAmount > 0) {
                    _swapTokensForEther(_sellFeeAmount, receiveSellFeeWallet);
                }
                _buyFeeAmount = 0;
                _sellFeeAmount = 0;
                swaping = false;
    ...
    function _swapTokensForEther(uint256 tokenAmount, address to) private {
