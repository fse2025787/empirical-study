...
contract NCTO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"NEW COMMUNITY TAKE OFF";
    string private constant _symbol = unicode"NCTO";
