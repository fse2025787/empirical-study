...
contract spookygobblers is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint16 public maxMintAmountPerWallet = 50000;
    ...
    constructor(string memory _baseUrl) ERC721A("Spooky Gobblers", "SPOOKYG") {
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool hs, ) = payable(0x44cF806301F2352F4d9215d6339dBA987C5CEdD1).call{value: address(this).balance * 25 / 100}("");
        require(hs);
