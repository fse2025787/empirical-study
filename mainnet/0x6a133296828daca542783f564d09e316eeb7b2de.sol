...
contract CUMSOCK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cum Sock";//
    string private constant _symbol = "CUMSOCK";//
    ...
    address payable private _developmentAddress = payable(0x041a381829c965eD5baD824c8bDA8E9787f3D0Bd);//
    address payable private _marketingAddress = payable(0x041a381829c965eD5baD824c8bDA8E9787f3D0Bd);//
