...
contract    quokkaCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quokka Coin"; 
    string private constant _symbol = "QKA"; 
    ...
    address payable private _developmentWalletAddress = payable(0xafc59Cc6e226C035EfC026b309b7C98add83EE61);
    address payable private _marketingWalletAddress = payable(0xafc59Cc6e226C035EfC026b309b7C98add83EE61);
