...
contract ProofofGhosts is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Proof of Ghosts";
    string private constant _symbol = "A PHANTOMS DREAM";
