...
contract KUNIYOSHI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Kuniyoshi";
    string private constant _symbol = "KUYOSHI";
    ...
    address payable private _developmentAddress = payable(0x89FEf75073845A8b5e0f8581711233B355c630b4);
    address payable private _marketingAddress = payable(0x89FEf75073845A8b5e0f8581711233B355c630b4);
