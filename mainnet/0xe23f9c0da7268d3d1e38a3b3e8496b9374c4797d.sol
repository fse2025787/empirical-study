...
contract WWWDOTW5DOTOMG is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xF4A976273F46B1eDD14b9f78ceDa194719aCf5d5); // Marketing Address

    address payable public liquidityAddress =
        payable(0xF4A976273F46B1eDD14b9f78ceDa194719aCf5d5); // Liquidity Address
    ...
    uint256 private constant _tTotal = 50 * 1e7 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "WEB5DOTOMG";
    string private constant _symbol = "WEBV";
