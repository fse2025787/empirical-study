...
contract WrappedCreepyDough is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Wrapped Creepy Dough";
    string private constant _symbol = unicode"WCD";
