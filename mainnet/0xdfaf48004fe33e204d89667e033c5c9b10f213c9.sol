...
sheepDAO
Blue chip NFTs at your disposal


SheepDAO was formed with the core objective of establishing one of the most unique, 
exclusive, and prestigious NFT collections on Ethereum. We have gathered the collective 
talents and knowledge of those within the Ethereum NFT space to pursue this vision. 
We are a group of DeFi enthusiasts, NFT collectors, financial investors, and digital 
artists coming together to build a robust digital community.

Since its inception, the vision of SheepDAO has rapidly expanded from simply just 
collecting NFTs to investing in all types of emerging blockchain assets. The 
ever-expanding industry of decentralized finance and the advent of blockchain-based 
entertainment entities have forged a brand-new opportunity for investment. SheepDAO 
now brings that opportunity to any individual regardless of their net worth.


Website: https://sheepdao.org/

Telegram: https://t.me/sheepDaoEntryPortal
...
contract SHEEPDAO is ERC20, Ownable {
    ...
    constructor() ERC20("sheepDAO", "BAA") {
