...
contract Tim is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Tim", "Tim") {
        owner = msg.sender;
        maxMintAmountPerWallet = 20;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmZXqezQ3wRCy2xj24a741CyQyDVjzX3tZeS78w7HjTiHb/", _toString(tokenId), ".json"));
    }
