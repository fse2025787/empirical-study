...
-------------THE JUGGLER ETHEREUM MIXER---------------
       _
                 ...
                 '<((_'    |__H/  \__\
                       ...
                       (_ x
                         \_\@
Telegram: https://t.me/TheJugglerETH

Website:thejuggler.me
...
contract thejuggler is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Juggler";//
    ...
    address payable private _developmentAddress = payable(0x571a0A40b9CB78D32B77B8cEDf3cCb3BA5311fdc);//
    address payable private _marketingAddress = payable(0x571a0A40b9CB78D32B77B8cEDf3cCb3BA5311fdc);//
