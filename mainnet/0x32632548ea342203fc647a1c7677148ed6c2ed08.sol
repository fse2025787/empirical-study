...
contract ZillaInu is ERC20, Ownable {
    ...
    constructor() ERC20("Zilla Inu", "ZILL") {
        ...
        marketingWallet = address(0x80E52b028F69C50533B840da1363b4176611cf2E); // set as marketing wallet
        devWallet = address(0xB6B0f35DdaAf7e47bcd35b092886aE90a445dA0e); // set as dev wallet
