...
contract Splash is ERC721A, DefaultOperatorFilterer, Ownable {
  enum SaleStates {
    CLOSED,
    PUBLIC,
    WHITELIST
  ...
  uint256 public maxPublicTokens = 313;
  ...
  address public partnerAddress = 0x448844c90A552D136cFBc3d664f5c2CA7f4B5897;

  constructor() ERC721A("Splash", "Splash by Pinhas") {
