...
contract HydraToken is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xdA7E45c91C72342AfC25B17e118EC5a1b939d4a0);
    address payable public developmentAddress = payable(0x72888F5C9DA90B5e937d9Da7101165889a76d629);
