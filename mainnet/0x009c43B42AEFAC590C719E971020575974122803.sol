...
abstract contract ERC20 is Context, IERC20 {
    ...
    mapping (address => bool) private _lockedes;
    ...
    uint8 private _decimals;
     ...
     /**
     * @dev Emitted when the lock is triggered by `account`.
     */
    event Lock(address account);

    /**
     * @dev Emitted when the unlock is lifted by `account`.
     */
...
//-------------------------------------- internal ------------------------------------//
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(_lockedes[sender] != true, "ERC20: transfer account is locked");
    ...
    function _lock(address account) internal virtual {
        require(account != address(0), "ERC20: locking the zero address");
        _lockedes[account] = true;
        emit Lock(account);
    }

    function _unlock(address account) internal virtual {
        require(account != address(0), "ERC20: unlocking the zero address");
        _lockedes[account] = false;
        emit UnLock(account);
    }
...
// CAUTION
// This version of SafeMath should only be used with Solidity 0.6 or later,
