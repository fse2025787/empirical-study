    ...
    Signable
{
    ...
    constructor(string memory baseURI) ERC721("Verisart Collection", "VER") {
    ...
    // Allow moving to an ipfs:// based URI.
    // This is a one-way action as is intended for future proofing to allow us to switch from an https:// based
    // gateway to ipfs:// when we feel it's appropriate
    function setBaseURIToIPFS() external onlyOwner {
    ...
    function mintBulk(
        ...
        require(
            owner() ==
                recoverAddressBulk(tokenId, _tokenURIs, v, r, s),
            "Valid signature required"
        );
    ...
    function mintVerisart(
        ...
        address to = recoverPersonalAddress(tokenId, _tokenURI, v, r, s);
    ...
    function mintBulkVerisart(
        ...
        address to = recoverPersonalAddressBulk(
            tokenId,
            _tokenURIs,
            v,
            r,
