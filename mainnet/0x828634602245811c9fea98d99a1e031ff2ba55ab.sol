...
/**
Fuck Bears Inu  (🖕🏾🐻🖕🏾) is the coin that will help us facing the huge economic crisis bubble.

Telegram: https://t.me/FBINU
...
contract FuckBearsInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fuck Bears Inu";//
    ...
    address payable private _developmentAddress = payable(0x4CfC3aF42535253Ec4D7223fbf31E7e7997Fd19c);//
    address payable private _marketingAddress = payable(0xCaA06f134c8E5C631ACa1c1a06C7917F5E9A12BA);//
