...
// 
// File: contracts/KotaroSharks.sol
...
contract KotaroSharks is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.005 ether;
    uint256 public MAX_SUPPLY = 2220;
    uint256 public MAX_MINTS = 2200;
    string public baseURI = "ipfs:///";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("Kotaro Sharks Gen II", "KOTARO", MAX_MINTS, MAX_SUPPLY) {  
    }
