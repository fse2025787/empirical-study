...
**              EX NOCTIS
**              https://ex-noctis.org/
**              https://medium.com/@ExNoctis
**              https://twitter.com/0X_NOCTIS
**
**              We call for a return to the glory days of the space, 
**              and in order to do so, we believe that it is incumbent 
**              on every participant in this crazy game we take a part 
**              in — to take responsibility, and to promote accountability 
...
contract NOCTIS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EX NOCTIS", "NOCTIS") {
        ...
        uint256 totalSupply = 9 * 1e12 * 1e18;
