...
contract MiniFrensInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini FrensInu";
    string private constant _symbol = "MFRENSINU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4e8987da38c1CfA3984F2e4f89678faAb1AA4803);
        _feeAddrWallet2 = payable(0x4e8987da38c1CfA3984F2e4f89678faAb1AA4803);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x4aB01838389fBaaB825dbBA88c2B7a04f706148b), _msgSender(), _tTotal);
    }
