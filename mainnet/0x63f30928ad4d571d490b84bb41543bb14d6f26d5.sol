...
contract Shibaism is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibaism";
    string private constant _symbol = "Shibaism";
    ...
    address payable private _developmentAddress = payable(0xc8c7aFEb72F2D56B09C21f56EA1e7B1FebE0E9B8); 
    address payable private _marketingAddress = payable(0x64FfB8A374c9426a13aEae65f53A03B0e614Da78);
