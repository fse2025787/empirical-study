...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5bEfA15b1CfC4c859aDB60B122BBDe5eb4BaA70e];
  address public erc20Payable = 0x5bEfA15b1CfC4c859aDB60B122BBDe5eb4BaA70e;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 721) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibm4jz6bxbsnxvsq6nrjyhtrwzuryxuufh66i7y33lq7zhncku5hi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/tveZR8TL3HAIFCW3sR3T/contract-metadata";
  }
...
// File: contracts/AkiraNinjasClubContract.sol
//

pragma solidity ^0.8.0;

contract AkiraNinjasClubContract is RamppERC721A {
    constructor() RamppERC721A("Akira Ninjas Club", "ANC"){}
}
