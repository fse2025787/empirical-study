...
contract Ethoge is Context, IERC20, ERC20Ownable {
    ...
    uint256 private _marketingTax = 7;
    ...
    string private constant _name = "Ethoge";
    string private constant _symbol = "$ETHOGE";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0xd8Da0cb293018c8f53d8ed518bf114F09b99C93C);
        DevWallet = payable(0x2AC039543a98B55f60E54673Cf27Da3c17bFb9aC);
