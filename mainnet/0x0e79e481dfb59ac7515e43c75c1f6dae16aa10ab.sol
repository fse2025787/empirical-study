...
contract USET is ERC20, ERC20Detailed, PriceConsumerV3{
  ...
  constructor () ERC20Detailed("U.S. EMEL TOKEN", "USET", 18) PriceConsumerV3() public{
      ownership = msg.sender;
    _totalSupply = 6000000 * (10**uint256(18)) ;
 ...
 contract tokenSale is PriceConsumerV3{
  ...
  address payable wallet = 0xfa3095f2a47dB58df57A2b3C5250A9389c90f292;
    ...
    function buy(address beneficiary) payable  public
    {
        ...
        amountOfTokens =  unitPrice * uint256(10**18); //1 USET token * USD amount of Value
