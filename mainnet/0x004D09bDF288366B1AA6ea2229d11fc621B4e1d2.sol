...
//DDAB Functionality; Tg Bot shows what Previous token deployments are related to the dev wallet, Dev Launch Alert System, You get a notification if dev buybacks, transfers from MW, transfers from developer wallet, etc.
//Renounced contract, 100% liquidity burnt at launch
...
contract DevDetectorAi is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dev Detector Ai Bot";
    string private _symbol = unicode"DDAB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xbB311BC9Ee37CE0A77a8E50D6E535638690E6dB7));
        marketingWallet = payable(address(0xd0AFDe90028E2d55e50e32312Fce9E5B806cdaAf));
