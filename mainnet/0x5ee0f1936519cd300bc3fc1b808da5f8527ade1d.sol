...
/**
 * @title DharmaSmartWalletImplementationV15 (staging version)
 * @author 0age
 ...
 */
contract DharmaSmartWalletImplementationV15Staging is
  ...
  uint256 internal constant _DHARMA_SMART_WALLET_VERSION = 1015;

  // DharmaKeyRegistryV2Staging holds a key for verifying meta-transactions.
  ...
  address internal constant _ACCOUNT_RECOVERY_MANAGER = address(
    0x2a7E7718b755F9868E6B64DD18C6886707DD9c10 // staging version
  );
  ...
  address internal constant _TRADE_BOT = address(
    0x0f36f2DA9F935a7802a4f1Af43A3740A73219A9e // staging version
  );
