...
contract InfiTorem is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 265;
    uint256 public immutable supply = 365;
    ...
    address[] public withdrawAddresses = [0x8C964A0838E99E3ED05dAAD6eF9c417d244BEF70, 0x4EacBbD2fEc093F7d0bc5252F26D1C8B338129a0, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [47, 48, 5];

    bytes32 public merkleRoot = 0x95bc56c4f7aa340bcb1e9e13aa144db6f716717b24d15c7b8bd38b049e0cecfb;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x4EacBbD2fEc093F7d0bc5252F26D1C8B338129a0, _royaltyAmount);
    }
