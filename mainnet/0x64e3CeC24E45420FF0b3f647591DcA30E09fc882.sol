...
interface IBoxingBoyzCustomToken {
...
contract BoxingBoyzCustomToken is IBoxingBoyzCustomToken, ERC721Enumerable, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    constructor() 
        ERC721("BoxingBoyzCustom", "CUSTOMBOY") {}
