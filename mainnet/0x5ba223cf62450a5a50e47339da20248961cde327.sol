...
Shib Kabuki is creating an ecosystem utilizing the SHIBUKI token as the backbone. 
The project intends to branch into the NFT space initially with the goal of creating a 
additional community meme utility within the ERC space. Kabuki mask is a type of theater mask that is used in kabuki theater. 
It is characterized by its highly ornate and exaggerated design. 
The kabuki mask is often made from wood, lacquer, or cloth, and it is often decorated with gold leaf, feathers, and sequins.
...
contract ShibKabuki is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SHIBUKI"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0xd4131cdD920f2eAE48dbe31AcE987DA03Fd9E67b; 
    ...
    function FeeExcludewallet(address account) public onlyOwner {
        _isExcludedFromFee[account] = true;
    }
    
    function FeeIncludewallet(address account) public onlyOwner {
    ...
    function set_MarketingFee(uint256 marketingFee) external onlyOwner() {
        _marketingFee = marketingFee;
    }
    
    function set_LiquidityFee(uint256 liquidityFee) external onlyOwner() {
