...
contract skulmfers is StartTokenIdHelper, ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory name_, string memory symbol_) StartTokenIdHelper(1) ERC721A(name_, symbol_) {
        baseURI = "https://mnn.mypinata.cloud/ipfs/QmNjrFWHBEcyB9zLjPg64cyDXkpDmdA71xeJdaGpCYa3Hv/";
        _mintPrice = 0.035 ether;
        _maxAmount = 3000;
        _mintAmount = 2650;
        _maxTXAmount = 10;
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(msg.value == (_mintPrice * quantity), "Not enough ETH");
