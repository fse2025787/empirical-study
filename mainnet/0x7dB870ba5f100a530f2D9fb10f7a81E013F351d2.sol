...
contract TheMergedOnes is ERC721A, Ownable { 
    ...
    uint256 public  maxFreeSupply = 1022; 
    ...
    constructor() ERC721A("The Merged One's", "TMO") {     
        paidSaleOpen = true;
        freeSaleOpen = true;
        setHiddenMetadataUri("ipfs://bafybeib7dwu3qfekyggnzc5tbpz7tj6wv2bmtfzk7z55afgbeyrt2sbxtm/waiting.json");
