...
HOLD $TEHBANK EARN $USDC! 🏦

TG: https://t.me/TehBankETH
...
contract TEHBANK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TEH BANK", "TEHBANK") {
        ...
        operationsBuyFee = 40;
        liquidityBuyFee = 10;
        totalBuyFees = rewardsBuyFee + operationsBuyFee + liquidityBuyFee; // Start 13
        
        rewardsSellFee = 40;
        operationsSellFee = 80;
        liquiditySellFee = 10;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee; // 13
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 130, "Must keep fees at 13% or less");
    }
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 130, "Must keep fees at 13% or less");
    }
