...
contract LEAP is ERC20, Ownable {
    ...
    constructor() ERC20( "Leap of Faith", "LEAP") {
        ...
        operationsAddress = address(0xe84B075836D72F68Ef11C547A4D5680F0bac2c73); // change this address to wallet u want for operations   
        TaxAddress = address(0xe84B075836D72F68Ef11C547A4D5680F0bac2c73);  // change this address to the one for tax 
