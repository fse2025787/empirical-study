...
contract UkrainianShib is Context, IERC20, ERC20Ownable {
    ...
    uint private _marTax = 8; // tax for marketing
    ...
    string private constant _n = "Ukrainian Shib";
    string private constant _s = "UkrainianShib";
    uint8 private constant _d = 18;
    ...
    constructor() {
        ...
        marketingAddress = payable(0x0D49Fe22239602F3Db9C98019079883330b03339);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
			require(amount <= 1000000000000 * 10**18, "Limits are in place, please lower buying amount");
		}
        if(_initLaunch == true) {
    ...
    function setBuyTax(uint buyMarTax, uint buyLiqTax, uint buyRefTax) external onlyOwner {
        _buyMarTax = buyMarTax;
        _buyLiqTax = buyLiqTax;
        _buyRefTax = buyRefTax;
        require(_buyRefTax + _buyMarTax + _buyLiqTax <= 20,  "Must keep buy taxes below 20%");
    }
    function setSellTax(uint sellMarTax, uint sellLiqTax, uint sellRefTax) external onlyOwner {
        _sellMarTax = sellMarTax;
        _sellLiqTax = sellLiqTax;
        _sellRefTax = sellRefTax;
        require(_sellRefTax + _sellMarTax + _sellLiqTax <= 20, "Must keep sell taxes below 20%");
    }
