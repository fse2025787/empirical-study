...
https://medium.com/@SendorETH/sendor-send-it-inu-2432773255ad

TG: https://t.me/ThisIsSendor 
Website: https://ThisIsSendor.com (Will be live within 36 Hours after Launch)
Medium: https://medium.com/@SendorETH
Twitter: https://twitter.com/ThisIsSendor
...
contract SENDOR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Send It Inu";
    string private constant _symbol = unicode"SENDOR";
