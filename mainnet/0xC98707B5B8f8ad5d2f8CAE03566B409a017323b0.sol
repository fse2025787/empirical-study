...
contract WeaponNFT is ERC721A, Ownable, Pausable {
    ...
    event Minted(address minter, uint256 weaponBoxId, uint256 boxCategory, uint256 tokenIdStart, uint256 quantity, bytes32 randomHash);
    ...
    function mint(address to, uint256 weaponBoxId, uint256 boxCategory, uint256 quantity, bytes32 randomHash) external onlyMinter {
        ...
        emit Minted(to, weaponBoxId, boxCategory, tokenIdStart, quantity, randomHash);
    }
