...
//*********************************************************************//
//
//        __        _          __  ___        _          ________      __  
//       / /___    (_)___     /  |/  /___    (_)___     / ____/ /_  __/ /_ 
//  __  / / __ \  / / __ \   / /|_/ / __ \  / / __ \   / /   / / / / / __ \
// / /_/ / /_/ / / / /_/ /  / /  / / /_/ / / / /_/ /  / /___/ / /_/ / /_/ /
// \____/\____/_/ /\____/  /_/  /_/\____/_/ /\____/   \____/_/\__,_/_.___/ 
//           /___/                     /___/                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4B179DFff7A1F2c58D62CDd872c740AA9273f2F5];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 1490 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTbE81UzZRwvV8z5ePjJ3Bikh3YFSoJsxEDpcYwDgRb9R/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1490");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1490");
...
// File: contracts/JojoMojoClubContract.sol
//

pragma solidity ^0.8.0;

contract JojoMojoClubContract is RamppERC721A {
    constructor() RamppERC721A("Jojo Mojo Club", "JOJO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/dil8j4nTrifkF4hLzYdh/contract-metadata";
    }
}
