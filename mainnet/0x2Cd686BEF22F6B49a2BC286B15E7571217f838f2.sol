...
// contracts/GuildOfGuardiansArtCollectableNFT.sol
// 
pragma solidity ^0.8.0;
...
contract GuildOfGuardiansArtCollectableNFT is GuildOfGuardiansNFTCommon {
    event MintFor(
        address to,
        uint256 amount,
        uint256 tokenId,
    ...
    constructor() ERC721("Guild of Guardians Art Collectable", "GOGAC") {}

    /**
     * @dev Called by IMX to mint each NFT
     *
     * @param to the address to mint to
     * @param amount not relevant for NFTs
