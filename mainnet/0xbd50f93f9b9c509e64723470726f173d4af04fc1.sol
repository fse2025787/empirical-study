...
Unaffected by Trap Cards or effects. This card can attack all monsters your opponent controls, once each.

Blue Eyes Tyrant Dragon - $FUSION

https://t.me/blueeyestyrant
https://www.twitter.com/fusionerc
...
contract BlueEyesTyrantDragon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Blue Eyes Tyrant Dragon", "FUSION") {
        ...
        marketingWallet = address(0x6a7b7dB0fF494601a371b9a2221a496496d9d893); // set as marketing wallet
        devWallet = address(0xF827171Ec2498FF58B2a218792771305a91aaD2C); // set as Tyrant wallet
