...
Here to purify and cleanse a space riddled with skems and rugs. 

Purify DAO will be an exclusive DAO for holders of the $PURE token and will give members direct access to our unique utilities which include
...
Medium: https://medium.com/@purifytoken/purify-an-introduction-4f76fcb5ea25

Telegram: t.me/PurifyDAO
...
contract PURE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Purify DAO";
    string private constant _symbol = "PURE";
