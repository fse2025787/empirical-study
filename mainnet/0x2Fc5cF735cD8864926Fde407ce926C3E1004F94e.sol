...
contract DILF is ERC20, Ownable, AccessControl {
    constructor() ERC20("Digital Invest Lab Founder", "DILF") {
...
contract Crowdsale is Ownable{
  ...
  function checkICOBalance(address _address) external view onlyOwner returns(uint256)
  {
  ...
  function _forwardFunds() internal {
   ...
   function removeStuckTokenFromICO(address _address) external onlyOwner {
