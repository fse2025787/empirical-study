...
Telegram: https://t.me/zukoinutoken
Website: https://www.zukoinu.io/
...
*/
 ...
 contract ZukoInu is Context, IERC20, Ownable {
     ...
     string private constant _name = "Zuko Inu";
     string private constant _symbol = "ZUKOINU";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xB74a67c6a42DC5e9C056F013dc91A5F3EdF33d45);
         _feeAddrWallet2 = payable(0xB74a67c6a42DC5e9C056F013dc91A5F3EdF33d45);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xB74a67c6a42DC5e9C056F013dc91A5F3EdF33d45), _msgSender(), _tTotal);
     }
     ...
     function _transfer(address from, address to, uint256 amount) private {
         ...
         if (!_isBuy(from)) {
             // TAX SELLERS 15% WHO SELL WITHIN 4 HOURS
             if (_buyMap[from] != 0 &&
