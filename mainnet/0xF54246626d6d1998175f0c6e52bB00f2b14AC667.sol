...
// Twitter : https://twitter.com/DiamondHandBot

/*

Diamond Hand Detector | DHD | ETH
Utility Of Bot 🤖 
USE $DHD in Any Group To Detect Whale and Dimond Hand Work On ETH and Other Chain 

Token Tax : 0 % 

Close To Launch 

Tg : t.me/DiamondHandDetector
*/
...
contract DiamondHandDetector is Ownable, IERC20 {
    ...
    uint256 private _totalSupply = 30000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 3 / 100;
    uint256 public _walletMax = _totalSupply * 4 /100;

    string constant private _name = "Diamond Hand Detector";
    string constant private _symbol = "$DHD";
    ...
    constructor() {
        ...
        lpWallet = 0xb93d3785DbF21DbF604e137E16E6E10d4F14B031;
        projectAddress = 0xb93d3785DbF21DbF604e137E16E6E10d4F14B031;
        devWallet = 0xb93d3785DbF21DbF604e137E16E6E10d4F14B031;
