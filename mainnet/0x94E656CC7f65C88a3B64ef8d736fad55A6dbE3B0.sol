...
contract LOKI is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = 250_000 * 10**18;
    uint256 public maxWalletAmount = 500_000 * 10**18;
    
    address public marketingWallet = 0x9EBC832aee837eE6f0cEBa181912Af65fDfE3c30;
    address public devWallet = 0x9EBC832aee837eE6f0cEBa181912Af65fDfE3c30;
    ...
    Taxes public sellTaxes = Taxes(8,0,0);
    uint256 public totTax = 5;
    uint256 public totSellTax = 8;
    ...
    constructor() ERC20("Legacy Floki", "LOKI") {
