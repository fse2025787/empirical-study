...
contract HinokamiInu  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Hinokami Inu", unicode"HINU") {
        ...
        swapTokensAtAmount = totalSupply * 15 / 10000; // 1.5% swap wallet
