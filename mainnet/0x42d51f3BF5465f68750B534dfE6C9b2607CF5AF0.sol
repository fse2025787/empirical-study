...
//Thanks to Hashlips NFT for helping with contract development & deployment
...
contract TheJonProbyCollection is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x0948CBb6F90DBE952bBb5C88F72419dEf54b0eaa).call{value: address(this).balance * 10 / 100}('');
    require(hs);
    // =============================================================================
