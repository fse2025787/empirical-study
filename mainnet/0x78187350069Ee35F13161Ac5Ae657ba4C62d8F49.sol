...
contract ClinicSBT is ERC1155URIStorage, Ownable, Operable {

    using Strings for string;

    string public name = "RE-HABILITAION";
    string public symbol = "REHABILI";
    mapping(address => bool) bondedAddress;

    constructor() ERC1155("") {
        _grantOperatorRole(msg.sender);
        _setBaseURI("ipfs://QmctR9dtcmTb2exXtZR6suYhAttThQkTrw3hCqa19FGYud/");
        initializeSBT(0, "metadata.json");
    }
