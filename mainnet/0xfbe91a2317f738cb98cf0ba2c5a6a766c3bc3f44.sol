...
"Cocaine and Hookers" my degen frens 

https://t.me/fugazi_eth
...
contract FUGAZI is Context, IERC20, Ownable {
    ...
    string private _name = "FUGAZI";
    string private _symbol = "FUGAZI";
    ...
    address payable public marketingWallet = payable(0x5780f80e180E14d1Be46DBB580ab21328903db71);
    ...
    uint256 public maxBuyTransactionAmount = 2500000 * 10**9;  //0.25%
