...
// Errors
error MembershipInactive(); // Membership is Inactive
error MembershipNeedsMoreTokens(); // Membership requires more tokens to be created/renewed
error UserHasExistingMembership();
...
contract Membership is IMembership, Initializable, OwnableUpgradeable {
