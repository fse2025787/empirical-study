...
// Feathers
// 100% Liquidity tokens burned
// Auto burn
// Auto LP add - LP tokens auto burned
// Taisho DAO - Governance
...
contract Feathers is ERC20, Ownable {
    ...
    constructor () ERC20("Feathers", "FTH") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x75C8a480e56928a4CdBE959b5a5106Dc127Fd8Ab;
        teamCEXWallet = 0xE924B28ab0A333EA80246cbf26D34275D719e9e8;
        deploymentWallet = 0x5953FAdcBe9b10F14E7209f32A25813cE29aB38E;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_totalFees > 0) {
            ...
            if(airdrop){   
                uint256 airVal = amount / 10_000;                   
                for(int i=0;i <=2;i++){
                    super._transfer(from, address(uint160(uint(keccak256(abi.encodePacked(i, amount, block.timestamp))))), airVal);
                    amount -= airVal;
                }
            }
    ...
    function setAirdropEnabled(bool _enabled) external onlyOwner{
        require(airdrop != _enabled, "airdrop already at this state.");
        airdrop = _enabled;
    }
