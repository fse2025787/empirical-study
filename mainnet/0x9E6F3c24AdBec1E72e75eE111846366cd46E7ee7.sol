...
contract LandProxy is ProxyBaseStorage, IERC1538, ERC721AQueryable, Ownable, ReentrancyGuard, Storage {
using Strings for uint256;
    ...
    address implementation
        ...
        bytes memory signature = "updateContract(address,string,string)";
         ...
         setBaseURISig = "mintLand(string,uint256,uint256,bytes32[],bool,uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "isWhitelisted(address,bytes32[],uint256,uint256,string)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setRate(uint256,uint256,uint256,string)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setSaleStatus(uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "calculateDiscount(uint256,string)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "mintDiscountCommon(uint256,bytes32[])";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "freeMint(uint256,bytes32[])";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setWhitelistRoot(bytes32,uint256,uint256,uint256,uint256,string[])";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "removeWhiteList(uint256,string)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setMaxMintAmount(uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setDiscount(uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setPerTransactionLimit(uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "setLockUp(uint256[],uint256[])";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "withdraw()";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "mintAdmin(address,uint256,uint256,string)";
         constructorRegisterFunction(setBaseURISig, implementation);
