...
contract AnimusEGGPERIENCE is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint public MAX_SUPPLY = 19433;
    uint public MAX_TEAM = 5555;
    uint public MAX_TX = 5555;
    ...
    uint public saleStartTime = 1679298400;

    bytes32 public merkleRoot;

    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Animus Egg by RTFKT", "EGG")
    {
        baseURI = _baseURI;
    ...
    function claimCLONEXHolderMint(address _to, uint _quantity) external payable onlyOwner {
    ...
    function RTFKTEggMint(address _account, uint _quantity) external payable isNotContract {
