...
contract CuteAlienPlants is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmTDu7fg4DHSRHkfMknzoNp2XTg6Jh1CgkzojbJ6TcadfQ/";
  uint256  public  maxSupply = 766;
