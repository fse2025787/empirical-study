...
contract SpaceOtterClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable otterForAdoption = 3333;

    // 0.001ETH per otter
    // One to cover cost, one to show-off, one left for the moon
    uint256 public otterAdoptionFee = 0.003 ether;
    ...
    function adoptOtter() external payable callerIsUser nonReentrant {
        ...
        require(otterSupply + 3 <= otterForAdoption, "No more otter for adoption.");
        require(adoptedOtter[msg.sender] == false, "Already adopted 3 otters. Don't be greedy.");
    ...
    function adoptRemainingOtters() public onlyOwner {
        uint256 otterSupply = totalSupply();
        require(otterSupply < otterForAdoption, "All 3,333 otters are adopted! Owner cannot mint.");
    ...
    // Thank you for letting us to continue building in the Web3 space.
