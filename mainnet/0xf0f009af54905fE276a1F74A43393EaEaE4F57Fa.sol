...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!_isRevealed()) {
            return "ipfs://bafkreianfdnnaokqfvpipln2y25ob24zsdzqzfkpy34dkhymkxqyzvo4uq";
        }
    ...
    function _isRevealed() public view virtual returns (bool) {
        return false;
    }

    // To be overridden in the child contracts
