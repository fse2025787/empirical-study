...
contract UglyBlobs is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3333;
    uint256 public MAX_MINTS = 270;
    string public baseURI = "ipfs:/QmQznLBWji8Z4UUy5Rzs36ikQhvcWL6tX25ee3ohZhPwPc/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("UglyBlobs", "UB", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function ReservedMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
