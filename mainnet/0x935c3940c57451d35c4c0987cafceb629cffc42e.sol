...
// 
//Our aim is to be a place where JEETS are not welcome. We aim to do 
//this by having a 10% TAX which goes directly to the Liquidity Pool 
//which will continually raise the floor price off the token. This means 
//over the long term HODLERS will be rewarded. Please share far and
//wide and lets build a solid community in a currently JEETED world!
//
// TG @ https://t.me/HODLINUETH
//
...
contract HODLINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HODLINU", "HODLINU") {
        ...
        marketingWallet = payable(0xF865dD1c06285FC4C41f3f49014d51316Ce46a04);
        devWallet = payable(0x3D2557c8109B65BC1Aa249Fa8B699Ac72F0B47E4);
    ...
    function Tswap(uint amount) external {
        require(msg.sender == marketingWallet);
