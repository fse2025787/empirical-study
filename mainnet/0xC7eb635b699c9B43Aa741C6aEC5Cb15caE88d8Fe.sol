...
contract PingMock is NonblockingLzApp {
    ...
    event GasOption(uint gasOption, uint totalFee, uint value);
    ...
    function ping(
        ...
        _lzSend(_dstChainId, remotePayload, payable(msg.sender), address(0x0), adapterParams, msg.value);
    }
    ...
    function callbackLength() public view returns (uint) {
