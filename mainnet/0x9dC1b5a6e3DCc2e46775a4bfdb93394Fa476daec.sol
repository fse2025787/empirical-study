...
contract ForgeNFT is ERC721A, Ownable {
    ...
    string public nftURI = "QmcFFKftSaaphWs9zTxFTcnm9yqm3YdzsSwpfraftXbuVG";

    address public feeWallet = 0x3076867a85f67F5c3d1459BA8c140a735DfaE23f;

    constructor() ERC721A("Forge", "NFT") {
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked(baseURI, nftURI));
    }
