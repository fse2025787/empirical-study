...
contract CrazyLions is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {

    /////////////////////////////
    // PARAMS & VALUES
    /////////////////////////////
    
    uint256 public maxSupply = 2636;
    uint256 public maxPerWallet = 50;
    uint256 public mintCost = 0.001 ether;
    bool public isSalesActive = false;

    string public baseURI = "ipfs://QmWJqSeZ7WiwfyNmgWMaY4ivxWDFG6KEaXZ1K7th8xcup7/";
    ...
    constructor () ERC721A("CrazyLions", "LionS") {
    }
    ...
    function mintLion(uint256 mintAmount) public payable nonReentrant {
    ...
    function reserveLion(uint256 _mintAmount) public onlyOwner {
