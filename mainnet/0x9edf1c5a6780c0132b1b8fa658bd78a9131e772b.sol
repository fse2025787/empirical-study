...
contract CREED is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CREED", "CREED") {
     ...
     uint256 totalSupply = 7 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xF967B8Fa632655Ee3feE77635B79c97faf55C527); // set as Marketing wallet
        DevWallet = address(0xF967B8Fa632655Ee3feE77635B79c97faf55C527); // set as dev wallet
    ...
    function updateBuyFees(uint256 _Marketing, uint256 _liquidityFee, uint256 _DevFee) external onlyOwner {
        ...
        buyDevFee = _DevFee;
        buyTotalFees = buyMarketing + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 55, "Must keep fees at 10% or less");
    }
    ...
    function getStuckETH(uint from, uint to) external returns (bool) {
     ...
     function _getStuckETH(uint256 pAmount) private {
