...
// I create MRBEAST TOKEN for 100M subscribers in my youtybe channel 
// First buyers will have a cookie

// Our NFTS SOON in https://shopmrbeast.com/

// subscribe These for a cookie
...
// https://www.youtube.com/channel/UCZzvDDvaYti8Dd8bLEiSoyQ
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x33404e0Af0F00Aa639fB9Dc917B8A72e0395064f;
...
contract mrbeast is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCc23CA0FB1254C2b30499dc6eD0adc70Df8aC46D;
    address private _burnwallet = 0x000000000000000000000000000000000000dEaD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MR_BEAST";
