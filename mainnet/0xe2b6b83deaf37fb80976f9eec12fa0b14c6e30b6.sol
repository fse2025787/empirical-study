...
// MEDIUM LINK: https://link.medium.com/FqHQx023Vvb

// TELEGRAM: HTTPS://T.ME/koriETH
...
contract Kori is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Kori";
    string private _symbol = "KORI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x87c060E284848f4771EfDCbe80b885f8F5a2DF45);
