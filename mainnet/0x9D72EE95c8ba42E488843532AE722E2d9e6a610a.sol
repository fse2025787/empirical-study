...
contract USDCGobblers is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("USDC Gobblers", "GUSDC") OperatorFilterer(address(OSlist), false) {
