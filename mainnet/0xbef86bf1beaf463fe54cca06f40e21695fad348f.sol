...
contract XMAS is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Christmas";
    string private _symbol = "XMAS";
    uint8 private _decimals = 18;
    uint256 private _supply = 2400000;

    uint256 private _buyTotalTax = 4;
    uint256 private _buyMarketingTax = 1;
    uint256 private _buyLiquidityTax = 1;
    uint256 private _buyVaultTax = 2;
    uint256 private _sellTotalTax = 4;
    uint256 private _sellMarketingTax = 1;
    uint256 private _sellLiquidityTax = 1;
    uint256 private _sellVaultTax = 2;
    uint256 private initialMarketingTax = 99;

    uint256 public maxTxAmount = (_supply / 100) * 10**_decimals;
    uint256 public maxWalletAmount = (_supply / 40) * 10**_decimals;
    address public marketingWallet =
        address(0x019EeC93AB4B71CcfD9b7204250D1931DE7a29d8);
    address public vaultWallet =
        address(0xceA71C67867aE53d4F5ECE87219945658d7EF5CA);
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToETH = 2400 * 10**_decimals;
    ...
    function changeBuyTaxes(
        ...
        require(
            (_taxForLiquidity + _taxForMarketing + _taxForVault) <= 10,
    ...
    function changeSellTaxes(
        ...
        require(
            (_taxForLiquidity + _taxForMarketing + _taxForVault) <= 35,
            "ERC20: total tax must not be greater than 35"
        );
