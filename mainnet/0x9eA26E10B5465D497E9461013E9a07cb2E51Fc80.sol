...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xE4b996bbE80E6727723a822ABbe03dB6244d7aeE];
  address public erc20Payable = 0xE4b996bbE80E6727723a822ABbe03dB6244d7aeE;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 650) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/sV3S6iGMnp2Cj0T92Ql6/contract-metadata";
  }
...
// File: contracts/KimDigitalTradingCardsContract.sol
//

pragma solidity ^0.8.0;

contract KimDigitalTradingCardsContract is RamppERC721A {
    constructor() RamppERC721A("Kim  Digital Trading Cards", "Kim Cards"){}
}
