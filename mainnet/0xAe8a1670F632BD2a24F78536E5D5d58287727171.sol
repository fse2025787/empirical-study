...
//*********************************************************************//
//
//     ___       ______     _          ________                           __       __  __            ____             __  
//    /   |     /_  __/____(_)___     /_  __/ /_  _________  __  ______ _/ /_     / /_/ /_  ___     / __ \____ ______/ /__
//   / /| |      / / / ___/ / __ \     / / / __ \/ ___/ __ \/ / / / __ `/ __ \   / __/ __ \/ _ \   / /_/ / __ `/ ___/ //_/
//  / ___ |     / / / /  / / /_/ /    / / / / / / /  / /_/ / /_/ / /_/ / / / /  / /_/ / / /  __/  / ____/ /_/ / /  / ,<   
// /_/  |_|    /_/ /_/  /_/ .___/    /_/ /_/ /_/_/   \____/\__,_/\__, /_/ /_/   \__/_/ /_/\___/  /_/    \__,_/_/  /_/|_|  
//                       /_/                                    /____/                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc9742f8de41bD4dF1da0d5cfe49E54732a81a789];
  address public erc20Payable = 0xc9742f8de41bD4dF1da0d5cfe49E54732a81a789;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih3p7k4ujk2bm6qtjfols3yzft2tknaei2qog2lobt64ewmtzyzr4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/AAnkErvBqgYrMssIGIxw/contract-metadata";
  }
...
// File: contracts/ATripThroughtheParkContract.sol
//

pragma solidity ^0.8.0;

contract ATripThroughtheParkContract is RamppERC721A {
    constructor() RamppERC721A("A Trip Through the Park", "ATP"){}
}
