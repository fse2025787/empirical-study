...
// Supply: 4242
// 3000 free, 1 max/tx & wallet
// 0.004 ETH, 20 max/tx & wallet
...
contract nerdsJPG is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://nerdsjpg/";
    uint   public price             = 0.004 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 3000;
    uint   public maxSupply         = 4242;
    bool   public paused            = true;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("nerdsJPG", "NRD"){}
    ...
    function nerdMaster(address mintAddress, uint256 count) public onlyOwner {
