...
contract MedievalMonkeys is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_MINTS = 100;
    string public baseURI = "https://mint.medievalmonkeys.io/metadata/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Medieval Monkeys", "MM", MAX_MINTS, MAX_SUPPLY) {  
    }
