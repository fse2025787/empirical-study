...
/**
A multi-collateralized DeFi protocol built on Arbitrum for lending, stabilizing the ecosystem and providing liquidity for Defi users.
Link: http://t.me/HexusFinancePortal
*/
...
library Address{
 ...
 contract HEXUSFINANCE is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 650_000 * 10**9;
    uint256 public maxBuyLimit = 20_000_000 * 10**9; //2%
    uint256 public maxSellLimit = 20_000_000 * 10**9; //2%
    uint256 public maxWalletLimit = 40_000_000 * 10**9; //4%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x534e812F9656E51e21A1BF7A12A39390e1307840;
    address public buybackWallet = 0x534e812F9656E51e21A1BF7A12A39390e1307840;

    string private constant _name = "HEXUS FINANCE";
    string private constant _symbol = "$HEXUS";
