...
contract ChainShift is Context, IERC20, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, address uniswapV2Router_) {
        _name = name_;
        _symbol = symbol_;
        _decimals = 18;
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "SHIFT: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "SHIFT: decreased allowance below zero");
        unchecked {
