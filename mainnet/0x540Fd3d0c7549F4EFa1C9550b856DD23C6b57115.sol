...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x3d35c6d9583f85A40066FB40859177192D61e1c7];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x3d35c6d9583f85A40066FB40859177192D61e1c7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdodAyvxpgQTtqULWEXGNgLT6hvdTGLA5hJQw46xYckFs/";
...
// File: contracts/EndGameContract.sol
//

pragma solidity ^0.8.0;

contract EndGameContract is RamppERC721A {
    constructor() RamppERC721A("End Game", "RED"){}
}
