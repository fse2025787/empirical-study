...
abstract contract Ownable is Context {
    ...
    contract WaifusNFT is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  string private uriSuffix = ".json";
  string public hiddenURL= "ipfs://QmaMQtWmvYeJSZxMKNnhkCvyTcNU6dFMK1DRcb51XXMS2o/hidden.json";

  
  

  uint256 public cost = 0.18 ether;
  uint256 public whiteListCost = 0.14 ether;
  ...
  bytes32 public whitelistMerkleRoot = 0x7bff422bd6884fdb9a8451596a59ef37974bb324ac0460747170df3ab5d74f07;
  

  constructor() ERC721A("Waifus NFT", "WFS") {
  }
  ...
  function mint(uint8 _mintAmount) external payable  {
    ...
    require(_mintAmount + NFT <= maxMintAmountPerWallet, "Exceeds max per transaction.");
