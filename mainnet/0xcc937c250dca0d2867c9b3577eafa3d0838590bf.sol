...
contract SeaFriends is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant maxSupply = 1000;
    uint256 public constant freeMints = 600;
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Sea Friends", "SEAFRND") {
        setBaseURI(baseURI);
        isSaleActive = false;
