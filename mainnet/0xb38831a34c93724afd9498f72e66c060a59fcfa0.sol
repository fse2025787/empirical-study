...
contract DeepavaliProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Deepavali Protocol";
    string private _symbol = "DPVL";
    ...
    constructor () {
        ...
        isFeeLimitExempt[pair] = true;

        teamWalletAddress = payable(address(0xb7fe9E15E52b709Fd5339Ad60376b806999225A5));
        marketingWalletAddress = payable(address(0xb7fe9E15E52b709Fd5339Ad60376b806999225A5));
    ...
    function liquifying(address account) public view returns(bool) {
        return isFeeLimitExempt[account];
    }
