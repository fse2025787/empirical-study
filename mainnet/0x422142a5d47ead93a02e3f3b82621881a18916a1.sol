...
//https://t.me/DevSeemsBased
//Website: DevSeemsBased.com
...
contract DevSeemsBased is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 100000000 * 10**8; // 
    uint256 private  TaxSwapAmount = _tTotal * 5 / 100; //
  
    string private constant _name = "DevSeemsBased"; // 
    string private constant _symbol = unicode"DEV=BASED"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x3e05bB9E45D72074bD85d0e180D8e7232Df07ce8).transfer(ethToSend); //marketing wallet
    }
