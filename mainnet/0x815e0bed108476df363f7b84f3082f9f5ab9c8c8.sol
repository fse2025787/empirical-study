...
/**
 * @dev Contract for Soma Wave Coin
 */
contract SMW is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 120_000e18;

    constructor() ERC20("Soma Wave", "SMW") {
