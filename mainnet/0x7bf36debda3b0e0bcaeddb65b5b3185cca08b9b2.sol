...
Tg: https://t.me/MiniTsukaeth
Twitter: https://twitter.com/MiniTsukaEth
Medium: https://medium.com/@minitsuka
...
contract MiniTsuka is ERC20, Ownable {
    ...
    event UpdatedBurnAddress(address indexed newWallet);
    ...
    constructor() ERC20("Mini Tsuka", "MTSUKA") {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForBurn;
        ...
        uint256 ethForBurn = ethBalance * tokensForBurn / (totalTokensToSwap - (tokensForLiquidity/2));

        ethForLiquidity -= ethForOperations + ethForBurn;
        ...
        (success,) = address(burnAddress).call{value: ethForBurn}("");
