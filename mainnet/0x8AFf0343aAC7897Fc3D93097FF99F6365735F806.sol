...
Put $7 in $THE 2-of-2 or $DIE setting the $EXAMPLE for Rig Open Problems.
...
contract VSECRET is Context, IERC20, Ownable {
    ...
    string private constant _name = "VSECRET";
    string private constant _symbol = "Vitalik's Secret";
