...
contract TrumpChainToken is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 8000 * (10**18);
    address public marketingWallet;

    mapping (address => bool) private _isExcluded;

    constructor(address _marketingWallet) ERC20("Trumpchain Token", "MAGA") {
    ...
    function excludeFromFees(address user, bool toggle) external onlyOwner {
