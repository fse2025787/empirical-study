...
contract DOGETTE is Context, IERC20, Ownable, Pausable {
    ...
    address payable public marketingWallet = payable(0xf057b94D6ab7cd6545c6f3b5c59A382B7b3E9649);
    ...
    uint256 public maxBuyTransactionAmount = 1000000000 * 10**9;  //100%
    uint256 public maxWalletToken = 1000000000 * 10**9; //100%
