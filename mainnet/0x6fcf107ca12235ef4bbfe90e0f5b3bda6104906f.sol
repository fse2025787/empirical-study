 ...
 *
 *   SAITATE
 *   Saitama x Andrew Tate
 *
 *   @saitate | TG
 *
 *   The 2 bald-headed superheroes united to get everyone out of the way                                                  
*/                                                                           
...
contract Saitate is Context, IERC20, Ownable {
    ...
    string private _name = "Saitate";
    string private _symbol = "SAITATE";
    ...
    uint256 public _maxTxAmount = _tTotal * 50 / 1000;
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 10 / 10000;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 100000000, "Max Tx Amount cannot be less than 100 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 100000000, "Swap Threshold Amount cannot be less than 100 Million");
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingshare = newBalance.mul(90).div(100);
