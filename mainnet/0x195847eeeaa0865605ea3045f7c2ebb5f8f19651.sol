...
contract ExoticApes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Exotic Apes", "EAPE") {
    setHiddenMetadataUri("https://bbvsea.mypinata.cloud/ipfs/QmTAjjev62qoLtUG7jgNFTJ5nsrRReWC7gjSXBX5s5DGRL");
  }
