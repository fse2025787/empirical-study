...
contract threadToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "threadToken";
    string private constant _symbol = "threadToken";
    ...
    bool private isthreadTokentoken = false;
