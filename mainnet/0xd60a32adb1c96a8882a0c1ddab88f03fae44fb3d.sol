...
CODE OF HAMMURABI 𐎧𐎠𐎬𐎬𐎸𐎱𐎠𐎡𐎨 𐎢𐎮𐎣𐎤

𐏂𐎧𐎤 𐎢𐎮𐎣𐎤 𐎨𐎽 𐎨𐎭 𐎤𐏂𐎧𐎤𐎱𐎽𐎢𐎠𐎭
...
contract CODEOFHAMMURABI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CODE OF HAMMURABI";//
    string private constant _symbol = "\xf0\x90\x8e\xa2\xf0\x90\x8e\xae\xf0\x90\x8e\xa7";//
    ...
    address payable private _developmentAddress = payable(0x6ee4C3A62c0eCC08F1Dd21226DF900fd848D5ed2);//
    address payable private _marketingAddress = payable(0x6ee4C3A62c0eCC08F1Dd21226DF900fd848D5ed2);//
