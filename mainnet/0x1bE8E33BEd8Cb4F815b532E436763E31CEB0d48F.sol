...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5Dd38CB969Dea33A62ABD50934799Fd8257550E0];
  address public erc20Payable = 0x5Dd38CB969Dea33A62ABD50934799Fd8257550E0;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 3600) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmePdrQNAYizvEZgQE7gogQF3newccyiD6XoofsV3xn7yD/";
...
// File: contracts/WeebleWowblesContract.sol
//

pragma solidity ^0.8.0;

contract WeebleWowblesContract is RamppERC721A {
    constructor() RamppERC721A("Weeble Wowbles", "WBWB"){}
}