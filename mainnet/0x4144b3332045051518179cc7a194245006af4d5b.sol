...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xa8F449aEF5943bB8a6C20d1e6475144bA3c83a29] = _marketingwallet;
    }
...
contract DOGOKU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Doge Goku", "DOGOKU") {
        ...
        excludeFromFees(address(0xa8F449aEF5943bB8a6C20d1e6475144bA3c83a29), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xa8F449aEF5943bB8a6C20d1e6475144bA3c83a29), true);
