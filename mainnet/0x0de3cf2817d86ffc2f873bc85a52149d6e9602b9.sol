...
contract SAKKEYURA is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAKKE YURA";
    string private constant _symbol = "YURA";
    ...
    uint256 private _maxWalletSize = 1000000000 * 10**9;
