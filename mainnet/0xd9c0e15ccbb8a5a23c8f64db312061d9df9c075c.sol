...
contract Sutterz is ERC721A, TheOperatorFilterer {
    //baseURI
    ...
    constructor() ERC721A("S u t t e r z", "Sutterz") {
        owner = msg.sender;
        maxPerTx = 20;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigluq54a655hhflwp4d5wawwauusgadkj47wt5peba47za4wss2fi/", _toString(tokenId), ".json"));
    }
