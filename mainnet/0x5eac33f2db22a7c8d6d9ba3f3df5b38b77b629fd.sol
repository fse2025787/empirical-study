...
/* 
https://t.me/BonkShibaERC
If you just got dumped on by the 700k wallet 
that was bought for $330 on BONK buy a $20 bag and HODL
at launch and lets moon this !!
*/
...
contract BonkS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public constant bsAddress = address(0x8BFCF49a5874a336E10c648647eb1186986a71d0);
    ...
    constructor() ERC20("BonkShiba", "BonkS") {
        ...
        uint256 totalSupply = 11 * 1e6 * 1e18;
        ...
        devWallet = address(0x8BFCF49a5874a336E10c648647eb1186986a71d0); // BonkS Address
