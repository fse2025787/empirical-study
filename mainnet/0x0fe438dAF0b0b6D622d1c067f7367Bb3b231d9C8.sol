...
contract SavvySeagulls is ERC721A, Ownable, ReentrancyGuard {
    ...
    string baseURL = "https://ipfs.io/ipfs/Qmat6M1of73j8QtU1UCAQSHApmN43A34a2v7das2Lcwo8Q/";
    ...
    constructor() ERC721A("Savvy Seagulls", "SVYSGLS") {
    }
    ...
    modifier mintComp(uint256 _mintAmount){
        ...
        require(balanceOf(_msgSender()) + _mintAmount <= maxMintAmountPerWallet, "You have 10 Seagulls.");
        _;
    }

    function mint(uint256 _mintAmount) public payable nonReentrant mintComp(_mintAmount){
