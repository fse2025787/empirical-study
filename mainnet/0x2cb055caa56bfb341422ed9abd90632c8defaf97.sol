...
contract Emerald is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0xb7B1B539Fcf6Ba2Be0cCd48f12aCb76e152B899b); // Marketing Wallet
    address payable private devWallet = payable (0xb7B1B539Fcf6Ba2Be0cCd48f12aCb76e152B899b); // dev Wallet
    ...
    string private _name = "Emerald";
    string private _symbol = "EMD";
    ...
    uint256 public _buyMarketingFee = 20;   //4%
    ...
    uint256 public swapThreshold = _tTotal.div(1000).mul(3); //0.3%
