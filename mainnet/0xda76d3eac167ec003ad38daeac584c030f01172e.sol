...
contract Shumo is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x046ec226cd522f93c6F0F9d8C2e8Fd61dB3e439d); // Marketing Address

    address payable public liquidityAddress =
        payable(0x2c3cA3A17E44Ef08B7DAcf94e06117a61149Df90); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10 * 1e12 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Shumo";
