...
contract TSUKASTRIPERC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka's Trip";
    string private constant _symbol = "TSUKASTRIP";
