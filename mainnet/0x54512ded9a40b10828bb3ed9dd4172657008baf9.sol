...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xFb3808F85BAb21cbbE9827Dc5227D41336929B1b,0x69C8f376DD9d9144aC7800302E1151f1599DD9Bb];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVfKLFNtQRoz9ivKgXRLpAQsse5Jkhsv4KFqXu6LpKK2K/";
...
// File: contracts/wealthCyborgsClubContract.sol
//

pragma solidity ^0.8.0;

contract WealthCyborgsClubContract is RamppERC721A {
    constructor() RamppERC721A("Wealth Cyborgs Club", "WCCs"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/afv9nkKZdOYSf2ZGcIKI/contract-metadata";
    }
}