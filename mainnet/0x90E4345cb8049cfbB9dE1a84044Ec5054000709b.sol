...
//*********************************************************************//
//
//  _    _ ___________ _    ______   ___________   _    _ _   _ ________  ________ _____ _____ _____ 
// | |  | |  _  | ___ | |   |  _  \ |  _  |  ___| | |  | | | | |_   _|  \/  /  ___|_   _|  ___/  ___|
// | |  | | | | | |_/ | |   | | | | | | | | |_    | |  | | |_| | | | | .  . \ `--.  | | | |__ \ `--. 
// | |/\| | | | |    /| |   | | | | | | | |  _|   | |/\| |  _  | | | | |\/| |`--. \ | | |  __| `--. \
// \  /\  \ \_/ | |\ \| |___| |/ /  \ \_/ | |     \  /\  | | | |_| |_| |  | /\__/ /_| |_| |___/\__/ /
//  \/  \/ \___/\_| \_\_____|___/    \___/\_|      \/  \/\_| |_/\___/\_|  |_\____/ \___/\____/\____/ 
//                                                                                                   
// STRANGE IS JUST THE BEGINNING.
// TWITTER: @WORLDOFWHIMSIES
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x829D29a68f787de9d3D25434278F6515e2f9eB5D];
  address public erc20Payable = 0x829D29a68f787de9d3D25434278F6515e2f9eB5D;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4400) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/6xMI8wNkggNdOm7hBLiM/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ItIQOpULa4ej4tY7hkPo/contract-metadata";
  }
...
// File: contracts/WorldofWhimsiesContract.sol
//

pragma solidity ^0.8.0;

contract WorldofWhimsiesContract is RamppERC721A {
    constructor() RamppERC721A("World of Whimsies", "WHIMSY"){}
}