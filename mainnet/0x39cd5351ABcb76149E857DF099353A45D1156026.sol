...
contract DNAtoSpace is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 700;

  bool public paused = false;
  bool public revealed = false;

  constructor() ERC721("DNA to Space", "DTC") {
    setHiddenMetadataUri("ipfs://QmTBWYpxz6wahsHbkjKtX2RJxYy16jxgEBS7PQnnTmJ5Sc/");
  }
