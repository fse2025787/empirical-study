...
contract JPEXFlashPokerNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    string private mBaseURI = "";

    constructor() ERC721("JPEX Flash Poker NFT", "JPEXNFT") {
    ...
    function setBaseURI(string memory uri) public onlyRole(MINTER_ROLE) {
        require(bytes(uri).length > 0, "Base URI string cannot be empty");
        mBaseURI = uri;
    }
