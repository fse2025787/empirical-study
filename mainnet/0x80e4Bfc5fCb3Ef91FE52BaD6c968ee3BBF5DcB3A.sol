...
//    /   |  ____  ____ ____  / ( )_____   / __ \____ _      ______  / __/___ _/ / /
//   / /| | / __ \/ __ `/ _ \/ /|// ___/  / / / / __ \ | /| / / __ \/ /_/ __ `/ / / 
//  / ___ |/ / / / /_/ /  __/ /  (__  )  / /_/ / /_/ / |/ |/ / / / / __/ /_/ / / /  
// /_/  |_/_/ /_/\__, /\___/_/  /____/  /_____/\____/|__/|__/_/ /_/_/  \__,_/_/_/   
//              /____/                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x087F5240fff0b74F907F60D3AB1dd3795BC93AbE];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRFLT9jzB9uWQ8UvkHHh9QecVVyh1C26yy6aHFzSUxwpi/";
...
// File: contracts/AngelsDownfallContract.sol
//

pragma solidity ^0.8.0;

contract AngelsDownfallContract is RamppERC721A {
    constructor() RamppERC721A("Angels Downfall", "RAMPP"){}
}
