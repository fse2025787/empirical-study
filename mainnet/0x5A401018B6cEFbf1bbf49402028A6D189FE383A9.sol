...
/** YinYang - complete opposites but they fullfill each other. Opposite forces battling against each other but could not be with out each other.
...
contract YinYang is Context, IERC20, Ownable {
    ...
    string private _name = "YinYang";
    string private _symbol = "YinYang";
