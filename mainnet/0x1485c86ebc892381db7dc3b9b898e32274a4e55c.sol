...
/**
RABBIT AI is a token that resides on the Ethereum network. 
the purpose of this token is to make security for investors from many circles, 
because in our opinion there are so many cryptocurrency projects that deliberately take advantage 
of the situation to trap investors so that they fall into a fraud trap. 
With the project that we are going to carry out, 
we have high hopes for the safety of all investors from fraud 
by irresponsible developers. 

Telegram : https://t.me/Rabbit_AI
...
contract ERC20 is Context, IERC20, IERC20Metadata {
 ...
 contract RABBITAI is ERC20, Ownable {
    string private _name = "RABBIT AI";
    string private _symbol = "RBAI";
    ...
    address public marketingWallet = 0xeFe7CAC7133E60d659C1820dAB0a5D1bfABda155;
