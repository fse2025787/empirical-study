...
contract FiveInOne is ERC721AQueryable, Ownable {
  ...
  uint256 public publicMintFee = 0.05 ether; // public minting fees in ether.
  ...
  constructor(string memory baseUri_,  address feeReceiver_) ERC721A("The Metaverse of Shibgotchi", "ShibgotchiNFT") {
    baseUri = baseUri_;
