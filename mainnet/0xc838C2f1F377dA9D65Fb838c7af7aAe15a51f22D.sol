...
🐉 $PYTHON - The Fable of Python 🐉

There are so many untold stories, so many dragon tales, but this one.. you surely will want to hear.

https://thefableofpython.com 
https://t.me/thefableofpython 
...
contract thefableofpython is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Fable of Python";
    string private constant _symbol = unicode"PYTHON";
