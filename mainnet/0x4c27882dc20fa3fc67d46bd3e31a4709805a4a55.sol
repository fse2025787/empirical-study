...
contract INUSTRATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"INUSTRATOR";
    string private constant _symbol = unicode"INUSTRATOR";
