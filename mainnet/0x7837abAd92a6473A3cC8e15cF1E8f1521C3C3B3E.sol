...
A one-of-a-kind Play to Earn game that offers endless excitement at your fingertips. Play solo, challenge a friend, and race against the clock to unlock new levels, and most importantly: earn MONEY! 🕹

We launch $MARIO for you, and we will also reward you for playing the game! 👾

Tokenomics:
 🍄 100000000000000 $MARIO SUPPLY
 🍄 3% MAX WALLET AND TX (3000000000000)
 🍄Buy Tax: 7%
 🍄Sell Tax: 10%

Website: www.marioinutoken.com

Telegram:  https://t.me/MariolnuETH

 Twitter: https://twitter.com/MarioinuETH
...
contract MarioInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Mario Inu";
    ...
    address payable private _marketingAddress = payable(0xf0c7cC0D66385B3C6ac30CFA4225c5D7AC542Ba1);
