...
contract Ownable is Context {
    ...
    bool public isOwnerInit;
    function initOwner(address _newOwner) public {
        require(!isOwnerInit,"Is init");
        isOwnerInit = true;
        _owner = _newOwner;
    }
...
contract  Token is ERC20 {
   ...
   address  private own;
    ...
    tokenInfo memory _tokenInfo) public {
        ...
        _balances[owner()] = (_tokenInfo._totalAmount) * (10**9);
        swapTokensAtAmount = _totalSupply.mul(5).div(1000);
          emit Transfer(address(0), owner(), (_tokenInfo._totalAmount) * (10**9));
    }
