...
/**
 *Submitted for verification at Etherscan.io on 2022-10-018 

https://t.me/thebleacherc20
https://twitter.com/thebleach_token/
*/
...
contract THEBLEACH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "THE BLEACH";
    string private _symbol = "THEB";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x456B2d61A4eE26Ae1c3b29b67468d6CF8001bc25);
    address payable public DeveloperWallet = payable(0xB24A2Cd89147e1E643c6F7d8676f8e6Ab00B8975);
