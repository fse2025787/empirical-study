...
contract sumo is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Sumo", "SUMO") {
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _devFee) external {
        ...
        require(buyTotalFees <= 6000, "Must keep fees at 6% or less");
    }
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellTotalFees <= 10000, "Must keep fees at 10% or less");
    }
