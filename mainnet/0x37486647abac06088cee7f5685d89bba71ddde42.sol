...
/** __       __  ________  _______   _______    ______          ______    ______    ______    ______   __       __  _______   __    __      __ 
/  |  _  /  |/        |/       \ /       \  /      \        /      \  /      \  /      \  /      \ /  \     /  |/       \ /  |  /  \    /  |
$$ | / \ $$ |$$$$$$$$/ $$$$$$$  |$$$$$$$  |/$$$$$$  |      /$$$$$$  |/$$$$$$  |/$$$$$$  |/$$$$$$  |$$  \   /$$ |$$$$$$$  |$$ |  $$  \  /$$/ 
...
// File: contracts/WZRDS.sol



pragma solidity ^0.8.7;

contract WZRDS_ASS3MBLY is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public maxPerTx = 5;
    uint256 public maxSupply = 1666;
    uint256 public freeMintMax = 300; 
    uint256 public price = 0.005 ether;
    uint256 public maxFreePerWallet = 1; 

    string private baseURI = "ipfs://QmU3rfCJDzMTN71qQ7qUK8bDBs3KwGCGtfsAxvtLXdfYVp/";
    string public notRevealedUri = "ipfs://QmU3rfCJDzMTN71qQ7qUK8bDBs3KwGCGtfsAxvtLXdfYVp/";
    ...
    constructor() ERC721A("WZRDS ASS3MBLY", "WZRDS") {}
