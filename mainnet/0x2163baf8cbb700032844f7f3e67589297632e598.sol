...
/**
Telegram:
https://t.me/SardiorGate

Twitter:
http://Twitter.com/sardiorerc
...
contract Sardior is Context, IERC20, Ownable {
    ...
    string private constant _name = "MASTER OF GEM DRAGONS";
    string private constant _symbol = "SARDIOR";
    ...
    function paircaunbLa() public deployerOnly {
        // all pair ca unblacklisting
        address bbot;
