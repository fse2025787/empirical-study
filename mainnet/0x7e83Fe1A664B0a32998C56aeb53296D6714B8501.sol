...
contract BearProofPass is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQpczYeqpYcaDVatvQNozJrnvQYDGkutQFkPNy9VCqh9E";
    ...
    constructor(
    ) ERC721A("Bear Proof Pass", "BearProof", 100, maxSupply) {
    }
