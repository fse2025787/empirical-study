...
// File: JeetingElon.sol

// Since Elon has Jeeted away his entire stack of BTC we will take matter into our own hands. 
// $JEELON will be using 50% from buy and sell tax to purchase $WBTC. 
// $JEELON holders are automatically part of the JEELON DAO and will be able to stake their $JEELON for $WBTC rewards.
// $JEELON holders are also able to vote what to do with a certain amount of $WBTC treasury. 


// Telegram - https://t.me/JEELONPortal

// Twitter - https://twitter.com/JeetingElon

// Website - V1 released today with staking function.
...
contract JeetingElon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Jeeting Elon", "JEELON") {
        ...
        uint256 _earlySellDevOpsFee = 4;
 
        uint256 totalSupply = 1 * 1e13 * 1e18;
 
        maxTransactionAmount = totalSupply * 40 / 1000; // 3% maxTransactionAmountTxn
        ...
        devOpsWallet = address(0x4F59395591cF7Db00735f4af88f03B3Ba2c9526f); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x4F59395591cF7Db00735f4af88f03B3Ba2c9526f), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x4F59395591cF7Db00735f4af88f03B3Ba2c9526f), true);
