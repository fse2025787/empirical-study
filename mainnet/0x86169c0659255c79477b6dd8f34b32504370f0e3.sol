...
/*
    The ERC20 GLG tokens have been generated by Golden Loop Group (GLG) LLC. 

    The purchase possession, exchange and use and ownership of these tokens are subject 
    to the terms and conditions, risk warnings and disclaimers issued by Golden Loop Group (GLG) LLC 
    which can be found at www.glgcoin.com/terms/ERC20token and which shall be binding on all 
...
contract GLG is ERC20Burnable, ERC20Mintable {
    address depositAddress = 0x4Bf7CbdB2B50E78614Ab1B6d2687e60E52B0368D;
    uint256 amount = 200000000000;

    constructor()
        public
        ERC20("Golden Loop Group (GLG) Token", "GLG")
    {
