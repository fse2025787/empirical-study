...
contract VikingVault52 is Context, Ownable, Fees {
    ...
    constructor(address Token) {
        ...
        vault.stakingPeriod = 52 weeks; // 12 months staking period.
        withdrawFeePeriod = vault.stakingPeriod; // 12 months fee period.
        withdrawPenaltyPeriod = 8 weeks; // 8 weeks penalty period.
