...
contract NoIdea is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function updateBuyFee(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
    ...
    function updateSellFee(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
