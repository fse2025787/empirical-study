...
contract PepeApeYachtClub is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZ3zZt227PcYs5EjVFNJ3gAnDvdCVDU99rkVjoJASseXc";
    ...
    constructor(
    ) ERC721A("Pepe Ape Yacht Club", "PAYC", 100, maxSupply) {
    }
