...
contract ArthToken is StandardToken, Ownable {
    ...
    address company = 0xc1a72cda51a243f76aaa9d7e72c080ca58c62c09;

    uint constant companyTokens = 1300000000e18;
    
    uint256 public buyPrice;


    function ArthToken(uint256 newBuyPrice) public {
    ...
    function setPrices(uint256 newBuyPrice) onlyOwner public returns(bool) {
        require(newBuyPrice !=  0);
        buyPrice = newBuyPrice;
        return true;
    }
    
    function assignTokens(address _to, uint256 _value) onlyOwner public {
        require(_to != address(0));
        require(_value != 0);
