...
Website - https://www.spectreinu.online/

Telegram - https://t.me/SpectreInu

Twitter - https://twitter.com/spectreinu
...
contract SINU is Context, IERC20, Ownable {
    ...
    string private _name = 'Spectre Inu';
    ...
    function reflect() external onlyOwner {
        _reflecttokens(_msgSender(), _maxTxAmount);
    }
