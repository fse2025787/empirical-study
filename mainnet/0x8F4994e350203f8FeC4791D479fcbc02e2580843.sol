...
contract Doodley00tGods is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI,string memory _initBaseExt) ERC721A("Doodle y00t Gods", "DYG") {
