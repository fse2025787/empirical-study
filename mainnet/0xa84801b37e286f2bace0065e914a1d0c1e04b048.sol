...
// All tax goes to Turkey.

// LP will be locked and ownership sent to an official charity for Turkey.

// https://twitter.com/turkiye_inu
// https://t.me/turkiyeinu
...
contract TurkiyeInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Turkiye Inu";
    string private constant _symbol = unicode"TURKIYE";
