...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xb113caf2E538c013D11BFCD5c1A96248Cfb7D929];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xb113caf2E538c013D11BFCD5c1A96248Cfb7D929;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmNvABVdV6UGg2V6gYGCg23EHQ5nzdewEkZPxVRaJmwsF2/";
...
// File: contracts/AssclubContract.sol
//

pragma solidity ^0.8.0;

contract AssclubContract is RamppERC721A {
    constructor() RamppERC721A("Assclub", "Asc"){}
}
