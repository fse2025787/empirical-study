...
// File: contracts/NiftyMuslimBrother.sol
...
contract NiftyMuslimBrother is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard, PaymentSplitter{
    ...
    uint private constant MAX_FREE = 300;

    uint public pricePresale = 0.05 ether; 

    uint public publicSalePrice = 0.0313 ether;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, string memory _theBaseURI, string memory _theNotRevealedURI, bytes32 _merkleRoot) 
    ERC721A("Nifty Muslim Brother", "NMB")
    ...
    function Giveaway(address _to, uint _quantity) external onlyOwner {
