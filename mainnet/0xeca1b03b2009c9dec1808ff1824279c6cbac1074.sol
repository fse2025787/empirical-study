...
/**
    Uptober ERC Token
    Telegram: https://t.me/uptobereth
...
contract Uptober is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xeC1396f29c7Ee6Ab825CB3535BAf6763B323aaD0); // Marketing Address
    address payable public multiSigAddress = payable(0x5f1a0E65Ccd168b94bDF5466983E58744A6322e3); // Marketing Address
    address payable public devAddress = payable(0x5f1a0E65Ccd168b94bDF5466983E58744A6322e3); // Dev Address
    address payable public liquidityAddress = payable(0x5f1a0E65Ccd168b94bDF5466983E58744A6322e3); // Liquidity Address
    ...
    string private constant _name = unicode"Uptober";
    string private constant _symbol = unicode"UPTOBER";
