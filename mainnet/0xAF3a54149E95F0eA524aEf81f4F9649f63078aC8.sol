...
contract SpaceApeClub is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 100000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmXZ1KrJmiit9PvevF3NRPCS1fZYhBWXG9LJZCHsKY2X7g/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Space Ape Club", "SPACE-APE", MAX_MINTS, MAX_SUPPLY) {  
    }
