...
contract TrumpTwo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trump 2.0";
    string private _symbol = unicode"Trump2.0";
    ...
    address payable public marketingWalletAddress = payable(0x78E6364D46C3E2e0eAD1E596c7877424dBB313a2); 
    address payable public BurnedWalletAddress = payable(0x78E6364D46C3E2e0eAD1E596c7877424dBB313a2); 
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000 * 10**_decimals; 
