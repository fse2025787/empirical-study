...
// TG:      https://t.me/PhotoAIETH
// Medium:  https://medium.com/@PhotoAI/
...
contract PhotoAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Photo AI"; 
    ...
    address payable private _developmentWalletAddress = payable(0x05bCF7Ec8080456ab12de9754Dd715CD01B29413);
    address payable private _marketingWalletAddress = payable(0x05bCF7Ec8080456ab12de9754Dd715CD01B29413);
    ...
    uint256 public _maxTxAmount = 30000000 * 10**9;      // 3% MAX TX
