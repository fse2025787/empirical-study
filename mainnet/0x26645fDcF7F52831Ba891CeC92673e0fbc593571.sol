...
//*********************************************************************//
//
//     ____  __  ________   __________  _______   _______    _   ______________
//    / __ \/ / / / ____/  / ____/ __ \/ ____/ | / / ___/   / | / / ____/_  __/
//   / /_/ / / / / / __   / /_  / /_/ / __/ /  |/ /\__ \   /  |/ / /_    / /   
//  / _, _/ /_/ / /_/ /  / __/ / _, _/ /___/ /|  /___/ /  / /|  / __/   / /    
// /_/ |_|\____/\____/  /_/   /_/ |_/_____/_/ |_//____/  /_/ |_/_/     /_/     
//                                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  */
  ...
  uint256 public allowlistDropTime = 1654887600;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8669D6B0c033CeAba3cF0061bF2539f5A61Dd050];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 6969 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYzVj34oTJDAzMCcyQJdHUmkVFcitKLAvZPRDF63oXcBy/";
...
// File: contracts/RugFrensNftContract.sol
//

pragma solidity ^0.8.0;

contract RugFrensNftContract is RamppERC721A {
    constructor() RamppERC721A("Rug Frens NFT", "FRENS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/B59Guw1bHIjiGuVb7lMU/contract-metadata";
    }
}
