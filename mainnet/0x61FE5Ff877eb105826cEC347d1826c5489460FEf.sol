...
contract BoboDegenApocalypse is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(totalSupply() + reserved + _mintAmount <= maxSupply, 'Ask Bobrandt.eth nicely');
