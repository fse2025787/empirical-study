...
contract SwapSushiAndV2Router {
    ...
    function sushiForUniswapV2CallBack(
        ...
        if (amount0 > 0) {
            ...
            CommonLibrary.swapExactTokenByV2(amount0, token0, token1);
            // require(
            //     amountOut - payETHToCoinbase >= amountIn,
            //     "amount less min"
            // );
            ...
            CommonLibrary.swapExactTokenByV2(amount1, token1, token0);
            // require(
            //     amountOut - payETHToCoinbase >= amountIn,
            //     "amount less min"
            // );
    ...
    function uniswapV2ForSushiCallback(
        ...
        if (amount0 > 0) {
            ...
            CommonLibrary.swapExactTokenBySushi(amount0, token0, token1);
            // require(
            //     amountOut - payETHToCoinbase >= amountIn,
            //     "amount less min"
            // );
            ...
            CommonLibrary.swapExactTokenBySushi(amount1, token1, token0);
            // require(
            //     amountOut - payETHToCoinbase >= amountIn,
            //     "amount less min"
            // );
