...
/*
 .----------------.  .-----------------. .----------------.   .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. |
| |     ____     | || | ____  _____  | || |  _________   | | | |  _________   | || |  _________   | || |  ____  ____  | |
| |   .'    `.   | || ||_   \|_   _| | || | |_   ___  |  | | | | |_   ___  |  | || | |  _   _  |  | || | |_   ||   _| | |
| |  /  .--.  \  | || |  |   \ | |   | || |   | |_  \_|  | | | |   | |_  \_|  | || | |_/ | | \_|  | || |   | |__| |   | |
| |  | |    | |  | || |  | |\ \| |   | || |   |  _|  _   | | | |   |  _|  _   | || |     | |      | || |   |  __  |   | |
| |  \  `--'  /  | || | _| |_\   |_  | || |  _| |___/ |  | | | |  _| |___/ |  | || |    _| |_     | || |  _| |  | |_  | |
| |   `.____.'   | || ||_____|\____| | || | |_________|  | | | | |_________|  | || |   |_____|    | || | |____||____| | |
| |              | || |              | || |              | | | |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------' 
*/
...
contract oneETH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("oneETH", "$1E") {
     ...
     uint256 totalSupply = 1 * 10 ** 12 * 10 ** decimals();
        ...
        maxTransactionAmount = 15 * 10 ** 9 * 10 ** decimals(); // 1.5% maxTransactionAmountTxn
