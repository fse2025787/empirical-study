...
/*
    ...
    Hexabis also known as Ancient Egyptian is the god of death, mummification, embalming, the afterlife, cemeteries, tombs, and the Underworld
    In ancient Egyptian religion, usually depicted as a canine or a man with a canine head.

    https://t.me/hexabis
    https://twitter.com/hexabis_
    https://medium.com/@hexabis
*/
...
contract HEXABIS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HEXABIS";
    string private constant _symbol = "HEXABIS";
    ...
    address payable private _developmentAddress = payable(0x5feEF3e7CDd61D378934f2eF8bd7Af391ca6afF5); 
    address payable private _marketingAddress = payable(0x5feEF3e7CDd61D378934f2eF8bd7Af391ca6afF5);
