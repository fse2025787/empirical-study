...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4Fa3AE7923B39463d0f1e69E103201326F47A028;
...
contract FDG is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x4Fa3AE7923B39463d0f1e69E103201326F47A028);
    address payable private Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private Wallet_zero = payable(0x000000000000000000000000000000000000dEaD); 
    ...
    */
    ...
    string private _name = "Flash Dragon"; 
    string private _symbol = "FDG";  
    ...
    uint256 private maxPossibleFee = 3; 
    ...
    */
    ...
    uint256 private _maxWalletToken = _tTotal.mul(100).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (100% at launch)
    uint256 private _maxTxAmount = _tTotal.mul(100).div(100); 
