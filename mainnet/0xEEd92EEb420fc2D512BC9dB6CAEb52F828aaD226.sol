...
contract WeAreEverything is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmaH4fqH8xwh8k6JUAxvsTqYHuwikQ1QdxR4MMASQjQuxP/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.00777 ether;
  uint256 public maxSupply = 777;
  uint256 public maxMintAmountPerTx = 10;
  uint256 public freeUntil = 777;
  uint256 public freebiesPerWallet = 1;
  mapping(address => uint256) public freebieMap;

  bool public paused = false;

  constructor() ERC721A("WeAreEverything", "WAE") {
  }
