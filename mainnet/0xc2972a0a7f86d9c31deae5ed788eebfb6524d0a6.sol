...
contract MINATO is Context, IERC20, Ownable {
    ...
    string private _name = "Minato Namikaze Inu";
    string private _symbol = "MINATO";
    ...
    address public marketing = 0x51648Fff9049e75b366095706b30B402Cefe36A0;
    ...
    uint256 public _maxBalAmount = _tTotal.mul(7).div(1000);
