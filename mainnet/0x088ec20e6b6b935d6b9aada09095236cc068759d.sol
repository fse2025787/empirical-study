...
The reason why Dumbledore Inu is designed with a burn function is simply because we want to pay tribute to his glorious and faithful pet - Fawkes. 

https://dumbledoreinu.com
...
contract DINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "DUMBLEDORE inu";
    ...
    constructor () {
        _feeAddress = payable(0xAcABAAD572D67B035dBFF22F1a7790ea8A5E9995);
        _buyTax = 10;
        _sellTax = 10;
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        if (maxTxAmount > 2000000000 * 10**9) {
