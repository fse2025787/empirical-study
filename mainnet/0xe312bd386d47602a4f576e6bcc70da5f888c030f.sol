...
contract KFC_RESUME is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 1100;
    

    uint256 public publicPrice = 0.0025 ether;

    uint256 constant public PUBLIC_MINT_LIMIT_TXN = 3;
    uint256 constant public PUBLIC_MINT_LIMIT = 6;

    string public revealedURI;

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://T2GUQQYJY3A44XVYEH9V6AQEBKVS5RFYRT";
    ...
    address constant internal DEV_ADDRESS = 0x7b6fc4900E42bcf2737c919B18C2a168c3d0B1E7;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("KFC Resume", "KFC") { }
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x7b6fc4900E42bcf2737c919B18C2a168c3d0B1E7");
