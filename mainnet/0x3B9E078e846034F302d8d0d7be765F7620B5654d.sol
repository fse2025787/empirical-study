...
contract BikiniBottomMiniature is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.004 ether;
    uint   public maxTx             = 506;
    uint   public maxSupply         = 506;
    ...
    constructor() ERC721A("Bikini Bottom Miniature", "BikiniBottomMiniature") {}
