...
contract SakuraInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sakura Inu", "SakuraERC") {
        ...
        uint256 buyProjectFee = 3;
        uint256 buyLiquidityFee = 4;

        uint256 sellProjectFee = 4;
        uint256 sellLiquidityFee = 3;
        
        uint256 totalSupply = 1e10 * 1e9;
        
        maxTransactionAmount = totalSupply * 10 / 100; 
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 3 / 1000) / 1e9, "Cannot set maxTransactionAmount lower than 0.1%");
