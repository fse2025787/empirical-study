...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1671737400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x53C84004F2E46BB6568e33e53dE24427E9a9f0d9];
  address public erc20Payable = 0x53C84004F2E46BB6568e33e53dE24427E9a9f0d9;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 3004) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdyfKtmGQZt2jxBBXwXkKmYRdAb8ohTxybn8DFkjHYZWv/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/DOapQOojPbp30XLqWsiq/contract-metadata";
  }
...
// File: contracts/SbfTradingCardsOfficialContract.sol
//

pragma solidity ^0.8.0;

contract SbfTradingCardsOfficialContract is RamppERC721A {
    constructor() RamppERC721A("SBF Trading Cards Official", "SBF"){}
}
