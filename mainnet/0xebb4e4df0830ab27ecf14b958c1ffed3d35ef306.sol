...
Whitepaper: https://vshapefinance.gitbook.io/
...
contract VshapeFinance is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Vshape Finance";
    string private constant _symbol = unicode"VSPF";
