...
/**
Welcome to Anti Tax Farm! We're an Ethereum zero tax project dedicated to taking a stand against crypto projects which exploit users for ridiculous tax percentages. Our project allows all income generated by our smart contracts and tokens to remain untaxed, leaving investors with more of their hard-earned money.
Our innovative technology makes it easy for people to invest without worrying about what a crypto project may do when it comes time to pay. We believe that no investor or user should have to worry that they may lose out on their profits because of the absurd amount of taxes being levied by other projects.

https://anittaxfarm.com
https://t.me/Antitaxfarmeth
...
contract AntiTaxFarm is ERC20, Ownable {
    ...
    constructor() ERC20("Anti Tax Farm", "ATF") {
