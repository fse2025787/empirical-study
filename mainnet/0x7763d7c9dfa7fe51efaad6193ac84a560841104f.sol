...
contract TheMightyDragon is ERC20, Ownable {
    ...
    uint256 public maxWalletToken = 100000000 * (10**9);
    uint256 public maxBuyTxAmount = 100000000 * (10**9);
    uint256 public maxSellTxAmount = 100000000 * (10**9);
    uint256 public swapTokensAtAmount = 80000 * (10**9);

    uint256 public marketingFee = 3;

    address payable public marketingWallet = payable(0x4767014E6847543505294CF4B49C053B47a306E5);
    ...
    constructor() ERC20("The Mighty Dragon", "CHENGDU") {
