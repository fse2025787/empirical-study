...
//*********************************************************************//
//
//     ___       ____             __              _                _    ___      _                __             __  ______  ____  ______
//    /   |     / __ \__  _______/ /_____  ____  (_)___ _____     | |  / (_)____(_)___  ____     / /_  __  __   / / / / __ \/ __ \/ ____/
//   / /| |    / / / / / / / ___/ __/ __ \/ __ \/ / __ `/ __ \    | | / / / ___/ / __ \/ __ \   / __ \/ / / /  / /_/ / / / / /_/ / __/   
//  / ___ |   / /_/ / /_/ (__  ) /_/ /_/ / /_/ / / /_/ / / / /    | |/ / (__  ) / /_/ / / / /  / /_/ / /_/ /  / __  / /_/ / ____/ /___   
// /_/  |_|  /_____/\__, /____/\__/\____/ .___/_/\__,_/_/ /_/     |___/_/____/_/\____/_/ /_/  /_.___/\__, /  /_/ /_/\____/_/   /_____/   
//                 /____/              /_/                                                          /____/                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf36Aa99a000A53a193F78c13229BDF550bd94d73];
  address public erc20Payable = 0xf36Aa99a000A53a193F78c13229BDF550bd94d73;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 230) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifzztenhwedowae5wuxt2r7b3buvkkb6i3t4fwianolbdr74ormdm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/crQZmaJblvqwKUSTRQch/contract-metadata";
  }
...
// File: contracts/ADystopianVisionbyHopContract.sol
//

pragma solidity ^0.8.0;

contract ADystopianVisionbyHopContract is RamppERC721A {
    constructor() RamppERC721A("A Dystopian Vision by HOP", "DVHOP"){}
}
