...
/* 
    ...
    █   F o m o s p h e r e     $ F M S

    ░   https://blobmixer.14islands.com/

    ▒   https://twitter.com/FOMO_SPHERE

    ▓   https://medium.com/@fomosphere/taking-fomo-to-a-new-dimension-d630f19a11fa
...
contract FMSToken is ERC20, Ownable {
    ...
    constructor() payable ERC20("FOMOSPHERE", "FMS") {
        ...
        uint256 totalSupply = 5555555555 * 1e18;
        ...
        operationsAddress1 = address(0x220Ce548335248aB2B4d900cbF5bF718286287FD); //80%
        operationsAddress2 = address(0x220Ce548335248aB2B4d900cbF5bF718286287FD); //20%
        lpReceiverAddress = address(0x220Ce548335248aB2B4d900cbF5bF718286287FD);
