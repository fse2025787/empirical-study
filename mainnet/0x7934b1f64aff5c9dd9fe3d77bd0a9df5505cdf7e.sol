  ...
  IERC721Enumerable
{
  ...
  // operator approval access for Opensea Seaport
  bool public marketplaceApproval;

  // owner disapproval access for Opensea Seaport
  mapping(address => bool) private _disapprove;
  ...
  function setMarketplaceApproval(bool _marketplaceApproval) internal {
    marketplaceApproval = _marketplaceApproval;
  }

  function setApproval(bool _approval) public {
    _disapprove[_msgSender()] = !_approval;
  }
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(marketplaceApproval && !_disapprove[owner] && operator == address(0x1E0049783F008A0085193E00003D00cd54003c71)){
      return true;
    } else {
