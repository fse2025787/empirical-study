...
/*
Lorempsum是一种填充文本，用于平面设计、电子排版和出版领域。 这被用作行业的标准虚拟文本，
以便人们可以查看文本布局而不会被其内容分散注意力。对于从事平面设计和类似领域的人来说，
lorempsum文本是一个非常有用的工具。如果有人希望客户专注于网页，
产品标签或其他设计的设计布局，他们不希望任何分心。
*/
...
contract Lorem is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Lorem Ipsum";
    string private constant _symbol = "FILLER";
    ...
    address payable private liqAddress = payable(0x013aAECa5b61a7355D009876Eb59F7B1dC96d9fA);
