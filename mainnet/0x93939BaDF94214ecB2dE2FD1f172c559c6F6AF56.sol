...
// File contracts/BigBros.sol

// 
pragma solidity 0.8.11;

contract BigBros is Auth, ERC721 {
  ...
  constructor(string memory newUnrevealedURI) ERC721("BigBros", "BigBros") {
  ...
  function mint(uint256 amount) external payable {
    ...
    if (msg.sender != owner) {
      ...
      if (supply <= 100) require(msg.value == 0, "Invalid ether amount");
