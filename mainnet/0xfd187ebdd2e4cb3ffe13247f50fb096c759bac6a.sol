...
contract Bail250M is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Bail';
    string private constant _symbol = '$250M';
    ...
    address internal constant Dev_receiver = 0x9f855cfFaA87d73eB99748e971dF76F4Fac0C86f; 
    address internal constant marketing_receiver = 0xF81Ad8b468797d839633c5753a156536bb7Ba330;
    address internal constant liquidity_receiver = 0x85346B8B9515AD9167B6b6A10D5AF0454DabbbF4;
    ...
    function settaxes(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _Dev, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if(remainingBalance > uint256(0)){payable(Dev_receiver).transfer(remainingBalance);}
    }
