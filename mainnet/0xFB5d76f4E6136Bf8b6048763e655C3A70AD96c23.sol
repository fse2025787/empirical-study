...
contract PULSETSUKA  is Context, IERC20, Ownable {
    ...
    uint256 public SWAPamount = 7 * 1e9 * 1e9; // .07%
    ...
    constructor () {
        dev = payable(0xbA9f75d85Def96F6A7057E36E3b322175D873b9C);
        mktg = payable(0xbA9f75d85Def96F6A7057E36E3b322175D873b9C);
