...
contract AIDO is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AIDoge";
    string constant _symbol = "AIDO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 1) / 1000;
    uint256 _maxSellTxAmount = (_totalSupply * 1) / 1000;
    ...
    address payable public liquidityFeeReceiver = payable(0xDa87a5e6A934112019137748E332D4Bb772e3Feb);
    address payable public marketingFeeReceiver = payable(0xDa87a5e6A934112019137748E332D4Bb772e3Feb);
