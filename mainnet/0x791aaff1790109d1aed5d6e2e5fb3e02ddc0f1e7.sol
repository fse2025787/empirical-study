...
contract PeterSchiffInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Peter Schiff Inu";
    string private constant _symbol = "PSI";
