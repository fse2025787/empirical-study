...
contract BondDepositoryALCX is Ownable {
    ...
    constructor ( 
        ...
        DAO = _DAO;
        priceFeed = AggregatorV3Interface(0xc355e4C0B3ff4Ed0B49EaACD55FE29B311f42976);
    }
    ...
    function bondPriceInUSD() public view returns ( uint price_ ) {
        price_ = bondPrice().mul( uint( assetPrice() ) ).mul( 10 ** 6 );
    }
