...
contract Bonerium is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BONER";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  110000000  * 10**_decimals;

    uint256 public _maxWalletAmount = 3300000 * 10**_decimals;
    uint256 public _maxTxAmount = 3300000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 1100000 * 10**_decimals;
