...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xED5FF04e42ca14c8D2F1b158A4B992713d98103E];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 777 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmf175A2EeXUikqBdQYicnNcnEU9s767L32fEir2iHmszi/";
...
// File: contracts/CloudCloutsContract.sol
//

pragma solidity ^0.8.0;

contract CloudCloutsContract is RamppERC721A {
    constructor() RamppERC721A("Cloud Clouts", "Cloud"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9hFbNWSdUnvyVgrMjdHj/contract-metadata";
    }
}
