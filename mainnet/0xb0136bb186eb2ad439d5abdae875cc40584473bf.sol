...
contract FTG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Fuck Top G";
    ...
    address payable private _opAddress = payable(0xC5d8Dd88F7d9e9739b0bCF033b22BC6A06397fD4);
