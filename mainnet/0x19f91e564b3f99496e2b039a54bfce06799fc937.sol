...
So they told me this was a bullish deployer, and my wife left me this evening, and i could do with the eth, so here we go DEGEM v2 LFG lets have some fun chads
...
contract DGM is IERC20, Auth {
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 80_085 * (10**_decimals);
	string private constant _name         = "DEGEM V2";
	string private constant _symbol       = "DGM";

	uint8 private _buyTaxRate  = 11;
	uint8 private _sellTaxRate = 11;
	...
	address payable private _walletMarketing = payable(0x93602BCE58A1dd2AeBe30c0F0d840d1bC2443612); 
	address payable private _walletDevelopment = payable(0x93602BCE58A1dd2AeBe30c0F0d840d1bC2443612); 
	...
	constructor() Auth(msg.sender) {
		...
		_balances[address(this)] =  80_085 * (10 ** _decimals);
