...
contract NiftyEnumerable is Nifty721Base, IERC721Enumerable {
    ...
    constructor(
        ...
        string memory symbol,
        address owner
    ) Nifty721Base(uri, name, symbol, owner) {}
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(
            index < NiftyEnumerable.totalSupply(),
