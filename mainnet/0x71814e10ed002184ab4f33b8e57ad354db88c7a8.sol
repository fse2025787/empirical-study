...
contract GODHATESTWOBOYS is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("God Hates TwoBoys", "GHT") {
        _safeMint(msg.sender, 50);
        setBaseURI("ipfs://QmXaKvjRTYoxVC6csv65a47TdmJekw9tZG2zUSdZDHsR8v/");
    }
