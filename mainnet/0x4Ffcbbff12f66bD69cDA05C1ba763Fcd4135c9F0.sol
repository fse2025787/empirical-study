    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeia4f4mm4m5f5nc5c4z4vuop663ts6zj4uftbi5mya6rcwrr6op53e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/aJagKqjytIE0UdTGYC2V/contract-metadata";
  }
...
// File: contracts/LoveBraceletsByWarholContract.sol
//

pragma solidity ^0.8.0;

contract LoveBraceletsByWarholContract is RamppERC721A {
    constructor() RamppERC721A("Love Bracelets By Warhol", "LBW"){}
}
