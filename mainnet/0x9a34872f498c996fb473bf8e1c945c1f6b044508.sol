...
and sponsored by ShibaCEX (future of all centralised exchanges). This is a community-driven project with one goal 
in mind. THE NO JEETS policy! Buy tax goes to liquidity period. Not only that, but with every sell tax collected 
from paper hand jeets will be used for this project development! As our community grows we will come up with other 
creative ideas to help reach the NO-JEET objective!!

buy 2 sell 3 tokens 1 billion
...
contract ShibaJeets is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Jeets", "JEETS") {
        ...
        marketingWallet = payable(0x9DFb85b1289e713567e847119D44827984fc60Ba);
        buybackWallet = payable(0x9DFb85b1289e713567e847119D44827984fc60Ba);
