...
contract mAIow is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 50000000 * 10**_decimals; //
  
    string private constant _name = "mAIow"; // 
    string private constant _symbol = unicode" MAIOW🐈"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x91796a2c64a208DBDb0cE94fD29e03EaA9F922da).transfer(ethToSend); //marketing wallet
    }
