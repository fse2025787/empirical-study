...
/**
Burn the CULT
We buy back, we burn it all

Contract will be renounced in 5mins after launch
1 Month lock
...
contract BURNCULT is Context, IERC20, Ownable {
	...
	string private constant _name = "BURNCULT ";
	string private constant _symbol = "BURNCULT";
