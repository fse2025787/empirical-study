...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x86DD236BC45103Aaeb076cD861828dE6acFe2281];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x86DD236BC45103Aaeb076cD861828dE6acFe2281;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXawVYo8yFLDKzqQdB4hz51cE7MXG8unRBfJsxmzQbXxv/";
...
// File: contracts/BullishJackassContract.sol
//

pragma solidity ^0.8.0;

contract BullishJackassContract is RamppERC721A {
    constructor() RamppERC721A("Bullish Jackass", "ASS"){}
}
