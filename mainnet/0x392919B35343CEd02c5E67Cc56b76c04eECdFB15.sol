...
/*
The purpose of CYT project is to combine 
meme tokens social and connect them into one great community which can benefit us all

Telegram https://t.me/CYTokens
Twitter https://twitter.com/CYTokens
website https://www.cytokens.net/
*/
...
contract CYT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CYToken";
    string private constant _symbol = unicode"CYT";
