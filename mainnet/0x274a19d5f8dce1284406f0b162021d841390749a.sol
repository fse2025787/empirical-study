...
contract CalciferInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Calcifer Inu";
    string private _symbol = "CALCIFER";
    ...
    // limit
    uint256 public _maxTxAmount = 100000000 * 10**2 * 10**9; //1.5% after 50% burn
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
         require(taxFee <= 50, "Maximum fee limit is 50 percent");
        _taxFee = taxFee;
    }
