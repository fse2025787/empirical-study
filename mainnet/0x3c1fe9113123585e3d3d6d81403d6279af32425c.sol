...
https://t.me/PatternsToken

You have stumbled onto something unimaginably rare...
...
contract Patterns is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private pair;
    bool public tradingOpen;
    uint256 private _totalSupply  = 10 * (10 ** 9) * 10 ** decimals();
    uint256 public _maxWalletSize = _totalSupply.mul(2).div(100);

    constructor() ERC20("Patterns", "NTDGHASZBC") {
