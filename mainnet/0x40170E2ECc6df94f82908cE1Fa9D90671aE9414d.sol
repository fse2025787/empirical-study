...
/*
    ...
    @title Degen Beings NFT
    @notice This contract provides minting for the DegenBeings NFT by twitter.com/degenbeings
    @author twitter.com/0xUberchimp
...
contract DBEINGS is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable MAX_SUPPLY = 10000;
    uint256 public constant PRICE = 0 ether;
    uint256 public maxPublicTx = 2;
    uint256 public amountForPublic = 2;
    uint256 public amountForTeam = 200;
