...
contract AnimalsNotFood is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("AnimalsNotFood", "ANF") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmauURREgMs8MP7457aCZSwz8AVcTdJuapjmHedUY3RNQk/", _toString(tokenId), ".json"));
    }
