...
contract MasterGarden is Ownable {
    ...
    // Block number when bonus Peaches period ends.
    uint256 public bonusEndBlock;
    // Peaches tokens created per block.
    uint256 public PeachesPerBlock;
    // Bonus muliplier for early Peaches makers.
    ...
    // The block number when Peaches mining starts.
    ...
    // Update the given pool's Peaches allocation point. Can only be called by the owner.
    ...
    // Deposit LP tokens to MasterGarden for Peaches allocation.
    ...
    // Withdraw LP tokens from MasterGarden.
