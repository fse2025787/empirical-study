...
contract ProtectorOfInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Protector Of Inu";
    string private constant _symbol = "WeRinu";
