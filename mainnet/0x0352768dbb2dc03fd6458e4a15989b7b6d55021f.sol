...
// File: contracts/BoredRareApepeYC.sol
...
contract BoredRareApepeYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2135;
  ...
  ) ERC721A("Bored Rare Apepe YC", "BRAYC") {
