    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmaUBnW1LXyuw2xVvRePZFaxwgjze2xsnQzy1ocZaC8gZ8/";
...
// File: contracts/TankDogsContract.sol
//

pragma solidity ^0.8.0;

contract TankDogsContract is RamppERC721A {
    constructor() RamppERC721A("Tank Dogs", "Tank Dogs"){}
}
