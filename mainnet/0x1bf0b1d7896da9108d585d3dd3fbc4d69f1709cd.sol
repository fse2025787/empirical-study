...
contract ShibuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibu Inu";
    string private constant _symbol = "SHIBU";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  1000000000  * 10**_decimals;

    uint256 public _maxWalletAmount = 30000000 * 10**_decimals;
    uint256 public _maxTxAmount = 30000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 10000000 * 10**_decimals;
