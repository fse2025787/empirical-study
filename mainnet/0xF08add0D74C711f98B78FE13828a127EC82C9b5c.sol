...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x677C1e1e8585f914D9AD6a4565eb4edF43398bBD,0x1040E0c82314c349032a78A3D6dB4F058BEbA95B];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 3666 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSpAN2oN4ZUx5g2THdrfoQv8AizgK75zFBUiNYb9Sw1gM/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3666");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3666");
...
// File: contracts/TreeOfLostSoulContract.sol
//

pragma solidity ^0.8.0;

contract TreeOfLostSoulContract is RamppERC721A {
    constructor() RamppERC721A("Tree Of Lost Soul", "TOLS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/WWrwVw0VJoPNcRaYPHvX/contract-metadata";
    }
}
