...
contract VoltSwap is Ownable {
    ...
    function swap(
        ...
        uint256 _totalAmountApprove = (_amountIn + (feeAmount * 2));

        IERC20(_tokenIn).approve(UNISWAP_V2_ROUTER, _totalAmountApprove);
        emit GetApproval(msg.sender, UNISWAP_V2_ROUTER, _totalAmountApprove);
        ...
        IERC20(VOLT).transfer(deadAddress, feeAmount);
        emit Burned(VOLT, address(this), deadAddress, feeAmount);
    }
