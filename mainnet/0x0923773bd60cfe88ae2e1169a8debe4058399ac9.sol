...
/*
4chan The best part of the Hunter dirt is you know damn well the NSA and CIA and FBI had all this shit for years and years, AND COVERED IT ALL UP! 

May God damn their rotten souls.
Let's transfer that to blockchain
*/
...
contract PedoPeter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pedo Peter", "4CHAN") {
		...
		marketingWallet = address(0x003c1429cE6855B9Bd9D5BB9EdF536dcCa56EEce); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x003c1429cE6855B9Bd9D5BB9EdF536dcCa56EEce)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x003c1429cE6855B9Bd9D5BB9EdF536dcCa56EEce)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x003c1429cE6855B9Bd9D5BB9EdF536dcCa56EEce)] = true;
