...
/**
    Double Infinity DAO
    Telegram:  https://t.me/DoubleInfinityDAO
/*
/**
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a DID shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract DoubleInfinityDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Double Infinity DAO";
    string private constant _symbol = "DID";
    ...
    address payable public marketingWallet = payable(0x1fE1006815297999dDAD03fEF32e93bd73F04028);
    address payable public treasury = payable(0x91ce4C866672f8Aaa50455fB9A2c1bCd39e1f614);
    ...
    uint256 private maxBuy = 25000000000 * (10 ** _decimals);
