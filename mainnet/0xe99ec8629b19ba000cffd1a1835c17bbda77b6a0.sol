...
Maxtrade is a regulated Binary trading company offering a vast number of trading solutions to the Binaries community. 
We deals with 100% fully automated binary trading software. We will be the best binary trading option with a wide
selection of assets, fast order execution, and high pay-outs. One of the advantages are that you can trade
during weekends, various options for withdrawal methods, 100% secured trading, data protection, 24/7 customer support, 
and a skilled trader to guide you through the trading facility.

TOKEN NAME: MAXTRADE
TICKER: MXT
SUPPLY 1,000,000,000,000
MAX WALLET 0.005 AT LAUNCH 5000000000 
...
contract MaxTrade is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MaxTrade";
    ...
    uint256 private maxWalletAmount = 5000000001  * 10**9;
    uint256 private maxTxAmount = 5000000001  * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xa7bB152708C2BEd70aFe9792d976584873112d8D); 
        ...
        maxTxAmount = 5000000001  * 10**9;
        maxWalletAmount = 5000000001  * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
     ...
     function renounceOwnership() public virtual onlyOwner { }
     function extendLock() public virtual onlyOwner {
        tradingOpen = false; swapEnabled = false;
    }
