...
// File: contracts\Rockets.sol

pragma solidity ^0.8.7;



contract Rockets is ERC1155, Ownable {

    mapping (uint256 => string) private _uris;

    constructor() ERC1155("ipfs://bafybeib5stqme2hgff4itsesypemfizmhzhdhqycpynawcpicva7xg4cvy/{id}.json") {
        for (uint i = 1; i <= 23; i++) {
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        return(
            string(abi.encodePacked(
                "ipfs://bafybeib5stqme2hgff4itsesypemfizmhzhdhqycpynawcpicva7xg4cvy/",
