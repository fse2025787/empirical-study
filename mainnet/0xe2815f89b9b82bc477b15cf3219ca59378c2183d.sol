...
contract AAA is Context, IERC20, Ownable {
    ...
    uint256 private _prevLiqFee = 1121;
    ...
    string private constant _name = "AAA";
    string private constant _symbol = "AAA";
    ...
    bool public isAAAstoken = false;
    uint256 private _maxTxAmount = 30_000_000_000 * 10**9;
    uint256 private _maxWalletSize =  30_000_000_000 * 10**9;
