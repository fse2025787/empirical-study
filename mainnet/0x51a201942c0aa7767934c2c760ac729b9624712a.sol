...
contract MrMoon is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Mr Moon";
    string private constant _symbol = "MrMoon";
    ...
    address payable private _developmentAddress = payable(0x2EdB8ef25428d25BdAF90Daa20BE0fFa500Edbd0); 
    address payable private _marketingAddress = payable(0x2EdB8ef25428d25BdAF90Daa20BE0fFa500Edbd0);
    ...
    function RealLaunch(int code) public onlyOwner {
        tradingOpen = code== 10;
        _taxFeeOnBuy = 5;
        _taxFeeOnSell = 5;
    }
