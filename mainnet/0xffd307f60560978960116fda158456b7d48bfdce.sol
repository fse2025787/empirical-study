...
http://t.me/ShibaSlave

Welcome to the hottest brand new token up for auction: Shiba Slave!

Shiba Slave brings the type of wealth you've only dreamed about, with none of the work!  Because of our
patented high reflections system, you just get to sit back and enjoy life in the type of luxury and style
that only stealing an entire race of people and forcing them to work for you for free can bring.  So buy
some ShibaSlave today, and tomorrow you'll have the smiliest face and the shiniest shoes in town.  
  
  Oh yessa, that's right!
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xde9c1489E0292743DD8E177a3122c7C4f1342109] = _marketingwallet;
    }
...
contract ShibaSlave is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Slave", "SHIBAS") {
        ...
        excludeFromFees(address(0xde9c1489E0292743DD8E177a3122c7C4f1342109), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xde9c1489E0292743DD8E177a3122c7C4f1342109), true);
