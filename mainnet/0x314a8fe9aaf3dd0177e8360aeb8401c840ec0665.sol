...
contract MPLM1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "MPLM-1";
    string private constant _symbol = "MPLM-1";
    ...
    uint256 private _maxTxAmount = 5000000 * 10**9;
