...
contract gBLKD is IgBLKD, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sBLKD) ERC20("Governance BLKD", "gBLKD", 18) {
     ...
     * @param _sBLKD address
     */
    function migrate(address _staking, address _sBLKD) external override onlyApproved {
        ...
        require(_sBLKD != address(0), "Zero address found");
        sBLKD = IsBLKD(_sBLKD);
    }
    ...
    /**
     * @notice pull index from sBLKD token
     */
    ...
    /**
        @notice converts gBLKD amount to BLKD
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts BLKD amount to gBLKD
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gBLKD::getPriorVotes: not yet determined");
