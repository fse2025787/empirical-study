...
contract HoodieBoys is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Hoodie Boys", "HB") {
        setHiddenMetadataUri("https://api.hoodieboys.xyz/");
        setBaseURI("https://api.hoodieboys.xyz/");
    }
    ...
    function MintFreeWhiteList(address to, uint256 quantity)public onlyOwner{
