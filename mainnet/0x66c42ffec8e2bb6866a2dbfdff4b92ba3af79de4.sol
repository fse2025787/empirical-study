...
contract SHEMALE is Context {
    event SheM(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit SheM(address(0), msgSender);
    }
}
 ...
 */
contract ERC20 is  IERC20, IERC20Metadata , SHEMALE{
...
contract ShemaleInu is ERC20{
     ...
     */
    constructor () ERC20('Shemale Inu | t.me/shemaleinu', 'SHEMALE') {
