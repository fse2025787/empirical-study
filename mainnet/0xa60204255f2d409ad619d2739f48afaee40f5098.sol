...
contract Alpha is IBEP20, Auth {
    ...
    string constant _name = "Alpha";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x9e1467E6047087DD055feC055BaAb6d9694832Fe;
        marketingFeeReceiver = 0x9e1467E6047087DD055feC055BaAb6d9694832Fe;
