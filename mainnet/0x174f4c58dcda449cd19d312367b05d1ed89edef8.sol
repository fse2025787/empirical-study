...
Akogare is the Japanese term used to describe a person’s sense of aspiration to be like someone else.
This token will flood marketing dollars back into the value of the coin by paying for callers and influencers to come on board.
More marketing = increased coin value.
Tokenomics : 4% marketing buy and sell.
...
contract Akogare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Akogare", "AKOG") {
        ...
        maxTransactionAmount = supply * transDigit / 10;
        swapTokensAtAmount = supply * 5 / 10000; // 0.05% swap wallet;
        maxWallet = supply * walletDigit / 10;
        ...
        devWallet = 0x438217762c8E2169A0BE894BEa80A5D9C0EEEb4D; // set as dev wallet
        ...
        */
        ...
        _approve(owner(), address(uniswapV2Router), 100 * 1e6 * 1e6);
