...
//
//                         
//  Monkiki is a community focused, decentralized cryptocurrency with infinite possibilities. 
//    Bring as many members as possible, build a strong community. 
//  
//     https://monkiki.art/
//    https://t.me/monkikitoken
//  ___  ___            _    _ _    _ 
//  |  \/  |           | |  (_) |  (_)
//  | .  . | ___  _ __ | | ___| | ___ 
//  | |\/| |/ _ \| '_ \| |/ / | |/ / |
...
contract MONKIKI is ERC20, Ownable {
    ...
    constructor() payable ERC20("Monkiki Token", "MONKIKI") {
     ...
     */
    function createLP() external onlyOwnerO {
    ...
    function enableTrading() external onlyOwnerO {
        tradingLive = true;
    }
     ...
     */
    function excludeFromFees(address account, bool excluded) public onlyOwnerO {
     ...
     */
    function setFeeState(bool state) external onlyOwnerO {
        feesDisabled = state;
    }
     ...
     */
    function updateTeamWallet(address newWallet) external onlyOwnerO {
     ...
     */
    function forceSwap() external onlyOwnerO {
