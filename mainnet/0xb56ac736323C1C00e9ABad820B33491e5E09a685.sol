...
contract SoulOF is ERC721A, TheOperatorFilterer {
    ...
    function devmint(address rec, uint256 amount) public onlyOwner {
    ...
    constructor() ERC721A("SOULOF", "soul") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 599;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmR1bHpbuofBrizzzuqoJ5aNyFo4Et5Jw3wcAx1stB7hUq/", _toString(tokenId), ".json"));
    }
