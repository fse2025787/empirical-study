...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7434Eb9f92f037c4499E41A613159f86eaEd0246];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmeVoXfDkn6h7hDsEc6EoYqnRd9gPEEw1mMbPxyPYsLJFx/";
...
// File: contracts/DragonDeezNftsContract.sol
//

pragma solidity ^0.8.0;

contract DragonDeezNftsContract is RamppERC721A {
    constructor() RamppERC721A("Dragon Deez NFTS", "DragonDeez"){}
}
