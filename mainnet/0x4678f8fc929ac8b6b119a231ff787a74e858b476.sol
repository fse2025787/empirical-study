...
contract BabblerFriendsUniverse is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("Babbler Friends Universe", "BFU") {
    setNotRevealedURI("ipfs://QmQBhgYnrvvb3k9bwdFoiQDCGz2SXXvuyucfLzi4MxQdk4/1.json");
  }
  ...
  function ogMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable callerIsUser {
    ...
    require(MerkleProof.verify(_merkleProof, ogRoot, leaf), "user is not in the oglist");
