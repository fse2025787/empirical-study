...
contract SummerTide is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard, PaymentSplitter{
    ...
    uint private constant MAX_SUPPLY = 92;


    uint public publicSalePrice = 0.0092 ether;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, string memory _theBaseURI, string memory _theNotRevealedURI) 
    ERC721A("The Queen z 92 dayz Of Summer ", "Summer Tide") 
