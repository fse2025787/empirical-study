...
contract MagicalGoools is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://ipfs.io/ipfs/QmXrxtkCsGvTdwuHoMa5V3TFzQnVmiPPY6vcPgkXrYwc6w";
    ...
    constructor(
    ) ERC721A("Magical Goools", "GOOOLS", 100, maxSupply) {
    }
