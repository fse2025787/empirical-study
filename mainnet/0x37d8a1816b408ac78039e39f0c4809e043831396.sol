...
contract MoonApes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbJi15JwNfYjNfa9HRGrmeUQWWaGxuobmSVHYzcBVSYsF";
    ...
    constructor(
    ) ERC721A("MoonApes", "MoonApes", 100, maxSupply) {
    }
