...
contract O3EthereumSushiAggregator is Ownable {
    ...
    function _swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        if (pull) {
            ...
            IERC20(path[0]).safeTransfer(EthereumSushiLibrary.pairFor(factory, path[0], path[1]), amountIn);
        }
