...
contract dosline is IERC721A { 
    ...
    uint256 public TX_LIMIT = 2;
    uint256 public MAX_FREE = 333;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "dosline";
    string private constant _symbol = "dosline";
    string private _baseURI = "QmVHE69AhLMEyCTEXig39nZ16EnGZ91drHokeyfX3LNNXN";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount <= TX_LIMIT, "Max 2 per TX");
