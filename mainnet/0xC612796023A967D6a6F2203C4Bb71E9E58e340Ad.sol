...
// - Contract for BYTNODE Project: token (ERC20 compliant Non-Mintable Token). Fully compliant with the ERC20 specification.
...
contract BytnodeProject is ERC20 {
    constructor() ERC20("BYTNODE", "BYTE") {
        _mint(msg.sender, 330000000 * 10 ** decimals());
    }
}