...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD4E8084f2c3bA9cAa08345128BD9eE135796bb8D; // owner address
...
contract BearTrap is Context, IERC20, Ownable {
    ...
    string private _name = "BearTrap";
    string private _symbol = unicode"TRAPPED";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD4E8084f2c3bA9cAa08345128BD9eE135796bb8D); // 
    address payable public teamWalletAddress = payable(0xD4E8084f2c3bA9cAa08345128BD9eE135796bb8D); // 
