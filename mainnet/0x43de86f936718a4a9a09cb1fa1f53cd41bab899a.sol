...
contract Carbon is ERC20, Ownable {
    ...
    constructor() ERC20("Carbon", "C") {
        ...
        uint256 _buyPrizepoolFee = 1;
 
        uint256 _sellMarketingFee = 4;
        uint256 _sellLiquidityFee = 1;
        uint256 _sellPrizepoolFee = 1;
 
        uint256 totalSupply = 612011 * 1e18;
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyPrizepoolFee;
 
        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellPrizepoolFee = _sellPrizepoolFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellPrizepoolFee;
 
        marketingWallet = address(owner()); // set as marketing wallet
        prizepoolWallet = address(owner()); // set as prizepool wallet
    ...
    function excludeFromMaxTransaction(address updAds, bool isEx) public onlyOwner {
        ...
        buyPrizepoolFee = _prizepoolFee;
        buyLiquidityFee = _liquidityFee;
        buyMarketingFee = _marketingFee;
        buyTotalFees = buyPrizepoolFee + buyLiquidityFee + buyMarketingFee;
    ...
    function updateSellFees(
        ...
        sellPrizepoolFee = _prizepoolFee;
        sellLiquidityFee = _liquidityFee;
        sellMarketingFee = _marketingFee;
        sellTotalFees = sellPrizepoolFee + sellLiquidityFee + sellMarketingFee;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellPrizepoolFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForDev += fees * buyPrizepoolFee / buyTotalFees;
    ...
    function swapBack() private {
        ...
        (success,) = address(prizepoolWallet).call{value: ethForDev}("");
