...
contract bHODLERDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _approve(
        ...
        require(false, "bHODLER_Dividend_Tracker: No approvals allowed");
    }
    ...
    function _transfer(
        ...
        require(false, "bHODLER_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(
            false,
            "bHODLER_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main bHODLER contract."
        );
    }
...
contract bHODLER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bHODLERDividendTracker public dividendTracker;

    address payable public devAddress =
        0x31e67021B3846E62cB11d15858E9C2ac85C3f69b;

    uint256 public ethFee = 9;
    uint256 public devFee = 6;
    uint256 public totalFee = 15;

    uint256 public tradingStartTime = 1628614800;
    ...
    constructor() public ERC20("bHODLER", "bHODLER") {
        IFTPAntiBot _antiBot = IFTPAntiBot(
            0x590C2B20f7920A2D21eD32A21B616906b4209A43
        );
        antiBot = _antiBot;

        dividendTracker = new bHODLERDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "bHODLER: The dividend tracker already has that address"
        );

        bHODLERDividendTracker newDividendTracker = bHODLERDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "bHODLER: The new dividend tracker must be owned by the bHODLER token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "bHODLER: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "bHODLER: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "bHODLER: The UniSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "bHODLER: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function allowPreTrading(address account, bool allowed) public onlyOwner {
        ...
        require(
            ...
            "bHODLER: Pre trading is already the value of 'excluded'"
        );
        canTransferBeforeTradingIsEnabled[account] = allowed;
    }
    ...
    function setMaxPurchaseEnabled(bool enabled) public onlyOwner {
        require(
            ...
            "bHODLER: Max purchase enabled is already the value of 'enabled'"
        );
        maxPurchaseEnabled = enabled;
    }
    ...
    function reinvestInactive(address payable account) public onlyOwner {
        ...
        require(
            ...
            "bHODLER: Account balance must be less then minimum token balance for dividends"
        );

        uint256 _lastTransfer = lastTransfer[account];
        require(
            block.timestamp.sub(_lastTransfer) > 12 weeks,
            "bHODLER: Account must have been inactive for at least 12 weeks"
        );
    ...
    function _claim(
        ...
        require(
            ...
            "bHODLER: Claimer has no withdrawable dividend"
        );
    ...
    function _transfer(
        ...
        if (tradingStartTime > block.timestamp) {
            require(
                ...
                "bHODLER: This account cannot send tokens until trading is enabled"
            );
        }
        ...
        if (maxPurchaseEnabled && automatedMarketMakerPairs[from]) {
            require(
                ...
                "bHODLER: Exceeds max purchase amount"
            );
        }
