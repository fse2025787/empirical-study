...
contract Bravy is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  mapping(address => uint256) public maxWalletMints;
...
// public
    ...
    uint256 totalMinted = maxWalletMints[msg.sender];
