...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xEFB551E7B9fFdb53c2d8fbfD03A2b8A62A2C8872];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xEFB551E7B9fFdb53c2d8fbfD03A2b8A62A2C8872;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdqxHCou5Uu1eeX8oea9TnYJQ1gdR2UuKTon75cQxtykD/";
...
// File: contracts/VitalikPumpsContract.sol
//

pragma solidity ^0.8.0;

contract VitalikPumpsContract is RamppERC721A {
    constructor() RamppERC721A("Vitalik Pumps", "VTLKP"){}
}
