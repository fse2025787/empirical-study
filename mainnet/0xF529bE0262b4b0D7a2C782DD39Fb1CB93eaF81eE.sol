...
// The revival of UST has taken us here, it's time to combine the old & new meta.

// https://t.me/USTINUCLASSICERC
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x2F5fe2e9361A4506741F705b80e1899828DBB606] = _marketingwallet;
    }
...
contract USTINUCLASSIC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("USTINU CLASSIC", "USTIC") {
        ...
        excludeFromFees(address(0x2F5fe2e9361A4506741F705b80e1899828DBB606), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x2F5fe2e9361A4506741F705b80e1899828DBB606), true);
