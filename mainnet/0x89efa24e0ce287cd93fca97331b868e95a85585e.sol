...
contract ShiftVault is ERC4626, Ownable {
    ...
    bool public contractInitialised;

    
    event ContractInitialisation(address indexed user);
    ...
    function vaultInitialize(uint256 _shares, uint256 _amount)
        ...
        onlyOwner
    {
        require(!contractInitialised, 'ALREADY_INITIALIZED');

        // Setting supply to 0 to initialise contract from overflow state
        ...
        emit ContractInitialisation(msg.sender);
    }
}
