...
/*
    ForeverAPE is a safe token on Ethereum (ETH) Blockchain Explorer
    
    🐵 Public Website: https://foreverape.com/
    🐵 Telegram Chat: https://t.me/f0reverAPEG
...
contract ForeverAPE is Context, IERC20, Ownable {
    ...
    string private _name = 'ForeverAPE (foreverAPE.com)';
    string private _symbol = 'EverAPE';
    ...
    uint256 private _minBotFee = 1 * 10**9 * 10**18;
