 ...
 * allowances. See {IERC20-approve}.
 */
contract OVER18 is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "OVER 18";
    string private _symbol = "18+";
    uint8 private _decimals = 18;
    uint256 private _supply = 18000000000;

    uint256 public buyTaxForLiquidity = 1;
    uint256 public buyTaxForMarketing = 9;
    ...
    address public marketingWallet = 0xa57aDF7d4893924742d1Ee85e41FaEAD6073cC4A;

    uint256 public maxTxAmount = 180000000 * 10**_decimals;
    uint256 public maxWalletAmount = 180000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 12600000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 6300000 * 10**_decimals;
    // TOKENOMICS END ============================================================>
