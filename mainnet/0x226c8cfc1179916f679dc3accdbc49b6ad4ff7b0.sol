...
contract SlySlothSociety is ERC721, Ownable {
    using Strings for uint256;
    ...
    // URIs
    string public uriPrefix = "ipfs://QmWNmjZ16B8wNWQZNNC1djsZTdS2C4ZbqngGGEn7rz2B6k/";
    string public uriSuffix = ".json";
    
    // Costs
    uint256 public presaleCost = 0.02 ether;
    uint256 public publicsaleCost = 0.035 ether;
    ...
    // Constructor
    constructor() ERC721("Sly Sloth Society", "SSS") {}
