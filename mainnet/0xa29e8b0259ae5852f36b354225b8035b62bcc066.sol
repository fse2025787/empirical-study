...
/*
This token created in order to remember KING MARTIN LUTHER memory.
Telegram : https://t.me/MartinLutherERC20
Website : http://martinluthererc.site/
*/
...
contract MARTINLUTHER is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x48f0c0BA3657dc2012E82b425EC97Da970D20587));

    string private _name = "King Martin Luther";
    string private _symbol = "MARTINLUTHER";
