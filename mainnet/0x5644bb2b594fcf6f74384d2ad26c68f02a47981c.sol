...
/**
 #SuperMegaHyperDoge
  ...
  #SuperMegaHyperDoge features:
   ...
   4% liquidity fee ensures rising liquidity
                    &
   6% marketing fee ensures a huge marketing budget 
...
contract SuperMegaHyperDoge is Context, IERC20, Ownable {
    ...
    string private _name = "SuperMegaHyperDoge";
    string private _symbol = "SMHDoge";
    ...
    uint256 public _maxTxAmount = 42 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2.1 * 10**6 * 10**9;
