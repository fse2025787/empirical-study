...
TG: https://t.me/TheGermanShepherd_Portal
Web: https://www.thegermanshepherdtoken.com

There’s been a whole lot of Doge’s and Shiba’s but little to no love for 
perhaps the most sophisticated breed of them all, The German Shephard. 
German Shephard’s are known for being easy to train and good for 
performing tasks and following instructions. They are especially well 
known for their police work, being used for tracking criminals, 
patrolling troubled areas and detection and holding of suspects. 
...
contract TheGermanShepherd is Context, IERC20, Ownable {
    ...
    string private _name = "TheGermanShepherd";
    ...
    uint256 public marketingFeePercent = 6;
    ...
    uint256 public numTokensSellToAddToLiquidity = 250000000000000000000 * 10**9;
