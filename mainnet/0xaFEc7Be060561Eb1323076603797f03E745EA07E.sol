...
contract LarvaCrabs is ERC721Enumerable, Ownable {

  using Strings for uint256;
  string public baseURI;
  string public baseExtension = ".json";
  bool public isPauseMode = true;
  uint256 public PriceNFT = 0.0075 ether;
    ...
    require(supply + _mintAmount <= MaxCollection, "Collecton Sold");  
      if (msg.sender != owner()) {
        ...
        if(supply < FreeMint){}
            ...
            require(msg.value >= PriceNFT * _mintAmount, "Balance Insufficient"); 
        }
    }
