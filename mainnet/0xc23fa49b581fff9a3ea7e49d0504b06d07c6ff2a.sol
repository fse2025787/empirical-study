...
contract CRC is Context, IERC20, Ownable {
    ...
    string private _name = "Crazy Rich Coin";
    ...
    address public marketing = 0xD94fE122F6fD1c5490C7948211F5e7585019DC2A;
    ...
    uint256 public _maxBalAmount = _tTotal;
    ...
    constructor () {
        ...
        _transfer(_msgSender(), 0xfA966EC644511Da66a149b1a5545FE3F747930D9, 8312500000 * 10**18);
        _transfer(_msgSender(), 0xAE4dD0e27Df7e55246D325dbfB4797FB7213EB7A, 6125000000 * 10**18);
        _transfer(_msgSender(), 0x86f2A12E980762b6f9D7A427C6dF4895852f6C86, 3062500000 * 10**18);
        _transfer(_msgSender(), 0xEc7471162E4478EBAA8E8D4387b233452C0AC664, 4375000000 * 10**18);
        _transfer(_msgSender(), 0xAA28FfF7298Dd7aA52638Ca89e8B09031ae81f96, 5250000000 * 10**18);
        _transfer(_msgSender(), 0x9659B37D233D70f827791dAb908AbC9BF8dD5557, 1750000000 * 10**18);
        _transfer(_msgSender(), 0x85Cb6aD670D58ED9A0afb278dfcF710c3954E379, 1750000000 * 10**18);
        _transfer(_msgSender(), 0xBb31f76953248E76bDA2f04d219b8fE68bc96A06, 4375000000 * 10**18);

        _transfer(_msgSender(), 0xE87017D7f4d66e78f07c4b4502737984b71cEb6e, 2000000000 * 10**18);
        _transfer(_msgSender(), 0x06c4d5598d804710093e10e1160a3036CB046218, 2000000000 * 10**18);
        _transfer(_msgSender(), 0xe58719DC8DA6686534b5Ac52Cb604344E1bb7388, 2000000000 * 10**18);
        _transfer(_msgSender(), 0xa005bd8E02d68F8606457e2B128D0b196d3cFC69, 4000000000 * 10**18);

        _transfer(_msgSender(), 0x7CeE84F71B174A2d07e7bEf2b155331749a1Cf37, 30000000000 * 10**18);

        _transfer(_msgSender(), address(0), 100000000000 * 10**18);
