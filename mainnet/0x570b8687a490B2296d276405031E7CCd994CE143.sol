...
contract BoardingPass is ERC1155, Ownable {

    string constant public name = "OuterCircle Pass";
    string constant public symbol = "OCP";
    ...
    function print(
        ...
        require(passPrinter.available >= amount, "BoardingPass: can't print the pass with provided id/amount");
