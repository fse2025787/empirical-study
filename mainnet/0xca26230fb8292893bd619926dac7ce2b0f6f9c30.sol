...
TG https://t.me/LAI_token

Website : www.lai-token.com
...
L::::::::::::::::::::::L       A:::::A               A:::::A  I::::::::I
L::::::::::::::::::::::L      A:::::A                 A:::::A I::::::::I
LLLLLLLLLLLLLLLLLLLLLLLL     AAAAAAA                   AAAAAAAIIIIIIIIII

 I have two rules:
1) I’m never wrong
2) if I’m wrong back to the first rule

With the amount of launches going around lately you can’t be sure where to invest … that’s where L AI comes in, our bot will investigate the CA 
...
// 
    ...
    contract L is ERC20 {
        ...
        constructor () ERC20("L AI", "$LAI"){

            numTokensSellToSendEthToDev = 5000 * 10 ** decimals();
            _devWalletAddress = 0x6E3921CF861CB03bfC635F03f1E1C4E5254A8AF9;
