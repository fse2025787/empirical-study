...
DynaETH is an explosive addition to the Ethereum Network, where you could enter with as little as 0.1 ETH but walk away with thousands of dollars. We have a dedicated tax to building up a prize fund, and when the bomb detonates whoever purchased more than 0.1 ETH last - takes it all.

How does it work❓

Once the prize fund reaches 1 ETH the fuse is lit. The dynamite could explode at any moment, and when it does, whoever has purchased > 0.1 ETH takes the entire pot. Once a winner has been selected they will automatically receive payment, and the cycle continues...
