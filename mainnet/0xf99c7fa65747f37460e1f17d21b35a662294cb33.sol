...
contract TowerImagesCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TowerImagesCoin() {
        ...
        name = "TowerImagesCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TIC";                                             // Set the symbol for display purposes (CHANGE THIS)
