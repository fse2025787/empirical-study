...
Website release in around 24-48h with all informations.
...
contract OnlyAI is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"OnlyAi"; ////
    string public constant symbol = unicode"OnlyAi"; ////
