...
/**
    BEARS DAO - GOVERNANCE TO STRATEGIZE TO DEFEAT THESE BEARS
*/
...
contract BearsDAO is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bears DAO";
    string private constant _symbol = "BDAO";
    ...
    address payable private _developmentAddress = payable(0x58a50512FA4e613c3EAAD94F69Ab0E409240E6f6);
    address payable private _marketingAddress = payable(0x58a50512FA4e613c3EAAD94F69Ab0E409240E6f6);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy <= 10 && taxFeeOnSell  <= 10 );
