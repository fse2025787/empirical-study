...
contract YUM is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "YUM";                                                // name
    string private _symbol = "YUM";                                             // symbol
    ...
    address payable public marketingWallet = payable(0xDC6cC7C0DeC8AbC14E74eD330763B4EDEB7fDcD9); // marketing wallet
