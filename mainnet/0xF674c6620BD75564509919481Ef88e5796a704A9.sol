...
https://twitter.com/BurntDuckEth
https://t.me/BurntDuckEth
...
contract BURNTDUCK is ERC20, Ownable {
    ...
    address public burnTokenAddress = 0xa52bfFAD02B1FE3f86A543a4e81962d3B3bB01A7;
    address public marketingWallet = 0x61e2C7CF6Bb4ad19ab0c21def3DD70de09BE0e77;
    ...
    constructor() ERC20("Burnt Duck", "PEKING") {
        ...
        tokenburnBuyFee = 40; // 3%, being used to buy and burn Duckereum
        marketingBuyFee = 20; // 2%
        totalBuyFees = 60; // 5%

        tokenburnSellFee = 50; // 5%, all being used to buy and burn Duckereum
   ...
   function burnTargetToken(uint256 ethAmountInWei, address BurnToken) internal {
    ...
    function swapBack() private {
        ...
        // buy the Duckereum token and burn it
