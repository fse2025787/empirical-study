...
LIQUIDITY BURNT, CA RENOUNCED.

DO NOT BUY. ERROR. TOKEN NOT FOUND.
...
contract NOTOKEN is Context, IERC20, Ownable {
    ...
    //
    string private _name = "TOKEN NOT FOUND";                                           // name
    string private _symbol = "NOTOKEN";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x1D33386fa99b4A4396AFfc1912BBb28544846b39);
