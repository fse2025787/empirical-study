...
//*********************************************************************//
//
//     _           _     _       _    __      _____  _  _ ___  ___ ___ ___ _   _ _     __      _____  __  __ ___ _  _ 
//    /_\__ ____ _| |_  /_\  _ _| |_  \ \    / / _ \| \| |   \| __| _ \ __| | | | |    \ \    / / _ \|  \/  | __| \| |
//   / _ \ V / _` |  _|/ _ \| '_|  _|  \ \/\/ / (_) | .` | |) | _||   / _|| |_| | |__   \ \/\/ / (_) | |\/| | _|| .` |
//  /_/ \_\_/\__,_|\__/_/ \_\_|  \__|   \_/\_/ \___/|_|\_|___/|___|_|_\_|  \___/|____|   \_/\_/ \___/|_|  |_|___|_|\_|
//                                                                                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1669852800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xB566C82ba5eb0df25e759afB53384E8249dF6837,0x78f896DBcCa3384966f645ae52628CD2aF519745];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcS5S9J5Er9tvSWXNaLkCb5sYt9WsKRXhF6mzSdXFUiTt/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2500");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2500");
...
// File: contracts/AvatArtWonderfulwomenContract.sol
//

pragma solidity ^0.8.0;

contract AvatArtWonderfulwomenContract is RamppERC721A {
    constructor() RamppERC721A("AvatArt WONDERFUL WOMEN", "AWW"){}
}
