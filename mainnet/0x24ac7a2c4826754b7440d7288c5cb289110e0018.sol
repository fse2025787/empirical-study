...
// File: metacomrade.sol
    ...
    contract MetaComrade is ERC721, Ownable, ERC721Enumerable {
      ...
      event ComradeMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("MetaComrade", "MTC") {}
      ...
      function mintComrade(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit ComradeMinted(id, msg.sender);
          }
        }
      }
    
      function presaleComrade(uint256 numberOfTokens) external payable {
