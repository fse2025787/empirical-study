...
contract HUNKS is ERC721Delegated, ReentrancyGuard {
  ...
  uint256 public constant PRICE = 26000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.026 ETH per item"
    );
