...
contract MOONORDUST is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    string private constant _nomenclature = "MOONORDUST";
    string private constant _symb = "MOD";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0xc92d87B0996CB0B818fdF8DBe0062Cba54B8aeb9);
        DevWallet = payable(0xA23443Ea515786E3BbB155F8D449707aBcc8cA10);
