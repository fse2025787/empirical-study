...
Technically speaking, seems fine.

https://t.me/TechnicallySpeakingERC
...
contract TechnicallySpeaking is Context, IERC20, Ownable {
    ...
    string private constant _name = "Technically Speaking";
    string private constant _symbol = "INDY";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x9F84Ae146bb3E6b9A011EbdF7A61805A9e74D339);
    ...
    function openTrading() external onlyOwner() {
        ...
        tradingOpen = true;
        _maxWalletAmount = _tTotal * 4 / 100;
