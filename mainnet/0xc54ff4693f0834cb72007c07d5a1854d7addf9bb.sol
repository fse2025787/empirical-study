...
contract GoghVan is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmZWSDk82muYiJhAJspXbeqdHt4RCk27iRfY5aekJdmgiW//";
  uint256  public  maxSupply = 3635;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  NUM_FREE_MINTS = 3635;
  uint256 public  MAX_FREE_PER_WALLET = 2;
  uint256 public freeNFTAlreadyMinted = 0;
  bool public isPublicSaleActive = true;

  constructor() ERC721A("GoghVan", "GV") {
  }
