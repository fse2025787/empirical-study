...
contract Diamond is IERC165, IDiamondCut, IDiamondLoupe, Initializable, IERC173 {
    ...
    function setupInterfaces() private {
        DiamondLib.setupInterfaces();
    }

    function setupEventReporting() private {
        DiamondLib.setupEventReporting(msg.sender, address(this));
    } 

    function setupMetadata(
        AppStorage storage appStorage, 
        address tokenAddress,
        BitGemSettings memory params) private {
        DiamondLib.setupMetadata(appStorage, tokenAddress, params);
    }
