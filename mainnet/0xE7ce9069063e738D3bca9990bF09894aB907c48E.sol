...
//*********************************************************************//
//
// Sunbirds | When the moon sets, the sun rises.
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5c498E9Ee93E055549da7880efbF6Af15319e118,0xb61B188a897f96602Ff2f63F5d9db0C8Bea418B8,0x401399fb7F2452ea658102009f8E8D157a9a826C];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x5c498E9Ee93E055549da7880efbF6Af15319e118;
  uint256[] public payableFees = [5,45,45,5];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid2ap6inobxdedlxpmxbiu7j3bpmadxiyzohmxfbqlv5clenzikky/";
...
// File: contracts/SunbirdsContract.sol
//

pragma solidity ^0.8.0;

contract SunbirdsContract is RamppERC721A {
    constructor() RamppERC721A("Sunbirds", "Sunbirds"){}
}
