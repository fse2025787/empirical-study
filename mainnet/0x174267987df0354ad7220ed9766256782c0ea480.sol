...
contract PUNANI is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "PUNANI";
 string private _symbol = "PUNANI";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x1BE52A282C2B9fEF06AEB346A3a27526750Dba0f);
 ...
 //Tokenomics related functions
  function PUNANIDay() public onlyOwner{
      require(block.timestamp > PUNANIDaycooldown, "You cant call PUNANICoinDay more than once a day");
 ...
 function PUNANICoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      PUNANIDaycooldown = block.timestamp + 86400;
 }
