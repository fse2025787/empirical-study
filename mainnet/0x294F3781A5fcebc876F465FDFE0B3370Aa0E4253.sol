...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x7743BaCAe43538d36411bA04FE9a5c953273Fa57];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x7743BaCAe43538d36411bA04FE9a5c953273Fa57;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 797) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmbF1WtWJWBXkRNGLkbkAxirdRZAEyZZuHVsaPCERxTZvH/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 797");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 797");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 797");
...
// File: contracts/TheturtleandthehareContract.sol
//

pragma solidity ^0.8.0;

contract TheturtleandthehareContract is RamppERC721A {
    constructor() RamppERC721A("The turtle and the hare", "Shell"){}
}
