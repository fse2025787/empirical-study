...
contract Buildereum is ERC20, Ownable {
    ...
    constructor() ERC20("Buildereum", "BUILD") {
    ...
    function StartBuilding(uint256 _percent) external onlyOwner payable {
    ...
    function modifyFees(uint256 marketingFee, uint256 liquidityFee) external onlyOwner {
        ...
        _liquidityFee = liquidityFee;
        totalFees = _marketingFee + _liquidityFee;
        require(totalFees <= 1, "Must keep fees at 1% or less");
    }
