...
// File: contracts/Freaks.sol

    contract Freaks is Ownable, ERC721A, IERC2981, ReentrancyGuard {
        string public notRevealedUri;   
        string public baseExtension = ".json";
        
        uint256 public MAX_SUPPLY = 4444;
        uint256 public PRICE = 0.23 ether;
        uint256 public PRESALE_PRICE = 0.12 ether;
            ...
            returns (address receiver, uint256 royaltyAmount)
        {
            ...
            return (royaltyAddress, (salePrice * royaltyPercent) / 1000);
        }
