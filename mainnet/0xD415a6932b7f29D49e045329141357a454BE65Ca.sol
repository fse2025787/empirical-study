...
contract Helpers is Variables {
        ...
        )
    {
        ...
        if (totalSupply_ != 0) {
            exchangePriceWithRevenue_ = (netSupply * 1e18) / totalSupply();
        } else {
...
contract CoreHelpers is Helpers {
    ...
    function withdrawFinal(
        ...
        return (amount_, balances_.wethVaultBal, balances_.wethDsaBal, balances_.stethVaultBal, balances_.stethDsaBal, balances_.totalBal);
    }
...
contract InstaVaultImplementation is CoreHelpers {
    ...
    function withdrawClaim(
        ...
        for (uint i = 0; i < indexes.length; i++) {
            ...
            (amount_, balances_.wethVaultBal, balances_.wethDsaBal, balances_.stethVaultBal, balances_.stethDsaBal, balances_.totalBal) = withdrawFinal(
                amount_,
                balances_,
                to_
            );
