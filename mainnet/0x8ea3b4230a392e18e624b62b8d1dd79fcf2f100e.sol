...
// BurnedLunc is a token about what should've happened with Classic
// Luna if a few trillions were burned the token price would've 
// exploded that's what we are gonna do we will burn a few tokens for
// every buy and sell tax 3% buy 3% sell

// Join our Telegram : https://t.me/BurnedLunc
...
contract BurnedLunc is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "BurnedLunc";
    string private constant _symbol = "BLUNC";
    ...
    address payable private _marketingAddress = payable(0xc96180098a48f62dDA1f3a2f8E1d4D4E046C8729);
