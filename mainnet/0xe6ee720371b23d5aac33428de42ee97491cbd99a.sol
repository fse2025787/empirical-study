...
TICKER: AKECHI
SUPPLY 1M
Initial Max Wallet 1% of TotalSupply = 10,000
will lift after an hour

All liquidity will be burnt automatically. 


Telegram: https://t.me/AkechiETH
...
contract AKECHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "AKECHI";
    string private constant _symbol = "AKECHI";
    uint8 private constant _decimals = 9;

    uint256 public buyAutoLiquidityFee = 100; //1%
    uint256 public buyAutoBurnFee = 100; //1%
    uint256 public buyMarketingFee = 500; //5%
    ...
    uint256 public sellMarketingFee = 500; //5%
    ...
    uint256 private maxWalletAmount = 20000 * 10**9; //2% of Tsupply
    uint256 private maxTxAmount = 10000 * 10**9; //1% of Tsupply
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xFF69F75d1A5593BC62Fdb857Ce4FEB64A5B7Af99); 
        ...
        uint256 _buyMarketingFee = 500; //5%

        uint256 _sellAutoLiquidityFee = 100; //1%
        uint256 _sellAutoBurnFee = 100; //1%
        uint256 _sellMarketingFee = 500; //5% initial tax
