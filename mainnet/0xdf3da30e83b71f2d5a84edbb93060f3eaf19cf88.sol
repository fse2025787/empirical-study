...
/**
  More info: @ChumpsOnlyPunks
  Stealth Mint
  Website: chumpsonlypunks.io
*/
...
contract ChumpsOnlyPunks is ERC721A, Ownable {
    uint256 constant public MAX_MINT = 555;
    uint256 constant public MAX_MINT_PER_TX = 5;
    uint256 constant public PRICE = 0.05 ether;

    string public baseURI = "";
    bool public paused;

    constructor() ERC721A("ChumpsOnlyPunks", "ChumpsOnlyPunks") {}
