...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0082feA23adE768Cb04ce46503Ad7baAf8849Cf5];
  address public erc20Payable = 0x0082feA23adE768Cb04ce46503Ad7baAf8849Cf5;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.madnesstrader.wtf/";
...
// File: contracts/MadnessTraderbyCryptoNoblesContract.sol
//

pragma solidity ^0.8.0;

contract MadnessTraderbyCryptoNoblesContract is RamppERC721A {
    constructor() RamppERC721A("Madness Trader by CryptoNobles", "MD"){}
}