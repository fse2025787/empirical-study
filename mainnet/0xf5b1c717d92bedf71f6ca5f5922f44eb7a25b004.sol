...
contract Suzumiya is Context, IERC20, Ownable {
    ...
    string private constant _name = "Suzumiya Inu";
    string private constant _symbol = "SUZINU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x2Ac7b6410052471Bc0e5a4c60849846C538e0705);
        _feeAddrWallet2 = payable(0x2Ac7b6410052471Bc0e5a4c60849846C538e0705);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x2Ac7b6410052471Bc0e5a4c60849846C538e0705), _msgSender(), _tTotal);
    }
