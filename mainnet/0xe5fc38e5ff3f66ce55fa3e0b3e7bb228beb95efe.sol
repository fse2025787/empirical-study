...
contract COMMUNITY is ERC20, Ownable {
    ...
    constructor() ERC20("Power of a Community", "COMMUNITY") {
     ...
     uint256 totalSupply = 9 * 10 ** 6 * 10 ** decimals();
 
        maxTransactionAmount = 18 * 10 ** 4 * 10 ** decimals(); 
        maxWallet = 18 * 10 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x1ab5988E26703d335813043Db6B444c8d5716d6b); // set as Marketing wallet
        DevWallet = address(0x1ab5988E26703d335813043Db6B444c8d5716d6b); // set as dev wallet
