...
$$ |  $$ |$$ |      $$  _$$<  $$ |  $$ |$$ |  $$ |$$  __$$ |$$ |  $$ |  $$ |$$\ 
$$ |  $$ |$$ |      $$ | \$$\ \$$$$$$  |$$ |  $$ |\$$$$$$$ |\$$$$$$  |  \$$$$  |
\__|  \__|\__|      \__|  \__| \______/ \__|  \__| \_______| \______/    \____/ 
                                                                                
Arkonaut NFT is your digital passport to a philanthropic NFT program founded for the purpose of supporting charities worldwide. 
Arkonaut has a mission to help bring the most importunate children's charities to a new Web3 stage.                                                                             
/******************************************************************************/
...
contract Arkonaut is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 6000;
    uint256 public immutable supply = 6000;
    ...
    address[] public withdrawAddresses = [0x58b5b8755edA4548c5800C0aBeD4fF3A7ECf8fEC];
    uint256[] public withdrawPercentages = [100];

    bytes32 public merkleRoot = 0xd530916792920e1c280ae5d43f676a8dadc28deeac1ae5d78b3065295b18e1e4;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x2EF129d1cc4979D31922BFf0d83f79B0cF50460A, _royaltyAmount);
    }
