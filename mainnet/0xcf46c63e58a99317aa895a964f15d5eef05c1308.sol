...
A 100% $PYRO fork that will be burning its own supply in the same way as $PYRO, but also burning $PYRO in support of their innovation in the crypto market.

Welcome to the official Baby PYRO ($BPYRO) :)
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Baby PyroMatic", "BPYRO") {
        ...
        devWallet = 0x4f0eC52aAF08Fb62772D4cD4F3E1b7BC1bf80B4a;
