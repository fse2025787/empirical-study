...
contract LAIKARETURNS is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x5B94E4536838ed8b9A514f36A79a6E22683BC316);
    ...
    constructor() ERC20("LAIKA RETURNS", "LAIKA RETURNS") {
