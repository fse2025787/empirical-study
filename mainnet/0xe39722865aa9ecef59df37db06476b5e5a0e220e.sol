...
contract THE  is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xC7A4Fe792D92D11F51e0b47E4CB772FeBaBeCFaf); 
    address payable private _marketingAddress = payable(0xC7A4Fe792D92D11F51e0b47E4CB772FeBaBeCFaf);
    ...
    function setTradingV(bool _tradingOpen) public onlyOwner {
