...
contract WrappedGazers is ERC721Burnable {

    address public constant COLLECTION = 0xa7d8d9ef8D8Ce8992Df33D8b8CF4Aebabd5bD270;
    ...
    constructor() ERC721("Wrapped Gazers by Matt Kane", "GAZERS") {}

    
    function safeWrap(uint256 tokenId) external {
        // Gazers tokenId range
        require(215000000 <= tokenId && tokenId <= 215000999, "Gazers: invalid tokenId");
