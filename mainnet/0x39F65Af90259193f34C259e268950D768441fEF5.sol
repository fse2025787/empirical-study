...
contract TheAbstractions is ERC721A, Ownable, ReentrancyGuard
{
    ...
    uint public constant NUMBER_RESERVED_TOKENS = 25;
    uint256 public PRICE = 0 ether; //first 500 free, then the rest 0.044
    ...
    constructor() ERC721A("TheAbstractions", "abstra") {}
    ...
    function withdraw() external nonReentrant
    {
        ...
        (bool success, ) = devguy.call{value: address(this).balance / 100 * 6}("");
