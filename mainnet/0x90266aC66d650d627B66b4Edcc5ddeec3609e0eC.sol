...
contract YieldFarmLP2 {
    ...
    // constants
    uint public constant TOTAL_DISTRIBUTED_AMOUNT = 4500000;
    uint public constant NR_OF_EPOCHS = 6;
    uint128 public constant EPOCHS_DELAYED_FROM_STAKING_CONTRACT = 3; // Starts staking epoch 4
    ...
    // constructor
    constructor(address unixTokenAddress, address uniLP, address stakeContract, address communityVault) public {
