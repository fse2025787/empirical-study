...
contract LITTokenomic is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "LIT Tokenomic";
    string private _symbol = "Litnomic";
    uint8 private _decimals = 9;

    uint256 public _rewardFee = 2;
    uint256 private _previousRewardFee = _rewardFee;

    uint256 public _burnFee = 12;
