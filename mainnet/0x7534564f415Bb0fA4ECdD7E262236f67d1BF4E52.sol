...
// 
/**
For a degen, sometimes Luck is everything.
The gas, the News, the snipers, even the Dextools can rekt us by some bugs showing.
That's why we always say maybe moon, maybe dust.
Its not depends on what we did or what solid people we got.
Probably it's just all about Luck.
So how about some Black Luck fill-in?

-Swap
-NFT
-Stake

t.me/blackluckportal
twitter.com/BlackLuckPortal
**/
  ...
  contract blackluckportal is Context, IERC20, Ownable {
      ...
      string private constant _name = "BLUCK";
      string private constant _symbol = "BLUCK";
