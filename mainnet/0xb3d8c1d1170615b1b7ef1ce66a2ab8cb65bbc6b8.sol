...
contract THEWORLDISYOURS is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE WORLD IS YOURS";
    string private constant _symbol = "TWIY";
    ...
    constructor () {
        dev = payable(0xf8F6F8558aEb9A4C97BD626031B8f1C7D404aFd9);
