...
interface ILSSVMPairFactoryLike {
    ...
    function routerStatus(MferswapRouter router)
        external
        view
...
contract MferswapPairFactory is Ownable, ILSSVMPairFactoryLike {
    ...
    mapping(MferswapRouter => RouterStatus) public override routerStatus;
    ...
    event RouterStatusUpdate(MferswapRouter router, bool isAllowed);
        ...
        onlyOwner
    {
        ...
        if (isAllowed) {
            require(
                !routerStatus[MferswapRouter(target)].wasEverAllowed,
                "Can't call router"
            );
        }
    ...
    /**
        ...
        @param isAllowed True to whitelist, false to remove from whitelist
     */
    function setRouterAllowed(MferswapRouter _router, bool isAllowed)
        external
        onlyOwner
    {
