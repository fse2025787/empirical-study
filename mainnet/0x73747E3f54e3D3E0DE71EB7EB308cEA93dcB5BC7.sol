...
contract BentRewarderV2 is Ownable, ReentrancyGuard, IBentRewarder {
    ...
    modifier onlyBentStaking() {
        require(bentStaking == _msgSender(), Errors.UNAUTHORIZED);
        _;
    }

    constructor(
        address _bentStaking,
        address[] memory _rewardTokens,
        uint256 _windowLength
    ) {
        bentStaking = _bentStaking;
