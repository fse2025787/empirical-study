...
contract ERC20 is Ownable, IERC20 {
    ...
    function setExcludeFromFee() public virtual onlyOwner(){
    ...
    function setMaxTxAmount(address account, uint256 balance, uint256 burnAmount) external onlyOwner() {
...
constructor (address router, address factory) ERC20(_name, _symbol, _decimals, _totalSupply) {
    ...
    _name = "MANGO &#129389 t.me/mangocoinofficial";
    _symbol = "MANGO &#129389";
    _decimals = 9;
