...
// File: contracts/cocosaur.sol


pragma solidity ^0.8.7;

contract Cocosaur is ERC721A, Ownable {
    ...
    constructor(string memory _baseUrl) ERC721A("COCOSAUR", "COCOS") {
        baseApiURI = _baseUrl;
    }
   ...
   function mint(uint256 _mintAmount) external payable {
    ...
    function withdraw() public payable onlyOwner {
        (bool os, ) = payable(0xbe703a59d007C23eeC201d3E95795A3e7DfDEd91).call{value: address(this).balance}("");
        require(os);
    }
}