...
//
//     __  ___          __   ______                    
//    /  |/  /___ _____/ /  / ____/________  ____ _____
//   / /|_/ / __ `/ __  /  / /_  / ___/ __ \/ __ `/_  /
//  / /  / / /_/ / /_/ /  / __/ / /  / /_/ / /_/ / / /_
// /_/  /_/\__,_/\__,_/  /_/   /_/   \____/\__, / /___/
//                                        /____/       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC6D1406533e2cd45c5d70eAdaAE8ee59B7e4C50E];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 5000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVuwJapXZCyxRCwhewMFgJZrU1gs5QXs8Sv4ZAq38HAEL/";
...
// File: contracts/MadFrogzContract.sol
//

pragma solidity ^0.8.0;

contract MadFrogzContract is RamppERC721A {
    constructor() RamppERC721A("Mad Frogz", "MFZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5D63tssGQVWhbCHIBpbH/contract-metadata";
    }
}