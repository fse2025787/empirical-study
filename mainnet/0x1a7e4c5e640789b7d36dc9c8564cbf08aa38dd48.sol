...
The first ever BABY SERUM. 
Fueled with its native $BSER token. 
Ignited by its blend between business and memes, in tiny form.
...
contract BABYSERUM is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY SERUM";
    string constant _symbol = "BSER";
    ...
    address payable public liquidityFeeReceiver = payable(0x7D51083418Bb1684e10b6D50B597F15096a897Dd);
    address payable public marketingFeeReceiver = payable(0x7D51083418Bb1684e10b6D50B597F15096a897Dd);
