...
contract MoonKuma is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmciG7ZdXMuT2b7bTULq3zpLoaY5GcsNSZ9WHwUF5zyToe";
    ...
    constructor(
    ) ERC721A("MoonKuma", "MK", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
		 string(abi.encodePacked(baseURI, "/", "moonkuma", ".json"));
