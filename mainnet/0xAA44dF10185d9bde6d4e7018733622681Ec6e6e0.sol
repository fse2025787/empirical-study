...
contract Referable {
    ...
    address public r2eAddress = 0xc6672E7E9F6Db8CFc7d929b128192a98AB8Dc168;
...
contract ERC1155Factory is Ownable {
    ...
    constructor(address _treasuryAddress, address _launchpassAddress, uint16 _treasuryShare, address _crossmintAddress) {
    ...
    function updateConfig(address _treasuryAddress, address _launchpassAddress, uint16 _treasuryShare, address _crossmintAddress) external onlyOwner {
        treasuryShare = _treasuryShare;
        launchpassAddress = _launchpassAddress;
        treasuryAddress = _treasuryAddress;
        crossmintAddress = _crossmintAddress;
    ...
    function deploy(
        ...
        ERC1155Contract nft = new ERC1155Contract(_id, _name, _symbol, _uri, payees, shares, msg.sender, crossmintAddress, token);
