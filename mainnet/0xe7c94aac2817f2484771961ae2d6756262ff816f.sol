...
contract MOONLIGHT is ERC20, Ownable {
    ...
    constructor() ERC20("MOONLIGHT", "MOONLIGHT") {
        _mint(msg.sender, 1e11 * 10**decimals());

        marketingFeeAddress = payable(
            0xe650496d99D9418527D1f17418700e6deb75ef00
        );
        stakingFeeAddress = payable(0xe650496d99D9418527D1f17418700e6deb75ef00);
        ...
        bridgeAddress = 0xe650496d99D9418527D1f17418700e6deb75ef00;
