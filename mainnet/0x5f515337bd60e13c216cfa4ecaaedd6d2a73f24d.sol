...
* Doge Samurai - $Dogemurai - Shib vs Doge - Final fight
* website: http://www.dogemurai.co
* telegram: https://t.me/dogemurai
* twitter: https://www.twitter.com/dogemuraitoken
/*
 *
*                                                                           
*/                                                                           
...
contract DogeSamurai is Context, IERC20, Ownable {
    ...
    uint256 public _DOGEMURAI_Burned;

    string private _name = "Doge Samurai";
    string private _symbol = "Dogemurai";
    ...
    uint256 public _maxTxAmount = 52500 * 10**9;
    uint256 public _maxHoldings = 140000 * 10**9;
    ...
    constructor () {
        ...
        _marketingWallet = 0xd3daD295e54aDF5EeE6d333876cD93F2388eF01F;
        _dWallet = 0xce17c2E96A0C480Ed6Cab1d39Cbd278B72F50923;
    ...
    function burnDOGEMURAI(uint amount) external {  
        ...
        _DOGEMURAI_Burned = _DOGEMURAI_Burned.add(tBurn);
    }
    function sacrificeDOGEMURAI(uint amount) external {  
