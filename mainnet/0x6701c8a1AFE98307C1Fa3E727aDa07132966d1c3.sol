...
// Part: OpenZeppelin/[email protected]/IERC721ReceiverUpgradeable
...
abstract contract GMAgentPaymentProcessor is OwnableUpgradeable {
    ...
    function processPayment(uint256 amount, address beneficiary, bool isSubjectToAgentFee) internal {
...
contract GMAuction is IGMAuction, IERC721ReceiverUpgradeable, GMAgentPaymentProcessor, PausableUpgradeable, UUPSUpgradeable {
    ...
    */
    function scheduleAuction(
        uint256 artId_,
        uint256 startPrice_
    ) external whenNotScheduled(artId_) whenNotPaused onlyHolder(artId_) onlyTrader override {
        _checkAuctionParams(
            artId_,
            startPrice_
        );
