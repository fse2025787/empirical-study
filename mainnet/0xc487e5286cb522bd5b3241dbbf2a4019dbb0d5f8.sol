...
contract Elf_World is ERC721, Ownable {
  ...
  constructor() ERC721("Elf World", "Elf") {
    setHiddenMetadataUri("ipfs://QmTcQfEYSWK4S9pEx9ZDg5us8LJFXsGQbnLF32c6ce5mRJ/hidden.json");
  }
  ...
  modifier isValidMerkleProof(bytes32[] calldata merkleProof, bytes32 root) {
        require( MerkleProof.verify( merkleProof, root, keccak256(abi.encodePacked(msg.sender))), "Address does not exist in list"); _;
    }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(!Presale, "Public Mint is not open!");
