...
contract KingKong is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xD939b2d61a69C499762464E4548Be04615326a21));
    ...
    uint256 public _maxTxAmount = 69 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 210 * 10**19 * 10**9;
