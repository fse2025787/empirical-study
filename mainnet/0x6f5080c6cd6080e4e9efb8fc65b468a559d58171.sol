...
DogeTube | THE NEW DECENTRALIZED VIDEO SHARING PLATFORM | 
 
There is a strong need to build a fully decentralized video sharing platform taking into account the new paradigm of Web3.

The recent Elon Tweet called for new social media platforms. 

We are here to make that happen & set new standards for social media & content sharing.

The new decentralized video sharing platform - DogeTube is here to flip YouTube

https://t.me/DogeTubeETH
...
contract DogeTube is Context, IERC20, Ownable {
    ...
    string private _name = "DogeTube";
    string private _symbol = "DogeTube";
