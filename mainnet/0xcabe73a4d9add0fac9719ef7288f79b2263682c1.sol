...
The reason behind that is I needed to accomodate a SVG generator complete with an embedded font and custom colors and
text, and a secondary, static SVG to be displayed when tokenId is out of bounds.
...
contract Etherwriter is Context, ERC721 {
	...
	uint256 private _mintFee = 194600000000000000; //194600000000000000, 0.1946 ETH
