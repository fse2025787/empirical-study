...
contract SDragons is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmP64QHCVcGLSeEHkSryPkhqSB69PQh2ysSqQvAhN2Ms4h/";
  uint256  public  maxSupply = 7000;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.003 ether;
  uint256 public  NUM_FREE_MINTS = 7000;
