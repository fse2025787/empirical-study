...
Are you ready Anon? For the moment of truth?

The time has come... for us to go 🆙 like always!

⚠️ BEARS GET THE ROPE
WE FEATURE A 1% MARKETING TAX BECAUSE WE'RE CHADS TO ENSURE THAT THIS TOKEN ALWAYS GOES 🆙

🚀 GET IN NOW OR FOMO IN WHEN WE ARE 1000% UP, THE ROCKET IS NOT STOPPING
👾 DEGENS LOVE THIS FOR A REASON. PREPARE FOR BIG MARKETING PUSHES AFTER LAUNCH.
...
contract AlwaysUP is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000000 * 10 ** 18;

    constructor () ERC20(unicode'Always⬆️','AlwaysUp') {
