...
contract POP is ERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 25 * 10 ** decimals();
    uint256 private _totalSupply = 1000 * 10 ** decimals();

    constructor() ERC20(unicode"Proof of Proof", "POP") {
