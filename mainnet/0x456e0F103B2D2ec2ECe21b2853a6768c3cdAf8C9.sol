...
contract PoolRewards is Initializable, IPoolRewards, ReentrancyGuard, PoolRewardsStorage {
    ...
    function _claimable(
        ...
        console.log("SC:reward token", _rewardPerToken(_rewardToken, _totalSupply));
        uint256 _rewardPerTokenAvailable =
            _rewardPerToken(_rewardToken, _totalSupply) - userRewardPerTokenPaid[_rewardToken][_account];
        console.log("SC:_rewardPerTokenAvailable", _rewardPerTokenAvailable);
        console.log("SC:_balance", _balance);
    ...
    function _notifyRewardAmount(
        ...
        console.log("SC:_totalSupply", _totalSupply);
