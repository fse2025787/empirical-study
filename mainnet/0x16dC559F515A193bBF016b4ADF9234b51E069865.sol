...
contract DEFIKILLER  is Context, IERC20, Ownable {
    uint8 private _decimals = 18;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply =  450000000 * 10**_decimals;
    uint256 public immutable _buyTax =0;
    uint256 public immutable _sellTax = 2;
    string private _name = unicode"DEFI KILLER";
    string private _symbol = unicode"DKILL";
    bool active=false;  
