...
//
//   _______                ____             __        __      
//  /_  __(_)___  __  __   / __ \____  _____/ /_____  / /______
//   / / / / __ \/ / / /  / /_/ / __ \/ ___/ //_/ _ \/ __/ ___/
//  / / / / / / / /_/ /  / _, _/ /_/ / /__/ ,< /  __/ /_(__  ) 
// /_/ /_/_/ /_/\__, /  /_/ |_|\____/\___/_/|_|\___/\__/____/  
//             /____/                                          
//     
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0A5872263c724D914B0eeD234F68473B23360E64];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 1000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUCtV4njMuxu3xjSRCChxR9e5xZi9MQaZrm3ex3xVtwth/";
...
// File: contracts/TinyRocketsContract.sol
//

pragma solidity ^0.8.0;

contract TinyRocketsContract is RamppERC721A {
    constructor() RamppERC721A("Tiny Rockets", "ROCKET"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wlHF8ZkrgJrRCksVS2TL/contract-metadata";
    }
}
