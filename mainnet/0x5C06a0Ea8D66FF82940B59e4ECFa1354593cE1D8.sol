...
// 
        ...
        contract DigiDaiOddparents is ERC721A, Ownable, ReentrancyGuard  {
            ...
            uint256 public costOfNFT = 2000000000000000 ether;
            uint256 public numberOfFreeNFTs = 0;
            
            uint256 currentFreeSupply = 0;
            uint256 freeSupplyLimit = 700;
            string HiddenURL;
            bool revealed = false;
            bool paused = true;
        ...
        constructor(string memory _initBaseURI) ERC721A("Digi Dai Oddparents", "DDOP") {
