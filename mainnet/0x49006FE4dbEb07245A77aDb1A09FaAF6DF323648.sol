...
contract CGHMCNFT is ERC721, Ownable, ERC721URIStorage {
    struct URIwithID {
        uint256 id;
        string uri;
    }
    ...
    constructor() ERC721("Mr Whiskers's Only NFT", "MEOW") {}
    ...
    function tokenURIsAndIDsByOwner(address _owner) public view returns (URIwithID[] memory) {
