...
Welcome to DOGESHIBA!!!!

Here At DogeShiba we aim to combine the massive audiences of both these giants!


TELEGRAM: https://t.me/DogeShibaCommunity
...
contract DogeShiba is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xD6B44884E000a956d0b6AAfB32ab970572aF14fE));
    address payable public _devwallet =
        payable(address(0xe862E6933707471a1898e5794431387b82f8C9d6));
    address public _exchangewallet =
        payable(address(0x19b6D0016Cf750E9A6aF5B686532B1800A0c2d82));
    address _partnershipswallet =
        payable(address(0xDd74224B895149A8d100Dd263f5BDcAe09c3cc2E));
