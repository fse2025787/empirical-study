...
contract WRLDTakeOverX$BEO1 is Ownable, ERC721A, ReentrancyGuard {

    bool public publicSale;

    uint256 public constant MINT_PRICE_ETH = 0.01 ether;
    ...
    constructor() ERC721A("WRLDTakeOverX$BEO1", "WTOG", MAX_BATCH, MAX_TOKENS) {
