...
contract Kongerz is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.0134 ether;
  ...
  constructor() ERC721("Kongerz", "KGZ") {
    setHiddenMetadataUri("ipfs://QmevDPDrxuApcQjX3vY4BiAPmKSpfmgHQekLXRCxQU1kNU/hidden.json");
  }
