...
contract BitFarmUniverse is ERC20, Ownable {
    ...
    address public marketingWallet = 0xB2a32efb1e553F10F4416262C7147D40736Ba546;
    address public devWallet = 0x290A06499e01EaFe647e04ccb21a596e44Bcf844;
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 5, "Must keep fees at 5% or less");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 5e3, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 5e3, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 5e3, "Cannot set max wallet amount lower than 1%");
