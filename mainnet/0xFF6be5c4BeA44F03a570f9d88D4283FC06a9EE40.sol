...
contract SENTRYERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Super Soldier Serum";
    string private constant _symbol = unicode"SENTRY";
