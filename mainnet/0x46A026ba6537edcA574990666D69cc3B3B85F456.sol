...
pragma solidity ^0.8.0;
contract CryptoMax is ERC721A, Ownable, ReentrancyGuard { 
    ...
    uint256 public _maxFreeMintSupply = 7500;

    using Strings for uint256;
    string public baseURI ="QmU4hSJdqC7mA1GaHU3gmzP8H6eEaz87YDckbYy9dGvkA5";
    mapping(address => uint256) private _mintedFreeAmount;

    constructor(string memory initBaseURI) ERC721A("CryptoMax", "Max") {
        baseURI = initBaseURI;
    }
