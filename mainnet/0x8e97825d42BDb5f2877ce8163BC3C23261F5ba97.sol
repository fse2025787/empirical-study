...
contract pod is Context, IERC20, Ownable {
    ...
    string private constant _name = "Planet of Degens"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x92B2887B9a86eFf532b68125f28B99b43A2e291d).transfer(ethToSend); //marketing wallet
    }
