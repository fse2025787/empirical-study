...
Akiramenaide is the Japanese phrase for NEVER GIVE UP! 
This token is for everyone who has felt defeated by the crypto space. 
THIS IS YOUR OPPORTUNITY FOR REDEMPTION!

Tax : 6/6

Community run TG - Twitter coming.
...
contract Akiramenaide is Context, IERC20, Ownable {
    ...
    string private constant _name = "Akiramenaide";
