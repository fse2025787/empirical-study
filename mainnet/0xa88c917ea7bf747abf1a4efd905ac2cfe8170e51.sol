...
contract Monoply is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Monoply Token T.me/MonoplyETH";
    string private constant _symbol = "Monoply";
