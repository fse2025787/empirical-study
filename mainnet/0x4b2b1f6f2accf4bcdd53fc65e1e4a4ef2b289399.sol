...
// File contracts/assets/SON.sol


pragma solidity =0.8.4;


contract SON is ERC20, ISoNetAsset {

    bool public constant override isSoNetAsset = true;

    constructor(address reserve, address custodian) ERC20("Social Network", "SON") {
        _mint(reserve, 1_080_000 * (10 ** decimals()));
        _mint(custodian, 34_920_000 * (10 ** decimals()));
    }
