...
contract DegeneratesAI is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("DegeneratesAI", "{DEGENAI}") {

  }
  
  function paint(uint256 numberOfTokens)
      external
      payable
  {
  ...
  function O(uint numberOfTokens, address user)
    public
    onlyOwner
  {
    require(
