...
contract OneShotBear is ERC721A, DefaultOperatorFilterer {
    uint256 public maxSupply = 1100;
    uint256 maxPerWallet = 25;   
    ...
    string uri = "ipfs://QmUGigeP9aormjQUft5Pjon3uhssAUHD2reK3bPHL7LYGB/";
    ...
    constructor() ERC721A("OneShotBear", "OSB") {
        owner = msg.sender;
    }
