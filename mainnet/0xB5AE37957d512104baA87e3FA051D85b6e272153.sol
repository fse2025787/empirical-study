...
contract TheFarmGamePlay is PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  // Egg shop type IDs
  uint16 public applePieTypeId;
  uint16 public rainbowEggTypeId;
  uint16 public silverEggTypeId;
