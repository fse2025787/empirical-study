...
contract CZDigital is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("CZ Digital Trading Cards", "CZ") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return "ipfs://QmRbczSSXVAYT9jKUCSUEbQJHdspvrcK8iyn8gDC6cCbUV";
    }

    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 80) / 1000;
