...
contract FumaKotaro is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Fūma Kotarō", "FK") {
        ...
        operationsAddress = address(0x9f32AB6aEbB8c1D5D12D641AE528DFD39eF11e5C);
        devAddress = address(0x9f32AB6aEbB8c1D5D12D641AE528DFD39eF11e5C);
