...
/*
 ...
 Only The Enlightened shall be granted my key.

 Let no man ignorant of Geometry enter here.
 
 https://www.nostrum.me
...
contract NOSTRUM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NOSTRUM PLATONIS", "NOSTRUM") {
    ...
    ; uint256 totalSupply = 0.216 * 1e12 * 1e18;
