...
contract Strategy is CurveVoterProxy {
    ...
    constructor(address _vault) public CurveVoterProxy(_vault) {
        dex = sushiswap;
        curve = address(0x0Ce6a5fF5217e38315f87032CF90686C96627CAA);
        gauge = address(0x90Bb609649E0451E5aD952683D64BD2d1f245840);
        keepCRV = 1000;
    }
        ...
        )
    {
        ...
        if (_usdc > 0) {
            ...
            Uni(uniswap).swapExactTokensForTokens(_usdc, uint256(0), path, address(this), now);
        }
