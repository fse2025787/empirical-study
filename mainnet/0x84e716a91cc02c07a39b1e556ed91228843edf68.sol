...
/**
A super low tax meme token

https://t.me/greendragoninu

https://www.greendragoninu.com/
*/
...
contract GREENDRAGON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Green Dragon Inu", "GDINU") {
    ...
    ; uint256 totalSupply = 1 * 1e7 * 1e18;
        ...
        maxTransactionAmount = totalSupply * 75 / 10000; // 0.75% maxTransactionAmountTxn
