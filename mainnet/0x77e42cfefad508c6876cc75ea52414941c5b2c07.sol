...
// https://t.me/banzai_eth
// https://twitter.com/banzai_eth
// http://tinyurl.com/BanzaiETH
...
contract Banzai is ERC20, Auth {
    // TOKENOMICS START ==========================================================>
    string private _name = "Banzai";
    string private _symbol = "BANZAI";
    ...
    address public marketingWallet = 0x8a647EBDfa3dC781d549ebcdf6DA7807B967AFB6;
     ...
     * construction.
     */
    constructor() Auth(msg.sender) ERC20(_name, _symbol) {
        _owner = owner;
    ...
    function excludedFromFee(address _address) public authorized {
