...
contract PixelWizards is ERC721A, Ownable {
    ...
    constructor() ERC721A("Pixel Wizards", "PW", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function BestWizMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
