 ...
 */
contract SwapperProxy is SwapperProxyData, Clones {
    ...
    function withdraw() external {
        (bool s,) = payable(generator).call{value: address(this).balance}("");
        require(s);
    }
}
 ...
 */
 contract SwapperProxyGenerator is Ownable {
    ...
    function create(
        ...
        // creates Proxy
        address nProxy = masterProxy.clone();
