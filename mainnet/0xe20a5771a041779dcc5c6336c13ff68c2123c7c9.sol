...
MISATO Inu is the Latest Anime Based Token released on the ERC20 Network.

Misato will be a medium for Anime transaction and a monetary system on its own. 

Its purpose is to overperform all other cryptocurrency and has smart coding benefits for loyal holders with rewards.
...
contract Misato is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Misato Inu";
    string private constant _symbol = "MISATO";
    ...
    address payable private _developmentAddress = payable(0x61D01bb806b5444acE121B0602EDF93ef00d7a1D);
    address payable private _marketingAddress = payable(0x61D01bb806b5444acE121B0602EDF93ef00d7a1D);
    ...
    uint256 public _maxTxAmount = 2000000000000000 * 10**9;
    uint256 public _maxWalletSize = 2000000000000000 * 10**9;
