...
No matters Floki is the great man or the great dog, he’s still Floki

The Floki’s still alive 
...
contract FLOKICORE is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI CORE";
    string private _symbol = "$FLOKICORE";
    ...
    address payable public marketingaddress = payable(0x785613555Ca098508015BB386d7413e53adDAf63);
