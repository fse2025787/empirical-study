...
/**
Project Name: Félicette
Telegram: https://t.me/Felicetteofficialannouncement
Twitter: https://twitter.com/Felicette_space
Website: https://www.felicette.space/


Félicette is without a doubt one of the most heroic cats in recorded history but very few know about the dark side of her story. One would think that a hero such as Félicette would have received parades of celebration and honour but sadly, she had been brutally electrocuted to death as soon as she arrived back to earth from her valiant space voyage.
Many campaigns and rallies tried to fight for Félicettes injustice but unfortunately they had failed and over the decades her legacy was forgotten. 
Let’s stand together and unite as one so we can finally give Félicette the proper memorial and justice she truly deserves.
...
contract Felicette is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Space Cat";
    uint8 private constant _decimals = 9;

    uint16 public tokensBuyFee = 5;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x53744a299Ee0BDb1D4E1B26B464f4502EF3B8AE4); 
    ...
    function openTrading() external onlyOwner() {
        ...
        maxWalletAmount = 30_000_001 * 10**9;
        tradingOpen = true;
