...
Elon’s favourite sport

With Evaluation of 1 Billion it’s another unicorn of Elon after Tesla and SpaceX.

https://t.me/theboringcompanyportal
...
contract TheBoringCompany is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Boring Company";////////////////
    string private constant _symbol = "TBC";////////////////
    ...
    address payable private _developmentAddress = payable(0x668A842f5f5B846137eAdB49d769816e8e4E49Fa);////////////////////
    address payable private _marketingAddress = payable(0x668A842f5f5B846137eAdB49d769816e8e4E49Fa);/////////////////////
