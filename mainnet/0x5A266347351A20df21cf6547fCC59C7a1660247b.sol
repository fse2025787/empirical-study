...
contract MINXIE is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, bytes32 _merkleRootVIP, string memory _baseURI) ERC721A("MINXIE", "MNX")
