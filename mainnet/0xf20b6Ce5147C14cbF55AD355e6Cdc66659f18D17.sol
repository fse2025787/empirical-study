...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x4bA3D78fD02A9F69B5Bc5a31E91E60F8Fdc93DCF];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x4bA3D78fD02A9F69B5Bc5a31E91E60F8Fdc93DCF;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiakiyioyv6ujwofzldfc52eaegobnoolxxamt7rvmtp7slyshikai/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1333");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1333");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1333");
...
// File: contracts/MoonfrogsContract.sol
//

pragma solidity ^0.8.0;

contract MoonfrogsContract is RamppERC721A {
    constructor() RamppERC721A("Moonfrogs", "MFROG"){}
}
