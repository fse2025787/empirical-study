...
contract GM is Context, IERC20, Ownable {
    ...
    string private constant _name = "GM";
    ...
    address payable private _developmentAddress = payable(0xd0B384d73173a7C40AEB184a752727178B9b6688);
    address payable private _marketingAddress = payable(0xd0B384d73173a7C40AEB184a752727178B9b6688);
