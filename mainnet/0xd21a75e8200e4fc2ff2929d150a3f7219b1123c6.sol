...
contract SmolInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Smol Inu";
    string private constant _symbol = "SMOLU";
    ...
    address payable private _developmentAddress = payable(0xC45E3a5a6b78471D7740C6c0224a86ca2cBd0682);
    address payable private _marketingAddress = payable(0x4613f0348919C8aC7d92bE45B8E434419EA42ab2);
