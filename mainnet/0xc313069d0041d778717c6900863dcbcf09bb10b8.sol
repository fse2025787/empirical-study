...
contract Exo is Initializable, OwnableUpgradeable, ERC721XUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    using AddressUpgradeable for address;
    using StringsUpgradeable for uint256;
    ...
    function safeMint(address to, uint256 quantity) public {
        ...
        if (balanceOf(to) + quantity > MAX_PER_WALLET) revert MintExceedsWalletAllowance();
        _safeMint(to, quantity);
    }
