...
contract PartyRockBunny is Context, IERC20, Ownable {
    ...
    string private constant _name = "Party Rocking Bunny";
    string private constant _symbol = "BUNNYROCK";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x21AB96500b819943e6656f40C04ad12790077CAC);
        _feeAddrWallet2 = payable(0x21AB96500b819943e6656f40C04ad12790077CAC);
