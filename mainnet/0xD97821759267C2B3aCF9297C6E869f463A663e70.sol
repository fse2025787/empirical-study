...
//*********************************************************************//
//
//    ______      __    ___          ________                   _      __                ________      __  
//   / ____/___  / /_  / (_)___     / ____/ /_  ___  ____ ___  (_)____/ /________  __   / ____/ /_  __/ /_ 
//  / / __/ __ \/ __ \/ / / __ \   / /   / __ \/ _ \/ __ `__ \/ / ___/ __/ ___/ / / /  / /   / / / / / __ \
// / /_/ / /_/ / /_/ / / / / / /  / /___/ / / /  __/ / / / / / (__  ) /_/ /  / /_/ /  / /___/ / /_/ / /_/ /
// \____/\____/_.___/_/_/_/ /_/   \____/_/ /_/\___/_/ /_/ /_/_/____/\__/_/   \__, /   \____/_/\__,_/_.___/ 
//                                                                          /____/                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2c551a42C9A3CFCE6d79F3FD001e81A106D60B1D,0xc144B1c84D08e3008A9258D8F9b9eF61c191aCC5,0xfb26520811cE2AEE195943b654fFF280887728Ef];
  uint256[] public payableFees = [5,15,45,35];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVdSkQPj29d1SXVyH61ivHoqMvsbPSz7x5HwBe9xPTsU7/";
...
// File: contracts/GoblinChemistryClubContract.sol
//

pragma solidity ^0.8.0;

contract GoblinChemistryClubContract is RamppERC721A {
    constructor() RamppERC721A("Goblin Chemistry Club", "GoblinCC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HJYmIwnbbfY4SYaqhQVD/contract-metadata";
    }
}
