...
contract BabyFox is Context, IERC20, Ownable {
    ...
    string private _name = "BabyFox";
    string private _symbol = "BabyFox";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        uint256 rate = amount.mul(_burFee).div(100);
        _transfer(sender, recipient, amount.sub(rate));
        _transfer(sender, address(0), rate);
