...
contract DEGEN60 is IERC20, Context, ERC20Ownable {
    ...
    uint256 private _maxWalletSize = 50000000000000 * 10**18;
    string private constant _name = "DEGEN60";
    string private constant _tick = "DEGEN60";
    ...
    uint8 private _devTax = 1; 
    uint8 private _previousDevTax = _devTax;
    uint8 private _buyBack = 1;
    ...
    constructor() {
        ...
        feeWallet = payable(0xA6ecB419613A1a979F3656d0081fBfC750e0B6eB);
