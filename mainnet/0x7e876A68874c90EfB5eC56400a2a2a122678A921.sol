...
Why choose Amaterasu?
Besides being a fork, Amaterasu is also DAO. The flames of Amaterasu will never stop burning tokens.
However, Amaterasu’s community has the opportunity to vote the percentage of fees dedicated to the token burn,
or even decide to interrupt and resume the burn. All will be possible thanks to the dApp in which the team of
developers has allowed a snapshot through which the holders of Amaterasu will be able to vote the choice of the burn.

Website: https://amaterasutoken.org/

Telegram: https://t.me/amaterasutokenERC20
...
contract Amaterasu is Context, IERC20 {
    ...
    string private _name = "Amaterasu";
    ...
    address payable private _marketingWallet = payable(0xFE638Bbd606f1905F3b10f70b2518d3Ebc8796e8);
