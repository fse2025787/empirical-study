...
contract FD123 is ERC721A, Ownable {
  ...
  uint256 public allowListprice = 0.000422 ether;
  ...
  constructor(string memory baseURI) ERC721A("FD123", "FD123") {
  ...
  function withdraw() external payable onlyOwner {
    payable(0x1ffe41c5d154EC5ddB86a931BC47Aa9548a6CD73).transfer(address(this).balance);
  }
}
