...
// File: contracts/GoblinRareApepeYC.sol
...
contract GoblinRareApepeYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2345;
  ...
  ) ERC721A("Goblin Rare Apepe YC", "GBLNRAYC") {
