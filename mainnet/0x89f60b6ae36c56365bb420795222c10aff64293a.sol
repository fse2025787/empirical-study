...
Welcome to Centralized Exchange Classic!

Has your CEX disabled withdrawals and transfers?  Well don't worry about it a bit!

We here at Centralized Exchange Classic will take you back to a time when your currency 
wasn't locked out of reach when you needed it most. With 30 days of locked liquidity, 
a verified contract, and renounced ownership, you can sleep soundly, knowing your money 
is stored in a SAFE store-of-value currency, and available whenever you need it! Now THAT'S bullish!

Tax: 4% Buy / 4% Sell

Telegram at $10k!  Website at $50k!
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xB0fB917acCd21C498B3F392Bb775de59fcB72C49] = _marketingwallet;
    }
...
contract CEXC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Centralized Exchange Classic", "CEXC") {
        ...
        excludeFromFees(address(0xB0fB917acCd21C498B3F392Bb775de59fcB72C49), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xB0fB917acCd21C498B3F392Bb775de59fcB72C49), true);
