...
contract TwentyMission is ERC1155, ContextMixin, NativeMetaTransaction {
  // token vars
  ...
  constructor() ERC1155("https://nft.20mission.com/metadata/{id}") {
    admin = msg.sender;
    openseaProxyEnabled = true;
    _initializeEIP712("20mission");
  }
  ...
  /**
   * Override isApprovedForAll to whitelist opensea proxy account and admin
   */
  function isApprovedForAll(
      ...
      // eth mainnet
      if (_operator == address(0xa5409ec958C83C3f309868babACA7c86DCB077c1) && openseaProxyEnabled == true) {
          return true;
      }
