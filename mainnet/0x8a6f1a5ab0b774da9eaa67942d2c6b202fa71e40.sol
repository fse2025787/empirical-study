...
contract EXPLODERS is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5750;
    uint256 public MAX_MINTS = 1000;
    string public baseURI = "ipfs://bafybeiesfhau25hgwpxlt7qinfntd26ipp23oux5zg4s5qcvgrt47s7xva/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("EXPLODERS", "EXP", MAX_MINTS, MAX_SUPPLY) {  
    }
