...
contract WorldCupStars is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="World Cup Stars";
    string private _symbol = "WCS";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x940BCC3A293fA6824617d40b0bD5872803040F8d);
    address payable private taxWallet2 = payable(0x940BCC3A293fA6824617d40b0bD5872803040F8d);
