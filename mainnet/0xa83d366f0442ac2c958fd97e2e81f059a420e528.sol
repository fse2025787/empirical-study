...
contract GalDev is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Gal Dev';
    ...
    uint256 private MarketingsFee = 50;
    ...
    address internal constant devfee_receiver = 0xD12173B62671201DCBeF0ec95003Dc0Cf21a45A8; 
    address internal constant Marketingfee_receiver = 0xD12173B62671201DCBeF0ec95003Dc0Cf21a45A8;
    address internal constant liquidityfee_receiver = 0xD12173B62671201DCBeF0ec95003Dc0Cf21a45A8;
    ...
    function releasetheMarketings() external onlyOwner {tradingAllowed = true;}
    ...
    function setTaxes(uint256 _liquidity, uint256 _Marketing, uint256 _burn, uint256 _dev, uint256 _total, uint256 _Marketings, uint256 _trans) external onlyOwner {
        liquidityFee = _liquidity;
        MarketingFee = _Marketing;
        burnFee = _burn;
        devFee = _dev;
        totalFee = _total;
        MarketingsFee = _Marketings;
        transferFee = _trans;
    ...
    function getTotalFee(address sender, address recipient) internal view returns (uint256) {
        ...
        if(recipient == pair){return MarketingsFee;}
