...
contract TurtleSamuraiNFT is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.005 ether;
    uint   public maxTx             = 333;
    uint   public maxSupply         = 333;
    uint256 public reservedSupply   = 333;
    string private baseURI          = "ipfs://bafybeigsw5vuyvbvgwoszavimzoilqiwoasjnbw3xv2iuxwu6x7trff44y/";
    ...
    constructor() ERC721A("Turtle Samurai NFT", "TSN") {}
