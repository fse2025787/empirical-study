...
contract Psycho is Ownable, IERC2981, ERC721 {
    ...
    function checkVipMintlist(bytes calldata sig) private view returns(bool) {
        return(
            ...
            IERC721(0x60E4d786628Fea6478F785A6d7e704777c86a7c6).balanceOf(msg.sender) > 0 ||
            IERC721(0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D).balanceOf(msg.sender) > 0 ||
            IERC721(0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e).balanceOf(msg.sender) > 0
        );
    }
