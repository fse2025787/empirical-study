...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public maxWallet = 300000000000e18;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(!Limtcheck[recipient]){ require(_balances[recipient].add(amount) <= maxWallet,"Tx Limit Exceed");}
...
contract Proofof2023 is ERC20 {
   ...
   IUniswapV2Router02 public uniswapV2Router;
     ...
     */
    constructor () ERC20('Proof of 2023', 'P23') {
