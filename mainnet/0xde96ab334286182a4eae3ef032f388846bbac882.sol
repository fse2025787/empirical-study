...
$BRYANT is here waking up every sleepy degen. 

BRYANT SNIPER

$BRYANT team will be developping a block 0 sniping tool available for holders. 
The sniping tool will also include advanced rugpull options, copy trading options and will be faster than most snipers out, such as Maestro and Sonic
 
200.000.000 Total supply
2% max wallet
5% tax

https://twitter.com/BlackTyrantETH
https://t.me/BlackTyrant
**/
...
contract BlackTyrant is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Tyrant";
    string private constant _symbol = "BRYANT";
