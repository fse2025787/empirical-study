...
contract CASPER is ERC20, Ownable {
    ...
    constructor() ERC20("CASPER", "CASPER") {
        ...
        devWallet = address(0x8a83873CAeCd90a694161f29126d821Ed2628127); // set as dev wallet
