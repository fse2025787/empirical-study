...
contract OSAMU is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x45273710D395a125381B4d85f5bCfDb4D4db5A64);
    address payable private _marketingAddress = payable(0x45273710D395a125381B4d85f5bCfDb4D4db5A64);
