...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB6d6509206A78060D7A81F73f139D3Cf16f99eF7];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmYQSimbbRhJn9M86B4KMMiGgX3QtrgsWpTXUqkfW3iiHw/";
...
// File: contracts/KrazykatswtfContract.sol
//

pragma solidity ^0.8.0;

contract KrazykatswtfContract is RamppERC721A {
    constructor() RamppERC721A("krazykatswtf", "krazykats"){}
}
