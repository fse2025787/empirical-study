...
We should all be glad that there are ballistic missiles. This will help ensure we don't throw bombs on each other

If the community ever wishes to create a Telegram, name it BallisticERC.
...
contract Ballistic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Launch", "BALLISTIC") {
        ...
        devWallet = 0xF72B4964eE8b8deeAf3c76765DD2F88845d897bE;
