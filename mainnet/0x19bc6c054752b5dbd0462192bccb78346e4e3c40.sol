...
contract TradeTrove is ERC1155, ERC2981, Ownable, Pausable, ERC1155Burnable, ERC1155Supply, DefaultOperatorFilterer  {

    string public contractURI;
    string public name;
    string public symbol;

    constructor(string memory _nftUri, string memory _contractURI, uint96 _royaltyFeesInBips) ERC1155(_nftUri) {
