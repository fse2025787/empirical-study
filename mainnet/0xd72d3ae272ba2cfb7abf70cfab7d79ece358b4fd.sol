...
Ethereum Blast - Play Free & Earn ETH!

Step into the realm of the unknown and embark on an interstellar journey unlike any other. With Ethereum Blast, the future of crypto earning games has finally arrived, and it's packed with non-stop excitement and the chance to earn real Ethereum. Experience a whole new world of gaming as you blast your way through a cosmic match-2 adventure and conquer the universe, one Ether at a time. Don't wait any longer, your journey into the ether space starts now!

https://t.me/Ethereum_Blast
...
contract BLAST is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1000000000000 * 10**9; //

    string private constant _name = "Ethereum Blast"; //
    string private constant _symbol = unicode"BLAST"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA2C7f43719F341018855F3a30ECD26D46C32508C;
