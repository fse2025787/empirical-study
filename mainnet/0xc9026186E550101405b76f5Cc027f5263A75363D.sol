...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xEb4Aa0437ebE4867B95f5f23916eF1423001C7C3];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xEb4Aa0437ebE4867B95f5f23916eF1423001C7C3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmULGvejJQF7qRqnQwGs5WbayPEZwZQuxPgE24pUZXZBjn/";
...
// File: contracts/NonfungibleBannersContract.sol
//

pragma solidity ^0.8.0;

contract NonfungibleBannersContract is RamppERC721A {
    constructor() RamppERC721A("Nonfungible Banners", "NFB"){}
}
