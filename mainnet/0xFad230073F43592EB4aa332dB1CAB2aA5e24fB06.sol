    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibdkbbgvdu3j47wllpyvflneudxzyunnnqoreolpzm4kgv25wptpe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/utv8CdDMYsJYPKsoVXZH/contract-metadata";
  }
...
// File: contracts/HellSkullContract.sol
//

pragma solidity ^0.8.0;

contract HellSkullContract is RamppERC721A {
    constructor() RamppERC721A("Hell Skull", "HSKULL"){}
}
