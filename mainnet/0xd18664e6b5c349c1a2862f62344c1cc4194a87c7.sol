...
//Okay Moonbirds ERC721A CONTRACT
...
contract OkayMoonbirds is Ownable, ERC721A {

    uint256 public adoptionLimit =3;
    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    string public baseURI = "ipfs://QmZvfbD7rkFkCTBNQNUzY1gYTT8KxQvpz6H31YUNs3M4Ji/";
    string public _extension = ".json";
    uint256 public price = 0 ether;
    uint256 public maxSupply = 5000;

    constructor() ERC721A("Okay Moonbirds", "OMBirds"){}
