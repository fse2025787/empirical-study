...
contract CNLuckyClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("888 CN Lucky Club", "888CNL") {
    setHiddenMetadataUri("ipfs://QmZdfUFExXMgyhmAHRghsEkP6fdJNs4u69LGrVMGzK4RP7/hidden.json");
  }
