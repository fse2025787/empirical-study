...
Website:
https://bearpunks.finance/

Twitter:
https://twitter.com/bearpunks_eth

Telegram:
https://t.me/BearPunksETH
...
contract bpunks is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bear Punks";
    string private constant _symbol = unicode"BPUNKS";
