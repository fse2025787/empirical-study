...
// About: Do we really need introduction for how reflections token still works? This just got to be the sickest reflection of all time. 
// Who has 10% BTC reflection built in them? BTC is no doubt the coin that affect any market. 
// WE PUMP BTC UP EVERYTHING WILL BE UP. PERIOD. Join us at our revolution to force BULL MARKET in again.
// 🔒 100% LP locked. Refer to link below.
// 💲 10% BTC Reflection
// 💧 5% Automatic liquidity
// 🐋 Anti-Whale mechanism to limit buys
// 🥡Anti-Dump mechanism, max 0.5% can be sold at 1 time
// 🚀 4chan Banner, Tiktok, Reddit, Twitter, YouTube Marketing
...
contract BabyBTCPUMP is Context, IERC20, Ownable {
    ...
    string private _name = 'BabyBTCPump 💲 t.me/BabyBitcoinPump';
    string private _symbol = 'bBITCOINPUMP';
