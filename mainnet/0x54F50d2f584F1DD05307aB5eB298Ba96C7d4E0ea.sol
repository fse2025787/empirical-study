...
// File contracts/BiFiGovernance.sol
// 
pragma solidity ^0.8.2;

contract BiFiGovernance is Governor, GovernorProposalThreshold, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    address public owner;
    address public pendingOwner;

    uint256 _votingDelay = 1; // 1 block
    uint256 _votingPeriod = 45818; // 1 week
    uint256 _proposalThreshold = 1000000e18;
