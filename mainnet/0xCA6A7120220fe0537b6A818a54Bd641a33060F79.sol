...
contract NFTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {
    ...
    constructor(
    ) ERC721Psi("Overcharged Girl", "OCG") {
        ...
        setBaseURI("https://data.gia-illust.com/ieofjqdm/metadata/");
        ...
        //initial mint
        _safeMint(0x9B2cc63523f46Ee5C4a5CAa352695c6f0Efe795F, 11);
        //_safeMint(msg.sender, 11);
        
        //Royalty
        setDefaultRoyalty(0x9B2cc63523f46Ee5C4a5CAa352695c6f0Efe795F , 500);
        setWithdrawAddress(0x9B2cc63523f46Ee5C4a5CAa352695c6f0Efe795F);
    ...
    uint256 public maxSupply = 200 -1;
