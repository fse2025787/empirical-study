...
//
//     __  _______                    __                  
//    /  |/  / __/__  _____________  / /___  ______  _____
//   / /|_/ / /_/ _ \/ ___/ ___/ _ \/ __/ / / / __ \/ ___/
//  / /  / / __/  __/ /  (__  )  __/ /_/ /_/ / /_/ (__  ) 
// /_/  /_/_/  \___/_/  /____/\___/\__/\__,_/ .___/____/  
//                                         /_/            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xEE47F646B866891aBd4bD90220401Fe645b82b70];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 100, 1111 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaFWriwgbPdsRwPa7osFyddcRMxQS25jV1H2U5XUQVBnp/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1111");
        _safeMint(_to, 1);
    }
...
// File: contracts/MfersetupsContract.sol
//

pragma solidity ^0.8.0;

contract MfersetupsContract is RamppERC721A {
    constructor() RamppERC721A("Mfersetups", "MFSU"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/OLcGWCmchMuYoAjc8uVG/contract-metadata";
    }
}
