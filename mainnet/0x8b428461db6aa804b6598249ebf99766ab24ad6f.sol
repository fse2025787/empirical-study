...
contract WAP is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Wet Ass Pump";
    string private constant _symbol = "WAP";
    ...
    address payable private _developmentAddress = payable(0xBc4Add3Beb922f9Ce99BE3CC4B9dC7EAB424eFa8); 
    address payable private _marketingAddress = payable(0xBc4Add3Beb922f9Ce99BE3CC4B9dC7EAB424eFa8);
