...
contract Chai {
    ...
    JoinLike public daiJoin =
        JoinLike(0x9759A6Ac90977b93B58547b4A71c78317f391A28);
    GemLike public daiToken =
        GemLike(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    ...
    bytes32 public constant DOMAIN_SEPARATOR =
        0x0b50407de9fa158c2cba01a99633329490dfd22989a150c20e8c7b4c1fb0fcc3;
...
// File: .deps/remix-tests/Chai4626.sol


pragma solidity ^0.8.13;
//import erc4626
contract Chai4626 is ERC4626 {
    Chai public chaiContract = Chai(0x06AF07097C9Eeb7fD685c692751D5C66dB49c215);
    ERC20 public daiToken = ERC20(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    PotLike public pot = PotLike(0x197E90f9FAD81970bA7976f33CbD77088E5D7cf7);
    uint256 public assetBalance;

    // Chai();
    constructor()
        ERC4626(daiToken, "wCHAI", "Wrapped 4626 Chai")
    {
