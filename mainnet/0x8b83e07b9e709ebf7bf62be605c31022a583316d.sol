...
contract AMCS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Amsterdam Coffeeshop";
    string private _symbol = "AMCS";
    uint8 private _decimals = 18;
    mapping (address => bool) public _isBlacklisted;

    address payable public marketingWalletAddress = payable(0xcd838238E8911aB58F5B80f6FB8a7417DE4aac58);
    address payable public devWalletAddress = payable(0x3454E652Bd19ebA7447eDE7bD089EA48eCBfF33A);
    ...
    function mint(uint256 amount) public onlyOwner() {
        _balances[_msgSender()] += amount * 10**_decimals;

        emit Transfer(address(0), _msgSender(), amount * 10**_decimals);
    }
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevTax) external onlyOwner() {
