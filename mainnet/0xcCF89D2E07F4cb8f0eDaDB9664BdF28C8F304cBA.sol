...
/**
 * @title PricyNFTTradablePrivate
 * PricyNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract PricyNFTTradablePrivate is ERC721A, ERC721AQueryable, Ownable {
    using Strings for uint256;
