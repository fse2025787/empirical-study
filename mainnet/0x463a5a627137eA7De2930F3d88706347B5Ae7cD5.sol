...
// File: contracts/dex_contract.sol
...
contract DexSell is Initializable , ERC20Upgradeable, OwnableUpgradeable,ReentrancyGuardUpgradeable , UUPSUpgradeable{
    ...
    function initialize(address PQLTokenAddress) initializer public {
    ...
    /*===========Events================-*/
    event buy(address from, address reciever, uint amount);
    event tokenRate(uint rate);

    // set the per token price
    function setTokenPerEthPrice(uint _tokenPerEthPrice) public onlyOwner{
