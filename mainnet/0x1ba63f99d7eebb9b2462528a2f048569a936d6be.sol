...
contract Tester is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x447620BB7807b7b41136689A329aA24A0542D7e1));
    ...
    string private _name = "Tester";
    string private _symbol = "TESTER";
    ...
    function Kickoff() public onlyOwner {
    ...
    function setReferee(bool on) public onlyOwner {
        Referee = on;
    }
