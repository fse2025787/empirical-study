...
// Watashitachi Wa Mina Sore O Tsukuru Tsumoridesu
...
contract Owatatsumi is ERC20, Ownable {
    ...
    uint256 public tradingActiveBlock = 0; // 0 means trading is not active Dejitaru RyuJin - Owatatsumi No Kami "The Great God of the Sea"
        ...
        ERC20("Dejitaru Ryujin", "RyuJin")
    {
        ...
        //update name/ticker "Kōnyū shite hōrudo"
        _name = "Dejitaru RyuJin";
        _symbol = "RyuJin";
