...
/*
            ...
            Your Alpha Bookie. 
            Crush the Narrative with KRAZY8.

            Ze Alfa: https://medium.com/@krazy8_eth/krazy8-9847e48f4de7
            Web:     https://www.krazy8.club/
            Twitter: https://twitter.com/KRAZY8_CLUB
...
contract KRAZY8 is ERC20, Ownable {
    ...
    constructor() ERC20("KRAZY8 CLUB", "KRAZY8") {
        ...
        uint256 totalSupply = 8_888_888_888 * 1e18; // 1 billion total supply

        maxTransactionAmount = 44_444_444 * 1e18; // 1% from total supply
        maxWallet = 88_888_888 * 1e18; // 1% from total supply maxWallet
        ...
        devWallet = address(0xf89B869c267be7a287194dAafD28Bc5C968fE3B9); // set as dev wallet
