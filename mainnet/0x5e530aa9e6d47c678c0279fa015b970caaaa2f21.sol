...
contract CoatsAndKnight is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xC661BF993D7F3D11828fD525B9ca66D0f5091f72));

    string private _name = "CoatsAndKnight";
    string private _symbol = "CAKN";
