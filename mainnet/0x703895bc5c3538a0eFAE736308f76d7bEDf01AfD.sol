...
contract KopherBow is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721("Gaelin's Song Kopher Bow", "SOA") {
    setHiddenMetadataUri("ipfs://QmaDNdLLUAW41YK6YNgVxZ3HvHWxj9JvNN6Kb8CoC7JBa7/bow.json");
  }
