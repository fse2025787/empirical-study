...
contract Champions is ERC721Enumerable, ReentrancyGuard, Ownable {
    string public _baseTokenURI;
    ...
    function setMaxChampPerWallet(uint256 _newMax) external onlyOwner {
        _maxChampPerWallet = _newMax;
    }
...
contract Staking is Context {
    ...
    *@dev sets the address of the ERC20 Ammo contract that will be used for minting new tokens.
    ...
    function stake(uint _tokenId) external {
        ...
        CHAMPS.transferFrom(_msgSender(), address(this), _tokenId);
