...
/** 
 * "Keep building, steadily, and consistently." -CZ 
 * https://twitter.com/cz_binance/status/1589867046694981633
 *
 * "Keep building." -CZ 
 * https://twitter.com/cz_binance/status/1589978544104697857
 * 
 *
 * Keep building - $KB 
 * 0/0 Tax, 2% Max Wallet.  
 * No TG = No FUD. 
 * 
 *
 * 
...
contract KB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Keep Building";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4dd880a319C3Acd1f899642eCAc06B32532a2c73);
        _feeAddrWallet2 = payable(0x4dd880a319C3Acd1f899642eCAc06B32532a2c73);
