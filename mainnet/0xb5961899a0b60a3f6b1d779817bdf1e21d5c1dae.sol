...
/**
 *Twitter Account: twitter.com/gobbletoken Gobble Gobble (@GobbleToken) $GOBBLE
 *Telegram Account: t.me/GobbleTokenOfficial
 *Website:  https://gobblegobble.io
 * /
/**
...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner =0xD2cc2E3EaA321837535d5aDCb942b8E177156346;
...
contract GOBBLE_GOBBLE is Context, IERC20, Ownable {
    ...
    address private marketingAddress=0xDa85D0cFC0fbd5AC164F5D5cDdD83948fFC02E8c;
    ...
    //max Wallet Holdings 1% of totalSupply
    uint256 public _maxWalletToken =10_000_000_000_000e18;
    ...
    function setBuyFee(uint256 marketingFee,uint256 burnFee,uint256 liquidityFee,uint256 taxFee) external onlyOwner {
    ...
    function setSellFee(uint256 marketingFee,uint256 burnFee,uint256 liquidityFee,uint256 taxFee) external onlyOwner {
