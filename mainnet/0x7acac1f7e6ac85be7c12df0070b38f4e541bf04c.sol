...
contract FIFA is ERC20, Ownable {
    ...
    constructor() ERC20("Fifa Cult", "FIFA") {
        ...
        marketingWallet = address(0xb16cb9B43E0f31ca5c66891c0c3D38D25D30AE1c);
        devWallet = address(0x3417cc03a91a3F653Ba65Ba2181df8002aF85c54);
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _devFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _devFeeSell) external onlyOwner{
        ...
        require(_fees.sellTotalFees <= 31, "Must keep fees at 15% or less");
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(block.number < taxTill) {
                ...
                tokensForMarketing += (fees * 74) / 99;
                tokensForDev += (fees * 25) / 99;
