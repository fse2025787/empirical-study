...
No tax, no marketing, no dev. Just for fun. Let`s check how big MCap it will achieve.
...
contract QUEEN is Ownable, IERC20 {
    ...
    string private _name = "Queen of the green arrow";
    string private  _symbol = "QUEEN";
