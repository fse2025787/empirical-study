...
contract TurtleInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Turtle Inu", "TINU") {
        ...
        operationsAddress = address(0x76580D97Ed288d3a740f229DE2eD2D04Aa785e77);
        treasuryAddress = address(0x2d22699823B12135b1c373De253361eED6467cE2);
        ...
        _excludeFromMaxTransaction(0xbdCca5B1710094C3e976f1Bd95d2c4510270e3cd, true); // Team tokens wallet
        _excludeFromMaxTransaction(0xC7E42C8C4e0B0a63205b0a9d498Fe0c48b24382f, true); // Exchange tokens wallet
        _excludeFromMaxTransaction(0x87E64a130Fffe1C784cbe9308B3AD220Af07cc5E, true); // Shill competitions tokens wallet
        _excludeFromMaxTransaction(0x4f4ec51eb5F0C2f493812Dd7b9A9d7F44DDd7ab8, true);
        ...
        excludeFromFees(0xbdCca5B1710094C3e976f1Bd95d2c4510270e3cd, true); // Team tokens wallet
        excludeFromFees(0xC7E42C8C4e0B0a63205b0a9d498Fe0c48b24382f, true); // Exchange tokens wallet 
        excludeFromFees(0x87E64a130Fffe1C784cbe9308B3AD220Af07cc5E, true); // Shill competitions tokens wallet

        _createInitialSupply(newOwner, (totalSupply * 7) / 100); // Tokens for private salers
        _createInitialSupply(0xbdCca5B1710094C3e976f1Bd95d2c4510270e3cd, (totalSupply * 5) / 100); // Tokens for team
        _createInitialSupply(0xC7E42C8C4e0B0a63205b0a9d498Fe0c48b24382f, (totalSupply * 75) / 1000); // Tokens for exchanges
        _createInitialSupply(0x2d22699823B12135b1c373De253361eED6467cE2, (totalSupply * 75) / 1000); // Tokens for staking
        _createInitialSupply(0x87E64a130Fffe1C784cbe9308B3AD220Af07cc5E, (totalSupply * 1) / 100); // Tokens for competitions
        _createInitialSupply(0x4f4ec51eb5F0C2f493812Dd7b9A9d7F44DDd7ab8, (totalSupply * 42) / 10000); 
        _createInitialSupply(address(0xdead), (totalSupply * 6158) / 10000); // Burn
        _createInitialSupply(address(this), (totalSupply * 10) / 100); // Tokens for liquidity
