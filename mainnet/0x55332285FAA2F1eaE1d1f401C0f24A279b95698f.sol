...
contract MemeLocker is ERC20, Ownable {
   ...
   constructor() ERC20("Meme Locker Inu", unicode"MLI") {
       ...
       marketingWallet = address(0xA0AA7139b5EF8b92f5fA2123096EBB7840f689Fa); // set as marketing wallet
       devWallet = address(0xA0AA7139b5EF8b92f5fA2123096EBB7840f689Fa); // set as dev wallet
