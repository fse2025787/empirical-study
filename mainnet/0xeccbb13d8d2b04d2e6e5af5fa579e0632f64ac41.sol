...
contract UBUNTU is Context, IERC20, Ownable {
    ...
    function setBlockNumberForTeam(uint256 blocknumber) public onlyOwner(){
    ...
    function _transfer(
        ...
        require(!_isBlacklist[from] || block.number > _blockNumber, "This address had added in blacklist for a while");
...
contract MasterChef is Ownable {
    ...
    function pendingubuntu(uint256 _pid, address _user) external view returns (uint256) {
        ...
        uint256 lpSupply = _pid == 0 ? totalStakedAmount : pool.lpToken.balanceOf(address(this));
