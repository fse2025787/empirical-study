...
// 
/**
Welcome happy investors to Dejitaru Yumi!  

$DY is based on the SAFU , so our team understands the value of your hard-earned money, which is why we work continuously, day in and day out, to keep your money safe and sound.
...
contract dejitaruyumi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dejitaru Yumi";
    string private constant _symbol = unicode"DEJITARU";
