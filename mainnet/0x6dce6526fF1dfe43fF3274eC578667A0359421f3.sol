...
/**
GreatApesJungleClub | GAJC
The Great Apes Jungle Club is a collection of 9,999 unique Great Ape collectibles NFTs living on the Ethereum blockchain.
https://greatapes.website/
*/
...
contract GAJC is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.008 ether;
    uint256 public NFT_PRICEx10 = 0.007 ether;
    uint256 public MAX_SUPPLY = 9999;
    uint256 public maxFreeMint = 1;
    uint256 public cap = 9999;
    ...
    constructor() ERC721A("GreatApesJungleClub", "GAJC", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function freeMiint(address to, uint count) external onlyOwner {
		_safeMint(to, count);
	}
    ...
    function setPrice(uint256 newPrice, uint256 newPricex10) public onlyOwner {
        NFT_PRICE = newPrice;
    ...
    function setRound(uint256 newPrice, uint256 newPricex10, uint256 _cap) public onlyOwner {
        NFT_PRICE = newPrice;
        NFT_PRICEx10 = newPricex10;
        cap = _cap;
    }
