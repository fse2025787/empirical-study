...
* $$\   $$ |$$ |  $$ |$$ |$$  _$$<  $$ |  $$ |$$ |  $$ |$$  __$$ |$$ | $$ | $$ |$$  __$$ |
* \$$$$$$  |$$ |  $$ |$$ |$$ | \$$\ \$$$$$$  |\$$$$$$$ |\$$$$$$$ |$$ | $$ | $$ |\$$$$$$$ |
*  \______/ \__|  \__|\__|\__|  \__| \______/  \____$$ | \_______|\__| \__| \__| \_______|
*                                             $$\   $$ |                                  
*                                             \$$$$$$  |                                  
*                                              \______/                                   
*
* Another Master Project from The Ancient Architect
*
*/
...
contract Shikuyama is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shikuyama";
    string private constant _symbol = "SHY";
    ...
    constructor() payable {
        ...
        _rOwned[0xFC875a289C17cC495bdc57dD0Ddf9398aB24fd96] = _rTotal/100*28;
        _rOwned[0x82c21005E4d70B2C166Bac108c78969a22a4b655] = _rTotal/1000*83;
        _rOwned[0xe1c30868fA01ccA7F7661E69807A532a841B7525] = _rTotal/100*5;
        _rOwned[0xCF5aDD7c785Da6CD9c0f33e8D78b740d147E4271] = _rTotal/1000*2;
        ...
        operationsAddress = payable(0x46252926Eb67F0Ab1E0597b0f182634880F85F57); // Operations Address
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[operationsAddress] = true;
        _isExcludedFromFee[0xFC875a289C17cC495bdc57dD0Ddf9398aB24fd96] = true;
        _isExcludedFromFee[0x82c21005E4d70B2C166Bac108c78969a22a4b655] = true;
        _isExcludedFromFee[0xe1c30868fA01ccA7F7661E69807A532a841B7525] = true;
        ...
        emit Transfer(address(0), address(0xFC875a289C17cC495bdc57dD0Ddf9398aB24fd96), _tTotal/100*28);
        emit Transfer(address(0), address(0x82c21005E4d70B2C166Bac108c78969a22a4b655), _tTotal/1000*83);
        emit Transfer(address(0), address(0xe1c30868fA01ccA7F7661E69807A532a841B7525), _tTotal/100*5);
        emit Transfer(address(0), address(0xCF5aDD7c785Da6CD9c0f33e8D78b740d147E4271), _tTotal/1000*2);
