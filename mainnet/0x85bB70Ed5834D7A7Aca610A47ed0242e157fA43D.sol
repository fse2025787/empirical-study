...
contract LendingStorage is AccessControl, ReentrancyGuard, Pausable {
  ...
  address public _commissionWallet;
  address public _verifier;
  address public _currencyToken;
  uint32 public _commissionPercent;

  mapping(uint256 => Counters.Counter) public _orderIds;
  mapping(uint256 => mapping(uint256 => OrderERC4907)) public orders;
  mapping(string => bool) public _orderUUids;
  address[] public _contractAddresses;
  uint32 public _percentDecimals;
  uint32 public _maxWaitingTime; // minutes
