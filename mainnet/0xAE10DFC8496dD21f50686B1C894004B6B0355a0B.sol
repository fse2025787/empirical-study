...
contract TheYoYos is ERC721A, Ownable {
    using Strings for uint256;

    uint16 public immutable MAX_SUPPLY = 777;
    uint16 public immutable MAX_PER_TX = 5;
    uint256 public PRICE = 0.0025 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmYnz4XTYUB4V64Eqf6e7tZSZK3sCUnrknLKz1iyYDd2Yg/";
