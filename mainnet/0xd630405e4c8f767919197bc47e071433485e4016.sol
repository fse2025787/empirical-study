...
contract DeltaWalkers is Ownable, ERC721A {
    ...
    string public baseURI = "ipfs://bafybeicucuqawwqlm5xvekkxlkm5w72ycxxr5gyfoqs6vqt4zlcvnra64e";
    string public _extension = ".json";
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 42690;

    constructor() ERC721A("Delta Walkers", "DWalkers"){}
    
    function mintNFT(uint256 _quantity) public payable {
        require(_quantity > 0 && _quantity <= adoptionLimit, "Wallet full 10 max per wallet");
