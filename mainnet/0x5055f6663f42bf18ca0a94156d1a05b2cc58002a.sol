...
/*
https://t.me/BrieERCPortal
https://www.brietoken.xyz
*/
...
contract BRIE is Context, IERC20, Ownable {
    ...
    string private constant _name = "BRIE";
    string private constant _symbol = "BRIE";
    ...
    constructor () payable {
        _feeAddrWallet1 = payable(0x9681F97436F1fD2C9EA73474446e58077ADeBB22);
        _feeAddrWallet2 = payable(0x9681F97436F1fD2C9EA73474446e58077ADeBB22);
