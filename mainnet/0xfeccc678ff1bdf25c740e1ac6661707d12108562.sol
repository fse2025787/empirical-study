...
/**
Buy and Hold, get FPUNK NFT rewards.
*/
...
contract PUNKCLASSIC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Punk Classic", "FPUNK") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xe48e669150B649efa44d8cC3b2B1Ef08ed965d4b); // marketing wallet
        devWallet = address(0xe48e669150B649efa44d8cC3b2B1Ef08ed965d4b); // dev wallet
