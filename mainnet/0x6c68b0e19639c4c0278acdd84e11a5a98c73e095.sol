...
🛢OIL PRINCE🛢
Oil Prince is a meme coin to capitalize on the fun 
and organic growth that are common in this space. 
We are a utility that solves the problems newcomers and OG’s face frequently. 
We are a community that is regarded as the best and others try to emulate. 
Best of all, we are just getting started.

Enjoy this play 🌕

🌎Website: https://oilprince.xyz/
🛎Telegram: https://t.me/OilPrinceToken
...
contract OilPrince is Context, IERC20, Ownable {
    ...
    string private constant _name = "OilPrince";
    string private constant _symbol = "OilPrince";
    ...
    constructor () {
        _feeAddrWallet = payable(0xb09D45065332367a9E5244df73BaeECa7B5a5adF);
