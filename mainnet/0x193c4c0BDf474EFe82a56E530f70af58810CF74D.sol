...
** Using FTP LPAdd to recycle 6.00% of ALL transactions back into the liquidity pool. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xf47269dc118E0b6eB6c8DA32f20dabCbB57A7fE0), 5000);
        m_DidDeploy = true;
    }
...
contract WINORWATCH is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "WIN OR WATCH";
    string private m_Symbol = "WOW";
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 6000;
    // MISC
