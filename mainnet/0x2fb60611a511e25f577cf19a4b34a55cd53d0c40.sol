...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x772afa0c0A1dfa6249eb5aa2bb11ed3818e5C053];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 6660 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbnV41CZXEb6RUG615BHA9t6wCffYhtE8h6qb4ziEA88g/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6660");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6660");
...
// File: contracts/OninousContract.sol
//

pragma solidity ^0.8.0;

contract OninousContract is RamppERC721A {
    constructor() RamppERC721A("Oninous", "ONI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/FWXXucnCeyrz9SgGSVQK/contract-metadata";
    }
}
