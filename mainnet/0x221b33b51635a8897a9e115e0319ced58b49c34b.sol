...
The Okane Token is a blockchain-based system for tracking media consumers' time 
and attention on websites using the Okane web browser.

Built on Ethereum Network , its goal is to efficiently distribute 
advertising money between advertisers, publishers, and 
readers of online marketing content and ads.

$OK has auto burning mechanism and autoliquidty 
feature in every trading transactions.

Telegram: https://t.me/OKANE_ERC20
Twitter: https://twitter.com/OKERC20
...
contract OKANE is Context, IERC20, Ownable {
    ...
    string private constant _name = "OKANE";
    string private constant _symbol = "OK";
    ...
    uint256 private maxWalletAmount = 200000000 * 10**9;
    uint256 private maxTxAmount = 200000000 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xf5c887E93E81E9F99Ad0daF9D205D7Fbbbb7CE00);    
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        maxWalletAmount = 200000000 * 10**9;
        maxTxAmount = 200000000 * 10**9;
        tradingOpen = true;
