...
contract HasukiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hasuki Inu";
    string private constant _symbol = "Hasuki";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xB120b36Fb2894a66F549Fd85B21cd1E541f9a061);
    address payable private _marketingAddress = payable(0xe2c6045ba96FE50beA28701E70FC764343303a78);
    ...
    constructor () {
        ...
        emit Transfer(address(0xe2c6045ba96FE50beA28701E70FC764343303a78), _msgSender(), _tTotal);
    }
