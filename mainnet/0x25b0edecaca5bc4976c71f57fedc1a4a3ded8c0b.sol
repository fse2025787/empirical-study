...
//  /$$  \ $$| $$ | $$ | $$ /$$__  $$| $$ | $$ | $$| $$  | $$| $$    $$| $$      | $$  | $$| $$       /$$  \ $$
// |  $$$$$$/|  $$$$$/$$$$/|  $$$$$$$| $$ | $$ | $$| $$$$$$$/|  $$$$$$/| $$      |  $$$$$$/|  $$$$$$$|  $$$$$$/
//  \______/  \_____/\___/  \_______/|__/ |__/ |__/| $$____/  \______/ |__/       \______/  \_______/ \______/ 
//                                                 | $$                                                        
//                                                 | $$                                                        
//                                                 |__/                                                        
//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8EAf0176861b07B79D91BBa4F2dDe886fd06A35a];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmTv49EoANcww4HKfUTUA2FZ22QFGT4wj5kzBPVJJqZH9x/";
...
// File: contracts/SwampCrocSContract.sol
//

pragma solidity ^0.8.0;

contract SwampCrocSContract is RamppERC721A {
    constructor() RamppERC721A("SwampCrocS", "CROC1"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/eMF6B9BnuTYpX7B7ZtV3/contract-metadata";
    }
}
