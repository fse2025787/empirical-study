...
// File: contracts/Geass.sol



/**
 *
 * If one wishes to know what others are going to do, one can penetrate into their minds and predict their behavior. 
 * if one wishes to be loved by others, one can penetrate into their minds and make them give love to oneself.
 * 
...
contract Geass is IERC20, ReentrancyGuard, Ownable {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;
    string private _name = "Geass";
    string private _symbol = "Geass";
