...
contract MunySwap {
    ...
    function swapTokens(uint256 amount, uint256 direction) public {
        ...
        if (direction == 0) {
            ...
            // divide by 10 ** 2 cause token B has 6 decimals and token A 8
            outputAmount = amount.mul(swapRate).div(100).div(100);
            ...
            // multiply by 10 ** 2 cause token B has 6 decimals and token A 8
            outputAmount = amount.mul(100).mul(100).div(swapRate);
