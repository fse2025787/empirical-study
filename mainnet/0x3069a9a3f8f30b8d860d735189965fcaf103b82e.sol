...
contract Materia is Ownable, ERC721A {
  ...
  constructor() ERC721A("MATERIA", "MTR")  {
    setHiddenMetadataUri("ipfs://QmYrLpGQ84BwdyZyKWy6DD2LgEdSt915T8vByMuKBSVmGt/hidden.json");
  }
