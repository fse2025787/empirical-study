...
M. americanum, sometimes called the "giant ground sloth", or the megathere

__Tokenomics__
Supply = 1 billion;
Decimal = 9;
Name = GiantGroundSloth
Symbol = Megatherium
...
contract GiantGroundSloth is Context, IERC20, Ownable {
    ...
    string private _name = "GiantGroundSloth";
    string private _symbol = "MEGATHERIUM";
    ...
    address public marketingTokenFeeWallet = 0x4e82C43AffAC2FA76AFa13B2D6E4027d9cDDa297;
    address public marketingETHFeeWallet = 0x4e82C43AffAC2FA76AFa13B2D6E4027d9cDDa297;
    ...
    uint256 public _maxTxAmount = 3 * 10**7 * 10**9;//3% maxTxAmount
    uint256 public _maxWallet = 6 * 10**7 * 10**9;//6% maxWallet
