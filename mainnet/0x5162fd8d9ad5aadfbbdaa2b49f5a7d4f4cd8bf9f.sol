...
/**
CAW will never be defeated - We will gather liquidity from the taxes of this token and take CAW back to where it belongs.
*/
...
contract CawRescue is ERC20, Ownable {
    ...
    constructor() ERC20("Caw Rescue", "CawR") {
