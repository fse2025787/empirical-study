...
contract BabyNeuralink is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Neuralink";
    string private _symbol = "BNEURALINK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD843696A73F751479715b3bD3028a45F892098B1);
    address payable public teamWalletAddress = payable(0xD843696A73F751479715b3bD3028a45F892098B1);
