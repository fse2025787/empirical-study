...
contract pablToken is TimeLockToken, FreezableToken, PausableToken, BurnableToken {
    string public constant name = "pabltoken";
    string public constant symbol = "PBLS";
    uint public constant decimals = 18;

    uint public constant INITIAL_SUPPLY = 2000000000 * (10 ** decimals);
