...
contract HattoriHanzo is IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal {
        ...
        if ((from == uniswapV2Pair && !_isExcludedFromMaxTransactionLimit[to]) || (to == uniswapV2Pair && !_isExcludedFromMaxTransactionLimit[from])) {
