...
contract ElvenTown is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint _mintAmount) {
    ...
    require(_mintAmount + balanceOf(_msgSender()) <= MAXPerWallet, 'Only ten allowed per wallet!');
