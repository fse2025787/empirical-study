...
contract NUWA is Context, IERC20, Ownable {
    ...
    string private constant _name = "NUWA";
    string private constant _symbol = "NUGUA";
    ...
    uint256 private _maxTxAmount = _tTotal.mul(7).div(1000);
    uint256 private _maxWalletSize = _tTotal.mul(14).div(1000);
