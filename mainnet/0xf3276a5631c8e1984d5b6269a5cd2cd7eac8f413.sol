...
contract CatTrap is Context, IERC20, Ownable {
    ...
    string private _name = "CatTrap";
    string private _symbol = "CTRAP";
    uint8 private _decimals = 9;
     
    uint256 private _taxFee = 0;    // Reflections tax
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _liquidityFee;  // never used, leave it as is, not chnage anything
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 private _developmentFee = 700;     // 1200 = 12%  | marketing/development/team tax | this gets collected in the mnarkeing wallet
    uint256 public _totalTax = (_taxFee * 100) + _developmentFee;
    
        mapping (address => bool) private _isBlacklisted;
     
    /*@dev here i implement the blacklisting functions*/
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**9;  // max transaction is equal to total supply by default, can be changed after launch
    ...
    constructor () {
        ...
        degenSwapRouter = IDEGENSwapRouter(0x4bf3E2287D4CeD7796bFaB364C0401DFcE4a4f7F); //DegenSwap Router ETH mainnet
        ...
        IDEGENSwapPair(degenSwapPair).updateTotalFee(700);
        ...
        marketingAddress = address(0xaaA9F200823A2e25690C02A712Ca57ce2CCd975E);  // add your marketing wallet address here | its contract deployer by default
    ...
    function setmarketingAddress(address walletAddress) public onlyOwner {
        marketingAddress = walletAddress;
    }
    ...
    function claimERCtoknes(IERC20 tokenAddress) external {
        tokenAddress.transfer(marketingAddress, tokenAddress.balanceOf(address(this)));
    }
    ...
    function setFees(uint256 _tax, uint256 _developmentTax) public onlyOwner {   
        ...
        require(_developmentFee >= 100, "Development tax cant be lower than 1%");
