...
contract VaultMigratable_1INCH2SUSHI is Vault {
  ...
  address public constant wbtcStrategySushi = address(0x0);
  address public constant daiStrategySushi = address(0x0);
  address public constant usdtStrategySushi = address(0x0);
  address public constant usdcStrategySushi = address(0x0);
  ...
  mapping (address => address) public targetStrategy;
  ...
  */
  function migrateUnderlying(
    ...
    targetStrategy[wbtcVaultOneInch] = wbtcStrategySushi;
    targetStrategy[daiVaultOneInch] = daiStrategySushi;
    targetStrategy[usdtVaultOneInch] = usdtStrategySushi;
    targetStrategy[usdcVaultOneInch] = usdcStrategySushi;
...
//  TODO: uncomment once real strategies are set
//    require(IStrategy(targetStrategy[address(this)]).vault() == address(this), "vault mismatch");
//    require(IStrategy(targetStrategy[address(this)]).underlying() == underlying(), "underlying mismatch");

    _setStrategy(targetStrategy[address(this)]);
    require(strategy() == targetStrategy[targetStrategy[address(this)]], "strategy switch failed");
  }
