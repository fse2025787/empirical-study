...
THE space dog was launched to commemorate the first space dog, LAIKA, hoping that LAIKA can guide us in the direction of space in the cryptocurrency universe
we'll lock and renounce,send him to space

https://t.me/THESpaceDoge_ETH
https://twitter.com/THESD_Doge
...
contract THESpaceDoge is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"THE Space Doge";
    string private constant _symbol = unicode"THESD";
