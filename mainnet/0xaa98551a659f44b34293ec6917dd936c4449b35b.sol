...
contract NFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  * 
  */
  function publicAdopt(uint256 count)
  public
  payable
  nonReentrant{
  ...
  */
  function adminMint(address[] calldata recipients)
  public
  payable
  nonReentrant{
  ...
  * @dev Mint `count` tokens if requirements are satisfied.
  */
  function freeAdopt(uint256 count) 
  public 
  payable 
  nonReentrant{
    require(owner() == msg.sender || _isPublicMintEnabled, "Mint disabled");
  ...
  */
  ...
  function _baseURI() override internal pure returns (string memory) {
    return "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/token/cool-petz/";
  }
  function contractURI() public pure returns (string memory) {
    return "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/contract/cool-petz";
  }
}