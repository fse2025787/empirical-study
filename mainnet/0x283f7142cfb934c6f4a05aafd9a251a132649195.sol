...
contract theelonsink is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 50000 / 1000000;
    uint256 public _walletMax = _totalSupply * 50000 / 1000000;
    ...
    string constant _name = "THE Elon Sink";
    string constant _symbol = "$SINK";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x13528C1beA282e35F46ea868C10fA2041ce131ad;
        marketingWallet = 0x0154740c222355AfB716D3DF37a80B5012Ef0d09;
        devWallet = 0x13528C1beA282e35F46ea868C10fA2041ce131ad;
