...
// File: contracts/Loki.sol

pragma solidity ^0.8.7;

contract Loki is Ownable, ERC721, NonblockingReceiver {
    //uint256 public cost = 0.01 ether;
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 500;
    uint256 MAX_MINT_Amount = 1000;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens < 3, "Loki: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_Amount,
            "Loki: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "Loki: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "Loki: Failed to withdraw");
    }
