...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
    ...
    // File: contracts/mascotSocialClubCollectionContract.sol

    //

    pragma solidity ^0.8.0;

    contract MascotSocialClubCollectionContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Mascot Social Club Collection", "MSC", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "https://gateway.pinata.cloud/ipfs/QmYqa9MJFdKZ1udsc4gGhZmpdyzUDbbnEkWyZRYumihuVi/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/jLKjZbshC9uBYTtXsALC/contract-metadata";
        }
    }