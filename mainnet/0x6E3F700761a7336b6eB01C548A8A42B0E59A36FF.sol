...
$SOL and FTX are collapsing, while INUs and decentralization will live forever. $SOLINU is a low tax community token, with it's own SWAP.

https://t.me/solinu_eth
https://twitter.com/solinu_eth
...
contract SOLINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SOLANA Inu";
    string private constant _symbol = unicode"SOLINU";
