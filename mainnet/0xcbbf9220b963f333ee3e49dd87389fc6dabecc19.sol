...
contract NinjaApes is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 260;
    string public baseURI = "ipfs://";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("NinjaApes", "NA", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function TeamMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
