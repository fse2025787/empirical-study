...
//*********************************************************************//
//
//  _____   ___   __ __  ____   ___      ___  ____       _____  ____     ___  ____    _____    
// |     | /   \ |  |  ||    \ |   \    /  _]|    \     |     ||    \   /  _]|    \  / ___/    
// |   __||     ||  |  ||  _  ||    \  /  [_ |  D  )    |   __||  D  ) /  [_ |  _  |(   \_     
// |  |_  |  O  ||  |  ||  |  ||  D  ||    _]|    /     |  |_  |    / |    _]|  |  | \__  |    
// |   _] |     ||  :  ||  |  ||     ||   [_ |    \     |   _] |    \ |   [_ |  |  | /  \ |    
// |  |   |     ||     ||  |  ||     ||     ||  .  \    |  |   |  .  \|     ||  |  | \    |    
// |__|    \___/  \__,_||__|__||_____||_____||__|\_|    |__|   |__|\_||_____||__|__|  \___|    
//                                                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xbF8eF2FB6eE452C078Cf23a5fb7108656BdfACCB];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 250) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://placeholder/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 250");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 250");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 250");
...
// File: contracts/FounderfrensContract.sol
//

pragma solidity ^0.8.0;

contract FounderfrensContract is RamppERC721A {
    constructor() RamppERC721A("FOUNDER FRENS", "OGFREN"){}
}