 ...
 * allowances. See {IERC20-approve}.
 */
contract Tanami is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Tanami Token";
    string private _symbol = "TANAMI";
    uint8 private _decimals = 9;
    uint256 private _supply = 8000000;
    uint256 public taxForLiquidity = 2;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 80000 * 10**_decimals;
    uint256 public maxWalletAmount = 80000 * 10**_decimals;
    address public marketingWallet = 0x09928c693C4148f57cA2595bD657a85c26b344CF;
    // TOKENOMICS END ============================================================>
