...
contract crazypenguins is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;


    uint256 public constant NFT_PRICE = 0.025 ether; // 0.025 ETH
    ...
    constructor() ERC721("CrazyPenguinsClub","crazypenguins"){
        _safeMint( 0xab3D5C2C6F8E7D3802Aa370DE6EFF358BE562E03, 0);
        _safeMint( 0xab3D5C2C6F8E7D3802Aa370DE6EFF358BE562E03, 1);
        _safeMint( 0xab3D5C2C6F8E7D3802Aa370DE6EFF358BE562E03, 2);
        _safeMint( 0xab3D5C2C6F8E7D3802Aa370DE6EFF358BE562E03, 3);
        _safeMint( 0xab3D5C2C6F8E7D3802Aa370DE6EFF358BE562E03, 4);
    }

    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved Penguin supply" );
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(0xab3D5C2C6F8E7D3802Aa370DE6EFF358BE562E03).send(_each));
    }
    ...
    function mint(uint numberOfTokensMax20) public payable {
        require(saleIsActive, "Sale is not active at the moment");
        require(numberOfTokensMax20 > 0, "Number of tokens can not be less than or equal to 0");
        require(totalSupply().add(numberOfTokensMax20) <= MAX_SUPPLY, "Purchase would exceed max supply");
        require(numberOfTokensMax20 <= MAX_NFT_PURCHASE,"Can only mint up to 10 per purchase");
        require(NFT_PRICE.mul(numberOfTokensMax20) == msg.value, "Sent ether value is incorrect");

        for (uint i = 0; i < numberOfTokensMax20; i++) {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory base = "https://crazypenguinsofficial.com/metadata/";
