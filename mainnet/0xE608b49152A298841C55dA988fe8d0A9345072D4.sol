...
contract PAJEETETH is Context, IERC20, Ownable {
    ...
    string private _name = "PAJEET ETH";
    string private _symbol = "$PAJEET";
    ...
    address payable public marketingaddress = payable(0xc3352B4BB8831D03Ec8b30fFC22EE2A993Fdf31d);
