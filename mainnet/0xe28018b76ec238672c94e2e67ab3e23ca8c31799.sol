...
contract NGMI is Context, IERC20, Ownable {
  ...
  event SwapAndLiquify(
	...
	constructor () {
		 _bmWallet = payable(0xc0d03b908e0Ae3eF8f572634C30d2C9a35b794BA);

		_taxFee = _buyTaxMarketing + _autoLpFee;
		_uniswap = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

		_isExcludedFromFee[address(this)] = true;
    	_maxTxAmount = _tTotal.mul(20).div(10**2);
	  	_maxWallet = _tTotal.mul(40).div(10**2);
