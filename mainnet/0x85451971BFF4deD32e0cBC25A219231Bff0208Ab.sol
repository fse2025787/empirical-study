...
The CEX, platforms and funds ruined the crypto space in 2022. They got the deposited funds from people and ran away. It is time to get things right. It is time to tell everyone to hold their coins in their own wallets, not those untrustful custodian.

"Asgard is not a place, it's a people"

This project is gathering a community with crypto enthusiasts. We spread the knowledge of protecting our funds from vulnerabilites and risks.
...
Here we got THOREUM for the believers.
...
Tax 5%
 ...
 https://twitter.com/thoreumerc 
 https://t.me/thoreumerc 
...
contract thoreumerc is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Thoreum";
    string private constant _symbol = unicode"THOREUM";
