...
// File: contracts/UnderCoversNft.sol
...
/*
UnderCovers NFT.sol
Total Supply = 6969 tokens, 
Free Mint = first 2000, 1 NFT per wallet 
Public Mint = remining 4969, 5 NFT per wallet 
CONTRACT SPECIAL
1.owner cannot edit mint limit per wallet in contract
2.75 % of fund directly goes to community wallet onces contract owner withdrawls the funds 
*/

contract UnderCoversNFT is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmXyvUotS1K8LJkiZxCsZ7ffcMJEbfvHwGG2BaPbx6s7g1";
    
    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmXyvUotS1K8LJkiZxCsZ7ffcMJEbfvHwGG2BaPbx6s7g1";
    ...
    constructor() ERC721A("UnderCoversNFT", "UCS") { }
    ...
    */
    ...
    function teamMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= 2000, "Team mints after free");
