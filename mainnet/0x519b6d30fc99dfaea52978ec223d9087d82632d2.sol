...
$DDC - Duel Desert Cup - token for finish of the World Cup

Elon tweeted a hint.
Search for a duel desert...

https://twitter.com/dueldesert
https://t.me/dueldesert
...
contract dueldesertcup is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DuelDesertCup";
    string private constant _symbol = unicode"DDC";
