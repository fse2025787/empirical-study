...
Once upon a time, in the small kingdom of Takayama, a yokai snake slithered towards a young princess, brave dog Takahiro came to the rescue, snatching the yokai and saving the princess' life. 
In the process, Takahiro was bitten himself; the seven-year-old hero was willing to risk his life to protect the princess that will soon become the queen and rule the kingdom. 
The name Takahiro is primarily a male name of Japanese origin that means Valuable, Noble, Filial Piety.


 Tokenomics:
  - ETH Pair
  - Tax 3/3% for Manual Buybacks and Marketing
  - Max Buy 2% at launch , removing the limits after

  Socials:
  - TG: https://t.me/TakahiroInuPortal
  - Medium: https://medium.com/@TakahiroERC
  - Twitter: https://twitter.com/TakahiroInuERC
...
contract Takahiro is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Takahiro Inu", unicode"犬贵宏") {
