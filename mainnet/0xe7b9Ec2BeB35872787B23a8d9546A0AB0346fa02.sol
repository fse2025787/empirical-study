...
contract BuddysAIM is ERC721Delegated, ReentrancyGuard {
    ...
    )
  {
    ...
    allowedMintCountMap[msg.sender] = 20;
  }
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 30;
  ...
  uint256 public constant MAX_SUPPLY = 2075;
