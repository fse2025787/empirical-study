...
contract Cockertoshi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cockertoshi", "COCKER") {
        ...
        uint256 totalSupply = 2000000000000000 * 1e18;
        ...
        marketingWallet = address(0x38C5FeC7d87BBBa45eE2ECe02F4FFDdC81e24CE1); // set as marketing wallet
