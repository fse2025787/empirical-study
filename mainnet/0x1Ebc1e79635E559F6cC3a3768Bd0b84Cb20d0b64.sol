...
// ~ Telegram: ShibaGirlETH ~

// ~ Twitter: ShibaGirlETH ~

// ~ Website: www.shibagirleth.com ~

// ~ In a world full of disparities between men and women, we need ShibaGirl to overcome her brother Shiba ~
...
contract ShibaGirl is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xf42873f350fB36859911aBe58962FC5fE076a7E0);
    ...
    string private _name = "ShibaGirl";
    string private _symbol = "$SHIBGIRL";
