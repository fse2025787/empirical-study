...
contract MakeItReindeer is Context, IERC20, Ownable {
    ...
    string private constant _name = "MakeItReindeer"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x1f8b889ff881Cd7C18F308a4f73b9361f7512285).transfer(ethToSend); //marketing wallet
    }
