...
contract NeoTokyo is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.001 ether;
    uint256 public MAX_SUPPLY = 8888;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "https://neotokyo.sfo3.cdn.digitaloceanspaces.com/citizen_token_uri/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("NeoTokyo Citizens S2", "CITIZEN", MAX_MINTS, MAX_SUPPLY) {  
    }
