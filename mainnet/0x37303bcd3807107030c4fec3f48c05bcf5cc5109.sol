...
contract MeepFeed  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmPCLbrfKg5ovFXLyfQK5YWBs8vr21i2UariTwuwU8tLU9/";
    ...
    function KillMeep(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
