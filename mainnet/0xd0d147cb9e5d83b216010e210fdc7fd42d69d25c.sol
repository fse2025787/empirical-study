...
contract SonofPoseidon is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //UNISWAP
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Son of Poseidon";
    string constant _symbol = "PERSEUS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 111_111_111_111 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0xee503f5b5B33b8C7C5afe66FAE9e06E5fd48a6a8;
