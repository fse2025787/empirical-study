...
// TG: https://t.me/Moonfeg  , SLIPPAGE 9%
...
contract MOONFEG is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x25b90a439F222106763a596d970193Ef3363F1D2); 
    address payable public rewardsWallet = payable(0x25b90a439F222106763a596d970193Ef3363F1D2); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "MOONFEG";
    string private _symbol = "$MFEG";
    uint8 private _decimals = 9;

    uint256 public _autoliquidity = 1;
    uint256 public _marketing = 4;
    uint256 public _developer = 3;     
