...
contract MerkleTreeWithHistory {
    ...
    uint256 public constant ZERO_VALUE = 21663839004416932945382355908790599225266501822907911457504978515578255421292; // = keccak256("tornadov2") % FIELD_SIZE
...
abstract contract TornadoV2 is MerkleTreeWithHistory, ReentrancyGuard {
...
contract ETHTornadoV2 is TornadoV2 {
    constructor(
        IVerifier _verifier,
        IHasher _hasher,
        uint256 _denomination,
        uint32 _merkleTreeHeight
    ) TornadoV2(_verifier, _hasher, _denomination, _merkleTreeHeight) {}
