...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1BDCbD1f9cCC602B97c96fE735b2b21E13994C8C];
  address public erc20Payable = 0x1BDCbD1f9cCC602B97c96fE735b2b21E13994C8C;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/DvN9LVwYEVkMurAuIXC9/contract-metadata";
  }
...
// File: contracts/PoddyContract.sol
//

pragma solidity ^0.8.0;

contract PoddyContract is RamppERC721A {
    constructor() RamppERC721A("PODDY", "Poddy"){}
}
