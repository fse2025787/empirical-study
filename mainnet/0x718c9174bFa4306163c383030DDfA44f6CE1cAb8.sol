...
// hevm: flattened sources of src/ERC1155/VaultFactory.sol
// 
...
contract Vault is ERC721Holder, ERC1155Holder {
  ...
  function start() external payable {
    require(auctionState == State.inactive, "");
  ...
  function bid() external payable {
    require(auctionState == State.live, "");
    require(msg.value * 100 >= livePrice * 105, "");
  ...
  function withdrawETH() external {
    require(auctionState == State.redeemed, "");
    require(msg.sender == winning, "");
