...
contract BabyCreepy is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Creepy Dough";
    string private constant _symbol = unicode"Baby Creepy";
