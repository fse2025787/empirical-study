...
contract GlitchWorld is ERC721A {
    ...
    constructor() ERC721A("Glitch World", "GlitchGlitch") {
        owner = msg.sender;
        royalty = 69;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmVTKiUoZKCVa87siYtw9zmYkXi8gRt74aRPFHuqeEGhbS/", _toString(tokenId), ".json"));
    }

    function setRoralty(uint256 r) public onlyOwner {
        maxSupply = r;
    }
