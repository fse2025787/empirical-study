...
Telegram: https://t.me/fexirinu


Fexir Inu - $FEXIR

Fexir Inu ($FEXIR) is a community token made in the honor of the Meme God, Fexir!

One true meme to rule them all!
We follow the great leader, and we ape what Fexir apes!

Tax of 1/1% used completely for buybacks.


Twitter: https://twitter.com/fexirinu
Website: https://fexirinu.com/
...
contract FexirInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fexir Inu";
    string private constant _symbol = "FEXIR";
    ...
    constructor () {
        _feeAddrWallet = payable(0x355b767cbf80c219333C479A21BB663f9f91411e);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                //anti-frontrunning bot
                if(block.number <= _holderLastTransferTimestamp[tx.origin] + 1) {
                    _taxes.sellFee2 = 20;
                }
                ...
                if (_taxes.buyFee2 == 30 || _taxes.sellFee2 == 30) {
                    _taxes.buyFee2 = 1;
                    _taxes.sellFee2 = 1;
    ...
    function adjustFees(uint256 buyFee1, uint256 buyFee2, uint256 sellFee1, uint256 sellFee2) external onlyOwner {
        require(buyFee1 + buyFee2 <= 10);
        require(sellFee1 + sellFee2 <= 10);
