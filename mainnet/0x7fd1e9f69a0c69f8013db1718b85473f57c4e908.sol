...
contract SHAKE  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmNrecBqVPMo5HY4jkxFv6VQroeoh3g7NmLZEDWtUHZSPY/";
    uint   public price             = 0.003 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 4000;
    uint   public maxSupply         = 4000;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("SHAKESHAKE", "SK"){}
