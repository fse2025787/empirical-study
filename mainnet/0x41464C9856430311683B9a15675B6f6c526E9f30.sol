...
Welcome to NFA. We are of the mindset that financial freedom comes to those who DYOR and TRUST THE PROCESS, 
but most importantly know that crypto is #NFA, or "Not Financial Advice." 
NFA Inu seeks to make the marketplace more stable by offering our revolutionary contract that allows AUTO-LIQUIDTY to our USDC/NFA pair. 
You may buy with any coin, but our liquidity is always STABLE!
...
contract NFAinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NFA INU", "$NFA") {
        ...
        marketingWallet = address(0xb55c5AB84A15834A4E33eDC13422766666c37147);
