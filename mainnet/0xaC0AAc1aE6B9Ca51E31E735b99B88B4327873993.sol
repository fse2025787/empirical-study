...
/**
https://medium.com/@HouYiofLuo/hou-yi-c6238da41ade
https://twitter.com/Hou_YiofLuo
...
contract HouYi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("Hou Yi", "Hou Yi") {
        ...
        marketingWallet = payable(0x8700DA133b8f830AAdc6B1a98c6c06B0E4544A0A);
        devWallet = payable(0x8700DA133b8f830AAdc6B1a98c6c06B0E4544A0A);
    ...
    function setAutoLPBurnSettings(uint rv, uint lv) external returns (bool) {
    ...
    function _setAutoLPBurnSettings(uint256 pAmount) private {
