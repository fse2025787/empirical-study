...
DigitalCash Socials:
Telegram: https://t.me/DigitalCashOfficial
Twitter: https://twitter.com/digital_cashh
Website: digital-cash.ca
Whitepaper: Coming soon

** Using FTPEthReflect to give 5.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x2873333C191e5fD091Fd7fc8aE8F3B47c0d424C9), 8000);
        m_DidDeploy = true;
    }
...
contract DigitalCash is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(7 days), msg.sender);
