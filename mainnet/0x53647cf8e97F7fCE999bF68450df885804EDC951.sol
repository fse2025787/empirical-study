...
contract WenOneMillion is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Wen 1 million";
    string private constant _symbol = "WEN 1 MILL";
    ...
    address payable private _devAddress1 = payable(0xB513818bA06C19c2AA2DF5A8C88b287057F06C14);
    address payable private _devAddress2 = payable(0xB513818bA06C19c2AA2DF5A8C88b287057F06C14);
