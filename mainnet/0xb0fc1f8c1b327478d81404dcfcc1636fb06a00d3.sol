...
/**
Welcome to the world of gods
Yori: the brave and humble
join us at The final battle
Tg : https://t.me/YoriERC
website: https://yoritoken.com/
...
contract Yori is ERC20, Ownable {
    ...
    constructor() ERC20("Yori", "$YORI") payable {
        ...
        uint256 totalSupply = 10 * 1e5 * 1e18;
        
        maxTxnAmount = totalSupply * 5 / 100; // 2% of supply
    	...
    	marketingWallet = address(0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA); // set as Marketing wallet
        devWallet = address(0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA, true);
        excludeFromFees(0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA, true);
        excludeFromMaxTransaction(0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x3ed5DFF392f481b38EdD7EED8fB7c8B7121C8eeA,
            block.timestamp
        );
    }
