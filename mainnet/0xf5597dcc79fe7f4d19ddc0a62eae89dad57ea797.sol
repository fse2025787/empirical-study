...
// Skyship - New Ethereum Gem!
// SkyShip is a community driven, fair launch token which is made to make everone's dream come true with 100x you've been waiting for. To make sure everyone will be a part of this dream, we are making this a fair launch with Anti-Bot measures. Holders will be rewarded and Sellers will be punished with each sell transaction.

// 🟢 Contract verified
// 🟢 Liquidity Locked (on Unicrypt for 6months)
// 🟢 Ownership Renounced On Launch 

// ✅ Telegram - https://t.me/theskyship
// ✅ Twitter - https://twitter.com/theskyship
// ✅ Website - https://theskyship.com
...
contract $SkyShip is Context, IERC20, Ownable {
    ...
    string private _name = 'SkyShip';
    string private _symbol = '$SkyShip';
