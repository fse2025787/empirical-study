...
contract Karito is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Karito";
    string private constant _symbol = "Karito";
    ...
    address payable private _developmentAddress = payable(0x380c12A9A4a7d50B693A399AAF5dBC44742bCa10);
    address payable private _marketingAddress = payable(0x380c12A9A4a7d50B693A399AAF5dBC44742bCa10);
