...
// File: Mutated Donuts/Mutated Donuts.sol

/**
 *Submitted for verification at Etherscan.io on 2022-09-9
*/
...
contract MutatedDonuts is ERC721A, Ownable {
    ...
    constructor() ERC721A("Mutated Donuts", "MD") {
        _safeMint(msg.sender, 1);
        setBaseURI("https://api.donuts.one/api/donut/");
    }
