 ...
 * Contract by: Smeisty Co. & _granto
...
contract SmeistyMToken is ERC721Enumerable, Ownable {
    string  public              baseURI;
    
    address public              proxyRegistryAddress;
    address public              smeistyAccount;

    uint256 public              MAX_SUPPLY          = 5600;

    uint256 public constant     MAX_PER_TX          = 6;
    uint256 public              RESERVES            = 220;
    uint256 public              priceInWei          = 0.07 ether;
    ...
    constructor(
        ...
        address _smeistyAccount
    )
        ERC721("M-Token", "MTOKEN")
    {
        baseURI = _baseURI;
        proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
        smeistyAccount = _smeistyAccount;
    }
    ...
    function setSmeistyAddress(address _smeistyAccount) external onlyOwner {
        smeistyAccount = _smeistyAccount;
    }
    ...
    function setReserves(uint256 _reservesCount) external onlyOwner {
        RESERVES = _reservesCount;
    }
    ...
    function withdraw() public  {
        (bool success, ) = smeistyAccount.call{value: address(this).balance}("");
        require(success, "Failed to send to Smeisty.");
    }
