...
contract onethreethreeseven  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "1337 H4XOR";
    ...
    uint256 private constant _tTotal = 1337 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x4f6dFcA3aB4A7B38CB913a7f6168Dd5d560290cB); 
    address payable private _marketingAddress = payable(0x4f6dFcA3aB4A7B38CB913a7f6168Dd5d560290cB);
