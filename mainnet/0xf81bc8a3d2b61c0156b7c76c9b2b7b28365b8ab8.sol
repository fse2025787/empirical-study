...
contract DOLLARINUPROTOCOL is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'DOLLAR INU PROTOCOL';
    ...
    //DevWallets
    address public Development=payable(0x9a08328c17Fd4E176B5e34fac77Ca5500431Cee6);
    address public Marketing=payable(0x9a08328c17Fd4E176B5e34fac77Ca5500431Cee6);
    //MainNet
    ...
    uint256 private MaxBuy = 3000000 * 10**_decimals; // 10,000,000 tokens
