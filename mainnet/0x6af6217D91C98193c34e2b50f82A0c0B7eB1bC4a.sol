...
contract MetaMishima is ERC721A, Ownable, ERC2981, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("META MISHIMA", "MM") {
        ...
        merkleRootGoldList = 0x26ddbac4c7edabf9c1fe83b43e819c82fd76a27df7aa57463b9c6f421d7827ed;
        merkleRootEarlyBird = 0x8fe82a44d5befa39801643e65434ce6b0e439cae3e9328c7856170486917bb46;
        //merkleRootWhitelist = ;
    ...
    {
        require(mintsPerAddress[msg.sender] + quantity <= maxMintPublic, "Exceeds Max Mint Amount!");
    ...
    function mintWhitelist(uint256 quantity, bytes32[] calldata proof, bytes32 leaf)
        ...
        correctValue(tokenPrice * quantity)
    {
        require(verify(merkleRootWhitelist, leaf, proof), "Not a valid proof!");
        require(mintsPerAddress[msg.sender] + quantity <= maxMintWhitelist, "Exceeds Max Mint Amount!");
        _safeMint(msg.sender, quantity);
        mintsPerAddress[msg.sender] += quantity;
    }
     ...
     * @param quantity The number of tokens to mint.
     */
    function mintEarlyBird(uint256 quantity, bytes32[] calldata proof, bytes32 leaf)
        external
        payable
        noBots
        ...
        correctValue(tokenPrice * quantity)
    {
        require(verify(merkleRootEarlyBird, leaf, proof), "Not a valid proof!");
        require(mintsPerAddress[msg.sender] + quantity <= maxMintEarlyBird, "Exceeds Max Mint Amount!");
        _safeMint(msg.sender, quantity);
        mintsPerAddress[msg.sender] += quantity;
    }
     ...
     * @param quantity The number of tokens to mint.
     */
    function mintGoldList(uint256 quantity, bytes32[] calldata proof, bytes32 leaf)
        external
        payable
        noBots
    ...
    {
        require(verify(merkleRootGoldList, leaf, proof), "Not a valid proof!");
        require(mintsPerAddress[msg.sender] + quantity <= maxMintGoldList, "Exceeds Max Mint Amount!");
        _safeMint(msg.sender, quantity);
        mintsPerAddress[msg.sender] += quantity;
    }
