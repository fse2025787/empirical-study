...
// File contracts/RibbonBribe.sol
...
contract RibbonBribe is BribeBase {
    ...
    /**
        @notice Set a single proposal for a DAO voting event
        @param  voteId    uint256  DAO vote identifier
        @param  deadline  uint256  Proposal deadline
     */
    ...
    /**
        @notice Get list of DAO vote identifiers
     */
