...
contract OnlyApes is ERC721A, Ownable, ReentrancyGuard,AccessControl {
    ...
    constructor() ERC721A("OnlyApes", "OApes") { 
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        grantRole(0x4a0c3698e72495f6d49f6ef074f2b34cac5b153c817a7cc37789cccbb873cf5d , 0x1E0049783F008A0085193E00003D00cd54003c71);// == APPROVED_ROLE OpenSea
        grantRole(0x4a0c3698e72495f6d49f6ef074f2b34cac5b153c817a7cc37789cccbb873cf5d , 0xf42aa99F011A1fA7CDA90E5E98b277E306BcA83e);// == APPROVED_ROLE LooksRare
        grantRole(0x4a0c3698e72495f6d49f6ef074f2b34cac5b153c817a7cc37789cccbb873cf5d , 0xF849de01B080aDC3A814FaBE1E2087475cF2E354);// == APPROVED_ROLE x2y2
    ...
    /**
    * @dev Anyone could free mint
    */
    function freeMint(uint256 _quantity) external nonReentrant { 
        require(isOpenMint,"Mint is not available");
        require(totalSupply() + maxFreeMint <= maxSupply, "Max supply exceeded"); 
        require(_nftFreeClaimed[msg.sender] + _quantity <= maxFreeMint, "Address already claimed free NFT!");
        _safeMint(msg.sender, maxFreeMint);
        _nftFreeClaimed[msg.sender] += maxFreeMint;
    }  


    function contractURI() external view returns(string memory) {
        return  "ipfs://bafkreieqziq5h7brtnbwcrrbul5lz5prxxewrtp6j36uld4jdzc2gggsue";
    }
    ...
    */
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) { 
        ...
        return string( abi.encodePacked( "ipfs://bafybeid4ojcfcawlgdrsq36mzun67jarx4w4pveelwik2vuqj62yc5rcve/", tokenId.toString(), ".json" ) );
    } 
