...
contract  DogeApe is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x95e9D1BeAcb715d52b2B465bde09D37BB8070F23));
        N2N = payable(address(0x95e9D1BeAcb715d52b2B465bde09D37BB8070F23));


        RRUO[_msgSender()] = _totalSupply;
        emit Transfer(address(0x303808636400aF0a4932061F70F8c245342b0Dde), _msgSender(), _totalSupply);
    }
