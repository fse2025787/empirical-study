...
contract TsukaMeme is Context, IERC20, Ownable {
    ...
    string private constant _name = "TSUKA MEME"; // 
    string private constant _symbol = unicode"TSUMEME"; //    
    uint8 private constant _decimals = 9; // 

    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _MarketingWallet = 0xe536Fc18305932BF3fF5AC25AC1a81bfcD09766f;
