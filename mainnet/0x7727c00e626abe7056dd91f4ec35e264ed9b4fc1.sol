...
contract BSocial is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public socialSupply = 6000;
    uint256 public MAX_MINTS = 2;
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("BSocial.io", "BSOCIAL") {
        mintIsOpen = true;
    }
    ...
    // Mint
    function socialMint(uint256 qty) external payable
    {
        require(mintIsOpen , "Time us of the essence!");
        require(qty <= MAX_MINTS, "Can't mint any more!");
        require(totalSupply() + qty <= socialSupply,"100% Sold Out!");
        require(msg.value >= qty * price,"Short on ETH!");
