...
MINI WORLD CUP INU - $MWCI

4% Tax for Buybacks, Marketing and Development
...
contract MiniWorldCupInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MINI WORLD CUP INU", "MWCI") {
        ...
        marketingWallet = payable(0x8D54C9657f5aAE61E5D61d60d96d76076a068505);
        devWallet = payable(0x8D54C9657f5aAE61E5D61d60d96d76076a068505);
