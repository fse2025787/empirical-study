...
contract ShibaDefender is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Defender";
    string private constant _symbol = "SHIBD";
