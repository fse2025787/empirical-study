...
You're probably wondering how the son of the wind god and a nymph turned out to be a monkey. 
The answer is that Anjana once angered a sage who cursed her to be born as a monkey.

Tax for prayer : 5% both
...
contract hanumaninu is Context, IERC20, Ownable {
    ...
    string private _symbol = "$HANUMAN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 100000000 * 10**_decimals;     
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**_decimals;
    uint256 public _totalDistributionShares = 24;
    address payable public marketingaddress = payable(0x5Dc4F8Cec615F8FDfF86ec78B90E48496048C9bf);
