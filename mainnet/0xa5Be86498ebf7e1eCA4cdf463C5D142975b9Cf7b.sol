...
// 
        ...
        contract BoredApepeGrinchClub is ERC721A, Ownable, ReentrancyGuard  , DefaultOperatorFilterer{
        ...
        constructor(string memory _initBaseURI) ERC721A("BoredApepeGrinchClub", "BAGC") {
