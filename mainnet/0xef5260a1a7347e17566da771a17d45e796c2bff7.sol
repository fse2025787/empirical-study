...
contract Shinigami is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x454e41b0CACf6A7aB72DecC2119c08fE604ddCa9));

    string private _name = "Shinigami";
    string private _symbol = "SNGM";
