...
The noblest thing a man can do is, just humbly to receive, 
...
contract Believe is Context, IERC20, Ownable {
    ...
    string private _name = "Believe";
    string private _symbol = "BELIEVE";
    ...
    address payable public marketingWallet = payable(0xA64110abed5af64eCAc0d66C8bf9E6640cfada36);
