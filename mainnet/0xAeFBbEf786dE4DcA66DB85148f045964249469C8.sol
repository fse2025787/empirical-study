...
contract Vesting {
    ...
    constructor(
        ...
        timelock.amount = 62500000 * BASE;
        timelock.allowedSupply = 500000000 * BASE;
        developmentIndex = 0;
        ...
        timelock.amount = 31250000 * BASE;
        timelock.allowedSupply = 250000000 * BASE;
        coreTeamIndex = 2;

        // set vesting data, tokens allowed to claim in vesting
        allowedOneYearVesting = 125000000 * BASE;
        allowedTwoYearVesting = 125000000 * BASE;
