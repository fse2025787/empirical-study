...
/**
   ...
   Website : https://xsatan.medium.com/

   Twitter : https://twitter.com/SatanXErc
...
contract SatanX is Context, IERC20, Ownable {
    ...
    string private constant _name = " Satan X";
    string private constant _symbol = " SATANX";
