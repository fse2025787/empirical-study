    ...
    DefaultOperatorFilterer721
{
    ...
    {
        if (_tokenId > 0)
            return (address(this), _salePrice * (_royality / 100));
    }
}
...
// File contracts/LifeStyleDao.sol

pragma solidity ^0.8.0;

contract LifeStyleDao is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxPublic = 200;
    uint256 public maxSupply = 200;
    uint256 public presaleCost = 0.000 ether;
    uint256 public publicCost = 0.000 ether;

    constructor(string memory _initBaseURI)
        ERC721A("LifestyleDAO Phase 1", "LDAO")
    {
    ...
    function setPrice(uint256 _whitelistCost, uint256 _publicCost)
        public
        onlyOwner
    {
    ...
    function setRoyality(uint256 _amount) public onlyOwner {
        _royality = _amount;
    }
