...
contract TCN is ERC721, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 250;
    ...
    string public hiddenMetadataUri = "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxx/";

    constructor() ERC721("The Crypto Affiliate Network", "TCN") {}


    function mint(address _to, uint256 _numTokens) external onlyOwner {
