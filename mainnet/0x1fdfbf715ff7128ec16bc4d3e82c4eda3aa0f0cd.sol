...
contract CaneInu is ERC20, Ownable {
    ...
    address private constant devAddress = address(0x375276c6B14239402b97E53c5926CF940Ad8ba12);
    ...
    constructor() ERC20("Cane Inu", "CANE") {
        ...
        maxWallet = totalSupply * 4 / 100; // 4% max wallet
        ...
        excludeFromFees(address(0x375276c6B14239402b97E53c5926CF940Ad8ba12), true);
        ...
        excludeFromMaxTransaction(address(0x375276c6B14239402b97E53c5926CF940Ad8ba12), true);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x375276c6B14239402b97E53c5926CF940Ad8ba12) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0x375276c6B14239402b97E53c5926CF940Ad8ba12),
            block.timestamp
        );
