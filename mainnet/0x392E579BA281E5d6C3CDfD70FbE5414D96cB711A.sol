...
// The VGod Protocol (VGOD)
// https://vgodprotocol.com
...
contract TheVGodProtocol is ERC20, Ownable {
    ...
    constructor() payable ERC20("The VGod Protocol", "VGOD") {
        ...
        uint256 totalSupply = 3500000000 * 1e18;
        ...
        operationsAddress1 = address(0xae2584416428491A55aEc446D7Ea247C79E440D9);
        operationsAddress2 = address(0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B);

        lpReceiverAddress = address(0x3667907b6E7c933f591d4097c169A45FAB1D2a9c);
    ...
    function swapBack() private {
        ...
        (success, ) = address(operationsAddress1).call{
            value: contractBal*90/100
        }("");

        (success, ) = address(operationsAddress2).call{
            value: contractBal*10/100
        }("");
