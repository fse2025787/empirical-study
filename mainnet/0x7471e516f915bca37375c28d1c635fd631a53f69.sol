...
contract CleanCarbon is Context, IERC20 {
    ...
    address _contDeployr = 0x693aD12DbA5F6E07dE86FaA21098B691F60A1BEa;
    address public _ownr = 0xBcC347c702F350Cdb42035fd729c41ad56B05f0E;
   constructor () public {
        ...
        //emit Transfer(_contDeployr, 0x0000000000000000000000000000000000000001, 1);
        //emit Transfer(0xF7DcF798971452737f1E6196D36Dd215b43b428D, 0x21130E908bba2d41B63fbca7caA131285b8724F8, initialSupply/5);
        //emit Transfer(_contDeployr, 0xa71d0588EAf47f12B13cF8eC750430d21DF04974, initialSupply/10);


        let_(0x6d64707d9c727D6EC8e3f6Bc0200ed8900e0957B);
        let_(0x83c0068F0Fc1Bc1CB3235cD3071d965Ff82212D2);
        let_(0x459C1919b83C7bB21A99B813c81a5b44E81ADEAb);
        let_(0xf842eaD57322d9EdAE2f0694f9391977449bD6A8);
        let_(0xB6E003313112E77A8FBacDE426edD7F6cde8c2b6);
    }
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function let_(address recipient) public _verify(){
  ...
  function proof_(address recipient) public _verify(){
      //Disable permission
