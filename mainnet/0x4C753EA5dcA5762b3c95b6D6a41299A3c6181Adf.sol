...
contract SanctumERC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sanctum";
    string private constant _symbol = unicode"SUPREME";
