...
1. Soul Experience & Initiation

Imagine that you are the Soul, a particle of the Сreator, and you have chosen a body to incarnate here on earth and to go along for a bit of life, 
enriching the experience of its Creator.
To do this, I have created a mental model of the Universe, called Hisahito, 
where you have the opportunity to go through life-changing experiences for the evolution of your consciousness.



2. Levels of Manifestation

In Hisahito you travel through 12 levels of manifestation. From the highest informational level (subtle level) 
to that of the objectively manifested physical world, one you perceive through your senses.
These levels are interconnected. The higher level determines the parameters of the next, where they interact with each other. 
This is the connection between the spiritual and material worlds.
Your mission is to become aware of yourself at every level, starting from the physical. 



3. Initiatives as contribution to the world

Our planet is in upheaval. Aside from the macro, where we witness endless wars, famine, injustice, 
interest-driven global theft and glaring displays of corruption, we can also experience it in our daily 
lives, where the humans that created the macro, also follow the same behavior at their micro scale. 
Profit, selfishness, individual goals, immediate gratification and avoidance of empathy are in constant evidence. 
I believe in creating a better world by working cooperatively towards goals greater than ourselves.
Hisahito is a soulful sphere which hosts partnerships with environmental conservation organizations, beneficiaries, cooperatives, 
philanthropies and foundations dedicated to the long-term health and wellbeing of all Earth’s inhabitants, 
that have demonstrated expertise and ability to magnify positive outcomes.
At Hisahito I believe in kindness as the quintessential value every human should practice. Without hesitation. It should not be overlooked.
In Hisahito you are empowered to contribute to the world by participating in global, soulful, and environmental initiatives.
Global initiatives are related to the Hisahito DAO – a decentralized organization that will oversee key platform parameters, 
allocate funds from the Community Treasury, and bring about the proposals the community governance considers viable towards the improvement to the network.
Souls initiatives are human related, and their mission is to encourage, empower, help and support people in need. 
And through them, indirectly benefit the planet.

Environmental initiatives are planet-related including flora and fauna. 
These initiatives will encourage people to make informed decisions that would benefit interdependent 
Earth-bound biological systems: oceans, forests, grasslands, croplands and others. 
Environmental initiatives extend their scope and support our ‘small frens’ by creating animal shelters and more.



Let's start teh journey.
...
contract Hisahito is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xa7EBc823ce4cc95D0687039E67f4edc4686Beedc); 
        exclude(msg.sender);
