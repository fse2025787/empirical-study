...
contract PunksCoin is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 980;
    uint256 public constant MAX_FREE_SUPPLY = 890;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.0015 ether;

    string private constant _name = "Punks Coin";
    string private constant _symbol = "PUNKSCOIN";
    string private _contractURI = "QmVxcqVeWz1SL6wQQJDtFhz7KyDfdtNSvNpwHYkrKS5rTx";
    string private _baseURI = "QmNaWeb7fcuD4G48LY7M3AwsWiAB6NLEWENjb9rF874pJs";
    ...
    function freeMint() external{
        ...
        require(totalSupply() + amount <= MAX_FREE_SUPPLY, "Freemint SoldOut");
