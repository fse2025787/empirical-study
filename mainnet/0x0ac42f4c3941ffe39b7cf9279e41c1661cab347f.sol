...
contract GRAVISFINANCE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    string public constant _name = "Gravis Finance";
    string public constant _symbol = "GRVS";
    ...
    constructor() {
        ...
        _genesis_wallet.marketing   = address(0x89a0d9Ddc60dD388fE1BCe2ab9Ac24B20909D278);
    ...
    function updateBurnWallet() external onlyOwner returns(bool) {
