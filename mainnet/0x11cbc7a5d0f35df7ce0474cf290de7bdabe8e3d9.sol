...
contract GatsbyToolsPass    is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 4000* 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'Gatsby Tools Pass';
    string private _symbol = 'GTP ';
