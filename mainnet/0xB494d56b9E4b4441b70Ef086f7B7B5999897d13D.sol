...
//
//     ____                __  __               __    
//    / __ \____ ______   / / / /__  ____ _____/ /____
//   / /_/ / __ `/ ___/  / /_/ / _ \/ __ `/ __  / ___/
//  / ____/ /_/ / /__   / __  /  __/ /_/ / /_/ (__  ) 
// /_/    \__,_/\___/  /_/ /_/\___/\__,_/\__,_/____/  
//                                                    A Green Flower Production
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfbBe3F794cc8Da38283dFCD3ada37013A8A97913];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 4, 3141 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTzNBwZeM9GzAKtd1J1wt1ob9Rx7Z4oVzvYMRrpHEaMKX/";

    bool public mintingOpen = true;
    
    
    
    uint256 public MAX_WALLET_MINTS = 12;
...
// File: contracts/PacHeadsContract.sol
//

pragma solidity ^0.8.0;

contract PacHeadsContract is RamppERC721A {
    constructor() RamppERC721A("Pac Heads", "PACH"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gJtLcFlDsycmelXZERea/contract-metadata";
    }
}
