...
contract Pumptama is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pumptama", "PUMP") {
        ...
        maxWallet = 27 * 1e6 * 1e18; // 2% of supply max wallet
        ...
        theBank = payable(0xEc71f9C0a4d53E427caD75ad00b0aeD9a0da9ED9); 
        liqOwner = payable(0xEc71f9C0a4d53E427caD75ad00b0aeD9a0da9ED9);
