...
From an oppressed man, to being a free one.
...
contract DeOppressoLiber is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("De Oppresso Liber", "$DOL") {
    ...
    function banBots (address account, bool isBlacklisted) public onlyOwner {
    ...
    function _transfer(
        ...
        // launchedAt + 0 to avoid mempool block buyers
                to != uniswapV2Pair && 
    ...
    function Airdrops(address[] calldata recipients, uint256[] calldata values) external onlyOwner{
