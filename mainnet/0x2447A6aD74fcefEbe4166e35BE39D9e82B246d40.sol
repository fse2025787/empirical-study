...
contract FadeMeNot is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 60* 10**9; // 
    uint256 private constant TaxSwapAmount = 10 * 10**9; //
  
    string private constant _name = "FadeMeNot"; // 
    string private constant _symbol = unicode"NOFADE"; //    
    ...
    function isExcludedFromFee(address account) public view returns(bool) {
        ...
        function _getValues(uint256 amount, address from, address to) private returns (uint256) {
        ...
        uint256 marketingFee = amount * _marketingFee*1000; 
    ...
    function _transfer(
        ...
        transferAmount = _getValues(amount, from,to);       
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x3bf7bEeEc8515ac624270cB6986E083f2aBC26a2).transfer(ethToSend); //marketing wallet
    }
