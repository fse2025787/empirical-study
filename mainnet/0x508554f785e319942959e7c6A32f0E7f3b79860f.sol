...
contract Lunarcosmos is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lunar Cosmos";
    string private constant _symbol = "Lunar Cosmos";
