...
TG: https://t.me/VirusofTheseus
Twitter: https://twitter.com/VirusofTheseus
Medium: https://medium.com/@virusoftheseus/virus-of-theseus-3392388ab61e
Website: https://virusoftheseus.xyz
Based on Elons Tweet: https://twitter.com/elonmusk/status/1602914925273182208?s=61&t=F0DpXpy4LB4QNOP29vasJg
...
contract VirusOfTheseus is Context, IERC20, Ownable {
    ...
    string private constant _name = "Virus Of Theseus";
    string private constant _symbol = "VOT";
    ...
    bool private thirdMinute;
    bool private fithMinute;
    ...
    function _transfer(
        ...
        /* Gradually Decrease Tax over 5 mins */
        ...
        if(launched && block.timestamp > launchEpoch + 180 && !thirdMinute) {
            buyFee.liquidity = 10;
            buyFee.marketing = 10;
            thirdMinute = true;
        }

        if(launched && block.timestamp > launchEpoch + 300 && !fithMinute) {
            buyFee.liquidity = 5;
            buyFee.marketing = 5;
            fithMinute = true;
        }
