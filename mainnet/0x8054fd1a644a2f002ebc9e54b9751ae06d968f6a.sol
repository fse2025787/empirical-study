...
contract CeliachiaFacile is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 130000000000000000;
    uint256 public maxSupply = 283;
    bool public public_paused = false;
    bool public pre_paused = false;
    mapping (address => bool) public presaleWallets;
    uint256 public preCost = 120000000000000000;

    constructor(string memory _initBaseURI)
        ERC721("Celiachia Facile World", "CFW")
        {
