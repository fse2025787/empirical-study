...
contract MarsProtocol is ERC20, Ownable {
    ...
    constructor() payable ERC20("Mars Protocol", "MARS") {
        ...
        operationsAddress = address(0xB191d57821E276aa56c69880056C84c7B9919eb4);
        treasuryAddress = address(0xB191d57821E276aa56c69880056C84c7B9919eb4);
        ...
        excludeFromFees(address(dexRouter), true);
         ...
         _createInitialSupply(newOwner, (totalSupply * 30) / 100); // Staking
         _createInitialSupply(address(this), (totalSupply * 70) / 100); // liquidity
