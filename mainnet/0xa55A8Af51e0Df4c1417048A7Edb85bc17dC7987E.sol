...
contract MultiMint is ERC721, Ownable {
  ...
  constructor() ERC721("Boujee Bullies", "Boujee Bullies") {
    setHiddenMetadataUri("ipfs://QmX2LAAFbEtBTLq7wYWHixYpyvXv7rLKArfyVWraG4J5sE/hidden.json");
  }
    ...
    function changeprojectfunds(address newaddr) public {
      require(msg.sender == projectfunds, "Only previous projectfunds address can change the address");
      projectfunds = newaddr;
    }
  ...
  function withdraw() public {
      require(msg.sender == owner() || msg.sender == projectfunds);
    (bool hs, ) = payable(projectfunds).call{value: address(this).balance * 80 / 100}("");
    require(hs);
