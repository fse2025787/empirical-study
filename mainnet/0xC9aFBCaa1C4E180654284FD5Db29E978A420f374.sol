...
// of the logic contract. This is called UUPS. To see how this compares to other methods, see https://docs.openzeppelin.com/contracts/4.x/api/proxy
...
contract BotProxy is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    address public bot;
