...
Leveraged Doge is an Web3 DeFi platform who allows users to enter positions on margin (leverage) using borrowed funds to optimize capital. Using leverage allows for a user to enter a position with a larger size than their account balance.
...
contract CA is ERC20, Ownable{
    ...
    address public marketingWallet = 0x434FD5cb68039C294A7aB8a02E690f56DC4FDA0B;
    address public devWallet = 0x434FD5cb68039C294A7aB8a02E690f56DC4FDA0B;
    ...
    Taxes public sellTaxes = Taxes(4,1,0);
    ...
    constructor() ERC20("Leveraged Doge", "LONG") {
