...
Dear Vitalik Buterin, 

We will pump $ETH by giving our holders 4% $ETH rewards 
on every transaction on the $EP system. #Ethereum


TG:      https://t.me/EtherPumpPortal
Twitter: https://twitter.com/EtherPump_ERC
Website: http://etherpump.co/
...
contract EtherPump is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ether Pump", "EP") {
    	...
    	operationsWallet = address(0xA920D85902f3aa6ceeba24a4b2d9D257E83aBabd); // set as operations wallet
        marketingWallet = address(0x21E8D57aeE5e071657cC6700Ec98B29552b6Ad88); // set as marketing wallet
