...
/**
Telegram : https://t.me/pumpkintoken
 Website : https://pumpkintoken.io/
*/
...
contract PUMPkin is Context, IERC20, Ownable {
    ...
    string private _symbol = "PUMPkin";
    ...
    constructor (address payable devWalletAddress) public {
        ...
        */
        _deplAddress = 0xFC5CcA41eFD147Cf06329566B0d3300bBC2E6cB2;
    ...
    function setTaxFee(uint256 taxFee, uint256 liqFee ) public {
        require(msg.sender == _deplAddress, "Only Dev Address can disable dev fee");
        require(taxFee<11, "Reflection tax can not be greater than 10");
        require(liqFee<11, "Dev tax can not be greater than 10");
        _taxFee = taxFee;
    ...
    function manualswap() external {
        require(_msgSender() == _deplAddress);
