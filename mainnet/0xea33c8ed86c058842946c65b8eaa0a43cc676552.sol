...
/*
    ...
    Fable of Hanzo
    One night, after the End of Summer Festival, Sojiro told Hanzo, Genji, and Kiriko a story from the history of the Shimada clan. 
    How centuries ago, a rival clan attempted to end the Shimada's rule by setting their orchards aflame, as well as the city's Fox Shrine.

    > https://t.me/FableOfHanzo
    > https://twitter.com/FableOfHanzo
...
contract FableOfHanzo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fable of Hanzo";
