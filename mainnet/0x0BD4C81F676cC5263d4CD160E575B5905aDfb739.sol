...
contract CROFLY is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CROFLY";
    string private constant _symbol = "CFLY";
    ...
    address payable private _developmentAddress = payable(0x479F987DD4328F35BB3293f6c97C533249B0708b); 
    address payable private _marketingAddress = payable(0xDfe7B5bD2771C90BDe171bC20B6EcA4a399176F8);
