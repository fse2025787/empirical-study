...
contract ELONVSAPPLE is Context,IERC20, Ownable{
using Address for address;
string private _name = "ELON VS APPLE";
string private _symbol = "ELONAPPLE";
...
address _owner;
address payable public marketingAddress = payable(0xE809D142bCdE664aC16067a371CeB34e1b48A8fb);
...
uint256 ELONVSAPPLECOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > ELONVSAPPLECOINDaycooldown, "You cant call ELONVSAPPLECOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function ELONVSAPPLECOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    ELONVSAPPLECOINDaycooldown = block.timestamp + 86400;
}
