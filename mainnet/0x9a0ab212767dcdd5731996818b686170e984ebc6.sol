...
contract Shibifu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibifu";
    string private constant _symbol = "IFU";
    ...
    address payable private _developmentAddress = payable(0x9C70ef55b39453198e820e8a79242641375750B1); 
    address payable private _marketingAddress = payable(0x9C70ef55b39453198e820e8a79242641375750B1);
