...
contract NiftyBuilderInstance is ERC721, ERC721Burnable {
    ...
    address public dateTimeContract;

    string[2] private artifact_1 = ["Qman8rCRYmLQnm3iBH5VwhMfHJkz7e7g9TQopSyrwtbCes", //Day
                                    "QmQwSqEohMXeP9QxzrzWeEwtdWPnxH6WjnpXkfyPPMEK2o"];//Night

    string private artifact_2 = "QmVdE84ZJxT66j8nEEVFKvwBKXsyYYihHawHmCqsLF9qMv"; //Love for the Low

    string[3] private artifact_3 = ["QmcsKgicSRsCVNu4NcFZu1PgjhvWZMm34ASTUh5QivvSn4", //Day 0 (Peace)
                                    "QmV1U5fKdLgnYmz8wVnLXxPJAovjEYeUaqCi4ZNxueavts", //Day 1 (Air)
                                    "Qmf9NSo6C9Ufwyz23JH9LS3kfKXAN5FUYpKTDPyYJDsax9"];//Day 2 (Spark)

    constructor(address _dateTimeContract,
                address masterBuilderContract, 
                address niftyRegistryContract) ERC721("Coming of Age", "JAG", masterBuilderContract, niftyRegistryContract) {
        ...
        _setNiftyTypeName(1, "Breffis Day n' Night");
        _numNiftyPermitted[1] = 1;

        _setNiftyTypeName(2, "Love for the Low");
        _numNiftyPermitted[2] = 5;
        
        _setNiftyTypeName(3, "FreeDOOM Rocket");
        _numNiftyPermitted[3] = 10;

        _setBaseURIParent("https://api.niftygateway.com/juliangilliam/");
    }
    ...
    function tokenIPFSHash(uint256 tokenId) external view override returns (string memory) {
        ...
        BuilderMasterAPI bm = BuilderMasterAPI(masterBuilderContract);
        uint nifty = bm.getNiftyTypeId(tokenId);
        ...
        uint index = day % artifact_3.length;
        return artifact_3[index];
    }
}