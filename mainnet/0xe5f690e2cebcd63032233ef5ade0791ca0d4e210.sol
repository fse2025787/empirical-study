...
contract DemonsPlaying is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmVAqro3VVoFUBnj8za5WDhspQxRRY5xzCvBFDsa4Eh97f/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 333;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Demons Playing", "DP") {
        baseURI = initBaseURI;
