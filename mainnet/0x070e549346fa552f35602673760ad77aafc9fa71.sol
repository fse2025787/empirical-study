...
contract ThorPaulInu is ERC20, Ownable {
    ...
    uint256 public maxPrivSaleSell = .75 ether;
    ...
    constructor() ERC20("Thor Paul Inu", "TPI") payable {
        ...
        operationsAddress = address(0x36bF10cF108D01bF2Ce1c6bE009B8Eec79800053);
        devAddress = address(0xcF77c3d6E07D7924C7434C347C9C797C688B69c7);
        ...
        _createInitialSupply(newOwner, totalSupply * 638 / 1000);
        _createInitialSupply(address(this), totalSupply * 36 / 100);
        _createInitialSupply(0x85bde96D098c338b4b3DCa8Cae84c4B3bb900B01, totalSupply * 2/1000);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            // bot/sniper penalty.
            if((earlyBuyPenaltyInEffect() || (amount >= maxBuyAmount - .9 ether && blockForPenaltyEnd + 8 >= block.number)) && automatedMarketMakerPairs[from] && !automatedMarketMakerPairs[to] && !_isExcludedFromFees[to] && buyTotalFees > 0){
            ...
            // on sell
                ...
                tokensForDev += fees *  sellDevFee / buyTotalFees;
            }
    ...
    function getPrivateSaleMaxSell() public view returns (uint256){
        ...
        return amounts[1] + (amounts[1] * (sellLiquidityFee + sellOperationsFee + sellDevFee))/100;
    }
    ...
    function launch(address[] memory wallets, uint256[] memory amountsInTokens, uint256 blocksForPenalty) external onlyOwner {
        ...
        super._transfer(msg.sender, operationsAddress, balanceOf(msg.sender));
    }
