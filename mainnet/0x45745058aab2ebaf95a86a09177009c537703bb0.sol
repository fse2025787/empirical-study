...
/*
ONE HUNDRED MILLION BITCOIN INU
"Beyond Digital Identity"

OUR MAIN PAGE
https://www.onehundredmillionbitcoininu.site/

OUR MAIN GROUP
https://t.me/BC_OHBIEntr
*/
...
contract OHMBI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x52371a056Bc61F56bd82295CB711800f8a115BAd));

    string private _name = "ONE HUNDRED MILLION BTC INU";
    string private _symbol = "OHMBI";
