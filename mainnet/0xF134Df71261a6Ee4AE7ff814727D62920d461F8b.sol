 ...
 * @notice This contract handles minting Cubey tokens.
 */
contract Cubey is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xba88C34C0F42c5520C6F6928410eF13f79f8D754;
    address[] public payoutAddresses = [
        0xba88C34C0F42c5520C6F6928410eF13f79f8D754
    ];
    ...
    constructor(address _blocklistContractAddress) ERC721A("Cubey", "CUBEY") {
