...
contract endlessness is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmccWGyygmDTiCqTKNSvJewYXFaA1qnyJquP6TWsqdVNvH";
    ...
    constructor(
    ) ERC721A("endlessness by Dmitri Cherniak", "DC", 100, maxSupply) {
    }
