...
contract GAWK2 is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "GAWK2.0";
    string private constant tokenSymbol = "GAWK2.0";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x7812e084eC5e065c2aC75605da710a22Be83bBC0);
        devAddress = payable(0x7812e084eC5e065c2aC75605da710a22Be83bBC0);
