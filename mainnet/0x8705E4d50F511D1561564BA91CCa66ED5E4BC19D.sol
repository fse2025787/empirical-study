...
/**
 * The First Ever Streetwear Crypto Coin 🪙
 * Clientele NFT 🤖
 * Clientele Wallet 💵
 * Clientele Ecosystem 🌎
 * #ClienteleCoin
 * https://t.me/ClienTelegram
*/
...
contract Clientele is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 137000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'ClienteleCoin'; 
    ...
    function _setMinSellLiqPercent(uint256 burnFee) external onlyOwner() {
