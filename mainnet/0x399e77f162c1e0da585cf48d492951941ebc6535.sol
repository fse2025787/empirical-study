...
// The CocaInu project is the king of the Memecoins not just because Coca Inu is the cutest dog.
// $COCAINU is making an appearance in the dog culture and it has a community-backed meme token that runs on the ETH network. 
// CocaInu takes pride in its community and is always there to reward its holders when needed.
// Marketing starting with coinsniper, YouTubers, and next week CMC and CG.
//
...
contract $COCAINU is Context, IERC20, Ownable {
    ...
    string private _name = 'Coca Inu t.me/cocainue';
