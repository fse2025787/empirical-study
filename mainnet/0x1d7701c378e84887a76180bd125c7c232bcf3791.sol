...
The real owner of the virtual currency is SpaceX,
The best way for INU to persist in any given market is to merge with SpaceX.
The creation of new things starts with imagination!

🐕Telegram:https://t.me/SpaceXInuEth
🐕Twitter:https://twitter.com/SpaceXInuEth
...
contract SpaceXInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"SpaceX Inu";
    string private constant _symbol = "SpaceX";
