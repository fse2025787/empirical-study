...
// File: contracts/theMetalorianDAO.sol
...
contract TheMetalorianDAO is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 1;
   
    
    uint256 public constant LIMIT_NFT_BY_ADDRES = 1;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian DAO", "TMD") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeihrfzx2l2w4npwtv6jlxtmkj6kll7xfyx2bjj5l6mposeg5neouxm/";   
        mintCost = 0 ether;
    }
    ...
    event MintTheMetalorianDAO(address indexed user, uint256 tokenId); 
    ...
    function mintTheMetalorianDAO(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDAO(msg.sender, tokenIdCounter.current());            
