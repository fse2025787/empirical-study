...
contract CHIMATA is ERC20, Ownable {
    ...
    constructor() ERC20("Chimata No Kami", "CHIMATA") {
        ...
        devWallet = address(0x8eF3Fe5A5e0F2053214762C89cFD6B318F47eeDe); // set as dev wallet
