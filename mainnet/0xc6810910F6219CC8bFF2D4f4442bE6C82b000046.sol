...
contract GOLD is Context, IERC20, Ownable {
  ...
  address payable public marketingAddress =
    payable(0x7E6a4aAc3C75Fe22d5C113169C0F71522aA1Ae33); // Marketing Address
    
  address payable public maintenanceAddress =
    payable(0xdE9911500E6B691F7c684a65aE340530554DED3F); // Project Maintenance
    
  address payable public treasuryAddress =
    payable(0x00FE74e7c35b5402aFA1F94223E9EdfFDeCf54A5); // Treasury
...
// limit
  ...
  function setBlacklist(address[] calldata accounts, bool flag) external {
    ...
    for(uint i = 0; i < accounts.length; i += 1) {
      ...
      _isSniper[accounts[i]] = flag;
      _confirmedSnipers.push(accounts[i]);
    }    
  }
