...
contract Loony_Pirates is ERC721A, ReentrancyGuard, Ownable{
    ...
    constructor(string memory _unrevealedUri) ERC721A("Loony_Pirates", "LONPIRI"){
    ...
    uint256 private constant MAX_GIFT = 50;
    uint256 public constant SALE_PRICE = .0009 ether;
