...
contract BeanHeadz is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    string public baseURI = "ipfs://QmVyB1XtHvGQSW18cMEhGRPSmJJQeLj1cED5ReeeTuMMJZ/";
    ...
    constructor () ERC721A("BeanHeadz", "BEANHEADZ") {
    }
    ...
    function mintBean(uint256 mintAmount) public payable nonReentrant {
    ...
    function reserveBean(uint256 _mintAmount) public onlyOwner {
