...
Website:
https://www.triangleplatform.com/

Telegram:
https://t.me/triangleerc/
...
contract TRIANGLE is ERC20, Ownable {
    ...
    address public marketingWallet = 0xCE3512FB09c514d676B727e0Beb142D376C07eC8;
    ...
    constructor() ERC20("Triangle", unicode"Δ") {
        ...
        marketingSellFee = 40; 
        totalSellFees = marketingSellFee; // 4%
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 50) / 1000) / 1e18,
            "Cannot set maxTransactionAmount lower than 5.0%"
        );
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 50) / 1000) / 1e18,
            "Cannot set maxWallet lower than 5.0%"
        );
    ...
    function updateSellFees(uint256 _marketingSellFee) external onlyOwner {
        ...
        require(totalSellFees <= 60, "Must keep fees at 6% or less");
    }
