...
/**
    🔥🦊 FIREFOX - TULIKETTU - TULIREPO - TULIKKO 🦊🔥

	        🔥🦊 Every Hunter's Dream 🦊🔥

    Where water meets skies, you'll find along the coast of the northern light, the fiery fox traversing the ice age fauna
    The mythical creature of Finnish folklore, catch a glimpse of its precious radiant fur, tail twinkled with fire.
    Hunters dream of the Firefox, as fast as the wind, its flaming tail whipping crystals of snow into the sky
    Capture the fox, and all the earthly delights are yours, become the envy of all tribes
    When a firefox screams, the woods creak and a ghostly whimper fills the skies
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    contract FIREFOX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FIREFOX", "FIREFOX") {
        ...
        // 🔥🦊 NOTE: HIGH TAX AT THE BEGINNING TO DISSUADE PAPER-HANDS 
        ...
        devWallet = 0x7DFE37E8583e44aAf592a38F32fFB873949B5Fc7;
    ...
    // 🔥🦊 NOTE: CALLING THIS FUNCTION SHORTLY AFTER LAUNCH TO REDUCE TAXES
    // 🔥🦊 MAX BUY / WALLET : 5%
