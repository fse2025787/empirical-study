...
contract ETHWalkersMiami is ERC721A, Ownable, ReentrancyGuard, Pausable {
    ...
    address payable public payoutsAddress = payable(address(0x2608b7D6D6E7d98f1b9474527C3c1A0eD54bE399)); // Default team wallet, will replace with payment splitter and lockout
