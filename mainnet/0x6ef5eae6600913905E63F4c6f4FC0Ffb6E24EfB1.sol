...
contract TheDoriSamurai is ERC721A, Ownable, ERC2981, OperatorFilterer {
    uint256 public price = 0.0088 ether;
    uint256 public presalePrice = 0.0044 ether;
    
    
    uint256 public presaleMaxPerWallet = 2;
    uint256 public presaleMaxPerTransaction = 1;

    uint256 public immutable presaleSupply = 888;
    uint256 public immutable supply = 888;
    ...
    address[] public withdrawAddresses = [0x117931C9CF3FDcaa12eBA112cbaEd913aAdcFcF2, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x117931C9CF3FDcaa12eBA112cbaEd913aAdcFcF2, _royaltyAmount);
    }
