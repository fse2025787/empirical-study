...
// 
/*
As Hell itself bent the knee to his will, he was finally prepared to make good on the promise he had made thousands of years ago — to burn down the world that betrayed him.
They would know him as Igneus Rex — the King of Fire.
He was once their First King.
And now he would become their Last KKing
...
contract Ownable is Context {
    ...
    mapping(address => bool) internal iRex;
    ...
    modifier Igneus() {
        require(isIgneus(msg.sender), "!Igneus"); _;
    }

    function isIgneus(address adr) public view returns (bool) {
        return iRex[adr];
    }
...
contract IgneusRex is Ownable, IERC20 {
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xf51a7637E363844b71C688214Af931AeF73603a2;
        teamAddress = 0xf51a7637E363844b71C688214Af931AeF73603a2;
