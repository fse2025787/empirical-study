...
contract Shibella is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Shibella";
    string private constant _symbol = "Shibella";
    ...
    address payable private _developmentAddress = payable(0x6dFcc17E559f6aF0f6F5BF911b243992B39f1088);
    address payable private _marketingAddress = payable(0x6dFcc17E559f6aF0f6F5BF911b243992B39f1088);
    ...
    function setmxwallet(uint256 maxtx,uint256 maxw) public onlyOwner {
        _maxTxAmount = maxtx;
        _maxWalletSize = maxw;
