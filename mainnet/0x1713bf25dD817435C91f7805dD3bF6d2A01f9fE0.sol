...
/**
    ...
    Fable of The Egg - EGG

Dragons start from eggs and then hatch. We must support our hatched dragons.
...
contract EGG is Context, IERC20, Ownable {
    ...
    //naming
    string private constant _name = "Fable of The Egg";
    ...
    address payable private _developmentAddress = payable(0x2717f7786C6a37c9E1E39384eAcE57E7C41E8850);
    address payable private _marketingAddress = payable(0x2717f7786C6a37c9E1E39384eAcE57E7C41E8850);
