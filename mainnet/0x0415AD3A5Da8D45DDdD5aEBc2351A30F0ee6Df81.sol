...
contract CryptoBulls is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    address holder1 = 0xfC99Ec9C944d752bA900CAdFAAF034925Ea49E36;
    address holder2 = 0xC9Fd5484C5e01d9ABEe259d5de658eDcaaE9628B;

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721("Crypto Bulls", "CB") {
        mintPlatinum(holder1, 9);
        mintPlatinum(0xCEAAE818Fc6bc440E7b5355B0B2a53148835DeA7, 1);
        ownerMintGold(holder1, 24);
        ownerMintGold(0xCEAAE818Fc6bc440E7b5355B0B2a53148835DeA7, 1);
        ownerMintGold(0x3343c1cf4d6E2cf320BCc7FbC0c41c21B6b8d4e7, 1);
        setBaseURI("ipfs://QmUHnUd4sRnUBT5Gb5zyZm2v6PzmiDXtu89eF5PZzocik1/");
    }
    ...
    function mintPlatinum(address _address, uint256 _mintAmount) internal {
    ...
    function mintGold(uint256 _mintAmount) public payable {
        ...
        uint256 transferpay = msg.value / 2;
        payable(holder1).transfer(transferpay);
        payable(holder2).transfer(transferpay);
    }

    function ownerMintGold(address _address, uint256 _mintAmount) public onlyOwner {
        uint256 supply = totalSupply();
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(_address, supplyGoldTokens + 10 + i);
            setRoyalties(supply + i, payable(address(this)), 1000);
            allTokens++;
            supplyGold++;
        }
    ...
    function ownerMintBlack(address _address, uint256 _mintAmount) public onlyOwner {
        uint256 supply = totalSupply();
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(_address, supplyBlackTokens + 60 + i);
            setRoyalties(supply + i, payable(address(this)), 1000);
            allTokens++;
            supplyBlack++;
        }
