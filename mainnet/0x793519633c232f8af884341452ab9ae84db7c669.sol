...
Welcome to The Ponziverse.. 


https://medium.com/@theponziverse
...
contract ThePonziverseCA is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(4,1); //dev tax, liquidity tax
        setSellTax(6,1); //dev tax, liquidity tax
        setTaxWallets(0x37c9C2197E7b8495860e827Ed9e935F7fF151898); // Wallet
        exclude(msg.sender);
