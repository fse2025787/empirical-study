...
/** 
* @author Formation.Fi.
* @notice Implementation of the contract DepositConfirmationAlpha.
*/
 contract DepositConfirmationAlpha is DepositConfirmation {
         constructor() DepositConfirmation ("DALPHA", "DALPHA"){
         }
}
