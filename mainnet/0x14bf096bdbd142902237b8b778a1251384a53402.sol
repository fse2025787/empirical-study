...
contract ElonsVision is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Elons Vision";
    string private _symbol = "EVISION";
    ...
    uint256 public defaultMarketingFee = 10; //buying only
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _marketingFee4Sellers = 10; //selling only

    bool public feesOnSellersAndBuyers = true;

    uint256 public _maxTxAmount = 80000000 * 10**2 * 10**9; // max transaction amount
