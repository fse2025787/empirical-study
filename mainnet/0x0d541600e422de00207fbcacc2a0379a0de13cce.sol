...
contract GoogleVerse is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Google Verse";//
    string private constant _symbol = "GVERSE";//
    ...
    address payable private _developmentAddress = payable(0x0Fe7f698D5f950Dd7677F74800d45EfE9d0dd62D);//
    address payable private _marketingAddress = payable(0xb3505b8faD8eB16b1EE740ed7F3E5af6b5d862be);//
