...
/**
    Dasher Inu  ERC20 Token
    https://t.me/DasherInuERC20
*/
...
contract Dasher is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x00039BA0D296123AB3c5A063030b2aae826eaE18); // Marketing Address
    address payable public multiSigAddress = payable(0xd925e419b4777dFEd65dB9eE3DB493BD64Ff3683); // Multisig Address
    address payable public devAddress = payable(0xd925e419b4777dFEd65dB9eE3DB493BD64Ff3683); // Dev Address
    address payable public liquidityAddress = payable(0xd925e419b4777dFEd65dB9eE3DB493BD64Ff3683); // Liquidity Address
    ...
    string private constant _name = unicode"Dasher Inu";
    string private constant _symbol = unicode"DASHER";
