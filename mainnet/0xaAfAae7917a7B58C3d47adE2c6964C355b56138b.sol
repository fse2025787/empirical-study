...
contract PrePayTechnoAndChill is Ownable, ERC721A, PaymentSplitter {
    ...
    //Constructor
    constructor()
    ERC721A("Prepay Techno And Chill", "Prepay_TACPass") 
    ...
    *
    * @param _prepayPrice the new prepay price 
    */
    function setPreOrderPrice(uint _prepayPrice) external onlyOwner {
