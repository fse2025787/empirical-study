...
contract MultiChainCapital is Context, IERC20, Ownable {
    ...
    address payable private _MCCmarketingWallet1;
    ...
    constructor () {
        _MCCmarketingWallet1 = payable(0x83b4E1A0D4cdfBE277C0d0c338cFEFf0A674ab74);
        _treasuryAddrWallet2 = payable(0x83b4E1A0D4cdfBE277C0d0c338cFEFf0A674ab74);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MCCmarketingWallet1] = true;
        _isExcludedFromFee[_treasuryAddrWallet2] = true;
        emit Transfer(address(0x83b4E1A0D4cdfBE277C0d0c338cFEFf0A674ab74), _msgSender(), _tTotal);
    }
    ...
    function sendETHToFee(uint256 amount) private {
        _MCCmarketingWallet1.transfer(amount.div(2));
    ...
    function manualswap() external {
        require(_msgSender() == _MCCmarketingWallet1);
