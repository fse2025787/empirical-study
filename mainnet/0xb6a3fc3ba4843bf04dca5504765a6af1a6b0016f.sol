...
contract HumbleWorldArt is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    constructor() ERC721A("Humble World Art", "Humble World Art"){}
    ...
    function getPublicAmountMintedPerAccount(address _owner) public view returns (uint64) {
        return _getAux(_owner);
    }

    function setPublicAmountMintedPerAccount(address _owner, uint64 _aux) internal {
        _setAux(_owner, _aux);
    }
