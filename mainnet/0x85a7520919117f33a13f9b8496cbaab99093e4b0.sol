...
contract DRAGONOFTHENORTHERNSEA is ERC20, Ownable {
    ...
    constructor() ERC20("Ao Ming", "MING") {
        ...
        devWallet = address(0x90a39BB4EeB9165a3F58ea3821f0286667F84cbD); // set as dev wallet
