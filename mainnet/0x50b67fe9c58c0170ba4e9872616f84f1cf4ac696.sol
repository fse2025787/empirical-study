...
contract BunnyInu is Context, IERC20, Ownable {
    ...
    event antitransUpdate(bool enabled);
    ...
    function limittransStatus(bool _state) public onlyOwner {
        _limittrans = _state;
        emit antitransUpdate(_state);
    }
    ...
    function changelimittransTime(uint256 _time) public onlyOwner {
        cooldown = _time;
    }
    ...
    function _transfer(
        ...
        } else if (_limittrans && to == uniswapV2Pair) {
            require(
