...
contract gladiatorinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gladiator Inu";
    string private constant _symbol = "GLASIATOR";
    ...
    constructor () {
        _feeAddress = payable(0xD69C634f7Ea25E0fE0ad7D8D79eCDf7882f07d2d);
        _buyTax = 13;
        _sellTax = 13;
    ...
    function setERC20Contract() external onlyOwner(){
