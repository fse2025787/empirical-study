...
contract BitNinjas is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdZWjyWbhPTzn6PQhHqaAs1iKWXppLqWFDgUwRrsmBApd";
    ...
    constructor(
    ) ERC721A("Bit-Ninjas", "BN", 100, maxSupply) {
    }
