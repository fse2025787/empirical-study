...
contract hi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "hi";
    string private constant _symbol = "hi";
    ...
    address payable private _marketingAddress = payable(0x3295ecc581feF8f5041Da17a0B8B312cF64BC8d5);
    ...
    uint256 public _maxTxAmount = 1000000000000 * 10**9; //1.0
