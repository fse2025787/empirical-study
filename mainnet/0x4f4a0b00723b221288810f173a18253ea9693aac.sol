...
contract $8s is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "8s";
    string private _symbol = "8s";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9b2204444637D275b4F69a7AaF27F79189553f63);
    address payable public teamWalletAddress = payable(0x9b2204444637D275b4F69a7AaF27F79189553f63);

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public addressDev = 0x9b2204444637D275b4F69a7AaF27F79189553f63;
