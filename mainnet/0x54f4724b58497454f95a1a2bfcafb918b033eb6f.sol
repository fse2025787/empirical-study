...
contract TheOfficialAzukiApe is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Official Azuki Ape", "AA") {
  ...
  {
       if(_supply < 300 && maxTokensPerWallet == 6) {
           return 6;
       } 
       else if (_supply < 300 &&  maxTokensPerWallet != 6){
           return maxTokensPerWallet;
       }
       else if (_supply <= maxSupply && maxTokensPerWallet == 6){
           return 100;
       }
        else if (_supply <= maxSupply && maxTokensPerWallet != 6){
           return maxTokensPerWallet;
