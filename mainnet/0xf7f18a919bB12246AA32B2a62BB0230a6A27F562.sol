...
contract EightBitLootBox is ERC1155, ERC2981, ReentrancyGuard, Ownable, Pausable {
    ...
    mapping(address => bool) public hasAirdropRole;
    ...
    constructor() ERC1155("https://eightbit.me/api/lootbox/{id}") {
        ...
        hasAirdropRole[msg.sender] = true;
    }
    ...
    function airdrop(
        ...
        require(hasAirdropRole[msg.sender], "EightBitLootBox#airdrop: REQUIRES_AIRDROP_ROLE");
     ...
     * *** ONLY OWNER ***
     *
     * @notice set or update airdrop role
     */
    function setAirdropRole(address _address, bool _hasRole) external onlyOwner {
        hasAirdropRole[_address] = _hasRole;
    }
