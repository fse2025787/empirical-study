...
contract TENGOKU is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.1 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_MINTS = 1000;
    string public baseURI = "https://droaqyb4mp3w7.cloudfront.net/incubation/metadata/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("TENGOKU SPACE", "TENGOKU", MAX_MINTS, MAX_SUPPLY) {  
    }
