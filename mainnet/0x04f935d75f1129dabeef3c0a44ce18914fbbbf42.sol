...
Eren, like all others with the power of the Titans, must physically harm himself (or suffer some kind of injury) 
in order to transform into his Titan form and redistribution to all holders his life with 

100% liq locked and renounced 
50% burned
5% redistributed 
0 dev token, 0 hiden tax 
*/
// 
...
contract ErenYeagerInu is Context, IERC20, Ownable {
    ...
    //initial token
    string private _name = 't.me/ErenYeagerInu';
    string private _symbol = 'EYI';
