...
contract Propellerhead is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Propellerhead() {
        ...
        name = "Propellerhead";                                   // Set the name for display purposes (CHANGE THIS)
