...
/**
    ...
    KICHIRO - The Lucky Son

    片工亡廾工尺回 - ㄒ卄乇　ㄥㄩ匚Ҝㄚ　丂ㄖ几
...
contract Kichiro is Context, IERC20, Ownable {

    using SafeMath for uint256;
    //naming
    string private constant _name = "Kichiro";
    string private constant _symbol = "KICH";
    ...
    address payable private _developmentAddress = payable(0x9eDE184CC31f02f381468D6e805071a714772090);
    address payable private _marketingAddress = payable(0x9eDE184CC31f02f381468D6e805071a714772090);
