...
contract ARB is Context, IERC20, Ownable {
    ...
    string private _name = "ARB token";
    ...
    address public marketingWallet = 0xf250e61eBcABCb53Ae2e5e764b206cFdaD1DeBd5;
    ...
    uint256 private _tTotal = 90000000 * (10**18);
    ...
    function swapTokensForLiquidity(uint256 newAmount) external onlyOwner() {
    ...
    function decreaseTotalFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) external onlyOwner() {
