...
/**
    ...
    Telegram: https://t.me/HalloweenProtocolETH
*/
...
contract HalloweenProtocol is Context, IERC20, Ownable {
    ...
    address payable public multiSigAddress = payable(0x1A7E38Cf09B39efbf9271E3713D20Ab28188818a); // Marketing Address
    address payable public devAddress = payable(0x1A7E38Cf09B39efbf9271E3713D20Ab28188818a); // Dev Address
    address payable public liquidityAddress = payable(0x1A7E38Cf09B39efbf9271E3713D20Ab28188818a); // Liquidity Address
    ...
    string private constant _name = unicode"Halloween Protocol";
    string private constant _symbol = unicode"HALP";
