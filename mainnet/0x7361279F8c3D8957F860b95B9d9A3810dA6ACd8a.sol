...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8760035a98207F805888beB1C38ea952B0414131];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 7, 3322) { }
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSVkjcFAFCsPvxPspgiGcKKdAvoy2ok9puQS3PkaM9ayq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3322");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3322");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3322");
...
// File: contracts/MoofiesContract.sol
//

pragma solidity ^0.8.0;

contract MoofiesContract is RamppERC721A {
    constructor() RamppERC721A("Moofies", "MOO"){}
}
