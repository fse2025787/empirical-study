...
/**
 * @title beepbeepboopboop contract
...
contract beepbeepboopboop is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI;
    uint256 public price = 0.019 ether;
    uint256 public maxPerTx = 20;
    uint256 public maxPerWallet = 10000;
    uint256 public totalFree = 1000;
    uint256 public maxSupply = 10000;
    uint256 public nextOwnerToExplicitlySet;
    bool public mintEnabled;

    constructor() ERC721A("beepbeepboopboop", "BEEP") {}
    ...
    function mint(uint256 amt) external payable {
        ...
        require(
            ...
            "No more beepbeepboopboop"
        );
        require(
            mintEnabled,
            "Minting is not live yet, hold on beepbeepboopboop."
        );
        require(
    ...
    function _setOwnersExplicit(uint256 quantity) internal {
        ...
        require(
            _nextOwnerToExplicitlySet < currentIndex,
