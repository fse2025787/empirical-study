...
contract UpOnly is ERC721, Ownable, ReentrancyGuard {
    ...
    string constant private ERROR_TRANSFER = "This NFT cannot be transferred. It must be sold for a higher price.";
    ...
    //
    // Transfer functions disabled. Use list/buy.
    //

    function transferFrom(address, address, uint256) public virtual override {
        require(false, ERROR_TRANSFER);
    }
