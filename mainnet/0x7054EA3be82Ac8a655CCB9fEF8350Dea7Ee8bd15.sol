...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x566917DB5B793B77E70a3070584ba5358179518c];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x566917DB5B793B77E70a3070584ba5358179518c;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRnHVVV31kscsJfCr6PYH2Ej5z8msAEQyE2kaWePK5Dcg/";
...
// File: contracts/X10KItemsContract.sol
//

pragma solidity ^0.8.0;

contract X10KItemsContract is RamppERC721A {
    constructor() RamppERC721A("10K Items", "10K"){}
}
