...
contract PigToken is Context, IERC20, Ownable {
    ...
    string private _name = "FaceDao Token";
    string private _symbol = "FACE";
    ...
    address burnAddress = 0x8888888888888888888888888888888888888888;
    ...
    constructor () public {
        ...
        _isExcludedFromFee[address(0xcFf09971465C2c836326fF4cd68451c31D0F6531)] = true;
    ...
    function includeInReward(address account) external onlyOwner() {
        ...
        emit Transfer(sender, burnAddress, tLiquidity);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        return (tTransferAmount, tFee, tFee);
    }
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 currentRate =  _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
        _rOwned[address(burnAddress)] = _rOwned[address(burnAddress)].add(rLiquidity);
        if(_isExcluded[address(burnAddress)])
            _tOwned[address(burnAddress)] = _tOwned[address(burnAddress)].add(tLiquidity);
