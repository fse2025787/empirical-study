...
contract EthRepRen is ERC721A, Ownable {
    uint256 MAX_MINTS = 5;
    uint256 maxSupply = 4000;
    uint256 public mintRate = 0 ether;
    bool public paused = false;
    string public baseExtension = ".json";
    string public baseURI = "ipfs://QmbWu7MVJievdGKxzvdfvw2BhhssaTUaegmY36BUrb6aSr/";

    constructor(string memory _name, string memory _symbol) ERC721A("ETHEREUM RENEGADE LIZARDS", "ELIZ") {}
