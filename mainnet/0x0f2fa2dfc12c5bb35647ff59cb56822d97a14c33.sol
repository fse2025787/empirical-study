...
contract Flappy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flappy";
    string private constant _symbol = "FLAP";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7e8B23b1B969E8B0F1847f779ecd9B50fD2F6e5B);
    address payable private _marketingAddress = payable(0xcC3a5F6496a8FDad821d235745d404C6B26EAAE0);
    ...
    constructor () {
        ...
        emit Transfer(address(0xcC3a5F6496a8FDad821d235745d404C6B26EAAE0), _msgSender(), _tTotal);
    }
