...
/*
 * @title Bitcoin Legend Token
 * @dev Burnable ERC20 standard Token
 */
contract BitcoinLegend is BurnableToken, StandardToken {
  string public constant name = "BITCOIN LEGEND"; // solium-disable-line uppercase
  string public constant symbol = "BCL"; // solium-disable-line uppercase
