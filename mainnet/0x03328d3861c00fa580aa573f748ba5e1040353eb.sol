...
contract Theory is Ownable, ERC20 {
    ...
    address public developmentWallet = 0x3942e5D35715BdD8AAB3aA623c68849297d349Dc;
    ...
    constructor() ERC20("Theory", "THEORY") {
        _mint(msg.sender, (121212121212 * 10**decimals()));
