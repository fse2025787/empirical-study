...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) internal virtual { if (isExcluded[from] == false) {
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(isTransferEnabled==true,"transfer is in locked state");
        }
...
contract THENCOIN is ERC20, ERC20Burnable {



    constructor() ERC20("THE N COIN", "TNC") {
    ...
    owner only
    if value is true, everyone can make transfer, if it's false only owner, excluded addresses can transfer.
    **/
