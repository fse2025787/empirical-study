...
60% token were burnt to destory the stupidity. Constant burning follows.
Brace yourself, blob is coming
*/
...
contract BlobIsComing is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Stupid and cloddish";
