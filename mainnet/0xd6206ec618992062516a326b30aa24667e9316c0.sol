...
contract LunaTwoPointZero is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Luna2.0";
    string private constant _symbol = "LUNA2.0";
    ...
    address payable private _marketingAddress = payable(0x0F665Ad888050362048AAe1B2B3eFA5210191707);
