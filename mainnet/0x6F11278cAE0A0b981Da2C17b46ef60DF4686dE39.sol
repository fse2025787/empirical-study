...
pragma solidity ^0.8.13;
 ...
 // Default NFT setup
 // Token indexing globally and by owner, total supply
 // Allows to get owner of contract and transfer ownership
 // Allows to pause mint and transfer
 // To be able to convert integers to strings
