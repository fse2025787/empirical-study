...
contract Cuck is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cuck";
    string private constant _symbol = "$CUCK";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5913FA0880dA4EaA6b86532409480f435b1fA870);
        _feeAddrWallet2 = payable(0x4c065EA611C39B629F7520c2022C422806BF7Eb4);
