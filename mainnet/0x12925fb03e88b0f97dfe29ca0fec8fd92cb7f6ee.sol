...
With the market sentiment returning to a time of early where its tough and hopeless, but $HOPI bring us hopes. Spider Woman appears as a wise, old woman who guides us to wisdom and knowledge, we will never lose our faith! Join us in this $HOPI stay strong and bring the powerful energy to the cryptoworld. 
...
T.me/spidergrandmother

https://medium.com/@spidergrandmother1/spider-grandmother-15b387f59fe6
**/
...
contract SpiderGrandmother is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6666666 * 10**8;
    ...
    string private constant _name = "Spider Grandmother";
    string private constant _symbol = "HOPI";
    ...
    uint256 private _maxWalletSize = 40000 * 10**8;
