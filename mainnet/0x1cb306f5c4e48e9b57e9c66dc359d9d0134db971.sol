...
contract ShibCoke is ERC20, Ownable {
    ...
    constructor() ERC20("ShibCoke", "SBC") {
        ...
        maxWallet = 2000000 * 1e18; // Max Wallet 2%
		...
		marketingWallet = address(0x813Ba8e14b5475b4338368671013b5ACB02ca5a4); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x813Ba8e14b5475b4338368671013b5ACB02ca5a4)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x813Ba8e14b5475b4338368671013b5ACB02ca5a4)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x813Ba8e14b5475b4338368671013b5ACB02ca5a4)] = true;
    ...
    function updateMaxWallet() external onlyOwner {
        maxWallet = 4000000 * 1e18; // Max Wallet 5%
    }
