...
contract PassiveStrategy {
    ...
    function setBaseThreshold(int24 _baseThreshold) external onlyGovernance returns(int24 baseThreshold_){
        baseThreshold_ = _baseThreshold;
        baseThreshold = _baseThreshold;
        _checkThreshold(baseThreshold, tickSpacing);
    }

    function setLimitThreshold(int24 _limitThreshold) external onlyGovernance returns(int24 limitThreshold_){
        limitThreshold_ = _limitThreshold;
    ...
    function setMinTickMove(int24 _minTickMove) external onlyGovernance returns(int24 minTickMove_){
        require(minTickMove >= 0, "minTickMove must be >= 0");
        minTickMove = _minTickMove;
        minTickMove_ = _minTickMove;
    }

    function setMaxTwapDeviation(int24 _deviation) external onlyGovernance returns(int24 maxTwapDeviation_){
        require(maxTwapDeviation >= 0, "maxTwapDeviation must be >= 0");
        maxTwapDeviation = _deviation;
        maxTwapDeviation_ = _deviation;
    }
