...
contract  FlokiTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Tsuka";
    string private constant _symbol = "FTSUKA";
    ...
    uint256 private _maxWalletSize = 1_000_000 * 10**9;
