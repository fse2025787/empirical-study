...
// File contracts/CeaserToken.sol
...
contract CeaserToken is ERC20, BasicAccessController, ERC20Permit, ERC20Votes {
    constructor(address _addressTreasury) ERC20("Ceaser", "CEA") ERC20Permit("CeaserToken") {
...
// File contracts/CeaserLeverageEngine.sol
...
contract CeaserLeverageEngine is AccessController, ReentrancyGuardUpgradeable, UUPSUpgradeable, PausableUpgradeable {
    ...
    CeaserPositionToken internal _positionToken;
    CeaserParameterStore internal _parameterStore;
    CeaserToken internal _archToken;
    ...
    function setDependencies(
        ...
        _positionToken = CeaserPositionToken(addressPositionToken);
        ...
        _archToken = CeaserToken(addressArchToken);
