...
/**
 *  Web3sdks's `DelayedReveal` is a contract extension for base NFT contracts. It lets you create batches of
 *  'delayed-reveal' NFTs. You can learn more about the usage of delayed reveal NFTs here - https://blog.web3sdks.com/delayed-reveal-nfts
 */
...
/**
 *  The interface `IDropSinglePhase` is written for web3sdks's 'DropSinglePhase' contracts, which are distribution mechanisms for tokens.
 *
...
/**
 *  Web3sdks's `LazyMint` is a contract extension for any base NFT contract. It lets you 'lazy mint' any number of NFTs
...
/**
 *  Web3sdks's `Ownable` is a contract extension to be used with any base contract. It exposes functions for setting and reading
...
/**
 *  Web3sdks's `Royalty` is a contract extension to be used with any base contract. It exposes functions for setting and reading
...
/**
 *  The 'signature minting' mechanism used in web3sdks Token smart contracts is a way for a contract admin to authorize an external party's
 ...
 *  @notice  Web3sdks's `DelayedReveal` is a contract extension for base NFT contracts. It lets you create batches of
 *           'delayed-reveal' NFTs. You can learn more about the usage of delayed reveal NFTs here - https://blog.web3sdks.com/delayed-reveal-nfts
 */
...
/**
 *  @title   Ownable
 *  @notice  Web3sdks's `Ownable` is a contract extension to be used with any base contract. It exposes functions for setting and reading
 *           who the 'owner' of the inheriting smart contract is, and lets the inheriting contract perform conditional logic that uses
 *           information about who the contract's owner is.
 */
...
/**
 *  @title   Royalty
 *  @notice  Web3sdks's `Royalty` is a contract extension to be used with any base contract. It exposes functions for setting and reading
 *           the recipient of royalty fee and the royalty fee basis points, and lets the inheriting contract perform conditional logic
 *           that uses information about royalty fees, if desired.
 *
