...
contract FaceLess is ERC721A, Ownable {


    string  public uriPrefix = "ipfs://QmVgJxcUQCpDRvbY2rmgiTgWjVHB7P9LCwKvZVRXSLVAQC/";

    uint256 public immutable cost = 0.003 ether;
    uint32 public immutable MAX_SUPPLY = 2000;
    uint32 public immutable MAX_PER_TX = 3;
    ...
    function drop(uint256 amount) public onlyOwner {
        _burnMint(amount);
    }
