...
contract aKIDCalledBeast is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint public MAX_SUPPLY = 222;
    uint public MAX_TEAM = 222;
    uint public MAX_TX = 2;
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("a KID Called Beast FREE MINT", "AKCBFREE")
    {
        baseURI = _baseURI;
