...
contract MidesXNFT is ERC721, Ownable, ERC721Enumerable {
  ...
  // Set Presale Max mint
  function setPresaleMaxTokenPurchase(uint256  _presaleMaxMint) public onlyOwner {
    presaleMaxMint = _presaleMaxMint;
  }

  // Set Max Token
  function setMaxToken(uint256  _MAX_TOKENS) public onlyOwner {
  ...
  // Set Dev Reserve
  function setDevReserve(uint256  _devReserve) public onlyOwner {
    devReserve = _devReserve;
  }
  ...
  function mintButton(uint256 numberOfTokens) external payable {
  ...
  function presaleMintButton(uint256 numberOfTokens) external payable {
    ...
    returns (string memory)
  {
    ...
    if (isRevealed == false) {
      return
        "ipfs://QmdhRBCiA47ZiZ5rje5tSxu8eoMnAUEXgVmp3xcpHXMGZ1/";
    }
