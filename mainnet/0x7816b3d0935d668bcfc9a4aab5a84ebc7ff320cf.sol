...
// File contracts/TokemakBribe.sol


pragma solidity 0.8.12;

contract TokemakBribe is BribeBase {
    address[] public gauges;
    mapping(address => uint256) public indexOfGauge;

    constructor(address _BRIBE_VAULT) BribeBase(_BRIBE_VAULT, "TOKEMAK") {}
    ...
    function setGaugeProposals(
        ...
        uint256 deadlineLen = deadlines.length;
        require(gaugeLen != 0, "Invalid gauges_");
        require(gaugeLen == deadlineLen, "Arrays length mismatch");
