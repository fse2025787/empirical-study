...
/**
 * @title NativePrediction
 */
contract NativePrediction is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(_operatorAddress != address(0), "Operator cannot be zero address");
    ...
    function claimable(uint256 epoch, address user) public view returns (bool) {
        ...
        if (!round.oracleCalled || betInfo.amount == 0 || betInfo.claimed) {
            return false;
        }
        if (
            round.bullAmount == 0 ||
