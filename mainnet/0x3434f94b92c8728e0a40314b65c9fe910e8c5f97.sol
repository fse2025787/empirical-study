...
contract PixelScapes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRvkVgRFgQskQbaepBueYaZYBGmjf8aYm4ebUhoVtF559";
    ...
    constructor(
    ) ERC721A("Pixel-Scapes", "PXL", 100, maxSupply) {
    }
