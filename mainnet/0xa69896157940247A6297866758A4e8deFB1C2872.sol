...
// 
// https://web.wechat.com/Okamikosis.ETH
// https://t.me/OkamikosisETH
// https://www.zhihu.com/
// https://okamikosiseth.com
...
contract ERC2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Okamikosis";////////////////
    ...
    address payable private _developmentAddress = payable(0x5709Da886fe06f826dB6b4bd595775B44F7e5176);////////////////////
    address payable private _marketingAddress = payable(0x5709Da886fe06f826dB6b4bd595775B44F7e5176);/////////////////////
