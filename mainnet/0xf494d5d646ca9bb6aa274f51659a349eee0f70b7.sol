...
contract ZATIRKAV is Context, IERC20, Ownable {
    ...
    Taxes private _taxes = Taxes(0,5,0,6);
    ...
    string private constant _name = "ZATIRKAV";
    string private constant _symbol = "ZATV";
    ...
    constructor () {
        _feeAddrWallet = payable(0x11E40CAa8B26381E21ae6dBc8296dFDD562c3877);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxWalletSize = 5_000_000_000 * 10**9;
        tradingOpen = true;
