...
//https://t.me/BaycTamaEth
//https://www.BaycTama.com


// Seeing the hype with the mixed names, 
// and one of the most popular one SHIBTAMA, 
// it was only a matter time before someone launched TamaShiba. Well here we are, ready to fucking go.
...
contract BAYCTAMA  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "BAYCTAMA";                                          
    string private _symbol = "$BAYCTAMA";                                           
    ...
    uint256 public _maxTxAmount = _tTotal.div(1).div(50);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0xe5F500058DE20e27cBfdf5b9E6E94B17cb2E31cB);
    ...
    function setSellersFee(uint256 marketingFee4Sellers) external onlyOwner() {
