...
contract BitSelectProtegido is StandardToken {
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function BitSelectProtegido(
        ...
        name = "Bit Select Protegido";                                   // Set the name for display purposes
        decimals = 10;                            // Amount of decimals for display purposes
        symbol = "BSP";                               // Set the symbol for display purposes
    }
