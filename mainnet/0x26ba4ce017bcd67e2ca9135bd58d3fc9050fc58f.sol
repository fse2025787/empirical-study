...
// File: Azur/Swap/core/interfaces/IAzurSwapV2Callee.sol

pragma solidity >=0.5.0;

interface IAzurSwapV2Callee {
    function AzurSwapV2Call(address sender, uint amount0, uint amount1, bytes calldata data) external;
}

// File: Azur/Swap/core/interfaces/IERC20.sol
...
// File: Azur/Swap/core/libraries/UQ112x112.sol
...
// File: Azur/Swap/core/libraries/Math.sol
...
// File: Azur/Swap/core/libraries/SafeMath.sol
...
// File: Azur/Swap/core/interfaces/IAzurSwapV2ERC20.sol

pragma solidity >=0.5.0;

interface IAzurSwapV2ERC20 {
    event Approval(address indexed owner, address indexed spender, uint value);
    event Transfer(address indexed from, address indexed to, uint value);
...
// File: Azur/Swap/core/AzurSwapV2ERC20.sol

pragma solidity =0.5.16;



contract AzurSwapV2ERC20 is IAzurSwapV2ERC20 {
    using SafeMath for uint;

    string public constant name = 'AzurSwap LP';
    string public constant symbol = 'Azur-LP';
...
// File: Azur/Swap/core/interfaces/IAzurSwapV2Pair.sol

pragma solidity >=0.5.0;

interface IAzurSwapV2Pair {
    event Approval(address indexed owner, address indexed spender, uint value);
    event Transfer(address indexed from, address indexed to, uint value);
...
// File: Azur/Swap/core/interfaces/IAzurSwapV2Factory.sol

pragma solidity >=0.5.0;

interface IAzurSwapV2Factory {
...
// File: Azur/Swap/core/AzurSwapV2Pair.sol
...
contract AzurSwapV2Pair is IAzurSwapV2Pair, AzurSwapV2ERC20 {
    using SafeMath  for uint;
    ...
    function initialize(address _token0, address _token1) external {
        require(msg.sender == factory, 'AzurSwapV2: FORBIDDEN'); // sufficient check
        token0 = _token0;
        token1 = _token1;
    }
...
// File: Azur/Swap/core/AzurSwapV2Factory.sol
