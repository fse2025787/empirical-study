...
contract SignArtGatewayV3 is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721HolderUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, ERC2981Upgradeable {
    ...
    function safeMint(address _to, string memory _uri, string memory _wavesAssetId, address _creatorETHaddr, uint96 _creatorRoyalties) public onlyOwner {
        uint256 tokenId = _tokenIdCounter.current();
        
        require(!nftData[_wavesAssetId].minted, "This NFT already exist");
        require(_creatorRoyalties >= 0, "Royalties cannot be negative");
        require(_creatorRoyalties <= 1000, "Royalties cannot exceed 10%");
        ...
        _setTokenRoyalty(tokenId, _creatorETHaddr, _creatorRoyalties);
