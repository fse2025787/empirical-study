...
// File: contracts/CyberDemonHeads.sol
...
contract CyberDemonHeads is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    {
        require(mintIsOpen , "isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"Soldout !");
