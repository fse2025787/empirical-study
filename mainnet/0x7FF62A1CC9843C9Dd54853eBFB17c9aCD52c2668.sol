...
// https://t.me/MessierClassic
// Group will be opened after lock & renounce to avoid fud
...
contract MessierClassic is Context, IERC20, Ownable {
    ...
    uint256 private _sellLiquidityFee = 6;
    ...
    constructor () {
        _name = "Messier Classic";
        _symbol = "M87C";
        _decimals = 9;
        _tTotal = 10000000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 1000000 * 10 ** _decimals;
        _marketingWalletAddress = 0xCc0175c13e5aC96d7932DC46f38398540035B02c;
