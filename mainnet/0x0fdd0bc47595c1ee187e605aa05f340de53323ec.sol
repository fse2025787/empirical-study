...
// File: contracts/chelbasket.sol

pragma solidity >=0.7.0 <0.9.0;



contract Chelbasket is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public preSaleMaxSupply = 10000;
    uint256 public maxMintAmountPresale = 1000;
    uint256 public maxMintAmount = 1000;
    uint256 public nftPerAddressLimitPresale = 1000;
    uint256 public nftPerAddressLimit = 1000;
    uint256 public preSaleDate = 1653231598;
    uint256 public preSaleEndDate = 1653231599;
    uint256 public publicSaleDate = 1653231600;
    ...
    function gift_new(uint256 _mintAmount, address destination) public onlyOwner {
        require(_mintAmount > 0, "need to mint at least 1 NFT");
        uint256 supply = totalSupply();
        require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
