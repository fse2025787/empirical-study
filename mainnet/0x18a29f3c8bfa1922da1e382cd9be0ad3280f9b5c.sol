...
contract rektGhxsts is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.001666 ether;
  ...
  constructor() ERC721A("rekt Ghxsts", "RGX"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Ghxsts...");
