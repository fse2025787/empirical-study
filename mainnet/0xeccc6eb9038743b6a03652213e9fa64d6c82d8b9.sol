...
contract RyuKitsune  is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RyuKitsune";
    string constant _symbol = "RyuKitsune";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0xd27d02f72Ec0Ea58bF53047AEd5a1e2e573Ac79a; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xd27d02f72Ec0Ea58bF53047AEd5a1e2e573Ac79a;
        solor = msg.sender;
...
contract StandarToken is RyuKitsune {
    constructor() {}
}