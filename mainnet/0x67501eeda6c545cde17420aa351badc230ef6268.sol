...
contract Soda is ERC721A, Ownable {
    ...
    uint256 public maxFreePerWallet = 12;

    uint256 public totalFree = 455;
    ...
    constructor() ERC721A("Soda NFT", "Soda") {
        _safeMint(msg.sender, 1);
        setBaseURI("https://soda.blob.core.windows.net/metadata/");
    }
