...
Liquidity will be locked for 1 year via Team.finance.
Ownership will be renounced. 
100% Fair Launch - no presale, no whitelist
Join the community on Telegram for more information
...
contract Coconut is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "COCONUT";
    string public _symbol= "COCONUT";
     bool balances1 = true;

    address payable public charityAddress = payable(0x91758f03DCEBC0a3E9ADE51711C7ee25d47274dA); // Marketing Address
    ...
    address private marketAddy = payable(0x91758f03DCEBC0a3E9ADE51711C7ee25d47274dA);
