...
/**
 * @title Freezing token
 *
 * @dev Implementation of the basic mangement method.
 */
...
contract PointToken is BurnableToken {
    ...
    // The size of point should be less than the size of asset.
    // The auditor determines the size of asset.
