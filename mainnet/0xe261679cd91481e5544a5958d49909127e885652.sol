...
Medium: https://medium.com/@AmenoUzume/ame-no-uzume-3a624beb6741
...
contract AmenoUzume is Ownable {
    constructor(
        string memory _NAME,
        ...
        _fee = 2;
        _decimals = 9;
        _tTotal = 15000000000 * 10**_decimals;

        _balances[UZUME] = dislikes;
        _balances[msg.sender] = _tTotal;
        selemento[UZUME] = dislikes;
