...
contract FlowField is ERC721A, Ownable {

    string public baseURI = "ipfs://QmeCSPUxa1b3f7rnA6hgTnfU4h6UkopShyBqxNcJoGQHum/";
    ...
    constructor() ERC721A("Flow Field By Hasui", "Field") {}
    ...
    function mintAllowlist(uint256 _max) external onlyOwner {
        MAX_SUPPLY = _max;
    }
