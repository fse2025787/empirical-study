...
/**
    Trump Announcement  ERC20 Token

    “I’m going to be making a very big announcement on Tuesday, November 15th at Mar-a-Lago in Palm Beach, Florida,”
    Trump said an election-eve event in Dayton.

    https://t.me/TrumpAnnounce
*/
...
contract BIGNEWS  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x5CCaf835ea1feb615F874Cf50Bb7E2DbF5aDCCf0); // Marketing Address
    address payable public multiSigAddress = payable(0x5CCaf835ea1feb615F874Cf50Bb7E2DbF5aDCCf0); // Marketing Address
    address payable public devAddress = payable(0x7C15A516a97e5Ad9dB7Ccd23f428d67b0F9Cb7Be); // Dev Address
    address payable public liquidityAddress = payable(0x7C15A516a97e5Ad9dB7Ccd23f428d67b0F9Cb7Be); // Liquidity Address
    ...
    string private constant _name = unicode"Trump Announcement";
    string private constant _symbol = unicode"BIGNEWS";
    ...
    uint256 public _buyDevFee = 400;

    uint256 public _sellTaxFee;
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMultiSigFee = 500;
