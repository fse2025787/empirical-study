...
contract DmitryButerin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dmitry Buterin";
    string private constant _symbol = "ETHGRAND";
