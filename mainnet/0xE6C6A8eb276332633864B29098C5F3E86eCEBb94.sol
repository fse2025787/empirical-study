...
contract PawnShop is Ownable, IERC721Receiver {
    ...
    uint256 monthlyFee = 563; // 5.63%
    uint256 originFee = 860; // 8.6%
    ...
    function openALoan(
        ...
        ERC20(usdtAddress).safeTransfer(msg.sender, _amount * 10**ERC20(usdtAddress).decimals());
        totalCnt++;
        loans[totalCnt] = Loan(
            totalCnt,
            msg.sender,
    ...
    function updateContractDate(uint256 _id) public {
        ...
        ERC20(usdtAddress).safeTransferFrom(msg.sender, address(this), fee);
