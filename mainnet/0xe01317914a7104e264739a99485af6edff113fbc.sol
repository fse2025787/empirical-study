...
contract RareAsset is StandardToken {
  ...
  bytes public attributes;
  address public creator;
  uint public decimals = 0;

  function RareAsset (bytes assetname, uint supply, bytes ipfsHash_, bytes attrHash, address creator_) public payable {
    name = assetname;
    totalSupply_ = supply;
    ipfsHash = ipfsHash_;
    attributes = attrHash;
    creator = creator_;
    balances[creator_] = supply;
  }
}
