...
contract STFUDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Simp Traders Frowned Upon DAO";
    string private constant _symbol = "STFU DAO";
    ...
    address payable public marketingWallet = payable(0x6471289A0C114DfF90Bacc89eD287C7cF0c3e4E4);
    address payable public treasury = payable(0xee96A72E5A48e8e0Fa29EeB5Db8DE20d9446Ada1);
