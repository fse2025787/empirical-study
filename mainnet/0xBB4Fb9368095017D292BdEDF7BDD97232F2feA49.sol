...
//*********************************************************************//
//
//  _    ___                  _    __      ____                     ______      __                    ______      ____          __  _           
// | |  / (_)___  ____  __  _| |  / /_  __/ / /___  __________     / ____/___ _/ /___ __  ____  __   / ____/___  / / /__  _____/ /_(_)___  ____ 
// | | / / / __ \/ __ \/ / / / | / / / / / / __/ / / / ___/ _ \   / / __/ __ `/ / __ `/ |/_/ / / /  / /   / __ \/ / / _ \/ ___/ __/ / __ \/ __ \
// | |/ / / / / / / / / /_/ /| |/ / /_/ / / /_/ /_/ / /  /  __/  / /_/ / /_/ / / /_/ />  </ /_/ /  / /___/ /_/ / / /  __/ /__/ /_/ / /_/ / / / /
// |___/_/_/ /_/_/ /_/\__, / |___/\__,_/_/\__/\__,_/_/   \___/   \____/\__,_/_/\__,_/_/|_|\__, /   \____/\____/_/_/\___/\___/\__/_/\____/_/ /_/ 
//                   /____/                                                              /____/                                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 98 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmP7HAyDzuf6SznpChTfc9kR3r26djLu6qF3bWEKwmXyPk/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 98");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 98");
...
// File: contracts/VinnyVultureGalaxyCollectionContract.sol
//

pragma solidity ^0.8.0;

contract VinnyVultureGalaxyCollectionContract is RamppERC721A {
    constructor() RamppERC721A("VinnyVulture Galaxy Collection", "VVGC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/VDmyjeRNJjnkfPRnJ6NW/contract-metadata";
    }
}
