...
contract QR is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "QR";
    string private _symbol = "QR";
    ...
    uint256 private _totalSupply = (100000000 * 10**4) * 8**_decimals; //1T supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0x401092cFBf7e292a7CAf3e624ed5Bec5948ebce9);
