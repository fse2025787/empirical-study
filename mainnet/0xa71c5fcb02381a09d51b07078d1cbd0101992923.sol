...
contract LMACC is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmap9m1utdpVKeRtUJ5ckx4XqJWTZf4Nq1TPSYKvKieQTE";
    ...
    constructor(
    ) ERC721A("Lil Mutant Grandpa Country Club", "LIL", 100, maxSupply) {
    }
