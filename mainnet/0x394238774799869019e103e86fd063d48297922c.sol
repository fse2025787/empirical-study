...
// File: interfaces/IHI-PLANET.sol
...
// File: interfaces/IHI-PLANET-UTIL.sol
...
interface IHI_PLANET_UTIL is IHIPLANET {
     ...
     */
    function getMintTimeDiff(uint256 _policyIndex)
        external
        view
...
contract HIPLANET is ERC721AQueryable, Ownable, ReentrancyGuard, IHIPLANET {
    ...
    constructor(address _proxy) ERC721A("HI PLANET NFT", "HPN") {
        // HIPLANETNFT
        // HPN
