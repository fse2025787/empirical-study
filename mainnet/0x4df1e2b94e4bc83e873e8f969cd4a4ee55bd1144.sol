...
contract MiniWomen is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmRXWZG7Zf1L78RL8pmJFzA71YH5DF69o9HPAh2vSRkipi";

  uint256 public  maxSupply = 3333;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  FREE_MINTS_PER_TX = 2;
  uint256 public  PUBLIC_SALE_PRICE = 0.002 ether;
  uint256 public  TOTAL_FREE_MINTS = 1800;
  bool public isPublicSaleActive = false;

  constructor() ERC721A("MiniWomen", "MINI") {
