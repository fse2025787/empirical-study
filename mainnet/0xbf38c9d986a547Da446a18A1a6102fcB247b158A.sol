...
contract AllowedWorm is ERC721, Ownable {
  ...
  constructor(bytes32 _merkleRoot) ERC721("worm_merkle", "wm") {
  ...
  function _setMerkleRoot(bytes32 _merkleRoot) public onlyOwner {
    merkleRoot = _merkleRoot;
  }
