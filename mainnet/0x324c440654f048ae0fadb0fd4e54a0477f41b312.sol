...
contract WaterTokenStaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // Water Token Contract Address
    address public constant tokenAddress = 0x47651CC7e0ba5850b3a8280614555abdd42fDeaD;
    ...
    uint private constant stakingAndDaoTokens = 1000000e18;   // 1,000,000 Water Token will be staked by owner
