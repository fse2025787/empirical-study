...
contract ThuggiesGang is ERC721A, Ownable {
    ...
    uint private mintCost_ = 0.015 ether;
    ...
    constructor() ERC721A('Thuggies Gang', 'TG') {
        maxTotalTokens = 2222;
    ...
    function publicSaleMint(uint256 number) public payable {
        ...
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 0.015 ether for each NFT)");
    ...
    function withdraw() public onlyOwner {
        ...
        _withdraw(payable(0x5Ce2cca46602dfB47c02e2929E7b130e667Dd108), balance); 
    }
