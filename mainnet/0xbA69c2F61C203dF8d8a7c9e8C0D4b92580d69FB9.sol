...
contract AyahuascaCats is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 7777;
    uint256 public immutable supply = 7777;
    ...
    address[] public withdrawAddresses = [0xEFd80E35Fcd8B33c25a8875eb07C72A8c08a50B8, 0x88bbebAE3dbE4Ed2835563c42bF6a30083fF3858, 0x67f0b63342dD642e3Be3B9618AcFA2c06E8C389c, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [35, 30, 30, 5];

    bytes32 public merkleRoot = 0x9de2c09225630e502c9fb783214c95e5d5bd346b3044417a7017e6ec37879b10;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x67f0b63342dD642e3Be3B9618AcFA2c06E8C389c, _royaltyAmount);
    }
