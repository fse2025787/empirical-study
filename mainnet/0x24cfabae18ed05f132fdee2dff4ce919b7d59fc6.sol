...
contract Horizon is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWW78vmtyNtKRzdMEfHpLLaXeDBT9xwz7MBV1jEShjXuu";
    ...
    constructor(
    ) ERC721A("Horizon by Elizabeth", "Horizon", 100, maxSupply) {
    }
