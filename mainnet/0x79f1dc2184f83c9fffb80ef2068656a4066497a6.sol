...
contract LASM is ERC20, ERC20Burnable, Ownable {
    ...
    address public constant manager             = address(0x95c6c446ca29205c9F20Ec7534DC15A095F7d192);
    address public teamDevWalletAddress         = address(0x02Bf0D509547830204C33314755CfE016957E65f);
    address public buyBackWalletAddress         = address(0x5278af973E3776EC35a72dEAd67cc293a70C889f);

    // vesting wallets
    address public constant locked              = address(0x5A1b042a1385A9793aC36c010dA36Ef710f6881c);
    address public constant team                = address(0x05D6D4C0679E0476C3D3c87EE5675a9CeEb94baF);
    address public constant partners            = address(0xe72649122B096F32ff013890d49f199feeB0899E);
    address public constant marketing           = address(0xe7075Cc5B25823b6fAaf11C92d753A9E788aB20B);
    address public constant development         = address(0x56169c77C6B3175C839B17f180d0817c92a87c2d);
    address public constant stakingRewards      = address(0x79f9CfC743852944DECac99368A93153184a9cC7);
    address public constant airdrop             = address(0x66b8A8ba7041A53DF5A09c77D9016F4Ea286d414);
    address public constant nftAirdropWallet    = address(0x0D1ec162F2B10515C909eAbD039967Ab756a7b1E);
    ...
    // constructor() ERC20("LasMeta Ticker", "LASM") {
