...
// 
/*
The merge made Shiba even greater.
https://twitter.com/MergeShiba
https://t.me/MergeShiba
https://mergeshiba.com
*/
...
contract MergeShiba is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MergeShiba", "MergeShiba") {
        ...
        maxTransactionBuyAmount = totalSupply * 1 / 100; // 1% maxTransactionAmountTxn
        maxTransactionSellAmount = totalSupply * 1 / 100; // 1% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x0cd69434e11d2D4CC5F79135A56d97e691566D80); // set as marketing wallet
        ...
        lock(owner(), true);
        lock(address(this), true);
        lock(address(uniswapV2Pair), true);
    ...
    function lock(address account, bool excluded) public onlyOwner {
