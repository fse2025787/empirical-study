...
// File: contracts/Olympian lands.sol
...
contract Olympus_Lands is Ownable, ERC721A {
    ...
    string private revealedURI = "ipfs://QmXJK7EBR5wKJbLBeCW8pJfPSNdfAaMD4Qoahh2Jycgzye/";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string private CONTRACT_URI = "ipfs://RHZ2RXVRGU59WG8VI7EQI72IAGY6HGD667/";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Olympus Lands", "OPLD") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 150, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xc7D227B5D96bCe305F0db14642bdb626A2d41B78");
