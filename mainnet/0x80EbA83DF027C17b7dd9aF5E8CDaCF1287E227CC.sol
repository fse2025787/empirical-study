...
// NFTs are minted at create time, cannot be minted after
// Owner can change NFT metadata url
contract OverlordsNFT is ERC721, Owned {
  ...
  constructor(
    ...
    for (uint256 i = 1; i <= _mintCount; i++) {
      _mint(msg.sender, i); // Forgive me, t11s
    }
  }

  // Owner can change base URL
