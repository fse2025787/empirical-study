...
contract Diabolus is ERC20, Ownable {
    string private _name = unicode"Diabolus";
    string private _symbol = "666";
    ...
    address public marketingWallet = 0x38369A8589c55011fE0931A93f72820e5245632B;
    ...
    function setMW(address marketingWALLET)
        public
        onlyOwner
        returns (bool)
    {
    ...
    function setLpMarketingTaxes(uint256 lpTAX, uint256 marketingTAX)
        public
        onlyOwner
        returns (bool)
    {
        require((lpTAX+marketingTAX) <= 5, "ERC20: total tax must not be greater than 5");
        taxForLiquidity = lpTAX;
        taxForMarketing = marketingTAX;
