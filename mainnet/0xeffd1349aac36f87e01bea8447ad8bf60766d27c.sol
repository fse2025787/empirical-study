...
contract pumpndumppass is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI = "ipfs://QmZTfrPfh1jffw8FBPKAZcPQmBdEgv6fasFgSS7r6nDSkk/";
    ...
    constructor() ERC721A("pumpndumppass", "PDPASS") {
        setBaseURI("");
    ...
    /**
    * @dev MINT A FREE FUCKING PUMP + DUMP PASS
    * @param _mintAmount HOW MANY NFTS U WANT
    */
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max pumpndumppasses per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 pumpndumppasses" );
		require(s + _mintAmount <= maxFree, "Cant exceed pumpndumppass supply" );
    ...
    /**
    * @dev MINT A PUMP + DUMP PASS
    * @param _mintAmount HOW MANY NFTS U WANT
    */
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 pumpndumppasses");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more pumpndumppasses" );
        require(s + _mintAmount <= maxSupply, "Cant exceed pumpndumppass supply");
    ...
    /**
    * @dev GIFT SOME PASSES TO THE LADS YEA
    */
    ...
    */
    ...
    /**
    * @dev HOW EXPENSIVE THAT SHIT IS
    */
    ...
    */
    ...
    /**
    * @dev CHANGE THE FUCKING FREE SUPPLY
    */
    ...
    /**
    * @dev SET THE LOCATION OF THE FUCKING GIFs
    */
    ...
    /**
    * @dev YOINK THE FUNDS OUTTA HERE
    */
