...
// | |     / /__  / /_     /   | ____ ____  ____  / /______   / /_  __  __   _      _____  / /_  ____ _____ ____  ____  _______  __ ___  / /_/ /_ 
// | | /| / / _ \/ __ \   / /| |/ __ `/ _ \/ __ \/ __/ ___/  / __ \/ / / /  | | /| / / _ \/ __ \/ __ `/ __ `/ _ \/ __ \/ ___/ / / // _ \/ __/ __ \
// | |/ |/ /  __/ /_/ /  / ___ / /_/ /  __/ / / / /_(__  )  / /_/ / /_/ /   | |/ |/ /  __/ /_/ / /_/ / /_/ /  __/ / / / /__/ /_/ //  __/ /_/ / / /
// |__/|__/\___/_.___/  /_/  |_\__, /\___/_/ /_/\__/____/  /_.___/\__, /    |__/|__/\___/_.___/\__,_/\__, /\___/_/ /_/\___/\__, (_)___/\__/_/ /_/ 
//                            /____/                             /____/                             /____/                /____/                  
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x52F8d91fd06Bb980cd88205fbA2dBAea437BD53D];
  address public erc20Payable = 0x52F8d91fd06Bb980cd88205fbA2dBAea437BD53D;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.004 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeidqpwtrj3ossaiqahc3bdpqyhc2vlzg7p634mnzgr7cxpjj2cecjy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3xpoOQQa2lYvJTgAZ6it/contract-metadata";
  }
...
// File: contracts/WebAgentsContract.sol
//

pragma solidity ^0.8.0;

contract WebAgentsContract is RamppERC721A {
    constructor() RamppERC721A("Web Agents", "WEBA"){}
}
