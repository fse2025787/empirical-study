...
contract TestPusk is Ownable, ERC721A {
   ...
   mapping(address => uint256) private _mintedFreeAmount;
    ...
    constructor() ERC721A("DeathPunk", "DEATHPUNK") {
    ...
    require( _mintedFreeAmount[msg.sender] + amount <= maxFreePerWallet,"Exceeded Tx limit");
