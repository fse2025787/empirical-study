...
A peer-to-Peer algorithm which allow peg and bridge tokens between Eth and Dogecoin Chains

THe Pegg and Bridge system is auto and decentralized, powered by LilDoge mechanism - LilDoge Platform (Coming Soon)

Lildoge Token
Lildoge will be our main utility and native token on the blockchain. Future vesting, NFTs, and bridge will use LilDoge solely for the transactions keeping the token a valuable asset for all innerworkings.
...
contract LilDoge  is ERC20, Ownable{
    ...
    address public marketingWallet = 0xc4fFE06788b665FC21Ba417bF1547eF2546AE323;
    address public devWallet = 0xc4fFE06788b665FC21Ba417bF1547eF2546AE323;
    ...
    constructor() ERC20("Lildoge", "LILDOGE") {
