...
contract Akamaru is ERC20, Ownable {
    ...
    string constant private _name = "Akamaru";
    string constant private _symbol = "Kiba";
    ...
    //Fees
    uint256 private constant liquidityFee = 0;
    uint256 private constant marketingFee = 3;

    uint256 private constant sellFeeLiquidity = 0;
    uint256 private constant sellFeeMarketing = 3;

    uint256 private constant transferFee = 0;

    uint256 private constant totalBuyFee = 3;
    uint256 private constant totalSellFee = 3;

    uint256 private feeDenominator  = 100;

    address private autoLiquidityReceiver = 0x3E1eCf2B6B1410BDEFA2b4DFc19298C6C25CaA1D;
    address private marketingFeeReceiver = 0x3E1eCf2B6B1410BDEFA2b4DFc19298C6C25CaA1D;
