...
// File: contracts/OxSpaceDoodles.sol
...
contract OxSpaceDoodles is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    ) ERC721A("0xSpaceDoodles", "0xSPCDDL") {
        PRICE = price;
    ...
    address private constant payoutAddress1 =
        0xa4A54da531ED37d5F84CF0987b70E600D4B4E55b;
