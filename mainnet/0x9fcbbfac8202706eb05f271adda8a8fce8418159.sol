...
// File: browser/PollToken.sol


pragma solidity 0.6.0;


// PollToken with Governance.
contract PollToken is ERC20("PollToken", "POLL"), Ownable {
    ...
    function lockFromUpdate(uint256 _newLockFrom) public onlyOwner {
        lockFromBlock = _newLockFrom;
    }
    
     // Update the lockToBlock
    function lockToUpdate(uint256 _newLockTo) public onlyOwner {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Poll::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Poll::delegateBySig: invalid nonce");
        require(now <= expiry, "Poll::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Poll::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Poll::_writeCheckpoint: block number exceeds 32 bits");
