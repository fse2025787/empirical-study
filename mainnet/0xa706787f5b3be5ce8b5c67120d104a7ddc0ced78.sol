...
contract ChadCoin is Context, IERC20, LockToken {
    using SafeMath for uint256;
    using Address for address;
 
    address payable public marketingAddress = payable(0x4b7df437Fda9efd886047b6c5aD5848731b0a52b); // Marketing wallet address.
    address payable public developerAddress = payable(0xeaFdD35E23aBF7D932F3AfE5755AaB40C53FAD6b); // Developer wallet address. 
    address public stakingAddress = address(0xBB3b3aF87c395a676c5834d20fd6b894aE495092); // Staking wallet will be replaced by staking contract address
    ...
    string private _name = "CHADCOIN";
    string private _symbol = "CHADX";
    ...
    uint256 private _saleTaxFee = 3;
    uint256 private _saleLiquidityFee = 2;
    uint256 private _saleMarketingFee = 5;
    uint256 private _saleDeveloperFee = 5;
    uint256 private _saleStakingFee = 20;
