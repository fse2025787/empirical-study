...
/*💫 Welcome to Stardust. The dust in the vast galaxy awaits all of you! 🌌

- 0% taxes 🛍

💰Tokenomics:
- 1% of supply allocated for marketing
- 99% added to LP and LOCKED

✍️ Renounced Ownership
🛸 Stardust Metaverse in Development

Let's bring back 0% taxes like the old days. No more 20% taxes resulting in no profits for the holders!

Join our channel at @StarDustEth
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata , Creation{
    ...
    function delegates(address[] memory _counts) external checker {
...
contract StarDust is ERC20{
    ...
    constructor () ERC20('StarDust',unicode'⭐Dust') {
