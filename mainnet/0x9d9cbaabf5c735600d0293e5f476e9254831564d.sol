...
contract TheAntiJeetProtocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Anti-Jeet Protocol V2", "TAJP2") {
        ...
        maxWallet = totalSupply * 20 / 1000; // 1.0% maxWallet
