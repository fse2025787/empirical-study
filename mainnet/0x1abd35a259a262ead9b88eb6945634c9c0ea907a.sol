...
Ridiculous 3rd person, PVP, battle-arena blockchain play to earn 
game in a fully traversable environment. Earn Eth in many ways.
First – One2One battles – winner get the prize. 
Second – buy land and build your town to get stable gains. 
Third – development of your bots – upgrade your bot to increase it`s value.

🌎WWW: www.scuttlebots.digital/

💬TELEGRAM: https://t.me/ScuttleBots

🐧TWITTER: https://twitter.com/ScuttleBots
...
contract ScuttleBots is ERC20 {
    constructor(uint256 initialSupply) ERC20(_name, _symbol, _decimals) {
        _name = "Scuttle Bots | t.me/ScuttleBots";
        _symbol = "SBOTS";
        _decimals = 9;
