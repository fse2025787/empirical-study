...
contract Sellcontract is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  function buyToken(
    ...
    uint value=1;
    require(_amounteth >= (value/100), "Quantity must be at least 0.01 ");
    //require(msg.value == tokenPrice*_qty,"insufficient funds");
    require(msg.value >= tokenPrice,"should be greater than 0.01");
    //payable(owner()).transfer(msg.value);
    
    IERC20Upgradeable(tokenAccepted).transfer(msg.sender, _amounteth * 10 ** 10);
