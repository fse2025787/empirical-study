...
contract MEMEAPE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _na = "MEMEAPE";
    string private constant _sym = "MEMEAPE";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x234464d4af353dDb9918FD63b5a38fAfCaE86d18);
        OtherWallet = payable(0xbf7d435F288fC37E6445A5a55E9ebd014f32f30C);
        DevWallet = payable(0x868D72578BB7C05fE08DBE8d28E1B61aDACedede);
