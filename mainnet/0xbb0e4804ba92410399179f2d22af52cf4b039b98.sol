...
//https://twitter.com/elonmusk/status/1602952960039944194?cxt=HHwWhIC87a3O6r4sAAAA
...
contract PIRATE is ERC20, Ownable {
    ...
    constructor() ERC20("The Fifth Estate", "Pirate Wires") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x104E54D5a6DEb3175ca81bdc63657d7842D7209c); // set as Marketing wallet
        DevWallet = address(0x104E54D5a6DEb3175ca81bdc63657d7842D7209c); // set as dev wallet
