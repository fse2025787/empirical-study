    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 4500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigm4gg6efsjwdl4chqb4eajc5qyusjibumeuem3allfap57bd4cym/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/yz8bEYRH80rQlvyIkVJT/contract-metadata";
  }
...
// File: contracts/XiKimDigitalTradingCardsContract.sol
//

pragma solidity ^0.8.0;

contract XiKimDigitalTradingCardsContract is RamppERC721A {
    constructor() RamppERC721A("Xi Kim Digital Trading Cards", "XKD"){}
}
