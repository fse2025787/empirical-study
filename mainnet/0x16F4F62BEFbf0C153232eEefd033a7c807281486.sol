...
contract PasokonMvp is ERC721A, Ownable {
    string  public baseURI;

    uint256 public immutable publicMintPrice = 0.08 ether;
    uint256 public immutable wlMintPrice = 0.06 ether;
    uint32 public immutable maxSupply = 555;
    ...
    constructor()
    ERC721A ("PasokonMvp  Official", "PM") {
    }
    ...
    function publicMint(uint32 amount) public payable callerIsUser{
        ...
        require(amount <= maxPerTx,"max 2 per tx");
