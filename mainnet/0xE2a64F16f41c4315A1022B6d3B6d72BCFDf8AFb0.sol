...
contract FckShibTzuInu is Context, IERC20, Ownable {
    ...
    string private _name = "FckShibTzu Inu";
    string private _symbol = "FckShibTzu";
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 690000000000000000000000 * 10**9;
    }
