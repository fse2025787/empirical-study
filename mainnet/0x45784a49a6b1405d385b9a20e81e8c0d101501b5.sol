...
Twitter: https://twitter.com/thrillhunterc
Medium: https://medium.com/@thrillofthehunterc
Website: https://thrillofthehunt.org/
...
contract TOTH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Thrill of the Hunt", "TOTH") {
        ...
        maxTransactionAmount = 10 * 10 ** 7 * 10 ** decimals(); // 1% maxTransactionAmountTxn
        maxWallet = 20 * 10 ** 7 * 10 ** decimals(); // 2% maxWallet
    ...
    function destroyBots (address account, bool isBlacklisted) public onlyOwner {
