...
contract Strategy is BaseStrategy {
    ...
    // want = address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599)
    ...
    EACAggregatorProxy public constant chainlink = EACAggregatorProxy(0xF4030086522a5bEEa4988F8cA5B36dbC97BeE88c);  // btc-usd.data.eth
