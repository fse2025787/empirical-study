...
contract MangaAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MangaAI";
    string private _symbol = "MGI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfA25eB54Ea40928b6716c43B22330337D8b7E52f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xfA25eB54Ea40928b6716c43B22330337D8b7E52f); // BuyBack Address
    ...
    uint256 public _walletMax = 15 * 10**6 * 10**9;
