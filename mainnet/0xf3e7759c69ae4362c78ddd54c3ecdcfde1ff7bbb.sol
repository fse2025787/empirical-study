 ...
 * POWERBALL TOKEN
 * 
 * Token launch is powered by DexRoulette - every day a new play!
 * 
 * Uniswap is full of gambling tokens with most of them being rugged by their 'developers'.
 * Therefore we’ve launched DexRoulette which bring you every day a safe token play.
 * Liquidity is locked for 48hrs, frontrunner protected and ownership renounced.
 *
 * Be aware that these daily token launches are for entertainment purposes only.
 * There is no other value than a safe play without the fear of a honeypot or rug. Let’s Play!
 *
 * Launch date: June 29, 2021 around 21:00 UTC
 *
 * t.me/DexRoulette
...
contract Powerball is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000000000;
    ...
    string private _name = 'Powerball | t.me/DexRoulette';
    string private _symbol = 'Powerball';
    ...
    uint256 public _maxTxAmount = 5000000000000000000000;
    ...
    function initContract() external onlyOwner() {
        ...
        _taxFee = 1;
        _teamDev = 8;
        _teamDevAddress = payable(0x69e3329c243fdA3C0FcCE2E14F054419b16edE45);
    }
