...
contract TheOtakuMurderer is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "The Otaku Murderer";
    string private _symbol = "Tsutomu Miyazaki";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB13fA2D5932c3D17456C3030cb63006A08AF8b05));
        _metawallet = payable(address(0xB13fA2D5932c3D17456C3030cb63006A08AF8b05));
