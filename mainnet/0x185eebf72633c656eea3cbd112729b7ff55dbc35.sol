 ...
 * allowances. See {IERC20-approve}.
 */
contract KOYANE is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "AME-NO-KOYANE";
    string private _symbol = "KOYANE";
    ...
    address public marketingWallet = 0xB9cca016E22f5eD51577b91fd2c9B3BFE9f0178b;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 2 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 1 * 10**_decimals;
