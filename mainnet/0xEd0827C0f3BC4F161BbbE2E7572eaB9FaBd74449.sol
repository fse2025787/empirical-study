...
contract Ryoshiki is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ryoshiki";
    string private constant _symbol = "RYOSHIKI";
    ...
    address payable private _developmentAddress = payable(0xCc71AEDEbaEDFdb8bE9EA4e85B6ea038ca7a42a9); 
    address payable private _marketingAddress = payable(0xCc71AEDEbaEDFdb8bE9EA4e85B6ea038ca7a42a9);
