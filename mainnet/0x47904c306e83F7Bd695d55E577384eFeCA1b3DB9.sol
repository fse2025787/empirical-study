...
contract Vinelon is IERC20 {
    ...
    string constant private _name = "Vinelon";
    string constant private _symbol = "Vine";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x29cCe86EeA2019B096E7316e6C4690f6AE05F1Dc),
        treasury: payable(0x29cCe86EeA2019B096E7316e6C4690f6AE05F1Dc)
    });
...
//===============================================================================================================
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        uint256 tokenAmt = (feeAmount * ratios.treasury) / ratios.totalSwap;
        uint256 swapAmt = feeAmount - tokenAmt;
        if (swapAmt > 0) {
            _tOwned[address(this)] += swapAmt;
            emit Transfer(from, address(this), swapAmt);
        }
        if (tokenAmt > 0) {
            _tOwned[_taxWallets.treasury] += tokenAmt;
            emit Transfer(from, _taxWallets.treasury, tokenAmt);
        }
