...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        // bnb address of the contract owner
        _owner = msg.sender;
...
contract MadHoney is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**6 * 10**9; //Total supply 100m]M
    uint256 private _tFeeTotal;
    string private _name = "Mad Honey";
    string private _symbol = "MADH";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**3 * 10**9; //Fee threshold for LP acquisition
