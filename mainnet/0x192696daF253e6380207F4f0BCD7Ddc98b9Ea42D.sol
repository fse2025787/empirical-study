...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 240;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 246) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSfVd31aVzsX4Qj665DXt8S4ZMRYvSJ41vgX852cKF5Sy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 246");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 246");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 246");
...
// File: contracts/FashionLiensContract.sol
//

pragma solidity ^0.8.0;

contract FashionLiensContract is RamppERC721A {
    constructor() RamppERC721A("FashionLiens", "Fabric"){}
}
