...
contract FTXHUB is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public totalFree = 369;

    uint256 public maxSupply = 3669;

    bool public mintEnabled = true;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Ftx Hub", "FTXHUB") {
