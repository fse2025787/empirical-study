...
contract DODOV2 is IExchange, AdapterStorage {

  uint constant swapLimitOverhead = 900;
  ...
  override
  {
    ...
    if (address(fromToken) == Utils.ethAddress()) {
      ...
      Utils.approve(lData.erc20ApproveProxy, address(fromToken), fromAmount);
  ...
  function getKey() public override pure returns(bytes32) {
    return keccak256(abi.encodePacked("DODOV2", "1.0.0"));
  }
}