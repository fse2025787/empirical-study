...
contract XENCryptoNew is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private pair;
    bool public tradingOpen = false;
    uint256 public _maxWalletSize = 24816326412800 * 10 ** decimals();
    uint256 private _totalSupply = 1123581321345589 * 10 ** decimals();
    address _deployer;

    constructor() ERC20("XEN Crypto 2.0", "XEN2.0") {
