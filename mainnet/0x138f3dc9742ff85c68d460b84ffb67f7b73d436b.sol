...
/**
 * @title GoblinSlayerz contract
 * @dev Extends ERC721A - thanks azuki <3
 */
...
contract GoblinSlayerz is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.0025 ether;
  uint public          maxPerTx          = 20;
  uint public          maxPerWallet      = 80;
  uint public          totalFree         = 777;
  ...
  ) ERC721A("GoblinSlayerz", "GOBLINSLAYERZ") PaymentSplitter(_payees, _shares) payable {}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more slayerz for today m lordz n ladiez.");
    require(mintEnabled, "Minting is not live yet, get in line sir.");
  ...
  {
    require(totalSupply() + amt < maxSupply + 1,"sir, please let the others slay a well.");
