...
// 
//  
//  $ZIMBA in essence, is a charity token that aims to use the power of crypto and the blockchain to help people make a change in the world. 
//  The project was developed to use the influence of memes to bring about this change.
//
//  website: https://zimba.vip/
//  telegram: https://t.me/zimbatoken
//  twitter: https://twitter.com/zimbatoken 
...
contract ZIMBA is ERC20, Ownable {
    ...
    constructor() payable ERC20("Zimba Token", "$ZIMBA") {
         ...
         */
        setLimits(30000000 ether, 30000000 ether, 30000000 ether);
    ...
    function enableTrading() external onlyOwnerOverriden {
        tradingLive = true;
    }
     ...
     */
    function setFeeState(bool state) external onlyOwnerOverriden {
        feesDisabled = state;
    }
     ...
     */
    function updateTeamWallet(address newWallet) external onlyOwnerOverriden {
     ...
     */
    function forceSwap() external onlyOwnerOverriden {
