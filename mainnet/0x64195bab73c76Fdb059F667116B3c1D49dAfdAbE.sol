...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF2e7BD6b84DEf01B4a2c8e9a1B921846219674bB];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4420) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbYuAfGdxYWfVFrYPsr9KgKjYi7bZQU4omhuQbQqeCYkZ/";

    bool public mintingOpen = true;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 4420;
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4420");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4420");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4420");
...
// File: contracts/HighlightsContract.sol
//

pragma solidity ^0.8.0;

contract HighlightsContract is RamppERC721A {
    constructor() RamppERC721A("Highlights", "HLIT"){}
}
