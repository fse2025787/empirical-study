...
contract Tsunami is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsunami";
    ...
    address payable private _marketingAddress = payable(0xA780367B0b537AE6613d84f8423a0DED502E9d65);
    address payable private _devAddress = payable(0xC2ED2Ee3DC19555d279f6E3BeFf8ab67eA17A128);
