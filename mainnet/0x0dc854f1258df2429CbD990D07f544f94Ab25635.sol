...
contract DOKWONCAKE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DO KWON CAKE";
    string private constant _symbol = "DOWCAKE";
    ...
    address payable private _developmentAddress = payable(0x23804897621d6bA0f33eAbE18ca04884972280fC); 
    address payable private _marketingAddress = payable(0x23804897621d6bA0f33eAbE18ca04884972280fC);
 
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    uint256 public _maxTxAmount = _tTotal.mul(10).div(100);
    uint256 public _maxWalletSize = _tTotal.mul(10).div(100); 
