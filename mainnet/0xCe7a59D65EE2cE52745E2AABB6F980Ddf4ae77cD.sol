...
contract Train is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Train";
    string private constant _symbol = "$Train";
    ...
    address payable private _developmentAddress = payable(0x2895e1a77AE0f4E156Cee4CfA1D13620eCb9f755);
    address payable private _marketingAddress = payable(0x2895e1a77AE0f4E156Cee4CfA1D13620eCb9f755);
