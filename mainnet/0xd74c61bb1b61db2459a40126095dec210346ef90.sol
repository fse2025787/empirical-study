...
contract PyroInu is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Pyro Inu';
    string private constant _symbol = 'PYROINU';
    ...
    address payable public _fireWalletAddress;
    ...
    uint256 private _maxTxAmount = 10000000000000 * 10 ** 18;
    uint256 private constant _numOfTokensToExchangeForTeam = 3000000 * 10 ** 18;
    uint256 private _maxWalletSize = 10000000000000 * 10 ** 18;
    ...
    constructor (address payable devWalletAddress, address payable marketingWalletAddress, address payable fireWalletAddress) public {
        _devWalletAddress = devWalletAddress;
        _marketingWalletAddress = marketingWalletAddress;
        _fireWalletAddress = fireWalletAddress;
    ...
    function addBotToBlacklist(address account) external onlyOwner() {
        require(account != 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F, 'We cannot blacklist UniSwap router');
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F, 'We can not exclude Uniswap router.');
    ...
    function sendETHToTeam(uint256 amount) private {
        _devWalletAddress.transfer(amount.div(10));
        _marketingWalletAddress.transfer(amount.div(10).mul(3));
        _fireWalletAddress.transfer(amount.div(10).mul(6));
    }
    ...
    function _setFireWallet(address payable fireWalletAddress) external onlyOwner() {
        _fireWalletAddress = fireWalletAddress;
    }
