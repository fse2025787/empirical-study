...
contract XD is ERC20, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        if (amountToSwap >= (swapThreshold*8)){
            amountToSwap = swapThreshold*8;
        }
    ...
    function setWalletLimit(uint256 amountPercent) external onlyOwner {
        ...
        require (_maxWalletAmount > _totalSupply/100,"Max wallet more than 1%");
    }
    ...
    function BLBots(address botAddress, bool status) external onlyOwner {      
