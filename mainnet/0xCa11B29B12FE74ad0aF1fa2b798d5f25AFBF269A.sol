...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x57E2dafb65A6097d7B13f74634D6282d1BB49059] = _marketingwallet;
    }
...
contract HexLunaClassic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hex Luna Classic", "HexLunaClassic") {
        ...
        excludeFromFees(address(0x57E2dafb65A6097d7B13f74634D6282d1BB49059), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x57E2dafb65A6097d7B13f74634D6282d1BB49059), true);
