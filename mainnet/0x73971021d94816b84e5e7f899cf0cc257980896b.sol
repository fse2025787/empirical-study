...
contract Kerincy is Context, IERC20, Ownable {
    ...
    string private _name = "Kerincy";
    string private _symbol = "Kerincy";
    ...
    uint256 public launchSellFee = 12;
    uint256 private _previousLaunchSellFee = launchSellFee;

    uint256 public maxTxAmount = _tTotal.mul(5).div(1000); // 2%
    address payable private _devWallet = payable(0xfc56f2A3f67D62862A1D0D61155fEf9c89e50307);
    address payable private _marketingWallet = payable(0xCde2b0B14f3D9B4df31fc82370Aca6b77bf07994);
    ...
    function sendEthToDevAddress(uint256 amount) private {
        if (amount > 0) {
            ...
            _devWallet.transfer(ethToDev);
            _marketingWallet.transfer(ethToMarketing);
        }
    }
    ...
    function setDevFeePercent(uint256 devFee, uint256 devTax, uint256 marketingTax) external onlyOwner() {
         require(devFee <= 10, "Maximum fee limit is 10 percent");
