...
contract CKCToken is TimeLockToken, FreezableToken, PausableToken, BurnableToken {
    string public constant name = "Cambodia K-POP Coin";
    string public constant symbol = "CKC";
