...
//Hedge against the bear.
//https://t.me/HedgeCommunity
...
contract TheHedge is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 6.3 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'The Hedge';
    string private _symbol = 'HEDGE';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint256 private _maxTxAmount = 6.3 * 10**6 * 10**18;
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <= 10, 'taxes should be in 0 - 10');
        _taxFee = taxFee;
    }
    
    function _setBurnFee(uint256 burnFee) external onlyOwner() {
        require(burnFee >= 0 , 'burnFee should be greater than 0');
        _burnFee = burnFee;
    }
