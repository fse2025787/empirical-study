...
contract TheProfessor is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x7275454b86923A1794F3Fcf38AB71DF446FB8fef);    
    address payable public teamAddress = payable(0x7275454b86923A1794F3Fcf38AB71DF446FB8fef);   
    address payable private ownerAddress = payable(0x7275454b86923A1794F3Fcf38AB71DF446FB8fef);    
    ...
    string private constant _name = "The Professor";
    string private constant _symbol = "TheProfessor";
