...
contract Huskynaut is Context, IERC20, Ownable {
    ...
    string private constant _name = "Huskynaut Finance";
    string private constant _symbol = "Huskynaut";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!(_isExcludedFromFee[from] || _isExcludedFromFee[to])) {
            ...
            uint256 standardTax = to == uniswapV2Pair ? _finalTax : from == uniswapV2Pair? _standardTax : 0;
