...
/**
Tired of all the fucking devs.
Lets run this by community, not devs, Fuck The DEVS
Taxes 1/1 
Lets show those devs that they are shit!
 */
...
contract FuckTheDev is ERC20, Ownable {
    ...
    constructor() ERC20("FTD ", "FTD") {
        ...
        devWallet = address(0x914A360c3864978d7Cd5b0aeab740eBd52A52eD6); // set as dev wallet
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellDevFee + sellLiquidityFee;
        require(sellTotalFees <= 20, "Must keep fees at 15% or less");
    }
