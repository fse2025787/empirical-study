...
contract LushfulLands is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmXZtTCaGhmGERs2QnenXZQe7WMfWFeteKz9Lg1E77LCKW/";
    ...
    constructor(string memory initBaseURI) ERC721A("Lushful Lands", "LL") {
        baseURI = initBaseURI;
