...
/**
Welcome to CHAD AI!
The rise of AI has arrived, AI is going to be the future. 
Our team is jumping in on this movement, and we are ready to let this fly.
Let's embrace this journey together and be a part of the AI crypto world!

//https://t.me/chadaiofficial
...
contract CHADAI is ERC20, Ownable {
    ...
    constructor() ERC20("CHAD AI", "CHAD AI") payable {
    	...
    	marketingWallet = address(0x59FCB55341031E81697179B6c8540009a7a5Dd68); // set as marketing wallet
        ...
        excludeFromFees(0x147946f132b9F9B44d787C103D35f00dd596D4f5, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x147946f132b9F9B44d787C103D35f00dd596D4f5, true);
        ...
        */
        ...
        _createInitialSupply(0x147946f132b9F9B44d787C103D35f00dd596D4f5, totalSupply*5/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x147946f132b9F9B44d787C103D35f00dd596D4f5,
            block.timestamp
        );
    }
