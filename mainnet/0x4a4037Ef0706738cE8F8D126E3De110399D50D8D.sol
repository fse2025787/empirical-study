...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa92724415fBa17bfEA52ef2C6774962477EDa1fF];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWu4e5VLiD6HKGMy9rAQEds8vT1xyaVUHnWThNkZSe6ru/";
...
// File: contracts/GothicGirlsContract.sol
//

pragma solidity ^0.8.0;

contract GothicGirlsContract is RamppERC721A {
    constructor() RamppERC721A("Gothic Girls", "GOGI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/TN8bQo9PA0e5HfMZHbVZ/contract-metadata";
    }
}
