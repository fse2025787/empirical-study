...
contract CasualCavemen is ERC721, Ownable {
  using Strings for uint256;
           
  string public _collectionName= "Casual Cavemen VIP Collection";
  string public _collectionSymbol="CAVE";

  string baseURI="ipfs://Qmd22x5iAizHKvcJSMMbUmDkjZNwYHY7dr5UNR3ReciNCs/";
  ...
  bool public paused = true;
    ...
    //address one = creator
    address private addressOne = 0x5B0987Fc0e0180393EbeC15eC3F045F5Cdd9f2d8;
 ...
 //primary withdraw
  function primaryWithdraw() public payable onlyOwner {
   uint256 CurrentBalance = address(this).balance;
        payable(addressOne).transfer((CurrentBalance));
