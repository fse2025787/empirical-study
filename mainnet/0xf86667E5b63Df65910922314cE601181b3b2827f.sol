...
contract GraveyardGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(string memory name, uint256 votingPeriodBlocks, uint256 quorumPercent, IVotes _token, TimelockController _timelock)
        Governor(name)
        GovernorSettings(1 /* 1 block */, votingPeriodBlocks, 1)
