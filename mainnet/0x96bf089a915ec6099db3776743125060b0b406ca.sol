...
contract The4thDs is ERC721A, Ownable {
    ...
    // URI
    string public baseURI = "ipfs://QmSkeBM3MfTmKyDbkSBjL9bu82KvLs7vYphTQrfaGS76Qe/";

    //Hidden URI
    string public hiddenURI = "ipfs://QmZz15c44onmxbQQ9SiksFgYuJxHtRsJTh5aPPky3uh8uK/1";


    // Constructor
    constructor() ERC721A("The 4th Ds", "T4D") {}

    // Mint - Functions
    function freesaleMint(uint256 _mintAmount) external {
    ...
    function presaleMint(uint256 _mintAmount) external payable {
        require(!paused, "MSG: The contract is paused");
        require(totalSupply() + _mintAmount <= maxSupply, "MSG: Max supply exceeded.");
        require(!freesale && presale, "MSG: Presale is not active.");
        require(totalSupply() + _mintAmount <= preSaleSUpply, "MSG: Presale max supply exceeded.");
    ...
    function publicsaleMint(uint256 _mintAmount) external payable {
        require(!paused, "MSG: The contract is paused");
        require(totalSupply() + _mintAmount <= maxSupply, "MSG: Max supply exceeded.");
        require(!freesale && !presale, "MSG: Publicsale is not active.");
