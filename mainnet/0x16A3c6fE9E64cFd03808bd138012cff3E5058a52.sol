...
contract LasmVesting is ReentrancyGuard, Ownable {
    ...
    // vesting wallets
    address private constant lockedWallet            = address(0x5A1b042a1385A9793aC36c010dA36Ef710f6881c);
    address private constant managerWallet           = address(0x95c6c446ca29205c9F20Ec7534DC15A095F7d192);
    address private constant teamWallet              = address(0x05D6D4C0679E0476C3D3c87EE5675a9CeEb94baF);
    address private constant partnersWallet          = address(0xe72649122B096F32ff013890d49f199feeB0899E);
    address private constant marketingWallet         = address(0xe7075Cc5B25823b6fAaf11C92d753A9E788aB20B);
    address private constant developmentWallet       = address(0x56169c77C6B3175C839B17f180d0817c92a87c2d);
    address private constant stakingRewardsWallet    = address(0x79f9CfC743852944DECac99368A93153184a9cC7);
    address private constant airdropWallet           = address(0x66b8A8ba7041A53DF5A09c77D9016F4Ea286d414);
    address private constant nftAirdropWallet        = address(0x0D1ec162F2B10515C909eAbD039967Ab756a7b1E);
