...
contract CountriesWeaponized is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmTxh59HypHhMU4UcRHdVgyAMa54whGvFEouyFk7VLkGkR";

  uint256 private maxSupply = 5120;
  ...
  ) ERC721A("CountriesWeaponized.wtf", "CountriesWeaponized.wtf") {
