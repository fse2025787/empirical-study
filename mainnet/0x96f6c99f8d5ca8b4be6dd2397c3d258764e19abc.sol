...
// Given the atmosphere of the meme coin space on ethereum for 2023 $ROSIE has decided to take its place.
// Providing multiple avenues for a strong ecosystem $ROSIE has decided it will set the standards for a low market cap coin. 

// TELEGRAM: T.me/RosieInuETH

// Twitter: twitter.com/RosieInuERC

// Website: RosieInu.tech
...
contract ROSIE is Context, IERC20, Ownable {
    ...
    string private _name ="Rosie Inu";
    string private _symbol = "ROSIE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xda1875e32937066750D3005f70DA472025a62562);
    address payable private taxWallet2 = payable(0xda1875e32937066750D3005f70DA472025a62562);
