...
//IceCreamCats Enumerable Contract. 
/*
.-.             .--.                             .--.        .-.      
: :            : .--'                           : .--'      .' `.     
: : .--.  .--. : :   .--.  .--.  .--.  ,-.,-.,-.: :    .--. `. .'.--. 
: :'  ..'' '_.': :__ : ..'' '_.'' .; ; : ,. ,. :: :__ ' .; ; : :`._-.'
:_;`.__.'`.__.'`.__.':_;  `.__.'`.__,_;:_;:_;:_;`.__.'`.__,_;:_;`.__.'
...
contract IceCreamCats is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint(uint256 _times) payable public {
        ...
        require(_times > 0 && _times <= maxToMint, "You can only mint 15 at a time");
        require(totalMints + _times <= totalCount, "Sold out!");
        require(msg.value == _times * price, "Please send correct amount of ETH (0.045)");
