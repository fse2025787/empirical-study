...
contract EthosDudes is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeib5tkkaljrz6jbg2d3uumw6ieyh6xtlf6pvlowuljqydjqkaozldy/", Strings.toString(tokenId), ".json")
            );
    }
