...
Second atempt of 'might' franchise
This time, it actually might fly

7/7 taxes until 15k, like last time, getting them reduced to 2/2.
...
contract MightFly is Context, IERC20, Ownable {
    ...
    string private constant _name = "Might Fly";
    string private constant _symbol = "MIGHTFLY";
