...
contract TerraFirma is Ownable, ERC721A {
    ...
    string private revealedURI = "ipfs://QmfYNGjgivKyMqTNBNbU3Tmd8gPvm7Non1reDh65aKg4p4/";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string private CONTRACT_URI = "ipfs://IHAWPFPHGUBU5KRA175BYGA9FU56GPYZAF";
    ...
    address constant internal DEV_ADDRESS = 0xcC3068499C0D498535C8b9534fa1CCb1A660a1cf;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("TerraFirma", "TF") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 80, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xcC3068499C0D498535C8b9534fa1CCb1A660a1cf");
