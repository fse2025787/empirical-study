...
contract IRSTaxes is Context, IERC20, Ownable {
    ...
    string private constant _name = "Taxes";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x7649366eb6300d8c35e162070fE713DeD45c6B88);
        _feeAddrWallet2 = payable(0x7649366eb6300d8c35e162070fE713DeD45c6B88);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 30% WHO SELL WITHIN 2 HOURS
            if (_buyMap[from] != 0 &&
    ...
    function removeStrictTxLimit() public onlyOwner {
        _maxTxAmount = 1000000000000 * 10**8;
    }
