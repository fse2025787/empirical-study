...
// 
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Foreground 1", unicode"Foreground 2", unicode"Foreground 3", unicode"Middle Ground 1", unicode"Middle Ground 2", unicode"Background 1", unicode"Background 2", unicode"Background"];
        bool private shouldWrapSVG = true;
        uint256 public constant maxTokens = 600;
        ...
        ContractData public contractData = ContractData(unicode"Still Lifes", unicode"Édouard Manet once called still life 'the touchstone of painting'. Characterized by an interest in the insentient, this genre of art has been popular across movements, cultures, and periods, with major figures like Paul Cézanne and Pablo Picasso.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9b0638f3-e513-43a5-b47a-77b73111bcb6", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9b0638f3-e513-43a5-b47a-77b73111bcb6", "", 500, "0xf98537696e2Cf486F8F32604B2Ca2CDa120DBBa8");

        constructor() ERC721A(unicode"Still Lifes", unicode"SL") {
            TIERS[0] = [120,480];
TIERS[1] = [20,20,25,38,38,38,40,40,41,300];
TIERS[2] = [18,32,40,45,50,50,50,50,50,50,50,115];
TIERS[3] = [40,50,50,50,50,50,50,55,205];
TIERS[4] = [20,25,25,25,35,40,40,40,40,40,40,50,180];
TIERS[5] = [10,25,40,45,50,430];
TIERS[6] = [60,540];
TIERS[7] = [600];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Still Lifes #");
