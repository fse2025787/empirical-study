...
contract SYCC is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 672 * 10**5* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'Super Yacht Coin ';
    string private _symbol = 'SYCC';
