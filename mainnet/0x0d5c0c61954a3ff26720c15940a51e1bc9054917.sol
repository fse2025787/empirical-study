...
contract buttfaze is Ownable, ERC721A {
    ...
    uint256 constant public MAX_SUPPLY_PRIVATE_WHITELISTED = 0;

    
    uint256 public mintRatePublicWhitelist = 0 ether;
    ...
    uint256 public mintedPublicWhitelistAddressLimit = 0;
    uint256 public mintedPublicAddressLimit = 1;    

    string public baseURI = "ipfs://QmRV3dXXKeGegBsZGLRASkytG7XhA5LCQDJaiLnC8BLCtT/";

    string public hiddenMetadataUri = "ipfs://QmRV3dXXKeGegBsZGLRASkytG7XhA5LCQDJaiLnC8BLCtT/Hidden.json";
    string constant public uriSuffix = ".json";

    string public CONTRACT_URI;

    address public privateWLAddress = 0x20B19f16876E39E459A466b99a1d155eAA27a6d0;


    mapping(address => uint256) public numUserMints;

    address constant public buttfazeAddress = 0x20B19f16876E39E459A466b99a1d155eAA27a6d0;

    address public communityWallet = 0x24283f7268034edee23DDF9Db6Fdf2C51a3BCb04;

    address public teamWallet = 0xDd1F25FbB2c88052671e6180DB96aBA4e3823dAd;


    uint256 private buttfazePayable;

    constructor() ERC721A("buttfaze buttfaze", "buttfaze") { }
    ...
    */
    ...
    function publicWhitelistMint(uint256 quantity, bytes32[] memory proof) external payable mintCompliance(quantity) {
        ...
        buttfazePayable += ((price * quantity) * 5) / 100;
    ...
    */
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool succ, ) = payable(buttfazeAddress).call{
            value: buttfazePayable
        }("");
        require(succ, "buttfaze transfer failed");

        buttfazePayable = 0;

        (succ, ) = payable(communityWallet).call{
            value: (currBalance * 80) / 100
        }("");
