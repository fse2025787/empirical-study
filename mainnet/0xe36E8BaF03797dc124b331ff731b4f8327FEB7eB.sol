...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xb5b436a8Ac0aa0197F00711c06888b50e40Ec6E6] = _marketingwallet;
    }
...
contract HexLuna is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hex Luna", "HexLuna") {
        ...
        excludeFromFees(address(0xb5b436a8Ac0aa0197F00711c06888b50e40Ec6E6), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xb5b436a8Ac0aa0197F00711c06888b50e40Ec6E6), true);
