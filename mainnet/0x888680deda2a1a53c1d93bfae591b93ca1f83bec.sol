...
contract SLEEP is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    string private constant _name = "SLEEP";
    string private constant _symbol = "SLEEP";
    ...
    uint256 private constant _tTotal = 5e17 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _maxWalletSize = 10000000000000000 * 10**9;
    ...
    constructor() {
        ...
        marketingAddress = payable(0x6344F90dDeC1e57DE4DD170b620391A22Bd3584c);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
            require(amount <= 2500000000000000 * 10**9, "Limits are in place, please lower buying amount");
        }
        if(_initLaunch == true) {
