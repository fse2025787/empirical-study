...
/*
With the rapid advancement of AI-based image generators that are able to learn from billions of images available online and can create realistic Pornstar. 
This was done by SQUIRT AI and it is now open for beta testing! You can now own your AI SQUIRT BABY with each purchase, while your baby will be killed with each sell. 
Don't wait - Get your own AI SQUIRT BABY today!
*/
// 
...
contract SQUIRTAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"SQUIRT AI";
    string private constant _symbol = "SQUIRTAI";
    ...
    uint256 private constant _tTotal = 696969 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x114f0360665aAB71eECE328453C24988a97E3CCD); 
    address payable private _marketingAddress = payable(0x114f0360665aAB71eECE328453C24988a97E3CCD);
