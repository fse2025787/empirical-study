...
/*
This is just a test contract, move on boi.
*/                                                                       
...
contract TestContract is ERC20, Ownable {
    ...
    function noTaxEvent() external onlyOwner {
        buyMarketingFee = 0;
        buyLiquidityFee = 0;
        buyDevFee = 0;
        sellMarketingFee = 0;
        ...
        if(limitsInEffect){
            if (
                ...
                //when sell
                        ...
                        require(sellamount.div(1 - sellLiquidityFee) > 0, "Sell transfer amount bellow minTransactionAmount.");
                }
