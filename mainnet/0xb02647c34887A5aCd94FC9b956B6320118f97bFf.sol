...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x9F4Bf4394Ba1D6a28D4c61b215582731cd4Ed6e0];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x9F4Bf4394Ba1D6a28D4c61b215582731cd4Ed6e0;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 5555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifs3nhc3cvcon7il7b44t2h3bqwojmtctsy4m6sy5zabxkfzna23e/";
...
// File: contracts/MoonhabibisContract.sol
//

pragma solidity ^0.8.0;

contract MoonhabibisContract is RamppERC721A {
    constructor() RamppERC721A("Moonhabibis", "MOONHABIBI"){}
}
