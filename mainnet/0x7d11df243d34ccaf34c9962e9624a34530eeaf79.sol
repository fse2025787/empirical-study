...
// File @openzeppelin/contracts/token/ERC20/ER[email protected]
...
contract SummerToken is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Summer','SUMMER') {
        _mint(0x559ebFeC7be7f1A27a38Be3b03bF2D4c70Ad62b3, 66000000 *10**18);
    ...
    function _mint(
        ...
        require(ERC20.totalSupply() + amount <= 660000000 *10**18, "ERC20Capped: cap exceeded");
