...
// Telegram: no tg, if community want to make one thats cool. 
// Twitter: coming
// Website: live 30 minutes after launch
...
contract NewDogeOrder is ERC20, Ownable {
    ...
    constructor() ERC20("NewDogeOrder", "NewDogeOrder") {
    ...
    function newdogeorder() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
