...
// File: contracts/FUSDImplementation.sol
...
contract FUSDImplementation {
    ...
    string public constant name = "FARMIES DOLLAR"; // solium-disable-line
    string public constant symbol = "FUSD"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all FUSD at the contract address.
     * This sends the FUSD tokens that this contract add holding to the owner.
