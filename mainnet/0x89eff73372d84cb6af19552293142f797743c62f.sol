...
The foundation of decentralization is community decision, so we lock in liquidity for 100 years and hand over all power to the community.

Salute greatness and learn how to be great!
...
contract SatoshiCult is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SatoshiCult", "SatoshiCult") {
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 3 / 100)/1e18, "Cannot set maxTransactionAmount lower than 1%");
        maxTransactionAmount = newNum * (10**18);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 3 / 100)/1e18, "Cannot set maxWallet lower than 2%");
