...
// File: contracts/TemperRhythm.sol
...
contract TemperRhythm is ERC721AQueryable, Ownable {
  using Strings for uint256;
  uint256 public EXTRA_MINT_PRICE = 0.003 ether;
  ...
  constructor() ERC721A("Temper Rhythm by Tarcosa", "TR") {}
  ...
  function mint(uint256 _mintAmount) external payable {
      ...
      require(_mintAmount < MAX_PER + 1, "Max Per Transaction Is 10");
