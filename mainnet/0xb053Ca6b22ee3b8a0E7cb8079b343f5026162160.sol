...
//
//     ______                   ______                     
//    / ____/___ _________     / ____/___  ____  ___  _____
//   / /_  / __ `/ ___/ _ \   / /   / __ \/ __ \/ _ \/ ___/
//  / __/ / /_/ / /__/  __/  / /___/ /_/ / / / /  __(__  ) 
// /_/    \__,_/\___/\___/   \____/\____/_/ /_/\___/____/  
//                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x21e1224Dd7093C367730eC629E3f84906f83b451];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXxiDZ5RGMEjdUGWxoihyP7YuFyQea6NYifsgYt3zoqn5/";
...
// File: contracts/FaceConesContract.sol
//

pragma solidity ^0.8.0;

contract FaceConesContract is RamppERC721A {
    constructor() RamppERC721A("Face Cones", "FCCNS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/w6bWuBPfJBi5oTBQOfsM/contract-metadata";
    }
}
