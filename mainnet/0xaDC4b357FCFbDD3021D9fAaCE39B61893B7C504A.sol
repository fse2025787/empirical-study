...
contract Polkamoon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 770000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tBurnTotal;

    string private _name = 'Polkamoon';
    string private _symbol = 'PMOON';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[0]/**tTax*/ = tAmount.div(10);
        _localVal[1]/**tBurnValue*/ = tAmount.div(100).mul(5);
        _localVal[2]/**tFee*/ = tAmount.div(100).mul(2);
        _localVal[3]/**tLiquidity*/ = tAmount.div(100).mul(3);
