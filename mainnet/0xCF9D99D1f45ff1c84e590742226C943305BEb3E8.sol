...
contract AnalLust is Context, IERC20, Ownable { 
    ...
    uint256 private initialsupply = 69696969;
	uint256 private _tTotal = initialsupply * 10 ** _decimals; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 30000 * 10**9;
    uint256 public maxBuyLimit = 1045454 * 10**9;
    uint256 public maxSellLimit = 1045454 * 10**9;
    uint256 public maxWalletLimit = 1045454 * 10**9;

    uint256 public genesis_block;
    
    address public marketingWallet = 0x72Bf7F1b763BDa2f861d20E7c0e8D5b29A82D59b;
    address public treasury = 0x72Bf7F1b763BDa2f861d20E7c0e8D5b29A82D59b;

    string private constant _name = "Anal Lust";
    ...
    function _takeDonation(uint256 rDonation, uint256 tDonation) private {
        totFeesPaid.treasury +=tDonation;
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tDonation = tAmount*temp.treasury/100;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        uint256 donationAmt = unitBalance * 2 * temp.treasury;
        if(donationAmt > 0){
            payable(treasury).sendValue(donationAmt);
        }
    }
