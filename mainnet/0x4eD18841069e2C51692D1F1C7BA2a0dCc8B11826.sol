...
contract P_NFTs is Context, Ownable, ERC721Enumerable, ERC721Pausable {
    ...
    uint256 public immutable supplyCap = 1770;
    ...
    constructor() ERC721("Out of Africa: Poster NFTs", "P-NFT") {
        _baseTokenURI = "ipfs://QmSGCfSazPHvdz7EvqFrPBKnjxt139CxATtsbvh69nCdSa/";
    }
    ...
    function setBaseURI(string memory baseTokenURI) external onlyOwner nonFrozen {
    ...
    /** @notice Prevent most token functions being called thereby freezing metadata
    NON-REVERSIBLE**/
