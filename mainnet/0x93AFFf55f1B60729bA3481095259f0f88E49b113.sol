...
contract TwitterInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TwitterInu";
    string private constant _symbol = unicode"TINU";
