...
abstract contract Ownable is Context {
    ...
    contract WW3ApeYachtClub is ERC721A, Ownable {
    using Strings for uint256;

    string private uriPrefix;
    string private uriSuffix = ".json";
    string public hiddenURL = "ipfs://bafybeicpulsq43qgeyzq7xuxvf3q2kwnrvo6mjdahly7lq4vyprc6smnny/hidden.json";
    ...
    constructor() ERC721A("WW3 Ape Yacht Club", "WAYC") {
    }
