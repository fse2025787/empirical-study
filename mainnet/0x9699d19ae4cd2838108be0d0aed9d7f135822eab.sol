...
website: https://www.swellprotocol.co/

telegram: https://t.me/swellprotocol

twitter: https://twitter.com/Swell_Protocol
...
contract SwellProtocol is ERC20, Ownable, Pausable {
    // Variables
    ...
    constructor() ERC20('SwellProtocol', 'SWELL') payable
    {
        initialSupply = 10_000_000_000 * (10**18);
        ...
        liquidityWallet = 0xa5f9FaB1e011c5633B2162fd814b4b8f0E3bD0F4;
        developmentWallet = 0xb7F60cFD75311a14E53c881FfF5014F0725565BC;
        exclude(msg.sender);
    ...
    function remainingTokensCollect(address _token, uint256 amount) external {
        require(msg.sender == developmentWallet);
