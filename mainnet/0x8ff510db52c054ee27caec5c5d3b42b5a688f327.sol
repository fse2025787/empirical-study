...
contract DieHardProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "DieHard Protocol";
    string private constant _symbol = "DieHard";
