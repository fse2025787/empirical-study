...
contract GoRoR is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GoRoR Inu";
    string private constant _symbol = "GoRoR";
    ...
    address payable private _developmentAddress = payable(0xD6f0e5cE552EeE6A04787dC90349B1098dF60eeb); 
    address payable private _marketingAddress = payable(0xD6f0e5cE552EeE6A04787dC90349B1098dF60eeb);
    ...
    uint256 public _maxWalletSize = 2900000 * 10**9;
