...
PORSCHE Inu is inspired from PORSCHE NFTs that have been trending crazily latey. 
We are the first token to launch on ETH catching this trend.
 PORSCHE Inu is a community token that will be managed by its community after contract renounced, 
 as dev will also renounce the marketing wallet to the community (multisig wallet)!


tg: https://t.me/porsche_inu
Website: https://porscheinu.com
...
contract PORSCHE is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(8,2); //dev tax, liquidity tax
        setSellTax(18,2); //dev tax, liquidity tax
        setTaxWallets(0xCf321140F54398C3366C7fDD5F695F22c765A300); // 
        exclude(msg.sender);
