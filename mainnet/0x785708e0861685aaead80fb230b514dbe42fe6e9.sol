...
/**
The community at Bill Murray Inu is creating this token to send to Bill Murray to let him know 
 we are raising funds to help Evelyn and replace the charity funds that were stolen during the wallet hack.
 Bill, thank's for utilizing the WEB3 space to make a difference outside of the blockchain.
 We hope the unfortunate incident that happened doesn't discourage you in the future, and that we can also make an impact.

 - t.me/BillMurrayInu community <3 ( BillMurrayInu.com)
...
contract YourFriendsAtBillMurrayInu is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Visit Us At T.me/BillMurrayInu, We Have Raised Funds For Evelyn To Help Recover The Stolen Charity Funds";
    string constant _symbol = "Visit Us At T.me/BillMurrayInu, We Have Raised Funds For Evelyn To Help Recover The Stolen Charity Funds";
    ...
    address private marketingFeeReceiver = 0x289B578e643b7e23113fC2Ac073F8C572CE587b2;
