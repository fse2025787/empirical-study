...
contract AstroApesBaby is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4444;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "https://astrobabies.s3.amazonaws.com/apes/jsons/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Astro Apes Bbaby", "AAB", MAX_MINTS, MAX_SUPPLY) {  
