...
World Peace Shiba token is deflationary ERC20 token deployed on the Ethereum Network with great features and mechanism offering streamline of attainable gains via trading.

Official Channel: https://t.me/WorldPeaceShibaErc
Official Twitter: https://twitter.com/WorldPeaceShiba
*/
//
...
contract WorldPeaceShiba  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "World Peace Shiba";
    string private  _symbol = "WPS";
