...
// File contracts/Dojo.sol

contract onmifrank is Ownable, ERC721Burnable, ERC721Enumerable, LayerZeroable {
    ...
    string public constant BASE_URI =
        "ipfs://QmY3WAoZWeiRGNoTABmb4HHxorxQUGjTWiMkDUyVLW2Qmi/";
    uint256 public constant MAX_SUPPLY = 500;

    constructor(uint256 _lastTokenId, address _layerZeroEndpoint)
        ERC721("omnifrank", "omnifrank")
    {
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens < 2, "1 omnifrank per TX MAX");
        mintedSupply++;
