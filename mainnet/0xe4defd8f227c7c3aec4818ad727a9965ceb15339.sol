...
/**
 *                                 
 * Telegram: https://t.me/CreampaiETH
 * Landing page DAPP: Dropping ONE hour after LP add.
 * 
 * 
 * Set slippage to 4-6% : 1% to LP, 3% tax for marketing & VR development costs.
*/
 ...
 * allowances. See {IERC20-approve}.
 */
 contract CreamPAI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "CreamPAI";
    string private _symbol = "PAI";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000;
    uint256 public taxForLiquidity = 4; //sniper protection, to be lowered to 1% after launch
    uint256 public taxForMarketing = 5; //sniper protection, to be lowered to 3% after launch
    uint256 public maxTxAmount = 10000001 * 10**_decimals;
    uint256 public maxWalletAmount = 10000001 * 10**_decimals;
    address public marketingWallet = 0xb6259e4d7162D32361420F9da12CF865AD6eD21F;
