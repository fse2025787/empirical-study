...
contract BabyRubic  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Baby Rubic";
    string private constant _symbol = "$BABYRBC";
    ...
    address payable private _developmentAddress = payable(0x30ea8a617C1676C5C5fa1f9dc554EaA879ed9bf5); 
    address payable private _marketingAddress = payable(0x30ea8a617C1676C5C5fa1f9dc554EaA879ed9bf5);
