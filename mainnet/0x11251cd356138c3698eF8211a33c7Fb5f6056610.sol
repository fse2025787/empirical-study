...
contract EthericeBiggestBuy is Ownable, ReentrancyGuard {
    ...
    EthericeTokenInterface private _tokenContract;
    ...
    /**
        ...
        @param _tokenAddress the address of the etherice token
    */
    function doStartComp(address _tokenAddress) external  {
        ...
        _tokenContract = EthericeTokenInterface(_tokenAddress);   
        startLottery = true;
