...
// GO TO LINE 1904 TO SEE WHERE THE DUCKS CONTRACT STARTS
...
contract DandyDucks is ERC721, Ownable {

    using SafeMath for uint256;

    string public DUCK_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN DUCKS ARE ALL SOLD OUT

    string public LICENSE_TEXT = ""; // IT IS WHAT IT SAYS

    bool licenseLocked = false; // TEAM CAN'T EDIT THE LICENSE AFTER THIS GETS TRUE

    uint256 public constant duckPrice = 30000000000000000; // 0.03 ETH
    ...
    constructor() ERC721("Dandy Ducks Club", "DDC") { }
    ...
    function mintDandyDuck(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint a Duck");
        require(numberOfTokens > 0 && numberOfTokens <= maxDuckPurchase, "Can only mint 20 tokens at a time");
    ...
    // GET ALL DAUCKS OF A WALLET AS AN ARRAY OF STRINGS. WOULD BE BETTER MAYBE IF IT RETURNED A STRUCT WITH ID-NAME MATCH
