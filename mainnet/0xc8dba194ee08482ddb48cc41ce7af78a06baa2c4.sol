...
contract SantasLoot is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santas Loot"; // 
    string private constant _symbol = unicode"HOHOHOLD"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xc8475D80EA401C5b59E8be5379b0206b71D19e5a).transfer(ethToSend); //marketing wallet
    }
