...
contract MyToken {
   ...
   uint8  public decimals;  // ERC20标准，decimals 可以有的小数点个数，最小的代币单位18,是建议的默认值
    ...
    * 初始化构造 小数位数要写9。
    */
   constructor(uint256 _initialSupply, string memory _tokenName, string memory _tokenSymbol, uint8 _decimals){
       totalSupply = _initialSupply;  // 供应的份额，份额跟最小的代币单位有关，份额 = 币数 * 10 ** decimals。
