...
╚═╝      ╚═════╝ ╚═════╝ 
 ...
 🖥WEBSITE: TheFudToken.com
 💬 TG: t.me/FudTokenOfficial
 🐤Twitter: Twitter.com/Fud_Token
 💧Vimeo: Vimeo.com/TheFudToken

Fear, Uncertainty and Doubt

While typically it is the death of most tokens, we have chosen to embrace the darkness. 
Sometimes you must flip the script.

What does “Tochi’s Fair Launch” mean?
“A Tochi's word is valued and stronk. For a frog is only as powerful as his croak.”

Tochi’s Fair Launch means upon Launch, the liquidity will be locked. The roadmap is 
genuine, realistic, honest, and achievable. The Tochi Fair Launch stamp certifies 
it’s made by the trustable clean conscious team of artists, “Team Tochi”. 
There won’t be preloaded wallets, there won’t be a fake NFT marketplace, just pure, 
...
contract TheFudToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Fud Token";//
    ...
    address payable private _developmentAddress = payable(0x5BB81974Aa9a538cfb58eD763B0dCDC66dD1ec15);//
    address payable private _marketingAddress = payable(0x616AcF5237854EC7B10f7B8E353260691c2AC776);//
