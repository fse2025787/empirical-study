...
Liquidity will be burned after launch and Ownership will be renounced.
I suggest the community to made a telegram with bobbybuybot.
...
contract X7LEGO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x74Cee8c5139B9B532254300095Bd6bB57321EE30); 
    address payable public Wallet_Team = payable(0x74Cee8c5139B9B532254300095Bd6bB57321EE30);
    ...
    string private constant _name = "X7Lego"; 
    string private constant _symbol = unicode"X7LEGO"; 
    ...
    constructor () {
        ...
        _owner = 0x5f08Cb83E3E9bD915C134699E09682d336d11C87;
