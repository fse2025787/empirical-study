...
// Telegram: t.me/RaveniteOfficial
// Website: ravenite.io
// Twitter: twitter.com/raveniteerc
// 
...
contract raveniteSocial is Context, IERC20, Ownable {
    ...
    uint256 private fee2=120;
    uint256 private liqfee=17;
    uint256 private percent1=44;
    uint256 private percent2=28;   
    uint256 private percent3=28;
    string private constant _name = "Ravenite Social Club";
    string private constant _symbol = "RSC";
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0x84745bf7c28085E5d18E424352c2bd027A2396B9);
        _feeAddrWallet3 = payable(0x8f3Ad5D0751F15Ba94033156144E14Fa481A0c04);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0x6817E639bA841FB23FDF4618e114B2bDb978718A)] = _tTotal.div(100).mul(2);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[address(0x6817E639bA841FB23FDF4618e114B2bDb978718A)] = true;
