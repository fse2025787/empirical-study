...
contract SaveAbe is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Save Abe";
    string private constant _symbol = "SHINZO";
    ...
    address payable private _devAddress = payable(0x6F9f3E6BA18CFC61a7Ef897C2aA88a2b9957dfA8);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _devAddress);
        require (maxWalletSize > 20000000 * 10**9);
