...
contract DekuInu is Context, IERC20, Ownable {
    ...
    string private _name = "DekuInu";
    string private _symbol = "DEKU";
    ...
    uint256 public _marketingFee = 3; // All taxes are divided by 100 for more accuracy.
