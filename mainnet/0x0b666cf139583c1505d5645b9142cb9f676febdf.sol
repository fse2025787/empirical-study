...
I know he will greet me there when I arrive. 
...
contract NamikoHoraizan is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        maxWallet = initialSupply * 2 / 100; //2% 
        ...
        setBuyTax(10,10); 
        setSellTax(10,10); 
        setTaxWallets(0x9363672B07BE136b4Fb2f5807f409320770bE423); 
        exclude(msg.sender);
