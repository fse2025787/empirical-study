...
contract Web80085 is Context, IERC20, Ownable {
    ...
    constructor () {
        _name = "Web 80085";
        _symbol = "Web of Boobs";
        _decimals = 9;
        _tTotal = 80085 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 10 * 10 ** _decimals;
        _marketingWalletAddress = 0xd904A012494155123e1761eC4E6944D9736cea7F;
