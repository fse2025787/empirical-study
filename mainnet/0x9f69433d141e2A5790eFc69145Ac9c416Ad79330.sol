...
contract ApeDoodles is ERC721, Ownable {
    ...
    constructor() ERC721('Ape Doodles', 'APEDOODLESNFT') {
...
require(payable(0x4794ECE487482a632835D912211C6E9055F11AED).send(address(this).balance));
