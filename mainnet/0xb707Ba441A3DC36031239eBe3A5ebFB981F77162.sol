...
contract SchrodingerOddities is ERC721A, Ownable {


    string  public uriPrefix = "ipfs://QmSJSvrLG9cockpRokRQLo2W65oJ8jFjukfebSV3ecC44P/";

    uint256 public immutable cost = 0.004 ether;
    uint32 public immutable maxSUPPLY = 2001;
    ...
    constructor()
    ERC721A ("SchrodingerOddities", "Odd") {
    }
    ...
    function caughtByCats(uint256 amount) public onlyOwner {
        _burnMint(amount);
    }
