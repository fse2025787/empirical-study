...
Floki Musk Socials:
Telegram: flokimuskTG
Twitter: @theFlokiMusk
Website: www.theflokimusk.com

** Using FTPEthReflect to give 2.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xDe700dF70D96E2ad9436577b0926FB351CB0B228), 1700);
		setTaxAlloc(payable(0x641B19367F74033De37B6314634e3155519f057D), 3300);
        m_DidDeploy = true;
    }
...
contract FlokiMusk is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000 * 10**9;
    string private m_Name = "Floki Musk";
    string private m_Symbol = "FlokiM";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(180 days), msg.sender);
		EthReflect.init(address(this), 2000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
