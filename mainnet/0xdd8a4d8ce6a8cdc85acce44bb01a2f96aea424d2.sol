...
contract CroatiaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Croatia Inu";
    string private constant _symbol = "Croatia Inu";
