...
contract CryptoInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 250000 * 10**_decimals;
    string private constant _name = unicode"Crypto Inu";
    string private constant _symbol = unicode"CPINU";
    uint256 public _maxTxAmount =   3750 * 10**_decimals;
    uint256 public _maxWalletSize = 7500 * 10**_decimals;
    uint256 public _taxSwapThreshold=2500 * 10**_decimals;
    uint256 public _maxTaxSwap=7500 * 10**_decimals;
