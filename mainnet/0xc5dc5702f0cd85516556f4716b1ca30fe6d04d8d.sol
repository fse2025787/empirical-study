...
contract WAGDIE is Context, IERC20, Ownable {
    ...
    string private constant _name = "WAGDIE";
    ...
    uint256 public _maxWalletAmount = 300000000 * 10**_decimals;
    ...
    address payable private _marketingAddress = payable(0xE45F41AB037ae2a29F9193661E8f00e9817afaAf);
    address payable private deploymentWallet = payable(0xE45F41AB037ae2a29F9193661E8f00e9817afaAf);
