...
contract AngryPufferFfish is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3250;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("AngryPufferFfish", "APF", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function FisherMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
