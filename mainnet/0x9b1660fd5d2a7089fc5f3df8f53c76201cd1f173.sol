...
contract FifaWorldShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fifa World Shib";
    string private _symbol = unicode"FWS";
    ...
    address payable public marketingWalletAddress = payable(0xF946278329b4726075AAAAE3A52D3180c1f7C443); 
    address payable public BurnedWalletAddress = payable(0xF946278329b4726075AAAAE3A52D3180c1f7C443); 
