...
// https://www.thedumbdragon.com/
// https://t.me/dumbdragonerc
// 
...
contract DUMB is ERC20, Ownable {
    ...
    address payable _marketingWallet =
        payable(address(0x55EdC2A4B9262819fD94905d73bEcaDC69220934)); // marketingWallet
    address payable _devWallet =
        payable(address(0x088eeb85D8f1E643328a800B8e32A25877d8763B)); // devWallet
    ...
    constructor() ERC20("Dumb Dragon", "$DUMB") {
    ...
    function swapAndSendToMarketing(uint256 tokens) private lockTheSwap {
        ...
        uint256 devShare = newBalance.div(3);
