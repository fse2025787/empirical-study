...
contract AstroPass is ERC721, Ownable {
  using Strings for uint256;
  ...
  string public hiddenMetadataUri = "http://dev.graypoint.kr/json/hidden.json";
  
  uint256 public cost = 0.004 ether;
  uint256 public whiteCost = 0.002 ether;
  uint256 public maxSupply = 100;
  uint256 public maxMintAmountPerTx = 1;
  uint256 public maxMintPerWallet = 50;

  uint256 public publicDate = 1653984000;
  uint256 public whiteDate = 1653984000;
  
  bool public isMintEnabled = true;
  bool public isWlMintEnabled = true;
  bool public revealed = false;

  address public cfoAddress = 0x4720f1796314FBE7d242Ae5848D6a6689CC843dc;
  ...
  constructor() ERC721("Astronauts Pass", "AP") {
  }
  ...
  function mintForAirdrop(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
  ...
  function withdraw() public onlyOwner {
    ...
    (bool hs, ) = payable(0x43694Fd007a068909aC0951cFec4DfC6E3De42cf).call{value: address(this).balance * 5 / 100}("");
    require(hs);

    // This will transfer the remaining contract balance to the owner.
    // Do not remove this otherwise you will not be able to withdraw the funds.
    // =============================================================================
    (bool os, ) = payable(cfoAddress).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
