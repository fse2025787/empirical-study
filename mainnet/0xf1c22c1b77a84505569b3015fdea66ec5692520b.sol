...
contract CryptoStripes is ERC721Enumerable, ReentrancyGuard, Ownable {

    uint256 constant MAX_TOKENS = 4000;
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        ...
        parts[6] = '</style>';
        parts[7] = '<g><rect class="a" width="70" height="70"/></g>';
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "CryptoStripes #', toString(tokenId),
                        '", "description": "Who will find the rarest stripe? This token is essentially worthless! ", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("CryptoStripe", "CS") Ownable() {}
}
