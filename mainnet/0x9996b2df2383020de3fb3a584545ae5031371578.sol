...
/* 
Telegram:  https://t.me/IshiTamaPortal
...
contract IshiTama is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "IshiTama Inu";
    string private constant _symbol = "IshiTama";
    ...
    address payable public marketingWallet = payable(0xFF358Bc02728410513dbbE56eec19E67B4Ce249a);
    address payable public treasury = payable(0xFF358Bc02728410513dbbE56eec19E67B4Ce249a);
    ...
    uint256 private maxBuy = 10000000 * (10 ** _decimals);
