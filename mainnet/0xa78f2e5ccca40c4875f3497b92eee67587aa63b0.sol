...
contract UCats is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmarpurGT1jMFH2bdGpwfMaDztjTABy3wvQAFm5a2HHmwu";
    ...
    uint256 public PUBLIC_SALE_PRICE = 0.00606 ether;
    ...
    constructor(
    ) ERC721A("Ugly Cats", "UCats", 100, maxSupply) {
    }
