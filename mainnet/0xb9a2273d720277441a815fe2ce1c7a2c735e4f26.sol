...
First ETH/BTC > SHIB mixer on Shibarium.
...
contract SHIBNADO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibnado";
    string private constant _symbol = "sNADO";
