...
contract ELIZABETHAN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "God Save The Queen";//
    string private constant _symbol = "ELIZABETHAN";//
    ...
    address payable private _developmentAddress = payable(0x3953Ba6668F996A8e5840ac2DE9Bb93Ad53254ef);//
    address payable private _marketingAddress = payable(0x3953Ba6668F996A8e5840ac2DE9Bb93Ad53254ef);//
