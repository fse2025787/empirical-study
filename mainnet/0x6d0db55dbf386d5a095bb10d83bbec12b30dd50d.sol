...
contract BabyBitcoinBlack is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Baby Bitcoin Black";
    string private constant _symbol = "BBTCB";
    ...
    address payable private _developmentAddress = payable(0x761DBa57A8B982Cdfc29e2e5669ef881241e3C3b);
    address payable private _marketingAddress = payable(0x761DBa57A8B982Cdfc29e2e5669ef881241e3C3b);
