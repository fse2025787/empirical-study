...
/* 
    The link to all, connecting to the creator himself. 
 
     - Bringing Protocols, Projects, Chains, People together & more details to be released. 
 
    "You can never imagine what you are getting into, early." 
 
    Taxes (3% Liquidity, 2% Marketing) will be used for the future upgrading of our protocol and to strengthen our entry for whales,  
    initial exchange listings will be done through connections shortly. 
 
    Socials will only be released once we have all the connections ready for the public. 
 
    *There'll be a letter from the team, which'll be posted in the transactions later on. EST 13-16 Sept.* 
 
    As a bot prevention measure, we'll be blacklisting the first 5 blocks for snipers. 
*/
...
contract MERGEPROTOCOL is Context, IERC20, Ownable {
    ...
    string private constant _name = "MERGE PROTOCOL";
    string private constant _symbol = "MPE";
    ...
    constructor () {
        _MarketingWallet = payable(0xfF5B30132EcF90E563097d3890931047C8e7eF0F);
        _liquidityWallet = payable(address(0xE8272a103176dCEd4c6a025CC1e51F3907Ee28C7));
        _rOwned[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MarketingWallet] = true;
        _isExcludedFromFee[_liquidityWallet] = true;
        emit Transfer(address(0x48C5246f728a0a60D8C766bbbaddfcDBB2D84933), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 2e6 * 10**9; // 2,000,000 or 2%
        _maxSellAmount = 2e6 * 10**9; // 2,000,000 or 2%
        _maxWalletAmount = 2e6 * 10**9; // 2,000,000 or 2%
        swapTokensAtAmount = 5e5 * 10**9; // 500,000
        tradingOpen = true;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        ...
        require(newAmount <= 5e5 * 10**9, "Swap amount cannot be higher than 0.5% total supply.");
