...
/**
Chad Scanner Bot is brand new blockchain scanner tool.

With a built in wallet tracker, contract simulator, contract analyser and simple to use GUI this is the only tool a CHAD needs to get the upper hand when trading on ETH/BSC.

The future is chad.

www.chadscannerbot.com 
...
contract ChadScannerBot is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'ChadScannerBot';
    ...
    address internal constant development_receiver = 0x3A83D3292D4A8bAdF32083DC456bA1d9F3C01F89; 
    address internal constant marketing_receiver = 0x3A83D3292D4A8bAdF32083DC456bA1d9F3C01F89;
    address internal constant liquidity_receiver = 0x3A83D3292D4A8bAdF32083DC456bA1d9F3C01F89;
