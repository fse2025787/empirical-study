...
contract GROGOD is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "GROGOD";
    string private constant _symbol = "GROGOD";
    ...
    address payable private _developmentAddress = payable(0x76A4adb64671EEE8DAb0e3EccEc5d0c2C249DCC3);
    address payable private _marketingAddress = payable(0x76A4adb64671EEE8DAb0e3EccEc5d0c2C249DCC3);
