...
contract extensionLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Extension Bag #', toString(tokenId), '", "description": "Extension Loot is second set of Loot, a randomized adventurer gear generated and stored on chain. It uses the same algo as Loot, Extension Loot is just more Loot. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Exension Loot in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function claim(uint256 tokenId) public nonReentrant {
        require(tokenId > 8000 && tokenId < 15778, "Token ID invalid");
    ...
    constructor() ERC721("Extension Loot", "xLOOT") Ownable() {}
}
