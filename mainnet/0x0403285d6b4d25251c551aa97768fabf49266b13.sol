...
In 2007, "I" heard the "doomsday prophecy", the mysterious Maya said that the world would end on December 21, 2012...
"I" was confused and panicked, not knowing where it came from and where it was going. Since then, I've traveled all over the world in search of meaning in life...
"You Only Live Once"
"I" went to the birthplace of Jesus and walked through the "death road" of his crucifixion. I once prayed for the world beside the "Wailing Wall"; "I" also walked through the enlightened India of Sakyamuni, and communicated with him spiritually under the Bodhi tree; "I" went from Jerusalem to Everest; from Bethlehem to Mecca...
Along the way, I was looking for the ideal country in my heart and the "spiritual home" of "my".
We found the spiritual sustenance in NFT, and then we hope to let more people know our story, so two of our members are responsible for launching our tokens, So that our community is more complete, both NFT and token.
  
                                     https://yolo.holiday/
                                     https://twitter.com/yoloholidaynft
...
contract YOLO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("You Only Live Once", "YOLO") {
        ...
        swapTokensAtAmount = 1 * 1e5 * 1e18; // 0.1% swap threshold for the CA
		...
		marketingWallet = address(0x712B45Da8dFCa8ADB345e85AfEe20685093E7b9A); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x712B45Da8dFCa8ADB345e85AfEe20685093E7b9A)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x712B45Da8dFCa8ADB345e85AfEe20685093E7b9A)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x712B45Da8dFCa8ADB345e85AfEe20685093E7b9A)] = true;
