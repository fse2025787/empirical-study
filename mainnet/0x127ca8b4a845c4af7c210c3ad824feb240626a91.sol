...
contract AKITA is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if(contractTokenBalance >= _swapTokensAtAmount*7)
            {
                contractTokenBalance = _swapTokensAtAmount*7;
            }
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
        ...
        require (_maxTxAmount >= _maxTxAmount/100,"Max Tx Amount must be more than 1%");
    }

    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
        _maxWalletSize = _tTotal*maxWalletSize/100;
         require (_maxWalletSize >= _maxTxAmount/100,"Max Wallet Size must be more than 1%");
    }
