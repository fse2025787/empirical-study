...
//
 ...
 contract SmartWalletSecurity is ERC20, Ownable {
     ...
     constructor() ERC20("Smart Wallet Security", "SMART") {
     ...
     function updateMaxWallAmount(uint256 newNum) external onlyOwner {
         require(
