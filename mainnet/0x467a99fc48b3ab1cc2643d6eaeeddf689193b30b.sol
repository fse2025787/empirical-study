...
contract TheSpartans is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("The Spartans", "SPARTANS") {
        setHiddenMetadataUri("https://api.thespartans.xyz/");
        setBaseURI("https://api.thespartans.xyz/");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more SPARTANS");
