...
// One last hoorah?! Contract renounced. Moon mission confirmed. ETH 2.0 LFGGG!
// https://t.me/mergecomparty
...
contract TheMERGE is ERC20, Ownable {
    ...
    constructor() ERC20("The Great Merge", "MERGE2.0") {
        ...
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05% from total supply swap amount
        ...
        treasuryWallet = address(0xE99CFD9873e9B96dd594C96a6d53709628139E8F); // set as treasury wallet
