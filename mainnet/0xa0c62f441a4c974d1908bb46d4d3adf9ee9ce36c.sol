...
contract EthDiamonds is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"EthDiamonds"; ////
    string public constant symbol = unicode"ETHDIAMONDS"; ////
