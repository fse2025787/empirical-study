...
0 TAX - LET'S GIFT ELON MUSK A NEW SEX TAPE

TELEGRAM: T.ME/ELONSEXTAPE
...
contract ElonSexTape is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonSexTape";
    string private constant _symbol = "ElonSexTape";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xa4e1B3Ee998837dcC059CCa05538bBE2AF874049);
        _feeAddrWallet2 = payable(0xa4e1B3Ee998837dcC059CCa05538bBE2AF874049);
