...
{
  uint256 constant MASK_128 = 0xFFFFFFFFFFFFFFFF;
   ...
   */
  function initialize(string memory uri_, uint256 priceInKOOKS_)
    public
    initializer
  {
   ...
   * token
   */
  function openMint(uint128 tokenId, uint128 mintpassesToHold)
    external
    onlyOwner
  {
   ...
   */
  function _lockedMintPasses(uint256 tokenId, address account)
    internal
    view
    returns (uint256)
  {
