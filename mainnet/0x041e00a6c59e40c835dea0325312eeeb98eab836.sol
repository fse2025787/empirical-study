...
contract ObiWanInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Obi Wan Inu";
    ...
    address payable private _developmentAddress = payable(0x24c2668628839dBf4cBAD01A5F7a9f5362223a61);
    address payable private _marketingAddress = payable(0x24c2668628839dBf4cBAD01A5F7a9f5362223a61);
