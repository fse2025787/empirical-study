...
contract OnlyFans is Ownable, ERC721A {

    // constants
    uint256 constant MAX_ELEMENTS = 2222;
    ...
    constructor(uint256 maxBatchSize_) ERC721A("OnlyFans VIP", "ONLY", maxBatchSize_) {}
