...
contract MYSC is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    uint256 public constant max_Cubes = 412; 
    uint public cubesReserve = 22; 
    uint public ticketsCount = 22; 
    uint public maxTickets = 412; 
    ...
    mapping(uint => string) public member_Name; 
    mapping(uint => string) public cube_Quote; 
    mapping(uint => string) public art_Path; 
    mapping(uint => string) public metaverse_Path; 
