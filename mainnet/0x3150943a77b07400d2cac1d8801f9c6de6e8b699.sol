...
contract DOSAT  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DREAM OF SATOSHI";
    string private constant _symbol = "DOSAT";
    ...
    address payable private _developmentAddress = payable(0x8429EBC5F983e3FAe1533667F4ea8031AAD71625); 
    address payable private _marketingAddress = payable(0x12f8f4f07748fe5F5A2019D6d3D0B9D6ddFb8039);
    ...
    function enableLimits(bool _limitsEnabled) public onlyOwner {
