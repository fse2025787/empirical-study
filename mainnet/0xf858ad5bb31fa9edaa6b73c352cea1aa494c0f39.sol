...
contract Staking is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, WhitelistChecker, ERC721EnumerableUpgradeable, IERC721ReceiverUpgradeable {
	...
	function editGen2BagIds(uint256 _tokenId, uint256 _bagId) external onlyOwner {
		gen2BagIds[_tokenId] = _bagId;
	}

	function editGenBagIds(uint256 _tokenId, uint256 _bagId) external onlyOwner {
		genBagIds[_tokenId] = _bagId;
	}
	...
	function modifyBagInfo(
		...
		bags[_bagId].gen2TokenIds = _gen2Ids;
