  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x763bCC357Acb5959f1a71Dc7905Dd2DD619C5218);
        ...
        function mintTo(address _to) public payable {
            ...
            require(msg.value == PRICE, "Value needs to be exactly 0.01 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/sussyBallsContract.sol

    //

    pragma solidity ^0.8.0;

    contract SussyBallsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Sussy Balls", "SUSSY", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmVJJAdAmdTAV2R5krLmzjQeb4cCBU8JA5p5jVeS3oMRbR/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/N2f9BBgkRzENDeRC3sCM/contract-metadata";
        }
    }