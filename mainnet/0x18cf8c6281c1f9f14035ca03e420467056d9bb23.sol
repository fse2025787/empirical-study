...
/*
https://t.me/The100PercentCommunity
*/
...
contract The100Community is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 0.00001 * 10e18;
    uint256 public maxTxAmount = 1 * 10**18;
    uint256 public maxWalletAmount = 2 * 10**18;
    
    address public marketingWallet = 0x403DF7d299b5DdD26c028Aff509F4aBFdcA5F472;
    address public devWallet = 0x403DF7d299b5DdD26c028Aff509F4aBFdcA5F472;
    ...
    modifier inSwap() {
     ...
     constructor() ERC20("The100%Community", "100%") {
        _mint(msg.sender, 1e2 * 10 ** decimals());
