...
// Telegram : https://t.me/BoredAIEth

// Twitter : https://twitter.com/BoredAIEth
...
First Decentralize Social Media Platform

⭐️ No Private Sale  💎
📱TELEGRAM https://t.me/BoredAiETH

💎💎is a Decentralized Social Media Platform that aims to develop a “Smartway Decentralized” communication, a combination of both cryptocurrency innovation and social media modernization. ❤️

🐦 TWITTER : https://twitter.com/BoredAiEth


⭐️  Launch on ERC Chain 
🔐  Liquidity LOCKED 
⭐️  0% Tax ==> 
...
contract BOREDAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public UnderAmount = 2;

    uint256 public ValueThree = 2;
    uint256 public Txtimestamp = 2;
    uint256 public MaxSwapPerc =100;
    ...
    constructor() ERC20("BORED AI", "BAI") {
        ...
        uint256 _sellMarketingFees = 0;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 0;

        uint256 _feeDenominator = 100;

        uint256 _TimeStampInitial =0;
 
        uint256 totalSupply = 1_000_000 * 1e9;
 
        maxTransactionAmount = totalSupply ; // 3% maxTransactionAmountTxn
        ...
        marketingWallet = address(0xE795CDc70c3a59EC7Ca684B589915A8B28059Ae2); // set as marketing wallet
        devWallet = address(0xE795CDc70c3a59EC7Ca684B589915A8B28059Ae2); // set as dev wallet
    ...
    function CoolDownStarts(uint256 _sum) public {
