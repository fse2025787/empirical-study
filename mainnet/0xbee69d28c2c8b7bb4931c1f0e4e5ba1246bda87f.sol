...
/*
Been watching from the sidelines for a while now..
The Ryoshi larp trend is getting out of control, so many rugs and pump and dumps that only feed devs.
As i couldn't stand anymore and just watch i give you the last ryoshi , no tax ,no nothing , all based on community like it should've been from the start.
My friend wanted to leave $SHIB since it wasn't going in the direction he wanted it to , i will not leave this one.
*/
...
contract TLR is ERC20, Auth {
    ...
    string public constant name = "The Last Ryoshi";
    string public constant symbol = "Chosen1";
