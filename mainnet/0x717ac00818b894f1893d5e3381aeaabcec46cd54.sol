...
contract OtterResearchNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TOTAL_SUPPLY = 300;

    uint256 public constant MAX_PRE_SALE_MINTS = 250;

    uint256 public constant PRE_SALE_PRICE = 0.5 ether;

    uint256 public MAX_PUBLIC_SALE_MINTS = 25;

    uint256 public constant PUBLIC_SALE_PRICE = 0.75 ether;

    uint256 public constant MAX_RESERVE_TOKENS = 25;

    uint256 public constant ROYALTY_PERCENTAGE = 0;
    ...
    function setPublicSaleMint(uint256 max) external onlyOwner {
        MAX_PUBLIC_SALE_MINTS = max;
    }
