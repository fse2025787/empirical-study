...
contract WRLDTakeOverX$WRLD1 is Ownable, ERC721A, ReentrancyGuard {

    bool public publicSale;

    uint256 public constant MINT_PRICE_ETH = 0.025 ether;
    ...
    constructor() ERC721A("WRLDTakeOverX$WRLD1", "WTOG", MAX_BATCH, MAX_TOKENS) {
