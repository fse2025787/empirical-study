...
/**
Welcome to Taika Inu!

Yesterday the $TAICHA team sent last project to half a million within a few hours. 

$TAIKA is here to bring utilities onboard (already completed ready to be released after launch).  

Same dev, same community = Diamond hands in the group 

Website: Https://Taikainu.tech

Telegram: https://t.me/Taikainu
...
contract taikainu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Taika Inu";
    string private _symbol = "TAIKA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x19A52800931944380FCEd2a350473b8Faa8caF0B);
    address payable private taxWallet2 = payable(0x19A52800931944380FCEd2a350473b8Faa8caF0B);
