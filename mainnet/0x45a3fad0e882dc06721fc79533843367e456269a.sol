...
I CAN'T SAY FOR SURE THAT STARTSHIP WILL REACH ESCAPE VELOCITY, BUT MY HUBRIS CERTAINLY HAS
ELON MUSK TWEETED. ESCAPE VELOCITY IS BORN!
...
//Twitter: https://twitter.com/EscapeVelErc
//Telegram: https://t.me/EscapeVelocityErc
...
interface IUniswapV2Pair {
    ...
    contract EscapeVelocity is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Escape Velocity";
    ...
    address payable public marketingWallet = payable(0x2CdF49fB4FE09BdfBB99F6C9911da5f5be65Ef0e);
