...
//   | $$      | $$  | $$ /$$| $$  | $$| $$  | $$| $$| $$      | $$\  $ | $$ /$$__  $$| $$      | $$ /$$__  $$
//   | $$      | $$  |  $$$$/| $$$$$$$/|  $$$$$$/| $$| $$      | $$ \/  | $$|  $$$$$$$| $$      | $$|  $$$$$$$
//   |__/      |__/   \___/  |_______/  \______/ |__/|__/      |__/     |__/ \_______/|__/      |__/ \_______/
//

contract PitbullMafia is ERC721, Ownable, ERC721Enumerable {
    ...
    uint256 public constant publicMaxPerWallet = 8000;
    uint256 public constant whitelistMaxPerWallet = 0;

    string public contractURI =
        "https://ipfs.io/ipfs/QmbJWey8dGcUJ5bgRweez4WT2FakjVb39FnpZVgecP9bsZ/contract.json";
    ...
    uint256 public presaleMaxMint = 0;
    uint256 public devReserve = 0;

    event PBMMinted(uint256 tokenId, address owner);

    constructor() ERC721("PitbullMafia", "PBM") {}
    ...
    function mintPBM(uint256 numberOfTokens) external payable {
        ...
        require(
            balanceOf(msg.sender) < publicMaxPerWallet,
            "Can only mint 2 tokens per wallet"
        );
    ...
    function presalePBM(uint256 numberOfTokens) external payable {
        ...
        require(
            balanceOf(msg.sender) < whitelistMaxPerWallet,
            "Can only mint 1 token per wallet in Pre-sale"
        );
        ...
        returns (string memory)
    {
        ...
        if (isRevealed == false) {
            return
                "ipfs://QmbJWey8dGcUJ5bgRweez4WT2FakjVb39FnpZVgecP9bsZ/hidden.json";
        }
