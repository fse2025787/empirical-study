...
contract FLOKILFG is Context,IERC20, Ownable{
using Address for address;
string private _name = "FLOKI LFG";
string private _symbol = "FLFG";
...
address _owner;
address payable public marketingAddress = payable(0xCC60202660478E659ed2D2314f4F88e0Ae508323);
...
function COINDay() public onlyOwner{
    require(block.timestamp > FLFGCOINDaycooldown, "You cant call FLFGCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function FLFGCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    FLFGCOINDaycooldown = block.timestamp + 86400;
}
