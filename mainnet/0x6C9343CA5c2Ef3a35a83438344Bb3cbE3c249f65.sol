...
contract BoardApeCollective is ERC721Enumerable, Ownable {
    
    
    address private _controlCenter;
    uint256 public constant max_apes = 2001;
    uint256 private _maxRedemption = 10;
    uint256 private _mintLimit = 10;
    uint256 private _price = 70000000000000000; //0.5 ETH
    uint256 private _memberPrice = 5000000000000000;
    uint256 private _publicSaleTime = 1642876500;
    uint256 private _whitelistSaleTime = 1642876200;
    ...
    constructor(string memory baseURI, string memory provenanceHash)
        ERC721("Board Ape Collective", "BAC")
    {
        setBaseURI(baseURI);
    ...
    function mint(uint256 _count) public payable {
        ...
        require(totSupply < max_apes, "All Apes have been Claimed.");
        require(totSupply + _count <= max_apes,"There are not enough Apes available");
