...
// 
/*
 __  __ ___ _   _ ___ ___  ____  _____ _   _ __  __ 
|  \/  |_ _| \ | |_ _/ _ \|  _ \| ____| | | |  \/  |
| |\/| || ||  \| || | | | | |_) |  _| | | | | |\/| |
| |  | || || |\  || | |_| |  _ <| |___| |_| | |  | |
|_|  |_|___|_| \_|___\___/|_| \_\_____|\___/|_|  |_|

Evolving from ocean-dwelling organisms at the dawn of time, 
Minions have been searching for a master for hundreds of years. 
Without someone to serve the Minions fall into a deep depression. 
But Kevin, has a plan to accompanied by his pals Stuart and Bob, he sets out to find a new evil boss for his brethren to follow.

https://t.me/minioreum
https://t.twitter/minioreum
*/
...
contract Minioreum is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Minioreum";
    string private constant _symbol = "Minioreum";
    ...
    address payable private _developmentAddress = payable(0xb9d0f05917e56dBa0983873F190759a1087c8cA7); 
    address payable private _marketingAddress = payable(0xb9d0f05917e56dBa0983873F190759a1087c8cA7);
