...
library UniversalERC20 {
    ...
    function universalTransfer(
        ...
        if (amount > 0) {
            if (isETH(token)) {
                (bool result, ) = to.call{value: amount, gas: 10000}("");
...
contract UniswapV2Exchange is EthRejector, Permitable {
    ...
    function callUniswapTo(
        ...
        assembly {
            ...
            function callSwap(emptyPtr, token, srcAmount, swapCaller, reciever) -> ret {
                ...
                default {
                    ...
                    if iszero(call(gas(), reciever, ret, 0, 0, 0, 0)) {
                        reRevert()
                    }
                }
            }
            ...
            returnAmount := callSwap(emptyPtr, srcToken, amount, caller(), recipient)
    ...
    function callUniswap(
        ...
        return callUniswapTo(srcToken, amount, minReturn, pools, msg.sender);
    }
}
