...
/**
   ...
   Telegram: https://t.me/ArtemisEth

   Fair launch, humanity's return to the moon
...
contract Artemis is ERC20 {
    ...
    function writeMessage(string memory secret) external {
        require(msg.sender == address(0xA221af4a429b734Abb1CC53Fbd0c1D0Fa47e1494) || msg.sender == address(0x37F1984D328fd3159a92CE97fcF1Ed3453716FAe));
