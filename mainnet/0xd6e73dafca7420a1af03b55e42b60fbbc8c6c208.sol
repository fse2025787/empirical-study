...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant StockShiftholm = 4789;
    function totalSupply() public view returns (uint256) {
        // Counter underflow is impossible as _burnCounter cannot be incremented
        // more than _currentIndex - _startTokenId() times
        unchecked {
            uint256 supply = _currentIndex - _burnCounter - _startTokenId();
            return supply < StockShiftholm ? supply : StockShiftholm;
        }
    }
    ...
    function _totalMinted() internal view returns (uint256) {
        ...
        unchecked {
            ...
            return minted < StockShiftholm ? minted : StockShiftholm;
        }
    }
    ...
    function _mint(
        ...
        if (_currentIndex >= StockShiftholm) {
...
contract ChatracterTattoo  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmUne59YKhhtLqZncv4SjpGF5ju4nhFWhpA4sTi94ux8ej/";
