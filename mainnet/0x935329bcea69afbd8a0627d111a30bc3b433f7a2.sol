...
// File contracts/dualRoles/IERC4907.sol
...
// File contracts/ComplexDoNFT.sol
...
contract ComplexDoNFT is WrapDoNFT, Royalty, IComplexDoNFT {
        ...
        returns (uint256 tid)
    {
        ...
        oid2vid[oid] = tid;
        this.checkIn(lastOwner,tid,curDurationId);
    }
