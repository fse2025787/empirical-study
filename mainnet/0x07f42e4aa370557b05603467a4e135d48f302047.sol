...
TSUKABANK ($TSUKABANK), inspired by DEJITARU TSŪKA, will be the first saving-related coin ever to exist in the Ethereum blockchain.

Holders can vote on important issues and make their suggestions and proposals. 

TSUKABANK team aims to shift wealth into the decentralized finance (DeFi) ecosystem.TSUKABANK seeks to protect an essential part of the TSUKABANK community. All hail the $TSUKABANK with strong diamond hands! 50% tax from total buy/sell is redistributed to holders. 

Additionally, the status change to Decentralized Autonomous Organization will bring more new use cases for the $TSUKABANK Token.

We believe that $TSUKABANK is the best way for our community to actively participate and shape the project because we all come in safe.


T.me/tsukabank

https://twitter.com/tsukabanketh

Linktr.ee/tsukabank

https://medium.com/@tsukabanketh/welcome-to-tsuka-bank-6a326e655a6
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xc5fB36dd2fb59d3B98dEfF88425a3F425Ee469eD)); // Tsuka - 0xc5fB36dd2fb59d3B98dEfF88425a3F425Ee469eD
...
contract tsukabank is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bank of Tsuka", "TsukaBank") {

        uint256 totalSupply = 100 * 1e10 * 1e18;
        
        maxTransactionAmount = totalSupply * 20 / 1000; // 2% max transaction
        swapTokensAtAmount = totalSupply * 20 / 1000; // 2% swap tokens amount
