...
contract TattooMoneyPublicSaleIX {
    ...
    /// max tokens per user is 333333 as $15000 is AML limit
    uint256 public constant maxTokens = 222_222*(10**DECIMALS_TAT2);
    ...
    uint256 public tokensforadolar = 14_814_814_814_814_814_814;
    ...
    constructor(
        ...
        uint256 _startDate, // 9-12-2021  20:22:22 GMT (1639088542)
        uint256 _endDate //  13-1-2022  22:22:22 GMT (1642112542)
    ) {
        owner = _owner;
