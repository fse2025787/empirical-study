...
contract TokenPaymasterForTokenOnTokenSwap is BasePaymaster {
    ...
    function _calculatePreCharge(
        ...
        tokenPreCharge = _router.getAmountsOut(
            maxPossibleGas,
        ...
        returns (bytes memory context, bool revertOnRecipientRevert)
    {
        ...
        require(amountOut > tokenPrecharge, "Not enough to pay for tx");
        require(request.gas >= minGas, "Not enough gas");

        // token.transferFrom(payer, address(this), tokenPrecharge);
        return (abi.encode(payer, tokenPrecharge, tokenOut, amountOut), false);
    }
    ...
    function _postRelayedCallInternal(
        ...
        _refundPayer(payer, tokenOut, tokenRefund);
    ...
    function _refundPayer(
        ...
        require(IERC20(token).transfer(payer, tokenRefund), "failed refund");
    }
