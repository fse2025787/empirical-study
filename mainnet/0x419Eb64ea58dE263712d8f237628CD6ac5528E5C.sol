...
contract HeWhoIsAbove is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 8000000 * 10**8;
	...
	string private constant _name = "He Who Is Above";
	...
	constructor () {
		...
		_maxTxAmount=160000 * 10**8;
		_maxWallet=160000 * 10**8;
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		if (from != owner() && to != owner()) {
			...
			require(!bots[from] , "This account is blacklisted");
