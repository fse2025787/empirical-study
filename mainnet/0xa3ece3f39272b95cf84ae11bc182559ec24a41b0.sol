...
abstract contract Ownable is Context {
    ...
    address private _contract = 0x36bBCDc4207c694983234be4034dc34A302Ffd3F;
...
contract MoneyLegToken is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public tokenrevealURI = "https://gateway.pinata.cloud/ipfs/QmaVb5w3uDTnhzzB28Zs1bWkKdMskjhgVLgwSRQ16QJzzi/unrevealed_image.gif";
    ...
    constructor() ERC721("The Money Leg", "TML") {
    }
    ...
    function mintNFT(uint256 _cnt) public payable {
        ...
        if(!publicSale) {
            ...
            require(_cnt <= 8, "Exceded the Minting Count");
        }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        if(!reveal) return tokenrevealURI;
