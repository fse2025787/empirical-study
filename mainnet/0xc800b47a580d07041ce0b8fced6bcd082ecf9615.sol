...
contract Rooms is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _tokenUri, address _newVault) ERC721("Rooms", "ROOMS") {
    ...
    // mint function, will mint 10 each time called
    function mint() public onlyOwner {
        require(totalSupply() + 10 <= MAX_SUPPLY, 'Everything has been minted.');
