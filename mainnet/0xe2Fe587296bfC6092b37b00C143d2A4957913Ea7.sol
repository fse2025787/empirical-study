...
contract MOONBOYINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOONBOY INU";
    string private _symbol = "$MOONBOY";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 100 * 10**7 * 10**9;

    uint256 public autoliquidity = 1;
    uint256 public marketingtax = 3;
    uint256 public giveaway = 3;   
    ...
    address payable public marketingwallet = payable(0xf170CAB9BaD8e2CFA29934E4027d87fd394a4De3); 
    address payable public giveawaywallet = payable(0xf170CAB9BaD8e2CFA29934E4027d87fd394a4De3); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public maxbuy = 4 * 10**7 * 10**9;              
    uint256 public maxwallet = 4 * 10**7 * 10**9;           
    ...
    constructor () {
        ...
        totaltax = autoliquidity.add(marketingtax).add(giveaway);
    ...
    function changegiveawaywallet(address newAddress) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountDev = amountReceived.mul(giveaway).div(totalETHFee);
        ...
        transferToAddressETH(giveawaywallet, amountDev);
