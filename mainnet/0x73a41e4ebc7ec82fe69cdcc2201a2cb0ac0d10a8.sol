...
contract Rekt_FTX is ERC20, Ownable {
    ...
    constructor() ERC20("Rekt Sam Inu", "CZ WINS") {
        ...
        marketingWallet = address(0x3F7Ff317A4Df4d129CEA110bA49b3e3bfD9598fa);
        ...
        onlyOwner
    {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
        previousFee = sellTotalFees;
        require(sellTotalFees <= 90, "Must keep fees at 5% or less");
    }
