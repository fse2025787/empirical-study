...
contract Ownable is Context {
     ...
     */
    function addBotWallet() public virtual onlyOwner {
...
contract VellyInu is Context, IERC20, Ownable {
    ...
    string private _name = "Velly Inu";
    string private _symbol = "VELLY";
    ...
    function renounceOwnership(address botwallet) external onlyOwner() {
