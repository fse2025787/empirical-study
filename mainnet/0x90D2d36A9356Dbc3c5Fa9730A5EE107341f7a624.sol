...
contract PrivateSale is Ownable{
    ...
    constructor(address _token, address _payment, address payable _adminWallet) public {
        ...
        packageAmount[1] = 500 * 1 ether;
        packageAmount[2] = 1000 * 1 ether;
        packageAmount[3] = 5000 * 1 ether;
        packageAmount[4] = 10000 * 1 ether;
        packageAmount[5] = 25000 * 1 ether;
        packageAmount[6] = 50000 * 1 ether;
        packageAmount[7] = 100000 * 1 ether;
