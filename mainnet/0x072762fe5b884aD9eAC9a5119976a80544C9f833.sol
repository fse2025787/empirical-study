...
contract NounChecksRendererV1 is Initializable, OwnableUpgradeable {
    ...
    function initialize(address owner) public initializer {
        _owner = owner;
        description = "This artwork may or may not be nounable.";
        name = "Noun Checks";
        staticBlockNum = 16030;
        contractImage = "ipfs://QmfZj3LDCV1aCwerTj42wgbaPk4iY6aUe6MgYvM3Sayq8u";
    ...
    function getTokenIdSvg(
        ...
        return
            string(
                abi.encodePacked(
                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 320" width="2000" height="2000" shape-rendering="crispEdges"><defs><style>.check{fill: #',
                    params.getCheckColors()[tokenDNA[6]],
                    '}</style></defs><path fill="#',
                    params.getBgColors()[tokenDNA[0]],
                    '" d="M0 0h320v320H0z" /><path fill="#',
                    // frame for theme
                    params.getFrameColors()[tokenDNA[1]],
                    '" d="M80 40h180v180H80z"/><path fill="#',
                    // matte for theme
