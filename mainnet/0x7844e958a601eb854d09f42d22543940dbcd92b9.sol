...
contract DARKy00ts is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string public hiddenMetadataUri;
    ...
    constructor() ERC721A("DARKy00ts", "DARK") {
        setHiddenMetadataUri("ipfs://bafybeicuyqhkqlwtddjza3fijcytq4tvfhesxqcssrdsh5aahq2bvuj4jm/reveal.json");
    }

    uint256 public price = 0.01 ether;
    uint256 public maxPerTx = 10;
    uint256 public maxPerFree = 15;
    uint256 private maxFreeSupply = 8200;
    uint256 public max_Supply = 9000;
