...
contract DogeTsuka is ERC20, Ownable {
    ...
    uint256 private buyTotalFees = 2;
    ...
    address payable public marketingWallet = payable(0x03634645E23C1140Ba04044a630d4c65490167cA);
    address payable public devWallet = payable(0x40f29F8cE884e0eD1504e26637877Dad9a32737e);
    ...
    constructor(address router) ERC20("DogeTsuka", "DUKA") {
