...
// File: contracts/cryptokin17.sol
// Amended by HashLips
/**
    !Disclaimer!
...
contract Cryptokin is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
  string baseURI;
...
ERC721(_name, _symbol)
  ...
  function totalSupply() public view virtual override(ERC721Enumerable, WithLimitedSupply) returns (uint256) {
   return maxSupply;
}
  // internal
