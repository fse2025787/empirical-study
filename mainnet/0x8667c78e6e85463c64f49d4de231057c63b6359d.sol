...
/**
Mix the magic potion round
Add a splash of gains you've found
All day long they hunt for gems
Merlins Magic Potion Sends
After ten days more we wait
the moon is coming, - don't be late. 
*/
...
contract WizardsGuild is ERC20, Ownable {
    ...
    constructor() ERC20("WizardsGuild", "MERLIN") {
        ...
        devWallet = address(0x5bF0AA43530C2920900DF085F6B894610060f1FF); // set as dev wallet
