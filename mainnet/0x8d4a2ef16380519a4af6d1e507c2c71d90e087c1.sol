...
contract EpicSkulls is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xd3470248602b729f5a5ED73Dfe24575a63c19699));

    string private _name = "EpicSkulls";
    string private _symbol = "ESkulls";
