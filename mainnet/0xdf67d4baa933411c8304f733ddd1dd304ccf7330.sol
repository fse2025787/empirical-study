...
contract Plant is ERC721A, TheOperatorFilterer {
    bool private SALEACTIVE = false;

    string URI = "ipfs://QmQwGQ9eRaNY1W3KEJCbTi3DBUFNmFgCF14iDMxcM7SBwn/";

    uint256 public MAXSUPPLY = 498;
    ...
    constructor() ERC721A("Plant 3D by Betaso", "Plant") {
        owner = msg.sender;
    }
