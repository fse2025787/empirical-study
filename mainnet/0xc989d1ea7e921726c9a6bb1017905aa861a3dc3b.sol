 ...
 * - The maximum token ID cannot exceed 2**256 - 1 (max value of uint256).
 */
contract DeepInsideOfMeNFT is IERC721A {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmfTqsjiNDtPF7d7RcS5omngS4gKDzpK1rhb2LF1qeSWQQ/", _toString(tokenId), ".json"));
    }   
