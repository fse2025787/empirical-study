...
contract DubaiInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dubai Inu", "$DUBAI") {
        ...
        uint256 totalSupply = 896000 * 1e18;
 
        maxWallet = 8960 * 1e18; // Max Wallet 1%
        swapTokensAtAmount = 896 * 1e18; // 0.1% swap threshold for the CA
		...
		marketingWallet = address(0x1BcBB0E3025A590104750f455495645916E40b71); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x1BcBB0E3025A590104750f455495645916E40b71)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x1BcBB0E3025A590104750f455495645916E40b71)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x1BcBB0E3025A590104750f455495645916E40b71)] = true;
    ...
    function liftMaxWallet() external onlyOwner {
        maxWallet = 26880 * 1e18; // Max Wallet 3%
    }
