...
contract SantaApe is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x3338046B6B828DE0C2B265C9c8A97136d9D5B87C); // Marketing Address
    address payable public multiSigAddress = payable(0x58e0aa9c87A100E9358Cb458028aE3f2fFa25383); // Marketing Address
    address payable public devAddress = payable(0x3338046B6B828DE0C2B265C9c8A97136d9D5B87C); // Dev Address
    address payable public liquidityAddress = payable(0x3338046B6B828DE0C2B265C9c8A97136d9D5B87C); // Liquidity Address
    ...
    uint256 public _buyMultiSigFee = 25;
    uint256 public _buyMarketingFee = 0;
    uint256 public _buyDevFee = 25;

    uint256 public _sellTaxFee;
    uint256 public _sellLiquidityFee = 0;
    uint256 public _sellMultiSigFee = 25;
