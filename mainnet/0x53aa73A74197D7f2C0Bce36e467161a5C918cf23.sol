...
contract ImageEggsByAnon is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicz36qtffii4betxdbu5jtobi6sfdsmaoes6oge33i4d5eljbwo7e/", Strings.toString(tokenId), ".json")
            );
    }
