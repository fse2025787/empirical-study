...
contract GRAPEAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "GRAPE APE";
    string private constant _symbol = "GRAPEAPE";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x16d4608c1A91D80B110fa5e2f2313cf565Ba6B34);
        _feeAddrWallet2 = payable(0x16d4608c1A91D80B110fa5e2f2313cf565Ba6B34);
        ...
        emit Transfer(
            address(0x5c93dEBc04bB062C42e321D154A88c696F72F768),
            _msgSender(),
            _tTotal
        );
    }
    ...
    function openTrading() external onlyOwner {
        ...
        // .5% 
        _maxTxAmount = 3000000000001 * 10**9;
        _maxWalletAmount = 6000000000001 * 10**9;
        tradingOpen = true;
