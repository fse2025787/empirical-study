...
// File: blockbarBottle.sol

contract BlockBarBottle is ERC721, ERC721URIStorage, AccessControl, Pausable, Recoverability {
    ...
    constructor() ERC721("BlockBar", "BTL") Recoverability(msg.sender){
    ...
    function setTokenURI(uint256 tokenId, string memory tokenURI_) public onlyRole(MINTER_ROLE) {
    ...
    function recoverToken(address from, uint256 tokenId) public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(_exists(tokenId), "ERC721: token does not exist");
        _transfer(from, recoveryAddress, tokenId);
    }

    function setRecoveryAddress(address newRecoveryAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
