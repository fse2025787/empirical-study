...
contract DegenRoyal is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 777778 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress = payable(address(0x2EA97134d00380f4B293cDDA1b95bf3cd5502e67));
    address payable public _vaultwallet = payable(address(0x2EA97134d00380f4B293cDDA1b95bf3cd5502e67));
    address private _burnAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "DegenRoyal";
    string private _symbol = "ROYAL";
