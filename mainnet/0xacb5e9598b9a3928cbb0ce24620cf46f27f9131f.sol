...
contract Shapes is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  address public constant DEV_ADDRESS = 0xd021a1964B9d0C91098B2AD91C30C2Ed75bb4ef5;  
  address public constant PROJECT_ADDRESS = 0x8F0095612BB2b859976C80F34366A44c4e40d1bf;  
  ...
  constructor() ERC721A("Shapes by Bardi", "Shapes") payable {
    _mint(msg.sender, 1);
  }
