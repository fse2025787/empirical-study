...
https://twitter.com/VitalikButerin/status/1580981360499757056

The others got it wrong. $THE is Vitalik. $THE is Ryoshi.

The real $THE is no tax. The real $THE is here.
...
contract THEProtocol is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 50000000 * 10**_decimals;
    string private constant _name = unicode"THE Protocol";
    string private constant _symbol = unicode"THE";
