...
https://t.me/OnePunchMan_ETH
https://www.onepunchman.link
...
contract OnePunchMan is Context, IERC20 {
...
//==========================
    ...
    {buyFee: 600, sellFee: 600, transferFee: 0});
//==========================
    // Max Limits
...
//==========================    
    ...
    constructor () {
        ...
        _devWallet = address(_owner);

        maxTxPercent = 105; // Max Transaction Amount: 100 = 1%
        maxTxDivisor = 10000;
        _maxTxAmount = (_tTotal * maxTxPercent) / maxTxDivisor;
        
        maxWalletPercent = 210; //Max Wallet 100 = 1%
