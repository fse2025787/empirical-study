...
Welcome to $FAKENEWS Token!

The Token Created by Satoshi Nakamoto and Elon’s Grandmother. Come join and listen in on the AMAZING $FAKENEWS ALPHA!

TG: https://t.me/FakeNewsEth
...
contract FAKENEWS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fake News Token";
    string private constant _symbol = unicode"FAKENEWS";
