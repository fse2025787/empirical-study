...
Website:  http://ShibaSocialNetwork.com
Telegram: https://t.me/ShibaSocialNetwork
Twitter:  https://twitter.com/ShibaNetwork_
...
contract ShibaSocialNetwork is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Social Network", "SSN") {
        ...
        maxTransactionAmount = 25_000 * 1e18; // 2.5% max txn
        maxWallet = 25_000 * 1e18; // 2.5% max wallet
        ...
        markWallet = address(0x7d209429Ff4d35aB086A53456837e98894CD3e5A); 
        devWallet = address(0x8fA48DCAa0C6F3960b40AbdFd4CE6832425d51B6); 
        liqWallet = address(0xe3d82294f0d4C3A050EA287bF77f6b6b0d3ED817); 
        operationsWallet = address(0xd92d55286aaCffFA9a16FA2FAaC25c5e537f4cd5);
