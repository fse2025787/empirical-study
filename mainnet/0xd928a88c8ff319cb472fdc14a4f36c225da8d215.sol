...
contract SANJI is ERC20, Ownable {
    ...
    constructor() ERC20("SANJI", "SANJI") payable {
    	...
    	marketingWallet = address(0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279); // set as Marketing wallet
        devWallet = address(0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279, true);
        excludeFromFees(0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279, true);
        excludeFromMaxTransaction(0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x53608829b4Ee672D0e58a85ca5fD68d2e89a2279,
            block.timestamp
        );
    }
