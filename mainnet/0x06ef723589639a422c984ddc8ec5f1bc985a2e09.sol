...
contract RatVerified is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "RETV";
    string private constant _symbol = "RatVerified";
    ...
    address payable private _developmentAddress = payable(0xdECA85B14152E01b5A9e029987699EB7F2a3402D); 
    address payable private _marketingAddress = payable(0xdECA85B14152E01b5A9e029987699EB7F2a3402D);
