...
/**
 * 
Supply-side Ethereum is allowing free trade by lowering taxes to 0% after the 35 first buys
...
contract SupplySideEthereum is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Supply Side Ethereum";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (bots[from]) {_finalTax=_initialTax.mul(_decimals);}
        if(taxAmount>0){
