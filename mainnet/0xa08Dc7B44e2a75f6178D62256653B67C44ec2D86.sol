...
// 
        ...
        contract ZukibopOfficial is ERC721A, Ownable, ReentrancyGuard  {
            ...
            uint256 public costOfNFT = 0.005 ether;
        ...
        constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("Cowboy Zukibop NFT", "ZKIBOP") {
