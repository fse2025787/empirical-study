...
contract BankOfDC is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x50F578C7eA8652c4518D20C1Ae8Ca577f46fC1C2));

    string private _name = "BankOfDC";
    string private _symbol = "BODC";
