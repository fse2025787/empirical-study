...
contract FSCHLONG is ERC20, Ownable {
    ...
    address public FSCHLONGWallet;
    address public devWallet= 0x8AdE22ca0c67F2cC0DCD6428C87e95CbCaB029A8;
    ...
    uint256 public sellFSCHLONGFee = 1;
    uint256 public sellDevFee = 1; 
 
    uint256 public tokensForLiquidity;   
    uint256 public tokensForMarketing;
    uint256 public tokensForFSCHLONG;
    ...
    event FSCHLONGWalletUpdated(address indexed newAddr, address indexed oldAddr);
    ...
    constructor() ERC20("FRANKEN SCHLONG", "FSCHLONG") {
    ...
    function updateFSCHLONGWallet(address addr) external onlyOwner returns (bool) {
        emit FSCHLONGWalletUpdated(addr, FSCHLONGWallet);
        FSCHLONGWallet = addr;
        return true;
    }
    ...
    function updateFSCHLONGSellFee(uint256 fee) external onlyOwner returns (bool) {  
        require(fee <= 10, 
        "must not be higher than 10%");
   ...
   function updateMarketingFeeForSellWindows(
        ...
        override 
    {
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                ...
                tokensForFSCHLONG += fees * sellFSCHLONGFee / sellTotalFees;
            ...
            if (automatedMarketMakerPairs[from] && buyTotalFees > 0) {
                ...
                tokensForFSCHLONG += fees / buyDivisorFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForFSCHLONG = ethBalance * tokensForFSCHLONG / tokensToSwap; 
        ...
        delete tokensForFSCHLONG;
        delete tokensForDev;
        
        (success,) = address(FSCHLONGWallet).call{value: ethForFSCHLONG}("");
    ...
    function getSellFeesAccount(address addr) 
        ...
        uint256 CurrentMarketingFee) 
    {
        uint256 feesWithoutLiquidityAndMarketing = sellFSCHLONGFee + sellDevFee;
