...
contract AlienKiba  is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xBC1A7eeA40197cdB7E71C13F761708C77F61f58f);
        _feeAddrWallet2 = payable(0xBC1A7eeA40197cdB7E71C13F761708C77F61f58f);
        _feeAddrWallet3 = payable(0xBC1A7eeA40197cdB7E71C13F761708C77F61f58f);
