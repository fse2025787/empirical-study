...
contract NakedInvisibleFriends is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Naked Invisible Friends", "Naked")
  {
  ...
  uint256 public constant PRICE = 6000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.006 ETH per item"
    );
