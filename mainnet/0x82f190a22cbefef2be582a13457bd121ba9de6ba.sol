...
░░░╚═╝░░░╚══════╝░╚════╝░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░
    ...
    Telegram: https://t.me/TEJIMARUENTRY
    Tax: 0 % (make sure to use low slippage)

    I still remember the good old days and they will probably never come back.
    Personally, I stop with the blockchain, I have done a lot, probably too much.
    ...
    I will add 2 ETH and 100% of the supply to the pool.
    Can WE repeat history and make #TEJIMARU melt faces ?

    Remember - no one will ever be able to destroy TEJIMARU, liquidity is burned forever and no one will ever be able to access it.
    I wish you the best.
...
contract TEJIMARU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TEJIMARU", "TEJIMARU") {
        ...
        marketingWallet = payable(0x65fAe763c19177073b5a0F4662215339D0729076);
        devWallet = payable(0x65fAe763c19177073b5a0F4662215339D0729076);
