...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xA9d86071C7ac900218E5602326d80F580bD6A838];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xA9d86071C7ac900218E5602326d80F580bD6A838;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPGKUPxxWFhGE3knZo7CMJ5pbu2Y69eGjZqZhL4k438pm/";
...
// File: contracts/InfamousCatsContract.sol
//

pragma solidity ^0.8.0;

contract InfamousCatsContract is RamppERC721A {
    constructor() RamppERC721A("Infamous Cats", "pet"){}
}
