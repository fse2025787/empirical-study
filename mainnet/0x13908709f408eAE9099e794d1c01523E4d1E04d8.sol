...
// 
/**
The Queen has called on her fearless knights to help unite the kingdom. 
In this crypto world, investors must build a safe path across the green fields of Dragonwood while dashing past diving dragons! 

Will you make it before you run out of resources? 
Or will the dragons be victorious?
Or will we cooperate together?

t.me/dragondush
twitter.com/DragonDush
**/
  ...
  contract DRAGOND is Context, IERC20, Ownable {
      ...
      string private constant _name = "Dragon Dush";
      string private constant _symbol = "DRAGOND";
