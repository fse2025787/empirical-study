...
contract KABOSU is ERC20, Ownable {
    ...
    constructor() ERC20("Kabochan", "KABOSU") {
        ...
        uint256 totalSupply = 20100213 * 1e18;
    ...
    function updateFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _buyDevFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee, uint256 _sellDevFee) external onlyOwner {
        ...
        totalFees = buyMarketingFee + buyLiquidityFee + buyDevFee + sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(totalFees <= 5, "Must keep fees at 10% or less");
    }
