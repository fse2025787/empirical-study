...
// 
/*
Project twitter:    https://twitter.com/0xstudio
Site:               https://0xog.com/
    ...
    ReentrancyGuard
{
    ...
    event MintAttempt(address indexed account);
    ...
    constructor(
        ...
        payees[0] = address(0xB5aB45FafC84152eBddC92243a0d90F3AA7f592E);
        uint256[] memory shares = new uint256[](1);
        shares[0] = uint256(1);
        revenueShare.payees = payees;
        revenueShare.shares = shares;
