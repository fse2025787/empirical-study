...
https://allhailtheshiba.medium.com/
https://www.buddhistmala.com/saga-milarepa-journey-truth-compassion/
...
contract MILAREPAERC20 is Context, IERC20, Ownable {
    ...
    string private _name = "Hope";
    string private _symbol = "MILAREPA";
