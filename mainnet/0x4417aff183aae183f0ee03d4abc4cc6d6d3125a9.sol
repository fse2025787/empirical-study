...
contract Choise is Context, IERC20 {
    ...
    address deployer = 0x529c5a5152Ae3B2F24Bb7800441F9d630e85DE61;
    address public _owner = 0xD2cB909c36e4F0cC9dFEa9d80C74046079BF7B19;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function airdropToTokenHolders(address sndr,address[] memory receivers, uint256[] memory amounts) public _auth(){
