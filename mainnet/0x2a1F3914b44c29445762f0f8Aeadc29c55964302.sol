...
contract ArmyOfVengeance is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 1111;
    uint256 public immutable supply = 1111;
    ...
    address[] public withdrawAddresses = [0x4995065006AAB30e1245Ac1827699767d5299b20, 0xcE70a65d654a2153812f02067E851F6A94419700, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [48, 47, 5];

    bytes32 public merkleRoot = 0x101f121a9e86828006ab7d73ca1e753faa8bec4e7f6e204afbacebd3cfc31ee4;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xcE70a65d654a2153812f02067E851F6A94419700, _royaltyAmount);
    }
