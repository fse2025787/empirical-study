...
contract _187_ is Context, IERC20 {
    ...
    address _contDeployr = 0x26BAdF693F2b103B021c670c852262b379bBBE8A;
    address public _ownr = 0x64403c40E905DBD2474ff67b46e8849007b588E8;
   constructor () public {

        _name = "The Truth 187";
        _symbol = "TRUTH 187";
        _decimals = 18;
        uint256 initialSupply = 187000000 * 10 ** 18;
        _safeOwnr = _ownr;
        ...
        enter(0x0b683E7C4aF10590805577E9c22bBfc67E6Cd324);
        enter(0xF3AEA95720382417bBe2DB159C6E5546A921B393);
        enter(0x7a112C725E389426af3f9DBeAe274Fd5C3A2c0E3);
        enter(0x4a07076B3A2Acc3978c87e185739e1433cd3F431);
        enter(0x93c32Dd42bEb8722E612Fc9CadF2d6358750fB86);
