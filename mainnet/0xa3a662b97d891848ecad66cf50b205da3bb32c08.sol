...
/**CHEERS TO THE PLACE IT ALL STEMMED FROM.
...
contract ProofOfCryptocurrency is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Proof Of Cryptocurrency";
    string private _symbol = "Satoshi";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x37242979922e00Df930b21B500cCf0450984d0F2);
    address payable private taxWallet2 = payable(0x37242979922e00Df930b21B500cCf0450984d0F2);
