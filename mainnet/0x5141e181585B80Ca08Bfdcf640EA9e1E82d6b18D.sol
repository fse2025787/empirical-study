...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x2d991641EF064e697A367B30AEDb7A80C2a12008];
  address public erc20Payable = 0x2d991641EF064e697A367B30AEDb7A80C2a12008;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiah3i6jqkityk26jzyfzdca2bk66hk3ncy72ljc3mgp7yvwmpyzee/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    
    
    uint256 public MAX_WALLET_MINTS = 30;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/kNuTLJJxXPBW1keswzmK/contract-metadata";
  }
...
// File: contracts/XmasApesNftContract.sol
//

pragma solidity ^0.8.0;

contract XmasApesNftContract is RamppERC721A {
    constructor() RamppERC721A("Xmas Apes NFT", "Xmas Ape"){}
}
