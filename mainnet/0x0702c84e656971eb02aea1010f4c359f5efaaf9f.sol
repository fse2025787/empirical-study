...
contract Efdot is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x469AE3bE229c9322D16781124ae0d91d7d3A0C73);
    address payable private _marketingAddress = payable(0x469AE3bE229c9322D16781124ae0d91d7d3A0C73);
