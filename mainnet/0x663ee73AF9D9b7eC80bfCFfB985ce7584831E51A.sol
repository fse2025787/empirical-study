...
/**
    The Risu Protocol holders will be confident as they: accrue more tokens over time simply for holding; gain governance over tokenomics related decisions; receive realistic and precise updates on the future of the coin, roadmap, and swap exchange — all straight from the squirrel’s mouth

Behind The Risu Protocol's fluffy and soft exterior is a well-oiled squirrel-shaped machine. This machine will be monitored and tweaked by the governing holders, and fueled by a dedicated marketing team that will shout of Risu Protocol's cuteness from the mountain tops. While we at The Risu Protocol are resolved to keep all hands on deck for the longevity of the project, we understand that the true power of any cryptocurrency is in the hands of the holders. We know that we can cultivate a vibrate and thriving community that will see The Risu Protocol through a spectacular adventure.

        https://www.therisuprotocol.com/

        https://twitter.com/therisuprotocol

        https://t.me/TheRisuProtocolERC20
*/
...
contract TheRisuProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE7D9ec8CAb5232197672FC4a95F837963F6bb6aA); 
    address payable public Wallet_Utility = payable(0xE7D9ec8CAb5232197672FC4a95F837963F6bb6aA);
    ...
    string private constant _name = "The Risu Protocol"; 
    string private constant _symbol = unicode"TRP"; 
    ...
    constructor () {
        ...
        _owner = 0xE7D9ec8CAb5232197672FC4a95F837963F6bb6aA;
