...
contract ONE is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Just One Token";
    string private _symbol = "ONE";
    uint8 private _decimals = 18;
    uint256 private _supply = 1;
    uint256 public taxForLiquidity = 3;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 1 * 10**_decimals;
    uint256 public maxWalletAmount = 1 * 10**_decimals;
    address public marketingWallet = 0xd4874C4103cb5912C8A7521b778B781510fb8A9F;
    uint256 private _numTokensSellToAddToLiquidity = 1 * 8**_decimals;
    uint256 private _numTokensSellToAddToETH = 1 * 8**_decimals;
    // TOKENOMICS END ============================================================>
