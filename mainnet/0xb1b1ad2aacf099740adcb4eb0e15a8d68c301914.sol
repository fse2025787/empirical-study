...
Welcome to the cube. This is not for the faint hearted.

The Arecibo message is a 1974 interstellar radio message carrying basic information about humanity 
and Earth sent to globular star cluster M13 in the hope that extraterrestrial intelligence might receive and decipher it.

Website: https://www.areciboerc.com
Telegram: https://t.me/areciboerc20
Twitter: https://twitter.com/areciboerc
...
contract ARECIBO is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 public _totalAmount = 100000000 * 10 ** 18;
    uint256 public _totalFee = 4;
    uint256 public _feeDenominator = 100;
    mapping(address => bool) private _blackList;
    string  _name = "The Arecibo Message";
    string  _symbol = "MSG";
    address _marketingFeeReceiver = 0x2aC6aaBB5c4956fB26A0Bf858c7288a57D796D5f;
    address _teamFeeReceiver = 0x2aC6aaBB5c4956fB26A0Bf858c7288a57D796D5f;
