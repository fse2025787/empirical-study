    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 5000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifa7i7dcftit3vclkxsjtxek4m2dyfj5edvfu6eqawjf7busgepc4/";
...
// File: contracts/SappySealsYachtClubContract.sol
//

pragma solidity ^0.8.0;

contract SappySealsYachtClubContract is RamppERC721A {
    constructor() RamppERC721A("Sappy  Seals Yacht Club", "ssyc"){}
}
