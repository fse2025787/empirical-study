...
https://t.me/developerinu
https://developerinu.info/
...
contract DeveloperInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Developer Inu";
    string private constant _symbol = "DEVINU";
