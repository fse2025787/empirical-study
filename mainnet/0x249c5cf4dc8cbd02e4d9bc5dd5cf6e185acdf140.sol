...
contract  FlokiBillionaire  is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "FlokiBillionaire";
    string private _symbol = "FLOKIBILL";
    ...
    constructor () {
        ...
        ETHReceiver = payable(address(0xd81f5DBf2DF4d28101daE2DbfA1717C952f2A2b4));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x5b5F0Be3Cc57C9881f7dB11Eb5eE700A04CD120b), _msgSender(), _totalSupply);
    }
