...
/**
Don't be shy swap a wife. Get a new one each day. P2E, Metaverse and real world. We cover everything.

Telegram: t.me/wife_swap_eth
Website: wifeswap.lol
Twitter: twitter.com/wifeswap_eth
...
contract WifeSwap is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Wife Swap";
    string private constant _symbol = "WIFESWAP";
