...
//
//https://t.me/TravelInu
//Max buy 1.5% - 9,000,000
//Low tax play
//CULT BANK Dev team https://etherscan.io/token/0xf726d071bfc09236b2d24e3e3de435874d4cc58c
...
contract TravelInu is Context, IERC20, Ownable {
    mapping (address => uint) private _owned;
    mapping (address => mapping (address => uint)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isBot;
    uint private constant _totalSupply = 600000000 * 10**9;

    string public constant name = unicode"Travel Inu";
    string public constant symbol = unicode"TRAVELINU";
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyTokens = 9000000 * 10**9; 
        _maxHeldTokens = 18000000 * 10**9; 
