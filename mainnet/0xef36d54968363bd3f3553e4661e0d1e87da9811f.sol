...
contract ProofofIzumotaisha is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Proof of Izumo taisha";
    string private constant _symbol = "TAISHA 2.0";
