...
contract PrayForKabosu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pray For Kabosu";
    string private constant _symbol = unicode"PRAYKOBSU";
