...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xb61B188a897f96602Ff2f63F5d9db0C8Bea418B8,0x3B180B54D301e149600Ca7B59bcca8404414f653];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xb61B188a897f96602Ff2f63F5d9db0C8Bea418B8;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiezt3eidktr5nsnuyzp7rud6jaua4mgxypyji2w4tq3ztqkd5kt6y/";
...
// File: contracts/PudgyPhenguinsContract.sol
//

pragma solidity ^0.8.0;

contract PudgyPhenguinsContract is RamppERC721A {
    constructor() RamppERC721A("Pudgy Phenguins", "PPHG"){}
}
