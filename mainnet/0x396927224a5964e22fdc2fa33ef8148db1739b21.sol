...
HANNYA Token is the Latest Anime Based Token released on the ERC20 Network.

Hannya will be a medium for Anime transaction and a monetary system on its own. Its purpose is to overperform all other cryptocurrency and has smart coding benefits for loyal holders with rewards.
...
contract Hannya is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hannya";
    string private constant _symbol = "HANNYA";
    ...
    address payable private _developmentAddress = payable(0x23510367Dd5f4669549D4912e08C407863915B67);
    address payable private _marketingAddress = payable(0x23510367Dd5f4669549D4912e08C407863915B67);
