...
// 2% of every transaction gets sent to $LAEEB deployer/wallet to support our favourite Mascot.
...
contract BabyLaeebInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Laeeb Inu", "BLAEEB") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 1% maxTransactionAmountTxn
        ...
        devOpsWallet = address(0x3931595eb3AA089BeB6A62c586903C6DeA50Dd43); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x3931595eb3AA089BeB6A62c586903C6DeA50Dd43), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x3931595eb3AA089BeB6A62c586903C6DeA50Dd43), true);
