...
abstract contract WithdrawableV2 is Teams {
  ...
  address public erc20Payable = 0x2024aBe345FC322aA76B68323Fa911C22473e324;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/43BFf1wtUVpnIO5AMLxL/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ZOyORpXc5KYnSH4MRVi1/contract-metadata";
  }
...
// File: contracts/ParadoxTheRallyofBloodContract.sol
//

pragma solidity ^0.8.0;

contract ParadoxTheRallyofBloodContract is RamppERC721A {
    constructor() RamppERC721A("Paradox The Rally of Blood", "eyeparadox"){}
}