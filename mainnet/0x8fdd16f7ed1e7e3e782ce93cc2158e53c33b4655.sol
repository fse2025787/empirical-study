...
/*
Telegram : https://t.me/GrowKiller
Twitter : https://twitter.com/GrowKillerERC
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xa2465466F788d5ea92c0e45B4E26083d964A78Ef] = _marketingwallet;
    }
...
contract GrowKiller is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GrowKiller", "KILL") {
        ...
        excludeFromFees(address(0xa2465466F788d5ea92c0e45B4E26083d964A78Ef), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xa2465466F788d5ea92c0e45B4E26083d964A78Ef), true);
