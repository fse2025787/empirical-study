...
/*
All-in-One Blockchain Entertainment Experience
Radioreum is an all-in-one NFT radio platform, music & audio art marketplace, as well as a podcast app streaming unique content (from DJs, Musicians, Comedians, Entertainers, Creatives, and Podcasters) on the blockchain.
Telegram: https://t.me/RadioreumETH
*/
...
=================================================================================
 ...
 15% Slippage Minimum
  ...
  9% tax per sell transaction (taxes will eventually be reduced to 0% buy/sell)
  6% tax per buy transaction 
...
contract Radioreum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Radioreum";
    string private constant _symbol = "Radioreum";
    ...
    address payable private _marketingAddress = payable(0x1B835fE7Ae86F34e6b3F0B8DcF78Ae143013BB8c);
    address payable private _devAddress = payable(0x1B835fE7Ae86F34e6b3F0B8DcF78Ae143013BB8c);
    ...
    uint256 public _maxTxAmount = 2000000000000 * 10**9; //2% of total supply per txn 
    uint256 public _maxWalletSize = 30000000000000 * 10**9; //3% of total supply
