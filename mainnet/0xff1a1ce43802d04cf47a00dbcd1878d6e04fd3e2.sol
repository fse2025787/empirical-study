...
contract Momoshikiinu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Momoshiki inu";
    string constant _symbol = "MOMOSHIKI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0xcc5B71F2d1c7D67D78Dc84564ed657f788a0AfD5; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xcc5B71F2d1c7D67D78Dc84564ed657f788a0AfD5;
        solor = msg.sender;
...
contract StandarToken is Momoshikiinu {
    constructor() {}
}