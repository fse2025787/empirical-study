...
contract ElonGoose is Context, IERC20, Ownable {
    ...
    string private _name = 'ElonGoose';
    string private _symbol = 'ELONGOOSE';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 0; // NO reflections for holders. marketing = moonshot 
    uint256 private _marketingFee = 8; // 8% marketing
    ...
    address payable private _marketingWalletAddress = payable(0x1779bEd21680f9BCA62E619002396eF4B6a79656);
