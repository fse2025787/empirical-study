...
/**
     Tg:  https://t.me/babyshintamaerc

     Twitter:   https://twitter.com/BabyShintama

     Website: https://www.babyshintama.space/

     Gitbook: https://babyshintama.gitbook.io/
*/
...
contract BabyShintama is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Baby Shintama";
    string private  _symbol = "BABYSHINTAMA";
