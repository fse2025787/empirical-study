...
contract  TheBizTrust is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x80Ca7506D17F140f8a510F4554a96ABCcCDF0A19));
        CharityWalletAddress = payable(address(0x80Ca7506D17F140f8a510F4554a96ABCcCDF0A19));
