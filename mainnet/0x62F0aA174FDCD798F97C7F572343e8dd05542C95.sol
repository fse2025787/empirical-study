...
abstract contract ERC721ACheckpointable is ERC721AQueryable {
  ...
  function _beforeTokenTransfers(
    ...
    console.log('ERC721ACheckpointable: _beforeTokenTransfers start');
    super._beforeTokenTransfers(from, to, tokenId, quantity);

    console.log('ERC721ACheckpointable: _beforeTokenTransfers end');
  }
  ...
  function _moveDelegates(
    ...
    console.log('ERC721ACheckpointable: _moveDelegates start');
    console.log('ERC721ACheckpointable: _moveDelegates srcRep', srcRep);
    console.log('ERC721ACheckpointable: _moveDelegates dstRep', dstRep);
    console.log('ERC721ACheckpointable: _moveDelegates amount', amount);
    ...
    console.log('ERC721ACheckpointable: _moveDelegates end');
  }
