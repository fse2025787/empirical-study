...
/*
Tax will be 4 buy and 20 sell for first 20 minute 

After we lower the tax to 2 buy and 4 sell 

And renounce the ownership
...
contract StonedSpooky  is Context, IERC20, Ownable {
    uint256 public _buyTax =4;
    uint256 public _sellTax =20;
    string private _name = unicode"Stoned Spooky";
    string private _symbol = unicode"420";
    uint8 private _decimals = 6;


    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply = 420000  * 10**(_decimals);
    bool active=true;  
    bool init=false;
