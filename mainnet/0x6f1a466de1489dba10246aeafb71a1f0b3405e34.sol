...
/**
Baku (貘) are Japanese supernatural beings that are said to devour nightmares. According to legend, they were created by the spare pieces that were left over when the gods finished creating all other animals. 
...
Telegram:https://t.me/BAKUERC20
Twitter:https://twitter.com/BAKU_ETH
*/
...
contract TheDreamEater is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Dream Eater";
    ...
    constructor () {
        _feeAddrWallet = payable(0x3589fFAD3EE6861930f3D586307BAD1540566939);
