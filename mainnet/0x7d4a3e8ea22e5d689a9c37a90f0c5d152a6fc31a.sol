...
contract WorldCupBear is ERC721A, IERC2981, Ownable {
    string public baseURI = "https://art.getrik.com/c-948822084/World%20Cup%20Bear%20Club%20NFT/";

    uint256 public tokenPrice = 60000000000000000; //0.005 ETH

    uint256 public whitelistTokenPrice = 90000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("World Cup Bear", "WCB", 100, MAX_TOKENS) {}
