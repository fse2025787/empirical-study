...
$WRABBIT - Warrior Rabbit

https://t.me/WarriorRabbit

Warrior Rabbit

Inspired from the Rabbits that have just launched… we present to you $wRABBIT.
...
contract WRABBIT is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000 * 10**8;
    ...
    string private constant _name = "Warrior Rabbit";
    string private constant _symbol = "WRABBIT";
    ...
    uint256 public _maxWalletSize = 2000 * 10**8;
