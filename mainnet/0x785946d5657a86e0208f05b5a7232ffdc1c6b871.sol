...
contract dEaD is ERC20Burnable, Ownable {
    ...
    constructor() ERC20("0xdEaD", "0xdEaD") {
        ...
        _mint(msg.sender, _initial_supply.mul(10).div(100)); // for liquidity pool
        _mint(0x000000000000000000000000000000000000dEaD, _initial_supply.mul(90).div(100)); // burned to dEaD
