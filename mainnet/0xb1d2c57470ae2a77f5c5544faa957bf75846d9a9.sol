...
contract Last_Breath is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmdhP9kE5mwMei9hwa9xmvmPUgCLnzkKkeTS6jPEGoqLoQ/";
  ...
  constructor() ERC721A("Last Breath", "LTBR") {
