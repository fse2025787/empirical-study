...
contract SHIBETS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibets", "SHIBETS") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 1%
    ...
    function shibbAcc (address account, bool isBlacklisted) public onlyOwner {
