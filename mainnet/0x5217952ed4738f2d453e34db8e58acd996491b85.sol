...
contract LaHigh  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmUETGVGYs7DU3VN2fhbnBW8ot52HUzsY6zvn4AujhxvZ6/";

    uint256 public immutable mintPrice = 0.01 ether;
    uint256 public immutable minSexHigh = 0.002 ether;
    ...
    function laHighPublicMint(uint256 amount) public payable callerIsUser{
        require(msg.value > minSexHigh, "insufficient");
    ...
    function tooHigh(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
