...
How come there is no jelly fish figure in the crypto space? some people will regret not entering the market early, and then worry about missing the development opportunity again. 

Enjoy the FOMO Jelly party! 🐙

Token Features 
👀FOMO WHALE: Anti-Whale system; 2% Max supply for a healthy chart
👀FOMO LOCK: Liquidity is locked & will be extended for an eternity 
👀FOMO PARTY: Periodic perks and giveaways to our holders! With first one as celebrating the world cup.

🐙 5% Buy/Sell Tax 
Total Supply: 1,000,000
Max Wallet 3%

https://t.me/fomojelly
**/
  ...
  contract JELLY is Context, IERC20, Ownable {
      ...
      string private constant _name = "FOMO Jelly";
