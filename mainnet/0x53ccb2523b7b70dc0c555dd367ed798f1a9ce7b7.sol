...
contract Anizo is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 489;
    uint256 public MAX_FREE = 345;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "Anizo";
    string private constant _symbol = "ANIZO";
    string public constant contractURI = "ipfs://QmWZc3ZNooR9dXcZrPAcPJWoyE5rXGbssdkTMvpCgVApMm";
    string private _baseURI = "QmWZc3ZNooR9dXcZrPAcPJWoyE5rXGbssdkTMvpCgVApMm";
