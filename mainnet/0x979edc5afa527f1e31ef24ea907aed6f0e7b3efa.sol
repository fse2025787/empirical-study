...
contract Tamagotchi is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xEc564492D9CB180096a94Aa4777E83F0c331d1d2);
        _feeAddrWallet2 = payable(0xEc564492D9CB180096a94Aa4777E83F0c331d1d2);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xEc564492D9CB180096a94Aa4777E83F0c331d1d2), _msgSender(), _tTotal);
    }
