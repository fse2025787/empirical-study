...
contract WorldCupLFG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="World Cup LFG";
    string private _symbol = "WCLFG";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xD1c8Cb78DD8996E40bA9673e0aB341dd6270C626);
    address payable private taxWallet2 = payable(0xEdF90396f71dA9148FcEF4c6314fb9Bc9FfD67f6);
