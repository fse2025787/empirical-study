...
// File: contracts/Rick and Morty.sol
...
contract RickandMorty is Ownable, ERC721A {
  string public baseURI = "https://nftstorage.link/ipfs/bafybeihzdsbwduoik4fg7zyirbpik57ouyfvyhgulprj3thwbnzbqm7sei/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('Rick and Morty', 'RAM') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 1600) {
