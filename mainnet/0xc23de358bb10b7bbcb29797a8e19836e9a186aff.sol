...
Telegram: @alterproject

Social Link : 
Website - http://altertoken.site/
Twitter - https://twitter.com/AlterFeeds
Medium -  https://medium.com/@alterproject


Network: ETHEREUM (ERC-20)
Total Supply: 100,000,000 CLEANSE

Tax: 5% on Buys, 5% on sells
Max Wallet/TX: 4% max wallet, 2% max TX

Liquidity Pool: 2 ETH, locked (link)
...
contract  ALTER is Context, IERC20, Ownable {
    ...
    string private constant _name = "  ALTER ";
    string private constant _symbol = "ALTER";
