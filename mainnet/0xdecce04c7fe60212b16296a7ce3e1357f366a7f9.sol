...
The freshest dog on ETH! Ukrainu is here to bark peace and woof financial freedom to all.

Ukrainu is the latest viral name for a major ETH play, get in early before Ukrainu quickly sends from national news to worldwide news
...
contract Ukrainu is ERC20, Ownable {
    ...
    constructor() ERC20("Ukrainu", "UINI") {
