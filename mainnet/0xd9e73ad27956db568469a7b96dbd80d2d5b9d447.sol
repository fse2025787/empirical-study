...
contract OnChainGods is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  uint256 public  PUBLIC_SALE_PRICE = 0.0009 ether;
  uint256 public  NUM_FREE_MINTS = 9000;
