...
/**
Why aim for the moon when together we can go so much further?

Twitter: https://twitter.com/SaturnErc
Telegram: https://t.me/saturnerc 
Site: https://saturnerc.com/
...
contract SaturnERC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Saturn";
    ...
    address payable private _developmentAddress = payable(0x8609d7F0ACaCFF95CB6ACe3268B304Db643391e4); 
    address payable private _marketingAddress = payable(0x8609d7F0ACaCFF95CB6ACe3268B304Db643391e4);
    ...
    uint256 public _maxTxAmount = 10001 * 10**9; 
    uint256 public _maxWalletSize = 10001 * 10**9; 
