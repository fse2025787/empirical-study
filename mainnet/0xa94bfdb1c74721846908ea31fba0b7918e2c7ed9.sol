...
contract esodao is Context, IERC20, Ownable {
    ...
    string private constant _name = "esoteric DAO";
    string private constant _symbol = "ESODAO";
    ...
    constructor () {
        _MarketingWallet = payable(0x77e79aE4Aed8DA9bd38C1C51DEF5Bc390a417741);
        _liquidityWallet = payable(address(0xA6b7C20f0a00E06Bc595F8A11E578De2CC1b12ad));
        _rOwned[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MarketingWallet] = true;
        _isExcludedFromFee[_liquidityWallet] = true;
        emit Transfer(address(0x09E5723C3C78B6213635ff69E7347aB077558E18), _msgSender(), _tTotal);
    }
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        require(newAmount >= 1 * 10**9, "Swap amount cannot be lower than 0.001% total supply.");
        require(newAmount <= 5000 * 10**9, "Swap amount cannot be higher than 0.5% total supply.");
