...
contract AccessToken is ERC1155 {
    ...
    modifier onlyOwner {
        require(storageContract.owners(msg.sender), "621");
        _;
    }
    ...
    function mintAccess(
        ...
        require(msg.sender == roomContract, "600");
        _mint(_to, _room_id, 1, "");
    }

    function setRoomContract(address _roomContract) external onlyOwner {
