...
contract Deposit is Ownable, ReentrancyGuard {
    ...
    IERC20 immutable v1CATAddress = IERC20(0x3734Dc0D241B5AD886Fa6Bff45fFA67252AC0E89);
    IERC20 immutable v2CATAddress = IERC20(0x9B9301D79AF2Ebd99d709811D4Cb5632009F1fAC);//<--- SET THIS
    ...
    function depositTokens() external nonReentrant {
        ...
        IERC20(v2CATAddress).transferFrom(address(this), _msgSender(), v2CATAmount);
