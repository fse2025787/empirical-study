...
/*
________  .______________  _______  ______________________
\______ \ |   \_   _____/  \      \ \_   _____/\__    ___/
 |    |  \|   ||    __)_   /   |   \ |    __)    |    |   
 |    `   \   ||        \ /    |    \|     \     |    |   
/_______  /___/_______  / \____|__  /\___  /     |____|   
        \/            \/          \/     \/               
*/
...
contract DeathIsEvitable is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer  {
...
// ================== Variables Start =======================
  ...
  string public hiddenMetadataUri = "ipfs://bafybeihxvau2juficv27kk3jgm3wwfdazvb4s7xwj7mf3yfttlf27p62oq/DeathIsEvitable.json";
  uint256 public price = 0.005 ether;
  uint256 public wlprice = 0 ether;
  uint256 public supplyLimit = 1350;
  uint256 public wlsupplyLimit = 2400 ;
...
// ================== Mint Functions Start =======================
  ...
  function WlMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
    ...
    require(wlMinted + _mintAmount <= wlsupplyLimit, 'Max supply exceeded!');
    require(totalSupply() + _mintAmount <= mintSupply(), 'Max supply exceeded!');
  ...
  function PublicMint(uint256 _mintAmount) public payable {
    ...
    require(publicMinted + _mintAmount <= supplyLimit, 'Max supply exceeded!');
    require(totalSupply() + _mintAmount <= mintSupply(), 'Max supply exceeded!');
  ...
  function OwnerMint(uint256 _mintAmount, address _receiver) public onlyOwner {
    ...
    //for future upgrates - RESURRECTIONCONTRACT contract only mint func
    function mintExternal(address _address, uint256 _mintAmount) external {
        require( msg.sender == RESURRECTIONCONTRACT, "Sorry you dont have permission to mint from your contract");
...
// res contract setup
    function setResurrectionContractAddress(address _RESURRECTIONCONTRACT) public onlyOwner {
...
// ================== Read Functions Start =======================
  ...
  function mintSupply() public view virtual returns(uint256 _mintSupply) {
    return wlsupplyLimit + supplyLimit;
  }

    function totalPopulation() public view virtual returns(uint256 _totalPopulation) {
    return mintSupply() * 4/3;
  }
