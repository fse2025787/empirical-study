...
/**
    KURAYAMI is a ERC20 token project inspired by the Japanese word “DARK” or “DARKNESS.” We are throwing a lot of surprises in our community in order for this name to become dominant in the market. 


    https://www.kurayamieth.com/

    https://kurayamidarkness.medium.com

    https://twitter.com/kurayamieth

    https://t.me/kurayamiportal
*/
...
contract Kurayami is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Kurayami";
    string private _symbol = unicode"Kurayami";
