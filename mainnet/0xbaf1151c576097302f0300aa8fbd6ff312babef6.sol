...
contract TokenizedGold is ERC20PausableUpgradeable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;

    modifier onlyMinter() {
        require(
            minterAddress == msg.sender,
            "TokenizedGold: Only the minter contract can call this function"
        );
        _;
    }
