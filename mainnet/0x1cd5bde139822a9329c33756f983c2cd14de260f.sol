...
contract TSHM is ERC20, Ownable {
    ...
    constructor() ERC20("Tsuka No Hime", "TSHM") {
     ...
     uint256 totalSupply = 1 * 10 ** 9 * 10 ** decimals();
        ...
        MarketingWallet = address(0x0E00A30e577D7EC6d5826f6458aF97a899F94159); // set as Marketing wallet
        DevWallet = address(0x0E00A30e577D7EC6d5826f6458aF97a899F94159); // set as dev wallet
