...
abstract contract Devable {
  address public DEVADDRESS =0xB327204D35A09d3DFF77f1a780161508B128736c;
...
abstract contract Withdrawable is Ownable, Devable {
  address[] public payableAddresses = [DEVADDRESS,0x562b76D33b54b0b004d89D835B9669C3Bf105579];
  ...
  function withdrawAllDev() public isDev {
      require(address(this).balance > 0);
      _withdrawAll();
  }
...
// Save .sol file the same as below //
...
contract AFIREContract is AFIREERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://afire.mypinata.cloud/ipfs/QmasVHi2T6JyUyKRRC4nWeCGAeF6X2iLGCkqmGg1GRQRJc";
    }
}