...
/*
$Immolation - Dev by burning

An execution method for jeets and fuds with combustion to extreme heat.

50% tokens will be burnt at launch, constant burns follow.
...
contract Immolation is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Dev by Burning";
    string private constant _symbol = "Immolation";
