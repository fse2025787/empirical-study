...
// File: contracts/undergroundCult.sol

pragma solidity ^0.8.4;

contract UndergroundCult is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "ipfs://bafybeicmqnpws4kczxcinobzevqzz7e5bu5bmidbkp7pcuy56gpyspyulu/json/";
    ...
    uint256 public maxFreeSupply = 6000;

    mapping(address => uint256) public _mintedFreeAmount;

    constructor() ERC721A("Underground Cult", "UGC") {}
