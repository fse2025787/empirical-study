...
contract OPENAIInu is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "OPENAI Inu";
    string private _symbol = "OPENAI Inu";
    ...
    constructor () {
        ...
        _FeeETH = payable(address(0x9672C19dF10B22F9d5C11bDCB3557B8A33C7918b));
