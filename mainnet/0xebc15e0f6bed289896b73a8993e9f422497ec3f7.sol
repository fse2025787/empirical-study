...
The prototype of the dragon in the Yayoi era, the dragon represents supremacy, the prototype we designed combines the image of the dragon and ETH, implying that Yayoi dragon will become the best token

https://t.me/YayoiDragon
*/
...
contract YayoiDragon is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Yayoi Dragon";
    string private constant _symbol = unicode"YDRAGON";
