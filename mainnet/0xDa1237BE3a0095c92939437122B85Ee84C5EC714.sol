...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x82FFC9a4c8943Ee8d0cb075e5079CFEf9ea4aaaE];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 6, 1414 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaN1wMvyXu3n2eKmEnt2pzQtuNaZyJRQtk1TtNbwsjQw6/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1414");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1414");
...
// File: contracts/ToxicBeastClubContract.sol
//

pragma solidity ^0.8.0;

contract ToxicBeastClubContract is RamppERC721A {
    constructor() RamppERC721A("Toxic Beast Club", "TOXIC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/nzToRJx7gNb98oTxRMwV/contract-metadata";
    }
}
