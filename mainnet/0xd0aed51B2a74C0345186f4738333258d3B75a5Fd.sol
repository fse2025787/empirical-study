...
contract AZUKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AZUKI";
    string private _symbol = "AZUKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x859812d893C9983fac8715A09471F655CA7618F0); 
    ...
    constructor () {
        ...
        emit Transfer(address(0x2aE6B0630EBb4D155C6e04fCB16840FFA77760AA), _msgSender(), _totalSupply);
    }
