...
contract YosoNFT is ERC721A, Ownable {
    bytes32 public root;
    ...
    string private _baseURL = "ipfs://bafybeidij3w7ye2k2pvrwgtuwo5qbfioqf2paooucqvcixdtpehfmz3p2i";
    ...
    function mintYoso(uint count) external payable {
