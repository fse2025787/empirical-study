...
contract RatCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "RatCoin";
    string private constant _symbol = "RatCoin";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x1EE813C9a14aB52cA6897B3d2B93967ca90EB8eC);
        _feeAddrWallet2 = payable(0x1EE813C9a14aB52cA6897B3d2B93967ca90EB8eC);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 10% WHO SELL WITHIN 24 HOURS
            if (_buyMap[from] != 0 &&
