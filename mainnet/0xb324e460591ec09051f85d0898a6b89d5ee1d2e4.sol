...
/**
Odeum: the place to be for music, performance and theatre.
*/
...
contract Odeum is Context, IERC20, Ownable {
    ...
    string private constant _name = "Odeum";
    string private constant _symbol = "ODEUM";
