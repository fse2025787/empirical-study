...
Teh one who deserves to survive is teh one who has teh will to make it happen.  
       Teh community shall support our king and baby and we shall see teh light.                                     
                                                                                        
               ALL TAXES WILL GO TO THE LIQUIDITY OF $TSUKA & $DWAGON    
...
contract QueenOfTsuka is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "Queen of Tsuka";
    string private _symbol = "QSUKA";
    ...
    uint256 private _totalSupply = (777777777 * 10**4) * 10**_decimals; //1T supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0x9c65E0000F4621227Cd7A830fD17236CcaA112E0);
    ...
    function QSUKA() public onlyOwner{
         require(block.timestamp > QSUKAcooldown, "You cant call QSUKA more than once per day");
    ...
    function QSUKAOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         QSUKAcooldown = block.timestamp + 86400;
    }
