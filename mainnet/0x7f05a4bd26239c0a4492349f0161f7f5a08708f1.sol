...
APEOOOOOOOOOOOOOOOORRRRRRRRRR!!!

Website: apeor.finance
Twitter: twitter.com/apeorETH
Telegram: t.me/apeor
...
contract Apeor is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Apeor", "APEOR") {
        ...
        maxWallet = totalSupply * 4 / 100; // 2% Max wallet
        maxTransactionAmount = totalSupply * 2 / 100; // 2% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 15 / 10000; // 0.05% swap wallet
