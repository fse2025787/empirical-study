...
contract DFTSW is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Dragon Fish Tokyo Space War AL Register", "DFTSW")
    {
        baseURI = _baseURI;
