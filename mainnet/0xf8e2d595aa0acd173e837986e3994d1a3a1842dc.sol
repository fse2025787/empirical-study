...
contract FML is Context, IERC20, Ownable {
    ...
    string private constant _name = "FML";
    string private constant _symbol = "FML";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x7a5CF36bc7Ad61b9A9E3515A9F8F91303e9f2286);
        _feeAddrWallet2 = payable(0xD9d1F34539F4D2FA27edF85e68861091484F6cC0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 20% WHO SELL WITHIN 1 HOUR
            if (_buyMap[from] != 0 &&
