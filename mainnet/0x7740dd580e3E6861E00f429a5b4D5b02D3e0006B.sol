...
contract  KingFlokiETH  is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "KingFlokiETH";
    string private constant _symbol = "KFLOKI";
