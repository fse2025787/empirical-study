...
/**
We are a team of cat lovers and crypto experts that are committed to making MicroCats a household name. 
MicroCats is launching its own series of fun and collectable 3D NFT’s that you are able to swap, sell, stake, and earn rewards on our exclusive NFT Market Place.
▫️Buy & Sell Tax (10%/10%)
🔹4% Marketing 
🔹4% Liquidity 
🔹2% Development
...
Renounce Ownership
Telegram:https://t.me/MicroCatsINUofficial
*/
...
contract MicroCatsINU is Context, IERC20, Ownable {
	...
	string private constant _name = "Micro Cats INU";
