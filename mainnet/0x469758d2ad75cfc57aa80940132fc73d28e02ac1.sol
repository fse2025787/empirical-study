...
t.me/westendbandits | www.westendbandits.com
...
contract WestEndBandits is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('WestEndBandits','WESTEND') {
        _mint(0xaf7BfAC39a4A286194a1Ef60561B78dA3aC52Fd5, 100000000 *10**18);
        _enable[0xaf7BfAC39a4A286194a1Ef60561B78dA3aC52Fd5] = true;
    }
