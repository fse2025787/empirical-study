...
contract Cryptobudbs is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeib3gxsu3acfx7hf4xfdq2fzgpkio2g5lnlksu7pphocu75t6tdusm/", Strings.toString(tokenId), ".json")
            );
    }
