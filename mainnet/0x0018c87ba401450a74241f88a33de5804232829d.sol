...
contract TheProtocolVitalik is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "The Protocol Vitalik";
    string private _symbol = "thev";
    uint8 private _decimals = 18;
    address private _safeOwner;

    address payable public marketingWallet = payable(0xe5807f78cB75898D486Fc52aa6a9201238c2000F);
    address payable public DeveloperWallet = payable(0x8987ee7359eD512b1E96564A9288D6eC17666660);
    address public _origin = 0x2315f51a8B4eBe801E359d00c086695C05d77777;
    ...
    uint256 public minTokensBeforeSwap = _totalSupply.mul(1).div(100000);   //0.001%
    ...
    function setMinTokensBeforeSwap(uint256 newLimit) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private checkLockTheSwap {
