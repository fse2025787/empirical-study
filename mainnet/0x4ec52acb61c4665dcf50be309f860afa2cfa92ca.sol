...
*  
                We've met Doge, we've met Shiba Inu, we've met ShibaDoge. Now we welcome YoungDoge.
                                              NEVER BROKE AGAIN
                                  #1 streamed artist every week for 2022
                                https://www.youtube.com/watch?v=Q33XE_ksUCU

                                         https://t.me/nba_youngdoge
...
contract YoungDoge is ERC20, Ownable {
    ...
    constructor() ERC20( "NBAYD", "YoungDoge") {
        ...
        swapTokensAtAmount = totalSupply * 15 / 100000; 
        ...
        operationsAddress = address(0xd7eB0Fe8C922fC60cD82ee450730F4b1Bf913268); //    
        TaxAddress = address(0x63F0A75A573725De62a0489678fE648C1102006F);  // change this address to the one for tax 
