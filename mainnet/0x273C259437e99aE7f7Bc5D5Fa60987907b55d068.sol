...
//*********************************************************************//
//
//     ___    _   _____________ ________  ____  ____  ___ 
//    /   |  / | / / ____/ ___//  _/ __ \/ __ \/ __ \/   |
//   / /| | /  |/ / __/  \__ \ / // / / / / / / /_/ / /| |
//  / ___ |/ /|  / /___ ___/ // // /_/ / /_/ / _, _/ ___ |
// /_/  |_/_/ |_/_____//____/___/_____/\____/_/ |_/_/  |_|
//                                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x8cc85bC19Bcd0B40cBfA292549129B8D367FB1EB];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x8cc85bC19Bcd0B40cBfA292549129B8D367FB1EB;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdR55xwLZAWttfQwW7TndBHjzUDC7x6tkh8pgXy1oAjBH/";
...
// File: contracts/AnesidoraContract.sol
//

pragma solidity ^0.8.0;

contract AnesidoraContract is RamppERC721A {
    constructor() RamppERC721A("ANESIDORA", "ANSDR"){}
}