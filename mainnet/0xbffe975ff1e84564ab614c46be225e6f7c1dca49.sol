...
// File: contracts/ERC721BaseUpgradeable.sol
...
contract ERC721Mintable is UUPSUpgradeable, ERC721BaseUpgradeable {
    ...
    modifier ecosystemContractOnly() {
        require(
            ...
            "ERC721Mintable: Internal contracts only"
        );
        _;
    }
    ...
    // Method to set minting charges per NFT
    function setBrokerage(uint256 _brokerage) external onlyOwner {
        require(
            _brokerage <= 100 * decimalPrecision,
            "ERC721Mintable: Brokerage can't be more than 100%"
        );
    ...
    function initialize(
        ...
        bool _chargeInETH,
        uint256 _brokerage, // Brokareage Percentage
        IRouter _router,
        address _WETH,
        address _USDC
    ...
    function mint(string memory tokenURI, uint96 _royalty) external payable {
        require(
    ...
    function lazyMint(
        ...
        uint256 _brokerage = (price * brokerage) / (100 * decimalPrecision);
