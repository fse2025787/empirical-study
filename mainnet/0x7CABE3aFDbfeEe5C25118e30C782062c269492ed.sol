...
pragma solidity ^0.6.12;
    ...
    contract Shenroninu is Context, IERC20, Ownable {
        ...
        string private _name = 'Shenron inu';
        string private _symbol = 'SHENRON';
        uint8 private _decimals = 9;
        
        uint256 public _liquidityFee = 1;
        uint256 private _taxFee = 4; 
        uint256 private _MarketingFee = 30;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xB934135F641fA23eF2A7e5d0C750366DC2ab42D5, 'We can not exclude Uniswap router.');
