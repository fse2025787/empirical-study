...
contract TheF8Club is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public maxItems = 26000;
    address public devAddress = 0xe754be98baa42E2D1f03db6284f82eDdbC4B350F;
    ...
    constructor(string memory baseURI) ERC721("TheF8Club", "F8CLUB") {
        setBaseURI(baseURI);
        whitelist = true;
        sale = false;
        price = 0.08 ether;
    ...
    function mintF8(address _to, uint256 _count) public payable saleIsOpen {
        uint256 total = _totalSupply();
        require(total <= maxMint, "Max per transaction");
