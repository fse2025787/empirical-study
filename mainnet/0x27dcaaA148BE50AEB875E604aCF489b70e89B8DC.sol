...
contract DontWar is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dont War Inu";
    string private constant _symbol = "DWI";
    uint256 public _maxTxAmount = 20_000 * 10**_decimals;
    uint256 public _maxWalletSize = 20_000 * 10**_decimals;
    uint256 public _taxSwap=4_000 * 10**_decimals;
