...
contract Ownable is Context {
    ...
    function lockContractForOwner(uint256 time) public virtual onlyOwner {
    ...
    function unlockContractForOwner() public virtual {
...
contract SHIO is Context, IERC20, Ownable {
    ...
    string private _name = "SHIO";
    string private _symbol = "Shiroi Umi";
