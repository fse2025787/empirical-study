...
/**
Welcome to the Mini MRI.
TG: https://t.me/miniMRI
...
contract MiniMRI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mini Marshall Rogan Inu";
    string private constant _symbol = "MINIMRI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x000EB5991a6c7fB52f8c6Fbdcf01AF2eFFE6a18c);
