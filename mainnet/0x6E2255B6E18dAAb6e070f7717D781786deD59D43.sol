...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x285bd58cAB268BBC5e7d6E0d28E7Ce24717588BE];
  address public erc20Payable = 0x285bd58cAB268BBC5e7d6E0d28E7Ce24717588BE;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 271) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeig77ayoy2kv4rnofc5tzyb3bll3coxle35or3wn3wzu5dkxqtcryq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/BnMtHzIPt6nubCRM1WX4/contract-metadata";
  }
...
// File: contracts/TheWildSideArtContract.sol
//

pragma solidity ^0.8.0;

contract TheWildSideArtContract is RamppERC721A {
    constructor() RamppERC721A("The Wild Side Art", "TWS"){}
}
