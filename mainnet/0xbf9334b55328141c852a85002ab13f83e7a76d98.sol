...
contract X is ERC20, Ownable {
    ...
    constructor() ERC20("X Protocol", "X") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x66583dA3689110A048Ab2efEb1c64Af6eBcB9834); // set as Marketing wallet
        DevWallet = address(0x66583dA3689110A048Ab2efEb1c64Af6eBcB9834); // set as dev wallet
