...
contract YazukaBladeGirl is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("Yazuka Blade Girls", "YBG") {}
    ...
    uint256 public immutable publicSalePerAddress = 5;

    function setPrice(uint256 publicPrice_) external onlyOwner {
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(maxSupply >= quantity, "reached max amount");
        ...
        uint256 price = uint256(publicPrice) * quantity;
