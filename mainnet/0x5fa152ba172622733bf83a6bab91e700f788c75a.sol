...
contract Ownable is OwnableData {
    ...
    function setDVaultAddress(address _DVault) public {
    ...
    modifier onlyDVault() {
        require(msg.sender == DVault, "Ownable: caller is not the DVault");
        _;
    }
...
contract taxDistributor is Ownable {
    ...
    function addLiquidity(address urv2, address dai, uint256 tokenAmount, uint256 daiAmount, address liquidityTo) private {
        ...
        IERC20(DVault).approve(urv2, tokenAmount);
    ...
    function distribute(address urv2, address dai, address marketingWallet, uint256 daiForBuyback, address buybackWallet, uint256 liquidityTokens, uint256 daiForLiquidity, address liquidityTo) external onlyDVault{
