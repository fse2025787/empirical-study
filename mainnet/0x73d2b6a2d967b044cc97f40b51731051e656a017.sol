...
contract CryptoCreepers is ERC20, Ownable {
    ...
    uint256 private _supply = 700000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 98;
    uint256 public maxTxAmount = 17500000 * 10**_decimals;
    uint256 public maxWalletAmount = 17500000 * 10**_decimals;
    address public marketingWallet = 0xb95d0fe897F76a567A1122922d8537deD086157B;
    // TOKENOMICS END ============================================================>
