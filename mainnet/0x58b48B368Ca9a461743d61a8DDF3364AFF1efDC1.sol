...
interface RoyaltiesV2 {
    ...
    function getArtlinxV2Royalties(uint256 id) external view returns (LibPart.Part[] memory);
}
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2 {
    ...
    function getArtlinxV2Royalties(uint256 id) override external view returns (LibPart.Part[] memory) {
        return royalties[id];
    }
...
library LibRoyaltiesV2 {
    /*
     * bytes4(keccak256('getArtlinxV2Royalties(uint256)')) == 0xcad96cca
     */
