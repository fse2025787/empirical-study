...
/*
https://t.me/shukokuinu
https://twitter.com/shukokuinu

𝐅𝐨𝐫𝐠𝐞𝐭 𝐩𝐚𝐬𝐭 𝐦𝐢𝐬𝐭𝐚𝐤𝐞𝐬. 𝐅𝐨𝐫𝐠𝐞𝐭 𝐟𝐚𝐢𝐥𝐮𝐫𝐞𝐬. 𝐅𝐨𝐫𝐠𝐞𝐭 𝐞𝐯𝐞𝐫𝐲𝐭𝐡𝐢𝐧𝐠 𝐞𝐱𝐜𝐞𝐩𝐭 𝐰𝐡𝐚𝐭 𝐲𝐨𝐮’𝐫𝐞 𝐠𝐨𝐢𝐧𝐠 𝐭𝐨 𝐝𝐨 𝐧𝐨𝐰 𝐚𝐧𝐝 𝐝𝐨 𝐢𝐭.
...
contract ShukokuInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shukoku Inu";
    string private constant _symbol = "SHUKU";
    ...
    address payable private _developmentAddress = payable(0xaFD6b94fB6Ec65Be2bFeB4FCC0d31672f613e2B4); 
    address payable private _marketingAddress = payable(0xaFD6b94fB6Ec65Be2bFeB4FCC0d31672f613e2B4);
