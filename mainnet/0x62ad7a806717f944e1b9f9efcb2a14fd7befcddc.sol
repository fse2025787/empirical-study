...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1296;
...
contract POWGhosts  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmVqeasimtjwV3w4wa6NUmcSjAMVqG3EXZx5FobgymoibQ/";

    uint256 public immutable cost = 0.01 ether;
    uint256 public immutable Min = 0.003 ether;
    ...
    function POWmint (uint256 amount) public payable callerIsUser{
        require(totalSupply() + amount <= maxSupply, "sold out");
        require(msg.value >= Min, "insufficient");
        if (msg.value >= cost * amount) {
            _safeMint(msg.sender, amount);
        }
    }

    function BurnToMiner (uint256 amount) public onlyOwner {
