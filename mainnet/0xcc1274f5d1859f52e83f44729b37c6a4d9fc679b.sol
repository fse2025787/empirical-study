...
contract ERC5050 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZRbmLjzPU5uJZc6AZ7ek53eVgns2WQYeSnXpXpf3SB5G";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("PIXELHEROES", "50/50", 100, MAX_SUPPLY) {
    }
