...
//ApeRewards is a Frictionless Yield Redistribution. Simply hold the token to Gain Automatic Restribution Rewards

//🔥Rewards are all AUTO Distribution WITH $APE!! 🔥

//TELEGRAM : https://t.me/ape_rewards
...
contract ApeInu is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    ...
    constructor(uint256 initialSupply, address reflectionToken, address routerAddress, address initialHldAdmin) {
        ...
        _maxTxAmount = initialSupply * 1 / 4000;
        _walletMax = initialSupply * 1 / 2000;
