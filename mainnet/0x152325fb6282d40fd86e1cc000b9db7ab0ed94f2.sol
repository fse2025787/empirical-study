...
/* 
        NO MORE MEV BOTS. Community ran token. If you are a holder, make the twitter, and we'll meet at TG @
        MEVBENOTNOT. Which is for someone to make it. 
 */             
...
contract MEVBOTNOT is ERC20, Ownable {
...
constructor() ERC20 ("MEVBOTNOT" , "$MBOTBOT") {
        ...
        operationsAddress = address(0x715c0Cf01DE96b05dB6FB54B5e8E7f9825d3Ad99); // change this address to wallet u want for operations   
        TaxAddress = address(0x715c0Cf01DE96b05dB6FB54B5e8E7f9825d3Ad99);  // change this address to the one for tax 
