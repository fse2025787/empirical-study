...
contract BlueTracker is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x94dD1909A48116C9234174A7509720B137F2862c));

    string private _name = "BlueTracker";
    string private _symbol = "BlueTracker";
