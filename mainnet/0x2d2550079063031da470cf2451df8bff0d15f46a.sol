...
contract TASHIRO is ERC20, Ownable {
    ...
    address payable devWallet = payable(address(0x526262E534eF436060128B88dF75D2C64296b32C)); 
    ...
    constructor() ERC20("Tale of Tashiro Shinji", "TASHIRO") {
