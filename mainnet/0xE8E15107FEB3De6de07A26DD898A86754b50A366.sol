...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x38DB01a84A5A8de026e2815c2dFCAfa061Ee6863];
  address public erc20Payable = 0x38DB01a84A5A8de026e2815c2dFCAfa061Ee6863;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 240) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXAJfhAbfYyXcAdCYmLjy6wuniTXvWC31H8QmW1Hw688t/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gRsAo9xUjrFvaDig6q54/contract-metadata";
  }
...
// File: contracts/DmtBeingsContract.sol
//

pragma solidity ^0.8.0;

contract DmtBeingsContract is RamppERC721A {
    constructor() RamppERC721A("DMT Beings", "DMT Beings"){}
}
