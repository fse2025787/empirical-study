...
// 
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"1 OF 1", unicode"Special Item", unicode"Mouth", unicode"Eyes", unicode"Character", unicode"Drip", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"PXCC", unicode"The premier NFT club for everything degenerate. Obviously nothing planned beyond this website. Why would I have a roadmap? Airdrop you something to burn in exchange for another NFT? Definitely not. I don’t even wake up before noon.     Anyways welcome to The PXCC where the pixels are diverse and the vibes are real. Congrats you have the balls [or your’e an idiot] to stick around in the bear market. Reward yourself by clicking that button below and join The PXCC.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/ef990a91-9b26-4e0e-be6f-587f4b9e29ce", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/ef990a91-9b26-4e0e-be6f-587f4b9e29ce", "https://pixelart.lol/pxcc", 0, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");

        constructor() ERC721A(unicode"PXCC", unicode"PXCC") {
            TIERS[0] = [1,1,1,1,2218];
TIERS[1] = [0,21,26,43,69,195,294,295,299,330,650];
TIERS[2] = [0,135,180,182,220,230,325,350,600];
TIERS[3] = [0,30,35,37,50,60,100,100,130,160,170,175,265,280,290,340];
TIERS[4] = [0,50,64,100,110,111,115,118,120,185,306,413,530];
TIERS[5] = [0,15,21,71,85,90,108,115,120,121,130,142,200,242,246,246,270];
TIERS[6] = [0,28,34,44,55,83,106,110,139,160,172,172,176,184,187,189,191,192];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"PXCC #");
