...
// Making history, one flag at a time!
//@wwiportal
...
// contract 
contract WorldWideInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "World Wide Inu";
    string private _symbol = "WWI";
    ...
    address payable public marketingWallet = payable(0x096C1608A46Cd07b8c88C5c779A5A2Ca07975D50);
