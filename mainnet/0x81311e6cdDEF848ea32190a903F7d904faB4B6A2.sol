...
contract RentADawgHelper {
    ...
    address constant public RENTADAWG = 0xb0bFF1a7D2Eb226f2DEBfA89F28A543c0a645D9c;
    ...
    function getTokenStatus(address vault, address contract_, uint256 tokenId) internal view returns(TokenStatus memory ts) {
        ...
        ts.delegated = delegateCash.checkDelegateForToken(RENTADAWG, vault, contract_, ts.tokenId);
