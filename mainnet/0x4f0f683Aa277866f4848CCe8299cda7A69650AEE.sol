...
contract PICCOLOPENIS is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "PICCOLOPENIS";
    string private constant _symbol = "PICCOLOPENIS";
    ...
    address payable private _marketingAddress = payable(0x930cA7a4bfC88057b8A66976a438b4A899d7244d);
    address payable private _devAddress = payable(0x6b429240309eAB225652B02C6A791105a6B4ea26);
    ...
    function sendETHToFee(uint256 amount) private {
        _devAddress.transfer((amount).div(5).mul(4));
