...
/**************************************
    ...
    @dev AB: OZ override
    @dev Modification scope: getAtBlock
...
library CheckpointsUpgradeable {
    ...
    /**************************************
        ...
        @notice Override of OZ getAtBlock

        ------------------------------

        @dev AB: allowed to call for current block

        ------------------------------

        @param self Checkpoints history
    ...
    function getAtBlock(History storage self, uint256 blockNumber) internal view returns (uint256) {
        require(blockNumber <= block.number, "Checkpoints: block not yet mined"); // @dev < -> <=
