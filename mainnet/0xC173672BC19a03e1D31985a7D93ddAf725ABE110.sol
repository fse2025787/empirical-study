...
contract CuteMonkeyPixel  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmaKCnkW6oAkq7kXQavKR7dFySYUTuoikC5ciY3pbLC5Eh/";
    ...
    constructor() ERC721A("Cute Monkey Pixel", "CMP"){}
    ...
    function cutemint(uint256 count) external payable {
        uint256 cost = price;
    ...
    function CuteAirdrop(address mintAddress, uint256 count) public onlyOwner {
