...
contract HIROI is ERC20, Ownable {
    ...
    constructor() payable ERC20("Hiroi Mikami", "Hiroi") {
        ...
        operationsAddress = address(0xE1f847Fc0c0A5268422d549A71c2BAB61Af2e120);
        treasuryAddress = address(0xE1f847Fc0c0A5268422d549A71c2BAB61Af2e120);
        ...
        _createInitialSupply(address(0xdead), (totalSupply * 20) / 100); // Burn
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellTreasuryFee;
        require(sellTotalFees <= 95, "Must keep fees at 20% or less");
    }
    ...
    function lfg(uint256 blocksForPenalty) external onlyOwner {
