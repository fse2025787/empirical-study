...
contract RoyalRabbit is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RoyalRabbit","ROYRALR") {
        ...
        maxWallet = totalSupply * 10 / 1000; // 2% 
        ...
        marketingWallet = 0x6912074f5b63639190247Bc5FF1E535B70897D03; 
        devWallet = 0x8C7A0BeC2254374674B062361fE85177c811DAA6; 
    ...
    function excludeFromMaxTransaction(address updAds, bool isEx) public onlyOwner {
        _isExcludedMaxTransactionAmount[updAds] = isEx;
          ...
          function updateRoyalRabbitBuyFees(
        uint256 _devFee,
    ...
    function updateRoyalRabbitSellFees(
        uint256 _devFee,
        uint256 _liquidityFee,
        uint256 _marketingFee
    ) external onlyOwner {
    ...
    function UpdateRoyalRabbitDevWallet(address newWallet) external onlyOwner {
