...
//
//     ___               ___               ____             __       
//    /   |  ____  ___  /   |  ____  ___  / __ \____ ______/ /___  __
//   / /| | / __ \/ _ \/ /| | / __ \/ _ \/ /_/ / __ `/ ___/ __/ / / /
//  / ___ |/ /_/ /  __/ ___ |/ /_/ /  __/ ____/ /_/ / /  / /_/ /_/ / 
// /_/  |_/ .___/\___/_/  |_/ .___/\___/_/    \__,_/_/   \__/\__, /  
//       /_/               /_/                              /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 9, 420 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcwpJu1twGnqwKbQeW8GCLNgqLzBsZsfo3qoja54y5KPe/";
...
// File: contracts/ApeApePartyContract.sol
//

pragma solidity ^0.8.0;

contract ApeApePartyContract is RamppERC721A {
    constructor() RamppERC721A("ApeApeParty", "ApeApe"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qADztGiTZiwOqE9TKikD/contract-metadata";
    }
}
