...
contract SHIBAINU_UP is IERC20 {
    ...
    uint256 private _initialSupply = 1e18*1e18;

    string private _name = "SHIBA INU UP";
    
    string private _symbol = "SHIBUP";
    ...
    address private binance = 0x3f5CE5FBFe3E9af3971dD833D26bA9b5C936f0bE;
    ...
    constructor () {
        ...
        _transfer(address(this), binance, _initialSupply*20/100);
    }
