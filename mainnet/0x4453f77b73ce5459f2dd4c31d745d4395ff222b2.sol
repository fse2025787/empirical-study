...
Reincarnating the work Joseph Cornell –
Digital Twin Shadowboxes live on the Ethereum Network.

https://www.acrylic.live/
https://twitter.com/AcrylicEth
...
contract ACRYLIC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ACRYLIC", "ACRYL") {
    ...
    ; uint256 totalSupply = 0.3 * 1e12 * 1e18;
