...
contract Purchaser {
    ...
    function setMinInvPrice(uint newMinPrice) external {
        require(msg.sender == minPriceGuardian || msg.sender == gov, "ONLY minPriceGuardian or GOV");
        minInvPrice = newMinPrice;
    }

    function setMinPriceGuardian(address newGuardian) external onlyGov {
        minPriceGuardian = newGuardian;
    }
