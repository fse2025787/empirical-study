...
Medium - https://medium.com/@KaliDocs
Twitter - https://twitter.com/kali_token
...
contract Kali is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kali";
    string private constant _symbol = unicode"KALI";
