  ...
  */
   ...
   */
    ...
    function getUnclaimedGenesis(uint16 tokenId) external view returns (uint256 owed) {
        ...
        } else if (genesisType[tokenId] == 2 && alien[tokenId].owner != address(0) && alien[tokenId].value > 0) {
            return TOPIAPerAlien - alien[tokenId].value;
        } else if (genesisType[tokenId] == 3 && general[tokenId].owner != address(0) && general[tokenId].value > 0) {
