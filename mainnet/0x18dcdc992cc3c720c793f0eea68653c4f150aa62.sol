...
Spook come join the fun

https://t.me/SpookToken
...
contract Spookf is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("Spook", "Spook") { // 
        marketingWallet = payable(0xf7d900f692c7327f31E44C56Bf1cF3aF358A7B1D); //
        devWallet = payable(0x23399cb06e817b4Bd24d256EeE67427Fd3ac022e); // 
        address router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; /// 

        //INITIAL FEE VALUES HERE
        buyMarketingFees = 2;
        sellMarketingFees = 10;
        buyBurnFee = 0;
        sellBurnFee = 0;
        buyDevFee = 2;
        sellDevFee = 10;
        ...
        swapTokensAtAmount = _totalSupply / 200; // 1%;
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 burnBuy,
        ...
        // 
        require(totalSellFees <= 99 && totalBuyFees <= 15, "%");
