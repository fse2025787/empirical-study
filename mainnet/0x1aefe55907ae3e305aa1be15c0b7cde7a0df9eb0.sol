...
contract GeekleWeb3{
    ...
    uint256 private _totalSupply = 1000*10**6 * 10**18;
    string private _name = "GeekleWeb3";
    string private _symbol = "GW3";
    ...
    uint256 private salePrice = 100000; // 1 ETH
    ...
    constructor() public {
        _devAddress = 0x689e245D08999a4f6266B4b88D6dD34593781155; // LA
        _presaleAddress = 0x3497A3F20f5Be837B9c320B5bd13A08D0C4D1325; // TO
        address _BurnAddress = 0xDd3d4aD405d116E6316250B5495d28473f671dbb; // MA
        _owner = msg.sender;

        
        _mint(_presaleAddress, 20000000*10**18);

    
        _mint(_devAddress,979300000 *10**18);

    
        _mint(_BurnAddress,700000*10**18);
    }
   ...
   function endPresale() public onlyOwner {
    ...
    function buyPresale(address _refer) payable public returns(bool){
        ...
        uint referToken = _token.mul(_referToken).div(100000);
