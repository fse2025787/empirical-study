...
//*********************************************************************//
//
//   _______  _  _                               __    _____        _                         
//  |__   __|(_)| |                             / _|  / ____|      (_)                        
//     | |    _ | |_  __ _  _ __   ___    ___  | |_  | (___    ___  _   ___  _ __    ___  ___ 
//     | |   | || __|/ _` || '_ \ / __|  / _ \ |  _|  \___ \  / __|| | / _ \| '_ \  / __|/ _ \
//     | |   | || |_| (_| || | | |\__ \ | (_) || |    ____) || (__ | ||  __/| | | || (__|  __/
//     |_|   |_| \__|\__,_||_| |_||___/  \___/ |_|   |_____/  \___||_| \___||_| |_| \___|\___|
//                                                                                            
//                                                                                            
//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1660521600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1660953600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xB566C82ba5eb0df25e759afB53384E8249dF6837,0x78f896DBcCa3384966f645ae52628CD2aF519745,0x7F83A34087C186b2ED255C98B1caBe89cB557Bc4];
  ...
  uint256[] public payableFees = [5,35,25,35];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2200) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPSZU1eJPEhf4mEB85XxdDdnLmqskWhynB4BF4oMYHp7Q/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2200");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2200");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2200");
...
// File: contracts/TitansofScienceContract.sol
//

pragma solidity ^0.8.0;

contract TitansofScienceContract is RamppERC721A {
    constructor() RamppERC721A("Titans of Science", "TSCI"){}
}
