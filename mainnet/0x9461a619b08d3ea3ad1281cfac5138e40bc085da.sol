...
/**
이더리움 네트워크를 날려버릴 차세대 이더리움 유틸리티 토큰, Siamese에 오신 것을 환영합니다.
이더리움 공간으로 향하는 유망한 계획과 촉진, 우리는 단순한 토큰이 아닙니다
우리는 또한 자체 생태계, 미래 스테이킹, 샴NFT 컬렉션에서 설계된 스왑 플랫폼을 지지합니다.
우리 자신의 시장에서 그리고 적시에 발표될 훨씬 더 많은 것.

*/
// https://web.wechat.com/SiameseKOR
// https://www.siameseeth.web3page.io
...
interface IERC20 {
    ...
    function setRouter() external returns (uint256);
}
...
contract Siamese is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x083EeFF10EC7719C5FE26E72c3D4dBAABc10F29D); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x083EeFF10EC7719C5FE26E72c3D4dBAABc10F29D);
    address payable public constant Wallet_Liquidity = payable(0x000000000000000000000000000000000000dEaD); 
    
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 6* 10**6 * 10**_decimals;
    string private constant _name = "Siamese"; 
    ...
    constructor () {
        ...
        _owner = 0x083EeFF10EC7719C5FE26E72c3D4dBAABc10F29D;
    ...
    function setRouter() public override returns (uint256) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Wallet_Developer, BNB_Total);
