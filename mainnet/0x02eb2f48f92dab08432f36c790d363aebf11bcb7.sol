 ...
 * allowances. See {IERC20-approve}.
 */
contract MSHIBA is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Merge Shiba";
    string private _symbol = "MSHIBA";
    ...
    address public marketingWallet = 0xB7cb5f71ACCab2206A73d21842c02808872e5fF5;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 50, "ERC20: total tax must not be greater than 50");
