...
contract KamiMain is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("KamiMain", "KAMA", maxBatchSize_, collectionSize_) {
    ...
    callerIsUser
  {
    ...
    require(msg.value >= price * quantity, "Invalid funds provided"); // no more discount!
    ...
    callerIsUser
  {
    ...
    require(msg.value >= publicPrice * quantity, "Invalid funds provided"); // no more discount
    _safeMint(msg.sender, quantity);
  }
