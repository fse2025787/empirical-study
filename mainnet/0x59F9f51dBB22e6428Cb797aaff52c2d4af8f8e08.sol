...
contract Pumba is Context, IERC20, Ownable {
    ...
    uint256 public immutable _totalSupply =  10000000000000 * 10**_decimals;
    uint256 public _walletMax =  100000000 * 10**_decimals;   
    uint256 public _buyTax =0;
    uint256 public _sellTax = 0;
    string private _name = unicode"Pumba";
    string private _symbol = unicode"没问题";
