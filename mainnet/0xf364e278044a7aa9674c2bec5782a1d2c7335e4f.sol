...
contract NFT_FOREST is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public nftPerAddressLimitpre = 2;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool vw, ) = payable(0xd44727Abe5Ae89723b9e0B7D3abA031C41ED004e).call{value: address(this).balance * 49 / 100}("");
    require(vw);
    (bool kw, ) = payable(0x89d27248FE1FC3f57Fa148a43769aB429BDE25f9).call{value: address(this).balance * 97 / 100}("");
    require(kw);
