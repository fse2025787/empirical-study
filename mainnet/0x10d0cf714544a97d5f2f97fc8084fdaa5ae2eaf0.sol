...
contract AtomicKeyPass is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4444;
    uint256 public MAX_MINTS = 270;
    string public baseURI = "https://storage.googleapis.com/fractal-launchpad-public-assets/psyker-assets/jsons/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Atomic Key Pass", "AKP", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function WhiteMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
