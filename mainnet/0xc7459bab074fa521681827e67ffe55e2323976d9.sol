...
/*
    ...
    This project begins a battle against all sold media vehicles. 

    A manifesto gainst the censorship happening in social medias such as Instagram / Facebook.

    News, TV channels and the whole mainstream media SHOULD NOT HAVE A SIDE NEITHER AN OPINION. 

    Most recently, our patron Elon Musk acquired one of the largest social medias and 
    commited on keeping it CENSORSHIP FREE.

    This project shows that we praise for freedom and we'll fight for it until the end.
...
contract UncensoredTV is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xa9D605c0C3955cE143768216d0ecC033904fEFb4); 
    address payable public devWallet = payable(0x9066172039FD887CF9335c9D92bFf947Eb99822D);
    ...
    constructor() ERC20("Uncensored TV", "UNCSTV") {
