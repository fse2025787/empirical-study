...
contract OrcRaid is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    */
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max OrcRaid per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 OrcRaid" );
		require(s + _mintAmount <= maxFree, "Cant exceed OrcRaid supply" );
    ...
    */
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 OrcRaid");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more OrcRaid" );
        require(s + _mintAmount <= maxSupply, "Cant exceed OrcRaid supply");
    ...
    /**
    * @dev GIFT SOME PASSES TO THE LADS
    */
    ...
    */
    ...
    /**
    * @dev SET THE LOCATION OF THE GIFs
    */
