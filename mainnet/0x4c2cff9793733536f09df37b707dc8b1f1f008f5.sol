...
//*Twitter: https://twitter.com/superviruseth
//*Telegram: https://t.me/SuperVirusNFT
...
contract SuperVirus is Context, IERC20, Ownable {
    ...
    string private constant _name = "SuperVirus";
    string private constant _symbol = "SVS";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x4f0cfD6385edd092Ff25A94CB9D96115bB24dc90);
    address payable private _marketingAddress = payable(0x4f0cfD6385edd092Ff25A94CB9D96115bB24dc90);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 10, "Redis cannot be more than 9.");
	    require(redisFeeOnSell < 10, "Redis cannot be more than 9.");
