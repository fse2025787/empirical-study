...
contract KIBI is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69 * 10**6 * 10**18;
    ...
    string private constant _name = unicode"Kibisu Inu";
    string private constant _symbol = unicode"KIBI";
    ...
    constructor () payable {
        _marketingWallet = payable(0x8DF34ab4CA6E5418DABfF02c45f8A7c7E620A935);
