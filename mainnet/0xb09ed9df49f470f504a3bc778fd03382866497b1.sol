...
/*
                ...
                (          _     _ _______ _______  _____  _______  ______ _______            )
                )          |____/  |______ |______ |_____] |______ |_____/ |______          (
                (          |    \_ |______ |______ |       |______ |    \_ ______|            )
                )                                                                           (
                (          At KPR, we see a world that keeps trying to take the persons       )
                )          out of the people. Though our environment faces new perils,      (
                (          we see beautiful blue skies to unite under. With hope, wits,       )
                )          and most of all, heart, we'll pilot our own future.              (
                (                                                                             )
                )          After all, building you is building us.                          (
                (                                                                             )
                )          https://kprverse.com/                                            (
                (          https://twitter.com/adventure_KPR                                  )
                )                                                                           (
...
contract KEEPERS is ERC20, Ownable {
    using SafeMath for uint256;
