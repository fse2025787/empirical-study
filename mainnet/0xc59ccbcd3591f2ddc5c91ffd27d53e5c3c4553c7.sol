...
contract ManateezComic is ERC721, Ownable {
    ...
    function reserveForTeam(uint _amount, address _to) external {
        ...
        require(RESERVED_FOR_TEAM.add(_amount) <= RESERVED_FOR_TEAM, "Can not mint more than 500 tokens for the team");
        RESERVED_FOR_TEAM += _amount;
