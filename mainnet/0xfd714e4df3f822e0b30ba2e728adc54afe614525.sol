    ...
    OwnableUpgradeable
{
    ...
    // TODO Uncomment for deployment mainnet
    function initialize(address _token) public initializer {
        ...
        mooncats = 0xc3f733ca98E0daD0386979Eb96fb1722A1A05E69; //change this to real mooncat TODO
    ...
    //     isAllowed(_attacker)
    // {
    //     // Can only bonk up to 30 minutes after someone mined
    //     require(
    ...
    //         token.mint(msg.sender, reward); //todo set reward
    //         petScore[_victim] -= petScore[_victim] / 20;
    //     } else {
    //         // the defender win 19%
    //         token.mint(victimOwner, reward);
    //         petScore[_attacker] -= petScore[_attacker] / 20;
    //     }
    //     emit Bonk(
    //         _attacker,
    //         _victim,
