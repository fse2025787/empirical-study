...
contract ExPowerPuffs is ERC721A, Ownable {
    string  public uriPrefix = "ipfs://QmSEMUcdm3prADFi1sXAF9TmwyCW2JecXa1azh8ypAdc2h/";

    uint256 public immutable cost = 0.004 ether;
    uint32 public immutable MAX_SUPPLY = 3600;
    uint32 public immutable MAX_PER_TX = 5;
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(amount <=  MAX_PER_TX, "max 5 per tx");
