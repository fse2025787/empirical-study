...
contract Momotaro is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Momotaro", "Peach Boy") {
        ...
        maxTransactionAmount = 15 * 10 ** 4 * 10 ** decimals(); // 1.5% maxTransactionAmountTxn
        maxWallet = 30 * 10 ** 4 * 10 ** decimals(); // 3% maxWallet
    ...
    function blacklistbots (address account, bool isBlacklisted) public onlyOwner {
