...
/**
   ...
   2% distributed to patient  Holders 
   2%  goes to Marketing budget
...
contract TheTrustToken is Context, IERC20, Ownable {
   ...
   address private _marketingWalletAddress = 0x40AEc1595A48aA945c706C69244D01AFE90De542 ;
    ...
    string private _name = "The Trust Token";
    string private _symbol = "TrusToken";
    ...
    uint256 private numTokensSellToAddToLiquidity = 50000000000 * 10**18;
    ...
    function marketingWalletAddress() public view virtual returns (address) {
    ...
    function setMarketingAddress(address payable marketing) public onlyOwner() {
        _marketingWalletAddress = marketing;
    }
