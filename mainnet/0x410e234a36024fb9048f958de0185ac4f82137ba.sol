...
contract DefiAptos is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x9aCc7fd0CC11B4F4899889f32C7448CF07afdf85));

    string private _name = "DefiAptos";
    string private _symbol = "DAPTS";
