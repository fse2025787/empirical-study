...
Token Name: Battalion Force
Ticker: Battalion
Supply: 1,000,000
Max Tx: 20,000
Tax: 4%

Telegram: https://t.me/BattalionForceERC20


No lieutenant.
No colonel.
Just a token created for the community to show the real battalion force.
Together we hodl. And send it together.
...
contract Battalion is Context, IERC20, Ownable {
    ...
    string private constant _name = "Battalion Force";
    string private constant _symbol = "BATTALION";
    ...
    function removeLimits() external onlyOwner{
        _maxTxAmount = 40_000 * 10**_decimals;
        _maxWalletSize = 40_000 * 10**_decimals;
        emit MaxTxAmountUpdated(40_000 * 10**_decimals);
    }
