...
* If POWL can do it, shit, why can't we do it with Tacos, everyone LIKEs TACOS, right?
*/

contract Proof_of_Tacos {
    /*=================================
    =            MODIFIERS            =
    =================================*/
    ...
    */
    function Proof_of_Tacos()
        public
    {
        //  more efficient - initialize ambassador in constructor
        onlyAmbassadors = false;
        ...
        ambassadors_[0x5EAFB40D69C06F36f50c53cB4882b79531bdA43b] = true; //AS
