...
contract PsychoFrens is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Psycho Frens", "PF") {
    setHiddenMetadataUri("ipfs://QmPscLgnigLdindNBfAXhryeTHsndT2vKu4oMXfGhb1tDC/hidden.json");
  }
