...
/**
JOIN US AS QUETZALCOATL!
BRINGS NEVER ENDING GREEN CANDLES TO THE CHART AND
RESTORES BALANCE TO THE CRYPTO UNIVERSE.

https://t.me/QuetzalcoatlToken
https://twitter.com/QuetzalcoatlETH
https://quetzalcoatl.site
...
contract QUETZALCOATL is ERC20, Ownable {
    ...
    constructor() ERC20("QUETZALCOATL", "QUETZALCOATL") payable {
    	...
    	marketingWallet = address(0x21718100cecd8c1AE01C80172B20CAB608a97E06); // set as marketing wallet
        ...
        excludeFromFees(0x21718100cecd8c1AE01C80172B20CAB608a97E06, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x21718100cecd8c1AE01C80172B20CAB608a97E06, true);
        ...
        */
        ...
        _createInitialSupply(0x21718100cecd8c1AE01C80172B20CAB608a97E06, totalSupply*10/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x21718100cecd8c1AE01C80172B20CAB608a97E06,
            block.timestamp
        );
    }
