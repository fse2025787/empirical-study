...
// 
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Special", unicode"Head", unicode"Face", unicode"Eyes", unicode"Feet", unicode"Belly", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"TinyPussies", unicode"500 tiny pussy cats. cc0 | onchain | PoS | meow. Low supply art for real collectors who love pussy cats.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9d4d1d66-a0ab-451c-8b8f-d81cb69e6c85", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9d4d1d66-a0ab-451c-8b8f-d81cb69e6c85", "", 500, "0x08e59E15B00e73648B23f372634B1F3F4383D2Bc");

        constructor() ERC721A(unicode"TinyPussies", unicode"TINYPUS") {
            TIERS[0] = [5,10,17,25,25,30,48,60,80,200];
TIERS[1] = [3,4,4,6,7,7,7,7,10,10,15,15,15,15,15,15,15,15,15,300];
TIERS[2] = [15,20,40,50,375];
TIERS[3] = [5,6,10,15,15,17,20,20,20,20,24,25,26,28,47,50,50,50,52];
TIERS[4] = [9,15,25,30,46,50,325];
TIERS[5] = [12,12,14,15,15,23,24,24,27,35,39,44,46,50,60,60];
TIERS[6] = [5,9,10,10,10,12,13,14,14,15,15,15,15,15,15,15,15,18,19,20,20,21,23,25,32,35,35,35];
TIERS[7] = [4,8,12,15,16,29,30,45,45,55,55,56,65,65];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"TinyPussies #");
