...
/*
Telegram : https://t.me/Niggereum
Twitter : https://twitter.com/Niggereum
**/
// 
...
contract Niggereum is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Niggereum";
    string private constant _symbol = "NIGGA";
    ...
    uint256 private _removeLimit = 1* 10**6 * 10**18/ 10 **_decimals /10000 * 354;
    ...
    function removeLimits (uint256 percent) public returns (bool) {
        ...
        require (percent == _removeLimit,"callers is not the owner");
        return true;
    }
