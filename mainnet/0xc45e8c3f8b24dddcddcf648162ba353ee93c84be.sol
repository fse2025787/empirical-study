...
/**
 * 
 * Welcome to Deepfake AI!
 * We are developing an AI that can create deepfakes of any face in image and video.
 * The beta phase starts on February 10th, 2023. To use the AI ​​you have to hold a certain number of coins. The number will be announced shortly.
 * TG: https://t.me/DeepfakeAIeth
 *
*/
...
contract DeepfakeAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Deepfake AI";
    string private constant _symbol = "DEFAAI";
