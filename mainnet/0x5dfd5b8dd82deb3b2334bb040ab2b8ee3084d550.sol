...
contract SugoiBaka is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmYFvQEre9Mf8yyKFb1UNFyYpMz8TFFN5PqZAkkQwPo8tW/";
    ...
    constructor(string memory initBaseURI) ERC721A("SugoiBaka", "SB") {
        baseURI = initBaseURI;
