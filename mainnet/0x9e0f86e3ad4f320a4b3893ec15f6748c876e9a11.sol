...
// solhint-disable
contract CHEESSE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd65B84C4E919aaD42F956d782d924DeE4bb10092);
    address payable public devAddress =
        payable(0xc5Aea1CFB5df024b92808d2A13Bb261759CE18c5);
    address payable public liquidityAddress =
        payable(0x3dd7bBaE16C97eCF0EBD1008da1b617560707f32);
    ...
    string private constant _name = "Cheesse";
    string private constant _symbol = "CHEESSE";
