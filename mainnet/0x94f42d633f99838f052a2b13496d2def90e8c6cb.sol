...
contract Goblin is ERC721A, Ownable {
    ...
    uint256 public mintFree = 3000;

    constructor(string memory _initBaseURI) ERC721A("Gross Goblins", "GGOBLIN") {
    ...
    // set Mint Free
    function setMintFree(uint256 _amount) public onlyOwner {
        mintFree = _amount;
    }
