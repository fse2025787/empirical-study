...
// 
//
// WHAT COLOR IS THE KIMONA? LOOK CLOSER.
// Buy, sell and trade on a meme project like never before! 
// Kimona is a sustainable token, aiming to provide safety to investors through
// its own decentralized exchange and private dashboard!
//
//  Website: https://kimona.co/
//  TG: https://t.me/kimonatoken
// 
//                  
//  __   ___   __     ___      ___     ______    _____  ___        __      
// |/"| /  ") |" \   |"  \    /"  |   /    " \  (\"   \|"  \      /""\     
// (: |/   /  ||  |   \   \  //   |  // ____  \ |.\\   \    |    /    \    
// |    __/   |:  |   /\\  \/.    | /  /    ) :)|: \.   \\  |   /' /\  \   
// (// _  \   |.  |  |: \.        |(: (____/ // |.  \    \. |  //  __'  \  
// |: | \  \  /\  |\ |.  \    /:  | \        /  |    \    \ | /   /  \\  \ 
// (__|  \__)(__\_|_)|___|\__/|___|  \"_____/    \___|\____\)(___/    \___)
...
contract KIMONA is ERC20, Ownable {
    ...
    constructor() payable ERC20("Kimona Token", "KIMONA") {
