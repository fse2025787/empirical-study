...
contract EL1 is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public teamFee = 12;
    uint256 public liquidityFee = 1;
  

    address payable public teamAddress = payable(0xD45aB715343DdF6361a4afbfbc4523133ce98f33);
    ...
    uint256 public _maxWalletAmount = 25000 * 10**9;
    ...
    constructor () ERC20Detailed("Elon1", "EL1", 9) {
    ...
    function setTeamFeePercent(uint256 updatedTeamFee) external onlyOwner {
        ...
        require(teamFee.add(liquidityFee) <= 20, "Fee is crossing the boundaries");
    }
