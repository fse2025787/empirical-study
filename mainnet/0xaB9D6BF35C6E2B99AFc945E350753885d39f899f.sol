...
Tiger Gates - Toranomon

🐯The innovative proof-of-holding methodology will ensure that the Toramon community always has a good attitude, prevent bots, fraudsters, 
and those providing "services," and ensure that the only people who can communicate with the community are those who are financially invested and motivated to work on their bags.

🐯Socials: 
  - Website: http://www.toranomon.co/
  - Twitter: https://twitter.com/ToranomonERC
  - Telegram: https://t.me/ToranomonPortal
  - Medium: https://medium.com/@ToranomonERC
...
contract TORANOMON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tiger Gates", "Toranomon") {
