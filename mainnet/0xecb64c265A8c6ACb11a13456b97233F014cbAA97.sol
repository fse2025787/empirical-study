...
contract ProxyYield is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function yieldLamex(uint256 tokenId) public whenNotPaused {
      require(IERC721(lamex).ownerOf(tokenId) == _msgSender(), "Activate your lamex first");
    ...
    function _switchToLamex(address _user) internal {
      ...
      _lastSwitch[_user] = block.timestamp;

      loomi.depositLoomiFor(_user, (accumulatedAmount - _accumulatedAtLamex[_user]));
