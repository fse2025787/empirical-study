...
Loyalty. Freedom. Family. Protection. 

Tama - from the beginning - has always meant safety. In a space 
where bad actors, who seek to destroy, run free and reign supreme, 
tama has sought to level the playing field. 

Few are worthy to take on tama’s call, even less, are equipped with 
the skillset. An impossible task (nearly) that has laid dormant, 
unblemished by the unmastered hand. Lying in wait – patiently, and 
undeterred from its purpose – for the tides to shift… and Shift. They. Will. 

In a sea of predators, tama feasts. For it is the predators that 
are to be culled, one by one to protect the loyal ones… the vulnerable. 
A culling of such magnitude that their rotten core is rent from the 
inside out… has it not been taught that the purification process begins 
– first – from the inside? So it will be as tama begins to feast. 

tama is in YOU, tama is in us ALL. The broken and mended, the 
tortured and nurtured. 

No tax, no team, all glory to tama. All glory to the loyal.

https://twitter.com/tamadeployer (to be handed off to the loyal)
...
contract TAMA is Context, Ownable, IERC20, IERC20Metadata{
