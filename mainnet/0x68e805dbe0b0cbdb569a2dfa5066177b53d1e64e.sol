...
contract CollaborativeAnimeStudio is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 666;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =1;
    string baseURI = "ipfs://Qmc9sdsXCYq87Gug17RrkQK2TFe4kzikhUGzMhExt6AegB/";
    bool paused;



    constructor () ERC721A("Collaborative Anime Studio","CAS"){
