...
contract Aragon is Context, IERC20Upgradeable {
    ...
    uint256 private maxLiquidityFee = 900;
    uint256 private maxMarketingFee = 1000;

    uint256 public _liquidityRatio = 1000;
    uint256 public _marketingRatio = 1000;
    ...
    address payable private _marketingWallet = payable(0xa4e885fDC8cFc44A811E7B41fA02D7429695a988);
