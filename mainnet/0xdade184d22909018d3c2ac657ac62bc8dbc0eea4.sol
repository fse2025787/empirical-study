...
contract DDLAND is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Danke Deutsch-land!!";
    string private constant _symbol = unicode"DDLAND";
