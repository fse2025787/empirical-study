...
AIKIBA is a dog inspired meme token that could become next OPENAI. 

Telegram: https://t.me/AIKibaERC
Website: https://www.aikiba.net
Medium: https://medium.com/@aikiba
Twitter: https://twitter.com/AIKIBAERC
*/
...
contract AIKIBA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "AI KIBA"; 
    string private constant _symbol = "AIKIBA"; 
    ...
    address payable private _developmentWalletAddress = payable(0xeCbF9b1B64A00145FdcA2D2bDb3FcaE9f405604e);
    address payable private _marketingWalletAddress = payable(0xCa128CAc643d3bd04E7159401818213d88413326);
