...
contract DualWorldFusion is NFTokenMetadata {
    ...
    */
        ...
        public virtual payable
    {
        ...
        require(msg.value >= 250000000000000000, "Not enough ETH sent; 0.25 ETH is required for minting");
        require(count <= 1400 && count > 0, "Only 1400 NFTs can be minted");

        string memory baseTokenURI = "https://us-central1-dual-world-fusion.cloudfunctions.net/app/nft/";
        // String representing RFC 3986 URI.
        string memory tokenURI = concatenate(baseTokenURI, uintToStr(count));
