...
/* @goktsuka
3/3% at launch then reduced to 0/0 after launch.
contract renounced and liquidity burnt.


WELCOME TO GOKUTSUKA SAN
*/
...
contract GOKUTSUKA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GOKUTSUKA ";
    string private _symbol = "GokTsuka";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xa7e086fC2B91a329ae752504D48E024eC8fD56cb);
    address payable private taxWallet2 = payable(0xa7e086fC2B91a329ae752504D48E024eC8fD56cb);
