...
contract Civilization   is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Civilization inu";
    string private constant _symbol = "Civilization";
    ...
    address payable private _developmentAddress = payable(0x849ffb7cfcfd798a9a7cF64DbC53739481B98E5d); 
    address payable private _marketingAddress = payable(0x849ffb7cfcfd798a9a7cF64DbC53739481B98E5d);
