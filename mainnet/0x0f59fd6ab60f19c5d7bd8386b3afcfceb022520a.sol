 ...
 */
contract DrunkPirates is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant premintPrice = 50000000000000000; //0.05 ETH

    uint256 public constant mintPrice = 80000000000000000; //0.08 ETH

    uint256 public constant maxPiratePremint = 1000;
    ...
    */
    function mintPirate(uint numberOfTokens) public payable {
        ...
        require((block.timestamp >= SALE_TIMESTAMP) || (totalSupply().add(numberOfTokens) <= maxPiratePremint), "Premint limit of 1000 tokens has been exhausted. Public mint starts soon."); 
        uint price = (block.timestamp >= SALE_TIMESTAMP) ? mintPrice : premintPrice;
