...
contract V2Punks is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _baseURIextended = 'ipfs://QmUSivCzYphi5i2h7RGriY5bdrBVb9nLtG5y2t37BRPXL9/';
    }
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = V2Punks.ownerOf(tokenId);
