...
pragma solidity ^0.6.12;
    ...
    contract Trade2Donate is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 1500 * 10**6 * 10**9;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private _name = 'Trade2Donate Token';
        ...
        uint256 private _maxTxAmount = 1500000000e9;
        // We will set a minimum amount of tokens to be swaped => 250K
        uint256 private _numOfTokensToExchangeForCharity = 250 * 10**3 * 10**9;
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 0 && taxFee <= 10, 'taxFee should be in 0 - 5');
            _taxFee = taxFee;
        }
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 100000000e9 , 'maxTxAmount should be greater than 100000000e9');
