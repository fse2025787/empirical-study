...
/*
Uraraka Inu is here to reignite anime season once again. 
By using her Zero Gravity powers, Uraraka will lift our chart off the ground, 
higher and higher, and once again revive anime season by building a strong community of loyal supporters.

Website: http://www.urarakainu.com/
*/
...
contract Uraraka is ERC20, Ownable{
    ...
    address public marketingWallet = 0xFB1C0C9AE2695d7DdA67F664718D7109e9757370;
    address public devWallet = 0xAE2865776bA84674ee8B885cffa11Fb0aECcdb8d;
    ...
    Taxes public taxes = Taxes(5,2,2);
    Taxes public sellTaxes = Taxes(5,2,2);
    uint256 public totTax = 9;
    ...
    constructor() ERC20("Uraraka Inu", "RAKA") {
