...
library Address{
 ...
 contract ANBUDAO is Context, IERC20, Ownable {
    ...
    address public burnWallet = 0x2196873a88FF0767d12e2F19bF453d14C4dEfb09;
    address public treasuryWallet = 0xBC0b81a32d8D613FDcfF0B5B17DcD2ef2EDBD599;

    string private constant _name = "ANBU DAO";
    ...
    Taxes public taxes = Taxes(0, 3, 1, 4);
    Taxes public sellTaxes = Taxes(0, 3, 1, 4);
    ...
    function setTaxes(uint256 _rfi, uint256 _burn, uint256 _liquidity, uint256 _treasury) public onlyOwner {
       taxes = Taxes(_rfi,_burn,_liquidity,_treasury);
        emit FeesChanged();
    }
    
    function setSellTaxes(uint256 _rfi, uint256 _burn, uint256 _liquidity, uint256 _treasury) public onlyOwner {
       sellTaxes = Taxes(_rfi,_burn,_liquidity,_treasury);
        emit FeesChanged();
    }
