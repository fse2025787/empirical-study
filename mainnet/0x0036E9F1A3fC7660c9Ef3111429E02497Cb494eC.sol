...
contract ADLair is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"A Degens Lair";
    string private constant _symbol = unicode"LAIR";
