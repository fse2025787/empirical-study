...
contract Bonk2023 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bonk 2023";
    string private constant _symbol = "BONK23";
    ...
    function burnsniper(address notbot) public onlyOwner {
        bots[notbot] = false;
    }
