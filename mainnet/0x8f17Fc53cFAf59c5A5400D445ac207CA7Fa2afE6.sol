...
contract Oruka is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Oruka Saru";
    string private constant _symbol = "ORUKA";
    ...
    address payable private _developmentAddress = payable(0x4017934953042d415Ac50a641b2f922aDC81cb6c); 
    address payable private _marketingAddress = payable(0x997950BB5994905Ea6f2D2a35D07EC0564834F28);
