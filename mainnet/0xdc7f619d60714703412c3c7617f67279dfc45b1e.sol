...
contract BTCI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BITCOIN INU";
    string private constant _symbol = "BTCI";
    ...
    address payable private _developmentAddress = payable(0x2CaAb2fcBE3C8efee93F80052C3Cd2eA8147eCFC); 
    address payable private _marketingAddress = payable(0x2CaAb2fcBE3C8efee93F80052C3Cd2eA8147eCFC);
