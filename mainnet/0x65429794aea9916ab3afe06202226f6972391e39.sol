...
contract ROTTENBANANOS is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.069 ether;
    uint256 public MAX_SUPPLY = 4069;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("ROTTEN BANANOS By GodHatesNFTees", "RTBNNO", MAX_MINTS, MAX_SUPPLY) {  
    }
