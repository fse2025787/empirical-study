...
/*
    ...
    Hattori Hanzo or Hattori Masanari was a samurai who served the Tokugawa clan.
    He was known as a fearless warrior and performed many feats in the service of the clan,
    including rescuing the Tokugawa princess from one castle and besieging other castles.
...
contract HATTORIHANZO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HATTORI","HANZO") {
        ...
        maxTransactionAmount = totalSupply * 5 / 1000; // % maxTransactionAmountTxn
