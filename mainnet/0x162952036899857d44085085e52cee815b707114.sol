...
/*
                     ...
                     Website: https://goghost.world/
                                                                               
                              Twitter: https://twitter.com/Gogh0st/

                                    Discord: https://discord.gg/goghost/                                                 
...
contract GoGhost is ERC721A, Ownable {
  ...
  constructor(
    ...
    signer = _signer;
    coverCid = _coverCid;
    revealedCidHash = _revealedCidHash;
    ...
    returns (string memory)
  {
    if (revealed) {
      ...
      return string(abi.encodePacked("https://", coverCid, ".ipfs.nftstorage.link/cover.json"));
    }
  }
