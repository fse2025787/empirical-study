...
contract rangerstownwtf is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("rangerstown.wtf", "RNG.wtf"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on ranger");
    require(totalSupply() + amount < maxSupply + 1,"No more rangers");
