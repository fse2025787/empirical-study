...
/**
    ...
    Linktree : https://linktr.ee/LFGoose

    Telegram : https://t.me/LetsFuckingGoosePortal

    Give away Tg a the bottom of this page 

    Go read to have a chance to win prize !!
...
contract LFGO is Context, IERC20, Ownable {
    ...
    string private constant _name = "LetsFGoose";
    string private constant _symbol = "LFGoose";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x4860Ed29eB591cE9Ce1DF1B0951C89454DaC2c14);
        _feeAddrWallet2 = payable(0xdb60419557b7a15d376316E4347107A7eD52c166);
        ...
        emit Transfer(
            address(0x3f2242dd0eF3b0379e8E13B0BE92bfB5a0312657),
            _msgSender(),
            _tTotal
        );
    }
