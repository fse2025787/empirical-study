...
contract Warcraft  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmerNrpuFwJieH5PThDY2rfaz3XXsYDvjf57s3CcSCEVGj/";
    ...
    constructor()
    ERC721A ("Warcraft   Game Studio", "WGS") {
    }
    ...
    function burnToFight(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
