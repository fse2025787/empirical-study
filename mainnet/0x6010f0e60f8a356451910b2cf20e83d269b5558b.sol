...
*/
// https://web.wechat.com/TinyDino
// https://www.tinydinonetwork.web3prg.io


contract DINO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tiny Dino"; // 
    string private constant _symbol = unicode"DiNO"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x4445f42d89ECEba571ec9FBACd6a3F5E5Da2699F).transfer(ethToSend); //marketing wallet
    }
