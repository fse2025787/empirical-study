...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1400;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmPx49D3QdgQqaifJ4gqatikha88hoifyZzZ9vti1fZ4Ph/";
...
// File: contracts/GrimsContract.sol
//

pragma solidity ^0.8.0;

contract GrimsContract is RamppERC721A {
    constructor() RamppERC721A("Grims", "EYE"){}
}
