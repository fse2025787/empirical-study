...
/*
 Please read the medium : https://medium.com/@BillMurrayERC/gather-up-chads-its-our-time-to-shine-740d890cd54d

 Together we can do it.... Don't jeet and karma will rewards you 

 Taxes going towards donation for Evelyn

 Burning 100% of the LP at launch

 Taxese : 5%/5% going straight to for donation.
...
contract BillMurray is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2dbcc0bd168aC2CA44083dfbF1E88a093413454c); 
    address payable public Wallet_Team = payable(0x2dbcc0bd168aC2CA44083dfbF1E88a093413454c);
    ...
    string private constant _symbol = unicode"Bill Murray"; 
    ...
    constructor () {
        ...
        _owner = 0x2dbcc0bd168aC2CA44083dfbF1E88a093413454c;
