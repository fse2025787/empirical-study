...
// 
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accessories", unicode"Eyewear", unicode"Eyes", unicode"Headwear", unicode"Mouth", unicode"Clothing", unicode"Body", unicode"Background"];
        ...
        uint public allowListPrice = 0.0069 ether;
        uint public maxPerAllowList = 2;
        bool public isAllowListActive;
        
        ContractData public contractData = ContractData(unicode"Treyliens", unicode"An army of 2K fully on-chain web3 aliens, ready to invade earth. Cc0.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/d8713115-3da5-42fe-a5b4-10df63d5430a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/d8713115-3da5-42fe-a5b4-10df63d5430a", "", 500, "0x2B8454f668669c9C888C8346416E10be86BB7620");

        constructor() ERC721A(unicode"Treyliens", unicode"TREY") {
            TIERS[0] = [13,17,69,143,168,229,261,277,353,470];
TIERS[1] = [10,30,76,155,185,206,207,242,278,611];
TIERS[2] = [90,90,95,100,110,110,125,195,250,250,260,325];
TIERS[3] = [16,20,35,40,69,100,105,205,325,500,585];
TIERS[4] = [46,67,77,79,147,165,209,289,406,515];
TIERS[5] = [45,53,60,68,92,104,124,259,329,392,474];
TIERS[6] = [25,39,66,105,150,165,180,270,305,695];
TIERS[7] = [59,85,90,181,256,312,1017];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Treyliens #");
