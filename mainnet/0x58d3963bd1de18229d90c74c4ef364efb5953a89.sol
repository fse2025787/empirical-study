...
You can get any kind of satisfying videos you want.
The more people join, the bigger the zone will be.
...
contract Rzctoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rzctoken";
    string private constant _symbol = "RZC";
    ...
    uint256 private _maxWalletSize = 3000000 * 10**8;
