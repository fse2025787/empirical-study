...
contract SpearInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Spear Inu";
    string private constant _symbol = "Spear";
    ...
    address payable private _marketingAddress = payable(0x7C74C88B0968083442dD3E5C81Ac5487355d2F0E);
    address payable private _devAddress = payable(0x23Fbc1082ab8c715c56955a9310516d2cA951742);
    ...
    uint256 public _maxTxAmount = 30000000000 * 10**9; //1.8% of total supply per txn 
