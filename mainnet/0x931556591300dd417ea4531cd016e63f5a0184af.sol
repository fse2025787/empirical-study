...
contract THEIMMOVABLE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("THE IMMOVABLE", "ACALA") {
        ...
        uint256 _buyMarketing = 4;
        uint256 _buyLiquidityFee = 1;
        uint256 _buyDevFee = 0;
 
        uint256 _sellMarketing = 4;
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0x2BCe3457F0552C7F47c6d833ADB66dF144e16Eb7); // set as Marketing wallet
        DevWallet = address(0x2BCe3457F0552C7F47c6d833ADB66dF144e16Eb7); // set as dev wallet
