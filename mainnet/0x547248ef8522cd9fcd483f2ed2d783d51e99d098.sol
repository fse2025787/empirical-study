...
contract SoundKI is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.0076 ether;
  ...
  constructor() ERC721("Sound KI Collection", "2ndKEY") {
    setHiddenMetadataUri("ipfs://QmUGsYTXRGp1uSNEeG4BdkNYDYovzMAKyFTcBJfU7WuMgi/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x418B37d194CB1237227342cEea19F82D856BE654).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
