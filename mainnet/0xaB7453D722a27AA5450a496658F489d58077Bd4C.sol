...
// ================== Variables Start =======================
  ...
  uint256 public ogsupplyLimit = 6000;
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("CNP PETS", "CNP PETS Official")  {
    seturi(_uri);
...
// ================== Mint Functions Start =======================
  ...
  function OGMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
    ...
    require(totalSupply() + _mintAmount <= ogsupplyLimit, 'Max supply exceeded!');
    require(ogMintCount[msg.sender] + _mintAmount <= ogmaxLimitPerWallet, 'Max mint per wallet exceeded!');
...
// supply limit
  ...
  function setogsupplyLimit(uint256 _ogsupplyLimit) public onlyOwner {
    ogsupplyLimit = _ogsupplyLimit;
  }    
