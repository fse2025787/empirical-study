...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    } //telegram https://t.me/MiyamotomusashiErc 
}     // 
...
contract MiyamotomusashiErc  is Context, IERC20, Ownable {
    ...
    string private constant _name = "@MiyamotomusashiErc";
    string private constant _symbol = "$Miyamoto";
