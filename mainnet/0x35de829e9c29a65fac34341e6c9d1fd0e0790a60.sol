...
contract LPTokenProcessorV1 is ILPTokenProcessor, KeeperCompatible, AccessControlEnumerable {
    ...
    function _removeLiquidity(address lpTokenAddress, address routerAddress) private {
        ...
        router.removeLiquidity(token0, token1, lpBalance, 0, 0, address(this), block.timestamp);
        ...
        if (FLOKI != address(0)) {
            ...
            bool success = _swapTokens(USDT, burnShare, FLOKI, BURN_ADDRESS, routerAddress);
