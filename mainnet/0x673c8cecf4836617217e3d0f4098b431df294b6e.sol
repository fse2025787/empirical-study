...
contract MultiChainCapital is Context, IERC20, Ownable {
  ...
  string private _name = 'MCC2.0';
  string private _symbol = 'MCC2.0';
  ...
  constructor() {
    _TeamWalletAddress = payable(0x4B961574C5c21755351082e815d7cCa4dCeB4C0D);
    _marketingWalletAddress = payable(0x4B961574C5c21755351082e815d7cCa4dCeB4C0D);
  ...
  function sendETHToTeam(uint256 amount) private {
    _TeamWalletAddress.call{ value: amount.div(2) }('');
