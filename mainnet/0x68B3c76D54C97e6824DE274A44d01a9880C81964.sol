...
September's CPI is 8.2%. This should be causing more FUD in the markets, but we are degens, so let's fucking RESHAPE the meaning of FUD:

🖕 $FUD - Fuck teh Unnecessary Dollar 🖕

We need no dollar doing well to thrive, send $FUD now.

https://t.me/fuckunnecessarydollar
...
contract FUD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fuck teh Unnecessary Dollar";
