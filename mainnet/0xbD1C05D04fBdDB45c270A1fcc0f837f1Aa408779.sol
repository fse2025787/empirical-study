...
//   / ____/___ _____ _   ______ ______   / /_  __  __   / //_/(_)___ ___  (_) /______ 
//  / /   / __ `/ __ \ | / / __ `/ ___/  / __ \/ / / /  / ,<  / / __ `__ \/ / //_/ __ \
// / /___/ /_/ / / / / |/ / /_/ (__  )  / /_/ / /_/ /  / /| |/ / / / / / / / ,< / /_/ /
// \____/\__,_/_/ /_/|___/\__,_/____/  /_.___/\__, /  /_/ |_/_/_/ /_/ /_/_/_/|_|\____/ 
//                                           /____/                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf5fFc159695bbf42564EDb06Ce237b30F482dDcD];
  address public erc20Payable = 0xf5fFc159695bbf42564EDb06Ce237b30F482dDcD;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 324) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib77mgflhncnkfu56nvxp3qznnwg6ij5ebr2rpfn5zt4g65fhdffy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/S5DoIjgttVMKF64HqIXL/contract-metadata";
  }
...
// File: contracts/CanvasbyKimikoContract.sol
//

pragma solidity ^0.8.0;

contract CanvasbyKimikoContract is RamppERC721A {
    constructor() RamppERC721A("Canvas by Kimiko", "CBK"){}
}
