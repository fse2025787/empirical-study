...
contract OYGB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Once You Go Black", "OYGB") {
        ...
        devWallet = 0x80232841D8b529195Bd0EcE145c5818F0e8Fb31a; // set as dev wallet
        ...
        */
        ...
        _mint(msg.sender, 1 * 1e8 * 10 ** _decimals);
