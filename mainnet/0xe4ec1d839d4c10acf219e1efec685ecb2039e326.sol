...
Three-leg Crow (YATAGARASU)

TG:  https://t.me/YatagarasuErc20
WEB: https://yatagarasu.webflow.io/
*/
// 
...
contract YATAGARASU is ERC20, Ownable {
    ...
    string constant _name = "Three-leg Crow";
    string constant _symbol = "YATAGARASU";
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 49; 
    bool inSwap;
