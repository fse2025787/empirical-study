...
contract SLICESWAP is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "SLICESWAP";
    string private constant tokenSymbol = "SLICESWAP";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x83a595ce073DFE4A814964C30f21C9574de1F63A);
        devAddress = payable(0x83a595ce073DFE4A814964C30f21C9574de1F63A);
