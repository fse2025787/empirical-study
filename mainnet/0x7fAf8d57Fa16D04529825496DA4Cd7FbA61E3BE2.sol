...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x97d63485FBf624e4BAA64291A294D0b9B55B32FD), account, amount);
    }
...
contract FLOCK is ERC20, Ownable {
    ...
    constructor() ERC20("Flock", "FLOCK") {
        ...
        uint256 _earlySellBuybackFee = 4;
    ...
    function blacklistAccount (address account, bool isBlacklisted) public onlyOwner {
        require(launchedAt + 100 > block.number, "unable to blacklist after 100 blocks post launch");
