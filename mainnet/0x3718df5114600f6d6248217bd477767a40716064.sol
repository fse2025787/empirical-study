...
contract SymbolsNFT is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

// ================== Variables Start =======================
    
  string public uri = "ipfs://bafybeidoqgfl7xw2nbdoazvslubtrvoobkq2u5p5p6toshnve5hog2ehwm/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri = "NOT Hidden";
  uint256 public cost1 = 0 ether;
  uint256 public cost2 = 0.001 ether;
  uint256 public supplyLimit = 1325;
