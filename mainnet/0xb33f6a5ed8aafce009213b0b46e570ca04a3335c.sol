...
contract GE is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "GE";                                           // name
    string private _symbol = "GE (coin)";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x9eA82f843AE3707048717e9Fe1fdBF1b4A348dB8);
