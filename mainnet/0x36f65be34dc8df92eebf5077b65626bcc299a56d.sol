...
contract liangxied is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "liangxied";
    string private _symbol = "liangxied";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEDA39403395011eC9A1e3eF6d72396DD7488EB36); 
    address payable public teamWalletAddress = payable(0xEDA39403395011eC9A1e3eF6d72396DD7488EB36); 
