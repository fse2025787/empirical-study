...
contract CelestialBodies is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcK6nfSXLJ3U8nLneqv6SxHJs2juGajmR2K1YCef5Zav4";
    ...
    constructor(
    ) ERC721A("Celestial Bodies by Gray Scaling", "Celestial Bodies", 100, maxSupply) {
    }
