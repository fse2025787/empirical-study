...
// Wander the Planes of Reality, Truth and Honesty...
...
contract HoroSha is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private _name = "Arhat";
    string private _symbol = "HoroSha";
