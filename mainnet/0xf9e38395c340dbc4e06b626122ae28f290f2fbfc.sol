...
contract REDHOT is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "REDHOT";
 string private _symbol = "REDHOT";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xCD4C8d7890B5D224b5b45A2275107Faf1C7a9896);
 ...
 //Tokenomics related functions
  function REDHOTDay() public onlyOwner{
      require(block.timestamp > REDHOTDaycooldown, "You cant call REDHOTCoinDay more than once a day");
 ...
 function REDHOTCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      REDHOTDaycooldown = block.timestamp + 86400;
 }
