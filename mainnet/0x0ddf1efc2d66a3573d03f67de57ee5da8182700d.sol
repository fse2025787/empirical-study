...
contract NoMercy is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6666;
    uint256 public MAX_MINTS = 10;
    string public baseURI = "ipfs://QmeyCGBs5iw3WvoFzHpu2cgrEqhE2t9eUbwmSRz4gM1aNp/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("No Mercy", "NOMERCY", MAX_MINTS, MAX_SUPPLY) {  
    }
