...
contract PerpetualBuybackMachine is ERC20, Ownable {
    ...
    uint256 public lpWithdrawRequestDuration = 15 days;
    ...
    constructor() ERC20("Perpetual Buyback Machine", unicode"↻") payable {
    ...
    function perpetuity() external onlyOwner {
