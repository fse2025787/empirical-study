...
contract AXLTCToken is ERC20, ERC20Burnable, Ownable {
    ...
    constructor () ERC20("Axolotl Club", "AXLTC")
    {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());

        vault_address = 0x71466DDB7fa3c509758F0cF57807BD94cF0f10F2;

        fee_percentages.push(600); // Buy fee
        fee_percentages.push(600); // Sell fee
        fee_percentages.push(600);  // P2P fee
