...
contract PEPEARMY is ERC721A {
    ...
    constructor() ERC721A("22nd pepe army", "PEPEARMY") {
        owner = msg.sender;
        royalty = 69;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmSCncffw1YczPXtcf5aDmAs4xsUq1sbkk3RbNS6e8BLXc/", _toString(tokenId), ".json"));
    }
