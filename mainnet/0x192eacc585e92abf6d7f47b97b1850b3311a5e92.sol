...
contract KawamuraTashiro is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x52180682f30C27758Fa1A933a1B72E3DA6BE80d8);
    ...
    constructor() ERC20("Kawamura Tashiro", "TASHIRO") {
        ...
        */
        _createSupply(owner(), 9999999999 * (10**9));
    }
