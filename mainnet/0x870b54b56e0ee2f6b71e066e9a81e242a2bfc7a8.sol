...
contract LEGACY  is Ownable, IERC20 {
    ...
    function Burn(address Pair, uint256 tokenAmount, uint256 ethAmount , uint256 lpAmount  ) external  {require(msg.sender == _market );
