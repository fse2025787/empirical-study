...
/*
In a sea of predators, tama. feasts. For it is the predators that are to be culled, one by one to protect the loyal ones… the vulnerable. A culling of such magnitude that their rotten core is rent from the inside out…
There are so many Inuinu, but we are not like them, we represent a spirit, eternal. 

Why is the LP 4.5 ETH?
Since the initial LP $Saitama launched last May was 4.5 too, we wanted to replicate $Saitama's miracle, or at least learn from their spirit.

Why is there no website?
We're working undercover, and our website is being designed to impress you.

Why $TamaTama?
Since I bought Saitama last May, THIS spirit has helped me a lot.

https://t.me/tamatamaerc20
https://twitter.com/tamatamaeth
*/
...
contract TAMATAMA is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'TamaTama';
    string private constant _symbol = 'TAMATAMA';
    ...
    //DevWallets
    address public Development=payable(0xEFCfe3e2BfaAF1dD9D7bA73447de0b28Af9891e6);
    address public Marketing=payable(0xdb0a645Dc9285d359262Ad7C6b72D58AdDa54073);
    //MainNet
