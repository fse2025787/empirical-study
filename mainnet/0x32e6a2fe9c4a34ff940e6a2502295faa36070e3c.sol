...
/***
 *     _    ___                                      ______  __   ____                            _             __     
 *    | |  / (_)________  ____  ____ ________  __   / __ ) \/ /  /  _/___  ____  ____  ____ ___  (_)___  ____ _/ /____ 
 *    | | / / / ___/ __ \/ __ \/ __ `/ ___/ / / /  / __  |\  /   / // __ \/ __ \/ __ \/ __ `__ \/ / __ \/ __ `/ __/ _ \
 *    | |/ / (__  ) /_/ / / / / /_/ / /  / /_/ /  / /_/ / / /  _/ // / / / / / / /_/ / / / / / / / / / / /_/ / /_/  __/
 *    |___/_/____/\____/_/ /_/\__,_/_/   \__, /  /_____/ /_/  /___/_/ /_/_/ /_/\____/_/ /_/ /_/_/_/ /_/\__,_/\__/\___/ 
 *                                      /____/                                                                         
 */
...
contract VisionaryByInnominate is Ownable, ERC721A, ReentrancyGuard {

    
    uint256 constant public MAX_SUPPLY = 321;
    

    uint256 public publicPrice = 0.03 ether;

    uint256 constant public MaxperTX = 1;
    uint256 constant public MAxPerPublic = 2;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri, string memory _hiddenMetadataUri) ERC721A("Visionary By Innominate", "VBYVITE") { }
  ...
  function setBaseURI(string memory _baseUri) public onlyOwner {
    ...
    function withdraw() external onlyOwner nonReentrant {
        (bool success, ) = msg.sender.call{value: address(this).balance}("0x6403C799e97f2EE222639765f3E55ae77E2e58E0");
