...
abstract contract LiquidityManagement is IMintyswapV3MintCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function addLiquidity(AddLiquidityParams memory params)
        ...
        returns (
            ...
            uint256 amount0,
            uint256 amount1,
            IMintyswapV3Pool pool
        )
    {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee});

        pool = IMintyswapV3Pool(PoolAddress.computeAddress(factory, poolKey));
...
interface IMintyswapV3PoolImmutables {
...
/// per transaction
interface IMintyswapV3PoolState {
...
interface IMintyswapV3PoolDerivedState {
...
interface IMintyswapV3PoolActions {
...
interface IMintyswapV3PoolOwnerActions {
...
interface IMintyswapV3PoolEvents {
...
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the mintyswap position
    struct Position {
    ...
    ) ERC721Permit('Mintyswap V3 Positions NFT-V1', 'MINTY-V3-POS', '1') PeripheryImmutableState(_factory, _WETH9) {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IMintyswapV3Pool pool = IMintyswapV3Pool(PoolAddress.computeAddress(factory, poolKey));
...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0x43217921bbb04fabc8c743fa538c897486d663f86b31754003da0ae10967a0bc;
...
library CallbackValidation {
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) internal view returns (IMintyswapV3Pool pool) {
