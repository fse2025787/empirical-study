...
Welcome to 🧸 ManBearPig 🐷, a deflationary meme token with tokenomics to set it off to the MOON on the Ethereum network!

✅ FUNDS ARE SAFE - Locked Liquidity and Renounced Ownership.
💪 Stake MANBEARPIG for passive income. Also, earn MANBEARPIG by simply holding with our reflect feature.
🚀 Fair Launch - Be first to the party by simply noticing us before we take off to the moon!
✍️ Whitepaper in progress - Staking will go public TONIGHT!
...
contract ManBearPig is Context, IERC20, Ownable {
    ...
    string private _symbol = 'ManBearPig🐷';
