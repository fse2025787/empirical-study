...
Green Eyed Monsters
$GEM
Portal: https://t.me/GEMportall
Website: http://gemnfts.io
Twitter: https://twitter.com/GEM_NFTs
Insta: https://www.instagram.com/gem_nfts
Discord: https://discord.gg/y94nsmg9

TOKENOMICS

Total Supply of 1 trillion
SUPPLY DISTRIBUTION
50% of the total supply is to be burned at launch, to a dead wallet.
4% of every transaction will be allocated to a marketing wallet.
3% of every transaction will be allocated to a liquidity wallet.
1% of every transaction will be allocated to holders of $GEM. 
2% of every transaction will be allocated to the DEV team
*/
...
contract GreenEyedMonsters is Context, IERC20, Ownable {
    ...
    uint256 public cooldown = 0 seconds;
    ...
    function antigenStatus(bool _state) public onlyOwner {
        _antigen = _state;
    ...
    function changeantigenTime(uint256 _time) public onlyOwner {
        cooldown = _time;
    }
    ...
    function _transfer(
        ...
        } else if (_antigen && to == uniswapV2Pair) {
            require(
                block.timestamp >= _lastBuyTime[from] + cooldown,
                "wait for next sell"
            );
        }
