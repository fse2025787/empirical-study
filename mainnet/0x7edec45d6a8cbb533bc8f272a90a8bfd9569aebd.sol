...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _totalMinted() internal view returns (uint256) {
        ...
        unchecked {
            ...
            return minted < StockholmBurn ? minted : StockholmBurn;
        }
    }
    ...
    function _mint(
        ...
        if (_currentIndex >= StockholmBurn) {
...
contract BBQOGameStudio  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://";

    uint256 public immutable mintPrice = 0.002 ether;
    uint32 public immutable maxSupply = 4777;
