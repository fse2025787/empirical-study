...
- 100% Stealth Launch
- 7% Marketing Tax for Call Channels
- 3% Dev Tax for devs to stay for support
- 1% max tx


Website: TBD
Telegram: https://t.me/SlayBelleInu
*/
...
contract SlayBelleInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Slay Belle Inu";
    string private constant _symbol = "SLAYINU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x8526B41fb4a0c5F13774903C0CcB6a24408E8CD0);
        _feeAddrWallet2 = payable(0x8526B41fb4a0c5F13774903C0CcB6a24408E8CD0);
