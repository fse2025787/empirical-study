...
contract Tsuru is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Tsuru";
    string private constant _symbol = "TSURU";
    ...
    address payable private _developmentAddress = payable(0x342890F6f7287402D583b9d2c8D794E6356987Dd);
    address payable private _marketingAddress = payable(0x031f4570De0b8a4db06a5F789B35A019103A21F7);
    ...
    function setBotFees() private {
        ...
        _redisFee = _previousredisFee * _botIncreaseFee;
    ...
    //Set AntiWhaleEnabled
    function setAntiWhaleEnabled(bool _antiwhaleEnabled) public onlyOwner {
