...
/**
 * Brown Doge is a community-driven memecoin launched on Ethereum blockchain.
 * Contract name: Brown Doge
 * Symbol: BDOGE
 * Decimals: 9
 * Total supply: 1000000
 *
 * Website: https://browndoge.space/
 * Telegram: https://t.me/BrownDoge_ETH
*/
...
contract BrownDoge is ERC20, Ownable {
    ...
    string private constant _name = "Brown Doge";
    ...
    constructor() ERC20(_name, _symbol, _decimals) {
        ...
        // Set buy marketing fee
        uint256 _buyMarketingFee = 4;
        // Set buy liquidity fee
        uint256 _buyLiquidityFee = 0;

        // Set sell marketing fee
        uint256 _sellMarketingFee = 21;
        // Set sell liquidity fee
        ...
        marketingWallet = address(0x4de17261c8c4d467e2656B78bEb650A626a9cCF2);
    ...
    /**
     * @dev Remove limit in effect.
     */
    function removeLimitsInEffect() external onlyOwner returns (bool) {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
        require(
            newAmount >= ((totalSupply() * 1) / 100000) / 10**_decimals,
            "Swap amount cannot be lower than 0.001% total supply."
        );
        require(
            newAmount <= ((totalSupply() * 5) / 1000) / 10**_decimals,
    ...
    /**
     * @dev Update max wallet and max Txn amount.
     */
    ...
    /**
     * @dev Update Buy fee and Sell fee.
     *
     * Total buy fee can't be more than 20%
     * Total sell fee can't be more than 20%
     */
    function updateFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) external onlyOwner {
        require(_buyMarketingFee + _buyLiquidityFee <= 20, "Must keep fees at 20% or less");
        require(_sellMarketingFee + _sellLiquidityFee <= 20, "Must keep fees at 20% or less");
        buyMarketingFee = _buyMarketingFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee;
    ...
    function updateMarketingWallet(address newWallet) external onlyOwner {
        ...
        require(newWallet != deadAddress, "Fee Address cannot be dead address");
