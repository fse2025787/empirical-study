...
contract PossessedGoblins is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Possessed Goblins", "GOB") {
        setBaseURI("");
    ...
    function UnleashTheFree(uint256 _mintAmount) public payable nonReentrant{
    ...
    function UnleashThePossessed(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
    ...
    function GiftThePossessed(uint256[] calldata quantity, address[] calldata recipient)
        external
        onlyOwner
    {
        require(
