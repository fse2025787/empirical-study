...
15% of each buy/sell goes into multi-chain farming to add to the treasury and buy back MCC tokens.


Telegram:
https://t.me/Mongoosechaincapital
...
contract MongooseChainCapital is Context, IERC20, Ownable {
  ...
  string private _name = 'MongooseChainCapital';
  ...
  function _setTaxFee(uint256 taxFee) external onlyOwner {
    require(taxFee <= 10, 'taxFee should be in 0 - 10');
    _taxFee = taxFee;
  }

  function _setTeamFee(uint256 teamFee) external onlyOwner {
    require(teamFee <= 10, 'teamFee should be in 0 - 10');
    _teamFee = teamFee;
  }
  ...
  function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
    require(
      maxTxAmount >= 21034500000000000000,
      'maxTxAmount should be greater than 21034500000000000000'
    );
