...
The Visitors arrived. Their mission was the swift and total conquest of Earth. 
Although they were armed with superior intelligence and technology, The Visitors quickly met their match. 
A never-ending diet of pop culture garbage from the dumpster of humanity swiftly disarmed the invaders. 
Too lazy and mindless to fulfill their mission, The Visitors are now cursed to share GIFs and 
memes with each other until the end of time. empowering them to emerge in Web3 and beyond. 
...
Website : https://aialien.xyz
Telegram : https://t.me/AIAlienToken
...
contract AIAlien is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI ALien";
    ...
    uint256 private _maxWalletAmount = 20_000 * 10**9;
