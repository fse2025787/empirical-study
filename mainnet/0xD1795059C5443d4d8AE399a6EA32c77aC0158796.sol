...
interface IStaking {
    function checkTokenStakedPeriodForUser(uint256 _tokenId, address _user)
        external
        view
        returns (uint256);
    ...
    UUPSUpgradeable
{
    ...
    // get unclaimed books
    function getUnclaimedBooks(uint256[] memory nfts_)
        public
        view
        returns (uint256[] memory)
    {
    ...
    function claimMaterial(uint256 _nftId, uint256 _meterial)
        public
        whenNotPaused
    {
        // clamin non book nft
    ...
    function claimMaterials(uint256[] memory _nftIds, uint256 _meterial)
        public
        whenNotPaused
    {
        // clamin non book nft
    ...
    function fissionReactor(uint256 _amount) public whenNotPaused {
        ...
        tokenAddress.transferFrom(msg.sender, address(this), _amount * 10**18);
