...
abstract contract ERC20Rebaseable is ERC20, Recoverable {
    ...
    function fragmentsPerToken() public view virtual returns(uint256) {
        return _totalFragments / totalSupply();
    }
    ...
    SwapHelper(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)
{
    ...
    constructor() ERC20("InuVerseToken", "IVT", 9, 1_000_000_000_000 * (10 ** 9)) ERC20Feeable() {
    ...
    function initializer() external onlyOwner payable {
        ...
        treasury = address(0xF865eeea3e1871429a871e4acFc1d4c20553E07F);
        ...
        fbl_feeAdd(TransactionState.Buy,    200, "buy fee");
        fbl_feeAdd(TransactionState.Sell,   1200, "sell fee");
