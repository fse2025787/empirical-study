...
/**
   It's just a matter of time when Do will drop a soap.
   🧼                                               🧼
*/
...
contract SlipperyKwon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Slippery Kwon";
    string private constant _symbol = "SOAP";
