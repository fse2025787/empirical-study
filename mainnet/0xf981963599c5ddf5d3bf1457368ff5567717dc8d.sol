...
//IVYBEARS WILL SELL OUT AND FLIP IVY BOYS
/**
...
contract IVYBEARS is Ownable, ERC721A {

    uint256 public adoptionLimit =100;
    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    string public baseURI = "ipfs://QmVuK3VbXQqVVUrttVt33qTmvpjrG63G8BpbghcKjSLyv8/";
    string public _extension = ".json";
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 5555;

    constructor() ERC721A("IVY BEARS", "IVYBEARS"){}
