...
// Twitter @ValhallaApes
// Twitter @ValhallaApes
// Twitter @ValhallaApes


// 
// File: contracts/ValhallaApes.sol
...
contract ValhallaApes is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeiaujhx6kqxrnwmxcyxbt3aldlh6r5xyxofqizig5akswgdr636ka4/";
    uint   public price             = 0.0033 ether;
    uint   public maxPerTx          = 10;
    uint   public maxPerFree        = 1;
    uint   public maxPerWallet      = 31;
    uint   public totalFree         = 9000;
    ...
    constructor() ERC721A("Valhalla Apes", "ValhallaApes"){}
