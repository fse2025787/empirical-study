...
contract Bored90sGang is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_ELEMENTS = 8896;
    uint256 public PRICE = 175 * 10**15; // 0.175 ETH
    uint256 public PRESALE_PRICE = 1 * 10**17; //0.1 ETH
    uint256 public constant MAX_BY_MINT = 3;
    uint256 public constant MAX_BY_MINT_WHITELIST = 3;
    uint256 public MAX_RESERVE_COUNT = 300;
    uint256 public SALE_START = 1650798000; //Sunday, April 24, 2022, 07:00:00 EDT
    uint256 public PRESALE_START = 1650711600; // Saturday, April 23, 2022, 07:00:00 EDT
    ...
    event CreateBored90sGang(uint256 indexed id);

    constructor(string memory baseURI) ERC721("Bored 90s Gang", "BNG") {
        setBaseURI(baseURI);
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(total <= MAX_ELEMENTS, "All Bored 90s Gang NFT's are sold out");
    ...
    function presaleMint(uint256 _count) public payable preSaleIsOpen {
        ...
        require(_count <= MAX_BY_MINT_WHITELIST, "Maximum of 3 allowed per transaction.");
        require(
    ...
    function presalePrice(uint256 _count) public view returns (uint256) {
