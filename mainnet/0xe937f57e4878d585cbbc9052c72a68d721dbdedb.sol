...
contract tinytubbies is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("tiny tubbies", "ttub", maxMintAmountPerTx) {
  ...
  function mintTo(address _to, uint256 _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
