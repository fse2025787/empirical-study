...
// File: contracts/ChildrenOfOrion.sol
...
contract ChildrenOfOrion is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "";
  uint256  public  Max_Supply = 1700;
  ...
  ) ERC721A("The Children of Orion", "COO") {
