...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x8901ceAC9DD796a98DAa32e2fc55dC68fEcDA01A));
...
contract LobsterRavioli is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable private mktg = payable(0xE40588BA96bB24Dd46F03329411b990B497fb824);
    address payable private dev = payable (0xE40588BA96bB24Dd46F03329411b990B497fb824);
    ...
    constructor() ERC20("Lobster Ravioli", unicode"🦞🥟") {

        uint256 totalSupply = 100 * 1e6 * 1e18;
        
        maxTransactionAmount = totalSupply * 20 / 1000; // 3% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 70 / 100000; // 0.07% swap tokens amount
        maxWallet = totalSupply * 10 / 1000; // 3% Max wallet
    ...
    function _transfer(
        ...
        if(takeFee){
            if(tradingActiveBlock + 1 >= block.number && (automatedMarketMakerPairs[to] || automatedMarketMakerPairs[from])){
                ...
                tokensForLiquidity += fees * 9 / 99;
                tokensForRewards += fees * 1 / 99;
                tokensForOperations += fees * 80 / 99;
            }
    ...
    function swapBack() private {
        ...
        (success,) = address(dev).call{value: address(this).balance.div(2)}("");
        (success,) = address(mktg).call{value: address(this).balance.div(2)}("");
