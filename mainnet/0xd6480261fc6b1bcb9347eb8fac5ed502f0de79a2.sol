...
contract Google is Context, IERC20, Ownable {
    ...
    string private constant _name = "Google";
    string private constant _symbol = "GOOGLE";
    ...
    constructor () {
        _feeAddrWallet = payable(0x2fA276da94f82aDB41Ee82dbaf07a94ea9465E99);
