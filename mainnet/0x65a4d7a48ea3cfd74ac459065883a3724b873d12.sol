...
contract ElizabethPunks is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Elizabet hPunks", "Elizabeth Punks",100,10000){}

    function mint(uint256 qty) external payable
    {
        require(qty <= maxMintPerTx, "Limit Per Transaction");
        require(totalSupply() + qty <= maxMint,"Soldout");
