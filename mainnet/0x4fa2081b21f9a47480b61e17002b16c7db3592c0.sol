...
contract DBUYV2 is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 2000000000 * 10**9;
  string private _symbol = "DBUYV2";
  string private _name = "Doont Buy V2";
