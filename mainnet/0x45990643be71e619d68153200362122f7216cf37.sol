...
contract PURPLE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "PURPLE";
    string private constant _symbol = "PURPLE";
    ...
    address payable private _marketingAddress = payable(0x22c22d02B3bBBE51829f7A2c2396a670B79BD02d);
    ...
    uint256 public _maxTxAmount = 15000 * 10**9; //0.75
    uint256 public _maxWalletSize = 15000 * 10**9; //1.5
