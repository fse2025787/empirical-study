...
contract StanInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Stan Inu", "SINU") {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellTreasuryFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForDev += fees * buyTreasuryFee / buyTotalFees;
