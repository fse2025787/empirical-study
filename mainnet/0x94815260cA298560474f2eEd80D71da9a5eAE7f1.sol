...
interface ILlamaZoo{
  function getStakedTokens(address) external view returns (
...
contract LVMintProxy is Delegated, Merkle {
  ...
  constructor(){
    merkleRoot = 0x4c4f1d9a8fabd34408ec60b1f8eda80760881ae67dacc2772465b39919dc1ab1;
  }
    ...
    if(total == 0){
      if(address(llamaZoo) != address(0)){
        (
          ...
          uint128 silverBoosts,
          uint128 goldBoosts
        ) = llamaZoo.getStakedTokens(account);
        total += silverBoosts + goldBoosts;
      }
    }
