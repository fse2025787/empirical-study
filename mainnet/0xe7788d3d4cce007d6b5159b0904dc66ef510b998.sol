...
// ENCRYPT - Are You Worthy?

/**

MYHYHNYM QAY CJGGYCQBUY, MYHYHNYM VAYMY BQ OQEMQYR, MYHYHNYM  KJVA, MYHYHNYM QJ IYUYM HEFY HBOQEFYO. OYHKYM JCCSGQSO, OYHKYM OYCMYQSH

*/

// 

// 084 103 032 064 084 104 101 071 104 111 115 116 068 101 118
...
contract ENCRYPT is ERC20, Ownable {
    ...
    event JackpotWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("ENCRYPT", "NCRYPT") {
        ...
        uint256 _earlySellMarketingFee = 120;
	    uint256 _earlySellDevFee = 40;
 
        uint256 totalSupply = 7 * 1e9 * 1e18;
 
        maxTransactionAmount = totalSupply * 65 / 10000; // 0.65% maxTransaction amount.
        maxWallet = totalSupply * 65 / 10000; // 0.65% maxWallet amount.
        swapTokensAtAmount = totalSupply * 1 / 100000; // swap when contravt token balance reaches 0.001%
        ...
        marketingWallet = 0xE9234a61914A2eAbeC6D733d5d709961079251dD; // marketing wallet
        devWallet = 0x8247E5271266f6077b42e654b8dDAA761397971a; // original deployer
        Jackpotwallet = 0xc05009e88feA347eE9B338760dF15D40712a1E9b; // jackpot wallet used for lottery winnings
    ...
    function updateJackpotWallet(address newWallet) external onlyOwner {
        emit JackpotWalletUpdated(newWallet, Jackpotwallet);
        Jackpotwallet = newWallet;
    }
    ...
    function manualsend() external onlyOwner() {
        ...
        uint256 ethJackpot = ethMarketing.div(3).mul(1);
        ...
        if(ethJackpot > 0)
            payable(Jackpotwallet).transfer(ethJackpot);
    }
    ...
    function swapBack() private {
        ...
        uint256 ethForJackpot = ethForMarketing.div(3).mul(1);
        ...
        (success,) = address(Jackpotwallet).call{value: ethForJackpot}("");
