...
contract DW is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Degenerational Wealth";//
    ...
    address payable private _developmentAddress = payable(0xdE1144f131f86A3B6AcA04899294a50303A15143);//
    address payable private _marketingAddress = payable(0xdE1144f131f86A3B6AcA04899294a50303A15143);//
