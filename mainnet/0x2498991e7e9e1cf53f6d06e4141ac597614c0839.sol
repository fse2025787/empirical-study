...
contract ModAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "ModAI";
    ...
    uint256 private _maxTxAmount = 25_000_000 * 10**8;
    uint256 private _maxWalletSize = 25_000_000 * 10**8;
