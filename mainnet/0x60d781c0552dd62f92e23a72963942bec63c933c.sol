...
// File: contracts/half-ave-main.sol
...
contract HalfAve is Ownable, ERC721A, DefaultOperatorFilterer   {
    ...
    uint128 public maxSupply = 3500;

    bool public saleActive = false;

    constructor() ERC721A("Half Ave", "Half Ave") {}
    ...
    function mintForAddress(uint64 _mintAmount, address[] memory _receivers) public mintCompliance(_mintAmount) onlyOwner {
