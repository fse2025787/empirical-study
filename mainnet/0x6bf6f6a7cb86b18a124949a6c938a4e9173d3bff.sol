...
contract VoiceAI is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x00000000000000000000000);
    address payable private _marketingWalletAddress = payable(0x00000000000000000000000);
