...
contract FountainOfYouth is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fountain of Youth";//
    string private constant _symbol = "Ageless";//
    ...
    address payable private _developmentAddress = payable(0x31AD65930B558c69f733633a4151B117657Ec338);
    address payable private _marketingAddress = payable(0x0fA6253b5C8DD10c2775F7cEaBDd89136E1BDee4);
    ...
    uint256 public _maxTxAmount = 12300000 * 1e18; //
    uint256 public _maxWalletSize = 20000000 * 1e18; //
