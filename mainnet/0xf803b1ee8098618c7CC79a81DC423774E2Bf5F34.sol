...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 125;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 379) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRv11QY6xJuF29DGvGn1xkc4bzEj3Q9qgxh6EqkNbd5rV/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 379");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 379");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 379");
...
// File: contracts/DaydreamsNftContract.sol
//

pragma solidity ^0.8.0;

contract DaydreamsNftContract is RamppERC721A {
    constructor() RamppERC721A("Daydreams NFT", "DREAM"){}
}
