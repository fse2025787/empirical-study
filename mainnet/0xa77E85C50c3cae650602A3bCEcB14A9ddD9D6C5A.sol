...
contract BoredDogsToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _initialSupply = 200_000_000;

    string  private constant _name     = "Bored Dogs Token";
    string  private constant _symbol   = "BDT";
    uint8   private constant _decimals = 18;

    uint256 public _transactionFee = 2;
    address constant public _feeWallet = 0x0000000000000000000000000000000000000000;
    ...
    function _transfer(
        ...
        uint256 transactionFee = calculatePoolFee(amount);
    ...
    function setPoolFeePercentage(uint256 transactionFee) external onlyOwner() {
