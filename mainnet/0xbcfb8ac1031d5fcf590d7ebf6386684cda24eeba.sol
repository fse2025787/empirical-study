...
//  | |\/| |/ _ \ __/ _` | |    / _ \/ _ \/ __|
//  | |  | |  __/ || (_| | |___|  __/ (_) \__ \
//  |_|  |_|\___|\__\__,_|______\___|\___/|___/
//
...
contract MetaLeos is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public mainSaleStartBlock = 1;
    mapping(address => bool) public whitelisted;

    // MetaLeos
    // ML
    // https://storage.googleapis.com/nfts-888.appspot.com/collections/meta-leos/json/
    constructor(
        string memory _name,
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (whitelisted[msg.sender] && block.number < mainSaleStartBlock) {
    ...
    function isMainSale() public view returns (bool) {
        return block.number >= mainSaleStartBlock;
    }
    ...
    function reveal(string memory revealedUri) public onlyOwner {
        revealed = true;
        setBaseURI(revealedUri);
    }

    function setMainSaleStartBlock(uint256 _newMainSaleStartBlock) public onlyOwner {
        mainSaleStartBlock = _newMainSaleStartBlock;
    }
