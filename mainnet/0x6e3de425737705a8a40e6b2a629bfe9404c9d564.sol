...
contract LooksC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buymrktfee;
    uint256 public buyLiquidityFee;
    uint256 public buyDevFee;
 
    uint256 public sellTotalFees;
    uint256 public sellmrktfee;
    uint256 public sellLiquidityFee;
    uint256 public sellDevFee;
 
    uint256 public earlySellLiquidityFee;
    uint256 public earlysellmrktfee;
    ...
    constructor() ERC20("Looks Classic", "LooksC") {
        ...
        uint256 _buymrktfee = 6;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevFee = 0;
 
        uint256 _sellmrktfee = 6;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 0;
 
        uint256 _earlySellLiquidityFee = 0;
        uint256 _earlysellmrktfee = 8;
        ...
        buymrktfee = _buymrktfee;
        buyLiquidityFee = _buyLiquidityFee;
        buyDevFee = _buyDevFee;
        buyTotalFees = buymrktfee + buyLiquidityFee + buyDevFee;
 
        sellmrktfee = _sellmrktfee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellmrktfee + sellLiquidityFee + sellDevFee;
 
        earlySellLiquidityFee = _earlySellLiquidityFee;
        earlysellmrktfee = _earlysellmrktfee;
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlysellmrktfee, uint256 _earlySellDevFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForMarketing += fees * sellmrktfee / sellTotalFees;
            }
            // on buy
                ...
                tokensForMarketing += fees * buymrktfee / buyTotalFees;
            }
