...
contract DJEET is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Dont JEET";
    string private constant _symbol = "DJEET";
    ...
    uint256 private constant _tTotal = 69e21 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x647e7Ea2197a395Eea0A6522BfB0062593D0FC35);
    ...
    uint256 public _maxTxAmount = 69E19 * 10**9; //1% - 10000000000
    uint256 public _maxWalletSize = 138E19 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 1000 * 10**9; 
    uint256 public _minimumBuyAmount = 345E18 * 10**9 ; // 0.5%
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) external {
        require(_msgSender() == _marketingAddress);
        require(maxTxAmount >= 69e18 * 10**9, "Maximum transaction amount must be greater than 0.1%");
