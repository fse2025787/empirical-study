...
contract Ohta is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 20_000 * 10e18;
    uint256 public maxTxAmount = 50_000 * 10**18;
    uint256 public maxWalletAmount = 250_000 * 10**18;
    
    address public marketingWallet = 0xf3d39c78C88C433DF5f8397b100528408A6131BA;
    address public devWallet = 0xf3d39c78C88C433DF5f8397b100528408A6131BA;
    ...
    Taxes public taxes = Taxes(3,3,3);
    ...
    constructor() ERC20("Eyes of Almighty", "OHTA") {
