...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = 0x4785f0B147B57C2AC822C14A2a7e47060462d466;
...
contract Musashi is Context, IERC20, Ownable {
    ...
    string private _name = "Musashi";
    string private _symbol = "MUSA";
    ...
    address public charityWallet = 0xcCc1b6df60028F31E5e5Ce6EcA8E55FEd35c5883;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Temporarily remove fees to transfer to dead address and charity wallet
        _taxFee = 0;
        _liquidityFee = 0;
        _charityFee = 0;
        ...
        //Send transfers to charity wallet
        if (charityAmt > 0) {
            _transferStandard(sender, charityWallet, charityAmt);
        }
        

        //Restore tax, liquidity and Charity fees
    ...
    function afterPresale() external onlyOwner() {
        ...
        _maxTxAmount = 10000000000000 * 10**18;
        inSwapAndLiquify = true;
    ...
    function prepareForPresale() external onlyOwner() {
        ...
        _maxTxAmount = 100000000000000 * 10**18;
        inSwapAndLiquify = false;
    ...
    function setMaxTxAmount(uint256 maxTxAmt, uint256 decimal) external onlyOwner() {
        _maxTxAmount = maxTxAmt * 10**decimal;
    }
