...
contract Y_CODE is Ownable, ERC721A, DefaultOperatorFilterer {
  ...
  uint256 public MAX_PER_Transtion = 5; // maximum amount that user can mint
  uint256 public MAX_PER_Address = 10; // maximum amount that user can mint
  ...
  uint private reserve = 77;

  uint public status = 0; //0-pause 1-whitelist 2-public 

  constructor() ERC721A("Halfbreedz","Y-Code") {
    _baseTokenURI = "https://bafkreiczmv4ylaoqzgyzzih722pyjc6eppgo2cvp6blitxwwveiv4hoija.ipfs.nftstorage.link/";
  ...
  function giveaway(address a, uint q)public onlyOwner{
    ...
    require(q <= reserve, "quantity exceeds reserved");
    _safeMint(a, q);
    reserve -= q;
  }
