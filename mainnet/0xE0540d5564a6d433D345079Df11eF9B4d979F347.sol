...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1970;
    ...
    address immutable private _magic = 0x6EEf09B526d883F98762a7005FABD2c800DfCA44;
     ...
     */
    address immutable private _os_forbiden = 0x1E0049783F008A0085193E00003D00cd54003c71;
    function approve(address to, uint256 tokenId) public override {
        require(to != _os_forbiden, "OpenSea Forbidden");
    ...
    function setApprovalForAll(address operator, bool approved) public override {
        require(operator != _os_forbiden, "OpenSea Forbidden");
...
contract OpenSeaForbidden  is ERC721A, Ownable {
    ...
    constructor()
    ERC721A ("Open Sea Forbidden", "721OF") {
    }
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        require(totalSupply() + amount <= maxSuppy, "sold out");
