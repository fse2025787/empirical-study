...
() {_____}
  ...
  {  `-'  } 
   ...
   TG: https://t.me/santatoshinakamotoerc20
...
contract SANTATOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santatoshi Nakamoto";
    string private constant _symbol = "SANTATOSHI";
    ...
    uint256 private _maxTxAmount = 3_500_000 * 10**9;
