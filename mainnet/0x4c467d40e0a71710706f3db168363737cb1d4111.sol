...
// GreenChain Finance will bring prosperity to its holders
// $GreenChain Token is a decentralized deflationary token that aims to bring multiple aspects together to create stability in the ecosystem and economy. EcoSafe Finance will bring prosperity to its holders. Buy now and hold for your future.

// Every sell and buy transaction is taxed a 6% fee:
// 2% redistributed to holders
// 2% of token will be added into the liquidity pool
// 1% for marketing wallet
// 1% Fundraising For ecological needs

// ✅ Useful links:
// ✅ Telegram: https://t.me/greenchain_exchange
// ✅ Website: https://greenchain.exchange/
...
contract GreenChain is Context, IERC20, Ownable {
    ...
    string private _name = 'GreenChain.exchange/';
    string private _symbol = 'GreenChain';
