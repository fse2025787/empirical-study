...
// File: contracts/governance/GROToken.sol
...
contract GROToken is Constants, ERC20, Ownable {
    ...
    uint256 public immutable INFLATION_START_TIME; // Timestamp to start inflation
    // GRO token inflation is defined by inflation rate / on year seconds, where inflation rate can be 
    ...
    uint256 public constant ONE_YEAR_SECONDS = 31556952; // average year (including leap years) in seconds
    ...
    constructor(
        ...
        INFLATION_START_TIME = block.timestamp + nonInflationPeriod;
    ...
    function setInflationRate(uint256 rate) public onlyOwner {
        ...
        if (currentTime > INFLATION_START_TIME) {
    ...
    function mint(address account, uint256 amount) external {
        require(msg.sender == minter, "mint: !minter");
