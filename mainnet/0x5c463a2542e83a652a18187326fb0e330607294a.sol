...
contract UpgradeNFT is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function __ChangeAttr_init(
        uint256 _nameChangePrice,
        uint256 _bioChangePrice
    ) internal initializer {
        setNameChangePrice(_nameChangePrice);
        setbioChangePrice(_bioChangePrice);
    }
    ...
    function setbioChangePrice(uint256 _bioChangePrice) public onlyOwner {
