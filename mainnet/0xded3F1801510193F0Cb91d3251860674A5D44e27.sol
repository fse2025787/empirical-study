    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmZX3iPctC7k3Gs3adwk2Nw6wK622FvbCW8EmHKp4Jwa1Q/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 800");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 800");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 800");
...
// File: contracts/AntarticansContract.sol
//

pragma solidity ^0.8.0;

contract AntarticansContract is RamppERC721A {
    constructor() RamppERC721A("Antarticans", "ICE"){}
}
