...
contract FairXYZDeployer  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmWwvTCSU9z14HxQJe3X4U626HQh3RDKaT94fCaRfv19TT/";

    uint256 public immutable mintPrice = 0.009 ether;
    uint256 public immutable minDonate = 0.008 ether;
    ...
    constructor()
    ERC721A ("BBQ Unreal  Game Station", "BBQ") {
    }
