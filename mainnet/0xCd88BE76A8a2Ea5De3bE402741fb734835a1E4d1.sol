...
contract UniswapPrice {
    ...
    address private constant USDC_ETH_ADDRESS = address(0xB4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc);
    address private constant ETH_BEAN_ADDRESS = address(0x87898263B6C5BABe34b4ec53F22d98430b91e371);
    ...
    function getUniswapUSDValue(uint256[2] memory balances, uint256[2] memory rates) private pure returns (uint) {
        return (balances[0].mul(rates[0]) + balances[1].mul(rates[1])).div(1e6);
    }
