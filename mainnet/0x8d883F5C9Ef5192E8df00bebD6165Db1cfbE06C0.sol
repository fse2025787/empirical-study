...
//*********************************************************************//
//
//    / __ \(_)  _____  / /___ _/ /____  ____/ /  / __ \___  ____ ____  ____ 
//   / /_/ / / |/_/ _ \/ / __ `/ __/ _ \/ __  /  / / / / _ \/ __ `/ _ \/ __ \
//  / ____/ />  </  __/ / /_/ / /_/  __/ /_/ /  / /_/ /  __/ /_/ /  __/ / / /
// /_/   /_/_/|_|\___/_/\__,_/\__/\___/\__,_/  /_____/\___/\__, /\___/_/ /_/ 
//                                                        /____/             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x92BdA736aD0c8be95e0a0930d840e8da198Be041];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 8888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiafvkjvmgiswii2zn75edidbnfjpbkwejvl2tkxahrmexhcifcd2e/";
...
// File: contracts/PixelatedDegensContract.sol
//

pragma solidity ^0.8.0;

contract PixelatedDegensContract is RamppERC721A {
    constructor() RamppERC721A("Pixelated Degens", "PLD"){}
}
