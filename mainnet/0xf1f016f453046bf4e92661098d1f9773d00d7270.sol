...
contract MainDex is Ownable, DexStorage {
  ...
  function init() public {
    ...
    XNFT = INFT(0x54994ba4b4A42297B3B88E27185CDe1F51DcA288); 
    // OldNFTDex = IERC20(0xc2F19E2be5c5a1AA7A998f44B759eb3360587ad1); //not-in-use
    // ALIA = IERC20(0x8D8108A9cFA5a669300074A602f36AF3252B7533); //not-in-use
    collectionConfig = true;
    admin=0xcfd872E3E8FB719EBEce7e872eD5DC287BB1E329;
    // LPAlia=LPInterface(0x52826ee949d3e1C3908F288B74b98742b262f3f1); //not-in-use
    LPBNB=LPInterface(0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852); //LPETH
    // nonCryptoNFTVault = 0x61598488ccD8cb5114Df579e3E0c5F19Fdd6b3Af; //not-in-use
    platform = 0x9c427ea9cE5fd3101a273815Ff8530f2AC75Db37;
    // authorVault = 0xF0d2D73d09A04036F7587C16518f67cE622129Fd; //not-in-use
    platformPerecentage = 25;
    countCopy = 0;
    ownerInit();
   factory = IFactory(0x53a5a2eaA5794384384dD990555c2B8fBE195D14);
   _supportNft[0x54994ba4b4A42297B3B88E27185CDe1F51DcA288] = true;
   emit CollectionsConfigured(0x54994ba4b4A42297B3B88E27185CDe1F51DcA288, 0x53a5a2eaA5794384384dD990555c2B8fBE195D14);
    BUSD = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    BNB= IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    _supportNft[address(this)] = true;
    
    a = 0x61598488ccD8cb5114Df579e3E0c5F19Fdd6b3Af;
