...
The $Mission failed, you have not trusted the process and it shows. 
The Counsel has been formed and we are rebuilding. 
I have chosen to stay anonymous but have summoned community leaders to lead our fight. 
Expect us.


https://t.me/TheCounselPORTAL
...
contract TheCounsel is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Counsel";//
    ...
    address payable private _developmentAddress = payable(0x202C262F6334D6E728B1D2092E1D40C8814C287d);//
    address payable private _marketingAddress = payable(0x1A18923Ca27E40BE2BcC592Aa5F56851f96DeCcF);//
