...
*/
contract D8aDaoGold is Initializable, ERC721AUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    */
    function withdrawBalance() external onlyOwner {
        ...
        uint256 quaterBalance = balance/4;

        uint256 wallet1Share = (quaterBalance / 100) * 14;
        uint256 wallet2Share = (quaterBalance / 100) * 8;
        uint256 wallet3Share = (quaterBalance / 100) * 16;
        uint256 wallet4Share = (quaterBalance / 100) * 18;
        uint256 wallet5Share = (quaterBalance / 100) * 7;
        uint256 wallet6Share = (quaterBalance / 100) * 15;
        uint256 wallet7Share = (quaterBalance / 100) * 22;
        uint256 wallet7Extra = quaterBalance * 3;
    ...
    */
    function initialize(string memory name_, string memory symbol_) public initializer {   
        ...
        TOKEN_PRICE = 8 ether;
        BASE_URI = "https://enefte.info/d8adao/metadata_gold.php?token_id=";
        saleOpens = 1668223320;
        saleCloses = 99999999999999;
        
        _dev[msg.sender] = true;
        _owner = msg.sender;
        _mint(address(0x2749Fa69c1f011b1a0164A01A35BEF781832d21D), 30);
