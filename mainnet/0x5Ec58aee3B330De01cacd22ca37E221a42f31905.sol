...
The Official World Cup 2022™  Token on the Ethereum Chain. We as fans of football wanted to create an online web3 betting community project for the fans of the World Cup 2022 in Qatar.
...
contract QATAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "QATAR WORLD CUP";
    string private constant _symbol = "QATAR";
