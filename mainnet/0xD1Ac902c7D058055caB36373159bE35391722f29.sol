...
/**
    ...
    The first official fork of SINs in a MEME!
...
contract HarumbleInuERC20Token is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    ERC20("Harumble Inu", "HRM", 9) 
    ERC20Permit("Harumble Inu") 
    {
        ...
        maxWallet = initialSupply * 40 / 1000;
