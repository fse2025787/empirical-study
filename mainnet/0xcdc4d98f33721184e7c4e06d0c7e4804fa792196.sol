...
SDI offers a range of AI based utilities. The first utility that is live pre-launch will be our custom automatic smart contract creator.

Why would this be useful?

The smart contract creator will be useful towards DeFi in many ways. 

Our customised smart contracts all require liquidity to be locked prior to launch, buy and sell taxes all required to stay at 10% or less. 


The aim of this Utility is to stop the amount of scam contracts being deployed on the Ethereum Blockchain & deploy some real legit proper contracts customised by our AI bot. 


Link to our website: https://SafuDevInu.site

Telegram Link: Https://t.me/SafuDevInu

Smart Contract Maker: https://classic.safudev.io/
...
contract SAFUDEVINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Safu Dev Inu";
    string private _symbol = "SDI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x5db85408a262712107C7e90D242d4Ae03ddc64B6);
    address payable private taxWallet2 = payable(0x5db85408a262712107C7e90D242d4Ae03ddc64B6);
