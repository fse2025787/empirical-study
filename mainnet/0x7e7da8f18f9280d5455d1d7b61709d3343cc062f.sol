...
contract TheTaiwanese_NFT is ERC721A, Ownable, ReentrancyGuard { 
    
    using Strings for uint256;

    uint256 public _maxSupply = 1999;
    uint256 public _mintPrice = 0.01 ether;
    uint256 public constant _maxMintPerTx = 10;
    ...
    constructor(string memory initBaseURI) ERC721A("TheTaiwanese_NFT", "Taiwan") {
    }
    ...
    function mint(uint256 count) external payable {
        ...
        uint256 mintedSoFar = _mintedFreeAmount[msg.sender];
