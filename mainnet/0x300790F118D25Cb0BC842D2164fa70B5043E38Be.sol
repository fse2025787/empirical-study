...
contract CAArtistKataKiss is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    // NFT Coonfiguration
    uint256 private _nftSupply =  50;                                           // how many nfts
    uint256 private _reservedSupply = 0;                                        // how mant are reserved
    uint256 private _forSaleSupply = 50;                                        // how many available for sale
    ...
    string private _preRevealURI = "QmPpSGi91JwbZ3D4dRZrbX2x2LFofkW66ynpFKkiJc7RdC";    // TODO switch for live

    string public _provenanceHash;                                               // provanace proof 
    string public _artistName = "Kata Kiss";                                            // artist name
    ...
    constructor() ERC721("CAArtistKataKiss", "CAKATA") {
