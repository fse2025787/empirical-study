...
/**
 * @title RstToken
 * @dev The RstToken contract inherits the ERC1404 security token contract.
 * Transacting abilities are managed through a whitelist. The whitelist is managed by owner and delegators
 * manage the list".
 */
contract RstToken is ERC1404, Managed {
    ...
    constructor () public ERC20("Realio Security Token", "RST"){
