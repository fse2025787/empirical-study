...
contract AETH_R10 is OwnableUpgradeSafe, ERC20UpgradeSafe, Lockable {
    using SafeMath for uint256;
    ...
    function burn(address account, uint256 amount) external {
        require(msg.sender == address(_bscBridgeContract) || msg.sender == owner() || msg.sender == address(_globalPoolContract), 'Not allowed');
