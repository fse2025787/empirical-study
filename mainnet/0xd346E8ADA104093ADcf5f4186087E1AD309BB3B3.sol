...
contract shibnaut is ERC20, Ownable {
    ...
    constructor() ERC20("Shibnaut", "SHIBN") {
        ...
        uint256 _sellOperationsFee = 99;

        uint256 totalSupply = 1_000_000_000 * 1e18;

        maxTransactionAmount = 1_000_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 2_000_000_000 * 1e18; // 2% max wallet at launch
        ...
        markWallet = address(0x1A9FB19df6465ccBE039f6073c181eaac4d841D8); 
        devWallet = address(0x1A9FB19df6465ccBE039f6073c181eaac4d841D8); 
        liqWallet = address(0x1A9FB19df6465ccBE039f6073c181eaac4d841D8); 
        operationsWallet = address(0x1A9FB19df6465ccBE039f6073c181eaac4d841D8);
