...
contract General is ERC20, Ownable {
    // Namings
    string private projectName = "Coin Inu Shard";
    string private tokenName = "SHRD";

    // Wallets
    address payable public devWallet = payable(0x73D002D4ED8d5346464cC4F90A01d78FC3Eaf047);
    address public marketingWallet = address(0x73D002D4ED8d5346464cC4F90A01d78FC3Eaf047);
