...
contract CustomSingleNativeOPool is NativeOPool {
    ...
    function withdrawFee(address _user) external payable onlyRouter {
        //check
        require(userInfo[_user].totalNFTpoint > 0,'Not Fee');
        ...
        //intaraction
        payable(_user).transfer(_totalStakeNFTfee);
    }
    ...
    {
        //check
        require(poolInfo.buyNum == 0 && poolInfo.sellNum == 0,"Not Change Time");
