...
contract  MiNiWORLDCUPINU is Context, IERC20, Ownable {
    ...
    string private _name = "MiNi WORLD CUP INU";
    string private _symbol = "MiNiWCI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x908B0dc3dF47430ec7B30e643F03208ac4Dc7Bb9));
        LLOOWalletAddre = payable(address(0x908B0dc3dF47430ec7B30e643F03208ac4Dc7Bb9));
