...
YOUNGYEEEZY / YOUNGYE / LETS BREAK BREAD TOGETHER / YE LOVES YOU / YEEEZY 

T.ME/YOUNGYEEZY / LETS GO BABY <3 
*/
...
pragma solidity ^0.6.12;
    ...
    contract YOUNGYEEZY is Context, IERC20, Ownable {
        ...
        string private _name = 'YOUNG YEEZY';
        string private _symbol = 'YE';
        ...
        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 11, 'charityFee should be in 1 - 15');
