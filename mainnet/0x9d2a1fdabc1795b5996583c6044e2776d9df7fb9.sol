...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x97d26f6E1E666d8f97a0Ad3E00f864d8617ff7e3,0x2c4dbdBed2D3102ef63229E59B02b44d12872eFc,0x737ceC5a949AC1d93Ce06a8c6fD2F98651e78622];
  uint256[] public payableFees = [5,70,18,7];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 6400 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNNFXMZSjuoAWqmTjYz2E84dEwjob8SkyAXVCckEZ5uha/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6400");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6400");
...
// File: contracts/X2022FootballPickEmnftContract.sol
//

pragma solidity ^0.8.0;

contract X2022FootballPickEmnftContract is RamppERC721A {
    constructor() RamppERC721A("2022 Football PickEM NFT", "22FBP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/4yCkSYJBUSJIhYwNeI8r/contract-metadata";
    }
}
