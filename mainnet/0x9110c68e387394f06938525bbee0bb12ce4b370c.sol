...
contract Solkasu23 is ERC20, Ownable {
    ...
    address payable public devWallet = payable(0x74ddaeaa983952c6E9b1457bDF28EC31486625CC);
    ...
    constructor() ERC20("Solkasu23", "Skasu") {
    ...
    string constant _name = "Solkasu23";
