...
https://twitter.com/cz_binance/status/1586431604729470976
...
contract HelloChang is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hello Chang Peng";
    string private constant _symbol = "HelloChang";
