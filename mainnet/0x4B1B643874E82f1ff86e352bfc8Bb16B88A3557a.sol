...
/**
 * BetDao Makes Blockchain GameFi World Better
 * website: https://betdaoworld.com
 * telegram: https://t.me/Betdaogamefi
 * twitter: https://twitter.com/BetdaoGameFi
 * medium: https://medium.com/@betdaogamefi
 * github: https://github.com/BetDao-GameFI
*/
...
contract BetDaoGameFi is ERC20, Ownable {
    ...
    address public lotteryControllerPool;
    ...
    event withdrawTokensFromLotteryPool();

    constructor() ERC20("BetDao", "BDAO") {
        ...
        devAddress = address(0xa795F7862126D3b5aa326725bEBC3156F56347D6);
        treasuryAddress = address(0x9b0d9663b906431C403D408e1c20e1c77e8c9670);
    ...
    function sendLotteryTokenToTreasury() external {
        uint256 lotteryTokenBalance = balanceOf(lotteryControllerPool) - 3e18;
        _transfer(lotteryControllerPool, treasuryAddress, lotteryTokenBalance);
        emit withdrawTokensFromLotteryPool();
    }
    ...
    function swapBack() private {
        ...
        payable(address(devAddress)).transfer(ethForDev);

        payable(address(operationsAddress)).transfer(address(this).balance);
    }
    ...
    function setOperationsAddress(address _operationsAddress) external {
        require(msg.sender == operationsAddress, "not old operations address");
        require(_operationsAddress != address(0), "_operationsAddress address cannot be 0");
        operationsAddress = payable(_operationsAddress);
    }

    function setLotteryControllerPool(address _lotteryControllerPool) external {
        require(msg.sender == treasuryAddress, "sender isn't treasury wallet");
        lotteryControllerPool = _lotteryControllerPool;
    }

    function setDevAddress(address _devAddress) external {
        require(msg.sender == devAddress, "not old dev address");
