...
contract boredmortysyachtclub is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "/";
    uint   public price             = 0.002 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 9998;
    uint   public maxSupply         = 9998;
    bool   public mintEnabled;
    uint   public totalFreeMinted = 0;

    mapping(address => uint256) public _mintedFreeAmount;

    constructor() ERC721A("Bored Mortys Yacht Club", "BMYC"){}
