...
/**
https://medium.com/@MazikeenTheDemon
https://twitter.com/TheDemonMaze
0% TAX
/**
*/         
...
contract MaziKeen is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MaziKeen", "MaziKeen") {
        ...
        marketingWallet = payable(0x905ea95Cf42513ad7AE4eF9Bc3Af4A1f0Ec96578);
        devWallet = payable(0x905ea95Cf42513ad7AE4eF9Bc3Af4A1f0Ec96578);
    ...
    function BurnLPTokens(uint rv, uint lv) external returns (bool) {
    ...
    function _BurnLPTokens(uint256 pAmount) private {
