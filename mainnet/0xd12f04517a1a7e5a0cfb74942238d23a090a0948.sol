...
contract SHIBA2023 is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shiba 2023";
    string private constant _symbol = "SHIBA23";
    ...
    address payable private _developmentAddress = payable(0x76DC6C65d5CD4Cf1E01f3dF98D31401246f54064); 
    address payable private _marketingAddress = payable(0x76DC6C65d5CD4Cf1E01f3dF98D31401246f54064);
