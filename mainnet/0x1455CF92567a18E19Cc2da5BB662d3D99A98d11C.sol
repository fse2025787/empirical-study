...
// Telegram : https://t.me/BabyShinuri


// Twitter : htpps://twitter.com/BabyShinuri
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaC92515589dBc525A4C652eed14E4C7246939Ba5;
        BSHIN[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal BSHIN;
    ...
    modifier SHIN1B() {
        require(isSHIN1B(msg.sender), "!SHIN1B"); _;
    }

    function isSHIN1B(address adr) public view returns (bool) {
        return BSHIN[adr];
    }
...
contract BabyShinuri is Context, IERC20, Ownable { 
    ...
    WALLETS dev , burn , none

    */


    address payable private Wallet_Dev = payable(0xaC92515589dBc525A4C652eed14E4C7246939Ba5);
    ...
    TOKEN DETAILS Token Nme : BabyShinuri  , Symbol : $BSHIN  , Supply : 1 billion

    */


    string private _name = "Baby Shinuri"; 
    string private _symbol = "$BSHIN";  
    ...
    uint256 public _sellFee = 1;  //Final Tax
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xaC92515589dBc525A4C652eed14E4C7246939Ba5] = true;
        _isExcludedFromFee[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true;  // Uniswap Address 
    ...
    */
    ...
    function NotMoreThen15(uint256 Buy_Fee, uint256 Sell_Fee) external SHIN1B() {
