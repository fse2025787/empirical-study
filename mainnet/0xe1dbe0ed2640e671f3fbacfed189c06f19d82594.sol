...
abstract contract TeamMembersUpgradeable is OwnableUpgradeable {
  ...
  function removeTeamMember(address _address) public onlyOwner {
    require(_address != address(0), "Invalid address");
    require(isTeamMember(_address), "This address is not in your team.");
...
abstract contract SignatureMintableUpgradeable is
  EIP712Upgradeable,
  TeamMembersUpgradeable
{
  ...
  SignatureMintableUpgradeable
{
  ...
  function __NFTArtGen_init(address _signerAddress, uint256 _commission)
    internal
    onlyInitializing
  {
    __ERC1155_init("");
  ...
  UUPSUpgradeable
{
  function initialize(address _signerAddress, uint256 _commission)
    ...
    initializer
  {
    __NFTArtGen_init(_signerAddress, _commission);
  }
