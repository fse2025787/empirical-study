...
contract TrumpTama  is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0x924254E860e948a040Dfe5444a59CFA9407Ab70c); // Dev Address
    address payable public liquidityAddress = payable(0x924254E860e948a040Dfe5444a59CFA9407Ab70c); // Liquidity Address
    ...
    string private constant _name = unicode"TrumpTama";
    string private constant _symbol = unicode"TTAMA";
