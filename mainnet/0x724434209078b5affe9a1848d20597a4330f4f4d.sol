...
// This will be a community coin
// Thor Inu (TINU)
// If you want to make a group, name it @ThorInuOfficial
// 2% Tax, 1% Liquidity Pool & 1% Reflections
// 2% Max Wallet
// Liquidity is locked for 1 Month
// https://etherscan.io/tx/0xf9d7fbcac98e69d652b2b70caa6cb6d35e2b854e731d03b584656b085183eb34
// The Contract is Renounced
// https://etherscan.io/tx/0xd20069a9097fdda9d60ea3cbe8719624ed14c668fa4ee49ac84faffb9d4ba77b
// The Liquidity Lock will be extended to 3 Months at 100k Market Cap
// At 500k Market Cap the Liquidity Lock will be extended to 1 year
// Liquidity will be locked forever at 2.5 Million Market Cap
// The fate of this coin is decided by you guys, do as you wish I will join the telegram group anonymously after it is created & make sure everything is done correctly. Good luck.
...
contract ThorInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Thor Inu";
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 2 / 1000;
