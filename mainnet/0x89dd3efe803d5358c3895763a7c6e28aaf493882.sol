...
/**
    ...
    Website: https://jokerinu.io/
    Twitter: https://twitter.com/jokerinu_
...
contract JokerInu is ERC20, Ownable {
    ...
    uint256 public buyRaffleFee;
    uint256 public buyLiquidityFee;
    uint256 public buyDevFee;
 
    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellRaffleFee;
    ...
    constructor() ERC20("JokerInu", "JOKERINU") {
        ...
        uint256 _buyRaffleFee = 2;
        uint256 _buyLiquidityFee = 2;
        uint256 _buyDevFee = 2;
 
        uint256 _sellMarketingFee = 5;
        uint256 _sellRaffleFee = 2;
        ...
        buyRaffleFee = _buyRaffleFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyDevFee = _buyDevFee;
        buyTotalFees = buyMarketingFee + buyRaffleFee + buyLiquidityFee + buyDevFee;
 
        sellMarketingFee = _sellMarketingFee;
        sellRaffleFee = _sellRaffleFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellMarketingFee + sellRaffleFee + sellLiquidityFee + sellDevFee;
