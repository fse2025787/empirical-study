...
Mark, Maintain, Marya $MMM

prestige, innovative dApp including heavily anticipated features to lock down security. Including (not limited to) Auto contract scan methodID’s to check validity of functions, Contract Blacklist mDAO to make sure you don’t purchase ill contracts, AI Method Model Training and MORE 
...
contract MMM is Context, IERC20, Ownable {
    ...
    string private constant _name = "MARYA";
    string private constant _symbol = "MMM";
    ...
    address payable private _developmentAddress = payable(0x112596ab71115B09b6Ac17680Ad450F3Ef81430c);
    address payable private _marketingAddress = payable(0x112596ab71115B09b6Ac17680Ad450F3Ef81430c);
