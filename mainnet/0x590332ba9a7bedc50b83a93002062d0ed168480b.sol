...
/*
`7MM"""Yp, `7MMF' `YMM' `7MM"""YMM   .g8"""bgd     `7MMF'                      
  MM    Yb   MM   .M'     MM    `7 .dP'     `M       MM                        
  MM    dP   MM .d"       MM   d   dM'       `       MM  `7MMpMMMb.`7MM  `7MM  
  MM"""bg.   MMMMM.       MM""MM   MM                MM    MM    MM  MM    MM  
  MM    `Y   MM  VMA      MM   Y   MM.               MM    MM    MM  MM    MM  
  MM    ,9   MM   `MM.    MM       `Mb.     ,'       MM    MM    MM  MM    MM  
.JMMmmmd9  .JMML.   MMb..JMML.       `"bmmmd'      .JMML..JMML  JMML.`Mbod"YML.
  ...
  `.      |  _.-'
     `.|__.-'                                                                                                                                                             
https://medium.com/@bkfcinu/bkfc-inu-86e5ab8dea03
https://twitter.com/BKFCInu
https://t.me/BKFCInuPortal
...
contract BKFCInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "BKFC Inu";
    string private _symbol = "BKFC";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xc093A75f347F5e1db12A618b5Ad73cf72d33AC9D);
    address payable public DeveloperWallet = payable(0xc0e67df227A387677f83FA64f9B97943227b6F1F);
