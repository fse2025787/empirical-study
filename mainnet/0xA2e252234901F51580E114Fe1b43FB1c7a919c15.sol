...
在日本，蓝龙是四城守护神之一，据说守护着东方的京都市。西为白虎，北为乌龟，南为朱雀，中为黄龙。京都有专门供奉这些守护神的寺庙。
京都东部的清水寺描绘了青龙。庙门前有一尊龙神像，据说是夜间从庙宇内的瀑布中喝水，因此每年都会举行祭祀东方龙的仪式。 1983年，在飞鸟村发现了Kitora的坟墓。
所有四个守护者都画在墙上（在相应的方向上），并在天花板上画了一个星座系统。这是四位守护者为数不多的古代记载之一。

在韩国，在平安南道乌岘里发现的高句丽古墓的壁画中，出现了青龙等四大象征的神话生物。[1]
...
contract BlueDragon is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Blue Dragon";
    string private _symbol = unicode"蓝色的龙";
