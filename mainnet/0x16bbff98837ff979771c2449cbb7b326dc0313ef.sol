...
contract Skoll is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Skoll", "Skoll") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        maxTransactionAmount = 15 * 10 ** 3 * 10 ** decimals(); // 1.5% maxTransactionAmountTxn
        maxWallet = 30 * 10 ** 3 * 10 ** decimals(); // 3% maxWallet
