...
contract Next is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Next Big Thing", "Next ") {

        uint256 totalSupply = 77 * 1e9 * 1e18;
        ...
        maxWallet = totalSupply * 40 / 1000; // 4% Max wallet
    	...
    	operationsWallet = address(0x103c97892B11578158baFf054F4f28B211C2dfd7); // set as operations wallet
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 950, "Must keep fees at 25% or less");
    }
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 950, "Must keep fees at 25% or less");
    }
