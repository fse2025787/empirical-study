...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      // Mainnet
      rewardTokens.push(address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48)); // USDC - Mainnet  0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
...
contract THEDISTRICT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private buybackburnWallet;
    ...
    constructor() ERC20("The District", "D82") {
        ...
        liquiditySellFee = 120;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee;

    	dividendTracker = new DividendTracker();
    	operationsWallet = address(0x4eFd1d32d52865299a38FeDCbF860A339763864B); // set as operations wallet
        developmentWallet = address(0x14e485DB7f0178Ae02A93f9fEbf3de8299eFbb02);
        buybackburnWallet = address(0xe57A300AE3e3C7AEe94cDA6AB23CB1966B707Fc1);
        projectWallet = address(0xD61C971E8483E934237DE5aAc8cc703e01325433);
        reserveWallet = address(0xb437eF4C46246f04E6C54fD183aEb656c4684459);
        ...
        excludeFromFees(buybackburnWallet, true);
        ...
        excludeFromMaxTransaction(buybackburnWallet, true);
        excludeFromMaxTransaction(projectWallet, true);
        excludeFromMaxTransaction(reserveWallet, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x62598ed094c6f7588Cc3f0E5c8D92EF0aeB9Ed3d),
            block.timestamp
        );
