...
Twit Shiba Cfief
Elon's n1 successor for twitter
...
contract TwitShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twit Shiba Chief";
    string private constant _symbol = "TwitShiba";
