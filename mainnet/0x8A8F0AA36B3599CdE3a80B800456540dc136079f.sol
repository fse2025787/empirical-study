...
Amazon Protocol (AMP) is the world's first Decentralized Advertisement and online payment token which enables developers, organizations, and entrepreneurs to make payments for advertisement, buy and sell goods and services online and on listening sites. AMP is the first workable token for advertisement to enjoy three properties simultaneously;

Telegram: https://t.me/AmazonProtocolOfficial
Website: https://amazonprotocol.netlify.app/
Twitter: https://twitter.com/AmazonProtocol?t=SmxGkI8wwbhRhF7GsaZYyw&s=09
**/
  ...
  contract AMP is Context, IERC20, Ownable {
      ...
      string private constant _name = "Amazon Protocol";
      string private constant _symbol = "AMP";
