...
Token Name: Legionnaires
Ticker: LEGION
Supply: 1,000,000
Tax: 4/4

The legion community is a DEFI Organization of DEGEN CHADS. 

Telegram: https://t.me/LegionnairesERC20
Twitter: https://twitter.com/Legion_Erc20
...
contract LEGION is Context, IERC20, Ownable {
    ...
    string private constant _name = "Legionnaires";
    ...
    uint256 private maxTxAmount = 100000 * 10**_decimals; 
    uint256 private maxWalletAmount = 200000 * 10**_decimals; 
    ...
    constructor () {
        ...
        MarketingWallet = payable(0x6207326F05B5eFb4bf914b1EC5E3151C6D529a55);
