...
contract QOMTAMA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "SAITAMA KILLER";
    string private constant _symbol = "QOMTAMA";
    ...
    address payable private _developmentAddress = payable(0x500832eB6bdc70221942bA89f1bCCca95F6Fbda8); 
