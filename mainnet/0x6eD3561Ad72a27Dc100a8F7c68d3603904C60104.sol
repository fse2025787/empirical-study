...
Paragraph: Web3-powered newsletters
...
contract Paragraph is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Pharagraph";

    string private _symbol = "PRH";
    ...
    uint256 private maxFeePercent = 10;
    /******************/
    ...
    address public taxAddress = 0x04Db387fB15a33244a47AC1cc4BACa03a745EC3a;
    ...
    uint256 public _totalSupply =  6000000000 * 10**_decimals;
    ...
    function updateBuyFees(
        ...
        require(buyTotalFees <= maxFeePercent, "must keep fees at 10% or less");
    }
    ...
    function updateSellFees(
        ...
        require(sellTotalFees <= maxFeePercent, "must keep fees at 10% or less");
    }    
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        uint256 fee = (amount * _tax) / 1000;
        _balances[sender] = _balances[sender].sub(amount);
        amount = amount.sub(fee);
        _balances[recipient] = _balances[recipient].add(amount);
        _balances[taxAddress] = _balances[taxAddress].add(fee);
