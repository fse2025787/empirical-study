...
Our goal is to utilize the strength of our community to deliver the most trending 2022 meme cryptocurrency across the whole world! 🌭🐶🚀

Sliding tax mechanism: starting at 9%, lowering every 30 minutes until it reaches 1%

Telegram: https://t.me/Dachshund_Inu
Twitter: https://twitter.com/dachshund_inu
Website: https://dachshundinu.dog/
...
contract DachshundInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dachshund Inu";
    string private constant _symbol = "DHUND";
    ...
    constructor () {
        _feeAddrWallet = payable(0x10f83Fb22008eA46e707D219e8b0946F234fd38e);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_taxes.buyFee2 > 1 && _taxes.sellFee2 > 1 && block.timestamp >= lastDecreasingTaxTime + decreasingTaxFrequency) {
    ...
    function getCurrentFees() external view returns (uint256, uint256, uint256, uint256) {
