...
contract WOLF is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10 * 10**5 * (10**9);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x9FFECCc6311E346013DC55f5d0523FAF6001bdA1); // Team Wallet
    address public _projectWalletAddress = address(0x9FFECCc6311E346013DC55f5d0523FAF6001bdA1); //Project Wallet
    ...
    constructor() ERC20("Sigma Coin", "WOLF") {
        ...
        buyFee.projectFee = 80; // 8% Project fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "WOLF: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "WOLF: The UniSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "WOLF: Automated market maker pair is already set to that value");
