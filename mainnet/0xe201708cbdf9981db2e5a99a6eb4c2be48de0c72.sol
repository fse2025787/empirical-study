...
/*
🔥WELCOME NITRO PANTHER🚀🚀

Nitro Panther is a project auto-staking token that had its ownership renounced and burn LP given to the community from the beginning of its creation.

🔥No Dev Wallets
🔥No Control Of Contract
🔥No Control of Liquidity
🔥Burn 3% of token for detail coming out
🚀 CG/CMC

Tg : https://t.me/NitroPhant
Twitter : https://twitter.com/nitro_panther
*/
...
contract NitroPanther is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nitro Panther"; //
    string private constant _symbol = unicode"NPanther"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x1287DFf4cFbe2079217716E805641639e4d1E0aB;
