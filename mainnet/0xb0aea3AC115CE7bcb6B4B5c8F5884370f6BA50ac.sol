...
contract XmasApeYachtClub is ERC721AQueryable, Ownable, DefaultOperatorFilterer {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(mintedWallet[_msgSender()] + _mintAmount <= maxMintAmountPerTx, "Max per wallet reached");
    _safeMint(_msgSender(), _mintAmount);
    mintedWallet[_msgSender()] += _mintAmount;
  }
