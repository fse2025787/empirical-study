...
SpaceX Dragon is a token based on the Ethereum Network (ERC20). With a strong community, we believe we can create a revolutionary token that is driven by an active community and token feature that can make all investors profit. We, SpaceX Dragon want to create a token that has a real project and can maintain investors security.

Telegram: https://t.me/SpaceXDragonPortal
Twitter: https://twitter.com/SpaceXDragon02
**/
  ...
  contract SpaceXDragonPortal is Context, IERC20, Ownable {
      ...
      string private constant _symbol = "SXD";
