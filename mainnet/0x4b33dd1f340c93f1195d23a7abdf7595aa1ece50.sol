...
contract Porsche is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "8BIT Porsche";
    string private constant _symbol = "$PRSCH";
    ...
    address payable private _developmentAddress = payable(0xBB3713cCb9965e6d1a73b8eBF9788Ba89D93762f); 
    address payable private _marketingAddress = payable(0xBB3713cCb9965e6d1a73b8eBF9788Ba89D93762f);
