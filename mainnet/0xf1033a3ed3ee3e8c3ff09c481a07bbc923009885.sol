...
contract Free is ERC20, Ownable {
    ...
    uint256 public timeBetweenSwaps = 3 minutes;
    ...
    constructor() payable ERC20("Free Speech", "FREE") {
    ...
    function taxesToZero() external onlyOwner {
        buyOperationsFee = 0;
        buyLiquidityFee = 0;
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyBurnFee;
    ...
    function updateCooldown(uint256 timeInMinutes) external onlyOwner {
        require(timeInMinutes > 0 && timeInMinutes <= 1440);
        swapCooldown = timeInMinutes * 1 minutes;
    }
