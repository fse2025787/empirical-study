...
//Are you always too scared to buy the dip ? We will do it for you.
...
contract FearFinance is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x629567B230b632EA390E2e015ABb3DCba68C6260); // Marketing Address

    address payable public liquidityAddress =
        payable(0x629567B230b632EA390E2e015ABb3DCba68C6260); // Liquidity Address
    ...
    string private constant _name = "FearFinance";
    string private constant _symbol = "FEAR";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 5 / 1000; // 1% max txn
        minimumTokensBeforeSwap = _tTotal * 3 / 10000; // 0.03%
        maxWallet = _tTotal * 5 / 1000; // 2%
        ...
        marketingAddress = payable(0x629567B230b632EA390E2e015ABb3DCba68C6260); //  update to marketing address
        liquidityAddress = payable(0x629567B230b632EA390E2e015ABb3DCba68C6260); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 20, "Must keep taxes below 15%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 20, "Must keep taxes below 20%");
    }
