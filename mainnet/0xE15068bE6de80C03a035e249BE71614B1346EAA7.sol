...
contract ApyFlow is ERC20, Ownable {
	 ...
	 */
	function recomputePricePerShareAndHarvestFee() public returns (uint256 actualPricePerShare)
	{
		uint256 _totalAssets = totalAssets();
        uint256 _totalSupply = totalSupply();
		...
		{
			uint256 oldTotalAssets = _totalSupply * lastPricePerShare / 10 ** decimals();
			...
			lastPricePerShare = pricePerToken();
