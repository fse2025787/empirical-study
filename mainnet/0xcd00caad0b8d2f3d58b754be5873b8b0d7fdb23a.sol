...
contract rich is ERC721A, Ownable {
    using Strings for uint256;

    uint256 MAX_MINTS = 2;
    uint256 MAX_SUPPLY = 1420;
    bool private paused = true;
    uint256 MAX_FREE = 1420;
    uint256 public mintRate = 0 ether;

    string public baseURI = "ipfs://rich/";

    constructor() ERC721A("you will be rich", "rich") {}
    ...
    function withdrawsplitter() external payable onlyOwner {
        ...
        address ad1 = 0xB9dcc48D7F97bacAfB958797A8c007Cd8fc78B7D;
