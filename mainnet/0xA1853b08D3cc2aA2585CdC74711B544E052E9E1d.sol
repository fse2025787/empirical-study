...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF2F173ECAf1B28eA450394e9e56d23ad2D3e2648];
  address public erc20Payable = 0xF2F173ECAf1B28eA450394e9e56d23ad2D3e2648;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 255) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidj7scsfwarybfmr3um5pd6tv2h6iz323dvr4hmzulbtnu3hpgriy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/24CE4gCzbcxNWyOiIPkv/contract-metadata";
  }
...
// File: contracts/TheSecretGroveContract.sol
//

pragma solidity ^0.8.0;

contract TheSecretGroveContract is RamppERC721A {
    constructor() RamppERC721A("The Secret Grove", "TSG"){}
}
