...
The cycle begins. $COMB is the 1st deflationary attachment token.

Any token can be added to $COMB's orbit and begin reducing their supply.

Mission: Allow all communities to become aware and add/enhance their deflationary and to become part of our ecosystem of new/current web3 projects.
...
contract COMBUSTION is Ownable {
    constructor(
        string memory _NAME,
