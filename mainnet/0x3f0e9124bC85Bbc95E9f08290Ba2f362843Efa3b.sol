...
contract ConvexStrategy2Token is IStrategy, BaseUpgradeableStrategy {
  ...
  function initializeBaseStrategy(
    ...
    BaseUpgradeableStrategy.initialize(
      ...
      _rewardPool,
      weth,
      220, // profit sharing numerator. It is 22% because we remove 10%
           // before conversion. So, (1 - 0.1) * (1 - 0.22) ~= 0.702, or 30% reduction
  ...
  */
  ...
  function finalizeUpgrade() external onlyGovernance {
    _finalizeUpgrade();
    setHodlVault(0x00d10Fe4b76cA47E4e5206A93F10205b9C0c42a2);
...
contract ConvexStrategyLinkMainnet is ConvexStrategy2Token {
  ...
  function initializeStrategy(
    ...
    ConvexStrategy2Token.initializeBaseStrategy(
      ...
      linkCurveDeposit,
      0x00d10Fe4b76cA47E4e5206A93F10205b9C0c42a2,
      1000
    );
