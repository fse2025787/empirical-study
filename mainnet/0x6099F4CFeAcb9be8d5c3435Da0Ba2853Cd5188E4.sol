    ...
    WhitelistUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        multiSigTreasury = 0x9D6D54dc7E2FDF018D94fbd71Ed23e49aE31639B; // Polygon
        /**
     ...
     */
    function setBridgeFee(uint256 percent) public onlyRole(ADMIN_eEUR) {
     ...
     * @dev set minimum percentage of bridge transaction fee
     */
    function setMinimumSentToChainAmount(uint256 amount) public onlyRole(ADMIN_eEUR) {
     ...
     */
    function setFeeTreasury(address account) public onlyRole(ADMIN_eEUR) {
        require(account != address(0), "Zero address");
     ...
     */
    function addSameToken(uint256 chainId, address token) public onlyRole(ADMIN_eEUR) {
    ...
    function removeSameToken(uint256 chainId) public onlyRole(ADMIN_eEUR) {
