...
contract JIZZAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "JIZZ AI";
    string private constant _symbol = "JIZZAI";
    ...
    address payable private _developmentAddress = payable(0x51f5680C930d142a9EE6A01306Ca785B0eA70b58); 
    address payable private _marketingAddress = payable(0x51f5680C930d142a9EE6A01306Ca785B0eA70b58);
