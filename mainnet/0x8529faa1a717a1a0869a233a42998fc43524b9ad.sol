...
/**
 ...
 ________  ________  ________          ________  ________      ________  ________      ___    ___ ________  _________  ________     
|\   ____\|\   __  \|\   ___ \        |\   __  \|\  _____\    |\   ____\|\   __  \    |\  \  /  /|\   __  \|\___   ___\\   __  \    
\ \  \___|\ \  \|\  \ \  \_|\ \       \ \  \|\  \ \  \__/     \ \  \___|\ \  \|\  \   \ \  \/  / | \  \|\  \|___ \  \_\ \  \|\  \   
 \ \  \  __\ \  \\\  \ \  \ \\ \       \ \  \\\  \ \   __\     \ \  \    \ \   _  _\   \ \    / / \ \   ____\   \ \  \ \ \  \\\  \  
  \ \  \|\  \ \  \\\  \ \  \_\\ \       \ \  \\\  \ \  \_|      \ \  \____\ \  \\  \|   \/  /  /   \ \  \___|    \ \  \ \ \  \\\  \ 
   \ \_______\ \_______\ \_______\       \ \_______\ \__\        \ \_______\ \__\\ _\ __/  / /      \ \__\        \ \__\ \ \_______\
    \|_______|\|_______|\|_______|        \|_______|\|__|         \|_______|\|__|\|__|\___/ /        \|__|         \|__|  \|_______|
                                                                                     \|___|/                                        
                                                                                                                                    
                                                                                                                                    
WE ARE ARES : GOD OF CRYPTO & WAR !

https://aresgodofficial.com/
https://t.me/Aresofficialgroup/
https://twitter.com/AresCryptoGod/
...
contract GODOFCRYPTO is ERC20, Ownable {
    ...
    uint256 public autoBuyBackFrequency = 86400 seconds;
    uint256 public lastAutoBuyBackTime;
    
    uint256 public percentForLPBurn = 100; // 100 = 1%
    bool public lpBurnEnabled = true;
    uint256 public lpBurnFrequency = 86400 seconds;
    ...
    constructor() ERC20("ARES", "ARES") payable {
                
        uint256 _buyMarketingFee = 0;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyBuyBackFee = 0;
        uint256 _buyDevFee = 0;
        // Total of 10% Sell Fee
        ...
        maxTxnAmount = totalSupply * 5 / 1000; // 0.5% of tsupply
        swapTokensAtAmount = totalSupply * 1 / 1000; // 0.1% of tsupply
    	...
    	marketingWallet = address(0x0A15bB2107Eb6Ea769AB3698Bf86f4D1A01620E5); // set as marketing wallet
        devWallet = address(0x3cf43e522586BFbcF79dD0908dE1917454af6Fb8); // set as dev wallet
        ...
        excludeFromFees(0x7972D04524E5d5b2Dc4290263C9844f0E81251Da, true); // future owner
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x7972D04524E5d5b2Dc4290263C9844f0E81251Da, true); // future owner
        ...
        */
        ...
        _createInitialSupply(0x000000000000000000000000000000000000dEaD, totalSupply*30/100);
        _createInitialSupply(0x7972D04524E5d5b2Dc4290263C9844f0E81251Da, totalSupply*70/100);
    }
