...
- Following Lobster Inu success Crab Inu is here!

 WE ARE COMMUNITY, WE WILL PROSPER
...
contract CrabInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "CrabInu";
    string private constant _symbol = "Crab";
