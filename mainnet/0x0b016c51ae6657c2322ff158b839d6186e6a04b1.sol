...
// Telegram : https://t.me/ApeCoinTwoPointZero

// Apecoin2.0 the next big meme coin 

// Apecoin2.0 will have 0% tax buy/sell

// max wallet will be 3% 

// max trx will be 3% 

// liq will be locked for 1 week

// at 50k marketcap we will extend the lock with 1 week

// for every 50k we go up we will extend the lock with a week
...
contract ApeCoinTwoPointZero is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ApeCoin2.0";
    string private constant _symbol = "APEZERO";
    ...
    address payable private _marketingAddress = payable(0x14e0ba844e5356B30Ba777E566B9ea84c2475b8e);
