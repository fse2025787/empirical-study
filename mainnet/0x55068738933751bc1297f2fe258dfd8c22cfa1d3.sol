...
contract CrazyMonke is ERC721A, Ownable {
    ...
    uint256 public maxSupply = 866;

    bool public mintEnabled = true;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Crazy Monke", "CM") {
        _safeMint(msg.sender, 1);
        setBaseURI("https://ipfs.io/ipfs/QmYpar93Xf5rEwsHSBfJhRxUhpCcsyLAvrw7DLayaFMtSF/");
    }
