...
/**
 * @title wordstobemusic1 contract
 */
...
contract wordstobemusic1 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("| wordstobemusic | - vol. #1", "| wordstobemusic |"){}
  ...
  {
    uint cost = price;
    require(msg.sender == tx.origin,"Be yourself, please.");
    require(msg.value >= amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more wordstobemusic...");
