...
contract Township is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "Township";
    string private constant _symbol = "APARTHEID";
    ...
    address payable private _developmentAddress = payable(0x599388FB26Ff301ED4464A7B77916D110d8A1dF6); 
    address payable private _marketingAddress = payable(0x599388FB26Ff301ED4464A7B77916D110d8A1dF6);
