...
/**
    Proof of Kiba ERC Token
    Twitter:  https://twitter.com/ProofofKiba
    Telegram: https://t.me/ProofOfKibaPortal
    Medium:   https://medium.com/@proofofkiba   
*/
...
contract ProofOfKiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x356fBc094cb9b21C86Ba8127BD2C4b2176e823E3); // Marketing Address
    address payable public multiSigAddress = payable(0x5f7C8D5349854Fd0C5D63999B5cF661EfAf08DA0); // Marketing Address
    address payable public devAddress = payable(0x5f7C8D5349854Fd0C5D63999B5cF661EfAf08DA0); // Dev Address
    address payable public liquidityAddress = payable(0x5f7C8D5349854Fd0C5D63999B5cF661EfAf08DA0); // Liquidity Address
    ...
    string private constant _name = unicode"Proof Of Kiba";
    string private constant _symbol = unicode"KIBA2.0";
