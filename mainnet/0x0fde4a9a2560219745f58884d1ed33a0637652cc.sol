...
contract Izumi is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Izumi Senju", "SENJU") {
    setHiddenMetadataUri("ipfs://QmeDomYnQVWgJRzYpfnJpkBBiS9JpVhC3DRDjuqy6s3v9Y/hidden.json");
  }
