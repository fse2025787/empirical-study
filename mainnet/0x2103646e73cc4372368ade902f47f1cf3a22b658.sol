...
contract Freezereum is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Freezereum";
    string private constant _symbol = "FREETH";
    ...
    address payable private _developmentAddress = payable(0x5aB6794B5AbDe7B8a92d2e555cfBfB3754Fd791d); 
    address payable private _marketingAddress = payable(0x5aB6794B5AbDe7B8a92d2e555cfBfB3754Fd791d);
