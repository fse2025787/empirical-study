...
/**
    ...
    Inspired by shakey markets.

    Dont Dump Inu does not allow the chart to dump. 

    2% buy, 2% sell. 

    2% tax auto LP
    2% auto buyback and burn 
...
contract Dump is Context, IERC20, Ownable {

    using SafeMath for uint256;
    //naming
    string private constant _name = "Dont Dump Inu";
    string private constant _symbol = "DDI";
    ...
    address payable private _developmentAddress = payable(0x5e3D2Ed1cA857793a8b749ebF7C010257208eac5);
    address payable private _marketingAddress = payable(0x5e3D2Ed1cA857793a8b749ebF7C010257208eac5);
    ...
    uint256 public _maxTxAmount =        5_000_000_000 * 10**9;
