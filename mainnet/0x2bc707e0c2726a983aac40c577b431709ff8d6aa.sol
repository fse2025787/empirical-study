 ...
 * allowances. See {IERC20-approve}.
 */
contract SOLUTION is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Solution Protocol";
    string private _symbol = "SOLUTION";
    ...
    address public marketingWallet = 0xbD7468A91476D071e1D5c92f40685BEAb5AF1171;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 6, "ERC20: total tax must not be greater than 6");
