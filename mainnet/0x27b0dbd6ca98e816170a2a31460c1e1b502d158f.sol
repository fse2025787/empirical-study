...
contract FadeAwayBunnyOwnership is FadeAwayBunnyBase, ERC721 {
    ...
    string public constant name = "FadeAwayBunnyNFT";
    string public constant symbol = "FAB";
    string public baseURI = "https://metadata.fadeawaybunny.com/";
...
contract FadeAwayBunnyMinting is FadeAwayBunnyOwnership {
    ...
    function setWhiteList(address _user, uint8 _number, uint256 _price) external onlyCOO {
        whitelist[_user] = _number;
        whitelistPrice[_user] = _price;

    }

    function setBatchWhiteList(address[] _users, uint8[] _numbers, uint256[] _prices) external onlyCOO {
