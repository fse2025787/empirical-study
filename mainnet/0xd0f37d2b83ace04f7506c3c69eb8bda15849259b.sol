...
// File: contracts/HOMELAND DAO.sol
...
interface IERC20 {
     ...
     * condition is to first reduce the spender's allowance to 0 and set           * the desired value afterwards Emits an `Approval` event.
     */
...
contract Token is ERC20, ERC20Detailed, ERC20Burnable, Ownable {
    ...
    string private _name = "HOMELAND DAO Token";
    string private constant _symbol = "HOME";
    uint   private constant _numTokens = 21000000;
