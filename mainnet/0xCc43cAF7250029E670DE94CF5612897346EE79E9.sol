...
// Fable of the Grimace - CA to be renounced and LP Burned 100%. Max Wallet - 2%. Buy/Sell - 6/6
...
contract  FableoftheGrimace  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fable of The Grimace"; // 
    string private constant _symbol = unicode"$FOTG"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x27b327Fed8B2cBE4140adA2Eae58EA1c81898D0e;
