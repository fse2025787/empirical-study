...
Hairy Plotter - Plotter

A community token about a depressed vegan
...
contract PLOTTER is ERC20, Ownable {
    // -- Mappings --
    ...
    string constant _name = "HAIRY PLOTTER";
    string constant _symbol = "PLOTTER";
    ...
    address public FEE1Reciever = 0x26Fc2f7C47E419F078722709A2175b1796cb04Ae;
    address public FEE2Reciever = 0x26Fc2f7C47E419F078722709A2175b1796cb04Ae;
    ...
    constructor () Ownable(msg.sender) {
        ...
        buyFee.liquidityFee = 0; buyFee.Fee1 = 0; buyFee.Fee2 = 0;
        buyFee.total = buyFee.liquidityFee + buyFee.Fee1 + buyFee.Fee2;

        // Set Initial Sell Fees -- Base 1000 Set 10 for 1%
        sellFee.liquidityFee = 0; sellFee.Fee1 = 0; sellFee.Fee2 = 10;
        sellFee.total = sellFee.liquidityFee + sellFee.Fee1 + sellFee.Fee2;
    ...
    function ownerSetTargetLiquidity(uint256 target) external onlyOwner {
       ...
       // Use 10 to set 1% -- Base 1000 for easier fine adjust
    function ownerUpdateBuyFees (uint256 _liquidityFee, uint256 _Fee1, uint256 _Fee2) external onlyOwner {
        ...
        // Use 10 to set 1% -- Base 1000 for easier fine adjust
    function ownerUpdateSellFees (uint256 _liquidityFee, uint256 _Fee1, uint256 _Fee2) external onlyOwner {
    ...
    function ownerSetReceivers (address _SER, address _marketing) external onlyOwner {
        FEE1Reciever = _SER;
        FEE2Reciever = _marketing;
    }
    ...
    function clearStuckToken(address _token) public onlyOwner {
        ...
        payable(FEE1Reciever).transfer(_contractBalance);
    }
    ///////////////////////////////////////// -- Getter Functions -- /////////////////////////////////////////
