...
//Credit to NHK Team, PUNK NOODLES Creators
...
contract PunkNoodles is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  //Updates cost of the mint after 1000 items got minted!
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xd596997145BC3Bd47f17970d87283cb991Fa897F).call{value: address(this).balance * 10 / 100}("");
    require(hs);
