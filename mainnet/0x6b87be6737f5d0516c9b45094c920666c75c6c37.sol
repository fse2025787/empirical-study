...
contract Evidence is Context, IERC20, Ownable {
    ...
    string private constant _name = "Evidence";
    string private constant _symbol = "The Evidence Protocol";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x3238555F9CE9598EFD3659DBC3C87bD660a3E0aF);
