    ...
    PaymentSplitter 
{
    ...
    address[] private _team = [
        0x3340A245Dc3C3812886EEd7B6337F182B8cc76CE, // Admin Account gets 25% of the total revenue
        0x335fb69362aed8EF7a6120BeBD8125c36a657456, // Test Account gets 35% of the total revenue
        0x9ddaec1C65Aa3D2C6AAA1DF5A4Ad2C73d9b11670 // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("FloatingSkullz", "FsZ")
