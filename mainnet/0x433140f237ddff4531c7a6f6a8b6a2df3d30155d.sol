...
contract FIDUS is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "FIDUS FINANCE";
    string private constant _symbol = "FIDUS";
    ...
    address payable private _developmentAddress = payable(0xB3b93f32B9084c3B1f8a8D21378F1bd7b115C222);
    address payable private _marketingAddress = payable(0xB3b93f32B9084c3B1f8a8D21378F1bd7b115C222);
