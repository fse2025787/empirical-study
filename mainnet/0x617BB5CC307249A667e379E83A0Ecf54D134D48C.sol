...
// Strechy Ape Bored Club

/*
The Strechiest apes on the blockchain, the Strechy Ape Bored Club NFT Collection symbolizes 
...
contract StrechyApeBoredClub is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.002 ether;
    uint   public maxTx             = 10000;
    ...
    constructor() ERC721A("Strechy Ape Bored Club", "SABC") {}
    ...
    function StrechyMint(uint256 count) external payable {
    ...
    function ReStrechyMint(uint256 Amount) external onlyOwner
    {
