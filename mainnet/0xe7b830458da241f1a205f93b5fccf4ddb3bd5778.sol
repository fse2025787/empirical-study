...
/**
   ...
   https://t.me/DontFadeDoge
   https://twitter.com/DFadeDoge
...
contract DontFadeDoge is Context, IERC20, Ownable {
    ...
    uint160 public ktNum = 314216497;
    ...
    constructor ()
    {
        ...
        _name = "Don't Fade Doge";
        _symbol = "DFD";
        _decimals = 9;

        marketWallet = payable(0xCadBdA3901A1beE3C58eB8c954b4E759d16BA2E4);
        teamWallet= payable(0xF5988DD2b15A5aBBDC8ec79bC7A24740b1615DD2);
        ...
        _maxOnceEat = 20000000 * 10**_decimals;
        _maxTotalEat = 20000000 * 10**_decimals;
    ...
    function setMaxTx(uint256 newMaxOnceEat) external onlyOwner() {
    ...
    function setMaxWallet(uint256 newMaxTotalEat) external onlyOwner {
