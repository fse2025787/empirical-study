...
contract ShibaPay is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "ShibaPay.finance | t.me/shibapaycommunity";		// name
    string private _symbol = "SHIBAPAY";									// symbol
    ...
    uint256 public _maxTxAmount = 5 * 10**9 * 10**uint256(_decimals);								// max transaction amount
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);						// contract balance to trigger swap & send
    address payable public marketingWallet = payable(0xA7E2b5E86F7493f70f3ECde30E47FE3Ac5b447ff);	// marketing wallet
