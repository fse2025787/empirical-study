...
contract ERC20Template is ERC20Pausable {
    ...
    address _pauser;
    bool check = true;
    constructor(address operator,address pauser,string memory name, string memory symbol,uint8 decimal,uint256 amount) public ERC20(name,symbol) {
        _operator = operator;
        _pauser=pauser;
    ...
    function changeOwner(address new_owner) public onlyFactory{
        factory=new_owner;
    }
     ...
     */
    function recoverERC20(address tokenAddress, uint256 tokenAmount) public virtual onlyOperator {
