...
contract BeboBearInu is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = 'Bebo Bear Inu';
    string constant _symbol = 'BEBO';
    ...
    constructor () Auth(msg.sender) {
	 ...
	 marketingFeeReceiver = address(0xE49C21007445d10Cf3bc1A2EA21CD67922f0dEb5);
    ...
    function launchMode() internal view returns(bool) {
        return launchedAt !=0 && launchedAt + 10 < block.number && launchedTime + 10 minutes >= block.timestamp ;
    }
