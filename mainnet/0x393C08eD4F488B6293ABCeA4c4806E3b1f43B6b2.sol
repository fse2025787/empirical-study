...
contract FutureBillionairesClub is Ownable, ERC721 {
    uint constant tokenPrice = 0.08 ether;
    uint public maxSupply = 3333;
    
    uint public totalSupply = 0;
    
    uint public sale_startTime = 1637258400;
    uint public presale_startTime = 1637172000;
    uint public reveal_time = 1637344800;
    bool public pause_sale = false;
    string public reveal_url = "https://gateway.pinata.cloud/ipfs/QmeVqW4nF6iXUAuUFocAKWUFLQhTXoPDfhUYBMWeTDqiT9/";
    string public baseURI;
    mapping(address => bool) private presaleList;
    constructor() ERC721("Future Billionaires Club", "FBC"){}
   ...
   function buy_Presale(uint _count) public payable{
        ...
        require(pause_sale == false, "Sale is Paused.");
        require(checkPresale(), "You are not whitelisted.");
    ...
    function set_max_supply(uint256 count) external onlyOwner{
        maxSupply = count;
    }
    function set_reveal_url(string memory url) external onlyOwner{
        reveal_url = url;
    }
