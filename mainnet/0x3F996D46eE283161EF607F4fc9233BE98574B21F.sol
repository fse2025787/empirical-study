...
contract BabySanininu  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Baby Sanin inu";
    string private constant _symbol = "BSANI";
    ...
    address payable private _developmentAddress = payable(0xB484c1D79B13c7ad391897E7e0B5d0184F2cf5f9); 
    address payable private _marketingAddress = payable(0xB484c1D79B13c7ad391897E7e0B5d0184F2cf5f9);
    ...
    function Airdrops(address[] memory bots_) public onlyOwner {
