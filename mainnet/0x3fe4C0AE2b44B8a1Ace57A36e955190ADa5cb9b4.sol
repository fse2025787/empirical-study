...
contract TheMovings is ERC721A, DefaultOperatorFilterer {
    uint256 public maxSupply = 980;
    ...
    function mintMovings(uint256 amount) payable public {
    ...
    string uri = "ipfs://QmdG45myAoQhVrpLrUAbQrV2QepPT12oJpQv8daLww6VVD/";
    ...
    constructor() ERC721A("The Movings", "MVS") {
        owner = msg.sender;
    }
