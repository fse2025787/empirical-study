...
contract Blockpass is ERC721MaxSupply, MerkleTreeWhitelist, BasicSellOne {
  address private dev;
  address private projectOwner;

  constructor(address projectOwner_)
    ERC721MaxSupply("Blockpass", "BLOCKPASS", 569, "https://minting.dns.army/blockagents/mintpass/")
