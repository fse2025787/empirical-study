...
contract XENSHIB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("XEN SHIBA", "XENSHIB") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xD67abB708Fd7e7B5Aa86d9239Fc91Ca6839C6824); // marketing wallet
        devWallet = address(0xD67abB708Fd7e7B5Aa86d9239Fc91Ca6839C6824); // dev wallet
