...
//Immortal YoshiShibu, leader of the Yoshibu Clan.
//Community driven missions where Yoshibu Clan members gather as council to cast their vote on which external project to invest funds from the “Missions Wallet” for short term gain.
//As a clan with a voice, YOU will help decide on where the mighty YoshiShibu plants his sword.
//YoshiShibu 
...
contract YoshiShibu is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0x6857cB7b5F12c7Fa83E8ED3a1eDaF9c4A7c51537); // set as marketing wallet
        ...
        excludeFromFees(0xEbD99f5996388BF3ae674Be0B2cD87020B7DC94A, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xEbD99f5996388BF3ae674Be0B2cD87020B7DC94A, true);
        ...
        */
        ...
        _createInitialSupply(0xEbD99f5996388BF3ae674Be0B2cD87020B7DC94A, totalSupply*20/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xEbD99f5996388BF3ae674Be0B2cD87020B7DC94A,
            block.timestamp
        );
    }
