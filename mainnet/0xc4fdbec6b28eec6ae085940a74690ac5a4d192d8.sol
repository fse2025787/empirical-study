...
It is an ERC20 community meme token that gives you tons of X from this project. 
Ookami is combined to most popular dog in crypto space and build OokamiInu.

OokamiInu is a wolf girl with golden eyes and long, voluminous black hair with a red highlight. Her hair is also tied with a red and white Japanese style rope at her waist behind her back. 

New Community Ookami Inu will have an auto liquidity to stabilize and make the chart strong.

We are planning to create a NFT platform where people can create, buy and sell fully customizable Inu. 
The OokamiInu ecosystem allows users to build their own inu with no technical knowledge in blockchain or programming all of the elements are put together through a friendly user interface.

☎️ LINK: https://t.me/NewCommunityOokamiInuETH
🐦 TWITTER: https://twitter.com/NC_OokamiInu
...
contract NewCommunityOokamiInu is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "New Community Ookami Inu";
    string private constant _symbol   = "cOOKAMIINU";
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 300 / 10000; // 3% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x7E01a24bd7FBF382Dc184d5C773643cCBdC315aa;
        _marketingWallet = 0x7E01a24bd7FBF382Dc184d5C773643cCBdC315aa;
