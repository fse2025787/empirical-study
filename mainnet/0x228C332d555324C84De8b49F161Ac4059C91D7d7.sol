...
Token Name: World Trade Center Attack
Ticker: 9/11 ATK
Supply: 11 million >> 1% initial max wallet (110,000)
Tax: 4/4 (1% burn, 3% marketing/charity)


https://t.me/WorldTradeCenterAttack911
*/
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "World Trade Center Attack";
    string private constant _symbol = "9/11 ATK";
    ...
    uint256 private maxWalletAmount = 110001 * 10**9;  
    uint256 private maxTxAmount = 110001 * 10**9;      
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x2246dEd7972b69f711a8F1b5CB954fb703a37325); 
