...
contract PengyFrens is ERC721Enumerable, Ownable {
    ...
    uint16 public maxMintAmountPerWallet = 25;
    uint16 public maxMintAmountPerWhitelist = 25;
    ...
    constructor(string memory _baseUrl) ERC721("Pengy Frens", "PGF") {
