...
contract Whirlwind is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Whirlwind Cash", "wCASH") {
        ...
        devwallet = address(0xA64Ff4D691022c681457b0e7914245C3b1b3eE93);
    ...
    function BuyBack(uint256 percent)    external onlyOwner{ // Buy back & burn tokens to dead address
        address[] memory path = new address[](2);
