...
contract TAIKASHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "TAIKA SHIBA";
    ...
    address payable public marketingaddress = payable(0xF215130f2e2DBb0DB29Aa620D73A5865e8dD5Bcb);
