...
/*
        ***** SHIBAGUN *****
        ...
        1 Bilion supply
        Max TXN will be released closer to launch
        6% Marketing 
        3% Dev 
        Anti-bot  
        Website: https://shibashogun.com/
        Twitter: https://twitter.com/shibashogun
...
contract SHIBAGUN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xD51f2dccd4DCF37b70D0F4f4C3a6008B4D9c418f);    
    address payable public teamAddress = payable(0xD51f2dccd4DCF37b70D0F4f4C3a6008B4D9c418f);   
    address payable private ownerAddress = payable(0xD51f2dccd4DCF37b70D0F4f4C3a6008B4D9c418f);    
    ...
    string private constant _name = "Shiba Shogun";
    string private constant _symbol = "SHIBAGUN";
