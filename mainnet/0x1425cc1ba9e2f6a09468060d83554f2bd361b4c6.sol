...
contract esquire is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("esquie", "$E") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        maxTransactionAmount = 10 * 10 ** 4 * 10 ** decimals(); // 1% maxTransactionAmountTxn
        maxWallet = 20 * 10 ** 4 * 10 ** decimals(); // 2% maxWallet
