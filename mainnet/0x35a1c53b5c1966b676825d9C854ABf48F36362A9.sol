...
contract ZukiRunner is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://zukirunners.mypinata.cloud/ipfs/QmT61Z2Pv918hia2t9PSktdnRHhhoH3HDFQLbFmgbJTrAL/";
  uint256  public  maxSupply = 3333;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  NUM_FREE_MINTS = 2200;
