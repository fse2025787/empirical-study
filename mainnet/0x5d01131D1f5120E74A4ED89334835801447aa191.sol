...
interface IIndexBetting {
    event BettingChallengeSettled(uint16 PDIRewardRate);
    ...
    UUPSUpgradeable
{
    ...
    */
    ...
    function startBettingChallenge(uint256 _challengeDuration, uint32 _frontRunningLockupDuration)
        ...
        onlyOwner
    {
        require(_challengeDuration > _frontRunningLockupDuration && startEpoch.timestamp == 0, "IndexBetting: INVALID");
    ...
    */
    ...
    function _setPDIRewardRate(int256 _DPIPrice) internal {
        ...
        emit BettingChallengeSettled(PDIRewardRate);
    }
