...
contract TFANON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Team Finance ANON";
    string private constant _symbol = "TFANON";
    ...
    uint256 private constant _tTotal = 1e5 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x8e60CD48056493D5eE36fCe8E04b02F68730b0c3);
    ...
    uint256 public _maxTxAmount = 2e3 * 10**9; //
    uint256 public _maxWalletSize = 2e3 * 10**9; //
    uint256 public _swapTokensAtAmount = 5e2 * 10**9; //
