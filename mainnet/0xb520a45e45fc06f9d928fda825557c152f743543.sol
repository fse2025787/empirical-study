...
// 999 Gateways // 0.003 // Max 3 // Welcome Travelers //
...
contract Gateways is ERC721A, Ownable {
  using Strings for uint256;
  
  uint256 public cost = 0.003 ether;
  uint256 public maxSupply = 999;
  uint256 public freePerWallet = 0;
  uint256 public maxMint = 3;
  uint256 public requiredBalance = 0.003 ether;
  ...
  constructor() ERC721A("Gateways", "GTWY") {
  }
