...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    } //telegram https://t.me/BlackEagleEth 
}     // 
...
contract BLACKEAGLE  is Context, IERC20, Ownable {
    ...
    string private constant _name = "BlackEagle";
    string private constant _symbol = "BLE";
