...
boy and girl have grown children
    and have earned that "middle-age spread"
     ...
     |` 66|_     @@@@@@@@,      @@@@@@,    (_   ':D
     C     _)    aa`@@@@@@      aa @@@@,    |_,  /
(\/)  \ ._|     (_   [email protected]@@@     (_  [email protected]@@@     \__(
 \/    ) /       =' @@@@"       =' @@@@"     //`\\     @@@@
      /`\\        \_(```         ) @@@"     | | ||    ee "@@
     /| |Y|       /``\          /-'@@@,     | |_||   (_   `D
    | | |#|      / | ||        / / \@@@     | | ||    |_  /
...
contract Partyneverends is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmNhZTm2CtzJ4QT1XM4QrawcmYyJBosGsKgJKf4BB2zMoY//";
  ...
  constructor() ERC721A("Party Never Ends", "PNE") {
  }
