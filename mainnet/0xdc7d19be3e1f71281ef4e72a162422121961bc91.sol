...
// add uint _startTime, uint _endTime in contructor
    ...
    function calculatePrice(uint256 _amount) internal view returns (uint256 totalValue) {
        ...
        if(salephases_number == 1) {

            require(salephases_number == 1, "Sale Phase is 1 selected");

            totalSoldUSD = (totalUsdValueForPresale*(10**18)) - inSaleUSDvalue;
            if(msg.sender != dAddress)
            {
                require(totalSoldUSD <= hardcapsizeUSD*(10**18), "hardcapUSDphase1 reached");
            }
        ...
        if(salephases_number == 2) {

            require(salephases_number == 2, "Sale Phase is 2 selected");

            totalSoldUSD = (totalUsdValueForPresale*(10**18)) - inSaleUSDvalue;
            if(msg.sender != dAddress)
            {
                require(totalSoldUSD <= hardcapsizeUSDPhase2*(10**18), "hardcapUSDphase2 reached");
            }
        ...
        if(salephases_number == 3) {

            require(salephases_number == 3, "Sale Phase is 3 selected");

            totalSoldUSD = (totalUsdValueForPresale*(10**18)) - inSaleUSDvalue;
            if(msg.sender != dAddress)
            {
                require(totalSoldUSD  <= hardcapsizeUSDPhase3*(10**18), "hardcapUSDphase3 reached");
            }

            require(totalSoldUSD  <= hardcapsizeUSDTotal*(10**18), "hardcapUSDTotal reached");
    ...
    function setSalePhases_Number(uint value_) external onlyOwner {
        salephases_number = value_;
    }
