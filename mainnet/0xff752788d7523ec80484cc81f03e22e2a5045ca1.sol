...
//** Government of the Chads, by the chads, for the bulls, shall not perish from the world**
//** https://t.me/ForTheChads **
...
contract FTC is ERC20, Ownable {
    ...
    constructor() ERC20("For The Chads", "FTC") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 2.5% maxTransactionAmountTxn
    ...
    function FTPMODE() external onlyOwner returns (bool){
