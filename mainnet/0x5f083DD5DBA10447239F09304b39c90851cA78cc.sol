...
// File: contracts/wARRRStaking.sol
...
contract WARRRStaking is Context, Ownable {
    ...
    function rewardOf(address _staker) public view returns (uint256) {
        ...
        uint256 _singlePart = _stakeDetail.amount.mul(
    ...
    function unstake() public {
        ...
        IERC20(lpToken).safeTransfer(feeWallet, fee);
