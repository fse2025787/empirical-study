...
contract JUICYTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x752AEa8ad60C1d8c6cDeB8A63A8c0a237B90Bdab); // Marketing Address
    address payable public multiSigAddress = payable(0x444Ba884db8d221B6816c3810BB385BE3B50F02D); // Marketing Address
    address payable public devAddress = payable(0x444Ba884db8d221B6816c3810BB385BE3B50F02D); // Dev Address
    address payable public liquidityAddress = payable(0x444Ba884db8d221B6816c3810BB385BE3B50F02D); // Liquidity Address
    ...
    string private constant _name = unicode"JUICY";
    string private constant _symbol = unicode"JUICY";
