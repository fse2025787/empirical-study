...
contract VTYRANT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Vitalik Tyrant";
    string private constant _symbol = "VTYRANT";
    ...
    address payable private _opAddress = payable(0x5d03D823bd1Aa6eaF157Cd5483A0f3D3be733cfE);
