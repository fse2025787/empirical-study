...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x8E2C20d71C617aFB10a95c0834b2A259BD0656Da];
  address public erc20Payable = 0x8E2C20d71C617aFB10a95c0834b2A259BD0656Da;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 987) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeievg6mcpzlwwcpmtwyn7yfy5x4vudyytsiod335jt2gujmxh2hz5u/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wqbzud3hHGX3lLRCo1K9/contract-metadata";
  }
...
// File: contracts/TheGloriousAgeContract.sol
//

pragma solidity ^0.8.0;

contract TheGloriousAgeContract is RamppERC721A {
    constructor() RamppERC721A("The Glorious Age", "TGB"){}
}
