...
contract OurFounderIsDead     is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1* 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'OurFounderIsDead  ';
    string private _symbol = 'OFID ';
