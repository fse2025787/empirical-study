...
//███████╗╚██████╔╝╚██████╗╚██████╗██║  ██║
//╚══════╝ ╚═════╝  ╚═════╝ ╚═════╝╚═╝  ╚═╝
//Simple and Hassle-free yield generating protocols
//Web : https://lucca.cash
//Telegram : https://t.me/luccacash
...
contract LuccaCash is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Lucca Cash";//
    string private constant _symbol = "LCASH";//
    ...
    address payable private _developmentAddress = payable(0x37EEC4e491ee49E646489583614a80739C82a855);//
    address payable private _marketingAddress = payable(0x2d2a40Def7eb23c3133f31E4Df1ffff4B072eBe3);//
    ...
    uint256 public _maxWalletSize = 25000 * 10**18; //
    uint256 public _swapTokensAtAmount = 2000 * 10**18; //
