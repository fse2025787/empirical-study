 ...
 * Symbol - $ROBIN
 * Slippage - 18
 * https://damianwayne.me
 * https://t.me/RobinInuGlobal
 * https://twitter.com/robininutoken
 */
...
contract RobinInu is Structer {
    using SafeMath for uint256;

    IUniSwapRouter private uniswapRouter;

    string private constant _name = "Robin Inu";
    string private constant _symbol = "$ROBIN";
    uint8  private constant _decimals = 9;

    uint8 private feeOnBuy = 14;
    uint8 private feeOnSell = 16;
    ...
    constructor() {
        ...
        maxTransactionAmount = tokenSupply.mul(2).div(100); // 2%
        ...
        marketingWallet = address(0xcc69B12fb04540A4E084a27856C31b24CBe5dc80);
