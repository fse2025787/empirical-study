...
// File: contracts/onyxs cubes.sol
...
contract onyxtreasure is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeidbksjk2sfyrbzazop3zry3mr7vgbrax4kztc3sajahsvmgcr7zym/";
  uint256 public  maxSupply = 800;
  uint256 public  MAX_MINTS_PER_TX = 4;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether; //for the tools to open the cubes
  uint256 public  NUM_FREE_MINTS = 800;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public freeAlreadyMinted = 0;
  bool public isPublicSaleActive = false;
  constructor() ERC721A("0nyx Treasure", "ONYX") {
  }
