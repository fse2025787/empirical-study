...
contract JETCLUB is Context, IERC20, Ownable {
    ...
    string private _name = "JET CLUB INU";
    string private _symbol = "JETCLUB";
    ...
    address payable public devWallet = payable(0x000000000000000000000000000000000000dEaD);
    ...
    uint256 public maxWalletToken = 20000000 * (10**9);
    uint256 public maxBuyTransactionAmount = 20000000 * (10**9);
