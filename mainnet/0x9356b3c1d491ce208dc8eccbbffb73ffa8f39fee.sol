...
contract DelegationContainer is IDelegationContainer, IERC721Receiver, Context {
  ...
  uint96 public containerSalePrice; // 96 || 256
  ...
  // Slot 6: 96 = 96
  uint96 public delegationSalePrice; // 96 || 96
  ...
  function endDelegationAndRelist(
    ...
    // Resent container or delegate sale details
  ...
  function endDelegationAndAcceptOffer(
    ...
    // Resent container and delegate sale details
    containerSalePrice = 0;
    delegationSalePrice = 0;
  ...
  function _performFinalisation() internal {
    ...
    // It therefore cannot be sold, or the underlying delegation rights
    containerSalePrice = 0;
    delegationSalePrice = 0;
  ...
  function listContainerForSale(uint64 provider_, uint96 salePrice_)
    ...
    onlyOwner
  {
    require(startTime != 0 && !terminated, "Cannot sell inactive container");
  ...
  function buyContainerForSale(uint64 provider_) external payable {
    ...
    _transferOwnership(provider_, msg.sender, epsFee);
  ...
  function listDelegationForSale(uint64 provider_, uint96 salePrice_)
    ...
    onlyDelegate
  {
    require(!terminated, "Cannot sell inactive delegation");
  ...
  function buyDelegationForSale(uint64 provider_) external payable {
    ...
    _transferDelegate(provider_, msg.sender, epsFee);
    ...
    onlyOwner
  {
    ...
    _transferOwnership(provider_, newOwner, 0);
  }
    ...
    onlyDelegate
  {
    ...
    _transferDelegate(provider_, newDelegate_, 0);
  ...
  function burnDelegate(uint64 provider_) public onlyDelegate {
    ...
    _transferDelegate(provider_, BURN_ADDRESS, 0);
