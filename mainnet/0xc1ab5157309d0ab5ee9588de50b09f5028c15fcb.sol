...
contract FLOKISuperSAIYAN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000_000_000_000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'FLOKI SUPER SAIYAN';
    string private _symbol = 'FLOKISUPER';
    ...
    address payable private _marketingWalletAddress = payable(0xB140d37Ce7449534A1c6b763835049e8AF895EC3);
    ...
    function _setLiquidityBurnFee(uint256 liquidityFee) external onlyOwner() {
