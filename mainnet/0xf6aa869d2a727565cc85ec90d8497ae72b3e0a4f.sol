...
// File: contracts/SaltAndSatoshiBondingCurve.sol
...
contract SaltAndSatoshiBondingCurve is Ownable, Pausable, Destructible {

    event Sent(address indexed payee, uint256 amount, uint256 balance);
    event TokenPurchase(address indexed payer, address indexed nftAddress, uint indexed tokenId, uint256 amount);
    ...
    * @param _initialPrice initial sales price
    * @param _priceStep bonding curves price step
    */
    constructor(uint256 _initialPrice, uint256 _priceStep) public {
    ...
    /**
    * @dev Purchase token
    * @param _nftAddress address token EIP721 contract address
