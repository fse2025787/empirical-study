...
/**
      TELEGRAM:  https://t.me/UsagiMonogatariErc
      WEBSITE:  https://www.usagimonogatari.live/
      TWITTER: https://twitter.com/usagimonogatar
      GITBOOK: https://usagimonogatari.gitbook.io/usagi-monogatari/?fbclid=IwAR0z21gVwKM18y4lYpHGbd6j2T2b403MeFFdHnhlyPnYQk6UgoT_stIXTkY
*/
...
contract USAGIMONOGATARI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "USAGI MONOGATARI"; 
    string private constant _symbol = "$USAGI"; 
    ...
    address payable private _developmentWalletAddress = payable(0xF2e3C596030cc16473ee29A10Ea13f52ADb2Ef65);
    address payable private _marketingWalletAddress = payable(0xF2e3C596030cc16473ee29A10Ea13f52ADb2Ef65);
