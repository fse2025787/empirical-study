...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x2ba4804A8b8414676F03eF96Ec06d5093355df65] = _marketingwallet;
    }
...
contract TheTitanomachy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Titanomachy", "MACHY") {
        ...
        excludeFromFees(address(0x2ba4804A8b8414676F03eF96Ec06d5093355df65), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x2ba4804A8b8414676F03eF96Ec06d5093355df65), true);
