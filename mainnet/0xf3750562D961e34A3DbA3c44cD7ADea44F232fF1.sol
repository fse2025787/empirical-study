...
contract monaMusk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Mona Musk";
    string private constant _symbol = "MOSK";
    ...
    address payable private _marketingAddress = payable(0x1b977e72062A852a89c54Bb398BC4B914f98a9bc);
    address payable private deploymentWallet = payable(0x78b3a8A3BF28f3F2eEae581309B13ef75c1678E1);
