...
contract FTT is ERC20, Ownable {
    ...
    constructor() ERC20("FTT Inu", "FTT") {
     ...
     uint256 totalSupply = 3 * 10 ** 5 * 10 ** decimals();
        ...
        maxTransactionAmount = 6 * 10 ** 3 * 10 ** decimals(); 
        maxWallet = 6 * 10 ** 3 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xD394a54a187eD6B4B19f292682C445Ae40365020); // set as Marketing wallet
        DevWallet = address(0xD394a54a187eD6B4B19f292682C445Ae40365020); // set as dev wallet
