...
contract MCAREY is Context, IERC20, Ownable {
    ...
    string private constant _name = "All I Want For Christmas Is ETH";
    string private constant _symbol = "MCAREY";
