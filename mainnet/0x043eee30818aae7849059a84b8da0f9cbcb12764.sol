...
contract KungFuPepeClub is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;
    string  public baseTokenURI = "ipfs://bafybeifiaiw3k63icqnt2mnd6msaskqxhkl6uq4zh2ktnyfrdiau5ch3we/";
    uint256 public MAX_SUPPLY = 4888;
    uint256 public MAX_FREE_SUPPLY = 4888;
    ...
    constructor() ERC721A("KungFu Pepe Club", "KFPC") {}


    function candy(address to, uint count) external onlyOwner {
		require(
    ...
    {
        require(state, "Minting is not live.");
