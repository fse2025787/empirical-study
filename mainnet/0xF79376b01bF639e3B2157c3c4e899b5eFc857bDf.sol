...
contract SadGirl is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sad Dirlfriends", "SDN") {
    setHiddenMetadataUri("ipfs://QmNZ44sgYAD9dQtMLhh9xEamaPm4C3x5kjha5oyjjNsADG/_metadata.json");
  }
