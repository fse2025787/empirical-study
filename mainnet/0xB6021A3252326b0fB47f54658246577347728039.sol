...
// https://t.me/KabosuInu05Erc20Portal
...
contract KabosuInu5 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Kabosu Inu 0.5";
    string private _symbol = "KABOSU 0.5";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xa4A01f2bD7710022Be6E70Ad95c3a683Dc05414B);
    address payable private taxWallet2 = payable(0xa4A01f2bD7710022Be6E70Ad95c3a683Dc05414B);
