...
// $HACKD
// TG: https://t.me/HACKDToken
// Made in honour of the PolyNetwork Exploiter, and his many bananas

// Ape Play Fair Launch: 10% Burn, 1% to PolyNetwork Exploiter

// Slippage Recommended: 10%
// Launched by https://t.me/FairLaunchCalls
...
contract Hackd is Context, IERC20, Ownable {
    ...
    string private _name = 'HACKD | t.me/HACKDToken';
    string private _symbol = 'HACKD \xF0\x9F\x9A\x93';
    ...
    uint256 private _numOfTokensToExchangeForTeamDev = 100000000000000000000;
    uint256 public _safetyProtocolLimitContract = 5000000000000000000000;
    ...
    function initDefaultLists() external onlyOwner() {
        ...
        _teamDevAddress = payable(0x25bebB6A2Bc14c626481B2D03dEC80bFB316b2FB);
    ...
    function disableSellSafetyProtocol() external onlyOwner() {
