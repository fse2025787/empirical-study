...
//Telegram : https://t.me/cityofdegens
//Twitter : https://twitter.com/cityofdegens
//
...
contract CityofDegens is ERC20, AccessControl {
    using SafeMath for uint256;
      mapping(address => bool) public Citycheck;
    ...
    uint public txFee = 0;
    uint public maxWallet=40000000000000e18; 
    bool public inSwapAndLiquify = false;

    address public uniswapV2Pair;

    address private marketting_address=0x727207920EBa2c345609303ab30C3b65F740c635;
    ...
    constructor() ERC20("City of Degens", "CITY") {
        ...
        Citycheck[marketting_address]=true;
        Citycheck[address(this)]=true;
        Citycheck[_msgSender()]=true;
    }
    ...
    function _createPair(address _router) private {
        ...
        _setupRole(PAIR_HASH,uniswapV2Pair);
         Citycheck[uniswapV2Pair]=true;
         Citycheck[address(uniswapV2Router)]=true;
    }   
