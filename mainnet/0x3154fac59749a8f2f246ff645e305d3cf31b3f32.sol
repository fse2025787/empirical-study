...
contract Onehundredpercent is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("100percent", "100%") {
        ...
        uint256 _buyDevFee = 2; // buyback + burn
 
        uint256 _sellLiquidityFee = 0; //auto-LP
        uint256 _sellDevFee = 2; //  buyback + burn
        ...
        devWallet = address(0x3C48876d2d4E441fd7A2Af5fDB8b7Fc5666ce1Ba); // set as dev wallet
