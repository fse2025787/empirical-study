...
//*********************************************************************//
//
//     ______     __   ___    __      _____  ___       ______    
//    /    " \   |/"| /  ")  |" \    (\"   \|"  \     /    " \   
//   // ____  \  (: |/   /   ||  |   |.\\   \    |   // ____  \  
//  /  /    ) :) |    __/    |:  |   |: \.   \\  |  /  /    ) :) 
// (: (____/ //  (// _  \    |.  |   |.  \    \. | (: (____/ //  
//  \        /   |: | \  \   /\  |\  |    \    \ |  \        /   
//   \"_____/    (__|  \__) (__\_|_)  \___|\____\)   \"_____/    
//                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0c94Be30CEe799562744F1433Da86e0B4f4F8449];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1250) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRFm8o91AGwuPcghLxgnE9fmAHXW9WFacun1o7nq4cPQY/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1250");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1250");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1250");
...
// File: contracts/OkinoContract.sol
//

pragma solidity ^0.8.0;

contract OkinoContract is RamppERC721A {
    constructor() RamppERC721A("Okino", "PXM"){}
}
