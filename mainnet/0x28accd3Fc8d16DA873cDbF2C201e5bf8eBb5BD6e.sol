...
contract WelcomeBackDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WelcomeBackDOGE", "$WDOGE") {
        ...
        swapTokensAtAmount = totalSupply * 20 / 10000; // 0.20% swap wallet
