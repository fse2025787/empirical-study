...
// File: contracts/AnatomyRareApepeYC.sol
...
contract AnatomyRareApepeYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2147;
  ...
  ) ERC721A("Anatomy Rare Apepe YC", "ARAYC") {
