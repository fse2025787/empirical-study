...
// File: contracts\FEIIToken.sol
// License: MIT




// FEIIToken with Governance.
contract FEIIToken is ERC20("FEIIToken", "FEII"), Ownable, Authorizable {
    uint256 private _cap = 100000e18; 
    constructor() public { 
        //mint for create uniswap pool
        uint256 _lpAmount = 100e18;
        address _to = msg.sender;
        _mint(_to, _lpAmount);
        _moveDelegates(address(0), _delegates[_to], _lpAmount);
    }
    /**
