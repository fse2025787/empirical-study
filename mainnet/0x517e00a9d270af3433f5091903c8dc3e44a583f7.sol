...
contract TheDreamMachine is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbGN1hjwRdW9NHWvvdb8KXa527eefre5WJj71fvZxUZRt";
    ...
    constructor(
    ) ERC721A("TheDreamMachine", "TDM", 100, maxSupply) {
    }
