...
shit ass dev just deploy a sink inu contract without verify and its rugged - welcome to the original sink inu!
...
contract SinkInu is ERC20 {
    constructor() ERC20("Sink Inu", "SINK") {
