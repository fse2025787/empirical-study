...
// 
//Developer Info: A pfp project for all of those that deserve justice and seek revenge. For the degens who seek a community to call home and are tired of the usual bullsh*t.
...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract STREETJUSTICENFT is ERC721A,DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("STREET JUSTICE", "NFT") {
  }
