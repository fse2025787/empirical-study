...
Stealth launching TODAY between 12:00-13:00 PM UTC!

Floki AI" is a term used to describe the AI ​​(Artificial Intelligence) used to create or analyze memes. AI can assist in creating new memes by using techniques such as generative text or image generation, or by analyzing the popularity of a meme and predicting what will become a popular meme
...
Telegram: https://t.me/FlokiAiETH
Twitter: https://twitter.com/FlokiAi
...
contract FlokiAi is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "Floki Ai";
