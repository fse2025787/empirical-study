...
contract CremeBrulee is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Creme Brulee";
    ...
    address payable private _developmentAddress = payable(0x318ca88397601F0b44395989CD4D2F30Eeffa25C); 
    address payable private _marketingAddress = payable(0x318ca88397601F0b44395989CD4D2F30Eeffa25C);
