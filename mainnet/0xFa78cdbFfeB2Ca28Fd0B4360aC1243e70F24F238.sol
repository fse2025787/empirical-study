...
⭐️ StealthElona - Only 2% Tax ⭐️

⭐️ Portal: https://t.me/StealthElona ⭐️
...
contract STEALTHELONA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("StealthElona", "STEALTHELONA") {
        ...
        maxTransactionAmount = totalSupply * 2 / 100; // 1% from total supply maxTransactionAmount
        ...
        marketingWallet = payable(0x357819f069E4d77b755716f98fF92410A0e47f63);
        devWallet = payable(0x357819f069E4d77b755716f98fF92410A0e47f63);
