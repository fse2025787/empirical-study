...
// File: contracts/ThePolishNFT.sol
...
/** Template created by arczi.eth - I do not take responsibility for 
 ...
 Visit https://github.com/Machovsky/ethereum-contracts for your free contract template!
 **/
...
contract ThePolishNFT is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public supplyLimitPhase1 = 1600;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 3333;  //change it to your total NFT supply
  uint256 public maxMintAmountPerTxPhase1 = 5; //decide how many NFT's you want to mint with cost1
  uint256 public maxMintAmountPerTxPhase2 = 3000; //decide how many NFT's you want to mint with cost2
  uint256 public maxLimitPerWallet = 3330; //decide how many NFT's you want to let customers mint per wallet
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("The Polish", "TPNFT")  { //change this line to your full and short NFT name
    seturi(_uri);
