...
| $$\  $$   | $$  | $$\  $$$| $$  \ $$      | $$  | $$| $$      | $$      
| $$ \  $$ /$$$$$$| $$ \  $$|  $$$$$$/      | $$  | $$| $$      | $$$$$$$$
|__/  \__/|______/|__/  \__/ \______/       |__/  |__/|__/      |________/
                                                                          
https://t.me/KingApePortal
*/
...
contract KINGAPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address developer, address marketing) ERC20("KING APE", "KAPE", marketing) {
        ...
        marketingWallet = marketing; // set as marketing wallet
        devWallet = developer; // set as dev wallet        
