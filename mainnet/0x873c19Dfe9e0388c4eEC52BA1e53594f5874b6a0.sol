...
// MIXING TWO OF THE HYPED TOKEN OF LAST DAYS! KUNOICHIX + VOLT INU
...
contract KunoVolt is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0x34454955b59d83f0AeC7dE9826aFCD81E4e630eD);
    ...
    string private _name = "KunoVolt";
    string private _symbol = "$KUVO";
