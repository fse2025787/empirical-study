...
contract DOGETRIBEPUP  is ERC721Enumerable, Ownable
{
    ...
    function setPreSaleMaxQtPerTx(uint256 _quantity) public onlyOwner {
        maxQuantity=_quantity;
    }
    function setMaxQtPerTx(uint256 _quantity) public onlyOwner {
        maxPreSaleQuantity=_quantity;
    }
    ...
    modifier isSaleOpen{
        require(totalSupply() < maxSupply, "Sale end");
        _;
    }
    ...
    function mint(uint chosenAmount) public payable isSaleOpen{
        ...
        require(totalSupply().add(chosenAmount + reserve) <= maxSupply, "Purchase would exceed max supply");
