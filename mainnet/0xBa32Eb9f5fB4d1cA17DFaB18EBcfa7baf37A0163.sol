...
contract FlowerFamMinter is Ownable {
    ...
    uint256 public mintDuration = 69 minutes; 
    uint256 public startTimeWL = 1653148800 - 1 minutes; 
    ...
    mapping(uint256 => uint256) public roundToMintLimits; 
    mapping(address => mapping(uint256 => uint256)) public roundToMinted; 
    mapping(uint256 => bytes32) public roundToMerkleRoot; 
    ...
    function whitelistMint(uint256 amount, bytes32[] calldata proof, bool stake) external payable {
        ...
        uint256 passesLeft = flowerFamMintPass.userPassesLeft(msg.sender); 
    ...
    function _stakeMintedFlowers(uint256 amount) internal {
        uint256 lastMinted = flowerFam.getLastMintedId(); 
