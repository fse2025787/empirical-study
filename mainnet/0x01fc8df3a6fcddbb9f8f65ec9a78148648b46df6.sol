...
contract ProofOfThunder is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of Thunder";
    string private constant _symbol = "ZEUS2.0";
    ...
    uint256 public minSwapThreshold= 1000 * 10**_decimals;
