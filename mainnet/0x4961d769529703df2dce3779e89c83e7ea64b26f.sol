...
/*
Many sacred sites are associated with the entity, others are said to be places where the gods materialized in the world.
*/
...
contract poe is ERC20, Ownable {
    ...
    constructor() ERC20("Pilgrimage of Entity", "PoE") {
