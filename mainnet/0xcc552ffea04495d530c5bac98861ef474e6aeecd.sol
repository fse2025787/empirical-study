...
contract SpacePass is ERC721A, Ownable, ReentrancyGuard {
        ...
        mintCompliance(_mintAmount) 
    {
        ...
        if ((_mintAmount + totalSupply()) > config_.whitelistMaxSupply) revert OutOfSupply();
