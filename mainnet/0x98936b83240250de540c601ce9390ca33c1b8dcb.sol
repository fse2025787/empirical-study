...
https://mobile.twitter.com/ishowspeedsui
...
contract IShowSpeedInu is Context,IERC20, Ownable{
using Address for address;
string private _name = "I Show Speed Inu";
string private _symbol = "IShowSpeedInu";
...
address _owner;
address payable public marketingAddress = payable(0x6E291f83ed371CB941869a7524E3e315D1ed3677);
...
uint256 IShowSpeedInuCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > IShowSpeedInuCOINDaycooldown, "You cant call IShowSpeedInuCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function IShowSpeedInuCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    IShowSpeedInuCOINDaycooldown = block.timestamp + 86400;
}
