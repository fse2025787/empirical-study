...
contract Miniverse is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3777;
    uint256 public MAX_MINTS = 300;
    string public baseURI = "";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Miniverse NFT", "MNVR", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function MintFree(uint256 numTokens) public payable {
        ...
        require(numTokens >= 1 || numTokens <= 2);
