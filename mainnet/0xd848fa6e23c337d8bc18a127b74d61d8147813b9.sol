...
contract BigBrainCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Big Brain Capital DAO";
    string private constant _symbol = "BBC DAO";
    ...
    address payable public marketingWallet = payable(0x0F52b9a101126e620B4B580Bd57820ED662bD533);
    address payable public treasury = payable(0x78b4300899Cca63b9EDE65807AAE2751447f316d);
