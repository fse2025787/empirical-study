...
contract Apefather is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xe9d5f909127D92Ef5dD715d62b2A1206E2214B5d); // Marketing Address

    address payable public liquidityAddress =
        payable(0x3728542A2C48A7986d970088a17CfDf0e085Fa77); // Liquidity Address
    ...
    string private constant _name = "The Crypto Empire";
    string private constant _symbol = "APEFATHER";
    ...
    constructor() {
        ...
        liquidityAddress = payable(address(0x3728542A2C48A7986d970088a17CfDf0e085Fa77)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
