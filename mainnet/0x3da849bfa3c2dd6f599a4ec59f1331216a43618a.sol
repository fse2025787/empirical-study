...
contract DarqMajik  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21000000000000000e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Darq Majik";
    string private _symbol = "MAJIK";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 0; //(3% liquidityAddition + 2% rewardsDistribution + 3% devExpenses)
    ...
    // limit
    uint256 public _maxTxAmount = 630000000000000e9; //1.5% after 50% burn
    ...
    constructor () public {
        ...
        emit Transfer(address(0x37341cbb14c5F128A70B149726ad8B2CE6F4C793), _msgSender(), _tTotal);
    }
