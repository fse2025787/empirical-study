...
/**
Bahia will burn 15% tokens from the liquidity pool every day.

https://bahiaburnbitcoin.fun/
https://t.me/bahiaburnbitcoinportal
...
contract Bahia is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x8C58574d2F6A85C8F0595b6aa9F0D229cF3E8888;
    address private feeTwo = 0x8C58574d2F6A85C8F0595b6aa9F0D229cF3E8888;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Bahia Burn Bitcoin";
    string private _symbol = "Bahia";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 21_000_000 * 10 ** _decimals;
    uint256 public _maxWalletAmount = 210_000 * 10 ** _decimals;
