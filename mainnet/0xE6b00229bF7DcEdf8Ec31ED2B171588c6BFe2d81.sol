...
$$ |  $$ | $$  /    $$ |  $$ |$$ |\$$$ |$$ |      
 $$$$$$  |$$$$$$$$\  $$$$$$  |$$ | \$$ |$$$$$$$$\ 
 \______/ \________| \______/ \__|  \__|\________|
*/

/*
 OZONE - www.ozoneintel.com
 
 https://t.me/OZN_Ozone_Official
*/
...
contract OZONE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "O ZONE";
    string private constant _symbol = "OZONE";
    ...
    address payable private _marketingAddress = payable(0xda957A38431f2B7BEED62ADd36D6580391b312e6);
