...
contract Bunny_Rocket is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
  
  string public baseExtension = ".json";
  uint256 public cost = 0.05 ether;
  uint256 public maxBR = 1000;
  uint256 public maxMintAmount = 10;
  bool public paused = false;
  
  string public baseURI = "https://api.bunnyrocketnft.com/files/";

  constructor(
  ) ERC721("Bunny Rocket", "BR")
