...
contract BeanieBets is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_TOKENS = 5001;
    ...
    constructor(string memory baseURI) ERC721("WS Champs 2021", "BEAN") {
        setBaseURI(baseURI);
    }
    ...
    function mintMyBean(address _to, uint256 _count) public payable saleIsOpen {
        if (msg.sender != owner()) {
