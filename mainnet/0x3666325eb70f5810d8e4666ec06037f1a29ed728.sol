...
// 
//Developer Info: Art Intel Labs is an NFT project that is short for Artificial Intelligence Labs. It is the first web3 project to be fully created using AI technology. From the text to the images, everything on the platform is generated by artificial intelligence. The Little Ninjas NFT release from Art Intel Labs is the key to unlocking more unique and AI-powered releases from this innovative project. Get your hands on this must-have NFT and join the ranks of Art Intel Labs collectors. 
...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract TheLittleNinjasbyArtIntelLabs is ERC721A,DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("The Little Ninjas by Art Intel Labs", "TLN") {
  }
