...
contract GoblinTownDao is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmeJUQEH7Jo1QJ76zjdWBG215ZRnBL6uh7cU5GgkP4ndCJ";
    ...
    constructor(
    ) ERC721A("GoblinTownDao", "GoblinDAO", 100, maxSupply) {
    }
