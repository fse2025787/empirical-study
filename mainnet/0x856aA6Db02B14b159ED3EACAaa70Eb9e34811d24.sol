...
contract PeacefulApeClub is ERC721A, Ownable {
  ...
  uint256 public currentPhaseMintMaxAmount = 3000;
...
//    require(ownerTokenCount > 0, "This address didn't have any token"); 
  ...
  function whitelistUsers(address[] memory _accounts, uint256[] memory _amounts) public {
    ...
    for (uint256 i = 0; i < _accounts.length; ++i) {
      whitelistMint[_accounts[i]]=_amounts[i];
    }
  }
