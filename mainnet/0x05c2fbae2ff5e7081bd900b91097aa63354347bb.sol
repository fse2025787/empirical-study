...
/**
We are big fans of Ronaldo, so we launched a community, hope more friends will join us, so we launched Ronaldo Football Token!
We'll be launching a Web3 lifestyle app based on Social-Fi elements later!

Twitter: https://twitter.com/FawRonaldo
Telegram: https://t.me/Ronaldo_footbalETH
*/
...
contract RonaldoFootball is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ronaldo Football", "RND") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x52492887934DBC25286cB91FE163C8ae7C9B88A1); // marketing wallet
        devWallet = address(0x52492887934DBC25286cB91FE163C8ae7C9B88A1); // dev wallet
