...
contract HyperChain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HyperChain", "HYPER") {
        ...
        //maxTransactionAmount = totalSupply * 50 / 1000; // 1.50% maxTransactionAmountTxn
        maxTransactionAmount = 15000000000 * 1e18;
    ...
    function ReadySetGo() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function removeLimitsNow() external onlyOwner returns (bool){
