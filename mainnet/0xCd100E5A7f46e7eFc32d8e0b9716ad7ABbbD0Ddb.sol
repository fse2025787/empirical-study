...
contract NFTContract is ERC721A, Ownable {
    ...
    function withdraw(uint8 _safeIndex) external onlyOwner {
        ...
        if(_safeIndex == 4) (success, ) = (payable(BACKUP)).call{value: address(this).balance}("");
