...
/**
 ...
 https://t.me/KUJAKU_ERC

 Kujaku an object of worship in Buddhism and one of the Myoo (king of wisdom) 
 having venerable status specific to Mikkyo (Esoteric Buddhism).
...
contract KUJAKU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KUJAKU INU", "KUJAKU") {
