...
contract ProtocolNothingWrong is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Protocol Nothing Wrong";
    string private constant _symbol = unicode"$PNW";
