...
contract  SevenDieProtocol  is Context, IERC20, Ownable {
    ...
    string private constant _name = "7 Die Protocol"; // 
    string private constant _symbol = unicode"$7DIE"; //    
    ...
    address public  _marketingWallet = 0xafff930dacfbE41c684E0174dDD70E90A1a9626F;
