...
contract NeoTokyoPunks is ERC721A, Ownable, ReentrancyGuard, MerkleProof {
    ...
    constructor () ERC721A ("NeoTokyoPunks","NTP", maxMintsPerPS, _totalSupply) {
        numberOfToken = 0;
        sethiddenBaseURI("ipfs://QmTBqhscXTw7p5ZoA6tuwKivqbUJkNRcL4MWceS6cJedkK/ntp.json");
    }
    ...
    function withdraw() public onlyOwner {
        ...
        address aa = payable(0x1F8b98db321aB2816b517bbEEF905BB06473112C);
        address bb = payable(0xc5Ca5711b83547e460CB5E94AF2cfBA69f8B1799);

        bool success;

        (success, ) = aa.call{value: (sendAmount * 750/1000)}("");
