...
contract Catcat is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 10;
    uint256 public immutable supply = 24;
    ...
    address[] public withdrawAddresses = [0x43dD74e3A9C30e3a1cC11a0ec5c855Be6265cB13, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x43dD74e3A9C30e3a1cC11a0ec5c855Be6265cB13, _royaltyAmount);
    }
