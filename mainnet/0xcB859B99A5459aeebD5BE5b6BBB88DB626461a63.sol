...
/**
 * @title GrovebridgeFeeManager
 * @dev Implements the logic to distribute fees from the Grovebridge mediator contract operations.
 * The fees are distributed in the form of ERC20/ERC677 tokens to the list of reward addresses.
 */
contract GrovebridgeFeeManager is MediatorOwnableModule {
