...
Time for one of the most popular dog breed to take the shine it deserves

1.000.000 total supply
2% max wallet and transaction
5% final tax to support the project

Twitter: https://twitter.com/LabradorInuETH
Telegram: https://t.me/LabradorETH
**/
...
contract Labrador is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "LANU";
