...
// File: mintnft/AdventureIsland_v2.sol
...
contract AdventureIsland is ERC721A, Ownable{
    ...
    uint256 public constant MAX_ALLOW_PUBLIC_MINT = 5;
    uint256 public constant MAX_ALLOW_WHITELIST_MINT = 5;
    uint256 public constant PUBLIC_ALLOW_SALE_PRICE = 0;
    uint256 public constant WHITELIST_ALLOW_SALE_PRICE = 0;
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require(_quantity <= MAX_ALLOW_PUBLIC_MINT, "Adventure Island : Max mint is 5");
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_ALLOW_PUBLIC_MINT, "Adventure Island : Already minted 3 NFTs!");
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require(_quantity <= MAX_ALLOW_WHITELIST_MINT, "Adventure Island : Max mint is 5");
        require((totalWhitelistMint[msg.sender] + _quantity) <= MAX_ALLOW_WHITELIST_MINT, "Adventure Island : Cannot mint beyond whitelist max mint!");
        require(msg.value >= (WHITELIST_ALLOW_SALE_PRICE * _quantity), "Adventure Island : Payment is below the price");
