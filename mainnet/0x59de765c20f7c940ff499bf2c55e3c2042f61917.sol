...
/**
 * 
     Telegram : https://t.me/DeployerInuETH
    
     We've been working on an utility that will find new tokens related to
     old tokens. For example, if a wallet with a token that had 3million
     mcap deploys a new token, it'll appear in the public group to people
     who holds
*/
...
contract DeployerInu  is Context, IERC20, Ownable {
    ...
    string private _name = 'Deployer Inu';
