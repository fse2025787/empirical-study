...
/**
Human Only Art: $HOA
- You buy, we support NFT Collections from Human Artists.

Tokenomics:
- 5% of each buy/sell goes into supporting the NFT Collection of "Human Only Art".

Website:
https://humanonlyart.eth.limo

Twitter:
https://twitter.com/HumanOnlyArtNFT

Medium:
https://humanonlyart.medium.com
*/
...
contract HumanOnlyArt is Context, IERC20, Ownable {
  ...
  string private _name = 'Human Only Art';
  string private _symbol = 'HOA';
  ...
  address payable public _NFTWalletAddress;
  ...
  constructor(
    address payable NFTWalletAddress,
  ...
  function sendETHToTeam(uint256 amount) private {
    _NFTWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _setNFTWallet(address payable NFTWalletAddress) external onlyOwner {
    _NFTWalletAddress = NFTWalletAddress;
  }
