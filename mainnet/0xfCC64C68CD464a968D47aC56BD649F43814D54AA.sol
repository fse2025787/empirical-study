...
contract ETHForce1 is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("ETH Force 1", "EF1") {
  ...
  uint256 public constant PRICE = 161800000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.1618 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x5b4f0daf6D625A359dd7E961C288a998189c094A;

  function withdraw() public nonReentrant {
    uint256 balance = address(this).balance;

    Address.sendValue(payable(owner()), balance * 60 / 100);
