...
contract AlphaPanthers is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("AlphaPanthers", "ALP"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Panthers...");
