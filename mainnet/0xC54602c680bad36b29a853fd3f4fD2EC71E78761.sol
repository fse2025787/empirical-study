...
contract StealthXStarship is Context, IERC20, Ownable {
   ...
   address public _MarketingAddress = 0xf4622C41e1cC7C72A46b968D46387Ff1789F2E5d;
    ...
    string private _name = "Stealth X Starship";
    string private _symbol = "STEALTHX";
    ...
    uint256 public _maxTxAmount = 50000 * 10**16 * 10**9;
    ...
    function _takeDonation(uint256 tDonation) private {
        uint256 currentRate =  _getRate();
        uint256 rDonation = tDonation.mul(currentRate);
        _rOwned[_MarketingAddress] = _rOwned[_MarketingAddress].add(rDonation);
        if(_isExcluded[_MarketingAddress])
            _tOwned[_MarketingAddress] = _tOwned[_MarketingAddress].add(tDonation);
    }
