...
contract XynoTech is ERC20, Ownable {
    ...
    constructor() ERC20("XynoTech", "XTECH") {
        ...
        marketingWallet = address(0x41469dfF7FE1506CB0CC0F0846860c2B0bA60cdE); // set as marketing wallet
        buybackWallet = address(0x0385d8b4B008a8b7D9BB41aC4D8143F03e3dFc33); // set as buyback wallet
        lpWallet = address(0xDc258c953a629871954d738B2c5FD5B7d61eADc1); // set as lp wallet
