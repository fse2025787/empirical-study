...
contract FullDigiHLA is Ownable, ERC721A, MerkleWhitelist, ReentrancyGuard {
    ...
    // uint256 public WL_AMOUNT = 20;
    // uint256 public DA_AMOUNT = 30;
    // uint256 public MAIN_AMOUNT = 20;
    // uint256 public EXTRA_AMOUNT = 70;
    // uint256 public ALL_AMOUNT = 77;


    // uint256 public DA_STARTING_PRICE = 30 ether;

    // uint256 public DA_ENDING_PRICE = 10 ether;

    // uint256 public DA_DECREMENT = 2 ether;

    // uint256 public DA_DECREMENT_FREQUENCY = 30;

    // uint256 public DA_FINAL_PRICE;

    // uint256 public WL_PRICE = 1 ether;


    uint256 public WL_AMOUNT = 50;
    uint256 public DA_AMOUNT = 11;
    uint256 public MAIN_AMOUNT = 5;
    uint256 public ALL_AMOUNT = 100;


    uint256 public WL_START_TIME = 1650541500;
    uint256 public WL_END_TIME = 1650543600;

    uint256 public DA_START_TIME = 1650544800;
    uint256 public DA_END_TIME = 1650546600;

    uint256 public MAIN_END_TIME;
    //uint256 public MAIN_LAST_TIME = 10800;
    uint256 public MAIN_LAST_TIME = 6000;

    uint256 public EXTRA_START_TIME = 1650549600;
    ...
    string public UNREVEALED_URI =
        "https://ipfs.io/ipfs/QmQ4FynS6XxMcLq9mJ7yqBQqtLuHiU3TzFL2Pxp1z4WNUu";
    string public BASE_URI;

    string public CONTRACT_URI ="http://zeroip.rungame.net/test/contracturl.json";


    constructor() ERC721A("fulldigithla", "FDA") {}
    ...
    function wlInfo() public view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256) {
       return  (WL_AMOUNT,WL_MINTED,STATE,WL_PRICE,WL_START_TIME,WL_END_TIME,WL_WALLET_CAP[msg.sender],WL_LIMIT);
    }

    function daInfo() public view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256) {
       return  (DA_AMOUNT,DA_MINTED,STATE,currentPrice(),DA_START_TIME,DA_END_TIME,DA_WALLET_CAP[msg.sender],DA_LIMIT,DA_STARTING_PRICE,DA_ENDING_PRICE,DA_DECREMENT,DA_DECREMENT_FREQUENCY);
    }

    function mainInfo() public view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256) {
       return  (MAIN_AMOUNT,MAIN_MINTED,STATE,mainPrice(),0,MAIN_END_TIME,MAIN_WALLET_CAP[msg.sender],MAIN_LIMIT);
    }

    function extraInfo() public view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256) {
       return  (extraAmount(),EXTRA_MINTED,STATE,extraPrice(),EXTRA_START_TIME,0,EXTRA_WALLET_CAP[msg.sender],EXTRA_LIMIT);
    }
    ...
    function desirableInitialFunds() public view onlyOwner returns (uint256) {
        uint256 WLFunds = WL_MINTED * WL_PRICE;
        uint256 DAFunds = DA_MINTED * DA_FINAL_PRICE;
        uint256 MAINFunds = MAIN_MINTED * mainPrice();
        uint256 EXTRAFunds = EXTRA_MINTED * extraPrice();
   ...
   function withdraw() public onlyOwner nonReentrant {
    ...
    function setWlStartTime(uint256 wlTime,uint256 wlEndTime) external onlyOwner {
        WL_START_TIME = wlTime;
        WL_END_TIME = wlEndTime;
    }

    function setDaStartTime(uint256 daTime,uint256 daEndTime) external onlyOwner {
        DA_START_TIME = daTime;
        DA_END_TIME = daEndTime;
    }

    function setExtraStartTime(uint256 extraTime) external onlyOwner {
        EXTRA_START_TIME = extraTime;
    }
