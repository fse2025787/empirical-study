...
contract NotGoblintown is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;
  
  string  public  baseTokenURI = "ipfs://QmcYNfdKrheRj6uNVv4zhPyuvzokaiBLZNrq2rY5WZAwK6";
  uint256 public  maxSupply = 3333;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  FREE_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  TOTAL_FREE_MINTS = 700;
  bool public isPublicSaleActive = false;

  constructor(

  ) ERC721A("NotGoblintown", "NGT") {
