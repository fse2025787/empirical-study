...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0e9dd5B48CbFd742E6e987bD633e224313caD1f1];
  address public erc20Payable = 0x0e9dd5B48CbFd742E6e987bD633e224313caD1f1;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 220) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQSmk69CQQ2m1zmUkUB9W6e5PRZyJWoP1jGZr59J6y3RS/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Dn4LSoCBVe6YUNb0u9AG/contract-metadata";
  }
...
// File: contracts/WildWestAdventureContract.sol
//

pragma solidity ^0.8.0;

contract WildWestAdventureContract is RamppERC721A {
    constructor() RamppERC721A("Wild West Adventure", "WILD"){}
}
