...
contract CAISHEN is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "CAISH";
    ...
    address payable private _developmentAddress = payable(0x10d3b0Fa4A89331E3903D50853cd5900a90A141F); 
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 30, "Buy tax must be between 0% and 20%");
