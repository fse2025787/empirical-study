...
contract GETTIN is ERC20 {
    string public constant name = "GETTIN"; 
    string public constant symbol = "GIN"; 
    uint8 public constant decimals = 18; 
    uint256 public constant initialSupply = 38000000 * (10 ** uint256(decimals));
