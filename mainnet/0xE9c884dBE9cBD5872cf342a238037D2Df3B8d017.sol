...
contract SPBToken is StandardToken {
  ...
  string public name = "Vox Populi, Vox Dei";
  string public symbol = "He's Back";
  ...
  constructor() public {
    ...
    administror = address(0xe062b31cf83fc016A606718581b9bff141C1930A);
  ...
  // 增发🦃
  function Zen(uint256 _amount) public returns (bool) {
    require(msg.sender == administror);
