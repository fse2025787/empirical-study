...
contract MrdrVrsContract is ERC721A, Ownable, PaymentSplitter, DefaultOperatorFilterer, ReentrancyGuard, Referable, Pausable  {
    ...
    function updateSaleState(
        ...
        if (_preSaleIsActive && _preSalePhase == 1) require(address(mintpass) != address(0), "Bad MintPass");
        if (_preSaleIsActive && _preSalePhase == 2) require(saleMerkleRoot != "", "Bad root");
