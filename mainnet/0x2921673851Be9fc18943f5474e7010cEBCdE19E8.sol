...
contract ProjectMOTOYO is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public wlPrice = 0.0066 ether;
  ...
  uint256 public maxWLSupply = 666;
  ...
  constructor() ERC721A('ProjectMOTOYO', 'PMT') {
  ...
  function publicMint(uint256 _quantity) external payable {
    ...
    if (msg.sender != owner()) {
      require(balanceOf(msg.sender) + _quantity <= maxTx, 'Max mint per wallet exceeded!');
