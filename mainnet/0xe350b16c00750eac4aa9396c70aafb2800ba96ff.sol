...
// Main Contract Logic 
// --------------------------------------------------------------
contract FlokianaInu is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Flokiana Inu";
    string private _symbol = "FLOKIANA";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 1 * 1e9 * 1e18;    
    uint256 private minimumTokensBeforeSwap = 900000e18;    

    // Restrictions
    uint256 public _maxTxAmount = 10000000e18;      
    uint256 public _walletMax = 10000000e18; 
    bool public checkWalletLimit = true;
    
    // wallets
    address payable public liquidityWallet = payable(owner());
    address payable public operationsWallet =  payable(0xf94669E3a0517744cdBB410328825e529809CD9e);
    address payable public operationsWallet2 =  payable(0xf94669E3a0517744cdBB410328825e529809CD9e);
    ...
    uint256 public operationsFeeSell = 8;
