...
contract KomodoDragon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Komodo Dragon"; //
    string private constant _symbol = unicode"KOMODO"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x8743C02e7cAc1a29FA0D06c6544Db10B1b872732;
