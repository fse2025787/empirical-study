...
contract RAPTOR2 is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "RAPTOR 2";
    string constant _symbol = "RAPTOR";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xce7Aa0D743B0A1f0DFe92C37D08209b8aF5252E0);
	    teamFeeReceiver = address(0xdAEe0F1a22144a48ec73cC5ab0Cf481363BC8687);
