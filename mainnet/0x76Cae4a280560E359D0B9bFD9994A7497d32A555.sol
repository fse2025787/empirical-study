...
//
/**
Bubble Buy Bot knows about new token launch before everyone else

Join our Telegram group at https://t.me/bubbleinu

Token Name: Bubble Inu (BUBBLE)
...
contract BubbleInu is Context, IERC20, Ownable {
	...
	string private constant _name = "Bubble Inu";
	string private constant _symbol = "BUBBLE";
	...
	function reduceTax(uint256 newTaxRate) public onlyOwner{
