...
contract KASOTSU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Kasō Tsuka";
    string private constant _symbol = "KASOTSU";
