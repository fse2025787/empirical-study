...
/**
Akashic Inu is the key to the door of wealth that will take you to decipher the higher intelligence that controls life in the universe.

TG:https://t.me/AkashicInu
*/
...
contract AkashicInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Akashic Inu", "AKASHICINU") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xE4Dca2851259325b1991f2120A8c4FE3e06840e6); // marketing wallet
        devWallet = address(0xE4Dca2851259325b1991f2120A8c4FE3e06840e6); // dev wallet
