...
contract ToeBeans is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner {
        (bool os1, ) = payable(0xed08Ad1bb4916450b11633f577E93C5bB2E2eEF6).call{value: address(this).balance * 5 / 10}("");
        require(os1);
        (bool os2, ) = payable(0x642B322F32f7D59EB25Cd6152D6bBA85BB55025A).call{value: address(this).balance * 5 / 10}("");
        require(os2);
    }
    ...
    function isApprovedForAll(address owner, address operator) public override view returns (bool) {
        if (openSeaRegistryAddress != address(0) && address(ProxyRegistry(openSeaRegistryAddress).proxies(owner)) == operator) {
            return true;
        }
