...
//   / / / / //_/____  / __/ /_   /_  __/__  _____/ /_
//  / / / / ,<  / __ \/ /_/ __/    / / / _ \/ ___/ __/
// / /_/ / /| |/ / / / __/ /_     / / /  __(__  ) /_  
// \____/_/ |_/_/ /_/_/  \__/    /_/  \___/____/\__/  
//                                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1f1A8679Dfae782D35d73d81E6A11012F5cd40DC];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x1f1A8679Dfae782D35d73d81E6A11012F5cd40DC;
...
// File: contracts/UKnftTestContract.sol
//

pragma solidity ^0.8.0;

contract UKnftTestContract is RamppERC721A {
    constructor() RamppERC721A("UKnft Test", "UKnft"){}
}
