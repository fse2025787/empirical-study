...
contract ShibChad is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ShibChad", "ShibChad") {
        ...
        _fees.sellContestAIFee = 0;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellContestAIFee;


        marketingWallet = address(0x66852d7c3E2723Da1bEbeC77eCeCeF82BEa18Be1);
        contestAIWallet = address(0x66852d7c3E2723Da1bEbeC77eCeCeF82BEa18Be1);
