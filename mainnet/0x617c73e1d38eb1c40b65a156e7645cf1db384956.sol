...
Let's create the telegram group, I will found you.

Pretty low tax, only 2%. This 2% will be used for dextools trending at a high MC and for marketing.

Ownership will be renounced at launch & LP will be locked for 2 weeks & extended.
...
contract CommunityETH is Context, IERC20, Ownable {
    using SafeMath for uint256;

    uint256 MAX_INT =
        115792089237316195423570985008687907853269984665640564039457584007913129639935;
    string private constant _name = "CommunityETH";
    ...
    uint256 _totalSupply = 696969696969 * 10**9;
    ...
    uint256 public _maxTxAmount = 10454545454 * 10**9; // 1%
    uint256 public _maxWalletSize = 20909090909 * 10**9; //3%
    uint256 public _swapTokensAtAmount = 696969696 * 10**9; //0.1%
