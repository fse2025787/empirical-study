...
contract UndeadBoki is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI           = "ipfs://QmbyUifCWRtM1Lcndp2gDfgL3euFf2BoYKBgocxkyoQYD3/";
  string public        contractURI       = "ipfs://QmbrqysZha1TMjbLfdKM2WXTaonvPn7gVo6o4S5TDHueqi";
  uint public          price             = 0.002 ether;
  uint public          maxPerTx          = 10;
  uint public          maxPerWallet      = 100;
  uint public          maxPerFreeTx      = 2;
  ...
  constructor() ERC721A("Undead Boki", "UB"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    if(totalSupply() + amt < totalFree + 1) {
      cost = 0;
      require( amt < maxPerFreeTx + 1, "Max per free TX reached.");
    }
