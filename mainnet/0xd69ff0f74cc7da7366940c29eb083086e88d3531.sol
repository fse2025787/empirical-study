...
contract Taxable is Ownable {
    ...
    address payable private m_ExternalServiceAddress = payable(0xf1473786BC5028c26d27821d36EDCbF5a629A581);
...
contract KIRBY is Context, IERC20, Taxable {
    ...
    address payable m_EthReflectSvcAddress = payable(0xcb343dD16088281dEe4553e1ea7bDf1091C64705);
