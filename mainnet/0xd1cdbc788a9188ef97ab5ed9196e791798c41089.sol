...
contract stonedanimalzoowtf is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qme5aBThsGS87hGGSqb8jTtRfYP9NjmhbmS9yVQA6w6zGn";
    ...
    constructor(
    ) ERC721A("stonedanimalzoo.wtf", "WTF", 100, maxSupply) {
    }
