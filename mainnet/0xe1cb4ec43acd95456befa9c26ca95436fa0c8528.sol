...
/* 
     ...
     CRIMA PROVIDES A PROPRIETARY WATCHDOG PLATFORM 
     THAT ENCOURAGES INVESTOR SAFETY WITH THE GOAL 
     OF FOSTERING BETTER HABITS IN THE DEFI SPACE. 

     https://www.crima.pro/
     https://medium.com/@crima_eth/crima-v-0-5-def-2120ed5e6655
                    ______
                 .-'      `-.
               .'            `.
              /                \
...
contract CRIMAToken is ERC20, Ownable {
    ...
    constructor() payable ERC20("CRIMA Token", "CRIMA") {
        ...
        operationsAddress1 = address(0x0D0248b07EFF45127c0C7492D29F42eF993061EE); //80%
        operationsAddress2 = address(0x0D0248b07EFF45127c0C7492D29F42eF993061EE); //20%
        lpReceiverAddress = address(0x0D0248b07EFF45127c0C7492D29F42eF993061EE);
