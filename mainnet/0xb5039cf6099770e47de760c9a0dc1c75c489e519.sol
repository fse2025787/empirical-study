...
contract DEENFT is ERC721Pausable, Ownable {

    mapping(address => bool) private _minters;
    uint256 public _maxTotalSupply;

    constructor() public ERC721("DeesseCard", "Card") {
    ...
    function mint(address player,uint256 tokenId) external onlyMinter returns (uint256) {
        require(totalSupply() < _maxTotalSupply, "DEENFT: total supply is error");
