 ...
 */
contract UniswapStrategy is BasePairLPStrategy {
  using SafeERC20 for IERC20;
  ...
  string public constant name = "Ondo UniswapV2 Simple Strategy";
  ...
  function addVault(
    ...
    vault_.pool = IERC20(
      UniswapV2Library.pairFor(uniFactory, address(_senior), address(_junior))
    );
