...
contract GHIDORAH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ghidorah";
    string private constant _symbol = "GHIDO";
    ...
    address payable private _developmentAddress = payable(0x18C08A6d1CEe23Ed0422Ab59A1dd96835ea8d9db); 
    address payable private _marketingAddress = payable(0x53F0377d1C331812c41d6258E7b5bf726e2D54e9);
