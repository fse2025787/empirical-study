...
/*
Only the patient will discover Nothing

https://t.me/NothingPortal

https://medium.com/@nothingtoken/nothing-token-nihil-c6738229565e
...
contract NothingToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Nothing Token";
    string private _symbol = "nihil";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x85F9c875Bc1bd63Ae314b80CDA1D89E96F3c80e1);
    address payable public DeveloperWallet = payable(0xF24a593BfB3Dffd539e12eF9192981B568626e22);
