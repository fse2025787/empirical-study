...
contract MyToken {
   ...
   uint  public decimals;  // ERC20标准，decimals 可以有的小数点个数，最小的代币单位18,是建议的默认值
    ...
    * 初始化构造
    */
   constructor(uint256 _initialSupply, string memory _tokenName, string memory _tokenSymbol, uint _decimals){
