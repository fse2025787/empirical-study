...
Website: https://block-capital.net/
TG: @blockcapital_eth
...
contract BlockCapital is Context, IERC20, Ownable {
    ...
    string private constant _name = "Block Capital";
    string private constant _symbol = "BlockCapital";
