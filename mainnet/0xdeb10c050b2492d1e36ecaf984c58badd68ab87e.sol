...
contract GovManager is Ownable {
    ...
    function setGovernerContract(address _address) external onlyOwner {
...
contract CryptoApeArtClub is ERC721, GovManager {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoApeArtClub", "CAArtClub") {
    setHiddenMetadataUri("ipfs://QmSZiCRKyXHz6vr4xj6JoyRoSHXeWYw4ADwJawrpZakSxR/hidden.json");
  }
