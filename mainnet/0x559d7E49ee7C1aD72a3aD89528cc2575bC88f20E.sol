...
contract BabyWeR1 is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xBEA71cb36226D6A9a09dF4f6CFbfE9C97d981679);
    ...
    constructor() ERC20("Baby Protectors of the realm", "BabyWeR1") {
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 0.3% maxTransactionAmountTxn
