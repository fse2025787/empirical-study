...
contract Goblindeeznuts is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint256 public SALE_START = 1654027200; // May 31, 2022 15:00 CST

    bool public isPaused = false;

    mapping(address => uint256) private _generalClaimed;
    string public baseTokenURI;
    event CreateGoblindeeznutsNFT(uint256 indexed id);

    constructor(string memory baseURI) ERC721A("goblindeeznuts.wtf", "GBZ") {
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        emit CreateGoblindeeznutsNFT(_count);
    ...
    function airdropNFT(address[] memory winners) public onlyOwner {
        ...
        for (uint256 i = 0; i < winners.length; i++) {
            ...
            emit CreateGoblindeeznutsNFT(1);
        }
    }
