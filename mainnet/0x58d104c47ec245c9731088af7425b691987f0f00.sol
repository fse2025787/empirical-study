...
$LAEEB (LAEEB MASCOT) is a meme token to celebrate the best world cup mascot that ever existed,
his kindness and cuteness are just other level.

   https://laeebmascot.xyz/
   https://twitter.com/LaeebMascotETH
   https://t.me/LaeebMascotEth
...
contract LaeebMascot is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xF021d3607fbe86bfEC44188CC12bAE53cA811A0E); 
    address payable public devWallet = payable(0xA0036e0141F8324A24775468022e0f0e2b08aE7a);
    ...
    constructor() ERC20("Laeeb Mascot", "LAEEB") {
