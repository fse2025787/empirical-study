...
This new Pulse meme / meta is hot
Hope on the train
chocochoo
...
contract PulseBabyDoge is ERC20, Ownable {
    ...
    constructor() ERC20("PulseBabyDoge", "PLBD") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0x4c83Db55bA4dBBDb7f742C32eBbFE2469A96442A); 
