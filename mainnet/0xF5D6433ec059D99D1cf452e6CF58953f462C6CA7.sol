...
contract PositionRouter is BasePositionManager, IPositionRouter {
    ...
    function _executeIncreasePosition(bytes32 _key, address payable _executionFeeReceiver) private returns (bool) {
    ...
    function _executeDecreasePosition(bytes32 _key, address payable _executionFeeReceiver) private returns (bool) {
    ...
    function _createIncreasePosition(
        ...
        _executeIncreasePosition(requestKey, payable(this.gov()));
        return requestKey;
    }
    ...
    function _createDecreasePosition(
        ...
        _executeDecreasePosition(requestKey, payable(this.gov()));
        return requestKey;
    }
