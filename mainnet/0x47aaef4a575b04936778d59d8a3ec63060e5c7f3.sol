...
contract KickStart is ERC20, Ownable {
    ...
    function maxHoldings() public view returns(uint256){

        uint256 max = (circulatingSupply() * _maxHoldings) / 100;
    ...
    function _transfer(
        ...
        if (sender == _pairAddress) {
            ...
            require(balanceOf(recipient) + amount < maxHoldings());
