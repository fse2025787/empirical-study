...
/**
LastVerse ($LSV) is a decentralized community token that will generate passive income and capital growth for its holders through various streams, 
such as profits returned in the form of token redistributions, 
token buy backs and dividends from investments made not just limited to DeFi but also NFTs and Metaverse Land.

visit us
https://t.me/LastVerseETH
https://www.twitter.com/LASTVERSE_ETH
*/
...
contract LastVerse is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LastVerse", "LSV") {
