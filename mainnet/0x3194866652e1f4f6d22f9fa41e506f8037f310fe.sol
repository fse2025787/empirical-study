...
contract ChengPengZhao is IERC20, Ownable {
    ...
    string constant _name = "Crypto King";
    string constant _symbol = "ChengPengZhao";
    ...
    constructor () {
        ...
        marketingFee = 50;   // to prevent bots at launch
        totalFee = marketingFee;       // to prevent bots at launch
        totalBuyFee = 4;     // to prevent bots at launch
    ...
    function swapBack() internal swapping {
        uint256 dynamicLiquidityFee = liquidityFee > 0 ? 0 : 0;
