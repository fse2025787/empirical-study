...
contract SC is ERC721A, Ownable, ReentrancyGuard, ControlledAccess {
    ...
    string public hiddenMetadataUri = "https://gateway.pinata.cloud/ipfs/QmU92E94fi73DwB6EWYPuFmGMk7WsAr3GeAdiXBkeW2hvj";
    ...
    function addWhitelistGroup(address[] memory userList) public onlyOwner {
        require(userList.length > 0 , "Empty user list");
        require(whitelistCount + userList.length < whitelistSpots, "Full of whitelist");
    ...
    function removeWhitelistGroup(address[] memory userList) public onlyOwner {
        require(userList.length > 0 , "Empty user list");
