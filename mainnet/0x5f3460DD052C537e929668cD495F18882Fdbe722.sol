...
3/6 initial tax - 0/0 tax on 10k mcap
will lock for 100 days

https://t.me/SetsukoERC20
...
contract Setsuko is Context, IERC20, Ownable {
    ...
    string private constant _name = "Snow Child";
    string private constant _symbol = "Setsuko";
    ...
    uint256 private maxWalletAmount = 50000001 * 10 ** _decimals;
    uint256 private maxTxAmount = 50000001 * 10 ** _decimals; 
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x6C4CBB4862252711dea50AFD5A30CeDc0430405C); //marketing wallet
    ...
    function SetWalletandTxtAmount(uint256 _maxTxAmount, uint256 _maxWalletSize) external onlyOwner{
      ...
      function RervertTaxToZero() external onlyOwner {
