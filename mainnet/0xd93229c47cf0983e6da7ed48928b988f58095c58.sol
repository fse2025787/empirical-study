...
// Audits
// Last passed audits
// Mythrill: 5, 2/22/2022
// MythX:
// Optilistic :

contract AfterpartyPass is ERC1155PresetMinterPauser {
    ...
    |        MAIN CONSTRUCTOR           |
    |__________________________________*/
    constructor() ERC1155PresetMinterPauser("https://nft.afterparty.ai/nft_metadata/2/{id}.json") {
        contract_owner = payable(msg.sender);
        name = "Afterparty Pass";
        symbol = "APP";
        // TODO: For testing -- Afterparty Pass collection
        //createCollection(0x4166746572706172747920506173730000000000000000000000000000000000, 1, 100, "https://nft.afterparty.ai/nft_collection_metadata/2.json", 1500, 90, contract_owner);
    }
    ...
    function mintPass(address _to, uint256 collectionId, bytes memory _data) public payable onlyWhenEnabled {
        ...
        // Split minting value
        uint artistFraction = collections[collectionId].artistPayablePercent;
    ...
    function nftUri() public pure returns (string memory) {
        string memory baseMetadataURI = "https://nft.afterparty.ai/nft_metadata/2/{id}.json";
