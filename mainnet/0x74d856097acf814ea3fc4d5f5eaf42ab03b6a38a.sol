...
// Celebrating the opening of Welly! The SHIB burger joint!
// Join our telegram https://t.me/ShibWelly
// 
...
contract WELLY is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibWelly";
    string private constant _symbol = "SHIBWELLY";
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0xf664994048A8B8C8110EAe7d5191b9Dc31c878E0);
        _feeAddrWallet3 = payable(0xD48050E96b21CE911EF1f97AB952af63Bdbac0F9);
        _tOwned[address(this)] = _tTotal.div(100).mul(96);
        _tOwned[address(0x10f306cbfCCf8524165baFDc53B95ede971b6e79)] = _tTotal.div(100).mul(2);
        _tOwned[address(0xf664994048A8B8C8110EAe7d5191b9Dc31c878E0)] = _tTotal.div(100).mul(1);
        _tOwned[address(0x5Ec23EEE4d32Ae3367A37331cbb192d3bfb36F37)] = _tTotal.div(100).mul(1);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[0x10f306cbfCCf8524165baFDc53B95ede971b6e79] = true;
