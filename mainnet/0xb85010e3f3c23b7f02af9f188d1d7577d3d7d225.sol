...
contract stephanie is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    uint256 public mintCost = 0.006 ether;
    ...
    constructor () ERC721A("stephanie by PHOGUE", "STEPHANIE") {
    }
    ...
    function mintStephanie(uint256 mintAmount) public payable callerIsUser nonReentrant {
