...
contract SOSOxNTPSoundSource is ERC721A, Ownable {
    using Strings for uint256;
    address public admin;   // Upgradable admin (only by owner)

    uint256 public maxSupply = 300;
    string public baseURI = "ipfs://Qmbm6Wz5GcTVpbzvBF8TeAycXAQjE5mpfXtNmwcDUZL9ER/";
    string public baseExtension = ".json";

    constructor() ERC721A('SO-SO X Neo Tokyo Punks Sound Source', 'SO-SO X NTP Sound Source') {
        admin = owner();
    }
