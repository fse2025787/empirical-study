...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Chipz";
    string public constant TOKEN_SYMBOL = "CHPZ";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x824B7d38B0b4ae71909B0fbB62f36Ce4FC7Fd879;
    
    uint public constant START_TIME = 1621600202;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(300000 * TOKEN_DECIMAL_MULTIPLIER, 0x824B7d38B0b4ae71909B0fbB62f36Ce4FC7Fd879, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1622779140)
        CappedCrowdsale(83333333333333333333)
        
        RefundableCrowdsale(50000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[3] memory addresses = [address(0x597a86d0e5b7e7f45c3bb93c0ddd67ce5081b6c5),address(0x58ce065eaf75c2759e7db256f0ca98b7b6cf741b),address(0xa2df767c342335d9d3a1a73818aafcda0c3c9819)];
        uint[3] memory amounts = [uint(10000000000000000000000000),uint(15000000000000000000000000),uint(50000000000000000000000000)];
     ...
     */
    function hasClosed() public view returns (bool) {
        bool remainValue = cap.sub(weiRaised) < 150000000000000000;
