...
// 
// https://medium.com/@TENBU/tenbu-40ec5ec72fe3
...
contract TENBU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tenbu", "TENBU") {
        ...
        marketingWallet = address(0x0Af68Ff5d7825e039d834EAe112a0B76ee07470C); // set as marketing wallet
        ...
        lockTokens(owner(), true);
        lockTokens(address(this), true);
        lockTokens(address(uniswapV2Pair), true);
    ...
    function lockTokens(address account, bool excluded) public onlyOwner {
