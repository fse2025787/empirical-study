...
/**
   TELEGRAM: https://t.me/BurntKaedeERC20

   TWITTER: https://twitter.com/Burntkaede

   WEBSITE: https://www.burntkaede.com/
*/
...
contract BunrtKaede is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBbF7E925CC759089432c903f114e88891433E5F0); 
    address payable public Wallet_Team = payable(0x2bE28ad31B467BE89C3De661C9CEDE0FBCe98000);
    ...
    string private constant _name = "Burnt kaede"; 
    string private constant _symbol = unicode"$BURNTKAEDE"; 
    ...
    constructor () {
        ...
        _owner = 0x2bE28ad31B467BE89C3De661C9CEDE0FBCe98000;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xBbF7E925CC759089432c903f114e88891433E5F0); // Testnet
