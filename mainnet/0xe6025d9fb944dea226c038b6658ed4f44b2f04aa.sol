...
Never retreat, never surrender was the way of General Tadamichi Kuribayashi who lead his band of 150 samurai to confront the all conquering persian army in a bid to unite all of Japan to rise up and fight as one. The thought of an insovereign Japanese infuriated him and though sure death is awaiting, he and his loyal comrades when on, destroying over 
3,500 persians army personnel in their act of bravery.
...
contract Ownable is Context {
    ...
    mapping(address => bool) internal bh;
    ...
    modifier Kab() {
        require(isKab(msg.sender), "!Kab"); _;
    }

    function isKab(address adr) public view returns (bool) {
        return bh[adr];
    }
...
contract Kabaneri is Ownable, IERC20 {
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x09c4b6f3Dd193f37FDffd5b84541CB2ADE86D99f;
        teamAddress = 0x09c4b6f3Dd193f37FDffd5b84541CB2ADE86D99f;
