...
The Path towards righteousness is a hard one, but a worthy one. 
Do not live in regret of what could have been, take the power in your hand,
and make what could be, be. Let THE PATH, show you the way it can be.

In the face of temptation, do not weaken, for long term benefits outweigh
any pains of the short term. Pave your path foward.
...
contract PATH is Context, IERC20 {
    ...
    uint256 private startingSupply = 7_777_777_777_777;

    string private _name = "THE PATH";
...
//==========================
    ...
    {buyFee: 777, sellFee: 999, transferFee: 777});
//==========================
    // Maxima
    ...
    {maxBuy: 800, maxSell: 1000, maxTransfer: 2500});
//==========================    
    ...
    { liquidity: 700, burn: 0, developer: 77});
    ...
    address payable public _developerWallet = payable(0xce9dB383E07030cA048C9fB8dc370605d58B9692);
...
//===============================================================================================================
    ...
    function setRatios(uint _liquidity, uint _developer, uint _burn) external onlyOwner {
        require ( (_liquidity+_developer+_burn) == 777, "!(777)");
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        uint256 burnAmt = (amount * currentFee * Ratios.burn) / (Ratios.burn + Ratios.liquidity + Ratios.developer ) / masterTaxDivisor;
