...
contract SpaceSamurai is ERC721Enumerable, Ownable {
  ...
  uint256 public presaleMaximumAllowedTokensPerWallet = 10;
  ...
  function preSaleMint(uint256 _count) public payable saleIsOpen {
    ...
    require(_count <= presaleMaximumAllowedTokensPerWallet, 'Cannot purchase this many tokens');
