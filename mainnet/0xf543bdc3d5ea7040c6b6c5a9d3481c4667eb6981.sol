...
contract Consts {
    ...
    string public constant TOKEN_NAME = "SWAPIT";
    string public constant TOKEN_SYMBOL = "SWIT";
    bool public constant PAUSED = false;
    address public constant TARGET_USER =
        0x181B0f00863CF5D2b5d39c38a8b4fCd79307b14A;
}

contract SWIT is Consts, FreezableToken, BurnableToken, Pausable {
    event Initialized();
    ...
    function init() private {
        ...
        address[1] memory addresses =
            [address(0x181B0f00863CF5D2b5d39c38a8b4fCd79307b14A)];
        uint256[1] memory amounts = [uint256(1000000000000000000000000000)];
