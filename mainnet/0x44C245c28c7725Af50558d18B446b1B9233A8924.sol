...
contract Moondickbuttbirds is ERC721A, Ownable {
    ...
    address MoonDick = 0x02f637b0B40b9e40E950Fa2bf90B4757709c47b6;
    address ButtBird = 0x714797e241B2e0761f8934936aFc793AF835bCef;

    mapping(address => uint) public mintedByAddress;

	constructor() ERC721A("Moondickbuttbirds", "DickBirds") {}
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(payable(MoonDick).send(_share * 50));
        require(payable(ButtBird).send(_share * 50));
    }
