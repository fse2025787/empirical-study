...
contract MurakamiSuns is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmdrpwDGxdd3qTNiUtvArTLwhJ1ESYJeT8RBJS4FVqvFJH";
  uint256  public  maxSupply = 3333;
  uint256 public  MAX_MINTS_PER_TX = 20;
  uint256 public  PUBLIC_SALE_PRICE = 0.002 ether;
  uint256 public  NUM_FREE_MINTS = 333;
  uint256 public  MAX_FREE_PER_WALLET = 20;
  uint256 public freeNFTAlreadyMinted = 0;
  bool public isPublicSaleActive = false;

  constructor(

  ) ERC721A("Murakami Suns", "MURAKAMISUNS") {
