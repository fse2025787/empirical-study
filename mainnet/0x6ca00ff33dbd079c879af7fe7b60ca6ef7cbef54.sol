...
contract TomBradyInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Tom Brady Inu";
    string private constant _symbol = "BRADY";
    ...
    address payable public marketingWallet = payable(0xEf3dfdA53375CeBa13e1021A70629C00FfE49f28);
    address payable public treasury = payable(0x4da6f4353C99526ed2DEc37e4a1F95678d2bA5e1);
