    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.skyskaters.xyz/";
...
// File: contracts/SkySkatersThebeginningContract.sol
//

pragma solidity ^0.8.0;

contract SkySkatersThebeginningContract is RamppERC721A {
    constructor() RamppERC721A("Sky Skaters The beginning", "SKY"){}
}