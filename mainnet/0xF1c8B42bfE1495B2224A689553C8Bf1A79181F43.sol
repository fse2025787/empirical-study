...
GROGUINU Socials:
Telegram: https://t.me/groguinu
Twitter: https://twitter.com/groguinu
Website: https://groguinu.com/
Whitepaper: https://groguinu.com/downloads/GROGUINU-Whitesaber-Paper-v1.pdf
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x68f4c5da1F7881f785e918bdB4EbB6F3A5E91b85), 1000);
		setTaxAlloc(payable(0x3d15F078f059c465FD60A93Fb62fd7DC091AF666), 1000);
		setTaxAlloc(payable(0x697fD67B8C2857151397449C786c26E6bA6A98F6), 1000);
...
contract GROGUINU is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "GROGUINU";
    string private m_Symbol = "GRGU";
    ...
    constructor () {
        ...
        ILO.init(20000000000000000000, 2000, 500, 100000, m_ILOPublic);
        initTax();
    ...
    function _checkTX() private view returns (uint256){
        if(block.timestamp <= m_Launched.add(9 minutes))
