...
contract AMorbidMenagerie is ERC721A, Ownable, ERC2981 {
    uint256 public price = 0.024 ether;
    uint256 public presalePrice = 0.012 ether;
    ...
    address[] public withdrawAddresses = [0x53593AF7E943168eE588bae830ac2Db8b0A275Ed, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xd4274d692d9a6a8e97e54a007f1619b79e5fdaa5a69621dd43a897ed7f4434fe;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x53593AF7E943168eE588bae830ac2Db8b0A275Ed, _royaltyAmount);
    }
