...
contract BelugaCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("BelugaCoin", "BELUGA");
        __ERC20Burnable_init();
        __ERC20Permit_init("BelugaCoin");
        __ERC20Votes_init();
        __Ownable_init();
