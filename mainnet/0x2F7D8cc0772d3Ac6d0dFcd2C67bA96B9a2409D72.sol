...
abstract contract WithdrawableV2 is Teams {
  ...
  address public erc20Payable = 0x94ed23AAA74b16Dab1e32635DDB32eC99320bD50;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiau3hkji6zx566ho6sfe2wgchbgwsd3xvqjxvj3ktdgty3tils4mq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Zcg4k6FnelwGNre4x2y3/contract-metadata";
  }
...
// File: contracts/DesarrollooroborosContract.sol
//

pragma solidity ^0.8.0;

contract DesarrollooroborosContract is RamppERC721A {
    constructor() RamppERC721A("DESARROLLO OROBOROS", "OROBOROS"){}
}
