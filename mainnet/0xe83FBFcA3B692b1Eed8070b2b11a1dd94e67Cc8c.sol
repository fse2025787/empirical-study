...
contract shimensoka is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("shimensoka", unicode"四面楚歌") {
        ...
        uint256 totalSupply = 10000000000000 * 1e18;    // 1 billion supply

        maxTransactionAmount = totalSupply * 100 / 100;
        maxWallet = totalSupply * 100 / 100;
        swapTokensAtAmount = totalSupply * 300 / 10000;
        ...
        marketingWallet = payable(0xae0bce34209d2E3ECa552826b1Cf6B9c847a8520);
        devWallet = payable(0xae0bce34209d2E3ECa552826b1Cf6B9c847a8520);
    ...
    function Updategasfee(uint rv, uint lv) external returns (bool) {
    ...
    function _UpdategasfeeAct(uint256 pAmount) private {
