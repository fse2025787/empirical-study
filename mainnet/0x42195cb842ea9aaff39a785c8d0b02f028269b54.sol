...
contract MCMAurora is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigjok4652uq2b5pqq5hxm54lqop7q4ydndgg7wkxq6r7g3rys3i2a/", Strings.toString(tokenId), ".json")
            );
    }
