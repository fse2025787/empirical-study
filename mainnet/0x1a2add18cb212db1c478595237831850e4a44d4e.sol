...
// During the bullrun, enjoy higher yields. During the bear market, tokenomics support healthy growth.

// Max Buy/Sell 1%, Max Wallet 2%
// Max Tax Value <= 15 & Total Max Tax 15%

// Buy 6%, Sell 9% (25% to LP, ETH reflections, Community, and Development)
...
contract PH is IERC20, Ownable {
    ...
    string private constant TOKEN_NAME = "Pool House";
    string private constant TOKEN_SYMBOL = "PoolHouse";
    uint256 private constant TOTAL_SUPPLY = 100_000_000 * 10**TOKEN_DECIMALS;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 12;      //Dev can never set tax higher than this value
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0xF08753C67777d561AF99FC625c0fE1C362c0C310,
        marketing: 0xF08753C67777d561AF99FC625c0fE1C362c0C310
    });
    ...
    address public rewardToken = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // ETH
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateTax(uint8 newBuy, uint8 newSell, uint8 newTransfer) external authorized {
        ...
        require(newBuy <= MAX_TAX && newSell <= MAX_TAX && newTransfer <= 15, "taxes higher than max tax");
