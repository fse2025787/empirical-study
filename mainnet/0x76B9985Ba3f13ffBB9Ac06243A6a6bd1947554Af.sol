...
Once in a blue moon, a saying we all know. This happens when a rare event occurs unexpectedly. 
Kagome is a representation of blessing, love on Japanese culture. 
Kagome-hime the elder sister of Kaguya arrives on ETH (Earth) to vanquish the remaining Larp on the block-chain.

Kagome-Hime カゴメ姫 Official Links

🌐 Website: https://kagomehime.com

🐦 Twitter: https://twitter.com/KagomeHimeErc

📖 Medium: https://medium.com/@kagomehime

JOIN OUR COMMUNITY: https://t.me/kagomehime
...
contract KAGOME is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kagome Hime", "KAGOME") {
