...
contract RS is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
...
uint256 public devTotal;
    ...
    constructor(string memory initBaseURI) ERC721A("R0ck Skull3", "RS") {
        baseURI = initBaseURI;
    }
