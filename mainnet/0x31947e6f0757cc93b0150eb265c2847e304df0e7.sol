...
contract MetalFriends is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Metal Friends","MFS") {
        ...
        maxTransactionAmount = totalSupply * 100 / 1000; // 1%
        ...
        marketingWallet = 0x4758171c7dB02c0429697c5C88E6B18B9C1Be683; // set as marketing wallet
        devWallet = 0x4758171c7dB02c0429697c5C88E6B18B9C1Be683; // set as dev wallet
