...
Crpto Punks are on Holidays
and there is no one to take their space

Hence ,this is where Holiday Punks comes
*/
...
contract HolidayPunks is ERC20, Auth {
    ...
    string constant private _name = "Holiday Punks";
    string constant private _symbol = "HPUNKS";
