...
contract Ogreland is ERC721, Ownable {
  ...
  constructor() ERC721("Ogreland", "OGRE") {
    setHiddenMetadataUri("ipfs://QmY1yHhe5N5kkBBm9LjgX9oexsC9SCCaSji3r9ERxfPvk5/hidden.json");
  }

  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
    require(supply.current() + _mintAmount <= maxSupplyPublic, "Max Public supply exceeded!");
    _;
  }
