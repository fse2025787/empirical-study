...
// File contracts/verification/BalanceChecker.sol
...
contract BalanceChecker {
    ...
    function verifyBalance(IERC20Upgradeable token, address holder, uint256 minBalance) public {
        require(token.balanceOf(holder) >= minBalance, "Min expected balance not met");
    }
}