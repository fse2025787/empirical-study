...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x13f2FdB4Cb668E4B7A33746bb0DfBd4c33BF9423];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 50, 1000000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSDUn81z1YsoR5ZHqSHYvpDkW1Gn6J9ePs1bDM8s6Suu1/";
...
// File: contracts/PoetocolContract.sol
//

pragma solidity ^0.8.0;

contract PoetocolContract is RamppERC721A {
    constructor() RamppERC721A("Poetocol", "POETOCOL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qLp5JVMoLrDRpzh7GZZv/contract-metadata";
    }
}
