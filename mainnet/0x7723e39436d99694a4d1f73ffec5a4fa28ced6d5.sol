...
An experiment to see how far a token with $100 starting LP can go.

5/5 Tax With 50% going to Burned LP

3% Max Wallet
3% Max TX

Telegram - https://t.me/OneHundredLP
...
contract OneHundredLP is IERC20, Ownable {
    string private constant _name = "$100LP";
    string private constant _symbol = "$100LP";
    uint8 private constant _decimals = 9;

    uint256 private constant _totalSupply = 1000000000 * 10**9;
    uint256 private _taxFeeOnBuy = 5;
    uint256 private _taxFeeOnSell = 5;
    uint256 private _liquidityFeeSplit = 2; // Denominator of fees that go to liquidity. E.g 2 means 1/2 (50%) goes to liquidity
    ...
    address payable private _developmentAddress =
        payable(0x613F7C335F98ecBe186B49c3674eAa1B1B6e9Fbe);
