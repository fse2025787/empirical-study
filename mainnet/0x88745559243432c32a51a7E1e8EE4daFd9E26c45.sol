    ...
    UUPSUpgradeable
{
    ...
    function publicWhiteListCountSetter(
        ...
        for (uint64 i = 0; i < length; ++i) {
            // NOTE: increasing the count number, not set it as value
            publicWhiteListCount[_publicWhiteListAddresses[i]] = _amount;
        ...
        nonReentrant
    {
        ...
        require(teamPlayerSaleIndex < 16, "team players all minted");
        ...
        nonReentrant
    {
        ...
        require(_count < 16, "whitelist mint balance over");
