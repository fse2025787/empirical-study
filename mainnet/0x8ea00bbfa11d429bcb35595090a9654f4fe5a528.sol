...
contract BBBill is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmNTwNTwirMjSYdzqbVep2wguxYSAMWWwSpNwaSpSnWSMN/";
  ...
  constructor() ERC721("BBBill", "BBBI") {
    setHiddenMetadataUri("ipfs://QmcFPnNg222tRB13Y6oiDbKvs6NsHpwa3jFSBJTgrB1ZxK/NotRevealed.json");
  }
