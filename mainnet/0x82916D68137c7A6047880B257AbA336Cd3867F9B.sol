...
contract DeathChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Death Chain";
    string private constant _symbol = "DeathChain";
