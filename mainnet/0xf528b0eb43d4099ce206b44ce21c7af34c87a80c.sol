...
https://medium.com/@JohnathonByers/persephone-unleashing-hell-with-true-burn-c1c3c968c0b
...
contract Persephone is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Persephone';
    ...
    function shouldSwapBack(address recipient, uint256 amount) internal view returns (bool) {
        ...
        return !swapping && swapEnabled && aboveMin && recipient == pair && swapAmount >= uint256(3) && canSwap;
    }
