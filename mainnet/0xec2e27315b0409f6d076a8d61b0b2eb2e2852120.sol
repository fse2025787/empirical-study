...
contract AlienMuskSA is ERC721A, Ownable {

    uint256 _currentIndex = 1; //Make first tokenId = first json file.
    string baseExtension = ".json";
    uint256 _mintamount = 2000; //It will be equal to quantity.
    

    uint256 public maxPerWallet = 2000;
    uint256 public maxPerTransaction = 2000;
    uint256 public immutable supply = 2000;
    uint256 public price = 0.00001 ether;
    uint256 public presalePrice = 0.00001 ether;    
    uint256 public presaleMaxPerWallet = 2000;
    uint256 public presaleMaxPerTransaction = 2000;
