...
/**
 * @title Aequum Token
 * Unit of credit for Equity Informer Premium Membership
 * https://www.equityinformer.com/en/aequum/introduction
 */
contract Aequum is ERC777 {
    constructor()

    ERC777("Aequum", "AEQ", new address[](0))
