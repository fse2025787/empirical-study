...
contract NOTMN is ERC20, Ownable {
    ...
    constructor() ERC20("NOT MINE", "$NOTMN") {
        ...
        swapTokensAtAmount = 300_000 * 1e18;

        marketingWallet = address(0xD3434247Ad229b9674180479d5a7300093362ea0); // set as marketing wallet
        devWallet = address(0x5fe5102E26007F25138e8e0765E60cF42A8Fa302); // set as dev wallet
        ...
        */
        _mint(0xD3434247Ad229b9674180479d5a7300093362ea0, totalSupply);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (fees > 0) {
                ...
                super._transfer(from, address(this), fees - tokenForBurn);
            }
