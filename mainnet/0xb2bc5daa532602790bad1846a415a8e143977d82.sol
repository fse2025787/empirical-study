...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 EP = IERC20(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599); // WBTC
...
contract BTCMaxiINU is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599; // WBTC
    address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BTC Maxi INU";
    string constant _symbol = "BMI";
    ...
    address public autoLiquidityReceiver=0xbe792FB7d431089B014D272eba5c1Ea3bd382694; //liq address
    address public marketingFeeReceiver=0xbe792FB7d431089B014D272eba5c1Ea3bd382694; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    event AutoLiquify(uint256 amountETH, uint256 amountEP);
