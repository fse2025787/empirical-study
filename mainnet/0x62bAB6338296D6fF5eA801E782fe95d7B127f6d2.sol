...
/**
INDY INU 
(NOT ASSOCIATED WITH @INDYJOURNAL)

IndyJournal is the hero we don't deserve. Indy never asks for any monetary rewards or payments for the vigilante work that he does.
$INDY is a token that seeks out to support Indy for his/her hard work.

Tokenomics

5% Tax
3% Goes to Indy's wallet (0xA73369D5ee033c6087f76881A6e06dcAEf70BeD5) reference (https://etherscan.io/address/0xa73369d5ee033c6087f76881a6e06dcaef70bed5)
2% Goes to Marketing


Let's bring in some volume and show our support to Indy!

Thank you Indy

Telegram : https://t.me/IndyInu
Website: Coming soon
...
contract IndyInu is ERC20, Auth {
    ...
    string constant private _name = "INDY INU";
    string constant private _symbol = "INDY";
    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 1000000000000* 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply * 10000 / 10000;
    uint256 public _maxWalletAmount = _totalSupply * 100 / 10000;
    ...
    address private autoLiquidityReceiver =0xBa3F4Caf5862C69339C69D6830EFEdE5a30D0562 ;
    address private marketingFeeReceiver =0xA73369D5ee033c6087f76881A6e06dcAEf70BeD5 ;
    address private operationsFeeReceiver =0xBa3F4Caf5862C69339C69D6830EFEdE5a30D0562 ;
    address private devFeeReceiver =0xBa3F4Caf5862C69339C69D6830EFEdE5a30D0562 ;
    address private stakingFeeReceiver =0xBa3F4Caf5862C69339C69D6830EFEdE5a30D0562 ;
