...
contract TrollTroll is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNh7K4VTJmo23xKxTfGTgDAycPmyW3NEHmr8acom1gCkz";
    ...
    constructor(
    ) ERC721A("TrollTroll", "TROLLTROLL", 100, maxSupply) {
    }
