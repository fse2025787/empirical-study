...
contract VUZU is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "VUZU";
    string private constant _symb = "VUZU";
    ...
    constructor() payable {
        ...
        _maxWallet = _tTotal * 10 / 100;
        _minTaxSwap = _tTotal * 5 / 10000;
        MarketingWallet = payable(0xc227Fc2573b3C936609Ee8610B75A5e94aDcdC29);
        TreasuryWallet = payable(0xfCb944d65D246Db3a063dA2DAd69bAC810711172);
        DevWallet = payable(0x0cF8EBdd7B8211e3aDEE8E1A781E3A6F866f0BC9);
