...
contract Democrat is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Democrat";
    string private constant _symbol = "Democrat";
    ...
    address payable private _developmentAddress = payable(0x9698CB2372C4C85f9e3881B2a44201f2074AaD32);
    address payable private _marketingAddress = payable(0x9698CB2372C4C85f9e3881B2a44201f2074AaD32);
