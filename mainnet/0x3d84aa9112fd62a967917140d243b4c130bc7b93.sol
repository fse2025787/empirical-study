...
contract BLAZE is Context, IERC20, Ownable {
    ...
    string private _name = "BLAZE";
    string private _symbol = "🔥BLAZE";
    ...
    uint256 public _maxTxAmount = 15000000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 15000000 * 10**6 * 10**9;
