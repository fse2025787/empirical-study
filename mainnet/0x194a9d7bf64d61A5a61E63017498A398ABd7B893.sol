...
//*********************************************************************//
//
//     __  ___           _               __  ___      _____          ________          
//    /  |/  /___ ______(_)___  ___     /  |/  /___ _/ __(_)___ _   / ____/ /___ _____ 
//   / /|_/ / __ `/ ___/ / __ \/ _ \   / /|_/ / __ `/ /_/ / __ `/  / /   / / __ `/ __ \
//  / /  / / /_/ / /  / / / / /  __/  / /  / / /_/ / __/ / /_/ /  / /___/ / /_/ / / / /
// /_/  /_/\__,_/_/  /_/_/ /_/\___/  /_/  /_/\__,_/_/ /_/\__,_/   \____/_/\__,_/_/ /_/ 
//                                                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x771eDC694FfcFD8E0A8d0C93dd573392c6ddf7b2];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x771eDC694FfcFD8E0A8d0C93dd573392c6ddf7b2;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.marinemafia.club/";
...
// File: contracts/MarineMafiaClanContract.sol
//

pragma solidity ^0.8.0;

contract MarineMafiaClanContract is RamppERC721A {
    constructor() RamppERC721A("Marine Mafia Clan", "MMC"){}
}
