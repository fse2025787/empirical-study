...
contract ROYALCHESS is Context, IERC20, Ownable {
    ...
    string private _name = 'Royal Chess ';
    string private _symbol = 'RCHESS';
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        require(recipient != address(0), "BEP20: transfer to the zero address, use burn function");
