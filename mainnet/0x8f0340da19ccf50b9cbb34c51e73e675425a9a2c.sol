...
Which tax haven you like best?

I like https://t.me/+nXK-FCDOnsZiNDQx
...
contract TheCaymanIslands is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x57924D80C81613d3ca9B1454906181cca5e89995));
    ...
    string private _name = "The Cayman Islands";
    string private _symbol = "TheCaymanIslands";
    ...
    uint256 public _maxTxAmount = 600 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 420 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 800 * 10**19 * 10**9;
