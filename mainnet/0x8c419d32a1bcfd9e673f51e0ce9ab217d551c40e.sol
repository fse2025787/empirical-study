...
contract IAYC is IERC721A { 
    ...
    string private constant _name = "Invisible Ape Yacht Club";
    string private constant _symbol = "IAYC";
    string private _contractURI = "QmdAheEjAW9BCxoDxCygSJyHr27nySpj6n8dZmYqbsiEyK";
    string private _baseURI = "bafybeiekw2vwntwukjscpnmrukb7rtvqhncs2b6qwxfraxqxzbb3nslvji";
    ...
    function setBaseURI(string memory _contract, string memory _base) external onlyOwner{
