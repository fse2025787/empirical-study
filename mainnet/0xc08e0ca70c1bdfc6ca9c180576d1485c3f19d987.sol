...
/*
    ...
    In these harsh times, the community must come together for a cause.

    0 Tax, Locked & Renounced - For the community, by the community
...
contract FKWON is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Everybody Hates Kwon";
    string public _symbol= "FKWON";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0xbC171F6Bf03842caFE9712eb5b8fd050d1A58A20);
