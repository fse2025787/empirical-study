...
contract PPPandas is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    address coreTeam = 0x29DCf839449Bd5D1b5F3726Cf7283099AF17F5DF;
...
contract PPPandasV2 is Ownable, ERC721Enumerable, PaymentSplitter {
    ...
    address payable PandasV1Addr = payable(0xe5954Fed7FC00F6cAF81CD99cf3509f1E1AfA7a4); // testnet TODO: point to mainnet
