...
contract EthWormhole is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        maticWormhole = _maticWormhole;
    }

    /* solhint-disable-next-line no-empty-blocks */
    function _authorizeUpgrade(address _newImplementation) internal override onlyOwner {}

    function setMaticWormhole(address _maticWormhole) external {
        maticWormhole = _maticWormhole;
    }
    ...
    function sendMessage(bytes calldata message_) external {
        ...
        fxRoot.sendMessageToChild(maticWormhole, message_);
    }
    ...
    function _validateAndExtractMessage(bytes memory inputData) internal returns (bytes memory) {
        ...
        require(processedExits[exitHash] == false, "EXIT_ALREADY_PROCESSED");
        ...
        // check child tunnel
        require(maticWormhole == log.getEmitter(), "INVALID_FX_CHILD_TUNNEL");
