...
Minshū (Shū) - Minshū in Japanese means democracy, for the people. Minshū (Shū) aims to give the power back to the people in the form of voting for important decisions for the community at key marketcaps.

Telegram:  https://t.me/MinshuPortal
Twitter:   https://twitter.com/MinshuERC20
...
contract Minshu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Minshu";
    string private constant _symbol = "Shu";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x6861b20DC3290d23108F7e31e2fa1f2C2584F6cD);
