...
/**
    ...
    Become a part of a large ecosystem that connects socially responsible brands with businesses 
    and individuals who want to reduce their carbon footprint. 
    Based on the blockchain, our platform empowers you to buy, sell, or retire carbon
    
    Telegram: https://t.me/IMPTIO
*/
...
contract IMPT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xd49452B04dBfAC4B44a5Cf17025cB777B9069Fef); // Marketing Address
    address payable public multiSigAddress = payable(0xd49452B04dBfAC4B44a5Cf17025cB777B9069Fef); // Marketing Address
    address payable public devAddress = payable(0xd49452B04dBfAC4B44a5Cf17025cB777B9069Fef); // Dev Address
    address payable public liquidityAddress = payable(0xd49452B04dBfAC4B44a5Cf17025cB777B9069Fef); // Liquidity Address
    ...
    string private constant _name = unicode"IMPT.io";
    string private constant _symbol = unicode"IMPT";
