...
contract NOFAP is ERC20, Ownable {
    ...
    constructor() ERC20("NOFAP", "NOFAP") payable {
        ...
        maxTxnAmount = totalSupply * 4 / 100; // 4% of supply
    	...
    	marketingWallet = address(0xB00261ed5E4dF98F630f0227443d77878D659B70); // set as marketing wallet
        ...
        excludeFromFees(0x253b4887305F0483E56E70DB49f443bf4eFd3880, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x253b4887305F0483E56E70DB49f443bf4eFd3880, true);
        ...
        */
        ...
        _createInitialSupply(0x253b4887305F0483E56E70DB49f443bf4eFd3880, totalSupply*8/100);
