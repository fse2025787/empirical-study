...
contract AlfalfaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Alfalfa Inu"; 
    string private constant _symbol = "$AI"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0xFaa0dDCC42422BF2a48B2606a8b7E33680aE032C; 
