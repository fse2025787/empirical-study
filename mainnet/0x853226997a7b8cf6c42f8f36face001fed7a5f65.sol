...
/*
Japanese Adult Movie, Following the dirty trend on ETH Right Now. 
Telegram - https://t.me/javerc
...
contract JAV is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Japanese Adult Video";
    string private constant _symbol = "JAV";
    ...
    address payable private _developmentAddress = payable(0x6437c4D69054dd5EBE5a2a2226E0B418DD733478); 
    address payable private _marketingAddress = payable(0x6437c4D69054dd5EBE5a2a2226E0B418DD733478);
