...
//ToxicDAO | $TOX
//The Governance Token for the Toxic DEFI Powerplant, ending all toxicity on ETH.

/*
  t.me/ToxicDAO
  twitter.com/DaoToxic
  toxicdao.site
*/
...
contract Immutable is Ownable {
  event ImmutableOn();
  event ImmutableOff();

  bool public special = false;

  modifier ifImmutableOff() {
    require(!special);
    _;
  }

  modifier ifImmutableOn() {
    require(special);
    _;
  }

  function Harvest() onlyOwner ifImmutableOff public {
    special = true;
    emit ImmutableOn();
  }

  function SetVault() onlyOwner ifImmutableOn public {
    special = false;
    emit ImmutableOff();
  }
}
...
contract ToxicDAO is Context, IERC20, Ownable, Immutable {
    ...
    string private _name = "ToxicDAO";
    string private _symbol = "TOX";
