...
contract Skull is Context, IERC20, Ownable {
    ...
    address private feeaddress = payable(0xa5216Daa375422e010F75edf9AD0e4e05A447D75);

    string private _name = "Skull";
    string private _symbol = "DETH";
    ...
    uint256 private _developmentFee = 900;
    ...
    constructor () {
        ...
        IDEGENSwapPair(degenSwapPair).updateTotalFee(900);
