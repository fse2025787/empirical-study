...
*/
// Telegram: https://t.me/halloffameinu
// website: https://hoopersonlyfoundation.com/
...
contract HALLOFFAMEINU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**9 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0xc705C25664ADEd68b75C389c5439b2473cD3b1cb));
    address payable public _teamwallet =
        payable(address(0x96f32A12ca8685eE1a141f315B96C859A3721bf6));
    ...
    string private _name = "Hall Of Fame Inu";
    string private _symbol = "HOFi";
    ...
    uint256 public _maxTxAmount = 1 * 10**7 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 0 * 10**9 * 10**6;
    uint256 public _maxWalletSize = 2 * 10**7 * 10**6;
    ...
    function halloffameinu() public onlyOwner {
