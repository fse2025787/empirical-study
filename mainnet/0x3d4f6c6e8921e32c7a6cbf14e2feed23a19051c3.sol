...
contract BlackShibaInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Black Shiba Inu";
    string private constant _symbol = unicode"BLACKINU";
