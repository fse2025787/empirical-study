...
//Today, we're ready, and we've brought together several early $Doge , $shib, and $elon investors to launch a project to honor those great doges. 

//Website: https://dogebraincapital.finance/
//Twitter: https://twitter.com/DogeBCDAO

//TG: In order to prevent fake links, we decided to lock the liquidity after the formation of telegram group.
//Launch: 5:00 UTC
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a DBCD shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract DogeBrain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Doge Brain Capital DAO";
    string private constant _symbol = "DBCD";
    ...
    address payable public marketingWallet = payable(0x456879B0885d892d0C86B50390b040B7fae427c1);
    address payable public treasury = payable(0xAFB70B81137f0Ab65F1eAE7089d15A164f3d91F5);
    ...
    constructor (    ) Auth(0xBB4a5334FA15d26e24BED379A98f1554e4522366) {
        address _owner = 0xBB4a5334FA15d26e24BED379A98f1554e4522366;
