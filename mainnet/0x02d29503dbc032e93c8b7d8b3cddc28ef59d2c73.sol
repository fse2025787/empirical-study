...
No official socials/website.

Community owned - ownership of the contract renounced und LP locked for 1 month (extended at $20k market cap).
...
contract SlowMoon is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SlowMoon";
    string constant _symbol = "SLOWMOON";
    ...
    function setWalletLimit(uint256 amountPercent) external onlyOwner {
        ...
        require (_maxWalletAmount >= _totalSupply/1000, "Max Wallet must be more than 0.1%");
    }
