...
// sMartSwap with Governance.
contract sMartSwap is ERC20("sMartSwap Token", "YAM"), Ownable {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying YAM (not scaled);
