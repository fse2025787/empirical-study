...
contract ContemporaryZuki is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Contemporary Zuki", "CZ") {
        PRICE = price;
    ...
    function changeMaxSupply(uint newMaxSupply) external onlyOwner {
        require(newMaxSupply >= _currentIndex, "ContemporaryZuki: Invalid new max supply");
        require(newMaxSupply <= 10000, "ContemporaryZuki: Invalid new max supply");
        require(!MAX_SUPPLY_FROZEN, "ContemporaryZuki: You can't change max supply anymore");
