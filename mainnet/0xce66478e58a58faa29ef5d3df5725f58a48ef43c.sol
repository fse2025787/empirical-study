...
contract Cats  is ERC721A, Ownable {
    ...
    uint256 public immutable caaaaaaaaaaat = 0.0049 ether;
    ...
    constructor()
    ERC721A ("Caaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaat", "Cat") {
    }
    ...
    function catPublicMint(uint256 amount) public payable callerIsUser{
        require(msg.value > caaaaaaaaaaat, "insufficient");
    ...
    function catdropToWL(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
