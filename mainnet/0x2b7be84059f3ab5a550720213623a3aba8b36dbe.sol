...
interface ISilverBackNFT {
    /**
     * @dev Getter to get count of silverbacks owned by user
     */
    function balanceOf(address _user) external view returns (uint256);

    /**
     * @dev Getter to get count of silverbacks created by user
     */
...
contract SilverToken is AccessControl, ERC20 {
    ...
    /* Last timestamp that rewards will be calculated agains */
    /* Saturday, November 15, 2031 12:00:00 PM GMT+0000 */
    uint256 public constant END = 1952510400;

    /* Are full rewards being rewarded? */
    uint256 public fullRewardsEnabledAt = 0;

    /* Mapping of rewards that have been calculated */
    mapping(address => uint256) public rewards;
    /* Mapping of last time rewards were updated */
    mapping(address => uint256) public lastUpdate;

    /* Silverback NFT contract */
    ISilverBackNFT public silverbackNFT;

    /* Addresss to send taxes to */
    address public treasury;
    /* Addressess excluded from fees */
    mapping(address => bool) private _isExcludedFromFees;
    /* Amount to take in trading fees as base points */
    uint256 public tradingFees;
    /* Addresses that are know pairs */
    ...
    /**
     * @dev Helper to verifiy _msgSender() is a reward distributor
     */
    ...
    /**
     * @dev Helper to verifiy _msgSender() is an admin
     */
    modifier onlyAdmin() {
    ...
    /**
     * @dev Getter for current rate owners generate
     */
    ...
    /**
     * @dev Getter for current rate creators generate
     */
    ...
    /**
     * @dev Getter for total claimable rewards
     */
    ...
    /**
     * @dev Called from a reward distributor to pull out rewards
     *
    ...
    /**
     * @dev Override so we can add a sell fee if need be
     */
    function _transfer(
        address from,
        address to,
    ...
    /** Admin Functions **/
    /**
     * @dev Called to turn full rewards on
     */
    ...
    /**
     * @dev Called configure address as a reward distributor
     */
    ...
    /**
     * @dev Set if an address is excluded from trade fees
     */
    ...
    /**
     * @dev Set if multiple addresses are excluded from trade fees
     */
    ...
    /**
     * @dev Set if address is a AMM pair
     */
    ...
    /**
     * @dev Set tradding fee in base points
     */
    ...
    /**
     * @dev Helper to get current block timestamp or end timestamp, which ever is older
     */
    ...
    /** Internal Functions **/
    /**
     * @dev Helper to calculate current claimable rewards
     */
