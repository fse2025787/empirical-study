...
contract BNBClassic is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BNBClassic";
    string constant _symbol = "BNBC";
    ...
    uint256 _totalSupply = 70000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 8 / 100;
    uint256 public _walletMax = _totalSupply * 8 / 100;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x57C2dd286c85bE36d60DA77eDCF5fb3cD33C734f;  
        anothermarketingWallet = 0x61f69F19A017DFb294142bf9778efce11F1adBdd;
