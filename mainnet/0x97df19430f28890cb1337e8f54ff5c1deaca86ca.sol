...
contract GOLDENLAEEB is Context,IERC20, Ownable{
using Address for address;
string private _name = "GOLDEN LAEEB";
string private _symbol = "GOLDLAEEB";
...
address _owner;
address payable public marketingAddress = payable(0xFf67c186fFbA72688972B9F6665E58755Bd48d24);
...
uint256 GOLDENLAEEBCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > GOLDENLAEEBCOINDaycooldown, "You cant call GOLDENLAEEBCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function GOLDENLAEEBCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    GOLDENLAEEBCOINDaycooldown = block.timestamp + 86400;
}
