...
contract Skylines is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTXmRUrE2s57deBiV8nKABSZPbQFAo4wpH3HXd7UzuHsK";
    ...
    constructor(
    ) ERC721A("Skyline Banners", "SKYLINE", 100, maxSupply) {
    }
