...
Welcome to $MiniDoge
   ...
   If you want to view all the information about this coin, please check https://t.me/MiniDogeChannel
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $MiniDoge to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $MiniDoge idea, increasing the liquidity pool automatically.
...
contract MiniDoge is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/MiniDogeChannel", "MiniDoge") {
