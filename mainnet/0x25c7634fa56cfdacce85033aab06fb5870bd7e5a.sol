...
Telegram :
https://t.me/TrannyInu

Twitter : 
https://twitter.com/trannyinu

Website: 
http://www.trannyinu.com

MEDIUM
https://medium.com/@gayoshiresearch/then-you-have-met-a-special-person-a2f67257b52a
...
contract TRANNY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "TRANNY INU";
    string private constant _symbol = "TRANNY";
    ...
    uint256 private _liquidityFeeOnBuy = 0; //100 = 1%
    
    //Sell Fee
    uint256 private _redisFeeOnSell = 0;
    uint256 private _marketingFeeOnSell = 600; //100 = 1%
    uint256 private _liquidityFeeOnSell = 0; //100 = 1%
    ...
    address payable private _taxWallet1 = payable(0x2b6047E92A400Bc184F8eF46f48Ef8F0E7fA6141);
    address payable private _taxWallet2 = payable(0x60596119eB37Be496c420645f3F36FE36B4fCcdE);
