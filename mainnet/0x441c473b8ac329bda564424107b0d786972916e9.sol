...
contract BoiledFish is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Boiled Fish";
    ...
    address payable private scorcherWallet = payable(0x702b54895522d95D1d297b68172eB99123b24555);
    address payable private jeetWallet = payable(0xdb5e40928db9B38a44ce573C7C72d7003571cfAd);
