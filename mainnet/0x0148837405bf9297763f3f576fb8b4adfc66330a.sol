...
/**
Twitter: https://twitter.com/Shiboya_Erc
Telegram: https://t.me/ShiboyaERC
*/
// 
...
contract SHIBOYA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Shiboya";
    string private _symbol = "SHIBOYA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x1EDea9BaBfB4Ef9B92389746c71c17D2Bb0F7404);
    address payable private taxWallet2 = payable(0x1EDea9BaBfB4Ef9B92389746c71c17D2Bb0F7404);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*49/10000; 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 80000000000000000)
