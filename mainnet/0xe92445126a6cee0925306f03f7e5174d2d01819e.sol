...
pragma solidity ^0.6.12;
    ...
    contract FLOKINATOR is Context, IERC20, Ownable {
        ...
        string private _name = 'Flokinator';
        string private _symbol = 'FLOKINATOR';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xBc15F644362Dc1983EE6d4e1AeDd1D8fED304725, 'We can not exclude Uniswap router.');
