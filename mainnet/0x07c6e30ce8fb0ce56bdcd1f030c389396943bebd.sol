...
contract MilkyWay is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0x7Bc2acD3691fa0D86Bb45A9272827ADC657A3fBb);
    ...
    constructor() ERC20("Milkyway", "ZOOM") {
        ...
        marketingWallet = address(0x2D0805e15F67F435A6aAD5E0E47A5d00f8E374eE); // set as marketing wallet
        devWallet = address(0x92B7cC6B425E592Ab89789D5779eb69bB10c3ed5); // set as dev wallet
