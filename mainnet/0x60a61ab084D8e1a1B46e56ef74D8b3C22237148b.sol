...
contract PILD is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = "Pump it Loom Dart" ;
    string private _symbol = "PILD";
    ...
    uint256 internal _tokenTotal = 100e9;
    ...
    uint256 public maxTxAmount = _tokenTotal.mul(5).div(200); // 0.5%
    
    uint256 public minTokensBeforeSwap = 1e9;
