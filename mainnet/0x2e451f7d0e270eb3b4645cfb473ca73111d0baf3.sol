...
contract KIBOSHI is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x420EC5849d7b5b45129ab08c31341a56e7ef6008;
    address private feeTwo = 0xDAD2f4D1c1a587Bcf09515617A8D0ceff06483Cc;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private tempBalance;
    mapping(address => uint) private tempBalanceCoolDown;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Monjiro Kiboshi";
    string private _symbol = "KIBOSHI";
    uint8 private _decimals = 18;
    uint256 private _tTotal = 1_000_000_000;
