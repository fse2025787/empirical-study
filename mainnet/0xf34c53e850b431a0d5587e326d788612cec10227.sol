...
contract Prosperity is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Prosperity", "PRO") {
    ...
    // newRate Rate users can buy from the contract
    ...
    function buy() payable public {
        ...
        require(!frozenAccount[_msgSender()]);// Check if sender is frozen
        ...
        super._transfer(address(this), _msgSender(), amountToBuy);// makes the transfers
        require(payable(owner()).send(msg.value),"Failed to send Ether");
    }

     // Withdraw unsold tokens 
    function withdrawUnsoldTokens(address tokenAddress, uint256 tokens) external onlyOwner returns (bool success){
