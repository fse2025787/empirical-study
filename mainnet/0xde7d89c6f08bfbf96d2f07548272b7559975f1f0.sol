...
777 Dollar Millionaire - $777
$777 token will add exactly 777$ worth of ethereum against all of the supply. We will start off with 777$ worth of liquidity.
...
$777 tokens only utility is to reach 777K marketcap starting out with just 777$ worth of liquidity.
...
string private _name = "777 Dollar Millionaire";
string private _symbol = "$777";
...
address _owner;
address payable public marketingAddress = payable(0x95354AB76f1a8d1f7E720eb6D193B5Abf4CC8bC9);
...
function updatebuyFee(uint256 newAmount) public onlyOwner{
       buyliqFee = newAmount;
}
function updatesellFee(uint256 newAmount)public onlyOwner{
