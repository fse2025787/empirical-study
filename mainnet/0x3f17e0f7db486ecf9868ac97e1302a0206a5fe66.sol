...
Oh the great past. When the landscape was filled with hopium, when degens would stand their ground no matter what comes through those defi doors.
Where the great diamond hands held fast and forged through with the developers. Those days are long gone... 
We need our bloodlines to hold firm, fear no darkness nor dumps. Like the greats of our time, SHIBA, FLOKI, SAFEMOON... 
Everyone held on and worked tirelessly to push the boundaries of their ambitions! We need to relight the fires! 

Pyro - Like the Greeks call it. 
never let the flame die out...

No taxes. No utility. Long Live the MEME...
We need you as one. Hold your bags. Forge ahead and push for new highs always...
May the spirits of SHIBA, FLOKI, SAFEMOON be upon you and us all!

SQ1 - Square1 

Let us begin...

https://t.me/square1portal
...
contract Square1 is Context, IERC20, Ownable {
  using SafeMath for uint256;

  string constant _name = "Square1";
  string constant _symbol = "SQ1";
