...
For this project to fulfill my vision, I must work from the shadows.  

I will leave it up to you all to make a community telegram. Trust me my presence will be felt. When time is right you will all know who I am.
...
contract Penalty is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Penalty";////////////////
    ...
    address payable private _developmentAddress = payable(0x19B887AAabcEd8177e2bDdEbbc22CEe1abE2d1Ac);////////////////////
    address payable private _marketingAddress = payable(0x19B887AAabcEd8177e2bDdEbbc22CEe1abE2d1Ac);/////////////////////
