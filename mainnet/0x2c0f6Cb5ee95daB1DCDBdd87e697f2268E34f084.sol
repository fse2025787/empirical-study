...
contract MainlandPortal is Ownable {
    ...
    function initialize(address fxRoot_, address checkpointManager_, address polylandPortal_) external onlyOwner {
    ...
    function forceProcessMessageFromChild(bytes memory data_) external onlyOwner {
