...
contract DISCO70s is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x238d19790acE60B097f267104d9Ec6d24b5192B4));

    string private _name = "DISCO70s";
    string private _symbol = "DISC70S";
