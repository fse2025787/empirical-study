...
//File: contracts/AbstractLoot.sol
...
/**
 * @title AbstractLoot contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract AbstractLoot is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    string public PROVENANCE = "";
    uint256 public lootersPrice = 15000000000000000; //0.015 ETH
    ...
    constructor() ERC721("AbstractLoot", "AL") {
    }
