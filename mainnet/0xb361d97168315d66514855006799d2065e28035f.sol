...
/*
WISE OLD MAN
Say hello to the Wise Old Man, the man who is going to bring back wealth to the community.
https://linktr.ee/wiseoldman
 */
...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x4C13FB81000dA0CB922D8CaF0a9eC7828c0bfF6C;
...
contract Wise_Old_Man is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Wise Old Man"; //token name
    string private _symbol = "WOM"; // token symbol
    uint8 private _decimals = 7; //decimals to return
    ...
    uint256 internal _tokenTotal = 2147000e7; // total supply
    ...
    uint256 public _liquidityFee = 1; // means 1% add liquidity on each buy and sell
    
    uint256 public devFee = 4; //0 means 0% 
    
    
    address devAddress = 0x4C13FB81000dA0CB922D8CaF0a9eC7828c0bfF6C; // Dev wallet
