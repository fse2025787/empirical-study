...
Dark Monilox へようこそ。イーサリアム ネットワークを吹き飛ばす次のイーサリアム ユーティリティ トークンです。
...
*/
// https://web.wechat.com/DarkMoniloxJPN
// https://www.zhihu.com/
// https://www.darkmonilox.zushont.io

contract Monilox is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf796924972bd32f4c6c7eF73e92B9bd3373E5eEE); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0xf796924972bd32f4c6c7eF73e92B9bd3373E5eEE);
    ...
    string private constant _name = "Dark Monilox"; 
    string private constant _symbol = unicode"DMiX";
    ...
    constructor () {
        ...
        _owner = 0xf796924972bd32f4c6c7eF73e92B9bd3373E5eEE;
