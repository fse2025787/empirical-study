 ...
 * 
   t)                    f)FFF  f)FFF l)L               d)                 
t)tTTT                 f)     f)      l)               d)                 
  t)    r)RRR  u)   UU f)FFF  f)FFF   l)  e)EEEEE  d)DDDD a)AAAA   o)OOO  
  t)   r)   RR u)   UU f)     f)      l)  e)EEEE  d)   DD  a)AAA  o)   OO 
  t)   r)      u)   UU f)     f)      l)  e)      d)   DD a)   A  o)   OO 
  t)T  r)       u)UUU  f)     f)     l)LL  e)EEEE  d)DDDD  a)AAAA  o)OOO  
 
 * Telegram: https://t.me/truffleprotocol
 * Web:      http://truffledao.xyz/
 * Twitter:  https://twitter.com/truffleprotocol
 *
 * The next generation community driven protocol for WEB3 ecosystems
*/
...
contract Truffle is ERC20, Ownable {
    ...
    constructor() ERC20("Truffle Protocol", "TRFL") {
    ...
    ; uint256 totalSupply = 4 * 1e13 * 1e18;
