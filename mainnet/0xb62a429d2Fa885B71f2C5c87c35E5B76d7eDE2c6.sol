...
National Basketball Association Inu

NBA is the 2nd most watched sport with some of the biggest world wide stars
...
contract NationalBasketballInu is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 5000000000 * 10**8;
    ...
    string private constant _name = "NBA INU";
    string private constant _symbol = "NBAI";
