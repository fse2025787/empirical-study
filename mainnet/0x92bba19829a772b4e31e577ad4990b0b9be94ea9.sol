...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF7470dFeAE46b6670Dc27756aC31c233cEC1c888];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 555 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmfUn91nCXzKyEcFqsJNSBDDo2BhzuzRtAKqFRzLm5gBJH/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 555");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 555");
...
// File: contracts/kevinmoriesContract.sol
//

pragma solidity ^0.8.0;

contract KevinmoriesContract is RamppERC721A {
    constructor() RamppERC721A("Kevinmories", "Kevin"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Kod1rMtLef3ROfDERdDn/contract-metadata";
    }
}