...
contract HC is Context {
    address internal recipients;
    mapping (address => bool) internal blacklist;
    event hc(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit hc(address(0), msgSender);
    }
    modifier checker() {
 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata , HC{
...
contract HOTCAT is ERC20{
     ...
     */
    constructor () ERC20('HOTCAT | https://t.me/hotcatofficial', '$HOTCAT') {
