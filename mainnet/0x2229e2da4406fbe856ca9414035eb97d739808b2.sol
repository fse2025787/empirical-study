...
contract Kichona is Context, IERC20, Ownable {
    ...
    string private _name = "Kichona";
    string private _symbol = "Kichona";
    ...
    address public devAddress = 0x98a4f9DAf864d1963cd7B494d2a9cD85BBf66622;
    address public marketingAddress = 0x98a4f9DAf864d1963cd7B494d2a9cD85BBf66622;
    ...
    constructor () {
        ...
        emit Transfer(address(0), 0xb70B90C114Fcb1Ba0f4bA65d4029e9e1c2d67164, _totalSupply);
    }
    ...
    function setWalletAddresses(address devAddr, address marketingAddr) external onlyOwner {
        devAddress = devAddr;
    ...
    function swap(uint256 tokens) private lockTheSwap {
        ...
        payable(marketingAddress).transfer(split);
        payable(devAddress).transfer(split);  
    }
