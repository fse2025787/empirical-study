...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc68CC89A0165df897944730bFf8b0514616A4ABc];
  address public erc20Payable = 0xc68CC89A0165df897944730bFf8b0514616A4ABc;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 80;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 8, 399) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiesfrhmwjgisxrpm7opltm7w5ch7hf2niswgqavjnvmfgcna6dghy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/nmFjh6LkroUpPBsvdmuV/contract-metadata";
  }
...
// File: contracts/PsychedelicspaceplanetsContract.sol
//

pragma solidity ^0.8.0;

contract PsychedelicspaceplanetsContract is RamppERC721A {
    constructor() RamppERC721A("psychedelic space planets", "space art"){}
}
