...
Nonki Shiba 🐕
https://twitter.com/nonkierc
https://nonki-shib.com/
...
contract Nonki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nonki Shiba";
    string private constant _symbol = "NONKI";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0 && _buyCount > 40) {
