...
library RareSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'f6b6f2ef4dbf8401afd2cb047e0c87d67c9d20e1d7a02a6c3b2102230cd10718' // init code hash
            ))));
    }
...
contract RareSwapRouter is SupportingSwap {
    ...
    constructor(address _factory, address _WETH, address _USDC, uint256 _adminFee, address _adminFeeAddress) public {
        factory = _factory;
        WETH = _WETH;
        USDC = _USDC;
