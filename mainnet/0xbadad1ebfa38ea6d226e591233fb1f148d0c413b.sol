...
contract CatsGang2023 is ERC721A, ERC2981, Ownable, DefaultOperatorFilterer {
    string public baseURI =
        "https://ipfs-storage.s3.amazonaws.com/2023CatsGangMainnet/";

    uint256 public tokenPrice = 40000000000000000; //0.04 ETH

    uint256 public whitelistTokenPrice = 20000000000000000; //0.02 ETH
    ...
    uint256 public whitelistMintRemains = 2023;
    ...
    bytes32 public merkleRoot =
        0x709cb1ea037fea83eb71c37cdc5dbae5a2fe68596896cc3dc407394aa9d22d7a;
    ...
    constructor() ERC721A("2023CatsGang", "CATG", 100, MAX_TOKENS) {
