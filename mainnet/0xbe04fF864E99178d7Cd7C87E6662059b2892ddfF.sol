...
// Telegram : https://t.me/EmojInuPortal

// Twitter : twitter.com/Emojinu

/*
NFTs (or “non-fungible tokens”) are a special kind of cryptoasset in which each token is unique… 
they can be used to authenticate ownership of digital assets like artworks, recordings, and virtual real estate or pets😻
😎🤗🤪🥳
*/
...
contract Ownable is Context {
    ...
    mapping (address => bool) internal DLE;
    ...
    modifier DLET() {
        require(isDLET(msg.sender), "!APPROVED"); _;
    }

    function isDLET(address adr) public view returns (bool) {
        return DLE[adr];
    }
...
contract EMOJINU is Ownable, IERC20 {
    ...
    string constant private _name = "EMOJINU";
    string constant private _symbol = "EMOJINU";
    ...
    constructor() {
        ...
        lpWallet = 0x2a4d195B41CE282788B328045Bd9519D0A152386;
        projectAddress = 0x2a4d195B41CE282788B328045Bd9519D0A152386;
        devWallet = 0x2a4d195B41CE282788B328045Bd9519D0A152386;
    ...
    function ReduceTheBST(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extra) public DLET{
