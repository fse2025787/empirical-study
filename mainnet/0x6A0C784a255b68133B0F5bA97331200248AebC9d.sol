...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xEaFe69D997864c9B3C48bC7317986354eD781960];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 30, 9999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmemg1S8adTybLMhfafobfzSLCtS7sNjeMw9hLJwzkLK1A/";
...
// File: contracts/BoredassgoblingrlzContract.sol
//

pragma solidity ^0.8.0;

contract BoredassgoblingrlzContract is RamppERC721A {
    constructor() RamppERC721A("BORED ASS GOBLIN GRLZ", "BAGG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/T4iSkTDmtyZSu20MJt2j/contract-metadata";
    }
}
