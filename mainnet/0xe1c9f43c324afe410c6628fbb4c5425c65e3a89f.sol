...
/**
   ___ ____   ___   __  __  __  ___   __  ______ ____    ___   __  __  ___  __ __ ______  __ 
  //   || \\ // \\ (( \ ||  || // \\ (( \ | || | || \\  // \\  ||\ || // \\ || || | || | (( \
 ((    ||_// ||=||  \\  ||==|| ||=||  \\    ||   ||_// ((   )) ||\\|| ||=|| || ||   ||    \\ 
  \\__ || \\ || || \_)) ||  || || || \_))   ||   || \\  \\_//  || \|| || || \\_//   ||   \_)) 
...
contract CrashAstronauts  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeiavwlb2bdvjk3i4wsanxrykyy43fwv2zvafqxxkmopxvgivlzerpq/";
