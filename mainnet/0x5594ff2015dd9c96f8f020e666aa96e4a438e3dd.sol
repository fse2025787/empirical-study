...
contract TheEmiratis is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.001 ether;
  uint public          maxPerTx          = 50;
  uint public          maxFreePerWallet  = 50;
  uint public          totalFree         = 2500;
  uint public          maxSupply         = 5000;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("The Emiratis", "EMIR"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Emiratis...");
