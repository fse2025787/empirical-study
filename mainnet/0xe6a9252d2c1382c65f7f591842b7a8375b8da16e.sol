...
https://twitter.com/elonmusk/status/1596716236477698048?s=46&t=1cmPxA8JkS97fqoSCCNGdw
...
contract STARRY is Context,IERC20, Ownable{
using Address for address;
string private _name = "STARRY";
string private _symbol = "STARRY";
...
address _owner;
address payable public marketingAddress = payable(0x4061969E624f9096ec2a1F246447e2192808Af34);
...
uint256 STARRYCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > STARRYCOINDaycooldown, "You cant call STARRYCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function STARRYCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    STARRYCOINDaycooldown = block.timestamp + 86400;
}
