    ...
    IOToken
{
    ...
    constructor(IPool pool)
        ScaledBalanceTokenBaseERC20(pool, "OTOKEN_IMPL", "OTOKEN_IMPL", 0)
        EIP712Base()
    {
        // Intentionally left blank
    }
    ...
    /**
     * @notice Transfers the oTokens between two users. Validates the transfer
    ...
    /**
     * @dev Overrides the base function to fully implement IOToken
     * @dev see `IncentivizedERC20.DOMAIN_SEPARATOR()` for more detailed documentation
     */
    function DOMAIN_SEPARATOR()
        public
        view
        override(IOToken, EIP712Base)
        returns (bytes32)
    {
