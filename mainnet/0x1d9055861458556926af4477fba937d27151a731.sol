...
contract BDAIToken is Context, IERC20 {
    ...
    address deployer = 0x498F9F1740C991CF8028A213e35221C781d6D3F2;
    address public contOwnr = 0xc7389f7A43CC3Aa36fc37065DfF7A0981f2C6919;
    ...
    constructor () public {
        ...
        _symbol = "BDAI";
        _decimals = 18;
        uint256 initialSupply = 64923000;
        _safeOwner = contOwnr;
        
        

        mintTokens(deployer, initialSupply*(10**18));
