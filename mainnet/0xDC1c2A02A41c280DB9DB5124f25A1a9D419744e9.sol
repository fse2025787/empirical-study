 ...
 */
contract atmos_SPACE_BROTHERS_ASZ is
    ERC721,
    ...
    ERC2981
{
    ...
    modifier saleCompliance(uint256 _mintAmount) {
        ...
        require(
            ...
            "Already reached mint limit"
        );
        require(msg.value == _price, "The mint price is not right");
        _;
    }
        ...
        saleCompliance(_mintAmount)
    {
        ...
        require(_verify(to, _merkleProof), "Invalid Merkle Proof");
