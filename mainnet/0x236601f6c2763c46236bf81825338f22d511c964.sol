...
contract INSIDERS is ERC20, Ownable {
    ...
    constructor() ERC20("Insiders", "CIRCLE") {
        ...
        devWallet = address(0x61bF04D7843DD5cD645BdD1BAb27CBFE2A979F97); // set as dev wallet
