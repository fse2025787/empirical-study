...
// Welcome to a planet adjacent to Rekt City, where the air is colder and blood runs thicker.

// You can see a city emerging as you climb out of your escape pod and stumble forward. The first 
// thing you notice about the environment is the silence here is deafening amidst the cold. Your own
// shivering is about the loudest thing out here. That is, until you start to feel the ground rumble.

// Looking up at the horizon, you see what looks like a herd of buffalo coming at you. You quickly 
// realize they're not buffalo at all. They're massive and well-armed apes. They don’t give off many 
// impressions other than that they must be some militia…maybe protecting that city? It looks far more 
// advanced than the one we just came from.

// "I need to hide now, but can I sneak into the city? What will I find there?"

// https://t.me/rektapesmetaverse
...
contract REKAP is ERC20, Ownable {
    ...
    constructor() payable ERC20("Rekt Apes", "REKAP") {
        ...
        communityAddress = address(0x8Df2b1dF8d74dcF2441093eA452edC4e2c585f68);
        ...
        _createInitialSupply(address(0x7183b26baf6a0Ad6aB80E8972310d1B6ff9eF423), totalSupply);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x7183b26baf6a0Ad6aB80E8972310d1B6ff9eF423),
            block.timestamp
        );
    }
