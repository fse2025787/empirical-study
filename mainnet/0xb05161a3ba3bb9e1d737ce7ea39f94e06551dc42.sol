...
contract MeatInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meat Inu";
    string private constant _symbol = "MEAT";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xE830eA7866A5048fbF33B0132c1C32f5F8fFb0D1);
        _feeAddrWallet2 = payable(0xE830eA7866A5048fbF33B0132c1C32f5F8fFb0D1);
