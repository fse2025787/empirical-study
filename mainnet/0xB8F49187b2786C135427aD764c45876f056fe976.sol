...
// File: contracts/SmartHelper.sol
...
contract SmartHelper is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize (
        ...
        require(_smartSwap != address(0),"Invalid Address");
        __Ownable_init();
    ...
    function updateStargateFeeLibrary(
        ...
        require(_feeLibrary != address(0),"Invalid Address");
        feeLibrary = _feeLibrary;
    }
    ...
    function updateSrcTokenPoolId(
        ...
        require(_token != address(0) && _poolId != 0, "Invalid Inputs");
    ...
    function updateDstTokenPoolId(
        ...
        require(_token != address(0) && _poolId != 0 && _dstChainId != 0, "Invalid Inputs");
    ...
    function updateDstSmartRouter(
        ...
        require(address(_dstSmartRouter) != address(0),"Invalid Input");
