...
contract RMVERSE is ERC721A, Ownable {
    ...
    string public preRevealURL = "https://ipfs.io/ipfs/QmZrTn7XveLCyAszxdFM1X51u4DhVeZYRGq63DGpinLHxs";
    ...
    function claim(uint count) external payable {
        if (msg.sender != owner()) {
