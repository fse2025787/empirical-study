...
contract BTFD is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Buy The Fucking Dip";
    ...
    address payable private _developmentAddress = payable(0x036839ef6f9C4e5e2402b700b12A7B81fE0F36F7); 
    address payable private _marketingAddress = payable(0x036839ef6f9C4e5e2402b700b12A7B81fE0F36F7);
