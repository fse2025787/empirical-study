...
// 
        ...
        contract CryptoPunksMoonCats is ERC721A, Ownable, ReentrancyGuard  , DefaultOperatorFilterer{
        ...
        constructor(string memory _initBaseURI) ERC721A("CryptoPunksMoonCats", "CPMC") {
