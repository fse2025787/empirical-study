...
/*
    ...
    Want to become your best version and win prizes?
    Improve your quality of life in manys aspects by enrolling the #NoNutNovember challenge! $NONUT

    https://nonutnovember.wtf

    t.me/NoNutNovemberETH

    https://twitter.com/NoNutNovETH
...
contract NoNutNovember is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x8A54436E7394259EB4e840B8B374bc0719F9F146); 
    address payable public devWallet = payable(0xf093626197720b4696B21f4643D27cb15ff3Bce4);
    ...
    constructor() ERC20("No Nut November", "NONUT") {
