...
contract HYDRA is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("HYDRA", "HYDRA") { // 
        marketingWallet = payable(0x47D3e9CF3F0B387beb243286A691E20626989653); // 
        devWallet = payable(0x47D3e9CF3F0B387beb243286A691E20626989653); // 
