...
contract yorozu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Yorozuya";
    string private constant _symbol = "YOROZU";
    ...
    address payable private _developmentAddress = payable(0x922e4FD96EC7DA435a967Bfd8Baf5A008fa14aDd); 
    address payable private _marketingAddress = payable(0x922e4FD96EC7DA435a967Bfd8Baf5A008fa14aDd);
