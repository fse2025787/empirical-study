...
contract RIPTWIT is Context, IERC20, Ownable {
    ...
    string private constant _name = "RIP Twitter inu";
    string private constant _symbol = "RIPTWIT";
