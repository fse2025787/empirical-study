...
/*
   ...
   ░     ▓▓▓▒      ▒▒▒▒▒░   ▒▒▒▒▒    ▒▒▒▒▒▒▒░    ▒   ▒▒▒▒▒▒  ░▒▒▒▒▒    ▒▒▒▒▒▒▒░    ▒▒▒     ▒▓▓▓▓    
    ...
    https://t.me/ShrubsERC20

    https://www.shrubserc.com

    https://twitter.com/ShrubsETH
...
contract SHRUBS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHRUBS";
    string private _symbol = "SHRUBS";
    uint8 private _decimals = 9;

    address public developerWallet = 0x2F4282086A48fDbDf51ddb81a9602fA1afae5335;
    ...
    uint256 _buyDeveloperFee = 45;
    
    uint256 _sellLiquidityFee = 0;
    uint256 _sellDeveloperFee = 45;
    ...
    uint256 public minimumTokensBeforeSwap = 500_000 * 10**_decimals;
    ...
    constructor () {
        ...
        totalBuy = _buyLiquidityFee.add(_buyDeveloperFee);
        totalSell = _sellLiquidityFee.add(_sellDeveloperFee);
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        uint256 amountETHDeveloper = amountReceived.sub(amountETHLiquidity);
    ...
    function setBuyFee(uint _newLP , uint _newDeveloper) public onlyOwner {     
        _buyLiquidityFee = _newLP;
        _buyDeveloperFee = _newDeveloper;
        totalBuy = _buyLiquidityFee.add(_buyDeveloperFee);
    }

    function setSellFee(uint _newLP , uint _newDeveloper) public onlyOwner {        
        _sellLiquidityFee = _newLP;
        _sellDeveloperFee = _newDeveloper;
        totalSell = _sellLiquidityFee.add(_sellDeveloperFee);
    }

    function setWallets(address _developer,address _liquidityRec) public onlyOwner {
