...
// No more dogs on ETH chain, just piggy.
// Piggy Inu is going to become the fattest pig of history, since he is going to eat and kill all the others shitcoins.

// tg: piggyinu // twitter = twitter.com/piggyinu_eth // website = piggyinu.info
...
contract PiggyInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xbcd31e678D7E9fB128E1bEe90f376cF95B59Fbfd);
    ...
    string private _name = "Piggy Inu";
