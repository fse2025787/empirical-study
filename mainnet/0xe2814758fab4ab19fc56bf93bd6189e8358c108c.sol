...
contract TTT is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private maxBuyLimit = 10000000000 * (10**18);
    uint256 public maxWallet = _tTotal.div(10000).mul(1000);

    string private _name = "Trillion Twin Token";
