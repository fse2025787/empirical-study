...
contract HumanCyborg is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmPcoUvxP2ohJ2p4E1MwAPzh8WpWVroYjHs9FGmogiayQj/";
  uint256  public  maxSupply = 555;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.0055 ether;
