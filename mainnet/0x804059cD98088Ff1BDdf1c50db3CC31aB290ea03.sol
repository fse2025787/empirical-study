...
contract HalfDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Half Doge";
    string private _symbol = "DOGE0.5";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xC556be7c63F8cc50065BA99BA333454d60f8Dd90);
    address payable private taxWallet2 = payable(0xC556be7c63F8cc50065BA99BA333454d60f8Dd90);
    ...
    uint256 public _buyMarketingFees = 13;
    ...
    uint256 public _marketingShares = 13;
