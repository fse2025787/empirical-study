...
/**
Prob a good idea not to buy this one... maybe. 
*/
...
contract SafetyTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SafetyTest", "SafeU") {
        ...
        maxWallet = totalSupply * 200 / 1000; // 2.0% maxWallet
