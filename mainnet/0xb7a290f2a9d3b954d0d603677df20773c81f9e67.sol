...
contract SquidInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xcCfdC0153cDB58cf3B9C5F4688e505bcAb1C537A);
    address payable private _marketingAddress = payable(0xcCfdC0153cDB58cf3B9C5F4688e505bcAb1C537A);
