...
contract Mythical is ERC721A, Ownable, ReentrancyGuard{
    ...
    // Sale configuration
    uint private mintingCost = 0.2 ether;
    uint public mintedPublicSale = 0;
    uint private maxPublicSale = 967;
    ...
    constructor() ERC721A('Mythical', 'MT') {}
    ...
    /***** BREEDING ****/
    IERC721 godNft = IERC721(0xf8C5F2bFc69433C9fECEd60c16ce0fc7C3468d5F);
    IERC721 goddessNft = IERC721(0xe495133b2C53eb75b78444A7F726dAb3F08fAc23);

    uint immutable public SEED_GOD = 2;
    uint immutable public SEED_GODDESS = 1;
    uint256 public BREEDING_TIME = 2*60;
    uint256 public GOD_WAITING_TIME = 5*60;
    ...
    function cancelBreeding(uint id) public nonReentrant { 
        (uint numberActiveBreeding, uint[] memory breedingIds, uint[] memory godIds, uint[] memory goddessIds, uint[] memory startTimes) = getActiveBreeding(msg.sender);
        require(numberActiveBreeding > 0, "You dont have active breeding!");
