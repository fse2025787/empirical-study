...
contract VOYAGER is Context, IERC20Upgradeable {
    ...
    uint256 public MarketShare = 5;
    uint256 public DevShare = 0;
    uint256 public ValueDivisor = 5;
    ...
    function _checkLiquidityAdd(address from, address to) internal {
        require(!_LiqHasBeenAdded, "Liquidity already added and marked.");
