...
contract BullishBanners is ERC721, Ownable {
    ...
    constructor() ERC721("Bullish Banners", "BB") {
        setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmUv7aWtwbtPb7AMN1Ekjs1UmhCz1dVoZzBoNshQetKk57/unrevealed.json");
    }
    ...
    function widthdrawToAddress(address _address, uint256 _amount) public onlyOwner{
    ...
    function withdrawToTokenIDs(uint256[] memory giveawayId, uint256 _amount) public onlyOwner {
