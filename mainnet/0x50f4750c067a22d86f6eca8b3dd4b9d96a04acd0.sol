...
// File: contracts/babymoonowls.sol
...
contract BabyMoonOwls is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public PUBLIC_PRICE = .0085 * 10**18;
    ...
    constructor(string memory initBaseURI) ERC721A("Baby Moon Owls ", "BMOS") {
        baseURI = initBaseURI;
