...
contract RedEyedDragon is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = "Red Eyed Dragon";
    string private _symbol = "RyeD";
    ...
    constructor () {
        ...
        gateio = payable(address(0xbd0Fd3e4cD84d2FEce1435083E0F79297C95BE16));
