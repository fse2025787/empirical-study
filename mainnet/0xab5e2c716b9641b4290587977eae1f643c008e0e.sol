...
contract ChurchProtector is Context, IERC20, Ownable {
    ...
    string private constant _name = "Church Protector";
    string private constant _symbol = "KIRK";
    ...
    constructor () {
        _feeAddress = payable(0x0f8aE8c06923bA25729C707e0e361A91af3576aC);
        _buyTax = 6;
        _sellTax = 6;
