...
contract LENNY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lenny the Squirrel";
    ...
    address payable private _developmentAddress = payable(0x014E0776af2B44fF0a3d2F3AE60dfF7D38Cc4826); 
    address payable private _marketingAddress = payable(0x014E0776af2B44fF0a3d2F3AE60dfF7D38Cc4826);
