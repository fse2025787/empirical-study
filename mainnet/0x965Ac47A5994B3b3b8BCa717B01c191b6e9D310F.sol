...
contract THERISUINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB9C19eBfc86221140bd2241B90554F1F1f5344f9); 
    address payable public Wallet_Utility = payable(0xca4c8ca5adAab9045432a737645C99f5df71EF7a);
    ...
    string private constant _name = "THE RISU INU"; 
    string private constant _symbol = unicode"THERINU"; 
    ...
    constructor () {
        ...
        _owner = 0xca4c8ca5adAab9045432a737645C99f5df71EF7a;
