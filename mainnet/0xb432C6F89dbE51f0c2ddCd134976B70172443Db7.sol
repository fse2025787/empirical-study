 ...
 * @notice This contract handles minting Divine Feminine Access Pass by The Women Collective tokens.
 */
contract DivineFeminineAccessPassByTheWomenCollective is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x3Ec84430385C97B7006237e9F97394Bb3d66f7A2;
    ...
    address public royaltyAddress = 0x6D1831Fd1db64e63A8fcb5C51FF653943E643Ef0;
    address[] public payoutAddresses = [
        0x6D1831Fd1db64e63A8fcb5C51FF653943E643Ef0
    ];
    ...
    string public name = "Divine Feminine Access Pass by The Women Collective";
    string public symbol = "APTWC";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeicsdens4kodz4vrz6gw3yholq7d3xcfuzmlh2uspevzhp47lriyje/{id}"
        )
    {
        blocklistContractAddress = _blocklistContractAddress;
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        tokenMaxSupply[1] = 500;
        tokenPublicPrice[1] = 0.015 ether;
        tokenPublicMintsPerAddress[1] = 15;
        tokenPublicSaleStartTime[1] = 1671654600;
        tokenPublicSaleEndTime[1] = 1986988639;
