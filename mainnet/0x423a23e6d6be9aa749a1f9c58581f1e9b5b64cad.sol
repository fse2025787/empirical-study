...
contract MetaVerse is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PUBLIC_PRICE = 0.19 ether;
    uint256 public constant PRESALE_PRICE = 0.16 ether;
    ...
    constructor(address dev, address artist, address dao) ERC721A("MetaVerse Kangaroo", "MVK") {
        startTime = 1657483200;
        endTime = 1658088000;
        devWallet = dev;
        artistWallet = artist;
        daoWallet = dao;
