...
/**   
        ...
        * Telegram: https://t.me/+AkSnJ82IuXgwNTMy
...
contract THESEEKES is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Seekers";
    string private constant _symbol = "SEEKES";
    ...
    address payable private _developmentAddress = payable(0x99f0B22903898a44e6a103B87c75B39b9F0EeF53);
    address payable private _marketingAddress = payable(0x99f0B22903898a44e6a103B87c75B39b9F0EeF53);
    ...
    function fireLaunch() external onlyOwner() {
