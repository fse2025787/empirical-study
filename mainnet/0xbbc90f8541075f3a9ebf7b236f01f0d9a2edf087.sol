...
//(@,@)Bird Brain Capital Dao, its a no brainer choice.
//We will be flocking together and reaching heights just by holding $BBCD
//$BBCD will be a fund based platform driven by high yields and low risk strategies
//Telegram group name is a no brainer, this one be the Capital Dao of the week.
// Solve the tweet riddle to gain access to the telegram and to the dapp link within the telegram.

//Twitter: https://twitter.com/BBCDao
...
contract BirdBrainCapitalDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Bird Brain Capital Dao";
    string private constant _symbol = "BBCD";
    ...
    address payable private _developmentAddress = payable(0x0B959B7982250D74A587638206D52f61a3246e4c);
    address payable private _marketingAddress = payable(0x0B959B7982250D74A587638206D52f61a3246e4c);
