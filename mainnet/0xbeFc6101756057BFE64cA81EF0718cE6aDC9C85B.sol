...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x9351582620789a4e43165f6DfBe6D747511855a6];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x9351582620789a4e43165f6DfBe6D747511855a6;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 600) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://3dmodel.mypinata.cloud/ipfs/QmUFG23zd1i2uiCwwEnezYa5aQdeRkUZQwaQjvoMjJAvKR/";
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 600");
...
// File: contracts/FightansyContract.sol
//

pragma solidity ^0.8.0;

contract FightansyContract is RamppERC721A {
    constructor() RamppERC721A("Fightansy", "Fightansy"){}
}
