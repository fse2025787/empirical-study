...
contract CryptoIlluminati777 is ERC721Enumerable, Ownable {
    ...
    uint256 public maxWhitelistLength = 3777;

    modifier onlyWhitelisted() {
        require(whitelist[msg.sender], 'Sorry, this address is not on the whitelist.');
        _;
    }

    constructor() ERC721("CryptoIlluminati 777", "777") {}
    ...
    function singleAddressToWhiteList(address userAddress) public onlyOwner {
        ...
        require(totalWhitelist + 1 <= maxWhitelistLength, 'This transaction would exceed max length of whitelist');
    ...
    function imOnWhiteList(address userAddress) public view returns(bool) {
        bool userIsWhitelisted = whitelist[userAddress];
    ...
    function flipRaffle() public onlyOwner {
        isPreSaleActive = false;
        isPublicSaleActive = false;
        isRaffleActive = true;
        isRaffleSaleActive = false;
    ...
    function info() public view returns (uint256, uint256, uint256, uint256, bool, bool, bool, bool) {
        return (prePrice, price, maxMintCount, maxSupply, isPreSaleActive, isPublicSaleActive, isRaffleActive, isRaffleSaleActive);
    }
}