...
contract smasamurais is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("smasamurais", "smas") {
        setBaseURI("");
	...
	require(saleActivated, "Mint: Mint process is pause");
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max smasamurais per address exceeded");
        require(_mintAmount > 0, "Cant mint 0 smasamurais");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more smasamurais" );
        require(s + _mintAmount <= maxSupply, "Cant exceed smasamurais supply");
