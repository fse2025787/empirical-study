...
contract DSV is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xa2a9359e3A9Ab3e5589BfA5fA3Cb75cA5C0aCfBe;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 75000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DSV";
    string private _symbol = "DSV";
    ...
    uint256 public _maxTxAmount = 75000000 * 10**8;
    ...
    constructor () {
       ...
       IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        ...
        //Mian Net
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xA58350d6dEE8441aa42754346860E3545cc83cdA);
