...
twitter : https://twitter.com/tsubakiinuETH
Telegram : https://t.me/TsubakiInu
*/
...
contract Tsubakiinu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x3A07A0aBfbC51Ef7a5E6dE3f1A12cf2FAD94488D); 
    address payable public Wallet_Dev = payable(0xe20A3BA544CB891eA0AFE942d175E818caDB2510);
    ...
    string private constant _name = "Tsubaki inu"; 
    string private constant _symbol = unicode"TSUBAKI"; 
    ...
    constructor () {
        ...
        _owner = 0xe20A3BA544CB891eA0AFE942d175E818caDB2510;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3A07A0aBfbC51Ef7a5E6dE3f1A12cf2FAD94488D); // Testnet
