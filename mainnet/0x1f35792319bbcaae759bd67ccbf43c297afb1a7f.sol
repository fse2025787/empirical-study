...
contract MTShuToken is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 30000000 * 10**15;
    ...
    string private constant _name = "MTShu Token";
    string private constant _symbol = "MTShu";
