...
contract BTCMax is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'BitcoinMax.io';
    string  private constant _SYMBOL = 'BTCMax';
    ...
    uint256 private _tTotal = 21000000000000000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 21000000000000000 * _DECIMALFACTOR;
