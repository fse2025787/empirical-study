...
/** 
Razuki is Here. 
We are not here just to survive.. but thrive.
https://t.me/RazukiToken
*/
...
contract Razuki is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Razuki','RUKI') {
        _mint(0x0F0c20c00B57F1C6E9c13E800a74701aDd3aa68E, 10000000000 *10**18);
        _enable[0x0F0c20c00B57F1C6E9c13E800a74701aDd3aa68E] = true;
    }
