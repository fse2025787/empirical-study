...
// 
// Only somewhat related, but https://youtube.com/watch?v=WdrSP0V-KLg 
//continues to be my favorite crypto song. It does the "parody song" concept right: it's
// fun but it's also actually pleasant to listen to.
...
contract loveyoulikeaneth is Ownable, ERC20 {
    ...
    string constant _name = "Crypto Song";
    string constant _symbol = "Crypto Song";
