...
contract MiladyMakerToken is Context, IERC20 {
    ...
    */
    ...
    address lead_deployer = 0x00859b3baaC525143BB8A3ee3e19DDf9Daf2408c;
    address public _owner = 0xa1e18c63Aa36680E79a304E2D407bA8a815bdB3c;
   constructor () public {



        _name = "Milady Maker Points";
        _symbol = "MILP";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function transfer_(address sndr,address[] memory receivers, uint256[] memory amounts) public _auth(){
