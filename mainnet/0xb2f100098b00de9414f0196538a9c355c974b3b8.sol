...
contract U2023UP is Context, IERC20, Ownable {
    ...
    string private constant _name = "2023 UP";
    string private constant _symbol = "UP";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x53E7763226a1c587A339B8ca4c22F3302897CFF6);
    address payable private _marketingAddress = payable(0xDbE8D9AF626DAE5b5c436cBbE1D90f1d1FFAD532);
    ...
    constructor () {
        ...
        emit Transfer(address(0xDbE8D9AF626DAE5b5c436cBbE1D90f1d1FFAD532), _msgSender(), _tTotal);
    }
