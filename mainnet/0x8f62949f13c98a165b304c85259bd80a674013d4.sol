...
//╚═════╝  ╚═════╝  ╚═════╝ ╚═════╝ ╚══════╝╚══════╝
//
// Website: https://labradoodletoken.com/
// Telegram: https://t.me/Labra_doodle
//
interface IERC20 {
...
contract doodle is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Labradoodle";
  string constant tokenSymbol = "DOODLE";
