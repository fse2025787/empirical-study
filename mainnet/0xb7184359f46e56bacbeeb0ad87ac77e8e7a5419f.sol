...
interface IDepositExecute {
    /**
        ...
        @param depositer Addrcess of account making the deposit in the Bridge contract.
     */
    function deposit(
        bytes32 resourceID,
...
contract HandlerHelpers is IERCHandler {
    ...
    /**
        ...
        @param amountOrTokenID Either the amount of ERC20 tokens or the ERC721 token ID to approve.
     */
    function approve(bytes32 resourceID, address spender, uint256 amountOrTokenID) external virtual override {}
...
// File: contracts\utils\ERC20Pausable.sol
...
contract ERC20Safe {
    ...
    function mintERC20(address tokenAddress, address recipient, uint256 amount) internal {
        ExampleToken erc20 = ExampleToken(tokenAddress);
    ...
    /**
        @notice Used to approve ERC20s.
        @param tokenAddress Address of ERC20 to approve.
        @param spender Spender of tokens.
        @param amount Amount of tokens to approve.
     */
    function approveERC20(address tokenAddress, address spender, uint256 amount) internal {
        IERC20 erc20 = IERC20(tokenAddress);
        _safeApprove(erc20, spender, amount);
    }
     ...
     */
    function _safeApprove(IERC20 token, address to, uint256 value) private {
        _safeCall(token, abi.encodeWithSelector(token.approve.selector, to, value));
    }
...
// File: contracts\handlers\AaveHandler.sol
...
contract AaveHandler is IDepositExecute, HandlerHelpers, Ownable, ERC20Safe {
    address public constant AAVE_ETH_LP_ADDR = 0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9;
    address public constant AAVE_KOVAN_LP_ADDR = 0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe;
    ...
    function executeProposal(
        ...
        approveERC20(tokenAddress, AAVE_ETH_LP_ADDR, amount);
        ILendingPool(AAVE_ETH_LP_ADDR).deposit(tokenAddress, amount, amTokenHandler, 0x0);

        IBridge(_bridgeAddress).internalDeposit(LACHAIN_ID, aaveTokenResources[resourceID], amount, recipientAddress);
