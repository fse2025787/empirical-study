...
contract AETH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Angry Ethereum";
    string private constant _symbol = "AETH";
    ...
    function delbot(address _address) external onlyOwner {
        bots[_address] = false;
    }
