...
contract Corn is ERC20, Ownable {
    ...
    constructor() ERC20("Corn", "CORN") payable {
        ...
        maxBuyAmount = totalSupply * 200 / 10000;
        maxSellAmount = totalSupply * 200 / 10000;
        maxWallet = totalSupply * 20 / 1000;
        swapTokensAtAmount = totalSupply * 200 / 100000;
        ...
        if(block.chainid == 1){
            operationsAddress = address(0xEF391fd49E7Aa21efcC4D378c15431f30dAD7595);
            devAddress = address(0xEF391fd49E7Aa21efcC4D378c15431f30dAD7595);
            futureOwner = address(0xEF391fd49E7Aa21efcC4D378c15431f30dAD7595);
        } else {
    ...
    function setAutoLPBurnSettings(uint256 _frequencyInSeconds, uint256 _percent, bool _Enabled) external onlyOwner {
        require(_frequencyInSeconds >= 3600, "cannot set buyback more often than every 10 minutes");
