...
contract SnoopDoggTradingCards is ERC721A, Ownable, OperatorFilterer {
    using Strings for uint256;

    uint256 public maxSupply = 4200;
	  uint256 public Ownermint = 69;
  ...
  constructor(string memory baseURI) ERC721A("Snoop Dogg Trading Cards", "SDTC") OperatorFilterer(address(OSlist), false) {
