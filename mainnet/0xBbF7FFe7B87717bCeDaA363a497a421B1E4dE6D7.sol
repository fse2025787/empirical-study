...
contract SkiesofHeroes is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1000;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xd8e17ffe4636fb517bca3979e09b9e73308b033a5d37ccffcc8c2424161644bb;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://Qmda91fjnp4mdsK57oBk794p3p7WctJXrxc9EjXxQEZvL7";

    constructor() public ERC721A("Skies of Heroes", "SKY", 1000, 1000) {}
