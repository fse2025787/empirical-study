...
contract SHIBNEX is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibnex";
    string private constant _symbol = "$SHIBNEX";
    ...
    address payable private _developmentAddress = payable(0xA5183e3896723517E1FCbe12Dd66186F864bB9B5); 
    address payable private _marketingAddress = payable(0x3D30397c916764BFabBe1AD25F9eb6eE7ECC68be);
