...
/*
  DAOofGold - $GSD
  ~ "The Gold Standard of DAO's"

  https://t.me/DaoOfGold
  https://www.gsdao.org

  https://gold-standard-dao.gitbook.io/gold-standard-dao
...
contract dAPPRewards is Ownable {
  ...
  function InitiateBond() onlyOwner ifdAPPRewardsOff public {
    special = true;
    emit dAPPRewardsOn();
  }
...
contract DAOofGold is Context, IERC20, Ownable, dAPPRewards {
    ...
    uint256 private _tTotal = 150000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DAOofGold";
