...
contract PeaceRabbitNFT is ERC721A, Ownable {
    ...
    bytes32 public merkleRoot = 0x835fd0c673f89c79458d58059d46c9951401aa7d1e8bc55be147a20b3b3e0c51;
    string private _baseURL;
    string public preRevealURL = "ipfs://QmYFwibvVACaGgLenJ5hjsGKgc6yceD64TQYuFciLESuyD";
    ...
    function contractURI() public pure returns (string memory) {
        return "data:application/json;base64,";
    }
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        require(count <= TOKENS_PER_TRAN_LIMIT, "PeaceRabbitNFT: Number of requested tokens exceeds allowance (5)");
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            ...
            require(_mintedCount[msg.sender] + count <= TOKENS_PER_PERSON_PUB_LIMIT, "PeaceRabbitNFT: Number of requested tokens exceeds allowance (5)");
