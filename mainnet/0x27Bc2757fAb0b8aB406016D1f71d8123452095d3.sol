...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x3832d2F059E55934220881F831bE501D180671A7); //the reward token you want distributed
...
contract TrogeETH is IBEP20, Auth {
    using SafeMath for uint256;
    address REWARDS = 0x3832d2F059E55934220881F831bE501D180671A7; //Input the token address of whatever your reward is. leave 431,432,433 as is.
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address _marketingAdr = 0x70A6Db3201dBD6B9221E9d5FEbc021fFA071dc1D;
    address routerv2 = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    string constant _name = "Troge";
    string constant _symbol = "TROGE";
    ...
    constructor() Auth(msg.sender) {
        router = IDEXRouter(routerv2); // ETH Testnet
    ...
    function flushContract(uint256 amount) public authorized {
    ...
    function setMarketingFeeReceiver(address marketingAddr) public onlyOwner {
        marketingFeeReceiver = marketingAddr;
    }
