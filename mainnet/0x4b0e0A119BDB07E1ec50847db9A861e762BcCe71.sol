...
contract GuardiansofMonkeyGalaxy is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.002 ether;
    uint   public maxTx             = 920;
    uint   public maxSupply         = 920;
    uint256 public reservedSupply   = 300;
    string private baseURI          = "ipfs://bafybeievvhu2wlq2bdhvaxb3nnx35hai3rimdsr7uqprne4xqcnw52heru/";
    ...
    constructor() ERC721A("Guardians of Monkey Galaxy", "GMGNFT") {}
    ...
    function RMint(uint256 Amount) external onlyOwner
    {
