...
contract OrcRaid is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

  string public baseURI = "ipfs://QmPbvkmeZP6t64XwW5543ZJBGXcE2aG4XSaXixCFr3gBmR/";
  string public baseExtension = ".json";
  string public notRevealedUri = "ipfs://QmPbvkmeZP6t64XwW5543ZJBGXcE2aG4XSaXixCFr3gBmR/";
  uint256 public cost = 0.01 ether;
  uint256 public maxSupply = 3200;
  uint256 public FreeSupply = 3200;
  ...
  ) ERC721A("OrcRaid", "TOR") {  // change the name and symbol for your collection
