...
/**
    ...
    Telegram: https://t.me/AnimeChainERC
    Twitter:  https://twitter.com/animechainerc
...
contract AnimeChain is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xfb42B2a83a13cD87679215dB3b4243D9B35f0Cd1); // Marketing Address
    address payable public multiSigAddress = payable(0xfb42B2a83a13cD87679215dB3b4243D9B35f0Cd1); // Marketing Address
    address payable public devAddress = payable(0xfb42B2a83a13cD87679215dB3b4243D9B35f0Cd1); // Dev Address
    address payable public liquidityAddress = payable(0xfb42B2a83a13cD87679215dB3b4243D9B35f0Cd1); // Liquidity Address
    ...
    string private constant _name = unicode"Anime Chain";
    string private constant _symbol = unicode"ANIMECHAIN";
