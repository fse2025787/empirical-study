...
contract Yecosystem is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yecosystem";
    ...
    address payable private _developmentAddress = payable(0x020Da674c406e6A5877DD5f7F82aD5ce2D185fab);
    address payable private _marketingAddress = payable(0x020Da674c406e6A5877DD5f7F82aD5ce2D185fab);
