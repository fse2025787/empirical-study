...
// Buy tax 0%
// Sell tax 12%
// * 2% Redistribution to holders (Auto-Reflection)
// * 10% Buybacks, LP, Development, Marketing
// Sell tax will apply only for 2 hour from last buy after will be 0%.
//
// Website
// https://shubier20.com/
//
// Twitter
// https://twitter.com/ShibaUBI
//
// Telegram
// https://t.me/ShibaUBI
//
...
contract ShibaUBI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Shiba UBI";
    string private constant _symbol = "SHUBI";
    ...
    address payable private _developmentAddress = payable(0xc7BCD2e20C5350Ab9b2942D4eF929C548bd8b468);
    ...
    uint256 public _maxTxAmount = 3e6 * 10**9; //
    uint256 public _maxWalletSize = 5e6 * 10**9; //
    uint256 public _swapTokensAtAmount = 5e4 * 10**9; //
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                if (_buyMap[from] != 0 && (_buyMap[from] + (3 minutes) >= block.timestamp)) {
                    _redisFee = 2;
                    _taxFee = 10;
                } else {
