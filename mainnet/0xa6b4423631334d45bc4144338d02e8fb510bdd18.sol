...
contract TheHand is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;

  string public baseURI = "ipfs://bafybeieh4oqb3nauetrebvoztw7bndwo43tkmik5smvh2rpoleavt6lrfq/";

  constructor() 
    ERC721("The Hand", "WH")
    RandomlyAssigned(999,0) // Max. 1000 NFTs available; Start counting from 0 
      ...
      payable
  {
      ...
      require( availableTokenCount() - 5 >= 0, "YOU CAN'T MINT MORE THAN AVALABLE TOKEN COUNT"); 
