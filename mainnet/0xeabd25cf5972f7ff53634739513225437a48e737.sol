...
contract FundingPublicGoods is ERC721, Ownable {
    ...
    constructor(string memory baseURI) ERC721("GTC Domains", "GTC-DOMAINS")
    {
    ...
    function contribute(address subDomainOwner, string memory subDomain)
        ...
        returns (uint256)
    {
        require(msg.value > 9999999999999999, "You need to contribute at least 0.01ETH to the Matching pool to be eligible for a gtc.eth subdomain");
    ...
    function TransferAllToMatchingPool() 
        private
    {  
        matchingpool.transfer(address(this).balance);
    }
