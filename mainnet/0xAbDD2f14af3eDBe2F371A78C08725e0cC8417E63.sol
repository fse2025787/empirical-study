...
/*
    Love Master Dev - Fighting against the hate. 
 
    LMD - For everyone who has made money on his plays and appreciates the pump.
    Others are hating, some made money, some missed out, and jeets sold too fast.  
    
    1.5% max txn at launch, marketing coming after launch
...
contract LoveMasterDev is Context, IERC20, Ownable {
    ...
    string private _name = "Love Master Dev";
    string private _symbol = "LMD";
