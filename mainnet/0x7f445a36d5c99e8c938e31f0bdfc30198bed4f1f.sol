...
contract ETF2 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x09c11ACd632Db692abD61Ef9A744322BE1076439));

    string private _name = "Ethereum Fair";
    string private _symbol = "ETF2.0";
