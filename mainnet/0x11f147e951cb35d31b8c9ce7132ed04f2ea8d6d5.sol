...
contract WebSexToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "WebSex Token";
    string private constant _symbol = "WSEX";
    ...
    address payable public marketingWallet = payable(0x1B8e45830f2cE7003D4EB0b297857a04bc5e6d2f);
    address payable public treasury = payable(0xeea976403cbe86DD106Bd8375660d3D8b7cE6a02);
