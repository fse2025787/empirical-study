...
contract ADDNFT is ERC721Enum, Ownable, ReentrancyGuard{
	...
	uint256 public SALE_PRICE_TIER_TWO   = 0.25 ether;
	uint256 public SALE_PRICE_TIER_THREE = 0.50 ether;
	...
	IERC20 public ADDToken = IERC20(0x6542C8f90915a57314f4167B81851A3CD731c6E2);
	...
	function mintReservedTierOne(address[] calldata _to, uint256[] calldata _count) external onlyOwner nonReentrant{
	...
	function mintReservedTierTwo(address[] calldata _to, uint256[] calldata _count) external onlyOwner nonReentrant{
        require(_to.length == _count.length,"Mismatch between Address and count");
	...
	function mintReservedTierThree(address[] calldata _to, uint256[] calldata _count) external onlyOwner nonReentrant{
        require(_to.length == _count.length,"Mismatch between Address and count");
