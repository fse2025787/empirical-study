...
contract BAIKA is ERC20, Ownable {
    ...
    constructor() ERC20("BAIKA", "BAIKA") payable {
    	...
    	marketingWallet = address(0x797fbed2935ba524e91D52A3995115B9BBc6BF0f); // set as marketing wallet
        ...
        excludeFromFees(0xD15b26904C3CcE387B338A40dc65fC86694eDED6, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xD15b26904C3CcE387B338A40dc65fC86694eDED6, true);
        ...
        */
        ...
        _createInitialSupply(0xD15b26904C3CcE387B338A40dc65fC86694eDED6, totalSupply*10/100);
