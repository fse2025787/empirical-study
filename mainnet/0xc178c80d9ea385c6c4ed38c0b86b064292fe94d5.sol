...
// File: contracts/Shortcutter.sol
...
contract Shortcutter is ERC721A, Ownable{ 
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintLimitPerWallet, uint256 maxMintPerTX, bool isSaleActive, uint256 freeMintSupply) ERC721A("Shortcutter", "JACK"){
    ...
    function mint(uint256 _mintAmount) public payable mintRegulation(_mintAmount) {
        ...
        function initialize(uint256 _mintAmount) public mintRegulation(_mintAmount) onlyOwner {
        _safeMint(msg.sender, _mintAmount);
    }
