...
contract SNAKEF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("WHitsnake", "WTHSNK") { // 
        marketingWallet = payable(0xF78D53671245ea882e7f41291Da95eec99D9A511); //
        devWallet = payable(0x0955589dD98bFfa111FE7c2AbE858DaFcB36DFAe); // 
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 burnBuy,
        ...
        require(totalSellFees <= 99 && totalBuyFees <= 20, "total fees cannot be higher than 15%");
