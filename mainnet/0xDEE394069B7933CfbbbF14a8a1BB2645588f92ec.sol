...
TELEGRAM : https://t.me/TigerJitsu
WEBSITE :  https://www.TigerJitsu.com
...
contract TigerJitsu is Context, IERC20 {
    ...
    address payable private _marketingWallet = payable(0xA207248d69052706599091B4CCca892DfDa19A20);
    address payable private _teamWallet = payable(0xA207248d69052706599091B4CCca892DfDa19A20);
...
//===============================================================================================================
    ...
    function setBlacklistWallets(address[] calldata account) external onlyOwner() {
        for (uint256 i; i < account.length; ++i) {
          _isSniperOrBlacklisted[account[i]] = true;
        }
      }    
