...
contract phoblintown is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNYoykng5niMgTsT6LUKxC8vHw2C1ooe7hw37fpTDgcf8";
    ...
    constructor(
    ) ERC721A("phoblintown.wtf", "phob", 100, maxSupply) {
    }
