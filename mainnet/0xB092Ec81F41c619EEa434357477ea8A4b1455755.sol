...
contract JustEthereumApe is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Just Ethereum Ape.", "JEA") {
        PRICE = price;
    ...
    function mintApe(uint32 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    function dropApe(address _to, uint _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
