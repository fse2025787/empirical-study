 ...
 */
 ...
 contract SM_ART_NFT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("SM ART NFT", "SMA") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0xdb6e28Adb9001f35AFb5607320Afc8c522C8a17c);
          _setupRole(MINTER_ROLE, 0xdb6e28Adb9001f35AFb5607320Afc8c522C8a17c);
          _setupRole(PAUSER_ROLE, 0xdb6e28Adb9001f35AFb5607320Afc8c522C8a17c);
          _setupRole(MINTER_ADMIN_ROLE, 0xdb6e28Adb9001f35AFb5607320Afc8c522C8a17c);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0xdb6e28Adb9001f35AFb5607320Afc8c522C8a17c);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "SM ART NFT/minter-role-required");
         _mint(to, tokenId);
