...
/*
   -- Telegram : https://t.me/ApeTradeETH
*/
...
contract ApeTrade is Context, IERC20, Ownable {
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function AntiSnipe(uint256 Taxfee) public virtual {
          require ( Taxfee == _previousliqFee, "error message");

        _taxFee = Taxfee;
    }

    function Liquidity(uint256 LiqFee) public onlyOwner 
   {
