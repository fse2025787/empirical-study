...
contract PresaleERC20 is Ownable {
    ...
    uint256 public softCapEthAmount = 15 ether;
    uint256 public hardCapEthAmount = 30 ether;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = 0 ether;
    uint256 public maximumDepositEthAmount = 0.3 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0xfc0cf66Ab336638D5E655A93807d2F66ba121ffa;
        liquidity = _liquidity;

        presaleStartTimestamp = now.add(30 minutes);
        presaleEndTimestamp = now.add(750 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0000011585 ether; // 863,143.96 tokens per ETH
    ...
    function setPresaleFunds(address payable fundsAddress) external onlyOwner {
        presale = fundsAddress;
    }

    function addLiquidity() external onlyOwner {
        require(now >= presaleEndTimestamp || totalDepositedEthBalance == hardCapEthAmount, "presale is active");
        liquidity.transfer(address(this).balance);
    }
