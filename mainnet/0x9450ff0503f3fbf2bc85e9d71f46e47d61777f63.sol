...
contract Babyrareapepeyc is ERC721A, Ownable {

    string public baseURI = "https://ipfs-storage.s3.amazonaws.com/babyrareapepeyc/";

    uint256 public tokenPrice = 50000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("Babyrareapepeyc", "BBRC", 100, MAX_TOKENS) {
    }
