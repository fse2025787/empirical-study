...
/**
   ...
   Sufferin' succotash! - Oh ho ho ho, degen hunters is da cwaziest peoples! Ha ha ha
   Consequences, Schmonsequences, as long as I'm rich
   Can you imagine anything so ridiculous as 0% Tax?!?!
   I can't help it. I'm a greedy slob. It's my hobby. Save me!

   Starting from where we are we send 1,000,000,000,000 turbo miles due up. Then west in an arc-deviation to here. 
   Then following the Great Circle several radiolubes south by down-east. By astro-astroble to here, 
   here, and here, then by space navigal compass to here, here and then to here, and here. 
   By thirteen point strato-cumulus going four million light years and THUS to our destination, Planet Uniswaps.

   Twitter    ---------------->  @daffycoin <---]
   Telegram Check Above-------------------------] or below -----]
   Website Look Below ------]                                   ]
                            ]                                   ]
                            ]                                   ]
                            ]                                   ]
...
contract DAFFYDUCK is Context, IERC20, Ownable {
    ...
    // My Name
    string private _name = "DAFFYDUCK";
    string private _symbol = "DAFFY";
    ...
    address payable public marketingWallet = payable(0x6932619C57737F9f88F1C027c1dd1714101b8057);
