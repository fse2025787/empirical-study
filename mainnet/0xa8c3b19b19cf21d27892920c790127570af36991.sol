...
/**
The history of the creation of Japan goes back to the time when the universe was in chaos and the birth when the children of the first gods were born. Among them,

Izanagi and his sister and the wife, Izanami were ordered to organize the world.

Shortly after the invention of their fertility ritual, several kami (Japanese deities) and islands were born from the union of the two gods,

including the Japanese archipelago and some major deities of Shintoism such as the god of fire, Kagutsuchi (or Homasubi).

The birth of the latter is also a fundamental element of the story since Izanami died of burns from childbirth and went to the kingdom of the dead.

The sequel recalls the myth of Orpheus.
...
contract IZANAGI is ERC20, Ownable {
    ...
    constructor() ERC20("Izanaki", "IZANAKI") {
