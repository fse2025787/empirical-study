...
contract MaskKids is ERC721A, TheOperatorFilterer {

    address public owner;

    uint256 public maxSupply = 1111;

    address public maskCoin;

    uint256 public cost;

    uint256 public maxFreeTx= 2;
    ...
    function mint_mask(uint256 amount) payable public {
    ...
    function team_mint_mask(address rec, uint256 amount) public onlyOwner {
    ...
    constructor() ERC721A("Mask Kids", "MK") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmWddLrMgCUPqYPjnr4HUgtUyPoBK94Ja7hXHY1c7mnkUQ/", _toString(tokenId), ".json"));
    }
