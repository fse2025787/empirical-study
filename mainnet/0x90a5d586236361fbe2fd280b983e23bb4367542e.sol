...
contract DuckRace is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 680;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant MAX_PER_WALLET = 2;
    uint256 public constant COST = 0.001 ether;

    string private constant _name = "Duck Race";
    string private constant _symbol = "DUCKRACEr";
    string private constant _contractURI = "QmWdrTrP9PULC3UEgK4zojTGiVmV2g2jbM9Y3k2DwLHbZe";
    string private constant _baseURI = "QmcwUhQKga7rQEELD7pwUwuaHtdKT6ASpFEj58pmEGRyYF";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount + _numberMinted(_caller) <= MAX_PER_WALLET, "AccLimit");
