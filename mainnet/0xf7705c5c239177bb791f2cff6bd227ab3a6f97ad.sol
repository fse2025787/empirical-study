...
/*
   ________                _         _       __      __________         
  / ____/ /___ ___________(_)____   | |     / /___ _/ __/ __/ /__  _____
 / /   / / __ `/ ___/ ___/ / ___/   | | /| / / __ `/ /_/ /_/ / _ \/ ___/
/ /___/ / /_/ (__  |__  ) / /__     | |/ |/ / /_/ / __/ __/ /  __(__  ) 
\____/_/\__,_/____/____/_/\___/     |__/|__/\__,_/_/ /_/ /_/\___/____/  


https://t.me/ClassicWaffles

no wl wallets like the other, just send it.
 */                     
...
contract ClassicWaffles is IERC20, Ownable {
    IRouter public uniswapV2Router;
    address public uniswapV2Pair;
    string private constant _name =  "Classic Waffles";
    string private constant _symbol = "\xF0\x9F\xA7\x87";
    ...
    constructor() {
        ...
        treasuryWallet = payable(0x4544aA854C6bd0e033075B1d3F95c8b7c9f0Dfc6); // gnosis safe (mainnet)
        devWallet = 0xbd9e0CC10B4ee6462430543d21F92b33c0338c30; // dev deployer (mainnet)
