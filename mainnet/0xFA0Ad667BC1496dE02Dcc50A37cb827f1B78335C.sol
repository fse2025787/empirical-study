...
contract BlockchainsandDragons is ERC721, Ownable, Mintable {
    string private _currentBaseURI;
    address public _owner;

    uint constant tokenPrice = 0.08 ether;
    uint constant max_Supply = 5000;

    uint public bought_for_imx = 0;

    uint public sale_startTime = 1638306000;
    bool public pause_sale = false;
    
    //testnet: 0x4527be8f31e2ebfbef4fcaddb5a17447b27d2aef
    //miannet: 0x5FDCCA53617f4d2b9134B29090C87D01058e27e9
    constructor(address _imx)
        ERC721("Blockchains and Dragons", "BAD")
    ...
    //This is a function to keep track of how many nfts have been bought to stop over buying.
    //Nfts will be minted through IMX Platform and will be disributed to the buyers.
    function buy(uint _count) public payable{
        require(_count > 0, "mint at least one token");
        require(_count <= 20, "Max 20 Allowed.");
        require(bought_for_imx + _count <= max_Supply, "Not enough tokens left");
        ...
        bought_for_imx += _count; //Counting how many have been bought
    } 
