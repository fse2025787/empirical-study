...
contract Shiblings is ERC20, Ownable {
    ...
    uint256 public earlySellEcosystemFee;
    ...
    constructor() ERC20("Shiblings", "SHIBS") {
        ...
        uint256 _earlySellEcosystemFee = 10;
        ...
        earlySellEcosystemFee = _earlySellEcosystemFee;
    ...
    function updateSellFees(uint256 _EcosystemFee, uint256 _liquidityFee, uint256 _MarketingFee, uint256 _earlySellLiquidityFee, uint256 _earlySellEcosystemFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if (!isBuy && enableEarlySellTax) {
            if (_holderFirstBuyTimestamp[from] != 0 &&
                ...
                sellEcosystemFee = earlySellEcosystemFee;
                sellTotalFees = sellEcosystemFee + sellLiquidityFee + sellMarketingFee;
            } else {
                sellLiquidityFee = 3;
                sellEcosystemFee = 3;
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForMarketing += fees * sellEcosystemFee / sellTotalFees;
            }
            // on buy
                ...
                tokensForMarketing += fees * buyEcosystemFee / buyTotalFees;
            }
