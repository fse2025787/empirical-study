...
contract Shikimori  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shikimori Coin";
    ...
    address payable private _developmentAddress = payable(0x7E0a5cc3EDD55CcDc9212CA87e51292DAE443543); 
    address payable private _marketingAddress = payable(0x7E0a5cc3EDD55CcDc9212CA87e51292DAE443543);
