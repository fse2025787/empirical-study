...
contract ERC721Tradable is ERC721Full, Ownable {
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory) {
        return Strings.strConcat(baseTokenURI(), Strings.uint2str(_tokenId), ".json");
    }
...
contract Creature is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("Wrapped-HashPunks", "W", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://turgutb455.github.io/turguta--github.io/links/collection-images-info/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://turgutb455.github.io/turguta--github.io/links/collection-info/1.json";
    }
}