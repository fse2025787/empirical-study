...
The time is now to create our movement to bring back Apu!

We must destroy wokeness before it destroys our society!

Telegram:
https://t.me/ApuInuEthereum
...
contract APU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Apu Inu";
    ...
    address payable private _marketingAddress = payable(0x19b6D0016Cf750E9A6aF5B686532B1800A0c2d82);
    ...
    uint256 public _maxTxAmount = 3000000000000 * 10**9; //3.0
