...
interface IManifoldERC721Edition {
     ...
     */
    function mintGLFXartverse(address creator, address recipient) external payable;
...
//////////////////////////////////////////////// 
contract glfxArtverse is CreatorExtension, ICreatorExtensionTokenURI, IManifoldERC721Edition, Pausable, ReentrancyGuard {
     ...
     */
    function mintGLFXartverse(address creator, address recipient) external whenNotPaused payable override nonReentrant {
