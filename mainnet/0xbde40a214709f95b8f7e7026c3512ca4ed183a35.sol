...
// (Bull,Bull) I don't always check my 401K balance but when i do, the Dow hits 20K.
//At Capital Dao Jones, stock markets do not exist, you do not have to worry about any crashes.
//$CDJ will beat any index with our yield farming strategy through covered call positions, delta neutral strategy on alt coins and mirrored assets
//In here, we are beating expectations and your only game stop to the moon.

//https://twitter.com/CapitalDaoJones
...
contract CapitalDaoJones is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("Capital Dao Jones", "CDJ") {
