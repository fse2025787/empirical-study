...
/**
 _______   ________  __         ______   ______  __    __  __       __ 
/       \ /        |/  |       /      \ /      |/  |  /  |/  \     /  |
$$$$$$$  |$$$$$$$$/ $$ |      /$$$$$$  |$$$$$$/ $$ |  $$ |$$  \   /$$ |
$$ |__$$ |$$ |__    $$ |      $$ | _$$/   $$ |  $$ |  $$ |$$$  \ /$$$ |
$$    $$< $$    |   $$ |      $$ |/    |  $$ |  $$ |  $$ |$$$$  /$$$$ |
...
$$$$$$$/  $$$$$$$$/ $$$$$$$$/  $$$$$$/  $$$$$$/  $$$$$$/  $$/      $$/ 
        ...
        𓂀         BELGIUM - TEH LIGHT BREWS         𓂀      
     Your wings already exist, all you have to do is fly    
The people shall make the community and they shall see light   
                                                     
                            3% Tax                                  
         ALL TAXES WILL GO TO THE LIQUIDITY POOL
...
contract BELGIUM is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "TEH LIGHT BREWS";
    string private _symbol = "BELGIUM";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x5edb34BdD8c506179E3bbD5dE06cA2F36eFDaA12);
    ...
    function CAW() public onlyOwner{
         require(block.timestamp > CAWcooldown, "You cant call CAW more than once per day");
    ...
    function CAWOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         CAWcooldown = block.timestamp + 86400;
    }
