...
contract MaxResources is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("Max Resources", "Maxres") { // 
        marketingWallet = payable(0x065577Ccbf20cE947e6bCafaB77a8D7B01dc2374); // 
        devWallet = payable(0x065577Ccbf20cE947e6bCafaB77a8D7B01dc2374); // 
