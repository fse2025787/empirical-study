...
contract StoneInu is Context, IERC20, Ownable {
    ...
    string private _name = "Stone Inu";
    string private _symbol = "STONE";
    uint8 private _decimals = 18;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWallet = payable(0xA295738eD982965562394bef26011733DdC61824);
    ...
    uint256 public minimumTokensBeforeSwap = 30000000 * 10**18;
    ...
    function setAllFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) private {
        require(taxFee.add(_liquidityFee).add(marketingFee).add(burnFee) <= 10, "tax too high");
        _taxFee = taxFee;
