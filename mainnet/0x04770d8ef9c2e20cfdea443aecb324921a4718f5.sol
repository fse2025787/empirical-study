...
contract DALLE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZjHsoHHdcSsKboAbvz3ooexYkSC6kq8hFQwCHwFRHdaS";
    ...
    constructor(
    ) ERC721A("DALLE-AI", "DAI", 100, maxSupply) {
    }
