...
contract NextGenDucks is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("NEXT GEN DUCKS", "NGD", 100) {
    setHiddenMetadataUri("ipfs://QmPEcoJ8Gemanq8p4U2JzAcsT9WbpadyXWdRWPtF7npqsx/hidden.json");
  }
