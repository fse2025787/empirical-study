...
contract H is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"H Inu";
    string private constant _symbol = "H";
    uint256 private _maxTxAmount = _tTotal.div(1000).mul(50);
    uint256 private _maxWalletAmount = _tTotal.div(1000).mul(50);
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(_deployer);
