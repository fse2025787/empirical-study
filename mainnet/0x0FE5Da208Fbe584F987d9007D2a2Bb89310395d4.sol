...
contract BtcNftRender {
    ...
    function getImage(uint256 itemId) public view returns(bytes memory) {
        ...
        // uint16 size = 1024;
        string memory strSize;
        string memory strOffset;
        if (traits.gt0001) {
            strOffset = "256";
            strSize = "512";
        } else if (traits.gt001) {
            strOffset = "384";
            strSize = "256";
        } else if (traits.gt01) {
            strOffset = "448";
...
"<svg viewBox='-420 -430 512 512'>"
    "<path d='m18.7 18.8c0.383-8.67-4.79-13.7-4.79-13.7l6.9 5.81-3.07-6.61 7 8.32-1.82-8.67 5.46 10.6-1.05-9.81 3.55 7.52 0.479-7.52 1.92 6.5 2.68-5.93 0.383 8.78 6.04-6.73s-4.98 10.6-3.93 11.4c1.05 0.798-19.7 0-19.7 0z' style='fill:#005600;stroke-width:.614;stroke:#000'/>"
    "<path d='m4.67 32.8s5.37 6.61 21.2 7.98 22.4 0.342 25.1-7.18-5.56-15.6-12.7-17.1c-7.09-1.48-24.3-0.342-28.7 5.81-4.31 6.16-6.5 8.37-4.9 10.5z' style='fill:#ececec;stroke-width:.614;stroke:#000'/>"
    "<ellipse cx='17.7' cy='24.8' rx='4.27' ry='3.88' style='fill:#fff;stroke-width:.614;stroke:#000'/>"
    "<ellipse cx='35.7' cy='23.8' rx='4.07' ry='4.16' style='fill:#fff;stroke-width:.614;stroke:#000'/>"
    "<ellipse cx='15.7' cy='25.8' rx='1.53' ry='1.94' style='stroke-width:.0812;stroke:#000'/>"
    "<ellipse cx='37.7' cy='22.8' rx='1.68' ry='1.71' style='stroke-width:.0812;stroke:#000'/>"
"</svg>"
);
...
"<svg width='1024' height='1024' version='1.1' viewBox='0 0 640 640' xmlns='http://www.w3.org/2000/svg' class='",classname,"'>"
  ...
  "<text x='10' y='560'>", strSats, " sat</text>"
  "<text x='10' y='600'>", strBtcs, " BTC</text>"
"</svg>"));
    }
    ...
    function getTokenURI(uint256 itemId) public view returns (string memory) {
        ...
        bytes memory json = abi.encodePacked(string(abi.encodePacked(
            '{'
                '"name": "', strBtcs, ' BTC NFT',traits.petRock?' *':'','",'
                '"image": "', image, '",'
    ...
    function getContractURI(address recipient) public view returns(string memory) {
        ...
        '{'
            '"name": "BTC NFT",'
            '"description": "BTC wants to be an NFT.  You can mint a normal token by locking some WBTC, which you can unlock burning the NFT.  Or you can mint a special token by BURNING some WBTC FOREVER.",'
            ...
            '"external_link": "https://btcnft.cyberpnk.win",'
