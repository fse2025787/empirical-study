...
contract WildRoseETH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Wild Rose";
    string private constant _symbol = unicode"NOBARA";
