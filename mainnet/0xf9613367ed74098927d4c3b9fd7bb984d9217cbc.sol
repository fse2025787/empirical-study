...
contract WCD is ERC20, Ownable {
    ...
    constructor() ERC20("World Cup Dejitaru", "WCD") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x21A2AC1103823A182aDb80a2203fC234DC6f5047); // set as Marketing wallet
        DevWallet = address(0x21A2AC1103823A182aDb80a2203fC234DC6f5047); // set as dev wallet
