...
contract FTXinPrison is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public immutable MAX_SUPPLY = 333;
    uint16 public immutable MAX_PER_TX = 3;
    uint256 public PRICE = 0.003 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmbdqoNkknZzh1vPhD5HCwfdYb7MsVkt9JjFFkH4GNAGSS/";
