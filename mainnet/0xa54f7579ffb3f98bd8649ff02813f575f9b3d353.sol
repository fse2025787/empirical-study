...
// File: src/contracts/ERC1155.sol
...
// File: src/contracts/MetaTxns.sol
...
contract LIT is ERC1155, ContextMixin, NativeMetaTransaction {
    ...
    constructor() ERC1155("https://mintlit.com/metadata/eth/{id}") {
        // constructor() ERC1155("https://mintlit.com/metadata/fantom/{id}") {
        // constructor() ERC1155("https://mintlit.com/metadata/xdai/{id}") {
        admin = msg.sender;
        ...
        returns (bool isOperator)
    {
        ...
        // eth mainnet
        if (
            _operator == address(0xa5409ec958C83C3f309868babACA7c86DCB077c1) &&
            openseaProxyEnabled == true
        ) {
            return true;
        }
    ...
    function contractURI() public view returns (string memory) {
        return "https://mintlit.com/contractMetadata";
    }
}