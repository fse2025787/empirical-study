...
contract CN01 is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 75;
     uint256 public devSupply = 13;
    ...
    constructor(string memory initBaseURI) ERC721A("CryptoNative Art by 0 1", "CN01") {
        baseURI = initBaseURI;
    }
