...
contract Graviless is ERC721A, Ownable {
    uint256 public constant RESERVE_SUPPLY = 50;
    uint256 public MAX_SUPPLY = 5500;

    uint256 public WL_PRICE = 0.035 ether;
    uint256 public PUBLIC_PRICE = 0.045 ether;

    uint256 public MINT_LIMIT = 4;
    ...
    address public constant ADDRESS_1 =
        0x8802Da8a9ee6c09356044b6E02b01ee0b255e4B0; // Owner
    ...
    constructor() ERC721A("Graviless", "GRAVILESS") {}
    ...
    function withdraw() external onlyOwner {
        ...
        payable(ADDRESS_2).transfer((balance * 1400) / 10000);
