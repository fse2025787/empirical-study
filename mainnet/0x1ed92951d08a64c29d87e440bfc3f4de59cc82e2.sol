...
contract Flokarium is ERC20, Ownable {
    ...
    constructor() ERC20("Flokarium", "FLOKARIUM") {
        ...
        maxBuyAmount = totalSupply / 65; // 0.50% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 65; // 1% maxTransactionAmountTxn
        maxWalletAmount = totalSupply * 1 / 65; // 1% maxWallet
        ...
        marketingWallet = address(0x31B44Ea17E36526c7F9b81b94379239eDB7B7A8c);
        contestAIWallet = address(0x31B44Ea17E36526c7F9b81b94379239eDB7B7A8c);
