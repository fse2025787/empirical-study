...
The Federal Reserve just announced a 12-week digital dollar pilot.

Central Banks Digital Currencies (CBDC) will give states a lot more power over our money than they already have.

They will see every transaction we make.
They'll be able to set acceptance criteria for our money at vendors they approve of.
They'll even be able to turn off the money on our account if they want to, and when they want to.

We CAN'T let it happen.
It is only another way for them to enslave us, again.
...
contract  FUCKCBDC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FUCK CBDC"; // 
    string private constant _symbol = unicode"FUCKCBDC"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA20f8bDcfae4dF686aa66876A2486D71e3357a60;
