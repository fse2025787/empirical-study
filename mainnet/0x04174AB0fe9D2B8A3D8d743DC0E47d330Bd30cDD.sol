...
contract ElLobo is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'El Lobo';
    string private constant _symbol = 'Lobo';
    ...
    uint256 private swapThreshold = ( _totalSupply * 450 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0x0570534cEB5b8A79E2Eda140FC23B73f34a7EFe1; 
    address internal constant marketing_receiver = 0x0570534cEB5b8A79E2Eda140FC23B73f34a7EFe1;
    address internal constant liquidity_receiver = 0x0570534cEB5b8A79E2Eda140FC23B73f34a7EFe1;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(4) && sellFee <= denominator.div(4), "totalFee and sellFee cannot be more than 20%");
    }
