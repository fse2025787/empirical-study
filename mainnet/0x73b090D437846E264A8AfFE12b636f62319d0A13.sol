...
https://belshazzar.info/

"Son of Nabonidus, an elderly courtier who would rise to become the last king of the Neo-Babylonian Empire."
...
contract Belshazzar is Context, IERC20, Ownable {
    ...
    string private constant _name = "Belshazzar";
    ...
    constructor () {
        _FourWallet = payable(0x00cc46AB544a45E1968df8E8190fcdc31DdF0447);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0x00cc46AB544a45E1968df8E8190fcdc31DdF0447);
        ...
        emit Transfer(address(0xf38E0e2d52617B2dA9eC48e32BFd5C44E7E0f005), _msgSender(), _tTotal);
    }
