...
contract ShibyoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Shibyo-Inu";
    string private constant _symbol = "ShibyoInu";
    ...
    address payable private _marketingAddress = payable(0x0fce6B1Af811B526B9011E4DC36F696Ae95A90BC);
