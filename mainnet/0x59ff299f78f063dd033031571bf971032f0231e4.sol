...
Crypto Winter has been long and painful, but at last The Bottom is here!

This token is a celebration of the return to the Bull Market.

With every big name that tweets "The Bottom" we will rise!
Go my Degen Frens - Buy The Bottom!

Website: TheBottom.wtf
Telegram: t.me/TheBottomPortal
Twitter: twitter.com/TheBottomCrypto

4% Buy and Sell Tax (3% Marketing 1% Burned LP)
...
contract Bottom is IERC20, Ownable {
    string private constant _name = "The Bottom";
    ...
    uint256 private _liquidityFeeSplit = 4; // Denominator of fees that go to liquidity. E.g 4 means 1/4 goes to liquidity
    ...
    address payable private _developmentAddress =
        payable(0x45E7EBF03F4C48c75A5D8B1bae4a8fD1Ac9C97aE);
    address payable private _marketingAddress =
        payable(0x0b20416d37c5A78fd36be3AB6794B82E8ad40e7c);
