...
//
//
//Tsangnyön Heruka (Gtsang smyon Heruka, 1452-1507),the self-proclaimed "madman of Central tibet" was both an iconoclastic tantric master and a celebrated auther, best known for his versions of life of milarepa and the hundred thousand songs of milarepa and the hundred thousand songs of milarepa.
// 
//
// 
// https://t.me/herukacommunity
// 
//  
// 
//
...
contract Tsangnyon is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Tsangnyön", "HERUKA") {
