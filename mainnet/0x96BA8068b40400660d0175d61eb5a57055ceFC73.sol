...
contract CultShibApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cult Shib Ape";
    string private constant _symbol = "CULTSHIBAPE";
