...
//*********************************************************************//
//
//   _____               _                                  __      _______   _    _ _              _       _             _____                   
//  |  __ \             (_)               /\                \ \    / / ____| | |  | | |            (_)     (_)           |  __ \                  
//  | |__) |   _ ___ ___ _  __ _ _ __    /  \   _ __   ___   \ \  / / (___   | |  | | | ___ __ __ _ _ _ __  _  __ _ _ __ | |  | | ___   __ _  ___ 
//  |  _  / | | / __/ __| |/ _` | '_ \  / /\ \ | '_ \ / _ \   \ \/ / \___ \  | |  | | |/ / '__/ _` | | '_ \| |/ _` | '_ \| |  | |/ _ \ / _` |/ _ \
//  | | \ \ |_| \__ \__ \ | (_| | | | |/ ____ \| |_) |  __/    \  /  ____) | | |__| |   <| | | (_| | | | | | | (_| | | | | |__| | (_) | (_| |  __/
//  |_|  \_\__,_|___/___/_|\__,_|_| |_/_/    \_\ .__/ \___|     \/  |_____/   \____/|_|\_\_|  \__,_|_|_| |_|_|\__,_|_| |_|_____/ \___/ \__, |\___|
//                                             | |                                                                                      __/ |     
//                                             |_|                                                                                     |___/      
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x061c6C37341eDe617624677046aEc0BBFAb662D8];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 100, 7777 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRTtUV8oqWEHSf2NtuWD1Wk5Np18DveUiSBstokZaTbBR/";
...
// File: contracts/RussianApeVsUkrainianDogeContract.sol
//

pragma solidity ^0.8.0;

contract RussianApeVsUkrainianDogeContract is RamppERC721A {
    constructor() RamppERC721A("RussianApe VS UkrainianDoge", "RAUD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/H2b1sln7Uhjqq8xTBDNi/contract-metadata";
    }
}
