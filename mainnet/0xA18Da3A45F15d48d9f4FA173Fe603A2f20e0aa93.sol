...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    struct AddressData {
        ...
        // (e.g. number of allowlist mint slots used).
    ...
    /**
     * Returns the auxillary data for `owner`. (e.g. number of allowlist mint slots used).
     */
    ...
    /**
     * Sets the auxillary data for `owner`. (e.g. number of allowlist mint slots used).
     * If there are multiple variables, please pack them into a uint64.
     */
