...
contract ShurikenStakingNFT is ERC721A, Ownable, AccessControl {
    using Strings for uint256;
    bytes32 public constant MINTER_ROLE = keccak256('MINTER_ROLE');
    bytes32 public constant BURNER_ROLE = keccak256('BURNER_ROLE');
    ShurikenStakingMetadata public metadata;
    ...
    constructor(
        ShurikenStakingMetadata _metadata,
        string memory _name,
    ...
    function setMetadata(ShurikenStakingMetadata _metadata) external onlyOwner {
        metadata = _metadata;
    }
