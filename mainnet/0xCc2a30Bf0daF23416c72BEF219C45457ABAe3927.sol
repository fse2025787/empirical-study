...
//
// @title OkayApesYachtClub contract
pragma solidity ^0.8.4;




contract OkayApesYachtClub is ERC721A, Ownable {
    ...
    constructor(string memory initBaseURI) payable ERC721A("OkayApesYachtClub", "OAYC") {
