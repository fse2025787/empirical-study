...
contract CoolLions is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Cool Lions", "CL") {
    setHiddenMetadataUri("ipfs://QmUvZnu7CSLJYXLv5WBbC3HEWyPeTASRHpPhuCSxoPjqrd/hidden.json");
  }
