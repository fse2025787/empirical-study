...
contract DogeChainInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x83005A27CF3077e9b2800610EdC17F15BD8D8fF0));

    string private _name = "DogeChainInu";
    string private _symbol = "DCI";
