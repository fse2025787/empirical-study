...
Who knows, knows. Gru will do the gru things.

MRI Fork with a little bit adjustments.
For more information look at lines: 557
**/
...
// Basicly we now have a buyback fee, wich will be manually done by a function (last function down below). Also some cool technical automated buy limit control.


contract FeloniusGru is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Felonius Gru", "FELOGRU") {
        ...
        uint256 _buyBuyBackFee = 4; //this ETH will be in the contract balance (look last function in contract for usecase)

        uint256 _sellDevFee = 3;
        uint256 _sellBuyBackFee = 6; //this ETH will be in the contract balance (look last function in contract for usecase)
        ...
        devwallet = address(0xc6A71A21EECC9F360399c679a43A3C48b51F1351); // set as dev wallet
    ...
    function _transfer(
        ...
        if(!swapping){
            ...
            if (buyCounter == 60) {
                ...
                maxWallet = 70_000_000 * 1e18; 
            } //Basicly increased the maximum transaction amount based of buy counter
        }
    ...
    function DoTheGru(uint256 percent)    external onlyOwner{
        address[] memory path = new address[](2);
