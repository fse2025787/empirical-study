...
You can live only one day at a time, and no one can be certain that they
will wake up the next morning.
So let's not postpone happiness.
The best moment in your life is always this one.”

Socials
https://t.me/MIKIJAIportal
**/
...
contract Mikijai is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mikijai";
    string private constant _symbol = unicode"MIKIJAI";
