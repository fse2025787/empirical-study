...
// solhint-disable
contract Saitama2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x6b9CaEa096Df6F793663ca39C0Fb6C15500D79be);
    address payable public devAddress =
        payable(0x6b9CaEa096Df6F793663ca39C0Fb6C15500D79be);
    address payable public liquidityAddress =
        payable(0xF0768d0E6448684F3f6956196f99b106bDF345Ec);
    ...
    string private constant _name = "Saitama 2.0";
    string private constant _symbol = "SAITA";
