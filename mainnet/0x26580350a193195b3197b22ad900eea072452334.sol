...
contract Spacemonkey is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmYCzN72VpimfDwQ3djDSi6GwutQXdBqdxZJWQb3j4PphG/";
    ...
    constructor(string memory initBaseURI) ERC721A("Space monkey", "SM") {
        baseURI = initBaseURI;
