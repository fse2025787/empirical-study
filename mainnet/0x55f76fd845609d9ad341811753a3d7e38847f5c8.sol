...
contract DegenFreakz is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmWvxsSWSVDQm3hoodwSecFc8dd91K9LiMHrL5zQ1nfMFF/";
    ...
    constructor(string memory initBaseURI) ERC721A("DegenFreakz", "DF") {
        baseURI = initBaseURI;
