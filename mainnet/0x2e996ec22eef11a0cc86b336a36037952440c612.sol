...
// File: contracts/DataVaultNFTs.sol


pragma solidity 0.8.15;


contract DataVaultNFTs is ERC721URIStorage, Ownable {
    ...
    function mintNFT(address recipient, uint256 numberOfTokens, string memory tokenURI) external onlyOwner {
