...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  //Initial price is 0.001 ETH
  uint256 internal PRICE = 100000;
  string public _contractURI;
  string internal _baseTokenURI;
  bool internal _isActive;
  string internal name_;
  string internal symbol_;
  uint256 internal MAX_FREE = 0;
  address proxyRegistryAddress;
  uint256 internal MAX_SUPPLY = 3000;
...
contract RBPill is DefaultOperatorFilterer, Context, ERC721Tradeable {
  using SafeMath for uint256;
  ...
  constructor(address _proxyAddress) ERC721Tradeable("RBPill", "RBP", _proxyAddress) {
    _baseTokenURI = "ipfs://tbd/";
    _contractURI = "ipfs://bafkreidzk6lepe2qxsifn75sxtkn6hizm3oua3fmempogmemfrp2v4eesm";
    payableAddress = payable(0x654CEe0271F7aE23A858581a0c46AE8C40C71853);
  }
