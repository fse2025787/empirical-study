...
// File: contracts/SamuraiDoge.sol

/**
 * @title SamuraiDoge contract
...
contract SamuraiDoge is ERC721, Ownable {
    ...
    function setAvatarName(uint256 _index , string memory _avatarName) public payable {
...
*/
    ...
    /**
    * Free Sale Mints Samurai Doge, allows you to mint 200 free tokens
    */
    function freeMintSamurai() public payable {
    ...
    /**
    * Pre Sale Mints Samurai Doge
    */
    function preMintSamurai(uint numberOfTokens) public payable {
        ...
        require(samuraidogePrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
    ...
    * Mints Samurai Doge
    */
    function primaryMintSamurai(uint numberOfTokens) public payable {
    ...
    * Mints Samurai Doge
    */
    function postMintSamurai(uint numberOfTokens) public payable {
