...
/*
Introducing… DogaCash Game!
Doge Cash Game is a Mario Run inspired game where anyone can earn coins through skilled gameplay and contributions to the ecosystem. 
The aim of the game is simple… Dash as fast as you can through all of the 15 levels whilst collecting coins along the way. 
Successful players who complete all levels will be rewarded with the collected coins direct to their wallets.
...
// 💲💲💲 Website - https://dogegame.cash
// 💲💲💲 Telegram Group: https://t.me/dogecashgame
...
contract DogeCashGame is Context, IERC20, Ownable {
    ...
    string private _name = 'DogeCash Game';
    string private _symbol = 'DOGECASHGAME';
