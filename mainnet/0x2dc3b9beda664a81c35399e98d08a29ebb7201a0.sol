...
// File contracts/ERC721A.sol
    ...
    contract Grit is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    string public uriPrefix = "ipfs://QmZUdmJH2NZAU6Kun8fUGydTFg6ZqWJcc4NE5oTn1hB264/"; string public uriSuffix = ".json"; string public hiddenMetadataUri;
    ...
    constructor() ERC721A("Grit", "GRIT") {setHiddenMetadataUri("ipfs:///hidden.json");}
