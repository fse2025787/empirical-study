...
contract KAMIYO is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "KAMI YO";
    string private constant _symbol = unicode"神々の時代";
    ...
    address payable private _developmentAddress = payable(0x45A78f9F772293558fD59D25F1928B86A7De973d);
    address payable private _marketingAddress = payable(0x45A78f9F772293558fD59D25F1928B86A7De973d);
