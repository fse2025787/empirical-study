...
contract ShapeTheFuture is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.008 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x39df1602cba181dcc2c0423447bf70269ce2d9f5b5ed2b0fead12793543845ac;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmdRiwqqBCAK3S74J3C4QxhbEQ8cCF3W6ivbLMqZp2Bs2P";

    constructor() public ERC721A("Shape The Future", "SHAPE", 999, 999) {}
