...
MergeCUlT
The merge is happening and is in process as we speak.
MergeCult is micing two trend to one mega trend.
With 5% Tax mergecult is gonna blow off the charts
...
contract MergeCult is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MergeCult";
