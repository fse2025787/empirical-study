...
// Our name is Black Legion, for we are many.
// https://t.me/BlackLegionETH
...
contract BlackLegion is ERC20, Ownable {
    ...
    constructor() payable ERC20("Black Legion", "LEGION") {
        ...
        marketingAddress = address(0x96Ca19b17102EAABAF0e68c330fbb60EEDAD1E0E);
        ...
        _createInitialSupply(0xF3Bc6f6b31e8C19e2259F1973ab61cD8fc32075e, totalSupply);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xF3Bc6f6b31e8C19e2259F1973ab61cD8fc32075e),
            block.timestamp
        );
    }
