...
/**
       ...
       オモイカネ (思兼 思金) は、知恵と知性の神です。 彼の名前は「自分の考えに奉仕する」という意味です

       天の神々の審議において「熟考」し、良い助言を与えるよう求められた天の神。

      アマテラスが洞窟に隠れたという神話では、彼はアマテラスを連れ出す方法を見つける任務を負っていました 
*/
...
contract OMOIKANE is Context, ERC20, Ownable {
