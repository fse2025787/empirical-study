...
contract PANDAO is Context, IERC20, Ownable {
    ...
    string private _name = "PANDAO";
    string private _symbol = "PANDAO";
    ...
    uint256 private _taxEndTimestamp = 1652659200;
    uint256 private _taxAfterEpoch = 0;
    ...
    function sendBNBToTreasury(uint256 amount) private { 
        swapTokensForEth(amount); 
        _treasuryWalletAddress.transfer(address(this).balance); 
    }
    
    function _setTreasuryWallet(address payable TreasuryWalletAddress) external onlyOwner() {
        _treasuryWalletAddress = TreasuryWalletAddress;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendBNBToTreasury(portionForFees);
