...
contract MERRYCHRISTMAS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MERRY CHRISTMAS", "XMAS") {
    	...
    	dev1Wallet = payable(0x9e037984ffd52bD9624f43Ab37439bcfDF9D0aAC);  // set as dev1 wallet
        dev2Wallet = payable(0x9e037984ffd52bD9624f43Ab37439bcfDF9D0aAC);  // set as dev2 wallet
        dev3Wallet = payable(0x9e037984ffd52bD9624f43Ab37439bcfDF9D0aAC);  // set as dev3 wallet
        dev4Wallet = payable(0x9e037984ffd52bD9624f43Ab37439bcfDF9D0aAC);  // set as dev4 wallet
        dev5Wallet = payable(0x9e037984ffd52bD9624f43Ab37439bcfDF9D0aAC);  // set as dev5 wallet

        marketingWallet = payable(0x9e037984ffd52bD9624f43Ab37439bcfDF9D0aAC); //marketing wallet
