...
contract RYUUINU is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Ryuu Inu';
    ...
    //DevWallets
    address public Development=payable(0x071C575a41C3063704922Ea6665ffd8934F5A2e8);
    address public Marketing=payable(0x071C575a41C3063704922Ea6665ffd8934F5A2e8);
    //MainNet
