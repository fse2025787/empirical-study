...
contract ClassicBearsNFT is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    constructor () ERC721A("Classic Bears NFT", "CBNFT") {
    }
    ...
    function mint(uint256 mintAmount) public payable callerIsUser nonReentrant {
