...
// File: MoustachePunks.sol

contract MoustachePunks is ERC721 {
    uint256 public tokenCounter;
    bool public saleStatus = false;
    address payable wallet = 0xa8aBC44bcb836bad922c08948b240d99eE5a411B;
    constructor () public ERC721 ("MoustachePunks", "MST"){
        tokenCounter = 1;
        _setBaseURI("ipfs://QmTUgwMuMGEJbUeG7fxZPvPcWmBT6XZccvB8Wqw6MfB4Vd/");
    }

    function mintMoustache() public payable{
        require(saleStatus);
        require(msg.value == 10000000000000000);
        require(tokenCounter<10001);
        _safeMint(msg.sender, tokenCounter);
        tokenCounter = tokenCounter + 1;
    }

    function mintMoustacheten() public payable{
        require(saleStatus);
