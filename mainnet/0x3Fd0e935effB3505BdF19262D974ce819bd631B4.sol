...
contract Feelgangdeploy is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FeelGang", "FG") {
    setHiddenMetadataUri("ipfs://QmZJnM4GK7rNbznNdekmR5ieTi1Ckh2PTpRVpjvq9Uq44p/hidden.json");
  }
