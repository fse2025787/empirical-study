...
//*********************************************************************//
//
//   ________       _    ___ ____                           _   ______________
//  /_  __/ /_  ___| |  / (_) / /___ _____ ____  __________/ | / / ____/_  __/
//   / / / __ \/ _ \ | / / / / / __ `/ __ `/ _ \/ ___/ ___/  |/ / /_    / /   
//  / / / / / /  __/ |/ / / / / /_/ / /_/ /  __/ /  (__  ) /|  / __/   / /    
// /_/ /_/ /_/\___/|___/_/_/_/\__,_/\__, /\___/_/  /____/_/ |_/_/     /_/     
//                                 /____/                                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 8, 8888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbnehFJ5ye68oVP8erCNhMHpv2rchRA6TCezyxQwj4Cfp/";
...
contract TheVillagersNftContract is RamppERC721A {
    constructor() RamppERC721A("TheVillagersNFT", "VILLAGERS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/8O4CUYDKyHo3oF4WY6uA/contract-metadata";
    }
}
