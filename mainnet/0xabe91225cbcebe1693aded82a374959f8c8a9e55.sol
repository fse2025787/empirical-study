...
contract Pixely00ts is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmSgZ6c3wbLhcw1Xk2n8ubku9JWurZnjcCPrhxATGfuKWY/";
  ...
  ) ERC721A("Pixel y00ts Yacht Club", "PYYC") {
