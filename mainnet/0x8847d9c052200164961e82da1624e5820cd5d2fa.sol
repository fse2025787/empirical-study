...
contract Spacefactory  is ERC721A, Ownable {

    string public baseURI = "https://nftservices.s3.amazonaws.com/spacefactory/";
    ...
    constructor() ERC721A("Spacefactory", "SPFA", 100, MAX_TOKENS) {
    }
