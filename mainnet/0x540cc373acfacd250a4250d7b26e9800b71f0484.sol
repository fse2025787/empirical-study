...
contract DirtyDogs is ERC721, Ownable {
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 balance2 = balance.mul(40).div(100);
        uint256 balance3 = balance.mul(10).div(100);
        payable(wallet4).transfer(balance2);
        payable(wallet3).transfer(balance2);
        payable(wallet2).transfer(balance3);
        payable(wallet1).transfer(balance3);
    }
}