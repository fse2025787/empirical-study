...
/*
At Halloween CLUB FC, we are designing a project based on definitive market rules and fundamental economic principles. 
$HCFC reconciles a high-performance protocol with integral price stability features.
2% MARKETING
2% LIQUIDITY

https://t.me/HalloweenCFCETH
*/
...
contract HalloweenCFC is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xa3D016B2A4f4d7b3359687c2a7E3c6D4849C5429));

    string private _name = "HalloweenCFC";
    string private _symbol = "HCFC";
