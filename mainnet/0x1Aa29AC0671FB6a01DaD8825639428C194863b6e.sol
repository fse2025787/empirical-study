...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x35Fa958227aa964643A8926629460b3a592214E5];
  address public erc20Payable = 0x35Fa958227aa964643A8926629460b3a592214E5;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 66;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeie7p47rcbagalep6os24p5psov4kcawdcmlnmqarntqld7sgjnzfu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ftbWvNH2q1U24K4biad1/contract-metadata";
  }
...
// File: contracts/SamuraiSoulContract.sol
//

pragma solidity ^0.8.0;

contract SamuraiSoulContract is RamppERC721A {
    constructor() RamppERC721A("Samurai Soul", "SS"){}
}
