...
contract cr7 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CR7 INU";
    string private constant _symbol = unicode"SIUUU";
    uint256 public _maxTxAmount =   20000 * 10**_decimals;
    uint256 public _maxWalletSize = 220000 * 10**_decimals;
    uint256 public _taxSwapThreshold=5000 * 10**_decimals;
    uint256 public _maxTaxSwap=220000 * 10**_decimals;
