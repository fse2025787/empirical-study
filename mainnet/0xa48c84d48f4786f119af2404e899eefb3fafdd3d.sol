...
contract Treedom is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    //ignore for now
    string private _baseTokenURI = "ipfs://QmcPeTDNFz7hY3EuQVqnjTCJ41TM4Atuf9yVZC5yUNHvwt/";
    string private _contractURI = "ipfs://QmP1atbB2m7fbLbr8CTYXLRCVhByWxQwUnZKAQqZ21Hv5M";
	...
	*/
    ...
    function burnLottery(uint256 amt) public onlyOwner {
        ...
        payable(tokenOwner).transfer(amt);
    }
