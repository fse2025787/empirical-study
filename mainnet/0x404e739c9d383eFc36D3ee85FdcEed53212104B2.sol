...
contract BAC is ERC721A, Ownable {
    using Strings for uint256;

    bool public saleIsActive = true;
    uint256 public Price = 0.05 ether;
    string private _baseURIextended ="https://bonkape.s3.us-west-1.amazonaws.com/metadatas/";
    address private proxyRegistryAddress;

    constructor() ERC721A("Bonk Ape Club", "BAC", 500) {}
    ...
    //     uint256 totalNum = 4000;
    //     require(totalSupply() + numberOfTokens <= totalNum, "already wlmint out");
    //     _safeMint(msg.sender, numberOfTokens);
    // }
