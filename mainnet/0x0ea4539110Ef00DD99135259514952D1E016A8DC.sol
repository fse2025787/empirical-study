...
//Our team is now all in the crypto world.




//To keep the tradition, we decided to create a contract first.




//Now, NothingButContract, 2048 OG tokens.
...
contract NothingButContract is ERC721A, Ownable {
    
    uint256 public immutable batchMintCost = 0.009 ether;
    uint32 public immutable MAX_SUPPLY = 2048;
    ...
    constructor()
    ERC721A ("NothingButContract", "NBC") {
    }
