...
contract ParentOpenTherapoid is ERC20, Ownable, Pausable {
    ...
    uint256 public maxAccTransferLimit = 7500 * 1 ether; // 7500 SCI Tokens
    ...
    event IssuerContractSet(address issuerContract);
    ...
    constructor(
        ...
        // Mint SCI tokens to contractOwner address
    ...
    function setIssuerContract(
        ...
        emit IssuerContractSet(_issuerContract);
    }
