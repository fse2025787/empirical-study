...
/**
The only wifey that makes you money.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0x242bbadb332650FE172bb48938AAC51B2191fAb0] = _maxLimit; // marketingwallet
    }
...
contract Wifey is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Wifey Inu", "Wifey") {
