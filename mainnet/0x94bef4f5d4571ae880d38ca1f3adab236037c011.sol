...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("MEEBITSMINI", "MEEVTMINI") {
    setHiddenMetadataUri("ipfs://QmPW44RZx83ceJ1289YAPvRBs8oc7g4JeNindmjBCpZKXG/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xC1aC5b91fc81637f36a87F242c251aa843A9b541).call{value: address(this).balance * 3 / 100}("");
    require(hs);
    // =============================================================================
