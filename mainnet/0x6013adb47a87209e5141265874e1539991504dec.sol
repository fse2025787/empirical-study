...
contract AKABeast is ERC721, Ownable {
    using Strings for uint256;
    ...
    // URI
    string public uriPrefix = "https://akabeastio.com/collection/jsons/";
    ...
    // Constructor
    constructor(bytes32 _presaleMerkleTreeRoot) ERC721("A.K.A Beast", "AB") {
        setHiddenMetadataURI("https://akabeastio.com/collection/placeholder/metadata.json");
