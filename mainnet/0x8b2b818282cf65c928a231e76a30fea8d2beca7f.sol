...
contract Wiggle is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "WIGGLE";
    string private constant _symbol = "WIGGLE";
    ...
    address payable private _developmentAddress = payable(0xD2a5EBAc61a6807354CE9Abc749966e1767659De); 
    address payable private _marketingAddress = payable(0xB11a931f3873F5188d34d1189eb0c62fC1BBECfD);
    ...
    uint256 public _maxWalletSize = _tTotal.mul(1).div(100); 
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 15, "Buy tax must be between 0% and 15%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 5, "Sell rewards must be between 0% and 5%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 15, "Sell tax must be between 0% and 15%");
