...
contract MiladyRaveMaker is ERC721, Ownable {
    using Strings for uint256;
    ...
    //Milady contract = 0x5Af0D9827E0c53E4799BB226655A1de152A425a5
    address public contract1 = 0x5Af0D9827E0c53E4799BB226655A1de152A425a5;
    ...
    uint256 public discount = .03 ether;
    uint256 public maxSupply = 5000;
    uint256 public maxMintAmountPerTx = 100;
    uint256 public MaxgiveawayAmountperTx = 30;
    uint256 public giveawaylimit = 5000;
...
function giveaway(uint256 _giveawayAmount)
        ...
        if (givedAway >= 5000) {
            ...
            if (isWhitelisted(msg.sender))
                ...
                if (givedAwayFree[msg.sender].claimedFree == true) {
                    ...
                    require(
                        msg.value >= discount * _giveawayAmount,
                        "Insufficient funds!"
                    );
        ...
        mintCompliance(_mintAmount)
    {
        require(!paused, "The contract is paused!");
             // check if other user is whitelisted
        if(isWhitelisted(msg.sender)) {
            //if user has equal to or greater than criteria one
            //whitelisted users pay the discount amount 
            require(
                msg.value >= discount * _mintAmount,
                "Insufficient funds!"
                );
                _mintLoop(msg.sender, _mintAmount);
                        }
            //if not whitelisted pay the full amount
        else {
    ...
    returns (string memory)
  {
        ...
        onlyOwner
    {
     ...
     function setgiveawaylimit(uint256 _giveawaylimit)
        public
        onlyOwner
    {
