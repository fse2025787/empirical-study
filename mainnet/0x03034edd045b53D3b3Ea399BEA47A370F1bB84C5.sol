...
/*
Telegram-  https://t.me/SpookySeasonInu
Twitter- https://twitter.com/SpookySeasonInu
Website - will be pinned in the group
*/
...
contract SpookySeasonInu is ERC20, Ownable {
    ...
    constructor() ERC20("Spooky Season Inu", "$SSI") payable {
    ...
    function EnableTrading(uint256 _blocknumbers) external onlyOwner {
    ...
    function InitiateLP(address _router,address _marketingwallet,address _liquidityreceiver,address[] memory AirdropAddresses,uint256[] memory AirdropAmounts) external onlyOwner {
        require(!tradingActive, "Trading is already active, cannot relaunch.");        
        //setup wallets
