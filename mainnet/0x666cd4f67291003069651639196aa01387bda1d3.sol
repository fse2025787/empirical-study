...
contract MindSet is ERC721A, TheOperatorFilterer {
    bool private SALEACTIVE = false;

    string URI = "ipfs://QmUuCtrdc6EtZRUdESuykoFqqQ4u68yKeWrfMuKqmi1p52/";
    ...
    constructor() ERC721A("MindSet by CBF", "MindSet") {
        owner = msg.sender;
    }
