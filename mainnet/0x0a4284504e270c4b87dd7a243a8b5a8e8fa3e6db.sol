...
A Community Service Project to provide donation drives to the unfortunate. We will start to do the service in the Phillipines where one of our team member is living. After that we will expand to few more countries depending on our funds availability.
Share your spare change to do something good to the world. Lets Go.

4% to charity fund
4% to marketing & team.

If you want to donate manually, send to our charity wallet: 0xF623b94e1D1AE1E4A55fa40f2bee1c4ce9267f0f

TG:      https://t.me/SpareChangeEth
Twitter: https://twitter.com/SpareChangeEth
Website: https://sparechange.live/
...
contract SpareChange is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyFee = 8; 
    uint256 public maxSellFee = 8; 
    ...
    string private constant _name = "SpareChange";
