...
contract PutinPaperTiger is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 6601;
  uint256 public maxMintAmountPerTx = 50;

  bool public paused = false;
  bool public revealed = false;

  constructor() ERC721("PutinPaperTiger", "PPTG") {
    setHiddenMetadataUri("ipfs://QmeaLFkJ1ypCxvXmURAaxMWFm1suu8EMR7UPLAFXi3f2iv/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // I will keep this my friend, you rock. (however, I will make it 2% because the ideaa is to donate for Ukraine)
    // =============================================================================
