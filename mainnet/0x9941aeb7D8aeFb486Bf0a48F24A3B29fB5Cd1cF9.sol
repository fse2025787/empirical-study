...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0xEd283CE55676E4f5dEafEb1d436d6ab2e7740d33 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
...
contract Benzema is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("Benzema Inu", "KB9") {
