...
// $CINU
// Cake Inu - $CINU
// TG - https://t.me/EthCakeInu
// Twitter - https://twitter.com/CakeInuToken
...
contract CakeInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cake Inu", "CINU") {
        ...
        devOpsWallet = address(0x951f774F6D42B7b0472190AB7BB4e0a627b7647a); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x951f774F6D42B7b0472190AB7BB4e0a627b7647a), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x951f774F6D42B7b0472190AB7BB4e0a627b7647a), true);
