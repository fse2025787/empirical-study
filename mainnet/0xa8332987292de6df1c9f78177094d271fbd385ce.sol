...
// File: contracts/BoredPudgyPenguins.sol
...
contract BoredPudgyPenguins is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3445;
  ...
  ) ERC721A("Bored Pudgy Penguins", "BPP") {
