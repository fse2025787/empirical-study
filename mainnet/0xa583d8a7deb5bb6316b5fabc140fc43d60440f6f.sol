...
contract MetaPepeInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 999_000_000 * 10**9;
    ...
    string private constant _name = "Meta Pepe Inu";
    ...
    constructor () {
        _feeAddress = payable(0x3bcffFD05da4bDC9edBFfA862b0Cc0359cCA5A57);
        _buyTax = 12;
        _sellTax = 12;
