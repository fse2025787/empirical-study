...
contract ETHerealsloths is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPlY = 8888;
    uint256 public OWNER_RESERVED = 88;
    uint256 public price = 68888000000000000; //0.068888 Ether
    uint256 public launchTime = 1631089234;
    uint256 public endTime = 1631707119;
    string baseTokenURI;
    ...
    constructor(string memory baseURI) ERC721("ETHereal Sloths", "SLOTHS") {
        setBaseURI(baseURI);
    }
    ...
    function burnNFTs() external onlyOwner returns (uint256){
        require(block.timestamp >= endTime, "Sale is not finished yet");
