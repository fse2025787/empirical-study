...
contract SpartanInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Spartan Inu", "SPARTAN") {
        ...
        maxTransactionAmount = totalSupply * 7 / 1000; // 1% maxTransactionAmountTxn
        maxWallet = totalSupply * 21 / 1000; // 2% maxWallet
    ...
    function _transfer(
        ...
        if (!isBuy && enableEarlySellTax) {
            if (_holderFirstBuyTimestamp[from] != 0 &&
                ...
                //Tax 25% if holders sell in first 3 hour , this helps for a better price floor
                sellLiquidityFee = 5;
                sellMarketingFee = 14;
                sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
            }
