...
contract DumbMonke is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public MAX_MINT_LIMIT_PER_WALLET = 1;
    ...
    constructor() ERC721A("Dumb Monke", "MONKE") {}
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) external payable {
        ...
        require((MAPPING_WHITELIST_MINT[msg.sender] + _mintAmount) <= _amount, "Exceeds Max Mint Amount");
        ...
        require((numberMinted(msg.sender) + _mintAmount) <= MAX_MINT_LIMIT_PER_WALLET,"You have exceeded your mint allowance per wallet!");
    ...
    function mint(address _to, uint256 _mintAmount) external payable {
        if (msg.sender != owner()) {
            ...
            require( _mintAmount <= MAX_MINT_PER_TX, "Sorry you cant mint this amount at once");
            require(totalSupply() + _mintAmount <= MAX_SUPPLY, "Exceeds Max Supply");
            require((numberMinted(_to) + _mintAmount) <= MAX_MINT_LIMIT_PER_WALLET,"You have exceeded your mint allowance per wallet!");
    ...
    function withdraw() public onlyOwner {
        ...
        payable(owner()).transfer(curBalance);
    }
}