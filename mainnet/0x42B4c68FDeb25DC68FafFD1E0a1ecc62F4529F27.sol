...
/**
$MiniGN is for the sleepy Euro-Ape who's been missing out on the crazy american pumps

For all those who seethe, and cope, who missed out on ENS, GM, and all the other ropeable events in defi. 

We are the ones that rage in the evening. Rope ready in the morning. 

GM is ALWAYS followed by GN. 

And the moon only lives at NIGHT.

GN GN GN.

https://t.me/minignETH
*/
...
contract MiniGN is Context, IERC20, Ownable {
    ...
    string private _name = "Mini GN";
    string private _symbol = "MiniGN";
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**1 * 10**9;
