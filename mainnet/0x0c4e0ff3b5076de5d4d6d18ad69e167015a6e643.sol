...
// File: contracts/ethereumy00ts.sol
...
contract Ethereumy00ts is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(string memory baseURI) ERC721A("Ethereumy00ts", "ETHy00ts"){
      setBaseURI(baseURI);
    }
