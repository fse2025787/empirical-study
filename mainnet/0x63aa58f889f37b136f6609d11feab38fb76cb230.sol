...
contract BabyApeCoin is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xaa6d384a13b0C2776A904b01cf747a37B4Fac980));
    address payable public _devwallet =
        payable(address(0x2795aB83A2Dbba745126A0336be1E829a8a1f0Ff));
    ...
    string private _name = "BabyApeCoin";
