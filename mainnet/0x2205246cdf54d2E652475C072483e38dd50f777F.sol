...
contract HADOUKENINU is IERC20,Context,ERC20Ownable {
    ...
    string private constant _name = "HADOUKEN INU";
    string private constant _symbol = "HADOUKEN INU";
    ...
    **/
    ...
    constructor () {
        _taxWallet = payable(0x9d176b99947aaA8757EA9A11bb9D309646789bFA);
