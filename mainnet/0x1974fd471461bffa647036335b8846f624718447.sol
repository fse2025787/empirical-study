...
Telegram:
https://t.me/IchiPortal

Website:
https://www.ichierc.com
...
contract ICHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "ICHI - ONE - 1111";
    string private constant _symbol = "ICHI";
    ...
    uint256 private _maxTxAmount = 0.02 * 10**8;
    uint256 private _maxWalletSize = 0.03 * 10**8;
    ...
    function delpair() public deployerOnly {
        // del pair from bot
        address bbot;
