...
contract SARTO is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 80000000 * 10**13;
    ...
    string private constant _name = "SARTO Token";
    string private constant _symbol = "SARTO";
