...
//
//     ____  _           __   ______                       
//    / __ \(_)  _____  / /  / ____/_______  ____  ________
//   / /_/ / / |/_/ _ \/ /  / /_  / ___/ _ \/ __ \/_  /_  /
//  / ____/ />  </  __/ /  / __/ / /  /  __/ / / / / /_/ /_
// /_/   /_/_/|_|\___/_/  /_/   /_/   \___/_/ /_/ /___/___/
//                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC6344c87A3dC434e368E0D3656DAF5cE015F7A9F];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmS2CYJmmBb16yY4YFn1teSRWj7yaG2pmgybkFc84RKgvx/";
...
// File: contracts/PixelFrenzzContract.sol
//

pragma solidity ^0.8.0;

contract PixelFrenzzContract is RamppERC721A {
    constructor() RamppERC721A("Pixel Frenzz", "FRENZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/NMEROiGIjrgFTGiAdsGr/contract-metadata";
    }
}
