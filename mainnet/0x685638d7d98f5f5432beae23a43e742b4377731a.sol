...
contract ScottiePippenSP33 is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Scotie Pippen SP33", "SCOTTIE-PIPPEN-SP33")
    {
        baseURI = _baseURI;
