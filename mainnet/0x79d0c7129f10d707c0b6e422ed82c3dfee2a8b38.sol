...
contract AwesomePossums is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant RESERVED_TOKENS = 2000;
    uint256 public constant FOR_SALE_TOKENS = 10000 - RESERVED_TOKENS;
    address public constant RESERVED_TOKENS_ADDRESS = 0xD1220e5E22bbE66721F9C9FC4dEc2F4eDF575115;

    uint256 public currentForSaleLimit = 10000 - RESERVED_TOKENS;
    ...
    uint256 public tokenPricePresale = 0.07 ether;
    uint256 public tokenPricePublicSale = 0.08 ether;

    uint256 public maxTokensPerAddressPresale = 50;
    uint256 public maxTokensPerAddress = 100;

    uint256 public presaleTotalLimit = 1000;

    bytes32 public whitelistRoot = 0x5cbb7b059a18f24e66ab9e16fce1ba1f309953713cee37b7f29bcf278d658db6;

    string public tokenBaseURI = "ipfs://QmRTqL1McYAJRq4GhpKQhfoBS6cSqQS8YKYQxHoTPo2K5H/";

    uint256 public soldAmount = 0;
    mapping(address => uint256) public purchased;

    constructor() ERC721A("Awesome Possums", "AP") {
    ...
    function setCurrentForSaleLimit(uint256 _currentForSaleLimit) external onlyOwner {
        currentForSaleLimit = _currentForSaleLimit - RESERVED_TOKENS;
    }
    ...
    function getMaxTokensAllowed(address target, bytes32[] memory proof) public view returns (uint256) {
        ...
        uint256 currentForSaleRemaining = safeSub(currentForSaleLimit, soldAmount);
        maxAllowedTokens = min(maxAllowedTokens, currentForSaleRemaining);
    ...
    function getContractInfo(address target, bytes32[] memory proof) external view returns (
        ...
        _totalForSale = currentForSaleLimit;
    }
