...
//  ______          __                  ___                __                 __     
// /\__  _\        /\ \__              /\_ \    __        /\ \               /\ \    
// \/_/\ \/     ___\ \ ,_\    __   _ __\//\ \  /\_\    ___\ \ \/'\      __   \_\ \   
//    \ \ \   /' _ `\ \ \/  /'__`\/\`'__\\ \ \ \/\ \ /' _ `\ \ , <    /'__`\ /'_` \  
//     \_\ \__/\ \/\ \ \ \_/\  __/\ \ \/  \_\ \_\ \ \/\ \/\ \ \ \\`\ /\  __//\ \L\ \ 
//     /\_____\ \_\ \_\ \__\ \____\\ \_\  /\____\\ \_\ \_\ \_\ \_\ \_\ \____\ \___,_\
//     \/_____/\/_/\/_/\/__/\/____/ \/_/  \/____/ \/_/\/_/\/_/\/_/\/_/\/____/\/__,_ /
//                                                                                   
//                                                                                   
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xE2F3F2DB26a5e8DA5E201A245972c6Ff7e0E1826];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xE2F3F2DB26a5e8DA5E201A245972c6Ff7e0E1826;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 222;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeig65ahetnw5mrftwnv7bwqxgbttafxwykalgilrkjzkiyk5votxga/";
...
// File: contracts/InterlinkedContract.sol
//

pragma solidity ^0.8.0;

contract InterlinkedContract is RamppERC721A {
    constructor() RamppERC721A("Interlinked", "INTRLINKED"){}
}
