...
contract TicketVault26 is Context, Ownable, Fees {
    ...
    constructor(address Token) {
        ...
        vault.stakingPeriod = 26 weeks; // 3 months staking period.
        withdrawFeePeriod = vault.stakingPeriod; // 3 months fee period.
        withdrawPenaltyPeriod = 4 weeks; // 2 weeks penalty period.
