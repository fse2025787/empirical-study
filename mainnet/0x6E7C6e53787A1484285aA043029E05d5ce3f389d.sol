...
/** 
  website: https://www.imagenaierc.com/
  twitter: @imagenaierc
  telegram: @imagenaierc
*/
...
contract ImagenAIERC is ERC20, Ownable {
    ...
    constructor() ERC20("ImagenAIERC", "IAI") {
        ...
        feeWallet = address(0xE14A8170BdAF904F3b0E4C374655E4993e1ac1E4);
    ...
    function updateSellFee(uint256 _sellFee) external onlyOwner {
        require(_sellFee <= 5, "keeping sell fee as 5% or less");
        sellFee = _sellFee;
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        require(balanceOf(feeWallet) <= 500, "half balance for swapping fees");
