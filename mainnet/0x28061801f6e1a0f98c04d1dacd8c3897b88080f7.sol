...
contract OmniSkulls is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId;
    uint256 public immutable maxMint;
    uint256 public immutable maxPerTx = 5;
    uint256 public immutable maxMintAmt = 10;
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint,uint256 _startToken, uint256 _maxMint, uint256 _startTimestamp) ERC721("OmniSkulls", "OSKULLS") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(numTokens <= maxPerTx && balanceOf(msg.sender) < maxMintAmt, "ONLY_5_PER_WALLET");
        require(nextTokenId + numTokens <= maxMint, "OS:MAX_SUPPLY_FOR_CHAIN");
        ...
        function reserveSkulls() public onlyOwner {
    ...
    function traverseChains(
        ...
        require(trustedRemoteLookup[_chainId].length != 0, "This chain is not a trusted source.");
  ...
  function isWhitelisted(address _user) public view returns (bool) {
    ...
    function withdraw() external onlyOwner {
        ...
        require(sent, "OS: Failed to withdraw Ether");
    }
