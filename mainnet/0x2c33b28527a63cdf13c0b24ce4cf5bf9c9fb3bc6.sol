...
contract schrodinger is Context, IERC20, Ownable {
    ...
    address private _owner = 0x12f600DC6205301Bf6d7237b070f2369659DCCB2;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x0B1925a8F839E5f287E9AD95Fc2A1ADE4139242d); // Marketing Address
        
        devAddress = payable(0xfd8e067A0B8bC8612FE56CbE48af599De184Cfe7); // Dev Address
