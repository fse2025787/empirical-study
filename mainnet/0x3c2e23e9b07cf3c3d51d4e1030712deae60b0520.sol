...
contract AlriNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    // set contract name and ticker. 
    constructor() ERC721("Web3 OGs", "ALRI") {}
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmZRrVnzZK9zBWREJ9oA2unKQe36hsqgm2HS9fbGM8VQC1?filename=001.json";
    }
