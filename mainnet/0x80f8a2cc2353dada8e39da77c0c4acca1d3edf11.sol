...
https://medium.com/@bakumantoken

max tx 0.8% in the first 5 minutes
(normal max tx 2%)
*/
...
contract BAKUMAN is ERC20, Ownable, LockToken {
    ...
    address payable private marketingWallet = payable(0xb7837c2b3Ac0fCE62dCb3E465f5a13c4fe4Ea15e);
    address payable private communityWallet = payable(0x6ecBaE7777a76cD694291E257f33c308F2Ad36AD);
    address payable private operationsWallet = payable(0x0597769782Fa3Ac7e1fBBb3AE130d1f57bF979fD);
    address payable private devWallet = payable(0x92b9525c3A0E62f140393a48B2E279d7030eED50);
    ...
    constructor() ERC20("BAKUMAN", "BAKUMAN") {
    ...
    function setBuyFees(uint256 _liqFee, uint256 _bbackFee, uint256 _markFee, uint256 _commFee, uint256 _opsFee, uint256 _devFee) public onlyOwner {  
        ...
        require(totalBuyFees <= 99, "fees too high");
    }
