...
Telegram: https://t.me/IYKYKPortal
Twitter: https://twitter.com/iykyketh
Website: https://iykyketh.com/
...
contract IYKYK is Context, IERC20, Ownable {
    ...
    string private constant _name = "IYKYK";//
    ...
    address payable private _developmentAddress = payable(0x11E32B927b311bEa7Dc22EA67f984Bb7f6107c00);//
    address payable private _marketingAddress = payable(0x11E32B927b311bEa7Dc22EA67f984Bb7f6107c00);//
    ...
    uint256 public _swapTokensAtAmount = (_tTotal * 1) / 10000; // 0.01%
    ...
    function setFee( uint256 taxFeeOnBuy, uint256 taxFeeOnSell) external {
        ...
        require(taxFeeOnBuy <= 4 && taxFeeOnSell <= 4 , "ERC20: Can not set tax more than 4%");
    }
