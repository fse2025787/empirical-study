...
AITRADER - The AI Trader

An AI that monitors all the major crypto buys and sells automatically. Think of it like an ETF that operates independently from an investment company. One we can all own a part of.

Tax: 5%

Total Supply 1,000,000

Telegram: https://t.me/aitradererc 
Twitter: https://twitter.com/AITradererc 
Website: aitrader.world 
...
contract aitradererc is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The AI Trader";
    string private constant _symbol = unicode"AITRADER";
