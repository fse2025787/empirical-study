...
/**
  Telegram:  https://t.me/dokwoncakeerc
  Website: https://www.dokwoncake.com/
...
contract DoKwonCake is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Do Kwon Cake";
    string private  _symbol = "DKWON CAKE";
