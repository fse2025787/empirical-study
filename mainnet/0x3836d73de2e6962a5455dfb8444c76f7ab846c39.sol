...
// File: contracts/Vault12Token.sol

/**
 * @title BluffBet token
 */
contract TruffleConToken is Ownable, Claimable, MintableToken, BurnableToken {
    event Transfer(address indexed from, address indexed to, uint256 value, bytes data);
    event Multisended();

    string public name = "TruffleCon Token";
