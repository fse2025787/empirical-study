...
Generate any wallet you like with $WGAI

Telegram: https://t.me/WalletGenerator  
Twitter: https://twitter.com/WalletGenAI
Medium: https://medium.com/@walletgenerator/whats-a-wallet-address-ai-generator-3449206342bf
...
contract WGAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Wallet Generator AI";
    string private _symbol = "WGAI";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x66666603c29eD7D1E2F2f72FD4fc5fD78de6bd2C);
    address payable public DeveloperWallet = payable(0x66666603c29eD7D1E2F2f72FD4fc5fD78de6bd2C);
    ...
    uint256 public _sellDeveloperFee = 4;
