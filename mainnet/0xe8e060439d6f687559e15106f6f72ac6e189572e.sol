...
What's-a what's-a what's-a what's-a what's-a what's-a what's-a what's-a what's UP, BITCONNEEEEEEEEEEEECT BLACK!

Hey hey hey everybody, My name is DEV CarlosMatos and I am coming from New York City, New York!
Let me tell you guys that I am SO EXCITED, I am SO HAPPY I am really so thrilled to be right now!
Sharing this amazing, glorious, SUPER and EXCITING moment of my life with all of you guys—and let me tell you that we are really changing the WORLD as we know it. 
The WORLD is not anymore the way it used to be, mm mm MM, NO NO NOH!

BitcoNNEEEEEEEEEEEEEEEEECT BLACK! WOOOoo... bitconnEEEEEEEEEEEEEEEEEEEEECT BLACK!
AHAHAHAHAHAh!

So GUYS, let me tell you: I LOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOVE BIT CON EEEEEEECT BLACK
*/
// 
 ...
 * allowances. See {IERC20-approve}.
 */
 contract BITCONNECT_BLACK is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "BITCONNECT BLACK";
    ...
    address public marketingWallet = 0x83378340b665A8a6E38C0D8962AF34Ce8857cE30;
    // TOKENOMICS END ============================================================>
