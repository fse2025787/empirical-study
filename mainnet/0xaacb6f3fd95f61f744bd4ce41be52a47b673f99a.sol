...
contract CZDAO is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5_000_000 * 10**9;
    ...
    string private constant _name = "CZ DAO";
    string private constant _symbol = "CZ DAO";
    ...
    uint256 private _maxWalletSize = 45_000 * 10**9;
