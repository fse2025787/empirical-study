...
Let us wish YE farewell following his suspension with $GYE. 

Taxes will be reduced to 0, contract renounced and liquidity locked. 
...
contract GYE is ERC20, Ownable {
    ...
    constructor() ERC20("Goodbye Ye", "GYE") {
