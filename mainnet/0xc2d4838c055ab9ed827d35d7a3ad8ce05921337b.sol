...
contract EXVATOKEN is
    ERC20Lockable,
    ERC20Burnable,
    Freezable
{
    string constant private _name = "EXVATOKEN";
    string constant private _symbol = "EXVA";
    uint8 constant private _decimals = 18;
    uint256 constant private _initial_supply = 1_500_000_000;
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "EXVA/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "EXVA/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "EXVA/approve : Should not approve zero address"
        );
