...
Schipperke Inu $SCHIPS is an innovative new ERC-20 meme token on the Ethereum Network 
striving to create the same inspirational journey many before us have gone through. 
He provides a safe home for his community members during one of the biggest and scariest 
bear markets in recent times. The $SCHIPS community will be known as a strong, supportive, 
and positive community in the crypto space as everyone works together to crush 0's and reach success.

Holding your $SCHIPS is rewarding, literally! With every transaction, 2% will be used to buy and distribute 
Shiba $BONE rewards to all holders automatically every 8 hours! 

https://www.facebook.com/groups/schipperkeinu
https://www.facebook.com/SchipperkeInuOfficial
http://schipperkeinu.com/
https://twitter.com/SchipperkeInu
https://t.me/SchipperkeInu
...
contract SchipperkeInu is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Schipperke Inu';
    string private constant _symbol = 'SCHIPS';
    ...
    uint256 public minPeriod = 480 minutes;
    ...
    address internal constant development_receiver = 0x81B627401F7E8A557405080446fCB2Db72e5d242; 
    address internal constant marketing_receiver = 0x3FcC39Fce78Cec54cC4ee9F654480dC16cB494f1;
    address internal constant liquidity_receiver = 0x81B627401F7E8A557405080446fCB2Db72e5d242;
