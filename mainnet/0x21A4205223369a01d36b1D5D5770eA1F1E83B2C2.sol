...
contract  BurntTyrant is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "Burnt Tyrant";
    string private _symbol = "$BTyrant";
    ...
    constructor () {
        ...
        SLNA = payable(address(0x73fbe02a538ed97DDDCbC087240B8E325a3eF65E));
