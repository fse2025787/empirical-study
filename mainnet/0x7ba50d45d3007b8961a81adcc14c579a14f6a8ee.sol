    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function initialize() initializer public {
        __ERC721_init("Sarah Sherman Samuel Collection by Tonic", "SSS");
        ...
        uriPrefix = "https://meta.tonic.xyz/sss-collection/";
    }
    ...
    function adminMint(address destination, uint quantity)
        external
        onlyOwner
    {
    ...
    function adminMintBulk(address[] calldata destinations)
        external
        onlyOwner
    {
        for (uint8 i = 0; i < destinations.length; i++) {
            _mintAndIncrement(destinations[i]);
        }
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://meta.tonic.xyz/sss-collection/collection";
    }
