...
contract SHIMURAI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x86b631C2363b37940912c4d3206a382577260496));
    address private _burnAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "Shimurai";
    string private _symbol = "SHIMURAI";
