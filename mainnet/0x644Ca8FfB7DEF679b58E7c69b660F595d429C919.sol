...
/**
 * @dev OZ implementation of ERC721 with modifications
 */
contract ERC721Custom is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function balanceOf(address user) public view override returns (uint256) {
        ...
        return _holderTokens[user].length();
    }
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://modifiable.art/api/nft/";
    }
    ...
    // ERC721Enumerable partial functionality
    /**
