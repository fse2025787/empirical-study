...
contract Emodus is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xF98b9c2af42C40C7502f91110E9f5344179bD4aF));

    string private _name = "Emodus";
    string private _symbol = "EMODUS";
