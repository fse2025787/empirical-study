    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieu7bqyxucjmfxzq4d4d6gk7tyt2sjmmerfzwrqeq4v7pgaf6fwaq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/sD7OJ9r63NavgClRinxg/contract-metadata";
  }
...
// File: contracts/LsdmachinesContract.sol
//

pragma solidity ^0.8.0;

contract LsdmachinesContract is RamppERC721A {
    constructor() RamppERC721A("LSD MACHINES", "LSDM"){}
}
