...
/**
    DEERCOIN is a project developed on the ERC chain.
With a strong combination of meme coin and the explosion of music in the near future. The project will become a great opportunity for those who grasp future trends.

DEER COINCOMMUNITY envisions the success of all investors involved, and the community will achieve this milestone as a whole.

ABOUT DEER COIN
In the ETHEREUM’s platform, $DCOIN is the next project to mirror Busd for holders. With a long-term vision, we are always here and growing. Trust in the project is very important, we have passed the safety audit. Contract is secured, so it is completely beneficial for investors
$DCOIN coin fulfills everyone’s need for a stable coin suitable for long term investment. With every transaction, a small percentage of tokens are automatically transferred to the Uniswap liquidity Pool.

A LOT OF PROMOTION WILL COME UP SO STAY WITH US AND FOLLOW
DEERCOIN UNTIL HE GOT THE MOONSHOT! LET’S GO SLICK HEADs!

Telegram: https://t.me/DeerCoinERC
Twitter: https://twitter.com/deerCoinerc
Medium: https://medium.com/@deercoinbusiness/
Web: https://www.deercoin.biz/
*/
...
contract DeerCoin is Ownable, IERC20 {
    ...
    string private _name = "DEERCOIN";

    string private _symbol = "$DEERCOIN";
