...
contract CheckCurrency is IERC721A { 
    ...
    uint256 public MAX_FREE = 950;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Check Currency";
    string private constant _symbol = "CC";
    string private _baseURI = "Qme7fZxes4shG8dpkjXaB1FeLtyxHdjE4G6xbQAhHotPgD";
