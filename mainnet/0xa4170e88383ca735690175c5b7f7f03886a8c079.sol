...
/**
 * @title Yosi Ocha Contract
 * @author Mai Akiyoshi & Ben Yu (https://twitter.com/mai_on_chain & https://twitter.com/intenex)
 * @notice This contract handles minting Yosi Ocha tokens.
 */
contract YosiOcha is ERC721A, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public price = 0.78 ether;
