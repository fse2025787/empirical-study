...
contract WoodyFrenz is ERC721A, Ownable, IERC2981, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public saleMode = 3; // 0 - register, 1- presale 2- raffle sale 3 - public sale
