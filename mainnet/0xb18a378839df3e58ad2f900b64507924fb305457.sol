...
// 
/*
Do you think pyramid is history?
Do you think pyramid is an ancient human legend?
Do you think pyramid is a great wonder of the world?
No, it's created by God. It's the trigger to the divine world.
That's why the pyramid is so solemn and unsurpassed. It is as good as any building, because it is above human beings.
https://twitter.com/pyramid_ERC20
*/
...
contract PYRAMID is ERC20, Ownable {
    ...
    constructor() ERC20("The Legend", "PYRAMID") {
        ...
        devWallet = address(0x282834B2e8dbeF0c8a2943aE65B23D1235Dc825A); // set as dev wallet
