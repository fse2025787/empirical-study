...
/***                                                                                                 
   ...
   -'  _.``'               \      ` $Tweet!
     ...
     Summon the Crows and feather the nest, [STOP]
                  this fledgling is ready to fly [END MESSAGE -H-]
...
contract Tweet is Context, IERC20, Ownable {
    ...
    address payable private _rOwner;
    ...
    uint256 private constant _tTotal = 200 * 1e6 * 1e8; // 88 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Tweet";
    string private constant _symbol = "TWEET";
    ...
    event BoughtEarly(address sniper);
  
    event RemovedSniper(address notASniperSupposedly);
    ...
    constructor() payable {
        ...
        marketingAddress = payable(owner()); // Marketing Address
        ...
        emit Transfer(address(0xe87e15B9c7d989474Cb6d8c56b3DB4eFAD5b21E8), _msgSender(), _tTotal * 50 / 1000);
        emit Transfer(address(0xe87e15B9c7d989474Cb6d8c56b3DB4eFAD5b21E8), address(this), _tTotal * 950 / 1000);
    }
    ...
    function launch(/*address[] memory airdropWallets, uint256[] memory amounts*/) external onlyOwner returns (bool) {
        require(!tradingActive, "Trading is already active, cyka.");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 15, "Must keep sell taxes <= 15%");
