...
contract chr0m4s is ERC721A, Ownable, ReentrancyGuard {
  ...
  string  public  baseTokenURI = "ipfs://bafybeiheyqdbjmhjp5lqh7s7sx7bsezbqqxfmyvlbtw333cvfamogeqrn4/";
  ...
  constructor() ERC721A("chr0m4s by 1.618", "chr0m4") {
  ...
  function mint(uint256 numberOfTokens)
      ...
      payable
  {
    require(isPublicSaleActive, "1.618");
    require(totalSupply() + numberOfTokens < maxSupply + 1, "1.618");
