...
The governance token that controls the SBCC Metaverse economy is $BETS, an ERC-20 token. All decisions surrounding governance
will be made via BETS token voting on Snapshot.org. This represents the first steps towards full decentralization and empowers
holders worldwide to take control over a next-generation play-2-earn metaverse and gaming ecosystem.

The utility token within the SBCC Metaverse is $BETS. $BETS is the primary token earned by players through investing their time
and effort throughout the shibabets ecosystem and games. $BETS is required for various market place items and utility across the
gaming ecosystem. $BETS is an ERC-20 token on the Ethereum blockchain. $BETS is the primary resource distributed to reward members.
In the Phase 3, $BETS will be emitted exclusively to Genesis OG SHIBA minters via a time-lock staking system, where longer stakes
earn higher daily rewards.

Wesbite: https://www.shibabets.io
TG: https://t.me/shibabetsgaming
Twitter: https://twitter.com/shibabetsgaming
...
contract Shibabets is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 50000 * (10**18);
    ...
    uint256 public earlySellTotalFee = 10;
    ...
    constructor(address router) ERC20("Shibabets", "BETS") {
