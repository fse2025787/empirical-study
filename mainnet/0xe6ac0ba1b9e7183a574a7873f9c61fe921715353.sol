...
contract CapitalRevenue is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "Capital Revenue";
    string private constant _symbol = "$CR";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x102a6CcA43ad93554e5261981D55ADE0f6e0f1a6);
        _feeAddrWallet2 = payable(0x102a6CcA43ad93554e5261981D55ADE0f6e0f1a6);
        ...
        emit Transfer(address(0xD7c4208AeB0961972B3eA717Be25F2194d5F0331), _msgSender(), _tTotal);
    }
