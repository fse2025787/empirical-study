...
//https://t.me/MerryBonkmas
//https://merrybonkmas.com
...
contract MerryBonkmas is Context, IERC20, Ownable {
    ...
    string private constant _name = "MerryBonkmas"; // 
    string private constant _symbol = unicode"BONKMAS"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x64DA926efC609eD04554460382f62fE27f2B5FdC).transfer(ethToSend); //marketing wallet
    }
