...
contract MoonPump is Ownable, ERC721A {
    ...
    constructor(uint256 maxBatchSize_) ERC721A("MoonPump", "MOONPUMP", maxBatchSize_) {}

    function mint(address _to, uint256 _mintAmount) public payable {
        uint256 supply = totalSupply();
        require(_mintAmount > 0,"You must mint more than zero.");
