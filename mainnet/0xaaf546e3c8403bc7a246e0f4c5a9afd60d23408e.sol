...
contract FIIngers is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 999;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.0 ether;

    string private constant _name = "FIIngers";
    string private constant _symbol = "FIIngers";
    string private _contractURI = "QmesFaHPQyjd2fT9kz4qckyCiX6nvwxau7K9f3TLnb6GsK";
    string private _baseURI = "QmVsL7LEsUsei6uMhHFQqH2LgSotNfhWkvZ48pr8ftZCUj";
