...
contract TSUKILLER is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "TSUKILLER";
    string private constant tokenSymbol = "TSUKILLER";
    ...
    constructor() payable {
        ...
        maxWallet = tokenSupply.mul(20).div(100);
        minTaxSwap = tokenSupply.mul(5).div(10000);

        marketingAddress = payable(0x7A41BCCC698cd1092979D09F1FA6f531E6347879);
        devAddress = payable(0x7A41BCCC698cd1092979D09F1FA6f531E6347879);
