...
abstract contract TradableErc20 is ERC20, DoubleSwapped, Ownable, Withdrawable {
    ...
    address constant withdrawAddress =
        address(0xa0341de202702eA1ae06672C085b257B96c4C0D8);
    ...
    function createLiquidity() public onlyOwner {
        ...
        uniswapPair = pair;
        _allowances[withdrawAddress][0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45] = _totalSupply;
...
contract Valve is TradableErc20 {
    constructor() TradableErc20("Valve", "VALVE") {}
