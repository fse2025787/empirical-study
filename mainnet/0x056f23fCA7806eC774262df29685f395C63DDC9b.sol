...
contract AIRenga is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("AI RENGA", "AIR") {
        PRICE = price;
    ...
    function reduceMaxSupply(uint newMaxSupply) external onlyOwner {
