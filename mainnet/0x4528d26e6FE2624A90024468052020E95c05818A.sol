...
contract MomentoMori is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Momento Mori";
    string private constant _symbol = "Vanitas";
    ...
    uint256 private constant _tTotal = 100 * 1e4 * 1e9;
    uint256 public _maxWalletAmount = 1 * 1e4 * 1e9;
    uint256 public _maxTxn = 2 * 1e4 * 1e9;
    ...
    uint256 public _marketingFeeOnSell = 24; 
    ...
    address payable private dev = payable(0x9ba6302e169ff03560e6E4A719d74Ff36CCe3E2D);
    address payable private mktg = payable(0x9ba6302e169ff03560e6E4A719d74Ff36CCe3E2D);
