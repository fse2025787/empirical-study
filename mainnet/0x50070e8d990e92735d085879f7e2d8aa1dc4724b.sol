...
// $FLOKASINO | Floki Kasino
// Casino Play, launched by FairLaunchCalls
...
/**
 * Casino Plays are purely degen gambles.
 * FLC maintain a safe environment to do this within, ensuring locked liquidity & renounced contracts.
 * However, these plays are incredibly risky.
 * Make no mistake - you are gambling when entering.
 * There will be no telegram, website, roadmap, whitepaper, or otherwise.
 * There will be no post-launch support - you are gambling.
 *
 * For long-term plays (or more gambles), check out our telegram at t.me/FairLaunchCalls.
*/
...
contract ShibSlots is Context, IERC20, Ownable {
    ...
    string private _name = 'Floki Casino | t.me/FairLaunchCalls';
    string private _symbol = 'FLOKASINO';
    ...
    function initContract() external onlyOwner() {
        ...
        _taxFee = 1;
        _teamDev = 8;
        _teamDevAddress = payable(0x1A87e42ce4A872d9aC793925Ad41ba463d030863);
    }
