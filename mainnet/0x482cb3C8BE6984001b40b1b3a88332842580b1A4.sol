...
contract BapesGenesisKeyDiamond is ERC721A, Ownable, AccessControl {
  ...
  constructor(string memory _metadataURI) ERC721A("Bapes Genesis Key Diamond", "BGKD") {
  ...
  function mint(
    ...
    uint256 bgkRequired = _mintAmount * 6;
    ...
    if (bgk1Balance >= bgkRequired) {
      ...
      revert("You do not have enough BGKs to morph into selected amount of Diamond.");
    }
  }
