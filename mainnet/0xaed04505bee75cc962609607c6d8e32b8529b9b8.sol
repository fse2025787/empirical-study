...
contract Cryptotrumps is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("Crypto Trumps", "CTRUMPS") OperatorFilterer(address(OSlist), false) {
