...
contract ZuckBucks is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Zuck Bucks";
    string private constant _symbol = "ZUCKBUCKS";
    ...
    address payable private _marketingAddress = payable(0x01B78436b03bF6B2eb2Fb3D161E838D2CF56471f);
    ...
    uint256 public _maxTxAmount = 6900000 * 10**9; //0.75
