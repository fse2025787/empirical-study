...
https://twitter.com/Bitboy_Crypto/status/1596621816973361154?s=20&t=EUtwjf0Wyx4VDQO03Ncg8Q
*/
// 
...
contract BITBOYVSSBF is Context,IERC20, Ownable{
using Address for address;
string private _name = "BITBOYVSSBF";
string private _symbol = "BBVSBF";
...
address _owner;
address payable public marketingAddress = payable(0xFDA85c6A1F6A7B0CdFc39937BA68DeC002D53431);
...
uint256 BITBOYVSSBFCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > BITBOYVSSBFCOINDaycooldown, "You cant call BITBOYVSSBFCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function BITBOYVSSBFCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    BITBOYVSSBFCOINDaycooldown = block.timestamp + 86400;
}
