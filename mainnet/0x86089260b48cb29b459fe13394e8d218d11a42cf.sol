...
contract GoonsofBalatroon is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 750000000*10**18;
    string public _name = "Goons of Balatroon";
    string public _symbol= "GOB";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x32bC539209157520EB24E432809eC638F75ba745);
