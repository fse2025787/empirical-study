...
contract SpaceJamShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'Space Jam Shiba';
    string private _symbol = 'SHIBAJAMZ';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[2]/**tholder*/ = tAmount.div(100).mul(15);
