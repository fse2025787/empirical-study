...
contract FLOKER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FLOKER";
    string private constant _symbol = unicode"FLOKER";
