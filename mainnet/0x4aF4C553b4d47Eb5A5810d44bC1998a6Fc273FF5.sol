...
/**                                            POWERED BY
 *  __  ________   ________      __   ____       _______             __ 
   /  |/  /  _/ | / / ____/    _/_/  / __ \___  / ____(_)___ _____  / /_
  / /|_/ // //  |/ / __/     _/_/   / / / / _ \/ /_  / / __ `/ __ \/ __/
 / /  / // // /|  / /___   _/_/    / /_/ /  __/ __/ / / /_/ / / / / /_  
/_/  /_/___/_/ |_/_____/  /_/     /_____/\___/_/   /_/\__,_/_/ /_/\__/  
   t.me/mcuentryportal                       t.me/defianthub                                 
  TheOfficialMineToken.io                linkre.ee/DeFiant_Platform                      
...
contract TheOfficialMINEToken is RewardsToken {
    ...
    address payable private constant _platformWalletAddress =
        payable(0xAf323b073057266C036E75cf0FfD336985428f3a);
    address payable private _devWalletAddress =
        payable(0x83800411295DB36af4B2DF5a04d32543464780ab); 

    uint256 private blacklistDeadline = 0;
    uint256 private launchSellFeeDeadline = 0;

    IRewardsTracker private _rewardsTracker;

   
    bool private useGenericTransfer = true;
    ...
    function changeTrueBurn(bool value) private onlyOwner{
        trueBurn = value;
    }
