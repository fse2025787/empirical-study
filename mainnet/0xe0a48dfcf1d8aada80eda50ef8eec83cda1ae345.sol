...
contract AlphaPenguin is ERC721A, Ownable, ReentrancyGuard { 

    uint256 public _maxSupply = 2098;
    uint256 public _mintPrice = 0.005 ether;
    uint256 public _maxFreeMintPerAddr = 2;
    uint256 public _maxFreeMintSupply = 498;
    ...
    constructor(string memory initBaseURI) ERC721A("AlphaPenguin", "AlphaPen") {
        baseURI = initBaseURI;
    }
