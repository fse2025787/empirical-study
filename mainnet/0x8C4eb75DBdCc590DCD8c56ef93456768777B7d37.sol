...
contract ZeroToHero  is Context, IERC20, Ownable {
    ...
    string private constant _name = "HeroToZero";
    string private constant _symbol = "HTZ";
    ...
    constructor () {
        dev = payable(0x2e69A85e5e454DDe8290683aEa652044de4D343B);
        mktg = payable(0x2e69A85e5e454DDe8290683aEa652044de4D343B);
    ...
    function updateFees(uint256 sellTax, uint256 reflections, uint256 buyTax) external onlyOwner {
        ...
        _sellTax = sellTax;
        _buyTax = buyTax;
        require(reflections <= 0, "Must keep fees at 5% or less");
        require(sellTax <= 99, "Must keep fees at 18% or less");
