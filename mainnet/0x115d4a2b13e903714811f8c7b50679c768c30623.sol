...
/**
    Black Rabbit ERC Token
    Twitter:  https://twitter.com/BlackRabbitETH
    Telegram: https://t.me/BlackRabbitEntry   
*/
...
contract BlackRabbit is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xEd8cae98a3aff77cB969b0f573c8729726bDfbc8); // Marketing Address
    address payable public multiSigAddress = payable(0x2280e45130C4152844683838bBA61cee46f705F1); // Marketing Address
    address payable public devAddress = payable(0x2280e45130C4152844683838bBA61cee46f705F1); // Dev Address
    address payable public liquidityAddress = payable(0x2280e45130C4152844683838bBA61cee46f705F1); // Liquidity Address
    ...
    string private constant _name = unicode"Black Rabbit";
    string private constant _symbol = unicode"BLKRabbit";
