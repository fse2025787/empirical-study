...
contract SKDE is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
...
uint256 public devTotal;
    ...
    uint256 public _mintPrice = 0.0044 ether;
    ...
    constructor(string memory initBaseURI) ERC721A("SkullDegens", "SKDE") {
        baseURI = initBaseURI;
    }
