...
contract WhatIfLads is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    LarvaLads larvaLads = LarvaLads(0x5755Ab845dDEaB27E1cfCe00cd629B2e135Acc3d);

    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        return larvaLads.tokenURI(tokenId + 5000);
    }
    ...
    constructor() ERC721("What If Lads", "WHAT") Ownable() {}
}