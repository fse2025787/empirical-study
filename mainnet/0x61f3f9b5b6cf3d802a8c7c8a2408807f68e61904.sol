...
contract MutantApepeYachtClub is ERC721A, Ownable {
    ...
    constructor() ERC721A("MutantApepeYachtClub", "PEPEYC") {}
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(quantity<=5 , "Sorry, there are only 5 items allowed for each minting.");
