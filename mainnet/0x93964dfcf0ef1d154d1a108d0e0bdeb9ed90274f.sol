...
contract Ares is ERC20, Ownable {
    ...
    constructor() ERC20("Ares", "WAR") payable {
    	...
    	marketingWallet = address(0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374); // set as Marketing wallet
        devWallet = address(0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374, true);
        excludeFromFees(0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374, true);
        excludeFromMaxTransaction(0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x67D1e9bdb1F1455C9F0a7DfA88E4b0d8903Ea374,
            block.timestamp
        );
    }
