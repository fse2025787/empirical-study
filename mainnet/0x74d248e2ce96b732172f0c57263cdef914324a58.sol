...
contract MakomoToken is Context, IERC20, Ownable {
    ...
    string private _name = "MakomoToken";
    string private _symbol = "MAKOMO";
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000000000 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 10000, "Swap Threshold Amount cannot be less than 10000");
    ...
    function addBotWallet(address[] calldata botwallet) external onlyOwner() {
