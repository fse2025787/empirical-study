...
contract KANJI is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x3256fDfEF518A2746901A929B6d8f5E29BE64dBF;
    address private feeTwo = 0x3256fDfEF518A2746901A929B6d8f5E29BE64dBF;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Dejitaru Kanji";
    ...
    uint256 public burnRateInBasePoints = 200;  //100 = 2%
