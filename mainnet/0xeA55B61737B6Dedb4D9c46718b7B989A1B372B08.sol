...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x25E355B2D592b8Eed304D46357C6b2A2FDFFe378];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmYc6XcZw7WDKxKyMtxRWjo9nscRvXvkRWMZqk3wJRuBgW/";
...
// File: contracts/MisfitPandasContract.sol
//

pragma solidity ^0.8.0;

contract MisfitPandasContract is RamppERC721A {
    constructor() RamppERC721A("Misfit Pandas", "PandaPanda"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/DQUXkN8UyNGxpV7tyXv6/contract-metadata";
    }
}
