...
GRINGODOGE THE MEXICAN BOSS FROM THE CARTELL

Telegram: https://t.me/GRINGODOGE
Website: GRINGODOGE.io
*/
...
contract GRINGODOGE is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "GRINGO DOGE"; // name
    string private _symbol = "GRINGODOGE"; // symbol
    uint256 private _tTotal = 10000000000000 * 10**uint256(_decimals); // total supply
