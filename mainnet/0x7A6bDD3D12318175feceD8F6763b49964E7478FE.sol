...
//         /　 ヽ　　 ﾉ      
//         │　　|　|　|      This contract allows you to 'open' a box on-chain, after which a creature
//     ／￣|　　|　|　|       inside imparts some wisdom on you and the closes the box. You can also
//      (￣ヽ＿_ヽ_)__)      bribe me to change the creature's name and wisdom. That's it. No other utility. 
//     ＼二)
...
contract MysteryCreature is Ownable, ENSNameResolver{
   ...
   string public creatureName = "Cat";
   ...
   function closeTheBox() private {
      string memory closeStr = string.concat(creatureName,
                                             " declared \"",
                                             wisdom,
                                             "\", and closed the box. ");
      boxIsOpen = false;
   ...
   // Pay a bribe to change the creatureName's name and wisdom. Initial bribe = .001E
   function name(string memory newCreatureName, string memory newCreatureWisdom) external payable {
      ...
      string memory ritual = string.concat(lastNamedBy, 
                                             ...
                                             creatureName, " to ", newCreatureName, 
                                             ", and whispered new wisdom into its ear." 
        );
      creatureName = newCreatureName;
      wisdom = newCreatureWisdom;

      emit namingCeremony(ritual);
    }


   // Update the required bribe amount to change the creatureName's attributes.
