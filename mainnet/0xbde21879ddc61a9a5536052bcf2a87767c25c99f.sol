...
contract Gnometown is Ownable, ERC721A {
    ...
    uint256 public publicPrice = 0.0035 ether;
    ...
    string public CONTRACT_URI = "ipfs://XG81QZ5P7F1YS3YDCM12U5GRAPBBF3EYRQ";
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Gnometown.wtf", "Gnome") { }
