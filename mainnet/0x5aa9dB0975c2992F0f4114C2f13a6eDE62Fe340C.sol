...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (IUniswapRouter02 _router) {
        router = _router;
        _token = msg.sender;
    }
...
contract metaSquid is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "MetaSquid";
    ...
    address public marketingWallet = 0x805e51AFB5B82A65142b683424D76D07807dFd95;
    address private teamWallet = 0x805e51AFB5B82A65142b683424D76D07807dFd95;
    ...
    uint256 public swapThreshold = 8 * (10 ** _decimals);
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newteamFee) external authorized {
        ...
        require(newLiqFee >= 0, "LP Tax on buys can not be higher than 10%");
        require(newMarketingFee >= 0, "Marketing Tax on buys can not be higher than 10%");
        require(newteamFee >= 0, "Team Tax on buys can not be lower than 0%");
        require(newRewardFee >= 0, "Rewards Tax on buys can not be lower than 2%");
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell, uint256 newteamFeeSell) external authorized {
        require(newLiqFeeSell >= 0, "LP Tax on sells can not be higher than 10%");
        require(newMarketingFeeSell >= 0, "Marketing Tax on sells can not be higher than 10%");
        require(newteamFeeSell >= 0, "Team Tax on sells can not be lower than 0%");
        require(newRewardFeeSell >= 0, "Rewards Tax on sells can not be lower than 2%");
