...
contract PepeLore is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Pepe Lore";//
    ...
    address payable private _developmentAddress = payable(0xd048300B4807eb318F9BB2Ce776623F55C55EdEE);
    address payable private _marketingAddress = payable(0xd048300B4807eb318F9BB2Ce776623F55C55EdEE);
