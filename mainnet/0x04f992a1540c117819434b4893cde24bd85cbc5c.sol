...
We combine the power of Elon Musks Dog with inuvative TECH,  MEVFLOKI gives power to the people and kills every AI that stands his ways!

Tokenomics: 
1% on to reflections on Buy/Sell.
The real tokenomics are 1% buy and 10% sell.
MEV-KILLER FORK!
*/
pragma solidity ^0.6.12;
    ...
    contract MEVFLOKI is Context, IERC20, Ownable {
        ...
        string private _name = 'MEV Floki';
