...
// 
// File: contracts/TheUsurpers.sol
...
contract TheUsurpers is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4000;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmR7wtDz5KVnoJwtzwFDXbtcjrzwucPac7P186C3USXt1y/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("The Usurpers", "USURPR", MAX_MINTS, MAX_SUPPLY) {  
    }
