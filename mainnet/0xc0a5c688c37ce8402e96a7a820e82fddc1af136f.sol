...
contract SantaSaitama is Context, IERC20, Ownable {
    ...
    string private constant _name = "Santa Saitama";
    string private constant _symbol = "SANTAMA";
