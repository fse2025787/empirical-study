...
contract BeverageMakerExploitMock {
    BeverageMaker public immutable beverageMaker;
    
    constructor(address _beverageMaker) public {
        beverageMaker = BeverageMaker(_beverageMaker);
    } 
  
    function convert(IFeeSplitExtension _feeSplitExtension, ISetToken _setToken) external {
        beverageMaker.convert(_feeSplitExtension, _setToken);
    }
}
