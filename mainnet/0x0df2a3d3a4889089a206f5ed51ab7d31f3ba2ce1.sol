...
contract CocaineBear is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Cocaine Bear Movie NFT", "COCOBEAR")
    {
        baseURI = _baseURI;
