...
// File: contracts/MoonSeals.sol
pragma solidity 0.8.14;

contract MoonSeals is ERC721A, Ownable {
  enum SaleConfig {
    PAUSED,
    ON
  }
  ...
  function mint(uint256 _amount) external payable {
      require(
          saleConfig == SaleConfig.ON,
    "");
      require(
          _amount <= LIMIT,
    "");
      require(
          totalSupply() + _amount <= SUPPLY,
    "");
