...
contract xETH is Context, IERC20, Ownable {
    ...
    string private _name = "xETH";
    string private _symbol = "xETH";
    ...
    address payable public _prizeWalletAddress;
    ...
    constructor (address payable prizeWalletAddress) public {
        _prizeWalletAddress = prizeWalletAddress;
    ...
    function sendBNBToPrize(uint256 amount) private { 
        swapTokensForEth(amount); 
        _prizeWalletAddress.transfer(address(this).balance); 
    }
    
    function _setPrizeWallet(address payable prizeWalletAddress) external onlyOwner() {
        _prizeWalletAddress = prizeWalletAddress;
    }
