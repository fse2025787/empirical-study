...
contract MECO is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Condo";
    string private _symbol = "MECO";
    ...
    address public marketing = 0xdF7E310732c283E0f1ca272502EbEecfE1aEa6F4;
    ...
    constructor () {
        ...
        _transfer(_msgSender(), address(0), 250000000 * 10**18);
