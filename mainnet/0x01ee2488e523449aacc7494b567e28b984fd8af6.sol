...
Telegram: https://t.me/kingdombankportal
Website: http://kingdombanketh.com/
...
contract KingdomBank   is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 40* 10**6* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = '  Kingdom Bank';
    string private _symbol = 'KNDMB ';
