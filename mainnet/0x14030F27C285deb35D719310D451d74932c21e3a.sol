...
// 
//
// AIRPAY is world’s 1st platform that accepts all minor & major cryptocurrencies
// The AIRPAY token will be implemented as a ETH compatible token on the Ethereum blockchain.
// 
// Users will be able to spend their $AIRPAY tokens using their AIRPAY debit card for shopping, eating out, purchasing services, and more. 
// $AIRPAY will be automatically converted to a fiat currency when settling the payment. 
//  
//    ________    ________  ______    ______   ________   __  __    
//   /_______/\  /_______/\/_____/\  /_____/\ /_______/\ /_/\/_/\   
//   \::: _  \ \ \__.::._\/\:::_ \ \ \:::_ \ \\::: _  \ \\ \ \ \ \  
//    \::(_)  \ \   \::\ \  \:(_) ) )_\:(_) \ \\::(_)  \ \\:\_\ \ \ 
//     \:: __  \ \  _\::\ \__\: __ `\ \\: ___\/ \:: __  \ \\::::_\/ 
//      \:.\ \  \ \/__\::\__/\\ \ `\ \ \\ \ \    \:.\ \  \ \ \::\ \ 
//       \__\/\__\/\________\/ \_\/ \_\/ \_\/     \__\/\__\/  \__\/ 
//                                                               
//       
//  Website: https://airpay.finance/
//  Telegram: https://t.me/AirpayAirdrop_bot                                      
...
contract AIRPAY is ERC20, Ownable {
    ...
    constructor() payable ERC20("Airpay Token", "$AIRP") {
