...
/**
    Hello!!!!! 
    My name is Bill vison.


    #AAS COIN

    I released 100000000 AAS in Ethereum at one time and will never increase the number.

    Official website: https://www.aascoin.com
    Standby website：https://www.aascoin.org

    Official twitter：https://twitter.com/AASCOIN

    I make this #AAS to hand over it to the community.
    You can join the community if you are interested.   
    English telegram: https://t.me/aascoinen
    Chinese telegram: https://t.me/aascoinzh


    Great features:
    Zero transaction transfer fee
    Completely decentralized to ensure 100% safety
    It is not bound by the laws of any country and applies to any institution and individual globally

    #AAS allocation:
    100,000,000 total supply
    10% coin for dev
    90% coin for investors
    The value of AAS coin is completely determined by the market. 
...
contract AASCOIN is AASCOINInterface {
    ...
    */
    ...
    uint256 private constant BULK_MAX_VALUE = 100000000 * (10 ** 18);
    uint32  private constant BULK_MAX_COUNT = 100000;
