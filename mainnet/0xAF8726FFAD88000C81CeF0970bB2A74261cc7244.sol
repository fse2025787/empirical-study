...
//
//     __  ____            __              _      
//    /  |/  (_)___  ___  / /_____  ____  (_)___ _
//   / /|_/ / / __ \/ _ \/ __/ __ \/ __ \/ / __ `/
//  / /  / / / / / /  __/ /_/ /_/ / /_/ / / /_/ / 
// /_/  /_/_/_/ /_/\___/\__/\____/ .___/_/\__,_/  
//                              /_/               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xe8252dDE52021732EEA3C297A99d5fB3536F15bB,0x2307962b8E30aec64B92fe0DAdA7D687498FE0f2];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xe8252dDE52021732EEA3C297A99d5fB3536F15bB;
  uint256[] public payableFees = [5,3,92];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 1000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVGNCPsiuEcPsZmY4jyH5F6cRsfxggsoSg7TgZ7W7myjA/";
...
// File: contracts/MinetopiaContract.sol
//

pragma solidity ^0.8.0;

contract MinetopiaContract is RamppERC721A {
    constructor() RamppERC721A("Minetopia", "Miia"){}
}
