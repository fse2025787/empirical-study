...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function uri(uint256) public view virtual override returns (string memory) {
        return ERC1155Lib.getState()._uri;
    }
    ...
    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        ...
        return ERC1155Lib.getState()._balances[id][account];
    }
    ...
    function isApprovedForAll(address account, address operator) public view virtual override returns (bool) {
        return ERC1155Lib.getState()._operatorApprovals[account][operator];
    }
    ...
    function _safeTransferFrom(
        ...
        ERC1155Lib.state storage s = ERC1155Lib.getState();
    ...
    function _setURI(string memory newuri) internal virtual {
        ERC1155Lib.getState()._uri = newuri;
    }
    ...
    function _mint(
        ...
        ERC1155Lib.getState()._balances[id][to] += amount;
    ...
    function _setApprovalForAll(
        ...
        ERC1155Lib.getState()._operatorApprovals[owner][operator] = approved;
...
/**************************************************************\
 * ERC1155DiamondStorage authored by Sibling Labs
 * Version 0.1.0
 * 
...
library ERC1155Lib {
    bytes32 constant DIAMOND_STORAGE_POSITION = keccak256("erc1155.storage");
