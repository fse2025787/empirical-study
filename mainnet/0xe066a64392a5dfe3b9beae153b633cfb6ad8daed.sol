...
contract Smokinja is Context, IERC20, Ownable {
    ...
    string private constant _name = "Smokinja";
    string private constant _symbol = "SMOKINJA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x11298aa2Ec3CD8371509894EA6006fA02C6322B1);
        _feeAddrWallet2 = payable(0x11298aa2Ec3CD8371509894EA6006fA02C6322B1);
