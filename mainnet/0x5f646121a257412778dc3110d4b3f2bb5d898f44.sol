...
contract SkullIsland is Ownable, IERC721Receiver {
    ...
    // kaiju earn 10000 $Gamma per day
    ...
    // emergency rescue to allow unstaking without any checks but without $Gamma
    bool public rescueEnabled = false;

    constructor() {
        // Use top exchange addresses to get random number.  Balances change every second
    ...
    function _stakeKongs(address account, uint16 tokenId) internal {
        ...
        // If account already has some Kongs no need to push it to the tracker
    ...
    function updateKongOwnerAddressList(address account) internal {
        ...
        // Update the address list of holders, account unstaked all Kongs
