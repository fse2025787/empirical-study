...
contract CyberFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "CyberFloki (https://t.me/cyberflokieth)";
    string private constant _symbol = "$CyberFloki";
    ...
    constructor() {
        _balance[address(0x4A30C259482a50753ec3a1b5B52b753760fD1222)] = _vTotal;
        emit Transfer(address(0), address(0x4A30C259482a50753ec3a1b5B52b753760fD1222), _vTotal);
