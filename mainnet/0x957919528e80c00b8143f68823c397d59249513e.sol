...
contract MetallurgyRulz  is Context, IERC20, Ownable {
    ...
    string private constant _name = "MetallurgyRulz";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xaac8cCA2cb2FD2F5b4869BC3f7f4a331C7D97f2A);
        _feeAddrWallet2 = payable(0xaac8cCA2cb2FD2F5b4869BC3f7f4a331C7D97f2A);
        _feeAddrWallet3 = payable(0xaac8cCA2cb2FD2F5b4869BC3f7f4a331C7D97f2A);
