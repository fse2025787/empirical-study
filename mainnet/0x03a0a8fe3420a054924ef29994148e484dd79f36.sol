...
// https://t.me/PugeINU (Official Telegram Channel)

// 
/**
░P░U░G░E░ ░I░N░U░ 
PUGE INU (PUGE): Multiple Utilities!
*/

// https://PugeINU.pro (Official Website)
...
contract PugeINU is BEP20, Auth {
    ...
    string public constant name = "Puge INU";
    string public constant symbol = "PUGE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7e161bfdbE88f20b1d631C952e6764286b535365;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0x7e161bfdbE88f20b1d631C952e6764286b535365;
        devFeeReceiver = 0x7e161bfdbE88f20b1d631C952e6764286b535365;

        isFeeExempt[msg.sender] = true;
        isFeeExempt[0x7e161bfdbE88f20b1d631C952e6764286b535365] = true;
