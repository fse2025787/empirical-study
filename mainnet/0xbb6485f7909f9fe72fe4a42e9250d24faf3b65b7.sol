...
contract SayonaraLigmaJohnson is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Sayonara Ligma Johnson";
    string private constant _symbol = "GTFO";
    ...
    function _setTax(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
