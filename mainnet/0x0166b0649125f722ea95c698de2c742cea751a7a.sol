 ...
 * allowances. See {IERC20-approve}.
 */
contract THREETWOETHPROTOCOL is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "32 ETH PROTOCOL";
    string private _symbol = "32ETH";
    uint8 private _decimals = 18;
    uint256 private _supply = 1000000000;

    uint256 public buyTaxForLiquidity = 1;
    uint256 public buyTaxForMarketing = 97;
    uint256 public buyTaxForBurning = 1;
    uint256 public sellTaxForLiquidity = 1;
    uint256 public sellTaxForMarketing = 97;
    uint256 public sellTaxForBurning = 1;

    address public marketingWallet = 0x82F9eAd611a0cB66fFef42191bb8Fb73D85cAf0A;
    ...
    uint256 private _numTokensSellToAddToETH = 750000 * 10**_decimals;
    // TOKENOMICS END ============================================================>
