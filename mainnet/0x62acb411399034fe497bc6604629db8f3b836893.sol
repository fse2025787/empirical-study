...
// File: contracts/nibbioUSDStorage.sol

// 

pragma solidity ^0.6.0;

contract nibbioUSDStorage {
    ...
    string public constant name = "NibbioUSD";
    string public constant symbol = "NibbioUSD";
...
contract LibraryLock is nibbioUSDStorage {
...
contract nibbioUSD is nibbioUSDStorage, Context, IERC20, Proxiable, LibraryLock {	
