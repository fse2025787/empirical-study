...
contract FUD is ERC20, Ownable {
    ...
    constructor() ERC20("Fear Uncertainty Doubt", "FUD") {
     ...
     uint256 totalSupply = 5 * 10 ** 5 * 10 ** decimals();
        ...
        MarketingWallet = address(0x02BeDE741C406D1A9cC3093403328e60b071C699); // set as Marketing wallet
        DevWallet = address(0x02BeDE741C406D1A9cC3093403328e60b071C699); // set as dev wallet
