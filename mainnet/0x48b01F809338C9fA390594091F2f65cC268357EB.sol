...
// 
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Eyes", unicode"Head", unicode"Mouth", unicode"Nose", unicode"Goo", unicode"Background"];
        ...
        uint public allowListPrice = 0.0016 ether;
        uint public maxPerAllowList = 20;
        bool public isAllowListActive;

        ContractData public contractData = ContractData(unicode"Gloops", unicode"10000 on-chain Gloops", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/b5b17fbb-7e45-4caf-85a6-bf887b510477", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/b5b17fbb-7e45-4caf-85a6-bf887b510477", "", 600, "0xFD7612C1A485f59B6Cec9e4A2E5471Dbda3Be94A");

        constructor() ERC721A(unicode"Gloops", unicode"GLOOP") {
            TIERS[0] = [40,60,70,100,100,102,121,163,189,200,200,200,240,252,254,300,362,400,413,453,491,502,566,600,605,650,667,800,900];
TIERS[1] = [8,16,18,20,21,25,31,41,45,52,70,74,79,93,97,100,121,144,159,176,196,202,215,221,240,245,252,264,266,269,274,305,353,354,359,405,450,740,3000];
TIERS[2] = [37,146,173,197,206,213,227,345,348,403,420,462,467,617,618,678,745,1107,1264,1327];
TIERS[3] = [50,122,143,175,199,400,428,700,854,1129,1200,1500,3100];
TIERS[4] = [19,120,140,368,468,589,641,1140,1242,1250,1300,1311,1412];
TIERS[5] = [62,108,224,263,323,346,404,1000,1000,1000,1000,1000,1070,1100,1100];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Gloops #");
