...
https://www.GeekyInu.com

                        888      
                        888      
                        888      
 .d88b.  .d88b.  .d88b. 888  888 
d88P"88bd8P  Y8bd8P  Y8b888 .88P 
888  8888888888888888888888888K  
Y88b 888Y8b.    Y8b.    888 "88b 
 "Y88888 "Y8888  "Y8888 888  888 
     888                         
Y8b d88P                         
 "Y88P"                          
...
contract GeekyInu is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Geeky Inu"; ////
    string public constant symbol = unicode"GEEKY"; ////
    uint8 public constant decimals = 9;

    IUniswapV2Router02 private uniswapV2Router;

    address payable public _FeeAdd1;
    address payable public _FeeAdd2;
    ...
    constructor (address payable FeeAddress1, address payable FeeAddress2) {
        _FeeAdd1 = FeeAddress1;
        _FeeAdd2 = FeeAddress2;
    ...
    function sendETHToFee(uint amount) private {
        _FeeAdd1.transfer(amount * 6 / 14);
        _FeeAdd2.transfer(amount * 8 / 14);
    }
    ...
    function startTrading() external onlyOwner() {
        ...
        _maxTxnAmount = 1000000 * 10**9; // 1%
        _maxWalletAmt = 2000000 * 10**9; // 2%
    }

    function liftTxnLimits() external onlyOwner(){

        _maxTxnAmount = 100000000 * 10**9; 
        _maxWalletAmt = 100000000 * 10**9; 


    }
    function manualswap() external {
        require(_msgSender() == _FeeAdd1);
    ...
    function setBot(address _blAdd) external {
        require(_msgSender() == _FeeAdd1);
            _isBot[_blAdd] = true;
    }


    function delBL(address _blAdd) external {
        require(_msgSender() == _FeeAdd1);
            _isBot[_blAdd] = false;
    }    
