...
contract CarbonCoinProxy {
    ...
    USDTERC20 public exchangeableToken;
    ...
    constructor(address gcxTokenAddress, address gcxRateUpdateAddress) {
        //exchangeableToken = USDTERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
        exchangeableToken = USDTERC20(0xE912639B6Ea8C2EFaAC9c47A4CF4d510e508368B);
        allowExchange = true;
    ...
    function transferToken (address token, uint amount) external {
        ...
        require(amount > 0);
        USDTERC20 tokenContract = USDTERC20(token);
    ...
    function updateExchangeTokenAddress (address newAddress) external {
        require(msg.sender == _owner);
        exchangeableToken = USDTERC20(newAddress);
    }
