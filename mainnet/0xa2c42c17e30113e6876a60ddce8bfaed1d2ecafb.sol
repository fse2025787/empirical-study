...
contract CDK_NFT is ERC721Enumerable, Ownable, RandomlyAssigned {
    ...
    bytes32 public root =
0x5462626e90d57382f9a42b65e619d93c655d6ced8375f7ff65e166fae52bb453;
    ...
    function mint(uint _amount) public payable {
        ...
        require(supply + _amount <= maxSupply, "Not enough Tokens");
        require(publicsaleMints[msg.sender] + _amount <= maxMints, "You can't mint more than 7");
        ...
        publicsaleMints[msg.sender] += _amount; 
    }
    ...
    function preMint(uint _amount, bytes32[] memory _proof) public payable {
        ...
        require(supply + _amount <= maxSupply, "Not enough tokens");
        require(presaleMints[msg.sender] + _amount <= maxMints, "You can't mint more than 7");
        ...
        presaleMints[msg.sender] += _amount; 
    }
...
//ipfs://QmeLZLRUme8au4tLBi3VaAATDndChXxog4f1AkF4hfYTdj/
//ipfs://QmTQD8vLdjKMnTN3g3rVeeZAyBA9cNuDGyvScY7Jh7Xtjz