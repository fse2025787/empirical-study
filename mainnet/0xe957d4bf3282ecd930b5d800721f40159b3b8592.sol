...
//Status: Alive, Dead, Injury, Life Support
//Each will play a role within the game.
...
contract DYSTOPIANAPESnft is ERC721A, Owneable {

    string public baseURI = "ipfs://QmZr7qfeGHwGkirSMMYyRbJzk56VVsom1VetEKarkA47qF/";
    string public contractURI = "ipfs://QmU4xtdsbyhz5PvaXziPJiYaEvMvnD73Kvduiyy9Br2qK8";
    ...
    constructor() ERC721A("Dystopian Apes Official", "APES") {}

    function fight(uint256 _amount) external payable {
    ...
    function configFREE_MAX_SUPPLY(uint256 newFreesupply) public onlyOwner {
        ...
        function apedeath(uint256[] memory tokenids) external onlyOwner {
