...
contract PRT is ERC721Enumerable, Ownable {
    string public constant tokenName = "Phishing Rods";
    string public constant tokenSymbol = "PRT";
    bool public saleIsActive = false;
    uint256 public mintPrice = 0.029 ether;
    uint256 public MAX_PER_TX = 20;
    uint256 public MAX_SUPPLY = 6155;
    string public baseURI;
   

    constructor(string memory _baseURI) ERC721(tokenName, tokenSymbol) {
        baseURI = _baseURI;
    }
