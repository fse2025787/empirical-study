...
/**
 https://t.me/FLOKITAMAINU
 http://www.flokitamainu.com/
...
contract FLOKITAMAInu is IERC20, Context, ERC20Ownable {
    ...
    uint256 private _maxWalletSize = 3000000000000000 * 10**18;
    string private constant _name = "FLOKITAMA INU";
    string private constant _tick = "FLOKITAMA";
    ...
    constructor() {
        ...
        feeWallet = payable(0xe62aD3054c9E5343911bba1D5906fE92F191F580);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_limitBuys == true && from == pcsV2Pair) {
			require(amount <= 7500000000000000 * 10**18, "Limits are in place, please lower buying amount");
		}
