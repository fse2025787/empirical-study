...
/**
Happy Science | Truth, Meaning, and Happiness
*/
...
contract HappyScience is Context, IERC20, Ownable {
    ...
    string private _name = "Happy Science";
    string private _symbol = "HAPPYSCIENCE";
    ...
    function addBotWallets(address[] memory botWalletsList) public onlyOwner {
        for (uint256 i = 0; i < botWalletsList.length; i++) {
            botWallets[botWalletsList[i]] = true;
        }
    }
