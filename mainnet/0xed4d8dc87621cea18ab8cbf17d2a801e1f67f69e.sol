...
contract Saint is ERC20, Ownable {
    ...
    constructor() ERC20( "Saint", "SANTAMA") {
        ...
        operationsAddress = address(0x620209Bed12a41CaE05BDD269e39eEC5C6CDCbBa); // change this address to wallet u want for operations   
        TaxAddress = address(0x2627Be89e54A88307faB35D94a9b12BcfCC69036);  // change this address to the one for tax 
