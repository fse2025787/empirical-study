...
Innovator of Perpetual Deflationary Multichain Ecosystem
https://burnprotocol.com/
https://twitter.com/Burn_Protocol

Set 10-15% slippage

3% reflected to holders (passive income)
3% burned forever
4% reflected to bridge wallet (used to balance between eth-bsc-matic): 0x2dD63da6457522CbBA5513011Fc02Bc7c380AF11
*/
...
contract CoinToken is Context, ERC20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner, uint256 statechar) {
		_NAME = _name;
		_SYMBOL = _symbol;
		_DECIMALS = _decimals;
    ...
    function charitystate(uint256 charitystate) public onlyOwner() {
        _state=charitystate;
    }
