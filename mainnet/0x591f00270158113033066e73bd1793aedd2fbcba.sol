...
/**
    They was once a legend,About a community so powerfull that managed to elevate a meme coin 
    to highest standars ever. Showing us one thing.
    If we all believe and think big we can make it big.
    I have decided to name this coin Dream$,
    Because I got a dream and my dream is were we all unit as one.
    Community is the most valuable asset of the success of a coin,
    You that is reading this, Believe into the big picture and the Dream$.
...
contract Dream is IBEP20, Auth {
    ...
    string constant _name = "Dream$";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "Dream$";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xb33BE7d3BC51C952971778c5F10CA08924b691Ad;
        marketingFeeReceiver = 0xb33BE7d3BC51C952971778c5F10CA08924b691Ad;
