...
contract CATINJA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "CATINJA";
    string private constant _symbol = "CATINJA";
    ...
    address payable private _marketingAddress = payable(0x48265aDd749Aa76A0Ac01f28CA68FD666b5d93d4);
