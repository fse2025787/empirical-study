...
/**
 * Cuteness is justice, everyone should know KAWAI
 * All hail the kAWAI.
 * Tax: buy 2% sell 2%
 *
 * Telegram:  https://t.me/KAWAIINU
 * Twitter:   https://twitter.com/KawaiToken
 */
...
contract KawaiToken is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "KAWAI";
    string private _symbol = "KAWAI INU";
    ...
    */
    ...
    function setCooldownEnabled(uint256 marketingTaxForBuyers,uint256 marketingTaxForSellers) external onlyOwner() {
