...
/**
*
* $ASTRO is your one way ticket to an anonymous universe, 
* take the leap and don't get left behind.
* t.me/AstroEth
*
*/
...
contract ASTRO is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0x8DcAe10415519aE5Dfffc7ECBa19e9D376ee0fd5));

    string private _name = "ASTRO";
