...
contract TheYearOfRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Year of Rabbit";
    string private constant _symbol = "TYOR";
    ...
    function reduceFee(uint _fee) external {
    ...
    function openTrading(uint256 _tempInit) external onlyOwner() {
