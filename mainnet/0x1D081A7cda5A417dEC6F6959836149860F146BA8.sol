...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF3b5f8eBF06862C40218D1605B1be5E1847d4a39];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1000, 6969 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYtYsDAPhTAasJS43d35qbu5oYyaGBX4nAyJeayZLq96v/";
...
// File: contracts/kevifuruNftContract.sol
//

pragma solidity ^0.8.0;

contract KevifuruNftContract is RamppERC721A {
    constructor() RamppERC721A("Kevifuru NFT", "KEVFURU"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gDDcQ21w2F9L4eTP0qS0/contract-metadata";
    }
}