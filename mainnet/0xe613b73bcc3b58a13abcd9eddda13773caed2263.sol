...
No Telegram, No Twitter, All Taxes go into burning SHI!
15/35 >>>>>>>>>>  0/6 
...
contract SHIBURN is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 2 * 10**7 * 10**18; 
    uint256 public maxSellAmount = 2 * 10**7 * 10**18; 
    uint256 public maxWalletAmount = 4 * 10**7 * 10**18; 
    ...
    address payable devWallet = payable(address(0xA6828035a35Ff38f275cFE83EDC3FC912a3E91F4)); 
    ...
    constructor() ERC20("SHIBURN", "SHI-BURN") {
   ...
   function enableTrading() external onlyOwner {
    ...
    function setSellFee(
        ...
        require (totalSellFee <= 35, "Max sell fees limit is 35%");
    }
    ...
    function setMaxWallet(uint256 amount) external onlyOwner {
        require(amount > 40000000, "Can't set lower amount, No rugPull");
    ...
    function setMaxSellAmount(uint256 amount) external onlyOwner {
        require(amount >= 200000000, "Can't set lower amount, No rugPull");
