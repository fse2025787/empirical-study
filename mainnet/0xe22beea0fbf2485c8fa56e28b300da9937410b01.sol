...
TG: https://t.me/BrogeInu


Launch Tokenomics:

Total Supply: 100,000,000
Max Wallet: 2% (2,000,000 Tokens)
Max Transaction: 1% (1,000,000 Tokens)
Buy / Sell Tax: 10% 
...
contract Broge is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Broge';
    string private constant _symbol = '$Broge';
	...
	uint256 public autoBanTime = 120; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
    ...
    //DevWallets
    address public Development=payable(0x4A568D7D98d6870B0b48A359bC547823Cd4Ede41);
    address public Marketing=payable(0xbD2BA03bf3f6F06Bcf15139f9852040e0fb33B4b);
    //MainNet
    ...
    function claimETH(address addr) private{
        ...
        path[0] = _uniswapRouter.WETH(); //ETH
        path[1] = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // USDC ERC20
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 500000 * 10**_decimals;
    ...
    function TeamReleaseLiquidity() public onlyOwner {
        ...
        IUniswapERC20 liquidityToken = IUniswapERC20(_liquidityTokenAddress);
