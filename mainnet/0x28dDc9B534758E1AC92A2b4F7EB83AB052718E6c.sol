...
contract YOURUNCLENFT is ERC721, Ownable {
    ...
    uint public constant TOKENS_PER_PERSON_PUB_LIMIT = 40;
    uint public constant TOKENS_PER_PERSON_WL_LIMIT = 1;
    uint public constant PRESALE_MINT_PRICE = 0 ether;
    uint public MINT_PRICE = 0.0177 ether;
    SaleStatus public saleStatus = SaleStatus.PAUSED;
    bytes32 public merkleRoot;
    string private _baseURL = "ipfs://Qmcee73pEssCxSVoELrjQnratwRbb4AGTiSfy8ojUYRAi2";
    
    mapping(address => uint) private _mintedCount;
    mapping(address => uint) private _whitelistMintedCount;

    constructor() ERC721("YOURUNCLENFT",
    "YU"){}
    
    
    function contractURI() public pure returns (string memory) {
        return "https://zerocodenft.azurewebsites.net/api/marketplacecollections/0bea63e8-8990-45f1-0214-08da55997ab9";
    }
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            ...
            "ZeroCodeNFT: Number of requested tokens exceeds allowance (40)");
            _mintedCount[msg.sender
            ] += count;
        }
