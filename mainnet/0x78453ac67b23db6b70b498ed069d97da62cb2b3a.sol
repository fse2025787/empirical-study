...
https://t.me/akani_erc

www.twitter.com/akani_erc
...
contract AKANI is Context,IERC20, Ownable{
using Address for address;
string private _name = "AKANI";
string private _symbol = "AKANI";
...
address _owner;
address payable public marketingAddress = payable(0x88EA9fc2152aBA05ec5b0389CF3F2aa82D153F1b);
...
uint256 AKANICOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
   require(block.timestamp > AKANICOINDaycooldown, "You cant call AKANICOINCoinDay more than once a day");
   buyPrevmktFee = buymktFee;
   buyprevLiqFee = buyliqFee;
   buyliqFee = 0;
   buymktFee = 0;
}
function AKANICOINCoinDayOver() public onlyOwner{
   buyliqFee = buyprevLiqFee;
   buymktFee = buyPrevmktFee;
   AKANICOINDaycooldown = block.timestamp + 86400;
}
