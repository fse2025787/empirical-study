...
contract WrappedFidenza is ERC721Burnable {

    address public COLLECTION = 0xa7d8d9ef8D8Ce8992Df33D8b8CF4Aebabd5bD270;
    ...
    constructor() ERC721("Wrapped Fidenza by Tyler Hobbs", "FIDENZA") {}

    
    function safeWrap(uint256 tokenId) external {
        // Fidenza tokenId range
        require(78000000 <= tokenId && tokenId <= 78000998, "FIDENZA: invalid tokenId");
