...
contract APCGPaused is Ownable {
...
contract PausableToken is StandardToken, APCGPaused {
...
contract APCGToken is PausableToken {
    string public constant name = "ALL Pay Coin";
    string public constant symbol = "APCG";
