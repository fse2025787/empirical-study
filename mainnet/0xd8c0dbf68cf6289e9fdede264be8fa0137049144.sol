...
contract PDK is ERC20, Ownable {
    ...
    constructor() ERC20("Please Die Kabosu", "PDK") 
    {
        ...
        uniswapV2Pair = IUniswapV2Pair(uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH()));
                                      ...
                                      //taxWallets
        taxWallets["liquidity"] = address(0x2eCDd0C1E6C9f0BD207CCe03dA61F52647Fdc41B);
        taxWallets["marketing"] = address(0xA5D972F09679b2223a1d1Fab42928Fc901dF0012);
        taxWallets["charity"] = address(0x3df2eF1Bb45E39d0D7E43da9b0FEacEd65C3c493);
        taxWallets["burn"] = address(0xdead);
                                     
                                //taxes
        setBuyTax(10,20,15,20); // 1% burn, 1.5% marketing, 1% LP, 1.5% charity
        setSellTax(10,20,15,20); //1% burn, 1.5% marketing, 1% LP, 1.5% charity
        exclude(msg.sender);
        exclude(address(this));

                                 //Limits
        maxBuyPerTx = maxSupply*2/100; // 2% of the supply
        maxSellPerTx = maxSupply*2/100;  // 2% of the supply
        maxWallet = maxSupply*2/100 ; // 1% of the supply
   ...
   /**
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "PDK: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "PDK: Account is not excluded");
