...
/**
* Telegram : https://t.me/aicoentry
* Website  : https://aicotoken.com/
* 
* Describe the type of token you would like to launch, and our AI will give you custom code fitting your criteria.
* Taxes, tokenomics , name, and other features . We believe this will be revolutoinary and will make launching a project as easy as having your own website.
* You can view this as the WIX , or WordPress of WEB3
*/
...
contract AICO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Artificial Intelligence Crypto", "AICO") {
        ...
        marketingWallet = address(0x998C8b1991029BEF77EA69a7fcCdDe6E636D1D84);
    ...
    function swapTrading(uint256 blocks) external onlyOwner {
        isTrading = true;
        swapEnabled = true;
        taxTill = block.number + blocks;
    }
