...
contract Shibata is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "SHIBATA";
    string private _symbol = "SHIBATA";
    ...
    constructor () {
        ...
        _FeeETH = payable(address(0x475B4B45A1b438AC75Db788a2A8CfA71fFaf73a7));
