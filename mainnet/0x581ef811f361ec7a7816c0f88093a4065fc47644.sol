...
contract SAKURA is Ownable, ERC20 {
    uint256 private _numTokensSellToAddToSwap = 100000 * (10**decimals());
    bool inSwapAndLiquify;

    // 1% buy/sell tax
    uint256 public constant buySellLiquidityTax = 1;
    uint256 public constant sellDevelopmentTax = 2;
    address public developmentWallet =
        0xB7510ad3336d4fB93a5642E8A5934dEd543De48C;
     ...
     * construction.
     */
    constructor() ERC20("SAKURA", "HANA") {
        _mint(msg.sender, (35035001 * 10**decimals()));
