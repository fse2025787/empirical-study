...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664330400;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiahxuo2ls6webrgbqenlpt7j37kkpphfts33myej2d2aighpp5yii/";
...
// File: contracts/SabotageContract.sol
//

pragma solidity ^0.8.0;

contract SabotageContract is RamppERC721A {
    constructor() RamppERC721A("Sabotage", "Flood"){}
}
