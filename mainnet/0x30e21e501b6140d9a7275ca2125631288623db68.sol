...
/*
                                     ...
                                     :???????????JGBBBBBBBBBBG~                                     
                                    ~?????????????GBBBBBBBBBBBB?                                    
                                  .!J?????????JJYP##BBBBBBBBBBBBY.                                  
                                 :7???????JY5PGGBB&&&&##BBBBBBBBBP^                                 
                                ^????JY5PGGBBBBGGB&&&&&&&&&##BBBBBB7                                
                              .!JY5PGGBBBBGGGGGGGB&&&&&&&&&&&&&###B#Y.                              
                              ~YGBBBBGGGGGGGGGGGGB&&&&&&&&&&&&&&&&&#G!                              
                                :!JPGBBBGGGGGGGGGB&&&&&&&&&&&&&&B57:                                
                              .^.   ^7YGBBBBGGGGGB&&&&&&&&&&#P?^   :~:                              
                               :77~:   .~?5GBBBGGB&&&&&&#GJ~.  .~?5Y^                               
                                 ~?J?!^.   :!JPBBB&&&B57:   ^7YPBG7                                 
                                  .!JJJ?7!^.   ^75P?^   .!JPGBBBY:                                  
...
contract HALFETH is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HALF ETHEREUM";
    string private constant _symbol = "ETH0.5";
    ...
    address payable private _developmentAddress = payable(0x92F6C92899A42B5d2f69076e68089aBA3b1C852B); 
    address payable private _marketingAddress = payable(0x92F6C92899A42B5d2f69076e68089aBA3b1C852B);
