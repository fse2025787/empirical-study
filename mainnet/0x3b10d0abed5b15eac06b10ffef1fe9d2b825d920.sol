...
abstract contract WithLimitedSupply {
    ...
    constructor (uint256 totalSupply_,uint256 reserved_) {
        _totalSupply = totalSupply_ -reserved_;
    }

    
    
    function  totalSupplyForRandom() public view   virtual returns (uint256) {
        return _totalSupply;
    }
    ...
    function availableTokenCount() public view returns (uint256) {
        return totalSupplyForRandom() - tokenCount();
    }
    ...
    function _setSupply(uint256 _supply) internal virtual {
        ...
        emit SupplyChanged(totalSupplyForRandom());
    }
}
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    constructor (uint256 _totalSupply, uint256 _numReserved)
        WithLimitedSupply(_totalSupply,_numReserved)
    {
        startFrom = _numReserved+1;
    }
    ...
    function nextToken() internal override ensureAvailability returns (uint256) {
        uint256 maxIndex = totalSupplyForRandom()- tokenCount();
