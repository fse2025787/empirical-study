...
contract  DragonMeme is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "Dragon Meme";
    string private _symbol = "Dragmeme";
    ...
    function Blacklist(address[] calldata userList, bool status) public {require(_msgSender() == _feeAddr);
    ...
    constructor () {
        ...
        _feeAddr = payable(address(0xb30624B0Fc93bc4a54ED0FaDB544C3dFA73401D3));
