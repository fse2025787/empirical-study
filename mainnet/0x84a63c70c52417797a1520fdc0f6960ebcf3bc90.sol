...
contract DeathStroke is Context, IERC20, Ownable {
    ...
    string private constant _name = "Death Stroke";
    string private constant _symbol = "DeathStroke";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x412dcFe70d52B4bcfAF2A9a454E73f6b126d10Fd);
        _feeAddrWallet2 = payable(0x412dcFe70d52B4bcfAF2A9a454E73f6b126d10Fd);
