...
███ ▄█▄ ███   ███    ███ ███   ███        ███    ███   ███    ███   ███    ███     ███       ███    ███   
 ▀███▀███▀    ██████████  ▀█   █▀         ██████████   ███    █▀    ███    ███    ▄████▀     ███    █▀    
                                   ...
                                   Twitter  : https://twitter.com/wenearthportal
                                   Website  : https://wen-earth.com
                                   Telegram : https://t.me/wenearthportal
...
contract ESCAPE is Context, IERC20, Ownable {
    ...
    string private _name = "Wen Earth";
    ...
    address public marketingTokenFeeWallet = 0x433ED6441BF1232657Fb4DD5E9871211DA7a38C1;
    address public marketingETHFeeWallet = 0x433ED6441BF1232657Fb4DD5E9871211DA7a38C1;
    ...
    uint256 public _maxTxAmount = 2 * 10**10 * 10**9;// 1% max tx amount
    uint256 public _maxWallet = 3 * 10**10 * 10**9;// 2% max wallet
    uint256 private _numTokensSwapToETHForMarketing = 1 * 10**8 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 1 * 10**13 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
