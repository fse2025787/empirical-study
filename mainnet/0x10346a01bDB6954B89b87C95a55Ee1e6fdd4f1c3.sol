...
/*
Token Name: Dame Tu Cosita Pulse
Symbol: Pulse Popoy
Supply: 1,000,000

Tax: 2/2 buy/sell

Telegram: https://t.me/pulsepopoy
...
contract PulsePopoy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromMaxWalletSize;
    string private constant _name = "Dame Tu Cosita Pulse";
    string private constant _symbol = "Pulse Popoy";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x409924fDD50F6CDa95fE6E18F474Dd004C9b11F9); 
