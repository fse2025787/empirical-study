...
🔮Project Oracle
"Oracle" is the latest ERC20 based utility project. 
It builds with AI algorithms that can detect which wallets are likely to become hot-spots for future trading and will predict a wallet's projected accuracy as a source of information when it comes to estimating future markets.
 
https://t.me/ProjectOracle
http://projectoracle.space/
https://twitter.com/OracleERC
...
contract ORACLE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2C955A050985649ED7A0d949a2276056B3c15E0a); 
    address payable public Wallet_Dev = payable(0x2C955A050985649ED7A0d949a2276056B3c15E0a);
    ...
    string private constant _name = "Project Oracle"; 
    ...
    constructor () {
        ...
        _owner = 0x2C955A050985649ED7A0d949a2276056B3c15E0a;
