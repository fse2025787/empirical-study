...
// Main Contract Logic 
// --------------------------------------------------------------
contract SheekaInu is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Sheeka Inu";
    string private _symbol = "SHEEKA";
    ...
    address payable public operationsWallet2 =  payable(owner());
