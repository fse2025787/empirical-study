...
contract WRAPPEDTSUKA is ERC20, Ownable {
    ...
    constructor () Ownable(msg.sender) {
        ...
        maxWalletPercentage = 5; maxWalletAmount = _totalSupply /1000 * maxWalletPercentage;
    ...
    function ownerSetLimits(uint256 _maxBuyPercentage, uint256 _maxSellPercentage, uint256 _maxWalletPercentage) external onlyOwner {
        maxBuyPercentage = _maxBuyPercentage;           maxBuyAmount = _totalSupply /1000 * maxBuyPercentage;
        maxSellPercentage = _maxSellPercentage;         maxSellAmount = _totalSupply /1000 * maxSellPercentage;
        maxWalletPercentage= _maxWalletPercentage;      maxWalletAmount = _totalSupply /1000 * maxWalletPercentage;
    }
