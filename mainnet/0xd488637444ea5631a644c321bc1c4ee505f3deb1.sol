...
contract TFA is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 4950;
	uint256 public RESERVED_NFT = 50;
	
	uint256 public MAX_MINT_PRESALE = 3;
	uint256 public MAX_MINT_SALE = 4950;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 3;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 4950;
	
	uint256 public PRESALE_PRICE = 0.09 ether;
	uint256 public SALE_PRICE = 0.09 ether;
    ...
    constructor() ERC721P("The First Arabs", "TFA") {}
	
    function _baseURI() internal view virtual returns (string memory) {
        return baseURI;
    }
	
	function mintReservedNFT(address _to, uint256 _count) external onlyOwner nonReentrant{
