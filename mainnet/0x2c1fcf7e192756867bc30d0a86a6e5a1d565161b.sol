...
// .S_sSSs     .S       S.     sSSs    sSSs        sdSS_SSSSSSbs   .S    S.     sSSs         .S_SsS_S.    .S_SSSs      sSSSSs   .S    sSSs         .S_sSSs     .S_sSSs     .S_SSSs      sSSSSs    sSSs_sSSs     .S_sSSs    
//.SS~YS%%b   .SS       SS.   d%%SP   d%%SP        YSSS~S%SSSSSP  .SS    SS.   d%%SP        .SS~S*S~SS.  .SS~SSSSS    d%%%%SP  .SS   d%%SP        .SS~YS%%b   .SS~YS%%b   .SS~SSSSS    d%%%%SP   d%%SP~YS%%b   .SS~YS%%b   
//S%S   `S%b  S%S       S%S  d%S'    d%S'               S%S       S%S    S%S  d%S'          S%S `Y' S%S  S%S   SSSS  d%S'      S%S  d%S'          S%S   `S%b  S%S   `S%b  S%S   SSSS  d%S'      d%S'     `S%b  S%S   `S%b  
//S%S    S%S  S%S       S%S  S%S     S%S                S%S       S%S    S%S  S%S           S%S     S%S  S%S    S%S  S%S       S%S  S%S           S%S    S%S  S%S    S%S  S%S    S%S  S%S       S%S       S%S  S%S    S%S  
//S%S    d*S  S&S       S&S  S&S     S&S                S&S       S%S SSSS%S  S&S           S%S     S%S  S%S SSSS%S  S&S       S&S  S&S           S%S    S&S  S%S    d*S  S%S SSSS%S  S&S       S&S       S&S  S%S    S&S  
//S&S   .S*S  S&S       S&S  S&S_Ss  S&S_Ss             S&S       S&S  SSS&S  S&S_Ss        S&S     S&S  S&S  SSS%S  S&S       S&S  S&S           S&S    S&S  S&S   .S*S  S&S  SSS%S  S&S       S&S       S&S  S&S    S&S  
//S&S_sdSSS   S&S       S&S  S&S~SP  S&S~SP             S&S       S&S    S&S  S&S~SP        S&S     S&S  S&S    S&S  S&S       S&S  S&S           S&S    S&S  S&S_sdSSS   S&S    S&S  S&S       S&S       S&S  S&S    S&S  
//S&S~YSSY    S&S       S&S  S&S     S&S                S&S       S&S    S&S  S&S           S&S     S&S  S&S    S&S  S&S sSSs  S&S  S&S           S&S    S&S  S&S~YSY%b   S&S    S&S  S&S sSSs  S&S       S&S  S&S    S&S  
//S*S         S*b       d*S  S*b     S*b                S*S       S*S    S*S  S*b           S*S     S*S  S*S    S&S  S*b `S%%  S*S  S*b           S*S    d*S  S*S   `S%b  S*S    S&S  S*b `S%%  S*b       d*S  S*S    S*S  
//S*S         S*S.     .S*S  S*S     S*S                S*S       S*S    S*S  S*S.          S*S     S*S  S*S    S*S  S*S   S%  S*S  S*S.          S*S   .S*S  S*S    S%S  S*S    S*S  S*S   S%  S*S.     .S*S  S*S    S*S  
//S*S          SSSbs_sdSSS   S*S     S*S                S*S       S*S    S*S   SSSbs        S*S     S*S  S*S    S*S   SS_sSSS  S*S   SSSbs        S*S_sdSSS   S*S    S&S  S*S    S*S   SS_sSSS   SSSbs_sdSSS   S*S    S*S  
//S*S           YSSP~YSSY    S*S     S*S                S*S       SSS    S*S    YSSP        SSS     S*S  SSS    S*S    Y~YSSY  S*S    YSSP        SSS~YSSY    S*S    SSS  SSS    S*S    Y~YSSY    YSSP~YSSY    S*S    SSS  
//SP                         SP      SP                 SP               SP                         SP          SP             SP                             SP                 SP                            SP          
//Y                          Y       Y                  Y                Y                          Y           Y              Y                              Y                  Y                             Y           
                                                                                                                                                                                                                         
  /**
     *https://twitter.com/puffthegas420
     *https://t.me/PufftheMagicDragonETH
     */
// 
...
contract PufftheMagicDragon is ERC20, Ownable {
    ...
    uint16 public buyLiquidityFee = 15;
    uint16 public buyMarketingFee = 25;
    ...
    constructor() ERC20("Puff The Magic Dragon", "PUFF") {
        _mint(msg.sender, 69e9 * 10 ** decimals());
        maxWallet = (69e9 * 10 ** decimals() * 2) / 100; // 2% of total supply

        marketingFeeAddress = payable(
            0x111b612c834A948A292A08D34091b1Ba4846BccE
        );
        ...
        isExcludedFromMaxWallet[routerAddress] = true;
        isExcludedFromMaxWallet[uniswapPair] = true;
    ...
    function setMaxWallet(uint256 _maxWallet) external onlyOwner {
        require(
            ...
            "Max wallet must be greater than 0.1%"
        );
    ...
    function addBlacklist(address wallet) external onlyOwner {
        require(!blacklisted[wallet], "Wallet already blacklisted");
        blacklisted[wallet] = true;
    }

    function removeBlacklist(address wallet) external onlyOwner {
        require(blacklisted[wallet], "Wallet not blacklisted");
    ...
    function updateMinLpBeforeSwapping(
        uint256 minLpBeforeSwapping_
    ) external onlyOwner {
    ...
    function updateBuyFee(
        ...
        require(
            _buyLiquidityFee + _buyMarketingFee <= maxFeeLimit,
    ...
    function updateSellFee(
        ...
        require(
            _sellLiquidityFee + _sellMarketingFee <= maxFeeLimit,
            "Must keep fees <= 30%"
        );
    }
    ...
    function updateTransferFee(
        ...
        require(
            _transferLiquidityFee + _transferMarketingFee <= maxFeeLimit,
            "Must keep fees <= 30%"
        );
    }
    ...
    function _transfer(
        ...
        require(!blacklisted[from] && !blacklisted[to], "Bot wallet");
        ...
        if (!isExcludedFromMaxWallet[to] && !automatedMarketMakerPairs[to]) {
            require(
        ...
        uint256 _transferAmount = amount - _liquidityFee - _marketingFee;
    ...
    function takeFee(uint256 contractBalance) private lockTheSwap {
        ...
        uint lpPart = (contractBalance * _liquidityTokensToSwap) /
            totalTokensTaken;
        uint256 marketingPart = (contractBalance * _marketingFeeTokensToSwap) /
            totalTokensTaken;
        uint256 tokensForLiquidity = lpPart / 2;
        uint256 initialETHBalance = address(this).balance;
        uint256 toSwap = tokensForLiquidity + marketingPart;
        swapTokensForETH(toSwap);
        uint256 ethBalance = address(this).balance - initialETHBalance;

        uint256 ethForMarketing = (ethBalance * marketingPart) / toSwap;
