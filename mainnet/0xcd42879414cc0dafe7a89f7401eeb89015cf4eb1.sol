...
//   1320 Phantomz ghosting  the Ethereum blockchain.
//   cost: 0.0032
//   max Mint Amount Per Tx : 6 Dont be Greedy :D 
...
contract ThePhantomz is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://Qme8eh4J6q958yRupFJ4j3qP26vEEUS7FQD3S2uPBgpfy7/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.0032 ether;
  uint256 public maxSupply = 1320;
  uint256 public maxMintAmountPerTx = 6;

  bool public paused = false;
  bool public revealed = true;

  constructor() ERC721("The Phantomz", "PHTZ") {
