...
contract ATH is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 4000000* 10**9; // 
    uint256 private constant TaxSwapAmount = 1000000 * 10**9; //
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x6ac2925091d1d11e04ec80E403d9390eF4b445AD).transfer(ethToSend); //marketing wallet
    }
