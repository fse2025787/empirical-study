...
contract FifaBetsInu is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0x8F1240fb6dFb2699e530e8E9e08e1dF6A6d47f8a);
    ...
    uint256 private percentForLPBurn = 50; // 25 = .25%
    bool public lpBurnEnabled = true;
    uint256 private lpBurnFrequency = 7200 seconds;
    ...
    constructor() ERC20("Fifa Bets Inu", "FBI") {
    ...
    function setFIFAModifier(address account, bool onOrOff) external onlyOwner {
