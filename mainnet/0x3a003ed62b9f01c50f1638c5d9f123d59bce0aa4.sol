...
Okay Good Luck Erc20

I’m heart broken guys

My boyfriend had left me.

I Hate You David

“Getting your heart broken wasn't something you wanted to happen, but here you are. No matter when it happened, or how it happened, you're allowed to wallow. It takes time to heal, 
and there's nothing wrong with putting on a sad song and pretending you're in a music video while the tears just flow. We've all been there.”

Okay, just good luck and please don’t do this again to someone

Symbol:  $BYE
Supply: 100,000,000 $BYE
Tax: 4% both buy and sell


Tg: https://t.me/okaygoodluck 
Website: as soon as possible after I get new boyfriend.
...
contract OKAYGOODLUCK is Context, IERC20, Ownable {
    ...
    string private _name = "OKAY GOOD LUCK";
    string private _symbol = "$BYE";
    ...
    address payable public marketingaddress = payable(0xABA6D0578A3891bf7f7eAA9Ab3c59fFfea80d8B3);

    uint256 public _MarketingFeeBuy = 4;
    uint256 public _LiquidityFeeBuy = 0;

    uint256 public _MarketingFeeSell = 4;
