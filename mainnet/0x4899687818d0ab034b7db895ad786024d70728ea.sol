...
contract CallOfMeta is ERC721A, Ownable {
    using Strings for uint256;
    
    uint256 public MAX_SUPPLY = 10000;

    address private PAYMENT_WALLET = address(0x6B9D2ddAe008704f022EdcEEF7AC9016c5A8cB5B);
    ...
    uint256 public WHITELIST_COST = 0.4 ether;

    bool public PAUSED = true;
    bool public ENABLE_WHITELIST_SALE = false;

    mapping(address => uint256) private MAPPING_WHITELIST_MINT;
    address private POOL_WALLET;
    constructor() ERC721A("Call of Meta", "COM") {
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) public payable {
        ...
        uint256 poolAmount = msg.value / 20;
        payable(POOL_WALLET).transfer(poolAmount);
        payable(PAYMENT_WALLET).transfer(msg.value - poolAmount);
