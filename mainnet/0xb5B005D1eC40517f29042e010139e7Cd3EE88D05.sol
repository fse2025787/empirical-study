...
contract DegenVitalikButerin   is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Degen Vitalik Buterin";
    string private constant _symbol = "$DVB";
    ...
    address payable private _developmentAddress = payable(0x549e6a0694c93F30F1c70c959d7E3eB7CF502b9D); 
    address payable private _marketingAddress = payable(0x549e6a0694c93F30F1c70c959d7E3eB7CF502b9D);
