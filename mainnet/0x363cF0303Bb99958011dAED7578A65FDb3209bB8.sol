...
/*
* @title ERC721 token for Club FOMO - Legendary VIP
*
* @author OUAILTAYARTH - RLG
*/
...
// File: contracts/ERC721A/ClubFomoVIP.sol
...
contract ClubFOMOVIP is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard{
    ...
    uint256 public constant PRICE = 13.85 ether;

    /* Extention to complete the metadata */
    string public baseExtension = ".json";

    /* To add Reveal metadata */
    string private baseURI;

    /* To add unrevealed metadata */
    string public notRevealedURI;

    /* Return of the status of reveal is true or false */
    bool public isRevealed;

    /* Toggle reveal */
    bool public revealed = false;

    /* The length of the _teamShares addresses */
    ...
    constructor(
        ...
        string memory _notRevealedURI) ERC721A("Club FOMO - Legendary VIP", "CLBFOMOVIP")
    ...
    modifier callerIsUser() {
        require(tx.origin == msg.sender, "Club Fomo :: Cannot be called by a contract");
        _;
    }


    /**
    * @notice To Mint CLUB FOMO NFT
    *
    ...
    **/ 
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "Club Fomo :: Beyond Max Supply");
        require(msg.value >= (PRICE * _quantity), "Club Fomo :: Not enough funds ");
    ...
    *
    * @param _maxSupply The new maxSupply value
    **/
    ...
    **/
    ...
    /**
    * @notice Allows The owner to release funds
    **/
    ...
    /**
    * @notice Revert if the user send user to the contract 
    **/ 
