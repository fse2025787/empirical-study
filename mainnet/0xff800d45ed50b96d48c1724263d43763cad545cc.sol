...
contract ProtectorOfBDS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Black Dragon Protector";
    string private constant _symbol = unicode"BDP";
