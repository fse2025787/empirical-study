...
abstract contract MultiStage {
    ...
    // royalty per stage
    mapping(uint256 => RoyaltyEntry) internal _royalty;
    ...
    function royalty(uint256 stageId)
        external
        view
        returns (RoyaltyEntry memory)
    {
        return _royalty[stageId];
    }

    function _setStageRoyalty(
        uint256 stageId,
        address receiver,
        uint96 feeNumerator,
        bool active
