...
Lets join the ride with our (Space) Shuttle Inu! We are about to leave to the moon! Where we belong ofcourse!

Website: https://shuttleinu.com/
TG: https://t.me/shuttleinu
Twitter: https://mobile.twitter.com/InuShuttle
...
contract ShuttleInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Shuttle Inu";
