...
contract GalaxyGreyInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Galaxy Grey Inu";
    string private constant _symbol = unicode"GHOUND";
