...
_____                            __  __                                 
/\__  _\                          /\ \/\ \                                
\/_/\ \/     ___   __  __         \ \ \ \ \     __   _ __   ____     __   
   \ \ \   /' _ `\/\ \/\ \  _______\ \ \ \ \  /'__`\/\`'__\/',__\  /'__`\ 
    \_\ \__/\ \/\ \ \ \_\ \/\______\\ \ \_/ \/\  __/\ \ \//\__, `\/\  __/ 
    /\_____\ \_\ \_\ \____/\/______/ \ `\___/\ \____\\ \_\\/\____/\ \____\
    \/_____/\/_/\/_/\/___/            `\/__/  \/____/ \/_/ \/___/  \/____/
...
$BONE is the governance token of the Inu-Verse platform. 
Built on the Ethereum, $BONE is an ERC20 token with numbers of impressive features.
We aim to cement the Inu-Verse ecosystem as the first and most revolutionary project 
to bridge the utility of a blockchain token with Games and NFTs that directly contribute back into the tokens price floor.

🔥 Social links:
Website: https://inu-verse.io
TG Chat: https://t.me/talesofinuverse
Twitter: https://twitter.com/inu_verse
...
contract TalesOfInuVerse is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 10000000000 * 10 ** 18;

    constructor () ERC20('Inu-Verse', unicode'BONE') {
