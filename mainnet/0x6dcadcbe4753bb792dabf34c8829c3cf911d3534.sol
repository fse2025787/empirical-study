...
contract AkumuSerpents is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.0015 ether;
  uint public          maxPerTx          = 7;
  uint public          maxFreePerWallet  = 7;
  uint public          totalFree         = 77;
  uint public          maxSupply         = 777;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Akumu Serpents", "AKS"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Serpents...");
