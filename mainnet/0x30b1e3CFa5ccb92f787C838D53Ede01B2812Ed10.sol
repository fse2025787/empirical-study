...
Patience is very important. The strong are the patient ones,
Anjin-san. patience means holding back your inclination to the seven emotions:
hate, adoration, joy, anxiety, anger, grief, fear. If you don't give way to the seven, 
you're patient, then you'll soon understand all manner of things and be in harmony with Eternity.”

*/

//https://medium.com/@hachimuraETH/
...
contract HACHIMURA is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9f5E3Ed6B513BadfC61519145Bb32Beed1210d25;

    string private _name = "The Shogun";
    string private _symbol = "HACHIMURA";
