...
contract Sizuki is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmW6i9u9qPERDZqGjbYULc5WrJKEe5qiA9NACFuyq67n15/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.002 ether;
  uint256 public maxSupply = 7777;
  uint256 public maxMintAmountPerTx = 30;
  uint256 public freeUntil = 7777;
  uint256 public freebiesPerWallet = 1;
  mapping(address => uint256) public freebieMap;

  bool public paused = true;

  constructor() ERC721A("Sizuki", "Sizuki") {
  }
