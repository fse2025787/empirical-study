...
contract TheRingsOfPower is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TheRingsOfPower", "POWER") {
        ...
        marketingWallet = address(0x6F3042C0545809A2724A760D6D01b114ca12D5dd); // set as marketing wallet
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee;
        require(_fees.buyTotalFees <= 3, "3 MAX");   
        require(_fees.sellTotalFees <= 3, "3 MAX");
