 ...
 * allowances. See {IERC20-approve}.
 */
contract EVANGELION is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Shinji Ikari";
    ...
    address public marketingWallet = 0xEFEaefD7EFB808B1eFe8972272f4772a674B7D1d;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 15, "ERC20: total tax must not be greater than 10");
