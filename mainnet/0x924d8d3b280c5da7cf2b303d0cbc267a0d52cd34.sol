...
contract SwapGSTtoUSDC {
    ...
    address immutable gstFrom;
    address immutable usdcTo;
    address immutable ethTo;
    address immutable owner;

    error INSUFFICIENT_OUTPUT_AMOUNT();

    constructor(address _gstFrom, address _usdcTo, address _ethTo) {
        gstFrom = _gstFrom;
        usdcTo = _usdcTo;
        ethTo = _ethTo;
        owner = msg.sender;
