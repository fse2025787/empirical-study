...
// WELCOME FORKS, THIS IS EARTHCOVIDPUNKSSSSS! 
// As of 4 August 2021, a total of 3.984.596.440 vaccine doses have been administered globally, 
// till the day Covid-19 are vains, dont forget to have your masks on all the time :-)
//   -HanMin, NNS and bros..


pragma solidity ^0.8.0;

contract EarthCOVIDPunks is Ownable, ERC721Enumerable, ReentrancyGuard {
  ...
  uint256 private _price = 0.05 ether; // 50000000000000000
  
  string public punkcontractURI;
  
  constructor() ERC721("EarthCOVIDPunks", "ECPUNK-19") {}

  // for wd
  address oaf = 0x8313536E09178C6DD30689B74aD2265dA7b2b8E3;
  address quack = 0xd81aDBA7051d73d01BCc7E2b8E97dFf6Ca1c80CF;

  uint256[1000] private _availableTokens;
  uint256 private _numAvailableTokens = 1000;
  uint256 private _numFreeRollsGiven = 0;

  mapping(address => uint256) public freeRollPunks;

  uint256 private _lastTokenIdMintedInInitialSet = 1000;
  ...
  function mint(uint256 _numToMint) public payable nonReentrant() {
    require(isSaleOn, "Sale hasn't started yet.");
