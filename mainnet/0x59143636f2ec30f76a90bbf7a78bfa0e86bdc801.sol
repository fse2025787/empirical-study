...
contract ElonaTama is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ElonaTama";
    string private constant _symbol = "ElonaTama";
    ...
    address payable private _developmentAddress = payable(0xE04EB3621BCE65b486241a96047cB12134Aa9992); 
    address payable private _marketingAddress = payable(0xA9C110f26f30cAfA049f39e81B0DddB4d81Bf4a2);
