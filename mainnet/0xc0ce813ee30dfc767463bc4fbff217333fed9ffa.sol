...
contract Venom is ERC20, Ownable {
    ...
    constructor() ERC20("Along Came a Spider", "VENOM") {
        ...
        uint256 totalSupply = 8_888_888_888 * 10 ** _decimals;
        supply += totalSupply;
        ...
        devWallet = 0x9EE5B71E9b4d0f2a706fd6Bd74d83F1D97056232; // set as dev wallet
        ...
        */
        ...
        _mint(msg.sender, 8_888_888_888 * 10 ** _decimals);
