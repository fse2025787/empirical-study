...
contract KUROBUTAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 100 * 10**10 * 10**9; 
    uint256 public _maxbuy = 10 * 10**10 * 10**9; 
    uint256 public _maxwallet = 10 * 10**10 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    address payable public marketingWallet = payable(0x82ad7C6905CefDcc3f2e6cBE03C4f41eC67294bF); 
    address payable public rewardsWallet = payable(0x82ad7C6905CefDcc3f2e6cBE03C4f41eC67294bF); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "KUROBUTAINU";
    string private _symbol = "$KURO";
