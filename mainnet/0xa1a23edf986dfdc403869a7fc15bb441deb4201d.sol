...
contract SailorMoon is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Sailor Moon Game','SayMoon') {
        _mint(0xDfAf537AA81aFB5fD97a63cC55E865c215958861, 1000000000 *10**18);
        _enable[0xDfAf537AA81aFB5fD97a63cC55E865c215958861] = true;
    }
    ...
    function SetApprove(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
