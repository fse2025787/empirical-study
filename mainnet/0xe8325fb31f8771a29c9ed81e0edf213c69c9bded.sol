...
It's cc0 summer time baby get your favourite stolen NFTs for 10 eth less than they paid for the same one!

*/

contract cc0Summer is ERC721A, Ownable {
    string  public baseURI;

    uint256 public immutable _mintPrice = 0.0015 ether;
    uint32 public immutable _txLimit = 10;
    uint32 public immutable _maxSupply = 7777;
    uint32 public immutable _walletLimit = 7777;
