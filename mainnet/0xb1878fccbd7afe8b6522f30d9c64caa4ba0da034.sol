...
contract DarkDisciples is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmRvJ5KEPaej1FT5FRGwENQmPpjcqHnsmKZduTaCFxr39i/";
    ...
    constructor(string memory initBaseURI) ERC721A("Dark Disciples", "DD") {
        baseURI = initBaseURI;
