...
contract tezeract is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRvkVgRFgQskQbDepBueYaZYBGmjf8pYm4ebUhoVtF559";
    ...
    uint256 public NUM_FREE_MINTS = 350;
    ...
    constructor(
    ) ERC721A("tezeract", "t", 100, maxSupply) {
    }
