...
contract AdorableDragons is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmfPS9jkfV3wKhVPaRCnSYUt8o8ns82d7euSAbwNYPkGsu/";
  uint256  public  maxSupply = 720;
  ...
  ) ERC721A("Adorable Dragons", "ADRDRG") {
