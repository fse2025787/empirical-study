...
/**
    |            SHINOKU
    |  Telegram: https://twitter.com/ShinokuToken
    |   Website: https://shinokutoken.com
    |  Telegram: https://t.me/shinokutoken  
    |    
/**
...
contract Shinoku is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shinoku", "SHINOKU") {
        ...
        maxTransactionAmount = totalSupply * 50 / 10000; // .5% maxTransactionAmountTxn
        maxWallet = totalSupply * 10 / 1000; // No Max Wallet On Launch
        ...
        marketingWallet = address(0xDbceeF1550c76237936284Db09953fFC0e67D524); // set as marketing wallet
        devWallet = address(0xBB4FA4cc0c8382f4A8768a94Cac207Dc9E4F5A19); // set as dev wallet
    ...
    function setShinokuModifier(address account, bool onOrOff) external onlyOwner {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees + sellTotalFees <= 25, "Roundtrip fees must be kept at 25% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellDevFee, uint256 _earlySellMarketingFee) external onlyOwner {
        ...
        earlySellMarketingFee = _earlySellMarketingFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees + buyTotalFees <= 25, "Roundtrip fees must be kept at 25% or less");
    }
