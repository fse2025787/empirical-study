...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xc8A0DBF16EF38e0fE7989246A6f58a14f926e66C];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xc8A0DBF16EF38e0fE7989246A6f58a14f926e66C;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.00087 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 99999999999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWKJrA7f2uv2juM6Ba3d7HGBcYYyinhCkNvBQD94Nds5u/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 99999999999");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 99999999999");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 99999999999");
...
// File: contracts/FireSwordContract.sol
//

pragma solidity ^0.8.0;

contract FireSwordContract is RamppERC721A {
    constructor() RamppERC721A("Fire Sword", "FS"){}
}