...
/** .
 * Invisible Hand
 * Lyik hase fleetri arsh liek iet staur ailn dag oblivoffy
 * https://invisiblehand.lol/
. **/
...
contract UnseenHand is ERC20, Ownable {
    ...
    constructor() ERC20("Invisible Hand", "INVISIBLE") {
    ...
    function excludeFromMaxTransaction(address _updtAds, bool isEx)
        public
        onlyOwner
    {
        _isExcludedMaxTransactionAmount[_updtAds] = isEx;
    }
    ...
    function _removeLimits() external onlyOwner returns (bool) {
