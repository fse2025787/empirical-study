...
Beagle Inu, the new favourite dog on the block 🐶

After many other dog tokens had their shine, its now time for the cutest, sweetest and smartest dog to take over

My boss will treat me well, by doing marketing and buybacks to help me overtake them

How am i build?
1.000.000 total tokens
20.000 token max transaction and wallet at launch
5% final tax after 40 trades

Twitter: https://twitter.com/BeagleInuETH
Telegram: https://t.me/BeagleInuETH
**/
...
contract Beagle is Context, IERC20, Ownable {
    ...
    string private constant _name = "Beagle Inu";
