...
contract batcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Batcoin";//
    ...
    address payable private _developmentAddress = payable(0x0e527EBc4DeebC2C489Bc7168f991BBA5b0CBA8f);//
    address payable private _marketingAddress = payable(0x0e527EBc4DeebC2C489Bc7168f991BBA5b0CBA8f);//
