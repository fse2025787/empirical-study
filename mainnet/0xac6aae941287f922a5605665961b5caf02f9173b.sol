...
//https://t.me/shintainuerc
//http://www.shintainu.com/
// Shinta was created to make some surpise on the ethereum.
// Shinta one of the female dog tokens that will compete with other tokens ! come join and feel the sensation with us.
...
contract ShintaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SHINTA INU", "$SHINTA") {
