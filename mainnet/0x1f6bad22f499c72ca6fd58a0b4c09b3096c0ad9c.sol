...
contract LITTNER is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Littner INU";                                           // name
    string private _symbol = "LITTNER";                                            // symbol
    uint256 private _tTotal = 69 * 10**18; // supply is 69, because only a few can have an entire waifu. 
    ...
    uint256 private maxMarketingFee = 8; // check settingFees
    uint256 public defaultMarketingFee = 5;
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _marketingFee4Sellers = 20; // Once changed to less than maxMarketingFee or equal, it can no longer be upped.

    bool public feesOnSellersAndBuyers = true;
    
    //TX & MAX WALLET

    uint256 public _maxTxAmount = _tTotal/150; // 0.46
    uint256 public _maxWalletAmount = 1 * 10**18; // 1.45% // 1 token
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(10000);
    address payable public marketingWallet = payable(0x4649882CEf7221E7E64f74C6EA689b54011D3806);
