...
contract CHAINLETTER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ChaiN LeTTeR", "PASSITON") {
        ...
        maxTransactionAmount = totalSupply * 1 / 100; // 0.2% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x1225037E9b435eb8Fe2EE97C9Fc1d1001D258fC3); // set as marketing wallet
        devWallet = address(0x1225037E9b435eb8Fe2EE97C9Fc1d1001D258fC3); // set as dev wallet
    ...
    function setChainModifier(address account, bool onOrOff) external onlyOwner {
