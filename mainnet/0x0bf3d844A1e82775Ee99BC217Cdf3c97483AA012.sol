...
contract OneCent is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "1 Cent";
    string private constant _symbol = "1CENT";
    ...
    address payable private _marketingAddress = payable(0x9a71fAB956721bf84c8E33dCE64E62EF1C97F717);
    address payable private _contestAddress = payable(0x9321EC3240C87467Bc5Dda09234eDc164CB1085d);

    address payable private _devAddress = payable(0x482AAA6ba795B87e511F653f500B65982e213f0B);
    ...
    function updateSellFees(uint256 _sellTax) external onlyOwner {
        sellTax = _sellTax;
    }

    function sendETHToFee(uint256 amount) private {
        _devAddress.transfer((amount).div(5).mul(3));
        _contestAddress.transfer((amount).div(5));
