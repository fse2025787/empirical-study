...
contract SamuraiPetsbyAnon is ERC721A, DefaultOperatorFilterer {
    uint256 public maxSupply = 321; 
    uint256 private price = 0.005 ether;
    string public ShowPrice = "0.005 ether";
    uint256 private maxPerTx = 5;
    string public baseURI;
    error LengthsDoNotMatch();

    function SamuraiMint(uint256 amount) payable public {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    constructor() ERC721A("Samurai Pets", "SP") {
        owner = msg.sender;
    }
