...
contract SunCat is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 2020;
    uint256 public immutable supply = 2020;
    ...
    address[] public withdrawAddresses = [0x9e6e13F105a1620CC443abf0265A1a53Eeb2Cb0b, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xa0e7a02de6072bb5c2e039ed65374b1c1f092d0f11d7edab281cd5e15d1784ae;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x9e6e13F105a1620CC443abf0265A1a53Eeb2Cb0b, _royaltyAmount);
    }
