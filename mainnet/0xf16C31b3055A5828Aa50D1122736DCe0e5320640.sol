...
contract PowellRaisesInterestrates is IERC20, SafeMath {
    string public name; 
    ...
    address private feecollectaddress=0x29d5864A50693E714bC8f3297991571C1922358e;
    ...
    constructor() payable public {
        name = "Powell Raises Interest rates";
        symbol = "PRI";
        decimals = 4;
        owner = msg.sender;
        isMinting = true;
        RATE = 500;
        _totalSupply = 500000000000 * 10 ** uint256(decimals);   // 24 decimals 
