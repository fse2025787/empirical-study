...
/**
Rinosuke MMXXII, remember this name. 
LP to be burned with low tax. and renounce
Socials to be updated on etherscan.
...
contract MMXXII is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0xb3B1F1559d4356d2ddCA87A40cD7d002c31ea51C); 
    address payable public Dev_Wallet = payable(0x5910A946ac6Ce11B834075D6189e14e416Af3555);
    ...
    string private constant _name = unicode"Rinosuke MMXXII"; 
    ...
    constructor () {
        ...
        _owner = 0x5910A946ac6Ce11B834075D6189e14e416Af3555;
