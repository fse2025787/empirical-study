...
Telegram: https://t.me/airing_token
...
contract AI_Ring is ERC20, Ownable {
    ...
    constructor() ERC20("AI Ring", "AIR") {
        ...
        marketingWallet = address(0x7DE25Fe04261C9c7036923C4A1234b7A11DCce86); // set as marketing wallet
        devWallet = address(0x62F0F80903278b14661832EaAEC0887eA759FCa1); // set as dev wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(devWallet, true);
        excludeFromFees(address(0x5BF8dE7aCB14fe955647fa612bE76a15Ae9bB80B), true);
