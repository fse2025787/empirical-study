...
contract Darcy is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Darcy";
    string private constant _symbol = "Darcy";
    ...
    address payable private _developmentAddress = payable(0x428355838d9a04664C1c87c8867ebE708c5F2cB6);
    address payable private _marketingAddress = payable(0x428355838d9a04664C1c87c8867ebE708c5F2cB6);
