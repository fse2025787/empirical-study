...
contract OMTL is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmQy6WDStFbrJZYMsqg4p99gsDe3rxJFABWgvKThmHsyNb";
  ...
  uint256 public  TOTAL_FREE_MINTS = 4320;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("OH~ My Terra LUNA!", "OMTL") {
