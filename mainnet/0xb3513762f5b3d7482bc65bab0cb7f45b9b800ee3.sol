...
//     .----------------.  .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------.     //
//    | .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. |    //
//    | |     ______   | || |      __      | || | _____  _____ | | | | ____    ____ | || | ____   ____  | || | ____    ____ | || |  _________   | |    //
//    | |   .' ___  |  | || |     /  \     | || ||_   _||_   _|| | | ||_   \  /   _|| || ||_  _| |_  _| | || ||_   \  /   _|| || | |  _   _  |  | |    //
//    | |  / .'   \_|  | || |    / /\ \    | || |  | | /\ | |  | | | |  |   \/   |  | || |  \ \   / /   | || |  |   \/   |  | || | |_/ | | \_|  | |    //
//    | |  | |         | || |   / ____ \   | || |  | |/  \| |  | | | |  | |\  /| |  | || |   \ \ / /    | || |  | |\  /| |  | || |     | |      | |    //
//    | |  \ `.___.'\  | || | _/ /    \ \_ | || |  |   /\   |  | | | | _| |_\/_| |_ | || |    \ ' /     | || | _| |_\/_| |_ | || |    _| |_     | |    //
//    | |   `._____.'  | || ||____|  |____|| || |  |__/  \__|  | | | ||_____||_____|| || |     \_/      | || ||_____||_____|| || |   |_____|    | |    //
//    | |              | || |              | || |              | | | |              | || |              | || |              | || |              | |    //
//    | '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' |    //
//     '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'     //
//                                                                                                                                                     //
...
contract CANVAS is ERC721Creator {
    constructor() ERC721Creator("CANVAS CAW", "CANVAS") {}
}
