...
contract SweetPotatoz is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSLoZ7JfpuwVnjVhoA9hXSQzENW91uX15rqR9nxSh91rZ";
    ...
    constructor(
    ) ERC721A("Sweet Potatoz", "Potato", 100, maxSupply) {
    }
