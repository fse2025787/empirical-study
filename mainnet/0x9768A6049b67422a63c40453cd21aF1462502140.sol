...
// token transfers
// ----------------------------------------------------------------------------
contract BIXENTOKEN is ERC20Interface, Owned, SafeMath, Lockable {
    //string public constant name = "BIXENTOKEN";
    //string public constant symbol = "BIXEN";
    string public constant name = "Bixen Token";
    string public constant symbol = "BIXEN";
    uint8 public constant decimals = 18; 
    uint public constant INITIAL_SUPPLY = 20000000000000000000000000;
