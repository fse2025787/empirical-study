...
contract GuardiansOfEth is ERC20, Ownable {
    ...
    constructor() ERC20("Guardians Of Eth", "GETH") {
        ...
        marketingWallet = address(0xEc2d124bE048182b0e5B4a813Eff4C9076A26Ce9); // set as marketing wallet
        devWallet = address(0xFf63E379018583B718a38cDA7Df53C315bd885F7); // set as dev wallet
