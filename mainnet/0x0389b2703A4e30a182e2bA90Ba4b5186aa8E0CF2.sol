...
// File contracts/Kaijoodles.sol


contract Kaijoodles is ERC721, Ownable, ReentrancyGuard {
    uint256 public PRICE = 0.08 * 1e18;
    uint256 public MAX_SUPPLY = 999;
    uint256 public constant OWNER_AMOUNT = 20;
    uint8 public PRESALE_MAXMINT = 2;
   ...
   function setPRESALE_MAXMINT(uint8 _newPRESALE_MAXMINT) public onlyOwner {
	    PRESALE_MAXMINT = _newPRESALE_MAXMINT;
    ...
    function public_mint() public onlyOwner {
