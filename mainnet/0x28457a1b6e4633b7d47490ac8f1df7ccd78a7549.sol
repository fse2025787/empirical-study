...
Telegram :https://t.me/StareumNetwork

Stareum Network development standards are focus on token interfaces. 
These standards help ensure Smart Contracts remain composable, 
so for instance when a new project issues a token, 
that it remains compatible with existing Decentralized Exchanges.
...
contract StareumNetwork is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x63fB7fbc807845A94831A4bcC4b659B6eeE21130); 
    address payable public Wallet_Dev = payable(0x63fB7fbc807845A94831A4bcC4b659B6eeE21130);
    ...
    string private constant _name = "Stareum Network"; 
    string private constant _symbol = unicode"STN"; 
    ...
    constructor () {
        ...
        _owner = 0x63fB7fbc807845A94831A4bcC4b659B6eeE21130;
    ...
    function excludedMaxTxLimit(address addr, bool value) public returns (bool) {
