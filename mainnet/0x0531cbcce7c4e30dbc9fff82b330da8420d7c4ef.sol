...
//contact telegram:Moonbird   help 
pragma solidity ^0.8.0;




contract Moonbird is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mintNft(uint256 tokenQuantity) public payable {
        ...
        require(tokenQuantity <= maxMint, "Can only mint 10 token at a time");
...
//unpackjson cid ipfs://QmXrhUCjqUQCZ9RrN5P6GFL4DR2huLDyMGc8cXWfGdpCmk/
