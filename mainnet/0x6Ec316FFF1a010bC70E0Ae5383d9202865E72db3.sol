...
/*         
                 𝓖𝓸𝓭 𝓞𝓯 𝓦𝓮𝓪𝓵𝓽𝓱 ($𝓟𝓛𝓤𝓣𝓤𝓢)

    In Greek mythology, Plutus is known as the God of wealth and abundance. 
Of all the gods, he travels everywhere over land and the vast expanse of the sea, 
and he bestows tremendous fortune upon the one who discovers and obtains him. 
Although wealth is determined by fate, Plutus is typically viewed as a god who 
makes an exception by encouraging the affluent to grow more wealthier, and the 
wealthier to become the wealthiest. 

    As Plutus emerges to explore the world of Ethereum, he is now prepared to conquer 
the path and undertake his power to bestow blessings and wealth with protection 
and security to the community.

Telegram: https://t.me/Plutusportal
Website : www.Plutustoken.co
...
pragma solidity ^0.6.12;
    ...
    contract GodofWealth is Context, IERC20, Ownable {
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x46E2C4E86020f3807B1E3De24d0981756B9B18f6, 'We can not exclude Uniswap router.');
