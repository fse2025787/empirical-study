...
contract AB is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 888;
     uint256 public devSupply = 111;
    ...
    constructor(string memory initBaseURI) ERC721A("American Beautys", "AB") {
        baseURI = initBaseURI;
