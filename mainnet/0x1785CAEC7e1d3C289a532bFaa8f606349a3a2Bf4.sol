...
//   __   .__.__  .__                         __                      .__   
//  |  | _|__|  | |  |   _____________  _____/  |_  ____   ____  ____ |  |  
//  |  |/ /  |  | |  |   \____ \_  __ \/  _ \   __\/  _ \_/ ___\/  _ \|  |  
//  |    <|  |  |_|  |__ |  |_> >  | \(  <_> )  | (  <_> )  \__(  <_> )  |__
//  |__|_ \__|____/____/ |   __/|__|   \____/|__|  \____/ \___  >____/|____/
//       \/              |__|                                 \/            
//
// 
...
contract KILLProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "KILL Protocol";
    ...
    address payable private _developmentAddress = payable(0x78B095Ab0fACCfb94561398aE4aFAe03FE410F68);
    ...
    uint256 public _maxTxAmount = 2e7 * 10**9; //2% - 5000000000
    uint256 public _maxWalletSize = 3e7 * 10**9; //3%
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                if (_buyMap[from] != 0 && (_buyMap[from] + (20 minutes) >= block.timestamp)) {
                    _redisFee = 0;
                    _taxFee = 10;
                } else {
