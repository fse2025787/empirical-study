...
contract HOORI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = " Hoori ";
    string private constant _symbol = unicode" 火折尊 ";
    ...
    address payable private _developmentAddress = payable(0x3F77cBfbe5dE29D8c58F1a54f222B99Ead643842);
    address payable private _marketingAddress = payable(0x3F77cBfbe5dE29D8c58F1a54f222B99Ead643842);
