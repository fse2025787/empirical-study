...
contract TokyoDrift is ERC20, Ownable {
    string private _name = "Tokyo Drift";
    string private _symbol = "TOKYO";
    uint8 private _decimals = 9;
    uint256 private _supply = 69696969;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 696969 * 10**_decimals;
    uint256 public maxWalletAmount = 696969 * 10**_decimals;
    address public marketingWallet = 0x8d177a755884f42fe6F701F8bBE61caeE372ad84;
    ...
    uint256 private _numTokensSellToAddToLiquidity = 69696 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 69696 * 10**_decimals;
    ...
    function setNumTokensSell(uint256 _eth, uint256 _liq) external onlyOwner {
        _numTokensSellToAddToETH = _eth * 10**_decimals;
        _numTokensSellToAddToLiquidity = _liq * 10**_decimals;
    }
