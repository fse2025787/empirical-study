...
contract TheGoldenFloki is ERC20, Ownable {
    ...
    constructor() payable ERC20("The Golden Floki", "GLDF") {
        ...
        operationsAddress = address(0x2C626BCbC6601fb2a6E302f7F4A8DeFCB89e9004);

        _createInitialSupply(newOwner, (totalSupply * 25) / 100); // Staking
         _createInitialSupply(address(this), (totalSupply * 75) / 100); // liquidity
