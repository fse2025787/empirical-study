...
contract tentojismartcontract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Heaven and Earth";
    string private constant _symbol = "Tentoji";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xAb91a1B96ADdE33d7883F496f627970cECec7c19); 
