...
kuda mochi families often become wealthy and powerful very quickly. 
However, as these families grow, they tend to acquire more and more kuda-kitsune
It will then multiply to 75, and so on. Kuda is also known as "Tube Fox".

TG:https://t.me/kudakitsune_ERC
...
contract kudakitsune is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"kuda kitsune";
    string private constant _symbol = "KUDAKITSUNE";
