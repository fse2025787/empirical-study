...
/**
https://medium.com/@kaikendeployer
@kaikenERC
*/
...
contract KaikenCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kaiken Coin";
    string private constant _symbol = "KAIK";
