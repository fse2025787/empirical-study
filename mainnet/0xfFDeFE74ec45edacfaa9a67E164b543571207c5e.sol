...
//*********************************************************************//
//
//     _   _______________    ___                  _    __      ____                
//    / | / / ____/_  __/ |  / (_)___  ____  __  _| |  / /_  __/ / /___  __________ 
//   /  |/ / /_    / /  | | / / / __ \/ __ \/ / / / | / / / / / / __/ / / / ___/ _ \
//  / /|  / __/   / /   | |/ / / / / / / / / /_/ /| |/ / /_/ / / /_/ /_/ / /  /  __/
// /_/ |_/_/     /_/____|___/_/_/ /_/_/ /_/\__, / |___/\__,_/_/\__/\__,_/_/   \___/ 
//                /_____/                 /____/                                    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE34f6b5B39CA253a38779aB584477a490961357A];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 455 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTTRaWJxmNk2RSNQwfEhvySfVJAjLQt2Dpkf5QzYtVQX4/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 455");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 455");
...
// File: contracts/VinnyVultureGhostCollectionContract.sol
//

pragma solidity ^0.8.0;

contract VinnyVultureGhostCollectionContract is RamppERC721A {
    constructor() RamppERC721A("VinnyVulture Ghost Collection", "Ghost"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/VMUdqnibfxnINPYlp2A0/contract-metadata";
    }
}
