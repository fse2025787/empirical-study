...
contract RiseAngleMembershipIceEdition is ERC721, ERC721Enumerable, Ownable {

    uint256 public MAX_RAMS = 1000;

    uint256 public PRE_SALE_PRICE = 0.14 ether;
    ...
    /**
     * @dev pass RAMIcePreBuy contract address as argument
     */
    constructor(address _preBuyContract) ERC721("RiseAngle Membership: Ice Edition", "RAMIce") {
        baseTokenURI = "https://ipfs.io/ipfs/QmNzE3qP1w7ZHLkzLHXLdBR94fdR7Sa79tCzGV2xD3DjCg";
        preBuy = RAMIcePreBuy(_preBuyContract);
        _fundReceiver = owner();
    }
    ...
    function mintPresale() external payable {
        ...
        require(_totalClaimed[msg.sender] < 5, "Pre-Sale Purchase exceeds max allowed per wallet");
