...
contract ConstellationsOfTheEther is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmULaQecAHiQ44JMvFTz6X8wYHgHeR9htJymXGX113pVcr/hidden.json";
  ...
  ) ERC721A("Constellations of the Ether", "CONST") {

  }


  function CHART(uint256 numberOfTokens)
      external
      payable
  {
