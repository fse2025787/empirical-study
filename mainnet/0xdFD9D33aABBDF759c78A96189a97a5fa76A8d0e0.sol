...
contract OxGREEN is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable maxPerWallet = 75;
    uint256 public immutable maxPerFreeMint = 1;
    uint256 public immutable freeMints = 420;

    uint256 public immutable devMints;
    uint256 public immutable maxPerTx;
    uint256 public immutable actualCollectionSize;

    uint256 public publicMintPrice = .042 ether;
    ...
    function ogMint(uint256 quantity, bytes32[] calldata _merkleProof) external callerIsUser {
        require(
