...
contract DoggerInu is ERC20, Ownable {
    ...
    constructor() ERC20("DOGGERINU", "DOGGERINU") payable {
        ...
        maxTxnAmount = totalSupply * 20 / 1000; // 2% of supply
        ...
        excludeFromFees(0xA2E3D92D85e4c78032F3749E06d0497A4CD32Bd9, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xA2E3D92D85e4c78032F3749E06d0497A4CD32Bd9, true);
        ...
        */
        ...
        _createInitialSupply(0xA2E3D92D85e4c78032F3749E06d0497A4CD32Bd9, totalSupply*20/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xA2E3D92D85e4c78032F3749E06d0497A4CD32Bd9,
            block.timestamp
        );
    }
