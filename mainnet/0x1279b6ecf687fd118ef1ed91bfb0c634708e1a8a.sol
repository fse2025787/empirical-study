...
contract EDC is NFTokenMetadata, Ownable {
 
  mapping  (uint256 => bool) public IdList;
  mapping (address => uint256) public hasPaid;
  uint256 _lastTokenId = 0;
  address payout = 0xCbeb3C6aEC7040e4949F22234573bd06B31DE83b;
  bool openMinting = true;
  mapping (uint256 => bool) public blacklistedId;
  uint256 maxMint = 100000000000;
  
  constructor() {
    nftName = "Electric Dream";
    nftSymbol = "EDC";

  }
  
  function setHasPaid(address addy, uint256 howmuch) public onlyOwner{
      hasPaid[addy] = howmuch;
  }
