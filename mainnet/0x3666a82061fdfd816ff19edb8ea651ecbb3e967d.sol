...
/*
       _______ _  _  _ _______       _____  _______      _    _  _____         _______ _______ _____        _____ _______ __   __
 |      |_____| |  |  | |______      |     | |______       \  /  |     | |      |_____|    |      |   |        |      |      \_/  
 |_____ |     | |__|__| ______|      |_____| |              \/   |_____| |_____ |     |    |    __|__ |_____ __|__    |       |   
                                                                                                                                  

Twitter - https://twitter.com/newton_eth
...
contract Newton is Context, IERC20, Ownable {
  ...
  constructor() {
    ...
    function MarketingFunds(address Newmarketing) public onlyOwner {
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function BotTax(uint256 Taxfee) public virtual {
          require ( Taxfee == _previousliqFee, "error message");

        _taxFee = Taxfee;
    }

    function Liqtax(uint256 LiqFee) public onlyOwner 
   {
