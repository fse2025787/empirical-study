...
contract AccessGrantedByTheFund is ERC721A, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0xbf2eB356bC1EEDb50C7e2e80E3a14dDdB0C72a52, 0x82A22Deb2aeb4FEfdc8D4836D7B484344Ab387F9];
    uint256[] public withdrawPercentages = [5, 5, 90];

    bytes32 public merkleRoot = 0xd6fc49a5b6e01d3a8bd6e66a4d1082c6569c4821e1de22cc58939c24d08b6519;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x82A22Deb2aeb4FEfdc8D4836D7B484344Ab387F9, _royaltyAmount);
    }
