...
contract DeadWorldEggs {
    function ownerOf(uint256 tokenId) public view returns (address) {}
}

contract WorldEggs is ERC721Enumerable, Ownable {
    uint256 public constant OWNER_SUPPLY = 3;
    uint256 public constant MAX_SUPPLY = 2505;

    uint256 private _launchTimeEpochSeconds = 1628890200;

    string private _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmY411zq3mTgz2PhaoL7P9ePqtqo1geKhNQGWkU27k8Pjm/";
    bool private _ripCord = false;
    uint256 public PRICE = 8 * 10**16;

    DeadWorldEggs private _previous;

    constructor(address _dead) ERC721("WorldEggs", "WORLDEGGS") {
        _previous = DeadWorldEggs(_dead);
    }
