...
contract CrystalOfPromotion is ERC721, ICrystalOfPower {
    ...
    ) ERC721("LEXOR Crystal of MetaPlayerOne", "LEXOR Crystal") {
    ...
    modifier checkMint() {
        require(quantity + 1 <= limit, "Limit is 700");
        require(
    ...
    function mintOther(uint256 _amount) public {
        ...
        require(quantity + _amount <= limit, "Limit exceeded. Max: 700");
