...
/**
 Snail Coin - one of the biggest hyped meme coin. SNAILCOIN is a crypto coin created by the community for the community.
 Website : https://snailcoin.app/
 Telegram : https://t.me/snailcoineth
*/
...
contract SnailCoin is ERC20, Ownable {
    ...
    address private _marketingWallet = 0x280E21d1cD8D3fE7129fED349eF3476a4f5289B1;
   ...
   modifier lockLiquidity() {
    ...
    {
        require(newRouter != address(0), "newRouter address can not be 0");
        require(
