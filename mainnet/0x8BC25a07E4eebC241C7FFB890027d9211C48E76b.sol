...
contract Trojan is ERC20, Ownable {
    ...
    uint256 public buyTxFee = 1;
    uint256 public sellTxFee = 4;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTax;

    uint256 public _cTotal = 1000000000 * 10**9;
    uint256 public swapAtAmount = _cTotal.mul(10).div(10000);
    uint256 public maxTxLimit = _cTotal.mul(120).div(10000);
    uint256 public maxWalletLimit = _cTotal.mul(240).div(10000);
    ...
    constructor() ERC20("A Wooden Horse", "TROJAN") {
        ...
        dev = address(0x7761C7958Be9C27252B122883a16E7bDE6608144);
        deployer = _msgSender();
    ...
    function _transfer(
        ...
        require(
            launched || isExcludedFromFees[from] || isExcludedFromFees[to],
            "Waiting to go live"
        );
