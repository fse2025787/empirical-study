...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x242aD97D6994344376cF9308621098e5A1637547];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmaPSSq71MtQiP4BFf7PJT3KTafHASuFEvkrGfuaBczXkc/";
...
// File: contracts/OkayBearsforOthersideContract.sol
//

pragma solidity ^0.8.0;

contract OkayBearsforOthersideContract is RamppERC721A {
    constructor() RamppERC721A("OkayBears for Otherside", "OBOS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vW8OiWeO2RABfk3fUEGy/contract-metadata";
    }
}
