...
/**
 * @title iNVM_StateCommitmentChain
 */
interface iNVM_StateCommitmentChain {
    ...
    function verifyStateCommitment(
        bytes32 _element,
        Lib_NVMCodec.ChainBatchHeader memory _batchHeader,
        Lib_NVMCodec.ChainInclusionProof memory _proof
    )
        external
        view
        returns (
     ...
     * @param _ovmTransaction Header of the batch to check.
...
/**
 * @title iNVM_StateTransitioner
 */
interface iNVM_StateTransitioner {
