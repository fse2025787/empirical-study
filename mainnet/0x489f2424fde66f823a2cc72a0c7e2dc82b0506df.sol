...
contract FFS_NFT is ERC721Enumerable, Ownable, RandomlyAssigned {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 300000000000000000;
    uint256 public presaleCost = 200000000000000000;
    uint256 public maxSupply = 5000;
    uint256 public batchCount;
    bool public public_paused = true;
    bool public pre_paused = false;
    address public owner1 = 0x1106cFdfa606642f049A6bF9c0E29CE0E780edE5;
    address public owner2 = 0x0138D20829CA2e0C0C88d75Ac73fB4854862c3a6;
    ...
    function mint() public payable {
        ...
        require(publicMint[msg.sender] < 20 );
        require(!public_paused, "Public Sale has not started yet");
        require(batchCount < 555);
    ...
    function presale_mint() public payable {
        uint256 supply = totalSupply();
        require(preMint[msg.sender] < 10 );
        require(!pre_paused, "Pre-sale has not started yet or has ended");
        require(batchCount < 555);
        require(presaleWallets[msg.sender] == true, "You are not listed for Pre-sale");
        require(supply < maxSupply);
    ...
    function startNewBatch() public onlyOwner {
        batchCount = 0;
    }
    ...
    function add50PresaleUsers(address[50] memory _users) public onlyOwner {
    ...
    function withdraw() public payable {
        ...
        payable(owner1).transfer(amount);
