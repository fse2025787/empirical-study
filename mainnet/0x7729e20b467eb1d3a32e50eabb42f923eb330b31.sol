...
/**
     ONE TOKEN
Total supply is 1 Token. Want to become a part of something legendary?
...
contract ONE_TOKEN is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet = payable(0x17Ee7FFA031c95752470542674d84E1DeBaaa32B);
