...
/**
$MYTH
Have you heard the myth of Saint George?
Whose names are justly reverenced among men, but whose actions are known only to God.

Auto Buyback per 1min 0.1ETH
Auto Burn Liq per 10 min 5%

NO TG, https://twitter.com/Erc20_myth
*/
...
contract MYTH is ERC20, Ownable {
    ...
    constructor() ERC20("MYTH", "MYTH") payable {
    	...
    	marketingWallet = address(0x1272c516F9219Ce4d3ADCa08e9df8f5F2cfcc2Bf); // set as marketing wallet
        ...
        excludeFromFees(0x1272c516F9219Ce4d3ADCa08e9df8f5F2cfcc2Bf, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x1272c516F9219Ce4d3ADCa08e9df8f5F2cfcc2Bf, true);
        ...
        */
        ...
        _createInitialSupply(0x1272c516F9219Ce4d3ADCa08e9df8f5F2cfcc2Bf, totalSupply*5/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x1272c516F9219Ce4d3ADCa08e9df8f5F2cfcc2Bf,
            block.timestamp
        );
    }
