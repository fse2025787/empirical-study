...
// 
/*
Big Akana controls the mind and the destiny.
22 Gods, from fools to the world.
Is death terrible? Can't be afraid.
Is poverty terrible? Can't be afraid.
The terrible thing is FATE, the fate line begins close to the Tarot, all the divination, all the prophecies, all the rules.
Everything is holding you back.
https://medium.com/@TAROTETH
*/
...
contract TAROT is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "The Fate";
    string private constant tokenSymbol = "TAROT";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x43F8818df077F028a666947DF2Ae77CDFc96301C);
        devAddress = payable(0x43F8818df077F028a666947DF2Ae77CDFc96301C);
    ...
    function FATE() external onlyOwner returns (bool){
