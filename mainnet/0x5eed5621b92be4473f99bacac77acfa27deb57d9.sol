...
contract StandardToken is ERC20, BasicToken, MinterRole {
...
contract NYAX is StandardToken 
{
    string  public constant name     = "New York Alt Exchange";
    string  public constant symbol   = "NYAX";
