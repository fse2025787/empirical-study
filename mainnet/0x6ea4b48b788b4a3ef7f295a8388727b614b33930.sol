...
contract NextCommunityGen  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xD943C25010cD8bfF6B483436EC7EdD401575fF70); // Marketing Address
    address payable public multiSigAddress = payable(0xD943C25010cD8bfF6B483436EC7EdD401575fF70); // Marketing Address
    address payable public devAddress = payable(0x85d707741b78c10Bfd7FaB0eb58c44210EA74160); // Dev Address
    address payable public liquidityAddress = payable(0x85d707741b78c10Bfd7FaB0eb58c44210EA74160); // Liquidity Address
    ...
    string private constant _name = unicode"Next Community Gen";
    string private constant _symbol = unicode"NEXTGEN";
