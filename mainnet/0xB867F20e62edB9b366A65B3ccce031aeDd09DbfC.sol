...
contract FullDigiHLA is Ownable, ERC721A, MerkleWhitelist, ReentrancyGuard {
    ...
    uint256 public DA_STARTING_PRICE = 0.01 ether;

    uint256 public DA_ENDING_PRICE = 0.005 ether;

    uint256 public DA_DECREMENT = 0.002 ether;

    uint256 public DA_DECREMENT_FREQUENCY = 40;

    uint256 public DA_FINAL_PRICE;

    uint256 public WL_PRICE = 0.008 ether;
    ...
    uint256 public WL_AMOUNT = 40;
    uint256 public DA_AMOUNT = 500;
    uint256 public MAIN_AMOUNT = 10;
    uint256 public ALL_AMOUNT = 600;


    uint256 public WL_START_TIME = 1650832800;
    uint256 public WL_END_TIME = 1650833100;

    uint256 public DA_START_TIME = 1650833220;
    uint256 public DA_END_TIME = 1650833520;

    uint256 public MAIN_END_TIME;
    //uint256 public MAIN_LAST_TIME = 10800;
    uint256 public MAIN_LAST_TIME = 600;

    uint256 public EXTRA_START_TIME = 1650833640;
    ...
    string public UNREVEALED_URI =
        "https://data.torizero.com/torizero/box.json";
