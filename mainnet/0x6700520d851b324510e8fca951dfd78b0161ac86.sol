...
/**
Will existing artists be replaced by AI art? No, they will only be replaced by artists using AI.
...
contract AICC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Artificial Intelligence Create Center", "AICC") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x4ff74D08aBBAb20131AF4533F10ec6072BC6a687); // marketing wallet
        devWallet = address(0x4ff74D08aBBAb20131AF4533F10ec6072BC6a687); // dev wallet
