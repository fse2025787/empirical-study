...
contract Staking is Ownable {
    ...
    enum StakingPeriod{ OPT_1, OPT_2, OPT_3, OPT_4, OPT_5 }

    uint256 public opt1_duration = 14 days;
    uint256 public opt2_duration = 50 days;
    uint256 public opt3_duration = 100 days;
    uint256 public opt4_duration = 250 days;
    uint256 public opt5_duration = 500 days;
    ...
    { 
        ...
        apr[StakingPeriod.OPT_1] = 35;
        apr[StakingPeriod.OPT_2] = 140;
        apr[StakingPeriod.OPT_3] = 350;
        apr[StakingPeriod.OPT_4] = 900;
        apr[StakingPeriod.OPT_5] = 2000;
    }
    ...
    function getInvestorRewards(uint256 _unstakeAmount, stake memory _investor) internal view returns (uint256) {
        ...
        return _unstakeAmount.mul(apr[_investor.stakePeriod]).div(10000);
    } 
    ...
    function getStakingPeriodInNumbers(stake memory _investor) internal view returns (uint256){
        return _investor.stakePeriod == StakingPeriod.OPT_1 ? opt1_duration : _investor.stakePeriod == StakingPeriod.OPT_2 ? opt2_duration : _investor.stakePeriod == StakingPeriod.OPT_3 ? opt3_duration : _investor.stakePeriod == StakingPeriod.OPT_4 ? opt4_duration : _investor.stakePeriod == StakingPeriod.OPT_5 ? opt5_duration : 0; 
    }
