...
contract ONEDAY is Context, IERC20Upgradeable {
    ...
    function intializeContract(address payable setMarketWallet, address payable setDevWallet, string memory _tokenname, string memory _tokensymbol) external onlyOwner {
        ...
        _marketWallet = payable(0x615B7d03AAB89b9ea7d58889Bb407173E96c1c11);
        _devWallet = payable(0x615B7d03AAB89b9ea7d58889Bb407173E96c1c11);
...
//===============================================================================================================
    ...
    function transferOwner(address newOwner) external onlyOwner() {
        ...
        if (_devWallet == payable(0x615B7d03AAB89b9ea7d58889Bb407173E96c1c11))
            _devWallet = payable(0x615B7d03AAB89b9ea7d58889Bb407173E96c1c11);
...
//===============================================================================================================
    ...
    function NewDevWallet(address payable newWallet) external onlyOwner {
        require(0x615B7d03AAB89b9ea7d58889Bb407173E96c1c11 != newWallet, "Wallet already set!");
        _devWallet = payable(0x615B7d03AAB89b9ea7d58889Bb407173E96c1c11);
    }
