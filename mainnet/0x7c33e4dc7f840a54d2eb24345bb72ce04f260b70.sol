...
contract CryptoPumpInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Crypto Pump Inu";
    ...
    address payable private _developmentAddress = payable(0x1CAd175d16443FcFfABCcfEB3FF21Ba101F38F1B);
    ...
    uint256 public _maxWalletSize = 4e3 * 10**9; //
    uint256 public _swapTokensAtAmount = 5e1 * 10**9; //
