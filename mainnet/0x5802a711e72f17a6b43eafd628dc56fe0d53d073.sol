...
contract TAMA is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "TAMA INU";//////////////////////////
    ...
    address payable private _developmentAddress = payable(0x349941DaD61aabEF12B2A524ac90A32D484217fD);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x349941DaD61aabEF12B2A524ac90A32D484217fD);///////////////////////////////////////////////////
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if(contractTokenBalance >= _maxTxAmount*5)
            {
                contractTokenBalance = _maxTxAmount*5;
            }
