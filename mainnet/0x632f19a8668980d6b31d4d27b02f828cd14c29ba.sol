...
contract FANG is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Li Fang";
    string private constant tokenSymbol = "$F";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xadBFf6cDCD1149dF07367B9CFD2fE427822D0140);
        devAddress = payable(0xadBFf6cDCD1149dF07367B9CFD2fE427822D0140);
