...
OSAKA INU TEST
https://t.me/osakainutoken
ERC20 Token
1% BURN 1% REWARDS 2% MARKETING
*/
...
contract OSAKAINU is Context, IERC20, Ownable {
    ...
    string private _symbol = "OSAKAINU";
    ...
    uint256 private numTokensSellToAddToLiquidity = 300000 * 10**9;
   ...
   // Number of Tokens to Accrue before Selling To Add to Liquidity
	...
	// Percentage for Liquidity Fees 
	function setAddtoLiquidityFees(uint256 fee) external onlyOwner() {
       _liquidityFee = fee;
    }
	
	// Percentage for Marketing Team Fees
