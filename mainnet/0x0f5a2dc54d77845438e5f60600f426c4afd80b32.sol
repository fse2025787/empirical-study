 ...
 * Telegram: https://t.me/LuckyERC

 * Website: https://www.luckyerc.com/
 * */
 ...
 contract LUCKY is Context, IERC20, Ownable {
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xb9ba8F6169D3990639B464D33b2b9D5F87B9A495);
         _feeAddrWallet2 = payable(0xb9ba8F6169D3990639B464D33b2b9D5F87B9A495);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xb9ba8F6169D3990639B464D33b2b9D5F87B9A495), _msgSender(), _tTotal);
     }
