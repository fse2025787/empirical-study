...
/**
miniSUZUME | Shita-Kiri Suzume

On the eve SUZUME crossed 10M MC ATH, we were convinced the conviction has and will continue to spread across crypto

miniSUZUME has a lot of surprises, and we're excited you're considering joining our journey

5% reflections in SUZUME (or wETH, USDC) / 1% to supply ETH for weekly rewards

Twitter - https://twitter.com/mini_SUZUME

TG - https://t.me/miniSUZUME
...
contract miniSUZUME is IERC20, Ownable {
    ...
    string private constant TOKEN_NAME = "miniSUZUME";
    string private constant TOKEN_SYMBOL = "miniSUZUME";
    uint256 private constant TOTAL_SUPPLY = 100_000_000 * 10**TOKEN_DECIMALS;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 20;      //Dev can never set total reflections tax higher than this value
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x641C2468CaF3f3E405Fa95D6F57DAa2f8174C3e1,
        marketing: 0x641C2468CaF3f3E405Fa95D6F57DAa2f8174C3e1
    });
    ...
    address public rewardToken = 0x0B452278223D3954F4AC050949D7998e373e7E43;
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor) external authorized {
        uint256 minLimit = TOTAL_SUPPLY / 10000;   
