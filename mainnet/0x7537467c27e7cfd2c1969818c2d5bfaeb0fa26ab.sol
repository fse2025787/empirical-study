...
contract CRYPTOKINGS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CRYPTOKINGS";//
    string private constant _symbol = "CRYPTOKINGS";//
    ...
    address payable private _developmentAddress = payable(0x40950b249BEf3282C5dA2fc4784A4EC6950051f6);//
    address payable private _marketingAddress = payable(0x40950b249BEf3282C5dA2fc4784A4EC6950051f6);//
