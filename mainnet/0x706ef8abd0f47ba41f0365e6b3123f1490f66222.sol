...
contract InteractiveBanners is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeibatynq4y2sttgesfxsbhplwun2ugstt6hejpzbae3nkanwdo2bbi";
  uint256  public  maxSupply = 6000;
  uint256 public  MAX_MINTS_PER_TX = 20;
  uint256 public  PUBLIC_SALE_PRICE = 0.003 ether;
  uint256 public  NUM_FREE_MINTS = 6000;
  ...
  ) ERC721A("Interactive Banners", "Interactive Banners") {
