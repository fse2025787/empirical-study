...
// File: contracts/DwarvesTownwtf.sol



/**
 * @title DwarvesTownwtf contract
*/
...
contract DwarvesTownWTF is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("DwarvesTownWTF", "DTW"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Dwarves available");
