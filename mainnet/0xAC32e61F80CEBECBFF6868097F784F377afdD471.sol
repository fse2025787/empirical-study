...
contract Sorcerer is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Sorcerer Inu";//
    string private constant _symbol = "SORCI";//
    ...
    address payable private _developmentAddress = payable(0x39e2ADdBa5C1e3e32f75567908158eC49D4b98ab);
    address payable private _marketingAddress = payable(0x3C9F09431A1D799EFD0b2A81719CdD0e2c2E57D2);
