...
contract NotOkayBearz is ERC721A, Ownable, ReentrancyGuard {

    using Address for address;
    using Strings for uint256;

    bool public publicOpen = false;
    uint256 public mintPrice = 0.0151 ether;
    uint256 public collectionSize = 10000;

    mapping (address => uint256) public totalMinted;


    constructor() ERC721A("Not Okay Bearz", "NOTOKAY", 1000) {
    ...
    function changeMint(uint256 newPrice) public onlyOwner
    {
        mintPrice = newPrice;
    }
}