    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 197) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPndenAN2BgR8WZAWZKhbvWDyBNLv2jYxR84wUsjAskHb/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 197");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 197");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 197");
...
// File: contracts/WildKingdomContract.sol
//

pragma solidity ^0.8.0;

contract WildKingdomContract is RamppERC721A {
    constructor() RamppERC721A("WildKingdom", "INTEL"){}
}
