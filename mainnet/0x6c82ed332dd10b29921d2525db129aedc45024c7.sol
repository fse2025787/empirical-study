...
Hooked  Inu is a meme token of Hooked Protocol based on Ethereum Network (ERC20).

With a strong community of Hooked Protocol, we believe that we can create a revolutionary token that is driven by an active community and token feature which can make all investors profit. We, at Hooked Inu have aim to build a platform where people can read and earn while we maintain our investors funds securely. Join us today!!!

🖇️ Telegram: https://t.me/Hookedinu
🕊️ Twitter: https://twitter.com/HOOKEDlNU
**/
  ...
  contract Hookedinu is Context, IERC20, Ownable {
      ...
      string private constant _name = "Hook Inu ";
      string private constant _symbol = "HOOKI";
