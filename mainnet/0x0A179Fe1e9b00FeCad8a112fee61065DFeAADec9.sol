...
contract TheNormalSyndicate is ERC721Enum, Ownable, PaymentSplitter, Pausable,  ReentrancyGuard {
    ...
    0xA33Cb2549886BFa745EFcDcB97fd97EBbE0De9B6,
    0x95c0C5A37dFfF9EAc1302563D11846e388382543
    ];

    uint[] private shareList = [90, 10];    

    constructor() ERC721P("TheNormalSyndicate", "TNS") PaymentSplitter(addressList, shareList){
        setBaseURI("");
    }
