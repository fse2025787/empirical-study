...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9e0DeE5c8B9864caDbcE0D0a6042E19E248Dc235];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 8999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicbuxlkvfcupdbvkto33peca45oxxn45wguijcfte3hohiviselhq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 8999");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 8999");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 8999");
...
// File: contracts/ApeToMoonContract.sol
//

pragma solidity ^0.8.0;

contract ApeToMoonContract is RamppERC721A {
    constructor() RamppERC721A("Ape To Moon", "Apetmoon"){}
}
