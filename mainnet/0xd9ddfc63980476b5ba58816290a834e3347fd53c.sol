...
// ADD_CONTRACT_NAME
    ...
    address payable private _developmentAddress = payable(0x5b3d95c9790D9Ff5c7bf8e8e7A57fC593a1F413D);
    address payable private _marketingAddress = payable(0x5b3d95c9790D9Ff5c7bf8e8e7A57fC593a1F413D);
    // ADD_OWNER
    ...
    function setTrading(bool _tradingOpenddd) public onlyOwner {
        tradingOpen = _tradingOpenddd;
    }
