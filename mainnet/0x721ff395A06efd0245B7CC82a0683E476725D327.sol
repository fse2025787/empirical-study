...
contract Cobra is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Cobra";
    ...
    address payable private _developmentAddress = payable(0x4Ec2e1cacfCbbd276B2c29E69ebb85219d4bE083);
    address payable private _marketingAddress = payable(0xf70f5f5991d8B1B9D17A2ebF0a60165633820aaD);
