...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDe6c546D0eb344Ddc0A913a5E466c97d07C4f41f;
...
contract SENDsational is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666666666 * 10**_decimals;
    uint256 public _maxTxAmount = 13333333 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SENDsational";
    string private _symbol = unicode"$SEND";
