...
contract NAIXIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="NAIXIN";
    string private _symbol = "Naixin";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x3CBdC56C6f5a6554B8e074F6737c3609f20e0eb7);
    address payable private taxWallet2 = payable(0x3CBdC56C6f5a6554B8e074F6737c3609f20e0eb7);
