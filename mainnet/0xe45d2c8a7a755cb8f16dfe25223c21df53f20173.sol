...
Built to support the $CULT movement and empower The Many...

⚪️ Dashboard to auto stake and claim $CULT rewards, lock LPs token and earn $CRAZE the yield farming token of WE ARE CULT, stake $CRAZE to earn ETH and CULT
⚪️ Fuel Cult Dao price and liquidity through buy backs and liquidity adding.

$WECULT Tokenomics
12% Buy/Sell (15% for first 24 hours )

⚫️  4% Swapped into $CULT for holders to earn passive income
⚫️  4% Buy $CULT from the market and add liquidity empowering The Many to strengthen Cult Dao 
⚫️  4% Treasury to sustain project development and growth.

⚫️ https://t.me/StreamOfCult
⚫️ https://www.streamofcult.com/ 
⚫️ https://twitter.com/StreamOfCult
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable CULT = address(0xf0f9D895aCa5c8678f706FB8216fa22957685A13); //UNI
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a CULTSTREAM shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract StreamOfCult is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Stream Of Cult";
    string private constant _symbol = "CULT STREAM";
    ...
    address payable public treasuryWallet = payable(0xebb989089444657Ec0D302F7842a9514F0ad4B91);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForCULT(amountToSwap.div(2));
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 15, "Fee can't exceed 15%");
        totalFee = _fee;
    }
