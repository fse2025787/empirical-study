...
/**
 Tsukaido is  a community-centric decentralized finance (DeFi) project with aims of revolutionising the De-Fi crypto space.  
Using the latest technology, TSUKAIDO aims to create new and innovative financial products empowering users to send, spend, 
and invest their crypto from anywhere in the world, faster, and more affordably than any bank in the market.

What is utility Meme?

The  new age of finance includes currencies based off memes that will become legitimate ways to conduct commerce. 
We believe that by leading the financial market in fun and creative ways to send, spend, and invest your money, 
Tsukaido will be the future of money for the next generations that will be born into crypto-banking

PORTAL: https://t.me/TsukaidoETH
WEBSITE: https://www.tsukaido.com
TWITTER: https://twitter.com/TsukaidoERC
MEDIUM: https://medium.com/@tsukaidoerc
...
contract TSUKAIDO is Context, IERC20, Ownable {
    ...
    string private constant _name = "TSUKA HOKKAIDO"; 
    string private constant _symbol = "TSUKAIDO"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public _marketingWallet = 0xA3c7eEb13a9A5126aDFad086D5476437Af061880; 
