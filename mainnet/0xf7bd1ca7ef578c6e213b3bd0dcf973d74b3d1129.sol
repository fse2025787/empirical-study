...
contract BONKV1MintContract is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmfHERT4EMwqjxKHCg9xWWMDjdihTMPojNNmWUFgXVhK2o";
    ...
    constructor(
    ) ERC721A("Bonk!", "$BONK", 100, maxSupply) {
    }
