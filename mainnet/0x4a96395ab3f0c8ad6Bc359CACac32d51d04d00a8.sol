...
contract Bobaclub is ERC721Enumerable, Ownable {
  ...
  bool public whitelistEnforced = true;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    // 50% for developer
    (bool os, ) = payable(address(0x2941905BC065726d0b5A9b79eA7AF7B01F96C193)).call{value: address(this).balance * 50 / 100}("");
    // 50% for Team
  ...
  function setMaxMintAmount(uint256 _newmaxMintAmount) public onlyOwner {
    require(_newmaxMintAmount <= 10, "Cannot set higher than 10");
