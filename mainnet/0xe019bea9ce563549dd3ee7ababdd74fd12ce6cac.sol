...
contract BoremonMfers is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmY6NSvbUGJDs7vxYfuigeMmvFc5YNRZK2XSMkDxQfVfp8";
    ...
    constructor(
    ) ERC721A("Boremon Mfers","BM", 100, maxSupply) {
    }
