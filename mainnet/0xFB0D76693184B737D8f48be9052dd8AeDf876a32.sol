...
contract PAJEETNINJA is Context, IERC20, Ownable {
    ...
    string private _name = "PAJEET NINJA";
    string private _symbol = "JEETNINJA";
    ...
    address payable public marketingaddress = payable(0x5d432e8e9B791C1F7B0FAc316826bAF767854853);
