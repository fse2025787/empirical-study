...
// File: contracts/DegenDay.sol

pragma solidity >=0.8.0 <0.9.0;

contract DEGEN_DAY_2022 is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A ( "Degen Day 2022", "LDT" ) {
    setNotRevealedURI( "ipfs://QmPBdACrzQRAusEewVoQgGmgGLWwEP1mQ4FEZvBFffhE5G/1.json" );
  }
...
// ~~~~~~~~~~~~~~~~~~~~ onlyOwner Functions ~~~~~~~~~~~~~~~~~~~~
  ...
  function setMS(uint256 _maxSupply) public onlyOwner {
    maxSupply = _maxSupply;
  }

  // ~~~~~~~~~~~~~~~~~~~~ Burn Function ~~~~~~~~~~~~~~~~~~~~
  // Burn multiple tokens
  function burnTokens(uint _qty) public onlyOwner {
