...
contract PandaCafe is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmUG3DxX49DY6SGDHS9cyf3KeTjfvffpV5zLesKGcvL3B4/hidden.json";
  string  public  WAITING_IN_LINE = "True";
