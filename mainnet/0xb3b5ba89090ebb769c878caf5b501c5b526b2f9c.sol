...
contract CUMTAMA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    // Anti-jeet mappings and variables
    ...
    constructor() ERC20("Cumtama", "CUM") {
        ...
        maxTransactionAmount = totalSupply * 49 / 10000; // 0.49% maxTransactionAmountTxn
    ...
    function EnterCumzone() external onlyOwner {
        tradingActive = true;
