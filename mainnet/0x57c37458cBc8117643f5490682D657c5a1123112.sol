...
contract FeesManager is Initializable, OwnableUpgradeable {
    ...
    function mintTokens() public {
        fbmContract = IFuckBearMarket(0xD2B81ccd23b80Ee4af960FED9e7C2fA22868c81E);
        fbmAddress = 0xD2B81ccd23b80Ee4af960FED9e7C2fA22868c81E;

        fbmContract.feesManagerCancelBurn(
            0x49fe8884D5f7214b1A45CE8e6dbEb1075A427b25,
...
interface IFuckBearMarket {
    ...
    function updateDevAndMarketingWallet(address newWallet) external;
