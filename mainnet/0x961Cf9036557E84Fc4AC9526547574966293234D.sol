...
// Part: OpenZeppelin/ope[email protected]/ERC721Burnable
...
contract Tabaat is Context, AccessControl, ERC721Burnable, ERC721Pausable {
    ...
    function setTokenURI(uint256 tokenId, string memory tokenURI) public {
        require(hasRole(MINTER_ROLE, _msgSender()), "Must have minter role to set token URI");
        _setTokenURI(tokenId, tokenURI);
    }
