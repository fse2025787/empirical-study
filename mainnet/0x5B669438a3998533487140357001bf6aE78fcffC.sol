...
contract Grich is Context, IERC20, Ownable {
    ...
    string private _name = unicode"I hate the christmast";
    string private _symbol = unicode"Grich";
    uint256 public _totalSupply =  2400000000 * 10**_decimals;    
