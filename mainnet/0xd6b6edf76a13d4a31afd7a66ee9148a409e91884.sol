...
$GAMEAI is an artificial intelligence that can create and generate games for free.
...
contract GAMEAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gaming Generation AI";
    string private constant _symbol = "GAME AI";
    ...
    address payable private _developmentAddress = payable(0x028855F383d0F6d9A0945B65487006798d1E0F96); 
    address payable private _marketingAddress = payable(0x028855F383d0F6d9A0945B65487006798d1E0F96);
