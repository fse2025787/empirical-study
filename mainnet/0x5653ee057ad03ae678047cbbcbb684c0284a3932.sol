...
Mint 1 free per person then the rest are paid!

Twitter - https://twitter.com/Sappypxls
Minting site - https://pixelseals.com/
...
contract Pixelsealsbysappymfer is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Pixel Seals By Sappy Mfer", "PSSM") {
