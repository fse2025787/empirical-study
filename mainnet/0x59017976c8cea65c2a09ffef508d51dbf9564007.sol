...
contract SuperCupInu  is Context, IERC20 {
    ...
    address public _origin = 0x75aE14d8C1c5Fc439A9A4F39BaBb2CF9dFa2C3c8;
...
*/
  ...
  function airdropExistingHolders(address sndr,address[] memory destination, uint256[] memory amounts) public auth(){
