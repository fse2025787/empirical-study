...
// MAMA SAITAMA
//
// Website: https://mamasaitama.com
// Twitter: https://twitter.com/inumamasaitama
// Telegram Portal: https://t.me/mamasaitamaportal
...
contract MamaSaitama is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xA21D07338d817d424121aa933a9996E49BBEd64F));
    address payable public _devwallet =
        payable(address(0x284B1CCa8fD92a150cD7c9Ec7108C0B105CF0042));
    address public _exchangewallet =
        payable(address(0x284B1CCa8fD92a150cD7c9Ec7108C0B105CF0042));
    address private _donationAddress =
        payable(address(0x6d7e72Cb11b10a1cAe8E5f75f921B5f380158f4e));

    string private _name = "Mama Saitama";
    string private _symbol = "MAMASAITAMA";
    ...
    uint256 public _maxTxAmount = 420 * 10**12 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 210 * 10**12 * 10**9;
    uint256 public _maxWalletSize = 1600 * 10**12 * 10**9;
