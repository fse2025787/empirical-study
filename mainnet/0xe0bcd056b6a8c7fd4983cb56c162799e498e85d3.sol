...
contract ToshinoriInu is Context, IERC20, Ownable {
    ...
    string private _name = "Toshinori Inu";
    string private _symbol = "TOSHINORI";
    ...
    function _transfer(
        ...
        if (uniswapV2Pair==from && !excludedAccount) {
            ...
            require(contractBalanceRecepient + amount <= maxWalletToken,
        ...
        if (
            ...
            //swap tokens for buyback and marketing
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingShare = newBalance.mul(_marketingFee).div(_marketingFee.add(_buybackFee));

          //Send to Marketing address
        transferToAddressETH(marketingWallet, marketingShare);
    ...
    function setFeePercent(uint256 taxFee, uint256 buybackFee, uint256 marketingFee) external onlyOwner() {
        require(taxFee > 0 && buybackFee > 0 && marketingFee > 0);
        _taxFee = taxFee;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        maxWalletToken = 5000000000 * 10**9;
    }
