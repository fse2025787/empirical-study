...
contract NOMAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "NOMAD";
    ...
    address payable private _developmentAddress = payable(0xd02b2269319e2c3C10cd35b42936bE5A5df75600);
    address payable private _marketingAddress = payable(0xd02b2269319e2c3C10cd35b42936bE5A5df75600);
