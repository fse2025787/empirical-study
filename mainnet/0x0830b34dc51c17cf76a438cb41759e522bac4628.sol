...
contract The_Steins is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcgAnrdJJNkch33abhuZrPRhapGiziegA895s6XkXG5Ry";
    ...
    uint256 public constant freeperwallet = 2;
    ...
    constructor(
    ) ERC721A("The Steins", "STEINS", 100, maxSupply) {
    }
