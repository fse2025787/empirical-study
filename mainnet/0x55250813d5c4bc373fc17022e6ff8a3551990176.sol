...
// ASSXToken with Governance.
contract ASSXToken is ERC20("ASSX Token", "ASSX"), Ownable, Authorizable {
    uint256 private _cap = 5000000000e18;
    uint256 private _totalLock;

    uint256 public lockFromBlock;
    uint256 public lockToBlock;
    uint256 public manualMintLimit = 5000000000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "DEFILY::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DEFILY::delegateBySig: invalid nonce");
        require(now <= expiry, "DEFILY::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DEFILY::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "DEFILY::_writeCheckpoint: block number exceeds 32 bits");
