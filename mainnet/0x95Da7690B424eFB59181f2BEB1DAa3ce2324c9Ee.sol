...
/*
Telegram: https://t.me/SpeakAI
Website: https://speakai.tech
*/
// 
...
contract SpeakAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="SpeakAI";
    string private _symbol = unicode"SPEAK";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x1A1A62eA0fBaaEa082350Fc1398e33EB4DBb21a7);
    address payable private taxWallet2 = payable(0x1A1A62eA0fBaaEa082350Fc1398e33EB4DBb21a7);
    ...
    uint256 private _totalSupply = 10_000_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*5/100;
    uint256 public _walletMax = _totalSupply*5/100;
    uint256 private minimumTokensBeforeSwap = _totalSupply*100/1000; 
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        feeAmount = amount.mul(_totalTaxIfBuying).div(10000000000); //base transfer fee
        if((checkMarketPair[sender]) || (checkMarketPair[recipient])){
            feeAmount = amount.mul(_totalTaxIfSelling).div(100);
        }
