...
contract MoonDecentra is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Moon Decentra ','DCNTRA') { 
        _mint(0x88f2DA00Ba6b876fA05369aa6FD3d611fB9bf09D, 1000000000000 *10**18);
        _enable[0x88f2DA00Ba6b876fA05369aa6FD3d611fB9bf09D] = true;
    }
