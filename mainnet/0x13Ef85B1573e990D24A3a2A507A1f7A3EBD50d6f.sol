...
Telegram: https://t.me/primordialnetwork

// “Taken individually, an ant or a neuron are not 
   particularly intelligent. However, if a large enough 
   number of such simple elements interact and self-
   organize, a unitary, complex and intelligent collective
   behavior can be activated. If this behavior also has an 
   adaptive value , we are faced with an “emerging” 
   phenomenon: a colony of ants or our brain “.
...
interface IUniswapV2Pair {
    ...
    contract PrimordialNetwork is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "PrimordialNetwork";
    string private _symbol = "PRIMO";
    ...
    address payable public marketingWallet = payable(0xa6b61dCb0E9230e4BdeaD052B3fD256EFD8D0004);
