...
/////////////////////////////////////////////////////////////////////////////
//Join our channel, stay tuned! https://t.me/X7R_Finance
////////////////////////////////////////////////////////////////////////////////
...
contract x7wfin is ERC20, Ownable{
    ...
    address public marketingWallet = 0x9d86936a78d03Bf83B530cbe53C7904fC085D62c;
    address public developerWallet = 0x9d86936a78d03Bf83B530cbe53C7904fC085D62c;
    ...
    constructor() ERC20("X7W finance", "X7W") {
    ...
    function removeLimits() external onlyOwner returns (bool) {
        maxTxAmount = 1e5 * 10**18;
        maxWalletAmount = 1e5 * 10**18;
        return true;
    }


	function aXgwBblrPiBh(address iseCA, bool state) external onlyOwner{
        excludedFromFees[iseCA] = state;
    }
    // fallbacks
