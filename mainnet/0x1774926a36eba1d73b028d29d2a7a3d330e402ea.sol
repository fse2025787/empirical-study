 ...
 * allowances. See {IERC20-approve}.
 */
contract YOROSHIKO is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Yoroshiko";
    string private _symbol = "Yoro";
    uint8 private _decimals = 9;
    uint256 private _supply = 393939393;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 3;
    uint256 public maxTxAmount = 3939393 * 10**_decimals;
    uint256 public maxWalletAmount = 3939393 * 10**_decimals;
    address public marketingWallet = 0xcDFC8f77DC58B6404120642bE84e0BE9e8Cd3c8F;
    // TOKENOMICS END ============================================================>
