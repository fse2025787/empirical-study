...
/*
   ...
   Space Warfare is a simple strategy game where 
   the player builds mines and 
   factories on conquered planets. 
   Battles with the enemy, construction 
   and movement of ships are carried 
   out automatically.
   We are adding P2E element in upcoming months.
...
contract SpaceWarfare is Context, IERC20, Ownable {
