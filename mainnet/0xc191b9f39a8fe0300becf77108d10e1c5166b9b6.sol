...
contract MintySwap is ERC721 {
    ...
    constructor (string memory name, string memory symbol, string memory tokenURIPrefix, address _transferProxy) ERC721 (name, symbol, _transferProxy){
