...
contract XFILES is Context, IERC20, Ownable {
    ...
    string private constant _name = "X-Files";
    string private constant _symbol = "xFiles";
    
    address public marketingWallet = 0x0830A031fFc0e3E34B0d168b77d30859f9f7eC30;
    ...
    Taxes public buyTaxes = Taxes(0,1,0);
