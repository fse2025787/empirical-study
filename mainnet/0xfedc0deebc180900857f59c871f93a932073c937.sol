...
contract X7m69 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf3be917E9Dd66A751159Bfe4e1C3284B07240f50); 
    address payable public Wallet_Team = payable(0xf3be917E9Dd66A751159Bfe4e1C3284B07240f50);
    ...
    string private constant _name = "X7m69"; 
    string private constant _symbol = unicode"X7m69"; 
    ...
    constructor () {
        ...
        _owner = 0xE3Ab4a737fC7A5370e50015e5aCEd8Ffba03c346;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xf3be917E9Dd66A751159Bfe4e1C3284B07240f50); // Testnet
