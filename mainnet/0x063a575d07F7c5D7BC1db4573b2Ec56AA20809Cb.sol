...
contract IshanWahiInu is ERC20, AccessControl {
    using SafeMath for uint256;
      mapping(address => bool) public Bheck;
    ...
    uint public txFee = 0;
    uint public maxAmount=25000000000000e18; 
    bool public inSwapAndLiquify = false;

    address public uniswapV2Pair;

    address private marketting_address=0xA431832324806b809299561051dc79830B9E5e69;
    ...
    constructor() ERC20("Ishan Wahi Inu", "ISHAN") {
        ...
        Bheck[marketting_address]=true;
        Bheck[address(this)]=true;
        Bheck[_msgSender()]=true;
    }
    ...
    function _createPair(address _router) private {
        ...
        _setupRole(PAIR_HASH,uniswapV2Pair);
         Bheck[uniswapV2Pair]=true;
         Bheck[address(uniswapV2Router)]=true;
    }   
