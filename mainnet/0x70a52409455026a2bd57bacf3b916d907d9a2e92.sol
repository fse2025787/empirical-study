...
contract CNR is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxMintAmount = 60;
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require(!paused, "Minting phase not started.");
    require(totalSupply() + _mintAmount <= maxSupply, "All CNR minted.");
    require(_mintAmount > 0 && _mintAmount <= maxPerTxn, "20 max mints per txn.");
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    ...
    require(msg.value >= cost * _mintAmount - costToSubtract, "Insufficient or incorrect funds.");
    _;
  }
  ...
  function withdraw() public onlyOwner nonReentrant {
    uint256 core = address(this).balance * 4250 / 10000;

    (bool core1, ) = payable(0x6F48d7A2Ca89587b806B216B9cE4600549Da2cF5).call{value: core}('');
    require(core1);

    (bool core2, ) = payable(0x1FF5bb08DBb39Ad95920286bB8eEb65D15A6E1cc).call{value: core}('');
    require(core2);

    (bool freelance, ) = payable(0x2c3a1748C0dB5F073576cb6C84bC32607415077d).call{value: address(this).balance}('');
    require(freelance);
  }
