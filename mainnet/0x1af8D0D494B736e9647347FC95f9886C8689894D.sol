...
contract TokenAuction is Exponential, TokenErrorReporter {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        /* Check if auction is allowed by mtroller. For collection offers only check if mToken is listed. 
           For specific offers allow instant sale if offer >= asking price */
    ...
    */
    ...
    /**
        ...
        offers for that _mToken and any active offers for the whole collection. Should only be called by 
        the _mToken contract, not the user directly. 
    */
        ...
        returns (address _maxOfferor, uint256 _maxOffer, uint256 auctioneerTokens, uint256 oldOwnerTokens)
    {
        ...
        /* check for and handle highest collection or specific offer */
