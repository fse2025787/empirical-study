...
contract AIDAO is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "Artificial Intelligence DAO";
    string private constant _Symbol = "AIDAO";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e12 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0xe0Dc62a20B91c87D5a83FBe7D6346b76084652be);
        treasuryAddress = payable(0xe0Dc62a20B91c87D5a83FBe7D6346b76084652be);
