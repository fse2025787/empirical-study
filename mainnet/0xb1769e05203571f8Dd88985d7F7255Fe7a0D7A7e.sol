...
contract TheBlackHole is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Black Hole";
    string private constant _symbol = unicode"$HOLE";
