...
contract HasbullaYachtClub is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Hasbulla Yacht Club", "HBYC") {
  ...
  function Hasbullish (uint256 _mintAmount) public payable nonReentrant callerIsUser{
