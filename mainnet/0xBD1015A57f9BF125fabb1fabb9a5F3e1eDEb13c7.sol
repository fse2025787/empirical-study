...
contract GoldenPunkz is IERC721A { 
    ...
    string private constant _name = "Golden Punkz";
    string private constant _symbol = "GOPUNKZ";
    string private _contractURI = "QmQY5h4P4ZLuBM1ueex35TB8riNLBEZqPhFBqV36g8zDVP";
    string private _baseURI = "QmNTENCYUwFoSAKadv9iqhwWj5y9VvTnqUxiDLKj7XDGu7";
    ...
    function freeMint() external{
        ...
        require(totalSupply() + amount <= MAX_FREE_SUPPLY, "Freemint Sold Out");
