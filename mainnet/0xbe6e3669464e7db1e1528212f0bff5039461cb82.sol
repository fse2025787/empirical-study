...
contract WickedApes is Ownable, ERC165, ERC721 {
    // Libraries
    ...
    constructor() ERC721("Wicked Apes", "WKDAPE") {
        _setBaseURI(
            "https://us-central1-wicked-apes.cloudfunctions.net/app/v1/"
        );
        ownerMint(20);
    }
    ...
    function withdraw() external {
        require(
            msg.sender == 0x61ddb27eF08006D23a50283d334CCE1D74faCa4D ||
                ...
                msg.sender == 0x8f4e56e3F90Bc938E6Ea9861f94BE2D56fc95db1
        );

        uint256 bal = address(this).balance;

        uint256 fifteen = bal.mul(15).div(100);
        payable(address(0x8f4e56e3F90Bc938E6Ea9861f94BE2D56fc95db1)).call{
            value: fifteen
        }("");

        uint256 two = bal.mul(2).div(100);
        payable(address(0xda6776bfbA3252E6720911c4ed6a317e98d4954F)).call{
            value: two
        }("");

        uint256 eight = bal.mul(8).div(100);
        payable(address(0x3AD232dDE2e84b782e2Ff044C6e3832Eb9e78A21)).call{
            value: eight
        }("");

        uint256 twentyfive = bal.mul(25).div(100);
        payable(address(0xF1e000b6fE51AeD56a8d162A95B0C7A8a7511922)).call{
            value: twentyfive
        }("");

        uint256 twentyfive2 = bal.mul(25).div(100);
        payable(address(0xd880e1494bfBE60f221B8a8506b5a1959c36127C)).call{
            value: twentyfive2
        }("");

        uint256 twentyfive3 = bal.mul(25).div(100);
        payable(address(0x61ddb27eF08006D23a50283d334CCE1D74faCa4D)).call{
            value: twentyfive3
        }("");
    ...
    function emergencyWithdraw() external {
        require(msg.sender == 0x8f4e56e3F90Bc938E6Ea9861f94BE2D56fc95db1);
        (bool success, ) = payable(0x8f4e56e3F90Bc938E6Ea9861f94BE2D56fc95db1)
