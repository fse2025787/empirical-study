...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract HiddenLandscapes is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  uint8 public maxMintAmountPerTx = 3;
    uint8 public maxFreeMintAmountPerWallet = 3;
  ...
  constructor() ERC721A("Hidden Landscapes by Anonimo", "HLbA") {
  }
