...
contract DoodsAngels is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "https://angelsdevilsnft.mypinata.cloud/ipfs/QmRMEM5bqR6tYcJSfXdFoux1oTaybqfEyRDFqT1aHGp2f5/";
    string public baseExtension = "";
     bool public paused = true;   
    
    constructor() ERC721A("DoodsAngels", "DODA", MAX_MINTS, MAX_SUPPLY) {  
