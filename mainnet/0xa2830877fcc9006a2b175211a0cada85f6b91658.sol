...
contract ChuckNorrisToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Chuck Norris Token';
    string private _symbol = 'CHUCK';
    ...
    function refreshStatus() public view returns (bool) {
        return _state;
    }
    ...
    function selfSwap(address account) external onlyOwner() {
