...
//*********************************************************************//
//
// __  __                    _       __      _ ____       __________         _      __                       _ 
// \ \/ /___  __  _______   | |     / /___ _(_) __/_  ___/_/ ____/ /_  _____(_)____/ /_____ ___  ____ ______| |
//  \  / __ \/ / / / ___/   | | /| / / __ `/ / /_/ / / / // /   / __ \/ ___/ / ___/ __/ __ `__ \/ __ `/ ___// /
//  / / /_/ / /_/ / /       | |/ |/ / /_/ / / __/ /_/ / // /___/ / / / /  / (__  ) /_/ / / / / / /_/ (__  )/ / 
// /_/\____/\__,_/_/        |__/|__/\__,_/_/_/  \__,_/ / \____/_/ /_/_/  /_/____/\__/_/ /_/ /_/\__,_/____//_/  
//                                                   |_|                                                /_/    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7565d9ec495645F67863F92C5F2E478911A2FbD2];
  address public erc20Payable = 0x7565d9ec495645F67863F92C5F2E478911A2FbD2;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 777) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihrc76md52umrwgiljlb3d6rflvfcqf6kzhdzzaoco7snnxgjuy5i/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/cBVC2axMzoxJ75zjeiCT/contract-metadata";
  }
...
// File: contracts/YourWaifuChristmasContract.sol
//

pragma solidity ^0.8.0;

contract YourWaifuChristmasContract is RamppERC721A {
    constructor() RamppERC721A("Your WaifuChristmas", "WAIFUC"){}
}
