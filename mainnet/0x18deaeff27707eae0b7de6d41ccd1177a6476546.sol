...
contract WantedU is ERC721A, DefaultOperatorFilterer, Ownable {

    mapping (address => bool) public minterAddress;
    bool public mintIsOpen;
    string public baseURI = "ipfs://bafybeigokrkjhxk6jisteaffengwuhjuldsyod6ptievfdzflqhzkrebqi/";  
    string public baseExtension = ".json";
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 3500;
    uint256 public maxPerTransaction = 10; 
    uint256 public maxFree = 3500; 
    ...
    constructor () ERC721A("WantedU Official", "WU") {
        mintIsOpen = false;
    }
