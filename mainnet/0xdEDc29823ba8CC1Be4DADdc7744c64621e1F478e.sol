...
contract EthereumWhales is ERC721A, DefaultOperatorFilterer {
    ...
    string uri = "ipfs://QmcH9nthNotYk5CSH7qivMSrEte9RhtpCWQ3w9vGw7r9v3/";
    ...
    function _mint(uint256 amount, uint256 total) internal {
        if (msg.value == 0) {
            uint256 num = (maxSupply - total) / 1000 + 1;
    ...
    constructor() ERC721A("Ethereum Whales", "WHALE") {
        owner = msg.sender;
    }
