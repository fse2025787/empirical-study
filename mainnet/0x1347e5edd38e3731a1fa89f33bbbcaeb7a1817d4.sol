...
contract BurnerBoy is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Burner Boy";
    ...
    address payable private _developmentAddress = payable(0x35bF12f2AffF3b6f04737B2abc87B6fA357DCd99); 
    address payable private _marketingAddress = payable(0x35bF12f2AffF3b6f04737B2abc87B6fA357DCd99); 
