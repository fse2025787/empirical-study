...
contract Burnie is Context, IERC20, Ownable {
    ...
    string private _name = "Burn Token";
    string private _symbol = "BURNIE";
    ...
    // limit
    uint256 public _maxTxAmount = 500000 * 10**2 * 10**9; //1.5% after 50% burn
