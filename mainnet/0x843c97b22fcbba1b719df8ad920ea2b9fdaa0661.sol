...
DAYUM, you are looking hot today. 
DAYUM, nice car you have there.
DAYUM, your mum is hot.
DAYUM, the food is good.
DAYUM, the taxes are low.
How many dam times you wanna say DAYUM? 
DAYUMMMMMM, you are fucking good on bed.

Your friendly neighbour hood dev here dayummm lmao. Peace out, enjoy this dayummm fork.
**/
...
contract DAYUM is ERC20, Ownable {
    ...
    constructor() ERC20("DAYUM", "DAYUM") { 
        ...
        uint256 totalSupply = 1 * 10 ** 12 * 10 ** decimals(); // 1 trillion total DAYUM
