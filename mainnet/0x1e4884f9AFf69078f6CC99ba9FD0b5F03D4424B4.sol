...
/*
*
* Vitalik is cracking the toughest blockchain problems to make us filthy rich
*
*/
...
contract VCERC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vitalik on Crack";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0 && _buyCount > 24) {
