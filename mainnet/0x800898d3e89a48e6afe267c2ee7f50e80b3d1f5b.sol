...
contract BirdsWereReal is Context, IERC20, Ownable {
    ...
    string private constant _name = "Birds Were Real";
    string private constant _symbol = "BWR";
    uint256 public _maxTxAmount =   30000 * 10**_decimals;
    uint256 public _maxWalletSize = 30000 * 10**_decimals;
    uint256 public _taxSwap = 90000 * 10**_decimals;
