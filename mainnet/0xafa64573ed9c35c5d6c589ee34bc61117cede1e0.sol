...
contract OrionProtocol is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**7 * 10**DECIMALS; // 100
    uint256 public gonMaxWallet = TOTAL_GONS.div(100).mul(2); // 2%
    ...
    uint256 private gonSwapThreshold = (TOTAL_GONS * 10) / 2000;
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
    ...
    constructor() ERC20Detailed("Orion Protocol", "OP", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x3FEEb66369F95eCee463a5B60C968900872A9976;
        marketingFeeReceiver = 0xAEfBC097cE671Fd8183a7f420A2f990F6b686ce3;
        ecosystemFeeReceiver = 0x3FEEb66369F95eCee463a5B60C968900872A9976;
        buyBackFeeReceiver = 0x3FEEb66369F95eCee463a5B60C968900872A9976;
