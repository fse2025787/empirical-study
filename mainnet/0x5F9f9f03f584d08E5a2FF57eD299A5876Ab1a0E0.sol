...
Fuck LIGMA JOHNSON - COME AND LIGMABALLZZ                                       
...
contract LIGMABALLZ is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "LIGMABALLZ";
 string private _symbol = "LIGMABALLZ";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xDbA04d6FDa36E60D48433ebDF1574c0D838617D5);
 ...
 uint256 LIGMABALLZDaycooldown = 0;
 ...
 //Tokenomics related functions
  function LIGMABALLZDay() public onlyOwner{
      require(block.timestamp > LIGMABALLZDaycooldown, "You cant call LIGMABALLZCoinDay more than once a day");
 ...
 function LIGMABALLZCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      LIGMABALLZDaycooldown = block.timestamp + 86400;
 }
