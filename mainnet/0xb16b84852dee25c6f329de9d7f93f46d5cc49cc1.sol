    ...
    ERC2981
{
    ...
    constructor(string memory baseUri) ERC721A("BabyRektGuy", "BRG") {
    ...
    function airdrop(address to, uint256 mintAmount)
        public
        canMint(mintAmount)
        onlyOwner
    {
    ...
    function setIsSaleActive(bool isSaleActive) external onlyOwner {
