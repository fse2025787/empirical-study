...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x44ca03ce4e5Fb088Aad2a98b38126672dE2F4909,0x57020cD5c6b4b7a94d4AC70d447706788cf4e100];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x44ca03ce4e5Fb088Aad2a98b38126672dE2F4909;
  uint256[] public payableFees = [0,50,50];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.04 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 7777) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmbo2ficRXQbo54WF8nJzrqzbo6Vwr7P35cXhKbyaZ4sWx/";
...
// File: contracts/SneakerboxnftContract.sol
//

pragma solidity ^0.8.0;

contract SneakerboxnftContract is RamppERC721A {
    constructor() RamppERC721A("SNEAKERBOX NFT", "SBNFT"){}
}