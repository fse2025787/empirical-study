...
Token Name: Samanosuke 
Ticker: Tenkai
Supply : 1,000,000
Max buy at launch is 1% = 10000    
TAX: 5%
Telegram address: https://t.me/TenkaiERC20
...
contract Tenkai is Context, IERC20, Ownable {
    ...
    string private constant _name = "Samanosuke"; //
    string private constant _symbol = "Tenkai"; //
    ...
    uint256 private maxWalletAmount = 10001 * 10 ** _decimals;
    uint256 private maxTxAmount = 10001 * 10 ** _decimals; 
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x15C9B22F877aC8243e9FE66b8708a7D5ADF188Dd); //wallet
