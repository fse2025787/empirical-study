...
// File: contracts/prod_ic/ETH_IndexxCrypto.sol
...
/**
 * @title IndexxCrypto token
 * @notice Asset backed BEP20 Token with pausable, mintable and burn features
 * @notice Pegged to Top 20 Crypto Tokens Index Price
 */
contract IndexxCrypto is ERC20, ERC20Burnable, Pausable, AccessControl {
     ...
     */
    constructor() ERC20("IndexxCrypto", "INXC") {
