...
TRG INU is a meme token inspired by  
@theruggame. Create a INU DAO for $TRG.

Twitter: https://twitter.com/TRG_INU
TG: https://t.me/TRG_INU
...
contract TRGINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TRG INU";
    string private constant _symbol = unicode"TRG INU";
