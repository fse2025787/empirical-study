...
/**
 * 
WOJAK INU- Experience the thrill and excitement of betting on your favourite players and win with them
...
contract WOJAKINU is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WOJAK INU";
    string constant _symbol = "WI";
    ...
    address payable public liquidityFeeReceiver = payable(0x4f564B587687e3eb1C3F4Dc9e55BB8635b619825);
    address payable public marketingFeeReceiver = payable(0x4f564B587687e3eb1C3F4Dc9e55BB8635b619825);
