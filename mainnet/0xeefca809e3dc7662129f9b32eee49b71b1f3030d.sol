...
/**
 *
 channel : https://t.me/DigiShibi

 website : http://www.digishibi.com/
*/
...
contract DigiShibi is IERC20, Auth {
	string constant _name = "DigiShibi"; 
	string constant _symbol = "SHIBI"; 
	...
	constructor() Auth(msg.sender) {
		...
		_balances[0x19E0286B8dBE71D14Fc854037Ac1C556Ad71651a] = _totalSupply;
		emit Transfer(address(0),0x19E0286B8dBE71D14Fc854037Ac1C556Ad71651a, _totalSupply);
	}
	...
	function _openTrading(uint256 blks) internal {
		lim_maxTxAmount     = 900 * _totalSupply / 10000 + 10**_decimals; 
		lim_maxWalletAmount = 900 * _totalSupply / 10000 + 10**_decimals;
		fee_taxRateBuy = 0;
		fee_taxRateSell = 0;
