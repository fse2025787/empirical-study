...
interface IMasterChef {
    ...
    function pendingTaal(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/TaalVault.sol

pragma solidity 0.6.12;

contract TaalVault is Ownable, Pausable {
    ...
    event Pause();
    event Unpause();
    event SetAdmin(address indexed sender);
    ...
    event SetWithdrawFee(uint256 _withdrawFee);
    event SetWithdrawFeePeriod(uint256 _withdrawFeePeriod);
