...
contract TigerQueen is ERC20, Ownable {
    ...
    uint256 public maxBuyTxAmount = 12 * 10**11 * (10**18);
    uint256 public swapTokensAtAmount = 5 * 10**8 * (10**18);
    ...
    constructor() public ERC20("TigerQueen", "TQUEEN") {
    ...
    function _transfer(
        ...
        if(
            ...
            uint256 swapTokens = contractTokenBalance.mul(25).div(1000);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        payable(0x22f350646C505c7FA33F9bDaC841950179B47Ca3).transfer(address(this).balance);
    }
