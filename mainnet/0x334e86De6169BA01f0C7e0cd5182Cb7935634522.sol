...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  uint256 internal constant PRICE = 5000000000;
...
contract OctopusPrime is Context, ERC721Tradeable {
  using SafeMath for uint256;
  using SafeMath for int256;
  using Counters for Counters.Counter;

  address payable payableAddress;
  constructor(address _proxyRegistryAddress) ERC721Tradeable("OctopusPrime", "OCTP", _proxyRegistryAddress) {
    _baseTokenURI = "ipfs://bafybeidqfmjy6vhhgdy6rds2brs75kiralyfqte43mc77aubaatwjh3wva/";
    payableAddress = payable(0xaB6EE6cA327494aCC0587058849e9f1C8760eb66);
  }
    ...
    function contractURI() public pure returns (string memory) {
      return "ipfs://bafkreicjwbiy3wtjyzl2bicgx6kd56hqui7fc4p4dvdsttehvzzymnu33q";
    }
