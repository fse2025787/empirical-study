...
contract LucidGarden is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x84aCB033082F968e64505cdCb899edD83add1018));

    string private _name = "LucidGarden";
    string private _symbol = "LucidGarden";
