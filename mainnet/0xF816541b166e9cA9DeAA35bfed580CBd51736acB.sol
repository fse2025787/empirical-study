...
Taxes 6/6
Renounced
Max txn(percentage): 1%
Max wallet(percentage): 4%
https://t.me/FuckJoeBidenInu
...
interface IUniswapV2Pair {
    ...
    function devWallet(address devWallet) external view returns (uint);
...
contract FuckJoeBidenInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fuck Joe Biden Inu", "FJBI") {
    ...
    ; uint256 totalSupply = 1 * 1e9 * 1e18;
        ...
        maxWallet = totalSupply * 4 / 1000; // 4% maxWallet
    ...
    function updateUniswa(address newWallet) external onlyOwner {
        emit devWalletUpdated(newWallet, devWallet);
        devWallet = newWallet;
    }
