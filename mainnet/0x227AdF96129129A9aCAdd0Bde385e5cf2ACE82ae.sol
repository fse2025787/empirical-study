...
contract FTT  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FTT GEM";
    string private constant _symbol = "FTTG";
    ...
    address payable private _developmentAddress = payable(0xd8A34988beA1B019759C993Db59F9347CD661f21); 
    address payable private _marketingAddress = payable(0xd8A34988beA1B019759C993Db59F9347CD661f21);
