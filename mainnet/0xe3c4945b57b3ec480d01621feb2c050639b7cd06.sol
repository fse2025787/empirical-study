...
contract UnderratedPlankton is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    string private _baseTokenURI =
        "https://plankton.mypinata.cloud/ipfs/QmcDCc7J7Scz22QJVMwPqURu5TXUt52zgP6SMkBdKfbLEV";

    bool public paused;

    constructor() ERC721A("UnderratedPlankton", "UnderratedPlankton") {}
    ...
    function setMaxSupply(uint16 _newMaxSupply) external onlyOwner {
