...
contract NAAS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NodeService", "NAAS") {
        ...
        marketingWallet = address(0x1Ee0C48d1a632B4Ba5eEDde71AE4cFd64834070E); // set as marketing wallet
        devWallet = address(0x1Ee0C48d1a632B4Ba5eEDde71AE4cFd64834070E); // set as dev wallet
