...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x37e1e77aBf6AE8F49abB0EAE13385D27ba7f79C8];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 16 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWc7WnjFrveWXfCwjvqBqpgfCw5URLz4aXXHrde93EiPX/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 16");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 16");
...
// File: contracts/BlottenContract.sol
//

pragma solidity ^0.8.0;

contract BlottenContract is RamppERC721A {
    constructor() RamppERC721A("BLOTTEN", "BLT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Xjml35EpzCN2cRqmwl8P/contract-metadata";
    }
}
