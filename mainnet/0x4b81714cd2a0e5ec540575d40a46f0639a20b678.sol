...
// File: contracts/StrangeMeInNFT.sol
...
contract RareApepeGrlzYC is ERC721A, Ownable {
    ...
    uint public MAX_FREE_PER_WALLET = 2;

	bool public isPaused = true;
    bool public isMetadataFinal;
    string private _baseURL = "ipfs://bafybeigf75fku4axlj47ri4glvf7b53dtkwbur2gmcybjqpkkiqsvto5zm/";
	string public prerevealURL = '';
	mapping(address => uint) private _walletMintedCount;

	constructor()
    // Name
	ERC721A('RareApepeGrlzYC', 'RAG') {
    }
    ...
    function setFreeMintNumPerWallet(uint256 _limit) external onlyOwner
    {
