...
//https://medium.com/@KintsugiERC/kintsugi-b443cc7e3347
...
contract kintsugi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Kintsugi";
    string private constant _symbol = "KINTSUGI";
