...
contract HistoryMkr is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, RoyaltiesV2Impl {
    ...
    bool internal mintPaused = true;
    address payable public treasurer;
    uint16 internal royaltyPercentageBasePoints = 400; //4%
    uint16 internal maxAvailableTokens;
    ...
    function transferNFTs(uint256 num, address recipient) internal {
    ...
    function startMintingProcess(uint256 tokenPrice) public virtual whenMintPaused() onlyOwner {
    ...
    modifier whenMintPaused() {
        require(mintPaused, "minting is not paused");
        _;
    }
