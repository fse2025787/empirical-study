...
contract SEXTRAFFICKER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mark Cohen Inu", "MCI") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xcB78bEdDc11796b30E09a2198f5d1336d9ffc7bf); // set as Marketing wallet
        DevWallet = address(0xcB78bEdDc11796b30E09a2198f5d1336d9ffc7bf); // set as dev wallet
