...
contract LiquidFinance is IERC20, Auth {
	string _name = "LiquidFinance";
	string _symbol = "LIQUID";
	...
	address payable private _ethTaxWallet1 = payable(0xe93219Dd6eC6c1A9251D5B8236242c73929bEF5B); 
	address payable private _ethTaxWallet2 = payable(0xe93219Dd6eC6c1A9251D5B8236242c73929bEF5B); 
	address payable private _ethTaxWallet3 = payable(0xe93219Dd6eC6c1A9251D5B8236242c73929bEF5B); 
	address private _tokenTaxWallet = address(0x5A5803CFfe6EB0C41903Be30FdDc6184eaEc3C4B); 
	...
	constructor () Auth(msg.sender) {      
		...
		_taxSwapMax = _totalSupply * 500 / 10000;
