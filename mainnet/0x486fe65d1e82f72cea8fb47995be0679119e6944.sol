...
contract HIMARI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Sun Flower";//
    string private constant _symbol = "\x48\x69\x6d\x61\x72\x69\x20\xe6\x97\xa5\xe5\x92\x8c";//
    ...
    uint256 private constant _tTotal = 8888888888888 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x5E253cB564cE51Cf2a7Ff21531E362d813a9C666);//
    address payable private _marketingAddress = payable(0x5E253cB564cE51Cf2a7Ff21531E362d813a9C666);//
    ...
    uint256 public _maxTxAmount = 88888888888 * 10**9; //
    uint256 public _maxWalletSize = 88888888888 * 10**9; //
    uint256 public _swapTokensAtAmount = 8888888888 * 10**9; //
