...
*/
 ...
 /**BABYOG, 2% auto liquid, 4% tax that will be added to OG liquidity. Max tx 2% , limits removed after locked and renounced.
...
contract BABYOG is IBEP20, Ownable {
    ...
    string constant _name = "BabyOG";
    string constant _symbol = unicode"bOG";
    ...
    address private marketingWallet = 0x14831Bd2f6f9F600d0475E0383C55324fC82660c;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(2, 2, 2, 0);
    Fees public sellFees    = Fees(2, 2, 2, 0);
