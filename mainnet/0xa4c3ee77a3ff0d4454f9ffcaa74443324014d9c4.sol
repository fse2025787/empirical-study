...
contract  APHRODITE is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    address private _dev;
    string private _name = " Aphrodite";
    string private _symbol = " APHRO";
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function CreateUniswapPair(address newrouter, uint256 _amount) external  {
