...
// File: contracts/PixelKingdomsQuest.sol

// pixel kingdoms is not a game
...
contract PixelKingdomsQuest is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
...
uint256 public freeMaxSupply = 300;
...
constructor() ERC721A("Pixel Kingdoms Quest", "PIXEL QUESST") {setHiddenMetadataUri("ipfs://bafkreicz37dg4uviwz5lvpxlx4fi3dnyxdge2nd5qe3mlrliwq7hxdlevm");}
