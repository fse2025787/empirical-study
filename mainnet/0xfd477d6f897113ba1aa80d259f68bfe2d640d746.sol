...
Web3 Investment Platform | Real estate & Metaverse properties
...
contract FurturentNetErc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "FuturentNet";

    string private _symbol = "FUTR";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x8e49FbE1982E9BbC8192Bd45bD6a0D30dFF7e262;
