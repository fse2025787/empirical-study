...
contract BondDepositoryYFI is Ownable {
    ...
    constructor ( 
        ...
        DAO = _DAO;
        priceFeed = AggregatorV3Interface(0xA027702dbb89fbd58938e4324ac03B58d812b0E1);
    }
    ...
    function setMinPayout(uint256 _newMinPayout) external onlyPolicy() {
    ...
    function bondPriceInUSD() public view returns ( uint price_ ) {
        price_ = bondPrice().mul( uint( assetPrice() ) ).mul( 10 ** 4);
    }
    ...
    function standardizedDebtRatio() external view returns ( uint ) {
        return debtRatio().mul( uint( assetPrice() ) )/ 10**priceFeed.decimals(); 
    }
