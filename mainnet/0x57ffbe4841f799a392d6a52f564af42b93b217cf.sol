...
contract ShibaSnack is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'ShibaSnack';
    string private constant _symbol = 'ShibaSnack🦴';

    uint256 private _taxFee = 900;
    uint256 private _burnFee = 0;
    uint public max_tx_size = 100000000000000 ether;
