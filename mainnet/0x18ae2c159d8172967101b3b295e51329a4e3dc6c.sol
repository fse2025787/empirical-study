...
contract BoredApeDoodlesClub is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    ) ERC721A("Bored Ape Doodles Club", "BADC") {
        PRICE = price;
    ...
    address private constant payoutAddress1 =
        0xA9a2037B0E9D234E8818bB7C280D2DcdB18F165B;
