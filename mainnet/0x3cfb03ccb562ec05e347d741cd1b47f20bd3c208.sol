...
contract Picasso_townAI is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYf63T1HMfuDEnCNUyFRNNHPeVN4m5zhHu6ZKJDDJGe7D/";
    ...
    constructor(
    ) ERC721A("Picasso townAI", "Picasso tAI", 100, maxSupply) {
    }
