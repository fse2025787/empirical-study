...
contract Glider is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sugar Glider", "Glider") {
        ...
        marketingWallet = address(0x3365a4b659D943605638A313C9f7a062FCCa9108); // set as marketing wallet
        devWallet = address(0x3365a4b659D943605638A313C9f7a062FCCa9108); // set as dev wallet
