...
Welcome to 🎃 $PUMPKING 👑
If it's not obvious from the ticker already, $PUMPKING is the king of PUMP. 

We all love pumpkins. We all love a good pump. 
Mr. 🎃 $PUMPKING 👑 is the ultimate combination, the king of pumpkins and the king of PUMPing the markets! 
He is now here to pump the crypto market, by setting a new cool meta with a pure old school memecoin that will be purely driven by the community.

Telegram: https://t.me/pumpkingeth
Website: https://pumpking.space
...
contract PUMPKING is Context, IERC20, Ownable {
    ...
    string private constant _name = "PUMPKIN(G)";
