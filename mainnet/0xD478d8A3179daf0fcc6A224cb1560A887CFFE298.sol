...
/*
            "Inugami may be feared for their power and strength, 
    but they also embody determination and the courage to overcome any challenge. 
        Let their fierce spirit inspire you to face your own struggles 
                     with resilience and never give up."

https://t.me/InugamiInu
https://twitter.com/Inugamiinu
https://medium.com/@InugamiERC/inugami-erc20-stealh-launch-c1fb541dcbc7
...
contract Inugami is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x382164C0690421f9E90E6616e9A0752F1B9CA21c; 
    address internal constant marketing_receiver = 0x382164C0690421f9E90E6616e9A0752F1B9CA21c;
    address internal constant liquidity_receiver = 0x382164C0690421f9E90E6616e9A0752F1B9CA21c;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        tradeCheck(sender, recipient);
        maxBagCheck(sender, recipient, amount); 
    ...
    function tradeCheck(address sender, address recipient) internal view {
    ...
    function maxBagCheck(address sender, address recipient, uint256 amount) internal view {
