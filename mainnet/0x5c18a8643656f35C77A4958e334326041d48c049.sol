...
/**
YOUVE WATCHED THE MOVIE YOU KNOW HOW IT WORKS!
BUY AND HODL AND LETS REK THE JEETS!
0% TAX ON ALL TX AND LP BURNT WITH CONTRACT RENOUNCED
COMMUNITY LED PROJECT WE ADVISE TO MAKE SOCIALS AND TG BUT PLEASE BE RESPECTFUL IN DOING SO.
...
contract WOLFOFWALLSTREET is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'WOLF OF WALL STREET';
    string private constant _symbol = '$BEAUFORT';
