...
contract Hoopers is Ownable, ERC721 {
    
    uint public tokenPrice = 0.01 ether;
    uint public presalePrice = 0.008 ether;
    uint constant maxSupply = 3000;
    ...
    uint public maxPerWallet = 10; //Max Limit for Presale
  
         
    constructor() ERC721("DeFi Hoopers", "Hoopers"){}
   ...
   function presale(uint _count) public payable{
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 31 / 100);
        payable(0xD803C759bd2f732427b1502b28b1359E7169124C).transfer(_balance * 31 / 100);
        payable(0x08437675f35528b8a96DFaE2644F0aB872fd2Af6).transfer(_balance * 31 / 100);
        payable(0x2098145E7D5572828209f89FB972568B765605C7).transfer(_balance * 5 / 100);
        payable(0xcFFE6645bec8E2CA0DaDb7c3c07f0b18BAB1bf64).transfer(_balance * 2 / 100);
