...
contract AssassinsNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    setNotRevealedURI("ipfs://Qmdr1bdLhDEcCKkFZvUsahxz6DwujLu4R2mLwWR5xpKSpZ");
    _safeMint(_msgSenderERC721A(), 3);
  }
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(totalSupply() + tokens <= maxSupply - teamreserve, "ASN: We Soldout");
