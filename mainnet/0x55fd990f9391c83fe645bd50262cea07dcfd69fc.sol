...
Akirameruna is the Japanese term for NEVER GIVE UP! This token is for everyone who has feels defeated by the crypto space. THIS IS YOUR OPPORTUNITY FOR REDEMPTION!

5% buy; 5% sell. TIME FOR REDEMPTION!!!

Stealth launch - Twitter and Telegram coming soon!
...
contract Akirameruna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Akirameruna";
    ...
    address payable private _developmentAddress = payable(0x249a428996caD330Dad9427D3f971d78314a4c30);
    address payable private _marketingAddress = payable(0x20B2A085AF6DaE3498809F61fc658b060318c5a8);
    ...
    uint256 public _maxWalletSize = 50000000000000 * 10**9; //5
