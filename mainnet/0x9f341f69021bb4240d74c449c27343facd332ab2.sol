...
contract Fisherman is ERC20, Ownable {
    ...
    constructor() ERC20("The Fisherman", "Fisherman") {
        ...
        devWallet = address(0xc2CEF1955bF367791F9bDAEedC57BE54C0aD0426); // set as dev wallet
