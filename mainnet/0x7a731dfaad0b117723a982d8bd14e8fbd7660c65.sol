...
contract Fart is ERC20, Ownable {
    // Basic units
    ...
    function _transfer(
        ...
        // collect tax amount, swap it and send it to owner
    ...
    function lastFart() external {
        require(msg.sender == assteroid, "u cant do this bro");
        _mint(msg.sender, 1 * (10**18));
    }

    function burnFart(address who, uint256 amount) external {
        require(who == msg.sender || msg.sender == assteroid, "cannot burn");
        _burn(msg.sender, amount);
    }

    function setAssteroidAddress(address addy) public onlyOwner {
        assteroid = addy;
