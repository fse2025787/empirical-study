...
// File: contracts/MoonSquirrels.sol
...
contract MoonSquirrels is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerAddress = 6;


  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("MoonSquirrels", "MOONSQUIRRELS") {
    setHiddenMetadataUri("ipfs://Qmc4gSQX98CuioUPxrWNy1vZGTy8hycP1dQSxr21xfS5tu/");
  }

 modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerAddress, "Invalid mint amount!");
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x6A85B8Ca2C38a2DB2d521FfDb156Ea2752c2844b).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
