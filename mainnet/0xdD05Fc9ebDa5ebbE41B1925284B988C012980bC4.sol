...
contract VikingShikoku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Viking Shikoku Inu";
    string private constant _symbol = "VSKI";
    ...
    address payable private _marketingAddress = payable(0xa3fC11ceadCFcb9FA7D1Eedeb7e0a92B0A7e156d);
