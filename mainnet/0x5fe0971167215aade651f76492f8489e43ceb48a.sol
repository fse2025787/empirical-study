...
With the year of the tiger ending, it's not only the song that will get the attention of a lifetime...

🐅 SOCIALS
Telegram: https://t.me/EOTT_eth
Twitter: https://twitter.com//EOTT_eth
...
contract EOTT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Eye of the Tiger";
    string private constant _symbol = unicode"EOTT";
