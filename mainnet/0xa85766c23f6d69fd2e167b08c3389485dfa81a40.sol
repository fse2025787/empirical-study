...
contract StickManERC721 is ERC721Enumerable, Ownable {
    ...
    function famSaleMint(uint8 mintNum, bytes32 hash) public payable {
        ...
        require(msg.value == ((0.06 ether + (_priceIncr * 0.01 ether)) * uint(mintNum)), "ether value incorrect");
    ...
    function preSaleMint(uint8 mintNum, bytes32 hash) public payable {
        ...
        require(msg.value == ((0.07 ether + (_priceIncr * 0.01 ether)) * uint(mintNum)), "ether value incorrect");
        goMint(msg.sender, mintNum);
    }
    ...
    function publicSaleMint(uint8 mintNum) public payable {
        ...
        require(msg.value == ((0.08 ether + (_priceIncr * 0.01 ether)) * uint(mintNum)), "ether value incorrect");
        goMint(msg.sender, mintNum);
    }
