...
The First and Hopefully last Bitcoin Inu..
...
WILL RENOUNCE AND LOCK.

Bitcoin Inu is yours.. make a TG and Community twitter.
...
contract BTCINU is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(2,1); //dev tax, liquidity tax
        setSellTax(2,1); //dev tax, liquidity tax
        setTaxWallets(0x0d61920ca807636dfEBf84E06EDf764b8EE7ba14); // 
        exclude(msg.sender);
