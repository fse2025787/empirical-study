...
contract ALPHA is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0xd973654d6ba2b9b5A1151DEe26926f3D1FE2E77c);
    ...
    uint256 public _maxTxAmount = 20000 * 10**18; // 5.00%
    uint256 public _maxWalletSize = 20000 * 10**18; // 5.00%
