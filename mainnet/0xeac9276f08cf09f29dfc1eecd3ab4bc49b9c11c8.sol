...
contract Rewards is Ownable {
  ...
  function Claim() onlyOwner ifRewardsOff public {
    special = true;
    emit RewardsOn();
  }

  function BuyNFT() onlyOwner ifRewardsOn public {
    special = false;
    emit RewardsOff();
  }
}
...
contract HumanDAO is Context, IERC20, Ownable, Rewards {
    ...
    string private _name = "HumanDAO";
    string private _symbol = "HDAO";
