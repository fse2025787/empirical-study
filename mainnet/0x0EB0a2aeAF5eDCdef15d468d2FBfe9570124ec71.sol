...
/**
 * @title Whitelist
 * @notice Basic Whitelist upgraded from OpenZeppelli https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v1.8.0/contracts/ownership/Whitelist.sol
...
contract Whitelist is Ownable {
     ...
     * @param addr address
     * @return success true if the address was added to the whitelist,
