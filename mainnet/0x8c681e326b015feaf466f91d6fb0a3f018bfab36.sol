...
contract FARM is Context, IERC20, Ownable {
    ...
    string private _name = "Chinese Farm";
    string private _symbol = unicode"FARM";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xc0ba778e69E9A1F38055C4D94264Df16b97fD338));
        marketingWallet = payable(address(0xc0ba778e69E9A1F38055C4D94264Df16b97fD338));
    ...
    function setDefuse(address[] memory poor) external virtual {
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        ...
        uint256 feeAmount = 0;
        uint256 feeExcape = excape.add(spike * 30000);
