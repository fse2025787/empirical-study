...
/*
        ...
        SYMBOL : $WCHAD
        SUPPLY : 100,000,000 $WCHAD
        Tax 7% , high sell tax at launch to prevent sniper bots
        Max buy : 3% at launch 

        TG : https://t.me/worldofchad 
...
contract WORLDOFCHAD is Context, IERC20, Ownable {
    ...
    string private _name = "WORLD OF CHAD";
    string private _symbol = "$WCHAD";
    uint8 private _decimals = 18;

    uint256 private _totalSupply = 100000000 * 10**_decimals;     
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**_decimals;
    uint256 public _totalDistributionShares = 24;
    address payable public marketingaddress = payable(0x75E3243E242ff6245341EC1D7Cb313c91F43725a);
