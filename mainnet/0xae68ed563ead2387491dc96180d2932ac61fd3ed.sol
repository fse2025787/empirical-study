...
contract BeepBeep is ERC20, Ownable{
    ...
    uint256 public maxBuyLimit = 1_500_000 * 10**18;
    uint256 public maxSellLimit = 1_000_000 * 10**18;
    uint256 public maxWalletLimit = 1_500_000 * 10**18;

    uint256 public genesis_block;
    
    address public marketingWallet = 0xA0d44A46073041E8cd442fED6802778B60c95411;
    address public devWallet = 0x391F5cfc8f9DE21ac131842cd0F744D23B50BAbD;
    address public operationWallet = 0xb04148F6956231c3CcA5E9B99de3329D10Ca173F;
    ...
    Taxes public taxes = Taxes(3, 0, 3, 4);
    Taxes public sellTaxes = Taxes(3, 0, 3, 4);
    ...
    constructor() ERC20("BEEP BEEP COIN", "BEEP") {
