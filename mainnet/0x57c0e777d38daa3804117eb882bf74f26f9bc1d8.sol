...
contract APESINERROR is IERC721A { 
    ...
    uint256 public MAX_FREE = 400;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.003 ether;

    string private constant _name = "APES IN ERROR";
    string private constant _symbol = "AIE";
    string private _baseURI = "bafybeiegmwbxthxymvbm7a2i55ap3i2vbhzua6z2sketa4owhyujuppprq";
