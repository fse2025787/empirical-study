...
// File: contracts/Ponzi/PonziNFT/Market.sol
...
contract Market is Ownable, ERC721Holder {
    ...
    function list(address _collection, uint256 _token_id, uint256 _price) public OnlyItemOwner(_collection, _token_id) {
        ...
        emit ItemListed(currentPairId,_collection,_token_id,_price,msg.sender);
    }
    ...
    function updatePrice(uint256 _id, uint256 _price) external {
        ...
        pairs[_id].price = _price;
        emit PriceUpdated(_id, _price);
    }
