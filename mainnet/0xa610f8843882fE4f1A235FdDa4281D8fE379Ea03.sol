...
* ███████║██║██║ ╚═╝ ██║╚██████╔╝██║ ╚████║    ███████║██║  ██║   ██║   
* ╚══════╝╚═╝╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═══╝    ╚══════╝╚═╝  ╚═╝   ╚═╝                                                                       
* twitter: https://twitter.com/Simon_Say_
* website: https://simon-say.com/
*/
...
contract SimonSay is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "SIMON SAY";
    string private constant _symbol = "SIMON";
    ...
    address payable private _developmentAddress = payable(0x14a47efc3878f064c9d6E60494605847b85e8786);
    address payable private _marketingAddress = payable(0x009b8499c1E4552cc24884ed5Cd91FbEac5B0eE3);
