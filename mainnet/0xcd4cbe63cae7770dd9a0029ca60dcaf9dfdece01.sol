...
// File contracts/MadScientists.sol


pragma solidity ^0.8.0;


contract MadScientists is ERC721Enumerable, Ownable {

    using Strings for uint256;

    string public _baseTokenURI;
    uint256 public _price = 0.065 ether;
    uint256 public _presaleprice = 0.055 ether;
    uint256 public _maxSupply = 7777;
    bool public _preSaleIsActive = false;
    bool public _saleIsActive = false;

    address a1 = 0xD8b56A3Bde5f5b870C2caE8f634cA60073F126b7;
    address a2 = 0x54CB35F30e2d69304b9e8260E72ce81613daf07a;


    constructor(string memory baseURI) ERC721("MadScientists", "MADS") {
        setBaseURI(baseURI);
    ...
    function preSaleMint(uint256 mintCount) public payable {
        ...
        require(mintCount <= 7,                    "max_presale_mint_count_exceeded");
        require(balanceOf(msg.sender) <= 7,         "presale_wallet_limit_met");
        require(supply < 1777,                       "max_presale_supply_exceeded");
    ...
    function mint(uint256 mintCount) public payable {
        ...
        require(mintCount <= 12,                    "max_mint_count_exceeded");
