...
contract TsunflowerChaos is ERC721A, Ownable, ERC2981 {
    uint256 public price = .0111 ether;
    
    uint256 public maxPerTransaction = 24;

    uint256 public immutable supply = 303;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x7cc4E967242E1CaD92152d47AE0bB9169e97d553];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x7cc4E967242E1CaD92152d47AE0bB9169e97d553, _royaltyAmount);
    }
