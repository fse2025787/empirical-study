...
contract ISLAND is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = _tTotal / 400; // 1%
    ...
    string private constant _name = "Island Token";
    string private constant _symbol = "ISLAND";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x3e9Ab58068DD9F39BdE22178D190C0857ECcB264);
        teamPoolWallet = payable(0x000000000000000000000000000000000000dEaD);
        ...
        buyFee.autoLp = 2;
        buyFee.teamPool = 1; // used for burning right now, not for team pool
        buyFee.marketing = 7;
        buyFee.tax = 1;

        sellFee.autoLp = 2;
        sellFee.teamPool = 1; // used for burning right now, not for team pool
        sellFee.marketing = 7;
        sellFee.tax = 1;

        excludeFromReward(address(0x000000000000000000000000000000000000dEaD));
        excludeFromReward(_msgSender());
        excludeFromReward(address(0x3e9Ab58068DD9F39BdE22178D190C0857ECcB264));
