...
// Do exactly what is needed to stay in wonderland.

// Living in our world, the believers are the chosen ones to create a new philosophy for the future.

// Only the ones true to themselves and the awakened shall see the light amongst every other in the circle.

// Harbor the truth and follow the way paved for all, for this shall lead to eternal trinity.
...
contract WRBT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The White Rabbit", "WRBT") {
        ...
        marketingWallet = address(0x744c24955CDAE54e505B7BBe2680AD56A169f321); // set as marketing wallet
