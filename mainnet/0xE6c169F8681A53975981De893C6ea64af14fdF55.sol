...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x28cdd2e17589D7960e65bf82424473F720C3c0C2];
  address public erc20Payable = 0x28cdd2e17589D7960e65bf82424473F720C3c0C2;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXn5Rmqv4RgSwNGBdNamv5XCH6sTpypkBg5DppqLDc9hF/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XkCaSwAnLWjE0dxPbCwG/contract-metadata";
  }
...
// File: contracts/QuillingOnesContract.sol
//

pragma solidity ^0.8.0;

contract QuillingOnesContract is RamppERC721A {
    constructor() RamppERC721A("Quilling Ones", "Quilling"){}
}
