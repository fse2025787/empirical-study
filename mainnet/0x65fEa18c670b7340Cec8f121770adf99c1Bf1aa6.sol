...
//*********************************************************************//
//
//     ____   __  ____              ________            ____  __    __   ____                  
//    /  _/  /  |/  (_)_________   /_  __/ /_  ___     / __ \/ /___/ /  / __ \____ ___  _______
//    / /   / /|_/ / / ___/ ___/    / / / __ \/ _ \   / / / / / __  /  / / / / __ `/ / / / ___/
//  _/ /   / /  / / (__  |__  )    / / / / / /  __/  / /_/ / / /_/ /  / /_/ / /_/ / /_/ (__  ) 
// /___/  /_/  /_/_/____/____/    /_/ /_/ /_/\___/   \____/_/\__,_/  /_____/\__,_/\__, /____/  
//                                                                               /____/        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4cD45eB5f8431364d50BE05f500C11e501c9C354,0x9C85b15aF4BAa5983cDC4F898f16E0D49fE06527,0x9267f06997168fF5972Aefa9f76781cA1E3B30EC];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSWwAuKHyr1rXRtoqW9NBiXYse6Pq4z1f3bEJsFPwM8f1/";
...
// File: contracts/IMissTheOldDaysContract.sol
//

pragma solidity ^0.8.0;

contract IMissTheOldDaysContract is RamppERC721A {
    constructor() RamppERC721A("I Miss The Old Days ", "IMTOldDays"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/DEHiIwemoAS7aHKTrKzl/contract-metadata";
    }
}
