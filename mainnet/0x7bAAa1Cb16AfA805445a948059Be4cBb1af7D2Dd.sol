...
Welcome to the bullrun.

3% buy/sell Tax

Will be used for DexTools Trending
*/
...
contract bullrun is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xd0C4386500F40f582B2e05AB74087870684c7183);
    address payable private _marketingAddress = payable(0xd0C4386500F40f582B2e05AB74087870684c7183);
