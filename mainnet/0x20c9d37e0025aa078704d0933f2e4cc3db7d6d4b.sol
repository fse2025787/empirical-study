...
/**
    Okinami Dao ERC Token

    Medium:    https://medium.com/@OkinamiDAO
    Telegram:  https://t.me/okinamidaoeth
...
contract OkinamiDao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x1FDb15F84bCfaBd5F2a2A95378214F54e94d0b3d); // Marketing Address
    address payable public multiSigAddress = payable(0x1FDb15F84bCfaBd5F2a2A95378214F54e94d0b3d); // Marketing Address
    address payable public devAddress = payable(0x1FDb15F84bCfaBd5F2a2A95378214F54e94d0b3d); // Dev Address
    address payable public liquidityAddress = payable(0x1FDb15F84bCfaBd5F2a2A95378214F54e94d0b3d); // Liquidity Address
    ...
    string private constant _name = unicode"Okinami Dao";
    string private constant _symbol = unicode"oDao";
