...
A sanctuary for the neverending meta of Anime!

Anime Pulse will be the home for all the anime tokens that will be deployed on the HEX chain, upon our migration.

APULSE platform will be utilized to help other anime projects with exposure, and only holders of $APULSE will be able to use it!

A pulse that nevers stops beating! - Anime Pulse

Website: https://animepulse.xyz/
Telegram: https://t.me/animepulseeth
Twitter: https://twitter.com/AnimePulseEth
...
contract AnimePulse is Context, IERC20, Ownable {
    ...
    uint256 private startSellFee = 15;
    ...
    string private constant _name = "Anime Pulse";
    string private constant _symbol = "APULSE";
    ...
    constructor () {
        _feeAddrWallet = payable(0x08F106b3F29b5EF3A0e0ddd55b1699F3D60CA77E);
