...
contract NFT is ERC721, PullPayment, Ownable, ContextMixin, ERC721Burnable, NativeMetaTransaction {
    ...
    constructor() ERC721("Incarceracism #1 - 100", "INCARETH") {
        baseTokenURI = "";
    }
    ...
    function mintTo(uint256 mintCount, address recipient) public onlyOwner returns (uint256) {
        uint256 tokenId = currentTokenId.current();
        uint256 newItemId = 0;
        uint256 count = 0;
        require(tokenId < TOTAL_SUPPLY, "Max supply reached");
