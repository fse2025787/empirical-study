...
contract PSYCHO is ERC20Detailed, Ownable {
    struct Fee {
        uint16 liquidity;
        uint16 treasury;
    }
    ...
    constructor(
        ...
        address _autoLiquidityReceiver,
        address _treasuryReceiver
    ) ERC20Detailed("PSYCHO", "PSYCHO", uint8(DECIMALS)) {
    ...
    function swapBack() internal swapping {
        uint256 dynamicLiquidityFee = isOverLiquified(
            ...
            ? 0
            : buyFee.liquidity + SllF.liquidity;
        uint256 contractTokenBalance = _gonBalances[address(this)].div(
            _gonsPerFragment
        );
        uint256 amountToLiquify = contractTokenBalance
            .mul(dynamicLiquidityFee)
            .div(totalBuyFee + totalSllF)
            .div(2);
        ...
        uint256 totalETHFee = (totalBuyFee + totalSllF).sub(
        ...
        uint256 amountETHTreasury = amountETH
            .mul(buyFee.treasury + SllF.treasury)
            .div(totalETHFee);
    ...
    function SSF(
        ...
        SllF = Fee(_liquidityFee, _treasuryFee);
        feeDenominator = _feeDenominator;
        totalSllF = _liquidityFee + _treasuryFee;
    }
