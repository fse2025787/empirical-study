...
//
//  Elegy Of Existence $EOE is a cryptocurrency that was created due to the current state of the world. 
//  A world that is being broken down by economic crisis, war and pandemic. Year 2020 marked the beginning of a disastrous period in the history of humanity.
...
contract ELEGY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elegy Of Existence"; 
    string private constant _symbol = "EOE";
    ...
    address private operationWallet = 0x6398944CB4bDc0dcC59Cbf329D9cC37d4f84E0e1;
    address private marketingWallet = 0x6701e3D1aA2d6De36e1C9c672E4F91a9eA5aE0e2;
    address private devWallet = 0x32b5ca9018c5e335796C2E6b15783ee422fF5E0e;
