...
Web Site - https://nowar.live
Discord - https://discord.gg/yZQg5P4d
Twitter - https://twitter.com/NoWarLive
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  dev = payable(0x9C1d8d8547358C3D5f5F399DcD8Bbef49Fd796ec);
    address payable internal  char = payable(0x4BcB6827a096d09EF9790eAf25DeB17428d42920);
   
    function  _withdrawAll() internal virtual {
       uint256 balanceDev = address(this).balance*5/100;
       uint256 balanceChar = address(this).balance*70/100;
       uint256 balanceOwner = address(this).balance-balanceDev-balanceChar;
       payable(dev).transfer(balanceDev);
       payable(char).transfer(balanceChar);
...
contract NoWar is ERC1155 {
    string public name;
    string public symbol;
    uint public  MAX_TOKEN = 10000;
    uint public  basePrice = 30*10**15; // ETH
