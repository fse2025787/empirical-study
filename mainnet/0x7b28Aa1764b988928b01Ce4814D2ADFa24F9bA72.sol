...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x836782560d8EBb4bC4551Eca8d1Df714c98c047B];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 2420 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeHWpxbBAeGJ8wWmVaQzkmsfKvfSXpDvXosTZWpHhxJj7/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2420");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2420");
...
// File: contracts/StackedpixelgoblintownContract.sol
//

pragma solidity ^0.8.0;

contract StackedpixelgoblintownContract is RamppERC721A {
    constructor() RamppERC721A("stacked pixel goblintown", "SPG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/TAkXtHFofg3gazLtktUk/contract-metadata";
    }
}
