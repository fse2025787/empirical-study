...
//
//t.me/aladdintokenentry
//Aladdin is a highly deflationary token on the Ethereum Blockchain that never stops pumping through its unique Aladdin magic that its based on core principal of doing huge buybacks and burns. 
...
contract ALADDIN is Context, IERC20, Ownable {
	...
	string private constant _name = "Aladdin Token";
	string private constant _symbol = "ALADDIN";
