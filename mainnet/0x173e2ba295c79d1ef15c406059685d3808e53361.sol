...
TREAT will serve as a reward token for everyone in the SHIB ecosystem, while the BONE token would be the reward token for validators in Shibarium.
...
contract SHIBTREAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBTREAT";
    ...
    constructor () {
        _feeAddrWallet = payable(0x78c1688607458Fd1a1aEdC3b1b4b4c65C5df081C);
