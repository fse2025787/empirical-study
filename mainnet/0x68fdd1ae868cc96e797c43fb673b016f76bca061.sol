...
contract TheFalconRocket is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"The Falcon Rocket";
    string private constant _symbol = unicode"FALCON 9";
