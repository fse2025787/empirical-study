...
// File: contracts/Stage2/RatioCalculator.sol
...
contract RatioCalculator {
    ...
    function getRatioForSEuro(uint256 _amountSEuro, uint160 _price, int24 _lowerTick, int24 _upperTick, bool _seuroIsToken0) external pure returns (uint256) {
        ...
        return _seuroIsToken0 ? getToken1Amount(_amountSEuro, _price, lower, upper) : getToken0Amount(_amountSEuro, _price, lower, upper);
    }

    function getToken0Amount(uint256 _amountSEuro, uint160 _price, uint160 _lower, uint160 _upper) private pure returns (uint256) {
        return LiquidityAmounts.getAmount0ForLiquidity(_price, _upper, LiquidityAmounts.getLiquidityForAmount1(_lower, _price, _amountSEuro));
    }

    function getToken1Amount(uint256 _amountSEuro, uint160 _price, uint160 _lower, uint160 _upper) private pure returns (uint256) {
        return LiquidityAmounts.getAmount1ForLiquidity(_lower, _price, LiquidityAmounts.getLiquidityForAmount0(_price, _upper, _amountSEuro));
    }
