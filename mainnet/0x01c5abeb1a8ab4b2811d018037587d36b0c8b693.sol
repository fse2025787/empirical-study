...
contract HabitatTeamToken is Utilities {
  ...
  function DOMAIN_SEPARATOR () public virtual view returns (bytes32 ret) {
    assembly {
      ...
      // keccak256(bytes('Habitat Team Token'))
      mstore(ptr, 0x304e875e7069a23701be15dde19baff1241ac5ca9b2e2c153f9a4bdc09c2fcc4)
      ptr := add(ptr, 32)
