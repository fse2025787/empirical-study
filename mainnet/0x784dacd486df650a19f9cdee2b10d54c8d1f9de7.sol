...
contract EmojiLoot is ERC721("EmojiLoot", "eLOOT"), ReentrancyGuard, Ownable {
    ...
    function claim(uint256 tokenId) public nonReentrant onlyEOA {
        require(tokenId > 0 && tokenId < 7888, "Token ID invalid");
    ...
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId > 7887 && tokenId < maxSupply, "Token ID invalid");
