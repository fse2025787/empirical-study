...
contract ShadyPenguins is ERC721, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZmybSiJS4VqUMAZZJ6M6Cak61PYypjnxFsd9FSKbF2fG";
    ...
    constructor(
    ) ERC721("Shady Penguins", "SHADYPENGUIN") {
    }
