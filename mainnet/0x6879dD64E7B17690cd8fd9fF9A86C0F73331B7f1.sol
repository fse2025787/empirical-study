...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x5cCa867939aA9CBbd8757339659bfDbf3948091B];
  address public erc20Payable = 0x5cCa867939aA9CBbd8757339659bfDbf3948091B;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiesrmmf5xexva3z5lykzi6nc2zzort3q45jflk5rgpaw4urndrrfe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vqOTpoIkZjH4GHwUVqkQ/contract-metadata";
  }
...
// File: contracts/NftInatorDemoContract.sol
//

pragma solidity ^0.8.0;

contract NftInatorDemoContract is RamppERC721A {
    constructor() RamppERC721A("NFTInator Demo", "INATOR"){}
}