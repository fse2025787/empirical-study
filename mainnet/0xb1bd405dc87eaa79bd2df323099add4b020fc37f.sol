...
contract RarosNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Raros Network";
    string private constant _symbol = "RAROS";

    uint256 public _maxTxAmount = 200_000 * 10**_decimals;
    uint256 public _maxWalletSize = 200_000 * 10**_decimals;
    uint256 public _taxSwap=20_500 * 10**_decimals;
    ...
    constructor () {
        ...
        _developmentWallet = 0xb57a8EcA0A1770AeD714c27077749C5a1Ad68027;
        _marketingWallet = 0xb57a8EcA0A1770AeD714c27077749C5a1Ad68027;
