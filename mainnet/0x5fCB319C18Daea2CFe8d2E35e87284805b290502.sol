...
contract erc721 is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    address public wallet1 = 0x2E24b0853c6CAD207fEaca2653FeEbdE1F0cdE8F;
    address public wallet2 = 0x2E24b0853c6CAD207fEaca2653FeEbdE1F0cdE8F;

    mapping(address => uint256) addressToMinted;

    constructor () ERC721A("erc721", "Mainnettest") {
