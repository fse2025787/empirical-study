...
// File: contracts/WatermanProtocol.sol
...
contract WatermanProtocol is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSz9hRmmpCCfhQWu1aSeSPfjxmAqgfqr18zUy9MtNCMQs";
    ...
    constructor(
    ) ERC721A("WatermanProtocol", "WP", 100, maxSupply) {
    }
