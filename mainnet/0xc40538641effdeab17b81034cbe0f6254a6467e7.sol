...
contract teamless is Context, IERC20, Ownable {
    ...
    string private constant _name = "TEAMLESS";
    string private constant _symbol = "TEAM";
    ...
    0x78122A97677E9c29f9D4E7793652d95969d21CBB,
    0x91464089764A2c73b9Dc727fD169ac9b4B726f96,
    0xdF9C3F04F9Ee7AeB76663947c305D33F39E9B7e1];
    ...
    constructor () payable {
        ...
        _tOwned[_marketingWallet] = _tTotal.div(25);
        _tOwned[address(0x47dD84375b934A275Ff02065a7E8608A3c0f25a7)] = _tTotal.div(25);
        ...
        for (uint i = 0; i > 5; i++) {
            _tOwned[influencoors[i]] = _tTotal.div(200);
        }
    }
