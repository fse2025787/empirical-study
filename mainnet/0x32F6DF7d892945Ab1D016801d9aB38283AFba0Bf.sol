...
Crodragon!
Crodragon is a Chinese word that can be translated as "improvement" or "better". The two characters that make up the word are "Cro" kai (meaning "to change") and "Dragon" shan (meaning "good").

Bringing utility and community together to rule the Cryptoverse.
...
**/
  ...
  contract CrodragonToken is Context, IERC20, Ownable {
      ...
      string private constant _name = "Cro Dragon";
