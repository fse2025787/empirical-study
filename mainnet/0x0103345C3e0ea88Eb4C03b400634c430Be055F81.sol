...
I'm using Pyro contract, so the tax is 4% for buy & sell, 2% for burning the supply & 2% for dev wallet.
Initial LP will be 2 ETH.
...
If you want to make a community telegram, make it @NomadInuCommunity.
...
contract NINU is ERC20, Ownable {
    ...
    constructor() ERC20("Nomad Inu", "NINU") {
        ...
        devWallet = 0x69e03B4ca9b7f856db0c6f8c8ba76140A89F9EAb;
