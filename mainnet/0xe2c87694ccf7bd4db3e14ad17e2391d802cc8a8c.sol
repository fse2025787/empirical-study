...
contract DegenFaces is ERC721A, DefaultOperatorFilterer {
    ...
    function mint_faces(uint256 amount) payable public {
        require(!pause);
    ...
    string uri = "ipfs://Qmc9jDerxvcxESFALJi1vPDfmSTeDyh87d5EXzHoATCx8A/";
    ...
    constructor() ERC721A("DegenFaces", "DF") {
        owner = msg.sender;
    }
