...
contract PLA11BXGUE1371 is Context, IERC20, Ownable {
    ...
    string private constant _name = "11B-X-1371";
    ...
    uint256 private _maxTxAmount = 6000000 * 10**9;
    uint256 private _maxWalletSize = 18000000 * 10**9;
