...
contract Pudgymfers is ERC721A, ERC721AQueryable, ERC721ABurnable, Ownable {
  uint256 private mintPrice = 0.005 ether;
  uint256 private maxSupply = 8888;
  uint256 private maxTransaction = 10;

  string tokenBaseUri = "ipfs://QmVV1DqsmCNewn5Kxd1KCAqZh9AzUAG8ZSNWjKHDSgWAPn/?";

  bool public isPaused = true;

  mapping(address => uint256) private freeCount;

  constructor() ERC721A("Pudgy mfers", "PM") {}
