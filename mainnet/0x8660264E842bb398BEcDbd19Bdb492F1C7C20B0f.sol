...
contract GloomyDoomers is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 3666;
    ...
    address[] public withdrawAddresses = [0x54f2747D57c57eBDbE45d5D69F1aE4e34F1c1D2F, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x68935f37f0e53f6682cb2653243bc59f56e4f6cdae383dc4d48d2903c6b765d6;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x54f2747D57c57eBDbE45d5D69F1aE4e34F1c1D2F, _royaltyAmount);
    }
