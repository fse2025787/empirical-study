...
contract AlexCoinDAO is ERC20, Ownable {
    ...
    IWrap public wrap = IWrap(0xe46A0775847c7c6BB5E11D9E3f769C225e97fBe9);
    ...
    constructor () ERC20("Alex Coin DAO", "ALEXDAO", 8, 50000000 * 10 ** 8){
        address msgSender = _msgSender();
        _balances[msg.sender] = totalSupply();
        emit Transfer(address(0), msgSender, totalSupply());
        pancakePair = IUniswapV2Factory(UniswapV2Router02.factory()).createPair(address(this), address(usdt));
