...
contract FashionLegends is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmbL4aQfbHUc98GWR93UBT8P5BYkX2fTqCxn4ED5DML2np/";
  uint256  public  maxSupply = 818;
  ...
  ) ERC721A("Fashion Legends", "FSNLGD") {
