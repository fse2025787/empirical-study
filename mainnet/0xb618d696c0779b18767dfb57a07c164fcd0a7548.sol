...
//
/*
		ElonMcult - revolves investment. Everyone Have a fair chance at landing on the Moon. 

		Supply: 1,000,000           Max Tx: 20,000 
		 
         
        TG: https://t.me/ElonMCult     Tax: 5% 
         
         Website:elonmcult.com

        
         - Contract will be renounced + Lp locked , Prelocking
...
contract ElonMcult is Context, IERC20, Ownable {
	...
	string private constant _name = "ElonMcult";
	string private constant _symbol = "ElonMcult";
