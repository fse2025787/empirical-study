...
contract RipQueen is ERC721AQueryable, Ownable {
    string public unrevealedURI;
    string public baseTokenURI;
    bool unrevealed = true;

    uint16 public maxSupply = 1926;
    uint16 public minted = 0;
    uint8 public constant batchLimit = 1; // mint amount limit
    bool public mintStarted = false; // is mint started flag

    constructor() ERC721A("RipQueen", "RipQueen") { }
