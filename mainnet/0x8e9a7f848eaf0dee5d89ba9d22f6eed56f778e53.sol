...
contract EarlyBirds_Staking is Ownable {
    ...
    constructor() {
        tiersRate[1] = 0.0000578703703 ether;
        tiersRate[2] = 0.0001157407406 ether;
        tiersRate[3] = 0.0002314814812 ether;

        tiersDays[1] = 14 days;
        tiersDays[2] = 90 days;
        tiersDays[3] = 365 days;
    }
    ...
    function changeBoostsBulk(uint256[] memory tokenIds, uint256 boost)
        external
        onlyOwner
    {
        for (uint256 index = 0; index < tokenIds.length; index++) {
    ...
    function changeBoosts(uint256[] memory tokenIds, uint256[] memory boosts)
        external
        onlyOwner
    {
    ...
    function claimableWormsFor(uint256[] memory tokenIds)
        external
        view
        returns (uint256)
    {
    ...
    function claimableWormsForId(uint256 tokenId)
        external
        view
        returns (uint256)
    {
        ...
        returns (uint256[] memory)
    {
        ...
        for (uint256 index = 1; index <= 1420; index++) {
        ...
        returns (uint256[] memory)
    {
        ...
        for (uint256 tokenId = 1; tokenId <= 1420; tokenId++) {
