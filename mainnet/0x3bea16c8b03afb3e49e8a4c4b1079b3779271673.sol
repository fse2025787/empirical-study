...
contract ChubbyDoodles is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmVnLL4YvDtqDCCyY31b2QWgtLtE4HXddx5AFx4YTvecUE/";
  ...
  constructor() ERC721("ChubbyDoodles", "CD") {
    setHiddenMetadataUri("ipfs://QmVnLL4YvDtqDCCyY31b2QWgtLtE4HXddx5AFx4YTvecUE/1.json");
  }
