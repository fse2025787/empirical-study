...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc2C0C7fA1892998D5C03c34225d6278B6D987a88];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigblflt27h665jdqb5qz2zz2whlbslfyqlf4t3lv74hjk74stia7y/";
...
// File: contracts/AstrologicsContract.sol
//

pragma solidity ^0.8.0;

contract AstrologicsContract is RamppERC721A {
    constructor() RamppERC721A("Astrologics", "ASTRO"){}
}
