 ...
 * */
 ...
 contract WormApe is Context, IERC20, Ownable {
     ...
     string private constant _name = "WormApe";
     string private constant _symbol = "WAPE";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x80c349e0FfaCa42341cAA6F3207BB89106944452);
         _feeAddrWallet2 = payable(0x80c349e0FfaCa42341cAA6F3207BB89106944452);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x80c349e0FfaCa42341cAA6F3207BB89106944452), _msgSender(), _tTotal);
     }
