...
contract MiniWolf is Ownable, ERC721, NonblockingReceiver {
    ...
    {
        _owner = msg.sender;
        setHiddenMetadataUri("https://ipfs.io/ipfs/QmV48JfedqHYW1EhWGsDdtfTK4TNotBdJJ6bYwuacbHYnt/hidden.json");
    }
