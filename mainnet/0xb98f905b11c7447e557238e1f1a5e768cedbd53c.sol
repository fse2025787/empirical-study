...
// File: contracts/RengaGorillas.sol
...
contract RengaGorillas is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3124;
  ...
  ) ERC721A("Renga Gorillas", "RENGAGORILL") {
