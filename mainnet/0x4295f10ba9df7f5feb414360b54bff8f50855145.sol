...
You can descover who i am and my mission here:

https://medium.com/@Mancoshi

Look for what i did and what i will do.
...
contract NOBODY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mancoshi";
    string private constant _symbol = "Mancoshi";
    ...
    address payable private _developmentAddress = payable(0x680A86486cbf4a5E29172CE2DBCeAe4C7DAFda08); 
    address payable private _marketingAddress = payable(0x680A86486cbf4a5E29172CE2DBCeAe4C7DAFda08);
