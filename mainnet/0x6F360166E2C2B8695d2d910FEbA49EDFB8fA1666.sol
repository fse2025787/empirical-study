...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x83477E410423411E31a5Aaab93f4d87c60E37c65];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVLVhSvEAhw5LzuLtj5if7rZsKUzhtpaLzzGNmzrQKwFQ/";
...
// File: contracts/RoygbivNftArtClubContract.sol
//

pragma solidity ^0.8.0;

contract RoygbivNftArtClubContract is RamppERC721A {
    constructor() RamppERC721A("ROYGBIVNFT Art Club", "RNAC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/fy92iJyLquVxebD1bgai/contract-metadata";
    }
}
