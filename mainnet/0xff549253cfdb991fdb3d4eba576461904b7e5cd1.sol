...
contract Kagutsuchi is ERC20, Ownable {
    ...
    constructor() ERC20( unicode"Kagutsućhi", unicode"Kagutsućhi") {
        ...
        devWallet = address(0x58cb5a3c8A22BC0E60f0410f2Ae248D01272f321); // set as dev wallet
