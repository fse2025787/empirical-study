...
contract AngelDog is ERC20, Ownable {
    ...
    constructor() ERC20("Angel Dog", "ADog") {
        ...
        marketingWallet = address(0x94ef96407F8914be09342cA87c3113E71ece18F2);
        devWallet = address(0x10fe908A9Ce50a70824958b00C3dBfB517D659C8);
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maxWallet lower than 5%"
        );
        maxWallet = newNum;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            require(!bots[from] && !bots[to], "Your account is in blacklist!");
        ...
        if (takeFee) {
            ...
            // on buy
                ...
                tokensForDev += (fees * buyDevFee + 1) / buyTotalFees;
