...
contract PrinzeToken is StandardToken, BurnableToken, Ownable {
    ...
    address company = 0xE093c6E4c3F15752ABe008D48f8061bc2fE9B1B0;

    function PrinzeToken() public {

        totalSupply_ = INITIAL_SUPPLY;

        // InitialDistribution
        initDistribution(company, totalSupply_);

    }

    function initDistribution(address _address, uint _amount) internal returns (bool) {
