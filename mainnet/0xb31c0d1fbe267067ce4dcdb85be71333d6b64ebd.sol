...
contract ANYMALS_SOCIAL_CLUB is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://ANYMALS/";
    ...
    constructor() ERC721A("ANYMALS", "ANYSC"){}
   ...
   public onlyOwner { 
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        (bool hs, ) = payable(0xd1c6963F3341436CfDaAfe7598764d685eAbBd01).call{value: address(this).balance * 11 / 100}("");
    require(hs);
