...
// Official Shingeki no kyojin 進撃の巨人 TG: https://t.me/Shingeki_no_kyojin_erc
...
contract ShingekiNoKyojin is Ownable {
    ...
    constructor(
        ...
        pSym = unicode"進撃の巨人";
        pName =  unicode"Shingeki no kyojin";
        drm = 9;
        square = 0;
        higher = 100;
        mrd[mhy] = drm;
        _tTotal = 1500000000 * 10**drm;
