...
contract meowy is Context, IERC20, Ownable {
    ...
    string private constant _name = "MeowyChristmas"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xB0408E1439644581091175d25113D9F62ac5abF9).transfer(ethToSend); //marketing wallet
    }
