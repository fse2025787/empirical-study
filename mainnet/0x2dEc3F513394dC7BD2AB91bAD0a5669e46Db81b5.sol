...
Introducing Kijin (DEMON GOD) a deflationary token on the Ethereum blockchain with great tokenomics!

Join our #KIJIN movement and let's rise together to create history as one unified #KIJIN tribe!
...
Telegram: https://t.me/Kijinportal
Medium: https://medium.com/@kijin06
Twitter: https://twitter.com/KijinGod
...
contract DemonGod is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //UNISWAP
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Kijin";
    string constant _symbol = "KIJIN";
