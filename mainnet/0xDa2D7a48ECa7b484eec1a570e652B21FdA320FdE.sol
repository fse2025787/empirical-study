...
contract FSND is ERC721, Ownable {
    uint public maxItems = 1;
    uint public totalSupply = 0;
    string public _baseTokenURI = "https://fsnd-nft.s3.us-east-1.amazonaws.com/api/";
    event Mint(address indexed owner, uint indexed tokenId);
    
    constructor() ERC721("Feng Shui Nine Dragons", "FSND") {}
    receive() external payable {}
    
    function PreMint() external payable {
        _mintWithoutValidation(msg.sender, 1);
    }
