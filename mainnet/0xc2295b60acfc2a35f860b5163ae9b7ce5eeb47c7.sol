...
// https://t.me/MoonKingPortal
// https://twitter.com/moonkingerc20
...
contract MoonKing is ERC20, Ownable {
    ...
    constructor() ERC20("Moon King", "MK") {
    ...
    ; uint256 totalSupply = 1 * 1e12 * 1e18;  // 1,000,000,000,000
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 2% maxTransactionAmountTxn 20000000000
        maxWallet = totalSupply * 30 / 1000; // 3% maxWallet 30000000000
