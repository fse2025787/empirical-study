...
contract DigiDaigaku is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public constant MAX_MINT_PER_ADDR = 25;
    ...
    constructor(string memory initBaseURI) ERC721A("Ai DigiDaigaku Genesis", "AIDIGI") {
        baseURI = initBaseURI;
