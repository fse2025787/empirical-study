...
/*
 ..-  -.  .-..  ---  -.-.  -.-   -  ....  .   --  -.--  ...  -  .  .-.  -.--  --..--   .-  -.  -..   ....  .  .-.  .  .----.  ...   ...  ---  --  .  -  ....  ..  -.  --.   -.--  ---  ..-   -.  .  ...-  .  .-.   .  -..-  .--.  .  -.-.  -  .  -.. 
https://www.morsecodeth.com
https://twitter.com/morseerc
https://t.me/morseerc
*/
...
contract MORSE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42096 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tReflectionFeeTotal;
    uint256 private _tBurnFeeTotal;

    string private _name = "The Morse Code";
    string private _symbol = "MORSE";
    ...
    address public marketingTokenFeeWallet = 0xece64b1Be4481d45E6d0368C72B4B15F2A7757d1;
    address public marketingETHFeeWallet = 0xece64b1Be4481d45E6d0368C72B4B15F2A7757d1;
    ...
    uint256 public _maxTxAmount = 421 * 10**9;
    uint256 private _numTokensSwapToETHForMarketing = 4 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 421 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
