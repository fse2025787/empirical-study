...
contract TheFrenZone is Context, IERC20, Ownable {
    ...
    string private constant _name = "TheFrenZone"; // 
    string private constant _symbol = unicode"FRENZ!"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xba9a6f7090AdE7dD96BF2bA0bec18407E6414fAd).transfer(ethToSend); //marketing wallet
    }
