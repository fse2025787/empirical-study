...
/**
  @flappyinu
  next erc-20 doge moonshot
  variable tax paarmeters for project growth. building up a sustainable liquidity pool while also slwoly taxing for marketing funds to atttarct new investors
   once community decides set tax we will communicate 
...
contract FlappyInu is Context, IERC20, Ownable {
    ...
    string private _name = "Flappy Inu";
    string private _symbol = "FLAPPY";
    ...
    uint256 public _marketingFee = 4; // All taxes are divided by 100 for more accuracy.
