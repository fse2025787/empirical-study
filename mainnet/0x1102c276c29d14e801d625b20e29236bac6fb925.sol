...
$DAI is much more than the biggest 
Anime Token on the ETH network.

 * Twitter: https://twitter.com/DAI_ETH

 * Telegram: https://t.me/daitokeneth

 * Website: http://dragonqd.io/
 ...
 * */
 ...
 contract dai is Context, IERC20, Ownable {
     ...
     string private constant _name = "DAI ETH";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x650F2eF9e073Dd8bEbb39452eB9FfcD543a2f109);
         _feeAddrWallet2 = payable(0x650F2eF9e073Dd8bEbb39452eB9FfcD543a2f109);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x650F2eF9e073Dd8bEbb39452eB9FfcD543a2f109), _msgSender(), _tTotal);
     }
