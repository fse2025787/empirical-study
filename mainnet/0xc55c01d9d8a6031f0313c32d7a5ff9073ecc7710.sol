...
contract degenfingers is ERC721A, Ownable {
    
    using Strings for uint256;


    uint256 FREE_MINT_LIMIT_PER_WALLET = 50;
    uint256 MAX_MINTS = 10;
    uint256 MAX_SUPPLY = 2000;
    bool private paused = true;
    uint256 MAX_FREE = 1800;
    uint256 public mintRate = 0.005 ether;

    string public baseURI = "https://degenfingers.xyz/api/";

    mapping(address => uint256) private freeMintCountMap;
    

    constructor() ERC721A("DEGEN FINGERS", "DF") {}
