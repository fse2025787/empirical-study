...
contract CharlesBlootRugs is ERC721Enumerable, OpenSea, Ownable, PaymentSplitter {
    using Strings for uint256;

    string private _baseTokenURI;
    string private _tokenURISuffix;

    uint256 public price = 20000000000000000; // 0.020 ETH
    ...
    ) ERC721("Charles Bloot Rugs", "CBRUGS") PaymentSplitter(_payees, _shares) {
    ...
    function mint(uint256 count) public payable {
        ...
        if (supply < 501 && supply + count > 501) {
            uint256 payCount = supply + count - 501;
