...
contract Mfronters is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmaNXqeX7FhZ9g76KmYbCZP3PBP7q5gjXmQGQXFkKBfFcg";
    ...
    constructor(
    ) ERC721A("MF", "MFronters", 100, maxSupply) {
    }
