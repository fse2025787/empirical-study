...
contract LiquidityProvision is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    using SafeMath for uint256;
    ...
    function notifyRewardAmount(uint256 reward) external override onlyRewardsDistribution updateReward(address(0)) {
        ...
        uint balance = X22Token.balanceOf(address(this));
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external onlyOwner {
        ...
        require(
            tokenAddress != address(stakingToken) &&tokenAddress != address(X22Token),
