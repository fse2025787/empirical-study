 ...
 * allowances. See {IERC20-approve}.
 */
contract Caimr is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Caimr";
    string private _symbol = "Caimr";
    uint8 private _decimals = 9;
    uint256 private _supply = 80000;
    uint256 public taxForLiquidity = 2;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 3500 * 10**_decimals;
    uint256 public maxWalletAmount = 5000 * 10**_decimals;
    address public marketingWallet = 0x0D101A9862ec7De236047d55C6F831d454f81d30;
    // TOKENOMICS END ============================================================>
