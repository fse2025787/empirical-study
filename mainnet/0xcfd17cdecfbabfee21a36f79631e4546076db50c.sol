...
contract Shibits is ERC721A, Ownable {
  using Strings for uint256;
  uint256 public mintPrice = 0.009 ether;
  uint256 public supply = 1000;
  string private baseURI = "ipfs://mUdsfsdf7EYdsdsdsJNm7i7ZsdssSAv/";
  ...
  constructor() ERC721A("Shibits", "Shibits") {
  }
  ...
  function toggleMinting(uint8 _phase) public onlyOwner {
    phase = _phase;
  }
  ...
  function withdrawAll() external onlyOwner{
        ...
        address[2] memory addresses = [
            0xA2DF9DE25b6071782fEc0Fdb67Bef08cC56C154D,
            0xA2DF9DE25b6071782fEc0Fdb67Bef08cC56C154D 
        ];
