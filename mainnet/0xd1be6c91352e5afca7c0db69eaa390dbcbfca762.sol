...
/// LQNTY's Liquidity is Perma-Locked in this contract
/// Liquinity's Auto-Burn LP Token prohibits a malicious actor from removing LP
/// even if the malicious actor is me

/// The only LP that will be burned is Liquidity bought by the contract
/// How much liquidity is locked and burned is proportional to LQNTY's market cap
/// Even you can add your own liquidity, because liquidity
/// enables free markets to be free
/// Liquinity is a free market

/// Trust in defi has been abused
/// LQNTY is a shield

/// Total Supply: 100,000,000,000.00 (100B) $LQNTY 
/// Taxes: 7/7%, all of which the Contract allocates to LP

/// 50% Tax for the first 60 seconds as Anti-Bot as Contract has no _deadBlock 

/// Taxes will decrease to:
...
/// 100% of taxes collected are added to the contract 
/// and introduced into the LQNTY Liquidity Pool 

/// https://t.me/LQNTY_portal
/// Community Admins will be assigned.
/// https://liquinity.io/ 
/// https://twitter.com/lqnty_token
...
contract Liquinity is ERC20, Ownable {
    /*
