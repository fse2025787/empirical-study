...
// REMIX
// import "https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/utils/ContextUpgradeable.sol";
...
// import "https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/token/ERC721/extensions/IERC721MetadataUpgradeable.sol";
// import "https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/token/ERC721/extensions/IERC721EnumerableUpgradeable.sol";
// import "https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/token/ERC721/IERC721ReceiverUpgradeable.sol";
// import "https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/master/contracts/utils/introspection/ERC165Upgradeable.sol";
...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, IERC721EnumerableUpgradeable {
    ...
    mapping (uint256 => address) private _tokenOwnersMap;
    ...
    */
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return _tokenOwners.contains(tokenId) || _tokenOwnersMap[tokenId] != address(0);
    }
    ...
    function _mintBatch(address to, uint256 tokenId, uint batchSize, string memory data) internal virtual {
        require(to != address(0), "ERC721: mint to the zero address");
        require(!_exists(tokenId), "ERC721: token already minted");
        _tokenOwnersMap[tokenId] = to;
        _setTokenURI(tokenId, data);
        for (uint _tokenId=tokenId+1; _tokenId<tokenId+batchSize; _tokenId++) {
            //_beforeTokenTransfer(address(0), to, _tokenId);
            //_holderTokens[to].add(_tokenId);
            _tokenOwnersMap[_tokenId] = to;
        }
    }
