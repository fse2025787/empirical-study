...
/**
   ...
   Solana 2.0 is your next ERC 20 moonshot

Solana is one of the trend right now because of the massive exploit. 
We will lock the liquidity 14 Days and Renounce ownership so that no one can change the contract.
...
TG: https://t.me/SolanaTwoPointZeroETH

My Channel: https://t.me/HypeGods
...
contract Solana is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xd1Ee0272a60B541c119bA864c8e5e496fDfE4a9F;
        _marketingWallet = 0xd1Ee0272a60B541c119bA864c8e5e496fDfE4a9F;
