...
contract Mountereum is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Mountereum";
    ...
    address payable private _developmentAddress = payable(0x1fF115190d5Aa08bB71ce1EB82Bd7d3594c30f9E); 
    address payable private _marketingAddress = payable(0x1fF115190d5Aa08bB71ce1EB82Bd7d3594c30f9E);
