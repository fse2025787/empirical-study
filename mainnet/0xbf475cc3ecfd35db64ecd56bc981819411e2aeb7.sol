...
Grass mud horses, next time you don’t want to eat it, you can eat it first
*/
...
contract GinotaToken is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Ginota Token";
    string private constant _symbol = "Ginota";
