...
contract PiNFTFactory is Ownable {
    ...
    */
        ...
        returns (address)
    {
        ...
        PiNFTTradable nft = new PiNFTTradable(
            _name,
            _symbol,
            auction,
            marketplace,
 ...
 */
contract PiNFTTradable is ERC721, Ownable {
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Pi auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Pi contracts to enable gas-less listings.
     */
