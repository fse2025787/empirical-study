...
contract cZero is ERC20, Ownable {
    ...
    constructor() ERC20("DO NOT COUNT", "cZero") {
        ...
        maxWallet = totalSupply * 5 / 1000; // 0.5% from total supply maxWallet
        ...
        devWallet = address(0x343e2D02cAa472c36B7E8dd897F9a48AB5a423e5);
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 1) / 100000) / 1e9,
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 5) / 100000) / 1e9,
