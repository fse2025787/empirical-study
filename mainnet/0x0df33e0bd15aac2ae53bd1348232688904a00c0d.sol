...
Are you ready for the next unique, innovative and crazy project?
Join THE Compound with highest APY on the market.
...
contract THECompound is ERC20Detailed, Ownable {
    ...
    string public _name = "THE Compound";
    string public _symbol = "TCOMP";
    ...
    constructor() ERC20Detailed("THE Compound", "TCOMP", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xeB14CbcDBba64c769Caf22f1F0ab37c9B9E55eDf;
        treasuryReceiver = 0x7051a7d2b011fB4158167ca298f39325125c1C8D; 
        RFVFundReceiver = 0xF19eb32A261fF249E7fbAf2b209f11674BB87Da9;
        firePit = DEAD;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TCOMP token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
