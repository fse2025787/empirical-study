...
contract NITRO is Context, Ownable, IERC20, IERC20Metadata { 
    ...
    address payable public communityWallet = payable(0x4dE9D9Ab5d1847D90319A4e4F73aAC5F71F8eC4a);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
      if (maxWalletSize > 250000000000 * 10 ** _decimals) {
           _maxWalletSize = maxWalletSize;
        }
    }

    function setMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
      if (maxTxAmount > 50000000000 * 10 ** _decimals) {
           _maxTxAmount = maxTxAmount;
        }
    }

    function setMinSwapTokensThreshold(uint256 swapTokensAtAmount) public onlyOwner {
      if (swapTokensAtAmount < 5000000 * 10 ** _decimals) {
