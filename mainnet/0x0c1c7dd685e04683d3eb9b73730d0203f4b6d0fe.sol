...
//             I am creating this token for the community.
//
//             There is a lot of uncertainty in the market right now green dildo's will come.                     
//             The tax will be 1% for liquidity and 1% for me for my Mcdonalds.
//             Max transaction will be 1.5% and the max wallet is 3%.
//
//             I will lock the token initially for 30 days. It will be 
//             extended at 100K to 6 months, 200K burn.
//
//             There is no website, no twitter, just community.
//             I am not Ryoshi, but I am nobody, yet I am somebody.  
//
//             Leaving you with this https://t.me/backtoworkscheme
// 
//             For the community, the culture and all that shit.
// 
//
// 
...
contract BTW is ERC20, Ownable {
    ...
    constructor() ERC20("Back to Work", "BTW") {
