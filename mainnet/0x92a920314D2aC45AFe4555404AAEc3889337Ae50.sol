...
contract LACGold is ERC721Enumerable, Ownable {
    ...
    function withdrawERC20() external onlyOwner
    {
        ...
        bool transfer1 = tokenContract.transfer(payable(creator2Address), totalBalance.mul(10).div(100));
        bool transfer2 = tokenContract.transfer(payable(creator3Address), totalBalance.mul(10).div(100));
        bool transfer3 = tokenContract.transfer(payable(creator4Address), totalBalance.mul(10).div(100));
