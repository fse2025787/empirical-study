...
contract StoryTellingNFT is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVR4rZxdomnCqgEYGHmtum2BAwu7HGqojUbwQu1ehMrze";
    ...
    uint256 public maxSupply = 2696;

    uint256 public constant PUBLIC_SALE_PRICE = 0.003 ether;
    uint256 public NUM_FREE_MINTS = 696;
    ...
    constructor(
    ) ERC721A("Story Telling NFT ", "Story Telling NFT ", 100, maxSupply) {
    }
