...
contract HP is ERC20, Ownable {
    ...
    constructor() ERC20("Set Fees", "HP") {
     ...
     uint256 totalSupply = 1 * 10 ** 5 * 10 ** decimals();
        ...
        MarketingWallet = address(0x2Ae3dD83dC1f3a95E2BbA9a8C47222A1aaD9134A); // set as Marketing wallet
        DevWallet = address(0x2Ae3dD83dC1f3a95E2BbA9a8C47222A1aaD9134A); // set as dev wallet
