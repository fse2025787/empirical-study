...
contract MetaEliteClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 9977;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Meta Elite Club", "MEC") {
    setHiddenMetadataUri("ipfs://QmcjrWHTS1xfnBX3r4cvHgFrUEi4xScoMp6YdjvdWgY4sH/hidden.json");
  }
