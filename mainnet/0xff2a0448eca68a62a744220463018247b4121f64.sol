...
ReentrancyGuardUpgradeable
{
    ...
    */
    function initialize(
        ...
        EA.startTime = 1664042400; // September 24, 2022 11:30 PM IST
        EA.endTime = EA.startTime + 3 hours;
        EA.buyLimit = 3;
        EA.maxAvailable = maxSupply - ownerRemainingTokens;
        EA.mintPrice = 0.0555 ether;

        EAclaim.startTime = EA.startTime;
        EAclaim.endTime = EAclaim.startTime + 2 hours;
        EAclaim.buyLimit = 1;
        EAclaim.maxAvailable = 1282;
