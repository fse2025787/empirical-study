...
contract createf is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("creating a team", "CAT") { // 
        marketingWallet = payable(0x1DB0C5B83e3d54F3d82f6C6bF140d418a6d0f90d); //
        devWallet = payable(0x1DB0C5B83e3d54F3d82f6C6bF140d418a6d0f90d); // 
