...
/**
https://www.oyukitoken.com/
https://t.me/GhostofOyukiERC
*/
...
contract CZSCAMMER is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("CZscammer", "VitalikOverlord") {
        ...
        maxTransactionAmount = totalSupply * 6 / 100; // 4% maxTransactionAmountTxn
        maxWallet = totalSupply * 6 / 100; // 4% maxWallet
    ...
    function updateFees(uint256 _burnFee, uint256 _devFee, uint256 _sellburnFee, uint256 _selldevFee) external {
