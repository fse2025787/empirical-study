...
// File: contracts/PdexToken.sol

/*
 * PdexToken is a standard ERC20 token with some additional functionalities:
...
contract PdexToken is StandardToken, BurnableToken, Ownable {
	string public constant symbol = "PDEX";
	string public constant name = "PDEX CHAIN";
	uint8 public constant decimals = 18;
	uint256 public constant INITIAL_SUPPLY = 36000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 14400000000 * (10 ** uint256(decimals));
	...
	*/
	function PdexToken(address admin) public {
	...
	* @param value Amount of pdextokens to send
	*/
