...
contract PAPADOGE2 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PAPADOGE 2.0";
    string private _symbol = "PAPADOGE2";
    uint8 private _decimals = 18;
    uint256 public _totalDistributionShares = 24;

    address payable public marketingwallet = payable(0x7d3d12245E79EE521996807eD3b94A548ecB7566);
