...
contract NodeWhales is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  string  public  baseTokenURI = "ipfs://QmYA3DSWKGeABzq7SzrnwajCydBuXnZGCmdtz66c7JCxxu";
  ...
  ) ERC721A("Node Whales", "NodeWhales") {
