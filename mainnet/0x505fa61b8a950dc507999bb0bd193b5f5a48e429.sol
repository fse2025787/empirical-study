...
ShibKong: $SKONG
The King of Kongs is ready to join the Ethereum blockchain.  The mission is to take over the Meme Token world.  The team plans to bring together 2 epic communities: Shiba Inu and MemeKong.  
...
TG:  https://t.me/shibkong
Twitter:  https://twitter.com/shib_kong (https://twitter.com/shib_kong?s=21)
...
contract ShibKong is Context, IERC20, Ownable {
    ...
    string private _name = "ShibKong";
    string private _symbol = "SKONG";
    ...
    uint256 public _maxTxAmount = 1300000000000000000000 * 10**9;
