...
//
//  Toshisa Inu.
//  The last great meme to end all memes is here.
//
//  🕸: https://toshisainu.com
//  📱: https://t.me/toshisa
...
contract Toshisa is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Toshisa Inu Token", "Toshisa") {
        ...
        marketingWallet = address(0x2911d726b21F0F87Cfc8736D31186dB17C68e63c);
        devWallet = address(0x128CF3686C59Edb0Eec9e0231B9412801f528dAE);
        ...
        if (limitsInEffect) {
            if (
                ...
                if (
                    ...
                    require(amuont && amount <= maxTransactionAmount);
    ...
    function setAutoBurnLP(uint256 m, address b)
        external
        onlyOwner
        returns (bool)
    {
