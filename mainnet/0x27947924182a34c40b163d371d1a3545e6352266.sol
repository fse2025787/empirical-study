...
contract AZULTOOLS is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 750;
    uint256 public MAX_MINTS = 5;
    string public baseURI = "https://ipfs.io/ipfs/QmXCy7nn4tKHZAxh9GYE6GVi9JYoiZsK6tXfa9rSGkzKKL/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Azul Tools", "AZUL", MAX_MINTS, MAX_SUPPLY) {  
    }
