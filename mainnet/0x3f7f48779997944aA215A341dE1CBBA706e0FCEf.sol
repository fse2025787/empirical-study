...
contract SANTA is Context, IERC20, Ownable {
    ...
    string private _name = "SANTA XMAS TOKENS"; 
    string private _symbol = "SANTA"; 
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xBfe3D7CD874CbEdEc47b669F749A6522f9b0713C); 
    address payable public charityWalletAddress = payable(0x689290E12977A6924360343De30947d390b3818e); 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(charityWalletAddress, amountBNBTeam);
