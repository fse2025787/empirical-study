...
/**
    Golden Tsuka ERC Token

    Enter the golden dragon.
    Total supply : 1000000
    Starting 0.5% supply then increased to 3% gradually

    Medium: https://medium.com/@goldentsuka
...
contract GoldenTsuka is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xfe48073Ccb35D0cF50104c5E26a59dA06f95C109); // Marketing Address
    address payable public multiSigAddress = payable(0xfe48073Ccb35D0cF50104c5E26a59dA06f95C109); // Marketing Address
    address payable public devAddress = payable(0xfe48073Ccb35D0cF50104c5E26a59dA06f95C109); // Dev Address
    address payable public liquidityAddress = payable(0xfe48073Ccb35D0cF50104c5E26a59dA06f95C109); // Liquidity Address
    ...
    string private constant _name = unicode"GOLDEN TSUKA";
    string private constant _symbol = unicode"JIN";
    ...
    constructor() {
        ...
        maxWallet = _tTotal * 50 / 10000; // 0.5%
