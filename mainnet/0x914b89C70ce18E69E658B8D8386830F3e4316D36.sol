 ...
 */
contract TWDDegenerativeStage3 is ERC721Airdroppable, Terms {
    /**
     * @notice TWDDegenerativeStage3 constructor.
     *
     * @param name The token name.
     * @param symbol The token symbol.
     */
        ...
        ERC721Airdroppable(name, symbol)
    {
        ...
        _baseTokenURI = "https://api.orangecomet.io/collectible-metadata/twd-degenerative-stage-3/";

        // Initial contract URI
        _contractURI = "https://api.orangecomet.io/collectible-contracts/twd-degenerative-stage-3/opensea";
    }
}
