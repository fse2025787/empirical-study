...
contract TheMeridius is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "The Meridius";
    string private _symbol = "MERI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x2A7e09eCB5530d7CA9e46846d6316ba5e35A5213);
