...
/**
Pulse Lobster - Stealth Launching today.
...
Pulse hype was seen on Maythous Calls. That's why we created Pulse Lobster
Pulse + Lobster = HYPE/SUCCESS.

// 📞Telegram : https://t.me/pulselobster
// 🐦Twitter: https://mobile.twitter.com/PulseLobsterETH
*/
...
contract PULSELOBSTER is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb561BbA3a74B95A1319Fbe60940bdCd060b9799B); 
    address payable public Wallet_Team = payable(0xc9D93c4a69Aa969f159aF871Ce217D95f59BeDf8);
    ...
    uint256 private _tTotal = 100* 10**13 * 10**_decimals;
    string private constant _name = "PULSELOBSTER"; 
    string private constant _symbol = unicode"PSLOBSTER"; 
    ...
    constructor () {
        ...
        _owner = 0xc9D93c4a69Aa969f159aF871Ce217D95f59BeDf8;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xb561BbA3a74B95A1319Fbe60940bdCd060b9799B); // Testnet
