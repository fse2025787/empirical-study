...
contract LaikaBank is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public laikaBuyBackWallet;
    address public laikaAddress;
    ...
    constructor()
        ERC20("Laika Bank", "LAIKABANK")
    {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        laikaAddress = 0x77f9CF0bd8C500CfFdF420e72343893aeCC2EC0b;
        ...
        laikaBuyBackWallet = address(0xE3C6b90be4412fE6F668DA07658831caFEc8A009);
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        buyFee = _buyFee;
        sellFee = _sellFee;
        require(buyFee <= 15 && sellFee <= 15, "Must keep fees at 15% or less");
    }
    ...
    function updateWallets(address newLaikaBuyBackWallet) external onlyOwner {
        laikaBuyBackWallet = newLaikaBuyBackWallet;
    }
    ...
    function swapBuyBack() private {
        ...
        if (contractBalance == 0 || tokensForLaika == 0) {
            return;
        }

        uint256 forSwap = tokensForLaika;
        if (tokensForLaika > contractBalance) {
