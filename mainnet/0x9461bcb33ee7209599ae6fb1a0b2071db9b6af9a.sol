...
contract SPN is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 333;
    ...
    constructor(string memory initBaseURI) ERC721A("Samurai Panda NFT", "SPN") {
        baseURI = initBaseURI;
    }
