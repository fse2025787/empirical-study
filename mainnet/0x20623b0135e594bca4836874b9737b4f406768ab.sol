...
/*
|   30% USDC Reflections Token - It's only 8% fee if you HODL! Just HODL and make it rain USDC!
|
|   TOKENOMICS : 30% USDC REFLECTIONS (8% BUY, 22% SELL)
|   WEBSITE    : https://reflectionslol.web.app/
|   TELEGRAM   : https://t.me/reflectionslol
*/
...
contract MassiveReflections is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("USDC Reflections", "30%") {
    ...
    function enableTradingAndMakeItRain() external onlyOwner {
