...
contract SPHERE is Context, IERC20, Ownable {
    ...
    string private _name = "Outersphere";
    string private _symbol = "SPHERE";
    ...
    uint256 private _liquidityFee = 7;
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _buyFees = 5;
    uint256 public _sellFees = 7;

    address public marketing = 0x8eADD64004817781d3991b45D5A03F34A965F240;
    ...
    uint256 public _maxBalAmount = _tTotal.mul(1).div(1000);
    ...
    constructor () {
        ...
        _transfer(_msgSender(), address(0), 90000000 * 10**18);
    ...
    function setSellFeePercent(uint256 sellFee) external onlyOwner() {
        require(sellFee <=25, "fees cannot be more than 25");
        _sellFees = sellFee;
        emit SetSellFeePercent(sellFee);
    }

    function setBuyFeePercent(uint256 buyFee) external onlyOwner() {
        require(buyFee <=25, "fees cannot be more than 25");
        _buyFees = buyFee;
