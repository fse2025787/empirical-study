...
/**
        // 
         ...
         ʰᵗᵗᵖˢ://ʷʷʷ.ᶜʳᵒⁿʸᶜʳᵒⁿᵒˢ.ᶜᵒᵐ/

         ht̺̠̫̙̗t̓ͣ̊p̨͂ͫ̋ͧs̠̦͕ͬͯ://͆̉t̑̒̔wiͥ̒̏t̶t̐̂͐ͭe͍̣r͟.com̯̜/̣͕CRÓ̉͑N̥̲͍Y̌̑̀CROǸOS̊͑͊̀ 
...
contract CRONY is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CRONY";
    string private constant _symbol = "CRONY";
    ...
    address payable private _developmentAddress = payable(0xce4f62cfdB1749Ad3DD7E95c19bf83A9F04985F2);
    address payable private _marketingAddress = payable(0xce4f62cfdB1749Ad3DD7E95c19bf83A9F04985F2);
