...
contract BlockAbstraction is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    uint64 public maxSupply = 700;

    uint64 public publicMaxSupply = 700;
    uint64 public publicTotalSupply = 0;
    uint64 public presaleMaxSupply = 300;
    ...
    constructor() ERC721A("Blocks by Anon", "Block"){}
