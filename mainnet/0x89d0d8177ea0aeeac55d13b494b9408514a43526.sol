...
Welcome to $BoxerInu
   ...
   If you want to view all the information about this coin, please check https://t.me/BoxerInu
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $BoxerInu to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $BoxerInu idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 15ETH in the pool. 
...
contract BoxerInu is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/BoxerInu", "BoxerInu") {
