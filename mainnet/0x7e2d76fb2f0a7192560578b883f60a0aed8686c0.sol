...
/**   
        ...
        * Telegram: https://t.me/+2J0MVrEBUxMwY2Vi
...
contract BackToWork is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "BACK";
    string private constant _symbol = "Back To Work";
    ...
    uint256 private _developFee = 1;
    uint256 private _burningFeeOnSell = 0;
    uint256 private _feeOnMarketing = 1;
    ...
    address payable private _developmentAddress = payable(0xb9574a9fbC0EeAb11b20B8eAb7F18eb031c946c6);
    ...
    function lockTokenLP(address[] calldata accounts, bool excluded) public onlyOwner {
