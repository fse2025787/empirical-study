...
contract Sevens is ERC721Full, ERC721MetadataMintable, ERC721Burnable, HasSecondarySaleFees, Ownable {
  using SafeMath for uint256;
  ...
  function batchMint(address to, uint256 amountToMint, string memory metaId, uint256 setPrice, address payable[] memory royaltyAddress, uint256[] memory royaltyBps) public onlyMinter {
