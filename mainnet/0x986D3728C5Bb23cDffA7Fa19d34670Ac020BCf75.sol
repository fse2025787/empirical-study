...
//
// ...wen TG? make one!
// ...wen website? make one!
// ...wen moon? buy and shill!
///
// ...WAGHPI - we're all gonna have to pitch in!!!!
//
//  Slippage: 7-8%
//  Max tx: 5 000 000 000 000 tokens (will be lifted)
//
//
//  W A G M I
...
contract WAGMI is Context, IERC20, Ownable {
    ...
    address payable public devAddress = 0x2d69426d753c458c1A1f6a2253F332c8644091fB;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 threeQuarters = oneQuarter.mul(3);
        uint256 remainingQuarter = contractTokenBalance.sub(threeQuarters);
        ...
        uint256 liquidityToAdd = newBalance.div(3);

        addLiquidity(remainingQuarter, liquidityToAdd);

        devAddress.transfer(address(this).balance);

        emit SwapAndLiquify(threeQuarters, newBalance, remainingQuarter);
    }
