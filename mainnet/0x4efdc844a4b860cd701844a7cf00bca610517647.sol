...
contract Y2K  is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 25 * 10**1 * (10**18);
    ...
    constructor() public ERC20("Y2K", "Y2K") {
    ...
    function _transfer(
        ...
        } else if (block.timestamp - startTime < 1) {
            require(amount <= 5**6 * (10**18), "Over the max tx amount.");
        }
