...
contract Allheroes is ERC721Enumerable, Ownable, PaymentSplitter {
  using Strings for uint256;

  string baseURI;
  uint256 public cost = 0.015 ether;
  uint256 public maxSupply = 5000;
  uint public maxFree = 1000;
  uint public wlMaxPerTx = 2;
  uint public wlMaxPerWallet = 2;
  uint public publicMaxPerTx = 2;
  uint public publicMaxPerWallet = 2;
  ...
  enum Step {
    ...
    address[] private _team = [
        0x4Efe84F064399d2D3503757cC9412d5D5562A24c
    ];
