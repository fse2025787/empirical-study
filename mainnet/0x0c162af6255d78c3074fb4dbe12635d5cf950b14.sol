...
contract BankCDramAlfa1 is ERC20, Ownable, PullPayment{
    ...
    constructor() ERC20('Crypto dram - Cdramtest2', 'CDramERC20-test2') { 
...
address public dumpAddress;
    ...
    function loanPayment(uint256 payingCdramByEther, uint256 cdram, uint256 eth, int isFullPayed, bytes memory signature) public returns(bool){
        ...
        address getSignAddress = parseSignatureLoanPayment(payingCdramByEther, cdram, eth, isFullPayed, signature);
        require (getSignAddress == getSignAddress, "Loan pay transaction failed, signatura is not compatible!");
