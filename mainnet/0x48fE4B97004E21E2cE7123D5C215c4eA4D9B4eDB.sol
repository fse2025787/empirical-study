...
/**
 * @title GrovebridgeInfo
 * @dev Functionality for versioning Grovebridge mediator.
 */
contract GrovebridgeInfo is VersionableBridge {
...
contract SelectorTokenGasLimitManager is OwnableModule {
    ...
    /**
     * @dev Sets the default values for different Grovebridge selectors.
    ...
    function setCommonRequestGasLimits(uint256[] calldata _gasLimits) external onlyOwner validGasLimits(7, _gasLimits) {
        ...
        selectorGasLimit[BasicGrovebridge.deployAndHandleBridgedTokens.selector] = _gasLimits[0];
        selectorGasLimit[BasicGrovebridge.deployAndHandleBridgedTokensAndCall.selector] = _gasLimits[1];
        selectorGasLimit[BasicGrovebridge.handleBridgedTokens.selector] = _gasLimits[2];
        selectorGasLimit[BasicGrovebridge.handleBridgedTokensAndCall.selector] = _gasLimits[3];
        selectorGasLimit[BasicGrovebridge.handleNativeTokens.selector] = _gasLimits[4];
        selectorGasLimit[BasicGrovebridge.handleNativeTokensAndCall.selector] = _gasLimits[5];
    ...
    {
        require(_gasLimits[1] >= _gasLimits[0]);
        selectorTokenGasLimit[BasicGrovebridge.handleNativeTokens.selector][_token] = _gasLimits[0];
        selectorTokenGasLimit[BasicGrovebridge.handleNativeTokensAndCall.selector][_token] = _gasLimits[1];
    }
        ...
        validGasLimits(4, _gasLimits)
    {
        ...
        require(_gasLimits[0] >= _gasLimits[2]);
        require(_gasLimits[1] >= _gasLimits[3]);
        selectorTokenGasLimit[BasicGrovebridge.deployAndHandleBridgedTokens.selector][_token] = _gasLimits[0];
        selectorTokenGasLimit[BasicGrovebridge.deployAndHandleBridgedTokensAndCall.selector][_token] = _gasLimits[1];
        selectorTokenGasLimit[BasicGrovebridge.handleBridgedTokens.selector][_token] = _gasLimits[2];
        selectorTokenGasLimit[BasicGrovebridge.handleBridgedTokensAndCall.selector][_token] = _gasLimits[3];
    }
}
...
contract TokenProxy is Proxy {
    ...
    constructor(
        ...
        symbol = _symbol;
        decimals = _decimals;
        owner = _owner; // _owner == HomeGrovebridge/ForeignGrovebridge mediator
