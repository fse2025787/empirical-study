...
contract DHPStaking is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        walletA = address(0x3A8c5f8bFb00B2525FF7f620B7653e65A26e0d5e);
        ...
        lockups.push(Lockup(0, 7, 0, 300, 10000000000000, 0, 0, 0)); // 1% liquidity
        lockups.push(Lockup(1, 15, 0, 300, 10000000000000, 0, 0, 0)); // 1.5% liquidity
        lockups.push(Lockup(2, 30, 0, 300, 10000000000000, 0, 0, 0)); // 2% liquidity
        lockups.push(Lockup(3, 90, 0, 300, 10000000000000, 0, 0, 0)); // 2.5% liquidity
