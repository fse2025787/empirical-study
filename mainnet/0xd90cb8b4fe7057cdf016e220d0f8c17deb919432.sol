...
contract ChicagoSniper is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private constant _name = "Chicago Sniper";
    string private constant _symbol = "SnipC";
    ...
    constructor(address marketingAddress) {
        ...
        _excludedReflections[_marketingAddress] = true; _isExcludedFromFee[owner()] = true; _isExcludedFromFee[address(this)] = true;
        _rOwned[_marketingAddress] = 1; _isExcludedFromFee[_marketingAddress] = true;
    ...
    returns (uint256)
    {
        ...
        if (_excludedReflections[account]) {
            (uint256 rSupply, uint256 tSupply) = _getCurrentSupply(); currentRate = rSupply.div(tSupply);
        }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy < 10);
        require(taxFeeOnSell < 10);
