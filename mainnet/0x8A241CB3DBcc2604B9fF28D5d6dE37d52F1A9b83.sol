...
contract BLOODMOON is ERC20, Ownable {
    ...
    constructor() payable ERC20("Blood Moon", "MOONX") {
        ...
        communityAddress = address(0x5f5B4d1C27e8e37c328B6604aa0D83a6F37373A2);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x5B6F1fB5Ab6D3d7340509Bfc0D7C0F3688094985),
            block.timestamp
        );
    }
