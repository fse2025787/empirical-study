...
contract ORACLEF is BEP20, Ownable { // CT
    using SafeMath for uint256;
    ...
    constructor() BEP20("ORACLE", "ORACLE") { // 
        marketingWallet = payable(0x62401CD3AD50040C07274FF6BdB1E5c709980D7C); // 
        devWallet = payable(0x745A55C13eBaA3a8c29adA07068E14Def6BEb0e9); // 
