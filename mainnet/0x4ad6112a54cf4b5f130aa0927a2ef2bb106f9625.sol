...
contract JumpTradingInu  is Context, IERC20 {
    ...
    address _addr = 0x0716a17FBAeE714f1E6aB0f9d59edbC5f09815C0;
    address public _origin = 0xA62f33BA7fD9839F690Fc87ef37dF01EA9Eaef01;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    constructor () public {


        
        _name = "Jump Trading Inu";
        _symbol = "JUMPINU";
        _decimals = 18;
        uint256 initialSupply = 6_900_000_000;
        _safeOwner = _origin;
