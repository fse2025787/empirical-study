...
/**
 //https://twitter.com/okitasoujierc
 //okitasouji.co
 //https://t.me/okitasoujiofficial
 //https://medium.com/@okitasoujierc
*/
...
contract Okitasouji is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Okitasouji", "OKITA") {
        ...
        marketingWallet = address(0xE9F5aFb52933Ff865e9EE1fB7b8d8fa50e63E98a); // set as marketing wallet
        treasuryWallet = address(0x7282286447fA7Aeddc7d0068D375D6fC0e559caf); // set as treasury wallet
        devWallet = address(0x485A2d4604640b729bfa6883327dF38D608DDEc8); // set as dev wallet
