...
contract TheLastDogeBender is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Last DogeBender";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x2b54d66D71c2Aca613FBE02c1ED205874f1D11B9);
        _feeAddrWallet2 = payable(0xEa5c4733ff30f3324CF4D213fe9333733B334721);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 3% WHO SELL WITHIN 2 HOURS
            if (_buyMap[from] != 0 &&
