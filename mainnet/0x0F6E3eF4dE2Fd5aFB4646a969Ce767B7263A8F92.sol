...
contract Culthor is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 4000000 * 10**18;
	string private constant _name = "Cult Thor";
	string private constant _symbol = "CULTHOR";
