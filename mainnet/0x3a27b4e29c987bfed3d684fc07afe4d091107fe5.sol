...
contract ERC20Base is Context, ERC20, Ownable, Lockable {
    ...
    string internal constant TOKEN_TIME_LOCKED = "ERC20: Tokens is Time locked for senders address";
...
contract Digitalcomics is ERC20Base {
    constructor() payable ERC20Base("Digitalcomics", "DC") {
        mint(msg.sender, 5000000000*(10**uint256(decimals())));
    }
