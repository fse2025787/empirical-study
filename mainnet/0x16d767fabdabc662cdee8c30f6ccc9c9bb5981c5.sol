...
Money Heist – Fortune favors the bold

Heist Vault
1% of all transactions are stored in the vault and will be given to lucky holders held their position throughout the heist.
A PERCENTAGE OF EVERY TRANSACTION IS SET ASIDE INTO THE VAULT, IF YOU HOLD THE MONEY HEIST TOKEN AND JOIN THE TEAM, WITHOUT SELLING, YOU ARE ENTERED TO WIN THIS HUGE STACK OF CASH. IF YOU SELL, YOU SOLD YOUR SPOT TO WIN THIS HUGE PRIZE.
...
contract HEIST is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Money Heist";
    string private constant tokenSymbol = "HEIST";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x120584ea1b0F194083e289bf3d93D1d37b380ea5);
        devAddress = payable(0x120584ea1b0F194083e289bf3d93D1d37b380ea5);
