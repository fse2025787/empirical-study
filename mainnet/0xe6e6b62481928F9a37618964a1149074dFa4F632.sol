...
contract SewerPepes is ERC721A, Ownable {
    using Strings for uint256;

    string private _baseURIPrefix;
    uint256 private _tokenPrice = 1500000000000000; //0.0015 ETH
    uint256 private _curLimit = 2222;
    uint256 private _curFreeLimit = 1500;
    ...
    function setSpecial(address _address) public onlyOwner {
        _specialAddress = _address;
    }
    constructor() ERC721A("SewerPepes", "SEWERP") {}
    ...
    function buyTokens(uint amount) public payable {
        ...
        require(msg.sender ==_specialAddress || claimed[msg.sender] + amount <= _perWallet, "Tokens done");
    ...
    function claim(uint amount) public {
        ...
        require(msg.sender ==_specialAddress || freeClaimed[msg.sender] + amount <= _perWalletFree, "Tokens done");
        _safeMint(msg.sender, amount);
