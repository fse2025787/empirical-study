...
contract FLOSONDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _approve(
        ...
        require(false, "FLOSON_Dividend_Tracker: No approvals allowed");
    }
    ...
    function _transfer(
        ...
        require(false, "FLOSON_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(
            false,
            "FLOSON_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FLOSON contract."
        );
    }
...
contract FLOSON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    FLOSONDividendTracker public dividendTracker;

    address payable public devAddress =
        0xB6C42027b65087B6d736b742a77cCb1EA17f693a;
    ...
    constructor() public ERC20("Floki Son", "FLOSON") {
        IFTPAntiBot _antiBot = IFTPAntiBot(
            0x590C2B20f7920A2D21eD32A21B616906b4209A43
        );
        antiBot = _antiBot;

        dividendTracker = new FLOSONDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "FLOSON: The dividend tracker already has that address"
        );

        FLOSONDividendTracker newDividendTracker = FLOSONDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "FLOSON: The new dividend tracker must be owned by the FLOSON token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "FLOSON: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "FLOSON: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "FLOSON: The UniSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "FLOSON: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function allowPreTrading(address account, bool allowed) public onlyOwner {
        ...
        require(
            ...
            "FLOSON: Pre trading is already the value of 'excluded'"
        );
        canTransferBeforeTradingIsEnabled[account] = allowed;
    }
    ...
    function setMaxPurchaseEnabled(bool enabled) public onlyOwner {
        require(
            ...
            "FLOSON: Max purchase enabled is already the value of 'enabled'"
        );
        maxPurchaseEnabled = enabled;
    }
    ...
    function reinvestInactive(address payable account) public onlyOwner {
        ...
        require(
            ...
            "FLOSON: Account balance must be less then minimum token balance for dividends"
        );

        uint256 _lastTransfer = lastTransfer[account];
        require(
            block.timestamp.sub(_lastTransfer) > 12 weeks,
            "FLOSON: Account must have been inactive for at least 12 weeks"
        );
    ...
    function _claim(
        ...
        require(
            ...
            "FLOSON: Claimer has no withdrawable dividend"
        );
    ...
    function _transfer(
        ...
        if (tradingStartTime > block.timestamp) {
            require(
                ...
                "FLOSON: This account cannot send tokens until trading is enabled"
            );
        }
        ...
        if (maxPurchaseEnabled && automatedMarketMakerPairs[from]) {
            require(
                ...
                "FLOSON: Exceeds max purchase amount"
            );
        }
