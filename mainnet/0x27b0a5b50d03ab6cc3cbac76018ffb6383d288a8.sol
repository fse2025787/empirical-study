...
contract A_True_Shitcoin is ERC20, AccessControl {
    ...
    address private marketting_address=address(0);
    ...
    constructor() ERC20("A True Shitcoin", "TOKEN") {
