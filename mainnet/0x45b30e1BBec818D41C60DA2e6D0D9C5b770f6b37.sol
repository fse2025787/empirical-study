...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x57AB1bB893577b2E3f91F979855eC6D913D643Ef];
  address public erc20Payable = 0x57AB1bB893577b2E3f91F979855eC6D913D643Ef;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.027 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 200) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibhgzzsyqmej7pqtpjlbznnlrw7gioxm4vez7sh7l42tclkyyqhea/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MHAE2qCK8LDCb9FQ4ZD5/contract-metadata";
  }
...
// File: contracts/SoundVerseSoundClauseContract.sol
//

pragma solidity ^0.8.0;

contract SoundVerseSoundClauseContract is RamppERC721A {
    constructor() RamppERC721A("SoundVerse Sound Clause", "SVSC"){}
}
