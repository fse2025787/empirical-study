...
PausableUpgradeable
{
    ...
    /**
     * Override isApprovedForAll to whitelist user's Jungle proxy accounts to enable gas-free listings.
     */
    ...
    {
        // Whitelist Jungle proxy contracts for easy trading.
    ...
    returns (bool)
    {
        ...
        return address(IProxyRegistry(proxyRegistryAddress).proxies(_user)) == _address;
    }
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by Jungle.
     */
...
interface IProxyRegistry {
    function proxies(address _address) external view returns(IOwnableDelegateProxy);
}
