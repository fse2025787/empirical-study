...
/*
Telegram : https://t.me/SwordInu
Twitter : https://twitter.com/SwordInu
*/
...
contract SwordInu is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 25000 * (10**18);
    uint256 public swapTokensAtAmount = 1000 * (10**18);
    uint256 public maxWalletToken = 25000 * (10**18);

    uint256 private buyTotalFees = 1;
    uint256 public sellTotalFees = 1;
    uint256 public earlySellTotalFee = 0;
    ...
    address payable public marketingWallet = payable(0x06fE045d7616E76E6d1b090A1A44C6a89625d88a);
    address payable public devWallet = payable(0xA5580B844e3Bc080815588bd019a366337C1741A);
    ...
    constructor(address router) ERC20("SwordInu", "SWI") {
