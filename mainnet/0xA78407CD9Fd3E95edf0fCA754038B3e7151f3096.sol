...
contract Middleground is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 44;
    ...
    address[] public withdrawAddresses = [0x219A19b4C73cD70632134f70FbAfb31d2F0dcF2c, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xc7dd626deeae27d11e4b5475b653abee8c24b6a19c5fe23b9a17363e0ba16255;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x219A19b4C73cD70632134f70FbAfb31d2F0dcF2c, _royaltyAmount);
    }
