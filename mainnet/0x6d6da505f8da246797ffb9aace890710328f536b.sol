...
contract SpiritualEth is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spiritual";
    string private constant _symbol = "SPIRITUAL";
