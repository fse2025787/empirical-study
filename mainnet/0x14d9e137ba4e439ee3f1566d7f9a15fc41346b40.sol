...
contract GGAncients is ERC721AQueryable, Ownable {
...
// MERKEL TREE STUFF
  bytes32 public merkleRoot = 0x9e36d13e68ab743d6d6b82c2d37d467466300d963044b6ec94dcf66c8aa631e3;
  
  constructor() ERC721A("GGAncients", "GGA") {
    _startTokenId();
    setHiddenMetadataUri("https://www.starlite.top/ghidorah/hiddenMeta.json"); //https://www.starlite.gg/hiddenMeta.json
  ...
  modifier mintCompliance (uint256 _mintAmount) {
    ...
    if (whitelistPhase == 0) //GG Claims
    {
      walletLimit = 2;
    }
    else if (whitelistPhase == 1) //SXS Claims
    {
      walletLimit = 1;
    }
    else if (whitelistPhase == 2) // Public
    {
        walletLimit = 1;
    }
  ...
  {
    if (whitelistPhase == 0 || whitelistPhase == 1)
    {
  ...
  {
    require(whitelistPhase == 2, "Still in Whitelist Sale!");
