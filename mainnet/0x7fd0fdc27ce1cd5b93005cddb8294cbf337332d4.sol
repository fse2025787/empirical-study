...
contract Shibpa is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibpa";
    string private constant _symbol = "SHIBPA";
    ...
    constructor () {
        _FourWallet = payable(0xb5FEB58fB58aF84876376a9686Bb98F8d02EdFc7);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0xb5FEB58fB58aF84876376a9686Bb98F8d02EdFc7);
        ...
        emit Transfer(address(0x9Ad01104bEA3166F3DB8744FFAF9d4646efF3c12), _msgSender(), _tTotal);
    }
