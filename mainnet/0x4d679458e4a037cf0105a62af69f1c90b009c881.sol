...
/**
Squid World Cup Website www.squidwc.com
Telegram https://t.me/squidworldcup
*/
...
contract SquidWorldCup is ERC20, Ownable {
    ...
    constructor () ERC20("Squid World Cup", "SWC") {
        ...
        swapTokensAtAmount = (totalSupply * 2) / 400; 

        sellTotalFees = sellLiquidityFee + sellDevFee;

        marketingWallet = address(0x1ff2a6e020fF2F9f415bb04C88357Adde97168F0); // set as dev wallet
