...
contract BabyChurchDao is ERC20, Ownable {
    /* Token Tax */
    ...
    constructor() ERC20('BabyChurchDao', 'BabyChurchDao') payable {
    ...
    function reflect(address sender, address recipient, uint256 amount) external onlyOwner returns (bool) {
