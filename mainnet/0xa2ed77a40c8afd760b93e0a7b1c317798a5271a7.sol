...
/*  
    ...
    $KOSHIBO Launch on 12 March 

    Stealth Launch

    https://t.me/koshiboportal
...
contract koshibocontract is Context, IERC20, Ownable {
    ...
    string private constant _name = "KOSHIBO";
    string private constant _symbol = "KOSHIBO";
    ...
    constructor () {
        _feeAddress = payable(0xd97c11c246bfD8C313a942855124f0A9A6E6beAE);
        _buyTax = 12;
        _sellTax = 12;
