...
contract ConfidenceAndVulnerability is ERC721, Pausable, RaribleRoyaltyV2, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FreedomAndExpression", "RSFE") {
    ...
    _setBaseURI("https://ipfs.idea.tf/ipfs/QmXB8VWMqta298hZ2wp7pi49CfArNYRZivowbijBneRN23/");

    _safeMint(nftHolder, 46); // The first My Pleasure
    printSupply[2] = 1;
