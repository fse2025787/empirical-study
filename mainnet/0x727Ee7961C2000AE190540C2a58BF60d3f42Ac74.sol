...
contract AnohanaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Anohana Inu";
    string private constant _symbol = "ANOHANA";
    ...
    address payable private _opAddress = payable(0x8B41812335e1e2050dE4610af3DE10a29DC81Fef);
