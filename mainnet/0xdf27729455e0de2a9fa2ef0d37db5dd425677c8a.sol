...
contract Vinlink is ERC20, LockToken {
    ...
    constructor() ERC20("VINLINK", "VINLINK") {
        ...
        address newOwner = address(0xD5e38d28b953399371024AE463fa35AF034F20ce);
        ...
        uint256 _buyTreasury = 4;
        
        uint256 _sellDevFee = 2;
        uint256 _sellLiquidityFee = 2;
        uint256 _sellTreasury = 6;
    	...
    	developmentWallet = address(0x29B46d2D02a7CAeE6dE90E6F50734BF7dD7b7ad6); // set as Development wallet
    	treasuryWallet = address(0x7750a2257B54b755F227097a1d0193e7037Dbc00); // set as treasury wallet
