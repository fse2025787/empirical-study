...
contract Mario is Context, IERC20, Ownable {
    ...
    // Context";
    string private _name = "Tanooki Mario";
    string private _symbol = "$Mario";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 1 * 1e5 * 1e18;    
    uint256 private minimumTokensBeforeSwap = _totalSupply * 1 / 700;    
    ...
    // wallets
    address payable public liquidityWallet = payable(0xe3fb1f3e0639114596bfAa8824C0acec056cdf65);
    address payable public operationsWallet =  payable(0xe3fb1f3e0639114596bfAa8824C0acec056cdf65);
    ...
    uint256 public maxTotalFeeSell = 70;
