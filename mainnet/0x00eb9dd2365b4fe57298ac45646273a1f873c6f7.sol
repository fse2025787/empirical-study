...
Website: https://riddle.lol/
Theres is a riddle on the website which wen solved will lead you to a v2 website
whoever finds its will have a nice surprise waiting for him. if nobody is able to find it .i will reveal it in 1 hr 
https://t.me/RiddlerErc
*/
// 
...
contract Riddle is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 25; // 4% of supply
    ...
    string private constant _name = "Riddler";
    string private constant _symbol = "Riddle";
