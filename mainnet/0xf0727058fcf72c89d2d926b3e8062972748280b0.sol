...
// Part: IComplifiVaultRegistry

interface IComplifiVaultRegistry {
    function getAllVaults() external view returns (address[] memory);
}

// Part: IDerivativeSpecification
...
interface ILiquidityMining {
    ...
    function calcUnlocked(uint256 reward)
        external
        view
...
// Part: IVault (Alias import as IComplifiVault)



interface IComplifiVault {
