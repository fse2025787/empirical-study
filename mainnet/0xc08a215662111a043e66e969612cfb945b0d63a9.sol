...
Always missing those Elon launches? Well Elon’s Degen’s has your back! Our experienced team will monitor Elon’s social media accounts (primarily Twitter) to make sure you get in early for any new coins based on Elon’s tweets. 

With many of these coins going up 50X-100X or more, you will want to get a piece of the action and get in early. 100% of all profits will be returned to token holders in the form of Eth dividends or buybacks. Initially, all profits will be delivered via buybacks. Token holders also enjoy 3% USDC reflections to boost passive income.

Together with an experienced team, $EDEGEN should be the last Elon coin you need to buy.

// Web: https://edegens.com/
// Twitter: https://twitter.com/elonsdegens
// Tg: https://t.me/ElonsDegens
...
interface IUniswapV2Pair {
    ...
    contract Edegen is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Elons degens";
    string private _symbol = "Edegen";
    ...
    address payable public marketingWallet = payable(0x6F3ce496EAC187F1E9867C2542c65A2329dEd1de);
