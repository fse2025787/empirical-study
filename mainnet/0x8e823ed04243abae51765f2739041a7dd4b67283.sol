...
// The darkness before dawn is only temporary, and there will always be sunshine.
...
contract darkness is Context, IERC20, Ownable {
    ...
    string private _name = "darkness";
    string private _symbol = "darkness";
