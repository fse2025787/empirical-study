...
contract DivineWind is Context, IERC20, Ownable {
    ...
    string private constant _name = "Divine Wind";
    string private constant _symbol = "Kamikazee";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x4F1588C85CFa05a8AE88a6a639EEC35b9090831a); 
