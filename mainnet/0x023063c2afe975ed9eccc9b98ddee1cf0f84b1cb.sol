...
// File: contracts/KiddiMainnet.sol
...
contract KiddieJungle is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    bytes32 public root;

    uint256 MAX_MINTS = 5;
    uint256 MAX_SUPPLY = 13;
    uint256 MAX_SUPPLY_PRIVATE_WHITELISTED = 5;

    uint256 public mintRatePrivateWhitelist = 0 ether;
    uint256 public mintRatePublicWhitelist = 0.01 ether;
    uint256 public mintRatePublicSale = 0.012 ether;
    ...
    string public baseURI = "ipfs://QmPvCnS6KwFU8sUKUTQZrfRcmGgYdg9UfZMhkh39SHoRJT/";
    string public uriSuffix = ".json";    
    string public hiddenMetadataUri;

    address constant public privateWLAddress = 0xaF72b6a1AC9f1C0b8bc9d6684a5F411d447111B1;

    constructor(bytes32 _root) ERC721A("Kiddie Jungle", "K Jungle") {
        setHiddenMetadataUri("ipfs://QmPvCnS6KwFU8sUKUTQZrfRcmGgYdg9UfZMhkh39SHoRJT/Hidden.json");
        root = _root;
    }
