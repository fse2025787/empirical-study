...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 180;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeNAf4zuAdzaxqXbXpc7NGYYXij78trQGGrAVPZEtQREF/";
...
// File: contracts/EtherealsAiContract.sol
//

pragma solidity ^0.8.0;

contract EtherealsAiContract is RamppERC721A {
    constructor() RamppERC721A("Ethereals AI", "ETHAI"){}
}
