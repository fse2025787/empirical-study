...
contract SwaggyMoose is ERC721, Ownable {
    ...
    swaggycows = SwaggyCows(0x398A5b355658Df4a836c9250FCe6F0A0fC0c9EA0);
    }
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        MOOSE_PROVENANCE = provenanceHash;
    }
    
      function isMinted(uint256 tokenId) external view returns (bool) {
    require(tokenId < MAX_MOOSE, "tokenId outside collection bounds");
    ...
    function tokenLicense(uint _id) public view returns(string memory) {
        require(_id < totalSupply(), "CHOOSE A MOOSE WITHIN RANGE");
        return LICENSE_TEXT;
    }
