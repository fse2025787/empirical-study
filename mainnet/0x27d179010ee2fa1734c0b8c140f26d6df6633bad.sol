...
*/
contract TeddyBoyLimitedEdition is Initializable, ERC721Upgradeable, OwnableUpgradeable {
	...
	function initialize(string memory name, string memory symbol, string memory baseURI_) public virtual initializer {
	...
	//getters
	//========
	function config() public view returns(bool) {
