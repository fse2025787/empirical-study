...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUXojRDwVZNTkyfeU12bxXWd3EDCCqSfuBcPqiERhN7pd/";
...
// File: contracts/JustaChickenContract.sol
//

pragma solidity ^0.8.0;

contract JustaChickenContract is RamppERC721A {
    constructor() RamppERC721A("JustaChicken", "AChicken"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5TzxoY2y0k4lUZDDY95Q/contract-metadata";
    }
}
