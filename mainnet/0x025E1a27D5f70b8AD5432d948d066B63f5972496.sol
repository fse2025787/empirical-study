...
contract GemSwap is SpecialTransferHelper, Ownable, ReentrancyGuard {
    ...
    function setOneTimeApproval(address token, address operator, uint256 amount) external onlyOwner {
        token.call(abi.encodeWithSelector(0x095ea7b3, operator, amount));
    }
