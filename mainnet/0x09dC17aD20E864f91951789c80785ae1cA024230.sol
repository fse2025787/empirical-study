...
contract TetoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Teto Inu";
    string private constant _symbol = "TetoInu";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xC32d316238C5811441863D0F2961167C755397f9); // Marketing Address
        devAddress = payable(0x65029D6872DeDD7D5344c20d1fe4C23bb6D3059D); // Dev Address   
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over.  DM a TetoInu Mod.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
