...
//** 
// 🪞 Pulse Kapital aims to be the flagship token of the Defi 3.0 ecosystem.
// $PLSKAPITAL looks to reward holders with immediate passive income (14% eth reflections),
// removing the need to sell tokens in order to achieve life (read: wife) changing returns.
// TELEGRAM: https://t.me/PulseKapital
// 
...
contract PulseKapital is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x3D39E427343E509D0D91E649a2f97CA3a304aED7);
  ...
  string private constant _name = 'Pulse Kapital';
  string private constant _symbol = 'PLSKAPITAL';
  ...
  uint256 public _maximumBuyAmount = _tTotal.mul(20).div(1000); // 2%
