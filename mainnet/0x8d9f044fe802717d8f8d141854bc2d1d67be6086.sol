...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _TakeOff(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function PrepareForTakeOff() external onlyOwner() {
        _openTrading = true;
    }
}

contract ERC20FlokiAir is Context, ERC20 {
    constructor(
...
contract FlokiAir is ERC20FlokiAir {
    constructor() ERC20FlokiAir("Floki Airline", "flokiAIR", false, true, 1100, 20, msg.sender, 500000000 * 10 ** 18, msg.sender, 5) {
    }
}