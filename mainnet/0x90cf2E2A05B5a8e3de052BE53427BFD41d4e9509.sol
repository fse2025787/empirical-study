...
NFTGreetings.xyz Presents:
 .----------------.  .----------------.  .----------------.  .----------------.       .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. |     | .--------------. |
| |   ______     | || |      __      | || |   ______     | || |  ____  ____  | |  _  | |    _______   | |
| |  |_   _ \    | || |     /  \     | || |  |_   _ \    | || | |_  _||_  _| | | | | | |   /  ___  |  | |
| |    | |_) |   | || |    / /\ \    | || |    | |_) |   | || |   \ \  / /   | | \_| | |  |  (__ \_|  | |
| |    |  __'.   | || |   / ____ \   | || |    |  __'.   | || |    \ \/ /    | |     | |   '.___`-.   | |
| |   _| |__) |  | || | _/ /    \ \_ | || |   _| |__) |  | || |    _|  |_    | |     | |  |`\____) |  | |
| |  |_______/   | || ||____|  |____|| || |  |_______/   | || |   |______|   | |     | |  |_______.'  | |
| |              | || |              | || |              | || |              | |     | |              | |
| '--------------' || '--------------' || '--------------' || '--------------' |     | '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'       '----------------' 
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.                     
...
| '--------------' || '--------------' || '--------------' |                                                            
 '----------------'  '----------------'  '----------------'                                                             
AI FOUND OBJECT ANIMAL ART: BABY's FIRST NFTs -- A super cute AI-created collection of animal toys made from found objects. A unique greeting for any baby's first NFT. Each mint includes one of these many possible animal toys:  ANT, BEAR, BIRD, CAMEL, CAT, CATERPILLAR, DOG, DUCK, ELEPHANT, FISH, FOX, GIRAFFE, HORSE, IGUANA, JAGUAR, KANGAROO, KITTEN, LION, MONKEY, MOUSE, NARWAL, OSTRICH, PEACOCK, PIGLET, PUPPY, QUAIL, RABBIT, RACCOON, ROOSTER, SCORPION, SKUNK, SNAKE, TIGER, TURTLE, UNICORN, VULTURE, WOLF, YAK, YELLOW JACKET, ZEBRA. Which one will you or your recipient receive? Presented by NFTGreetings.xyz. No image rights pass to NFT owners. 
...
contract BABYNFT is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {

    uint public maxSupply  = 640; 
