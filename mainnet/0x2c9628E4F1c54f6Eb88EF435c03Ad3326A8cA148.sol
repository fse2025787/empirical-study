...
//   mapping(address => bool) public whitelistClaimed;
  ...
  function withdrawAll() external payable onlyOwner nonReentrant {
        ...
        uint256 balanceOne = balance * 10 / 100;
        uint256 balanceTwo = balance * 20 / 100;
        uint256 balanceThree = balance * 15 / 100;
        uint256 balanceFour = balance * 5 / 100;
        uint256 balanceFive = balance * 10 / 100;
        uint256 balanceDev = balance * 1 / 100;
        ( bool transferOne, ) = payable(0x913f6294c35150B5067559b76C1e53380636BA0B).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xC11778679A4B7be52f63be6b152643549db2C246).call{value: balanceTwo}("");
        ( bool transferThree, ) = payable(0xBDd95CAd313eB8eD0784bcB07aEA41292ecCf3bc).call{value: balanceThree}("");
        ( bool transferFour, ) = payable(0x67fa73E8cc5F67AB017f68DCF213BB74dCbf9E6e).call{value: balanceFour}("");
        ( bool transferFive, ) = payable(0x7455D8672c75B50eC35bc62C1c9e231101704EBe).call{value: balanceFive}("");
        ( bool transferDev, ) = payable(0x913f6294c35150B5067559b76C1e53380636BA0B).call{value: balanceDev}(""); // Dev Donation - The Bee Collab
        (bool remaining, ) = payable(owner()).call{value: address(this).balance}('');
        require(transferOne && transferTwo && transferThree && transferFour && transferFive && transferDev && remaining, "Transfer failed.");
