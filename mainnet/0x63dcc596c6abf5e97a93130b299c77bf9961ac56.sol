...
contract ICExtensionGalaSale is ERC721, Ownable {
    using Strings for uint256;

    uint256 public IC_PRICE = 50 ether;
    ...
    IERC20 private constant IC_TOKEN = IERC20(0x15D4c048F83bd7e37d49eA4C83a07267Ec4203dA);
    ...
    function redeemCode(bytes32 codeHash, bytes calldata signature) external {
        ...
        IC_TOKEN.transferFrom(msg.sender, IC_PAYOUT_ADDRESS, IC_PRICE);
    ...
    function innerCircleSale(uint256 amount, uint256 maxAmount, bytes calldata signature) external {
    ...
    function allowListSale(uint256 amount, bytes32 nonce, bytes calldata signature) external {
        ...
        IC_TOKEN.transferFrom(msg.sender, IC_PAYOUT_ADDRESS, IC_PRICE * amount);
    ...
    function mint(uint256 amount, bytes32 nonce, bytes calldata signature) external {
