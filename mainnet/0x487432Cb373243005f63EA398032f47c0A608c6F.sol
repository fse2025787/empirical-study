...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xf727d32E2E2d4EFEc302d4eC0954dfa82A825aDc];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xf727d32E2E2d4EFEc302d4eC0954dfa82A825aDc;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 2499) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSywBDDHVBe1B6bsakxqEhQj5uodCaJNg3H7yjNVUUjwc/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2499");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2499");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2499");
...
// File: contracts/PixelCarRacerContract.sol
//

pragma solidity ^0.8.0;

contract PixelCarRacerContract is RamppERC721A {
    constructor() RamppERC721A("PixelCarRacer", "PixelCar"){}
}
