...
contract Blink is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x00aF98eFada61d3d57874A032a412e7DB19883D1); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x00aF98eFada61d3d57874A032a412e7DB19883D1); // Development Address
    ...
    function BlinkreaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
