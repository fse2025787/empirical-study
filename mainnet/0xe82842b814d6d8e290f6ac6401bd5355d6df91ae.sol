...
contract IronPhoenix is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1200000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Iron Phoenix";
    ...
    address payable private _devWallet = payable(0xb8C261664EC5937539c19315DB4Dc0Cca6cfC891);
    address payable private _marketingWallet = payable(0xaaf8dC636155CDb6291b45404B1883f82c46f3E4);
    ...
    uint256 private minTokensBeforeSwap = 1200000 * 10**9;
