...
// 
// Doge Of War - DOW INU 
// https://t.me/dogofwarerc
// https://www.dogofwar.vip
// tax : Buy 6/12 Sell  
...
contract DogofWar is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DogofWar Inu";
    string private constant _symbol = "DOWINU";
    ...
    uint256 _totalSupply = 23000000 * 10**18;
    ...
    address payable private _marketingAddress = payable(0xD567BDAdB3a2D42ee2cf811105B7052457f25935);
    ...
    uint256 public _maxTxAmount = 690000 * 10**18; //3
    uint256 public _maxWalletSize = 1150000 * 10**18; //5
    uint256 public _swapTokensAtAmount = 115000 * 10**18; //0.5
