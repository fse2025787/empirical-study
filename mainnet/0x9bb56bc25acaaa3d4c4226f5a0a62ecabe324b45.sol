...
/*
The Ancient first mentions of the Phoenix.
True burns of 9% on every sell.
*/

// 
// https://birdoffire.medium.com/ancient-9658d02d0db1
...
contract BENNU is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Bird Of Fire", "BENNU") {
        ...
        maxTransactionAmount = totalSupply * 2 / 1000; // 0.3% maxTransactionAmountTxn
    ...
    function updateBuyFees(uint256 _mintFee) external {
        ...
        buyMintFee = _mintFee;
        buyTotalFees = buyMintFee;
        require(buyTotalFees <= 500, "Must keep fees at 4.00% or less");
    }
    ...
    function LaunchProtocol(uint256 Bblock) external onlyOwner {
        tradingActive = true;
