...
contract FUCKEMOJIS is IERC20, Auth {
	string _name = "FUCKEMOJIS";
	string _symbol = "&#129324";
	uint256 constant _totalSupply = 10 * (10**6) * (10 ** _decimals);
	...
	uint16 private _ethTaxShares1  = 400;
	...
	address payable private _ethTaxWallet1 = payable(0x3D753978a32a649275481547C1925f82b7bB8A9f); 
	address payable private _ethTaxWallet2 = payable(0x3D753978a32a649275481547C1925f82b7bB8A9f); 
	address payable private _ethTaxWallet3 = payable(0x3D753978a32a649275481547C1925f82b7bB8A9f); 
	address private _tokenTaxWallet = address(0x3D753978a32a649275481547C1925f82b7bB8A9f); 
