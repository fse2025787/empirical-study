...
contract AKIYOSHIFUND is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private pair;
    bool public tradingOpen;
    uint256 public _maxWalletSize = 13339993339 * 10 ** decimals();
    uint256 private _totalSupply = 666999666999 * 10 ** decimals();

    constructor() ERC20("AKI FUND", "$Aki Fund") {
