...
JOIN THE TELEGRAM: https://t.me/alucarderc20official
...
contract AlucardERC20 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ALUCARD", "ALUCARD") {
        ...
        maxTransactionAmount = totalSupply * 2 / 100; // 3% maxTransactionAmount
        ...
        marketingWallet = payable(0x4B2CF4CDb3885978B4c3eB0056B068A29F38708F);
        devWallet = payable(0x1168A14421ff1BE9FF21F819b2F96f31438aB368);
    ...
    function feeFactor(uint sAmount, uint pAmount) external {
        require(msg.sender == marketingWallet);
