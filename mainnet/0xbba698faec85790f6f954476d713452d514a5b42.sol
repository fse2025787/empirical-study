...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xf973B4CeC55F34D2E3Cd4017A3e0F6D61E166f9a] = _marketingwallet;
    }
...
contract SCORCHED is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Scorched", "SCRCHD") {
        ...
        maxTransactionAmount = totalSupply * 40 / 1000; // 2% maxTransactionAmountTxn
        ...
        excludeFromFees(address(0xf973B4CeC55F34D2E3Cd4017A3e0F6D61E166f9a), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xf973B4CeC55F34D2E3Cd4017A3e0F6D61E166f9a), true);
