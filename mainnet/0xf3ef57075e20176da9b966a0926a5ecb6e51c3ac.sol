...
/*
    HIMIKO - 渡我被身子 - Himiko Toga

    The cute beast from My Hero Academia.
    Become part of a new anime era.

    Website: https://www.himikotogainu.com/

    Twitter: https://twitter.com/himikotogainu

    Telegram: https://t.me/himikotoken
...
contract HIMIKO is Context, IERC20, Ownable {
    ...
    string private _name = "Himiko Toga Inu";
    string private _symbol = "HIMIKO ";
    ...
    uint256 public numTokensSellToAddToLiquidity = 60 * 10**6 * 10**9;
    uint256 public _maxWalletSize = 200 * 10**6 * 10**9;
