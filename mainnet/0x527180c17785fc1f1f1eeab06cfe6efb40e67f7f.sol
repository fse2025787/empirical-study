...
contract BANANA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x357b677083B3c6B95A9A125Ba5FCe82a6c17D012); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x357b677083B3c6B95A9A125Ba5FCe82a6c17D012);
    address payable public constant Wallet_Liquidity = payable(0x357b677083B3c6B95A9A125Ba5FCe82a6c17D012); 
    
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 5* 10**6 * 10**_decimals;
    ...
    constructor () {
        ...
        _owner = 0x357b677083B3c6B95A9A125Ba5FCe82a6c17D012;
