...
contract YOU_POOL is IERC20 {
    ...
    uint256 private _initialSupply = 2e8*1e18;

    string private _name = "UPL";
    
    string private _symbol = "UPOOL";
    ...
    address private okex = 0x6cC5F688a315f3dC28A7781717a9A798a59fDA7b;
    ...
    constructor () {
        ...
        _transfer(address(this), vitalik, _initialSupply*25/100);
        _transfer(address(this), dead, _initialSupply*50/100);
        _transfer(address(this), okex, _initialSupply*5/100);
    }
