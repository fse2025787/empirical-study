...
contract DunksNFT is ERC721Enumerable, Ownable {
    ...
    bool public presaleWhiteListRequired;
    ...
    //Set PrivateSale
    function pausePrivateSale(bool _status) public onlyOwner {
        privateSaleOpen = _status;
    }

    //Set PreSale
    function pausePreSale(bool _status) public onlyOwner {
        presaleOpen = _status;
    }

    //Set sale
    function pauseSale(bool _status) public onlyOwner {
        saleOpen = _status;
    }
