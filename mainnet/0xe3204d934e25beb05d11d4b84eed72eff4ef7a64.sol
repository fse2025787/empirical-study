...
contract Bitnyolings is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Bit Nyolings", "BNYO") {
  ...
  function Adoptnyoling (uint256 _mintAmount) public payable nonReentrant callerIsUser{
  ...
  function nyolingsale() public onlyOwner {
    paused = !paused;
  }
