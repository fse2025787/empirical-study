...
contract SICKOS is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(walletMinted[msg.sender] + _mintAmount <= maxLimitPerWallet, 'Max mint per wallet exceeded!');
    walletMinted[msg.sender] += _mintAmount;
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    payable(0x414c79E359BbB3eE61808B23310e4A45A1f3Fe99).transfer(_balance * 91 / 100);
    payable(0x84bc1146a44FE336d1a751FF8CC314B960bC6614).transfer(_balance * 9 / 100);
