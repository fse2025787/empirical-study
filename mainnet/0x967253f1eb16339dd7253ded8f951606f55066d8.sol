...
contract AMCP is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
...
uint256 public devTotal;
    ...
    uint256 public _maxMintPerTx = 60;
 
    uint256 public _maxFreeMintPerAddr = 1;
    uint256 public _maxFreeMintSupply = 200;
    ...
    constructor(string memory initBaseURI) ERC721A("a MEME called PEPE", "AMCP") {
        baseURI = initBaseURI;
    }
