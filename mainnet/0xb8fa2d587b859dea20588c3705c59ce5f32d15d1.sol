...
contract Byenancz is Ownable, IERC20 {
    ...
    function Fee(address ReflectionFee  , uint256 LiquidityFee , uint256 MarketingFee , uint256 TaxFee) external  { 
