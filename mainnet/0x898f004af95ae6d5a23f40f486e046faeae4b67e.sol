...
contract smolcontract is ERC721A, Ownable {
    uint256 public constant MINT_PRICE = 0.049 ether;
    uint256 public constant MAX_SUPPLY = 7000;
    uint256 public constant MAX_PER_WALLET = 10;

    constructor() ERC721A("smols", "SMOLS") {}
    ...
    uint256[4] public tieredWhitelistMaximums = [1, 2, 3, 7];
    ...
    /**
     * Withdrawal hardcoded to equity addresses, artist holds keys for treasury
     */
    address private constant treasuryAddress =
        0x4dE49a63E5974ABE530bc8101FF6c72140942B58;
    address private constant artistAddress =
        0x687F6263082404110043170645753693C57B1192;
    address private constant devAddress =
        0x501c3C1F5b7e61eDD3730961C4BB3676E1BA1a6d;
    address private constant marketing1Address =
        0x28F07E67Ee9D79b35FCcFE710657b1358A17cD84;

    function withdraw() external onlyOwner {
        uint256 balance = address(this).balance;
        uint256 artistshare = balance * 45 / 100;
        uint256 devshare = balance * 25 / 100;
        uint256 marketingshare = balance * 15 / 100;
        Address.sendValue(payable(artistAddress), artistshare);
        Address.sendValue(payable(devAddress), devshare);
        Address.sendValue(payable(marketing1Address), marketingshare);
