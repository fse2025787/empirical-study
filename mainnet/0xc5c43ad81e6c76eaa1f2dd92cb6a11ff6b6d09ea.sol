...
contract ShibaCosmos is Context, IERC20, Ownable {
  ...
  string private _name = 'Shiba Cosmos';
  string private _symbol = 'SHIBCO';
  uint8 private _decimals = 9;

  uint256 public _maxTxAmount = 3000000 * 10**5 * 10**9;
