...
// 
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"Nounsmols", unicode"Noun 119 a.k.a Apenoun travelled to Smolville to meet a female Smol Brain. When he arrived he realised that he had been tricked to extract his Nounish essence and create clones out of him. Some Nouns tried to save him... and now they all look very smol. CC0, just vibes.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/b51796b8-a5a8-42c8-aa8c-4a84113d3943", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/b51796b8-a5a8-42c8-aa8c-4a84113d3943", "nounsmols.com", 500, "0xBc3D20463320958Dc7DE604b5FdCE94d9A85CEB2");

        constructor() ERC721A(unicode"Nounsmols", unicode"NOUNSMOL") {
            TIERS[0] = [238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,239,239];
TIERS[1] = [36,66,91,106,116,136,136,136,137,147,153,156,161,166,174,181,196,246,246,246,246,246,246,246,246,246,246,246];
TIERS[2] = [138,138,138,138,138,138,138,138,138,138,138,138,138,138,138,138,138,138,2516];
TIERS[3] = [185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,185,186,186,186,186,186];
TIERS[4] = [50,50,200,200,450,450,450,450,450,450,450,450,450,450];
        }
