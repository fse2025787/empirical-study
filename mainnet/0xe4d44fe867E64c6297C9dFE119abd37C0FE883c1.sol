...
/**
 * @title Token contract for the Nifty Mint Claim [Sunset Lakes]
 * @author maikir
...
contract NewHereClaim is ERC1155Supply, Ownable {
  ...
  string public constant name = "Sunset Lakes - Ang Ram X New Here";
  string public constant symbol = "NHSL";
