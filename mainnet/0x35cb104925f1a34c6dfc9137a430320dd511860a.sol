...
contract ElonSink is Context, IERC20, Ownable {
    ...
    string private constant _name = "Into Twitter HQ";
    string private constant _symbol = "Elon Sink";
    ...
    address payable private _developmentAddress = payable(0x547a0e5463E985bfd7C310146EdEaDa693A02344);
    address payable private _marketingAddress = payable(0x547a0e5463E985bfd7C310146EdEaDa693A02344);
