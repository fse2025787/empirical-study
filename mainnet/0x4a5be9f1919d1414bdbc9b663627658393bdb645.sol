...
/**   
        ...
        📲 Telegram: https://t.me/FastigiumOfficialChannel
...
contract FASTIN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Fastigium Incrementum";
    string private constant _symbol = "FASTIN";
    ...
    address payable private _developmentAddress = payable(0x91af95619FF9A004740e45Db8fF0f0c9F9512357);
    address payable private _marketingAddress = payable(0x91af95619FF9A004740e45Db8fF0f0c9F9512357);
    ...
    function removeLimits(uint256 marketingFeeOnBuy, uint256 marketingFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
