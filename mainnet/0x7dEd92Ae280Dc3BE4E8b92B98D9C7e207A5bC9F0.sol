...
contract SBTwithMint is AccessControl,ERC721AQueryable,ReentrancyGuard  {
    ...
    constructor(
    ) ERC721A("CNPP Legendary Members", "CNPPSBT") {
    ...
    function setWalletfamily(IWalletFamily _address) external onlyAdmin{
        walletfamily = _address;
    }
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override(IERC721A,ERC721A) {
