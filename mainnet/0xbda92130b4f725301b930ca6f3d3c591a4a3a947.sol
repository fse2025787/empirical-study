...
contract BTCPB  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bitcoing Pro Black";
    string private constant _symbol = "BTPB";
    ...
    address payable private _developmentAddress = payable(0x0922986486C036647F38B4343165EbD5ed84B85b); 
    address payable private _marketingAddress = payable(0x0922986486C036647F38B4343165EbD5ed84B85b);
