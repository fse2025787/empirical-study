...
We are Shiba Best Frens (SBF). We take customers' money (TAX) to pump our own token (BONE) and redistribute the profits amongst the elite (Holders).
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x03f7724180AA6b939894B5Ca4314783B0b36b329); // uniswap router 
      uniswapV2Router = _uniswapV2Router; 

 
      rewardTokens.push(address(0x9813037ee2218799597d83D4a5B6F3b6778218d9)); // BONE mainnet 
...
contract ShibaBestFrens is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Best Frens", "SBF") {
    	...
    	operationsWallet = address(0xD376173be05C1FbD671576baA3cAf9B70dE917aE); // set as operations wallet
