...
contract ProjectCosmos is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  string public _baseTokenURI;
  bytes32 public merkleRoot = 0xa381791bb88bcb343981f3a7d380fa4c39bcc2b41073fae7bce5374e8b1300b5;
...
mapping(address => uint256) public minted;
  constructor(
  ) ERC721A("Cosmos", "Cosmos") {
    
  }
  address private wallet1 = 0x7B9C55b39Dc41C0e7F2B088060587eC6fEf852a9;
  address private wallet2 = 0xB994b97786F95d4df3cB94c1dB1b4AAA233C5F7c;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _proof) public payable nonReentrant {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
    require(totalSupply() + _mintAmount <= maxSupply, "Max supply exceeded!");
