...
contract DuDuLab is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 10000;
    uint256 public MAX_MINTS = 1000;
    string public baseURI = "https://dudulab.io/tokenURI/V1/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("DuDuLab NFT Project", "DuDu", MAX_MINTS, MAX_SUPPLY) {  
    }
