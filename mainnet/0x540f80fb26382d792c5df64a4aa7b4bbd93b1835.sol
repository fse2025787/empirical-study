...
/*TELEGRAM  https://t.me/ethertv Be ready to watch some bullish eth tv chad here lets get the movie started with low tax  next eth lp been burnt
*/
...
contract ETHTV is Context, IERC20, Ownable {
    ...
    string private constant _name = "ethtv";
    string private constant _symbol = "$etv";
