...
// File: SpaceMonkey.sol

// 

/**
 __                                           _              
/ _\_ __   __ _  ___ ___    /\/\   ___  _ __ | | _____ _   _ 
\ \| '_ \ / _` |/ __/ _ \  /    \ / _ \| '_ \| |/ / _ \ | | |
_\ \ |_) | (_| | (_|  __/ / /\/\ \ (_) | | | |   <  __/ |_| |
\__/ .__/ \__,_|\___\___| \/    \/\___/|_| |_|_|\_\___|\__, |
   |_|                                                 |___/ 

(SPACEWORM FORK)

🔥 Telegram: https://t.me/SpaceMonkeyPortal
🐦 Twitter: https://twitter.com/SpaceMonkeyETH
🌐 Website: https://SpaceMonkeyETH.com

5% buy and sell taxes - 1% Liquidity Pool 2% Burn 2% Marketing
...
contract SpaceMonkey is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SpaceMonkey", "$SMONKEY") {
        ...
        marketingAddress = 0xb5d22120a738ce4D1bc5d00D496A11E1d4fFecca;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _marketingFee, uint256 _buyLiquidityFee) external onlyOwner {
      require(!_renounceFeeFunctions, "Cannot update fees after renouncement");
        ...
        buyLiquidityFee = _buyLiquidityFee;
        buyTotalFees = buyBurnFee + buyMarketingFee + buyLiquidityFee;
        require(buyTotalFees <= (feeUnits/10), "Buy fees must be 15% or less");
    }
    ...
    function updateSellFees(uint256 _burnFee, uint256 _marketingFee, uint256 _sellLiquidityFee) external onlyOwner {
      require(!_renounceFeeFunctions, "Cannot update fees after renouncement");
        ...
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellBurnFee + sellMarketingFee + sellLiquidityFee;
        require(sellTotalFees <= (feeUnits/10), "Sell fees must be 25% or less");
    }
