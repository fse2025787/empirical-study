...
// 
/*
 * @title Zoothereum Child Contract
 * @author NazaWeb Team
 */
...
contract ChildZoothereum is Ownable {
    ...
    // Function to be called if constructor zoothereum address has been set wrong
    function changeZoothereumAddress(address _zoothereum) external onlyOwner {
        zoothereumContract = INFT(_zoothereum);
    }
}
