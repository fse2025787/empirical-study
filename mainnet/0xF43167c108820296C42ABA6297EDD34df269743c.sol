...
contract JunpeiShibayama  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Junpei Shibayama";
    string private constant _symbol = "Shibayama";
    ...
    address payable private _developmentAddress = payable(0x21C814985eC2aBEcB3B8a9a6f1C8CdBE57200BDa); 
    address payable private _marketingAddress = payable(0x21C814985eC2aBEcB3B8a9a6f1C8CdBE57200BDa);
