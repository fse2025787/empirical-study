...
Sometime Jerry need to keep the distance from Tommy

So Jerry need you Floki
...
contract JerryFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Jerry Floki";
    string private _symbol = "$JFLOKI";
    ...
    address payable public marketingaddress = payable(0x9C25Ed3baDCfFfE7b14F98EdD516893538Cc9491);
