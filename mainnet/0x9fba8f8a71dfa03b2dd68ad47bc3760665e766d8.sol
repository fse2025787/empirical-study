...
/**
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@   Dejitaru Kaiju (BEAST)                                              @
@   TG:         t.me/DejitaruKaiju                                      @
@   Website:    https://www.dejitarukaiju.space/                        @                             
@   Twitter:    https://twitter.com/DejitaruKaiju                       @
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
*/
// 
...
contract BEAST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Dejitaru Kaiju";
    string private _symbol = "BEAST";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xd1285dE360B6F302899F11B8174819e37D4d6AE5);
