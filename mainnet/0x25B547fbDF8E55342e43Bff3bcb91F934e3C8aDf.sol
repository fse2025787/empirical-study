...
contract ONYX is ERC20, Ownable{
    ...
    function unFreezeAccount(address account, uint lockTime) external onlyOwner {
        lockTimePerAccount[account] = lockTime;
        emit UnFreeze(account, block.timestamp);
    }
