...
contract tides is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQ89XvwKrA4U4kSsYxcmbBUqimkWXwuJNP5SU5KKJJuRG";
    ...
    constructor(
    ) ERC721A("tides by anon", "tides", 100, maxSupply) {
    }
