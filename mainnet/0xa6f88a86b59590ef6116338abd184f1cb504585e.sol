...
/*
Telegram : https://t.me/RareTyrant
...
contract RareTyrant is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x47A1f01d0B6c8B1B602007296BB56f37333ee37E));

    string private _name = "Dungeon Of Tyrant";
    string private _symbol = "RareTyrant";
