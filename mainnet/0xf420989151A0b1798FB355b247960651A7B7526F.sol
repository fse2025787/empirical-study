...
contract ProbablySomethingClassic is Context, IERC20, Ownable {
    ...
    string private _name = "Probably Something Classic";
    ...
    address payable public marketingaddress = payable(0xF169A3c020a5877196c73beAF95543aC5d4B9036);

    uint256 public _MarketingFeeBuy = 1;
    uint256 public _LiquidityFeeBuy = 4;
