...
// 
/*
    Welcome to Tomo Sukesada | とも 祐定

    https://t.me/tomosukesada
    https://medium.com/@tomosukesada
*/
...
contract TomoSukesada is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tomo Sukesada";
    string private constant _symbol = "$TS";
    ...
    address payable private _developmentAddress = payable(0x57D692fa78977FA025ec1Ad28abaDbC2CC7A3403); 
    address payable private _marketingAddress = payable(0x57D692fa78977FA025ec1Ad28abaDbC2CC7A3403);
