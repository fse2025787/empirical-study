...
And we don't progress

Innovation is by trying new things
That's what this token is all about
Will it work
Or not?
Let's find out
...
contract WillItWork is Context, IERC20, Ownable {
    ...
    string private _name = "Will It Work";
    string private _symbol = "WIW";
