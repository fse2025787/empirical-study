...
contract LordsOfTheTower is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Lords of the Tower", "LordsOfTheTower"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on lords");
    require(totalSupply() + amount < maxSupply + 1,"No more lords");
