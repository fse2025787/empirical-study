...
// Telegram : https://t.me/NetworkBlackErc
/*
...
What is 🔎
Black Network is a technology for building apps and organizations, holding assets, transacting and communicating without being controlled by a central authority. There is no need to hand over all your personal details to use Black Network - you keep control of your own data and what is being shared.

Token ◼️
$BLACK is a decentralized token on the Ethereum Chain first. Created by the blockchain specialists with the main purpose of build and explore on the Black Network

Tax : 0

Twitter : https://twitter.com/BlackErcNetwork

Telegram : https://t.me/NetworkBlackErc

Website : https://BlackNetwork.io
*/
...
contract BlackNetwork  is Ownable, IERC20 {  // Name As COMPILE
    ...
    string constant private _name = "BLACK NETWORK";
    string constant private _symbol = "$BLACK";
    ...
    constructor() {
        ...
        lpWallet = 0x63eC1Fa99E95bd7fB9f2d62018CDE8048907703b;
        projectAddress = 0x63eC1Fa99E95bd7fB9f2d62018CDE8048907703b;
        devWallet = 0x63eC1Fa99E95bd7fB9f2d62018CDE8048907703b;
