...
contract SolidETH is Context, IERC20, Ownable {
    ...
    string private constant _name = "SolidETH";
    string private constant _symbol = "X";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xDFCf9360220e0CB2a0793C985604d56658c95Ac9);
    address payable private _marketingAddress = payable(0xd78d5D262124cd03F3b459866407E3D362D367bd);
    ...
    constructor () {
        ...
        emit Transfer(address(0xd78d5D262124cd03F3b459866407E3D362D367bd), _msgSender(), _tTotal);
    }
