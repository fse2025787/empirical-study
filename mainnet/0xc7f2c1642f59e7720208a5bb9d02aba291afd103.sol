...
contract OBT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"One Billion Tsuka";
    string private constant _symbol = unicode"OBT";
