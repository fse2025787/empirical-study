...
https://asciiart.website/index.php?art=objects/axes
...
contract AXE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ono";
    string private constant _symbol = unicode"AXE";
