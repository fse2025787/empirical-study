...
contract NeonNinjas is ERC721A , ERC721ABurnable, Ownable, ReentrancyGuard, DefaultOperatorFilterer  {
...
//OwnerAdress
address private OwnerAdress = 0xf4535A05E13BC0eC57C40ffC6fFAD33a435212b5;
...
function getWLMerkleRoot() public view returns (bytes32) {
  return wlMerkleRoot;
}

function getWAMerkleRoot() public view returns (bytes32) {
  return waMerkleRoot;
}

//burn
function burn(uint256 tokenId) public override {
    require(burnActive, 'Burn is not live!');
    burnedSupply += 1;
    super._burn(tokenId);
}

function setBurnActive() external onlyOwner {
