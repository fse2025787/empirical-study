...
contract ElonjetInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ElonJet Inu";
    string private constant _symbol = unicode"ELONJET ";
