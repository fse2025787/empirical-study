...
contract Thorshib is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 1800000 * 10**8;
	...
	string private constant _name = "Thor Shib";
	string private constant _symbol = "THORSHIB";
	...
	constructor () {
		...
		_maxTxAmount=18000 * 10**8;
		_maxWallet=36000 * 10**8;
