...
contract SingularityNFTOne is ERC1155, ERC1155Supply, Ownable {
    ...
    function mint(uint256 id) external {
        uint256 amount;
        require(BlaclistedWallets[msg.sender] == false,"Your wallet is blacklisted"); 
        ...
        if(WhitelistStatus[id]){ 
            ...
            require(amount > 0,"You are not whitelisted or you already have minted."); 
            _whitelistedWalletAmounts[msg.sender][id] = 0; 
        }
        else{
            require(_mintsPerWallet[msg.sender][id]<1,"You have minted more than 1 NFT"); 
        }
