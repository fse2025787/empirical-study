...
Website:https://www.doge-rocket.space/
======================
➡️ JOIN US: @dogerocket_eth 
...
contract DogeRocket is Context, IERC20, Ownable {
    ...
    string private _name = 'Doge Rocket';
    string private _symbol = '$DOGEROCKET ';
