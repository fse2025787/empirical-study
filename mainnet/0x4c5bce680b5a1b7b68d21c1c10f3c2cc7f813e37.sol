...
contract AIART is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbShsPbf3j7NxDNGc6uFn6KCVMQzisVLkAephmP5cVukT";
    ...
    constructor(
    ) ERC721A("AIART", "ART", 100, maxSupply) {
    }
