...
/*
Trillion Inu is powered by a proven BuyBack protocol.
Its goal is increasing the investor's value
    
Main features are
    
1) 2% tax is collected and distributed to holders for HODLing
2) 9% buyback and marketing tax is collected and 5% of it is sent for marketing fund and othe 4% is used to buyback the tokens
...
contract Trinu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x00000054f6cD730ecaF089acE02e94e4D2611344); // Marketing Address
    ...
    string private _name = "Trillion Inu";
