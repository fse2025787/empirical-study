...
contract SwingInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x0685b2E75C536544841CfCCA598b708bF44E0815));

    string private _name = "SwingInu";
    string private _symbol = "Swingn";
