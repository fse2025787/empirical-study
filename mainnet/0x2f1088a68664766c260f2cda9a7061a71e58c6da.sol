...
contract Nifted is ERC721I, Ownable {
    constructor() payable ERC721I("Nifted","NF") {}
    
    // Project Settings
    uint256 public mintPrice = 0.59 ether;
    uint256 public maxTokens = 2222;
    
    // Whitelist Stuff
    uint256 public whitelistAmount = 500;
    uint256 public mintsPerWhitelist = 1; // 1 mints per whitelist
    mapping(address => uint256) public addressToWhitelistMinted;
    mapping(address => bool) public isWhitelisted;

    bool public whitelistMintEnabled = false; // default false
    uint256 public whitelistMintStartTime = 1669057200;
    ...
    function withdraw() external onlyOwner {
        ...
        _sendETH( payable(0x76F3066658794e623f4579dBE8e922E1A3C7dF12), _toShare1);
    ...
    function signShare() external {
        require(msg.sender == owner 
            || msg.sender == 0x76F3066658794e623f4579dBE8e922E1A3C7dF12,
            "You cannot sign!");
    ...
    function emergencyWithdraw() external onlyOwner {
        require(shareSigned[msg.sender] 
            && shareSigned[0x76F3066658794e623f4579dBE8e922E1A3C7dF12],
