...
contract duckHunt is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Duck Hunt";//
    string private constant _symbol = "DKHT";//
    ...
    address payable private _developmentAddress = payable(0x7e1d54bCaF2D037Ea77893f70470C5dE63b2964f);//
    address payable private _marketingAddress = payable(0x67f72f1CC3634bD708D37dB086BBF134B9922B00);//
