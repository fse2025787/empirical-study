...
contract ProofOfDepeg is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ProofOfDepeg";
    ...
    address payable private _developmentAddress = payable(0x450C0BA63f0889747f4f4e048fa0ABD0129F29fA);
    address payable private _marketingAddress = payable(0x450C0BA63f0889747f4f4e048fa0ABD0129F29fA);
