...
// File: contracts/cyberShare_mint.sol
...
// import "@openzeppelin/[email protected]/utils/SafeMath.sol";

// import "@openzeppelin/[email protected]/token/ERC721/extensions/ERC721Enumerable.sol";

contract MonarchApeSociety is ERC721A {
    address payable public target1 =
        payable(0x65a0c566Ec5f592dFc70B53B8A7Cb28Ff3007Ac9);
    address payable public target2 =
        payable(0x0c4Bb88CaAD5F49e61501F9A88E6638Bb0c07665);
    ...
    uint256 public cost = 0.0432 ether;
    uint256 public preSaleCost = 0.0369 ether;
    string public baseURI =
        "https://gateway.pinata.cloud/ipfs/QmPCjTCS7t5Y5ZqvG7H31VZmiSG7mBUWtFKZm2MLXJP4F7/";
    string public baseExtension = ".json";
    mapping(address => bool) public whitelisted;
    bool public reveal = false;
    string public revealURI =
        "https://gateway.pinata.cloud/ipfs/QmZdUkHmNu4MAjx1Wn8s4sSHkh9nj2LBpVCtRUhF6ux991";

    constructor() ERC721A("Monarch Ape Society", "MAS") {
        owner = msg.sender;
        //   count=0;
    ...
    function updateAddress(address payable addr1, address payable addr2)
        public
        onlyOwner
    {
        target1 = addr1;
    ...
    function setRevealURI(string memory _revealURI) public onlyOwner {
        revealURI = string(abi.encodePacked(_revealURI));
    }

    // function createToken(string memory uri) public onlyOwner {
    //     count.increment();
    //     uint256 tokenId = count.current();
    ...
    function airDrop(address[] calldata _to, uint256[] calldata _id)
        public
        onlyOwner
    {
    ...
    function setPreSaleCost(uint256 _preSaleCost) public {
        ...
        if (msg.sender != owner) {
            if (preSale) {
                if (whitelisted[msg.sender] == true) {
                    ...
                    uint256 per = ((msg.value) * (5)) / (100);

                    payable(target1).transfer(per);
                    payable(target2).transfer(per);
                } else {
