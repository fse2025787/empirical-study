...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Ownable {
    ...
    // Address of NFT Contract => Token Id of staked NFT => UserData
    ...
    constructor(
        ...
        // Transfer ownership to sweeper account.
    ...
    function withdraw(
        ...
        // Virtual Stake: do not remove staking balance.
        // This maintained for correct reward calculation.
    ...
    function setStakingFee(
        ...
        // sum of all values of StakingFee and sum over percentage of StakingFeeData
        uint256 totalFee = 0;
        ...
        // require totalFee less than 100%
        require(totalFee <= 100, 'Total fee cannot be more than 100%');

        emit SetStakingFeeData(fee, percentage, to);
    }

    // For a given amount of tokens, calculate all the fees
    // and transfer out to given fee address
    // @review do we need to check if the fee address is valid?
    // @review do we need to check if the fee address is the same as the owner?
    // @review do we need to make the internal function non-reentrant?
