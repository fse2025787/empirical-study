...
contract DegenInu is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletamount = 2000000000 * 10**18;
    address public marketingWallet = payable(0xF644628400970eC07e534bD38Ed57AB2A8f8aB6B);
	address public devWallet = payable(0x3097e8A9f893CEa6827C19d69D925aF2Dc85aA59);

    string private _name = "Degen Inu";
    ...
    function setMaxWalletAmount(uint256 _maxwalletamount) public onlyOwner {
        require(_maxwalletamount > 500000000 * 10**18, "cannot be less than 500 million");
