...
// File: nft.sol
    ...
    contract Entities is Ownable, ERC721A {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmcB8Ur9Vp3N5mmdREWHGVN3mdi5K6zDoWGHXMHKDu23fJ/";
    string public constant baseExtension = ".json";
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("Entities", "ENTITY") {_safeMint(msg.sender, 1);}
