...
contract COFFEEDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Coffee DAO";
    ...
    address payable private _opAddress = payable(0xE46Ef86bf0955dbD62a32cC66088Ea8399EE34Ab);
