...
/**
The surname Bear is a ancient French name from Brittany that was derived from the Old French personal name Bertet,

which is composed of the Germanic elements behrt, which means bright or famous, and wald, which means rule.

Soon we will be known throughout the crypto space.
 */
