...
contract NumbersNFT is Ownable, ERC721A {
    address private _owner;
    uint256 private constant _price = 0.001 ether;
    uint256 private constant _maxNft = 6666;
    uint256 private constant _freeNum = 1;
    ...
    constructor() ERC721A("Numbers NFT", "NumbersNFT") {
        _baseTokenURI = "http://www.numbers.works/uri/";
        _owner = msg.sender;
    }
