...
pragma solidity ^0.6.12;
    ...
    contract MOOREX is Context, IERC20, Ownable {
        ...
        string private _name = 'MOOREX';
        string private _symbol = 'MOOR';
        ...
        uint256 private _maxTxAmount = 25000000e9;
        ...
        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 3, 'charityFee should be in 1 - 3');
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 25000000e9 , 'maxTxAmount should be greater than 25000000e9');
