...
// File contracts/LittleRocketmanIMX.sol


pragma solidity ^0.8.0;

// Classes for granting permissions to IMX contract

// ERC721 standards

/**
 * @title LittleRocketmanIMX contract
 */
contract LittleRocketmanIMX is Mintable, ERC721 {
    string private _baseURIPath;

    constructor(address _owner, address _imx)
    ERC721("LittleRocketmanIMX", "LRM")
    Mintable(_owner, _imx) {}

    // Called at the time of withdrawing a minted token from Immutable L2 to Mainnet L1.
    ...
    // Will there ever be a balance on this contract? Just in case...
