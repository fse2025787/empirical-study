...
contract TritonPass is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  string public _baseTokenURI = "https://ipfs.io/ipfs/QmWR8PPpBEMGrLd93oxwqufis5pmvpG5wtXh8iY5yaMGL7/1.json";
  ...
  constructor(
  ) ERC721A("Triton Pass", "Triton") {
 _safeMint(0x7d30285238699b79FEF01c1882E1788c45b4b04A, 1);
  }
  address private wallet1 = 0x612fE35c38fA52eD7b0E5100D30DFC0de5A6Ce7C;
  address private wallet2 = 0xd34826b45eE0B51678Ac27D17D11356BeFeD5317;

  function mint() public payable nonReentrant {
    require(hasAddressMinted[msg.sender] == false, "Address has already minted");
  ...
  function whitelistMint(bytes32[] calldata _proof) public payable nonReentrant {
    require(hasAddressMinted[msg.sender] == false, "Address has already minted");
    require(totalSupply() + 1 <= maxSupply, "Max supply exceeded!");
