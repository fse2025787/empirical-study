...
contract UndeadLegion is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("UndeadLegion", "UL") {
        setBaseURI("ipfs://QmTnAbfgmWDfpQMHTDyYrMyQpCMMQuuHLpPaD6RgNceZtT/");
