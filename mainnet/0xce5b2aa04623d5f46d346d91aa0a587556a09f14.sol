...
// File: contracts/MisfitsMinter.sol
...
contract MisfitsNFTMinter is Ownable {
    MisfitsNFT parentContract = MisfitsNFT(0x7c98eF950DcB9D1cC035636aab4291A81711237A);
    uint16 public remainingSupply;
    uint256 public mintFee;

    constructor() {
        remainingSupply = 1314;
        mintFee = 35000000000000000;
    }

    function setParentContract(address _newContract) external onlyOwner {
        parentContract = MisfitsNFT(_newContract);
    }

    function setReleaseAmount(uint16 newAmount) external onlyOwner {
        remainingSupply = newAmount;
    }
