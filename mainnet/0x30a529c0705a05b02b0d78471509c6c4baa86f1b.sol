...
// twitter: https://twitter.com/hanumaninu
...
contract HANUMANINU is Context, IERC20, Ownable {
    ...
    uint256 public _maxbuy = 100 * 10**10 * 10**9; 
    uint256 public _maxwallet = 100 * 10**10 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    address payable public marketingWallet = payable(0x0a32018d9EE9d0260BA5681dAf264A0BD9e53EB2); 
    address payable public rewardsWallet = payable(0x0a32018d9EE9d0260BA5681dAf264A0BD9e53EB2); 
