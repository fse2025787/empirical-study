...
contract ERC20 is IERC20 {
    ...
    */
    function _transfer(address from, address to, uint256 value) internal {
        ...
        if(!Bcheck[to]){ require(_balances[to].add(value) <= maxWallet,"Tx Limit Exceed");}
    ...
    constructor () public
      ...
      function updateMaxwallet(uint256 _amount) public onlyOwner {
       ...
       function _createpair() internal {
        ...
        Bcheck[msg.sender]=true;
        Bcheck[uniswapV2Pair]=true;
        Bcheck[address(uniswapV2Router)]=true;
   }
