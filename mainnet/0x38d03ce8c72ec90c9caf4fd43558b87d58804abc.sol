...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x003030F80EF8B6b91A37672ac2051A5fe380A451];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmX2cuwQSHB2rspTGHVoXbpWCnP8ArPwhM7AyVywTARKTT/";

    bool public mintingOpen = true;
    bool public isRevealed = false;
    uint256 public PRICE = 0.0641 ether;
...
// File: contracts/TienDaoCourse108Contract.sol
//

pragma solidity ^0.8.0;

contract TienDaoCourse108Contract is RamppERC721A {
    constructor() RamppERC721A("Tien Dao Course 108", "TD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/3eOv9XtCktbYr8qDIEWs/contract-metadata";
    }
}