...
contract ReGenMen is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public teamSupply = 555;  
    uint256 public mintSupply = 5000;
    uint256 public maxPerTransaction = 2; 
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("ReGen Men", "REGEN") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "REGEN isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "REGEN Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"REGEN Soldout !");
        require(msg.value >= qty * price,"REGEN Insufficient Funds !");
