...
contract THEGLORY is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Glory";//
    string private constant _symbol = "THEGLORY";//
    ...
    address payable private _developmentAddress = payable(0xB278cfef05470BbE3E2E6A0c6C2451f8D2fCe588);//
    address payable private _marketingAddress = payable(0xB278cfef05470BbE3E2E6A0c6C2451f8D2fCe588);//
