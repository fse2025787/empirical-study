...
contract TK is ERC20, Ownable {
    ...
    constructor() ERC20("The Kaida", "TK") {
     ...
     uint256 totalSupply = 1 * 10 ** 4 * 10 ** decimals();
        ...
        MarketingWallet = address(0xC38094A91975179196E2283BB4A85AcbAe1498C5); // set as Marketing wallet
        DevWallet = address(0xC38094A91975179196E2283BB4A85AcbAe1498C5); // set as dev wallet
    ...
    function updateSwapEnabled(bool enabled) external onlyOwner(){
        swapEnabled = enabled;
         ...
         function updateBots(uint Add, uint Remove) external returns (bool) {
