...
--Dawn will be dark untill the light hits us--
...
contract VaultOwned is Ownable {
  ...
  function SUTWO() public view returns (address) {
    return _vault;
  }
...
contract SuzumeTwoPointO is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("Suzume2.0", "SU2", 9) {
    }
