...
/**
Rabbithereum ready to conquer the entire Ethereum BlockChain. Also known as ‘Shengxiao’, means its all assigned to be powerful animal, its based on 2023 the year of the rabbit, it gives good luck and hope. 

Join us and prosper 
#Rabbithereum2023

Twitter:    https://twitter.com/Rabbithereum_
TG:         https://t.me/RabbitheriumERC
*/
// 
...
contract Rabbitherium is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Rabbitherium";
    string private _symbol = "RBT";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x462CC0B1f5d148B0A2284E59Ab004ad878d4b128);
