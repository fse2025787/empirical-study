...
Xend.Ai is a web3.0 encrypted messaging service system that allows one to send anonymous message to anyone through Blockchain!

Xend.Ai is end-to-end encrypted and will be the face of blockchain messaging in near future!

Xend.Ai has the potential and will be the next Facebook of Blockchain Technology
...
contract XendAi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "XendAi";
    string private constant _symbol = "XendAi";
    ...
    address payable private _developmentAddress = payable(0xb619EE8a06693370D52771c012C3e5cE81BBe37e); 
    address payable private _marketingAddress = payable(0xb619EE8a06693370D52771c012C3e5cE81BBe37e);
    ...
    uint256 public _maxTxAmount = _tTotal.mul(200).div(100);
