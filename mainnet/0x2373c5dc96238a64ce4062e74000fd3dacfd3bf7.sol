...
/*
	Angel Inu - $ANGEL
	Meet the most pure inu in town.. Angel Inu
	
	Website: Angelinu.io
	
	Telegram: https://t.me/AngelinuToken
...
contract Angelinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Angel Inu";
    ...
    uint256 private constant _tTotal = 10000000000000000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x4B7Fb8De75a2Bbb745932DbF454FC07DB66FE6d5);
    address payable private _marketingAddress = payable(0x92076FaB38b14E4Cd175055B5A55C8875A59D85C);
    ...
    uint256 public _maxTxAmount = 25000000000000000 * 10**9; //0.25%
    uint256 public _maxWalletSize = 100000000000000000 * 10**9; //1%
    uint256 public _swapTokensAtAmount = 10000000000000000 * 10**9; //0.1%
