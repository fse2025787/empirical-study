...
contract SurviveERC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Survival Protocol";
    string private constant _symbol = unicode"SURVIVE";
