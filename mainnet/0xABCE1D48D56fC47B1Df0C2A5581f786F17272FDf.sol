...
// File: orca_nft_monthly_pass.sol
...
contract OrcaNFT is ERC721, Ownable {
    ...
    uint256 private maxPublicSupply = 333;
    ...
    constructor() ERC721("ORCA MONTHLY PASS", "ORCAIPASS") {
        setHiddenMetadataUri("ipfs://QmbE8hBt3tT1CmF8pu5Sp8CswUCpkx4dT1cWvMiP1KPpJG");
        }
    ...
    function setTotalSupply(uint256 _totalSupply) public onlyOwner {
        maxPublicSupply = _totalSupply;
        }

    function totalSupply() public view returns (uint256) {  
          return maxPublicSupply;  }
    ...
    function mintPublic(uint256 _mintAmount  ) public payable {
        ...
        require(_mintAmount <= 1 ,"1 NFT maximum per Wallet!");
        require(AddressPurchases[msg.sender]+_mintAmount <= 1,  "Maximum NFTs minted per wallet!");
    ...
    function withdraw() external onlyOwner {
            payable(_team1).transfer(address(this).balance);
        }
