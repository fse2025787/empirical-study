...
/*
https://t.me/ExitLiquidityToken

🔥  Welcome to Exit Liquidity. Sell tax is set to 20%(All 20% are burned).   Every time someone sells. 20% of their bag is burned.  MAX DEFLATION.
...
contract EXITLIQUIDITY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Exit Liquidity", "EXIT") {
        ...
        devWallet = 0x8c733d0021Bd77776134f54298976414e63F6c5a;
