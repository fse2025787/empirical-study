...
contract MEVHOLE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Discovery of Mevhole";
    string private constant _symbol = "MEVHOLE";
