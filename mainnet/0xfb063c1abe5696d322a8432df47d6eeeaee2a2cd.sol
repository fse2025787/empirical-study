...
contract Shaitan is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shaitan Inu", "SHAITAN") {
        ...
        uint256 totalSupply = 666666666666666;
        supply += totalSupply;
        ...
        devWallet = 0xc5fF807347a22f4933Ef76cB2c21Fbfd1a2C7008;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyBurnFee + buyDevFee;
        require(buyTotalFees <= 66, "Must keep fees at 50% or less");
    }
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellTotalFees <= 66, "Must keep fees at 50% or less");
    }
