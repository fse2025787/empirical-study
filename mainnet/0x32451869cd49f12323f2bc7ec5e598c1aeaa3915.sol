...
contract NonFungibleToken is Ownable, ERC721A, ERC721APausable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory name, string memory symbol, string memory baseURI_, uint mintFee, uint maxToMint, uint256 maxPerWallet, uint maxPerTransaction) public ERC721A(name, symbol) {
