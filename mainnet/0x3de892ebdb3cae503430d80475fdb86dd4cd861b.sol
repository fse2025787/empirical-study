...
TG : https://t.me/GrumpiesERC
WEB : https://grumpies.xyz

Grumpies will serve as digital avatars and a genesis pass to our brand.
What this means is that users will hold a membership that grants access to things such as airdrops, along with token gated discounts and opportunities. More importantly however, it is a tradeable membership that allows individuals to express themselves equally in both the physical and digital worlds.
...
contract GrumpiesERC is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x0be43789c1A2b9980d5A7C1d92A7f6f4163E6530));

    string private _name = "GrumpiesERC";
