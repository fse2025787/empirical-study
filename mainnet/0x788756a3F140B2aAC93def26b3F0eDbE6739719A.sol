...
contract MARUTARO is IERC20, Ownable {
    ...
    function totalSupply() public pure override returns (uint256) {
        // One quadrillion, i.e., 1,000,000,000,000,000 tokens.
        return 1e15 * 1e9;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "MARUTARO:transferFrom:ALLOWANCE_EXCEEDED: Transfer amount exceeds allowance."
        );
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external returns (bool) {
        ...
        require(
            ...
            "MARUTARO:decreaseAllowance:ALLOWANCE_UNDERFLOW: Subtraction results in sub-zero allowance."
        );
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "MARUTARO:_approve:OWNER_ZERO: Cannot approve for the zero address.");
        require(spender != address(0), "MARUTARO:_approve:SPENDER_ZERO: Cannot approve to the zero address.");
    ...
    function _transfer(
        ...
        require(from != address(0), "MARUTARO:_transfer:FROM_ZERO: Cannot transfer from the zero address.");
        require(to != address(0), "MARUTARO:_transfer:TO_ZERO: Cannot transfer to the zero address.");
        require(amount > 0, "MARUTARO:_transfer:ZERO_AMOUNT: Transfer amount must be greater than zero.");
        require(amount <= _balances[from], "MARUTARO:_transfer:INSUFFICIENT_BALANCE: Transfer amount exceeds balance.");
