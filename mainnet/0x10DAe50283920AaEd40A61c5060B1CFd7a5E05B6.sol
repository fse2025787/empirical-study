...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xfEf0B1f151f0b0F114EA49679e1C9Ea5C14eDBb4];
  address public erc20Payable = 0xfEf0B1f151f0b0F114EA49679e1C9Ea5C14eDBb4;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 4444) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.angrydolly.wtf/";
...
// File: contracts/AngryDollyCloneContract.sol
//

pragma solidity ^0.8.0;

contract AngryDollyCloneContract is RamppERC721A {
    constructor() RamppERC721A("Angry Dolly Clone", "Dolly"){}
}