...
Trick or Eth!
2/2
Please do not ape until lock and renounce is confirmed 

Social platforms
Telegram : https://t.me/trickOrEth
Twitter :https://twitter.com/TrickOrEth
Medium :https://medium.com/@TrickOrEth
Reddit : https://www.reddit.com/user/TrickOrEth/
Website :http://trickoreth.website/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x2689eB863EE9B0f0dB3b8Df814941B30638862EE;
...
contract TrickOrEth is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Trick or Eth"; 
    ...
    uint256 public _maxWalletToken = 30 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 ETHAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x2689eB863EE9B0f0dB3b8Df814941B30638862EE), ETH_Tot);
            }
