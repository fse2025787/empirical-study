 ...
 */
contract StakeDaoNFT_V3 is ERC1155Tradable, StrategyRole {
    using SafeMath for uint256;
    ...
    {
        _setBaseMetadataURI(
            "https://gateway.pinata.cloud/ipfs/Qme8uLdZ8dpSnix4k3XoC5vasmMVdiHt7tXtNCZYGvM884/metadata/"
        );

        // starting ids for these nfts from 445
        _currentTokenID = 444;
    }
    ...
    function startUsingNFT(address _account, uint256 _id) public onlyStrategy {
        require(
            ...
            "StakeDaoNFT_V3: user account doesnt have NFT"
        );
    ...
    function safeTransferFrom(
        ...
        require(
            ...
            "StakeDaoNFT_V3: NFT being used in strategy"
        );
