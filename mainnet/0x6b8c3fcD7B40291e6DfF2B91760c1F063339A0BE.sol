...
contract TENNIS  is Context, IERC20, Ownable {
    ...
    string private constant _name = "World Floki cUp inu";
    string private constant _symbol = "WFCI";
    ...
    address payable private _developmentAddress = payable(0xA63d1B12696a60b157F8B6d3cA634A83c85800A0); 
    address payable private _marketingAddress = payable(0xA63d1B12696a60b157F8B6d3cA634A83c85800A0);
