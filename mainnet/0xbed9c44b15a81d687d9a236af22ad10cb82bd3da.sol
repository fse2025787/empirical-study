...
// Telegram: t.me/creepy_doughe_portal
...
// Main Contract Logic 
// --------------------------------------------------------------
contract CRDOGE is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Creepy Doughe";
    string private _symbol = "CRDOGE";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xD57D6a80D68ec3498d1F6F2FE3E5514DA6247A2B);
    address payable public operationsWallet =  payable(0xD57D6a80D68ec3498d1F6F2FE3E5514DA6247A2B);
