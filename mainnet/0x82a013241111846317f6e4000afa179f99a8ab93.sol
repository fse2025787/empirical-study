...
contract BunnyBand is ERC721A {
    string uri = "ipfs://bafybeiffpvq2pcpzpintwhdfkrnnsqqxd462faq7xmkqqzdzycqovwvg6m/";
    ...
    constructor() ERC721A("Bunny Band", "BB") {
        owner = msg.sender;
    }
    ...
    function FreeNum() internal returns (uint256){
        return (maxSupply - totalSupply()) / 1000;
    }
