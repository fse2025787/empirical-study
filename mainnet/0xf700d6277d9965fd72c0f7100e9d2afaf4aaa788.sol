...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract WW3PioneersByBonishBil is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("WW3 Pioneers By BonishBil", "WW3BB") {
  }
  ...
  function mint(uint8 _mintAmount) external payable  {
    ...
    require(totalSupply + 1266 <= maxSupply, "Exceeds max supply.");
