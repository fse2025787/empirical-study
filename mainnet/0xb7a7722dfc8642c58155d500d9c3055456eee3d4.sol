...
contract RapidlyReusableRockets is Context, IERC20, Ownable {
    ...
    string private _name = "Rapidly Reusable Rockets";
    string private _symbol = "RRR";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 6; //(3% liquidityAddition + 1% rewardsDistribution + 2% devExpenses)
