...
contract ZqSHI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ZqSHI Inu";
    string private constant _symbol = "ZqSHI";
    ...
    address payable private _developmentAddress = payable(0x210F4fbE929Afe85Ffb916440FF9C4bb588d8ECE); 
    address payable private _marketingAddress = payable(0x210F4fbE929Afe85Ffb916440FF9C4bb588d8ECE);
