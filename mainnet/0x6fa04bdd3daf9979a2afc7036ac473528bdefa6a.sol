...
contract FatShiba is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Fat Shiba Inu';
    string  private constant _SYMBOL = 'Fatshi';
    ...
    uint256 private      _TAX_FEE = 2;
    uint256 private     _BURN_FEE = 2;
    ...
    function setMaxTxSize(uint256 maxTxSize) external onlyOwner() {
        _MAX_TX_SIZE = maxTxSize;
    }
}