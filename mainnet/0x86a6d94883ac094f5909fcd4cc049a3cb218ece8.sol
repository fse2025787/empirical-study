...
contract HSBC is ERC721Enumerable, Ownable {
    using Strings for uint256;

    bool public _isSaleActive = false;
    bool public _revealed = true;
    bool public _isWLSaleActive = false;
    bool public _freedom = false;
    ...
    ) ERC721("ThisIsMyFamilyCollection", "TIMFC") {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override {
        super._beforeTokenTransfer(from, to, tokenId);
        require(from == address(0) || _freedom, "ERC721: transfer not permitted");
    }
    ...
    function flipFreedom() public onlyOwner {
        _freedom = !_freedom;
    }
