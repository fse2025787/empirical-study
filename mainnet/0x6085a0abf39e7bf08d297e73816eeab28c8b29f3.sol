...
contract GSW is Context, IERC20, Ownable {
    ...
    string private constant _name = "GSW Inu";
    string private constant _symbol = "GSW Inu";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xBDE775607B9B282d7B4A8D330181c4C78D38Aeca);
