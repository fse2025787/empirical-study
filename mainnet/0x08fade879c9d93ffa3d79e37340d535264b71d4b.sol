...
// File: HareOfInaba.sol

// Hare of Inaba
// The Sun, the Moon, and the Wind
// A reminder as to why we all began our journey.

// TG - https://t.me/InabaPortal

// Website - the one who follows the trails will conquer the elements.
...
contract HareOfInaba is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hare of Inaba", "INABA") {
        ...
        devOpsWallet = address(0xD11f58830cfDFB7dB65Ad418E6FCD058C190CE60); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xD11f58830cfDFB7dB65Ad418E6FCD058C190CE60), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xD11f58830cfDFB7dB65Ad418E6FCD058C190CE60), true);
