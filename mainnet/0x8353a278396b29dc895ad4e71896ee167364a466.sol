...
When the door opens everything will be revealed.

Till then sit and observe.
...
contract Door  is ERC20, Ownable {
    ...
    string constant _name = "The Door";
    string constant _symbol = "OPEN";
    ...
    address public marketingFeeReceiver = 0xE2F5Fb717e33cDb9d19E45Bc1C3d2f3c7d794356;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x340C89594E0B20D0A47F2f8889fc6426897C7296] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x340C89594E0B20D0A47F2f8889fc6426897C7296] = true;
