...
contract FuckTheDev is ERC20, Ownable {
    ...
    uint256 private _FuckbuyDevFee;
    uint256 private _buyLiquidityFee;
    
    uint256 public sellTotalFees;
    uint256 private _FucksellDevFee;
    ...
    constructor() ERC20("FuckTheDev", "FTD") {
        ...
        uint256 FuckbuyDevFee = 0;
        uint256 buyLiquidityFee = 0;

        uint256 FucksellDevFee = 0;
        ...
        _FuckbuyDevFee = FuckbuyDevFee;
        _buyLiquidityFee = buyLiquidityFee;
        buyTotalFees = _FuckbuyDevFee + _buyLiquidityFee;
        
        _FucksellDevFee = FucksellDevFee;
        _sellLiquidityFee = sellLiquidityFee;
        sellTotalFees = _FucksellDevFee + _sellLiquidityFee;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                _tokensForDev += fees * _FucksellDevFee / sellTotalFees;
            }
            // on buy
            else if (automatedMarketMakerPairs[from] && buyTotalFees > 0) {
        	    fees = amount.mul(buyTotalFees).div(100);
        	    _tokensForLiquidity += fees * _buyLiquidityFee / buyTotalFees;
                _tokensForDev += fees * _FuckbuyDevFee / buyTotalFees;
            }
