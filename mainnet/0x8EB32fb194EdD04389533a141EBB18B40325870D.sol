...
contract FastFoodBoredApes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Fast Food Bored Apes", "FFBA") {
    setHiddenMetadataUri("ipfs://QmdNcroqtyR2LZ1mhaJtbtAN54wqZUYYoAVZMqjHKticcC/hidden.json");
  }
