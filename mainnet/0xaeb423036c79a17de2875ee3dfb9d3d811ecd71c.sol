...
/*
Irene Doge is finally here, bringing the FIRST ever simp coin to ethereum.

$IRENE is a simp token for Irene Zhao.
A portion of all transactions are added to our simp fund. We'll regularly donate this to Irene because she's a queen.


https://irenedoge.com/
https://t.me/IreneDoge
https://twitter.com/IreneDoge
*/
...
contract IreneDoge is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "IreneDoge";//////////////////////////
    string private constant _symbol = "IRENE";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0xD6d85f18EC65d6656367952A1cA53133d241CC6E);/////////////////////////////////////////////////
    address payable private _simpAddress = payable(0x394E358f31210D5d2402011433baeD03145E5Ba1);///////////////////////////////////////////////////
    ...
    constructor() {
        ...
        _isExcludedFromFee[_simpAddress] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _simpAddress.transfer(amount.div(2));
    }
    ...
    function manualswap() external {
        require(_msgSender() == _developmentAddress || _msgSender() == _simpAddress);
