...
contract THETRUTHMETAVERSE is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "UFOMETAVERSE";
    string private constant _symbol = "UFOVERSE";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x1498893EC6204C7CF469fD31E889B79Da87c40E1);
        _feeAddrWallet2 = payable(0x1498893EC6204C7CF469fD31E889B79Da87c40E1);
