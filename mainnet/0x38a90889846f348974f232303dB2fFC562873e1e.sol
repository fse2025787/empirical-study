...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x57118798943b1Eead27F57a3bf53e865D8240CfA];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x57118798943b1Eead27F57a3bf53e865D8240CfA;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 400) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifq5ownx4rzqdehmbyvbs37g5vso2nmyzevjcypt4hgmemhsydwdi/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 400");
...
// File: contracts/TilesofEthereumContract.sol
//

pragma solidity ^0.8.0;

contract TilesofEthereumContract is RamppERC721A {
    constructor() RamppERC721A("Tiles of Ethereum", "TILE"){}
}
