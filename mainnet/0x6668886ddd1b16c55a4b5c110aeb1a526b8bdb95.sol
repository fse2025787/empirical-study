...
/*
WELCOME TO DEGEN TAO

Good opportunity, venture, and discovery radar for memecoin collectors! 
Get in on the action and be a part of the future with $DTAO - Utility, Governance, 
and Exposure all rolled into one powerful token that makes you part of the exciting DEGEN TAO ecosystem and its accelerating partners.
...
contract DegenTao is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Degen Tao";
    string private constant _symbol = "DTAO";
    ...
    address payable private _developmentAddress = payable(0x6Ff7A0B316C148e9b251DBBc19255d262cECDD14); 
    address payable private _marketingAddress = payable(0x6Ff7A0B316C148e9b251DBBc19255d262cECDD14);
