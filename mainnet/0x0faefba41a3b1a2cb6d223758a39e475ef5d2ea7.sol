...
contract PT is Context, IERC20, Ownable {
    ...
    string private _name = "Platinum";
    string private _symbol = "PT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xCf511A98B56227DBB31685fAf30fdfC2b0e3B90e);
    ...
    uint256 public _maxTxAmount =   _totalSupply.mul(1).div(1e3);
    uint256 public _walletMax =     _totalSupply.mul(2).div(1e2);
