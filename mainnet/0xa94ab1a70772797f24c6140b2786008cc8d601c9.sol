...
/**
https://medium.com/@timemachinecoin/time-machine-coin-91e553ab9fff

https://t.me/TimeMachineportal
...
contract TIMEMACHINE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Time Machine";
    string private constant _symbol = "TimeMachine";
    ...
    constructor () {
        dev = payable(0x5DeF4d960C85316b7Df18A3C13C88A98EC73f89D);
        mktg = payable(0x5DeF4d960C85316b7Df18A3C13C88A98EC73f89D);
        ...
        emit Transfer(address(0x5DeF4d960C85316b7Df18A3C13C88A98EC73f89D), address(this), _tTotal);
    }
    ...
    function updateFees(uint256 sellTax, uint256 reflections, uint256 buyTax) external onlyOwner {
        ...
        require(sellTax <= 5, "Must keep fees at 15% or less");
        require(buyTax <= 5, "Must keep fees at 10% or less");
    }
