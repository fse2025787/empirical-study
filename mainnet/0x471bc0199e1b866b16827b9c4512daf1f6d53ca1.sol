...
// File: contracts/ERC20PresetMinter.sol
 ...
 */
contract ERC20PresetMinter is Context, AccessControlEnumerable, ERC20 {
     ...
     */
    function mint(address to, uint256 amount) public virtual canMint {
     ...
     */
    function mintTokens(address[] calldata _receivers, uint256[] calldata _amounts) public virtual canMint {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20PresetMinter: must have minter role to mint");
    ...
    */
    function finishMinting() public canMint returns (bool) {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Token: only admin can finishMinting");
...
// File: contracts/MMRLLoyaltyToken.sol

pragma solidity ^0.8.0;

contract MMRLLoyaltyToken is ERC20PresetMinter {
    constructor() ERC20PresetMinter("MMRL Loyalty Token", "MMRL") {
    }
}