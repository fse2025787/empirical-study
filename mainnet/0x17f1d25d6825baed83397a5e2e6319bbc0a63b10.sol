...
contract TeamToken is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SBF Goes to Hell";
    string private _symbol = unicode"SBFH";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xdc0e4a2A6155043A63709a4C6c53fd688dd01304));
        marketingWallet = payable(address(0x7D9B27c81AeBAcAc6632fa2403eB771D3322616c));
