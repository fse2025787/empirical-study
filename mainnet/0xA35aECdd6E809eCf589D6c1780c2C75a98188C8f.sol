...
contract GoldenGurl is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "BettyWhite";                                           // name
    string private _symbol = "BETTY";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xdb10247585fe1a9c721C6fc51b2Ce5EA1a06599c);
