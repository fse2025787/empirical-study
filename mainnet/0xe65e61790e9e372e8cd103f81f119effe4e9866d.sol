...
contract GintoKin is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Gin to Kin";
    string private constant _symbol = "Gin to Kin";
    ...
    address payable private _developmentAddress = payable(0x00198c99Bd550060219C1Ee756d41a09c0de6e6b);
    address payable private _marketingAddress = payable(0x00198c99Bd550060219C1Ee756d41a09c0de6e6b);
