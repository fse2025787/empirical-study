...
//   _   _       _                 _     _ _                  _               _    __ 
//  | \ | |     | |               | |   | (_)                | |             | |  / _|
//  |  \| | ___ | |_    __ _  ___ | |__ | |_ _ __   __ _ _ __| |______      _| |_| |_ 
//  | . ` |/ _ \| __|  / _` |/ _ \| '_ \| | | '_ \ / _` | '__| |_  /\ \ /\ / / __|  _|
//  | |\  | (_) | |_  | (_| | (_) | |_) | | | | | | (_| | |  | |/ /  \ V  V /| |_| |  
//  |_| \_|\___/ \__|  \__, |\___/|_.__/|_|_|_| |_|\__, |_|  |_/___|  \_/\_/  \__|_|  
//                      __/ |                       __/ |                             
//                     |___/                       |___/                              
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xeE87f402d14BBF71347A165EaedAAe9F42c36f12];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 3333 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUaWJtPT3Kr23LnWBvydurREg772Y58bKRPvVjRunir9u/";
...
// File: contracts/NotgoblingrlzwtfContract.sol
//

pragma solidity ^0.8.0;

contract NotgoblingrlzwtfContract is RamppERC721A {
    constructor() RamppERC721A("Not goblingrlzwtf", "goblingrlz"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wmVwjzEIMuSQ2XIatY8C/contract-metadata";
    }
}
