...
contract SCXyLock is ISCXyLock, Ownable {
    ...
    address public feeWallet = 0xB7Bf5aaE118083f30Cb9fA25C475c30CC9Ad92da;
    ...
    function setFeeWallet(address walletAddress) external onlyOwner {
        feeWallet = walletAddress;
    }

    function recoverETH(address payable walletAddress) external onlyOwner {
