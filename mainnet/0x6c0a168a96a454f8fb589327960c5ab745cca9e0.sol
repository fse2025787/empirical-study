...
contract MMB is ERC721A, Ownable, ReentrancyGuard {

    string public baseURI = "ipfs://QmcAU6TLkirz6KGCJfRYJG7HeaKUZZDyJbfaJquZT4cx2t/";
    string public baseExtension = ".json";
  uint public          price             = 0.05 ether;
  uint public          maxPerTx          = 5;
  uint public          maxTxForFreeMints    = 1;
  uint public          totalFree         = 50;
  uint public          maxSupply         = 400;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = true;

  constructor() ERC721A("Moon Mythical Beings", "MMB"){
