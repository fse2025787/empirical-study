...
contract Elevations is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmY1K43ccHQKGJQk95BqE4vGFcZ91mC6Y4oVk6xjb7ucc3";
    ...
    constructor(
    ) ERC721A("Elevations | by Lynn Chang", "ELEVATIONS", 100, maxSupply) {
    }
