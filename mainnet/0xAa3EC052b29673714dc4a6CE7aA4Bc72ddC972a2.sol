...
contract TehApeOfficial is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TEH APE";
    string private constant _symbol = unicode"TAPE";
    ...
    uint256 public _maxTaxSwap= 500 * 10**_decimals;
