...
contract RebelsSecondaryVault is ERC1155, Ownable {

    receive() external payable { }


    // Payout addresses
    address team1 = 0x3F838Fb407b750655632088bDf1D0430F53AC8F3;
    address team2 = 0xCdC82eE2cbC9168e7DA4CD3EeF49705C5610839b;
    address team3 = 0x35364A2B2c2DC73bEdF16e7fBCd29D2dA27E04D4;
    address team4 = 0xDf82600D2fA71B2Cb9406EEF582114b395729d23;
    address team5 = 0x9D35BaDbC2300003B5CF077262e7Ef389a89e981;
    address team6 = 0x13205830f2bf6f1197D057f145454CE99A955A6d;
    ...
    function withdraw() public {
        uint256 amountToTeam1 = (address(this).balance * 170) / 1000; // 17%
        uint256 amountToTeam2 = (address(this).balance * 170) / 1000; // 17%
        uint256 amountToTeam3 = (address(this).balance * 170) / 1000; // 17%
        uint256 amountToTeam4 = (address(this).balance * 170) / 1000; // 17%
        uint256 amountToTeam5 = (address(this).balance * 170) / 1000; // 17%
        ...
        // send the rest to team 6
        uint256 amountToTeam6 = address(this).balance; // ~15%
