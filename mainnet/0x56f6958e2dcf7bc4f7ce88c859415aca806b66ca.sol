...
NOTAX Inu aims to be a stealth launch and creates the full freedom for our owners to Model and Bottle together. 
There will be no fucking Tax and marketing channels to deter toxic people or jeets. 
A tokenomics of  absolutely no buy tax but a three percent sales tax will be implemented to punish the jeets.
We believe rather than handing your hard earned wealth to so-called “marketing professionals” is total bullshit.
...
contract NOTAX is Context, IERC20, Ownable {
    ...
    string public constant name = unicode"NO TAX INU";
    string public constant symbol = unicode"NOTAX";
    ...
    function setFees(uint buy, uint sell) external onlyOwner() {
        require(buy < 0 && sell < 3 && buy < _buyFee && sell < _sellFee);
        _buyFee = buy;
        _sellFee = sell;
