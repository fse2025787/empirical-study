...
//
//     ____                   _       ___           
//    / __ \____ _____  __  _| |     / (_)___  _  __
//   / / / / __ `/_  / / / / / | /| / / / __ \| |/_/
//  / /_/ / /_/ / / /_/ /_/ /| |/ |/ / / / / />  <  
// /_____/\__,_/ /___/\__, / |__/|__/_/_/ /_/_/|_|  
//                   /____/                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x97E62A50981aeDf9A05BE7DE9A0E8Bacc16377Fe,0x4d8B6F8E6c5569B3003a94748b2A0cD3552962E5];
  address public erc20Payable = 0x97E62A50981aeDf9A05BE7DE9A0E8Bacc16377Fe;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.075 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmTk5Att3qgGatvdAwHzsct7fqbt7n9D36K9bNk16oBE1r/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/9Bi14TzWW9c4ccpskGmu/contract-metadata";
  }
...
// File: contracts/DazyWinxContract.sol
//

pragma solidity ^0.8.0;

contract DazyWinxContract is RamppERC721A {
    constructor() RamppERC721A("DazyWinx", "DZWX"){}
}