...
/*TELEGRAM  https://t.me/evilvitalikpump 
*/
...
contract evilvitalikpump is Context, IERC20, Ownable {
    ...
    string private constant _name = "@evilvitalikpump ";
    string private constant _symbol = "$epv";
