...
/*
The steadfastness of teh people guranteed complete victory over the enemy
...
contract TehFightClub is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Fight Club";
    string private constant _symbol = "CLUB";
