...
// Anri Kizuki is the new generation socialfi project to build the NFT, Play2Earn, Watch2Earn, Staking into an mobileapp.
 ...
 * allowances. See {IERC20-approve}.
 */
contract AnriKizuki is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Anri Kizuki";
    string private _symbol = "Anri";
