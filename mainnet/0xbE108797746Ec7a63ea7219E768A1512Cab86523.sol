...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656054000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1655967600;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2B0661F429202961b764572CBFA5C367B3dcf3a9];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmcDhu1LU4ShtHiy1bJShJFX3Dob3W63NwT8GK2GKeRo6A/";
...
// File: contracts/PunkedContract.sol
//

pragma solidity ^0.8.0;

contract PunkedContract is RamppERC721A {
    constructor() RamppERC721A("Punked", "PNKD"){}
}
