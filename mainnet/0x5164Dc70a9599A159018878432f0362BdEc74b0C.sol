...
Caw AI is a meme coin inspired by Vitalik Tweets. 
$CAIW is its token name, the coin is community-centered with the goal of making opportunity for holders to make passive income every day thus contributing unity for success.

Website : http://cawai.org/
Twitter : https://twitter.com/cawintelligence
TG      : https://t.me/cawaierc20
...
contract CAIW is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CAW Intelligence", "CAIW") {
