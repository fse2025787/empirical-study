...
contract DEXRIUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dexrium";
    ...
    address payable private _developmentAddress = payable(0x46E07B5db595290A5702215EF90963fBf7e7416d); 
    address payable private _marketingAddress = payable(0x46E07B5db595290A5702215EF90963fBf7e7416d);
