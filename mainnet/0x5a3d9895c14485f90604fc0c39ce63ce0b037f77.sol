...
contract YellowDuckCollection is ERC721Enumerable, Ownable {
    ...
    // running supply
    uint256 public runningSupply = 0;
    ...
    uint256 private _nextTokenId = 122;
...

    {
        ...
        require(runningSupply + numberOfTokens <= (maxSupply - 122), "Purchase would exceed max supply.");
        require(
    ...
    function publicMint(uint8 numberOfTokens) public payable _requirePublicSaleState {
        ...
        require(
            ...
            "You may mint up to 3 ducks on the public list sale."
        );
