...
Pirates, plunderers and pillagers.
We've moved from gold and diamond riches to crypto treasures.
Come onboard the crew and earn with us, yield with us and INVADE WITH US $PIRATES
...
V1 game: game.piratesplunder.io

Telegram:https://t.me/plunderentry
**/
// 
...
contract PiratesPlunder is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xF98142DC8D6a03028FEf94f6A6d8dd8eCCac25b0); 
    address payable private _marketingAddress = payable(0xF98142DC8D6a03028FEf94f6A6d8dd8eCCac25b0);
