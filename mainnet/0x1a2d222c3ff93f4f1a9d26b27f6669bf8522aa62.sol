...
contract PudgyDickButts is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeifjz62l7icqa7awog6hhxwtulxequ5wskhchot3xifrwat25sizpy/";
  uint256  public  maxSupply = 8888;
  uint256 public  MAX_MINTS_PER_TX = 11;
  ...
  ) ERC721A("Pudgy Dickbutt", "PUDGYDICK") {
