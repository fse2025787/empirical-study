...
contract ArabInu is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Arab Inu", "ARAB") {
    ...
    function maxBidding() external onlyOwner {

      buyMarketingFee = 6;
      buyTotalFees = buyMarketingFee;

      maxTransactionAmount = 22000 * 1e18;
      maxWallet = 22000 * 1e18;
