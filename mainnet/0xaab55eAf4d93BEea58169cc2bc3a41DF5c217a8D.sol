...
Token Name: JENGA BLOCKS
Ticker: JENGA

Supply: 100,000
TAX: 4/4

🧱 Playing crypto is like Jenga; we must hit the top level in order to moon it.  But for this particular game, we won’t let the tower fall completely. Instead we will focus on slow organic growth. 

https://t.me/JENGAERC20
...
contract JengaERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jenga Blocks";
    string private constant _symbol = "JENGA";
