...
/********************
Token Name: Ryoshi x Ryoko
Symbol: UNTOLD
Supply: 2,000,000 / initial max buy 20,000
...
Telegram: https://t.me/untolderc20
Twitter: https://twitter.com/RyokoUntold
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ryoshi x Ryoko";
    string private constant _symbol = "UNTOLD";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x0cC8eA0Ab45187ec343bc4FaF4CbABC921161071); 
        _tOwned[owner()] = _tTotal;
                
        uint256 _buyAutoLiquidityFee = 200;
        uint256 _buyAutoBurnFee = 0;
        uint256 _buyMarketingFee = 100;
        uint256 _sellAutoLiquidityFee = 600;
    ...
    function RervertSellFeesToOriginalTax() external onlyOwner {
        //Revert to original sell tax 3/3
