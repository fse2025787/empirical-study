...
contract ShinaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "ShinaDoge";
    string private _symbol = "SHIDOGE";
    ...
    uint256 public _maxTxAmount = 95000000 * 10**18;
    uint256 public maxWalletToken = 900000000 * (10**18);
