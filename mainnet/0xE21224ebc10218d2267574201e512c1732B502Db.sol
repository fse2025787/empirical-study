...
//TG: http://t.me/iNode512
//Twitter: https://twitter.com/iNode512
//Website: https://iNode512.com
...
contract iNode512 is ERC20, Ownable {
    ...
    constructor() ERC20("iNode512", "iNode") {
        ...
        swapTokensAtAmount = totalSupply * 50 / 10000; // 0.5% swap tokens amount
        ...
        rewardsSellFee = 20;
        operationsSellFee = 120;
        liquiditySellFee = 10;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee;

    	dividendTracker = new DividendTracker();
    	
    	operationsWallet = address(owner()); // set as operations wallet
        dev1Wallet = address(owner());
