...
* 契約は安全で、15 日間ロックされ、所有権は死亡したアドレスに転送されます。
...
WeChat : https://web.wechat.com/AkinzakoJPN
...
contract Akinzako is IERC20, Ownable {
    ...
    string private constant _name = "Akinzako";
    string private constant _symbol = unicode"AKIN";
