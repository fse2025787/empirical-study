...
The Yayoi followed the Jōmon period and Yayoi culture flourished in a geographic area from southern Kyūshū to northern Honshū. 

https://t.me/YayoiShiba_ETH
*/
...
contract YayoiShiba is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Yayoi Shiba";
    string private constant _symbol = unicode"YAYOI";
