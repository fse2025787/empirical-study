...
contract RRCOIN is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTJ4LGgWMnPEiHa6hDMCmYsJ1535H9D1gb7egcLh22LEU";
    ...
    constructor(
    ) ERC721A("RR/APECOIN", "$RR/APE", 100, maxSupply) {
    }
