...
contract LunarRabbit is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) nonReentrant {
    ...
    require(_mintAmount <= maxPerTx, "Exceed maximum per transaction");
