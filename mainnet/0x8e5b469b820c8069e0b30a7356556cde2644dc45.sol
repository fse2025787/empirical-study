...
contract pxPunks is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 1476;
    uint256 public MAX_FREE = 1222;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "pxPunks";
    string private constant _symbol = "PXPUNK";
    string private _baseURI = "QmcotzKE9Wc3bJ4MQnuzcC1J1Ct6NKawmXkqjzUFwjcbra";
