...
contract HachiNFT is Ownable, ERC721A, ReentrancyGuard {
    using   Strings for uint256;
    ...
    constructor (string memory _pendingURI, uint256 _mintStartTime) ERC721A("HachiNFT", "HACHINFT", maxSupply, maxSupply) {
