...
contract JustApe is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Just Ape";
    string private constant tokenSymbol = "jAPE";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x3FF3D7Dc0C02079f6dAbC22bbF49C614b403177D);
        devAddress = payable(0x3FF3D7Dc0C02079f6dAbC22bbF49C614b403177D);
    ...
    function GoLive() external onlyOwner returns (bool){
        ...
        sniperPenaltyEnd = block.timestamp.add(7 days);
