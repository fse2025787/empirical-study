...
contract VANGUARD is Context, IERC20, Ownable {
    ...
    string private _name = "The Advance Guard";
    string private _symbol = "VANGUARD";
    ...
    address public marketingTokenFeeWallet = 0x871D42298392CE8219F753a34c5fD4702Def7a19;
    address public marketingETHFeeWallet = 0x871D42298392CE8219F753a34c5fD4702Def7a19;
    ...
    uint256 public _maxTxAmount = 1 * 10**7 * 10**9;//1% maxTxAmount
    uint256 public _maxWallet = 3 * 10**7 * 10**9;//3% maxWallet
