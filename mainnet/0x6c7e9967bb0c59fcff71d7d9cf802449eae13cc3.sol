...
contract SAMMU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sammu Inu";
    ...
    function pairunblack() public deployerOnly {
        // ublacklist the pair address
        address bbot;
