...
/**
    ...
    Max wallet : 2% ( Per address,you can use multiple addresses)

    2% liquidity Fee on buying and selling MSN

    There is no dev or marketing fee.

    MSN is a social experiment style of token.
...
contract MISSION is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Mission", "MSN") {
