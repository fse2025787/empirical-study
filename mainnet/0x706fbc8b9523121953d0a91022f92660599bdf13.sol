...
contract Baggies is ERC721Enum, Ownable, ReentrancyGuard {
	...
	Tripsters public tripsterContractInstance = Tripsters(0xc7457f480416e145093EDB355F626FaA0fc7F90E);
	...
	function mint(uint256 _count, address _to) external onlyOwner nonReentrant{
	...
	function mint(uint256 _count) external onlyOwner nonReentrant{
		uint256 totalSupply = totalSupply();
		for (uint256 i = 0; i < _count; i++) {
		     address recipient = tripsterContractInstance.ownerOf(totalSupply+i);
