...
contract CACAxBELLA is ERC1155Tradable {
	constructor() public ERC1155Tradable("CACAxBELLA", "CBEL") {
		_setBaseMetadataURI("https://raw.githubusercontent.com/acenftproject2021/cbel_metadata/main/");
	}
  ...
  function setMaxSupply(uint256 _id, uint256 _newMaxSupply) public onlyWhitelistAdmin {
    require(_exists(_id), "CACAxBELLA#setMaxSupply: NONEXISTENT_TOKEN");
    require(_newMaxSupply >= tokenSupply[_id], "CACAxBELLA#setMaxSupply: Max supply cannot be less than token supply");
