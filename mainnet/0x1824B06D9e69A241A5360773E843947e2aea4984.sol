...
contract ishowspeedinu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "IShowSpeedInu";
    string private constant _symbol = "SEWY";
    ...
    address payable private _developmentAddress = payable(0x924B0343453F85400A45ee7C43a3F4A8B5a47367); 
    address payable private _marketingAddress = payable(0x924B0343453F85400A45ee7C43a3F4A8B5a47367);
