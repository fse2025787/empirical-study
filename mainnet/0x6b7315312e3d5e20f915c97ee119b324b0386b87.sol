...
contract TPB is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0x8579052c00C1ee82b556ae0C439aCe49aBa3b51d);
    ...
    constructor() ERC20("The Protocol Burn", "TPB") {
    ...
    function setTPBModifier(address account, bool onOrOff) external onlyOwner {
