...
// File: contracts/WrappedHotels.sol
...
contract WrappedHotels is ERC721A, Ownable {
    ...
    constructor(address _minter, string memory _tokenUri, string memory _contractUri, address _proxyRegistryAddress) ERC721A("WrappedHotels", "WH") {
        MINTER = _minter;
        baseURI = _tokenUri;
