...
contract TRIKO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "TRIKO";
    string private constant tokenSymbol = "TRIKO";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x54F0e06D0FE1a0e2A98D2D7B899Be240e2f331Be);
        devAddress = payable(0x70bB796b4D80773a19d7dA11D4Da9d81bAdc6912);
