...
//DeFi Sniper Bot
//Easy trading with free sniper bot tools. Buy and sell instant. 
//Advanced: low commission, fastest speed, list of profitable traders (ROI), copytrade.
...
contract DeFiSniperBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DeFi Sniper Bot";
    string private _symbol = unicode"DSB";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0xF1A38D0E6B3C7679eF6b43e45e49bd1E928FF0EF));
        marketingWallet = payable(address(0x3b4Ec6917bf7D1eb4dCe9664dE79c3c4F7E2123D));
