...
contract TheAmazingMetagals is Ownable, ERC721 {
    
    uint public tokenPrice = 0.03 ether;
    uint constant maxSupply = 1200;
    ...
    constructor() ERC721("The Amazing Metagals", "AMG"){}
   ...
   function buy(uint _count) public payable{
        ...
        require(totalSupply + _count<= phase, "Not enough tokens remaining in current phase");
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 90 / 100); //90%
        payable(0x5DE064024c5b898C016059B5d4c94Fc42cc8579b).transfer(_balance * 85 / 1000); //8.5%
        payable(0x5B588e36FF358D4376A76FB163fd69Da02A2A9a5).transfer(_balance * 15 / 1000); //1.5%
    }
