...
contract GOTAMA is Context, IERC20, Ownable {
    ...
    address public teamAndMarketingWallet = address(0xb5e54c347171e29300c1bf8E34CB2Bc00850Ace6);

    string private _name = "Gotama Inu";
    string private _symbol = "GOTAMA";
    ...
    uint256 public _maxTxAmount = 3000000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 990000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 4000000000000000000000 * 10**9;
    ...
    constructor () {
        ...
        Limtcheck[uniswapV2Pair]=true;
         Limtcheck[teamAndMarketingWallet]=true;
    ...
    function _transfer(
        ...
        require(amount > 0, "Transfer amount must be greater than zero");
         ...
         if(!Limtcheck[to]){ require(amount <= _maxTxAmount,"Tx Limit Exceed");
         }
       
        if(!Limtcheck[to]){ require(balanceOf(to).add(amount) <= _maxWalletSize,"Tx Limit Exceed");
         }
