...
contract Remit2Any {
    ...
    // @notice string => transfer asset
    mapping(string => TransferAsset) public transactions;

    // errors
    error ZeroAddress();
    error ZeroAmount();
    error TransactionIdDone();
    ...
    function getTransaction(string memory _transactionId) external view returns (TransferAsset memory _transaction) {
