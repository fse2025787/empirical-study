...
contract IKINAMI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x921e4Fea97F272E758b51815Dfb3499fb381B68D); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x921e4Fea97F272E758b51815Dfb3499fb381B68D);
    address payable public constant Wallet_Liquidity = payable(0x000000000000000000000000000000000000dEaD); 
    
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 7* 10**6 * 10**_decimals;
    string private constant _name = "IKINAMI"; 
    string private constant _symbol = unicode"Ikinami";
    ...
    constructor () {
        ...
        _owner = 0x921e4Fea97F272E758b51815Dfb3499fb381B68D;
