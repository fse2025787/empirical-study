...
/*
dish dog is a dog wrapped in Chinese cabbage The inspiration for this design was originally derived from the
Vegetable Elf  series created by Japanese painter ばんKichi. dish dog belongs to the existence of Yiqi Juechen

TG:https://t.me/DishDog_ETH

Twitter:https://twitter.com/DishDog_ETH
...
contract DISHINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Dish Dog";
    string private constant _symbol = unicode"DISH INU";
