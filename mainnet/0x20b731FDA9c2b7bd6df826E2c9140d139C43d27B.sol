...
/**
   https://t.me/PulseHadesErc20

   https://twitter.com/PULSEHADES

   https://www.pulsehades.com/
*/
...
contract PulseHades is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4DbBcaA614E9be280d4397504A1Ed1bD60e15A63); 
    address payable public Wallet_Team = payable(0x59fdc5409F6dc450bb246c3A00cAF2AC993345E0);
    ...
    string private constant _name = "PULSE HADES"; 
    string private constant _symbol = unicode"$HADES"; 
    ...
    constructor () {
        ...
        _owner = 0x59fdc5409F6dc450bb246c3A00cAF2AC993345E0;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4DbBcaA614E9be280d4397504A1Ed1bD60e15A63); // Testnet
