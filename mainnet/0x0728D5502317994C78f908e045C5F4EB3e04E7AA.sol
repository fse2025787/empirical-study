...
contract Builders is ERC721A, ERC2981, Ownable, ReentrancyGuard,Pausable {
    ...
    string public tokenBaseURI = "https://test-nft/";

    constructor(address _royaltyReceiver) ERC721A("This is just the test", "TESTING", 5, 1000) {
        maxMintPerUser = 5;
