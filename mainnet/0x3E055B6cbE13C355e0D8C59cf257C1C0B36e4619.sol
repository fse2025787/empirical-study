...
contract SHIBOBA is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "SHIBOBA";
    string private constant tokenSymbol = "SHIBOBA";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x270cE8360087dd9FEC85ed5F01eA165865867a08);
        devAddress = payable(0x270cE8360087dd9FEC85ed5F01eA165865867a08);
