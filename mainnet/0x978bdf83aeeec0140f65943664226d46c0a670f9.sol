...
contract HeartFirst is ERC721URIStorage, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint public constant maxPurchase = 10;
    uint public constant maxNFTs = 365;
    uint256 public constant purchasePrice = 60000000000000000; //0.06 ETH

    constructor() ERC721("Heart First Anatomy", "HEARTFIRST") {}
        ...
        returns (uint256)
    {
        ...
        _setTokenURI(newItemId, string(abi.encodePacked(
                "https://heart-first.s3.us-east-2.amazonaws.com/",
    ...
    function mintHF(uint numberOfTokens) public payable {
