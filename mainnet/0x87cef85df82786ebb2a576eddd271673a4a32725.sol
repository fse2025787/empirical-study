...
/*
    ...
    Everyone has failed. Some gave up, some got back up. Then there are losers, there are winners
*/
...
contract BEGINNING is ERC20, Ownable {
    ...
    constructor() ERC20("The Beginning", "BEGINNING") {
        ...
        devWallet = address(0xeA3a7f58AEC203C82d6dd782fD20a712d2dF722E); // set as dev wallet
