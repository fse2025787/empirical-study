...
contract aDegensMeme is Context, IERC20, Ownable {
    ...
    string private constant _name = "A Degens Meme";
    string private constant _symbol = "Teh Meme";
