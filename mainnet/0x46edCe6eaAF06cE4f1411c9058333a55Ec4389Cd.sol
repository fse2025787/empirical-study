...
contract Orbis86MintPassEdition1 is ERC721Delegated, ReentrancyGuard {
  using Counters for Counters.Counter;

  constructor(address baseFactory, string memory customBaseURI_)
    ERC721Delegated(
      baseFactory,
      "Orbis86 Mint Pass Edition 1",
      "O86MPV1",
      ConfigSettings({
        royaltyBps: 500,
  ...
  uint256 public constant PRICE = 175000000000000000;
  ...
  function mint(uint256[] calldata ids) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.175 ETH per item"
    );
