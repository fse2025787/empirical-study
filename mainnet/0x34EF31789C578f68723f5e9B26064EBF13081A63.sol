...
contract VSStaking is ERC721Holder, Ownable {
    ...
    uint256 public constant MINIMUM_TIME = 2592000;
    ...
    function stake(uint256 tokenId) public {
        ...
        if (nftAddress.ownerOf(tokenId) != msg.sender) revert VSStaking__NotOwner();
    ...
    function unstake(uint256 tokenId) public {
        ...
        if (staked.owner != msg.sender) revert VSStaking__NotOwner();
    ...
    function depositAndDistributeRewards(uint256[] memory _validTokenIds) public payable onlyOwner {
        ...
        for (uint i = 0; i < _validTokenIds.length; i++) {
            ...
            if (block.timestamp - stakeDetails.timestamp >= MINIMUM_TIME) {
