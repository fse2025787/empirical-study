...
contract CawKek is ERC20, Ownable {
    ...
    bool public blPeriodEnabled = true;
    ...
    event DisabledBlPeriodForever();

    constructor() payable ERC20("CawKek", "CAWKEK") {
        ...
        defaultLiquiditySellFee = 1;

        sellOperationsFee = 8;
        sellLiquidityFee = 2;
        sellTotalFees = sellOperationsFee + sellLiquidityFee;

        operationsAddress = address(0xd5704b84978C6a157BA6341c5e54250142d224CE);
        ...
        _createInitialSupply(
            address(0x36B59455AfeEdf0866FE6E775FE7651bbBe3e005),
            (totalSupply * 20) / 100
        ); // CAW DEPLOYER
    ...
    function turnOffBlPeriod(bool confirm) external onlyOwner {
        require(confirm, "Confirm selling enabled!");
        require(blPeriodEnabled, "Selling already disabled!");

        blPeriodEnabled = false;
        emit DisabledBlPeriodForever();
    }
