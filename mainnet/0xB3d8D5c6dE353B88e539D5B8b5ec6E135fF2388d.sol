...
contract WordofMouth is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000 * 1e7 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Word of Mouth";
    string private constant _symbol = "WOM";
    ...
    uint256 public maxTransactionAmount = (_tTotal * maxTxPercent) / 1000; // 1% maxTransactionAmountTxn
    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    uint256 private maxWalletPercent = 50;
    uint256 public maxWalletSize = (_tTotal * maxWalletPercent) / 1000; // 5% maxWalletSize of Total Supply
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 10;
        _rOwned[address(this)] = _rTotal / 1000 * 990;
        
        
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x9D8D0422958aC7039cB557421D5C1474519a16FD); // Marketing Address
        
        devAddress = payable(0x3103da067c04abCB95af45C2021B21474587c18A); // Dev Address
        
        liquidityAddress = payable(0x0eaF3bE925Ba0B5990A3102dBCdaE0506B169971); // Liquidity Address (switches to dead address once launch happens)
        ...
        excludeFromMaxTransaction(address(liquidityAddress), true);
        excludeFromMaxTransaction(address(devAddress), true);
       
        emit Transfer(address(0), _msgSender(), _tTotal * 10 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 990 / 1000);
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // higher tax if bought in the same block as trading active for 24 hours (sniper protect)
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 2;
