...
//http://t.me/burgerkong

//https://www.burgerkongtoken.com/
...
contract BKONG is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0x42cF8a0af09f2154cFce4FBCD20Ef3d749c8de5c); // set as marketing wallet
        ...
        excludeFromFees(0xB8762B2CBBf1EB148f8b8E686029DE976F9FAb1A, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xB8762B2CBBf1EB148f8b8E686029DE976F9FAb1A, true);
        ...
        */
        ...
        _createInitialSupply(0xB8762B2CBBf1EB148f8b8E686029DE976F9FAb1A, totalSupply*5/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xb98d1576AcCA7Ab82B1c4c6C39788C2374342285,
            block.timestamp
        );
    }
