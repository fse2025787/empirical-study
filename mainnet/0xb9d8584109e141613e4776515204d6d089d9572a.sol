    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getCover(
        ...
        IDistributor.Cover[] memory covers = new IDistributor.Cover[](
            arraySize
        );
    ...
    function _buyCover(
        ...
        bytes calldata data
    ) internal returns (uint256 _coverId) {
        (
            ,
            ,
            ,
        ...
        _coverDetails[0] = sumAssured;
        _coverDetails[1] = coverPrice;
        _coverDetails[2] = coverPriceNXM;
        _coverDetails[3] = generatedAt;
        _coverDetails[4] = generatedAt;

        bytes4 _currency = address(gateway.ETH()) == coverAsset
            ? bytes4("ETH")
            : bytes4("DAI");
