...
contract HealthyChart  is ERC20, Ownable {
    ...
    constructor() ERC20("Healthy Chart", "HEALTH") {
        ...
        devWallet = address(0xca6bBeA540c8040ddd064915f681D9488Cdf0Aee); // set as dev wallet
