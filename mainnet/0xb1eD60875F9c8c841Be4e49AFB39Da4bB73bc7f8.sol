...
contract PUMPITBOY is Context, IERC20, Ownable {
    ...
    string private _name = "PUMP IT BOY";
    string private _symbol = "$PUMPIT";
    ...
    address payable public marketingWallet = payable(0xC536775be0e3fF74EA29aEfF4189fe63cda9dEEF); 
    address payable public rewardsWallet = payable(0x2639CB470102d172C8e61d4eD0BfdAe019DBF063); 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = (nonfee[sender] || nonfee[recipient]) ? 
