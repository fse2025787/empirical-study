...
/**
Baby Clifford Inu - The baby red dog is still big
*/
...
contract babyCliffordINU is Context, IERC20, Ownable {
    ...
    string private _name = "Baby CliffordInu";
    string private _symbol = "babyCLIFF";
    ...
    function changeAntiDumpTime(uint256 _time) public onlyOwner {
        cooldown = _time;
    }
    ...
    function _transfer(
        ...
        } else if (_antidump && to == uniswapV2Pair) {
            require(
