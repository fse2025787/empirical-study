...
// File contracts/badger-geyser/UnifiedLogger.sol
...
contract UnifiedLogger is AccessControlUpgradeable {
    ...
    function batchLogs(bytes memory logs) public {
        ...
        // Batcher Library is Hardcoded
        (bool success, bytes memory data) = 0x8660888d78Cf6de2B6095B9045eC49e418B688D8.delegatecall(abi.encodeWithSignature("batchLogs(bytes)", logs));
        require(success);
