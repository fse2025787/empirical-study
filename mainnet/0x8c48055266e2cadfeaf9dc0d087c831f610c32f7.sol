...
contract CyberZombieSociety is Ownable, ERC721 {
    ...
    uint public reveal_time = 1637773200;
    ...
    string public reveal_img = "https://gateway.pinata.cloud/ipfs/Qma7B5W2cUK3FucWHVxEjiohs47hThw5ifYtEm5X7Zzipp/";
   ...
   function buy_Presale(uint _count) public payable{
    ...
    function set_reveal_img(string memory _value) external onlyOwner{
        reveal_img = _value;
    }
