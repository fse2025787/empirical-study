...
// BIRDSHOT - Bird Killer with 1% Tax for Liquidity
// https://t.me/birdshoterc
...
contract BIRDSHOT is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = 'BIRDSHOT';
    string private _symbol = 'BIRD KILLER';
    ...
    uint256 public maxTxAmount = _tokenTotal.mul(10).div(1000); // 1%
