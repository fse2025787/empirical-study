...
contract SATTAT is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmVE74apdsVDqnvjQ9n8vkVeorgXtFprQY6D5mmbe3HxLK";
  string  public  STAGE_ONE = "True";
  string  public  STAGE_TWO = "False";
  string  public  MOONTAKEOVER = "1 days";
