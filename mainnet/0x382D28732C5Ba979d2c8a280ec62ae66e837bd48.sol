...
contract Forgotten is ERC721A, Ownable, ReentrancyGuard{


    uint256 public constant mintSupply = 61;
    uint256 public maxMintTx = 1;
    uint256 public constant gwMintPrice = 0.15 ether;
    ...
    constructor() ERC721A("Forgotten", "COBWF"){
