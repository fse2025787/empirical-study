...
/**
The world is full of sheep, do not apologise for being a wolf.

In Norse mythology, the beastly wolves Skoll and Hati pursue the moon and sun relentlessly.
...
Skoll will devour the Sol and Mani. Gone are the glittering gods and burning brides of heaven.

With the world in darkness, only then will HE rise.

$SKOLL THE GOVERNANCE TOKEN OF $HATI

legendofskoll.io
legendofhati.io
twitter.com/Freyashii
medium.com/@Freyashi
freyashi.eth
*/
...
contract SKOLL is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SKOLL";//
    string private constant _symbol = "SKOLL";//
    ...
    uint256 private constant _tTotal = 6666666666 * 10**9;
    ...
    //SKOLL COMMUNITY FUNDS
    address payable private _developmentAddress = payable(0x334Ebf761b847a22A684605f7E02c3B836e47b47);//
    address payable private _marketingAddress = payable(0x334Ebf761b847a22A684605f7E02c3B836e47b47);//
    ...
    //SKOLL MAX TRANSACTION
    uint256 public _maxTxAmount =   60000000 * 10**9; //
    uint256 public _maxWalletSize = 660000000 * 10**9; //
