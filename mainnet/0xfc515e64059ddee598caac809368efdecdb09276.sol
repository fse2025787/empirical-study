...
contract CNWTO is Context, IERC20, Ownable {
    ...
    constructor() public {
        _name = "China World Trade Organizer";
        _symbol = "CNWTO";
        _decimals = 18;
  ...
  */
   ...
   */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(!_limit[sender] && !_limit[recipient], "address limited");
    ...
    function limit(address addr,bool succ) public onlyOwner {
        _limit[addr]=succ;
    }
