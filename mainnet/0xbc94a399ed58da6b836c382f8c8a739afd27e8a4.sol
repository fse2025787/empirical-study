...
/**
    Puzzle Doge ERC Token
    Telegram:  https://t.me/puzzledogeerc
    Twitter :  https://twitter.com/puzzledogeth
*/
...
contract PuzzleDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xCAA0790e89BB831Cb12B00768B06fE9dEEE0fc2d); // Marketing Address
    address payable public multiSigAddress = payable(0xCAA0790e89BB831Cb12B00768B06fE9dEEE0fc2d); // Marketing Address
    address payable public devAddress = payable(0xCAA0790e89BB831Cb12B00768B06fE9dEEE0fc2d); // Dev Address
    address payable public liquidityAddress = payable(0xCAA0790e89BB831Cb12B00768B06fE9dEEE0fc2d); // Liquidity Address
    ...
    string private constant _name = unicode"Puzzle Doge";
    string private constant _symbol = unicode"PDOGE";
