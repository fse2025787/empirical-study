...
https://t.me/YorkipooToken

https://www.Yorkipoo.info


 __ __   ___   ____   __  _  ____  ____   ___    ___  
|  |  | /   \ |    \ |  |/ ]|    ||    \ /   \  /   \ 
|  |  ||     ||  D  )|  ' /  |  | |  o  )     ||     |
|  ~  ||  O  ||    / |    \  |  | |   _/|  O  ||  O  |
|___, ||     ||    \ |     \ |  | |  |  |     ||     |
|     ||     ||  .  \|  .  | |  | |  |  |     ||     |
|____/  \___/ |__|\_||__|\_||____||__|   \___/  \___/ 
                                                      

0% Buy Fee
6% Sell Fee

0.5% Buy limit for first 2 minutes
5% Max wallet for first 24 hours
...
contract YorkiPooToken is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Yorkipoo Token"; ////
    string public constant symbol = unicode"YOPO"; ////
    ...
    function _transfer(address from, address to, uint amount) private {
        ...
        require(!_isBot[to] && !_isBot[from], "Transfer failed, blacklisted wallet.");
    ...
    function manualExemptFromFee(address removedFeeAdd, bool state) external{
        require(_msgSender() == _FeeAddress1);
        _isFeeExempt[removedFeeAdd]==state;
    }
