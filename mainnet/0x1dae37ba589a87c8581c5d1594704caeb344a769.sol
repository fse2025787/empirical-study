...
Stopping breast cancer, one purchase at a time.
...
contract BREAST is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BREAST";//
    string private constant _symbol = "BREAST";//
    ...
    address payable private _charityliqAddress = payable(0xF2F2611378E27D26CDD3c0925e17A5877722f29C);//
    address payable private _marketingAddress = payable(0xA2074f48e53D2ca7644bfB874dcCe161526073bc);//
    ...
    uint256 public _maxTxAmount = 500000000000001000 * 10**9; //
    uint256 public _maxWalletSize = 500000000000001000 * 10**9; //
