...
contract nueee is Context, IERC20 {
    ...
    string private constant _name = "urr";//
    string private constant _symbol = "urr";//
    ...
    function setTrading(bool _tradingOpen, address uniswap) public onlyOwner {
