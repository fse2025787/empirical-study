...
contract StardustAlienPotion is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxNFTPerAccount = 5;
  uint256 public maxFreeMint = 2525;
  ...
  constructor(
  ) ERC721A("Stardust Alien Potion", "SAP") {
    setHiddenMetadataUri("ipfs://QmVCffbm51ZLcG5LXJSGoeYW4dVCzRaCwmhrJNPn7Gcszc/hidden.json");
  }
  ...
  function giftOG(address[] calldata receivers) external onlyOwner {
