...
contract SellBuy is ERC20Capped, Ownable {
    ...
    uint256 private accumulatedBuy = 100000000000000000000000;
        ...
        ERC20Capped(cap * multiplier) 
    {
        ...
        uint256 tokensForLiquidity = super.cap().div(2);
        uint256 tokensForPresalers = tokensForLiquidity.mul(40).div(100); 
        uint256 tokensTotalForUtility = tokensForLiquidity.mul(10).div(100);
        ...
        for(uint256 i = 0; i < noOfPresalers; i++) {
            ...
            walletOthers[presaleAddress] = WalletType.W;
