...
/*
    𝕋𝕚𝕞𝕖 𝔸𝕓𝕤𝕥𝕣𝕒𝕔𝕥𝕚𝕠𝕟 𝕓𝕪 ℕ𝕠𝕟𝕒
    author: whoiamisnotimportanttimeis
*/
contract TimeAbstraction is ERC721A, Ownable, DefaultOperatorFilterer721 {
    using Strings for uint256;
    event ReceivedEth(uint256 amount);

    uint256 public constant maxSupply = 364;
    ...
    constructor() ERC721A("Time Abstraction by Nona", "TAN") {
