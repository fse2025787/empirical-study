...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb8243C5A365B26d6Be34b2917a90F4aD71864c2B];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 4999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbYrcZ5CBkQZUrSsDdiUKCohXqfdtH87eFk3FttVeNAsA/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4999");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4999");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4999");
...
// File: contracts/RrrrbaycContract.sol
//

pragma solidity ^0.8.0;

contract RrrrbaycContract is RamppERC721A {
    constructor() RamppERC721A("RRRRBAYC", "RRRRBAYC"){}
}
