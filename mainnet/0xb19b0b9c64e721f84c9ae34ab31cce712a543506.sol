...
/*
 ...
 Bringing back the True Burns META
 3% True Burns
 2% Marketing
 2% LP to be removed at listing
...
contract salvage is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "SALVAGE";
    ...
    address payable private liqAddress = payable(0x7031732A9De7BAbC619Df6376253BC2E171Ff753);
    ...
    function updateFees(uint256 liqSell) external onlyOwner {
        j_liqSell = liqSell;
        require(liqSell <= 100, "Must keep fees at 100% or less");
    }
