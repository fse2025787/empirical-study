...
// File: DirtyDEFIDaycare.sol

pragma solidity ^0.8.0;

contract DirtyDEFIDaycare is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPLY = 9999;
    uint256 public MAX_ALLOWED = 9;
    uint256 public OWNER_RESERVED = 199;
    uint256 public price = 90000000000000000; //0.09 Ether
    string baseTokenURI;
    ...
    constructor(string memory baseURI) ERC721("Dirty DEFI Daycare", "DDD") {
        setBaseURI(baseURI);
    }
