...
/**
 * @title BlockSport
 * BlockSport - Collect limited edition NFTs from BlockSport
 */
contract BlockSport is ERC1155Tradable {
    string _contractURI;
	constructor(address _proxyRegistryAddress) public ERC1155Tradable("blocsport.one", "BS1", _proxyRegistryAddress) {
