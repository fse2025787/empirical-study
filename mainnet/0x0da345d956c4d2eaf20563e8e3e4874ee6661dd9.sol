...
contract Trustnobody is Context, IERC20, Ownable {
    ...
    string private _name = "Trustnobody";
    string private _symbol = "Trustnobody";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 2_000_000 * 10 ** _decimals;
