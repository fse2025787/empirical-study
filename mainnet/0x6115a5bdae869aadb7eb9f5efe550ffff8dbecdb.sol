...
/**   
        ...
        Telegram: https://t.me/MintPaderc20
...
contract MINTPAD is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "MINT PAD";
    string private constant _symbol = "MINT";
    ...
    address payable private _developmentAddress = payable(0x3B0c68CECf99fBe1065270b79abF99318F275DB5);
    address payable private _marketingAddress = payable(0x3B0c68CECf99fBe1065270b79abF99318F275DB5);
    ...
    function removeLimits(address[] calldata accounts, bool excluded) public onlyOwner {
