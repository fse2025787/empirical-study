...
Telegram: https://t.me/TheVoltInuOfficial
...
contract TVI is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 166_666_666_666 * 10**_decimals;
    
    uint256 public maxSellAmount = 100_000_000_000_000 * 10**_decimals;
    uint256 public maxBuyAmount = 100_000_000_000_000 * 10**_decimals;
    uint256 public maxWalletBalance = 100_000_000_000_000 * 10**_decimals;

    address public marketingAddress = 0x923d11bFcD0C541803317d074b82B465ECD1334d;
    address public devAddress = 0xa6793B691DE17c4c0a2487D930f9fd2B948c9e43;

    string private constant _name = "The Volt Inu";
    string private constant _symbol = "TVI";
    ...
    Taxes public taxes = Taxes(0,5,0,0);
    Taxes public sellTaxes = Taxes(0,5,0,0);
    ...
    // Owner cannot transfer out TVI from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out TVI!");
