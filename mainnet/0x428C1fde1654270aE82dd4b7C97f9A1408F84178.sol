...
contract JAILSBF is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JAIL SBF";
    string private constant _symbol = unicode"JSBF";
