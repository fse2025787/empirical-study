...
contract Fallen is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc44Da406E081D24C80FC631E87D205c8bFF224C7); // Marketing Address
    address payable public multiSigAddress = payable(0xc44Da406E081D24C80FC631E87D205c8bFF224C7); // Marketing Address
    address payable public devAddress = payable(0xc44Da406E081D24C80FC631E87D205c8bFF224C7); // Dev Address
    address payable public liquidityAddress = payable(0xc44Da406E081D24C80FC631E87D205c8bFF224C7); // Liquidity Address
    ...
    string private constant _name = unicode"Fallen";
    ...
    function setMaxWallet(uint256 maxWalletSize) external onlyOwner {
