...
contract Glawarriors is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Glawarriors","GLAWAR") {
    setBaseURI("tokenURI");
  }
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(preSaleActive == true){
            ...
            require(msg.value >= preSaleCost * _mintAmount, "Ether value sent is not correct!");//error-değiş
        }
        else{
