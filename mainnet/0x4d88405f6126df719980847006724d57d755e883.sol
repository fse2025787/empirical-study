...
contract Zhou is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Zhou Dynasty";
    string private constant _symbol = "ZHOU";
    ...
    address payable private _developmentAddress = payable(0x977997dA03c8b39B0618816445F3a62BdBE09541); 
    address payable private _marketingAddress = payable(0xa41Ea0C0695c6046b85B0d3666855a6788D8C8Bf);
