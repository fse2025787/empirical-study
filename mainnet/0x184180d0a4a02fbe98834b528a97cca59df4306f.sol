...
/**
https://t.me/trumptradingcardfund
...
contract TRUMP is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 45_000 * 10**8;
    ...
    string private constant _name = "Trump Trading Card Fund";
    string private constant _symbol = "TTCF";
    ...
    uint256 private _maxTxAmount = 900 * 10**8;
    uint256 private _maxWalletSize = 1350 * 10**8;
