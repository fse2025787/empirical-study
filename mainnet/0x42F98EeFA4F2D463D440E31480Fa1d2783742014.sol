...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x0A0DEF4C9f03FEB725F4d936f9D7E705CEc03b43];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x0A0DEF4C9f03FEB725F4d936f9D7E705CEc03b43;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1600;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 2587) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://yepdderqweqw.mypinata.cloud/ipfs/Qmegrwo7SZbSXEWyZeTMNWfSXe8MFymBqLK39QpKaAmSiy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2587");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2587");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2587");
...
// File: contracts/AgeofSolariumContract.sol
//

pragma solidity ^0.8.0;

contract AgeofSolariumContract is RamppERC721A {
    constructor() RamppERC721A("Age of  Solarium", "SOLARIUM"){}
}
