...
// File contracts/FixedBROwnableToken.sol
...
contract FixedBROwnableToken is ERC20Base, ERC20Burnable, ERC20Recoverable, FeeProcessor {    
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "FixedBROwnableToken")
        payable {

        require(initialSupply > 0, "FixedBROwnableToken: initial supply cannot be zero");
