...
contract  INOSUKEINU is Context, IERC20, Ownable {
    ...
    string private _name = "INOSUKE INU";
    string private _symbol = "INOSUKE";
    ...
    constructor () {
        ...
        Team = payable(address(0xa0b5BD33b85212cC89ACa1c3244263A273eA98cc));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x23Be2C02b2553e342f1084B680E49CD1EeD2714F), _msgSender(), _totalSupply);
    }
