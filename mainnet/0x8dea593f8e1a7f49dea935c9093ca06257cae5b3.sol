...
contract Vildart is ERC721Enumerable, Ownable {                 //contract Name is NErdyCoderCLone and inherited from the openzaplin libraries
  ...
  uint256 public cost = 0.70 ether;                                      //amouont of each nft in ether if this in polygon so it also works as same but in matic (native ) token 
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function removeWhitelistUser(address _user) public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xea7230226C4D37bC4198AB8F0b2570224e7933Da).call{value: address(this).balance * 0 / 100}("");
    require(hs);
    // =============================================================================
    ...
    // =============================================================================
    (bool os, ) = payable(0xea7230226C4D37bC4198AB8F0b2570224e7933Da).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
}