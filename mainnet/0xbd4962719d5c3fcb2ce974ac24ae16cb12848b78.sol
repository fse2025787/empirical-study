...
contract Wen is Context, IERC20, Ownable, Pausable {
    ...
    address payable public marketingWallet = payable(0x978e543e369b5ACd107303c2e506b911F6a5A4F6);
    ...
    uint256 public maxBuyTransactionAmount = 20000000000 * 10**9;  
    uint256 public maxWalletToken = 20000000000 * 10**9; 
