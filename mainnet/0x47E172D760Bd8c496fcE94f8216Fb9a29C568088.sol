...
Meta Dragon is a well-built Decentralized Web3 MetaVerse inspired by the western dragon myth, featuring different powerful dragons and legendary kings. It provides an immersive world where dragons can live together with those creatures of myth in the antediluvian period.

🕊️ Twitter: https://www.twitter.com/MetaDragonMyth
👥 Telegram: https://t.me/MetaDragonMyth
🕸️ Website: Development on progress
**/
  ...
  contract MetaDragonMyth is Context, IERC20, Ownable {
      ...
      string private constant _name = unicode"Meta Dragon";
      string private constant _symbol = "METAD";
