...
contract CatTrap is Context, IERC20, Ownable {
    ...
    // Total Default tax = x% | x% reflections | 1% AutoLP | x% marketing
    uint256 private _taxFee = 0;  // Reflections tax
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _liquidity  = 100; // lp min 1%
    ...
    uint256 private _developmentFee = 600; // marketing 
    ...
    uint256 public _maxTxAmount = 10_000_000_000 * 10**9;  // max tx is set to 1% of the supply by default
    uint256 public _maxWallet = 30_000_000_000 * 10**9;      // max wallet is 3% of the supply by default
    ...
    constructor () {
        ...
        feeaddress = payable(0xaaA9F200823A2e25690C02A712Ca57ce2CCd975E);
