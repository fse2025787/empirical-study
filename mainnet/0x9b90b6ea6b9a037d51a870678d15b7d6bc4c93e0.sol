...
/*
    ...
    https://t.me/LeviTokenErc20
    https://levitoken.io/

    $LEVI is a community-driven project with the main goal off given back rewards to holders. 
    $LEVI will be implementing a staking dApp that will reward native tokens to their investors.
*/
...
contract LeviToken is Context, IERC20, Ownable {
    ...
    string private _name = "Levi Token";
