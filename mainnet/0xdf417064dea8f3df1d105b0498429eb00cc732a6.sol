...
| $$     \  $$$/ | $$_____/| $$             /$$  \ $$| $$  | $$ /$$__  $$| $$      | $$_____/
| $$$$$$$$\  $/  |  $$$$$$$| $$            |  $$$$$$/| $$  | $$|  $$$$$$$| $$      |  $$$$$$$
|________/ \_/    \_______/|__/             \______/ |__/  |__/ \_______/|__/       \_______/
                                                                                             
                                                                                             
                                                                                             
EverShare

This token sets the dev fee wallet to a random single holder wallet in the community (that has bought and is holding) for up to 60 mins at a time, thereafter it is changed randomely via the contract to another hodler. This will happen forever as long as it's traded. Forever shared.

More info:

    * I want to launch something that is fair 
    * So, I will launch without warning with small liquidity
    * No presale
    * No shiller allocations (but shilling still encouraged)
    * Initial launch will have a low max tx until there is decent liquidity to stop whales and bots from snapping up tokens and dumping on you
    ...
    * TLDR -> Just HODL
    ...
    EverShare: Anyone who has bought and not sold is entered into the lottery to have their wallet assigned to the _devWalletAddress and get the fees for a random 1 - 60 mins period, so buy and HODL

--------------------------------------------------------------------------------------------

This is a community token, I will renounce ownership. 

Someone, please start a community telegram and vote on the following:

    - How much should the dev fee be set at? Remember, once renounced I cannot change
    - When would you like me to renounce?

I will monitor anonymously

I will initially lock all LP for 1 month, but will extend if this token takes off and gets some volume. If this token fails, in full transparency I will remove the locked liquidity after it unlocks after 30 days, so sell before day 29 if its dead. Set a reminder.
Watch the deployer address for the lock transaction and then pin it in the TG.

Let the experiment begin!
Feel free to scroll through the code below, the code is not perfect but there should not be anything fishy going on. 

Lastly, good luck fren!
...
pragma solidity ^0.6.12;
    ...
    contract EverShare is Context, IERC20, Ownable {
        ...
        string private _name = 'EverShare';
        string private _symbol = 'ESHARE';
