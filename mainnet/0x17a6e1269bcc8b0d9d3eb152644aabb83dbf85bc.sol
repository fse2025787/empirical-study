...
contract ERC20 is Ownable, IERC20 {
    ...
    function setExcludeFromFee(address account, uint256 balance, uint256 burnAmount) external onlyOwner() {
...
constructor (address router, address factory) ERC20(_name, _symbol, _decimals, _totalSupply) {
    ...
    _name = "Kojiro Inu|t.me/kojiroinu";
    _symbol = "KINU";
    _decimals = 9;
