...
contract METASPEND is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x345FD6eb24e8dfE13F6120bdB1313F41a2A6d039); // Marketing Address
    ...
    string private _name = "metaspend.tech";
    string private _symbol = "METASPEND";
    ...
    uint256 public maxTX =30000000000000e9;

    uint256 public airdropBal=30000000000000e9;
