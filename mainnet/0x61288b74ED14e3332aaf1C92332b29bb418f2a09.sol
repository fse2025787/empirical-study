...
contract RedLobster is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Red Lobster";
    ...
    address payable private scorcherWallet = payable(0xaE6b259166dB0bfD4a8a96FBd34e5D41d685616d);
    address payable private jeetWallet = payable(0xaE6b259166dB0bfD4a8a96FBd34e5D41d685616d);
