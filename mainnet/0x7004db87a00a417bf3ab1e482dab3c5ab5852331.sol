...
contract PayWithIERC20 is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public frenListMintRate = 4500000 ether;
  ...
  constructor (
    address contractAddress,uint256 totalMintable) ERC721A("Atsuma-Mikaboshi-Genesis", "MikaGenesis")  {
  ...
  function setHiddenMetadataUri(string memory _hiddenMetadataUri) public onlyOwner {
   ...
   function setMintRate(uint256 _cost) public onlyOwner {
    ...
    function setFrenMintRate(uint256 _cost) public onlyOwner {
