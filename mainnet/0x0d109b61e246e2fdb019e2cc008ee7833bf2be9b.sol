...
library PaymentSplitterHelper {
    ...
    function _payeeData() private pure returns (Payee[] memory) {
        Payee[] memory payeeData = new Payee[](10);
        payeeData[0] = Payee(0x1980c5a48909811200977D41C1E28a4bA32537F6, 100, Identity.CHARITY);
        payeeData[1] = Payee(0x05593957d675ecEE7b63387372245c8b96836ca1, 350, Identity.SNEAKY);
        payeeData[2] = Payee(0x0f2EB30Fb51771e2636574D29E369B4f32D88731, 55, Identity.LINKO);
        payeeData[3] = Payee(0x440b4a49248F25a9cF514aD8c1557CbF504ED5C4, 45, Identity.AURA);
        payeeData[4] = Payee(0xe66e39343d48aF67fb1679697FCA58b08B638459, 45, Identity.HARASSMENT);
        payeeData[5] = Payee(0x0b9d6CF696877551492BCbFECF6891f9B96aC868, 45, Identity.LLAMA);
        payeeData[6] = Payee(0x6b611D278233CB7ca76FD5C08579c3337C01e577, 30, Identity.CONNOR);
        payeeData[7] = Payee(0x58b7aD00D9Ba0832eD1a172Be2370Cfac0f97Bb0, 20, Identity.KFNC);
        payeeData[8] = Payee(0x9619da520414812Fd3794A6E8A55464c37691574, 10, Identity.KFNC2);
        payeeData[9] = Payee(0x306126f43f1086C1d388257bD3A64423bBa6A485, 300, Identity.TREASURY);
