...
contract Unread is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "3 Unread Messages";
    string private constant _symbol = "MESSAGES";
    ...
    address payable private _developmentAddress = payable(0x899c110Fe7dC93aEaE334AE38c3CB63583ACC6cd);
    address payable private _marketingAddress = payable(0x899c110Fe7dC93aEaE334AE38c3CB63583ACC6cd);
