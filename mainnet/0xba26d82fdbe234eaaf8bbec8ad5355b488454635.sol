...
contract AlphaBPass is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://Qmag9dcgjACfw8nyo4nTWpGSdNdEV6XKUtbn5v1DmYUCn4/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Alpha B Pass", "ALPHB", MAX_MINTS, MAX_SUPPLY) {  
