...
contract SpiralDAO is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x177da9238Ddd66897D15ab43412a253119D553bc);
  ...
  string private constant _name = 'Spiral DAO';
  string private constant _symbol = 'SPIRAL DAO';
  ...
  address public buybackTokenAddress = 0xC94f3e2aDE5E92389AF7E543657211EcCcAFf11E;
  ...
  uint256 public _maxTxAmount = _tTotal.mul(20).div(1000); // 2%
