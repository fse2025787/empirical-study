...
// File: contracts/2DGenuineUndead.sol
...
contract DDGenuineUndead is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3114;
  ...
  ) ERC721A("2D Genuine Undead", "2DGU") {
