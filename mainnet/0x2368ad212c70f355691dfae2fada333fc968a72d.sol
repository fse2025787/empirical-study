...
https://metricator.io
https://medium.com/@metricator
https://twitter.com/Metricator_ETH
https://t.me/metricatorentry

Launch Plan-- 
Phase 1: Max Wallet 2%
Phase 2: Max Wallet 4%
...
contract MetricatorProtocol is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0x3519570755bf85BD266f6cf53912f4B05022Cb5C); // 
        exclude(msg.sender);
