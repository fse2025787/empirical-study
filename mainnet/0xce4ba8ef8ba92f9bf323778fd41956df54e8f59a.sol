...
contract WFToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "$WF";
    string private constant _symbol = "$WF";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x849888311C0C311f66C8e989daeEE26dd0D01923);
        _feeAddrWallet2 = payable(0x849888311C0C311f66C8e989daeEE26dd0D01923);
