...
// File: contracts/ExgentlemensClub.sol
...
contract ExgentlemensClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Exgentlemens Club", "EXGC") {
    setHiddenMetadataUri("ipfs://QmYYcaY8HsbPhqidueKyE5UjiqViFo9B6jgxU5emmA3rE8/hidden.json");
  }
