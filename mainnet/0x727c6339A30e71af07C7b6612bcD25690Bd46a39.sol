...
contract TinyTalkinu  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tiny Talk inu";
    ...
    address payable private _developmentAddress = payable(0x2cF2528Ff3DadF7757fe24EEe3d3DccdDc0Da4ac); 
    address payable private _marketingAddress = payable(0x2cF2528Ff3DadF7757fe24EEe3d3DccdDc0Da4ac);
