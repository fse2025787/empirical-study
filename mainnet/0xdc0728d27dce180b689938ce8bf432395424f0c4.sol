...
// File: contracts/DSB_Staking.sol

pragma solidity >= 0.8.0 < 0.9.0;

contract DSB_Staking is Ownable, IERC721Receiver, ReentrancyGuard {
  ...
  // reference to the DegenSpaceBombs NFT contracts & ERC20 token
  ERC721A nft;
  TokenRewards token;
