...
contract EZU is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxperAddressPublicMint = 15000;
    ...
    function TeamMint(uint256[] calldata quantity, address[] calldata recipient)
        external
        onlyOwner
    {
        require(
