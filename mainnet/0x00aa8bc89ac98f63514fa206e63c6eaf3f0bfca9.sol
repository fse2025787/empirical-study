...
contract Specter is ERC2981, ERC721A, Ownable {
    using Strings for uint256;

    uint32 public constant MAX_SUPPLY = 888;

    uint32 public FREE_SUPPLY = 444;

    uint32 public _freeMintTotal;

    uint32 public _MintPerWallet = 10;
    uint32 public _freeLimitPerWallet = 1;
    bool public _publicMintActive = true;
    bool public _freeMintActive = true;
    uint256 public _price = 0.001 ether;

    string public _prerevealURI = "ipfs://QmX36KvRzgVBkqKQY5M6Z6eEQTYTYLHUay8kkAYvPLo6jf";
    string public _matadataURI;

    constructor() ERC721A("specter", "SR") {
    ...
    modifier publicCompliance(uint32 amount) {
        ...
        require(
            ...
            _numberMinted(msg.sender) + amount <= _MintPerWallet,
    ...
    function set_free_supply(uint32 FREE_SUPPLY_NUM) external onlyOwner {
        FREE_SUPPLY = FREE_SUPPLY_NUM;
    }
