...
Everything turns in circles and spirals with the cosmic heart until infinity. Everything has a vibration that spirals inward or outward and everything turns together in the same direction at the same time
...
contract LifeCycle is ERC20, Auth {
    ...
    string public constant name = "LifeCycle";
    string public constant symbol = "LifeCycle";
    uint8 public constant decimals = 4;

    uint256 public totalSupply = 1 * 10**12 * 10**decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x50495bbFe6a5b2E919FeDd9454DEF0BCc48C73ce;
        buybackFeeReceiver = 0x50495bbFe6a5b2E919FeDd9454DEF0BCc48C73ce;
        teamFeeReceiver = 0x50495bbFe6a5b2E919FeDd9454DEF0BCc48C73ce;
