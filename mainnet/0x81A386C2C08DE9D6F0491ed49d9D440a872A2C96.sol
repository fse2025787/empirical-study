...
Tax will be reduced before renounce. 
*/
...
contract ReturnOfInvestment is Context, IERC20, Ownable {
    ...
    string private constant _name = "ReturnOfInvestment";
