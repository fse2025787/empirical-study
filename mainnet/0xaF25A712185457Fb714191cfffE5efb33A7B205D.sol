...
contract halloween is Context, IERC20, Ownable {
    ...
    string private constant _name = "halloween";
    string private constant _symbol = "halloween inu";
