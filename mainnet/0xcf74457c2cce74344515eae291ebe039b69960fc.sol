...
contract CoolShibaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cool Shiba Inu", "CSHIB") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x9438036e097D962A0d6feF5E15c606ABa21C8ce9); // marketing wallet
        devWallet = address(0x9438036e097D962A0d6feF5E15c606ABa21C8ce9); // dev wallet
