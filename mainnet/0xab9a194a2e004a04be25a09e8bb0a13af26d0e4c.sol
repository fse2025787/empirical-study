...
contract MetaMind is Context, IERC20 {
    ...
    string private _name = "Meta Mind";
    string private _symbol = "MIND";

    uint256 public _buyFee = 1200;
    uint256 public _sellFee = 10000;
    ...
    address payable private _marketingWallet = payable(0xAA541bAB0a09152143EB939693F9E12bd495eb6d);
    address payable private _teamWallet = payable(0xAA541bAB0a09152143EB939693F9E12bd495eb6d);
