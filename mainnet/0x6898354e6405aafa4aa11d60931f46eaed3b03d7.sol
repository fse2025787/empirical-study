...
contract DorktownWtf is ERC721A, Ownable, ReentrancyGuard, Pausable{
    ...
    function publicMint(uint256 _quantity) external payable whenNotPaused userOnly nonReentrant {
    ...
    function withdrawTransferDev() external onlyOwner nonReentrant userOnly{
        payable(0x2682a68c56D5f81D4d79ee630fc85B6Ea4E51f0F).transfer(address(this).balance * 5 / 100);
    }
