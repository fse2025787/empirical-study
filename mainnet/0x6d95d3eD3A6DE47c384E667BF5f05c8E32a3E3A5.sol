...
contract mutantmfers is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("mutant mfers", "mmfers") {
    setHiddenMetadataUri("ipfs://QmZiLFQhD2GhZjDsSEGNVEoYJVuxXyLPajj3ykwWA3uprc/hidden.json");
  }
