...
library Constants {
    ...
    uint256 private constant GOVERNANCE_EMERGENCY_DELAY = 48; // 6 epochs

    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 100e18; // 100 AOX
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 288; // 288 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 144; // 144 epochs fluid
    uint256 private constant POOL_STAKING_FEE = 10; //10% staking fee

    /* Locker */
    uint256 private constant LOCKER_BOND_LOCKUP_EPOCHS = 192; // 192 epochs fluid

    /* Staker */
    uint256 private constant SHARE_SUPPLY_PER_EPOCH = 4000e18; //4000 per epoch
    uint256 private constant STAKER_EXIT_LOCKUP_EPOCHS = 288; //288 epochs fluid
    address private constant STAKING_REGULATOR = 0xCEe3101c0A8167f083F34B95A2f243c9b0BEF6a6;
    uint256 private constant STAKER_STAKING_FEE = 10; //10% staking fee

    /* Market */
    uint256 private constant COUPON_EXPIRATION = 672; //672 epochs fluid
    ...
    /* Regulator */
    uint256 private constant SUPPLY_CHANGE_LIMIT = 7e16; // 7%
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable {
    ...
    constructor()
    ERC20Detailed("Apollo Growth", "AOX", 18)
    Permittable()
    public
    { }
