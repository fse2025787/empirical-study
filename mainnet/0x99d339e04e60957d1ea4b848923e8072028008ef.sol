...
THE DOGE MASK has now officially launched on the Ethereum cryptocurrency, we will launch to the safe moon

Twitter: https://twitter.com/THEDOGEMASK_ERC
JOIN TG: https://t.me/THEDOGEMASK_ERC
...
contract THEDOGEMASK is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"THE DOGE MASK";
