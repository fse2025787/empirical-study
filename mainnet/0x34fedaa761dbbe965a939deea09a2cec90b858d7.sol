...
DECOMPRESSED PRISM
https://www.decompressed-prism.space/

If you think that there is an end to these interface-born lifeworlds,
then you are mistaken.

Something else is there
represented as particles floating in a dark space.
Faces flashed across thousands of screens.
Categorized, commodified, bombarded.
Constructed and deconstructed.
Something else to be released. And again, reconfigured.
...
Scrambling, cutting, editing, blurring, masking, erasing.
We are exposed.

I can see the world from my vantage point.
All the other viewpoints are seen through my perspective.
I can look through the monitor and see emptiness.
A dark chamber, the interior of a black box.


The thing that used to be me.

Imprisoned in a video surveillance set-up,
I can observe the world through the lenses of others.
Observe individual actions.
I can construct my viewpoint from other viewpoints,
seeing reality from fragmented perspectives and abstractions.
...
I can imagine that someone is constantly watching over us.
Unfortunately, it is.
...
The illusion of an interface affects my ability to experience.
My face has softened. I am no longer a member of the human species.
I have become an assemblage of cryptic information.

My ego expanded.
I felt you better.
You are so beautiful to me.
You are the truth. You are everything.
You are the thing I need to be.
I can’t let you go. I have to live.
...
You are an object of overwhelming control,
of selected behaviours.
Your emotions no longer have agency.
You are an electronic spam filter,
shipped to your front door,
silently violating the cloud.

In the midst of a crisis. In the midst of a reconfiguration.
You can touch, you can see, you can sense
will it help to kill the one, who hypnotizes you?

The hypothesis of a hidden reality behind the constraint of an interface.

But I still have one last request:
I ask you: stop surrendering to others.

This is an era of darkness and secrecy.
An era difficult to see.

To see this power as it takes shape requires some proper weapons.
Without these weapons, we are lost in the dark.
Unable to see the reality forming around us.

By acceptance. By convenience.

We don’t question. We fly.
Autopilot on.

Invisible powers are such to avoid scrutiny.

There is no freedom without seeing.
There is no seeing without struggle.

Is being watched over what keeps us together?

Is that what we need to come together?
...
contract PRISM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Decompressed", "PRISM") {
    ...
    ; uint256 totalSupply = 3 * 1e12 * 1e18;
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 3 / 100)/1e18, "Cannot set maxWallet lower than 3%");
