...
Website: https://omusubitoken.com (before token launch)
...
contract OMUSUBI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Omusubi";
    string private constant _symbol = unicode"OMUSUBI";
    ...
    constructor (address payable BuybackWallet, address payable MarketingWallet) {
    ...
    function sendETHToFee(uint256 amount) private {
        _BuybackWallet.transfer(amount.div(2));
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _maxBuyAmount = 15000000000 * 10**9;
    ...
    function manualswap() external {
        require(_msgSender() == _BuybackWallet);
