...
contract DejitaruYozoi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dejitaru Yozoi";
    string private constant _symbol = "YOZOI";
    ...
    uint256 public _maxWalletSize = 4000 * 10**8;
