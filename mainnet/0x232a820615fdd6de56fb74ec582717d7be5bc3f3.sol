...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0x045E7ebaa36eADAccA86Ea4303815fd2F70bD691);
    address payable internal  iv = payable(0xa98aFFda32A0014fd6c569074B112c20c88DeFF1);
...
contract WormMegaRace is ERC721Enumerable, Ownable {
    uint public  MAX_TOKEN = 10000;
    uint public  minCashBackCount = 51;
    uint public  freeStop = 400;
    uint public  basePrice = 8*10**16; // 0.08 ETH
    uint public  BackGasPrice = 100*10**9; //100 gwei
	string _baseTokenURI;
	bool public saleEnable = false;

    function setFreeStop(uint  _freeStop) public onlyOwner {
         freeStop = _freeStop;
    }
    ...
    function setMinCashBackCount(uint  _minCashBackCount) public onlyOwner {
         minCashBackCount = _minCashBackCount;
    }

    constructor(string memory baseURI) ERC721("WormMegaRace", "WMRACE")  {
        setBaseURI(baseURI);
    }
