...
contract BridgeFee is Ownable, IBridgeFee {
    ...
    function transfer() external payable {
        ...
        address router = IBridgeFeeOracle(oracleAddress).getRouterAddress();

        (bool bridgeAmountSent, ) = payable(router).call{value: bridgeAmount}("");
        ...
        emit BridgeDone(_msgSender(), router, address(0), bridgeAmount, feeAmount);
    }
