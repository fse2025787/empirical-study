...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xa61d054B9236D15063C4Bf1145D61d4A940e9b22];
  address public erc20Payable = 0xa61d054B9236D15063C4Bf1145D61d4A940e9b22;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 162) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/yk39FRlDv6OP1ob4EKh1/contract-metadata";
  }
...
// File: contracts/DjagoonContract.sol
//

pragma solidity ^0.8.0;

contract DjagoonContract is RamppERC721A {
    constructor() RamppERC721A("DJAGOON", "DJAGOON"){}
}
