...
/*
WeChat - https://web.wechat.com/NebulakoETH
微博 - https://weibo.com/Nebulako

購入税: 0%
消費税：2%
総供給量: 1,000,000,000

※ETHERSCAN.io経由でご連絡いたします。
※Webサイトは65K MCで構築します。

これらのテレグラムは、ローンチ後すぐに取り消されることはありません
アクセスを待っています。
コミュニティおよびマーケティングパートナーから事前に

イーサリアムの次のユーティリティ トークンである Nebulako へようこそ
これは、有望な計画でイーサリアムネットワークを爆破し、促進します
イーサリアム空間への入り口。私たちは単なる普通のトークンやミームトークンではありません。
また、独自に設計された交換プラットフォームを代表しています
エコシステム。将来の杭打ち、私たち自身の市場でのNFTコレクション、
今後、さらに多くのことが発表される予定です。
*/
// 
...
contract Nebulako is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Nebulako";
    string private constant _symbol = unicode"NBK";
    ...
    address internal constant development_receiver = 0x2Bd73632A504a96546ffb9b330802b5470aeFD3F; 
    address internal constant marketing_receiver = 0x2Bd73632A504a96546ffb9b330802b5470aeFD3F;
    address internal constant liquidity_receiver = 0x2Bd73632A504a96546ffb9b330802b5470aeFD3F;
