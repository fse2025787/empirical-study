...
/*
White Sora Inu - Sora Inu

https://t.me/whitesorainu
...
White Sora Inu is a community-focused, decentralized cryptocurrency with instant rewards for holders. 🐶

With a dynamic sell limit based on price impact and increasing sell cooldowns and redistribution taxes on consecutive sells, White Sora Inu
...
No ones will be better than $SORAINU

👻 Max TX Amount 10,000,000,000
🕓 60 Seconds Cooldown for fir 5 minutes
...
contract SoraInu is Context, IERC20, Ownable {
    ...
    string private _name = 'White Sora Inu';
    string private _symbol = 'Sora Inu';
