...
contract MomocoNFT is ERC721A, Ownable, INFT {
    ...
    ////////////////////////////////////////////
    uint256 public constant INVENTORY = 10000;

    uint256 private W_PRICE = 0.1 ether;
    uint256 private N_PRICE = 0.125 ether;
    ...
    uint256 private _private_sell_start = 1649598600;
    ...
    string private _blindbox_uri = "https://ipfs.momoconft.com/momoco/token/";
  
    address private SIGNER = 0xe0c6fbEeC7Ce01a1614C81e04ddd7e909A88419d;
    ...
    /// NFT Related
    ////////////////////////////////////////////////////////////////////////
    constructor() ERC721A("Momoco NFT", "MMC") {
    }
    ...
    function querySellType() external view returns (uint256) {
    ...
    function verify(address user, bytes memory _signatures) public view returns (bool) {
