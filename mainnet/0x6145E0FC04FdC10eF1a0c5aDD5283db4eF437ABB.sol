...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4cD1102b8d103FFD82fF878495Fe7f3623D42730];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbtpBNe4R9n1HpQKPvs6iYgnb7AscR9T96TNz3Xg4uNe2/";
...
// File: contracts/BoredassgobIinsContract.sol
//

pragma solidity ^0.8.0;

contract BoredassgobIinsContract is RamppERC721A {
    constructor() RamppERC721A("boredassgobIins", "BAG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/dhCtUKNocmRTe4yPZj4j/contract-metadata";
    }
}
