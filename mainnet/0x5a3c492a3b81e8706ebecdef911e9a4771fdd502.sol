...
contract EndAsCoin is Ownable, ERC721A {
    ...
    // metadata URI
    string private _baseTokenURI = "ipfs://QmXUA1VuMwRMUkDXystpZTePN1FAb1SYYzcHAcJYwgySyn/";

    constructor(
        uint256 maxBatchSize_,
        uint256 collectionSize_,
        uint256 amountForDevs_
    ) ERC721A("EndAsCoin", "EAC") {
        require(
    ...
    function contractURI() public pure returns (string memory) {
      return "ipfs://QmNxmQHzVetmkGhFKCibsAcFcMMAqitnZEsbKXrsMLverq/";
    }
