...
pragma solidity ^0.8.0;
contract TheHabibis is Ownable, ERC721A, ReentrancyGuard {

    uint256 public maxPerTx = 10;
    uint256 public maxToken = 6666;
    uint256 public price = 0.003 ether;
    string private _baseTokenURI = "ipfs://bafybeiderdrbdwj7hcyjgva654hy254iurwnrwcjsnfvkpssl4fo6bg2my/";
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        require(numberMinted(msg.sender) + quantity <= maxPerTx, "PER_WALLET_LIMIT_REACHED");
