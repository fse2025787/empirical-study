...
contract ARCH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "ARCHIVES";
    ...
    address payable private _developmentAddress = payable(0xD91a32c0BC6A2f7Ce77DAc9B22aa6eDc9645BEa8);
    address payable private _marketingAddress = payable(0xD91a32c0BC6A2f7Ce77DAc9B22aa6eDc9645BEa8);
