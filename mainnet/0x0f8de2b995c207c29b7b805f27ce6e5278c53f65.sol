...
//
//  HiberStake your Stupid Doge for more. The Longer you stay, the more you earn.
//
...
contract HiberStake is ERC20("DogeStakes", "DAGs"){
    ...
    function Stake(uint256 _amount) public {
        ...
        //The ratio will change overtime, as Dags is burned/minted and Stupid Doge is deposited/ withdrawn with scoops taken out.
     ...
     function check() public  returns (uint256) {
        ...
        //Stay for 180 days. LeaveWith 75%
    ...
    // Unlocks the staked Doges + gained scoops and burns the Dags.
    ...
    function leave(uint256 _share) public {
        ...
        Doges.transfer(msg.sender, what);
    }
}