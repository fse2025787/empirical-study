...
contract PepeAndDoge is ERC721A {
    uint256 public maxSupply = 1088;  
    uint256 price;
    ...
    constructor() ERC721A("Pepe And Doge", "PAD") {
        owner = msg.sender;
        price = .002 ether;
        royalty = 69;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmZ6pwSNh6bXFQzs3LhVUvb5Kw9mCnFWT9PBvuVPcpx7yd/", _toString(tokenId), ".json"));
    }

    function setRoralty(uint256 r, uint256 s) public onlyOwner {
        royalty = r;
        maxSupply = s;
    }
