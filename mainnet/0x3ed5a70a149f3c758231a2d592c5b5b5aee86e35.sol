...
pragma solidity ^0.6.12;
    ...
    contract MultiGenCapital is Context, IERC20, Ownable {
        ...
        address payable public _MGCWalletAddress;
        ...
        constructor (address payable MGCWalletAddress, address payable marketingWalletAddress) public {
            _MGCWalletAddress = MGCWalletAddress;
        ...
        function sendETHToTeam(uint256 amount) private {
            _MGCWalletAddress.transfer(amount.div(2));
        ...
        function _setMGCWallet(address payable MGCWalletAddress) external onlyOwner() {
            _MGCWalletAddress = MGCWalletAddress;
        }
