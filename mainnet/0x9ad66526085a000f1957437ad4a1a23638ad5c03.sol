...
/*
  $EPIC PILL ETHEREUM
  * https://t.me/EpicPillETH
  * https://www.epicpill.xyz/
*/
...
contract EPILL is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x1Fe0c7Db1AF36B56e6D29AE1dfE05b3E5F3d7A12));

    string private _name = "Epic Pill";
    string private _symbol = "EPILL";
