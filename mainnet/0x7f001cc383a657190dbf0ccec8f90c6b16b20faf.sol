...
contract MousInDaParty is ERC721A, Ownable {
    uint256 MAX_MINTS = 10;
    uint256 maxSupply = 500;
    uint256 public mintRate = 0 ether;
    string public baseExtension = ".json";
    string public baseURI = "ipfs://Qma9mrP1j8eXKPiofrE1XEdqR1suR78pBE2g5mkLRuyZQb/";

    constructor(string memory _name, string memory _symbol) ERC721A("MOUS IN DA PARTY", "MOUS") {}
