...
contract HappyInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x73C9b5155C6CEffC5A3ce8129C8EBe7f2A76b939);
        _feeAddrWallet2 = payable(0x73C9b5155C6CEffC5A3ce8129C8EBe7f2A76b939);
