...
contract puncatus is IERC721A { 
    ...
    string private constant _name = "puncatus";
    string private constant _symbol = "PUNCATUS";
    string private _contractURI = "QmeMkqrSAMYVEjWcRH8HGdvyYNUA5buQKpdYSY1SGhMWad";
    string private _baseURI = "QmQ6mUoXB5XCGQoUQWi9WoTJ9ubntEyLt5CUw72hm66AZC";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount + _numberMinted(_caller) <= MAX_PER_WALLET, "Max Limit");
    ...
    function freeMint() external{
        ...
        require(totalSupply() + amount <= MAX_SUPPLY, "Freemint SoldOut");
