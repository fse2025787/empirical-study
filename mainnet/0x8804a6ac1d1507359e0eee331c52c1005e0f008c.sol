...
contract RoganTama  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Rogan Tama";                                          
    string private _symbol = "$RGNTAMA";                                           
    ...
    address payable public marketingWallet = payable(0x154c9E3A22bF98b99Eb858D690189D798144996a);
