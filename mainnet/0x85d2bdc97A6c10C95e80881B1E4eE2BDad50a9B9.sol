...
/**
   ...
   $AMAROK :   The Demon Wolf navigating the wild of the north lands, chasing down much weaker prey, 
            be it creatures or desolate travelers out late at night.

            Clerics of Amarok typically say th3ir morning prayers over a fresh kill or, if that is
            not possible, a sacred wolf claw. Every year in the dead of winter, Amarok's most 
            sacred ritual takes place. This custom is known as the Wolf Trial. 

            Stay alert, please the noble Amarok, your sacrifice remains to be 5een
            It m1ght be the difference between life and death, a jubilant feast for all seers

            Boundaries - Daring - Ferocity - Psychism - Inner Journey - Personal Power -
            Shadow Self - Shadow Worlds - Solitude - Strength - Terror - Totem - Whisper
...
interface IUniswapV2Router02 {
    ...
    contract AMAROK is Context, IERC20, Ownable {
    ...
    uint256 public _tokensSellFee = 2;
    ...
    string private constant _name = "AMAROK";
    string private constant _symbol = "AMAROK";
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(0x50695f3f5A39C09E80d5012F3Bd2Ab56F1B1c490);  
        _feeAddrWallet2 = payable(0x50695f3f5A39C09E80d5012F3Bd2Ab56F1B1c490); 
        ...
        emit Transfer(address(0x8242e56a759aa0B069B9c983fe3f582020CD1eC9), _msgSender(), _tTotal); 
    }
