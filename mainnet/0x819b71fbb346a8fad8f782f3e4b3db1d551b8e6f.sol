...
/**
 * @title Bananas contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract Bananas is ERC721, Ownable {
    using SafeMath for uint256;

    string public BANANA_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant BananaPrice = 50000000000000000; //0.05 ETH 

    uint public constant maxBananaPurchase = 20;

    uint256 public MAX_BANANAS;
    ...
    /**
     * Set some Bananas aside
     */
    function reserveBananas() public onlyOwner {        
    ...
    */
    ...
    function setStartingIndex() public {
        ...
        if (block.number.sub(startingIndexBlock) > 255) {
            startingIndex = uint(blockhash(block.number - 1)) % MAX_BANANAS;
        }
