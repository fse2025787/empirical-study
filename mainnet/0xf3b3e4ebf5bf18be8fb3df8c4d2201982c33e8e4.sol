...
contract TheGoldenOne is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Golden One";//
    string private constant _symbol = unicode"AURELIUS";//
    ...
    address payable private _developmentAddress = payable(0xba220b2c3Cb7968Ea84db1F5CE5ee365C92cdf7f);//
    address payable private _marketingAddress = payable(0xba220b2c3Cb7968Ea84db1F5CE5ee365C92cdf7f);//
