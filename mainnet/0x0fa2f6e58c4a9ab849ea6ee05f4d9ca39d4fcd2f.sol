...
/*
The gates to valhalla will open for those who seek glory. 
Odin's own canine, Valhalla Inu, will stride to pave the way for us.
*/
// 
...
contract $VINU is ERC20, Ownable  {
    ...
    address public deployer = 0xAf366827924C6b715BD1ed18E2F5C17368A0B878;
    ...
    constructor() ERC20("Valhalla Inu", "$VINU") {
        ...
        marketingWallet = address(deployer); // set as marketing wallet
        devWallet = address(deployer); // set as dev wallet
        lpReceiver = address(deployer); // set as lp receiver
    ...
    // disable trading to shake off bots
