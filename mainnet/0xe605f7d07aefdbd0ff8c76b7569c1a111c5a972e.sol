...
contract BlackAvatar is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Avatar";
    string private constant _symbol = "BLAVA";
