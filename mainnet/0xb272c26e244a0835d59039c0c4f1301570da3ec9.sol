...
With that being said, we decided to gift him the least we could do.
In one of his tweets he mentioned that his favourite cheese is Stilton🧀.
Our mission is to bring world's finest cheesecake to his housedoor.

Tax: Buy 5% - Sell 5%

Telegram: https://t.me/classicstilton
Twitter: https://twitter.com/StiltonClassic
...
contract ClassicStilton is Context, IERC20, Ownable {
    ...
    string private constant _name = "Classic Stilton";
    string private constant _symbol = "CILTON";
    ...
    constructor () {
        _feeAddrWallet = payable(0x62C52FB139dFBB01274B59732926963aEF6b6637);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = 300_000_000 * 10**9;
        _maxWalletSize = 300_000_000 * 10**9;
        tradingOpen = true;
