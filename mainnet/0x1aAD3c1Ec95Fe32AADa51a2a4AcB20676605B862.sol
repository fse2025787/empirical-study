...
abstract contract AdminSignature {
    function verifyAdminSignature(bytes32 hash, bytes memory signature) internal view virtual returns(bool);
}
...
abstract contract AdminOwnable is Context, Ownable, AdminSignature {
    ...
    function verifyAdminSignature(bytes32 hash, bytes memory signature) internal view override returns(bool) {
