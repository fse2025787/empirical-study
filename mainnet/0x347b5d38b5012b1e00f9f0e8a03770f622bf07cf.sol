...
contract Trojena is Context, IERC20, Ownable {
    ...
    uint256 private dBlocks = 2; //bDelay + 1
    ...
    string private constant _name = "Trojena";
    string private constant _symbol = "NEOM";
