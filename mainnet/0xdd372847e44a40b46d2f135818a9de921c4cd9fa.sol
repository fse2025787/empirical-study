...
contract goldcoin is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "BoomBaby.io Token";
    string private constant _symbol = "BoomBaby";
    ...
    uint256 private constant _tTotal = 60000000000 * 10**9;
