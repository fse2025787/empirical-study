...
contract JustinAversano is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 123;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Justin Aversano - 14 Days of Istanbul", "JAIST", MAX_MINTS, MAX_SUPPLY) {  
    }
