...
/**
    ...
    Telegram: https://t.me/SpookyFlokiERC
...
contract SpookyFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x845b50d778721bE6841C5f6306975600D56458Bf); // Marketing Address
    address payable public multiSigAddress = payable(0x845b50d778721bE6841C5f6306975600D56458Bf); // Marketing Address
    address payable public devAddress = payable(0x845b50d778721bE6841C5f6306975600D56458Bf); // Dev Address
    address payable public liquidityAddress = payable(0x845b50d778721bE6841C5f6306975600D56458Bf); // Liquidity Address
    ...
    uint256 private constant _tTotal = 1 * 1e8 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = unicode"Spooky Floki";
    string private constant _symbol = unicode"SFLOKI";
