...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQ4HkXndVgCLHZomjSHdfuadLWCdwg6BCajiPnfPeoDo9/";
...
// File: contracts/CreatureLandbySatomiContract.sol
//

pragma solidity ^0.8.0;

contract CreatureLandbySatomiContract is RamppERC721A {
    constructor() RamppERC721A("Creature Land by Satomi", "CRTRLND"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9b4ui4U8mF9usdapMlBx/contract-metadata";
    }
}
