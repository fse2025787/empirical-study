...
contract PuppyInu is IBEP20, Auth {
	using SafeMath for uint256;
	...
	string private constant _name = "Puppy Inu";
	...
	address payable private holderReflection = payable(0x120bCb731454960a783D223e06938820092F709b);
	address payable private treasury = payable(0x120bCb731454960a783D223e06938820092F709b);
	...
	constructor() Auth(0x120bCb731454960a783D223e06938820092F709b) {
		address _owner = 0x120bCb731454960a783D223e06938820092F709b;
		...
		emit Transfer(address(0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08), _owner, _totalSupply);
	}
