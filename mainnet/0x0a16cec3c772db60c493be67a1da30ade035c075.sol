...
contract  REAPER  is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Grimreaper"; // 
    string private constant _symbol = "REAPER"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xe9da49F2eeC5d3e87A6b9A8797E685dB1C20153C;
