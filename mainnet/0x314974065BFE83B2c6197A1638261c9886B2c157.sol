...
contract DMCInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "DMCInu";                                           // name
    string private _symbol = "DMCI";                                            // symbol
    uint256 private _tTotal = 1000000 * 10**9 * 10**uint256(_decimals);
    ...
    uint256 public defaultMarketingFee = 8;
    uint256 public _marketingFee = defaultMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _marketingFee4Sellers = 20;

    bool public feesOnSellersAndBuyers = true;

    uint256 public _maxTxAmount = _tTotal.div(100).div(100);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0xBbDDB9Ca699AD3d55Af5e212075fe74388b6bA4a);
