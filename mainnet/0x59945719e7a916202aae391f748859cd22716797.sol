...
// File: contracts/TheSaudisRareApepeYC.sol
...
contract TheSaudisRareApepeYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2213;
  ...
  ) ERC721A("The Saudis Rare Apepe YC", "TSRAYC") {
