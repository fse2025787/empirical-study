...
/**
    Proof of TamaDoge ERC Token
    Telegram: https://t.me/POTDportal
*/
...
contract ProofOfTamaDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x8A20242308C81b0Bb5a9EFCb00579033Fd61a091); // Marketing Address
    address payable public multiSigAddress = payable(0x8A20242308C81b0Bb5a9EFCb00579033Fd61a091); // Marketing Address
    address payable public devAddress = payable(0x8A20242308C81b0Bb5a9EFCb00579033Fd61a091); // Dev Address
    address payable public liquidityAddress = payable(0x8A20242308C81b0Bb5a9EFCb00579033Fd61a091); // Liquidity Address
    ...
    string private constant _name = unicode"Proof Of TamaDoge";
