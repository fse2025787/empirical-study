...
contract FalconHeavy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Falcon Heavy";
    string private _symbol = "Falcon";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x86830a1b390b1Fae2494A34B6A96cbEbd4365a86);
    address payable private taxWallet2 = payable(0x86830a1b390b1Fae2494A34B6A96cbEbd4365a86);
