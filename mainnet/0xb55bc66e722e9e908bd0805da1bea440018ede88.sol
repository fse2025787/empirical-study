...
/*
Kodama is a tree-dwelling spirit in Japanese folklore and Princess Mononoke that is cursed if anyone tries to chop it down.
and the knowledge of the trees that inhabit the wood spirits is passed down and protected by the elders of the region.

TG:https://t.me/KODAMA_ETH
...
contract KodamaInu is Context, IERC20, Ownable { 
    ...
    string private constant _symbol = "KODAMA";
