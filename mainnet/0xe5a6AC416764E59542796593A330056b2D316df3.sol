...
contract PornTV is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Porn TV";
    string private constant _symbol = "PORNTV";
    ...
    address payable private _developmentAddress = payable(0xb51A84351EFCB593a8e6768412a8C3a9B72bDCca);
    address payable private _marketingAddress = payable(0x8b2308b25b2C09699C7108bBAe9301E92a0216F3);
