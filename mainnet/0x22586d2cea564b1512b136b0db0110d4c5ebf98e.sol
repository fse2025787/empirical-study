...
contract KingKoopa is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Koopa";
    string private constant _symbol = "King Koopa";
    uint256 public _maxTxAmount = 1000 * 10**_decimals;
    uint256 public _maxWalletSize = 1000 * 10**_decimals;
    uint256 public _taxSwap=800 * 10**_decimals;
    ...
    function removeLimits() external onlyOwner{
        _maxTxAmount = 2800 * 10**_decimals;
        _maxWalletSize = 2800 * 10**_decimals;
        emit MaxTxAmountUpdated(2800 * 10**_decimals);
    }
