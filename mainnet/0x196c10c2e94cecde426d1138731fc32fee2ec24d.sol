...
contract DoomsdayXPlatinum is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmYsiuKeJxMbGb74FuEEKRCZXKGUb7HU4MBLhr3Y6szB21/";
  ...
  uint256 public mintPerAddress = 1;

  bool public paused = true;

  mapping(address => uint256) public minted;

  constructor() ERC721("DOOMSDAYX Gen 01: Haleek Maul Platinum NFT", "DOOMSDAYX_02") {
      _mintLoop(0x87858dc56634796488f2e4f2D7135Cc6132777E7, 10);
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    // Can be used by contract owner to mint freely (max of 1 per tx)
