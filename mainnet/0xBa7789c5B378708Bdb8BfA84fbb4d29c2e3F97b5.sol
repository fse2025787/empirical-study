 ...
 * @dev Allow a charity organization give nfts to contributors
 * @author Racks Labs® team
 */
...
contract UkraineCharity is Abstract1155Factory {
	...
	uint256[4] public nftsMaxSupply	= [1, 333, 333, 333];
...
//========================================================PUBLIC===========================================================
	...
	*/
	function donate() public payable notPaused {
		...
		uint256 tier = 0;
		if (amountDonated >= tierCost[2])
			tier = 3;
		else if (amountDonated >= tierCost[1])
			tier = 2;
		else {
			require(amountDonated >= tierCost[0], "Amount donated must be higher");
			tier = 1;
		}
		mint(tier);
	}
	...
	*/
	function giveAway(uint256 nftTier, address receiver) public onlyOwner {
		require(totalSupply(nftTier) + 1 <= nftsMaxSupply[nftTier], "Max supply has been reached");
...
//========================================================EXTERNAL=========================================================
	...
	*/
	function batchSetTierCosts(uint256[3] memory _newCosts)
		external
		onlyOwner
	{
...
//========================================================PRIVATE==========================================================
	...
	*/
	function mint(uint256 _tier) private {
		...
		require(totalSupply(_tier) + 1 <= nftsMaxSupply[_tier], "Max supply has been reached");
