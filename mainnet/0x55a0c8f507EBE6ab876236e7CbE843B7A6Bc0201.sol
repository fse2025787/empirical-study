...
contract AN0THERWRLD is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVV4V8nBXh7uFY21AJrmw58yWXzT8ELhPQRnAxCPnWp4";
    ...
    uint256 public NUM_FREE_MINTS = 377;
    ...
    constructor(
    ) ERC721A("AN0THERWRLD", "00WRLD00", 100, maxSupply) {
    }
