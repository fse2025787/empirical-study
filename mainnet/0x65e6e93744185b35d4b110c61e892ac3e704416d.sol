...
contract FlippedFrank is ERC721A, Ownable {

    string public baseURI = "";
    bool public paused;

    uint256 constant public MAX_MINT = 3333;
    uint256 constant public MAX_MINT_PER_TX = 20;
    uint256 public cost = 0.01 ether;

    constructor() ERC721A("Flipped Frank", "FLIPPEDFRANK") {}

    function mintflippedFrank(uint256 quantity) external payable {
