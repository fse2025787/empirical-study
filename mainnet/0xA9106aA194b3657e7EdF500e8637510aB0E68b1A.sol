...
Whitepaper: https://public.fairtokenproject.com/FTPWhitepaperV2.pdf
...
contract FTPDeployer is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FTPDeployer";
    string private m_Symbol = "FTPDEP";
