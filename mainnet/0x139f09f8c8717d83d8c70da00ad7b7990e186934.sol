...
contract MergingMoodles is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public PUBLIC_PRICE = .003 * 10**18;
    uint256 public constant MAX_SUPPLY = 2222;
    uint256 public constant FREE_MINT_SUPPLY = 555;
    uint256 public INSTANT_FREE_MINTED = 1;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Merging Moodles", "MRGMDL") {
        baseURI = initBaseURI;
