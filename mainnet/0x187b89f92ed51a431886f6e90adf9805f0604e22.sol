...
/**TG https://t.me/EagleEyeERC
WEBSITE https://erceagleeye.com/
TWITTER https://twitter.com/eagleeyeerc?s=21&t=BRmCgRTB_-wSDiHrD3O1kw
 *
*/
...
contract EAGLEEYE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="EAGLE EYE";
    string private _symbol = "tehEYE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xe3603aee71fA15d4E38e1487801804BBeDB0D76c);
    address payable private taxWallet2 = payable(0x7664BB65a5BC389D1BBcFB9BF6Eb5A14320119dA);
