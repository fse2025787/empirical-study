...
contract Bee is ERC721A, SimpleAccess {
     ...
     */
    uint256 public powerCycleBasePeriod = 1 days * 7; 
    uint256 public powerCycleMaxPeriods = 20; 

    struct BeeSpec {
        uint88 lastInteraction; 
        uint88 powerCycleStart; 
        uint80 powerCycleStored; 
    }
    struct UserBeeSpec {
        uint256 beeId;
    ...
    function stake(
        ...
        if (bee.powerCycleStart == 0) {
            ...
            bee.powerCycleStart = uint40(block.timestamp - bee.powerCycleStored); 
        }
        ...
        onlyAuthorized
    {
        ...
        bee.powerCycleStored = uint40(block.timestamp - bee.powerCycleStart); 
