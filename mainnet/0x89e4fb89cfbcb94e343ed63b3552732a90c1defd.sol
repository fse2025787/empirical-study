...
contract DegenAlpha is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmP8ugwz5oFjX3EVNM31MwK85nBoVPxoWpDb46RmAk8GkJ";
    ...
    uint256 public MAX_SUPPLY = 555;
      uint256 public constant Whitelisted_Mint_Amount = 1;

    uint256 public constant price = 0.005 ether;
    uint256 public Whitelisted_Amount = 100;
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("DegenAlpha", "DA", 100, MAX_SUPPLY) {
    }
    ...
    function mint(uint256 _amount) external payable {
      ...
      if(Whitelisted_Amount >= totalSupply()){
            require(Whitelisted_Mint_Amount  >= _amount , "Excess max per free tx");
        }else{
            require(maxpertx >= _amount , "Excess max per paid tx");
    ...
    function NumFree(uint256 _numfreemints)
        ...
        onlyOwner
    {
        Whitelisted_Amount = _numfreemints;
    }
