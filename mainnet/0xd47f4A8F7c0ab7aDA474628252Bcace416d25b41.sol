 ...
 */
contract CrowdpubFoundersNFT is Context, ERC165, IERC721, IERC721Metadata, Ownable, DefaultOperatorFilterer {
    ...
    string private _base_uri = "https://nfthooks.xyz/api/crowdpub/";

    uint public immutable maxSupply = 256;
    ...
    function approve(address to, uint256 tokenId) public override onlyAllowedOperatorApproval(to) {
        address owner = CrowdpubFoundersNFT.ownerOf(tokenId);
    ...
    function purchaseMint(uint amount) payable public {
      ...
      require(amount > 0, "purchase at least one");
       require(amount < 101, "purchase max 100 tokens");
