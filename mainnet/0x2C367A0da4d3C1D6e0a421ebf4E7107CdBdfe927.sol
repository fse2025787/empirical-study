...
contract NFT is
    ...
    function _y(
        ...
        return uint48(uint256(keccak256(
    ...
    function _q(
        ...
        return uint48(uint256(keccak256(
            abi.encodePacked(block.timestamp * 33)
        ))
    );}
    ...
    function _loop(
        ...
        _tokenMeta[_currentIdCount] =
            Meta(
                _mood(_currentIdCount),
                _grade(_currentIdCount),
                _to
            );
        emit Transfer(
            address(0),
    ...
    function _exists(
        ...
        return _tokenMeta[_tokenId].owner != address(0);
    }
    ...
    function ownerOf(
        ...
        return _tokenMeta[_tokenId].owner;
    }
    ...
    function approve(
        ...
        if (_tokenMeta[_tokenId].owner != msg.sender) {
            revert NonOwnerApproval();
        }
...
contract Supports is
    ...
    constructor(
        ...
        "ipfs://bafybeihmygiurvygn7oaruaz66njkvlicbfg7lnsc64ttxbc3o3x4fezfi"
    ) Master(msg.sender) {
        _genesis(
            msg.sender,
            1
    ...
    /**
     * @dev Returns `true` if relinquished
     */
