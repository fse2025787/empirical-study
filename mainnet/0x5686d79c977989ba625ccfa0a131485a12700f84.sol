...
contract AnimusEgg is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmeXjd8HPC4HbsawU8kMQFY4ZDwYFsfADipZDFsF1S5quz";
    ...
    constructor(
    ) ERC721A("Animus Egg - CLAIM", "RTFKT", 100, maxSupply) {
    }
