...
/**
Does today's ETH make you angry? Please stay angry, now the Anger Club is here.
https://t.me/AngryBoars_Token
*/
//
...
contract BOARS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Angry Boars";
    string private constant _symbol = "BOARS";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x6B41c34591f981B25e8e3a7674eCC62B218B4438);
        ...
        emit Transfer(address(0x5c15c01B6B4cd38be476b27Bf5d2F9f5a2AC44f6), _msgSender(), _tTotal);
    }
