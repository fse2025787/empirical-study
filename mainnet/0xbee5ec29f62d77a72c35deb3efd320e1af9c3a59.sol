...
contract iNode512 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("iNode512", "iNode512") {
        ...
        uint256 _earlySellMarketingFee = 19;
        uint256 _earlySellDevFee = 0;
       
 
        uint256 totalSupply = 1 * 1e12 * 1e18;
 
        maxTransactionAmount = totalSupply * 300 / 1000; 
        maxWallet = totalSupply * 300 / 1000;
        swapTokensAtAmount = totalSupply * 300 / 1000;
        ...
        marketingWallet = address(0x30AFE8bCE1163a7c5Cc8ccd92EcD7B13b0e1D869); // set as marketing wallet
        devWallet = address(0x30AFE8bCE1163a7c5Cc8ccd92EcD7B13b0e1D869); // set as dev wallet
