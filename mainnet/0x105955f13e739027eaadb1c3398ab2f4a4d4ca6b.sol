...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  dev = payable(0x5e714582eeBF6e897e1788511D8B2362A5Ba20EB);
    address payable internal  iv = payable(0x5e714582eeBF6e897e1788511D8B2362A5Ba20EB);
...
contract MobileSuit is ERC1155 {
    string public name;
    string public symbol;
    uint public  MAX_TOKEN = 3000;
    uint public  MAX_WL_TOKEN = 2000;
    uint public  basePrice = 80*10**15; // ETH
    uint public  basePriceWl = 10*10**19; // ETH
