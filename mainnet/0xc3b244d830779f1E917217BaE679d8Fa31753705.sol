...
// https://theartistfund.io/
// https://t.me/afundeth
// https://the-gift.gitbook.io/the-artist-fund/
...
contract AFUND is ERC20, Ownable {
    ...
    address payable _marketingWallet =
        payable(address(0x709B5f9D91F2da31bC409F3398560855897E9F2B)); // marketingWallet
    address payable _devWallet =
        payable(address(0x0fF78318BD8341B6f35D40211B1C0f0280e59e67)); // devWallet
    ...
    constructor() ERC20("The Artist Fund", "AFUND") {
