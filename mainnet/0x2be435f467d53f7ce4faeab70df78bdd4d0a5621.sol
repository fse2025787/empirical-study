...
contract TendiesToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Tendies", "TEND", 9) ERC20Permit() {
    ...
    /**
        @notice increases Tendies supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Tendies
