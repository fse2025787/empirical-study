...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6560577013acBF1745E5ECb56cd8797a1712d1c1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmXbH1B2MmwU1HWqTvNRTv96UXinmnew5v3Cg4LxcwCzZs/";
...
// File: contracts/ShemursContract.sol
//

pragma solidity ^0.8.0;

contract ShemursContract is RamppERC721A {
    constructor() RamppERC721A("Shemurs", "Shemurs"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YZGTXnXq1tncB5N5UgHZ/contract-metadata";
    }
}
