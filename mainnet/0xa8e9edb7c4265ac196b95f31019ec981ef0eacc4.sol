...
Decagon Defi (DECAFI)
    ...
    DecaFI is a decentralized finance in ERC-20 Network .
    Real Utilities in 8 ways of earning passive income.
    With deca ways of earning (farm,vaults,pool,staking ,launchpad,lending,borrowing,NFT).
...
contract DECAFI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Decagon Defi";
    string private constant _symbol = "DECAFI";
    ...
    function blockBot(address botaddress, bool status) public onlyOwner {
        bots[botaddress] = status;
    }
