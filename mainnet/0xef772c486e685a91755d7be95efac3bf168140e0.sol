...
Do, a Kwon, and bitch ass Kwon,
Re, a drop of golden sun,
Me, I lost, all my money,
Fa, a long way back to breakeven,
So, what do I do now?
La, Luna Luna sucks,
Ti (Tea), I really hate UST,
And that will bring us back to Do Do Do Do 


A memecoin for LUNA and UST holders to laugh at themselves
And hopefully recover some of your losses
...
contract DoReMe is ERC20, Auth {
    ...
    string constant private _name = "Do Re Me";
    string constant private _symbol = "DoReMe";
    ...
    uint256 private sellFeeMarketing = 7;
