...
contract FLIRD is IERC20, Auth {
    ...
    string private constant  _name = "Floki Bird";
    string private constant _symbol = "FLIRD";
    ...
    address payable public marketingWallet = payable(0x0d3B73A7125664DCa9966E8F973F4B0F3D02440f);
