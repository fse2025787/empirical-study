...
contract Boxe is Context, IERC20, Ownable {
    uint256 public immutable _buyTax =5;
    uint256 public immutable _sellTax = 3;
    string private _name = unicode"Jake Paul vs Anderson Silva";
    string private _symbol = unicode"Boxe";
