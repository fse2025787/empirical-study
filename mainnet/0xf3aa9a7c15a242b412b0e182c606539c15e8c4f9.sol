...
contract Morf is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Morf";
    string private constant _symbol = "MORF";
    ...
    address payable private _developmentAddress = payable(0xDE0ddc976675F787836aFB22577C1401EEE1aA8A); 
    address payable private _marketingAddress = payable(0x83d350FEF58c6106c760eEe6730fe912C0dD9a3e);
