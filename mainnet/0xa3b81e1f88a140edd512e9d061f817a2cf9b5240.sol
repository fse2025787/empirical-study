...
//From the depths of space, created in 2079 by Alien and baptized in the name of Umami, he rises against his creators and his ally Elon Musk.
//His goal is to unite all Memo Dog Coin holders in 2021 and stop the establishment before it is too late for the world in 2079. His success depends on you.
//You have the power to support him in his mission by holding, sharing, tweeting & following. Umami and his world are counting on you! How far will you go?
...
contract VEGUMAMI is Context, IERC20, Ownable {
    ...
    string private _name = 'VEGUMAMI';
    string private _symbol = 'UMAMI';
