...
contract NFTstats is  Ownable, ReentrancyGuard , ERC721A {
    using Strings for uint256;
    uint256 public maxSupply = 1000;
    string private BASE_URI = "http://nftmetadata.live/nftstats/";
    ...
    uint256 public wl_cost = 10000000000000000;   
   
    bytes32 public merkleRoot;

    constructor() ERC721A("NFT Stats Tools", "PASS") {}
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        (bool c1, ) = payable(0xE7a57E31659bdA6c1390069780eD44D867bdd34C).call{value: balance}('');
        require(c1);
    }
