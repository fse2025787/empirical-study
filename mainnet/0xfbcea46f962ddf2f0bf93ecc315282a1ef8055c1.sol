...
contract Test2 is ERC721A, Ownable, ReentrancyGuard, Pausable{
    ...
    function whitelistMint(uint256 _quantity, bytes32[] memory proof) external payable whenNotPaused nonReentrant {
        ...
        if (totalFreeMints[msg.sender] == 0 && freeMax <= 1000) {
            require(freeMax <= 1000, "No more free mints left!");
    ...
    function toggleReveal(string memory _URI) public onlyOwner nonReentrant {
        baseURI = _URI;
        revealed = !revealed;
    }
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        payable(0xc7c94dF9621898Bc3F621c69436897B8bf1aC467).transfer(address(this).balance * 10 / 100);
        payable(0x0837d97d5F619c11420F3035D22F55fF96b8171E).transfer(address(this).balance * 10 / 100);
