...
/*
-Heavenly Princess Ichikishima, Dispenser of Divine Wealth, Goddess of Wonderful Sounds-
Benzaiten also Benzaitennyo, a joyous goddess, dispenser of luck and wisdom.
One of the Seven Lucky Gods and rules over all that flows, including music, water, wealth, and time. 
 
As the light shines, the fire burns.
For every given and every taken.
The blessings diminish and shines more brightly on the ones given.





https://twitter.com/myoonten
https://heavenlyprincess.medium.com/
*/
...
contract Myoonten is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Heavenly Princess", "BENZAITENNYO") {
    ...
    function MoonTime() external onlyOwner {
        tradingActive = true;
    ...
    function MoonTime(uint256 Bblock) external onlyOwner {
        tradingActive = true;
