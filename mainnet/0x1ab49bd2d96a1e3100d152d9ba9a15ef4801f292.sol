...
/*
 _  __                   _ _   ____       _     
 | |/ /__ ___      ____ _(_|_) |  _ \ __ _| |___ 
 | ' // _` \ \ /\ / / _` | | | | |_) / _` | / __|
 | . \ (_| |\ V  V / (_| | | | |  __/ (_| | \__ \
 |_|\_\__,_| \_/\_/ \__,_|_|_| |_|   \__,_|_|___/                                           
*/
...
contract KawaiiPals is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYsosuTo1dvac1RDy75K6q5yJcnAzMAAfyGdBQtKC3Aeb";
    ...
    constructor(
    ) ERC721A("Kawaii Pals", "Kawaii", 100, maxSupply) {
    }
