...
// File: contracts/B0r3dy00tsp33p3.sol
...
contract B0r3dy00tsp33p3 is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3211;
  ...
  ) ERC721A("B0r3d y00ts p33p3", "B0Y00P33") {
