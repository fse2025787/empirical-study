...
/**
    Evil Tsuka ERC Token
    Telegram: https://t.me/eTsukaportal
*/
...
contract EvilTsuka is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xd391E70E92a67E7641A1C3D099476f6A2cFd05B4); // Marketing Address
    address payable public multiSigAddress = payable(0xd391E70E92a67E7641A1C3D099476f6A2cFd05B4); // Marketing Address
    address payable public devAddress = payable(0xd391E70E92a67E7641A1C3D099476f6A2cFd05B4); // Dev Address
    address payable public liquidityAddress = payable(0xd391E70E92a67E7641A1C3D099476f6A2cFd05B4); // Liquidity Address
    ...
    string private constant _name = unicode"Evil Tsuka";
    string private constant _symbol = unicode"eTsuka";
