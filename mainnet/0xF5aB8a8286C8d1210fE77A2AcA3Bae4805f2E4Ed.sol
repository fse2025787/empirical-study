...
contract dirtdevilswtf is ERC721Delegated, ReentrancyGuard {
  ...
  {
    allowedMintCountMap[msg.sender] = 30;
  }
  ...
  uint256 public constant PRICE = 3330000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.00333 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0xC5ae39c67f6Da0e882Cb85E0eF9d06f0c2feA8Fc;

  function withdraw() public nonReentrant {
    uint256 balance = address(this).balance;

    Address.sendValue(payable(_owner()), balance * 70 / 100);
