...
contract GenerativeCollectionToken is ERC721, ERC2981 {
    ...
    event reservation(address eth_address, uint256 price, uint256 timestamp, uint256 amount, bool is_whitelist_member);
    ...
    function reserve(uint256 quantity_) public payable {
        ...
        require((is_goldlist_custody && is_goldlist_member) || (is_whitelist_custody && is_whitelist_member));
        uint256 price = is_goldlist_member ? goldlist_price : whitelist_price;
        require(price * quantity_ <= msg.value);
        require(_limit >= reserved + total_supply + quantity_);
        ...
        emit reservation(msg.sender, price, block.timestamp, quantity_, is_whitelist_member);
    }
