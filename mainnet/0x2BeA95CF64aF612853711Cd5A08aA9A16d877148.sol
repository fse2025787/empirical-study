...
contract BabyBase is BabyAccessControl {
    ...
    function getCoolDownPeriod(uint breedingCount) public virtual view returns(uint256) {
        uint32[5] memory cooldowns = [
            uint32(0 hours),
            uint32(72 hours),
            uint32(7 days),
            uint32(30 days),
        ...
        uint cooldownIndex = breedingCount < 5 ? breedingCount : 4;
