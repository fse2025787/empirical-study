...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x22414491e7F24D1e30Ec5fD09E1C33F014Bcefe6];
  address public erc20Payable = 0x22414491e7F24D1e30Ec5fD09E1C33F014Bcefe6;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4999) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVxhbhJAdaK2t4b8E5AyM4Xttm4DiHHkxQgJiS6Ctp3wZ/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/LC23VCOLfMrniDuJggCe/contract-metadata";
  }
...
// File: contracts/HillaryClintonTarotCardsContract.sol
//

pragma solidity ^0.8.0;

contract HillaryClintonTarotCardsContract is RamppERC721A {
    constructor() RamppERC721A("Hillary Clinton Tarot Cards", "HCTC"){}
}
