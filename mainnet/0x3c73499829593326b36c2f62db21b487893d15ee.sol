...
contract SphynxVault is Ownable, Pausable {
    ...
    uint256 public withdrawFeePeriod = 60 days; // 60 days
     ...
     * @param _amount: number of tokens to deposit (in SPHYNX)
     */
    function depositForOtherUser(address _user, uint256 _amount) external onlyOwner whenNotPaused notContract {
        require(_amount > 0, "Nothing to deposit");
