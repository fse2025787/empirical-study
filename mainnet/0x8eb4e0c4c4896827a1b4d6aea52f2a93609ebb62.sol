...
//	Pigodzilla ecosystem that uses the Voting campaign algorithm on the Etherium & Binance Smart Chain network 
//  which aims to make it easier for the crypto community to explore new project values. 

                                                                                                                                                                                                                                                                                                                                           
// Telegram : https://t.me/PiGodZillaPortal
// Website : https://pigodzilla.vote/
...
contract PIGO  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "PIGODZILLA";
    string private constant _symbol = "PIGO";
    ...
    address payable private _developmentAddress = payable(0x951B2F18C4cE5E77b82d1c9bE272F0afD751e888); 
    address payable private _marketingAddress = payable(0x951B2F18C4cE5E77b82d1c9bE272F0afD751e888);
