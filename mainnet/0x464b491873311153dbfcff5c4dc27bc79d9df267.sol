...
contract PitBullCrypto is Context, IERC20, Ownable {
    ...
    string private _name = 'PitBull Crypto';
    string private _symbol = 'PITBULL';
    ...
    function contractRunning() public view returns (bool) {
        return _state;
    }
    ...
    function reflect() public virtual onlyOwner {
