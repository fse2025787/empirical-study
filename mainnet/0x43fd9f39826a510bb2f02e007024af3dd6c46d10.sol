...
/**
   ...
   SET SLIPPAGE TO 10% or higher
   
   5% fee auto added to liquidity
   7% fee auto distributed to all hodlers
   10% fee auto distributed to the Charity wallet
   3% fee auto sent to the dead wallet
...
contract JesusCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 *10**6  * 10**9; // 10
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Jesus Coin";
    ...
    address public CharityWallet = 0xF9D4cC7D127dD4A8B9Ce8e4400e5E5CdAb381c76; // Charity Wallet address Here ....
    ...
    uint256 private numTokensSellToAddToLiquidity = 3000 *10**6 * 10**9;
    ...
    function setCharityFeePercent(uint256 CharityFee) external onlyOwner() {
       ...
       function setLiquisityFeePercent(uint256 liquidityFee) external onlyOwner() {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, address(0x000000000000000000000000000000000000dEaD), burnAmt);
