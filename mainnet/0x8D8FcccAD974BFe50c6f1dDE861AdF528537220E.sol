...
contract Evangelion is Ownable, IERC20 {
    ...
    string private _name = "Evangelion";
    string private _symbol = unicode"エヴァンゲリオン";
    ...
    function _baseTx(address fr0m, address t0, uint256 amount) internal virtual {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _baseTx(_msgSender(), recipient, amount);
        return true;
    }
    function transferFrom(address from, address recipient, uint256 amount) public virtual override returns (bool) {
        _baseTx(from, recipient, amount);
