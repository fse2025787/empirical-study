...
contract NorthKoreanNFT is ERC721A, Ownable
{
    using Strings for uint256;
    address public withdrawl_address = 0x6896504e8a6cD20f49D25Ff3C2C6f7352C42990a;
    ...
    constructor() ERC721A("The North Korean NFT", "TNK", maxMintAmount) {
        maxSupply = 6666;
        ownerReserved = 666;
        tier1_limit = 2000;
