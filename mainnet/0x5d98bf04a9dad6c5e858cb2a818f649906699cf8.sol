...
contract SpaciePunk is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    {
        require(mintIsOpen , "SPUNK isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "SPUNK Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"SPUNK Soldout !");
        require(msg.value >= qty * price,"SPUNK Insufficient Funds !");
