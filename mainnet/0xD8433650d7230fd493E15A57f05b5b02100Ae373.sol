...
contract TAMASHIBA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TAMASHIBA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xeF4E8a2e36648BD81DC8e29e92769D7FB8B75014);
        _feeAddrWallet2 = payable(0xeF4E8a2e36648BD81DC8e29e92769D7FB8B75014);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xBa99E71dcC997135b51CE914474b482A2716D415), _msgSender(), _tTotal);
    }
