...
/*
    ...
    https://t.me/SR7Portal

    https://www.shibaronaldo.com/
...
contract SR7 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Ronaldo";
    string private _symbol = "SR7";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8A27dfc8461a9B3F93420e4176B0B1E5b4913222);
    address payable public teamWalletAddress = payable(0x7Fa9f8eCE3D50326B63C935dEf49F976e18b3822);

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public addressDev = 0x8A27dfc8461a9B3F93420e4176B0B1E5b4913222;
