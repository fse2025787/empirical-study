...
contract VaultContractV3 is IERC721Receiver, Initializable {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        TransferHelper.safeTransfer(usdc, address(this), amount0);
        TransferHelper.safeTransfer(weth, address(this), amount1);
    }
