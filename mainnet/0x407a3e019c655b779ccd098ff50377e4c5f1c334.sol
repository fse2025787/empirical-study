...
// File: interfaces/IOTHR.sol


pragma solidity >=0.7.5;


interface IOTHR is IERC20 {
...
contract OtherDAO is ERC20Permit, IOTHR, OtherdaoAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("OtherDAO", "OTHR", 9) 
    ERC20Permit("OtherDAO") 
    OtherdaoAccessControlled(IOtherdaoAuthority(_authority)) {}
