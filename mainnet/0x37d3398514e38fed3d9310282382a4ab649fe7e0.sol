...
contract DaddyMononokeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "DaddyMononokeInu";
    string private _symbol = "DMI";
    ...
    address liquidityWallet=0x9617bCf4E4037847798bCa57407de07729e586eD;
