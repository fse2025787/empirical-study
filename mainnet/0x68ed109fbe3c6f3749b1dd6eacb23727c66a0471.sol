...
contract  SantaSolana is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "SantaSolana";
    string private _symbol = "SSOL";
    ...
    constructor () {
        ...
        DXtw = payable(address(0xB2e181Deea2fc42B6beb5d5862c199ec9A76Cc94));
        teamWalletAddress = payable(address(0xB2e181Deea2fc42B6beb5d5862c199ec9A76Cc94));
