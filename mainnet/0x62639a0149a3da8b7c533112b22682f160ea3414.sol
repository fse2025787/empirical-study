...
/**
Alpha Ape (APPE)
Telegram: hhtps://t.me/alphaapeeth
*/
// 
...
contract APPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Alpha Ape";
    string private _symbol = "APPE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x0a4D477FBe7996BDAbE8eB9f6b5b762b60751230);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*33/10000; 
