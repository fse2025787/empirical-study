...
contract WAGLEAVE is Ownable, ERC721A {
    uint256 public maxSupply                    = 6666;
    uint256 public maxFreeSupply                = 6666;
    
    uint256 public maxPerTxDuringMint           = 10;
    uint256 public maxPerAddressDuringMint      = 30;
    uint256 public maxPerAddressDuringFreeMint  = 1;
    
    uint256 public price                        = 0.003 ether;
    bool    public saleIsActive                 = false;

    address constant internal TEAM_ADDRESS = 0x167c4602C7F61277AAA1AB3A1F76107F99499363;
    ...
    constructor() ERC721A("We Are All Going to Leave", "WAGLEAVE") {
