...
contract ProToken is Context, IERC20, Ownable {
    ...
    constructor(
        ...
        swapAmount = amountOfTokenWei.mul(1).div(1000);
    ...
    function excludeFromMaxTx(address account, bool isExcluded)
        public
        onlyOwner
    {
    ...
    function setAllFeePercent(
        ...
        require(marketingFee >= 0 && marketingFee <= maxWalletFee, "WF err");

        require(buybackFee >= 0 && buybackFee <= maxBuybackFee, "BBF err");
        require(charityFee >= 0 && charityFee <= maxWalletFee, "WFT err");
