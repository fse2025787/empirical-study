...
Proof of Pyro is back reviving the awesome concept of fast-burning hyper-deflationary tokens! Hodlers of $PYRO2.0 will see their tokens gain value with every buy & sell transaction.

2% Auto-Burn Mechanism which burns 2% supply with every Buy and Sell🔥

Alpha play and callers onboard so might do goo!✅
...
contract ProofOfPyro is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of Pyro";
    string private constant _symbol = "PYRO2.0";
