...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1657724400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1672501080;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x89aCBC3792674A835A2aDEe94d3dcbc09563ddc9];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmV1iVbJ1Cv6eRtB9Urjv5SxbyE2c8mVLrFVJZGHo2E5qJ/";
...
// File: contracts/PixelPandasSensoryWorldContract.sol
//

pragma solidity ^0.8.0;

contract PixelPandasSensoryWorldContract is RamppERC721A {
    constructor() RamppERC721A("Pixel Pandas Sensory World", "PPSW"){}
}
