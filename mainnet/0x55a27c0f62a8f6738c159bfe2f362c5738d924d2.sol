...
Who's ready to FIRE it UP?!

🔥 it 🆙 is a deflationary rocketship community token! Shills are inbound and everything is set up to ensure that we make it to the moon. 
Get your seatbelts on as this will be the ride of your life!

🌜 PHASE 1 WILL involve a SILENT LAUNCH (happening now) with SHILLS INBOUND shortly! Liquidity will be locked and ownership will be renounced.
🚀 We will orbit into space exactly one hour out of launch with our silent launch hype marketing plan! 
🥂 Have a few drinks and relax! We only have a 2% fee which serves as reflections to our holders. 1% of total supply is reserved for marketing 
and the developers ensuring this token is as fair as it gets! No hidden fees, no sell limits, and no buy limits.

Get ready... because it is time to 🔥 it 🆙 to the moon! 🚀 Join our telegram at https://t.me/fireituptoken
*/
interface IERC20 {
...
contract Fireitup is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000000 * 10 ** 18;

    constructor () ERC20('FIU',unicode'FIRE 🔥 it 🆙') {
