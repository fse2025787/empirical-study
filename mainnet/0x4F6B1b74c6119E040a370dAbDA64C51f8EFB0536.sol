...
contract LutherSigned is Signable {
  ...
  function claim(bytes memory ownerSignature) public returns(bytes32 namehash){
    require(!claimedAddresses[msg.sender], "one subdomain per wallet");
    require(validateSignature(msg.sender, ownerSignature, hex"1e3e4809e7f548d57fe0bf7786cea34feb35144070684c3bac7b4e928d06f9fb"), "invalid claim");

    uint256 newTokenId = _tokenIds.current();
    string memory _label = string(abi.encodePacked("miami-", Strings.toString(newTokenId)));

    namehash = _claimSubdomain(msg.sender, _label, hex"1e3e4809e7f548d57fe0bf7786cea34feb35144070684c3bac7b4e928d06f9fb");
