...
contract ZOMBAE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "ZOMBAE";
    string private constant tokenSymbol = "ZOMBAE";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xAe29D89a132589A230fcF1181Ebc84004B57FBAe);
        devAddress = payable(0xAe29D89a132589A230fcF1181Ebc84004B57FBAe);
