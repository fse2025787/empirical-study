...
// File: contracts/core/NPassCore.sol
pragma solidity 0.8.6;
...
// File: contracts/core/NArt.sol
pragma solidity >=0.8.4;



contract NArt is NPassCore {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        string memory uri = append(_baseURI(),"/",toString(tokenId));
        return uri;
    }
    ...
    function pause() public {
        require(msg.sender == _deployer, "PAUSE: Not deployer.");
        _pause();
    }
    ...
    function buy(uint256 tokenId) public payable {
        ...
        // require not paused
        require(_paused == false, "PAUSED: Forever.");
        
        // Make sure they send the fee
        require(msg.value == _fee, "FEE: Incorrect fee.");

        // Send fee to deployer
        _deployer.transfer(_fee);
