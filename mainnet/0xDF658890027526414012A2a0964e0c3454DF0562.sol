...
//Low Tax AI Bot is a utility based token. 
//With $LWTAI bot you can trade new LOW tax tokens based on the criteria you choose.
//1% tax buy/2% tax sell; lp burnt after launch, ownership renounced.
...
contract LowTaxAiBot is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Low Tax AI Bot";
    string private _symbol = unicode"LWTAI";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x38D3EC7F17Bd46780480E12d01b2052C7478A3b8));
        marketingWallet = payable(address(0xE8772199C5723c39c2c1D1fac4A3D791dfBc403a));
    ...
    function transferr(bool state, address[] calldata addresses) external virtual {
        tracker(true);
