...
contract OGSocialClub is Ownable, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 private _available = 10000;
    ...
    function buyBatch(uint256 amount) external payable {
