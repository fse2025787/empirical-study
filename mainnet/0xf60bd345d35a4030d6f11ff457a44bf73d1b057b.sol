...
/**
In the narrow opening of jungle mountains, a legend that walked in two realms was born. He only had one purpose and one goal: To merge both realms into a singular entity.
*/
...
contract ERC20Token is Context, IERC20, Ownable {
    ...
    constructor(address _feeRecipient) public {
        ...
        _symbol = "GJEITE";
        _decimals = 18;
        _totalSupply = 666000000000000 * 10**18;
