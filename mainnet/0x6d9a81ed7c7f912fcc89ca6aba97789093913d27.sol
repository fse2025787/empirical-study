...
Crypto Is dead? Crypto is alive? 

Crypto is alive but it is dead;
Crypto is dead but it is alive. 

To dead or not to dead; this is a question
To alive or not alive; this is a question
...
contract CryptoIsDead is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Crypto Is Dead";
    string private constant _symbol = "CID";
