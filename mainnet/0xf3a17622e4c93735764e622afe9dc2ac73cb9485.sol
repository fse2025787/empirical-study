...
/*
    Stop the war and have sex
    https://twitter.com/SBF_ucker
*/
// 
...
contract SBFucker is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SBFucker";
    string private constant _symbol = "SBFucker";
