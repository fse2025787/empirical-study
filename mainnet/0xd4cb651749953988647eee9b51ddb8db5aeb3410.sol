...
/**
join us
Tg : https://t.me/SpurdoPortal
twitter: https://twitter.com/SpurdoToken
*/
...
contract Spurdo is ERC20, Ownable {
    ...
    constructor() ERC20("Spurdo", "$SPURDO") payable {
    	...
    	marketingWallet = address(0xdF0C17118e056eCb4561995942cc285b849944f8); // set as Marketing wallet
        devWallet = address(0x66Cd901E2AAccE34BDc98bC8FE26D238bFf1a8D0); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x66Cd901E2AAccE34BDc98bC8FE26D238bFf1a8D0, true);
        excludeFromFees(0x66Cd901E2AAccE34BDc98bC8FE26D238bFf1a8D0, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x66Cd901E2AAccE34BDc98bC8FE26D238bFf1a8D0, true);
        excludeFromMaxTransaction(0x66Cd901E2AAccE34BDc98bC8FE26D238bFf1a8D0, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x66Cd901E2AAccE34BDc98bC8FE26D238bFf1a8D0,
            block.timestamp
        );
    }
