...
contract ReasonedArtEditions is ERC1155Creator, DefaultOperatorFilterer {
    constructor(
        string memory name_,
        string memory symbol_
    ) ERC1155Creator(name_, symbol_) {}
    ...
    // The following functions are overrides required by Opensea Royalty policies
    function safeTransferFrom(
        address from,
        address to,
        uint256 tokenId,
