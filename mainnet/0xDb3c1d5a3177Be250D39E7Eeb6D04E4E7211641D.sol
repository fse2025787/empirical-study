...
contract SugarPopFoundersPass is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable supply = 500;
    ...
    address[] public withdrawAddresses = [0xA3a9330Fa60C229f6d98F149dB9B68A8CF6654B7, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xd293bcfc6ea2a2e5d664433b5fe96eeefb4b457e236eb55d7f28cfed22622047;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xA3a9330Fa60C229f6d98F149dB9B68A8CF6654B7, _royaltyAmount);
    }
