 ...
 */
contract Cleartoken is Context, IERC20, Ownable, ReEntrancyGuard {
    ...
    address payable public _marketingAddress = payable(0xe09C95565E41370A60B7a3008f258F2d1908B734); // marketing Address
    address payable public _stakingAddress = payable(0xe09C95565E41370A60B7a3008f258F2d1908B734); //staking rewards Address
    address public _presaleAddress = 0x863d32d33BEd7DcDF1176A45e9B4e2b4681b1E27; //presale contract Address
    ...
    bool public _isFeedisabled; // to set fees on or off
    bool public _presaleenabled; 

    string private _name = "Clear Token"; // token name
    string private _symbol = "$CLEAR"; // token symbol
    ...
    uint256 public _dividendFromtx = 20; // dividend fee 2.0%

    uint256 public _burnFee = 10; // burn fee 1.0%
    ...
    uint256 public _maxTxAmount = 750 * 10**6 * 10**9; // max allowed tokens tranfer per transaction
    ...
    /**  
     * @dev set presale period on or off
     */
    function presaleenabled(bool presale) public onlyOwner {
        _presaleenabled = presale;
        if(presale == false)
        {
            _liqlaunchtime = block.timestamp;
        }
    }

    /**  
     * @dev set fees on or off
     */
    function disableFee(bool fee) public onlyOwner {
        _isFeedisabled = fee;
    }
