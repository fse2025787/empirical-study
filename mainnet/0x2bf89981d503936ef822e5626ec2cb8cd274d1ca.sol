...
/**
If pride in nothing else, have pride in token
*/
...
contract GayDolphin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gay Dolphin";
    ...
    uint256 private _maxTxAmount = 11_000_000_000 * 10**9;
    uint256 private _maxWalletAmount = 22_000_000_000 * 10**9;
