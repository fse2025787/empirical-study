...
contract UNSTABLEP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Unstable Protocol";
    ...
    constructor () {
        _feeAddrWallet = payable(0x522D0B4ee52499C0BCb96E4D16C77f19e423d113);
