...
Kijo mainly refers to women who went from human to scary monster.
Either out of intense jealousy, a vicious crime, or a terrible grudge that twists the soul into pure hatred.
These transformed women retreated from ordinary society to more secluded places where they continued to commit evil deeds.

👺https://t.me/THEKIJOETH
👺https://twitter.com/THEKIJOETH
...
contract THEKOJI is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"THEKOJI";
    string private constant _symbol = "THEKOJI";
