...
contract BlueLuna is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "BlueLuna";
    ...
    address payable private _marketingAddress = payable(0xd75985d0a2b4aa83F9ACa6ff9098a6F72121aBc1);
