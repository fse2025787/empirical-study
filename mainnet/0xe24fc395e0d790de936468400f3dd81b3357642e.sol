...
contract DORD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DeFi Or Die", "DORD") {
    	...
    	marketingWallet = address(0xc9445B7AC936F49d142857923c237BD802a5b373); // set as marketing wallet
    	devWallet = address(0xe1381Ef7A395459d6fe9A64b83E93b4f340BA3f7); // set as dev wallet
