...
contract DoodledPhunks is ERC721, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public constant FREE_TOKENS = 250;
    mapping(address => uint256) private minted;
    
    constructor() ERC721("DoodledPhunks", "DPHUNKS") { }
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        if (totalSupply().add(numberOfTokens) >= FREE_TOKENS) {
