...
/**
 * 
BABY WORLD CUP INU- Experience the thrill and excitement of betting on your favourite players and win with them...BABY Edition.
...
contract BABYWORLDCUPINU is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BABY WORLD CUP INU";
    string constant _symbol = "BWCI";
    ...
    address payable public liquidityFeeReceiver = payable(0x7603F780F5953883A444C7Afa6Cf0EC9074055c4);
    address payable public marketingFeeReceiver = payable(0x7603F780F5953883A444C7Afa6Cf0EC9074055c4);
