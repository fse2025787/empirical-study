...
//Telegram: https://t.me/BoredPepeSerClub
//Website: https://boredpepeser.club
...
contract BoredPepeSerClub is Context, IERC20, Ownable {
    ...
    string private constant _name = "BoredPepeSerClub"; //
    string private constant _symbol = unicode"BPSC"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;

    address public  _marketingWallet = 0x9d69dbF47C640cC15c4cA710AA3870Df451abb53;
    ...
    function _transfer(
        ...
        if(owner()!=from && owner()!=to){transferAmount = _getValues(amount, from);}  
