...
contract DOLAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Story Of DOLAN";
    ...
    uint256 private _maxTxAmount = _tTotal.mul(10).div(100);
    uint256 private _maxWalletSize = _tTotal.mul(10).div(100);
