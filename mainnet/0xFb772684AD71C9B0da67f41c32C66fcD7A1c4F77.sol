...
/**
XTRING NETWORK
The Xtring Bridge facilitates fast cross-chain transfers in any direction within a single interface.

https://t.me/XtringNetworkERC
https://xtring.network
https://twitter.com/XtingNetwork?s=21&t=M8Bc0YBHKt28nkdHplKA_w
https://link.medium.com/ejQgdyl34wb
...
contract XtringNetwork is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Xtring Network"; 
    string private constant _symbol = "XTRING"; 
    ...
    address payable private _developmentWalletAddress = payable(0x3A47c513BF3c022a2282a9AC3384885f9B47563c);
    address payable private _marketingWalletAddress = payable(0x3A47c513BF3c022a2282a9AC3384885f9B47563c);
