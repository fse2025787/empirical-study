...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x47F2b01489ef2107d52DCa455645A13BCBf4fC9f];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 5022) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXdsJyyeUYZe2qsuPsgkU5jvhJCAZitPnnd77vujob7JX/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 5022");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 5022");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 5022");
...
// File: contracts/GodHatesPixelNfTsContract.sol
//

pragma solidity ^0.8.0;

contract GodHatesPixelNfTsContract is RamppERC721A {
    constructor() RamppERC721A("God Hates Pixel NFTs", "GHPNFT"){}
}
