...
SAITA Whales is a community driven token that is aiming to raise new ETH whales, as well as it will be granting its holders access to our ALPHA incubated projects vetted by our expert devs'. 
Only holders will be having the access to the early ALPHA projects, as well as the project’s DAO.


**MIGHT BE THE OPPORTUNITY OF A LIFE TIME**

tg: https://t.me/saita_whales
Website: https://saitawhales.com
...
contract SAITA is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xD7ba8cdBb9329eEd078aE7A786f690f682102C09); // 
        exclude(msg.sender);
