...
contract PosersDickbutt is ERC721A, Ownable {
    
    uint256 public immutable mintPrice = 0.001 ether;
    uint32 public immutable maxSupply = 5000;
    uint32 public immutable maxPerTx = 10;

    string  public uriPrefix = "https://posersdickbutt.fra1.digitaloceanspaces.com/ape/public/metadata/";
