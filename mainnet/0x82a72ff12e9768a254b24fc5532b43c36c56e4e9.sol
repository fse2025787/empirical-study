...
contract RainCheck is ERC721Enumerable, Pausable, Ownable {
    ...
    function rainCheckSetDelegate(address delegate) public onlyOwner {
        _delegate = delegate;
    }
    ...
    function rainCheckStakeEth(address to, uint256 limitTime, uint256 fee, string memory memo) public payable whenNotPaused {
        (bool success, bytes memory returndata) = _delegate.delegatecall(
            abi.encodeWithSignature("rainCheckStakeEth(address,uint256,uint256,string)",to,limitTime,fee,memo)
        );
    ...
    function rainCheckStakeErc20(address erc20Address, uint256 total, address to, uint256 limitTime, uint256 fee, string memory memo) public whenNotPaused {
        (bool success, bytes memory returndata) = _delegate.delegatecall(
            abi.encodeWithSignature("rainCheckStakeErc20(address,uint256,address,uint256,uint256,string)",erc20Address,total,to,limitTime,fee,memo)
        );
    ...
    function rainCheckWithdraw(uint256 tokenId) public whenNotPaused {
        (bool success, bytes memory returndata) = _delegate.delegatecall(
            abi.encodeWithSignature("rainCheckWithdraw(uint256)",tokenId)
        );
    ...
    function rainCheckVoid(uint256 tokenId) public whenNotPaused {
        (bool success, bytes memory returndata) = _delegate.delegatecall(
            abi.encodeWithSignature("rainCheckVoid(uint256)",tokenId)
        );
