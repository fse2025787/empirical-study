...
// Twitter : htpps://twitter.com/ProofOfAlphaErc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb7c8A2Bd19f5aD456F0302D2cB53ED87737Bb203;
        POAE[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal POAE;
    ...
    modifier POA() {
        require(isPOA(msg.sender), "!POA"); _;
    }

    function isPOA(address adr) public view returns (bool) {
        return POAE[adr];
    }
...
contract ProofOfAlpha is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xb7c8A2Bd19f5aD456F0302D2cB53ED87737Bb203);
    ...
    */
    ...
    string private _name = "PROOF OF ALPHA"; 
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xb7c8A2Bd19f5aD456F0302D2cB53ED87737Bb203] = true;
    ...
    */
    ...
    function RemoveFees(uint256 Buy_Fee, uint256 Sell_Fee) external POA() {
