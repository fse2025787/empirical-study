...
contract OkayLlamaYachtClub is ERC721A, Ownable {
	...
	constructor() ERC721A("Okay Llama Yacht Club", "OLYC") {
		setBaseURI("http://api.okayllamayachtclub.com/lama/");
	}
