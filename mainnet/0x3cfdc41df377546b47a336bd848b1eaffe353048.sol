...
/* Elon’s Ape Club - $BORELON
 * https://t.me/BorelonEntry
*/
...
contract Borelon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Elons Ape Club", "BORELON") {
    ...
    ; uint256 totalSupply = 1 * 1e9 * 1e18;
        ...
        maxTransactionAmount = totalSupply * 8 / 1000; // 0.8% maxTransactionAmountTxn
        maxWallet = totalSupply * 16 / 1000; // 1.6% maxWallet
