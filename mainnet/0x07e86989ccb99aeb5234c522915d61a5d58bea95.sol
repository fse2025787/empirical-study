...
contract presale {
    ...
    IToken public VEPPT = IToken(0xF640c038C0f036B1302eF345500ff71A7451fBB1);
    ...
    uint256 public minimumDollar = 100 ether;
    uint256 public minimumETH = 0.06 ether;
    ...
    constructor() {
        owner = payable(0x482EC0c7fF7AED3d6EEb97683AaB5315176A69cB);
    ...
    function buyTokenEth() public payable {
        ...
        VEPPT.transfer(msg.sender, numberOfTokens);
    ...
    function getContractTokenApproval() external view returns (uint256) {
        return VEPPT.allowance(owner, address(this));
    }
}
