...
contract FTXReservesInu is ERC20, Ownable {
    ...
    address payable public teamWallet = payable(0x779c14fbAeaE6B725540cbc41147A705569FB21A);
    address public immutable deadAddress = 0x025e0dDC5B834E51FEa0F3C3129864A1297b4e8f;
    ...
    constructor() ERC20("FTXReservesInu", "$FTXR") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "FTXReservesInu: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FTXReservesInu: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "FTXReservesInu: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "FTXReservesInu: Automated market maker pair is already set to that value");
