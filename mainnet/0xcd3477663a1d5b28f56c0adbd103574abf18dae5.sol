...
/*
    ...
    We are a bunch of chads who like to give what the community wants. A long lock and a working dev.

    Lock will extend explosively from 10 month to 100 Year !
*/
...
contract AHUNDREDYEAR is IERC20, Ownable {
    ...
    string constant _name = "A HUNDRED YEAR";
    string constant _symbol = "100Y";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals); // 100,000,000,000
    ...
    uint256 swapThreshold = _totalSupply.div(1000); // 0.1%
    ...
    function adjustFees(uint256 _marketingFee, uint256 _feeDenominator) external onlyOwner {
        marketingFee = _marketingFee;
        totalFee = _marketingFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator / 5,"Fee must be less than 20%");
    }
