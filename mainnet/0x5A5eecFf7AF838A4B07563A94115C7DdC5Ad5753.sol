...
contract IsItOver is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRmbno77j4wj4FCFk5tvLEu8DABidScDdLMVp8YBgAGsU";
    ...
    constructor(
    ) ERC721A("Is It Over?", "IIO", 100, maxSupply) {
    }
