...
contract Kedies is ERC721A, Ownable {
    // 1 Slot - gas saving
    uint32 public maxSupply = 2222;
    uint16 public maxNFTPerAddress = 2;
    ...
    constructor(string memory _notRevealedURI) ERC721A("Kedies", "KED") {
        notRevealedURI_ = _notRevealedURI;

        // First 22 Kedies to the team
