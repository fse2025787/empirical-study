...
contract FeeContract is Governable {
    ...
    function valueOfMeta(address _vaultAddress) public view returns (uint256 _USDCInMeta) {
        ...
        _USDCInMeta = zapContract.calc_withdraw_one_coin(lpToken, amountLp, 2);
    }
    ...
    function getCurrentUniV3Price() external view returns (uint256 price) {
        IOracle ethOracle = IOracle(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
        uint256 ethPrice = ethOracle.latestAnswer(); // 1e8 precision
