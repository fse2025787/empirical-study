...
contract DegenNeko is Context, IERC20, Ownable {
    ...
    string private _name = 'Degen Neko Inu'; 
    string private _symbol = 'DNI';
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1000000000e9 , 'maxTxAmount should be greater than 1000000000e9');
