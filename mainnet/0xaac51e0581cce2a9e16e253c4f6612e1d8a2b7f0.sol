...
contract BangToken is ERC20Permit, Ownable {
    ...
    constructor(string memory _name, string memory _s) ERC20(_name, _s, 9) ERC20Permit() {
        initializer = 0x4e5b3043FEB9f939448e2F791a66C4EA65A315a8;
    ...
    /**
        @notice increases Bang supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Bang
