...
contract BabyGoblinTown is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxFreeMint = 555;
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount){
    if(msg.sender != owner()){
      ...
      if (totalSupply()+_mintAmount > maxFreeMint){
        ...
        require(_mintAmount <= maxMintAmountPerWallet, 'Invalid mint amount!');
      }
    }
