...
/**
         ...
         $MIDAS - MIDAS    - Ethereum Network|  
       

Telegram : @midasportal

Twitter :  https://twitter.com/MidasPadERC

Medium :   https://medium.com/@midasecosystem



$MIDAS
Midas is the investor’s dream destination, where investors can relax by investing in projects listed on Midas with complete security
Midas is truly decentralized and noncustodial so any user that connects with WEB3 Wallet, Can mint, Token Launch, Token Lock and use all future Dapps.
