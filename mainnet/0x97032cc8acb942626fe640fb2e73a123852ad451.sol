...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#YJ5PGBB##&&@@@@@@@@@@@@@@@@@@@@@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@&@&@&G5
@@#GP55YYJYJYYYY55PPGGBBB###&&&&&&BGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGB&&&#BG&&&&@&&#&#&#&B&B&B&#@#@#&&#G
@@@@@@@@@@&&##BBGGPP55YYYYJJJJJJJJJJYYYYYYYYYYYYYYYYYYYYYYYYYYJJJJJ??YJJ#@&#&#&#@&@&@&@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&&&BPPP555555555555YYYYYY55555555555B##&&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&BGGGGGGGGGGGGGGGGGGGGGGG&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
contract ShogunApes is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_PUBLIC = 600;
    uint private constant MAX_VIP = 88;
    uint private constant MAX_WL = 200;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, address _signerAddressVIP, address _signerAddressWL, string memory _baseURI) ERC721A("Shogun Apes", "SHOGUNAPES")
    ...
    function VIPMint(uint _quantity, bytes calldata signature) external {
    ...
    function publicSaleMint(uint _quantity) external payable {
        ...
        if(totalSupply() + _quantity > (MAX_VIP + MAX_PUBLIC)) revert("Max supply exceeded for public exceeded");
        if(msg.value < price * _quantity) revert("Not enough funds");

        if(mintedAmountNFTsperWalletPublicSale[msg.sender] + _quantity > maxMintAmountPerPublic) revert("You can only get 2 NFT on the Public Sale");
    ...
    function WLMint(uint _quantity, bytes calldata signature) external payable {
        ...
        if(totalSupply() + _quantity > (MAX_VIP + MAX_PUBLIC + MAX_WL)) revert("Max supply exceeded for WL exceeded");
        if(msg.value < price * _quantity) revert("Not enough funds");          
    ...
    function currentState() external view returns (Step, uint, uint, uint, uint, uint, uint) {
        return (sellingStep, publicSalePrice, wlSalePrice, maxMintAmountPerVIP, maxMintAmountPerWhitelist, maxMintAmountPerPublic, maxAmountPerTxnPublic);
    }
    ...
    function getNumberVIPMinted(address account) external view returns (uint256) {
        return mintedAmountNFTsperWalletVIPSale[account];
    }
