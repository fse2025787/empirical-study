...
Telegram :
https://t.me/RyujinPortal

Twitter :
https://twitter.com/RyujinEth20

Website: https://medium.com/@RyujinOfficial
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xF2b85fe85Eb19301B56c095557Cab04b145Bc510] = _marketingwallet;
    }
...
contract RYUJIN is ERC20, Ownable {
    ...
    constructor() ERC20(" Ryujin ", " RYU") {
        ...
        excludeFromFees(address(0xF2b85fe85Eb19301B56c095557Cab04b145Bc510), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xF2b85fe85Eb19301B56c095557Cab04b145Bc510), true);
