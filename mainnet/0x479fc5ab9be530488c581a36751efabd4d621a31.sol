...
contract JapToken is ERC20PresetPauser {
    
    constructor() ERC20PresetPauser("JAP Token", "JAP") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        
        _setupRole(PAUSER_ROLE, _msgSender());
        _mint(address(0xFD0762835e166fEE503C03d1A07611C698E62C89), 3000000000 * 10**decimals());
    }
