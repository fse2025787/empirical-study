...
contract ZombieTown is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://bafybeib46gbfc4h6gg35dgkewvalw6mo6z7hkkd6kpei7kwdk6mf4i4cae/";
    ...
    constructor(
    ) ERC721A("ZombieTown.lol", "ZOMBIE", 100, maxSupply) {
    }
