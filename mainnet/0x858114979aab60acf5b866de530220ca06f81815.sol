...
contract innocentchaos is ERC721A, Ownable {
    using Strings for uint256;

    uint256 MAX_MINTS = 1;
    uint256 MAX_SUPPLY = 222;
    bool private paused = true;
    uint256 MAX_FREE = 222;
    uint256 public mintRate = 0 ether;

    string public baseURI = "ipfs://chaos/";

    constructor() ERC721A("Innocent Chaos", "cos") {}
    ...
    function withdrawsplitter() external payable onlyOwner {
        ...
        address ad1 = 0xFd42450Dc82328aB8c9628456108F9F1F21cBE0c;
