...
contract MIDAS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Midas";
    string private constant _symbol = unicode"$MIDAS";
    ...
    address payable private _developmentAddress = payable(0xbff478F3F917439323593C1199279e4FeF620DC8);
    address payable private _marketingAddress = payable(0xbff478F3F917439323593C1199279e4FeF620DC8);
