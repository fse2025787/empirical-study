...
contract ElonaMusk is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor()
  ERC721A("Elona Musk", "ELONA")
  {
    maxPerAddressDuringMint = 50;
    maxBatchSize = 20;
    collectionSize = amountForDevs = amountForSaleAndDev = 5420;
    saleConfig.publicPriceWei = 242 ether / 10000;  // 0.02420 ETH
