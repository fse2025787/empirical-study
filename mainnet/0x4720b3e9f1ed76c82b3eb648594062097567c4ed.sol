...
// https://megaquake.info

// https://t.me/ProjectRichter
...
contract richter is ERC20 {
    constructor() ERC20("Project Richter", "MEGAQUAKE") {
        _mint(msg.sender, 501000000 * 10 ** decimals());
    }
}