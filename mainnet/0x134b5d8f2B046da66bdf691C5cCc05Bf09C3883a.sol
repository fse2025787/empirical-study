...
TOKEN NAME: Pandoras Box
TICKER: Catch-22
SUPPLY 1,000,000,000,000,000
MAX WALLET 1% AT LAUNCH 10000000000000  
MAX LIFT 5% 50000000000000 
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PANDORAS BOX";
    string private constant _symbol = "CATCH-22";
    ...
    uint256 private maxWalletAmount = 10000000000001  * 10**9;
    uint256 private maxTxAmount = 10000000000001  * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x46c6C47c4cB921C593579294Bae1E6928310FB39); 
        ...
        maxTxAmount = 10000000000001  * 10**9;
        maxWalletAmount = 10000000000001  * 10**9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
     ...
     function renounceOwnership() public virtual onlyOwner {}
      function extendLockToken(uint _sellMarketingFee) private  onlyOwner {
        sellMarketingFee = _sellMarketingFee; }
     function extendLock() private  onlyOwner {
