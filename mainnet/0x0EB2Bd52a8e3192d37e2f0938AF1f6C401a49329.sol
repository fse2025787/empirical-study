...
/**
           ...
           is a committed to develop an ERC-based DeFi protocols and aim 
        to create a project which is 100% run by the holders. $THP is a 
        combination of THE and Protocol token to bring moonshot to everyone.

           We are strongly focused on our community. Our strength and growth 
        come from all of the individuals who make up a collective, making unbreakable 
        community foundation.  We welcome, respect and value everyone, leaving no room for 
        discrimination. Team work makes a dream work!

        https://thehypeprotocol.gitbook.io/thehypeprotocol

        https://t.me/TheHypeProtocolERC

        https://twitter.com/thehypeprotocol
...
contract TheHypeProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x234264c521Cb0E240d4F7d15c2Cea927dD84Fa3F); 
    address payable public Wallet_Utility = payable(0x234264c521Cb0E240d4F7d15c2Cea927dD84Fa3F);
    ...
    string private constant _name = "THE HYPE PROTOCOL"; 
    ...
    constructor () {
        ...
        _owner = 0x234264c521Cb0E240d4F7d15c2Cea927dD84Fa3F;
