...
https://medium.com/@NatsumiEth
https://twitter.com/NatsumiEth
...
contract SUMI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "NATSUMI";
    string private constant _symbol = "SUMI";
    ...
    address payable private _developmentAddress = payable(0x79B2AeF76c18172e0D5E0DFfc5b6B548B0315B80); 
    address payable private _marketingAddress = payable(0xd88643f62e948fed6a70f2Af3D96ce7Af042EB41);
