...
//*********************************************************************//
//
//    ________              __            _       ___                   __                  ___                   
//   / ____/ /_  ___  ___  / /____  __   | |     / ( )____ _____  _____/ /_  ____  _____   /   |  ____  ___  _____
//  / /   / __ \/ _ \/ _ \/ //_/ / / /   | | /| / /|// __ `/ __ \/ ___/ __ \/ __ \/ ___/  / /| | / __ \/ _ \/ ___/
// / /___/ / / /  __/  __/ ,< / /_/ /    | |/ |/ /  / /_/ / / / / /__/ / / / /_/ / /     / ___ |/ /_/ /  __(__  ) 
// \____/_/ /_/\___/\___/_/|_|\__, /     |__/|__/   \__,_/_/ /_/\___/_/ /_/\____/_/     /_/  |_/ .___/\___/____/  
//                           /____/                                                           /_/                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664146800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1664319600;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmSoS61QNVHeynhAYa4UrF1E4d7gr8gNEVNvwuhA5D29M6/";
...
// File: contracts/CheekyWanchorApesContract.sol
//

pragma solidity ^0.8.0;

contract CheekyWanchorApesContract is RamppERC721A {
    constructor() RamppERC721A("Cheeky Wanchor Apes", "CWApes"){}
}
