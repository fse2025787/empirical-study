...
contract SANSHA is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x0212EDB38F49b0aAf939Be5C187A1B82E571cc16;
    address private feeTwo = 0xDa21b385DC8F4fF2595F49D488DD0b6850a5fCC3;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private tempBalance;
    mapping(address => uint) private tempBalanceCoolDown;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Jiyuto Sansha";
    string private _symbol = "SANSHA";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1_000_000_000 * 10 ** _decimals;
    bool inSwapAndLiquify;
    uint256 public ethPriceToSwap = 10000000000000;
