...
/**
        Saitama 2.0
        Telegram: https://t.me/Saitama2ERC
        1,000,000,000,000,000 Supply
        5/5 Tax
        Anti-Sniper/Anti-Bots
*/
// 
...
contract SAITAMA is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Saitama 2.0";
    ...
    address public marketingFeeReceiver = 0x0385420E914b60f1368e757E914b11dBc83aff28;
    ...
    uint256 public swapThreshold = _totalSupply / 100000 * 300;
    bool inSwap;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x0385420E914b60f1368e757E914b11dBc83aff28] = true;
        isFeeExempt[_owner] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x0385420E914b60f1368e757E914b11dBc83aff28] = true;
   ...
   function areBots(address[] memory bots_) public onlyOwner {
