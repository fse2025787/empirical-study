...
contract Wrapper is Ownable, IERC721Receiver, ERC1155Holder {
    ...
    function onERC721Received(
        ...
        // this doesn't work alongside manifold's batch minter.
        // if we had more time, I'd make it all work perfectly,
        // but the bottom line is I can't quite keep track of their
        // batch mint address as well as I'd like. For the time being,
        // lets just accept all 721s!
