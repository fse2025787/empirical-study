...
contract AutistInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Autist Inu";//
    ...
    uint256 private _taxFeeOnBuy = 11;// 3% donated to autists in need (dev)
 
    //Sell Fee
    uint256 private _redisFeeOnSell = 0;//
    uint256 private _taxFeeOnSell = 11;// 3% donated to autists in need (dev)
    ...
    address payable private _developmentAddress = payable(0x11B13B48BD53cf891994F55481c64CaCa59A8E15);//
    address payable private _marketingAddress = payable(0x0cB6507F6a3c511555bF6550D6b7ac7Ef365f5c8);//
