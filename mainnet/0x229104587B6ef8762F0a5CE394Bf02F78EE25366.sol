...
// File contracts/swappers/Leverage/wOHMLevSwapper.sol
// License-Identifier: MIT
pragma solidity 0.6.12;
...
contract wOHMLevSwapperV1 {
    ...
    IStakingWarmup public constant stakingWarmup = IStakingWarmup(0x2882A5CD82AC49e06620382660f5ed932607c5f1);
    constructor(
    ) public {
    ...
    function swap(
        ...
        stakingWarmup.retrieve(address(this), amountIntermediate);
