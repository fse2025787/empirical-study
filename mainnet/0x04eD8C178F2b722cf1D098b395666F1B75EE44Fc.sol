...
contract WhenRisu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5f0d93B53CB16538e7a8B7138Fa8541C54519a01); 
    address payable public Wallet_Utility = payable(0x5f0d93B53CB16538e7a8B7138Fa8541C54519a01);
    ...
    string private constant _name = "When Risu"; 
    string private constant _symbol = unicode"WHENRISU"; 
    ...
    constructor () {
        ...
        _owner = 0x5f0d93B53CB16538e7a8B7138Fa8541C54519a01;
