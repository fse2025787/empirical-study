...
// File: contracts/ZErc20.sol

pragma solidity 0.5.17;


/**
 * @title  ZErc20 Contract
 * @notice GToken which wrap an EIP-20 underlying
 */
contract ZErc20 is GToken, CErc20Interface {

    constructor() public {
        admin = msg.sender;
        underlyingIsNativeCoin = false;
    }
