...
//
//      On-Chain Capital
//      Investing in on-chain games with profits spread amongst holders.
//
//      https://www.occ.capital/
//      https://t.me/OnChainCapital
//      https://twitter.com/OCCapitalETH
//      https://medium.com/@onchaincapital
//
//
//
// 
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not an OCC shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract OnChainCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "On Chain Capital";
    string private constant _symbol = "OCC";
    ...
    address payable public marketingWallet = payable(0x80BfD092114559fee61657B13C401De445cE1bA7);
    address payable public treasury = payable(0xfc5D9FeB7b70798AD343e6c7624eDE6B302190f3);
