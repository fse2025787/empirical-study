...
contract EldensRing is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdnKkdi8QMsAUhpKk9dW18WsffD4Cx5CQL6WezYssnv8Z";
    ...
    constructor(
    ) ERC721A("Eldens Ring", "RING", 100, maxSupply) {
    }
