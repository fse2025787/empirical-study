...
contract Valhalla is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 222;
    uint256 public MAX_MINTS = 2;
    string public baseURI = "https://mintvalhalla.com/api/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("Valhalla Metaverse Land", "VAL", MAX_MINTS, MAX_SUPPLY) {  
    }
