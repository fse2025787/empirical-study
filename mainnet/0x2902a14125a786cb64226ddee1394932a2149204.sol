...
contract SaudiChicks is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Saudi Chicks";
    string private constant _symbol = "SCHICKS";
    ...
    address payable public marketingWallet = payable(0xA7684DA1612c0F66B449b1D14FDD5842a5D4Aa7A);
    address payable public treasury = payable(0xA7684DA1612c0F66B449b1D14FDD5842a5D4Aa7A);
