...
/**
    World Cup Protocol ETH
   
    Telegram: https://t.me/WorldCupProtocolERC
*/
...
contract WorldCupProtocol is Context, IERC20, Ownable {
    ...
    address payable public multiSigAddress = payable(0x4d2Dc4091C9A183BFc108c5aCC7041Cb97cEF311); // Marketing Address
    address payable public devAddress = payable(0x4d2Dc4091C9A183BFc108c5aCC7041Cb97cEF311); // Dev Address
    address payable public liquidityAddress = payable(0x4d2Dc4091C9A183BFc108c5aCC7041Cb97cEF311); // Liquidity Address
    ...
    string private constant _name = unicode"World Cup Protocol";
    string private constant _symbol = unicode"WCP";
