...
This is a community based project with long term goals and plans. Great team are working to build this project. Please join the Kaizen Warror. More info to come

Max txn limit set to give fair opporunity to all the crypto warriors.

Twitter: https://twitter.com/KaizenOfficial5
Telegram: @Kaizencommunityofficial

Website: https://kaizenofficials.com
...
contract KAIZEN is Context, IERC20, Ownable {
    ...
    string private _name = "KAIZEN";
    string private _symbol = "$KAIZEN";
