...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfE65Ca98e6BE175F12Ebee98dF68c336bDecD5e6];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 1888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXSMesYSRpEMfgU4ziqv37sq1FBnU1tqsk4JzLD4WWF9g/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1888");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1888");
...
// File: contracts/DegenLoserClubContract.sol
//

pragma solidity ^0.8.0;

contract DegenLoserClubContract is RamppERC721A {
    constructor() RamppERC721A("Degen Loser Club", "DGNLS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/0zsl2yBayGahUP0MYqyr/contract-metadata";
    }
}
