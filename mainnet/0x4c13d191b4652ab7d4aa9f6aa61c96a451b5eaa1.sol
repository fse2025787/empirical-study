...
contract Karazhan is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Karazhan ";
    string private _symbol = " KARA ";
    uint8 private _decimals = 9;
    uint256 private _supply = 2000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 2000 * 10**_decimals;
    uint256 public maxWalletAmount = 40000 * 10**_decimals;
    address public marketingWallet = 0xf71a016d9B44fd4D0b6FE5eAA321c94ebD6919D7;
    // TOKENOMICS END ============================================================>
