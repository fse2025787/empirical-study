...
contract LostWorlds is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmfMFCxQNuVxQrsVm6n59gqq1c1o9Pre1UXZC1kSckfLsZ/";
    ...
    constructor(string memory initBaseURI) ERC721A("LostWorlds", "LW") {
        baseURI = initBaseURI;
