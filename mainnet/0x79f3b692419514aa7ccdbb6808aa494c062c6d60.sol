...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v2.5.0/contracts/math/Math.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v2.5.0/contracts/crowdsale/emission/AllowanceCrowdsale.sol
...
// File: contracts/MettaProtocol.sol
...
contract PNRCICO is Crowdsale, AllowanceCrowdsale {
 ...
 //       priceFeed = AggregatorV3Interface(0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526); // Testnet  
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        ...
        uint256 usd = uint256(getLatestPrice());
        usd = usd.div(10 ** 8).mul(20);
        uint256 oneCent = ethDecimals.div(usd);
        return (weiAmount.mul(10 ** decimals).div(oneCent));
    }
