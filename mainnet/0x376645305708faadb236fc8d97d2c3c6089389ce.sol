...
/**
No risk betting is one of the most popular methods to make money online.

Our Protocol:
It allows dev to develop around content rather than frameworks.Empowering Third-Parties to manufacture applications 
for better agreeing on blockchain straightforwardness and unchanging nature another period of substance will develop.

$WCBP launch tax is 8%, after locked is tax 1%. 

wcbpcoin.net

Our community: https://t.me/wcbpcoin
...
contract WorldCupBetProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "World Cup Bet Protocol";
    string private constant _symbol = "WCBP";
    ...
    address payable private _developmentAddress = payable(0x4ae3BFE797525e79FEFFC779a2789ECFcAC639Ba);
    address payable private _marketingAddress = payable(0x4ae3BFE797525e79FEFFC779a2789ECFcAC639Ba);
