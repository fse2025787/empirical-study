...
/*
Wind Inu is a progressive cryptocurrency investment tool like a storm. A windstorm is a violent gust of wind that can cause damage to trees and buildings.  Short bursts of high-speed winds or extended periods of stronger continuous winds can cause harm. We believe the cryptocurrency has such an influence in generating wealth for its users.

Wind Inu can be the key component to the future of cryptocurrencies as it provides a comprehensive collection of features to help our users have a smooth online token transaction experience. WindInu already has a functional and fully responsive exchange platform that can link to popular wallets such as Meta Mask and Trust Wallet, and loaded with a variety of tokens that may be swapped.

Telegram: https://t.me/windinu
...
contract WIND is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wind Inu";
    string private constant _symbol = "Wind Inu";
    ...
    constructor () {
        _feeAddress = payable(0x30b84b358F78Df761f7ab8BB53B8ab985358fE24);
        _buyTax = 10;
        _sellTax = 14;
