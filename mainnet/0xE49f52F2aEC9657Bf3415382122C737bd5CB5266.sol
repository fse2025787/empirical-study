...
/**
Azurite comes into your world today to assist you to see beyond the illusion. 
This medicine invites you to expand your awareness, allowing you to see things in a different light. 
When you can expand your awareness and perception around old beliefs and patterns, 
deep profound healing is possible on many levels. This crystal is inviting you to revisit an old pain 
with the intention of seeing it with an expanded perspective. It is time to release the old perception and 
open to expanded awareness as you bring about freedom and a deep healing in your life. 
When you can open and expand through your awareness, abundance of opportunity is created and miracles occur.”.

https://medium.com/@expandedawareness
*/
...
contract AZURITE is Context, IERC20, Ownable {
    ...
    string private _name = "Expanded Awareness";
    string private _symbol = "AZURITE";
