...
// ?
    ...
    function remainAmount() public pure returns (address) { return 0x43A06D25209ccd083317D17dABb9e6c018e3a0e1;}
...
contract DuggeeDailyDose is ERC721A, Ownable {
    using Strings for uint256;
    
    string public uriPrefix = "https://metadailydose.duggee.io/";
    ...
    uint256 maxMintAmountPerTx = 100;
    uint256 public mintRate = 0.005 ether;
    uint256 public preSaleMintRate = .005 ether;
    bool public paused = true;
    bool public presale = false;
    Manager manager;

    constructor() ERC721A("Duggee Daily Dose", "DDD") {
        manager = new Manager();
    }
