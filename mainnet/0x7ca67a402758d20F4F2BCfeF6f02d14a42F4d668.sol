    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 758) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPvMVG2Wb26ukUqD5YLDCq27rF3cf5ZAMvodQrmGbnkjE/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 758");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 758");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 758");
...
// File: contracts/EnigmaContract.sol
//

pragma solidity ^0.8.0;

contract EnigmaContract is RamppERC721A {
    constructor() RamppERC721A("Enigma", "Enigma"){}
}
