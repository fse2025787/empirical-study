...
contract TheGivingTyrant is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Giving Tyrant";
    string private constant _symbol = "TGT";
    ...
    constructor () {
        _feeAddrWallet = payable(0x07fEb280858B2Afa265ecB05Ba547ee9609af9A1);
