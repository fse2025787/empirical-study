...
Khaby Token 🤩🤳 | $KHABY | ERC-20 Token


Telegram: https://t.me/KhabyTokenETH
Twitter: https://twitter.com/KhabyTokenETH
Website: http://khabytoken.space/
...
contract Khaby is Context, IERC20, Ownable {
    ...
    string private constant _name = "Khaby";
    string private constant _symbol = "Khaby";
    ...
    constructor () {
        _feeAddrWallet = payable(0xE23582A997a015452c8044fa8911f509eC755190);
