...
contract GoblintownBurgers is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool hs, ) = payable(0xAAA8dA314d8602945E67c51cE69935c09429f5E6).call{value: address(this).balance * 8 / 100}('');
    require(hs);
