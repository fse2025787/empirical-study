...
// File: contracts/IrregularPunks.sol


pragma solidity ^0.8.8;

contract IrregularPunks is Ownable, ERC721 {
    using SafeMath for uint256;

  uint public constant supplyLimit = 2222;
  ...
  function freeMint(uint256 numberOfTokens) public {
    require(totalSupply <= 2000, "free supply reached");
