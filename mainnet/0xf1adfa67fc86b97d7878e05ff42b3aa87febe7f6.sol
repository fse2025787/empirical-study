...
Web, TG link, and more will be updated as we get closer to launch.

Utility - Stake post-merge without the req 32 ETH, but still receive the rewards + holders of the token will receive 2% just for holding (stakers receive more!)
