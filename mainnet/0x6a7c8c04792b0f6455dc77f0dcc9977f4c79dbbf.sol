...
// File: WorldcupChampion/IOperatorFilterRegistry.sol
...
// File: WorldcupChampion/OperatorFilterer.sol
...
// File: WorldcupChampion/IERC721A.sol
...
// File: WorldcupChampion/ERC721A.sol
...
// File: WorldcupChampion/WorldcupChampion.sol
...
contract WorldcupChampion is DefaultOperatorFilterer, ERC2981, ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant MAX_SUPPLY = 6790;
    uint256 public RESERVED = 679;
    ...
    constructor(string memory _initBaseURI) ERC721A("WorldcupChampion", "WCC") {
    ...
    public view virtual override(ERC2981, ERC721A)
    returns (bool) {
