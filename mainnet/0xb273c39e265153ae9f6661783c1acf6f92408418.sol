...
/** 
    ...
    It is by telepathy that we find that one treasure. 
    Unlock your extra-sensory perception by being in tune with the universe. 
    This is the path to financial freedom and success, this is Telepathy! 

    Twitter: https://twitter.com/EspTelepathy
    Website: https://telepathyesp.com
...
contract Telepathy is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0Bf74ab91084eD385f9358e6569A245D1FFc9D27); // Marketing Address
    address payable public multiSigAddress = payable(0x0Bf74ab91084eD385f9358e6569A245D1FFc9D27); // Marketing Address
    address payable public devAddress = payable(0x0Bf74ab91084eD385f9358e6569A245D1FFc9D27); // Dev Address
    address payable public liquidityAddress = payable(0x0Bf74ab91084eD385f9358e6569A245D1FFc9D27); // Liquidity Address
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                if(!tradingActive || (tradingActiveBlock > 0 && tradingActiveBlock + deadBlocks > block.number)){
                    _isSniper[to] = true;
                }
