...
Ethermoon
🌑🌑🌑
Hello to all the inhabitants of the galaxy💫
🚀👨‍🚀👨‍🚀👨‍🚀👨‍🚀🚀
Neil Armstrong could not imagine that it would be possible to mint coins on the Moon.  
But thanks to Ethermoon, this has become possible. EtherMoon allows the creation of fungible assets, “synthetics”, that track the price of real world assets🛸🛸🛸
EtherMoon synthetics are intended to be used as key building blocks in smart contracts, and to bring the world’s assets to the blockchain🔗🔗🔗
🔹🔹🔹
Buy our token on Uniswap faster and conquer the moon
🔹🔹🔹
...
https://twitter.com/ethermoonerc20

https://t.me/ethmoonorg
...
contract EthMOON is Context, IERC20, Ownable {
    ...
    string private _name = 'ETHERMOON';
    string private _symbol = 'ethmoon.org';
