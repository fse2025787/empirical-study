...
/** https://t.me/ebisuinuerc20_portal
 *
*/ 
...
contract EbisuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Ebisu Inu";
    string private _symbol = "EBINU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x3144f51641f0e9a02A20AF97a76264B4C765D20F);
    address payable private taxWallet2 = payable(0x9b8228e1F4caC9ce35631287aA896B4AEaCce7F4);
    ...
    uint256 public _sellDevelopmentFees = 2;

    uint256 public _liquidityShares = 0;
    uint256 public _marketingShares = 6;
    uint256 public _developmentShares = 4;
