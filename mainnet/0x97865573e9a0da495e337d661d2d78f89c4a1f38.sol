...
contract FvckAndrewTate is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 500_000 * 10**8;
    ...
    string private constant _name = "Fvck Andrew Tate";
    ...
    uint256 public _maxTxAmount = 10000 * 10**8;
    uint256 public _maxWalletSize = 15000 * 10**8;
