...
contract JesusIsKing is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Jesus is King";
    ...
    uint256 private constant _tTotal = 1225001225 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x167b80fAF2D00064f70f7383166F2f9093294b79); 
    address payable private _marketingAddress = payable(0xD4f845508150Ec61eAB095E80845C83F3Ad565F2); 
    ...
    uint256 public _maxTxAmount = 36693669 * 10**9; 
    uint256 public _maxWalletSize = 36693669 * 10**9; 
    uint256 public _swapTokensAtAmount = 12250 * 10**9; 
