...
contract ADOGDAO is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xBB5b6e44B13344Ed5d24AF4317A15f69205b4ce8));

    string private _name = "ADOGDAO";
    string private _symbol = "ADDAO";
