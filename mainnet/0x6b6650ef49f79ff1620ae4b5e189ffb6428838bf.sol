...
contract ERC20 is Context, IERC20, Pausable,Ownable  {
    ...
    function ADD_Freezing(address _addr) onlyOwner() public{
    ...
    function deleteFromFreezing(address _addr) onlyOwner() public{
...
contract MiliCoin is ERC20,ERC20Burnable {

    constructor(uint256 initialSupply) public ERC20("MiliCoin", "MLC") payable {
