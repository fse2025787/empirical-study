...
/**
 * @title BadSantaApes contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract BadSantaApes is ERC721, Ownable {
    using SafeMath for uint256;

    string public BSA_PROVENANCE = "";

    uint256 public startingIndexBlock;

    uint256 public startingIndex;

    uint256 public constant apePrice = 100000000000000000; //0.08 ETH

    uint public constant maxApePurchase = 9000;
    ...
    */
    function mintApe(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxApePurchase, "Can only mint 9000 tokens at a time");
