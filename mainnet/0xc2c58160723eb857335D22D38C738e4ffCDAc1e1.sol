...
contract MekawaiiNft is ERC721A, Ownable, ERC2981, OperatorFilterer {
    uint256 public price = 0.0169 ether;
    uint256 public presalePrice = 0.0169 ether;
    ...
    address[] public withdrawAddresses = [0x82B27985DCCB03FB7fc541B94c661c90Cd5dE2f0, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x1be1b574750474f8c8e0970ed49ed2cda8804c1683b527e4858411f24fc0e759;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xC4C45570D2F257E5b51b9A6c24401ed995C086da, _royaltyAmount);
    }
