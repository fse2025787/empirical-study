...
\_   _____/|  | ___.__.\_____  \______\______ \ |__| ____  
 |    __)  |  |<   |  | /   |   \_  __ \    |  \|  |/ __ \ 
 |     \   |  |_\___  |/    |    \  | \/    `   \  \  ___/ 
 \___  /   |____/ ____|\_______  /__| /_______  /__|\___  >
     \/         \/             \/             \/        \/ 

        Telegram:   https://t.me/flyordieerc
...
contract FlyOrDie is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x2033c66593E5a8e6d977Ce3625210db193f00cc8));
    ...
    string private _name = "FlyOrDie";
    string private _symbol = "FOD";
    ...
    uint256 public _maxTxAmount = 75 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 280 * 10**19 * 10**9;
