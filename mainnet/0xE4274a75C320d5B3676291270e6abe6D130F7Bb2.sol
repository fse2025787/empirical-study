...
contract SOS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Son Of Saitama";
    string private constant _symbol = "SOS";
    ...
    address payable private _marketingAddress = payable(0x941962CD5d294eAe905c9287d78078be0DfEb563);
