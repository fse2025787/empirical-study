...
contract MDI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Mother's Day Inu";//
    string private constant _symbol = "MDI";//
    ...
    uint256 private _liqFeeOnBuy = 3;
 
    //Sell Fee
    uint256 private _redisFeeOnSell = 0;//
    uint256 private _taxFeeOnSell = 14;//
    uint256 private _liqFeeOnSell = 11;
    ...
    address payable private _marketingAddress = payable(  0xCAb72c4b41cFFC93F8f61929a48585777199682b);
