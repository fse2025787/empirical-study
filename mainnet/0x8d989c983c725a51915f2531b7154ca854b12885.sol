...
Much that once was, now is lost.
The crypto world became a shitfest….a hero was needed, more than ever.

Have no fear, because Señor Shit is here!

He is on a mission to bring back joy and save the crypto world.
This shitfest, needs its leader.

Tax: 5/5

Telegram: https://t.me/senorshit
Twitter: https://twitter.com/senorshiteth
...
contract SenorShit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Senor Shit";
    string private constant _symbol = "SENOR";
    ...
    constructor () {
        _feeAddrWallet = payable(0x46852019464FdBA53DA57de8184e73Ca95BBc886);
