...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x64773A23C363CfE9208D5336d2f7b3bAAaa607d7];
  address public erc20Payable = 0x64773A23C363CfE9208D5336d2f7b3bAAaa607d7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSUU8QNkrHru39FkphNEhKMBK8GqQugR4kweu2jtMprnB/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8lUxOK0rQMCwDQdK2dlR/contract-metadata";
  }
...
// File: contracts/CyberwearwomenContract.sol
//

pragma solidity ^0.8.0;

contract CyberwearwomenContract is RamppERC721A {
    constructor() RamppERC721A("CYBERWEAR WOMEN", "CB WOMEN"){}
}
