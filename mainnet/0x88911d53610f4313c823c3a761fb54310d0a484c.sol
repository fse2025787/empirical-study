...
contract TheGoldenWeek is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Golden Week";
    string private constant _symbol = "Huangjin Zhou";
