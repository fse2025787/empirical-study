...
/**
    ...
    https://twitter.com/BreakingNewBbc/status/1567883236763901958
*/
...
contract ElizabethInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"Elizabeth Inu";
    ...
    address payable private _developmentAddress = payable(0x7970109903DB2F034A4f1A2CB44103C540C4cE75); 
    address payable private _marketingAddress = payable(0x7970109903DB2F034A4f1A2CB44103C540C4cE75);
