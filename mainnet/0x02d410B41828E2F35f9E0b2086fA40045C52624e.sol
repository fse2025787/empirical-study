...
contract MoonProject is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmb4xibYVxuVnUJtVLcBS4gMxZ26NHkuMnquLHkv9CrkVn";
    ...
    constructor(
    ) ERC721A("Moon Project", "DarkSide", 100, maxSupply) {
    }
