...
Two Chinese giant pandas "Sihai" and "Jingjing" arrived in Qatar by special plane. 
Pandas will appear in Qatar during the World Cup, 
which will bring more wealth and happiness to everyone

🗣TG:https://t.me/QatarPandalnu

👉Twitter:https://twitter.com/QatarPandalnu
...
contract QatarPandaInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Qatar Panda Inu";
    string private constant _symbol = unicode"QPD";
