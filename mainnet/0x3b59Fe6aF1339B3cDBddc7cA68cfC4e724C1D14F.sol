...
/**
    https://t.me/SalarymansClubToken
*/
...
contract SalarymansClub is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Salaryman's Club", "SMC") {
    ...
    function _transfer(
        ...
        if(takeFee){
            if(tradingActiveBlock + 1 >= block.number && (automatedMarketMakerPairs[to] || automatedMarketMakerPairs[from])){
                ...
                tokensForOperations += fees * 65 / 99;
            }
