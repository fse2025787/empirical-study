...
contract TITAN is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Titan";
    ...
    address public marketing = 0x3bfFd0d0cd8997b28E9245CdfA6ECFbf9d7f8Dc2;
    ...
    constructor () {
        ...
        _transfer(_msgSender(), address(0), 227500000 * 10**18);
