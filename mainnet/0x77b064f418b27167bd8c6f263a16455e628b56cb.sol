...
address _owner;
address payable public marketingAddress = payable(0x05905e1FD1F737cF35E446d5FBBdDfeA7797f273);
...
uint256 private buymktFee = 3;//0
uint256 private buyPrevmktFee = 0;
uint256 TAIKOCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > TAIKOCOINDaycooldown, "You cant call TAIKOCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function TAIKOCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    TAIKOCOINDaycooldown = block.timestamp + 86400;
}
