...
/*
    Shikoku Inu is a fighting dog and is the only breed still used in Japanese dog fighting. 
    Ownership is restricted in some countries as a dangerous breed.
    
    TG LINK: https://t.me/ShikokuInuEth
...
contract ShikokuInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = address(0x1702bcC57c786115deD3B719Ef8722061e1CA0CE);

    string private _name = "Shikoku Inu";
    string private _symbol = "SHIKINU";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 4;
