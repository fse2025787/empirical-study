...
// File: contracts/project_s3cr3t.sol
...
contract S3CR3T is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    // PASSWORD: vN}vyFJtFivw
    string public tokenName = "S3CR3T";
    string public tokenSymbol = "S3CR3T";
    uint256 public maxSupply = 6602;
    uint256 public maxReservedSupply = 100;
    uint256 public reservedSupplyMinted = 0;
    
    uint256 public freeMintSupply = 6602;
    uint256 public freeMintPrice = 0;

    uint256 public wlMintAmount = 1;
    uint256 public freeMaxMint = 5;
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        if (currentSupply < freeMintSupply) {
            ...
            require(msg.value >= _mintAmount * freeMintPrice, 'Insufficient funds!');
        }
        _;
    }
    ...
    function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) whenPublicActive noContract {
