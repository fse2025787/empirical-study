...
contract RowaInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 120_000_000 * 10**8;
    ...
    string private constant _name = "Rowa Inu";
    string private constant _symbol = "ROWA";
    ...
    uint256 private _maxTxAmount = 2_400_000 * 10**8;
    uint256 private _maxWalletSize = 2_400_000 * 10**8;
