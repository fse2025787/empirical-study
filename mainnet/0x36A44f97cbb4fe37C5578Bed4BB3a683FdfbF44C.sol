...
Five Elements (5E) tokens combines the power of the five elements and boost it in the cryptomarket to make the next new mooner.
...
contract FiveElementsETH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Five Elements";
    string private constant _symbol = "5E";
