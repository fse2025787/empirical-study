...
contract InfinitySwap is Context, IERC20, Ownable {
    ...
    string private constant _name = "Infinity Swap";
    ...
    constructor () {
        ...
        _liquidityWallet = payable(address(0x555eF332Cf83b825aBbD14009f603e67C1c53046));
        _rOwned[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MarketingWallet] = true;
        _isExcludedFromFee[_liquidityWallet] = true;
        emit Transfer(address(0x555eF332Cf83b825aBbD14009f603e67C1c53046), _msgSender(), _tTotal);
    }
