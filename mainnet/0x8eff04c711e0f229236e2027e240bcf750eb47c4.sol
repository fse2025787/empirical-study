...
contract HomiesNFT is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("Homies NFT", "HOMIES", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmRKS6wxUaTdBhG1uW1DAaTuHwD5Yykg8txkzzg3yv4e2F/hidden.json");
  }
