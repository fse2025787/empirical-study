...
contract TheHakaman is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicn46beawbjzctkd7zmwszpv5fkugq265iv3kniq2ph6xzxpyyqjm/", Strings.toString(tokenId), ".json")
            );
    }
