...
contract Reality is ERC20, Ownable {
    ...
    constructor() ERC20("A Dream Within A Dream", "Reality") {
        ...
        devWallet = address(0x06464FFbaCefB308b8FF55BACcfEc52C86EA1dF6); // set as dev wallet
