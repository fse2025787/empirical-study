...
contract JailedApeYachtClub is ERC721A, Owneable {

    string public baseURI = "ipfs:///";
    string public contractURI = "ipfs://QmWBWMJR9XDBtd3chcBzswTVM5avxGMQBxFeKze4kbX25W";
    ...
    constructor() ERC721A("Jailed Ape Yacht Club", "Jailed") {}

    function mint(uint256 _amount) external payable {
        //the apes are jailed.  a mutation will break them out.  a serum will be coming.
    ...
    function Breakout() external onlyOwner {
...
//Future Use
        function jail(uint256[] memory tokenids) external onlyOwner {
