...
Welcome to Dog Season!

All Dogs Go to the Moon..

Read: https://medium.com/@dogseason

Links:
https://dogseason.io/
https://t.me/DogSeason
https://twitter.com/DogSeasonERC
...
contract DogSeason is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(10,10); 
        setSellTax(10,10); 
        setTaxWallets(0xFB22dc348C5014f2486A2735a9177D8C83A7dd16); 
        exclude(msg.sender);
