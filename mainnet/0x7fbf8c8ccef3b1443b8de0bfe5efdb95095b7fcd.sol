...
contract WeAreChineseApes is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.005 ether;
    uint256 public MAX_SUPPLY = 1111;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "https://ipfs.io/ipfs/Qmf7VZziui79nkVaZGVFvw2itkdunRMmd3BgbxUbivXgBV/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("We Are Chinese Apes", "CHINESE", MAX_MINTS, MAX_SUPPLY) {  
    }
