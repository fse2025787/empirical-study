...
contract Poopies is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Poopies Genesis", "Poopies"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Poopies");
    require(mintEnabled, "Minting is not live yet, hold on Poopies.");
