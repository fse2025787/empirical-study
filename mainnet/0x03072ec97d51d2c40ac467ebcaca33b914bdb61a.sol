...
contract SkulSerum is ERC1155, Ownable, Signed, Pausable, ReentrancyGuard {
    ...
    mapping(uint256 => mapping(address => bool)) alreadyClaim;
    ...
    function stakeSkul(uint256[] calldata nftIds) public whenNotPaused {
    ...
    function claim(
        ...
        for (uint256 i; i < nftIds.length; i++) {
            require(
                alreadyClaim[nftIds[i]][msg.sender] == false,
            ...
            alreadyClaim[nftIds[i]][msg.sender] = true;
