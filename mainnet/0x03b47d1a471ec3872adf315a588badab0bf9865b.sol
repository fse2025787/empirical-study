...
// File: contracts/Lil Baby Meebits.sol
...
contract LilBabyMeebits is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("LilBabyMeebits", "LBM", maxBatchSize_, collectionSize_) {
...
/* 
  ...
  function mintFreeFirst1000(uint256 quantity) external payable {
    ...
    require(quantity <= 10, "Cant mint more than 5");
    require(totalSupply() + quantity <= 1000, "Sold out");
    require(minted[msg.sender] + quantity <= 10, "Cant mint more than 5 per wallet");
