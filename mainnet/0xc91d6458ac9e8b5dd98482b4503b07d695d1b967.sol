...
contract HHRoyals is ERC721A, Ownable {
    using Strings for uint256;
   
    string public uriPrefix;
    string public uriSuffix = ".json";
    string public hiddenMetadataUri = "ipfs://QmU8KFoeWyh3arAUxURjEgpKbtcCB68D867xPpAf1pVXCr/unreveal.json";
    ...
    uint256 maxMintAmountPerTx = 7;
    uint256 public mintRate = .088 ether;
    uint256 public preSaleMintRate = .088 ether;
