...
contract WhaleInu is ERC20, Ownable {
    ...
    constructor() ERC20("Whale Inu", "WhaleInu") {
        ...
        devWallet = address(0xe58839131E169EE01a96366c85f077ec8B1EA450); // set as dev wallet
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
       ...
       function whitelist(address[] memory account) public onlyOwner {
        ...
        if (limitsInEffect) {
            if (
                ...
                if (!tradingActive) {
                    ...
                    if(whiteListEnabled){
                require(isWhitelisted[to], "You are not whitelisted to buy at the moment");
