...
// You buy on Ethereum, we execute algorithmic stablecoin strategies on various chains and return the profits to $AGFI holders.

//Initial Supply: 1,000,000,000,000 $AGFI 
//60% of $AGFI burned to 0x0dEaD
//10% of each buy goes to existing holders.
//10% of each sell goes into various-chain algorithmic stablecoin investing to add to the treasury and buy back $AGFI tokens.

// Twitter: https://twitter.com/AGFI_Official
// Website: https://aggregated.finance/
// Telegram: https://t.me/aggregatedfinance
...
contract AggregatedFinance is Context, IERC20, Ownable {
    ...
    string private _name = 'AggregatedFinance';
    string private _symbol = 'AGFI';
    ...
    address payable public _AGFIWalletAddress;
    ...
    constructor (address payable AGFIWalletAddress, address payable marketingWalletAddress) {
        _AGFIWalletAddress = AGFIWalletAddress;
    ...
    function sendETHToTeam(uint256 amount) private {
        _AGFIWalletAddress.transfer(amount.div(2));
    ...
    function _setAGFIWallet(address payable AGFIWalletAddress) external onlyOwner() {
        _AGFIWalletAddress = AGFIWalletAddress;
    }
...
// File: contracts/AGFIGovenor.sol
