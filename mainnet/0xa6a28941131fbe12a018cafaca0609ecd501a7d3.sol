 ...
 * allowances. See {IERC20-approve}.
 */
contract SHIKA is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Kami-no-Shisha";
    string private _symbol = "SHIKA";
    uint8 private _decimals = 9;
    uint256 private _supply = 6000000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 120000000 * 10**_decimals;
    uint256 public maxWalletAmount = 120000000 * 10**_decimals;
    address public marketingWallet = 0xBab8fe6ab338f40da2fa5f31e8DC2DB69bE257f9;
    // TOKENOMICS END ============================================================>
