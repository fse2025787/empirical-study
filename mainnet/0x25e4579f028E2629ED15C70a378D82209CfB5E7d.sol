...
contract DDS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0x775300FFd7Cf609175D1e170083AFD46Be7BA6B7); // Marketing Address
    ...
    uint256 private _tTotal = 1300000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'DDS.Store';
