...
contract TetsuInu is Context, IERC20, Ownable {
    ...
    constructor () {
        // multisig wallet requiring 3/4 signatures for transaction
        _marketingFeeAddr = payable(0x3fdDD9790290e6126b00b047818D30d9504AAe1B);
        // multisig wallet requiring 4/4 signatures for transaction 
        _devFeeAddr = payable(0xd8B924446A4Ef94Ec1Dab5BA54bAe70674bAe484);
        _rOwned[_msgSender()] = _rTotal;
        _excludedFromFee[owner()] = true;
        _excludedFromFee[address(this)] = true;
        _excludedFromFee[_marketingFeeAddr] = true;
        _excludedFromFee[_devFeeAddr] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingFeeAddr.transfer(amount.div(2));
        _devFeeAddr.transfer(amount.div(2));
    }
