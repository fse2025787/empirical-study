...
https://thenodeprotocol.com
https://t.me/thenodeprotocol

The Node Protocol - The earning environment, for The decentralized people.
...
contract THENODEPROTOCOL is StandardToken {
    string public name = "The Node Protocol";
    string public symbol = "THENODE";
    ...
    function THENODEPROTOCOL() public {
     ...
     */
    function addOwner(address _address) onlyOwner private {
     ...
     */
    function deleteOwner(address _address) onlyOwner private {
     ...
     */
    function deleteMinter(address _address) onlyOwner public {
