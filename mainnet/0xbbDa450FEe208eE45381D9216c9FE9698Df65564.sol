...
// File: contracts/UnlimitedPunks.sol
...
contract UnlimitedPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Unlimited Punks", "uPunks") {
    setHiddenMetadataUri("ipfs://QmcTfszdikQcULdateenzoKMWkoe3Ksr3TgiZcpaR3DwqL/hidden.json");
  }
