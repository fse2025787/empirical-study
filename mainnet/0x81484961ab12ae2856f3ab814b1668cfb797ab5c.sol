...
/** https://t.me/FvckTerareum

Let's Make This A Moon Mission - Terareum DEVS Are Shady & Taking From Investors Because ALL The Top Wallets Are Their Wallets - LET'S GET THIS TRENDING ON DEXTOOLS!!!
*/
...
contract FvckTerareum is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 10_000_000_000 * 10**18;
    ...
    address public marketingWallet = 0x39Fb8957A64F2c7912c301A7b50730B128a45d0E;
    address private devWallet = 0x1bef7293Aa718940990fC11B30456646fDCe4f8d;
    ...
    Taxes public sellTaxes = Taxes(4, 3, 3);
    ...
    constructor() ERC20("FvckTERAREUM", "FvckTERAREUM") {
        ...
        allowedTransfer[0x71B5759d73262FBb223956913ecF4ecC51057641] = true;
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 1_000_000_000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 1_000_000_000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 1_000_000_000, "Cannot set max wallet amount lower than 0.1%");
