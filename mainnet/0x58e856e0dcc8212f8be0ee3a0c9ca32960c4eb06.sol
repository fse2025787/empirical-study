...
// 
// https://web.wechat.com/Wizzakosis.ETH
// https://t.me/Wizzakosis
// https://www.zhihu.com/
// https://wizzakosiseth.com
...
contract ERC2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wizzakosis";////////////////
    string private constant _symbol = "WIZZ";////////////////
    ...
    address payable private _developmentAddress = payable(0xd2D6636De59B8188110745e1ec3cB39913d307dE);////////////////////
    address payable private _marketingAddress = payable(0xd2D6636De59B8188110745e1ec3cB39913d307dE);/////////////////////
