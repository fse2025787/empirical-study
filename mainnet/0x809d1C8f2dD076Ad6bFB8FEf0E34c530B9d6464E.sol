...
contract TwitterDM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Twitter Dark Mode";
    string private constant _symbol = unicode"TWITTERDM";
