...
contract LIGHTYEAR is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "LIGHTYEAR";
    string private constant tokenSymbol = "LIGHTYEARS";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 588e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x84B5095DE07Fd033b0c5dc5CAFFE2f3157EDC910);
        devAddress = payable(0x84B5095DE07Fd033b0c5dc5CAFFE2f3157EDC910);
