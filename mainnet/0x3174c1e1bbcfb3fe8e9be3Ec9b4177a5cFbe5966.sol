...
contract AgoraERC20 is ERC20 {

    constructor() ERC20("Agora", "AGR") {

        // Mint team $AGR allocation to safe.
        _mint(0x5581853b68b9EeE4f91dbA5Ad1202D9375AA5997, 18000000 * 10**18);

        // Deploy S01 and mint remaining tokens.
        AgoraS01 S01 = new AgoraS01(IERC20(address(this)));
        _mint(address(S01), 82000000 * 10**18);
