...
contract ShinaDAO is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x3B9bf4066048Df6B42C65d8D3A7Bd24F6606DA9A));
    ...
    string private _name = "Shina DAO";
    string private _symbol = "SHIDAO";
    ...
    uint256 public _maxWalletSize = 500000 * 10**6 * 10**9;
