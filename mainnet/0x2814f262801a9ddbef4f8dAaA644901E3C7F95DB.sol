...
contract Lottery is VRFConsumerBase, Ownable {
        ...
        override
    {
        ...
        uint256 manegercut=((address(this).balance)*9)/100;
        uint256 contractfee=((address(this).balance)*1)/100;    
        recentWinner.transfer((address(this).balance)-(manegercut+contractfee));
