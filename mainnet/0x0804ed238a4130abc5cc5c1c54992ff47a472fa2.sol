...
// 
/**
CREEPY DOUGH CURRENCY

We are literally paying taxes to fund these cases and they are out here talking about changing the name of cryptocurrency to CREEPY DOUGH CURRENCY 
**/
...
contract CREEPYDOUGHCURRENCY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CREEPY DOUGH CURRENCY";
    string private constant _symbol = unicode"CDC";
