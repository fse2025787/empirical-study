...
TG: https://t.me/WagieInu

Nobody wants to be Wagie. Well this is your opportunity, as a community, 
to take a leap of faith, join Wagie Inu, and transition from Wagies to Chads

The Telegram was set up and owned by a volunteer
...
contract WagieInu is ERC20, Ownable {
    ...
    constructor() ERC20("Wagie Inu", "WINU") {
        ...
        // launch buy fees
        uint256 _buyMarkFee = 8;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevFee = 0;
        uint256 _buyOperationsFee = 0;
        
        // launch sell fees
        uint256 _sellMarkFee = 10;
        ...
        maxTransactionAmount = 40_000_000 * 1e18; // 4% max txn
        maxWallet = 40_000_000 * 1e18; // 4% max wallet
        ...
        markWallet = address(0x5C1C7C7FFAf969D1f5574a0090bD53735f2b755d); 
        devWallet = address(0x5C1C7C7FFAf969D1f5574a0090bD53735f2b755d); 
        liqWallet = address(0x75ac4e6dc589Ee2005d9371F60aFbD71de5bf992); 
        operationsWallet = address(0x5C1C7C7FFAf969D1f5574a0090bD53735f2b755d);
