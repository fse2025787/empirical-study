...
Initial max buy: 20,000,000 (2% supply)
...
contract GowldMongoose is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gowld Mongoose";
    string private constant _symbol = "GMongoose";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x204B8F0c25A0549C8d7B673769b73DF4c15Ef7Ba); 
