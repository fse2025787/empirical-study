...
// File contracts/HaremsFreeDrop.sol
...
contract HaremsDrop is ERC721, ERC721Enumerable, Ownable {
   

    using SafeMath for uint256;
    // Make sure you have enough you change this to mainnet Harems Contract address before deploy
    ERC721 harems = ERC721(0xfC03dB45C058cf680CfEF6F1Ff3C0B5d82Fd62A4);



    uint256 MINT_PER_HAREMS = 1;
    ...
    constructor() ERC721("HaremsLive", "Season 1") {
        _saleStarted = false;
    }
    ...
    modifier whenSaleStarted() {
       ...
       function HaremsFreeClaim(uint256 tokenId) public whenSaleStarted {
        // Require the claimer to have at least one Harems from the specified contract
        require(tokenId > 427 && tokenId < 628, "Token ID invalid");
        require(harems.ownerOf(tokenId) == msg.sender, "Not Harems owner");
         // Set limit to no more than MINT_PER_HAREMS times of the owned Harems
        require(super.balanceOf(msg.sender) < harems.balanceOf(msg.sender) * MINT_PER_HAREMS, "Purchase more Harems");
