...
contract SAYLOR is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Michael Saylor Inu";//
    string private constant _symbol = "SAYLOR";//
    ...
    address payable private _developmentAddress = payable(0x5fc7A55D847ac7F07c1358078B741875A03e946E);//
    address payable private _marketingAddress = payable(0xb9Bd832aCCB7dfB8A6f6aD953BA095e4570dD5dA);//
