...
$MOBBY is a service that informs the investor about the token by generating a report with tokenomics, holders, remaining Uniswap liquid amount, renounceship, Market Cap, LP Lock data, maximum transaction limit and malicious code scanning of the requested token.


We develop tools to minimize the risk of scam by doing the hardest on the Ethereum chain, where the probability of scam is the highest.

Tax : 0/0

Telegram : https://t.me/mobbyscannerbot
...
contract MOBBY is IERC20, Ownable {
