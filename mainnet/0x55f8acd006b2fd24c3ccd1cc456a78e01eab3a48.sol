...
contract MacDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 440 * 10**21 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0xE681E17b797dEd467Eb3C06B369Bfefee9365E32));
    address payable public _devwallet =
        payable(address(0x2B944d5C1f075Efe78782d7A8029F056BbbC58B8));
    address public _exchangewallet =
        payable(address(0x1A3c9fd743936de468206eB0909E863871035208));
    address _partnershipswallet =
        payable(address(0xff12658D104d6698D8742aA68fAAa34089f1c18d));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "MacDoge";
    string private _symbol = "Macdoge";
    ...
    uint256 public _maxTxAmount = 220 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 220 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 440 * 10**19 * 10**9;
