...
contract DOPAMINU is ERC20, Ownable {
    /* Token Tax */
    uint16 public _taxTotal = 1000; // 10% tax
    ...
    constructor() ERC20('DOPAMINU', 'DOPAMINU') payable {
      _totalSupply = 888888888888888888888888888888888;
