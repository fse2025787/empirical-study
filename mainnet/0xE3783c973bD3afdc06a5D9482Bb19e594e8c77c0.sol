...
//*********************************************************************//
//
//     ___    __                 ____    ________    _     _       __           __    __
//    /   |  / /___  ____  ___  /  _/___/_  __/ /_  (_)___| |     / /___  _____/ /___/ /
//   / /| | / / __ \/ __ \/ _ \ / // __ \/ / / __ \/ / ___/ | /| / / __ \/ ___/ / __  / 
//  / ___ |/ / /_/ / / / /  __// // / / / / / / / / (__  )| |/ |/ / /_/ / /  / / /_/ /  
// /_/  |_/_/\____/_/ /_/\___/___/_/ /_/_/ /_/ /_/_/____/ |__/|__/\____/_/  /_/\__,_/   
//                                                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x019aAf230822ED9aCC707f94bff8F833D32022eD];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdSEKoaJRcordz1opVajAVLcCLa8Tq974hJ8qrrxN4dwo/";
...
// File: contracts/AloneInThisWorldContract.sol
//

pragma solidity ^0.8.0;

contract AloneInThisWorldContract is RamppERC721A {
    constructor() RamppERC721A("AloneInThisWorld", "AITW"){}
}
