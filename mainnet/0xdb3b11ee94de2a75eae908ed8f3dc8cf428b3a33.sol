...
contract GoblinBoyz is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRfoPDENZ27LYhmBE1FAv2jLDRNoJrA6toxNDHM7Mczuc";
    ...
    constructor(
    ) ERC721A("Goblin Boyz", "B0YZ RULE", 100, maxSupply) {
    }
