...
contract WeedAndMorty is Context, IERC20, Ownable {
	...
	string private constant _name = "Weed And Morty";
	string private constant _symbol = "WEEDNMORTY";
