...
// File: contracts/weareallgoingtofight.sol
...
// ERC721A Contracts v4.0.0
    ...
    contract WeAreAllGoingToFight is Ownable, ERC721A {
    uint256 public maxSupply                    = 1111;
    uint256 public maxFreeSupply                = 444;
    ...
    address constant internal TEAM_ADDRESS = 0xa67DB4ffc6001B297e799F2F5F5Ee04d8A943BC7;
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmX1CPr1HskTaC9W4oyovgd7DfgYGkuoEwAbDcze29jTRp/";
    string public constant baseExtension = ".json";
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("We Are All Going to Fight", "WAGFIGHT") {_safeMint(msg.sender, 1);}
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        require(_exists(_tokenId), "Token does not exist."); return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, Strings.toString(_tokenId), baseExtension)) : "";}
