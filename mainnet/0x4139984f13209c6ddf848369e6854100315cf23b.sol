...
contract Viadukt is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPvYeKMCj8TmpUr3W7SHVpkGHempBCt4UXvEbmYzVSA8w";
    ...
    constructor(
    ) ERC721A("Viadukts Towers", "Viadukt", 100, maxSupply) {
    }
