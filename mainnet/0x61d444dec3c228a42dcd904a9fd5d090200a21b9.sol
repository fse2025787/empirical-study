...
contract TheSeekers is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x0c9044dC2CF2c22D7065FF012FC0DE288cd302B6);
    address payable private _marketingAddress = payable(0x0c9044dC2CF2c22D7065FF012FC0DE288cd302B6);
    ...
    function walletSet(address[] calldata accounts, bool excluded) public onlyOwner {
