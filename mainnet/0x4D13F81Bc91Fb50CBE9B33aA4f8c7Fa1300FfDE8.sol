...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656713400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656712800;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xACBDA43a420cab424a43C7EcEA8cAfa019C0E13a,0x260983195b436a3eD26348f6A1D107f79dDBAE23];
  uint256[] public payableFees = [5,18,77];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 6000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQoqXjndoW5UBgFyNvzTeXSkboudQzHwbvwdEs1ZR4neU/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6000");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6000");
...
// File: contracts/WarloxContract.sol
//

pragma solidity ^0.8.0;

contract WarloxContract is RamppERC721A {
    constructor() RamppERC721A("Warlox", "Warlox"){}
}
