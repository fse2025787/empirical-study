...
/**
Make your own Telegram and share videos if you like
https://homeclips.com
https://homeclips.com/faqs for crypto memberships
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract Homeclips is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Homeclips.com";
    string private _symbol = "Homeclips";
    uint8 private _decimals = 9;
    uint256 private _supply = 69000;
    uint256 public taxForLiquidity = 2;
    uint256 public taxForMarketing = 6;
    uint256 public maxTxAmount = 1380 * 10**_decimals;
    uint256 public maxWalletAmount = 2760 * 10**_decimals;
    address public marketingWallet = 0x89f8a1499028B21aa3dF4b7442D80C92e021998b;
    // TOKENOMICS END ============================================================>
