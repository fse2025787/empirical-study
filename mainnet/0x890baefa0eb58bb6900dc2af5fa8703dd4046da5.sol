...
Website - Dig for our Web!
Telegram - Dig for our Telegram!
Twitter - Dig for our Twitter!
...
contract RAMEN is Context,IERC20, Ownable{
 ...
 address _owner;
 address payable public marketingAddress = payable(0x79593bA79d632Da2F0B5DE71df8CEFb721781697);
 ...
 //Tokenomics related functions
  function RAMENDay() public onlyOwner{
      require(block.timestamp > RAMENDaycooldown, "You cant call RAMENCoinDay more than once a day");
 ...
 function RAMENCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      RAMENDaycooldown = block.timestamp + 86400;
 }
