...
// Dependency file: contracts/OniBean.sol
...
// Dependency file: contracts/library/CurveLib.sol
...
// Dependency file: contracts/Swapper.sol
...
// import "contracts/library/CurveLib.sol";
...
// Dependency file: contracts/library/WETH9.sol
...
// Dependency file: contracts/library/ChainLinkFeed.sol
...
// Dependency file: contracts/OniPool.sol
...
// import "contracts/OniBean.sol";
// import "contracts/Swapper.sol";
// import "contracts/library/WETH9.sol";
// import "contracts/library/ChainLinkFeed.sol";

// BEAN lending pool
// Docs:
contract OniPool is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function borrow(
        ...
        if (_assetAmount > 0) {
            ...
            accountInfo[_borrower].totalAsset = accountInfo[_borrower].totalAsset.add(_assetAmount);

            IERC20(assetInfo.token).safeTransferFrom(msg.sender, address(this), _assetAmount);
        }
...
// Root file: contracts/OniPoolETH.sol
