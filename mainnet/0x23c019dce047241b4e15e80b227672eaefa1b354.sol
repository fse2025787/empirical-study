...
/***************************
$HexSD is a low-tax memecoin inspired by Shiba, Doge & Hex. Our goal is to become one of the hottest memecoin on both ERC20 and Hex. Make ShibDoge great again.
https://t.me/HexShibaDoge
https://hexshibdoge.com
https://twitter.com/hexshibadoge
****************************/
// 
...
contract HEXSD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420 * 10**15 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tReflectionFeeTotal;
    uint256 private _tBurnFeeTotal;

    string private _name = "Hex ShibaDoge";
    string private _symbol = "HEXSD";
    ...
    address public marketingTokenFeeWallet = 0x2C3BaDd9D4EfbeAe34Dc904bd5D38cF231DbC21E;
    address public marketingETHFeeWallet = 0x2C3BaDd9D4EfbeAe34Dc904bd5D38cF231DbC21E;
    ...
    uint256 public _maxTxAmount = 840 * 10**13 * 10**9;//2% maxTxAmount
    uint256 public _maxWallet = 840 * 10**13 * 10**9;//2% maxWallet
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 420 * 10**13 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
