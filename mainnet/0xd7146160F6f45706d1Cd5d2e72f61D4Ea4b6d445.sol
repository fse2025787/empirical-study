...
// 
/*
Tax: 3/3 - Liquidity and Reflections.

Telegram: https://t.me/Suzushib
Twitter: https://twitter.com/SuzushibERC
Website: https://medium.com/@Suzushib/the-story-of-suzushib-79a8b02f36eb
...
pragma solidity ^0.6.12;
    ...
    contract Suzushib is Context, IERC20, Ownable {
        ...
        string private _name = 'Suzushib';
        string private _symbol = 'SUZU';
        uint8 private _decimals = 9;
        
        uint256 public _liquidityFee = 3;
        uint256 private _ReflectionsRate = 16;
        ...
        address payable public _FundingWallet;
        ...
        constructor (address payable FundingWalletAddress) public {
            ...
            _FundingWallet = FundingWalletAddress;
            _isExcludedFromFee[FundingWalletAddress] = true;
        ...
        function sendETHToMarketing(uint256 amount) private {
            _FundingWallet.transfer(amount.mul(3).div(8));
        ...
        function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
            (uint256 tTransferAmount, uint256 tFee, uint256 tMarketing) = _getTValues(tAmount, _taxFee, _ReflectionsRate);
            uint256 currentRate =  _getRate();
        ...
        function _setFundingWallet(address payable FundingWalletAddress) external onlyOwner() {
            _FundingWallet = FundingWalletAddress;
