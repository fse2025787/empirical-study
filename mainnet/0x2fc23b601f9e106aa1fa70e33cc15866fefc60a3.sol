...
contract KoiToken is ERC20 {
    ...
    constructor() ERC20("Koi Metaverse Token", "KOI") public {
        owner = _msgSender();
    ...
    function addToBlocklist (address _user) public {
        require(_msgSender() == owner, "KOI: Not allowed");
        blacklist[_user] = 1;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        ...
        require(blacklist[from] == 0 && blacklist[to] == 0, "KOI: Transfer Not allowed"); 
    }
