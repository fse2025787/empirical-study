...
web : horsefarm.io
telegram : t.me/horsefarmio
twitter : twitter.com/HorseFarmIo
medium : medium.com/horsefarmio
*/
...
contract HorseFarmEth is ERC20, Ownable {
    ...
    uint256 public lpBurnFrequency = 5400 seconds;
    ...
    mapping (address => uint256) private _earlyBlockNumber;
    mapping (uint256 => uint256) public _stats;
    mapping(address => bool) public bots;
    uint256 private txThreshold = 6;
    ...
    constructor() ERC20("HorseFarm", "HRS") {
        ...
        devWallet = address(0x8CbEd2B4Ab5Ef1D880737B07dA6B5A1F591CFC9E);
        stakingRewardsWallet = address(0x0dd4688af414A3068a3D1eBd86f6f6EebB7aD59D);
        liquidityReceiver = address(0x497F7c4e168e2373384c25D8aC5cA8E5fAeEe3ba);
    ...
    {
        require(_msgSender() == devWallet, "!dev address");
    ...
    function updateStakingRewardsWallet(address newStakingRewardsWallet)
        external
    {
        require(_msgSender() == stakingRewardsWallet, "!staking rewards address");
        ...
        external
    {
        ...
        emit liquidWalletUpdated(newLiquidReceiver, liquidityReceiver);
    ...
    function _transfer(
            ...
            if (
                ...
                if (
                    ...
                    if(block.number <= launchBlock + deadBlocks) {
                        _earlyBlockNumber[tx.origin] = block.number;
                    }
                }
                //when sell
                else if (
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                bool detectSniper = _stats[block.number - 1] > txThreshold || _earlyBlockNumber[from] > 0;
                ...
                if (detectSniper) {
                    _sellLiquidityFee = 1; _sellDevFee = 32; _sellStakingRewardsFee = 15;
    ...
    function swapBack() private {
        ...
        uint256 stakingFeeTokens = balanceOf(stakingRewardsWallet);
        // Halve the amount of liquidity tokens
        uint256 liquidityTokens = (contractBalance * tokensForLiquidity) /
            totalTokensToSwap /
            2;
        uint256 amountToSwapForETH = contractBalance.sub(liquidityTokens)
            .sub(stakingFeeTokens);
    ...
    function claimETHBalance() external {
        require(_msgSender() == devWallet);
