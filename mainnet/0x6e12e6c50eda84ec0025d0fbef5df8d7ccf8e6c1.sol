...
contract OrphicProtocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Orphic Protocol", "ORPH") {
        ...
        uint256 totalSupply = 222000 * (10 ** 18);
        supply += totalSupply;
        ...
        marketingAddress = 0x2195Ff75aA35496E7329851F849031Da69522b6b;
