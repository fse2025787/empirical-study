...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1659538800;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x352905b439342717b8Ad24243AA36079Ab98f636];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihuw7szjldxmgb4kl7m4rxaa2n6jhbi4waa54dmmtkkhek5taw22q/";
...
// File: contracts/EveryLittleStepContract.sol
//

pragma solidity ^0.8.0;

contract EveryLittleStepContract is RamppERC721A {
    constructor() RamppERC721A("Every Little Step", "ELS"){}
}
