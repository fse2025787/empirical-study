...
contract ThisIsIt is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ThisIsIt", "TIT") {
        ...
        marketingWallet = address(0x3321d97968C96da0429483DEB986dE6A9dB3eFB8); // set as marketing wallet
        devWallet = address(0x3321d97968C96da0429483DEB986dE6A9dB3eFB8); // set as dev wallet
