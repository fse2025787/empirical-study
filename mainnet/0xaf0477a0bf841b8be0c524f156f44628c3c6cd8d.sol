...
contract TimeTravelAliens is ERC721A, Ownable { 

  using Strings for uint256; 

  bytes32 public merkleRoot = 0x6b18b710656f2cfce6c516385c92f96358ec124da5a0e0d1b0fdca21e06c6859; // Add MerkleRoot
  
  string public uriPrefix = "ipfs://Qmdhm6A7ppgDP3HjwCRbEvvHr61ghJM7qprNqS3tGdkSjc/"; // Add ipfs://__CID__/ 
  ...
  uint256 public publicMaxSupply = 8333; 
  uint256 public reservedMaxSupply = 555; 
  ...
  constructor() ERC721A("TTA", "TimeTravelAliens") { // Replace NAME and SYMBOL 
        setHiddenMetadataUri("ipfs://__CID__/hidden.json"); // Replace CID
        ownerMint(15); // Replace uint - Automatic Free Mint for the owner and team 
    } 
