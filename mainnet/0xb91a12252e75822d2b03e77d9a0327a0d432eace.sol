...
contract KINGLUNA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("King Luna", "KLUNA") {
        ...
        prizepoolWallet = address(0x610Ad091d6117006274b70B29Bc44502d5cC1a0b); // set as prizepool wallet
        marketingWallet = address(0xB17D933FF64bf4DbA618E2cCEE99C3c68D565417); // set as marketing wallet
        devWallet = address(0x9Cf7F019C201aD1Baf44C818fd111BB3e8aF6e58); // set as dev wallet
