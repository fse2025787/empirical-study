...
contract WDI is Context, IERC20, Ownable {
    ...
    string private _name = "World Degen Inu";
    string private _symbol = "WDI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xa446183a47859B04F8055DE7C705B14df051C7b9);
    address payable public teamWalletAddress = payable(0xF0D7A264bc069a7fa6751fa2c7D39CFcd86250b2);
