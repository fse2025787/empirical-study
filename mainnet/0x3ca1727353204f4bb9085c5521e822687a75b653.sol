...
contract KYLORINU is ERC20, Ownable {
    ...
    constructor() ERC20("KYLO RINU", "KINU") payable {
    	...
    	marketingWallet = address(0x9D4d4da4E97c0ac59619BD077c54C17541DFFDCC); // set as marketing wallet
        ...
        excludeFromFees(0x53005147C2F70253fEc28D26577A2AeEbC519a9B, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x53005147C2F70253fEc28D26577A2AeEbC519a9B, true);
        ...
        */
        ...
        _createInitialSupply(0x53005147C2F70253fEc28D26577A2AeEbC519a9B, totalSupply*20/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x53005147C2F70253fEc28D26577A2AeEbC519a9B,
            block.timestamp
        );
    }
