...
The AIs are here to party as they take over our realm. Its a scary world out there, anon.

Telegram: t.me/AIPartyERC
...
contract AIParty is Context, IERC20, Ownable
{
    using SafeMath for uint256;

    address payable public marketingAddress = payable(0x539CB90BE24eB3bc64d2c4fba49AA6187CaD9551);
    ...
    uint256 private _tTotal = 1000_000_000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    string private _name = "AI Party";
    string private _symbol = "AI Party";
    ...
    function setAllFees(uint256 buymarketingFee, uint256 sellmarketingFee) external onlyOwner
    {
        ...
        require(_sellmarketingFee<=12, "Too High Sell Fee");
