...
contract Test is Context, IERC20, Ownable {
    ...
    address payable public liquidityWallet = payable(0x2ab1D8d5d6c9E37654DB397799A6D9483128Df9c);
    address payable public operationsWallet =  payable(0x2ab1D8d5d6c9E37654DB397799A6D9483128Df9c);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 10;
    uint256 public totalFeesBuy =10;
    uint256 public maxTotalFeeBuy = 100;

    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 10;
    uint256 public totalFeesSell = 10;
