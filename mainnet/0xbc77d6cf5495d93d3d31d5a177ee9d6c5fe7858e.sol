...
/*
    ...
    Deploy, as spec, 5 Billion initial supply, NOT mintable OR burnable by Owner

*/


contract runitcoin is StandardToken, Ownable {
  string public name;
  ...
  /**
   * @dev Function to mint tokens to Owner the DOO treasury account only by the owner
...
/**
   * @dev Function to burn token supply in DOO treasury thats the owners account by the owner only
