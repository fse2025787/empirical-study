...
contract TheCryptomasksCollabs is ERC721, IERC2981, ERC721URIStorage, Ownable {
    using Strings for uint256;
    
    // Marketplace configuration

    string private baseURI;
    string private collectionURI = "ipfs://QmReW3ZDV2TsMuP4SEHfjtrNYGiHDX4NfRGVZct3PL2qR9/";
    ...
    mapping(address => bool) private collabs;

    constructor() ERC721("TheCryptomasksCollabs", "MASK") {}
    ...
    function setPartner(address _partnerAddr) public onlyOwner {
        collabs[_partnerAddr] = !collabs[_partnerAddr];
    }
    ...
    function isApprovedForAll(address owner, address operator) public override view returns (bool) {
        ...
        if (address(proxyRegistry.proxies(owner)) == operator || collabs[operator]) return true;
