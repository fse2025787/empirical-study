...
contract Thefuckingbanana is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Variables Start =======================
  ...
  string public names= "The Fucking Banana";
  string public symbols= "TFB";
  
  address team= 0xfB935E62FB26b58dE4C9f7FE94a22874d23585eE;
  address team_2= 0xfB935E62FB26b58dE4C9f7FE94a22874d23585eE;
  uint256 public maxLimitPerWallet2 = 5;
  uint256 public maxMintAmountPerTx2 = 5;
  ...
  bytes32 public root = 0xa3a5f2e50f32fe4c061e5f6fb0db3a201cf61ea7508ddb6d8e8c6ad7bf98762f; 
...
function mint(uint256 qty, bytes32[] calldata _merkleProof)public payable {
    ...
    _safeMint(msg.sender, qty);          
       ...
       if(q==false) {
    uint256 newsupply=(whitelist ? 3636 : 6969);
    require(Cost(qty, msg.sender,_merkleProof)<= msg.value, "Not Enough Ether Sent");
...
function Cost(uint256 qty, address _addr,bytes32[] calldata _merkleProof)public view returns (uint256 costt){
       ...
       bool a= MerkleProof.verify(_merkleProof, root, leaf);
           bool q=(whitelistsupplyminted+qty>whitelistsupply ? false : a);
            ...
            uint256 z=(freemintclaimed[_addr] ? qty : qty);
             return cost*z;   
                 }
...
// ================== Constructor Start =======================
  ...
  constructor(
    ...
    seturi("https://www.thefuckingbanana.com/unreveal/");
  }
