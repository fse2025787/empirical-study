...
contract SIMPSONINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SIMPSONINU";
    string private _symbol = "SIMPSONINU";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000000 * 10**_decimals;     
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**_decimals;
    address payable public marketingwallet = payable(0x9419a05cbCECa6d4B8B9A13763f47b7Dc43eCDC0);
