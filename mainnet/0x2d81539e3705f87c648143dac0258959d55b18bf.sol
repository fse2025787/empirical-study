...
contract RED is Context, IERC20, Ownable {
    ...
    string private constant _name = "RED";
    ...
    address payable private _marketingAddress = payable(0xB3C8990417552Ce765287Dea74bBFB1FbdBDc826);
    ...
    uint256 public _maxWalletSize = 3e8 * 10**9;
