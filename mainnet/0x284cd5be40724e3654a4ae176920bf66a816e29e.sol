...
contract Vesting is Context {
    ...
    /**
    * @notice Set the start date of the vesting contract
     */
    function setStartDate(uint256 _start) public onlyCreator {
        start = _start;
        cliff = DateTime.addMonths(_start, cliff_month);
    }
