...
In the Amazon River, there is an indigenous group. Patriarchs and leaders at each of their positions will have a goat skull, each representing a different status/class. 

In this regard, different crypto groups exist and XGoat is one of the emerging groups. XGoat is gathering a group of like-minded investors hoping to unite against the bad guys and make the world clean and peaceful ecosystem. 

We can be G.O.A.T ’Greatest of All Time’
...
contract XGoat is Context, IERC20, Ownable {
    ...
    string private constant _name = "XGoat";
    string private constant _symbol = "XGOAT";
