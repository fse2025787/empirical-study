...
/* ===============================================
* BETONRUG - "If you stop refreshing the price won't go down!"
* BETONRUG is a derivative betting, in which participants do not own the underlying asset they bet * on, such as a token. 
* 7000 Max Supply with 4% deflationary rate
* Website : https://www.betonrug.com
* ===============================================
*/
...
contract BETONRUG is ERC20 {

    constructor () public ERC20("BETONRUG", "BRG") {
        _mint(msg.sender, 7000 * (10 ** uint256(decimals())));
    }
