...
Welcome to $WTFTOKENS
This is our First Legendary Token Launch, $WTFMYOBU.
Same Tokenometrics as Myobu, More Hype.
Myobu Dev Will be Compensated with a % of the Team's Wallet.

Website:
https://www.whattheforktokens.com

Join our Telegram:
https://t.me/whattheforktokens

Twitter:
https://twitter.com/WTFtokens
...
contract Myobu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WTF Myōbu";
    string private constant _symbol = "WTFMYOBU";
