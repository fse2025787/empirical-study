...
contract Oneonetwo is ERC20, Ownable, Pausable, BlackListable {
    using SafeMath for uint;

    bool private tradingOpen;

    uint256 private _initialSupply = 10000 * 10 ** 18;
    uint256 private _maximumHoldingEachAddress = 300 * 10 ** 18;
    uint256 private _limitEachTransaction = 100 * 10 ** 18;
    uint256 private _taxFeePercentBuy = 500; // 100 = 1%
    uint256 private _taxFeePercentSell = 500; // 100 = 1%
