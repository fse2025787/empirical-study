...
contract PRIDEBATMAN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PRIDE BATMAN";
    string private _symbol = "$PBATMAN";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000000 * 10**_decimals;     

    uint256 private minimumTokensBeforeSwap = 5000000 * 10**_decimals;
    uint256 public _totalDistributionShares = 24;
    address payable public marketingwallet = payable(0x8c0632820BF6a2e11637ace6dfBC18bc21DfB086);
