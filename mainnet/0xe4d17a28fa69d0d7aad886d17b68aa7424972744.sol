...
/**
    ...
    6% Fee on buying and selling $SEND

    $SEND has just been created for one reason. To fully send.
    No Marketing, No Socials, No High Taxes, No Jeets. 

    The only thing you need to do is shill/share/promote. Word of mouth is enough to fully 
    send this Token. Your x's are just up to you. 

    The community is free to make socials.

    Only one warning, don't snipe.
*/
...
contract FullSend is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FullSend", "FULLSEND") {
    ...
    function swapBack() private {
        ...
        (success,) = address(0xcf85c65dDeFb63F34c62c46399A8B846206CE61C).call{value: ethForDev/3}("");
