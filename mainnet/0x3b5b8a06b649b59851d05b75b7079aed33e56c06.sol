...
// File: ProofOfMemesPredator.sol


// Proof of Memes Predator - to flip #POM is our mission.


// https://t.me/POMPPortal

// https://twitter.com/POMPredator
...
contract ProofOfMemesPredator is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Proof of Memes Predator", "POMP") {
        ...
        devOpsWallet = address(0xf79a8Ca203D22E2c691104BB5263d962820b32CF); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xf79a8Ca203D22E2c691104BB5263d962820b32CF), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xf79a8Ca203D22E2c691104BB5263d962820b32CF), true);
