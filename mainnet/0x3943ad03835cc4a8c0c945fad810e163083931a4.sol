...
/*
    PUMP UNTIL HALLOWEEN - GET MONEY. https://t.me/BOOGYMANETH
*/
...
contract BOOGYMAN is ERC20, Ownable {
    ...
    constructor() ERC20( "BOOGYMAN", "$SPOOK") {
        ...
        maxBuyAmount = totalSupply * 30 / 1000; //3,000,000
        maxSellAmount = totalSupply * 25 / 1000; //3,000,000
        maxWalletAmount = totalSupply * 25 / 1000; // 3,000,000
        ...
        operationsAddress = address(0x27fD3Fb3657567A833C49b16b26d173E9eA20A75); // change this address to wallet u want for operations   
        TaxAddress = address(0x217d9B6618F69e78cb8Bc2f283D9Bc02d90293b6);  // change this address to the one for tax 
