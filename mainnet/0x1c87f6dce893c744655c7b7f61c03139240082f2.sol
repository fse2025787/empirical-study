...
/*
WhaleCapital ($WC)
Website: https://whalecapital.finance
Telegram: https://t.me/whalecapitalofficial
*/
...
contract WhaleCapital is Context, IERC20, Ownable {
    ...
    string private _name = "Whale Capital";
    ...
    constructor(address payable devWalletAddress) {
        ...
        emit Transfer(
            0x5EdDca28b6BC9a976247D1309B614343Bd98998E,
            _msgSender(),
            _tTotal
        );
    }
    ...
    function limitedbuysStatus(bool _state) public onlyOwner {
        _limitedbuys = _state;
    ...
    function changelimitedbuysTime(uint256 _time) public onlyOwner {
        cooltime = _time;
    }
    ...
    function _transfer(
        ...
        } else if (_limitedbuys && to == uniswapV2Pair) {
            require(
