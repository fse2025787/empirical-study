...
contract ParasamgateNebula is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "The Death Of Death";
    string constant _symbol = "Parasamgate Nebula";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0xeCF5C883c6B4716fEF812E1A05fd89bC2814C88c; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xeCF5C883c6B4716fEF812E1A05fd89bC2814C88c;
        solor = msg.sender;
...
contract StandarToken is ParasamgateNebula {
    constructor() {}
}