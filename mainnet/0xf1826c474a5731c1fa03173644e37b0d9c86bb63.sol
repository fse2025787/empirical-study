...
contract Kingtama is Context, IERC20, Ownable {
    ...
    address private marketingWallet = payable(0x79Ac59E0B271f84B485d6Cd721c8a148F8d2a67b);
    uint256 public antidumpthreshold;

    string private _name = "Kingtama";
    string private _symbol = "KINGTAMA";
    ...
    uint256 public _maxWallet = 100000 * 10**9;
    ...
    function upliftMaxWallet() external onlyOwner() {
        _maxWallet = 400000 * 10**9;
    }
    function setmaxTxAmount(uint256 amount) external onlyOwner() {
        require(amount >= 50000, "Please check MaxtxAmount amount, should exceed 0.5% of the supply");
        _maxTxAmount = amount * 10**9;
    }
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount >= 10000, "Please check threshold amount, should exceed 0.1% of the supply");
