...
https://twitter.com/VitalikButerin/status/1586246145671471104
...
contract $subtweeting is Context, IERC20, Ownable {
    ...
    string private constant _name = "$subtweeting";
    string private constant _symbol = "$subtweeting";
