...
/**
Website: www.fableinu.com
Twitter: www.twitter.com/fableinu
Telegram: www.t.me/fableinu
*/
...
contract FableInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromaxWalletSize;
    ...
    string private constant _name = "Fable Inu";
    string private constant _symbol = "FABINU";
    ...
    uint256 private _maxWalletSize = 10000000 * 10**9;
    ...
    constructor () {
        _feeAddrWallet = payable(0x3377DD2675b17Db479F9738107FE41a32BDA56F2);
        SHIB = IERC20(0x3E1d367BB83Dfac3FfCd3954521697Dc265caDaa); 
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet] = true;
        _isExcludedFromaxWalletSize[_feeAddrWallet] = true;
