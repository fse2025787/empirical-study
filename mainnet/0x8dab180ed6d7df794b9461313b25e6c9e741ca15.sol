...
contract BUYBACKINU is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "BUYBACKINU";
    string private _symbol = "BUYBACKINU";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x71b0C178a9F00651A93650e4e3547569c8778a49);
