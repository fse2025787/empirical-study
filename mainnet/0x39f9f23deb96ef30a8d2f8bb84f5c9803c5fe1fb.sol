...
contract ShibArmy is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxSupplyLimit = 9999;
    ...
    // Constructor
    constructor() ERC721("Shib Army", "SA") {
        setHiddenMetadataUri("https://shibarmy-nft.com/nfts/placeholder.json");
    }
    ...
    function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        if(_mintAmount == 2) {
            ...
            _mintLoop(msg.sender, 6);
        }  else if(_mintAmount == 6) {
