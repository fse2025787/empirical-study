...
contract POP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Proof Of Powell";
    ...
    address payable private dev = payable(0x6aaC3492F6948AfFCcecC38fF4dfDF174f30CC1F);
    address payable private mktg = payable(0x6aaC3492F6948AfFCcecC38fF4dfDF174f30CC1F);
    ...
    function setMaxWalletAmount(uint256 maxWalletAmount) external {
        require(_msgSender() == dev);
        require(maxWalletAmount > _tTotal.div(100), "Amount must be greater than 0.5% of supply");
