...
contract RIKIGAMI is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "RIKIGAMI";
    string private constant tokenSymbol = "RIKIGAMI";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xbd92bd0Ad0e7e9a516b2Dbc83eAc7Aa910F62219);
        devAddress = payable(0xbd92bd0Ad0e7e9a516b2Dbc83eAc7Aa910F62219);
