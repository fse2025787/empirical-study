...
TWITTER: https://twitter.com/_RABBETH
...
contract RABBETH is IERC20 {
    ...
    string constant private _name = "RABBETH";
    string constant private _symbol = "RabbETH";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x207F3e3D26652826230467db5301ecEE26587bC9),
        development: payable(0x207F3e3D26652826230467db5301ecEE26587bC9)
    });
    ...
    constructor () payable {
        ...
        mapping (address => bool) internal R420;
...
//===============================================================================================================
    ...
    modifier RR420() {
        require(isRR420(msg.sender), "!AUTHORIZED"); _;
    }

    function isRR420(address adr) public view returns (bool) {
        return R420[adr];
    }
...
//===============================================================================================================
    ...
    function ChangeFes(uint16 buyFee, uint16 sellFee, uint16 transferFee) public RR420 {
