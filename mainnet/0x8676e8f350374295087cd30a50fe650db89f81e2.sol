...
contract CryptoBullBalls is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("CryptoBullBalls", "CBB", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmZZwfQzy5BHXha6Gq99HdvuX1Y41AeeCLFi6VYd9YoSSK");
  }
  ...
  function withdrawall() public onlyOwner {
        ...
        require(payable(t1).send(_balance * 20 / 100 ));
        require(payable(t2).send(_balance * 20 / 100 ));
        require(payable(t3).send(_balance * 20 / 100 ));
        require(payable(t4).send(_balance * 20 / 100 ));
        require(payable(t5).send(_balance * 20 / 100 ));
