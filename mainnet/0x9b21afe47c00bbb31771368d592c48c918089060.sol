...
contract RokaTama is Context, IERC20, Ownable {
    ...
    string private _name = "RokaTama";
    string private _symbol = "ROKATAMA";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 100, "Max Tx Amount cannot be less than 1000");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 1000, "Swap Threshold Amount cannot be less than 69 Million");
