...
contract ETHEREUM is Context, IERC20, Ownable {
    ...
    string private constant _name = "ETHEREUM TO 2K";
    string private constant _symbol = "ETH2K";
    ...
    address payable private _developmentAddress = payable(0x8Fb57Fd62E94998912b2bf1bd66b7239C6081524); 
    address payable private _marketingAddress = payable(0x8Fb57Fd62E94998912b2bf1bd66b7239C6081524);
