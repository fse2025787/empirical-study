...
contract TFlokiShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Twitter Floki Shiba";
    string private constant _symbol = "TFlokiShiba";
