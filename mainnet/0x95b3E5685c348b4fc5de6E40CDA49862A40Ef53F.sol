...
( * \ \,' ,' ,'-)
 `._,)     -',-')
   ...
   /       ,'-'
          ...
          Can't believe this shit is mooning...  
               === SHAKING 'MA HEAD ===
               with all these shitcoins
                https://t.me/smhtoken
*/
...
contract SMH is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e12 * 1e9; // 10 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Shaking Ma' Head";
    ...
    uint256 public _sellMarketingFee = 24;
    ...
    constructor() payable {
        ...
        minimumTokensBeforeSwap = _tTotal * 10 / 10000; // 0.1% swap tokens amount
        
        marketingAddress = payable(0x34B6FeDac0a18294f286ae442c8cEC12477c65E4); // Marketing Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 50 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 950 / 1000);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over.  DM an SMH admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 15, "Must keep buy taxes below 15%");
