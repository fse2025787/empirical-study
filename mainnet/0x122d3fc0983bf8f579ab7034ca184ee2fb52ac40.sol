...
contract CATDIDAS is Context, IERC20, Ownable {
    
    string constant private _name = "CATDIDAS";
    string constant private _symbol = "CDS";
    uint8 constant private _decimals = 18;

    address public constant  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public autoLiquidityReceiver = payable(0xF0C2A48282919C1B32999E3ad35aaDB02B456A09); // LP Address
    address payable public marketingWalletAddress = payable(0x567c6ec24BE4aB4864E08A229b4021F3cE96fbdA); // Marketing Address
    address payable public operationsWalletAddress = payable(0x2F934EAa42f8c734E427197f5a37Eb0EC2F89C29); // operations Address
