...
contract HATIDOGE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "HATIDOGE";
    ...
    address payable private _marketingAddress = payable(0xd80432EEDE6Dc93C9fE6196db739d2E9Ba65A818);
