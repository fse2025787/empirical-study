...
contract SHIROKO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiroko Hatsune Miku";
    string private constant _symbol = "SHIROKO";
