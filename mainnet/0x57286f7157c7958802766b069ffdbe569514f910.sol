...
2022's Hottest P2E Game.

TG: https://t.me/LandsOfTheMeta

Website: https://landsofthemeta.com/
...
contract LandsOfTheMeta is ERC20, Auth {
    ...
    string constant _name = "Lands Of The Meta";
    string constant _symbol = "$LANDS";
    ...
    constructor () Auth(msg.sender) {
        ...
        devFeeReceiver = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;
    ...
    function tradingStatus_LANDS(bool _status) public onlyOwner {
         LANDS = _status;
    }
