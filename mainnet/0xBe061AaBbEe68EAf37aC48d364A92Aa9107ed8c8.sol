...
abstract contract AccessControlEnumerable is IAccessControlEnumerable, AccessControl {
    ...
    function _grantRole(bytes32 role, address account) internal virtual override {
        ...
        bool result = _roleMembers[role].add(account);
    }
    ...
    function _revokeRole(bytes32 role, address account) internal virtual override {
        ...
        bool result = _roleMembers[role].remove(account);
    }
}
...
contract Registry is Multicall, ERC2771Context, AccessControlEnumerable {
...
contract Factory is Multicall, ERC2771Context, AccessControlEnumerable {
    ...
    function addImplementation(address _implementation) external {
        ...
        IContract module = IContract(_implementation);
