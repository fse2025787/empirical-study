...
/**
    https://t.me/JurojinERC

    https://twitter.com/JuroJinerc

    https://jurojin.gitbook.io/jurojin/

    https://www.jurojin.space/
...
contract Jurojin is Context, IERC20, Ownable {
    ...
    string private constant _name = "JUROJIN";
    string private constant _symbol = "$Jurojin";
    ...
    address payable public DonationsAddress = payable(0x005149cCcbF0d2A4f6E9e4EbC09a22DFf403c366);
    ...
    address public DonationsWallet = 0x005149cCcbF0d2A4f6E9e4EbC09a22DFf403c366;
