...
/**
Hiro Kimi (HIRO)
Telegram Link: T.me/HiroKimiETH
*/
// 
...
contract HIRO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Hiro Kimi";
    string private _symbol = "HIRO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xE1219790385639382C30F69c4117EF1174bb1646);
    address payable private taxWallet2 = payable(0xE1219790385639382C30F69c4117EF1174bb1646);
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*45/10000; 
