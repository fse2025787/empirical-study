...
contract BOPENAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Baby OpenAI";
    string private constant _symbol = "BOPENAI";
    ...
    address payable private _developmentAddress = payable(0xF08434df838BAD0bDF2582899861ce5b4940913D); 
    address payable private _marketingAddress = payable(0xF08434df838BAD0bDF2582899861ce5b4940913D);
