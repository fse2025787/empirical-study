...
/*
 Youve had tendies meta youve had burning meta now the two supermetas 
 combine to create FLAME COCK! THE NEXT SUPER META
https://t.me/flamecock
...
contract FCfinal is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("FlameCOCK", "FC") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xa3700C35F95fF434E168b404402A29Ac99480ca0); // CHANGE THIS TO YOURS
        devWallet = payable(0x97EdF114726DeB6eBB509219116335F49EC572ae); // CHANGE THIS TO YOURS
        address router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

        //INITIAL FEE VALUES HERE
        buyMarketingFees = 5;
        sellMarketingFees = 33;
        buyLiquidityFee = 0;
        sellLiquidityFee = 33;
        buyDevFee = 2;
        sellDevFee = 33;
