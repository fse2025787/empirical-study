...
Wer1 megamooned within an hour of launch! I got out at 70x and have been aping every Wer since then and most of them i’ve been rugged on! 

So Fuck Wer1 is to say fck off to anymore Wer launches.
...
contract FuckWeR is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "FuckWeR";////////////////
    string private constant _symbol = "FuckWeR";////////////////
    ...
    address payable private _developmentAddress = payable(0x12582cd43F7973fFb13857d28B7Fd7049F61544f);////////////////////
    address payable private _marketingAddress = payable(0x12582cd43F7973fFb13857d28B7Fd7049F61544f);/////////////////////
