...
contract PriceStrategyExpV2 is IPriceStrategy, Ownable {
    uint256 private _step;
    uint256 private _initial;

    constructor(uint256 initial, uint256 step) {
        initial = (initial == 0) ? 3e16 : initial;
        step = (step == 0) ? 2000 : step;
        setPrice(initial, step);
    }
