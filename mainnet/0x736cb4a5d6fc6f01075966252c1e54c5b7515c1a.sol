...
contract GobbleGun is ERC721A, Ownable, ReentrancyGuard {
    string public _baseTokenURI;
    uint   public price             = 0.0029 ether;
    uint   public maxPerTx          = 20;
    uint   public maxFreePerWallet        = 1;
    uint   public maxPerWallet      = 60;
    uint   public totalFree         = 3412;
    uint   public maxSupply         = 3412;
    ...
    constructor(string memory baseURI) ERC721A("Gobble Gun", "GG"){
      setBaseURI(baseURI);
    }
