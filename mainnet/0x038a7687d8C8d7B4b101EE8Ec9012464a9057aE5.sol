...
/*
Token Name: The 300 Pulse Law
Symbol: 300 Pulse
Supply: 300 initial buy 3

Tax: 2/2 buy/sell

Telegram: https://t.me/pulselawerc20
...
contract Pulselaw is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromMaxWalletSize;
    string private constant _name = "The 300 Pulse Law";
    string private constant _symbol = "300 Pulse";
    ...
    uint256 private maxWalletAmount = 3 * 10**9;  
    uint256 private maxTxAmount = 3 * 10**9;      
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x88d2E2fC0A0aFCc5E3AF408c31df8D3325D57475); 
