...
contract Phornado is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qma5CbrDA8hqjpeuWF1vrc42MWwjyxwarnnFuQWn58YXJw";
    ...
    constructor(
    ) ERC721A("Phornado Cash", "Phornado", 100, maxSupply) {
    }
