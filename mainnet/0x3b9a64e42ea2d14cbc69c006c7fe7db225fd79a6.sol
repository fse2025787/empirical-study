...
/*
    https://t.me/NeltharionPortal
    https://twitter.com/Neltharion
*/
...
contract Neltharion is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Deathwish";
    ...
    function openTrading(uint _init, uint _fint) external onlyOwner() {
