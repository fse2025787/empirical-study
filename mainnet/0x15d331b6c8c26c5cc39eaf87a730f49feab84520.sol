...
contract ESSENCE is ERC721A, Ownable {

    uint256 constant public MAX_MINT = 12969;
    uint256 constant public MAX_MINT_PER_TX = 3;
    uint256 public cost = 0.469 ether;
    uint256 public presale = 0.2 ether;

    string public baseURI = "";
    string public baseExtension = ".json";
    bool public paused;

    constructor() ERC721A("FVCKRENDER ESSENCE", "FVCKRENDER") {}
    ...
    function Purchase(uint256 quantity) external payable {
        ...
        require(quantity <= MAX_MINT_PER_TX, "Cannot exeeds 1 quantity per tx.");
