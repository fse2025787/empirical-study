...
are viewed as the protectors of the four cardinal directions.
They are the Azure Dragon, Vermillion Bird, White Tiger and the Black Tortoise.

 Medium: https://medium.com/@Shishou/the-birth-of-the-four-symbols-shishou-73d3c73f169f
 Telegram:t.me/foursymbolserc
**/
// 
...
contract SHISHOU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20('Four Symbols', 'SHISHOU') {
            ...
            if (
                ...
                if (transferDelayEnabled) {
                    if (
                        ...
                        _holderLastTransferTimestamp[tx.origin] = block.number;}}
         uint256 sellAmount = sellLiquidityFee;
                //when buy logic is required 
                if (
                ...
                //when sell
                    ...
                    require(
                        sellAmount > 0,
                        'Sell transfer amount bellow minTransactionAmount.'
                    );
