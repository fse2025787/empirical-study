...
@ Socials:                                              @@
@ https://t.me/NYShiba                                  @@
@ https://twitter.com/NewYearsShiba                     @@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
*/
// 
...
contract NYS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="New Year Shiba";
    string private _symbol = "NYS";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xA7f7Ab6C3F2d2Eacf6C6f2da0aa5F0d519B11E00);
    ...
    uint256 public _sellMarketingFees = 23;
