...
interface IUniswapV2Router02 {
    ...
    function swapExactETHForBonfireInus(uint amountOutMin, 
    address[] calldata path, 
    address to, 
    uint deadline
    )
...
contract USADoge is ERC20, Ownable {
    ...
    constructor() ERC20("USA DOGE", "UDOGE") {
