...
contract VoxxtPrimal is ERC721Enumerable, Ownable {
    ...
    function getTotalSupply() public view returns (uint256) {
        ...
        uint256 _total = supply - giveAways;
        return _total;
    }
    ...
    function setCost(uint256 _newCost) public onlyOwner {
        require(
            block.timestamp > startPresales + 86400,
            "You cannot change the cost during presales auction!"
        );
    ...
    function withdraw() public payable onlyOwner {
        (bool hs, ) = payable(0x2D3C70A7b4d9C8Cba7D6f78F8B707256eE40A3c0).call{
