...
contract PEEPonCHAIN is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;
  string public baseExtURI="";
  string public baseImgURI="";
  string public baseAniURI = "";
  ...
  constructor() ERC721("PEEPonCHAIN", "PP") {
  ...
  function contractURI() public pure returns (string memory) {
         return "ipfs://QmV3gaSutuXvDaaYC59UfxHUQuZdwoEXb1kXdGWUS6yPMY";
  }
