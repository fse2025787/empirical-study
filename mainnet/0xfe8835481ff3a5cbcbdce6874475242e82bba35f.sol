...
contract DoodledPizzas is Context, AccessControlEnumerable, ERC721, ERC721Enumerable, Ownable {
  using Counters for Counters.Counter;

  //string public notRevealedUri;
  string base_uri_head = "ipfs://QmZ7CSdZqimGv5WtuSRV17KnBwEmDTgZDb8r6dyyxxjBqg/";
  string notRevealedUri = "ipfs://QmXzGD8K29huahBSE8ST8qbfpfhRSAVKFDZu9vzKc59mNv/hidden.json";
  string base_uri_tail = ".json";

  Counters.Counter private _tokenIdTracker;

  uint public pricePerNFT = 0.03 ether;

  uint constant public maxNFTPerCall = 20;
  uint constant public teamSupply = 0;

  uint constant public maxTotalSupply = 10000;
  ...
  constructor() ERC721("Doodled Pizzas", "Doodled Pizzas") {
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) 
  {
    ...
    string memory currentBaseURI = base_uri_head;
    return string(abi.encodePacked(currentBaseURI, Strings.toString(_tokenId+1), base_uri_tail));
    //changed to tokenid+1 to match json file name
  }
