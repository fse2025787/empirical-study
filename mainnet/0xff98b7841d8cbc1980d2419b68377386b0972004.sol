...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1236;
...
contract SnapDogNFT  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmcxCNrkVf1S93iEVMwjxiGo4TNraFkVonDHZFYakVTCH7/";

    uint256 public immutable cost = 0.01 ether;
    uint256 public immutable WMMin = 0.003 ether;
    ...
    function SnapPublicMint (uint256 amount) public payable callerIsUser{
        require(totalSupply() + amount <= maxSupply, "sold out");
        require(msg.value >= WMMin, "insufficient");
