...
/**
    ...
    Max transaction : 200000

    Max wallet : 200000 ( Per address,you can use multiple addresses)

    5% liquidity Fee on buying and selling CMN

    There is no dev or marketing fee.

    CMN is a social experiment style of token. Combining the powers of The Mission & Cult DAO.
...
contract CMN is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _na = "Cults Mission";
    string private constant _sym = "CMN";
    ...
    uint256 private constant _tTotal = 1e7 * 10**18;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x45D0DAdc777Aa993a98142304d60E3351Ca9567B);
        OtherWallet = payable(0x45D0DAdc777Aa993a98142304d60E3351Ca9567B);
        DevWallet = payable(0x45D0DAdc777Aa993a98142304d60E3351Ca9567B);
