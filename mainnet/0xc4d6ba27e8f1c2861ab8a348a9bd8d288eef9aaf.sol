...
// Telegram Link : https://t.me/yokoso2023
...
contract Yokoso is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Yokoso 2023"; 
    ...
    address payable private _developmentWalletAddress = payable(0x18ee1463ea65CC6C1bCD9D128C8C8893a2603746);
    address payable private _marketingWalletAddress = payable(0x18ee1463ea65CC6C1bCD9D128C8C8893a2603746);
    ...
    function setWallet(address NewWallet, address newDev) external onlyOwner {
