...
contract Ownable is Context {
    ...
    function renounceOwnershipTo(address newOwner) public virtual onlyOwner {
...
contract BoboTech is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Bobo Tec";
    string private constant _symbol = "BtechAI";
    ...
    address payable private _marketingAddress = payable(0x89B4EF29D1701Cba5938Df0C90B65f80B7878fb2);
    address payable private _devAddress = payable(0x89B4EF29D1701Cba5938Df0C90B65f80B7878fb2);
    ...
    uint256 public _maxTxAmount = 16000000000 * 10**9; //1.8% of total supply per txn 
    uint256 public _maxWalletSize = 150000000000 * 10**9;
