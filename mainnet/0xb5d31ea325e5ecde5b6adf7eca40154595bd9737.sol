...
contract GoogleNode is Context, IERC20, Ownable {
    ...
    string private constant _name = "Google Node";
    string private constant _symbol = "GNODE";
    ...
    constructor () {
        _feeAddrWallet = payable(0xde1D8878ffE2AF5B4312Dc536F0282A0CE0FbB09);
