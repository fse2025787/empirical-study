...
contract HOICHICAKE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"Hoichi Cake";
    string private constant _symbol = "HOICHICAKE";
    ...
    address payable private _developmentAddress = payable(0x975f3DeF9f2532527B1eE2D587744bb84d38Ee47); 
    address payable private _marketingAddress = payable(0x975f3DeF9f2532527B1eE2D587744bb84d38Ee47);
