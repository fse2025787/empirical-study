...
/*
  Telegram : t.me/ProofOfShit << endl;
*/
// 
...
contract ProofOfShit is Context, IERC20 {
    ...
    string private _name = "Proof of Shit";
...
//==========================
    ...
    {buyFee: 300, sellFee: 600, transferFee: 700, antiDumpLT: 600});
//==========================
    // Maxima
...
//==========================
    ...
    address payable public _DeveloperWallet = payable(0x1e5C6aB8B4E463E0Ef880511f3a56e7C5Ba7e2FB);
    address payable public _developerWallet = payable(0x1e5C6aB8B4E463E0Ef880511f3a56e7C5Ba7e2FB);
