    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 360) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcDWxdYayUvtSito8rogDGreHMP5fcbZ9hpxW3LdHTNRs/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/3D23U3Ip6IyzklK99wsG/contract-metadata";
  }
...
// File: contracts/CyberThugsbyDisruptorContract.sol
//

pragma solidity ^0.8.0;

contract CyberThugsbyDisruptorContract is RamppERC721A {
    constructor() RamppERC721A("Cyber Thugs by Disruptor", "CyberThugs"){}
}
