...
contract StreetMeltGenesis is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

    string public baseURI = '';
    string public uriSuffix = '.json';
    uint256 public maxSupply = 1442;
    ...
    //- We leave this here in case the original token supply is incorrect and we require to increase size to complete the airdrop
