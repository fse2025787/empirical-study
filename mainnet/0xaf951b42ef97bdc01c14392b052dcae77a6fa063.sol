...
/**
 *https://michaeldogson.digital/
 * https://t.me/MichaelDogSon
...
pragma solidity ^0.6.12;
    ...
    contract MDSToken is Context, IERC20, Ownable {
        ...
        string private _name = 'MichaelDogSon';
        string private _symbol = 'MDS🕺🏻🐶';
        ...
        uint256 private _charityFee = 12;
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 12, 'taxFee should be in 1 - 12');
            _taxFee = taxFee;
        }

        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 12, 'charityFee should be in 1 - 12');
