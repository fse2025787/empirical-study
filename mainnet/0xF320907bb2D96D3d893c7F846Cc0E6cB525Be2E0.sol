...
contract Kemushi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kemushi";
    string private constant _symbol = "KEMUSHI";
    ...
    uint256 private _maxTxAmount = 2500000 * 10**9;
