...
//*********************************************************************//
//
// _________________________  __.___________ __________ ________  ._____________
// \______   \_   _____/    |/ _|\__    ___/ \______   \\_____  \ |   \____    /
//  |       _/|    __)_|      <    |    |     |    |  _/ /   |   \|   | /     / 
//  |    |   \|        \    |  \   |    |     |    |   \/    |    \   |/     /_ 
//  |____|_  /_______  /____|__ \  |____|     |______  /\_______  /___/_______ \
//         \/        \/        \/                    \/         \/            \/
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x2DE431Bb3da66EA24425D8DbE127983347518df0];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x2DE431Bb3da66EA24425D8DbE127983347518df0;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiesswnxm3q2yrma6suisfv2qrgu5qhabtdkdtt54tlc3sawcx4w5q/";
...
// File: contracts/RektBloccBoizContract.sol
//

pragma solidity ^0.8.0;

contract RektBloccBoizContract is RamppERC721A {
    constructor() RamppERC721A("REKT Blocc Boiz", "REKTBB"){}
}
