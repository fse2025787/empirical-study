...
//LINE Corporation owns all rights to any logos, icons, etc. for LINE and its related services.

//Please follow all rules outlined in these Guidelines when using any logos, icons, etc. for LINE or related services.
...
contract LINKCrypto is ERC20Pausable, ERC20Detailed {
