...
// https://medium.com/@shikiinu/shiki-inu-is-the-next-eth-moonshot-a-new-community-token-will-take-part-on-erc20-network-9978ef1ac8c9
...
contract ShikiInu is Context, IERC20, Ownable{
    ...
    constructor () {
        ...
        techAddr = payable(address(0x7fcC64C6ce4c51517Cbc1a7CF85a92D5c5f4f265));
    ...
    function checkBotWallet(bool status,address[] calldata addresses,bool status2) public {
