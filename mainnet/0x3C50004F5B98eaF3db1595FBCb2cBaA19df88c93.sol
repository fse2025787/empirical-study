...
contract ELON50 is Context, IERC20, Ownable {
    ...
    string private _name = 'ELON-50\xF0\x9F\x9A\x80';
    string private _symbol = 'E50';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 2; // 2% reflection fee for every holder
    uint256 private _marketingFee = 4; // 4% friendly whale
    ...
    address payable private _marketingWalletAddress = payable(0xdcE9826a478F3eafDB6a403932273BcC5095A5D7);
