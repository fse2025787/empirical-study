...
/**
 *Submitted for verification at Etherscan.io on 2069-69-69
*/
/**
JizzedToOEarly.Ai is an innovative Ai powered solution to premature ejaculation.

The native token is $JIZZAI which has a supply of 1,000,000,000 tokens.

Max Wallet 2%
Max TXN 2%

Taxes will be set to 3/3

https://t.me/JizzedTooEarlyAi
**/
...
contract JIZZAI is ERC20, Ownable {
    ...
    constructor() ERC20("JizzedTooEarly.Ai", "JIZZAI", DECIMALS) {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        feeReceiver = address(0x05663602Aa5aF3C743ac99abC3514194245Cd9F7); 
        ...
        maxTransactionAmount = 2 * 1e6 * 10**DECIMALS;
        maxWallet = 2 * 1e6 * 10**DECIMALS;
