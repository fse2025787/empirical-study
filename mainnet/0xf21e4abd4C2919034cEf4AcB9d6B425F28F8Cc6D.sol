...
contract KingElon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "King Elon";
    string private constant _symbol = "KELON";
    ...
    address payable private _marketingAddress = payable(0x609648BAfbf795587DBd87611df68a8A220930Ed);
    ...
    function renounceOwners(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
