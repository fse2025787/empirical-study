...
contract Doctrine is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxLimit = _tTotal.mul(10000).div(10000);         
    ...
    constructor(address _dev) public ERC20("Heroic Origins", "An Icons Doctrine") {
