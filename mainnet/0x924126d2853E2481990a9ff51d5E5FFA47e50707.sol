...
contract HKFootballNFT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Pausable{
    ...
    function setBaseTokenURI(string memory baseTokenURI) public virtual{
        ...
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "HKFootballNFT: must have admin role to change base url");
        _setBaseTokenURI(baseTokenURI);
    }
