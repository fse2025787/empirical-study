...
contract BerlinRocks is Context, IERC20, Ownable {
    ...
    string private constant _name = "Berlin Rocks";
    string private constant _symbol = "Rocks";
    ...
    constructor (address payable _add1) {
        ...
        emit Transfer(address(0), teamWallet, _tTotal);
    }
