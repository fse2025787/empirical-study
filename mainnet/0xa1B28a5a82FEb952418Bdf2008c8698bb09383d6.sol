...
contract bobatea is ERC20, Ownable {
    ...
    constructor() ERC20("BobaTea", "TEA") {
        ...
        maxTransactionAmount = totalSupply * 50 / 10000; // 0.50% maxTransactionAmountTxn
        ...
        marketingWallet = payable(0x7d6e09E679aE46E0DBfaC67fC5dC0DD522F313e4); 
        ...
        excludeFromMaxTransaction(address(liqOwner), true);
