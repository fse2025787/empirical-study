...
contract  TheProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "TheProtocol";
    string private _symbol = "BabyTheProtocol";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xe59c7772D036D808A3bc88EDEb6494b7c5e09acf));
        CharityWalle = payable(address(0xe59c7772D036D808A3bc88EDEb6494b7c5e09acf));
