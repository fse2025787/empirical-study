...
/**
TG：https://t.me/GintokiSakataInu	SITE:http://www.sakatagintokiinu.com/
*/
...
contract GintokiSakataInu is Context, IERC20, Ownable {
    ...
    string private _name = "GintokiSakataInu";
    string private _symbol = "$GintokiSakataInu";
    ...
    uint256 public _maxTxAmount = 14999999 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 14999999 * 10**9;
    uint256 public _maxWalletSize =29999999 * 10**9;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 100, "Tax fee cannot be more than 100%");
        _taxFee = taxFee;
    }
