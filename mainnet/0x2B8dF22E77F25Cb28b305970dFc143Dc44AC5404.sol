...
contract Hanayashiki  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Sakura-no Onryou";
    string private constant _symbol = "Hanayashiki";
    ...
    address payable private _developmentAddress = payable(0xf7913F8fEA43b5bf8ca3ee9b65a105006a3aF875); 
    address payable private _marketingAddress = payable(0xf7913F8fEA43b5bf8ca3ee9b65a105006a3aF875);
