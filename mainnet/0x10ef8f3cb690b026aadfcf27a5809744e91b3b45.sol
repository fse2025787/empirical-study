...
abstract contract Ownable is Context {
     ...
     */
    constructor () payable {
        _owner = 0x82df28C05643899FAF3b41cB58038a67de057FD6;
...
contract NinetyNinePercentToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xE3D97EAAA3Fe5a41f6e7A9D8d3C5139840cd3397;   
    
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 99000000000  * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "99% Token";
    string private _symbol = "99";
