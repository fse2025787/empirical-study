...
contract Catecoin is Context, IERC20, Ownable {
    ...
    uint256 public antiWhaleAmt = 10_000_000_000_000 * 10**_decimals;
    uint256 public swapTokensAtAmount = 10_000_000_000_000 * 10**_decimals;
    
    // Anti Dump //
    uint256 public maxSellAmountPerCycle = 50_000_000_000_000 * 10**_decimals;
    ...
    Taxes public buyTaxes = Taxes(2,0,3,0);
    Taxes public sellTaxes = Taxes(2,0,3,0);
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out Catecoin!");
