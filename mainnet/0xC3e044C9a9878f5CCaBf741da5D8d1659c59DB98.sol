...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1Ab861A5E9960ddA9F9118C5a3f6EC3439C5D375];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x1Ab861A5E9960ddA9F9118C5a3f6EC3439C5D375;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 600) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmdhobWZgMd9iqKYcc8yw1xFQRPzCsd8GNQM2zcd6Z3dpf/";
...
// File: contracts/ColonialsContract.sol
//

pragma solidity ^0.8.0;

contract ColonialsContract is RamppERC721A {
    constructor() RamppERC721A("Colonials", "Colonials"){}
}
