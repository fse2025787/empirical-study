...
contract MetaApeDAO is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xC6cBf62B988DEdE4359d9B198D6A0F7dda7C80dD);
        _feeAddrWallet2 = payable(0x307E759896F87dB0a4d59F3d2447EDF69203d746);
        _liquidityWallet = payable(0x2963e8C13c35C2e6a0ce36c2229e4b3eA447dB59);
