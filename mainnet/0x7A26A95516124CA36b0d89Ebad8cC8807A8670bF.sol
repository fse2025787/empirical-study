...
// Catch a $Vybe. 0% tax  
// https://twitter.com/VybeERC
// If a community member makes a telegram group for this token, please comment the link on our twitter for the vybe.
...
contract Vybe is ERC20, Ownable {
    using SafeMath for uint256;
