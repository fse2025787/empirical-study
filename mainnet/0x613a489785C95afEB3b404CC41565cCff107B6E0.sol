...
contract Farms is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of Share tokens
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. Share tokens to distribute per block.
        uint256 lastRewardBlock; // Last block number that Share token distribution occurs.
