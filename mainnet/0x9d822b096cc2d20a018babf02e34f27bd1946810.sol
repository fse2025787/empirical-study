...
Tonight, marching towards decentralization.
It's Time.
...
contract Masuku is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Masuku";
    string private constant _symbol = "MASUKU";
