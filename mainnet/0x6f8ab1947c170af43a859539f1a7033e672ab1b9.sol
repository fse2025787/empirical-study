...
contract DirewolvesContract is Ownable, ERC165, ERC721 {
    ...
    function tokenURI(uint256 a) public view virtual override returns (string memory) {
        require(a > 0 && a <= totalSupply(), "Cannot query URI for non-existant token");

        return string(abi.encodePacked(_ipfsURI, ipfsFolder, "/", a.toString()));
    }
