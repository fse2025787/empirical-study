...
contract CHIOGE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CHIOGE";
    string private constant _symbol = "CHIOGE";
    ...
    address payable private _developmentAddress = payable(0x89dE2f9DC33D46347A73B57Bd9970Db1DcFb3966);
    address payable private _marketingAddress = payable(0x89dE2f9DC33D46347A73B57Bd9970Db1DcFb3966);
