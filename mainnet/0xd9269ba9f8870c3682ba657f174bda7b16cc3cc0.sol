...
The idea is to have some fun in these tough times and spread some nostalgia and smiles across the crypto world.
So get in the spirit and let’s play!
You may join our official TG for a chat: t.me/HebiGaming
Follow us on Twitter: https://twitter.com/hebigaming
Read here: https://medium.com/@hebitoken
Play here: www.Hebi.info
Max wallet and Max txn applicable till token stable
Liq will be locked and CA renounced post token stable
*/
...
contract HEBI is ERC20, Ownable {
    using SafeMath for uint256;
