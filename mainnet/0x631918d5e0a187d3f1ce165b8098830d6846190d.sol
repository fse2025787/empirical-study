...
/*
THENUE
Nue is one of the oldest recorded monsters in Japan. It has the head of a monkey, the body of a raccoon, the tail of a snake, and the limbs of a tiger. Nue can turn into a dark cloud and fly.

links
Twitter:https://twitter.com/THENUE_ETH
Telegram:https://t.me/THENUE_ETH
*/
...
contract THENUEINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"THE NUE INU";
    string private constant _symbol = "THENUE";
