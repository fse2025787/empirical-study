...
interface IFactory{
        function createPair(address otkenA, address tokenB) external returns (address pair);
}
...
contract Goodbye is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = totalSupply() * 2 / 100;
    uint256 public maxWalletAmount = totalSupply() * 2 / 100;
    
    address public marketingWallet = 0x2C55331c116c10ED2551aAa7D1E7162f953C249E;
    address public developerWallet = 0x933Fc5179A79B13BbaFbFEcD0CFD93944ad02687;
    ...
    Taxes public taxes = Taxes(4,1,0);
    Taxes public sellTaxes = Taxes(67,2,0);
    uint256 public totTax = 5;
    uint256 public totSellTax = 69;
    ...
    constructor() ERC20("Crypto is over man, Im out. Goodbye everyone, was nice meeting you all and learning about whatever you think. Good luck on all your endeavors.", "GOODBYE") {
