  ...
  ERC721Upgradeable
{
    ...
    function claimPreBoostStake() public whenNotPaused nonReentrant returns (uint256) {
        ...
        uint256 stakedAmount = PoolStakingRewards5(poolStakingRewardAddress).getCurrentBalance(msg.sender);
        ...
        PoolStakingRewards5(poolStakingRewardAddress).unstakeForWallet(msg.sender, amount);
