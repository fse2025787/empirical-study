...
contract BEQUIET is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Be Quiet";
    string private constant _symbol = unicode"$PLEASE";
    ...
    address payable private _developmentAddress = payable(0x283c863Ca41c5899a872B8566ad413e9fDd77B6f); 
    address payable private _marketingAddress = payable(0x283c863Ca41c5899a872B8566ad413e9fDd77B6f);
