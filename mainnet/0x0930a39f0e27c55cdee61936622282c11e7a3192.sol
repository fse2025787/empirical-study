...
contract FUD is Context, IERC20, Ownable {
    ...
    string private constant _name = "For Us Degenerates";
    ...
    address payable private _developmentAddress = payable(0x0BE331d492D93e7196EC4C346E16F9676d3dE70a);
    address payable private _marketingAddress = payable(0x0BE331d492D93e7196EC4C346E16F9676d3dE70a);
    ...
    uint256 public _maxWalletSize = 7500000000000 * 10**9; //0.75
