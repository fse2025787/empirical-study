...
contract EtherBall is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVRFMVdhBZMxapNXuto8rKAL4HqeSa7Qez8Mfj7vNkzUA";
    ...
    constructor(
    ) ERC721A("Etherball", "LOTTO", 100, maxSupply) {
    }
