...
//                                      ***        nETHing       ***        
//    
// Telegram | https://t.me/nETHingERC20
//
// Twitter | https://twitter.com/nethingerc20
//
//
// 
...
contract nETHing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "nETHing";
    string private constant _symbol = "nETH";
    ...
    uint256 private constant _tTotal = 1e3 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x8E2d12d6c442e69F5E9ba408C3eB89AE3DafB75D);
    ...
    uint256 public _maxTxAmount = 3e1 * 10**9; //3%
    uint256 public _maxWalletSize = 5e1 * 10**9; //5%
    uint256 public _swapTokensAtAmount = 1e0 * 10**9;
    uint256 public _minimumBuyAmount = 3e1 * 10**9 ; //3%
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount >= 5e6 * 10**9, "Maximum transaction amount must be greater than 0.5%");
