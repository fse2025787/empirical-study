...
contract FranceVictory is Ownable, IERC20 {
    ...
    uint256 public _walletMax = _totalSupply * 100 /1000;

    string constant private _name = "France Victory";
    string constant private _symbol = "FranceVictory";
    ...
    constructor() {
        ...
        lpWallet = 0xCB0Df4D8F07c0C2D308b0F88Cdcb2De42206A759;
        projectAddress = 0xCB0Df4D8F07c0C2D308b0F88Cdcb2De42206A759;
        devWallet = 0xCB0Df4D8F07c0C2D308b0F88Cdcb2De42206A759;
    ...
    function smd(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extra) public authorized{
    ...
    function LockBots(address _address, bool status) public onlyOwner{
