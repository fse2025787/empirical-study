	...
	Ownable
{
	...
	function supportsInterface(
		bytes4 interfaceId
		) public view virtual override(AccessControl, IERC165, ERC1155) returns (bool) {
		return interfaceId == type(IMintableERC1155).interfaceId || super.supportsInterface(interfaceId);
	}
}
