...
contract Hoseki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hoseki Room";
    string private constant _symbol = "Hoseki";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x322da0275233adBe6472bC611eA513440c1d3aeC);
        _feeAddrWallet2 = payable(0x322da0275233adBe6472bC611eA513440c1d3aeC);
        ...
        emit Transfer(
            address(0x322da0275233adBe6472bC611eA513440c1d3aeC),
            _msgSender(),
            _tTotal
        );
    }
