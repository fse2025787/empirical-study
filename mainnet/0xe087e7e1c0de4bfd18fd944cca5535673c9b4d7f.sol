...
HALLOWEEN IS NEAR!
SO I CREATED THIS HALLOWEEN BURN TOKEN FOR teh COMMUNITY
$JASON HAS A TOTALSUPPLY SET AT HALLOWEEN'S DATE 10-31-2022
LETS BURN THE SUPPLY!!!!
...
Symbol: $JASON
Total supply: 10.312.022
5% tax Buy/Sell (2% burn 3% marketing)
taxes cannot be set higher 5, lp will be locked (extended while we grow) and CA renounced..there will be no TG by DEV..community may create as u choose
Lets send this!
Burn it!!
*/
...
contract CampCrystalLake is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CAMP CRYSTAL LAKE", "JASON") {
        ...
        uint256 totalSupply = 10_312_022 * 10**9;
        supply += totalSupply;
        ...
        devWallet = 0x2cc195AA3347950d1E6c8c5677E93F2f2ED48542;
