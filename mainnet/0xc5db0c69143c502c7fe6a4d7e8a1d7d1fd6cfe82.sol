...
/*
SAFU LOCK AND RENOUNCE PLAY. 
4% TAXES IN & OUT.
THE NEWEST MEME TOKEN OF ETH.
Benji, a stray but friendly dog.
*/
...
contract BENJINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "BENJI INU";
    string private constant _symbol = "BENJI";
    ...
    uint256 private _maxWalletSize = 2500000 * 10**9;
