...
contract AtmosDAO is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x7FC91BD7313Aeed3a407C0b266DEE03Ece460ACf));

    string private _name = "AtmosDAO";
    string private _symbol = "AtmosDAO";
