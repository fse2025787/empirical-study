...
/*
 __      __         __         .__                           
/  \    /  \_____ _/  |_  ____ |  |__   _____   ____   ____  
\   \/\/   /\__  \\   __\/ ___\|  |  \ /     \_/ __ \ /    \ 
 \        /  / __ \|  | \  \___|   Y  \  Y Y  \  ___/|   |  \
  \__/\  /  (____  /__|  \___  >___|  /__|_|  /\___  >___|  /
       \/        \/          \/     \/      \/     \/     \/ 
               http://t.me/watchmentoken

⚔️ We have numerous things coming out in development including a functional NFT mint 
    system that uses Watchmen tokens along with an NFT marketplace!

What's coming over the next couple days:
• Twitter/TikTok Marketing Plan
• Official Website/Whitepaper
• Limited edition NFT giveaways
...
Tokenomics:
• 0% fees just like a token should be!
• 1% of total supply sent to our marketing wallet
...
contract WatchmenToken is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , WatchmenToken{
...
contract Watchmen is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 555555 * 10 ** 18;

    constructor () ERC20('Watchmen', unicode'Watchmen🙂') {
