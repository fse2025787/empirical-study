...
/**
Ultra Unit Bias: $UUB
- Reflections Token with ultra low unit count and decentralized auto-buy of $MCC via SmartContract.

Tokenomics:
5% of each buy/sell goes to existing holders.
5% of each buy/sell goes into auto-buy backs of $MCC for #MultiNodes.
*/
...
contract UltraUnitBias is Context, IERC20, Ownable {
  ...
  string private _name = 'Ultra Unit Bias';
  string private _symbol = 'UUB';
