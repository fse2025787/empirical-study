...
contract KoratCatCoin is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x0e338fEd913F0D585861a028C4276bb91A0ac5d3));
    address payable public _devwallet =
        payable(address(0xFDDAC431bfE2322bD14eB5fDaE0a2918Ba7d0025));
    address public _exchangewallet =
        payable(address(0x0e338fEd913F0D585861a028C4276bb91A0ac5d3));
    address _partnershipswallet =
        payable(address(0x7c502953BC4B53FA5C6FbF7B02a93296AC6C4970));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Korat Cat Coin";
    string private _symbol = "KCC";
    ...
    uint256 public _maxTxAmount = 60 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 240 * 10**19 * 10**9;
