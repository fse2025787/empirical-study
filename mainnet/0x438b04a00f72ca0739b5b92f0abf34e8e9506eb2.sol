...
Website:  www.guccicoin.live
Telegram: https://t.me/GucciPortalErc
Twitter:  https://twitter.com/GucciCoinErc20
...
contract GUCCI is ERC20, Ownable {
    ...
    string constant _name = "Gucci Coin";
    string constant _symbol = "GUCCI";
    ...
    function setmarketingFee(uint256 _marketingFee) external onlyOwner {
        ...
        require(marketingFee<=10,"Must keep fees at 10% or less");
    }
