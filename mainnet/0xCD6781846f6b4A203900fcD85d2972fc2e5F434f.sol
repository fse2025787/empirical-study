...
/**
  ...
  Tale of Kishu is similar to the Shib crypto currency 
and the dogecoin meme.TOKISHU is a decentralized meme 
protocol on the Ethereum Blockchain.

The Kishu Ken is a large game hound used in the densely 
forested mountains of Japan. They are spirited, alert, 
and rustic dogs with compact, well-developed muscles. 
Kishu are often white-coated, medium-sized, with erect ears and
a tail held over the back.
...
contract TaleOfKishu is Context, IERC20, Ownable {
    ...
    string private constant _name = "TAKISHU"; 
    string private constant _symbol = "TAKISHU"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0xdAFcCA911FcA57b36723a5f402949B2CB034b3eb; 
