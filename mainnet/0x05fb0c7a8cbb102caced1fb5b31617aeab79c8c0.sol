...
/*
Bitcoin WhitePaper $BPAPER 

14 years ago today Satoshi published the #Bitcoin whitepaper. 

This PDF changed the world, Bitcoin becoming #1 Crypto Asset on the world 


$BPAPER is a erc20 token on ethereum blockchain crated by Bitcoin lovers and experienced developers with the main aim to create the biggest project from ethereum network

Tokenomics:
AutoLiquidity: 1%
Marketing: 2%
Bounties & Giveaways : 1%


Telegram: https://t.me/BitcoinWhitePaperERC
...
contract BCPAPER is ERC20, Ownable{
    ...
    address public marketingWallet = 0xb892d1F5e10D3E0Ba976F52b7dB88538ACF5950b;
    address public devWallet = 0x41a296018D19D1092cB7C1872cF6CB483117405A;
    ...
    Taxes public taxes = Taxes(3,0,1);
    Taxes public sellTaxes = Taxes(3,0,1);
    ...
    constructor() ERC20("Bitcoin WhitePaper", "BPAPER") {
