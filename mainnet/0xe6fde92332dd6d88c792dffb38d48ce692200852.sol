...
contract ConfirmedChaos is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Confirmed Chaos By Anon", "CBA") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibdsxolvpaxranjjfq762vxgi5kzjqbebh37dwvvth4avkxohksaq/", _toString(tokenId), ".json"));
    }
