...
Telegram: https://t.me/WeAreOnePortal

Twitter: https://twitter.com/weareall1ne

Medium:https://medium.com/@101weareallone/we-are-one-847aabce561b 

Website: https://weareallone.tech/
*/
// 
...
contract WeAreAllOne is ERC20, Ownable {
    ...
    constructor() ERC20("We Are All One", "WAAO") payable {
        //taxes set
        ...
        maxTxnAmount = totalSupply * 3 / 100;
    ...
    function _reducebuyfees(uint256 _marketing,uint256 _liquidity) external onlyOwner{
        require((_marketing+_liquidity) <= TotalbuyFees, "can't increase buy taxes");
        buyMarketingFee = _marketing;
        buyLiquidityFee = _liquidity;
        TotalbuyFees = buyMarketingFee + buyLiquidityFee;
    }
    function _reducesellfees(uint256 _marketing,uint256 _liquidity) external onlyOwner{
        require((_marketing+_liquidity) <= TotalsellFees, "can't increase buy taxes");
    ...
    function ActivateTrading(uint _b) external onlyOwner {
    ...
    function BlacklistAddresses(address[] memory Addresses,bool _status) external onlyOwner(){
