...
//*********************************************************************//
//
//  _____  __ ___ _____ ___ ___   _____  __ __  _____  __ ___      
// /  _  \|  |  //  _  \\  |  /  |  _  \/  |  \/     \|  |  /      
// |  |  ||  _ < |  _  | |   |   |  |  ||  |  ||  |--||  _ <       
// \_____/|__|__\\__|__/ \___/   |_____/\_____/\_____/|__|__\      
//                                                                 
//  _____  ___  __  __  _____  ____     _____  ____   __ __  _____ 
// /  _  \/___\/  \/  \/   __\/  _/    /     \/  _/  /  |  \/  _  \
// |   __/|   |>-    -<|   __||  |---  |  |--||  |---|  |  ||  _  <
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x50DaF6835d2CfC8B462Af24F08855607A2198f25];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmeWmAeAXbpjoN9Vqko2rAJCSe7xUQJuoVKnbrzKxmQZRp/";
...
// File: contracts/OkayDuckPixelClubContract.sol
//

pragma solidity ^0.8.0;

contract OkayDuckPixelClubContract is RamppERC721A {
    constructor() RamppERC721A("Okay Duck Pixel Club", "OkayDuckPC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ezPmA3nEboneyMjmSFS1/contract-metadata";
    }
}
