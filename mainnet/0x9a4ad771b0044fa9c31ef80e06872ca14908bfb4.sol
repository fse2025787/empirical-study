...
contract HorsHors is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://ibb.co/TL4sd2g";
    address private openSeaProxyRegistryAddress = 0x05B0319c6f3AA8A895cA30B5eEb29657C1285983;
    ...
    constructor(
    ) ERC721A("HorsHors", "HorsHors", 100, maxSupply) {
    }
