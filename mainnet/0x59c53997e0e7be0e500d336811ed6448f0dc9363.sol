...
contract DUCKME  is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://QmXfdCFTxPVGamr4hRhHgxb6K3ztZ4BB2wWebc95PWqyZC/";

    uint256 public immutable mintPrice = 0.003 ether;
    uint256 public immutable minDuckToTheMoon = 0.002 ether;
    ...
    function duckPublicMint(uint256 amount) public payable callerIsUser{
        require(msg.value > minDuckToTheMoon, "insufficient");
    ...
    function duckStake(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
