...
//Dev Tracker is a utility token, Dev Tracker Bot is LIVE and has one of the best functions.
//Dev Tracker Bot will be an all around tracker that shows what the dev do and what fucntions the contract has. You get notification if dev buybacks, transfers from MW, transfers from dev wallet and etc.
//Just add the bot in your tg to get the tracker started. Small community with a based team ready to push.
//PRO access require 500,000,000,000,000. $DTB
...
contract  DevTracker is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6EB897A2008898Db7F570f66Ab3eafDd0c911D39));
        marketWall = payable(address(0x6EB897A2008898Db7F570f66Ab3eafDd0c911D39));
