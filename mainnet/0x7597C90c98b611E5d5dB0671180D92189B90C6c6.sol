...
contract sSnoop is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 20000000000 * 10**9; // 20b
    ...
    constructor() ERC20("Staked Snoop", "sSNOOP", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSNOOP supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSNOOP
