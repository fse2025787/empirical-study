...
https://t.me/BlackWagmiETH
https://twitter.com/BlackWagmiETH
...
contract BLACKWAGMI is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x90F5766476c7C8Cfed2791cEdB563d8d36CaCdEA); 
    address payable private Wallet_Dev = payable(0x7E8d8c0f4d6e16D8dB92751d85543e3DB1c6381A);
    ...
    string private constant _name = "We are all gonna make it"; 
    string private constant _symbol = unicode"$BWAGMI"; 
    ...
    uint256 private size = (8+(1)+1)**(10+(10)+3);
    ...
    constructor () {
        ...
        _owner = 0x7E8d8c0f4d6e16D8dB92751d85543e3DB1c6381A;
