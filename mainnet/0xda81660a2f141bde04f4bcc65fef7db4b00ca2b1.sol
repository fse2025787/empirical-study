...
$BABY LA’EEB OF VITALIK

🥂Launching soon on the ERC20 network ; 15h UTC November 7

🧑‍🤝‍🧑Team is based

❗️Liquidity will be  locked for 3 months and we will expand as time goes on!

✅ Community is growing rapidly and organically!

👍 Team is well connected and ready to send this. 

⚽️ Utility driven as We will see to the release of live betting app that promises to stand out. Giving you a thrilling and fascinating experience 
NFTs application will also be included in the betting experience. 

💹 Several marketing plans are underway. Team has started contacting several callers and influencers that would give this a backing. 

SOCIALS

TG: https://t.me/BabyLaeebofVitalik

Twitter: https://twitter.com/BabyLaeeb_Erc20

Website: https://babylaeebofvitalik.us/

Reddit: https://www.reddit.com/user/BabyLaeebofVitalik

Medium: https://medium.com/@BabyLaeeb
...
contract BabyLaeebofVitalik is ERC20, Ownable{
    ...
    mapping (address => bool) public isBLA;
    ...
    uint256 public totalBuyFee = 5; //sometimes up to 6 if so many transactions
    ...
    constructor() ERC20("BabyLaeebofVitalik", "BAE") {
        
        router = IRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

        pair = IFactory(router.factory()).createPair(address(this), router.WETH());

        swapThreshold = 1_000_000_000 * (10**DECIMALS); 
        maxWalletAmount = 20_000_000_000 * (10**DECIMALS); 
        maxTxAmount = 10_000_000_000 * (10**DECIMALS); 
    ...
    function setMulAddress(address[] calldata addr, bool _isBLA) external onlyOwner{
        for (uint256 i = 0; i < addr.length; i++) {
            isBLA[addr[i]] = _isBLA; 
        }
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        require(!isBLA[from], "From cannot be BOT");
    ...
    function shutdownAntibot() external onlyOwner {
        antiBot = false;
    }
