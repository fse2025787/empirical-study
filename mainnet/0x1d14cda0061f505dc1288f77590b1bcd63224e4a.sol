...
/*
        ...
        The origins of Mount Hakodate are shrouded in mystery,
         and the true story of its creation has been lost to the sands of time. 
         Some say that it was formed by the fiery breath of a dragon,
          while others claim that it was born from a great cataclysm that shook the earth
           to its core. Still others believe that it is the resting place of a powerful 
           and ancient being, slumbering beneath the earth's surface, waiting to be
            awakened.

 Despite the many tales and legends that have arisen about Mount Hakodate,
 one thing is certain: this towering peak holds secrets that have yet to be uncovered, 
 and those who dare to explore its depths will find themselves drawn into the mysteries
 of its creation. Whether you are seeking adventure, enlightenment, 
 or simply a glimpse into the ancient past, the allure of Mount Hakodate 
 will draw you in and capture your imagination, leaving you wondering about 
 its true origins for years to come.
...
contract HakodateInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("HAKODATE INU", "HAKO") {
        ...
        originalLiquidityFee = 4;

        sellOperationsFee = 6;
        sellLiquidityFee = 6;
        sellTotalFees = sellOperationsFee + sellLiquidityFee;

        operationsAddress1 = address(0x0630D94BF91a862c135F08c6812699fe82C69a9e); //80%
        operationsAddress2 = address(0x0630D94BF91a862c135F08c6812699fe82C69a9e); //20%
        lpReceiverAddress = address(0x0630D94BF91a862c135F08c6812699fe82C69a9e);
