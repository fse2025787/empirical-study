...
/**
https://twitter.com/BullsVsBearsErc
https://t.me/BullsVsBearsPortal
*/
// 
...
contract BULLSVSBEARS is ERC20, Ownable {
    ...
    constructor() ERC20("BULLS VS BEARS", unicode"🐂VS🐻") payable {
    	...
    	marketingWallet = address(0xB331c974f3E0029530463b878CCb2ad1cc3b86c7); // set as Marketing wallet
        devWallet = address(0x202aB3825997D3cC91C6819A39784264B981B932); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xB331c974f3E0029530463b878CCb2ad1cc3b86c7, true);
        excludeFromFees(0x202aB3825997D3cC91C6819A39784264B981B932, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xB331c974f3E0029530463b878CCb2ad1cc3b86c7, true);
        excludeFromMaxTransaction(0x202aB3825997D3cC91C6819A39784264B981B932, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x202aB3825997D3cC91C6819A39784264B981B932,
            block.timestamp
        );
    }
