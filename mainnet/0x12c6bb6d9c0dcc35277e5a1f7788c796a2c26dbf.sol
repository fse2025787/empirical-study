...
/** 
    ...
    https://twitter.com/TokenTanuki
    https://t.me/tanukidensetsuportal
    https://medium.com/@tanukitokenofficial/2403530d11ed
*/
...
contract Tanuki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC0A70c1Ed5e7c5286d9716f3da26377217b8Eb9d); // Marketing Address
    address payable public multiSigAddress = payable(0xC0A70c1Ed5e7c5286d9716f3da26377217b8Eb9d); // Marketing Address
    address payable public devAddress = payable(0xC0A70c1Ed5e7c5286d9716f3da26377217b8Eb9d); // Dev Address
    address payable public liquidityAddress = payable(0xC0A70c1Ed5e7c5286d9716f3da26377217b8Eb9d); // Liquidity Address
    ...
    string private constant _name = "Tanuki";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 200 / 10000; // 1% max txn
