...
contract DickToadz is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public pricePerToken = 0.069 ether;
  ...
  constructor() ERC721A("DickToadz", "DTOADZ") {}
  ...
  function setMaxMintAmountPerWallet(uint256 newAmount) external onlyOwner {
    maxMintAmountPerWallet = newAmount;
  }

  function setTokenCost(uint256 newCost) external onlyOwner {
    pricePerToken = newCost;
  }
