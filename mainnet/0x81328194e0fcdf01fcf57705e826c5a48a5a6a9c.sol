...
contract MetaFortunes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRvkVgRFgQskQbaepBueYaZYBGmjf8pYm4ebUhoVtF559";
    ...
    constructor(
    ) ERC721A("MetaFortunes", "Web3-Fortune", 100, maxSupply) {
    }
