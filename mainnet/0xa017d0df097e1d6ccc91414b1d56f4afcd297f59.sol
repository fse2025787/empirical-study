...
Look for $PLAT1 on Twitter. You will find Teh Platinum One.
...
contract PLATINUM is ERC20, Ownable {
    ...
    constructor() ERC20("PLAT1", "Teh Platinum One") {
        ...
        uint256 _earlySellMarketingFee = 29;
	    uint256 _earlySellDevFee = 0;
        uint256 totalSupply = 100 * 1e9 * 1e18;
 
        maxTransactionAmount = totalSupply * 3 / 1000; // 3% maxTransactionAmountTxn
        maxWallet = totalSupply * 35 / 1000; // 3,5% maxWallet
