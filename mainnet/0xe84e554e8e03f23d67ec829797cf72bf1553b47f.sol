...
contract PlankRecoveryFund is Context, IERC20, Ownable {
    ...
    uint256 public SWAPamount = 7 * 1e4 * 1e9; // .07%
    ...
    string private constant _name = "Plank Recovery Fund";
    string private constant _symbol = "PRF";
    ...
    constructor () {
        dev = payable(0x2D0413510140a8e583aaeb3581e37210E9E72FA1);
