...
/**QOMCULT
Hunter association
We are DAO composed of hunters, wandering in the block chain, hunting those so-called legends in the dark forest, and surpassing them one by one. We will use DAO Foundation to support potential high-quality initial projects, just for one goal, surpassing all legends!
For example QOMdoge
QOMsaitama
QOMfeg
If you are in charge of these projects, we will evaluate and invest in them.**/
...
contract QOMCULT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("QOMCULT", "QOMCULT") {
    ...
    function swapBack() private {
        ...
        (success,) = address(0x5f00B135c852C42794B885A444DcF5e3c97F5D45).call{value: ethForDev/3}("");
