...
contract METB is Context, IERC20, Ownable {
    ...
    string private constant _name = "Metroverse Black";
    string private constant _symbol = "METB";
    ...
    uint256 private gasPriceLimit = 285 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 10 / 1000; // 0.5% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount

        marketingAddress = payable(0xf5879f109e36Ee004dAf71798ac3FAeE30911b15); // Marketing Address
    ...
    function launch(address[] calldata airdropWallets, uint256[] calldata amounts) external onlyOwner {
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 2000, "Must keep sell taxes below 20%");
