...
//Master Matrix Ai 
//Find the tg and know more.
//All tools to recognize safe tokens on ETH. All is easy with MatrixBot. 
...
contract MasterMatrixAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Master Matrix AI";
    string private _symbol = unicode"MMxAI";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x01eB233978582E2efb34735a0515F6C996d814DD));
        marketingWallet = payable(address(0x376490b07B7b4992715faE37D6ABE832425AEbB4));
