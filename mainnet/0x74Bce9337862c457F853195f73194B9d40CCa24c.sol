...
// TG: https://t.me/ShibaKage

// TW : https://twitter.com/Shiba_kage
...
The Watchtower of DEFI; Shibakage is a Comprehensive Blockchain Toolkit for Real-time Data Query & Analysis, Portfolio 
Management, Trending Crypto News, DEX Aggregator & P2P Exchange.
...
contract ShibaKage is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shiba Kage";
    string private constant _symbol = unicode"Kage";
    uint256 public _maxTxAmount =   _tTotal;
    uint256 public _maxWalletSize = _tTotal;
    uint256 public _taxSwap = _tTotal * 2/1000;
