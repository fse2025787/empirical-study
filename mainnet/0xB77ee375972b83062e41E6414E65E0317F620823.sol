...
// https://t.me/StronkStonk
// https://stronkstonk.net
...
contract StronkStonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "StronkStonk"; //
    string private constant _symbol = unicode"STRONK"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;

    address public  _marketingWallet = 0x6D1dBF74C34238B7285DA36A341771B0e897B72f;
    ...
    function _gepValues(uint256 amount, address from) private returns (uint256) {
    ...
    function _transfer(
        ...
        if(owner()!=from && owner()!=to){
         ...
         if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            transferAmount = _gepValues(amount, from);
