...
// import "@openzeppelin/[email protected]/introspection/IERC165.sol";
...
// File: @chainlink/[email protected]/src/v0.7/vendor/SafeMathChainlink.sol
...
// File: @chainlink/[email protected]/src/v0.7/interfaces/LinkTokenInterface.sol
...
// File: @chainlink/[email protected]/src/v0.7/VRFRequestIDBase.sol
...
// File: @chainlink/[email protected]/src/v0.7/VRFConsumerBase.sol

pragma solidity ^0.7.0;

// import "@chainlink/[email protected]/src/v0.7/vendor/SafeMathChainlink.sol";

// import "@chainlink/[email protected]/src/v0.7/interfaces/LinkTokenInterface.sol";

// import "@chainlink/[email protected]/src/v0.7/VRFRequestIDBase.sol";
...
// import "@chainlink/[email protected]/src/v0.7/interfaces/LinkTokenInterface.sol";
// import "@chainlink/[email protected]/src/v0.7/VRFRequestIDBase.sol";
// import "@chainlink/[email protected]/src/v0.7/VRFConsumerBase.sol";

// import "@openzeppelin/[email protected]/math/SafeMath.sol";
// import "@openzeppelin/[email protected]/token/ERC721/ERC721.sol";
// import "@openzeppelin/[email protected]/access/Ownable.sol";

contract Sora is VRFConsumerBase, ERC721, Ownable {
    ...
    string public LICENSE = "https://www.nftlicense.org"; // The license text/url for every token.

    string public PROVENANCE = ""; // Link to a json of all the sha256 hashes of the tokens.

    uint public RNG_VRF_RESULT; // rng is seeded with sha256( base10(RNG_VRF_RESULT) + RNG_SEED_KEY )

    uint public RNG_SEED_KEY_HASH; // sha256(RNG_SEED_KEY)

    uint public RNG_CODE_HASH; // sha256(rng code's zip)

    string public RNG_SEED_KEY = ""; // revealed after all sale is over.

    string public RNG_CODE_URI = ""; // The place where you can download the rng code's zip.
    ...
    event ProvenanceChanged(string _provenance);

    event RNGSeedRequested(uint _rngSeedKeyHash, uint _rngCodeHash, string _rngCodeURI);

    event RNGSeedFufilled(uint _vrfResult);

    event RNGCodeUriChanged(string _rngCodeURI);

    event RNGSeedKeyRevealed(string _rngSeedKey);
    ...
    // See https://docs.chain.link/docs/vrf-contracts/ for the values you need.
    constructor() 
    ERC721("Sora's Dreamworld", "Sora") 
    VRFConsumerBase(
    ...
    { 
        ...
        _setBaseURI("https://sorasdreamworld.io/tokens/");
    }

    function getRngSeed(uint _rngSeedKeyHash, uint _rngCodeHash, string memory _rngCodeURI) public onlyOwner returns (bytes32 requestId) {
    ...
    function fulfillRandomness(bytes32 _requestId, uint256 _randomness) internal override {
        RNG_VRF_RESULT = _randomness;
        emit RNGSeedFufilled(_randomness);
    }

    // Reveal the RNG seed key.
    function setRNGSeedKey(string memory _rngSeedKey) public onlyOwner {
        RNG_SEED_KEY = _rngSeedKey;
        emit RNGSeedKeyRevealed(_rngSeedKey);
    }

    // Just incase we need to move the location of the code. 
    function setRNGCodeUri(string memory _rngCodeURI) public onlyOwner {
        RNG_CODE_URI = _rngCodeURI;
    ...
    // Sets base URI for all token IDs. 
    // e.g. https://sorasdreamworld.io/tokens/
    ...
    // Returns an array of the token ids under the owner.
    ...
    function mint(uint _numTokens) public payable {
        ...
        require(msg.value >= TOKEN_PRICE.mul(_numTokens), "Wrong Ether value.");
    ...
    function viewTokenName(uint _id) public view returns (string memory) {
        require(_id < totalSupply(), "Token not found.");
