...
contract nation3inu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nation3 INU";
    string private constant _symbol = unicode"Nation3 INU";
