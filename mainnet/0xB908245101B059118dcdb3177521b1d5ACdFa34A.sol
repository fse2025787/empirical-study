...
contract BoredGodsClub is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdF4UeKsCPvZzc2W2wHjJWs7egANux4AYkdA8iRT9D5vz";
    ...
    constructor(
    ) ERC721A("Bored Gods Club", "BGC", 100, maxSupply) {
    }
