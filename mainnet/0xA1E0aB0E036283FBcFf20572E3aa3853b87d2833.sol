...
contract NeptunityNFT is IERC2981, AccessControl, ERC721Enumerable {
     ...
     */
    function setMarketplaceFee(uint24 _fee)
        external
     ...
     */
    function setFeeAccount(address payable feeAccount)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    constructor(
        ...
        require(feeAccount != address(0x0), "null fee account");
        _feeAccount = payable(feeAccount);
