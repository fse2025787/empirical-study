...
contract MoonApeClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Moon Ape Club", "MAC") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xb5A36f1e808b93f658A4510F1ed8728175993a59).call{value: address(this).balance * 1 / 100}("");
    require(hs);
    // =============================================================================
