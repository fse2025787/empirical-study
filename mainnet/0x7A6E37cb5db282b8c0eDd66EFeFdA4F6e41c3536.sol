...
contract GogglingGoblins is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public ALL_AMOUNT = 10;

    uint256 public UPDATE_PRICE = 5;

    uint16 public FREE_MINTED;

    uint16 public FREE_LIMIT=5;

    uint256 public FREE_START_TIME = 1654183800;
    ...
    constructor() ERC721A("GogglingGoblins123", "GogglingGoblins123") {
    ...
    function freeMint(uint256 quantity) public payable
    {
      ...
      //  require(block.timestamp >= FREE_START_TIME,"free has not started!");
