...
/**
https://twitter.com/tsukagroweth
TG AND MEDIUM WILL BE POSTED ON TWITTER SHORTLY AFTER LAUNCH
*/
...
contract  TSUKAGROW is Context, IERC20, Ownable {
    ...
    string private constant _name = "TSUKA GROW";
    string private constant _symbol = "TGROW";
    ...
    uint256 private _maxTxAmount = 4_000_000 * 10**9;
