...
The cute and fluffy child of $SHI and $SHIB!

4% tax to $SHI DEPLOYER
2% tax to $BSHI MARKETING
 ...
 *
 * Finally, the non-standard {decreaseAllo wance} and {increaseAllowance}
...
contract BabyShinaInu is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Shina Inu", "BSHI") {
        ...
        marketingWallet = address(0x0129829dBE7a41bBED9626DF482A2fc38e21584A); // set as marketing wallet
        devWallet = address(0x70393d4B985AE48Cded1e1882fad2aF3e7DbeFb2); // set as dev wallet
