...
Community is one thing, but fcm is much stronger, the bonds between fcm members are sencere.

I will do my part from the sidelines.
Trust the process.
...
contract FiveCardMiracle is Context, IERC20, Ownable {
    ...
    string private _name = "FiveCardMiracle";
    string private _symbol = "FCM";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 99, "Tax fee cannot be more than 99%");
        _taxFee = taxFee;
    }
