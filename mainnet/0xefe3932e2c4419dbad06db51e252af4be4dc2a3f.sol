...
contract WOTHA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "WOTHA";
    string private constant _symbol = "$WOTHA";
    ...
    address payable private _developmentAddress = payable(0x0808AcB282958118E245c8807faE40FbE2Ce99B5); 
    address payable private _marketingAddress = payable(0x0808AcB282958118E245c8807faE40FbE2Ce99B5);
