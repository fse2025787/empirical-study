...
contract elonRing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Elon Ring";
    string private constant _symbol = "ERING";
    ...
    address payable private m_Address = payable(0x908CbC87A8e670F2Cb4526864a316d7ceFD72963);
