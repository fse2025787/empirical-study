...
It's safe to say that the calamity blossomed.

Lowering taxes to 3/3 after 30 minutes. Unlike the mess that happened today, this contract is completely safe. Keep your heads up frens.
...
contract Calamity is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Blossomed Calamity", "BLOSSOM") {
    ...
    ; uint256 totalSupply = 1 * 1e12 * 1e18;
        ...
        maxTransactionAmount = totalSupply * 18 / 1000; // 1.5% maxTransactionAmountTxn
