...
Hold $ApePay and earn free APE !

Tax fee : 7% (5% APE rewards - 2$ marketing) 

Auto rewards, don't need to claim it!
...
contract ApePay is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"ApePay"; ////
    string public constant symbol = unicode"APEPAY"; ////
