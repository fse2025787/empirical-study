...
contract ApeChain is ERC20, Ownable {
    ...
    constructor() payable ERC20("Ape Chain", "ApeChain") {
        ...
        operationsAddress = address(0x00596a4E29539Ff1651c5025656749D3d9FDD1a4);
        treasuryAddress = address(0x00596a4E29539Ff1651c5025656749D3d9FDD1a4);
    ...
    function removeEarlyBuyer(address wallet) external onlyOwner {
        require(boughtEarly[wallet], "Wallet is already not flagged.");
        boughtEarly[wallet] = false;
    }

    function addEarlyBuyer(address wallet) external onlyOwner {
