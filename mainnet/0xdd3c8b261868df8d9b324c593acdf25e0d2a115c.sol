...
// t.me/shiba_wallet_protocol_portal
...
// Main Contract Logic 
// --------------------------------------------------------------
contract ShibaWallet is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Shiba Wallet Protocol";
    string private _symbol = "ShibaWProtocol";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x14Ac255C199418be6c5fdfFc0348846F3440f643);
    address payable public operationsWallet =  payable(0x14Ac255C199418be6c5fdfFc0348846F3440f643);
    ...
    uint256 public maxTotalFeeSell = 20;

    // distribution ratio
    uint256 public _liquiditySharePercentage = 50;
    uint256 public _operationsSharePercentage = 50;
