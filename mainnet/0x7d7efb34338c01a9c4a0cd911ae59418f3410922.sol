...
Link : 
Twitter - https://twitter.com/CONNECTION_ETH
Medium -  https://medium.com/@connectioneth
Telegram - will be revealed later
...
contract  CONNECTION is Context, IERC20, Ownable {
    ...
    string private constant _name = "CONNECTION";
