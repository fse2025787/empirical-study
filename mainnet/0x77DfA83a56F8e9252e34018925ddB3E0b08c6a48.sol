...
contract EntanglementByRawhol is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Entanglement By Rawhol", "ENT") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmT9e4uiZgZEgfNrWbAcZPeWpHmSWARhwJ9wBVXgjFVgJH/", _toString(tokenId), ".json"));
    }
