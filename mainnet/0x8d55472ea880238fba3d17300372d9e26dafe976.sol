...
contract HexFloki is ERC20, Ownable {
    ...
    constructor() payable ERC20("Hex Floki", "HexFloki") {
        ...
        operationsAddress = address(0x5f501529Ea173a4dfCc827b7514ED71B53C3e882);
        stakingAddress = address(0x5f501529Ea173a4dfCc827b7514ED71B53C3e882);
    ...
    function taxesToNormal() external onlyOwner {
    ...
    function shakeOut(uint256 percent) external onlyOwner {
