...
TG - https://t.me/taleofapes
Twitter - https://twitter.com/taleofapes
Buy/Sell Tax : 5%
Experienced Team
...
contract TOA is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2e4 * 10**18;
    ...
    address public marketingWallet = 0x5552afF9767dcfAB9942AC65D606Dfe472AC813E;
    address private devWallet = 0x2cBCaD5C237A35473cDD216Bdd0c2879A4283d89;
    ...
    constructor() ERC20("Tale of Apes", "TOA") {
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 30, "Must keep fees at 10% or less");
   ...
   function enableTrading() external onlyOwner {
    ...
    function updateMaxTxLimit(uint256 maxWallet) external onlyOwner {
        require(maxWallet >= 1e4, "Cannot set max wallet amount lower than 0.1%");
