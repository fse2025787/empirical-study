...
contract Corsair_Cat is ERC2981, ERC721A, Ownable {
    using Strings for uint256;


    uint32 public constant MAX_SUPPLY = 555;


    uint32 public _MintPerWallet = 3;

    bool public _publicMintActive = true;
    
    uint256 public _price = 0.001 ether;

    string public _prerevealURI = "ipfs://QmbqULR2x5QhwfYLAQRUzvCH4Mb9oGgY6orf9BgUwKmaAq";
    string public _matadataURI;

    constructor() ERC721A("Corsair Cat", "CorsairCat") {
