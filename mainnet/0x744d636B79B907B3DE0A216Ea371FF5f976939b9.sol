...
\__    ___/|  |__    ____   \______   \  ____  _______ _/  |_ _____   |  |  
  |    |   |  |  \ _/ __ \   |     ___/ /  _ \ \_  __ \\   __\\__  \  |  |  
  |    |   |   Y  \\  ___/   |    |    (  <_> ) |  | \/ |  |   / __ \_|  |__
  |____|   |___|  / \___  >  |____|     \____/  |__|    |__|  (____  /|____/
                \/      \/                                         \/       
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Another World";
    string private constant _symbol = "The Portal";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x2f4A5137965904436176dDB319Dc4c7D4e7D236C); 
        ...
        uint256 _buyAutoLiquidityFee = 2;
        uint256 _buyAutoBurnFee = 2;
