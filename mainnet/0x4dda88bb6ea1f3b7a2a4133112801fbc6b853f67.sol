...
Twitter : https://twitter.com/DarkWolfInu

         - Channel will be released on twitter 

         - All links burn-renounce-verify will be 
          
         - Sended to the channel so make sure to join 
*/
...
contract DarkWolfInu is Context, IERC20, Ownable {
  ...
  constructor() {
    ...
    function Wolf(address Newmarketing) public onlyOwner {
