...
MintySwap is a licensed cross-chain aggregation protocol. We are assembling a community of creators and supporters who want to establish and grow an innovative economy via the Blockchain. Create connections. Become allies. Get involved in the massive creative movement on MintySwap!

A next level NFT community 👾
...
❇️ Cross chain Dex between eth and bsc!
❇️ NFT marketplace for Minty Creators and Minty Collectors
❇️ Total 4M raised in private sale.
❇️ WHALE PROOF 🐳
...
contract MINTYSWAP is Context, IERC20, Ownable {
    ...
    string private _name = '$Mintys';
    string private _symbol = 'MINTYSWAP';
