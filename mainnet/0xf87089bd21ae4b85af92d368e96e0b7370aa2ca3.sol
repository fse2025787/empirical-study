...
contract FableofTarocchi is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Fable of Tarocchi", "TARO") {
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 100000000) / 1e18, "Cannot set maxTransactionAmount lower than 0.1%");
        maxTransactionAmount = newNum * 1e18;
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 100000000)/1e18, "Cannot set maxWallet lower than 0.5%");
