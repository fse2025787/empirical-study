...
// File: contracts\GFarmBridgeableNft3.sol



pragma solidity 0.7.5;

contract GFarmBridgeableNft3 is ERC721{

	address swapContract;

	constructor(address _swapContract) ERC721("GFarmNFT V2 Type 3", "GFARM2NFT3"){
		require(_swapContract != address(0));
		swapContract = _swapContract;
	}

	function mint(address to, uint tokenId) external{
		require(msg.sender == swapContract, "ONLY_SWAP_CONTRACT");
		_mint(to, tokenId);
	}
