...
Telegram: https://t.me/NanoAIportal
Twitter: https://twitter.com/nanoaiboterc  
Medium: https://nanoaibot.medium.com/ 
...
contract NanoAI is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    //old testnet - 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    // pcs testnet - 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    uint256 public buyMktngFee;
    uint256 public buyLiquidityFee;
    uint256 public buyDevFee;
    uint256 public buyOpsFee;

    uint256 public sellTotalFees;
    uint256 public sellMktngFee;
    ...
    constructor() ERC20("Nano AI", "NANOai") {
        ...
        // launch buy fees
        uint256 _buyMktngFee = 1;
        uint256 _buyLiquidityFee = 1;
        uint256 _buyDevFee = 4;
        uint256 _buyOpsFee = 4;
        
        // launch sell fees
        uint256 _sellMktngFee = 0;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 30;
        uint256 _sellOpsFee = 30;

        uint256 totalSupply = 100_000_000 * 1e18;

        maxTransactionAmount = 2_000_000 * 1e18; // 3% max txn at launch
        maxWallet = 2_000_000 * 1e18; // 3% max wallet at launch
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05% swap wallet

        buyMktngFee = _buyMktngFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyDevFee = _buyDevFee;
        buyOpsFee = _buyOpsFee;
        buyTotalFees = buyMktngFee + buyLiquidityFee + buyDevFee + buyOpsFee;

        sellMktngFee = _sellMktngFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellOpsFee = _sellOpsFee;
        sellTotalFees = sellMktngFee + sellLiquidityFee + sellDevFee + sellOpsFee;

        mktngWallet = address(0xa1a5116cA5C191037eebFACe49219347d51E5719); 
        devWallet = address(0x029372B5b502912f3D28468Aa288cC914D2df978); 
        liqWallet = address(0x029372B5b502912f3D28468Aa288cC914D2df978); 
        opsWallet = address(0x66D8f73e32469d90fD72d351fD828864734C7115);
    ...
    function initialLp() external onlyOwner() {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForMarketing += (fees * sellMktngFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokensForMarketing += (fees * buyMktngFee) / buyTotalFees;
    ...
    function rekSnipers(address[] calldata blockees, bool shouldBlock) external onlyOwner {
