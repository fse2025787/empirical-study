...
contract HINU is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x2b6dFD975fa2D46343a5C067F0B52ecF542b14AA);
    address payable private _marketingAddress = payable(0x2b6dFD975fa2D46343a5C067F0B52ecF542b14AA);
