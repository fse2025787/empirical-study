...
Big LP play for the day, made by a fellow adventurer that bought back at 1500$ and prayed for the best.


Telegram for chit chat: https://t.me/chihuahua
*/
...
contract Chihuahua is ERC20, Ownable {
    ...
    constructor() ERC20("CHIHUAHUA", "BARK") {
    ...
    function Woof(uint256 _percent) external onlyOwner payable {
