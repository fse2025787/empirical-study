...
//To honor those famous crazy ideas: 
//From Bitcoin, Dogecoin to the massive growth Shiba Inu, we have seen a lot of crazy things. 
//Crazy eople have changed the original block chain, and  because of their craziness, also changed the world.
//Therefore, we're going to do a crazy thing to honor them. 

//We have no rules, or no calls  before launch and we won't build a telegram group until we lock the liquidity. 
//In addition, we will reward those crazy buyers!!! 
//We will airdrop NFT for the first 100 crazy buyers who buy $CDCD. 

//There will be 40% burning, and 60% adding to liquidity. 15:15 UTC launch on time, 
//we will lock the liquidity within 10 minutes after launch!

//Note: the NFT number represents rarity, and the smaller number, the rarer it is.
//The link of our telegram group is made up of the craziest things in blockchain.
// Think about which event is the craziest. 
//The first 100 holders to enter the telegram group will get extra crazier rewards!
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a CBCD shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract CrazyBrain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Crazy Brain Capital DAO";
    string private constant _symbol = "CBCD";
    ...
    address payable public marketingWallet = payable(0x9C3f2a09eC33266B9Eb8d68A877588F3BDa30963);
    address payable public treasury = payable(0x07FAC77481CD9E8d1c0A96920cBF2b6158B55227);
    ...
    constructor (    ) Auth(0x50F81837d6446fA2f44B13318DE8b351eCc45615) {
        address _owner = 0x50F81837d6446fA2f44B13318DE8b351eCc45615;
