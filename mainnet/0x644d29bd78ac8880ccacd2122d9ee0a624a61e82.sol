...
contract Flockers is ERC721A, Ownable {

    uint256 public constant MAX_SUPPLY_LIMIT = 2125;
    uint256 public constant MINT_COST = 0.00 ether;
    uint256 public constant MAX_MINT_AMOUNT_PER_TX = 20;
    uint256 public constant MAX_MINT_AMOUNT_PER_WALLET = 20;
    

    bool public paused = true;
    bool public revealed = false;
    uint256 public maxSupply = 2125;
    ...
    constructor(string memory hiddenMetadataURI) ERC721A("Flockers", "FLOCK") {
