...
contract BoredKevinKevinKlub is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "QmSoafJXpaCWNpPFkpSjdXZujpXQXVPfEPbbgMFcnn5bMM";
    ...
    uint256 public NUM_FREE_MINTS = 450;
    ...
    constructor(
    ) ERC721A("Bored Kevin Kevin Klub","KKK", 100, maxSupply) {
    }
