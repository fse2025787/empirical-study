...
contract DreamCatcher is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 0.008 ether;
    uint256 private whitelistCost = 0.0 ether;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://bafybeifzdexsesahrlns77k4oicicnaryyelarebi3kxrx3rnvetbqv3si/",
