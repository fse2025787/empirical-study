...
contract TwitterCoin is Context, IERC20, Ownable {
    ...
    address payable private taxWallet1 = payable(0x9f88f986A41042443C361340A96c9bAc74798fA2);
    address payable private taxWallet2 = payable(0x9f88f986A41042443C361340A96c9bAc74798fA2);
