...
contract BurtonSquad is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Burtons Squad", "MONSTER") {
        setHiddenMetadataUri("https://api.burtonsquad.monster/");
        setBaseURI("https://api.burtonsquad.monster/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Monsters");
    ...
    function ButchMint(address to, uint256 quantity)public onlyOwner{
