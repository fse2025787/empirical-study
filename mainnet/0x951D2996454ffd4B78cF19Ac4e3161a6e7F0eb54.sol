...
// 
//
//  WELCOME TO THE YEAR OF SHARKEEL!
//  Sharkeel token is a fully decentralized community-based ERC20 cryptocurrency token on the Ethereum smart chain. 
//  Our goal is very simple - we are building the exclusive community of creatives, developers, designers, entrepenurs, writers and investors who are crypto enthusiasts and are passionate about using their skills and knowledge to make an impact in the world!
//
//      Tokenomics:
//     - FAIRLAUNCH!!
//     - Buy & sell fee 5%
//     - 2% initial max wallet & tx
//     - Renounced & locked contract        
//
//  Website: https://sharkeel.com/
//  Telegram: https://t.me/sharkeel
...
contract Sharkeel is ERC20, Ownable {
    ...
    constructor() payable ERC20("Sharkeel", "$SHK") {
