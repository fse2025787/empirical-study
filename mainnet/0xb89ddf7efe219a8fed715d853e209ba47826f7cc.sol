...
/*
What are you going to FUD about anon ? When there's no tax , no tg , no medium?
Proof that a token can moon with or without FUD.
*/
...
contract POF is ERC20, Auth {
    ...
    string public constant name = "Proof of FUD";
    string public constant symbol = "POF";
