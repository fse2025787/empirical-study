...
contract SACRED is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Sacred Protocol";
    string private constant _symbol = unicode"$SAC";
    ...
    address payable private _developmentAddress = payable(0x9ED6bD58655Aceba990FA1d8CF02124cBaa6a094); 
    address payable private _marketingAddress = payable(0x9ED6bD58655Aceba990FA1d8CF02124cBaa6a094);
