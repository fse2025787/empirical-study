...
// File: contracts/PixelPudgyPenguins.sol
...
contract PixelPudgyPenguins is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmVFUvE9Lso2BADiUjm82rcx7SGSkvDQXToFkK16S4Fx23";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 2000;
    uint256 public INSTANT_FREE_MINTED = 1;


    event Minted(address minter, uint256 amount);

    constructor( ) ERC721A("Pixel Pudgy Penguins", "PLPP") {
