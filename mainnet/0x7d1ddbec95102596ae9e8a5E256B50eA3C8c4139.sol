...
contract Trembling is ERC721A {
    ...
    constructor() ERC721A("Trembling.WTF", "Trembling") {
        owner = msg.sender;
        maxSupply = 2000;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmSCqJ7audT83iANWYqGFswgtyanT6FHgMvx8xrojTvqJx/", _toString(tokenId), ".json"));
    }
