...
/**
    ...
    BabyShinji  - BABYSHINJI

    Tg: https://t.me/babyShinji_ETH
...
contract BabyShinji is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xcB1AF028915f1683bb50246CA3d3E12Fc010Cb7E); // Marketing Address
    ...
    string private constant _name = "BabyShinji";
    string private constant _symbol = "BABYSHINJI";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 1 / 100; // 1% max txn
        minimumTokensBeforeSwap = _tTotal * 3 / 10000; // 0.03%
        maxWallet = _tTotal * 3 / 100; // 3%
        ...
        marketingAddress = payable(0xcB1AF028915f1683bb50246CA3d3E12Fc010Cb7E); //  update to marketing address
