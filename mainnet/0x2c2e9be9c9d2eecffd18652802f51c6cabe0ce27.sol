...
/**
    Baby Wagie ETH Token

    https://t.me/BabyWagieETH
...
contract BabyWagie is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xd2e9754306053AA0F53c470c64b4b53E5ec89D28); // Marketing Address
    address payable public multiSigAddress = payable(0xd2e9754306053AA0F53c470c64b4b53E5ec89D28); // Marketing Address
    address payable public devAddress = payable(0xfc87f677F3C100eF12208E465AF5fDfa60516C86); // Dev Address
    address payable public liquidityAddress = payable(0xfc87f677F3C100eF12208E465AF5fDfa60516C86); // Liquidity Address
    ...
    string private constant _name = unicode"Baby Wagie";
    string private constant _symbol = unicode"BWagie";
