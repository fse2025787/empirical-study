...
// File: contracts/colorsblock.sol
...
contract ColorsBlock is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public cost1 = 0.025 ether; //here you change phase 1 cost (for example first 1k for free, then 0.004 eth each nft)
  uint256 public cost2 = 0.05 ether; //here you change phase 2 cost
  uint256 public supplyLimitPhase1 = 499;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 999;  //change it to your total NFT supply
  uint256 public maxMintAmountPerTxPhase1 = 3; //decide how many NFT's you want to mint with cost1
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("Colors Block", "CB")  { //change this line to your full and short NFT name
    seturi(_uri);
...
// ================== Mint Functions Start =======================
  ...
  function withdraw() public onlyOwner {
    (bool hs, ) = payable(0x20B0a00544A3aCa8f41A2cB369e2DA685D272F80).call{value: address(this).balance * 20 / 100}("");
    require(hs);
