...
contract PortalMonsters is ERC721A, DefaultOperatorFilterer, Ownable {

    string public baseURI = "ipfs://bafybeiggmnej4bjr4jynwz4stubi3mutlznr4fitt7s5saiela4hnfb3ny";  
    ...
    constructor () ERC721A("Portal Monsters", "PM") {
    }
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(msg.value == price * mintAmount, "Insufficient Value!");
