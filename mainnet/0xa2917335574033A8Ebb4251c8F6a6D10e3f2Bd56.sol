...
// File: StarNFTProxy.sol

/**
 * There is a vulnerability SWC-106 which implicitly caused by delegation to self-destruct call which will results in
 * anyone could destruct the real-contract.
 */
