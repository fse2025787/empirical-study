...
contract KIWIINU is Context, IERC20 {
    ...
    string private _name = "Kiwi Inu";
    string private _symbol = "KIWI";

    uint256 public _buyFee = 800;
    uint256 public _sellFee = 800;
    uint256 private _transferFee = 2500;

    uint256 constant private maxBuyTaxes = 1500;
    uint256 constant private maxSellTaxes = 2500;
    uint256 constant private maxTransferTaxes = 2500;
    ...
    address payable private _marketingWallet = payable(0x531604472AB8ec3F516974D2c68C2dfa703e5cD1);
    address payable private _teamWallet = payable(0x531604472AB8ec3F516974D2c68C2dfa703e5cD1);
