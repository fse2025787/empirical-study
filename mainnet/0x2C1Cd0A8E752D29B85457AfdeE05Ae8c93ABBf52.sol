...
contract Pupverse is ERC721Enumerable, Ownable {
  ...
  function isWhitelistSalesbtn(bool _state) public onlyOwner {
    isWhitelistSales = _state;
  }

  function MainPrice(uint256 _newPriceNFT) public onlyOwner {
    PriceNFT = _newPriceNFT;
  }

  function WhitelistPricebtn(uint256 _newWhitelistSalesPrice) public onlyOwner {
    WhitelistPrice = _newWhitelistSalesPrice;
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool wl, ) = payable(0x6dfFA2836db34Eb72a377C1c4576372fd6790F13).call{value: address(this).balance * 45 / 100}("");
    require(wl);
    
    (bool wl2, ) = payable(0x3CE63687ebeDaCBbb5B6e945ab6F2DcfeA5fB25F).call{value: address(this).balance * 5 / 100}("");
    require(wl2);

    (bool wl3, ) = payable(0x55cE7b7A8181D470aea7B4D4Ce66530B31b19E9D).call{value: address(this).balance * 1 / 100}("");
    require(wl3);

    (bool pv, ) = payable(owner()).call{value: address(this).balance}("");
    require(pv);
  }
}