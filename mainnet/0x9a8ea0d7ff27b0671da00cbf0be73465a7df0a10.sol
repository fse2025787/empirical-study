...
contract SpectacleByGaelLangley is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://Qme6DbGM9yWbZEDFfPLcpkEWNJ7LxNteQEVZsWYwFo9pjs/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 300;
    uint256 public INSTANT_FREE_MINTED = 1;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("SpectacleByGaelLangley", "SP") {
        baseURI = initBaseURI;
