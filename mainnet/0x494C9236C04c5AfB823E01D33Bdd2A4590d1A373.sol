...
contract ShibaFloki is Context, IERC20, Ownable {
    ...
    address private _owner = 0x67ba2971465Ec970D986509a641c0Bd35d0Ac227;
    ...
    string private constant _name = "Shiba Floki";
    string private constant _symbol = "$ShibFloki";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 10 / 1000; // 1.0% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 15 / 1000; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x67ba2971465Ec970D986509a641c0Bd35d0Ac227); // Marketing Address
        
        devAddress = payable(0x67ba2971465Ec970D986509a641c0Bd35d0Ac227); // Dev Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 2; // 1/2 goes to development
