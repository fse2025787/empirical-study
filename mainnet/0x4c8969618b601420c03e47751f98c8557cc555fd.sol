...
contract EthOnRise is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ethereum On Rise";
    string private constant _symbol = "eRISE";
    ...
    uint256 private _maxWalletSize = 400000000000 * 10**9;
