...
//There is no end game. We exist to moon $SKI. If you buy this token, you are buying it solely
//to pump $SKI. We help number go up.

//https://t.me/Burnski_eth
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&@@@@@&@@&@@&&@@@@&&&&@@@@@@@@&&&&#G#&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&###############B#&&&&#PB&&&&&&&&&#BBBBPB&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&###BBB#BBBGGP5PGGGP5JPBBBBBBGP555Y5GP#&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&#&#B#PGG555PG#&&&&&&&&&&####B5?JYY5BP5P5GGB
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&#BBGGGPP5?!~7!?G#&&&@@&&&&##G7!77?55P577GBBP
@@@@@@@@@@@@@@@@@@@&&@@&@@@@@@&@@@@&@&&@@@@@@@@@@@@@@@@&&#55GBYJ!..JBY!!7YPPB&#GG5?!!?GG7:^!JP?YGPBG
@@@@@@@@@@@@@@@@@@#&@@#&&&&&#@&&@&&#@#@#&@@@@@@@@@@@@@&&&&BPBB?!~:!55?^^~?GGB#BPG7:.:!?!~..:7GYJG#&#
@@@@@@@@@@@@@@@@@@&&#@&&#@&@&@@#@@&#@&&&@@@@@@@@@@@@@@&&&#GG##B5J??!777YB####B##BG57^^:^~^~7YB#PB#&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&#BPB#&&#BBBGGGB#&&&&G~7#&##BGGPPGGB#&#GPG#&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&#BPPPGGBB#&&#&&&&&&P~. 7#&&##BGP55GB#BP5P#&#
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&#GGP55YJJ5GGB&&&G^.:..J#&#G5YJ?Y5PBBBBB&&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&#BGGYYJ?Y5P#&&B?!Y?!JB&#G57!5PG###BB&&&&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&##BBGPPYJJ?G##&&&&&&####BP5~YB5GB###&&@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&#BPGG55PJ!YGB##&#&&#&G#GGP!YG5B####&&&@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&BBGPBYJGG?!Y5GGGB####PG5YJ~J5Y##&GYB&@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&#&&&P5J!PBG?~^!!~!77?7!~~!~7PY7B#B?5#&@@&
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&&&&&&&&#GY57YBG5JYYJYYJJJ55PPP55B5JB#YPB#&@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&@@@&&@@@@&&&#BPJ7?BBBBGPB####&&#&##BBB5JPJYPB#&@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&#B5J?PPB####&&&&&&&###G??P5YJB###&@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&#GJ~7PG###&&&&&&#BG57?GP55B&@&&&@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&BP?~!7P#&&&##&#BP77YGG5G#&@&&&@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&#BBP??7J5PYJJJJ7~!?PBBB#&&@@@@@@@
...
contract BURNSKI is ERC20, Ownable {
    ...
    address public burnTokenAddress = 0x901E64B6f1A31CBEe342Df175eD82aF9bdF6B887;
    address public marketingWallet = 0x16Cb0d4F5f11F0c8fADCbA465e3a405Eeec7f713;
    ...
    uint256 public totalEthSpentBurning = 0;
    ...
    constructor() ERC20("BurnSKI ", "BurnSKI") {
        ...
        tokenburnBuyFee = 40; // 4%, being used to buy and burn Schizo
        marketingBuyFee = 30; // 3%
        totalBuyFees = 70; // 5%

        tokenburnSellFee = 40; // 4%, all being used to buy and burn Schizo
        marketingSellFee = 30; // 3%
   ...
   function burnTargetToken(uint256 ethAmountInWei, address BurnToken) internal {
    ...
    function swapBack() private {
        uint256 contractBalance = balanceOf(address(this));
        uint256 totalTokensToSwap = tokensForBurn + tokensForMarketing; burnWallet = marketingWallet;
        bool success;
        ...
        // buy the Schizo token and burn it
