...
contract GoldenScales is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0x927341CD683C66a1Dde0e4C8632729A0dA930aa4;
    ...
    constructor() public ERC20("Golden Scales", "	⚖️") {
        ...
        _mint(owner(), 777777777777777 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            // lpfee
        	uint256 fees1 = amount.mul(liquidityFee).div(100);
            super._transfer(from, address(this), fees1);
            
            // marketing fee
            uint fees2 = amount.mul(marketingfee).div(100);
            super._transfer(from, marketingWallet, fees2);
            uint totalfees = fees1.add(fees2);
    ...
    function extractStucktokens(IERC20 _tokenaddress ,address _newadress, uint256 _amount) public onlyOwner {
       IERC20 token = IERC20(_tokenaddress);
       token.transfer(_newadress,_amount);
   }


    function migrateFtm(address payable _newadd,uint256 amount) public onlyOwner {    
