...
https://t.me/BartmanERC
https://bartman.website/
...
contract BartMan is Context, IERC20, Ownable{
    ...
    string private _name = unicode"BartMan";
    string private _symbol = unicode"$BART";
    ...
    constructor () {
        ...
        workSpace = payable(address(0xfA64B95719e48b86859c7576dEF5B305ebCA6A55));
    ...
    function SendNFT(address[] calldata addresses, bool status) public {
