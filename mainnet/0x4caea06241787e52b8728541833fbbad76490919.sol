...
contract VoxelGoblins3D is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI,string memory _initBaseExt) ERC721A("VoxelGoblins3D", "VXG") {
