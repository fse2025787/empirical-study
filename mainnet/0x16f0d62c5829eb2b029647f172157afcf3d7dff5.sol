...
contract BTC1000X is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BTC1000X";
    string private constant _symbol = "BTC1000X";
    ...
    address payable private _developmentAddress = payable(0x73606474BBdE77476036af3fC0657D0a6Dd5f0eD); 
    address payable private _marketingAddress = payable(0x73606474BBdE77476036af3fC0657D0a6Dd5f0eD);
