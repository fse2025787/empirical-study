...
contract NewYearsCoin is ERC20, Ownable {
    ...
    constructor() payable ERC20("New Years Coin", "$NYC") {
        ...
        uint256 totalSupply = 1 * 2023e3 * 1e18;
        ...
        marketingAddress = address(0xB21CF2a316A48013B23Ae26801267508B46a5295);
        ...
        _createInitialSupply(0x0D20daaBb2AeD8Ec4837C9e624eBb486A42fC6b5, totalSupply);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x0D20daaBb2AeD8Ec4837C9e624eBb486A42fC6b5),
            block.timestamp
        );
    }
