...
// This is No DEV token. Early buyer will get rich.
...
contract TRUMPET is Context, IERC20, Ownable {
    ...
    string private _name = "TRUMPET";
    string private _symbol = unicode"Trumpet";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x6cBA568A72CfdA9BEf8c4e13baF60C7598b4A872); 
    address payable public BurnedWalletAddress = payable(0x6cBA568A72CfdA9BEf8c4e13baF60C7598b4A872); 
