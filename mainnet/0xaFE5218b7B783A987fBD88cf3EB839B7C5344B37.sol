...
contract TYRANTGOLD is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Fable Of The Dawgon";
    string private constant _symbol = "TYRANT GOLD";
    ...
    uint256 public _maxSellAmount = 200_000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 20_000 * 10**_decimals;
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 1200 && !launchComplete) {
            _maxWalletAmount = _tTotal;
            _maxTxAmount = _tTotal;
            _maxSellAmount = 200_000 * 10**_decimals;
            launchComplete = true;
        }
