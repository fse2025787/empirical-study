...
这对我来说是一个实验，所以我希望每个人都能做好准备和处理。

欢迎来到 Okimako
我们不只是象征物和普通人。我们想要我们自己的生态系统，我们未来的参与，
随着时间的推移，NFT 收藏品将在其自己的市场和其他地方展示。
─────▀▄▀─────▄─────▄
──▄███████▄──▀██▄██▀
▄█████▀█████▄──▄█
███████▀████████▀
...
* 合约是安全的，锁定 35 天，所有权转移到死者的地址。
* 合约和投资组合规模不能超过 2%，税收不能超过 0%。
* 我们将通过 ETHERSCAN.io 与您联系。
* 该网站是用 50K MC 构建的。

从外面看

https://weibo.com/Okimako
https://web.wechat.com/Okimako-cn
*/
// 
...
contract Okimako is IERC20, Ownable {
    ...
    string private constant _name = "Okimako";
    string private constant _symbol = unicode"OKi";
    ...
    address internal constant development_receiver = 0xcc4a01218F540FACaCc4C2C3Ed270b385FB4eCe6; 
    address internal constant marketing_receiver = 0xcc4a01218F540FACaCc4C2C3Ed270b385FB4eCe6;
    address internal constant liquidity_receiver = 0xcc4a01218F540FACaCc4C2C3Ed270b385FB4eCe6;
