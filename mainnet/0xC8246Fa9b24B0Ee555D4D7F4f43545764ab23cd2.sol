...
contract QUEENJA is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "QUEENJA";
    string private constant tokenSymbol = "QUEENJA";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 96e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x146ca42FaBA398304B1c7100fD7c30a6d5928C4F);
        devAddress = payable(0x146ca42FaBA398304B1c7100fD7c30a6d5928C4F);
