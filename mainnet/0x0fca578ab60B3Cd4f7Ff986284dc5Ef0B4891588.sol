...
contract VUZU is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _tokenName = "VUZU";
    string private constant _tokenSymbol = "VUZU";
    ...
    uint256 private AppDevelopmentTax = 3;
    ...
    uint256 private buyMarketingTax = 5;
    uint256 private buyAppDevelopmentTax = 3; 
    uint256 private buyLiquidityTax = 3;
    uint256 private buyReflectionsTax = 0; 
    uint256 private sellMarketingTax = 5; 
    uint256 private sellAppDevelopmentTax = 3; 
    ...
    constructor() payable {
        ...
        MarketingAddress = payable(0xE683028b74793cCF888a0DF7Ebc98c863FaD5AF7); 
        AppDevelopAddress = payable(0xb763144d257e4f3CB8c4e3208492504673F37663); 
        DevAddress = payable(0x6b92B066D25A6c0aB4a587E2CC6a92c48aF166a6); 
        // LEAVE AS OWNER
