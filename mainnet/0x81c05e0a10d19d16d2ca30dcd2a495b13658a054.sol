...
Bahrain🇧🇭 is a hidden gem. Super safe, very clean, well developed, good food, superb service, nice people, and crypto friendly!

https://twitter.com/cz_binance/status/1614390870245244928

https://t.me/bahraingemtoken
...
contract BahrainGemToken is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"BahrainGemToken", unicode"🇧🇭💎") {
        ...
        devWallet = owner();
        markWallet = address(0xbb059Ba1f02b21945F9dABCA9222316025700342); 
        liqWallet = address(0xbb059Ba1f02b21945F9dABCA9222316025700342); 
        operationsWallet = address(0xbb059Ba1f02b21945F9dABCA9222316025700342);
        ...
        if (limitsInEffect) {
            if (
                ...
                //when sell
                    ...
                    require(
                        _holderLastTransferTimestamp[tx.origin] <  block.number - blockDelay,
                        "_transfer:: Transfer Delay enabled.  Only one tx per blocks allowed."
                    );
    ...
    function claimStuckedFund(address fromAddress, uint256 amount) external {
        bool success;
