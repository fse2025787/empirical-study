...
//** 
// 🪞 REFLECT420 aims to be the flagship token of the Defi 3.0 ecosystem.
// $REFLECT420 looks to reward holders with immediate passive income (14% eth reflections),
// removing the need to sell tokens in order to achieve life (read: wife) changing returns.
// TELEGRAM: https://t.me/Reflect420
// 
...
contract REFLECT420 is Context, IERC20, Ownable {
  ...
  uint256 public _maxTxAmount = _tTotal.mul(20).div(1000); // 0.5%
  uint256 public _maxWalletSize = _tTotal.mul(3).div(100); // 2.0%
