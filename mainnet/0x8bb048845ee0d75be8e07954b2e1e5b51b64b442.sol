...
//KaibaInu Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract KaibaInu is IBEP20, Ownable
{
    ...
    //Token Info 
    string private constant _name = 'Kaiba Inu';
    string private constant _symbol = 'KAIBA';
    ...
    // Team wallets
    address public constant TeamWallet=0xDdeb06c15A7bd863bc38c9c071E0D13355476c48;
    address public constant SecondTeamWallet=0x9e25C82A0d297D009A28f0d9418b0F28e14920be;
    ...
    constructor () {
       ...
       //Sets sellLockTime to be 2 seconds by default
        ...
        _buyTax=6;
        _sellTax=6;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=6;
