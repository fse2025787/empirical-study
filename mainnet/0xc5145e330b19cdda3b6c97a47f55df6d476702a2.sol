...
contract CombustInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "COMBUST";
    ...
    constructor () {
        _feeAddress = payable(0xB9B91D30d3fc963Be5C738cCb49e70F7da7E2794);
        _buyTax = 5;
        _sellTax = 5;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] 
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                ...
                uint burnAmount = contractTokenBalance.mul(3).div(5);
