...
contract FABLEOFELON is Context,IERC20, Ownable{
using Address for address;
string private _name = "FABLE OF ELON";
string private _symbol = "FELON";
...
address _owner;
address payable public marketingAddress = payable(0x51335562B8208480d9E22a080c274925eB615246);
...
uint256 FABLEOFELONCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > FABLEOFELONCOINDaycooldown, "You cant call FABLEOFELONCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function FABLEOFELONCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    FABLEOFELONCOINDaycooldown = block.timestamp + 86400;
}
