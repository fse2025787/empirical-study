...
//   / ___|_ __ _   _ _ __ | |_ ___  / ___|___   ___| | _____  \ \   / /___ \ 
//  | |   | '__| | | | '_ \| __/ _ \| |   / _ \ / __| |/ / __|  \ \ / /  __) |
//  | |___| |  | |_| | |_) | || (_) | |__| (_) | (__|   <\__ \   \ V /  / __/ 
//   \____|_|   \__, | .__/ \__\___/ \____\___/ \___|_|\_\___/    \_/  |_____|
//              |___/|_|                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7C1Ec007437759153c73E00333f8b249420C5e0E];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 6969) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiby65chxfwj6strvs5p3dhtzvdvxdko6vd6iwvduphoy4dqubibpy/";
...
// File: contracts/CryptoCocksV2Contract.sol
//

pragma solidity ^0.8.0;

contract CryptoCocksV2Contract is RamppERC721A {
    constructor() RamppERC721A("CryptoCocksV2", "COCKS"){}
}
