...
//
// https://medium.com/@VitalikMaximus/leaking-the-insider-part-1-7bd461d6fa63
//
// https://t.me/vitalikmaximus
//
// 
...
contract ETHUS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Vitalik Julis Maximus", "ETHUS") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 0.5% maxTransactionAmountTxn
        maxWallet = totalSupply * 30 / 1000; // 1.5% maxWallet
