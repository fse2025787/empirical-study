...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x907272fbeA52d475A35953F2E2bfE96faA9dC0a7];
  address public erc20Payable = 0x907272fbeA52d475A35953F2E2bfE96faA9dC0a7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUrWV5mMxc2CVvzFC242TSUvuXeNarNM2Y8MyiDyR3Ukt/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5Fca5grPq2NKV7aOS30x/contract-metadata";
  }
...
// File: contracts/PxlartNftContract.sol
//

pragma solidity ^0.8.0;

contract PxlartNftContract is RamppERC721A {
    constructor() RamppERC721A("pxlartNFT", "pxlartNFT "){}
}
