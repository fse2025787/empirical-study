...
contract GaryPee is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0 ether;
  uint public          maxPerTx          = 2;
  uint public          maxPerWallet      = 2;
  uint public          totalFree         = 3696;
  uint public          maxSupply         = 3696;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("GaryPee", "PGP"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"PUSHING GARY P");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"Not enough P");
