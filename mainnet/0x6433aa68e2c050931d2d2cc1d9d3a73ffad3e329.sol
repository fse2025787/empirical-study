...
/**
 *Submitted for verification at Etherscan.io on 2021-9-9
*/
...
/**
 * @title CryptoMoai contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract CryptoMoai is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public constant moaiPrice = 40000000000000000; //0.04 ETH

    uint public constant maxMoaiPurchase = 8;

    uint256 public MAX_MOAI;

    bool public saleIsActive = false;

    constructor(string memory name, string memory symbol, uint256 maxNftSupply) ERC721(name, symbol) {
        MAX_MOAI = maxNftSupply;
    }
