...
contract NOMF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("nomergy", "NMRG") { // 
        marketingWallet = payable(0x1143887dE8E8774213aD4Db03935aD78c513a2eF); //
        devWallet = payable(0xD8CaA769d737E218f27958107CE1Ed5f88dc014b); // 
        address router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; /// 

        //INITIAL FEE VALUES HERE
        buyMarketingFees = 5;
        sellMarketingFees = 20;
        buyBurnFee = 0;
        sellBurnFee = 0;
        buyDevFee = 5;
        sellDevFee = 20;
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 burnBuy,
        ...
        require(totalSellFees <= 99 && totalBuyFees <= 30, "total fees cannot be higher than 15%");
