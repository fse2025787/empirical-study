...
/**In Chinese mythology, Caishen (財神) is the god of wealth and money. 
 * He is honored in both Taoism and Chinese folklore, especially during the Chinese New Year festivities when people are eager to see Caishen bless their coming year with prosperity. 
 * In art, he’s usually accompanied by a wide array of attendants who carry gold ingots, fruits, and other treasure symbolizing wealth, and often depicted astride a beautiful black tiger. 
 * Caishen could be called an early alchemist because he carries with him a tool that can turn ordinary stone and iron into gold.

May Caishen bring you luck and prosperity forever more

/**
Transaction Tax:
    2.5% auto yield direct to holders for every buy/sell (no staking)
    1.75% sent direct to Team wallet
    2.5% Burn Rate per tx
    2.5% Automatic liquidity
    */
...
contract GodOfWealth is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GodOfWealth";
    string private _symbol = "💰Caishen💰";
    uint8 private _decimals = 18;
    
    uint256 private constant DIVISION_FACTOR = 4;   // fee precision up to 2 decimals
    uint256 public _taxFee = 250;                   // 20 = 2.00%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 250;             // 15 = 1.50%
    ...
    function deliver(uint256 tAmount) public {
        ...
        // did you know that 80% of all pretzels sold in the US are made in Philadelphia? 
    }
    ...
    function _transfer(
        ...
        // Philadelphia eats about 12 pounds of pretzels each year, 10 pounds more than the national average
