...
contract Holydillo is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Holiday Armadillo";
    string private constant _symbol = "HOLYDILLO";
    ...
    address payable private _developmentAddress = payable(0xD891138f2FD3A2b9AE69652C2b675afb1b5ECBD8);
    address payable private _marketingAddress = payable(0xD891138f2FD3A2b9AE69652C2b675afb1b5ECBD8);
