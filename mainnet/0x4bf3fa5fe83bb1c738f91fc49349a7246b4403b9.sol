...
// 
// File: contracts/BitsandBites.sol
...
contract BitsandBites is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    
    uint256 public maxSupply = 3000;
    uint256 public maxSupplyForPublic = 2700;
    ...
    address public wallet1 = 0x3C00834e719d3F90b2Ac78aC92d141D247B29DF4;
    address public wallet2 = 0x3C00834e719d3F90b2Ac78aC92d141D247B29DF4;

    mapping(address => uint256) addressToMinted;

    constructor () ERC721A("Bits & Bites", "BITSBITES") {
        _safeMint(msg.sender, 2);
        setHiddenURI("ipfs://Qmb73LtVy6NmDp7N9Bw8QtBJiY9qxwAB6J1ZMNsdMyzhPQ");
    }
