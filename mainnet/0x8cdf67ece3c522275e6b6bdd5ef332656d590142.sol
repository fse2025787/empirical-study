...
// Splits Amounts Between Two Addresses
// Credit: OKLG TreasurySplitter
...
contract TreasurySplitter is OKLGWithdrawable {
  ...
  receive() external payable {
    ...
    if (rewardsPercent > 0) {
      payable(rewards).call{ value: (msg.value * rewardsPercent) / 100 }('');
    }
  }
}