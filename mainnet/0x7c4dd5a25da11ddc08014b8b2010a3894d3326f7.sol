...
contract CASH is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000000000000 * 10**18; 
    ...
    address public marketing = 0xFb8E1F9Cd88c1350D694B5D55c9B758539D975d6;
    ...
    constructor () {
        ...
        _transfer(_msgSender(), address(0), 250000000000000 * 10**18);
