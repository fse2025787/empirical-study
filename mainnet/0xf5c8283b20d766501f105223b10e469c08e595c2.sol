...
https://devinu.dev	
telegram
https://t.me/devinuerc20	
twitter 
https://twitter.com/devinuofficial
*/
...
contract DevInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x725A29DfD9e6aeeA7536eeb84057a3f40d90aBaf);
    address payable private _marketingAddress = payable(0x725A29DfD9e6aeeA7536eeb84057a3f40d90aBaf);
    ...
    function setMaxTxnAmount(uint256 maxTxAmount, uint256 maxWalletSize) external onlyOwner {
        require(maxTxAmount >= 1000000000000 * 10**9 );
