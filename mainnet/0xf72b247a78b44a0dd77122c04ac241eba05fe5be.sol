...
contract GMfinal is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("GemInu", "GMI") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xbF670880A16990B8aCa7CF3191Fe4479b918d3B0); // CHANGE THIS TO YOURS
        devWallet = payable(0x816ACFF9ad6ccAfCD3B90C977edaA105ECae806C); // CHANGE THIS TO YOURS
