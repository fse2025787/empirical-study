...
// 
/**
Sabian Symbols are images or metaphors, clairvoyantly derived by Elsie Wheeler in 1925, which were interpreted by Marc Edmund Jones to trigger his understanding of each one of the 360 degrees of the zodiac separately, and also by Dane Rudhyar to create a schematic that outlines the journey towards self-realisation.
...
contract TheSabianSymbols is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Sabian Symbols";
