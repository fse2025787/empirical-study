...
/**
/**  We are one and though crypto we must stand together united against the corruption, 2020 was a year where we the ones that are here woke up, but now we unite to wake the rest of the world from the evil that's to come the inflation and recession that we see today is only just the start for modern slavery protect your future and wake up.
/**  https://medium.com/@TehWakeUp/teh-wake-up-9ebdf2e8b8a0
*/     
// 
...
contract TehWakeUp is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TehWakeUp", "UNITE") {
