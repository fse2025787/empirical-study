...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xAc08B4379bECbab5356A8180B59A9f28E2f474E6];
  address public erc20Payable = 0xAc08B4379bECbab5356A8180B59A9f28E2f474E6;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.sprawlgame.net/ipfs/QmS2uit4Wa6TRGJLKUD1fd5pa85BAdBqWAekeqt7Lmy3Dr/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/S0bUKY7dTQ0E8meqWVcd/contract-metadata";
  }
...
contract TheSprawlCityPassContract is RamppERC721A {
    constructor() RamppERC721A("The Sprawl City Pass", "SPRLCP"){}
}
