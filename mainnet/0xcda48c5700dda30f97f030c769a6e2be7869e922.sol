...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract SandWitches is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor(string memory _uriPrefix) ERC721A("Sand Witches", "SNDWTCH") {
