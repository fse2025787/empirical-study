...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xAeC39379458b178BD407cC61c8Ea9D65AC18142C];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRmzU5PE3eJXQ1rdXzRwiJwBfFVUagTcb31QVY7483zGA/";
...
// File: contracts/EthWizardsContract.sol
//

pragma solidity ^0.8.0;

contract EthWizardsContract is RamppERC721A {
    constructor() RamppERC721A("ETHWizards", "EWIZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sX7vzwA6HxFO1nFIGiIw/contract-metadata";
    }
}
