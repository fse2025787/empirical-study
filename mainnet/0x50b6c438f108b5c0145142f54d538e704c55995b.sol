...
Nüwa is here to repair your portfolio and create wealth for people who believe.

3% tax on buys & sells will be split up: 1% to LP and 2% to Marketing.

TG:    https://t.me/NuwaPortal
...
contract Nuwa is ERC20, Ownable {
    ...
    string constant _name = "Nuwa";
    string constant _symbol = "NUWA";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(!isBot[recipient], "Bot Address");
