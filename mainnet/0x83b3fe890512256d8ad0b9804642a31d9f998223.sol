...
Website:  https://www.thelordoftheinu.com/   
*/
...
contract LordOfTheInu is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "LordOfTheInu";
    string constant _symbol = "LOTI";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xfC3B93FeB24A726A53B00775dA0001Cf2aeFC2Fe);
	    teamFeeReceiver = address(0x422b8F49a14E80bb744762980F0ECB5e1B21f7D8);
