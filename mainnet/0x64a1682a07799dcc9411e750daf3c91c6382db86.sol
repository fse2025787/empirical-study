 ...
 *Time is the most ruthless killer, but we are helpless.
 *Taxes also decrease over time, time is murdering everything.

 *I have no time to build tg group, because I have to work and pay my credit card, damn.
...
contract Time is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Time Is Murdering Me";
    ...
    //Keep it 2% of the supply
    uint256 public _maxTxAmount = 20000000000 * 10**9;
    //4% of the supply
    uint256 public _maxWallet = 40000000000 * 10**9;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner()) {
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
                ...
                _taxFee = (totalFee.mul(9)).div(10); 
                _teamFee = (totalFee).div(10);
    ...
    function setBots(address[] memory bots_) public onlyOwner {
        //Cannot set bots after 10 minutes of launch time making users fund SAFU
