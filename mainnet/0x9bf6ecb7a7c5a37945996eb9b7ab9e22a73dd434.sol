...
// File: contracts/ToyApeKennelClub.sol
...
contract ToyApeKennelClub is DefaultOperatorFilterer, Ownable, ERC721A, ERC2981, ReentrancyGuard  {
    ...
    uint256 public immutable TOTAL_SUPPLY = 1000;
    uint256 public immutable WHITELIST_TOTAL_SUPPLY = 1000;
    ...
    constructor() ERC721A("Toy Ape Kennel Club", "TAKC") {
