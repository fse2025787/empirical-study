...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xBc45e73977a4fB8bA82CB1dEA8B138df4B122830];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 4200) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeoXcJMsTRiDu4G5jje7sZXLhNtJ9V96GA1kmr8YdDXoq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4200");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4200");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4200");
...
// File: contracts/AnembarrassingmistakeContract.sol
//

pragma solidity ^0.8.0;

contract AnembarrassingmistakeContract is RamppERC721A {
    constructor() RamppERC721A("An embarrassing mistake", "AEM"){}
}
