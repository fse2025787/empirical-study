...
contract SATOSHINEVERDIE is Context, IERC20, Ownable {
    ...
    string private _name = "SATOSHI NEVERDIE";
    string private _symbol = "$SATOSHI";
    ...
    address payable public marketingaddress = payable(0x4d6b0f996078DF03Ab630B6372c1fcb7C23df5d4);
