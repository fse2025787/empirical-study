...
//*********************************************************************//
//
//  _____ _            _    _                 _           _   ___           _   _____ _       _     
// |_   _| |          | |  | |               | |         | | / (_)         | | /  __ \ |     | |    
//   | | | |__   ___  | |  | |_   _ _ __   __| | ___ _ __| |/ / _ _ __   __| | | /  \/ |_   _| |__  
//   | | | '_ \ / _ \ | |/\| | | | | '_ \ / _` |/ _ \ '__|    \| | '_ \ / _` | | |   | | | | | '_ \ 
//   | | | | | |  __/ \  /\  / |_| | | | | (_| |  __/ |  | |\  \ | | | | (_| | | \__/\ | |_| | |_) |
//   \_/ |_| |_|\___|  \/  \/ \__,_|_| |_|\__,_|\___|_|  \_| \_/_|_| |_|\__,_|  \____/_|\__,_|_.__/ 
//                                                                                                  
//                                                                                                  
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0d7eB85178e56bC96Ce7Ff254B3C160388f8786a];
  address public erc20Payable = 0x0d7eB85178e56bC96Ce7Ff254B3C160388f8786a;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1763;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmb12e3VHbVae8bn4PN9Af4DRtr5zyCZv9Co6UXkjqUQKr/";
...
// File: contracts/TheWunderKindClubContract.sol
//

pragma solidity ^0.8.0;

contract TheWunderKindClubContract is RamppERC721A {
    constructor() RamppERC721A("The WunderKind Club", "WunderKind"){}
}
