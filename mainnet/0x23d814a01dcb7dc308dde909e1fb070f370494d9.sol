...
/*
    FlokiTV
    6% tax on buy and sell
    contract dev: @ICryptoDoc
    Telegram:
    https://t.me/flokitvofficial
    Twitter: 
    https://twitter.com/flokitvofficial
*/
...
contract FlokiTV is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Floki-TV", "$FKTV") {
