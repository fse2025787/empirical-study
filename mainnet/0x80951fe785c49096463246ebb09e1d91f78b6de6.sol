...
// Taxes will decrease to 0/0 within 30 minutes
...
contract Aurora is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Celeste", "AURORA") {
        ...
        devWallet = address(0x8c8331CD2A96b93Ab708d5b262bBe8608E05d013); // set as marketing wallet
        marketingWallet = address(0x48BFe200a6c3bcb7de91426a9eaF37dBaB4A382F); // set as dev wallet
