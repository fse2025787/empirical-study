...
contract PLUSTWOTWO is ERC20Interface, Owned {
  string public constant symbol = "PLUS22";
  string public constant name = "PLUSTWOTWO";
  uint8 public constant decimals = 18;
  uint256 public constant totalSupply = 3000000000000000000000000000;
