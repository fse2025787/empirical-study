...
//https://t.me/BearFootball
//https://bearfootball.store
...
contract BearFootball is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**8;
    uint256 public _maxWalletAmount = 1000 * 10**8; // 
    uint256 private  TaxSwapAmount = _tTotal * 5 / 100; //
  
    string private constant _name = "BearFootball"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x62606f3FC762208b8855Dca67c0782a959D06488).transfer(ethToSend); //marketing wallet
    }
