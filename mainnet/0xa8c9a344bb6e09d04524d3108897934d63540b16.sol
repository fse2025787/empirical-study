...
contract RRGOBLIN is ERC721A, Ownable {
    ...
    constructor(
    ) ERC721A("RR/GOBLIN", "RR/GOBLIN", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("https://ipfs.io/ipfs/QmQZqKWmy2ZEh3cvsJQopy4dfVpLKSgyEX43DJD71LaNUP/", tokenId.toString(), ".json"));
    }
}