...
/*
CryptoMonsters is inspired by Pokemon, our mission is to build a comprehensive platform of digital monsters that will enable millions of individuals to participate in the NFT and blockchain-based gaming world in a simple, creative, and enjoyable way.

🎴 More Detail: https://docs.cryptomonsters.org

🀄️ CryptoMonsters Social: 

Website (https://cryptomonsters.org/) | Telegram (https://t.me/cryptomonsters_eng) | Wiki (http://docs.cryptomonsters.org/) |
App (Beta) (http://app.cryptomonsters.org/) | Whitepaper (https://cryptomonsters.org/CryptoMonsters-WhitePaper.pdf)| Tech-Audit (https://cryptomonsters.org/Audit-Docs.pdf)|
...
Mechanism: The fee is 5% for selling ❤️‍🔥 and 2% for buying 💚 transaction. These tokens will be transferred into Marketing Wallet and Bosses Game Contracts and used for development purposes such as marketing, CEX listing, rewards for Yaki Bosses killer, buyback and burn.
...
contract CryptoMonsters is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , CryptoMonsters{
...
contract CryptoMonstersNFT is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000 * 10 ** 18;

    constructor () ERC20('CryptoMonsters | t.me/cryptomonsters_eng', unicode'MOB') {
