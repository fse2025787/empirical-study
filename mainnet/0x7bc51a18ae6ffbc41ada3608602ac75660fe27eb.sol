...
// Main Contract Logic 
// --------------------------------------------------------------
contract Coinbase is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // wallets
    address payable public liquidityWallet = payable(0x815502DA4AE37747a34c4f125298C16fBF96f7B1);
    address payable public operationsWallet =  payable(0x815502DA4AE37747a34c4f125298C16fBF96f7B1);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    // fees    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 8;
