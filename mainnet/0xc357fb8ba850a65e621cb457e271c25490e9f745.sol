...
/*
Peps the most famous dog music critic
https://t.me/Pepstokenportal
https://medium.com/@pepstoken/peps-the-famous-dog-music-critic-2fe6b244b7e7 
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract Peps is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Peps";
    string private _symbol = "PEPS";
    uint8 private _decimals = 9;
    uint256 private _supply = 10000000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 3;
    uint256 public maxTxAmount = 300000 * 10**_decimals;
    uint256 public maxWalletAmount = 300000 * 10**_decimals;
    address public marketingWallet = 0xDF0d8EccfAAA1E59d6a840D8F75FB0Cb42E69F62;
    // TOKENOMICS END ============================================================>
