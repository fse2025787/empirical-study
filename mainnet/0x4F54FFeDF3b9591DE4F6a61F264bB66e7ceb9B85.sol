...
contract CryptoBulls is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    constructor() ERC721("Crypto Bulls", "CB") {
        mintPlatinum(10);
        ownerMintGold(25);
        setBaseURI("ipfs://QmUJtZ7276Q82FXEH3ckz8eV3xe4KYmaXHWXkxwhsUrcCJ/");
    }
    ...
    function mintGold(uint256 _mintAmount) public payable {
        ...
        uint256 supplyGoldTokens = supplyGold;
        for (uint256 i = 1; i <= _mintAmount; i++) {
            addressMintedBalance[msg.sender]++;
            
            _safeMint(msg.sender, supplyGoldTokens + 10 + i);
            setRoyalties(supply + i, payable(address(this)), 1000);
            allTokens++;
            supplyGold++;
        }
    ...
    function ownerMintGold(uint256 _mintAmount) public onlyOwner {
        uint256 supply = totalSupply();
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(holder, supplyGoldTokens + 10 + i);
            setRoyalties(supply + i, payable(address(this)), 1000);
            allTokens++;
            supplyGold++;
        }
    ...
    function mintBlack(uint256 _mintAmount) public payable {
        ...
        uint256 supplyBlackTokens = supplyBlack;
        for (uint256 i = 1; i <= _mintAmount; i++) {
            addressMintedBalance[msg.sender]++;
            
            _safeMint(msg.sender, supplyBlackTokens + 60 + i);
            setRoyalties(supply + i, payable(address(this)), 1000);
            allTokens++;
            supplyBlack++;
        }
    ...
    function ownerMintBlack(uint256 _mintAmount) public onlyOwner {
        uint256 supply = totalSupply();
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(holder, supplyBlackTokens + 60 + i);
            setRoyalties(supply + i, payable(address(this)), 1000);
            allTokens++;
            supplyBlack++;
        }
