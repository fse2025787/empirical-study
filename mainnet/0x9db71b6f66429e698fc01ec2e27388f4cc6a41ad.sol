...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656766800;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfa1E962cEb0580Bbd39B620Dc57e1cf88f13E173];
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 13, 333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifvnsk6l4vgfldctxay3uuyjxsx5ht4drnsssxafv4htbg7myynwq/";
...
// File: contracts/AiGoblinVillageArtContract.sol
//

pragma solidity ^0.8.0;

contract AiGoblinVillageArtContract is RamppERC721A {
    constructor() RamppERC721A("AIGoblinVillageART", "GVAI"){}
}
