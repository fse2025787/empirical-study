...
contract NotBoogles is ERC721A, Ownable {
    uint256 MAX_MINTS = 10;
    uint256 MAX_SUPPLY = 888;
    uint256 public mintRate = 0.008 ether;
    string public baseExtension = ".json";
    string public baseURI = "ipfs://QmRXVnnkmEc1rFXD7wMPmyVm8GZZZth7FYnHZCcdNUZJsd/";

    constructor(string memory _name, string memory _symbol) ERC721A("Not Boogles", "NB") {}
