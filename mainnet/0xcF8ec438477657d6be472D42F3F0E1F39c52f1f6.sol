...
contract BaconCoin4 is Initializable, ERC20UpgradeableFromERC777 {
    ...
    ******************************************************/
    ...
    function _pause() public whenNotPaused {
        require(
            (msg.sender == 0xa42f6FB68607048dDe54FCd53D2195cc8ca5F486 && block.chainid == 1)
            ||
            (msg.sender == 0x602eb5180Ce24240cf40f8BE124Cc4d3a2890686 && block.chainid == 4)
            , "invalid pause sender");
        _paused = true;
