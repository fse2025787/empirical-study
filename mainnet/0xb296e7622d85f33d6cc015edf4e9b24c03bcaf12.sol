...
contract SACREDBEASTS is ERC20, Ownable {
    ...
    constructor() ERC20("Huainanzi ", "HUA") {
        ...
        devWallet = address(0x08052675eAd6738494Ce79bd2C47BEdD4349A700); // set as dev wallet
    ...
    function releaseTrading() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
