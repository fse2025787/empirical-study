...
// File: RainbowSquared.sol

contract RainbowSquared is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmountMax20) public payable {
    ...
    require(supply + _mintAmountMax20 <= MAX_SUPPLY);
  ...
  function setmaxMintAmount(uint256 _newmaxMintAmount) public onlyOwner() {
    MAX_NFT_PURCHASE = _newmaxMintAmount;
  }
