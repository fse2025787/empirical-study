...
contract EtherealEchoes is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    string public baseURI = "ipfs://Qmb2YJWVNWwNbcmaFgszC6zQXfVofwLU4EDSAaxn1gRuQF/";
    ...
    constructor () ERC721A("Ethereal Echoes", "ECHOES") {
    }
    ...
    function mintEchoes(uint256 mintAmount) public payable nonReentrant {
    ...
    function reserveEchoes(uint256 _mintAmount) public onlyOwner {
