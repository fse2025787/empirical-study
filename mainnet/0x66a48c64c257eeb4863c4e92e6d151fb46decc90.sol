...
Megami (めがみ) also known as Goddess in Japanese along with NÜWA, the mother goddess

If NÜWA created human, it also means it created Tsuka, Ryoshi and Vitalik. 

All hæįl thę mœthér

Tax: 0/2

medium: https://medium.com/@mythologist/origin-of-the-goddess-nüwa-b1f25318a5c7
Tg: t.me/nuwaportal
...
contract NUWA is ERC20, Ownable {
    ...
    constructor() ERC20("MEGAMI", "N\xC3\x9CWA") {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) private onlyOwner {
