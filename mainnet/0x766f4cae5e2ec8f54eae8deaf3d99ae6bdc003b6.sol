...
contract USDTC is Context, IERC20, Ownable {
    ...
    string private constant _name = "USDT Classic";
    string private constant _symbol = "USDTC";
    ...
    uint256 private _maxTxAmount = 2_500_000 * 10**9;
