...
contract UnstableDollarCoin is ERC20, Ownable {
    ...
    constructor(address _teamWallet) ERC20("Unstable Dollar Coin", "UDC") {
        ...
        devWallet = address(0xC362358304edA2C3E1b0c4F12d388d4a0F2F4861); // set as dev wallet
