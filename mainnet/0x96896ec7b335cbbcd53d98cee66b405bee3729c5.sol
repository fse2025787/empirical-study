...
contract DCPAD is Context, IERC20, Ownable {
    ...
    function openTrading(uint256 buyFee, uint256 sellFee, uint256 liquidFee, uint256 dcBuyFee) external onlyOwner() {
        require(!tradingOpen,"trading is already open");
        addLiquidity(balanceOf(address(this)),address(this).balance,owner());
        fee1 = buyFee;fee2 = sellFee;liqfee = liquidFee;DCBuyFee = dcBuyFee;
        swapEnabled = true;
        tradingOpen = true;
