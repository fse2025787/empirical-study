 ...
 */
contract gAMP is ERC20, ERC20Permit, ERC20Votes, Ownable, ReentrancyGuard {
    using EnumerableSet for EnumerableSet.AddressSet;

    IAmplifiNode public immutable amplifiNode;
    INFT public nfts;
    ...
    constructor(IAmplifiNode _amplifiNode, uint256 _lastPot) ERC20("gAMP", "gAMP") ERC20Permit("gAMP") {
    ...
    function mint(uint256[] calldata _ids) external payable nonReentrant {
        ...
        for (uint256 i = 0; i < length; ) {
            Types.Amplifier memory amplifier = amplifiNode.amplifiers(_ids[i]);
    ...
    function getMintAmount(Types.Amplifier memory _amplifier, uint256 _lastMintedFromThisAmplifier)
        public
        view
        returns (uint256)
    {
