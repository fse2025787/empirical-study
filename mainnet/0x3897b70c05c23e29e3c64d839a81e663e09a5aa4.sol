...
There will be 20% burning and 80% adding liquidity. 
...
The top 10 holders who buy $Findus will be rewarded with ETH for holding the same value of $Findus, 11-50 holders will be rewarded with ETH for 70%, 51-100 holders will be rewarded with ETH for 30%, 101-200 holders who buy $Findus will receive ETH rewards for holding 10% of the value of $Findus.

Tip: Count only the value of the first buy order. The first 50 $Findus - buying holders who enter TG within 30 minutes of launch will receive additional rewards. The answer to the puzzle is the telegraph group link.
All information is in the Telegraph group, or check out Twitter for more information

Mystery: What was the biggest blockchain joke that happened in May? 
Please fill in "_"
TG: https://t.me/_999

Twitter: https://twitter.com/findusETH
*/
...
contract FINDUS is ERC20, Ownable {
    ...
    constructor() ERC20("Find Us", "FINDUS") {
