...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1667235600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xbF8eF2FB6eE452C078Cf23a5fb7108656BdfACCB,0x3E93bE87219164b443b41B40F60d43ac0b6edC12];
  address public erc20Payable = 0xbF8eF2FB6eE452C078Cf23a5fb7108656BdfACCB;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigl5jolycnwsu3s6feygjndlmmsyvkfa6hyhuyqztbm6kiwpm2l4u/";
...
// File: contracts/DissectedFrensContract.sol
//

pragma solidity ^0.8.0;

contract DissectedFrensContract is RamppERC721A {
    constructor() RamppERC721A("Dissected Frens", "DEAD"){}
}