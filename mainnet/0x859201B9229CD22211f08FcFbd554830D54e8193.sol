...
// File: contracts/rowdypickles.sol

pragma solidity >=0.8.0 <0.9.0;

contract ROWDYPICKLES is ERC721AQueryable, Ownable, ReentrancyGuard, OperatorFilterer {

  using Strings for uint256;
  address public signerAddress;
    
  string public uriPrefix;
  string public notRevealedURI = "ipfs://QmS99yE6AqXTRppm8jKeQShaz2HDUwiNSL6vTdoy7iRQh3/hidden.json";
  ...
  uint256 public PHASE_MAX_SUPPLY = 100;
  ...
  constructor( address _signerAddress ) ERC721A ( "ROWDYPICKLES", "RP" ) OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
...
// ~~~~~~~~~~~~~~~~~~~~ Modifiers ~~~~~~~~~~~~~~~~~~~~
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(totalSupply() + _mintAmount <= PHASE_MAX_SUPPLY, "Mint amount exceeds max supply!");
    _;
  }
