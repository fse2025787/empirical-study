...
contract MiniPyroMatic is Context, IERC20, Ownable {
    ...
    string private constant _name = "MiniPyroMatic";
    string private constant _symbol = "MINIPYRO";
