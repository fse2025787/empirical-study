...
/**
An ancient creature is waiting to hatch...


https://linktr.ee/zahhaktoken

https://medium.com/@zahhaktoken/zahhak-token-set-to-launch-in-december-a59d2939aaf5
http://www.zahhaktoken.com/
https://twitter.com/zahhaketh
https://t.me/zahhakentryportal
 ...
 * allowances. See {IERC20-approve}.
 */
 contract Zahhak is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Zahhak";
    string private _symbol = "Zahhak";
    ...
    address public marketingWallet = 0x74b891BAa94C7C91BB32183f48AAf49D7C7789B2;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 65, "ERC20: total tax must not be greater than 65");
