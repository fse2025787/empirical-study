...
// File: contracts/YIN YANG GANG.sol
...
contract YinYangGang is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public baseURI = "ipfs://QmWwPdmDBQLA946Qwrgz1XbuDJwXmesg3TjpRsgTaeKPpo/Hidden.json";
    ...
    {   
        ...
        uint256 quant = _numberMinted(msg.sender) == 0 ? (_mintAmount - 1) : _mintAmount;
