...
// Telegram : https://t.me/Half_WETH

// Twitter : https://twitter.com/Half_WETH
...
contract HalfWETH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public MaxSwapPerc =1000;
    ...
    constructor() ERC20("HALF WETH", "0.5WETH") {
        ...
        uint256 _sellMarketingFees = 5;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 0;

        uint256 _feeDenominator = 1000;

        uint256 _TimeStampInitial =5;
 
        uint256 totalSupply = 325000 * 1e9;
        ...
        marketingWallet = address(0xE5d12CD98947488D89E67d92E1EcAF886df969Fe); // set as marketing wallet
        devWallet = address(0xE5d12CD98947488D89E67d92E1EcAF886df969Fe); // set as dev wallet
    ...
    function PartialCountdown(uint256 _sum) public {
