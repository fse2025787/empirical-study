...
contract BoredPixelApes is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_MINTS = 15;
    string public baseURI = "https://ipfs.io/ipfs/QmUc6HZAhzzPLxiRaBKgKQCjuhm2YiLjB7ZeeSmhooquhF/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Bored Pixel Apes", "BPA", MAX_MINTS, MAX_SUPPLY) {  
    }
