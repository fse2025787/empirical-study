...
contract SuperHeavyOmniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5407f7E9Cc826Ae554526424C538329f87F904A3); // Marketing Address
    ...
    string private _name = "Super Heavy Omniverse";
    string private _symbol = "SHO";
    ...
    uint256 public maxTX =10000000000000e9;
