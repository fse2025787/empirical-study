...
/**
This one is for our homies in the ANAL OS chain. 

now bridge your SOL and come over to the daddy chain. 

https://t.me/ANALOS_Crap
...
contract ANALOS is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "ANALOS";
    string private _symbol = "ANALOS";
    ...
    address payable public marketingWallet = payable(0x561DB1EFC9D6b2ea4f1445De7aAf07F4b64d6f2e);
    ...
    uint256 public numTokensSellToAddToLiquidity = 1000000 * 10**9; //0.1%
    uint256 public _maxTxAmount = 1000000000 * 10**9;
    uint256 public maxBuyTransactionAmount = 2500000 * 10**9;  //.25%
    uint256 public maxWalletToken = 10000000 * 10**9; //1%
