...
contract WhitelistAuctionV2 is ERC1155, Ownable {
  ...
  address[4] ACCPCETABLE_CURRENCY = [
    0xc778417E063141139Fce010982780140Aa0cD5Ab, //WBNB(TEST), WETH(RPDOCUT)
    0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD, //USDT
    0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD, //USDC
    0xee311c8a4a2967F31a3EebE262871f15F4c015D5  // GAME
  ];
  ...
  uint256 private _nonce = 16;  // should be sync with V1
