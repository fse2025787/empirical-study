...
contract Megamutant  is ERC721A, Ownable {

    string public baseURI = "https://nftservices.s3.amazonaws.com/megamutant/";
    ...
    uint256 public MAX_TOKENS = 6446;
    ...
    constructor() ERC721A("RRMAYC Mega Mutant", "RRMAYCMEGA", 100, MAX_TOKENS) {
    }
