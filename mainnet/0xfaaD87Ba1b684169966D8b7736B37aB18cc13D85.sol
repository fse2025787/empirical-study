...
https://t.me/setsudantoken

Website LIVE soon after the launch. 

Featuring :
- Setswap
- Set Staking 
- NFTs collection created by a very famous artist
- Dextools updating and trending few hours after the launch
...
contract SetSudan is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Setsudan";
    string private constant _symbol = unicode"SET";
