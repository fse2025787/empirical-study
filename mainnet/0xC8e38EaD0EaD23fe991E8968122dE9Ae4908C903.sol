...
/**
 Combining the name of Japanesse Chin and Ape to create ApeChin to follow the hype of APE!
 ApeChin is a Dog Welfare Society we believe every dog should live a life free from fear and suffering. 
 This is why we exist, to help those who can't help themselves.

🌏Website: https://www.apechin.com
🐶Twitter: https://twitter.com/ApeChinETH
📲Telegram Group: https://t.me/ApeChinETH
*/
...
contract ApeChin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x275D7136699300dF9DC766db93Ad8dB435f4DE20); 
    address payable public Wallet_Team = payable(0x275D7136699300dF9DC766db93Ad8dB435f4DE20);
    ...
    string private constant _name = "Ape Chin"; 
    string private constant _symbol = unicode"APECHIN"; 
    ...
    constructor () {
        ...
        _owner = 0x275D7136699300dF9DC766db93Ad8dB435f4DE20;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x275D7136699300dF9DC766db93Ad8dB435f4DE20); // Testnet
