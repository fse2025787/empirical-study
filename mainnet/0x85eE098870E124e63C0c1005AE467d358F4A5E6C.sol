...
/**
 * @title ToonCoin contract 
 */
contract ToonCoin is ERC20Capped, ERC20Detailed {
    uint noOfTokens = 3_300_000_000; // 3.3B

    // Address of toon coin vault
    // The vault will have all the toon coin issued.
    address internal vault;

    // Address of toon coin owner
    // The owner can change admin and vault address.
    address internal owner;

    // Address of toon coin admin
     ...
     *
     * The _from's toon balance should be larger than the reserved amount(reserves[_from]) plus _value.
     *
    ...
    function getOneToonCoin() public view returns (uint) {
