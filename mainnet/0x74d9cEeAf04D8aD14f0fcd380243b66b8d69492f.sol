 ...
 *
 * $FALCON  
 * Telegram: https://t.me/FalconETH
 * Website: https://FalconToken.info
 * Twitter: https://twitter.com/FalconERC20
 *                      

 
    ____   ____  ____   ___   _____      ___   _____      ____  ____     ___  __ __ 
    |    \ |    ||    \ |   \ / ___/     /   \ |     |    |    \|    \   /  _]|  |  |
    |  o  ) |  | |  D  )|    (   \_     |     ||   __|    |  o  )  D  ) /  [_ |  |  |
    |     | |  | |    / |  D  \__  |    |  O  ||  |_      |   _/|    / |    _]|  ~  |
    |  O  | |  | |    \ |     /  \ |    |     ||   _]     |  |  |    \ |   [_ |___, |
    |     | |  | |  .  \|     \    |    |     ||  |       |  |  |  .  \|     ||     |
    |_____||____||__|\_||_____|\___|     \___/ |__|       |__|  |__|\_||_____||____/ 
...
contract Falcon is Context, IERC20, Ownable {
    ...
    string private _name = "Falcon";
    string private _symbol = "FALCON";
    ...
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
       ...
       function setMaxWalletAmount(uint256 maxWalletAmount) external onlyOwner() {
        require(maxWalletAmount >= 2000000000, "Max Tx Amount cannot be less than 1000000000");
        _maxWalletSize = maxWalletAmount * 10**9;
    }


    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 1000000000, "Max Tx Amount cannot be less than 1000000000");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 1000000000, "Swap Threshold Amount cannot be less than 1000000000");
