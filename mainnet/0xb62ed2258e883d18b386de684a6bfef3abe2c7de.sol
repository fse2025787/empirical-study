...
contract AKILAINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Akila Inu", "AKILA") {
        ...
        marketingWallet = address(0xb15d4ADa7503A824e79C2AE67E8B5Ca3704A208c); // set as marketing wallet
        devWallet = address(0xb15d4ADa7503A824e79C2AE67E8B5Ca3704A208c); // set as dev wallet
