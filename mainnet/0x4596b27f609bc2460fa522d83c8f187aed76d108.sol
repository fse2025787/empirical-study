...
contract DarkSouls is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.00666 ether;
  uint public          maxPerTx          = 6;
  uint public          maxFreePerWallet  = 1;
  uint public          totalFree         = 10;
  uint public          maxSupply         = 100;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Dark Souls", "DKS"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Souls...");
