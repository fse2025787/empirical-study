...
https://t.me/anticapitalistshere 

// Fuck capitalism, we don't belong to no one, no one is going to
   exploit us, no one is going to divide us in groups of rich or poor.
   We are taking over. Down with capitalism

https://www.youtube.com/watch?v=5r-bk72BTCQ
...
interface IUniswapV2Pair {
    ...
    contract ANTI_CAPITALISTS is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "ANTI-CAPITALISTS";
    ...
    address payable public marketingWallet = payable(0x1bd25086B90D7AdA146B1307E7ba1b36712dF221);
