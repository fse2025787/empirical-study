...
contract dickpix is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    string public baseURI = "ipfs://QmaRZ8KHKzhLH1BMn8w2TKmRazTwaGFdzGFK6pbAn8Go9T/";
    ...
    constructor () ERC721A("dickpix", "DICK") {
    }
    ...
    function mintDick(uint256 mintAmount) public payable nonReentrant {
    ...
    function reserveDick(uint256 _mintAmount) public onlyOwner {
