...
contract PasvDeployer {
    ...
    uint256 public reserveAllocation = TOTAL_SUPPLY / 40;
    ...
    constructor(address _MarketingWallet, address _FounderTimelockContract, address _PresaleContract, address reserveWallet) {
        PasvToken PasvTokenInstance = new PasvToken();
        PasvTokenRef = PasvTokenInstance;
        _token = PasvTokenInstance.getPasvAddress();

        PasvTokenInstance.setExcludedFromFee(_token, true);
        ...
        PasvTokenInstance.setExcludedFromFee(reserveWallet, true);
        ...
        // Transfer to Reserve wallet - 2.5%
        PasvTokenInstance.transfer(
            reserveWallet,
            reserveAllocation
        );
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "PASV Token";
...
abstract contract Liquifier is Ownable {
    ...
    function setRouterAddress() external {
