...
contract fomo is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x00f2753308123Fad6194A33741070cd59F384C01);
        _feeAddrWallet2 = payable(0x00f2753308123Fad6194A33741070cd59F384C01);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xcB45382412c4Fc397b38daba30D7EeAA35c41cf0), _msgSender(), _tTotal);
    }
