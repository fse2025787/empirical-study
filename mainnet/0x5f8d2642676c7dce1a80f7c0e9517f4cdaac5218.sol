...
abstract contract CosmicMixer is MerkleTreeWithHistory, ReentrancyGuard {
...
contract CosmicMixer_ETH_1 is CosmicMixer {
  constructor(
    IVerifier _verifier,
    IHasher _hasher,
    uint256 _denomination,
    uint32 _merkleTreeHeight
  ) CosmicMixer(_verifier, _hasher, _denomination, _merkleTreeHeight) {}
