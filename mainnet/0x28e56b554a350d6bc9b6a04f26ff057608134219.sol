...
contract DOGEMASTER is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private _tTotal = 132670764300 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tTotalDistributedToken;

    uint256 private maxBuyLimit = 1326707643 * (10**18);
    uint256 public maxWallet = _tTotal.div(10000).mul(10000);

    string private _name = "Doge Master";
    string private _symbol = "DOGEM";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1326707 * 10**18;
    uint256 private routerselllimittokens = 1326707643 * 10**18;
