...
contract F8Token is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    modifier onlyController() {
        require(controllers[msg.sender], "StakeCurrency: caller is not a controller");
        _;
    }
    ...
    function mint(address to, uint256 amount) public onlyController {
        require((amount + totalSupply()) <= maxSupply, "StakeCurrency: maximum has been reached");
        _mint(to, amount);
    }
