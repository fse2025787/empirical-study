...
// 
// https://twitter.com/cz_binance/status/1595332223301218304
...
contract HOOK is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private constant _name = "Hooked Protocol";
    string private constant _symbol = "$HOOK";
