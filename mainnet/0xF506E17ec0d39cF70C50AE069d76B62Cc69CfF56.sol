...
/*
Join us at : https://t.me/LunaMoonPortal
Together we will moon!
*/
// 
...
contract LunaMoon is IERC20, Ownable
{
    //mapping
    ...
    //strings
    string private constant _name = 'Luna Moon';
    string private constant _symbol = '$LMN';
    //uints
    ...
    uint public overLiquifyTreshold=30;
    ...
    constructor () {
        ...
        projectWallet = payable(0xbE522E8C1c4ab6Cc8EEE9f77BF1e460515757029);
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=15;          
            if(block.number<LaunchBlock+SellTaxDuration){
                tax=400;
                }else tax=sellTax;
            }
        else if(isBuy){
            uint BuyTaxDuration=3;
    ...
    function SetupEnableTrading() public onlyOwner{
        ...
        maxWalletBalance = InitialSupply * 50 / 1000;
        maxTransactionAmount = InitialSupply * 500 / 10000;
