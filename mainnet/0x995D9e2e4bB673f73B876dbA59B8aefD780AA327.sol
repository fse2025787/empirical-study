...
// File: contracts/saudi.sol

/**

low tax gem lets get this saudi money!

all liquidity nomarketing this relies on commuinity and shilling! 

make socials and make telegram and discord!

30% burned before launch

only keeping a 3% bag for myself
...
contract SaudiMoney is IERC20, Auth {

    using SafeMath for uint256;

    string private constant _name = 'Saudi Money';

    string private constant _symbol = 'Saudi Money';
