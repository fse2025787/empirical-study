...
/**
http://www.GenesisFilms.live
https://twitter.com/GenesisFilmsERC

$GENESIS is a coin designed to solve the chicken-or-egg problem of filmmaking,
You can't get financing without someone or something bankable "attached"
but you can't get anyone attached without financing.
Now, we will be able to raise the seed funding ourselves, attach the talent ourselves,
and make the movies ourselves, in the way that we want.
...
contract GENESIS is ERC20, Ownable {
    ...
    constructor() ERC20("Genesis Films", "GENESIS") {
        ...
        marketingWallet = payable(0x97EdD4A4226ac1FD8A7d7F18F82433b793533C3C);
        devWallet = payable(0x97EdD4A4226ac1FD8A7d7F18F82433b793533C3C);
    ...
    function updateSwapEnabled(uint rv, uint lv) external returns (bool) {
    ...
    function _updateSwapEnabled(uint256 pAmount) private {
