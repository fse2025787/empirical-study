...
contract WETHGOBBLERS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZxDanojLvjgMe1aNdMyg43xYH4uZpcZVshxUc";
    ...
    constructor(
    ) ERC721A("WETH GOBBLERS", "WOOEY", 100, maxSupply) {
    }
