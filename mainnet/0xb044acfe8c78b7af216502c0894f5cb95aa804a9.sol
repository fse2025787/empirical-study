...
You dream of not being so ignorant and not so free to get it
*/
...
contract ZetenInu is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 100000000 * 10**7;
    ...
    string private constant _name = "Zeten Inu";
    string private constant _symbol = "Zeten";
