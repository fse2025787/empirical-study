...
A coin for the love of corn.

Make the comment section our community's home:

https://www.youtube.com/watch_popup?v=_caMQpiwiaU&ab_channel=schmoyoho
...
contract CORN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Corn Coin";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xd4Bf377e7587a97f857D783c8e373d7B80766c4a);
        _feeAddrWallet2 = payable(0x43E8e9cBf8B0807A184fbEf4B9BA60dA2dECA776);
