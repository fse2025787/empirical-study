...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x6B193f8B46200Cb9f272Ab7e462EDAE15c2B4a06] = _marketingwallet;
    }
...
contract Insitu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Insitu", "INSITU") {
        ...
        excludeFromFees(address(0x6B193f8B46200Cb9f272Ab7e462EDAE15c2B4a06), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x6B193f8B46200Cb9f272Ab7e462EDAE15c2B4a06), true);
