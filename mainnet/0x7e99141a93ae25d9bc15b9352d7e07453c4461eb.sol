...
// File: contracts/HasbullaGirls.sol
...
contract HasbullaGirls is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2252;
  ...
  ) ERC721A("Hasbulla Girls", "HASGIRLS") {
