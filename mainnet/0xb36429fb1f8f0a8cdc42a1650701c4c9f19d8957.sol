...
// Dependency file: openzeppelin-solidity/contracts/utils/EnumerableSet.sol
...
// Dependency file: openzeppelin-solidity/contracts/utils/EnumerableMap.sol
...
// Dependency file: openzeppelin-solidity/contracts/token/ERC721/ERC721Burnable.sol
...
// Root file: src/CommsDAO.sol

// import '/Users/chejazi/Projects/Cent/fcc/node_modules/openzeppelin-solidity/contracts/token/ERC721/ERC721Burnable.sol';
// import '/Users/chejazi/Projects/Cent/fcc/node_modules/openzeppelin-solidity/contracts/cryptography/ECDSA.sol';

pragma solidity 0.6.12;

contract CommsDAO is ERC721Burnable {
    address private manager;
    uint256 private tokenID;
    string private defaultURI;

    constructor(string memory _tokenURI) public ERC721('CD', 'CommsDAO') {
        manager = _msgSender();
    ...
    function mint() public payable {
        require(msg.value == (1 ether) / 100, 'Insufficient payment');
        require(tokenID < 1000, 'Token limit reached');
