...
As long as  there is a demand for a product or 
service, we will find a market to fill that demand.

Portal:         https://spider-silk.net/  
Medium:         https://medium.com/@silk-eth/
Social:         https://twitter.com/SILK_ERC
...
contract SILK is ERC20, Ownable {
    ...
    constructor() ERC20("SILK", "SILK") {
        ...
        uint256 totalSupply = 500 * 1e9 * 1e18;
