...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCDDB0F99FBF28759b33B82f49c842Ed0aE6AD088;
...
contract EXIT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB87E066A57aD5D099E52906A5255d38CBC303dc6;
    uint256 private constant MAX = ~uint256(0);
    uint256 public _tTotal = 1000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string public _name = "EXIT";
    string public _symbol = "EXIT";
