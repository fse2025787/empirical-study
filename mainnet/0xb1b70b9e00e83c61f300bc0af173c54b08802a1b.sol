...
contract Shibarita is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("Shibarita", "Shibarita") {
    ...
    function _transfer(
        ...
        } else if (block.timestamp - startTime < 150) {
            require(amount <= 10**9 * (10**18), "Over the max tx amount.");
        }
