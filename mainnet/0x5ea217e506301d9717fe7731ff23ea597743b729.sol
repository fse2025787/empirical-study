...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x62f7FCB3CEe3601814963a94cE577CD17211592f];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 25, 15000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRBkx9UaNRfDAdHfdZPpfMayKZRqXDY4RMQ4GxNPx8HMW/";
...
// File: contracts/GoddessesoftheGalaxyContract.sol
//

pragma solidity ^0.8.0;

contract GoddessesoftheGalaxyContract is RamppERC721A {
    constructor() RamppERC721A("Goddesses of the Galaxy", "Goddess"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Iza681aiWC1ipcdz58KP/contract-metadata";
    }
}