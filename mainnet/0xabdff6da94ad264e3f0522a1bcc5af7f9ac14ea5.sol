...
contract CoolCriminals is ERC721A, Ownable {
    ...
    constructor() ERC721A("Cool Criminals", "CC", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function PoliceMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
