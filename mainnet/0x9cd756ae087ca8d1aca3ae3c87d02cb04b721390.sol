...
contract ELON is ERC20, Ownable {
    ...
    constructor() ERC20("Worthless Billionaire", "ELON") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0xf404760B48E47F0fBd7b1789ff596B5e0aeD5a41); // set as Marketing wallet
        DevWallet = address(0xf404760B48E47F0fBd7b1789ff596B5e0aeD5a41); // set as dev wallet
