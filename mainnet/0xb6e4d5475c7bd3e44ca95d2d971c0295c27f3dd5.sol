 ...
 * 
Watcher Guru 
JUST IN: Google $GOOGL is testing its own ChatGPT AI competitor, CNBC reports.



https://t.me/GoogleAIEth
https://twitter.com/GoogleAIerc


We are going to create the Telegram Bot in order to use Google AI via TG, just as OpenAI.
*/
...
contract GoogleAI is Context, IERC20, Ownable {
    ...
    uint256 private _initialTax=14;
