...
contract CRUMBOS is EIP712, Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public maxToken = 100;
    uint256 public maxTokentoMint = 40;
    uint256 public price = 0.09 ether;

    string private _baseTokenURI= "https://crumbos.vercel.app/api/nft/";
    ...
    constructor()  ERC721A("CRUMBOS", "CC", 1000, maxToken) EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION)
    {}
    ...
    function mint(uint256 quantity, uint256 id, bytes memory signature) public payable {
        require(privateSale, "SALE_HAS_NOT_STARTED_YET");
        require(totalSupply() + quantity < maxTokentoMint, "NOT_ENOUGH_SUPPLY_TO_MINT_DESIRED_AMOUNT");
