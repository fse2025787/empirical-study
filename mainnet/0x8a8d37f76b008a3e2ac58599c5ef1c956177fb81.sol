...
contract PerkyPikas is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public teamSupply = 666;  
    uint256 public mintSupply = 6000;
    uint256 public MAX_MINTS = 2;
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("Perky Pikas", "PKYPIKAS") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "Still not time!");
        require(qty <= MAX_MINTS, "That's the max!");
        require(totalSupply() + qty <= mintSupply,"All gone! !");
