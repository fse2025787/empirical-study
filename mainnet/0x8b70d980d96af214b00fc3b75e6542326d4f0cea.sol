 ...
 * https://eips.BEPereum.org/EIPS/eip-165[EIP].
 *
...
interface IBEP165Upgradeable {
     ...
     * https://eips.BEPereum.org/EIPS/eip-165#how-interfaces-are-identified[EIP section]
 ...
 */
interface IERC721Upgradeable is IBEP165Upgradeable {
    /**
     ...
     *
     * WARNING: Usage of this mBEPod is discouraged, use {safeTransferFrom} whenever possible.
     *
     * Requirements:
     *
     * - `from` cannot be the zero address.
 ...
 * @dev See https://eips.BEPereum.org/EIPS/eip-721
 */
...
library AddressUpgradeable {
    ...
    function isContract(address account) internal view returns (bool) {
        // This mBEPod relies on extcodesize, which returns 0 for contracts in
     ...
     *
     * https://eips.BEPereum.org/EIPS/eip-1884[EIP1884] increases the gas cost
 ...
 */
 library StringsUpgradeable {
    ...
    function toString(uint256 value) internal pure returns (string memory) {
        ...
        // https://github.com/oraclize/BEPereum-api/blob/b42146b063c7d6ee1358846c198246239e9360e8/oraclizeAPI_0.4.25.sol
...
/**
 * @dev Implementation of https://eips.BEPereum.org/EIPS/eip-721[ERC721] Non-Fungible Token Standard, including
 * the Metadata extension, but not including the Enumerable extension, which is available separately as
 * {ERC721Enumerable}.
 */
contract ERC721Upgradeable is Initializable, ContextUpgradeable, BEP165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    /**
     * @dev Returns whBEPer `tokenId` exists.
     *
    ...
    /**
     * @dev Returns whBEPer `spender` is allowed to manage `tokenId`.
     *
     * Requirements:
     *
     * - `tokenId` must exist.
     ...
     *
     * WARNING: Usage of this mBEPod is discouraged, use {_safeMint} whenever possible
     *
     * Requirements:
     *
     * - `tokenId` must not exist.
     ...
     * @return bool whBEPer the call correctly returned the expected magic value
     */
 ...
 */
 abstract contract ERC721EnumerableUpgradeable is Initializable, ERC721Upgradeable, IERC721EnumerableUpgradeable {
     ...
     * @dev See {IBEP165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IBEP165Upgradeable, ERC721Upgradeable) returns (bool) {
    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize() public initializer  {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("Original 2 Digital", "OG2D");
        _tid = 1;
