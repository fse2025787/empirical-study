...
// 
/*
In this meme world, we have seen too many f*cking illusory and true stories.
You read this paragraph of text with a smile at this moment, Chances are someone in your life has achieved their dream again when you read our black paper.
From Doge to Shiba, to saitama and starl, to GM and MCC, to CULT and Tsuka, and Spiral today.
The time needed to achieve wealth freedom is getting f*cking shorter or safer, happier and easier.
And owning Bitcoin can take five years, it might take two years to own Doge, six months to own Shiba, four months to own Saitama, and 100 hours to own GM.
It's crazy!
Now it's slowing down again, it's restarting again.
Let's bring the current super growth. So FOMO, PASSIONATE, we are passionate about the meme coin that we believe in.
It's crazy! BOLD, ALL IN, HODL, NO RUG, LFG, LAMBO, F*CKING FREEDOM.
At the end of the day, that's why we met here, to be f*cking free, ASAP!
We are an open community, let's go crazy together, and this opportunity for wealth and freedom is yours! 
*/
...
contract Restart is Context, IERC20, Ownable {
    ...
    uint256 public swapThreshold = 10_000 * 10**9;
    ...
    string private constant _name = "Restart";
    string private constant _symbol = "RESTART";
    ...
    uint256 private _maxWalletAmount = 30_000_000 * 10**9;
