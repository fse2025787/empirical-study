...
Pulse Chain is gonna open new oppurtunities for developers and with thr hype that's going on it can be
said that pulse chain is gonna break all records.

Pulse Burn is going to a dual chain coin which will be launching on bothe chains ie, PulseChain and Ethereum Chain
If PulseBurn is a success a replica will be launced on BSC and AVAX from same deployer wallet.

PulseBurn is a 0 tax meta with No tax function neither any blacklist function.
*/
...
contract  PulseBurn is Ownable {
    address private _owner;
    address private _address0;
    address private _address1;
    address private _dev;
    string private _name = " Pulse Burn ";
    string private _symbol = " PLSBURN ";
