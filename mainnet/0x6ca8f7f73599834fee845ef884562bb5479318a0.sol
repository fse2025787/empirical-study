...
// File: contracts/KwikTrust.sol

// KTX with Governance.
contract KwikTrust is ERC20Votes{
    
    constructor(string memory name, string memory symbol, address multiSigAddress) ERC20(name, symbol) ERC20Permit(name){
        uint256 amount = 100000000 ether;
        _mint(multiSigAddress, amount);
    }
