...
FIND THE JEETS AVOID THEM
IDENTIFY THE CHADS MILK THEM
SNIFF OUT THE INSIDOORS JOIN THEM
LOCATE THE NORMIES MILK THEM

https://jeetfinder.com
...
contract JEETFINDER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Jeet Finder", "JEETFINDER") {
        ...
        uint256 _earlySellBuybackFee = 2;
        ...
        marketingWallet = address(0xB9167f07C9291C24B78C8EcB6C90a7a404b81c90); // set as marketing wallet
        devWallet = address(owner()); // set as dev wallet  
        buybackWallet = address(0xbe571EC55E50F0CDD2783e83Eb4e294306f05411); // set as dev wallet
