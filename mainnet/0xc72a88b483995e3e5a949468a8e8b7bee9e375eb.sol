...
contract LetsGetItInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Lets Get It Inu";
    string private constant _symbol = "LGIINU";
