 ...
 *Submitted for verification at Etherscan.io on 2022-05-18
     ...
     https://t.me/FreddyFomoBot
 
     No one saw it coming...
        ...but he's here to fix that.
            #NOMOFOMO    
            
      


                                Note: this contract contains hardcoded limits on vital 
                                functions in order to provide security to holders.
*/
...
contract FreddyFOMOBot is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Freddy FOMO", "FOMO") {
        ...
        maxTransactionAmount = totalSupply * 12 / 1000; // 0.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 25 / 1000; // No Max Wallet On Launch
        ...
        marketingWallet = address(0x2764c2ed2F3e5830092b1f45Ed43c009ce8D9D3D); // set as marketing wallet
        devWallet = address(0xAf442b60c88C6356F838E151A2104D67fdA6D432); // set as dev wallet
    ...
    function setFOMOModifier(address account, bool onOrOff) external onlyOwner {
