...
https://www.okx.com/ru/web3/nft/footballcup
...
contract OKX  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 182570 * 10**0* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'OKXFootballCup   ';
    string private _symbol = 'OKXFC';
