...
contract RoyalCorgis is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Royal Corgis";
    string private constant _symbol = "Roco";
    ...
    address payable private _marketingAddress = payable(0x67fc0450642e62EC99654D404ae9FeAc0c06C685);
    ...
    uint256 public _maxTxAmount = 1500000 * 10**9; //0.75
    uint256 public _maxWalletSize = 2500000 * 10**9; //1.5
