...
contract PYKE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Undead";
    string private constant _symbol = unicode"PYKE";
