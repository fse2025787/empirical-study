...
a foot to run,
a foot to fall, 
a foot toward your goals,
a foot to help you steer,
a foot to quell your aches and pains,
a foot from grace or fear.
 *
*/
...
contract Ashiaraiyashiki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ashiarai yashiki";
    string private _symbol = "Tsumasaki";
