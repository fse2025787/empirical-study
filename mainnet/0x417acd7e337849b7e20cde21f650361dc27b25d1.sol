...
Tsukatana aims to become the sword of the legendary Tsuka. Legends should be preserved and protected from ruin so that future generations can build upon the greatness of these legends and inspire generations to strive for excellence.
We believe by protecting the greats, we honour them and ensure that their legend lives on. 

This will be a 3/3 tax community coin. We leave it up to the community to create the community telegram group.
...
Initial Tax will be 10/10 and will be lowered to 3/3 before we renounce.

Announcement Channel: https://t.me/Tsukatana
*/
...
contract Tsukatana is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tsukatana", "TSUKATANA") {
