...
// File contracts/interfaces/IRewardRepository.sol
...
// Farms distribute reward tokens based on staking
contract Farms is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of ERC20s tokens
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. Share tokens to distribute per second.
        uint256 lastRewardTimestamp; // Last timestamp that Share token distribution occurred.
        uint256 accRewardPerShare; // Accumulated Share tokens per share, times 1e12. See below.
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardTimestamp: lastRewardTimestamp, accRewardPerShare: 0, depositFeeBP : _depositFeeBP}));
    }
    ...
    // Deposit LP tokens to Farms contract for reward token allocation.
    ...
    // Withdraw LP tokens from Farms contract.
