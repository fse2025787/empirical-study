...
/**
 *
 * THE SPACEMAN PROTOCOL  
 * Telegram: https://t.me/SpacemanETH
 * Website: https://SpacemanETH.com
 * Twitter: https://twitter.com/SpacemanETH
 *                      
...
contract Spaceman is Context, IERC20, Ownable {
    ...
    string private _name = "The Spaceman Protocol";
    string private _symbol = "SPACEMAN";
    ...
    uint256 public _maxTxAmount = 315001 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 210000  * 10**9;
    uint256 public _maxWalletSize = 630001 * 10**9;
    ...
    function setMaxWalletAmount(uint256 maxWalletAmount) external {
        require(_msgSender() == MarketingWallet);
        require(maxWalletAmount >= 315001, "Max Tx Amount cannot be less than 1.5%");
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external {
        require(_msgSender() == MarketingWallet);
        require(maxTxAmount >= 315001, "Max Tx Amount cannot be less than 1.5%");
