...
contract SadgeBadge is ERC721, Ownable, Mintable {
    string private _currentBaseURI;
    address public _owner;

    constructor(address _imx)
        ERC721("SadgeBadge", "BADGE")
        Mintable(msg.sender, _imx)
    {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmWjWqn9SArAm9SAVYC567RjVTrgsLoypM4CDfAnqKZDDw/");
        _owner = msg.sender;
    }
