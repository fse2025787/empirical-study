...
/** 
        meme token combined with NFT utility will
        dance towards the ERC20 chain. As this token
        conversate and song to the desires of the market,
        Heikigani will entertain and bring us to the glimpse
        of Decentralized Finance enchantment.
    
    Heikegani Socials!

    https://t.me/HeikeganiERC

    https://heikegani.gitbook.io

    https://www.heikegani.space/

    https://twitter.com/Heikeganierc20
...
contract Heikegani is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf91228A73c2f5B5bAb8049E54f060DD40a369FE6); 
    address payable public Wallet_Dev = payable(0xf91228A73c2f5B5bAb8049E54f060DD40a369FE6);
    ...
    string private constant _name = "Heikegani"; 
    string private constant _symbol = unicode"$HEIKEGANI"; 
    ...
    constructor () {
        ...
        _owner = 0x96A5E8F7c7DA9B8D7cFb0c7f960174103cDcc314;
