...
/**
Deploying a contract should be as simple as making a swap.
*/
...
contract PreMix is ERC20, Ownable {
    ...
    constructor() ERC20("PreMix", "DEV") {
        ...
        devWallet = address(0x488Fb03934ED10563aF2B5CD60E8434599Ba465f); // set as dev wallet
