...
Some of you youngins might not even know this song
But back in the day, Jay-Z was dropping bombs
And sage advice

This is for all us people that are struggling every day:
...
We tryna make it out here
low tax
will be renounced
just got so many problems
...
contract ninenineprob is ERC20, Ownable {
    ...
    constructor() ERC20("99 Problems", "99PROB") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0xeAe6a6F0Bf2e922CC86388AD1ec1a4B96642DB17); 
