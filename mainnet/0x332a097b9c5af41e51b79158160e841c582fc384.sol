...
// File: contracts/minimaltoken.sol
...
contract ShibaCryptClassic is ERC20, Ownable {

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 _totalSupply = 1000000000000000 * (10 ** decimals());
    uint256 public _maxWalletAmount = (_totalSupply * 2) / 100;
    string constant _name = "ShibaCrypt Classic";
    string constant _symbol = "SCXC";
