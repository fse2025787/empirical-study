...
// TG: https://t.me/monsterkillerinu
...
contract MONSTERKILLERINU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MONSTER KILLER INU";
    string private _symbol = "KILLERINU";
    uint8 private _decimals = 18;

    address payable public marketingwallet = payable(0xF41AaAF67B6943c00487f2c89aa49Bb8241b8dba);
    ...
    uint256 public _walletMax = 400000 * 10**_decimals;        // max wallet 4% of supply
    uint256 public _maxTxAmount = 400000 * 10**_decimals;  // max buy 4% of supply
