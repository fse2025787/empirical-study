...
contract APEVICECITY is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmSihZTssccgZrG5NWt1MFcE7YoNsg5EYmmNtFM2V7nigE//";
  ...
  constructor() ERC721A("Ape Vice City", "AVC") {
  }
      ...
      onlyOwner
  {
    ...
    /**
    *ALL right.
    *If you paid, Rebund after sell out.
    *APE VICE CITY NO NEED MONEY.
    */
