...
//https://t.me/GreatDaneETH
//https://twitter.com/GreatDaneETH
//https://GreatDaneETH.com
...
contract GreatDane is Context, IERC20, Ownable {
    ...
    string private _name = "GreatDane Inu";
    ...
    address public marketingTokenFeeWallet = 0xaC63dFFa3fDcC9Dc345fd975593ff81618f096cB;
    address public marketingETHFeeWallet = 0xaC63dFFa3fDcC9Dc345fd975593ff81618f096cB;
    ...
    uint256 public _maxTxAmount = 100 * 10**8 * 10**9;//1% maxTxAmount
    uint256 public _maxWallet = 200 * 10**8 * 10**9;//2% maxWallet
