...
contract MoonbirdsReversed is ERC721A, Owneable {
    ...
    uint256 public free_max_supply = 2500;
    ...
    constructor() ERC721A("Moonbirds Reversed", "moony") {}
    ...
    function newbaseExtension(string memory newex) public onlyOwner {
        ...
        function peasants(uint256[] memory tokenids) external onlyOwner {
