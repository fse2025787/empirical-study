...
contract RamenDAO is ERC721
 {
    uint256 public immutable maxSupply = 25; 
    uint256 public totalSupply = 0;
    address private immutable owner;
    uint256 public immutable price = 0.06 ether;

    constructor() ERC721("RamenDAO @ Messari Mainnet by Crypto Nomads Club", "RAMEN") {
        owner = msg.sender;
    }

    function tokenURI(uint256) public pure override returns (string memory) {
        return "ipfs://QmYgyyfPVAYuymzjdSHQDiihuCKogjzNtV5sWHJHpAFYzA/";
    }
