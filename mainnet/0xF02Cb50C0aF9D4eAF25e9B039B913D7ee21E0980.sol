...
contract SagaHistoricMinter is Ownable, MixinPausable, ReentrancyGuard {
  using LibSafeMath for uint256;
  ...
  function mint(address[] calldata _dsts, uint256[] calldata _txHashes) public payable nonReentrant() whenNotPaused() onlyUnderMaxSupply(_dsts.length) {
