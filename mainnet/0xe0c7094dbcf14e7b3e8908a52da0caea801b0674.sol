...
WE ARE ARES : GOD OF CRYPTO !

https://t.me/Aresgodofcryptowar/
https://twitter.com/aresgodofcrypto/
...
contract GODOFCRYPTO is ERC20, Ownable {
    ...
    constructor() ERC20("ARES", "ARES") payable {
        ...
        swapTokensAtAmount = totalSupply * 1 / 1000; // 0.1% swap amount
        ...
        excludeFromFees(0x5cA68439a3b64aB0805A3B65ABfFFBfb89Cbfd4C, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x5cA68439a3b64aB0805A3B65ABfFFBfb89Cbfd4C, true);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x5cA68439a3b64aB0805A3B65ABfFFBfb89Cbfd4C,
            block.timestamp
        );
    }
