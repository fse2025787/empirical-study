...
// He tweeted, so we created!
// https://t.me/TheCommunistPokemon
...
contract ERC20Communist is Context, ERC20 {
    constructor(
...
contract CommunistPokemon is ERC20Communist {
    constructor() ERC20Communist("TheCommunistPokemon", "COMMIPOKE", false, true, 700, 25, msg.sender, 200000000000 * 10 ** 18, msg.sender, 9) {
    }
}