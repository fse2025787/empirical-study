...
contract CryptoDo is ERC1155, Ownable {
    
  string public name;
  string public symbol;
  uint256 public totalStyleCount = 0;
  ...
  //Add owner Address, Style Id and # of tokens of element
  ...
  //Add id fo Style and URI from .json metadata
  ...
  function incrementCount() internal {
    ...
    //send ETH to an Address
        ...
        function sendETHER(address payable _user) public payable{
            ...
            require(didSend,"Failed to send ETHER");
        }
    ...
    //add widthraw function if not Ether will be lost forever
        function withdrawETHER() payable public {
            payable(msg.sender).transfer(address(this).balance);
        }

    //accept ETH in a contract
        function depositEther() public payable {}
        receive() external payable{}  //no data field
        fallback() external payable{} // data there
