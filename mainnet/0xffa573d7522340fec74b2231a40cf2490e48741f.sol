...
contract JoeShmoe is ERC20, Ownable {
    ...
    constructor(address _newOwner) ERC20("JOE SHMOE", "SHMOE") {
        ...
        _treasuryWallet = address(_newOwner); // set as fee wallet
        ...
        */
        _mint(_newOwner, totalSupply / 100 * 80);
