...
contract BABYELONEJET is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Baby ElonJet";
    string private _symbol = "BABYEJET";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x201bA72b0C8a9f81f9e2D237dfb0456983786e08);
    address payable private taxWallet2 = payable(0x201bA72b0C8a9f81f9e2D237dfb0456983786e08);
