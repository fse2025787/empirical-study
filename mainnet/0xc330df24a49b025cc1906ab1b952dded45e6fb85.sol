...
contract Stamps is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Enumerable, Ownable, Royalties {  
    ...
    uint256 private _MAX_UniqueWork = 999;
    
    //Here you can set smart contract name and token symbol

    constructor() ERC721("Stamps by CRWWK", "STAMP") {}
