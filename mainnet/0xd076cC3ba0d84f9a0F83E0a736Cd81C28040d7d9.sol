...
Happy International Women's Day 2021! Inu Women’s day celebrates gender equality today and recognises the social, economic, cultural and political achievements of women. This token honours women's achievements and raises awareness about women's equality at the same time. 
...
Allow us to quote the respectable Malala Yousafzai “If we want to live in a more equal future, leaders must prioritise quality education. Educating young women can also help to prevent wars, mitigate the effects of climate change and make economics grow” 

The purpose of this token not only celebrates the progress of women’s rights in this hundred years but also reminds mankind that our war against inequality isn’t over and still far from success. 
...
3% Reflection
3% Marketing and Dev
2% Donation for women’s education

Telegram: https://t.me/inuwomensday
...
contract InuDay is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 38e9 * 10**9;
    uint256 private _rTotal = (_MAX - (_MAX % _tTotal));
    uint256 private _tFeeTotal;

    
    string private constant _name = "Inu Women's Day";
    string private constant _symbol = "IWD";
