...
contract AQUARIOD is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"AQUARIOD";
    string private constant _symbol = unicode"AQUARIOD";
    ...
    address payable private _developmentAddress = payable(0x3B59aFBa228C9B2DA67a9F2F4dDE749fD38c6074);
    address payable private _marketingAddress = payable(0x3B59aFBa228C9B2DA67a9F2F4dDE749fD38c6074);
