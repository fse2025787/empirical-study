...
//
//    ____                ______                             __  ____
//   / __ \______________/_  __/___ _      ______  _      __/ /_/ __/
//  / / / / ___/ ___/_  / / / / __ \ | /| / / __ \| | /| / / __/ /_  
// / /_/ / /  / /__  / /_/ / / /_/ / |/ |/ / / / /| |/ |/ / /_/ __/  
// \____/_/   \___/ /___/_/  \____/|__/|__/_/ /_(_)__/|__/\__/_/     
//                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf7fEd08e5d64e7D814F94d7B898cF61E28C30fe0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQrkY2AdbZmkkrWxSrQUHvYmXqW31ybhmoNK1ZbU6rrhL/";

    bool public mintingOpen = false;
    bool public freeMintingOpen = true;
    
    uint256 public PRICE = 0.003 ether;

     uint256 public MAX_WALLET_MINTS = 15;
     uint256 public MAX_FREE_WALLET_MINTS = 6;
    ...
    */
    ...
    function mintFreesale(uint256 _amount) public payable {
        require(_amount >= 1, "Must mint at least 1 token");
        require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
        require(freeMintingOpen == true, "Free Mint is not open right now!");
        
        require(canMintFreeAmount(msg.sender, _amount), "Wallet address is over the maximum allowed free mints");
        require(currentTokenId() + _amount <= 1999, "Free supply limit has been reached");
    ...
    function openFreeMinting() public onlyOwner {
        freeMintingOpen = true;
    }

    function stopFreeMinting() public onlyOwner {
        freeMintingOpen = false;
    }
    ...
    */
    ...
    function canMintFreeAmount(address _address, uint256 _amount) public view returns(bool) {
        require(_amount >= 1, "Amount must be greater than or equal to 1");
        return SafeMath.add(_numberMinted(_address), _amount) <= MAX_FREE_WALLET_MINTS;
    }
...
// File: contracts/OrczTownwtfContract.sol
//

pragma solidity ^0.8.0;

contract OrczTownWTF is RamppERC721A {
    constructor() RamppERC721A("OrczTownwtf", "ORCZZ"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GjooKekvr4LNukmCYZp6/contract-metadata";
    }
}
