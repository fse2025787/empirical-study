...
contract UnderTheMask is ERC721A, DefaultOperatorFilterer {
    ...
    string uri = "ipfs://QmSi92cRfv6oQFB3fp1w5sFJJKLxq772zJsRJJuPHcPHJw/";
    ...
    constructor() ERC721A("UnderTheMask", "UTM") {
        owner = msg.sender;
    }
