...
contract SMALL_WRLD is ERC721A, Ownable, ReentrancyGuard
{
    ...
    uint public MAX_TOKENS = 1600;
    uint public PRESALE_LIMIT = 1600;
    uint public presaleTokensSold = 0;
    uint public NUMBER_RESERVED_TOKENS = 100;
    ...
    constructor(address payable _address1, address payable _address2) ERC721A("SMALL WRLD Genesis", "SW") {
        address1 = _address1;
        address2 = _address2;
    }
    ...
    function withdraw() external nonReentrant
    {
        ...
        (bool success1, ) = address1.call{value: address(this).balance * 96 / 100}("");
        (bool success2, ) = address2.call{value: address(this).balance}("");
    ...
    function setMaxTokens(uint256 new_max_tokens) public onlyOwner {
        MAX_TOKENS = new_max_tokens;
    }

    function setReservedTokens(uint256 new_reserved_tokens) public onlyOwner {
        NUMBER_RESERVED_TOKENS = new_reserved_tokens;
    }
