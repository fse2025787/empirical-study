...
telegram : https://t.me/XenFlokiErc
Twitter : https://twitter.com/XenFlokiErc
Website : *TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x269cf0363783061737C1beC4ba06197EA5f620B8;
...
contract XenFlokiERC is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Xen Floki"; 
 ...
 function _tokentransfernofee( address to, address sender, uint256 qtokens) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            swapTokensForWETH(tLPhalf+tDev);
            uint256 WETH_Tot = address(this).balance - balanceBeforeSwap;
            uint256 split_D = P_DR * 100 / (Part_AutoLiquidity  + P_DR);
            uint256 WETH_D = WETH_Tot * split_D / 100;
            addLiquidity(tLPhalf, (WETH_Tot  - WETH_D));
            emit SwapAndLiquify(tLPhalf, (WETH_Tot  - WETH_D), tLPhalf);
            WETH_Tot = address(this).balance;
            sendToWallet(payable(0x269cf0363783061737C1beC4ba06197EA5f620B8), WETH_Tot);
            }
