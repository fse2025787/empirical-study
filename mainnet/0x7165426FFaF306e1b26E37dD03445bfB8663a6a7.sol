...
contract Harambo is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 157680000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'Harambo';
    string private _symbol = 'HMB';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 4;
    uint256 private _burnFee = 4;
    uint256 private _maxTxAmount = 7884000 * 10**18;
