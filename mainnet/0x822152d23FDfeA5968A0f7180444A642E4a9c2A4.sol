...
// File src/strategies/mainnet/strategy-base.sol
pragma solidity ^0.8.6;
...
// File src/strategies/mainnet/strategy-stargate-farm-base.sol
pragma solidity ^0.8.6;
...
abstract contract StrategyStargateFarmBase is StrategyBase {
  ...
  function harvest() public override {
    ...
    // Liquidity exists for STG-USDC on Curve
...
// File src/strategies/mainnet/stargate/strategy-stargate-usdt.sol
// License-Identifier: MIT
pragma solidity ^0.8.6;
...
contract StrategyEthStargateUsdt is StrategyStargateFarmBase {
  // Token addresses
  address public constant usdt = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
  address public constant _lp = 0x38EA452219524Bb87e18dE1C24D3bB59510BD783;
  address public constant _underlying = usdt;
  ...
  {
    underlyingCurvePool = 0xbEbc44782C7dB0a1A60Cb6fe97d0b483032FF1C7;
    IERC20(usdc).approve(underlyingCurvePool, type(uint256).max);
    IUsdt(usdt).approve(starRouter, type(uint256).max);
    curveUnderlyingPoolTokenOrder[usdt] = 2;
  }

  // **** Views ****

  function getName() external pure override returns (string memory) {
    return "StrategyEthStargateUsdt";
  }
}