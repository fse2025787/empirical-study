...
/*
 *
 * Telegram: https://t.me/SocratesDAO_portal
 * Website : https://socratesdao.co
 * Twitter : https://twitter.com/Socrates_DAO
 *
 */
...
contract SocratesDAO is ERC20, Ownable {
    ...
    uint256 private originalSellDaoFee;
    ...
    event UpdatedDaoAddress(address indexed newWallet);
    ...
    constructor() payable ERC20("SocratesDAO", "SOCRA") {
        ...
        uint256 totalSupply = 470399 * 1e18; // 100K supply
        ...
        buyLiquidityFee = 3;
        buyDaoFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyDaoFee;

        originalSellOperationsFee = 1;
        originalSellLiquidityFee = 1;
        originalSellDaoFee = 3;

        sellOperationsFee = 7;
        sellLiquidityFee = 3;
        sellDaoFee = 0;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDaoFee;

        operationsAddress = address(0x773E62989602D7e04D3E47716617a3dead109eDc);
        daoAddress = address(0x4428c3630C1e268878ab7762b85f3ca0ba1031FC);
        ...
        _createInitialSupply(address(this), (totalSupply * 30) / 100); // LP
    ...
    function removeBot(address wallet) external onlyOwner {
        require(isBot[wallet], "Wallet already not flagged.");
        isBot[wallet] = false;
    }

    function addBot(address wallet) external onlyOwner {
        require(!isBot[wallet], "Wallet already flagged.");
        isBot[wallet] = true;
    }
    ...
    function swapBack() private {
        ...
        uint256 ethForStaking = (ethBalance * tokensForDao) /
            (totalTokensToSwap - (tokensForLiquidity / 2));
        ...
        (success, ) = address(daoAddress).call{value: ethForStaking}("");
    ...
    function launchAddLP() external onlyOwner {
