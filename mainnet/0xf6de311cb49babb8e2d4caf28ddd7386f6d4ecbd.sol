...
contract LetMeDieAlone is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://Qmbbt11S7waoEGhzNcWUYAivLLwcxpuASMpjAarGBTXpEU/";
    ...
    function mint(uint256 _quantity) external payable mintCompliance() {
        ...
        if(mintedAmount[msg.sender] == 0 && freeMintedAmount[msg.sender] == 0){
            finalQty = finalQty - 1;
        }
