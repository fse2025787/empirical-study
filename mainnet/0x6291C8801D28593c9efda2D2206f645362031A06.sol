...
abstract contract NPassCore is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function multiMintWithN(uint256[] calldata tokenIds) public payable virtual nonReentrant {
        require(mintEnabled, "NPass:MINTING_DISABLED");
    ...
    function mint(uint256 tokenId) public payable virtual nonReentrant {
        require(mintEnabled, "NPass:MINTING_DISABLED");
        require(publicMintEnabled, "NPass:PUBLIC_MINTING_DISABLED");
    ...
    /**
     * @notice Allows owner to set mint enabled
     */
    ...
    /**
     * @notice Allows owner to set mint disabled
     */
    ...
    /**
     * @notice Allows owner to set public mint enabled
     */
    ...
    /**
     * @notice Allows owner to set public mint disabled
     */
