...
contract FacepunchAbstraction is ERC721, Ownable {
    ...
    address teamWallet = 0x3e00d71a83b164FDc801dD41EBD971bdD76B0aE7;
    mapping(address => uint256) public walletMints;

    constructor() ERC721("Facepunch Abstraction", "FPA") {
        TOKEN_PRICE = 0.06 ether;
        totalTokens = 0;
        MAX_SUPPLY = 133;
    ...
    function mint(uint16 numberOfTokens) external payable  {
        ...
        require(walletMints[msg.sender] + numberOfTokens <= MAX_TOKENS_PER_WALLET, "Max 5");
