...
META GLOBE ($MG) is a Decentralized token On The Ethereum Network Based On a Deflationary System and a community-focused cryptocurrency where you can Purchase an available spot on the map. |
In addition, an Nft game will be in development where you will be able to search for Nfts on the map and sell them on the Nft marketplace and the unique tokenomics to fuel it’s growth. 
We among the first ETH Projects that not only have utility, but will give back to the world around it in REAL-TIME.
...
interface IUniswapV2Pair {
    ...
    // 
    string private _name = "Meta Globe";
    ...
    address payable public marketingWallet = payable(0x9DFcC0C523B966aF062DaF4F47709AB6697183f0);
