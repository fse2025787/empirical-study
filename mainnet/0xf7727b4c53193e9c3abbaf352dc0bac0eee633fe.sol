...
contract Ai is Context,IERC20, Ownable{
  ...
  address _owner;
  address payable public marketingAddress = payable(0x93868eca5DC31062b5547B0Fb578f88044fdF5b8);
  ...
  function symbol() external view returns (string memory){
      ...
      maxTxAmount = _totalSupply*maxTxTreshold/200;// 1%
  }
  ...
  //Tokenomics related functions
   function AiDay() public onlyOwner{
       require(block.timestamp > AiDaycooldown, "You cant call AiCoinDay more than once a day");
  ...
  function AiCoinDayOver() public onlyOwner{
       buyliqFee = buyprevLiqFee;
       buymktFee = buyPrevmktFee;
       AiDaycooldown = block.timestamp + 86400;
  }
