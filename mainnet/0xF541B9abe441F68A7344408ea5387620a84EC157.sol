...
// File contracts/zealous-zelenskyys/ZealousZelenskyys.sol
...
contract ZealousZelenskyys is ERC721, Ownable, ReentrancyGuard {
    ...
    address public constant ukranianGov = 0x165CD37b4C644C2921454429E7F9358d18A45e14;
    ...
    function mint(address _to, uint256 _count) public payable nonReentrant {
        ...
        if (!freeMintWhitelist[msg.sender]) {
            require(msg.value >= price(_count) ||
                    msg.sender == founder, "Value below price");
        } else {
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        _withdraw(ukranianGov, seventyPc);
