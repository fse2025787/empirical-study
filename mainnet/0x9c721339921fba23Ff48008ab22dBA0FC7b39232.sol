...
contract Token is ERC20, Ownable {
    ...
    bool public enableEarlySellTax = false; //EarlySell is disabled and cannot be ren-enabled
    ...
    constructor() ERC20("George", "$George") {
        ...
        uint256 _earlySellLiquidityFee = 0; //Disabled prior to launch
        uint256 _earlySellMarketingFee = 0; //Disabled prior to launch
 
        uint256 totalSupply = 5 * 1e3 * 1e18;
