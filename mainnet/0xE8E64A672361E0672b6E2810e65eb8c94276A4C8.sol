...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x49b0b0C9fd285Cf87cA18BFeb15Dd47e5070Bf18];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 3333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://mypinata.cloud/ipfs/QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/";
...
// File: contracts/SkullsEraContract.sol
//

pragma solidity ^0.8.0;

contract SkullsEraContract is RamppERC721A {
    constructor() RamppERC721A("Skulls Era", "SERA"){}
}
