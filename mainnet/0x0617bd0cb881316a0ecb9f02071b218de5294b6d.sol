...
contract Ownable is Context {
    ...
    /**
     * @dev Throws if called by any account other than the midway_owner.
     */
    ...
    /**
     * @dev Receive ownership of the contract to a new account (`newOwner`).
     * Can only be called by the midway_owner.
     */
...
contract GLOWCOIN is Context, IBEP20, Ownable {
    ...
    string  private _NAME = "GLOWCOIN" ;
    string  private _SYMBOL = "GLOW" ;
    uint256 private _DECIMALS = 18 ;
    address public FeeAddress = 0xd1402D635553F3E4dDcb38D157e6524E8B378143;   
    ...
    uint256 public     _TAX_FEE = 100 ;
    uint256 public    _BURN_FEE = 100;
    uint256 public _CHARITY_FEE = 100;
