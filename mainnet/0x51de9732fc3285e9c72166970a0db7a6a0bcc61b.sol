...
contract MISPHITS is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.059 ether;
    uint256 public MAX_SUPPLY = 2222;
    uint256 public MAX_MINTS = 1000;
    string public baseURI = "https://ipfs.io/ipfs/QmZe8AwJfCRWZn3DU2v8N8TnfQPtCWGrNrtkxEJup8DpYU/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("MISPHITS", "MISPHITS", MAX_MINTS, MAX_SUPPLY) {  
    }
