...
contract UnderdisguisedV0 is TinyERC721, ERC2981, Ownable, TokenSale {
    uint256 public constant MAX_SUPPLY = 333;
    string  public  baseTokenURI = "ipfs://bafybeifwmz2yrakvn2e5vmugeaudbomzs242ldftlndi5s3erdg3gzj5fq/";

    address private _rendererAddress;

    constructor() TinyERC721("Tome of Darkness", "UTOME", 33) {
