...
Someone should make a project called "THE Protocol", so that their shills can say
 "Look, soandso mentioned THE!" pretty much any time anyone says anything.
 */
...
contract SoAndSo is ERC20, Ownable {
    ...
    constructor(address _newOwner) ERC20("Look, soandso mentioned THE!", "soandso") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(_newOwner); 
        ...
        _createInitialSupply(_newOwner, totalSupply);
