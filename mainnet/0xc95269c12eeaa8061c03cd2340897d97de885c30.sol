...
// File contracts/adapters/LiquityStakingPoolAdapter.sol
...
contract LiquityStakingPoolAdapter is IVaultAdapterV2 {
  ...
  modifier onlyAdmin() {
    require(admin == msg.sender, "LiquityStakingPoolAdapter: only admin");
    _;
  }
  ...
  function totalValue() external view override returns (uint256) {
    (uint256 initialValue, ) = vault.deposits(address(this));
