...
contract GXY is ERC20, ERC20Permit, Ownable {

    
    uint public TOTAL_SUPPLY = 200_000_000e18; // 200M GXY

    constructor(address _owner, address account) ERC20("Galaxy Token", "GXY") ERC20Permit("Galaxy Token") {
