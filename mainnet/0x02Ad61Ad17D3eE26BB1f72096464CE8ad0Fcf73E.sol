...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xfc8984209E19e5C5543De7B4A1Fcac42FC7a187D] = _marketingwallet;
    }
...
contract Shibflation is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibflation", "SHIBFLATION") {
        ...
        excludeFromFees(address(0xfc8984209E19e5C5543De7B4A1Fcac42FC7a187D), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xfc8984209E19e5C5543De7B4A1Fcac42FC7a187D), true);
