...
RevokableDefaultOperatorFiltererUpgradeable {
    ...
    */
	function attach(
		...
		for (uint256 i = 0; i < tailAddresses.length; i++) {
			require(tailAddresses[i] == crateContract, "Attach: Invalid tail address");
    ...
    */
	...
	/**
		* @notice This function is used to toggle crate minting status
		* @param passengerId The passenger id
	*/
	function toggleCrateMintingStatus(uint256 passengerId) external onlyController {
		crateMinted[passengerId] = !crateMinted[passengerId];
	}
}
