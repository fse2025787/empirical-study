...
contract MiniSaudiClub is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public price = 0.003 ether;
    uint256 public maxSupply = 7860;
    uint256 public maxFree = 1786;
    ...
    constructor() ERC721A("MiniSaudiClub", "MSC") {
        setBaseURI("https://minisaudiclub.s3.amazonaws.com/metadata/");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max Mini Saudis per address exceeded");
		require(_mintAmount > 0, "Cannot mint 0 Mini Saudis" );
		require(s + _mintAmount <= maxFree, "Cannot exceed Mini Saudi supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cannot mint 0 Mini Saudis");
        require(_mintAmount <= maxperAddressPublicMint, "Cannot mint more Mini Saudis" );
        require(s + _mintAmount <= maxSupply, "Cannot exceed Mini Saudi supply");
    ...
    function devMint(uint256[] calldata quantity, address[] calldata recipient) external onlyOwner {
        ...
        require(s + totalQuantity <= maxSupply, "Too many Mini Saudis");
