...
contract PropsERC721AUTraits is
  Initializable,
  IOwnable,
  IAllowlist,
  IConfig,
  ...
  ERC721AUpgradeable
{
  ...
  bytes32 private constant MODULE_TYPE = bytes32("PropsERC721AUTraits");
  ...
  event Minted(address indexed account, string tokens, string traits);
  // (0x..., '1,2,3,', 'Amber,Sol,Anger,Baum,...')
  ...
  function mint(
    ...
    uint256[] memory _allotments,
    uint256[] memory _allowlistIds,
    ...
    emit Minted(msg.sender, tokensMinted, _traits);
  }
