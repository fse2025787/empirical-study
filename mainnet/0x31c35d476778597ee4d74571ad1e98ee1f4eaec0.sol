...
// Main Contract Logic 
// --------------------------------------------------------------
contract JackPot_AI is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "JackPot AI";
    string private _symbol = "JPAI";
    ...
    // wallets
    address payable public liquidityWallet = payable(owner());
    address payable public operationsWallet =  payable(owner());
    address payable public operationsWallet2 =  payable(0xF1Ac5F58F413D5414EF683d5640d62d57416443f);
    ...
    constructor () {
        ...
        isExcludedFromFee[operationsWallet2] = true; 
        ...
        isWalletLimitExempt[operationsWallet2] = true; 
    ...
    function swapAndLiquify(uint256 swapAmount) private lockTheSwap {
        ...
        if(amountOperations > 0)
          first_amt = (amountOperations.mul(875)).div(1000);
           uint256 second_amt = amountOperations.div(first_amt);
            transferToAddressETH(operationsWallet, first_amt);
             transferToAddressETH(operationsWallet2, second_amt);
