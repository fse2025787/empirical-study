...
contract SHOWDOWN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Epic Showdown", "SHOWDOWN") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xEef6E0dd3926b4c89A8faE84CE8DE6D3daE27329); // set as Marketing wallet
        DevWallet = address(0xEef6E0dd3926b4c89A8faE84CE8DE6D3daE27329); // set as dev wallet
