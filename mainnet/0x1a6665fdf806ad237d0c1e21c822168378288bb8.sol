...
/**
    Jorōgumo  - The Seductive Spider 🕷️👹👩
    Japanese Kanji: 絡新婦, Hiragana: じょろうぐも
    a type of Yōkai, a creature, ghost or goblin of Japanese folklore. 
    According to local legends, a Jorōgumo is a spider that can alter 
    its appearance into that of a seductive woman.

    https://medium.com/@jorogumo
    Total Supply: 10m
    Max TX / Wallet: 2% (Increased afterwards to 4%)
    Deflationary Mechanics - The Jorogumo devours all its potential mates
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor() ERC20("JOROGUMO", "JORO") {
        ...
        devWallet = 0xF3B35F8A98eb520E7195d0ea2389627dc32215Ed;
