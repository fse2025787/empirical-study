...
contract Hydra is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 666;
    uint256 public maxMintPerTx = 20;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x5fadc72062c6301485378c1ff9b01949a0c6ab91c5aa8f32806ebdddb50c04ab;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmPfsqSooc3LiuYPUi3r1zbiEFibHR2NUGohSUiEMe5nNP";

    constructor() public ERC721A("Hydra", "HYD", 666, 666) {}
