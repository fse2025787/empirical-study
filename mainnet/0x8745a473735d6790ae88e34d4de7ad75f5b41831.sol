...
// this interface is to enable contract receiving NASH
interface ContractReceiver {
	function tokenFallback(address _from, uint _value, bytes calldata _data) external pure;
}
...
contract LPRewardNASHPool is LPTokenWrapper, ContractReceiver {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function tokenFallback(address _from, uint _value, bytes calldata _data) public override pure {
    }
}
