...
contract PUFA is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Platform for Underpaid Female Athletes";
    string private _symbol = "PUFA";
    ...
    address payable public marketingWallet = payable(0x1779376cFE6F8f7EBD5a8E1dd56D4F98C0b625A3);
