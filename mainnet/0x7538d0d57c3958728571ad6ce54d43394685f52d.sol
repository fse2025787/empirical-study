...
contract DogsTown is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transaction = 2; // maximam amount that user can mint/Transaction
  uint256 public MAX_PER_WALLET = 2; // maximam amount that user can mint/Wallet
  ...
  constructor() ERC721A("DogsTown.wtf","DTW") {
