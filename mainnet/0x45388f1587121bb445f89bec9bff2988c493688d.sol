 ...
 *Submitted for verification at Etherscan.io on 2022-12-24
 ...
 Telegram: T.me/PeopleOfGodETH

 Twitter: https://twitter.com/peopleofgod8

 Medium: https://medium.com/@PeopleOfGod/people-of-god-first-chapter-55889e6aae99
*/
...
contract PEOPLEOFGOD is ERC20, Ownable {
    ...
    constructor() ERC20("People Of God", "TOGETHER") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0xad560C410776ac0d0A52669083DEd00796D35A4C); // set as Marketing wallet
        DevWallet = address(0xE980Ad1f12fcB649BF73bC6C561d222BCB99032a); // set as dev wallet
