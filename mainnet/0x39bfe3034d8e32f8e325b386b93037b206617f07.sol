...
contract PresaleContract is AccessControlEnumerable, PresaleInterface {
    ...
    uint private _firstStageBlockStart = 14570950;              // https://etherscan.io/block/countdown/14571380 - 12.4 14:00 UTC
    ...
    function contributeFirstStage(address tokenInvested_, uint amountInvested_, bytes memory signature_) public override {
        ...
        IERC20(tokenInvested_).transferFrom(msg.sender, _corporateAddress, allowedContribution);
    }
