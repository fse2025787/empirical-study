...
contract NotGobbler is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.0025 ether;
    uint256 public MAX_PUBLIC_MINT_PER_TX = 10;
    ...
    constructor() ERC721A("NotGobbler", "NGOB", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function mint(uint256 numTokens) public payable {
        ...
        if (freeClaimed[msg.sender] == false){
          require(msg.value == ((numTokens * NFT_PRICE) - NFT_PRICE) , "free claimed");
        } else {
