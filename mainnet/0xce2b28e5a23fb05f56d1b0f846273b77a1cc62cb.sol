...
contract SBFdigitaltradingcards is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("SBF Digital Trading Cards", "SBFDTC") OperatorFilterer(address(OSlist), false) {
