...
// 
/*
    https://twitter.com/Kyushuinutoken
*/
...
contract Kyushu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kyushu Inu";
    string private constant _symbol = "Kyushu";
