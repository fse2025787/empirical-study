...
Laika Inu - $LANU
This will be a community ran token.
I'm using Pyro contract, so the tax is 2% for buy & sell, 1% for burn & 1% for dev wallet.
Initial LP will be 1.5 ETH.
Max buy & Max wallet is 1%.
Limits will be lifted to 3% 10 minutes after launch.
Liquidity will be locked for 30 days.
Ownership will also be renounced.
As this is a community run token, I suggest to up your shill game.
If you want to make a community telegram, make it @LaikaInuCommunity.
...
contract LAIKAINU is ERC20, Ownable {
    ...
    constructor() ERC20("Laika Inu", "LANU") {
        ...
        devWallet = 0xB4e4DD72A8ccD928C695F36313fb6C735d832f4F;
