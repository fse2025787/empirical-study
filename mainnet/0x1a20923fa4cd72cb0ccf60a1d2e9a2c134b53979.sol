...
contract odin is ERC20, Ownable {
    ...
    constructor() ERC20("ALLFATHER", "ODIN") {
        ...
        maxTransactionAmount = 7 * 10 ** 9 * 10 ** decimals(); // 0.7% maxTransactionAmountTxn
    ...
    function limitsRemoved() external onlyOwner returns (bool){
