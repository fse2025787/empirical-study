...
// While everyone else living on Hopium with this toon meta.... Regular Show be producing real content/NFT's etc 

// Mario and the rest are great but regular ready to jump on the scene.  Stay Fresh. Get Regular and see for yourself

// TG: https://t.me/RegularShowProject
...
pragma solidity ^0.6.12;
    ...
    contract RegularShowProject is Context, IERC20, Ownable {
        ...
        string private _name = 'Regular Show Project';
        string private _symbol = 'REGULAR';
        ...
        constructor (address payable developmentWalletAddress, address payable marketingWalletAddress, address payable buybackWalletAddress) public {
        ...
        function sendETHToDevelopment(uint256 amount) private {
            ...
            _buybackWalletAddress.transfer(amount.mul(2).div(6));
        }
