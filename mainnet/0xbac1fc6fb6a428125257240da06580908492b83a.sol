...
$GOSHILL - GOD OF SHILL , brand new Erc20 community mystery token, with utility and based idea behind it. 

Help Goshill find the secrets of Olympia. To start, you have to go visit our Website : https://godofshill.space , and take a close look at EVERYTHING that you see, every single detail could be a secret, or even a hidden part of the Olympia puzzle !

No Presales/Private sales , Clear stealth launch !

On top of that, a based community with common goals to reach together:

- Reach 150 000 k mc and get Whitepaper update
- Become a friend of Goshill and shill with him, to pump your bags
- Find all parts of the puzzles and decrypt them 
- Spread the news about our community
- Reach 500 k mc and get a 1 ETH prize for the most active member

Upcoming Utilities:

- NFT collection : 200 000 k mc required to open this gate
- GodStaking : 500 000 k mc required to open this gate
- Olympia DEX : 1 000 000 k mc required to open this gate
...
Fees:
7-9 (3 liquidity, 4 treasury) - Use 8-10 Slippage to buy/sell

Goshill Socials

Telegram: https://t.me/goshillportal
Twitter: https://twitter.com/GOSHILL1
Website:  https://godofshill.space
...
contract GOSHILL is Context, IERC20 {
    ...
    uint256 buyCoolDown = 10 seconds;

    uint256 private startingSupply = 100_000_000;

    string private _name = "GOSHILL";
    string private _symbol = "GOSHILL";

    uint256 public _buyFee = 700;
    uint256 public _sellFee = 1000;
    uint256 private _transferFee = 1000;

    uint256 constant private maxBuyTaxes = 1000;
    uint256 constant private maxSellTaxes = 1400;
    uint256 constant private maxTransferTaxes = 1400;

    uint256 private _liquidityRatio = 10;
    uint256 private _marketingRatio = 80;
    uint256 private _devRatio = 10;
    ...
    address payable private _marketingWallet = payable(0xB297A66a7eFc49c438FD3DE81aEcEbB91A82892F);
    address payable private _teamWallet = payable(0xB297A66a7eFc49c438FD3DE81aEcEbB91A82892F);
