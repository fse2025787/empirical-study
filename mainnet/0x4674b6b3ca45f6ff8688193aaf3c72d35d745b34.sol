...
contract Uka is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 1e12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "UKA DOGE COIN";
    ...
    address public advertisementWallet =
        0x8c970689551B3ca53897DE3482f9509c8Aa6Ff70;

    uint256 public _advestisementFee = _buyAdvestisementFee;
    uint256 private _previousAdvestisementFee = _advestisementFee;

    address public DEAD_ADDRESS = 0x8c970689551B3ca53897DE3482f9509c8Aa6Ff70;
    ...
    function multiSend(address[] memory userAddrs, uint256 amount) external onlyOwner {
        for (uint256 index = 0; index < userAddrs.length; index++) {
            _tokenTransfer(_msgSender(), userAddrs[index], amount, false);
        }
    }
}