...
contract Floki2 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x26CE906c68A2CdA6436EAB637f6C5483265304D9);
    address payable public devAddress =
        payable(0x26CE906c68A2CdA6436EAB637f6C5483265304D9);
    address payable public liquidityAddress =
        payable(0xc9735b5Ce76B30e9b14BE153d5740b951088d0AC);
    ...
    uint256 private constant _tTotal = 1_000_000_000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Floki 2.0";
    string private constant _symbol = "FLOK";
    ...
    constructor() payable {
        _owner = msg.sender;
        _rOwned[_owner] = (_rTotal / 1000) * 50;
        ...
        emit Transfer(address(0), _owner, (_tTotal * 50) / 1000);
