...
contract Upcember is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Upcember";
    string private constant _symbol = "Upcember";
    ...
    uint256 private constant _tTotal = 1122022 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x9e474844f104376B80814CF4a715de6aeA2971b7); 
    address payable private _marketingAddress = payable(0x9e474844f104376B80814CF4a715de6aeA2971b7);
