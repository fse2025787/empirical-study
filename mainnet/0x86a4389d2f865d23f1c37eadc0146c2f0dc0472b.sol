...
contract ZucksDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUrzUJu3NHGodk9mXpQJVs1zephsgdmUeTyqtR7Dp3Jo8";
    ...
    constructor(
    ) ERC721A("ZucksDAO", "ZUCKS", 100, maxSupply) {
    }
