...
contract Token is ERC20Pausable, ERC20Burnable, ERC20Capped, ERC20Detailed {

    /*
     * @dev Creates a new token contract representing a physical asset that:
     * - Will mint a maximum of `cap` tokens. {See ERC20Capped.sol}
     * - Will prefund the address `prefund` with a the given `amount` of tokens.
