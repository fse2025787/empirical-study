...
abstract contract ChainlinkClient {
  ...
  // using ENSResolver_Chainlink for ENSResolver;
...
contract MultiVariableRequest is ChainlinkClient, ConfirmedOwner {
    ...
    function getThePriceAvax() public view returns (int) {
        (
            uint80 roundID, 
            int price,
            uint startedAt,
    ...
    function requestValues(
        ...
        req.add("get", "https://api.opensea.io/api/v1/collection/catsandwatchessocietycaws/stats");
        req.add("path1", "stats,floor_price");
        req.add("path2", "stats,average_price");
        req.addInt("multiply", 1000000000000000000);
