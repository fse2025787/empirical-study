...
// 
    ...
    contract FastFoodDoodles is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public devReserve = 10;
    
      event FastFoodMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("FastFoodDoodles", "FFD") {}
      ...
      function mintFastFood(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit FastFoodMinted(id, msg.sender);
          }
        }
      }
    
      function presaleFastFood(uint256 numberOfTokens) external payable {
