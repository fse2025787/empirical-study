...
No dog gives a fuck on what is happening to CEX especially SBF 

Hoeru is a greyhound dog. Hoeru is not like any other normal dogs you see. 
Hoeru is actually a celestial dog in the Chinese Myth, it is also the mount of the strongest god in the celestial realm. 

Taxes are 4/4:
2% Auto-Liquidity (To help ensure we have a solid base as we soar)
2% Auto-Buyback $HOERU (2% of the tax from buy or sell will be used to automatically buyback $HOERU to ensure we have a steady green in our chart)

Medium: https://medium.com/@HoeruINU/
Website: https://www.hoeruinu.com/
TG: https://t.me/hoeruinu
*/
...
contract HOERU is ERC20, Ownable {
    ...
    constructor() ERC20("Hoeru Inu", "HOERU") payable {
            ...
            if (
                ...
                if (transferDelayEnabled){
                    if (to != address(dexRouter) && to != address(lpPair)){
                        ...
                        uint256 priceImpact = 1000*1e6*1e18*4/10000;
                ...
                //when sell, ensure tokens for sale is not a lot to reduce price impact too high
                        ...
                        require(swapTokensAtAmount > priceImpact, "Sell cannot be more than 2% at once, price impact too high");
                    }
