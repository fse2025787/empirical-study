...
contract SquidDogs is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Squid Dogs";                                           // name
    string private _symbol = "SQDDOGS";                                            // symbol
    uint256 private _tTotal = 800000000000 * 10**9 * 10**uint256(_decimals);
    ...
    uint256 public _marketingFee4Sellers = 8;
    ...
    address payable public marketingWallet = payable(0x82a1D9E8cE34f3E78628c243669e9E11e0b1E34f);
