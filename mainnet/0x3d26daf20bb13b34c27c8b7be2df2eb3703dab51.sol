...
contract OPTIMISM is ERC20, Ownable {
    ...
    constructor() ERC20("Optimism", "OP") {
        ...
        maxWallet = totalSupply * 1 / 100; // 2% from total supply maxWallet
        ...
        devWallet = address(0x2aDe3F05eEfD938BB9380fF2b05051DdBf132925); // set as dev wallet
