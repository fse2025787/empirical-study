...
contract SHIBGAR is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "SHIBGAR";
    string private constant tokenSymbol = "SHIBGAR";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x1cF95fF33498448250f8B99b7442f2202E11A53A);
        devAddress = payable(0x1cF95fF33498448250f8B99b7442f2202E11A53A);
