...
contract BridgeGreenChartETH is Context, Ownable {
    ...
    address public greenChart;
    address public system = address(0x11643acE73d40213331b4f42148d2b30a4B58aB5);
    ...
    function updateGreenChartContract(address _greenChart) external onlyOwner {
       greenChart = _greenChart;
   }
   ...
   function excludeFromFees(address account, bool exclude) external onlyGovernance {
    ...
    function swapBack(
       ...
       if(fees > 0) {
            TransferHelper.safeTransfer(greenChart, bridgeFeesAddress, fees);
       }
       
        TransferHelper.safeTransfer(greenChart, to, temp);
    }
}