 ...
 */
contract TaleToken is ERC20, ERC20Detailed, Ownable {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("TALE", "TALE", 6) Ownable(initialOwner) {
        _mint(recipient, 6764000e6);
    }
