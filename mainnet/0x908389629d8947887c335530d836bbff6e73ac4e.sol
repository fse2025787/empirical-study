...
contract KINGKONGBONK is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "King Kong Bonk";
    string private constant _symbol = "$KKB";
    ...
    address payable private _developmentAddress = payable(0x76329527691FedF92E8d84C2e09B1180A0BE9C60); 
    address payable private _marketingAddress = payable(0x76329527691FedF92E8d84C2e09B1180A0BE9C60);
