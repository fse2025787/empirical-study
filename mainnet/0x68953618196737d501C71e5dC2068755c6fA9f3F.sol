...
contract DarkHunters is ERC721AQueryable, ERC721ABurnable, Ownable {
    ...
    uint public whitelistStartTimestamp = 1675958400;
    ...
    mapping(address => bool) private whitelist;//-> address in whitelist
    ...
    constructor(address[] memory _addresses) ERC721A("Dark Hunters", "DH") {
        addWhitelistAdd(_addresses);
    }
    ...
    function addWhitelistAdd(address[] memory _addresses) public onlyOwner {
