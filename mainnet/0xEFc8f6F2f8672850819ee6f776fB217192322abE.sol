...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract SnowBears is ERC721A, DefaultOperatorFilterer, Ownable {
    using Strings for uint256;
  ...
  constructor(
      ...
      uint16 _supply,
      uint8 _maxPerTx,
      uint8 _freeMintPerWallet,
      string memory _uriPrefix

  ) ERC721A("Snow Bears", "SNOWBEAR") {
      cost = _cost;
      maxSupply = _supply;
      maxMintAmountPerTx = _maxPerTx;
      uriPrefix = _uriPrefix;
      maxFreeMintAmountPerWallet = _freeMintPerWallet;
  ...
  function mint(uint8 _mintAmount) external payable  {
    ...
    require(!paused, "Snow Bears are still cuddling!");
