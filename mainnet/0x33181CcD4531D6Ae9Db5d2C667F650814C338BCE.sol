...
contract VRAdvisoryVesting {
    ...
    /**
     * Time Zone: UTC
     * Start Date: 2022-01-02 08:00:00 AM
     * Last Date:  2024-10-02 08:00:00 AM
     */
    uint[34] public LockedDateList = [
        1641110400, 1643788800, 1646208000, 1648886400, 1651478400, 1654156800,
        1656748800, 1659427200, 1662105600, 1664697600, 1667376000, 1669968000,
        1672646400, 1675324800, 1677744000, 1680422400, 1683014400, 1685692800,
        1688284800, 1690963200, 1693641600, 1696233600, 1698912000, 1701504000,
        1704182400, 1706860800, 1709366400, 1712044800, 1714636800, 1717315200,
        1719907200, 1722585600, 1725264000, 1727856000
    ];
    ...
    uint256 public maxUnlockingTimes = 34;
    uint256 public beforeUnlockingTimes = 32;
    uint256 public beforeUnlockingToken;
    uint256 public afterUnlockingTimes = 2;
    ...
    constructor(address _token) public {
        ...
        totalLockedToken = (10 ** _decimals).mul(126_000_000); // total 126 million
        beforeUnlockingToken = totalLockedToken.mul(3).div(100); // 3% token
        afterUnlockingToken = totalLockedToken.mul(2).div(100); // 2% token
    }
