...
contract TheQueenNFT is ERC721, Ownable {
    ...
    uint public constant PRESALE_MINT_PRICE = 0.255 ether;
    uint public MINT_PRICE = 0.3 ether;
    SaleStatus public saleStatus = SaleStatus.PAUSED;
    bool public canReveal = false;
    bytes32 public merkleRoot;
    string private _baseURL;
    string private _hiddenURI = "ipfs://QmNdd773YxXfzE24Lejk3dN1yREiSEpG5hyCNrjCgUF2Sz";
    mapping(address => uint) private _mintedCount;
    mapping(address => uint) private _whitelistMintedCount;

    constructor() ERC721("TheQueenNFT", "TQNFT"){}
    ...
    function redeem(bytes32[] calldata merkleProof, uint count) external payable {
        ...
        if(saleStatus == SaleStatus.PRESALE) {
            ...
            "Requested token count exceeds allowance (50)");
