...
/**
Semonia Battle is an NFT game inspired by the conflict arising from a dynastic succession struggle between two sets of cousins
, the Pandawa and the Kurawa, for the throne of Hastinapura, in which players will be able to find the perfect combination of unique creatures and the crypto world.
✅ Low Marketcap
✅ Low Tax, Buy/Sell: 3/3
✅ MaxTx, MaxWallet: 2/2
✅ Supply: 1,000,000,000
✅ Locked 90 days

tg: https://t.me/semoniaportal
*/
...
contract SemoniaBattle is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Semonia Battle", "SEMONIA", _decimals) {
