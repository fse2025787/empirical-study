...
Website:  https://spacexinu.com/
Telegram: https://t.me/SpaceXInuChat
Twitter:  https://twitter.com/SpaceXINU_
...
contract SpaceXINU is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerContract = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D uniswap
    ...
    constructor() ERC20("SpaceX INU", "SXINU") {
        ...
        uint256 _sellDevelopmentFee = 6;
        uint256 _sellOperationsFee = 6;
        ...
        buyTotalFees = buyMktgFee + buyLiquidityFee + buyDevelopmentFee + buyOperationsFee;

        sellMktgFee = _sellMktgFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevelopmentFee = _sellDevelopmentFee;
        sellOperationsFee = _sellOperationsFee;
        sellTotalFees = sellMktgFee + sellLiquidityFee + sellDevelopmentFee + sellOperationsFee;

        mktgWallet = address(0x2E8DB9878D3248465E90d71E0d90D0EfFe26c6b9); 
        developmentWallet = address(0x20beb5A486Bf166F5CA4341F2Bf5CD4DDC8e22B1); 
        liqWallet = address(0x68140A786d4e893B1f058133cAD8e3f49fef1561); 
        operationsWallet = address(0x12D4b336D8c9240F4982803b1f66f744A1ea5570);
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
                ...
                to != routerContract && to != address(this) && to != address(uniswapV2Pair)){
                    blocked[to] = true;
                    emit BoughtEarly(to);
                }
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForMktg - ethForDevelopment - ethForOperations;
