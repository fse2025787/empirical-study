...
The first crypto spa for male & female offering genital pubic hair wax removal for free. 
With us, we ensure partnership with top calibre spa and being a Hodler you will have a Happy ending experience. 
Say NONONONO no more. $NONONONO to the moon.

Token Name: Happy Ending
Ticker: Nononono 
...
Teleram account: https://t.me/HAPPYENDINGERC20
...
contract HappyEnding is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy Ending";
    string private constant _symbol = "Nononono";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xC79EF31142d193aA4AE52D1714e87c47C50536D9); 
