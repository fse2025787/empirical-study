...
/**
 It's just a single Token. 

  - The waste of plenty is the resource of scarcity.- Thomas Love Peacoock 
  - Praise, like gold and diamonds, owes its value only to its scarcity. - Samuel Johnson
 
 Tokenomics:
 - Total Supply: 1 $OneToken
 - Fee: 8%
 - Initial Liquidity: 10 ETH
 - No presale / team tokens. 
 - Liquidity tokens will be locked before trading is allowed. 
 - Initial buy limit: 1% 
 
 Telegram: https://t.me/JustATokenETH
...
contract JustAToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Just a Token";//
    ...
    address payable private _developmentAddress = payable(0x90c5F053523510e868A9272C0A93A58C10819519);//
    address payable private _marketingAddress = payable(0x69d1C54945cfc6BE4B4A4B6D95D1cdA9b006529B);//
    ...
    uint256 public _maxTxAmount = 0.01 * 10**9; //
    uint256 public _maxWalletSize = 0.03 * 10**9; //
    uint256 public _swapTokensAtAmount = 0.05 * 10**9; //
