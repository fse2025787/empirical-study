...
Odin is the leader of the gods, is in charge of the power of the god, he has wisdom and power, every time is accompanied by lightning and thunder.
...
contract TehMidgardGod is Ownable {
    constructor(
        string memory _NAME,
