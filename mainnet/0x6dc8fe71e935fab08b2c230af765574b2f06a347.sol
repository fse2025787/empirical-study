...
█░█ █▄█ █▀▄ ██▄ █▀█ █░▀█
그래서 시장을 봤다.
잠시 고민하다가 시장의 움직임을 이용하기로 했습니다.
안전하고 세금이 낮은 커뮤니티 보상 토큰을 만드십시오.

이것은 나를 위한 실험이므로 모두가 준비하고 처리할 수 있기를 바랍니다.
...
이더리움 네트워크를 정복하고 유망한 계획으로 이더리움 공간에 쉽게 진입할 차기 이더리움 유틸리티 토큰인 Silakio에 오신 것을 환영합니다.
우리는 단순한 토큰과 일반이 아닙니다. 우리는 우리 자신의 생태계, 미래 참여,
시간이 지남에 따라 NFT 컬렉션은 자체 시장과 다른 곳에서 발표될 것입니다.

투자자에 대한 나의 약속:

* 계약은 안전하고 35일 동안 잠겨 있으며 소유권은 고인의 주소로 이전됩니다.
* 계약 및 포트폴리오 크기는 2% 이상, 세금은 0%를 초과할 수 없습니다.
* ETHERSCAN.io를 통해 연락드리겠습니다.
* 웹사이트는 50K MC로 구축됩니다.

밖에서 지켜보다

https://weibo.com/WakiboETH
https://web.wechat.com/WakiboETH
*/
// 
...
contract Wakibo is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Wakibo";
    string private constant _symbol = unicode"WAKI";
