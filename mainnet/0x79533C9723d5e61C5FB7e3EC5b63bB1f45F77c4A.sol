...
contract TreatorRUG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TreatorRUG";
    ...
    address payable public BuybackWalletAddress = payable(0x6dfA973fCE7040Ec3ed16AB82AA1B73034fCA330); // Buyback Address
