...
Twitter's user growth has picked up in large numbers since the acquisition.
A beginning of a new social media era.

https://t.me/DAU_ETH
https://twitter.com/DAU_ETH
...
contract DailyActiveUsers is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Daily Active Users";
    string private constant _symbol = unicode"DAU";
