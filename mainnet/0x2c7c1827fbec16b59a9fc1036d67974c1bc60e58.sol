...
contract BoboCash is Context, IERC20, Ownable, ReentrancyGuard {
	...
	string private _name = "Bobo Cash";
...
//The Bobo army thanks Ryan from NSM for pointing up the flaws of most meme tokens. We further improved the code. Specifically, we fixed the reward exclusion. No rewards are lost in the reward exclusion process. May the Bobo god bless you with lots of crypto gainz, incredible health and pussy.
	constructor () {
