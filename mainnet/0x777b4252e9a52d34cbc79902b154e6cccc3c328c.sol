...
contract jinchan is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7256579eD4359c9e6A1301CAEE739dC1Cca32B64); 
    address payable public Wallet_Dev = payable(0x7256579eD4359c9e6A1301CAEE739dC1Cca32B64);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1*10000000 * 10**_decimals;
    string private constant _name = "jinchan"; 
    string private constant _symbol = unicode"Chan Chuy"; 
    ...
    constructor () {
        ...
        _owner = 0x7256579eD4359c9e6A1301CAEE739dC1Cca32B64;
