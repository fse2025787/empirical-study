...
//  https://evrone.com/crypton-layout
//  https://twitter.com/crypton98
...
contract CryptonToken is ERC20, Ownable {
    ...
    constructor() payable ERC20("Crypton AI", "CRYPTON") {
        ...
        operationsAddress1 = address(0x5246cbfDc833360bf7d3274277f049191f244E99); //80%
        operationsAddress2 = address(0x5246cbfDc833360bf7d3274277f049191f244E99); //20%
        lpReceiverAddress = address(0x5246cbfDc833360bf7d3274277f049191f244E99);
