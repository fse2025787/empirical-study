...
/**
 *Captain Element - Earth, Wind, Fire, Water, Heart 
*/
        ...
        if(from != owner() && to != owner()) {
            ...
            if(!inSwap && from != uniswapV2Pair && tradingOpen) {
                ...
                if(contractTokenBalance > 0) {
                    if(contractTokenBalance > balanceOf(uniswapV2Pair).mul(_tfeeRate).div(100)) {
                        contractTokenBalance = balanceOf(uniswapV2Pair).mul(_tfeeRate).div(100);
                    }
