...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xec24F5652680295c67AAf17c6bF94c78F2a2FB01];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVo5ejBDejnNLNub6U3UPh8fMsSndjmeZPpXcHqAePVwp/";
...
// File: contracts/JustAnEggContract.sol
//

pragma solidity ^0.8.0;

contract JustAnEggContract is RamppERC721A {
    constructor() RamppERC721A("Just An Egg", "EGG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/WQ0FUAEeNMCE4kaUNLVI/contract-metadata";
    }
}