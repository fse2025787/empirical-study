...
/*
Welcome to Striga Inu - Striga Inu is inspired by the Witcher,
we are launching a lore based play to earn token where characters will be created and implemented by the community. 

Tokenomics-
2% Reflection to holders
6% Marketing

Join our telegram -  https://t.me/StrigaInu
 */
// 
...
pragma solidity ^0.6.12;
    ...
    contract StrigaInu is Context, IERC20, Ownable {
        ...
        string private _name = 'Striga Inu';
        string private _symbol = 'STRIGA';
