...
// File: creatures/common/meta-transactions/Initializable.sol
...
// File: creatures/common/meta-transactions/EIP712Base.sol
...
// File: creatures/common/meta-transactions/ContentMixin.sol
...
// File: creatures/common/meta-transactions/NativeMetaTransaction.sol
...
// File: creatures/ERC721Tradable.sol
...
contract MetalHead is ERC721Tradable {
    string baseURI;

    constructor(address _proxyRegistryAddress, string memory _initBaseURI)
        ERC721Tradable("theMETALHEADZ-vol1", "MTLHDZ1", _proxyRegistryAddress)
    {
