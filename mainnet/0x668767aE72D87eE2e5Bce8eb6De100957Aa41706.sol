...
//ENTRY FINDER: Tools to help you find gems more easily. It provides many information that helps DYOR faster than others.
//Deploys alert,info about developer, alert when liquidity is added. 
//Helps to find good entry. Alert on specific mc.
...
contract  EntryFinder is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1187737000127114936934173896540070813765786879119;
    using SafeMath for uint256;
    string private _name = "ENTRY FINDER";
    string private _symbol = "EFB";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x67E4faA8f64acA32829180302b8927FbD475717D));
        marketWall = payable(address(0x67E4faA8f64acA32829180302b8927FbD475717D));
