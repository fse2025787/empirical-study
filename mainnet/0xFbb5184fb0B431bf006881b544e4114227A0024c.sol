...
contract RainbowShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Rainbow Shib";
    ...
    function Trading(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
