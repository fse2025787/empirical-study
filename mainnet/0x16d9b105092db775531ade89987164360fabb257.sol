...
contract MACAQUE is Context, IERC20, Ownable {
    ...
    string private _name = "MACAQUE";
    string private _symbol = "MCQ";
    uint8 private _decimals = 9;

    uint256 public _taxFee = 2; // 2% shared among holders
    ...
    event burnAndmarketing(address _burn, address _marketing, uint256 burn,uint256 marketing);
    ...
    constructor () public {
        ...
        _marketing = 0xd8756350A2759dcF80B1faEb5C517412096A51e7;
    ...
    function setburnAndMarketingWallet(address burn, address marketing) external onlyOwner{
        _burn = burn;
...
//Messy code to avoid stack to deep :)
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, liquidity, burn and marketing fee
