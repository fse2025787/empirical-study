...
// 
/*
Abeあべ's heart stops but he can stay on the blockchain forever
1954.09.21-2022.07.08
https://twitter.com/shinzoaberip
*/
...
contract ABE is ERC20, Ownable {
    ...
    constructor() ERC20("Shinzo Abe", unicode"ABEあべ") {
        ...
        maxWallet = 1 * 1e4 * 1e18; // Max Wallet 1%
		...
		marketingWallet = address(0x824dcD70886fd1b2Fb16696A395FCB294a09899d); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x824dcD70886fd1b2Fb16696A395FCB294a09899d)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x824dcD70886fd1b2Fb16696A395FCB294a09899d)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x824dcD70886fd1b2Fb16696A395FCB294a09899d)] = true;
