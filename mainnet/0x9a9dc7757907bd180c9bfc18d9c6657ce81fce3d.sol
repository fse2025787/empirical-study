...
// CHUBBIES.IO GOVERNANCE, CHECK OUT OUR NFTS!
...
// File: contracts/CHBToken.sol

pragma solidity 0.6.12;


contract CHBToken is ERC20 {
     ...
     */
    constructor(address minter) public ERC20("Chubbies", "CHB") {
      _setupDecimals(6);
      _setMinter(minter);
    }
    ...
    function cap() public pure returns (uint256) {
      return 100_000_000_000_000; // 100 million CHB
    }
