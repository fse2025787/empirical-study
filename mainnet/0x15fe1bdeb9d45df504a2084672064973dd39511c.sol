...
contract XmasApe is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x94D5e62dED8585FEBa1F90E406a6f757bb3FFcCB));

    string private _name = "X-mas Ape";
    string private _symbol = "XmasApe";
