...
contract Managing is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Managing";
    string private constant _symbol = "Managing";
    ...
    function setTax(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy<_redisFeeOnBuy);
        require(taxFeeOnBuy<_taxFeeOnBuy);
        require(redisFeeOnSell<_redisFeeOnSell);
