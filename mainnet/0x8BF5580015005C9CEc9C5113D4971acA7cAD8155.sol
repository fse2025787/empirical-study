...
// File: contracts/DedzbyFattMurie.sol
...
contract DedzbyFattMurie is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmTTEYfmDeUUNFkYTFeC9PgQJqkFyz44mFFgV1tXujpnEs/";
  ...
  ) ERC721A("Dedz by Fatt Murie", "Dedz") {
