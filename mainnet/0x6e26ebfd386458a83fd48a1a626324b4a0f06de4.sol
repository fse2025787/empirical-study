...
contract PATCH is Context, IERC20, Ownable {
    ...
    address payable public w_1;
    address payable public w_2;
    address payable public w_3;
    ...
    string private _name = "Patch";
    string private _symbol = "PATCH";
    ...
    //Budget for ambassadors, partnerships, marketing
    uint256 public _treasuryFee = 600;
    uint256 private _previousTreasuryFee = _treasuryFee;

    //Budget for Marketing (as a percentage of the treasuryFee above)
    uint256 public _marketingPartOfTreasury = 17;

    //Budget for Team Salaries (as a percentage of the treasuryFee above)
    uint256 public _teamPartOfTreasury = 17;
    ...
    uint256 public _maxWalletHolding = 500 * 10**3 * 10**9;
    ...
    constructor (address payable _w1, address payable _w2, address payable _w3) public {
      w_1 = _w1;
      w_2 = _w2;
      w_3 = _w3;
    ...
    function payTreasury(uint256 ethAmount) private {
      uint256 teamFee = ethAmount.mul(_teamPartOfTreasury).div(100);
      uint256 marketingFee = ethAmount.mul(_marketingPartOfTreasury).div(100);
      uint256 treasuryWalletFee = ethAmount.sub(teamFee).sub(marketingFee);

      w_1.sendValue(teamFee);
      w_2.sendValue(marketingFee);
      w_3.sendValue(treasuryWalletFee);
    }
