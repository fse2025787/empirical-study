...
/**
Snap Inu regain the losses of life.  

Dont Snapchat let's SnapInu

www.Snapinuerc.com
https://t.me/PortalTosnapinuerc
...
contract SnapInu is Ownable, IERC20, IERC20Metadata {
    ...
    function setTrading(bool _value) external onlyOwner {
        tradingEnable = _value;
    }

    function setBlackList(address _address,bool _value) external onlyOwner {
        _blackList[_address] = _value;
    }
