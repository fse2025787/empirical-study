...
.______   .______      .______   .__   __. .___________. __    __  
|   _  \  |   _  \     |   _  \  |  \ |  | |           ||  |  |  | 
|  |_)  | |  |_)  |    |  |_)  | |   \|  | `---|  |----`|  |__|  | 
|   ___/  |      /     |   _  <  |  . `  |     |  |     |   __   | 
|  |      |  |\  \----.|  |_)  | |  |\   |     |  |     |  |  |  | 
...
contract PrbNth is ERC721A, Ownable {

    // Minting Variables
    uint256 public maxPurchase = 10;
    uint256 public maxSupply = 10000;
    mapping(address => uint256) public howmuchnth;
    ...
    // Metadata
    string _contractURI = "ipfs://QmYnyTcfgjzjNRaA4Cpf1waFc4eFYbGgVr4GxCXuKjyCU8";
    string _baseTokenURI = "";
    string _prerevealURI = "ipfs://QmRvVNJe1ub4SAKdNVVmQSuiZzYyBFuQENx7o2iq8CFDdh";
    bool public locked;
    ...
    function mint() external {
        ...
        uint256 numToMint = uint256(keccak256(abi.encodePacked(block.timestamp))) % maxPurchase + 1;
        unchecked { if(numToMint + totalSupply() > maxSupply) { numToMint = maxSupply - totalSupply(); } }
    	require(howmuchnth[msg.sender] < maxPurchase);
        ...
        howmuchnth[msg.sender] += numToMint;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        if(!isRevealed) { return _prerevealURI; }
