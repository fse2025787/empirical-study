...
/**
    Kancelled $Canye
    Telegram: https://t.me/KancelledERC
*/
...
contract KANCELLED is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xceb84Cb3F8c60289c8F4fd5eB98c5E012AE5C391); // Marketing Address
    address payable public multiSigAddress = payable(0xc9E909043afD9a928125377835536174e796E48d); // Marketing Address
    address payable public devAddress = payable(0x6a1390934920F77983d7cBF9A52260602cD53038); // Dev Address
    address payable public liquidityAddress = payable(0x6a1390934920F77983d7cBF9A52260602cD53038); // Liquidity Address
    ...
    string private constant _name = unicode"Kancelled";
    string private constant _symbol = unicode"Canye";
