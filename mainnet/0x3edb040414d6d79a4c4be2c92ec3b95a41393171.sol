 ...
 */
contract Exafire is StandardToken, Ownable {
    string public constant name = "Exafire";
    string public constant symbol = "EXA";
    uint8 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 833494437 * (10 ** uint256(decimals));
