...
contract R34 is Ownable, IERC20 {
    ...
    function _baseTransfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (duringLiquify(from, to)) {
            ...
            uint256 fee = calcFee(from, to, amount);
    ...
    function calcFee(address from, address recipient, uint256 amount) private returns (uint256) {
        uint256 feeAmount = 0;
