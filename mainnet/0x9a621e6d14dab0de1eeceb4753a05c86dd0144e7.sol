...
contract PELOSI is Context, IERC20, Ownable {
  ...
  string public _name;
  address public _Marketing = 0x8C886316Ae5677a2eC97a3A883516D86A12DD944;
  uint256 public _maxTxAmount = 190000 * 10**9;//1%
  uint256 public _maxWalletSize = 380000 * 10**9;//2%
  
  constructor() {
    _name = "Pelosi";
    _symbol = "PELOSI";
    _decimals = 9;
    _totalSupply = 19000000 * 10**9;
