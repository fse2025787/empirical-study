...
//  /_  __/ /_  ___     / __ )__  __(_) /___/ /___  ____  __________
//   / / / __ \/ _ \   / __  / / / / / / __  / __ \/ __ \/ ___/ ___/
//  / / / / / /  __/  / /_/ / /_/ / / / /_/ / /_/ / /_/ / /  (__  ) 
// /_/ /_/ /_/\___/  /_____/\__,_/_/_/\__,_/\____/\____/_/  /____/  
//                                                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x786372081563FB64284aDb3E55Ad5BB28C2002F8];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://bafybeid65esqonkh4ff2cuj6zj7lrnw2eeyhcoosask2isfbqw7kvippce/";
...
// File: contracts/TheBuildoorsContract.sol
//

pragma solidity ^0.8.0;

contract TheBuildoorsContract is RamppERC721A {
    constructor() RamppERC721A("The Buildoors", "BUIDL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/GGdjkxb6YWX1TNUtsILC/contract-metadata";
    }
}
