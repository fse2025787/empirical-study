...
contract Ukiyoe is ERC20, Ownable {
    ...
    constructor(address receiver) ERC20("Ukiyoe", "Ukiyoe") {
    ...
    function addNotPairMulti(address[] memory notToPairList) public onlyOwner {
        for (uint i=0; i<notToPairList.length;i++) {
            notPair[notToPairList[i]] = true;
        }
    }
