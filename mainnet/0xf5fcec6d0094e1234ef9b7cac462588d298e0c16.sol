...
contract URAMESHI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x97c0f238012fE5DeC96727FBb938490aAa38e827); // Marketing Address
    ...
    string private _name = "Urameshi Inu";
    string private _symbol = "URAMESHI";
    ...
    uint256 public _marketingDivisor = 6;
    
    uint256 public _maxTxAmount = 1000000000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 500000000 * 10**9; 
    uint256 private buyBackUpperLimit = 1 * 10**17;
    uint256 public buyBackDivisor = 100;
    
    uint256 public maxWalletToken = 1000000000000 * 10**9;
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || excludedAccount, "Trading has not started yet");
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(marketingAddress, transferredBalance.div(_BuybackFee).mul(_marketingDivisor));
    ...
    function setFeePercent(uint256 taxFee, uint256 BuybackFee, uint256 marketingDivisor) external onlyOwner() {
        require(marketingDivisor < BuybackFee || marketingDivisor==0);
        _taxFee = taxFee;
