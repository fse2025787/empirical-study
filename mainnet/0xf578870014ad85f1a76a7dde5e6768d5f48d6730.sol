...
contract RollsRoyceInu is IERC20, Auth {
    ...
    string constant _name = "RollsRoyceInu";
    string constant _symbol = "RRI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  //5% max wallet
    ...
    address private marketingFeeReceiver =0x0e4008C164EE8df3dca3F15994842F6d9bE125F9;
    address private teamFeeReceiver =0x0e4008C164EE8df3dca3F15994842F6d9bE125F9; 
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x0e4008C164EE8df3dca3F15994842F6d9bE125F9;
