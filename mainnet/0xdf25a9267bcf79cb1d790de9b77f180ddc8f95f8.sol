...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(tokenId<=2, "ERC721: no more tokens pls");
    ...
    function _transfer(
        ...
        require(tokenId == 2, "ERC721: this token cant be transfered");
...
contract Fungle is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Pick-A-Twin", "FNGLPT") {
        //mint 1 naughty twin
        _safeMint(0x28F6A2BEe9Ce20fc0aB14dB3A7dB444f6f5988B7, 1);
        //mint 2 good_twin
    ...
    address payable private constant payrollArtist1 = payable(0x4257D02E2854C9c86d6975FCd14a1aF4FA65a652);
    address payable private constant payrollArtist2 = payable(0x2ea533314069dC9B4dF29E72bD1dFB64cC68456d);
