...
contract BabyETH2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Proof of Memes", "BabyETH2.0") {
        ...
        marketingWallet = payable(0x452Ffa3933dE48E9f3cAd575b92f514DC192A5de);
        devWallet = payable(0x452Ffa3933dE48E9f3cAd575b92f514DC192A5de);
