...
contract JoyFellaz is ERC721, Ownable {
  ...
  constructor() ERC721("Joy Fellaz", "JF") {
  ...
  {
       if(_supply < 1000 && maxTokensPerWallet == 3) {
           return 3;
       } 
       else if (_supply < 1000 &&  maxTokensPerWallet != 3){
           return maxTokensPerWallet;
       }
       else if (_supply <= maxSupply && maxTokensPerWallet == 3){
           return 500;
       }
        else if (_supply <= maxSupply && maxTokensPerWallet != 3){
           return maxTokensPerWallet;
