...
contract PublicMinter is Ownable {
  DrunkenRaccoon private token;
  address private contractAddress;
  bytes32 private merkleRoot;
  uint256 public BASE_PRICE = 0.0 ether;
  uint256 public MAX_CAPACITY = 1000;
  uint256 public MAX_PER_BATCH = 100;
  uint256 public MAX_PER_WALLET_WL = 100;
  bool private IS_PUBLIC = true;
  ...
  ***************************
  ...
  function batchMint(
    ...
    //   token.safeMint(to);
    // }
    token.safeMint(to, batchMintAmt);
    emit Log(msg.value, gasleft());
  }
...
contract DrunkenRaccoon is ERC721A, Pausable, AccessControl, ERC721ABurnable, ERC721AOwnersExplicit {
  ...
  constructor() ERC721A('DrunkenRaccoon', 'DRRC') {
  ...
  function _baseURI() internal pure override returns (string memory) {
    return 'https://nft.drunkenraccoon.io/meta/';
  }
