...
We have nothing
We have zero from the start
But eventually we will build everything
But eventually we will have the world
There is no point in anything but growth
Liquidity locked is the first step
**/
...
contract NOTHING is ERC20, Ownable {
    ...
    constructor() ERC20("For The Dream", "NOTHING") {
        ...
        marketingWallet = payable(0x46C185bb34aBDda6B662e2d68BC6101A4aDbcFC4);
        devWallet = payable(0x46C185bb34aBDda6B662e2d68BC6101A4aDbcFC4);
