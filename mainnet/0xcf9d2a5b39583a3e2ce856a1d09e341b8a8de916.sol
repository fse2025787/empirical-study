...
// Join Shiba's Senpai and become a young Shenpai : t.me/ShenpaiInu ; twitter.com/ShenpaiInu
//
...
contract SHENPAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHENPAI INU";
    string private constant _symbol = "SHENPAI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x00cf01b8f3274C4ec750fE1b90d9731d08af216A);
        _feeAddrWallet2 = payable(0x954D034fFB3A35e4f11bca58aF5D3339d4f65f96);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            if (_buyMap[from] != 0 &&
                (_buyMap[from] + (16 hours) >= block.timestamp))  {
                _feeAddr1 = 1;
                _feeAddr2 = 19;
            } else {
                _feeAddr1 = 1;
