...
Telegram https://t.me/bariswapportal
Website https://www.bariecosystem.com

Bari is a decentralized exchange with a vision to become one of the biggest projects 
on the upcoming Shibarium L2 blockchain. Main ecosystem token is $BARI, which is already 
available on ETH chain. Unlike other DEXs, BariSwap will introduce revenue share model for $BARI holders. 
Hold $BARI and split up to 50% of the revenue. 
...
contract BariSwap is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "BariSwap";
    string private constant _symbol = "BARI";
