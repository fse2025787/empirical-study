...
Tg : https://t.me/cryptogramplatform
website: https://www.cryptogramplatform.com/
twitter: https://twitter.com/CryptogramTM
*/
...
contract CryptoGram is ERC20, Ownable {
    ...
    constructor() ERC20("CryptoGram", "$GRAM") payable {
    	...
    	marketingWallet = address(0x0abe62972484B8Af46565A31a3F5A4028F750501); // set as Marketing wallet
        devWallet = address(0x0abe62972484B8Af46565A31a3F5A4028F750501); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x0abe62972484B8Af46565A31a3F5A4028F750501, true);
        excludeFromFees(0x0abe62972484B8Af46565A31a3F5A4028F750501, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x0abe62972484B8Af46565A31a3F5A4028F750501, true);
        excludeFromMaxTransaction(0x0abe62972484B8Af46565A31a3F5A4028F750501, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x0abe62972484B8Af46565A31a3F5A4028F750501,
            block.timestamp
        );
    }
