...
contract MetaWatchesAnalogSummer is ERC721, Ownable, ERC721Enumerable {
    ...
    constructor(string memory baseURI, uint256 maxTokenSupply)
        ERC721('MetaWatchesAnalogSummer', 'MWAS')
    {
    ...
    function publicMint(uint256 amount) external payable {
        require(publicSaleActive, 'Public sale is not active');
        require(amount <= publicSaleLimit, 'Can only mint 5 watches at once');
