...
contract HODLCats is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_MINTS = 10;
    string public baseURI = "ipfs://QmTERydeoc5a7kGdFYDccmc23pcbFRfqA6uk8xE85qF89k/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("HODL Cats", "HODLCATS", MAX_MINTS, MAX_SUPPLY) {  
    }
