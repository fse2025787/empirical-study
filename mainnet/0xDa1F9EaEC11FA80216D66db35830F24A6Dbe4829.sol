...
/*
    https://t.me/CoinbaseDAO
    https://twitter.com/CoinbaseDAO_
    https://www.coinbasedao.faith/
*/
...
contract CoinbaseDAO is Context, IERC20, Ownable {
    ...
    string private _name = "CoinbaseDAO";
    string private _symbol = "CBDAO";
    ...
    function upliftTxAmount(uint256 maxTxAmount_) external onlyOwner {
        _maxTxAmount = uint256(maxTxAmount_) * 10**9;
    }
    ...
    {
        require(
            SwapThresholdAmount > 1000000000000,
            "Swap Threshold Amount cannot be less than 1000000000000"
        );
