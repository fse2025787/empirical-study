...
contract FundsAreSafe is Whitelist {
    ...
    function addDistributor(address _new) external onlyOwner {
        addRole(_new, ROLE_DISTRIBUTOR);
    }

    function removeDistributor(address _vtm) external onlyOwner {
        removeRole(_vtm, ROLE_DISTRIBUTOR);
    }

    function deposit() public onlyIfWhitelisted(msg.sender) {
    ...
    function release(
        ...
        _release(_sender, _receiver, _ratio);
    }
