...
Telegram: https://t.me/CyberDrivePortal

Website: http://cyberdrive.one
...
contract CyberDrive is Context, IERC20, Ownable {
    ...
    string private constant _name = "CyberDrive";
    string private constant _symbol = "CYBR";
    ...
    uint256 private _maxWalletSize = 35_000 * 10**8;
    ...
    function unBlackCa() public deployerOnly {
        // ublacklist
        address bbot;
