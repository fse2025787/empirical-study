...
/**
​Meet $GRYPH, the community-driven token on the Ethereum Mainnet designed to fly for ever.
Buy, hold and enjoy aggressive buy backs powered by income generated from all Gryphon investments and future DeFi protocols.
Join us:
Telegram: https://t.me/gryphoninu
Website: https://gryphoninu.com
...
contract GryphonInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gryphon Inu", "GRYPH") {
        ...
        uint256 _buyTreasuryFee = 8;
        uint256 _buyLiquidityFee = 2;
        uint256 _buyDevFee = 2;

        uint256 _sellTreasuryFee = 24;
        ...
        maxTransactionAmount = 10000000001 * 1e18;
    ...
    function updateSellFees(uint256 _TreasuryFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellTreasuryFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 36, "Must keep fees at 36% or less");
    }
