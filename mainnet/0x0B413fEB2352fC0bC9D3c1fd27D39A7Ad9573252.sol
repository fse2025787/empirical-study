...
//*********************************************************************//
//
//   / __ \___  / ____/__  ____  ____     / ____/ /___ _____ 
//   / / / / _ \/ / __/ _ \/ __ \/_  /    / /   / / __ `/ __ \
//  / /_/ /  __/ /_/ /  __/ / / / / /_   / /___/ / /_/ / / / /
// /_____/\___/\____/\___/_/ /_/ /___/   \____/_/\__,_/_/ /_/ 
//                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5C91246365dc3Bc5512Af4a6a90DB8534DE442aF];
  address public erc20Payable = 0x5C91246365dc3Bc5512Af4a6a90DB8534DE442aF;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif5iz7vd5csy727okrvw6lx4dnqcvhxh2hqbor6fc2rqp5olmpnse/";
...
// File: contracts/DeGenzClanContract.sol
//

pragma solidity ^0.8.0;

contract DeGenzClanContract is RamppERC721A {
    constructor() RamppERC721A("DeGenz Clan", "DeGenz"){}
}