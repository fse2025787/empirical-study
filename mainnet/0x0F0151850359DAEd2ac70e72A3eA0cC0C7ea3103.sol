...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x41788BCd2cc518b5cd0e75dd0254791d10b7C65F,0xDCD67FBf5FEcd832ffbb3951860e8ce3EA265eB3];
  address public erc20Payable = 0x41788BCd2cc518b5cd0e75dd0254791d10b7C65F;
  uint256[] public payableFees = [2,91,7];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 505) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibyusi3fvmrml4xr3rglouzbufbmmruhufbd4b5y5nipqfcn7yw3u/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 505");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 505");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 505");
      require(mintingOpen == true, "Minting is not open right now!");
...
// File: contracts/BblockCorpArmyContract.sol
//

pragma solidity ^0.8.0;

contract BblockCorpArmyContract is RamppERC721A {
    constructor() RamppERC721A("bblockCorp Army", "BLCK"){}
}
