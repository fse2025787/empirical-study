...
contract BystraOsadaMlynarzyContract is ERC20 {
    string  internal _name              = "Bystra Osada Młynarzy";
    string  internal _symbol            = "BOM";
    string  internal _standard          = "ERC20";
    uint8   internal _decimals          = 18;
    uint    internal _totalSupply       = 72000 * 1 ether;
