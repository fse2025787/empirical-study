...
Website:        https://hentaifi.com/
Video Channel:  https://t.me/WatchHentaiVideos
TG:             https://t.me/HentaiFi_EntryPortal
Twitter:        https://twitter.com/HentaiFi_
Backup Twitter: https://twitter.com/HentaiFiSFW
Medium:         https://medium.com/@HentaiFi

30% supply is being held back for the bridge that will go live in a few days. 
Holders will be able to bridge their HENTAI tokens to and from Arbitrum, BSC, and Ethereum
...
contract HentaiFi is ERC20, Ownable {
    ...
    constructor() ERC20("Hentai Fi", "HENTAI") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D uniswap
                                                                                                              ...
                                                                                                              // 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 Sushi ARBI
        ...
        maxTransactionAmount = 5_000 * 1e18; // 1% max txn
        maxWallet = 5_000 * 1e18; // 1% max wallet
        ...
        mktgWallet = address(0x131315Cac6dC9Ed64B758C3F162d2304D762e9f7); 
        devWallet = address(0xECCc66Ee0E9ee3A8Aae8234aDa40de57c7cD9701); 
        liqWallet = address(0x313230F9022fB46c0C63AFeb6888D5f989Fc81a1); 
        operationsWallet = address(0x313230F9022fB46c0C63AFeb6888D5f989Fc81a1);
