...
// Main Contract Logic 
// --------------------------------------------------------------
contract Ancalagon is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "ANCALAGON THE BLACK";
    string private _symbol = "ANCALAGON";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x23474f3E1Bb790aD6567B3D738290002b1F51680);
    address payable public operationsWallet =  payable(0x23474f3E1Bb790aD6567B3D738290002b1F51680);
    ...
    uint256 public maxTotalFeeSell = 90;
