...
// Welcome to baby Reagan
//
// "We are Never Defeated Unless We Give Up On Crypto - baby Reagan"
//
// Connect with us on Telegram : t.me/BabyReaganToken
// 
// Check out baby Reagan Website : babyreagan.xyz
// 
// 
...
contract bReagan is Context, IERC20, Ownable {
    ...
    string private _name = "baby Reagan";
    string private _symbol = "bREAGAN";
    ...
    uint256 public _maxTxAmount = _tTotal.div(10) ;
    uint256 private numTokensSellToAddToLiquidity = 500000 * 10**6 * 10**9;
    
    address payable private _devWalletAddress1 ;
    address payable private _devWalletAddress2 ;

    uint256 private dev1;
    uint256 private dev2;
    ...
    constructor (address payable devWalletAddress) public {
        ...
        _isExcludedFromFee[_devWalletAddress1] = true;
        _isExcludedFromFee[_devWalletAddress2] = true;
    ...
    function _setdevWallet(address payable devWalletAddress) external onlyOwner() {
        ...
        function setDev1(address payable devW1) external onlyOwner() {
            _devWalletAddress1 = devW1;
    }
    
    function setDev2(address payable devW2) external onlyOwner() {
            _devWalletAddress2 = devW2;
    }
    ...
    function sendETHTodev(uint256 amount) private {
        dev1 = (amount.div(2));
        dev2 = (amount.sub(dev1));
        
       _devWalletAddress1.transfer(dev1); 
       _devWalletAddress2.transfer(dev2);
    }
