...
The Iron Rat wears a shabby monk's garb and holds a string of buddhas.
Although it is called the Iron Rat, it is not directly related to elements or substances such as iron.
Iron here refers more to money and treasure.

TG:https://t.me/IronRat_INU
...
contract IronRatINU  is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Iron Rat INU";
    string private constant _symbol = "IRONRAT";
