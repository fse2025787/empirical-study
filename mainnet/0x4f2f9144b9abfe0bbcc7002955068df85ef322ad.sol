  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0xb422063a62127AaE7454451B57b3ce55fA529f15);
    ...
    // File: contracts/cyberTunerzContract.sol

    //

    pragma solidity ^0.8.0;

    contract CyberTunerzContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cyber Tunerz", "TUNERZ", _proxyRegistryAddress)
        {}
        ...
        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/mTPZ0aivFiufMohUZ57Z/contract-metadata";
        }
    }