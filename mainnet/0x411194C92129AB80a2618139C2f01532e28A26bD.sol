...
//    / __ \________  ____ _____ ___  (_)___  ____ _   ____  / __/  / ____/ /_  __(_)___  ____ _
//   / / / / ___/ _ \/ __ `/ __ `__ \/ / __ \/ __ `/  / __ \/ /_   / /_  / / / / / / __ \/ __ `/
//  / /_/ / /  /  __/ /_/ / / / / / / / / / / /_/ /  / /_/ / __/  / __/ / / /_/ / / / / / /_/ / 
// /_____/_/   \___/\__,_/_/ /_/ /_/_/_/ /_/\__, /   \____/_/    /_/   /_/\__, /_/_/ /_/\__, /  
//                                         /____/                        /____/        /____/   5
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x572e1Ca29b786f0dA849FC421F8F37CBCF76934a];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicahjcfjvly266yl7swdknadwrwuqv546qdsyb64kdqon2feywr3e/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 200");
...
// File: contracts/DreamingofFlyingContract.sol
//

pragma solidity ^0.8.0;

contract DreamingofFlyingContract is RamppERC721A {
    constructor() RamppERC721A("Dreaming of Flying", "FLYING"){}
}
