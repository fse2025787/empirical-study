...
/**
Today I offer the spark that will re-light the flame of individuality within you, 
allowing your unity with all to become known once again. Feel my Yellow Fire blessing the Solar center of self
and link it to the pureGreen Ocean fo your unconditional Heart.
Under the perfected guidance of the Eternal white light,you and I are now One.
*/
...
contract Chrysoprase is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fearless Movement";
    string private constant _symbol = "Chrysoprase";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xd10d426f1F9151628CC67E597f0bFD1056acd035); 
