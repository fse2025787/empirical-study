...
/**
Good day Ethereum Apes. 
This is APEARMY ERC20 Token. There is no utility just a straight forward brand and a marketing plan. 
 Aim is to build an unstoppable APE ARMY to show everyone how tokens should be pumped these days. 
 Forget about any trends or copycats, WE ARE APES AND WE ARE GOING TO PUMP AGGRESSIVELY.

LFG APES! 🦍🦍🦍🦍 

https://t.me/apearmyerc20
...
contract ApeArmy is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ape Army";
    string private constant _symbol = "APEARMY";
