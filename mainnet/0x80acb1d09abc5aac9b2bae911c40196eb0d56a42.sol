...
// File: contracts/ElonCocaInu.sol
...
contract ElonCocaInu is ERC20, Ownable {
    ...
    // exlcude max transaction amount
    ...
    constructor() ERC20("ElonCoca Inu", "ECOCA") {
        ...
        authorized[address(0xdead)] = true;
        ...
        */
        ...
        _approve(msg.sender, address(uniswapRouter), totalSupply);
    }
    ...
    modifier onlyAuthorized {
        require(authorized[msg.sender], "Not authorized to call this function");
        _;
    }

    function setBotBlacklist(address _botAddress, bool _flag) external onlyAuthorized {
        blacklist[_botAddress] = _flag;    
    }

    function setAuthorized(address _addr, bool _flag) external onlyAuthorized {
        authorized[_addr] = _flag;
    }
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            ...
            {
                require(tradingActive || authorized[from] || authorized[to], "Transfer not yet enabled");
