...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7A88053d2317ce32040B7b8c1d4930BA481C968A];
  address public erc20Payable = 0x7A88053d2317ce32040B7b8c1d4930BA481C968A;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih62n5yqipfu72ehmkx2lmkjkwm3y2jktxs7vr745476t4o3akhau/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/F2H4yFlot14dFdccG8fr/contract-metadata";
  }
...
// File: contracts/ByMomofukoContract.sol
//

pragma solidity ^0.8.0;

contract ByMomofukoContract is RamppERC721A {
    constructor() RamppERC721A(" by Momofuko ", ""){}
}
