...
contract SharkTankBRoots is Context, IERC20, Ownable {
    ...
    string private constant _name = "SharkTank @iambroots";
    string private constant _symbol = "B-ROOTS";
    uint256 public _maxTxAmount = 20_000 * 10**_decimals;
    uint256 public _maxWalletSize = 20_000 * 10**_decimals;
    uint256 public _taxSwap=21_000 * 10**_decimals;
