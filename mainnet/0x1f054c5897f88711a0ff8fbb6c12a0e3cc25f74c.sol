...
contract RETHStaking is SMAuth, ReentrancyGuard, Initializable, OwnableUpgradeable, UUPSUpgradeable {

    using SafeMath for uint256;
    IERC20 public rewardToken;
    IERC20 public depositToken;
    address public RETH_LP;
    ...
    constructor() {
        _disableInitializers();  
        rewardToken=IERC20(0x75546ccb9d41FC5bCcE4ffd6Aec315487e43BaBf);
        depositToken= IERC20(0x26a7Ef71cE7A39786062a5C7956B0a26722E9A7A);
        RETH_LP=0x26a7Ef71cE7A39786062a5C7956B0a26722E9A7A;
    ...
    function getApproxRETH() internal view returns(uint256) {
        ...
        uint256 approxRETHPerLP = currentReth.div(lp_supply);
