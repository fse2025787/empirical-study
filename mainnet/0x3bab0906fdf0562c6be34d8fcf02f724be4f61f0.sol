...
contract SmackaDino is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public teamSupply = 800;  
    uint256 public mintSupply = 8088;
    uint256 public maxPerTransaction = 3; 
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("Smack-a-Dino", "SMACKDINO") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "SAD isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "SAD Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"SAD Soldout !");
        require(msg.value >= qty * price,"SAD Insufficient Funds !");
