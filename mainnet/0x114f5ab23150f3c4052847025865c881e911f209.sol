...
contract Fellowship is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fellowship", "SA") {
        ...
        marketingWallet = address(0xa04a10D00f6C5E4106eBaFc0A3344a488d30B934); // set as marketing wallet
        devWallet = address(0x95EFC3Bbc2e258FCfca0766C9c76585fdf7D6855); // set as dev wallet
