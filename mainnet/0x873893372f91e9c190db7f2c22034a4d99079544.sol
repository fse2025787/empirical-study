...
contract MiniShibDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x4011aDC508DDD53125e758951660575f5d9173c0);    
    address payable public teamAddress = payable(0x4011aDC508DDD53125e758951660575f5d9173c0);   
    address payable private ownerAddress = payable(0x4011aDC508DDD53125e758951660575f5d9173c0);    
    ...
    string private constant _name = "Mini ShibDoge";
    string private constant _symbol = "MiniShibDoge";
