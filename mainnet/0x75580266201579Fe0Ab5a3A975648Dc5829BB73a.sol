...
contract RQ is ERC721EnumerableDelegable, IERC721Receiver, IERC2981, ReentrancyGuard, Ownable {
   ...
   */
  constructor(address DQContract_) ERC721("RQ NFT", "RQ"){
   ...
   * delegate token.
   */
  function wrap(address _sourceContract, uint256 _sourceTokenId, bytes calldata _data) external virtual nonReentrant {
