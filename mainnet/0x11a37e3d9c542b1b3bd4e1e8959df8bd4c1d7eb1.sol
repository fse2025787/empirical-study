...
contract IXCHEL is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Maya moon goddess";
    string private constant _symbol = "IXCHEL";
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x201B54cADB558FaB5182B8CCAaB58feF75A9336a] = true;
        _initialTax=5;
        _finalTax=3;
