...
contract TheUkrainians is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmcSfbq6ruhzhpdudTyhRaSqtbsmthHM5SQLBZu4vHNBu2/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.002 ether;
  uint256 public maxSupply = 5555;
  uint256 public maxMintAmountPerTx = 25;
  uint256 public freeUntil = 5555;
  uint256 public freebiesPerWallet = 2;
  mapping(address => uint256) public freebieMap;

  bool public paused = false;

  constructor() ERC721A("TheUkrainians", "TU") {
  }
