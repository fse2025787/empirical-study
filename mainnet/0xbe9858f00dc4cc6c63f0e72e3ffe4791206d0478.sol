...
/**
* Nyan Doge is here to take it over...
* LP will be burned
* Ownership Renounced
*
* TG @NyanDogeERC
...
contract NyanDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NyanDoge";
    ...
    address payable public liquidityWallet = payable(0x223edB2357E42117F5c247c43e0d27D2268611f6);
    address payable public operationsWallet =  payable(0x223edB2357E42117F5c247c43e0d27D2268611f6);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 10;
    uint256 public totalFeesBuy;
    uint256 public maxTotalFeeBuy = 100;

    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 10;
    uint256 public totalFeesSell;
    uint256 public maxTotalFeeSell = 100;
