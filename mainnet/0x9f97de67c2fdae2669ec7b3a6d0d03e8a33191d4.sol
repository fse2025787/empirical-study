...
/**
HHHHHHHHHHHHHHHHHORRNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN
Welcome To HORNBILL ERC-20!

Flying (no pun intended) with the current bird hype, the latest feathered friend is here to provide a SAFE and PROFITABLE platform for you to watch your earnings grow!  Proven dev!  Dedicated team!  Low taxes!  Coolest bird ever!  Join the flock today!
...
TG: http://t.me/hornbillerc
TWITTER: https://twitter.com/hornbillETH

BIIIIIIIIIIIIIIIILLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL
*/
// 
...
contract hornbill is Context, IERC20, Ownable {
    ...
    string private constant _name = "HORNBILL";
    string private constant _symbol = "HORNBILL";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 3 / 1000; //0.3%
