...
contract Glory is Context, ERC20, Ownable {
    ...
    constructor (address routerAddress) ERC20("Glory", "Glory"){
        ...
        maxTxAmount = (TOTAL_SUPPLY / 1000) * 5 + 1; // Max trans .5%
        maxWalletAmount = maxTxAmount * 5; // Max wallet 2.5%
        swapTokensAt = TOTAL_SUPPLY / 1000 * 5; // Swap token at .5%
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (!inSwap && from != uniswapV2Pair && contractTokenBalance > 0 && contractTokenBalance >= swapTokensAt) {
            swapAndLiquify();
            getMarketingFee();
        }
    ...
    function setSwapTokensAt(uint256 amount) public onlyOwner {
        swapTokensAt = amount * 1e18;
    }
    ...
    function setWalletAndTxtAmount(uint256 _maxTxAmount, uint256 _maxWalletSize) external onlyOwner {
        ...
        maxTxAmount = _maxTxAmount * 1e18;
        maxWalletAmount = _maxWalletSize * 1e18;
    }
