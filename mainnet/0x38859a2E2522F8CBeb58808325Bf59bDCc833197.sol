...
contract HeatInu is ERC20, Ownable {
    ...
    constructor() ERC20("Ultra Inu", "ULTRA") {
        ...
        maxTransactionAmount = 1_000_000 * 1e18; //1% of total supply
        maxWallet = 2_000_000 * 1e18; //2% of total supply
    ...
    //Retrieve  stuck eth and stuck tokens
    ...
    function retrieveStuckEthForBuyback() external {
