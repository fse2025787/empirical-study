...
// Token is safely owned by a 48 hour timelock after launch, so fees can be adjusted by community proposals

Timelock address - 0x71acc9F23851A629CFf952df25d30D8B878Eb0e6

Tokens locked with Unicrypt

- 7% to Marketing and Support of the protocol
- 5% to back Liquidity through swap and liquify, creating price floors and increasing liquidity
- 1% Max buy transaction limit 

Telegram - t.me/GoblinModeEthereum

- Twitter will be published in Telegram alongside the website...
 ...
 */
 contract GoblinMode is ERC20, Ownable {
    ...
    address public marketingWallet = 0xdbE2230c332717533f42E3F5DC48642D3E721dFc;
    // TOKENOMICS END ============================================================>
