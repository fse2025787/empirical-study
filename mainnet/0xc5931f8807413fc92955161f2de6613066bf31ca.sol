...
邪王炎殺黒龍波 ! The Dragon of the Darkness Flame !

https://t.me/hieiinu


Hiei famous’s attack Dragon of the Darkness Flame is ready to launch the strike in the crypto world. He is extending his arm out, and the dragon shoots forward, charging in the direction Hiei points. As the dragon moves forwards, it utterly destroys anything it comes into contact with since it is made out of demonic flames - meaning that it consumes anything it touches, sending them straight to oblivion. 

Hiei Inu is designed to launch attacks on those infamous snipers. We are here to make this crypto space safer for the average investor. With the help of Hiei Inu, we are making that possible. 
...
contract HINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "HIEI INU";
    ...
    uint256 public _maxTxAmount = 2e11 * 10**9;
