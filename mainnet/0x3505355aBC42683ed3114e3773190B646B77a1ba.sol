...
contract MTVX is Context, IERC20, Ownable {
    ...
    string private constant _name = "MTVX";
    string private constant _symbol = "MTVX";
    ...
    uint256 public _buyLiquidityFee = 500;
    ...
    uint256 private gasPriceLimit = 475 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() {
        ...
        marketingAddress = payable(0xc94930B77f54361857D35c5FdcDB9bE040F8474D); // Marketing Address
        liquidityAddress = payable(address(0xdead)); // Liquidity Address
