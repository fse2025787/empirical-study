...
/**
Token Name: Chain Breaker
Ticker: Fenrir
Supply: 1,000,000 (1M)

Token allocation: 100% or 1 M for the LIQUIDITY 
...
2% Dev fee for Dapp and Servers

Telegram: https://t.me/ChainBreakerFenrir
Twitter: https://twitter.com/FenrirERC20
Website: https://fenrirchain.com/
*/
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    uint256 private maxWalletAmount = 200000 * 10**9; //20% of 1M
    uint256 private maxTxAmount =  100000 * 10**9; // 10% of 1M

    address payable private marketingAddrWallet; 
    address payable private feeAddrWallet;
    
    string private constant _name = "Chain Breaker";
    ...
    uint256 public totalSellFees = sellAutoBurnFee + sellAutoBuyBackandBurnFee + sellMarketingFee + sellDevFee; 
 ...
 constructor () {
    ...
    feeAddrWallet = payable(0x0d0d6E490D5e30CE51F260C159d6Ff24C6a3963C); 
    marketingAddrWallet = payable(0xC5095eC43E15C67C49E4b161cC18cB5e5f7d01F4);
