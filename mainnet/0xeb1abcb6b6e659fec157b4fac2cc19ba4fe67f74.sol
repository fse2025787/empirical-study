...
// File: misc-tokens/Ryoshi/IERC20.sol
...
// File: misc-tokens/Ryoshi/IERC20Metadata.sol
...
// File: misc-tokens/Ryoshi/Context.sol
...
// File: misc-tokens/Ryoshi/Ownable.sol
...
// File: misc-tokens/Ryoshi/ERC20.sol
...
// File: misc-tokens/Ryoshi/Address.sol
...
contract Cadence is ERC20, Ownable {
    ...
    uint8 private liquidityFee = 0;
    uint8 private marketingFee = 2;
    uint8 private burnFee = 4;
    uint8 public totalFees = liquidityFee + marketingFee + burnFee;
    address public marketingWallet = 0xcFFD2bf68228608ADDE8FA6502944Ed43fB0fb7d;
    ...
    constructor() ERC20 ("Cadence", "CADENCE", 9) {
        ...
        _mint (msg.sender, 5 * 10**7 * 10**9);
        _maxTxAmount = 5 * 10**7 * 10**9 ;
