...
contract Booster {
    ...
    uint256 public lpStakerIncentive = 8000; //incentive to psdn stakers
    uint256 public psdnOceanStakerIncentive = 1500; //incentive to psdn stakers
    ...
    function setRewardContracts(
        ...
        //has a means to redeploy
        if (psdnOceanStakersRewards == address(0)) {
