...
contract shibadoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _shibadoge_Burned;
    ...
    uint256 public _maxTxAmount = 2000000000000000000000 * 10**18;
    uint256 public _maxHoldings = 4000000000000000000000 * 10**19;
    bool public maxHoldingsEnabled = true;
    bool public maxTXEnabled = true;
    bool public antiSnipe = true;
    uint256 public numTokensSellToAddToLiquidity = 40000000000000000000 * 10**18;
    ...
    constructor () {
        ...
        _marketingWallet = 0xAf4Fc29f47C02E53610e0a223a947C201cAdd39c;
        _dWallet = 0x81023171063604d28626e81BAFA2AF3e2F710Bd7;
    ...
    function burnshibadoge(uint amount) external {  
        ...
        _shibadoge_Burned = _shibadoge_Burned.add(tBurn);
    }
    function sacrificeshibadoge(uint amount) external {  
