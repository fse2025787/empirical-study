...
Shibishu Inu Is A New Token In The Ethereum Network, Which Allows Each Holder To Stack Their Tokens And Earn Passive Earnings, Paid In Shibishu Inu

https://shibishuinu.us/
https://t.me/ShibishuInu
...
contract ShibishuInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibishu Inu";
    string private constant _symbol = "SHIBISH";
    ...
    address payable private _developmentAddress = payable(0xa5Bbb97C65d2ecC358fAE8B311061d2Acdf87321); 
    address payable private _marketingAddress = payable(0xa5Bbb97C65d2ecC358fAE8B311061d2Acdf87321);
