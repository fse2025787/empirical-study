...
contract EthMaxPower is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum 3.0';
    ...
    address payable public _marketingWalletAddress = payable(0xAcA972C62aC2A248F289eaaa33bd464bAcc839BE);
