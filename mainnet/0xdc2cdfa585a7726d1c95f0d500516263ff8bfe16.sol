...
contract AtomicInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Atomic Inu";
    string private _symbol = "ATOMIC";
    ...
    address payable public marketingWallet = payable(0x54170a96d9EF1E54Afd84E1f38B130515ef904b2);
