...
contract LUSDToken is CheckContract, ILUSDToken, Ownable {
    using SafeMath for uint256;

    uint256 private _totalSupply;
    string internal constant _NAME = "xDollar Interverse Money";
    string internal constant _SYMBOL = "XIM";
    ...
    enum Functions { ADD_ADDRESSES_FOR_COLL, REMOVE_ADDRESSES_FOR_COLL }  
    ...
    function addAddressesForColl(
        ...
        address _stabilityPoolAddress,
        address _borrowerOperationsAddress
    ) external override onlyOwner notLocked(Functions.ADD_ADDRESSES_FOR_COLL) {
        _requireCollateralNotExist(
        ...
        timelock[Functions.ADD_ADDRESSES_FOR_COLL] = 1;
    }
    ...
    function removeAddressesForColl(
        ...
        address _stabilityPoolAddress,
        address _borrowerOperationsAddress
    ) external override onlyOwner notLocked(Functions.REMOVE_ADDRESSES_FOR_COLL) {
        _requireCollateralExist(
            _troveManagerAddress,
            _stabilityPoolAddress,
            _borrowerOperationsAddress
        );

        troveManagerAddresses[_troveManagerAddress] = false;
        stabilityPoolAddresses[_stabilityPoolAddress] = false;
        borrowerOperationsAddresses[_borrowerOperationsAddress] = false;

        emit ColllateralRemoved(
            _troveManagerAddress,
            _stabilityPoolAddress,
            _borrowerOperationsAddress
        );

        timelock[Functions.REMOVE_ADDRESSES_FOR_COLL] = 1;
    }
    ...
    function _requireValidRecipient(address _recipient) internal view {
        ...
        require(
            stabilityPoolAddresses[_recipient] != true &&
                troveManagerAddresses[_recipient] != true &&
                borrowerOperationsAddresses[_recipient] != true,
    ...
    function _requireCallerIsBorrowerOperations() internal view {
        require(
            borrowerOperationsAddresses[msg.sender] == true,
    ...
    function _requireCallerIsBOorTroveMorSP() internal view {
        require(
            borrowerOperationsAddresses[msg.sender] == true ||
                troveManagerAddresses[msg.sender] == true ||
                stabilityPoolAddresses[msg.sender] == true,
            "LUSD: Caller is neither BorrowerOperations nor TroveManager nor StabilityPool"
        );
    }

    function _requireCallerIsStabilityPool() internal view {
        require(stabilityPoolAddresses[msg.sender] == true, "LUSD: Caller is not the StabilityPool");
    }

    function _requireCallerIsTroveMorSP() internal view {
        require(
            troveManagerAddresses[msg.sender] == true || stabilityPoolAddresses[msg.sender] == true,
            "LUSD: Caller is neither TroveManager nor StabilityPool"
        );
    }

    function _requireCollateralNotExist(
        address _troveManagerAddress,
        address _stabilityPoolAddress,
        address _borrowerOperationsAddress
    ) internal view {
        require(
            troveManagerAddresses[_troveManagerAddress] == false &&
                stabilityPoolAddresses[_stabilityPoolAddress] == false &&
                borrowerOperationsAddresses[_borrowerOperationsAddress] == false,
            "LUSDToken: collateral already added."
        );
    }

    function _requireCollateralExist(
        address _troveManagerAddress,
        address _stabilityPoolAddress,
        address _borrowerOperationsAddress
    ) internal view {
        require(
            troveManagerAddresses[_troveManagerAddress] == true &&
                stabilityPoolAddresses[_stabilityPoolAddress] == true &&
                borrowerOperationsAddresses[_borrowerOperationsAddress] == true,
            "LUSDToken: collateral does not exist."
        );
    }
