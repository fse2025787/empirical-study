...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x03857501d81bb5109b61008D34225d07b06379d1];
  address public erc20Payable = 0x03857501d81bb5109b61008D34225d07b06379d1;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 3333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmb4RwutMTsENrPMS4amcmkAnqXurtv2A5uAFf7AzzQGtY/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gopwddrtuXjW7uu8LaQR/contract-metadata";
  }
...
// File: contracts/EthDragonClubContract.sol
//

pragma solidity ^0.8.0;

contract EthDragonClubContract is RamppERC721A {
    constructor() RamppERC721A("ETH Dragon Club", "DrgClb"){}
}