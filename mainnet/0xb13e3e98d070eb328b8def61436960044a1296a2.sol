...
// TG: https://t.me/+caejHj5H_Yo4Y2Qx

// Twitter: Twitter.com/cakekwonerc
...
contract CAKEKWON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CAKE KWON", "CKWON") {
        ...
        devOpsWallet = address(0x2D03c885d48C008DD9295e55a9CDe9b5144D95E8); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x2D03c885d48C008DD9295e55a9CDe9b5144D95E8), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x2D03c885d48C008DD9295e55a9CDe9b5144D95E8), true);
