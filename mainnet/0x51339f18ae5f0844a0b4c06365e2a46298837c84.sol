...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC721/IERC721Upgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721MetadataUpgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC721/ERC721Upgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721EnumerableUpgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721EnumerableUpgradeable.sol
...
// Root file: contracts/nft/NFT.sol
    ...
    NativeMetaTransaction
{
    ...
    modifier onlyOwnerOf(uint256 _tokenId) {
        require(ERC721Upgradeable.ownerOf(_tokenId) == _msgSender(), "NFT: not owner of token");
        _;
    }

    modifier onlyAdminOrMinter() {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()) || hasRole(MINTER_ROLE, _msgSender()), "NFT: only admin or minter");
        _;
    }
    ...
    function mint(address _account) external onlyAdminOrMinter whenNotPaused returns (uint256) {
        _tokenIds.increment();
    ...
    function grantMinterRoleTo(address _account) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function revokeMinterRoleFrom(address _account) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function _burn(uint256 _tokenId) internal override(ERC721Upgradeable, ERC721URIStorageUpgradeable) {
        ERC721Upgradeable._burn(_tokenId);
    }
    ...
    function withdrawToken(address _token, address _recipient) external virtual whenPaused onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function withdrawSomeToken(
        ...
        address _recipient,
        uint256 _amount
    ) external virtual whenPaused onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function updateBaseTokenURI(string memory _baseTokenURI) external whenPaused onlyRole(DEFAULT_ADMIN_ROLE) {
        baseTokenURI = _baseTokenURI;

        emit UpdateBaseTokenURI(_baseTokenURI);
    }

    function updateProxyRegistryAddress(address _proxyRegistryAddress) external whenPaused onlyRole(DEFAULT_ADMIN_ROLE) {
        proxyRegistryAddress = _proxyRegistryAddress;
