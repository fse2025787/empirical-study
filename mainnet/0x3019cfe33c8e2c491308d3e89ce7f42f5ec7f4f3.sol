...
// / /___/ /_/ / / /                                   
///_____/\__/_/ /_/                           __       
//   / /   ____  ____  ____ _____  ___  _____/ /_______
//  / /   / __ \/ __ \/ __ `/ __ \/ _ \/ ___/ //_/ ___/
// / /___/ /_/ / / / / /_/ / / / /  __/ /__/ ,< (__  ) 
///_____/\____/_/ /_/\__, /_/ /_/\___/\___/_/|_/____/  
//                  /____/    
//For the fucking culture.  Fuck Canto - Eth The Superior Chain
//Bridge Deez Nuts
// 
...
contract TheEthLongnecks is ERC721A, Ownable, ReentrancyGuard {
    //For the culture
    string public baseURI = "ipfs://QmdENA9y9APoURyHaXtaPCwSArtEPmR1tEPpYjFfr7XB5T/";
    ...
    constructor() ERC721A("The ETH Longnecks", "EL"){}
    ...
    function PublicMint(uint256 count) external payable {
        ...
        if (isFree) { 
            ...
            require(tx.origin == msg.sender, "No Contract minting.");//recently added
   ...
   function TeamMint(uint256 quantity, address) external onlyOwner {
        _safeMint(_msgSender(), quantity);
    }

       function TeamMint2(uint256 quantity) external onlyOwner {
        _safeMint(_msgSender(), quantity);
    }
