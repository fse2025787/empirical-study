...
/**
 * Welcome to Ethereum Pro White. Feel free to make a tg. Stealth launch and fully community owned.
Eth Pro White - $ETPw
This token for my Chads-$ETHw will be The next community-driven token in 2022
0-0 Tax
Lp burned !!
Safe TEAM
*/
...
contract EthProWhite is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Eth Pro White", "ETPw") {
