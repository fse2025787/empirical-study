...
https://t.me/ProofofGoogle
https://twitter.com/Google2_Erc20
https://medium.com/@Google2.0_Eth20
...
contract Google2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of Google";
    string private constant _symbol = unicode"GOOGLE2.0";
    ...
    uint256 private maxTxAmount = 20000 * 10**_decimals; 
    uint256 private maxWalletAmount = 40000 * 10**_decimals; 
    ...
    constructor () {
        ...
        MarketingWallet = payable(0xfA1c656b04893132220af9d97455111B8b9dE844);
        ...
        maxTxAmount = 20000 * 10** _decimals;
        maxWalletAmount = 40000 * 10** _decimals;
    ...
    function removeLimits() external onlyOwner{
     ...
     function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        maxTxAmount = 20000 * 10**9; // 2%
        maxWalletAmount = 40000 * 10**9; // 4%
        tradingOpen = true;
