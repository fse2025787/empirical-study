...
/**
//OKANE TOKEN is a community-driven meme cryptocurrency on Ethereum blockchain.
with the values of community-led, transparency and trust, giving back, and longevity.

Our contract is have low tax on buys and sells.!
...
contract OKANETOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OKANE TOKEN", "OKANETOKEN") {
