...
//  
    ...
    */
    ...
    /**   
    * HedgiesNFT
    * Web: https://hedgies.wtf/
    * Say hello to Hedgies, a collection of 4,200 unique avatars represented as NFTs on Ethereum, 
    * to be distributed to voters, traders, and the crypto community at large. We are excited for each 
    * one to find a home, and for Hedgies to grow & unite our incredible community.
    */
...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    ...
    name = "HedgiesNFT";
    decimals = 9;
    _totalSupply = 7500000000000 * 10**9;
...
contract HedgiesNFT is TokenBEP20 {
