...
/**
    Sui-ō / 水王 ERC Token
    Medium:  https://medium.com/@waterlordsuio
    Twitter: https://twitter.com/SuioWaterLord   
*/
...
contract SuiO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x622de3D6935341DDa9Bd58cdce81A4e6B208A6D8); // Marketing Address
    address payable public multiSigAddress = payable(0x622de3D6935341DDa9Bd58cdce81A4e6B208A6D8); // Marketing Address
    address payable public devAddress = payable(0x622de3D6935341DDa9Bd58cdce81A4e6B208A6D8); // Dev Address
    address payable public liquidityAddress = payable(0x622de3D6935341DDa9Bd58cdce81A4e6B208A6D8); // Liquidity Address
    ...
    string private constant _name = unicode"Sui-ō";
    string private constant _symbol = unicode"水王";
