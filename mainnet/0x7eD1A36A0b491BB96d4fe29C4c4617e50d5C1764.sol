...
contract MPPH is ERC721MP, Ownable, ReentrancyGuard
{    
    struct MintPass
    {
    ...
    MintPass public MintPassSale = MintPass(
        ...
        50,         // [2] -> _MaximumAvailableForSale
        1666890000, // [3] -> _StartingBlockUnixTimestamp
        1004,       // [4] -> _SecondsBetweenPriceDecay
        true,       // [5] -> _ActivePublic
        0xebb31ccf8dbd220f189963bfca5616a792d029f1977098da0ad9f8e37341443e  // [6] -> _Root
    ); 
    ...
    string public baseURI = "ipfs://QmT24SCxUBaHhVtFEUEVUzsd1cAYTkLWPSsNrakrkVoLE3/";
    bool public RefundsDistributed;
    address public _LiveMint = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;   
    address public _Waitlist;
    ...
    constructor() ERC721MP("Mint Pass Pohualli | Fahad Falls | MPPH", "MPPH")
    {
        // Transfers Ownership 
        // _transferOwnership(0xe06F5FAE754e81Bc050215fF89B03d9e9FF20700); // operator.brightmoments.eth
        _mint(0xe06F5FAE754e81Bc050215fF89B03d9e9FF20700, 50);
     ...
     * @dev Purchases NFTs
     */
    function PurchasePass(uint Amount) external payable nonReentrant
    { 
        ...
        { 
            ...
            IWaitlist(_Waitlist).SeedClearingPrice(0, CurrentPrice, 75);
            ___EndMintPassSale();
        }
    ...
    {
        require(MintPassInternalSale._FinalClearingPrice > 0, "MP: Final Clearing Price Not Seeded");
        require(!RefundsDistributed, "MP: Can Only Call This Function Once");
        RefundsDistributed = true;
    ...
    /**
     * @dev Instantiates New Waitlist Address
     */
    function __NewWaitlistAddress(address NewAddress) external onlyOwner { _Waitlist = NewAddress; }
...
// 
pragma solidity 0.8.17;
interface IWaitlist { function SeedClearingPrice(uint WaitlistIndex, uint Price, uint Discount) external; }
