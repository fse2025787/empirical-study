...
contract Letmedoitforyou is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVCrx93J6fWrUXcvaHuJEGyWDFxgoYeXBvhfbzXzkHakd";
    ...
    constructor(
    ) ERC721A("Let me do it for you", "kermit", 100, maxSupply) {
    }
