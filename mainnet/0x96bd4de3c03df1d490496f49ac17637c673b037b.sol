...
contract TinyERC721 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZjHsoHHdcSsKboAbvz3ooexYkSC6kq8hFQwCHwFRHdFS";
    ...
    constructor(
    ) ERC721A("ERC-TinyBears", "ETB", 100, maxSupply) {
    }
