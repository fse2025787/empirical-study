...
contract VitaliksBoner is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "VitaliksBoner";
    string private _symbol = "VBONE";
    uint8 private _decimals = 18;
    uint256 totalFeeFortx = 0;
      uint256 maxWalletTreshold = 5;
    uint256 maxTxTreshold = 5;
    uint256 private swapTreshold =5;
    ...
    address _owner;
    address payable public marketingAddress = payable(0x61c55f7BFD205c6581155046553c90AFB0BF2431);
    ...
    function BlueBallsTime() public onlyOwner{
         require(block.timestamp > BlueBallsTimecooldown, "You cant call BlueBallsTime more than once per day");
    ...
    function BlueBallsTimeOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         BlueBallsTimecooldown = block.timestamp + 86400;
    }
