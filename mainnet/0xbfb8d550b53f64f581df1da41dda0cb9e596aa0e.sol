...
contract IERC4626Draft is EIP20Interface {
    ...
    */
    function withdraw(uint256 amount, address to, address from) public returns (uint256 shares);
    ...
    */
    function redeem(uint256 shares, address to, address from) public returns (uint256 amount);
