...
contract MakeMeController {
    address public constant makeMeController = 0x3455FbB4D34C6b47999B66c83aA7BD8FDDade638;
    ...
    */
    ...
    function migrateController() external {
        token.changeController(makeMeController);
    }
}