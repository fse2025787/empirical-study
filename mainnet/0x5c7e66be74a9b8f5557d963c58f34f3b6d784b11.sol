...
contract PIXIRADIO is
    Initializable, ERC1155Upgradeable,
    OwnableUpgradeable,
    PausableUpgradeable,
    ...
    ERC1155SupplyUpgradeable, UUPSUpgradeable
{
    ...
    mapping(address => bool) public whiteList; // Holds whitelisted address status
    uint256 constant public PIXIRADIO_NFT = 0;
    uint256 constant public PIXIRADIO_TOKEN = 1;
    string public baseExtension;


 /**
    * @dev Can be added on any function to restrict access to whitelisted addresses only similar to onlyOwner modifier
    */
    ...
    // ***Add future storage variables here***

    function initialize(address _owner, string memory _uri) public initializer {
        __ERC1155_init(_uri);
        __Ownable_init();
        __Pausable_init();
        __ERC1155Burnable_init();
        __ERC1155Supply_init();
        __UUPSUpgradeable_init(); // UUPS efficient Proxy
 ...
 /**
    * @dev To remove whitlisted address.
    ...
    */
    ...
    return string(abi.encodePacked(super.uri(PIXIRADIO_NFT), _tokenId.toString(), baseExtension));
    }
