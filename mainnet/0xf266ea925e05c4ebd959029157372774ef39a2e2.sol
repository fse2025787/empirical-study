...
contract CharlesInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xFf3fF7E49d639aa690E2e3A5ab82Ce5486de016A); // Marketing Wallet
    address payable private devWallet = payable (0xFf3fF7E49d639aa690E2e3A5ab82Ce5486de016A); // dev Wallet
    ...
    string private _name = "Charles Inu";
    string private _symbol = "CharlesInu";
