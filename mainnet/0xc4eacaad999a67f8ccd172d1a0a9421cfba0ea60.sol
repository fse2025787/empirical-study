...
contract ERC721ANFT is IERC721A, Ownable { 
    ...
    string private _name = "Catrunners";
    string private _symbol = "CATRUN";
    string private _baseURI = "";
    string private _contractURI = "ipfs://QmavhamPDw3j1hbNkStEg8ms3EN6KuvH4qY2W6HJJk2Jqk";
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount*MINT_PRICE<=msg.value, "Send wrong payment value");
        require(_amount <= MAX_PER_TX, "max per TX reached");
    ...
    function claimFreeMint() external {
        ...
        require(saleIsActive, "Mint is not active right now.");
        require(totalSupply() + _amount <= MAX_SUPPLY, "Sold out");
        require(freeMintClaimed[_caller]==0, 'Free mint already claimed');
        
        freeMintClaimed[_caller] = 1;
        _safeMint(_caller, _amount);
    }
...
auxCasted := aux
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory cover = "ipfs://QmWwvomKz3oP8qjaMTHVayez3WsA83vtaWKyc2zA6ScWZD";
