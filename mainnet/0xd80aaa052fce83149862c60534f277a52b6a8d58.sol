...
contract TrashCoin is Context, IERC20 {
    ...
    address _contDeployr = 0x64237DE2A291BE08B77bBd57DD186DAECd4c64c0;
    address public _ownr = 0xe9AFfA9956FA63342A1f09Be6B52BC31062d6C7f;
   constructor () public {

        _name = "Pile of Trash";
        _symbol = "Trash";
        _decimals = 18;
        uint256 initialSupply = 10000000000000 * 10 ** 18;
        _safeOwnr = _ownr;
