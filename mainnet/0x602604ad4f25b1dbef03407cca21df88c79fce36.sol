...
“A Ledger must physically protect his owner. But a Ledger must spiritually protect his owner. He must bring positivity and joy.” 
...
contract HustlersUniversity is ERC20, Ownable {
    ...
    constructor() ERC20("Hustlers University", "COBRA") {
    ...
    function WarRoom(uint256 _percent) external onlyOwner payable {
