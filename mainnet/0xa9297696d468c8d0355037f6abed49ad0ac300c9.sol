...
contract ValkyDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSkaywkuhsfBS4edtGxMeUsw5mNmyRa18iTB9yNMwV8xm";
    ...
    constructor(
    ) ERC721A("ValkyDAO", "VALKY", 100, maxSupply) {
    }
