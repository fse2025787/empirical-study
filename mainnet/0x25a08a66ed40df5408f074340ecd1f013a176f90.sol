...
contract MonoToken is ERC20, Ownable, AccessControl, ERC20Snapshot {
    ...
    function mint(address _to, uint256 _amount) public {
        ...
        require(_amount.add(totalSupply()) <= cap, "MONO: cap exceeded");
        _mint(_to, _amount);
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "MONO::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MONO::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "MONO::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "MONO::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MONOs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MONO::_writeCheckpoint: block number exceeds 32 bits");
