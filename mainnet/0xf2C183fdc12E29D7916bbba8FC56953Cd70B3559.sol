...
interface ILilFranks is IERC721Enumerable {
...
/*  
                    ...
                    ;#@S#####[email protected]          @Q                      @#b GGGG ^'' [email protected]##f#
                    @#########"%m         ###m,                   ]b( ,;,,QJQ G,QQ"#`%[email protected]
                    #SG##@"\[email protected]###MMWW%%"""""7""""""""""""""^```               `"%##""@p
                   #5#Q# ,Q##"`         ,,s,,                      s######wssm   p     %[email protected]
                 ##5#S5##W     p 'WW##############            "@@@###########       .p  @m#
                @###b#@#   ,       ]#########@###   .#MW55WM   @@############s          @b
                 %####@b       ,  [email protected]#############        `^"%p  @############       .p .#
                  ] %###           ^############b           ,#  ^@####@#####    s     ;#
