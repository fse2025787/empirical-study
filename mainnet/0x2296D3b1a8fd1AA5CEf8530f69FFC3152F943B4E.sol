...
contract BrilliantlyInLove is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xf06096def80b228605efa68fc93f60b6e42efd105d25ade83ecbe68a59973f22;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmZAEApXY7V9U9CitCnkQppfLpuTqB5F334PgZq2QTtie9";

    constructor() public ERC721A("Brilliantly in Love", "DIAMOND", 999, 999) {}
