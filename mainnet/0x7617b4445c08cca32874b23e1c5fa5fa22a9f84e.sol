...
contract OmniChan is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
...
uint256 public freeMaxSupply = 250;
...
constructor() ERC721A("OmniChan: Tiny Waifus", "tiny waifus") {setHiddenMetadataUri("ipfs://tyfkrz37dg4uvi7haswz5icpxlx4fi3dnyxdge5ty5qe3mltuinli0ioevm");}
