...
contract PlanetSeekers is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Planet Seekers", "PLANET") {
        setHiddenMetadataUri("https://api.planetseekers.space/");
        setBaseURI("https://api.planetseekers.space/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Planets");
    ...
    function MintFreeWL(address to, uint256 quantity)public onlyOwner{
