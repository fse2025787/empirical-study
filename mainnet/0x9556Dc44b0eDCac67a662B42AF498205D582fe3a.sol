...
contract  SpaceMonkeys is Context, IERC20, Ownable {
    ...
    string private _symbol = "SPMonkeys";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x748Ff08ff9A8dF76A9F119be77AAb3bb20b73b55));
        TITANWalletA = payable(address(0x748Ff08ff9A8dF76A9F119be77AAb3bb20b73b55));
