...
contract TurtleDoodle is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://QmNugZLEJy1vFM3BodWb9bA9Y3wX1LC4qjnHY58MoFyjyt/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("TurtleDoodle", "TD", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function FreeMint(uint256 numTokens) public payable {
        ...
        require(numTokens <= 20 && numTokens >0);
