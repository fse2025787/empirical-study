...
were an American criminal couple who traveled the Central United States with their gang during the Great Depression. 
The couple was known for their bank robberies, although they preferred to rob small stores or rural funeral homes. 
Their exploits captured the attention of the American press and its readership during what is occasionally referred to as 
the "public enemy era" between 1931 and 1934, until the couple were ambushed and shot to death in Bienville Parish, Louisiana. 
They are believed to have murdered at least nine police officers and four civilians.

Initial Tax - 4/4
1 Month Initial Lock
Ownership Renounced after Lowing the tax to 2/2

https://t.me/BonnieAndClydeportal
...
contract BonnieAndClyde is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Criminal Couple";
    string private constant _symbol = unicode"Bonnie Clyde";
    ...
    address payable private _developmentAddress = payable(0xbd6A2242621DA16772aAe57493C72162128fF6a8);
    address payable private _marketingAddress = payable(0xbd6A2242621DA16772aAe57493C72162128fF6a8);
