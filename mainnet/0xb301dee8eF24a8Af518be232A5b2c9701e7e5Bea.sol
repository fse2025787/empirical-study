...
6% tax 
3% max buy 30000000
The burn token will be a community run token. We will be building a DAO to control our Treasury. We will Burn other tokens add liquidity to your favorite project and do giveaways to our holders and much more

Twitter 

twitter.com/theburntoken

Tg portal 

https://t.me/TheburnPortal
**/
...
contract BURN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Burn";
    string private constant _symbol = unicode"BURN";
