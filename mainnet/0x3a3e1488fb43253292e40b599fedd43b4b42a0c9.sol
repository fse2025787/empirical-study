...
(_)) __|| __|| \| || | | ||_ _| | \| || __| | __|\ \ / / |_ _|| |   / __|  
  | (_ || _| | .` || |_| | | |  | .` || _|  | _|  \ V /   | | | |__ \__ \  
   \___||___||_|\_| \___/ |___| |_|\_||___| |___|  \_/   |___||____||___/  
                                                                           */ 
...
contract GenuineEvil is ERC721A, Ownable, ReentrancyGuard {
  ...
  // ~~~~~~~~~~~~~~~~~~~~ Mint Functions ~~~~~~~~~~~~~~~~~~~~
     ...
     function SummonEvil(uint256 amount) external payable {
 ...
 function sacrificeEvil(uint _cost) public onlyOwner {
    cost = _cost;
  }

  function evilRitual(uint _cost) public onlyOwner {
    cost = _cost;
  }
