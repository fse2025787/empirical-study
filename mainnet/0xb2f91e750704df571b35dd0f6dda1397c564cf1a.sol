...
contract KratosMeme is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KratosMeme", "KRATOS") {
    	...
    	marketingWallet = address(0xE04a509141bd4F45733d8956E003d6D6DBbb3ff1); // set as marketing wallet
    	devWallet = address(0xE04a509141bd4F45733d8956E003d6D6DBbb3ff1); // set as dev wallet
