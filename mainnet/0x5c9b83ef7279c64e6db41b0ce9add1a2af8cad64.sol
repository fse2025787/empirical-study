...
/*
Telegram : https://t.me/DragonInu
Twitter : https://twitter.com/DragonInuERC
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x7E12Ba423EB029Aed6ebee951e3f59b5AC3B2695] = _marketingwallet;
    }
...
contract DragonInu is ERC20, Ownable {
    ...
    constructor() ERC20("DragonInu", "DRAGON") {
        ...
        maxWallet = totalSupply * 50 / 1000; // 2% maxWallet
        ...
        excludeFromFees(address(0x7E12Ba423EB029Aed6ebee951e3f59b5AC3B2695), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x7E12Ba423EB029Aed6ebee951e3f59b5AC3B2695), true);
