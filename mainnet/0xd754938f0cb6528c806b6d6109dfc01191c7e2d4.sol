...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe002b0402cC598b4c48275F83148Ed9B6c798CFE];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 2, 1999 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qma22rKnZNMgSHD4LnUN4ACkf1H3SZeoaGHwNPU1rXsaRb/";
...
// File: contracts/Matrix1999Contract.sol
//

pragma solidity ^0.8.0;

contract Matrix1999Contract is RamppERC721A {
    constructor() RamppERC721A("Matrix 1999", "MATRIX"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/Nxv91v9hNn7rtvuGFfme/contract-metadata";
    }
}
