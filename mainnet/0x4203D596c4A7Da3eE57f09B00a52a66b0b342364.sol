...
contract UNIUNIUNI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Uni Uni Uni", unicode"ユニユニユニ") {
        ...
        marketingWallet = payable(0x1a6f61dD6B59F3D75B4fA1Ab4C204Ead4648599E);
        devWallet = payable(0x1a6f61dD6B59F3D75B4fA1Ab4C204Ead4648599E);
