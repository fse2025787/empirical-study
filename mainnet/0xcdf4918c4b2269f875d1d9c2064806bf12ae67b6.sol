...
contract THOU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "$THOU";
    string private constant _symbol = "$THOU";
    ...
    address payable private _developmentAddress = payable(0xfdF39916e50ed76E6ff2116A4b69b82f34fC2F54);
    address payable private _marketingAddress = payable(0xfdF39916e50ed76E6ff2116A4b69b82f34fC2F54);
