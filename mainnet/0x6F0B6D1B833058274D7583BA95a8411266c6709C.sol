...
// File: contracts/falconXUSDStorage.sol

// 

pragma solidity ^0.6.0;

contract falconXUSDStorage {
    /** WARNING: NEVER RE-ORDER FalconXUSDIABLES! 
    ...
    string public constant name = "FalconXUSD";
    string public constant symbol = "FalconXUSD";
...
contract LibraryLock is falconXUSDStorage {
...
contract falconXUSD is falconXUSDStorage, Context, IERC20, Proxiable, LibraryLock {	
