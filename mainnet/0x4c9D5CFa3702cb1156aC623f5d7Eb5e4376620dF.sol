...
contract Toigosdoor is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public whitelistMintRate = 0.1 ether;
    ...
    (bool success, ) = payable(0xec8493aC4cE8458C3c37248EA2843D64c0AF6dE3).call{value: address(this).balance * 75 / 100}("");
    require(success); 
        ...
        require(payable(0x2F96d71Ae6987Fde0F9BE47d0c082Fb763ACe04E).send(balance)); // Chad
    }
