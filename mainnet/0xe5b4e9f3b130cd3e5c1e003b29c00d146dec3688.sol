...
/**
* 0/0 tax after 50 buys,
*
* https://t.me/wrappedvitalik
**/
...
contract WrappedVitalik is Context, IERC20, Ownable {
    ...
    address payable private _feeAddrWallet = payable(_msgSender());

    string private constant _name = "Wrapped Vitalik";
    string private constant _symbol = "WVITALIK";
