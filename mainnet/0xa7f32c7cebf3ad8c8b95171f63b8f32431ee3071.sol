...
contract StreamClub is Context, IERC20, Ownable {

    using SafeMath for uint256;
    //naming
    string private constant _name = "Stream Club";
    string private constant _symbol = "SClub";
    ...
    address payable private _developmentAddress = payable(0x1520f05a005c3eE2e0066cf1e8B30A0B3cdEF9b1);
    address payable private _marketingAddress = payable(0x1520f05a005c3eE2e0066cf1e8B30A0B3cdEF9b1);
