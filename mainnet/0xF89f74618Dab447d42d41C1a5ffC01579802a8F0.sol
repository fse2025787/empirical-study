...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xFcDEBC61d85d6540f8158fA0353003238E5AAaE5];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 1500 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeFbn3Ejg6mjquycZTeqcsmZc9b9rx6FztWrcwwpySKxH/";
...
// File: contracts/MutantRhinoContract.sol
//

pragma solidity ^0.8.0;

contract MutantRhinoContract is RamppERC721A {
    constructor() RamppERC721A("Mutant Rhino", "RHINO"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/tanNnun4HhwnvFivE3ct/contract-metadata";
    }
}
