...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    function hasBurn(address _ad) public returns (bool){
        return _ownedBurned[_ad].length > 0;
    }
    function getBurnedToken(address _ad) public returns (uint256[] memory){
...
contract TheRoundies is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint private startSales = 1629489600; // 2021-20-08 à 20:00:00
