...
Dracarys ($DRACO) is a new ERC-20 cryptocurrency inspired by dragons. Every transaction made with Dracarys will have 3% of it burned, and 3% will be added to the liquidity pool. This will help to keep the currency stable, as well as help to grow the liquidity pool over time.

No dev or mkt taxes!

3% BURNED | 3% ADDED TO LIQUIDITY | 5B TOKENS | LIQUIDITY LOCKED

https://dracarys.wtf

https://t.me/dracaryserc

https://twitter.com/TokenDracarys
...
contract Dracarys is ERC20, Ownable {
    ...
    constructor() ERC20("Dracarys", "DRACO") {
