...
contract DogeGoldErc20 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DogeGold";
    string private constant _symbol = unicode"DEGOLD";
