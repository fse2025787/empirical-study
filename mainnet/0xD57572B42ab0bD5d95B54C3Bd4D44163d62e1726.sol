...
contract ArtmTimeLock is TokenTimelock {
    ...
    /**
     * @dev Constructs the ARTM Token Time Lock contract.
     ...
     * @param releaseTime_ is the initial date/time when the release function unlocks, releases the first tranche.
     ...
     * @param _maxTranches is the total number of tranches that represent the full vesting time for the contract.
     * @param _tranchePercent is the percentage of tokens that will be released during each tranche period.
     */
    constructor(
        IERC20 token_,
