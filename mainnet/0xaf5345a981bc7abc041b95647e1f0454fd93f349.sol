...
// File: tests/ERC20PresetMinterBurnerPauser.sol
 ...
 * roles, as well as the default admin role, which will let it grant minter, burner
 * and pauser roles to another accounts
 */
contract ERC20PresetMinterBurnerPauserUpgradeSafe is Initializable, ContextUpgradeSafe, AccessControlUpgradeSafe, ERC20BurnableUpgradeSafe, ERC20PausableUpgradeSafe {
    ...
    function initialize(string memory name, string memory symbol) public {
        __ERC20PresetMinterBurnerPauser_init(name, symbol);
    }

    function __ERC20PresetMinterBurnerPauser_init(string memory name, string memory symbol) internal initializer {
        __Context_init_unchained();
        __AccessControl_init_unchained();
        __ERC20_init_unchained(name, symbol);
        __ERC20Burnable_init_unchained();
        __Pausable_init_unchained();
        __ERC20Pausable_init_unchained();
        __ERC20PresetMinterBurnerPauser_init_unchained(name, symbol);
    }

    function __ERC20PresetMinterBurnerPauser_init_unchained(string memory name, string memory symbol) internal initializer {
    ...
    function mint(address to, uint256 amount) public returns (bool){
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20PresetMinterBurnerPauser: must have minter role to mint");
        _mint(to, amount);
        return true;
    }

    /**
     * @dev Destruct `amount` tokens from `from`.
     *
     * See {ERC20-_burn}.
     *
     * Requirements:
    ...
    function burn(address from, uint256 amount) public returns (bool){
        require(hasRole(BURNER_ROLE, _msgSender()), "ERC20PresetMinterBurnerPauser: must have burner role to burn");
        _burn(from, amount);
        return true;
    }
    ...
    function pause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC20PresetMinterBurnerPauser: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC20PresetMinterBurnerPauser: must have pauser role to unpause");
        _unpause();
    }
