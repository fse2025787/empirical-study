...
// hevm: flattened sources of /nix/store/9nsv73hmqz0jn01dv39h9cw3r2xydxb0-h2o-deploy/dapp/h2o-deploy/src/GovActions.sol
pragma solidity =0.6.7;

////// /nix/store/9nsv73hmqz0jn01dv39h9cw3r2xydxb0-h2o-deploy/dapp/h2o-deploy/src/GovActions.sol
/* pragma solidity 0.6.7; */
...
abstract contract GlobalSettlementLike_1 {
...
abstract contract DSTokenLike_1 {
...
contract GovActions {
    ...
    function shutdownSystem(address globalSettlement) public {
        GlobalSettlementLike_1(globalSettlement).shutdownSystem();
    }
    ...
    function mint(address token, address guy, uint wad) public {
        DSTokenLike_1(token).mint(guy, wad);
    }

    function burn(address token, address guy, uint wad) public {
        DSTokenLike_1(token).burn(guy, wad);
    }
