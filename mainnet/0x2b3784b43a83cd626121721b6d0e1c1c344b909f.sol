...
contract BestBuddies is ERC721Enumerable, Ownable, IERC2981, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxSupply = 1597;

    
    event NewMint(address minter, uint256 amount);
    ...
    ) ERC721("Best Buddies: Speakers Anonymous Pass", "BB") {
        tokenCounter = 0;
    ...
    function mintNFT(uint256 _mintAmount) public payable nonReentrant() {
        ...
        require(_mintAmount + mintPerWallet[msg.sender] <= maxmintAmount, "You reached your mint limit");
        ...
        emit NewMint(msg.sender, _mintAmount);
    }
    ...
    function setmintingPrice(uint256 _newPrice) public onlyOwner {
        emit PriceUpdate(mintingPrice, _newPrice);
