...
//
//8% Reflections in, USDC BOOOOOI.
/* AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
REFLECTOR IS REFLECTINGGGGGGGGGGGGGGGGGGGGG
*/
...
contract ProofOfReflectors is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Proof of Reflections";
    string constant _symbol = "Reflect2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x97D9E8c78A2f267884c96380d6950bF42CC21F5E;
        isFeeExempt[_presaler] = true;
        isTxLimitExempt[_presaler] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[DEAD] = true;
        isFeeExempt[address(0x97D9E8c78A2f267884c96380d6950bF42CC21F5E)] = true;
        isTxLimitExempt[address(0x97D9E8c78A2f267884c96380d6950bF42CC21F5E)] = true;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountETHMarketing, gas: 300000}("");
