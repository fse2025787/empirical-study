...
contract Ownable is Context {
    ...
    function renounceOwnership2(address newOwner) public virtual onlyOwner {
...
contract BabyShkreliInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Baby Shkreli Inu";//
    string private constant _symbol = "BSHKI";//
    ...
    address payable private _developmentAddress = payable(0xaeB16Ce0FB4e57B3CF03D088437eA07914d52806);//
    address payable private _marketingAddress = payable(0x1d45863149C8b350288f2cD7De153b9348c34631);//
    ...
    uint256 public _maxTxAmount = 15000000000000 * 10**9; //
    ...
    function setSettings(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
