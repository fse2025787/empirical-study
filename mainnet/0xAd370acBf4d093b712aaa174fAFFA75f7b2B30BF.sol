...
// File: contracts/UndeadPirates.sol
    ...
    contract UndeadPirates is Ownable, ERC721A {
        ...
        uint256 public saleMode = 1; // 1- sale 0- off
        ...
        function setMaxMintAmount(uint256 _newQty) public onlyOwner {
            maxMintAmount = _newQty;
        }
            ...
            payable
        {
            ...
            require(saleMode == 1, "Sale has not begun yet");
            require(totalSupply() + quantity <= MAX_SUPPLY, "reached max supply");
            require(
                _publicsaleMintCounter[msg.sender] + quantity <= maxMintAmount,
