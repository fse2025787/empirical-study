...
/*
    TG: https://t.me/ShibaStarlink
    WEB: http://shibastarlinktoken.com
    TW: https://twitter.com/ShibaStarLink
*/
...
contract ShibaStarlink is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibaStarlink";
    string private constant _symbol = "$SHIBLINK";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x07E2b5511b3a0E9a22EA675f7817936c03dfbE3B);
        _feeAddrWallet2 = payable(0xCbD86dda224AABE0b25ff0686A7adF5e88c51c60);
        _liquidityWallet = payable(0x481B4AB6E35edEF2dcd9341684EFE2E09410DE46);
