...
contract IFeltWired is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("I Felt Wired", "Wired") {
        owner = msg.sender;
        maxPerTx = 15;
        cost = 0.002 ether;
        maxSupply = 1000;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidygujp3uwquh6ow72xtj22e6mcjjfjhwfydq4xpbfddo5u4qwaly/", _toString(tokenId), ".json"));
    }
