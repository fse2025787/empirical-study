...
/**
 *
I am in limbo, and in limbo there are no races, 
no prizes, no changes, no chances. 
There are merely degrees of endurance, and endurance never was my strong point.
V O I D
*/
...
contract LIMBO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LIMBO";
    string private _symbol = "VOID";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x000000000000000000000000000000000000dEaD);
