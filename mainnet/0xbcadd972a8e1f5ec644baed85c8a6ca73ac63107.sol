...
/*
** Join Our Community : https://t.me/hopiumtokenchat
*/
...
contract Hopium is Context, IERC20, Ownable {
    ...
    uint256 private numTokensSell = 5000 * 10**6 * 10**9;
    ...
    constructor () {
        _devWalletAddress = payable(0x519327B11769F7CCF73125392eAbD530A023f451);
        _admin = _msgSender();
    ...
    function setNumTokensSell(uint256 numTokens) external onlyOwner() {
    ...
    function _transfer(
        ...
        // tokens that we need to initiate a swap lock?
        // also, don't get caught in a circular event.
    ...
    function swapAndSend(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(tokenBalance); // <-  breaks the ETH -> HATE swap when swap is triggered
