...
contract KeKers is ERC721A, Ownable, ReentrancyGuard {

    using Address for address;
    using Strings for uint256;

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmaQko1wgJ4S7puEXCX5AijS5vsj1urjLgP1pyRS54pjwR/";
    ...
    constructor() ERC721A("KeKERS", "KeK", 5) {
        
    }

    function KeK(uint256 amount) public payable nonReentrant onlySender 
    {      
