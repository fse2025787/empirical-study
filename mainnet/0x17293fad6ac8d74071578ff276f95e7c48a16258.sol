...
contract BrainDeadApe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Brain Dead Ape";
    ...
    address payable private _developmentAddress = payable(0x7162cCcbBc347F52118bC2B0bAaC91b803F0fbD2); 
    address payable private _marketingAddress = payable(0x7162cCcbBc347F52118bC2B0bAaC91b803F0fbD2);
