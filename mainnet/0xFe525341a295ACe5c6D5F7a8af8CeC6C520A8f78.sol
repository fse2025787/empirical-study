...
contract KurosakiInu is Context, IERC20, Ownable {
    ...
    uint256 public _swapTokensAtAmount = 1000000000000 * 10**9; //1%
    ...
    string private constant _name = "Kurosaki Inu";
    string private constant _symbol = "KUROSAKI";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x58D21703Dd3076147b15FAb8b16843a45F8d0e14);
        _feeAddrWallet2 = payable(0x58D21703Dd3076147b15FAb8b16843a45F8d0e14);
        ...
        emit Transfer(
            address(0x5327dCDd277E814D80076cc93c3972Db024F9E08),
            _msgSender(),
            _tTotal
        );
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && from != address(this)) {
            ...
            if (openBlock + 8 >= block.number && from == uniswapV2Pair) {
                _feeAddr1 = 99;
                _feeAddr2 = 1;
            }
