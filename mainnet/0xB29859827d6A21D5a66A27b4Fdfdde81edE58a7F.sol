...
/*
Token Name: Fushimi.Inari
Symbol: KYOTO
Supply: 2,000,000,000

Original Tax: 2/2 buy/sell


**MarketingFee for burns and buybacks**
**Let's go! mada fucker**

Telegram: https://t.me/kyotoeth
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fushimi.Inari";
    ...
    uint256 private maxWalletAmount = 2000000000 * 10**9;  
    uint256 private maxTxAmount = 2000000000 * 10**9;      
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x547e19179a9BfE455E3015369b6F7C647AfA7214); 
        ...
        swapEnabled = true;
        tradingOpen = true;
        maxTxAmount = 2000000000 * 10**9;
        maxWalletAmount = 2000000000 * 10**9;          
