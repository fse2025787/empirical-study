...
/* -------------------------------------------- 
    ...
    Twitter：https://twitter.com/SunYat_sen_ETH
...
contract SunYatsen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sun Yat-sen";
    string private _symbol = "Sun Yat-sen";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3c6F96A743955C511D0F485382ee8d5AD7269C42); 
