...
/**
$EIJIRO token is a 100% decentralized, community-focused project. Each transaction will contribute towards $EIJIRO's growth.
Telegram:https://t.me/eijirioeth
Twitter:https://twitter.com/eijiroeth
Website:https://www.eijiro.finance/
*/
...
contract EIJIRO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Eijiro", "EIJIRO") {
