...
Follow our official Twitter, all informations will be release on it ! 
...
contract HatiBurn is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"HatiBurn"; ////
    string public constant symbol = unicode"HATIBURN"; ////
