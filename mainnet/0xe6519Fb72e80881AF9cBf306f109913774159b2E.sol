...
https://mutant-ak-club.com/
https://twitter.com/MutankAKClub
...
contract Makc is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mutant Ape Kids Club";
    string private constant _symbol = "MAKC";
