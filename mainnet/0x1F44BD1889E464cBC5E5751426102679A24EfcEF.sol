...
contract FloraInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Flora Inu"; 
    string private constant _symbol = "FLORA"; 
    ...
    address payable private _developmentWalletAddress = payable(0x68893195C56f422C9Be24Bd58ff8Aea1ceB5c61f);
    address payable private _marketingWalletAddress = payable(0x68893195C56f422C9Be24Bd58ff8Aea1ceB5c61f);
