...
contract MetaAndMagic {
    ...
    */
    function getPrize(uint256 heroId_, uint256 boss_, bytes10 items_) external {
        ...
        if (prizeTokens[fh.boss] == 0xdAC17F958D2ee523a2206206994597C13D831ec7) {
            (bool succ, ) = address(0xdAC17F958D2ee523a2206206994597C13D831ec7).call(abi.encodeWithSelector(IERC20.transfer.selector, msg.sender, prizeValues[fh.boss] / boss.topScorers));
            require(succ, "tether transfer failed");
        } else {
    ...
    */
    function getRafflePrize(uint256 heroId_, uint256 boss_, bytes10 items_) external {
        ...
        if (prizeTokens[fh.boss] == 0xdAC17F958D2ee523a2206206994597C13D831ec7) {
            (bool succ, ) = address(0xdAC17F958D2ee523a2206206994597C13D831ec7).call(abi.encodeWithSelector(IERC20.transfer.selector, msg.sender, prizeValues[fh.boss]));
            require(succ, "tether transfer failed");
        } else {
