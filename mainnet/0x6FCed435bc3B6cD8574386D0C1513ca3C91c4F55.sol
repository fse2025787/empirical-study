...
$BURNIT is a hyper-deflationary token, even more deflationary than $KAMBO itself. $BURNIT is configured to burn 1% of the circulating supply ever 10 minutes, as opposed to $KAMBO, which burns every 30 minutes.

With this aggressive burning mechanism, $BURNIT will become extremely scarce, ensuring a supply-shock type even to happen.

Tokenomics

1% Burn every 10 minutes
5% Buy Tax
5% Sell Tax
Liquidity locked for 30 Days


https://t.me/burnit_portal
...
contract burnit is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x975828c3ee78419E0E48366f89e30e1BA9838ECB;
    address private feeTwo = 0x975828c3ee78419E0E48366f89e30e1BA9838ECB;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "burnit";
    string private _symbol = "BURNIT";
    ...
    uint256 public burnFrequencynMinutes = 10;  
