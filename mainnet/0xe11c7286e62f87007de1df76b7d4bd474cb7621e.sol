...
contract AllinOneAI is BEP20, Auth {
    ...
    string public constant name = "AllinOneAI";
    string public constant symbol = "AOAI";
    ...
    uint256 public _maxTxAmount = totalSupply * 1 / 50;
    uint256 public _maxWalletToken = totalSupply * 1 / 50;
