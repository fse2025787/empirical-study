...
/**
    ...
    Telegram: https://t.me/WhaleDaoPortal
*/
...
contract WhaleDao is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x41AB9e8e52BC5221089b0555C5A89C64cF376278); // Marketing Address
    address payable public multiSigAddress = payable(0x41AB9e8e52BC5221089b0555C5A89C64cF376278); // Marketing Address
    address payable public devAddress = payable(0x41AB9e8e52BC5221089b0555C5A89C64cF376278); // Dev Address
    address payable public liquidityAddress = payable(0x41AB9e8e52BC5221089b0555C5A89C64cF376278); // Liquidity Address
    ...
    string private constant _name = unicode"Whale Dao";
    string private constant _symbol = unicode"WHALEDAO";
