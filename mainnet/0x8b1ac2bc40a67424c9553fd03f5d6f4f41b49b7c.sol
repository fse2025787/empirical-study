...
░█─░█ ▀──▀ ▀───▀ ▀▀▀ ▀──▀ ▀──▀ ▀─▀▀ ▀▀▀ 　 ▄█▄ ▀──▀ ─▀▀▀
/**
*   https://twitter.com/KAMINARI_INU
*   https://www.kaminariinu.com/
*   https://kaminari-inu.medium.com/ 
*   https://t.me/kaminariinuportal
*/
...
contract KAMINARI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kaminari Inu";
    string private constant _symbol = "KAMINARI";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  7000000000  * 10**_decimals;

    uint256 public _maxTxAmount = 210000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 350000000 * 10**_decimals;
