...
contract ERC721Hut is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Mapping owner address to token counnts
    ...
    /**
     * @dev Extracts the artifactId and counter
     * that are packed into the uint256 tokenId.
     * @return (uint48 artifactId, uint48 witchId)
     */
