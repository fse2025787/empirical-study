...
Website: https://humanvoiceai.com/
TG:      https://t.me/Human_Voice_AI_Portal
Twitter: https://twitter.com/HumanVoice_AI
...
contract HumanVoiceAI is ERC20, Ownable {
    ...
    constructor() ERC20("Human Voice AI", "HVAI") {
        ...
        maxTransactionAmount = 10_000 * 1e18; // 1% max txn
        maxWallet = 10_000 * 1e18; // 1% max wallet
        ...
        mktgWallet = address(0xC9eA5B3CfF5798e31f1A3f9d20b3eC059f5fcB41); 
        devWallet = address(0x29FbcD2bDc41BFf7b0c81C26d0dD9A5847688543); 
        liqWallet = address(0x433927845A7b8E828b10aaac8DD0495b14fE15B4); 
        operationsWallet = address(0x433927845A7b8E828b10aaac8DD0495b14fE15B4);
