...
contract Naypegs is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZxDanojLvjgzhMe1gBaNdMygqh743xYH4uZpcZVshxUc";
    ...
    constructor(
    ) ERC721A("Naypegs", "NP", 100, maxSupply) {
    }
