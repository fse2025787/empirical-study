...
contract NewYorkCaresStandWithStudents is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 16160;
    uint256 public immutable supply = 16160;
    ...
    address[] public withdrawAddresses = [0x9D5025B327E6B863E5050141C987d988c07fd8B2];
    uint256[] public withdrawPercentages = [100];

    bytes32 public merkleRoot = 0x9b25ad9d10fb631dab47623eb4bff55a38e3404dd2123d85fc404f4b491e0767;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x9D5025B327E6B863E5050141C987d988c07fd8B2, _royaltyAmount);
    }
