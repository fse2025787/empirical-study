...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x307F3024541e1BB53878c3615f76cF4C6c1fa578];
  address public erc20Payable = 0x307F3024541e1BB53878c3615f76cF4C6c1fa578;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 2222) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigyuldp56oyxgakxw4abt7k5cy4tecw5t6sbsofismoyox7obwrpm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/UPZUPCYOwDF23OyfNTPo/contract-metadata";
  }
...
// File: contracts/TheGhostArmyContract.sol
//

pragma solidity ^0.8.0;

contract TheGhostArmyContract is RamppERC721A {
    constructor() RamppERC721A("The Ghost Army", "TGA"){}
}
