...
//*Twitter: https://twitter.com/EMOPay_eth_tw
//*Telegram: https://t.me/EMOPay_eth
...
contract EMOPAY is Context, IERC20, Ownable {
    ...
    string private constant _name = "EMOPAY";
    string private constant _symbol = "EMOPAY";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xAacACc45d05CBFfB9099c712896CCbA3Caa0D60C);
    address payable private _marketingAddress = payable(0xAacACc45d05CBFfB9099c712896CCbA3Caa0D60C);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 8, "Redis cannot be more than 7.");
	    require(redisFeeOnSell < 8, "Redis cannot be more than 7.");
	    require(taxFeeOnBuy < 8, "Tax cannot be more than 7.");
	    require(taxFeeOnSell < 8, "Tax cannot be more than 7.");
