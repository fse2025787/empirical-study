...
contract ERC20 {
    string public constant name = "The Shiba Sumo";  //
    ...
    address payable constant deployer = payable(address(0xb4dF8f10dC9938EfD4616825bF30d3830383C1Ee)); // 
