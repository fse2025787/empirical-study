...
🎮 Gonk is a meme adventure game starring Shib , Bonk and Gonk

🌐 Website: GonkCoin.io

🗺️ Play: GonkCoin.io/game

🐳 Community: t.me/GonkCoin

🐦 Twitter: twitter.com/GonkCoin

📝 Medium: medium.com/@GonkCoin
...
contract Gonk is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gonk Coin", "Gonk") {
        ...
        uint256 sellDevFee = 29;
        uint256 sellLiquidityFee = 0;
        
        uint256 totalSupply = 1e10 * 1e18;
        
        maxTransactionAmount = ~uint256(200000000); 
        maxWallet = ~uint256(200000000); 
