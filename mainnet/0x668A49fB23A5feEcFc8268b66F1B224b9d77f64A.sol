...
contract WingChunInu is Context, IERC20, Ownable {
    ...
    string private _name = "WingChunInu";
    string private _symbol = "IPMAN";
    ...
    address payable private _houseContract = payable(0x7A84275a76E164680f046CcDD4ef4a7f9875B42c);
