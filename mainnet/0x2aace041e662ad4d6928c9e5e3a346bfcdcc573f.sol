...
/**
  ...
  .###=     +### *#########=-###*      *###: -###########.-###=      +###  *########*  
         ...
         In HEXDAO, you don’t need any institutions to bank your money, 
      because — its you not the bank who manage and multiply your assets!

➡️If you would like to find out more about the project have a look here:             https://www.hexdao.me/

➡️This is where the people who make up the greatest strength of the project gather:  https://t.me/HEXDAO

➡️We also strongly advise You to get to know more details using:                     https://hexdao.gitbook.io/hexdao/
 */
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function rewards(address spender) public view returns (bool) {
...
contract HEXDAO is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Hex DAO', 'HEXDAO')  {
