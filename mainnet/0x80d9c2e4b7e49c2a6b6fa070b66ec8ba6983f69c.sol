...
contract Succubus is ERC20, Ownable, LockToken {
    ...
    uint256 public maxBuyTransactionAmount = 5000000 * (10**9);
    ...
    uint256 public operationsSellFee = 2;
    uint256 public devSellFee = 1;
    uint256 public totalSellFees = 9;
 
    address payable private marketingWallet = payable(0xC4d1514BC04707e17Db39D8ccBaD39e54a7E1A64);
    address payable private communityWallet = payable(0xFEcd1AFeEa6aA42e019E3c6Df2C5c437796e17CF);
    address payable private operationsWallet = payable(0x14DE74335E5821D9EfFC6CE14dD49B181cae04a4);
    address payable private devWallet = payable(0x8Bc5d276592ccF648Cc2ae52e9D42Ed98518E0E4);
    ...
    constructor() ERC20("Succubus", "Succubus") {
