...
contract ChiefTwit is ERC20, Ownable {
    ...
    constructor() payable ERC20("Chief Twit", "CTWIT") {
        ...
        maxBuyAmount = (totalSupply * 3) / 1000; // 0.3%
        ...
        operationsAddress1 = address(0x263F2307a50a412B3f671E8dCC026d87A216bBbF);
        lpReceiverAddress = address(0xdead);
