...
// File: contracts/WnwaVerification.sol
...
contract WnwaNFT is ERC721Enumerable, Ownable {
	...
	function mint(address _to, uint16 _count) external payable {
		...
		require(maxTokens - this.totalSupply() >= _count, "Mint capacity reached");
	...
	function contractURI() public pure returns (string memory) {
		return "ipfs://bafkreic7o7b6uak32jmuslw6v6rp2evribyrkv3uqg2pzk4kw34hn3clhi";
	}
