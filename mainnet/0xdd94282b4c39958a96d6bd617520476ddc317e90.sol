 ...
 *                                     \/____/                                  \/____/         
 * gATE | gATE
 * supply: 1.000.000.000.000 (50% burned at launch) 
 * Max Trx: 0.5%
 * Maxwallet: 2%
 * Tax Buy: 5%
 * Tax Sell: 5%
 * LOCK & RENOUNCED
 * 100% SAFE PLAY
 * https://medium.com/@THEGATE1/the-gate-e235be7dd4d2
 * https://twitter.com/Erc20Gate
 * THE gATE WILL BE OPEN SOON!!! OUR TG WILL BE ANNOUNCED ON https://medium.com/@THEGATE1
...
contract gATE is Context, IERC20, Ownable {
    ...
    string private constant _name = "gATE";
    ...
    address payable private _developmentAddress = payable(0x9de920605F518CB601764AbDB6Cd3B328Ca1FD46);
    address payable private _marketingAddress = payable(0xF003181C1743A6b6f9320791b617f4D514F649E5);
    ...
    uint256 public _swapTokensAtAmount = _tTotal.mul(2).div(10000);
