...
/**
 * This ICO Solution was made by ZiLab Technologies.
 * Web: www.zilab.co
 ...
 */
 ...
 contract IWFYCSale is OwnerWithdrawable {
     using SafeMath for uint256;
     ...
     modifier saleEnded(){
         if(preSaleEndTime != 0){
             require(block.timestamp < preSaleEndTime, "PreSale: Sale has already ended. Cannot change Sale Params!");
         }
         _;
     }
