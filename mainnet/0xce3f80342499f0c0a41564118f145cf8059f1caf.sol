...
// Main Contract Logic 
// --------------------------------------------------------------
contract MafiaInu is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Mafia Inu";
    string private _symbol = "MAFIA";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xa70be5eA15Ae80d13E038F7a5E1a56Fa3a78a4E9);
    address payable public operationsWallet =  payable(0xa70be5eA15Ae80d13E038F7a5E1a56Fa3a78a4E9);
