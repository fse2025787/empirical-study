...
contract TheSCIENTISTS is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0.0007 ether;
    uint256 public maxMints = 1111;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidij7pp4cshaiidlxhzol22xuxroupj4cbn75oqnybt3ggvfccm4a/", Strings.toString(tokenId), ".json")
            );
    }
