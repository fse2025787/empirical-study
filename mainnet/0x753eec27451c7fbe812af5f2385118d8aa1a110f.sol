...
//Relaunched Under DevelopereUnited."Bringing Clarity, Honesty & Development To The DeFi Space

//Telegram: @shibaiv2portal
//DevelopersUnited: @Developersunitedportal
//Developersunitedwebsite: Developersunited.org
...
contract ShibAiV2 is Context, IERC20, Ownable {
    ...
    string private _name = "ShibAiV2";
    string private _symbol = "SHIBAIV2";
    ...
    uint256 public _marketingFee = 7; // All taxes are divided by 100 for more accuracy.Back End Bot Will Split Amounts Daily Keeping Gas Fees Low For Investors
    uint256 private _previousMarketingFee = _marketingFee;    

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    address public burnAddress = 0xc53Ac0167c42DDb1feAF6b3e67a1dE67Bc6D1E9a;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 2000000 , "Swap Threshold Amount cannot be less than 2000000 tokens");
