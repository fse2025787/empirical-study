...
Elon fancies Meme Tennis. Degens fancy INUs.

We bring you $TENNINU, the so loved INUs in crypto space playing Tennis.
...
contract TENNINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tennis Inu";
    string private constant _symbol = unicode"TENNINU";
