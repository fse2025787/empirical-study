 ...
 * @notice This contract handles minting SBT tokens.
 */
contract SBT is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x2Bb8Fc89eCAa87c57a0AAE5b4259445a39392019;
    // Used to allow transferring soulbound tokens with admin privileges
    address public soulboundAdminAddress =
        0x2Bb8Fc89eCAa87c57a0AAE5b4259445a39392019;
    ...
    uint256 public publicMintsAllowedPerTransaction = 1000000000;
    ...
    constructor(address _blocklistContractAddress) ERC721A("SBT", "SBT") {
