...
Way forward:
* Release KIYA SWAP at 150K MC
* Build/Release KIYA LOCKER at 350K MC
...
contract KIYA is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "KIYA";
    string private constant _symbol = unicode"$KIYA";
