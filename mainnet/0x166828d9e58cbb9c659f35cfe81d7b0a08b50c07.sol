...
contract PresaleBEP20 is Ownable {
    ...
    uint256 public softCapEthAmount = 60 ether;
    uint256 public hardCapEthAmount = 100 ether;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = 0.025 ether;
    uint256 public maximumDepositEthAmount = 10 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x8c131C03F54f6e4B59A0B6Faf182D7a4975E5f23;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(2 days  + 6 hours + 30 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0025 ether; // 400 tokens per ETH
