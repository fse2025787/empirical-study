...
/**
We not bitcoin, neither are we someone, we just another place, a descentralised one, for you nomad degens to pass by
*/
...
contract NOMAD is ERC20, Ownable {
    ...
    constructor() ERC20("The Nomad", "Nomad") {
