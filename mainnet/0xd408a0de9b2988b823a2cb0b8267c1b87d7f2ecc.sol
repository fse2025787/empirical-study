...
//TELEGRAM : https://t.me/elon_ape
//Twitter: https://twitter.com/elonape9
...
contract ElonApe is Context, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    ...
    constructor(uint256 initialSupply, address reflectionToken, address routerAddress, address initialHldAdmin) {
        ...
        _maxTxAmount = initialSupply * 1 / 10;
        _walletMax = initialSupply * 1 / 10;
