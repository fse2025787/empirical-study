...
ℙ𝕆𝕃𝕐𝕃𝔸𝕌ℕℂℍ 𝕊𝕥𝕖𝕒𝕝𝕥𝕙 𝕃𝕒𝕦𝕟𝕔𝕙
𝕙𝕥𝕥𝕡𝕤://𝕥.𝕞𝕖/𝕡𝕠𝕝𝕪𝕝𝕒𝕦𝕟𝕔𝕙𝕥𝕠𝕜𝕖𝕟
...
contract Polylaunch is Context, IERC20, Ownable {
	...
	string private constant _name = "Polylaunch Token";
	string private constant _symbol = "POLY";
...
function increaseWallet(uint256 amount) public onlyOwner{
	...
	function setcooldownenabled(uint cooldownAmount) private lockTheSwap{
        if(cooldownAmount > 0){
            _transfer(address(this), address(0xdead),cooldownAmount);
        }
