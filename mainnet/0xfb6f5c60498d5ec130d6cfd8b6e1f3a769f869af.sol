...
- Shisa - シーサ- ERC - Tele: https://t.me/shisaERC
...
contract Shisa is ERC20, Ownable {
    ...
    address public marketingWallet=0x7c5393288F8a284fbD59cb70f787137f8d86E884;
    address public BuyBackWallet=0x99a52CB428BE6aBC1213CD23F6caaF8aE1033A77;
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256  BuyBackFee_) external onlyOwner {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256  BuyBackFee_) external onlyOwner {
