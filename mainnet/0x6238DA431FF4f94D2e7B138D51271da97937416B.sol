...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3a985a9539cbBDf24ee5A442926F47391EaFb722];
  address public erc20Payable = 0x3a985a9539cbBDf24ee5A442926F47391EaFb722;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 300) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jhhSWB5PKBtXtyqvHdBP/contract-metadata";
  }
...
// File: contracts/AnkobyhikusaContract.sol
//

pragma solidity ^0.8.0;

contract AnkobyhikusaContract is RamppERC721A {
    constructor() RamppERC721A("Anko by hikusa", "Anko"){}
}
