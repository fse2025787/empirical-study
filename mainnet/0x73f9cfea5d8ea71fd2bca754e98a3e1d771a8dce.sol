...
contract CryptoeGalaxy is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
// Set team addresses
  ...
  function withdraw() public payable onlyOwner { 
    ...
    require(payable(a1).send(percent * 45));
    require(payable(a2).send(percent * 45));
    require(payable(a3).send(percent * 10)); //Charity
    }
  }
}