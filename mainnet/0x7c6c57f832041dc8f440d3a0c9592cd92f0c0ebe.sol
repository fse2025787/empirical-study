...
contract RichestInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "RichestInu";
    ...
    uint256 public _liquidityFee = 9; // means 5% add liquidity on each buy and sell
    uint256 public _burnFee = 0; // means 3% it menas burn 3%
    
    
    address liquidityWallet=0x24E405ff1675E1EdDD52B5a08b7f7e525E8E87fd;
