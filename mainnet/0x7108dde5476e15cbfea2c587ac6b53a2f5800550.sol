...
時間の始まりの前に、すべての始まりの前に、始まりがある前に…
Website: obaketoken.co
Twitter: ObakeToken
Telegram: t.me/ObakePort
*/
...
contract Obake is ERC20, Ownable {
    ...
    constructor() ERC20("Obake ", "Obake") {
        ...
        devWallet = address(0x54B35d243344a730D38FFB8cA0E8e0B3fA0e0634); // set as dev wallet
