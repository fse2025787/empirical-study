...
contract TestApeBoss is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    address private _mechaMonkeyContract;
    uint   private _totalStake;
    bool   public JimmyTrialPhase = false; // Key owners reveal 
    ...
    constructor() ERC721A("Test Ape Boss", "TAB") {}
