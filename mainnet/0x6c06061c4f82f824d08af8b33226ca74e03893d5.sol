...
contract HAKU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ōhara Yūgaku";
    ...
    address payable private _developmentAddress = payable(0xd28BB12D2D739bcFF986454dA4F004f643218a0F);
    address payable private _marketingAddress = payable(0xd28BB12D2D739bcFF986454dA4F004f643218a0F);
