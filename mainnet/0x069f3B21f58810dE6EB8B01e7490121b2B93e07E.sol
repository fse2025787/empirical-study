...
contract MetaNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "MetaNetwork";
    string private _symbol = "MetaN";
    ...
    address payable private _devWallet = payable(0x51C912F634b4A32A79734B40b26fDcAAE584e7B4);
