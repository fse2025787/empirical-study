...
/**
      President Biden says he will "VETO" House Republican bill that would abolish the IRS and eliminate income tax.
*/
...
contract VetoProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Veto Protocol";
    string private constant _symbol = unicode"VETO";
