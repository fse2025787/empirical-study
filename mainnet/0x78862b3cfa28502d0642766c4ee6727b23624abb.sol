...
/*
Lit Capital from the makers of getlit.wtf
*/
// 
...
contract LITCAPITAL is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "Lit Capital";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xaC8907adDB65844778A66Ebd40adb490b1c2f6EE);
        _feeAddrWallet2 = payable(0xaC8907adDB65844778A66Ebd40adb490b1c2f6EE);
        ...
        emit Transfer(address(0xC5b3D3231001a776123194Cf1290068e8b0C783b), _msgSender(), _tTotal);
    }
