...
contract SHOSU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SHIBABOSU", "SHOSU") {
        ...
        marketingWallet = address(0xD1B288b0820e1dDb73a554ae0749AeF926D5DEf6); // set as marketing wallet
        devWallet = address(0xD1B288b0820e1dDb73a554ae0749AeF926D5DEf6); // set as dev wallet
