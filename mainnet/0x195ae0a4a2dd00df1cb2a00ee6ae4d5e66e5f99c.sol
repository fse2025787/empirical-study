...
/*
     ...
     The Tsuka Protocol (DEJITARU)

    Burning LP and renouncing.
    0/0 Tax

    TG and more will be revealed 11:00 UTC
*/
...
contract TheTsukaProtocol is IERC20, Ownable {
    ...
    string constant _name = "The Tsuka Protocol";
    string constant _symbol = "DEJITARU";
