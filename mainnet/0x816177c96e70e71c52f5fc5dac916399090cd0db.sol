...
/**
    Life is a complete cycle. This Halloween explore the branches of life to find out what lies beneath

    https://twitter.com/treeoflifedao/
    https://t.me/TreeOfLifeOfficial
    https://medium.com/@TreeofLifeEth
*/
...
contract TreeOfLife is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tree of Life", "LIFE") {
        ...
        marketingWallet = address(0x50f3305F2854398cF1397B4A7Bb3584686A25B73); // set as marketing wallet
        devWallet = address(0x50f3305F2854398cF1397B4A7Bb3584686A25B73); // set as dev wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellDevFee) external onlyOwner {
        ...
        require(earlySellTotalFees <= 95, "must keep fees at 95% or less");
    }
