...
contract  Tsyrant is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "Tyrant Tsuka";
    string private _symbol = "$Tsyrant";
    ...
    constructor () {
        ...
        SLNA = payable(address(0xaa266D1F1307575eAfF10d1E9090230c0750B5f7));
