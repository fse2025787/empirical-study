...
contract TsukaFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Tsuka Finance";
    string private _symbol = "TsukaFI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x91A2684EEa6bfbF5332125451723fA82911B4986);
    address payable private taxWallet2 = payable(0x91A2684EEa6bfbF5332125451723fA82911B4986);
