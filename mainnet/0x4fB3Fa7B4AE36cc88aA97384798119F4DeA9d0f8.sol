...
Al Dragon will help traders make decisions whether to buy a particular token or not by using the AID Blockchain tracker bot. 
This will work by the bot checking the wallets of the first/early buyers of the token to see if they are connected to pump and dump projects or if they are suspicious new wallets with airdropped tokens. 
It will give you a good insight of what is going on behind the scenes of the blockchain, without you wasting time tracking on etherscan
...
contract AiDragonErc is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AI DRAGON", "AID") {
        ...
        marketingWallet = address(0x495db0b2066af3E05571Ff40Bec931f62ec2Ef5f); // set as marketing wallet
        devWallet = address(0x495db0b2066af3E05571Ff40Bec931f62ec2Ef5f); // set as dev wallet
