...
Stealth Launched Fanin Inu by....
I WANT STRONG COMMUNITY ON FANIN. SO TAKE THIS TO $200K MARKET CAP MINIMUM. AFTERWARDS IM GONNA SENT SPECIFIC AMOUNT OF ETH TO FROM MY OWN WALLET WHERE IS MY LAST PROJECT REVEALED AND READY BLAST OFF 🧨🧨🧨

Telegram : https://t.me/FANININU
...
contract FANININU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FANIN INU";
    string private _symbol = "FANIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6a0edb400185842Aa3A3deB1DC2784CA3EFDB36c); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6a0edb400185842Aa3A3deB1DC2784CA3EFDB36c); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000 * 10**6 * 10**2;
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**2;
    uint256 public _walletMax = 1000 * 10**6 * 10**2;
    uint256 private minimumTokensBeforeSwap = 25000 * 10**2; 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000 * 10**6 * 10**2), "Max wallet should be less or euqal to 100% totalSupply");
