...
// Inspired by By Frens For Frens we are launching By Frends For Apes

// This will be the next big meme coin 0% tax chat will be muted 

// While we are preparing all the links lock renounce and we will add bobby

// Telegram : https://t.me/ByFrendsForApes
...
contract ByFrendsForApes is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "By Frends For Apes";
    string private constant _symbol = "BAPES";
    ...
    address payable private _marketingAddress = payable(0x3E21bc75402bC4c3162177b8E53C1632d999E30F);
    ...
    uint256 public _maxWalletSize = 9000000000 * 10**9;
    uint256 public _swapTokensAtAmount = 9000000000 * 10**9;
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _marketingAddress);
        require (maxWalletSize > 9000000000 * 10**9);
