...
// Symbol        : DSI
// Name          : CaptainShiba
// 2% Tax, 2% Redistributed, 50% Total Supply Burned
...
contract CaptainShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'CaptainShiba';
    string private _symbol = 'CPSHIB';
    ...
    _isExcluded[address(0x00000000b7ca7E12DCC72290d1FE47b2EF14c607)] = true;
    _excluded.push(address(0x00000000b7ca7E12DCC72290d1FE47b2EF14c607));
    ...
    _isExcluded[address(0x7C9F6b5707FA8177984DFdc99d31CED563671f83)] = true;
    _excluded.push(address(0x7C9F6b5707FA8177984DFdc99d31CED563671f83));
    }
