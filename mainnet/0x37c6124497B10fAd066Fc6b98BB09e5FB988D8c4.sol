...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664244000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x42E578CdBF14860254F37f3f4D6a42198A6FcC40];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x42E578CdBF14860254F37f3f4D6a42198A6FcC40;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 18, 25) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiginmjmrje4qvzgpsm6m6xnc63i34njyy2racuoh4ajhhg7opxqtu/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 25");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 25");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 25");
...
// File: contracts/WaitingGamesContract.sol
//

pragma solidity ^0.8.0;

contract WaitingGamesContract is RamppERC721A {
    constructor() RamppERC721A("Waiting Games", "Flood"){}
}
