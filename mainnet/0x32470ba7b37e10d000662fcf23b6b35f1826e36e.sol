...
/**
 * @title create ENTERSIX token
*/

contract ETS is StandardToken {
    string public constant name = "ENTERSIX"; // solium-disable-line uppercase
    string public constant symbol = "ETS"; // solium-disable-line uppercase
