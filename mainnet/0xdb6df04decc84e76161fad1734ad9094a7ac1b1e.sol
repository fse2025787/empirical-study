...
contract IntoMagick is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public mintSupply = 3333;
    uint256 public MAX_MINTS = 1;
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("Into the Magick Woods", "IMAGICK") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "Time is of the Essence!");
        require(qty <= MAX_MINTS, "The Law Forbids it!");
        require(totalSupply() + qty <= mintSupply,"All Entities minted!");
        require(msg.value >= qty * price,"Need More Funds.");
