...
/*
Token features:
8% redistribution to all holders
2% fee on all transactions to the marketing wallet 
5% fee on sell transactions to the marketing wallet
*/
...
contract SpaceCoookie is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x81f3c700C994a8A0b13bAe5cE79C1aBFCcA6C402); // marketing wallet
