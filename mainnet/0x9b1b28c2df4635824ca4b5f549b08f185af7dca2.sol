...
contract GoesUpHigherClassic is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Goes Up Higher Classic", "c.GUH") {
        ...
        uint256 _sellBurnFee = 500;
        uint256 _sellDevFee = 1000;
