...
contract OpenTermLoan is BaseLoan {
    ...
    // This function gets called whenever the borrower withdraws funds from this contract.
    function _beforeBorrowerWithdrawal (uint256) internal override {
    ...
    function _updateMinimumPaymentAmount () private {
        uint256 maxAmount = getPaymentAmount();
        uint256 minAmount = _loanAmountInPrincipalTokens * minPaymentPercent / 1e4;
        minimumPaymentAmount = (minAmount > maxAmount) ? maxAmount : minAmount;
    }
