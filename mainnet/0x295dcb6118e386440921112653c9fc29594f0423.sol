...
https://twitter.com/elonmusk/status/1583978878305173505?s=20&t=wFI8tsxNBul084l3j02grQ


Cypto is full of bigots and racism. 

We are all inclusive - all are welcome. 

We have one goal and we work together to achieve it.

Change is coming, it's time to create a movement. 

Let's celebrate this occasion and embrace all cultures.

Diwali symbolizes the spiritual "victory of light over darkness, good over evil, and knowledge over ignorance"

Happy Diwali!

https://t.me/diwaliprotocol

Contract will be renounced and LP will be locked for 1 month initially - it will be extended and never be less than 2 weeks.

Taxed liquidity will continually be relocked as it accrues.

Tax is set to be low and designed to support the longetivity of the project with a marketing fund growing to support long term activities such as listings.
...
contract DiwaliProtocol is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Diwali Protocol';
    string private constant _symbol = '$DIPRO';
    ...
    uint256 swapTimes;
    bool swapping; 
    uint256 swapThreshold = ( _totalSupply * 700 ) / 100000;
    uint256 _minTokenAmount = ( _totalSupply * 15 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address public constant liquidity_receiver = 0xa8a80A4E5A2099C015C29eF22C890FC7624Ba1C3; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0xF5a30bf5Af81f53618aF02468dA62940BBfe7C02;
