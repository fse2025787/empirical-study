...
https://t.me/ShugoshaOmukade
https://medium.com/@ShugoshaOmukade/a-new-yokai-wave-is-about-to-begin-on-erc20-3d2ff1b787fb
...
contract ShugoshaOmukade is Context, IERC20 { 
    ...
    address payable public Cam_Wallet = payable(0x0d9163Da46e47c263b8237C7cD4FD168F963150C); 
    address payable public Dev_Wallet = payable(0xAEE59D651A636DB978225830785Bf7323D67dBd1);
    ...
    string private constant _name = unicode"Shugosha Omukade"; 
    string private constant _symbol = unicode"$OMU";

    bool public swapAndLiquEnabled = true;
    bool public swapEqualLiq = false;

    uint8 private txCount = 0;
    uint8 private swapDrigger = 28;
    ...
    uint256 public _maxTxAmount = _dTotal * 10 / 100; 
    ...
    constructor () {
        ...
        _owner = 0xAEE59D651A636DB978225830785Bf7323D67dBd1;
