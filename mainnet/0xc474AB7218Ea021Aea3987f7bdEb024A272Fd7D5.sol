...
//  \  $$$/  | $$      | $$  \ $$   | $$            | $$  | $$  | $$| $$\  $$ | $$      | $$\  $$$
//   \  $/   | $$$$$$$$| $$  | $$   | $$            | $$  |  $$$$$$/| $$ \  $$| $$$$$$$$| $$ \  $$
//   \_/    |________/|__/  |__/   |__/            |__/   \______/ |__/  \__/|________/|__/  \__/
//
// https://verticaltoken.dev
//
...
contract Vert is ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint256 public startPrice = 800000;
    ...
    constructor(
    ...
    ) public ERC20("Verticaltoken.dev", "VERT") {
        ...
        uniswapPairPath[1] = _uniswapV2Router.WETH();
        
        _mint(_msgSender(), 10e24);
    }
    ...
    function _transfer(
        ...
        if(from != uniWethPool)
            require(!blacklist[to] && !blacklist[from], 'Vert: the transaction was blocked.');
    ...
    function getLastPrice() public view returns (uint256) {
        return uniswapV2Router.getAmountsIn(1, uniswapPairPath)[0];
    }
