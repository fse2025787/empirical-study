...
contract JennieKimDao is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("JennieKimDao", "JENNIE", 100, maxSupply) {
    }
    ...
    // Disable gasless listing function for security measurement (if opensea ever shut down or is compromised)
