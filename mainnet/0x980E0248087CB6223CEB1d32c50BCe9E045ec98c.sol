...
// 
/**
░S░A░F░E░M░O░O░N░ ░E░T░H░
SAFEMOON ETH ($SFMETH): The First TRULY Decentralized Meme Protocol!

We are setting out to create new mechanisms that come together to form a decentralized meme protocol.
The $SFMETH token has some of the most desirable yet sustainable tokenomics in the space, and will be used as base currency alongside ETH on our platform.
*/

// https://t.me/SafeMoonETH 

// https://SFMETH.pro (Official Website)

// https;//telegram.me/SafemoonETH
...
contract SafeMoonETH is BEP20, Auth {
    ...
    string public constant name = "SafeMoon ETH";
    string public constant symbol = "$SFMETH";
    uint8 public constant decimals = 8;

    uint256 public constant totalSupply = 1 * 10**12 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 200;
    uint256 public _maxWalletToken = totalSupply / 500;
    ...
    address public RewardToken = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    ...
    uint256 public swapThreshold = totalSupply / 3000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDB4f068d4B47e8a6FE5AF5B866D183E33F02724C;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0xDB4f068d4B47e8a6FE5AF5B866D183E33F02724C;
        devFeeReceiver = 0xDB4f068d4B47e8a6FE5AF5B866D183E33F02724C;
