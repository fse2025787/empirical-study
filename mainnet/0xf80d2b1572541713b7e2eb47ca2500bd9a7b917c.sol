...
contract NEOSTACKEY is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("NEO STACKEY", "NEO STACKEY")
    {
        baseURI = _baseURI;
