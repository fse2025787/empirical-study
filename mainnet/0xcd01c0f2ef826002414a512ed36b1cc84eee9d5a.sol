...
/**
* いくつかのおいしいタコノミクスを備えたERC-20トークンとしてラップされ、ブロックチェーンで最もおいしいプロジェクトをお届けします。
* $ BONEINUに参加して、世界のトップタコスマスターへの使命を持った夢のある未知のシェフからの旅に出かけましょう。
* BONEINU の名声が高まり、より多くのホドラーが彼の旅に参加するにつれて、報酬を獲得します。
* Bone Inuがグローバル化するにつれ、スリル満点の冒険に備えましょう。 できる限り、デジタルタコスを手に入れましょう。 サプライヤーは限られており、価格は急速に上昇します。
* 🚫プレセール、チーム、開発者。 100％コミュニティトークンです！ イーロンマスクの衛星のように、私たちはボーンイヌを横切って他の銀河に飛んでいきます🚀
* UniSwap $ BONEINUでのフェアローンチ🚀🚀
*/
...
contract BONEINU is Context, IERC20, Ownable {
    ...
    string private _name = 'ボーンイヌコイン';
    string private _symbol = 'BONEINU';
