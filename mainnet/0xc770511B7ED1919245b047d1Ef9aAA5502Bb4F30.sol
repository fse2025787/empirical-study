...
// Welcome to Shinemoon 🌕! 
// ShineMoon is Fair launched DeFi Token, the team has focused its efforts on giving back to the community through engaging in long-term hold semantics that encourages holding, feeds liquidity, and reflect unto the community as a whole.

// ✅ Useful links:
// ✅ Telegram: https://t.me/shinemoon_token
// ✅ Website: https://shinemoon.in/
...
contract ShineMoon is Context, IERC20, Ownable {
    ...
    string private _name = 'shinemoon.in';
    string private _symbol = 'ShineMoon';
