...
contract MiniCyborgs is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public maxFreeMintAmount = 0;
  ...
  function withdraw() public onlyOwner nonReentrant {
    uint256 artistPayment = address(this).balance * 100 / 100;

    (bool artistSuccess, ) = payable(0xa623Cc859981fF3d6C9DDb8cCD07Ba218dC13B3f).call{value: artistPayment}('');
