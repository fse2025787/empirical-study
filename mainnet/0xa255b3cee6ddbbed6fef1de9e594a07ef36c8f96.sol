...
contract NFTYearbookMintpasses is ERC721A, Ownable, ReentrancyGuard{
...
// ================== Variables Start =======================
  ...
  string public hiddenMetadataUri = "ipfs://bafybeifp2f46h4dcvy2ptnwqy52jy7dhq5pyhubw2mxzzpqzyqr6aqivsq/Hidden.json";
  ...
  uint256 public usdcprice = 190000000;
  uint256 public usdcwlprice = 190000000;  
  
  // supply - replace it with yours
  uint256 public supplyLimit = 25;
  uint256 public wlsupplyLimit = 25;
  ...
  uint256 public wlmaxLimitPerWallet = 25;
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("The NFT Yearbook Mintpass", "NFTYM")  {
    seturi(_uri);
  }
