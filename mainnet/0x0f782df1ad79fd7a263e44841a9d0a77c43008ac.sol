...
contract Yuuki is ERC20, Ownable {
    ...
    bool private highSellTaxInEffect = true;
    ...
    event HighSellTaxDisabledForever();
    ...
    constructor() payable ERC20("Yuuki", "YUUKI") {
        ...
        originalSellDevFee = 3;

        // Extra high sell tax. Once disabled, it cant be reenabled
        sellOperationsFee = 10;
        sellLiquidityFee = 10;
        sellDevFee = 10;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee;

        operationsAddress = address(0x965404De106BC40162c28257682B3C0bb36dA746);
        devAddress = address(0xB0D6010a4a49034180f6eCCCab032aC670c39c21);
        ...
        _createInitialSupply(address(0xdead), (totalSupply * 99) / 100); // Burn
        _createInitialSupply(address(this), (totalSupply * 1) / 100); // Tokens for liquidity
    ...
    function disableHighSellTaxForever() external onlyOwner {
        require(
            highSellTaxInEffect,
            "High sell tax already disabled forever ser!"
        );

        highSellTaxInEffect = false;
        ...
        emit HighSellTaxDisabledForever();
    }
    ...
    function vamos(uint256 blocksForPenalty) external onlyOwner {
