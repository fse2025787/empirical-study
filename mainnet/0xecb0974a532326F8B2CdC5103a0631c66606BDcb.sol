...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  ███  ▀██  ██     ██   ██   ██    ██  ▄██    ██  ▄█▀   ██ ██▀ ▀▀   ▄█▀   ██ ██   ██    ██  
     ...
     ▀▀██▄  ██    ▄██   ██   ██    ██  ▀██    ██  ██▄    ▄ ██     ▄▄██▄    ▄ ██   ██    ██  
        ████████████████▀██▄████  ████▄ ▀████▀███▄ ▀█████▀████▄   ██ ▀█████▀ ▀███████  ████▄
 ███  ▄█▀                                                                                             
  █████▀    ▌║█║▌│║▌│║▌║▌█║ subdomains; inspired by pcc.eth & @hodl_pcc ▌│║▌║▌│║║▌█║▌║█   
 
              ✴.·´¯`·.·★ 𝓢𝓹𝓮𝓬𝓲𝓪𝓵 𝓽𝓱𝓪𝓷𝓴𝓼 𝓽𝓸 @𝓯𝓾𝓽𝓾𝓻𝓮𝓯𝓸𝓻𝓫𝓮𝓼 &  ★·.·`¯´·.✴
...
contract EnsMapper is Ownable {
    ...
    string public domainLabel = "3lander";
    ...
    constructor(){
        ...
        nft = IERC721Enumerable(0xb4d06d46A8285F4EC79Fd294F78a881799d8cEd9);
   ...
   function getTokenDomain(uint256 token_id) private view returns(string memory uri){
    ...
    function setDomain(string calldata _label, uint256 token_id) public isAuthorised(token_id) {     
        ...
        string memory label = lower(_label);
        bytes32 encoded_label = keccak256(abi.encodePacked(label));
        bytes32 big_hash = keccak256(abi.encodePacked(domainHash, encoded_label));
