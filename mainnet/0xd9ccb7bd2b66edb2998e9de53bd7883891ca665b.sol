...
contract sManifestERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Manifest", "sMNFST", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMNFST supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMNFST
