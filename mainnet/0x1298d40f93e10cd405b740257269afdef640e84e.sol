...
/**
    ...
    Telegram: https://t.me/real_shibacapital
    
    Twitter : https://twitter.com/capital_shiba

    Website: https://shibacapital.investments/
*/
...
contract ShibaCapital is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69420000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public cliffWallet;
    ...
    uint256 public _cliffFee = 2;
    uint256 private _previousCliffFee = _cliffFee;

    uint256 public _treasuryBuyFee = 7;
    uint256 private _previousTreasuryBuyFee = _treasuryBuyFee;

    uint256 public _treasurySellFee = 11;
    uint256 private _previousTreasurySellFee = _treasurySellFee;
    ...
    uint256 public _maxTxAmount = 69420000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 1000000000000000000000000 * 10**9;
    ...
    function setCliffWallet(address cliffAddress) public onlyOwner {
        cliffWallet = cliffAddress;
    }    
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 69420000000000000000000000 * 10**9;
    }
