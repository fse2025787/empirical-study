...
// File: contracts/interfaces/IAstroFiLottery.sol

pragma solidity ^0.8.4;

interface IAstroFiLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in AFI per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in AFI token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInAfi: price of a ticket in AFI
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the AstroFi Lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == astroFiLottery, "Only AstroFiLottery");
    ...
    /**
     * @notice Set the address for the AstroFi Lottery
     * @param _astroFiLottery: address of the AstroFi lottery
     */
    function setLotteryAddress(address _astroFiLottery) external onlyOwner {
        astroFiLottery = _astroFiLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAstroFiLottery(astroFiLottery).viewCurrentLotteryId();
    }
}