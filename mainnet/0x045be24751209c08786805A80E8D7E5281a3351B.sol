...
/**
        Koharu Inu is a deflationary reflective farming protocol.
        This allows holders of $KoharuInu to get more by just holding,
        this is similar to the idea of auto-compound farming and frictionless
        farming provides more incentive to hold the token.
        As an intergalactic $KoharuInu holder, static reflection will grow your share of $KoharuInu tokens indefinitely. 

        https://koharuinu.gitbook.io/koharu-inu/

        https://www.koharuinu.com/

        https://twitter.com/koharuinuerc

        https://t.me/KoharuInuERC20
*/
...
contract KoharuInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4910FAD0545d04cFfDFC6144beea5540FFaB173d); 
    address payable public Wallet_Dev = payable(0x4910FAD0545d04cFfDFC6144beea5540FFaB173d);
    ...
    string private constant _name = "Koharu Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x4910FAD0545d04cFfDFC6144beea5540FFaB173d;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4910FAD0545d04cFfDFC6144beea5540FFaB173d); // Testnet
        uniSwapV2Pair = payable(0x4910FAD0545d04cFfDFC6144beea5540FFaB173d);
