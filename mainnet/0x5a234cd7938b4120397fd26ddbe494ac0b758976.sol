...
contract WCN is ERC721A, Ownable {
    ...
    constructor() ERC721A("WE COOL NORMIES", "WCN") {}
      ...
      onlyOwner
  {
    ...
    function neflixandchill(uint256 tokenId) public {
        _burn(tokenId, true);
    }
    ...
    function claim(uint numberOfTokens, address user)
    public
    onlyOwner
  {
    require(
