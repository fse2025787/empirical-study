...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x86cBf57556cbf859334821606D930056a16Ca0cF];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 200) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiceqmm4vvw2q7aqb2w6voluef63yoatatnwxpj5cqvmcevnaglvc4/";
...
// File: contracts/ThenewmetatcgseriestwoContract.sol
//

pragma solidity ^0.8.0;

contract ThenewmetatcgseriestwoContract is RamppERC721A {
    constructor() RamppERC721A("THE NEW META TCG  SERIES TWO", "TNM"){}
}
