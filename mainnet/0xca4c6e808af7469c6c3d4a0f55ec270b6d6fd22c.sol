...
contract _461 is IERC721A { 
    ...
    uint256 public constant MAX_PER_MINUTE = 46;
    uint256 public constant MAX_SUPPLY = 461;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "461";
    string private constant _symbol = "461";
    string private _contractURI = "QmedpRFgvfQoGjiopYX4FKCoPqiFqEFfZyVAqzUHcsjwqc";
    string private _baseURI = "QmcNoRQb54tmpgoi4SqvjTTF5Xfq8Qhv42oin7U8nAYr6D";
    ...
    function freeMint() external{
        ...
        require(timer[minute]<MAX_PER_MINUTE, "Max Mints per Minute reached");
