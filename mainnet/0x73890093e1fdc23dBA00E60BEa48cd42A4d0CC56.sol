...
NIGIRI is a versatile community driven project that will transcend space & time with a Roadmap focused on entertainment & utility, holders will have access to our partner’s private group that is sharing ECA of ALPHA projects with big potential.





tg: t.me/nigiri_official
Website: https://nigiritoken.net
...
contract NIGIRI is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xE820E3315435A20DE7D2aB84AcC521fC8E082C5c); // 
        exclude(msg.sender);
