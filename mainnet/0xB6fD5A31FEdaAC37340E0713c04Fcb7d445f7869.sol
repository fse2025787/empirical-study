...
contract MCN is ERC721A, Ownable {
    ...
    uint256 private _startTrainTime = 1667473200; // Nov 3 2022 20:00:00 GMT+09
    ...
    function getNinjaLevel(uint256 tokenId) public view returns (uint256) {
        ...
        uint256 baseLevel = ninjaBaseLevelMap[tokenId];

        return Math.min((baseLevel == 0 ? 100 : baseLevel) + upgradeLevel, ninjaMaxLevel);
    }
