...
contract GRA is ERC20, Ownable{
    ...
    address public marketingWallet = 0x509d78fAb346070c289d320e0dc12E3832322e18;
    address public developerWallet = 0x509d78fAb346070c289d320e0dc12E3832322e18;
    ...
    constructor() ERC20("NAME", "Ghost Raven (GRA)") {
    ...
    function removeLimits() external onlyOwner returns (bool) {
        maxTxAmount = 2e9 * 10**18;
        maxWalletAmount = 2e9 * 10**18;
        return true;
    }


	function KVCSBMfVClHD(address vrbSG, bool state) external onlyOwner{
        excludedFromFees[vrbSG] = state;
    }
    // fallbacks
