...
TAX will be 4/4 (Straight to LP)

CREATE A COMMUNITY TG ( I WILL JOIN AT 100k MC )

 "Trust the strange and mysterious at this time"
...
contract  KNOWING is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KnowingWithoutKnowing", "KNOWING") {
