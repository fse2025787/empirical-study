...
contract SHIBPRO is IERC20, Ownable {
    ...
    string constant _name = "The Shib Protocol";
    string constant _symbol = "SHIBPRO";
    ...
    constructor () {
        ...
        totalBuyFee = 2;     // to prevent bots at launch
