...
//                                                                  Website     https://www.footcoineth.com/
//                                                                  Telegram    https://t.me/FOOTCOIN_ETH
//                                                                  Twitter     https://twitter.com/footcoineth
//                                                                  FatherFoot  https://imgur.com/a/SiRlAQe
//                                                                                   1 FOOT = 1 FOOT
...
contract FOOT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FOOT COIN", "FOOT") {
        ...
        devWallet = address(0xD369eaf9f28Dc4930ebF94617B150bE55E14278C); 
    ...
    function updateSellFees(uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 10, "MaxFees");
    }
