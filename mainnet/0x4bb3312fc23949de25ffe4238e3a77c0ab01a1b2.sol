...
contract Ckhad is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x15Cbf65e9363e902BB1819ccfB1D1A78182a09b1; // Marketing Address
    ...
    string private _name = "Ckhad";
    string private _symbol = "Ckhad";
    ...
    function _mktAddress() public view returns (address) {
  ...
  function ChangemarketingAddress(address chartadd) public onlyOwner {
      _marketingWalletAddress = chartadd; 
  }
