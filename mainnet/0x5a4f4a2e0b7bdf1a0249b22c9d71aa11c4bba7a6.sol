...
Krupokuru is the legend of the Ainu. The legend of the villain is widely circulated in Hokkaido,
South Thousand Islands, Huatai and other places.

TG: t.me/koropokkuruInu

Initial tax rate 6% Final tax rate 2%
*/
...
contract koropokkuruInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = "koropokkuru Inu";
    string private constant _symbol = "KORPOKKUR";
