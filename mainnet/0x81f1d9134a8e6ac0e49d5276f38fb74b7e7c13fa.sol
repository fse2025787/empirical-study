...
contract Nautica is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRhBwCnH7JXAeRZeCw3qMVr3h37Lu7q6f2bUXQ3oXRq87";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("Nautica", "Scubanauts", 100, MAX_SUPPLY) {
    }
