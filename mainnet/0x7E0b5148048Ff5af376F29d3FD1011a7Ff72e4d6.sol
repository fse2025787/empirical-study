...
contract Parallel is ERC1155, Ownable, ERC2981ContractWideRoyalties, Pausable {
  ...
  uint private constant FOUNDER_SUPPLY = 111;           
  uint private constant PRESALE_PHYGITAL_SUPPLY = 111;  
  uint private constant GREENLIST_SUPPLY = 222;         
  uint private constant PUBLIC_SALE_SUPPLY = 667;       
