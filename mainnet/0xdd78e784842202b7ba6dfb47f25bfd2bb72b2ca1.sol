...
/*
    ...
    Borther of Mongoose - $BOM

    https://t.me/brotherofmongoose
...
contract BrotherofMongoose is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Brother of Mongoose", "BOM") {
    	...
    	dev1Wallet = payable(0xB8A3429ccC381AbA700B7008F68BB21F0AcA3b8c);  // set as dev1 wallet
        dev2Wallet = payable(0xB8A3429ccC381AbA700B7008F68BB21F0AcA3b8c);  // set as dev2 wallet
        dev3Wallet = payable(0xB8A3429ccC381AbA700B7008F68BB21F0AcA3b8c);  // set as dev3 wallet
        dev4Wallet = payable(0xB8A3429ccC381AbA700B7008F68BB21F0AcA3b8c);  // set as dev4 wallet
        dev5Wallet = payable(0xB8A3429ccC381AbA700B7008F68BB21F0AcA3b8c);  // set as dev5 wallet

        marketingWallet = payable(0xB8A3429ccC381AbA700B7008F68BB21F0AcA3b8c); //marketing wallet
