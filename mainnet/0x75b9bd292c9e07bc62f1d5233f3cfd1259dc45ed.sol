...
/*
Get ready to be sent back in time
            $IBM100
...
contract FloppyDisk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floppy Disk";
    string private constant _symbol = "IBM100";
