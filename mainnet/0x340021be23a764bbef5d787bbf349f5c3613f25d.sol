...
/**
Just watch the playback on the Aksu meal card what is convenient
$DiDa
*/
...
contract DiDa is Context, IERC20, Ownable {
    ...
    string private constant _name = "DiDa";
    string private constant _symbol = "DiDa";
