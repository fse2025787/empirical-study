...
contract MortalMonsters is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 4900;
	uint256 public GIVEAWAY_NFT = 100;
	
	uint256 public MAX_MINT_SALE = 4900;
	...
	address[] public addressList = [
	    0xdD46a7ebbc5752e92A34787521037feEC964a228,
		0x3876Ca261e758BD914331fD97EAF4B97C0B2F8D0,
		0x4C681F2019B92261936C062111dFb1430617373d,
		0xF6e37840CbEf4Ec240DB42d0015f6E8010B490a4,
		0x22EA0d910BfEf650D941b404EFbd7b8f5fD26E46
	];
	uint[] public shareList = [57,30,5,5,3];
    ...
    constructor() ERC721P('Mortal Monsters', 'Mortal Monsters') {}
	...
	function updateAddressList(address ownerOneAddress, address ownerTwoAddress, address ownerThreeAddress, address ownerFourAddress, address ownerFiveAddress) external onlyOwner {
		require(ownerOneAddress != address(0), "address is the zero address");
		require(ownerTwoAddress != address(0), "address is the zero address");
		require(ownerThreeAddress != address(0), "address is the zero address");
		require(ownerFourAddress != address(0), "address is the zero address");
		require(ownerFiveAddress != address(0), "address is the zero address");
		
		addressList[0] = ownerOneAddress;
		addressList[1] = ownerTwoAddress;
		addressList[2] = ownerThreeAddress;
		addressList[3] = ownerFourAddress;
		addressList[4] = ownerFiveAddress;
	}
	
	function updateShareList(uint256 ownerOneShare, uint256 ownerTwoShare, uint256 ownerThreeShare, uint256 ownerFourShare, uint256 ownerFiveShare) external onlyOwner {
	    require(ownerOneShare + ownerTwoShare + ownerThreeShare + ownerFourShare + ownerFiveShare == 100, "share must be 100%");
		
		shareList[0] = ownerOneShare;
		shareList[1] = ownerTwoShare;
		shareList[2] = ownerThreeShare;
		shareList[3] = ownerFourShare;
		shareList[4] = ownerFiveShare;
	}
}