...
//*********************************************************************//
//
//   ________            __  ___           __    _                __               ____                        __
//  /_  __/ /_  ___     /  |/  /___ ______/ /_  (_)___  ___  ____/ /___  ____ _   / __ \____  __  ______  ____/ /
//   / / / __ \/ _ \   / /|_/ / __ `/ ___/ __ \/ / __ \/ _ \/ __  / __ \/ __ `/  / /_/ / __ \/ / / / __ \/ __  / 
//  / / / / / /  __/  / /  / / /_/ / /__/ / / / / / / /  __/ /_/ / /_/ / /_/ /  / ____/ /_/ / /_/ / / / / /_/ /  
// /_/ /_/ /_/\___/  /_/  /_/\__,_/\___/_/ /_/_/_/ /_/\___/\__,_/\____/\__, /  /_/    \____/\__,_/_/ /_/\__,_/   
//                                                                    /____/                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x096279Ebe036ea1e3CDab2aC3f044742288dcF3a];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmagfJx8p7PdUGSXtMQjxG6wx2G1YFqe19P1BHPQrY4FGv/";
...
// File: contracts/TheMachinedogPoundContract.sol
//

pragma solidity ^0.8.0;

contract TheMachinedogPoundContract is RamppERC721A {
    constructor() RamppERC721A("The Machinedog Pound", "MDOG POUND"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/risSKDIqcF8QkqZfzYxv/contract-metadata";
    }
}