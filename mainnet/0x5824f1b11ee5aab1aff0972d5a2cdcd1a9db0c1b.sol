...
contract WORMS is ERC20, Ownable {
    ...
    uint256 max_supply = 7000000 ether;
    uint256 minted_supply;
    ...
    function removeAllowedAddress(address oldAddress) external onlyOwner {
        allowedAddresses[oldAddress] = false;
    }

    function mint(address to, uint256 value) external {
        require(allowedAddresses[msg.sender], "UNAUTHORIZED");
        require(minted_supply + value <= max_supply, "REACHED_MAX");
        require(value > 100000000000000000, "INVALID");
