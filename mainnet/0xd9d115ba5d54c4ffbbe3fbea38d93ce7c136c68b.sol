...
contract BULLEREUM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bullereum", "bETH") {
        ...
        maxTransactionAmount = totalSupply * 15 / 1000; // 3% maxTransactionAmountTxn
