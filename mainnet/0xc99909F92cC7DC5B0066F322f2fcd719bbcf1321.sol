...
/**
Website: http://attackoftitaninu.com

TG: https://t.me/attackoftitaninu

Twitter: https://twitter.com/AoT_Inu

Low Tax Anime Coin - 7/7 Buy/Sell

Attack of Titan is a Japanese series written and illustrated by Hajime Isayama. It is set in a world where humanity lives inside cities surrounded by three enormous walls that protect them from the gigantic man-eating humanoids referred to as Titans.

$AOT is a community driven anime project which was created to pay tribute to one of the best anime - Attack of Titan. With an incredible community we can create the best anime token on Ethereum network!

We will donate to various animation artists, little known animation studios, mangakas who are in need of funds. We are here for the community. We are here for the anime
**/
...
contract AOTInu is Context, IERC20, Ownable {
	...
	string private constant _name = "Attack Of Titan Inu";
