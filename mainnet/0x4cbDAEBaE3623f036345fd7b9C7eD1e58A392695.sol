...
I am the beginning i am the end, my burden never ends. Nightmare becomes real, fear blinds them, must keep focus in order to survive. Are you willing to take the risk?

If you make a community tg name it @omenerc. This is a command not a request.

Liquidity will be locked forever and renouncing ownership.
*/
...
contract Omen is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Raven", "OMEN") {
        ...
        devWallet = 0x89D286909015a4759B53F63322c1314Ea7C546a8;
