...
contract Chewie is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    ) ERC721A("Chewie Unwrapped", "Chewie") {
        PRICE = price;
    ...
    address private constant payoutAddress1 =
        0x166A5ABA2ad30265b090C7D5A4F0cfda069c7d6E;
    address private constant payoutAddress2 =
        0x7e632293721Df3BCf99A2B3713f7168dEcC3fD3a;
    address private constant payoutAddress3 =
        0x984A66e7c645deA48B81fEE619bf5560264C98ac;

    function withdraw() public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
        Address.sendValue(payable(payoutAddress1), balance / 3); //owner
        Address.sendValue(payable(payoutAddress2), balance / 3); //co
        Address.sendValue(payable(payoutAddress3), balance / 3); //mods+whales
    }
}