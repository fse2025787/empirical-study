...
/**
 * @title ETHGoldImplimentation
 * credits to paxgold for some snippets of code
...
contract ETHGold {
    ...
    uint256 internal totalSupply_ = 1000000e18;     //100,000
    string public constant name = "EthereumGold"; // solium-disable-line
    string public constant symbol = "ETHXAU"; // solium-disable-line uppercase
    ...
    */
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
        approve(spender, allowed[msg.sender][spender].sub(subtractedValue, "ERC20: decreased allowance below zero"));
        return true;
    }
     ...
     */
    function reclaimETHG() external onlyOwner {
    ...
    */
     ...
     * @return A bool success that indicates if the operation was successful.
     */
