...
contract UsmanDAO is ERC721A, Ownable {
    string public uriPrefix = "ipfs://QmbiKSNEsXr3np7QBq3iF5xkZMsj9Df5GLrW3EhQWkkHWx/";
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(amount <=  maxPerTx, "max 3 per");
