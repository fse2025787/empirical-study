...
contract murlocvillage is ERC721, Ownable {
    ...
    address t1 = 0x79Fb820da3fD92C76e461547CE130c911418804D;
    address t2 = 0x9B6F1B06bCEAEF7C896Beb50BB4943ece50e722f;

    constructor() ERC721("murlocvillage", "MUR") { 
    }
    ...
    function mint(uint256 toMint) external payable {
        ...
        require(_mintPrice * (toMint-1) <= msg.value, "You need more ETH to mint.");
        require(_t + toMint <= MAX_SUPPLY, "Exceed max supply.");
        _mint(toMint, msg.sender);
    }

    function foundermint(uint256 toMint) external onlyOwner {
        require(_t+ toMint <= MAX_SUPPLY, "Exceeds max supply");
        _mint(toMint, msg.sender);
    }
    ...
    function withdraw() public onlyOwner {
        uint256 profit = address(this).balance/2;
