...
// #miyake - www.miyakeofficial.com 
// #twitter - https://twitter.com/miyake_erc
// #tg - https://t.me/miyakeofficial
...
contract MIYAKE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MIYAKE", "$MIYAKE") {
        ...
        maxWallet = totalSupply * 13 / 1000; // 1.3% maxWallet
        ...
        marketingWallet = address(0x188eb05a0D6ba4d8B2B117Ab00e883A7Ead55F4a); // mwallet
        devWallet = address(0x188eb05a0D6ba4d8B2B117Ab00e883A7Ead55F4a); // dwallet
