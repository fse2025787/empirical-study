...
// File: contracts/AutoForwardableToken.sol


/**
    Copyright (c) 2022 BULLTRADING - Bulltrading.be
    Bulltrading.be / BLT ERC20 Token Smart Contract    
    Version 0.1
    based on the contracts of stasptr and OpenZeppelin:
    https://github.com/ElylandLLC/ico/blob/master/contracts/AutoForwardableToken.sol (stasptr)
    https://github.com/OpenZeppelin/zeppelin-solidity/tree/master/contracts (OpenZeppelin)
**/
 ...
 * @dev current balance and ll future transfers to address will be forwarded to new owner
 *
 ...
 */
contract AutoForwardableToken is ERC20 {

    constructor(string memory tokenName,string memory tokenSymbol,uint256 totalSupply) ERC20(tokenName, tokenSymbol, totalSupply) {}
    ...
    function doSetupAutoForward(address _sender, address _address, address _receiver) private {
        ...
        if (_receiver != address(0)) {
            ...
            doTransfer(_address, _receiver, _balances[_address]);
        }
    }
...
// File: contracts/BulltradingToken.sol
...
contract BulltradingToken is AutoForwardableToken {

    string public token_symbol = "BLT";
    string public token_name = "Bulltrading";

    uint256 constant public TOTAL_SUPPLY  =  500_000_000 * (10 ** uint256(18));
    
    constructor() AutoForwardableToken(token_name, token_symbol, TOTAL_SUPPLY) {}
