...
Tsuka Fuel (NENRYO)
Nenryō is a hyper deflationary token that is on a mission to fuel $TSUKA’s journey 
in becoming a multi-billion dollar market cap valuation. Nenryō has developed a 
unique contract that will auto-buy Dejitaru Tsuka tokens and then burn them by sending 
the tokens to a dead address, resulting in less $TSUKA in circulation. 
With a supply of 1 billion, Tsuka Fuel will be used to continuously burn $TSUKA!

Website 
https://tsukafuel.com

Telegram (Entry Portal)
https://t.me/TsukaFuel

Twitter
https://twitter.com/TsukaFuel
...
// File: Tokens/TSUKAFUEL/TsukaFuelv2.sol
...
contract TsukaFuel is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTxAmount = _tTotal.mul(100).div(10000); //1%
        _maxWalletAmount = _tTotal.mul(300).div(10000); //3%
