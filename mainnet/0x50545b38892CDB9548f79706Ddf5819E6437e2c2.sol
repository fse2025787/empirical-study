...
contract Gwojak is Ownable, IERC20 {
    ...
    string private _name = "Green Wojak";
    string private  _symbol = "GWOJAK";
    ...
    function setCooldownEnabled(bool e) external onlyOwner {cooldownEnabled = e;}
