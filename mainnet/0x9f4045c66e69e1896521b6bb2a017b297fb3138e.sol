...
contract Shimashi is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x1aEcC44aABbBDe7aCa17f1bE94c343a2036c89Cf));

    string private _name = "Shimashi";
    string private _symbol = "Shimashi";
