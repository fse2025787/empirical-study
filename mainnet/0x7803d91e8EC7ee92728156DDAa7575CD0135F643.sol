...
contract TheFirelordTsuka is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'The Firelord';
    string private constant _symbol = 'Firelord Tsuka';
