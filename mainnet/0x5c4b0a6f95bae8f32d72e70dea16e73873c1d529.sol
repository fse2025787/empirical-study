...
contract Inutrovert is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Inutrovert";
    string private constant _symbol = "INERT";
    ...
    address payable private _developmentAddress = payable(0xA2BCA93ea433C03406cCD875e1e4be5A0FB4dBF2); 
    address payable private _marketingAddress = payable(0xA2BCA93ea433C03406cCD875e1e4be5A0FB4dBF2);
