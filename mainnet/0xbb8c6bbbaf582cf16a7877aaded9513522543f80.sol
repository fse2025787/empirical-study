...
/**
Telegram:
https://t.me/ReiPortal

Twitter:
http://twitter.com/ReiZero

Website:
http://www.reierc.tech
**/
...
contract REI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 8 * 10**8;
    ...
    string private constant _name = "REI";
    ...
    uint256 private _maxTxAmount = 0.16 * 10**8;
    uint256 private _maxWalletSize = 0.24 * 10**8;
    ...
    function unreiBla() public deployerOnly {
        // ublacklist rei contract
        address bbot;
