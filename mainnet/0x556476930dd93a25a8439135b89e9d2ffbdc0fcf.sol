...
contract CurveConvexWallet is Ownable {
    ...
    function _depositInCurve (bytes32 recordId, uint256 depositAmount, uint256 expectedLpTokensAmountAfterFees) internal {
    ...
    function _depositInConvex (bytes32 recordId) internal {
    ...
    function collectRewards (bytes32 recordId) public onlyOwner ifNotReentrant {
