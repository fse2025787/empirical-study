...
contract SpaceMiceEmpire is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Space Mice Empire", "SME") {
        setHiddenMetadataUri("https://api.spacemice.xyz/");
        setBaseURI("https://api.spacemice.xyz/");
    }
    ...
    function MintPremintWL(address to, uint256 quantity)public onlyOwner{
