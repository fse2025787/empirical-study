...
/*
 Bamboo Tracing - $BAMBOO
 Harvest a ton of bamboo tax free.

 Tokenomics :
 - 1.000.000 $BAMBOO
 - 0% BUY/SELL TAX
 - 20% EARLY SELL TAX (24h)

 Links : 
 www.bambootracing.xyz
 www.twitter.com/BambooTracing
*/
...
contract BambooTracing is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x9a94E1ec7feCB2DceE6b3d0134E4b8Aca19215ef);
    address payable public devWallet = payable(0xf896E2AFff126D8a7953Dfda1A00fD92a06078C4);
    ...
    constructor() ERC20("Bamboo Tracing", "BAMBOO") {
