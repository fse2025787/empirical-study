...
contract SailorDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'SAILOR DOGE';
    string private _symbol = 'SAIDOGE';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[0]/**supply*/ = tAmount.div(100).mul(3);
        _localVal[1]/**tBurnValue*/ = tAmount.div(100).mul(1);
        _localVal[2]/**tholder*/ = tAmount.div(100).mul(1);
        _localVal[3]/**tLiquidity*/ = tAmount.div(100).mul(1);
