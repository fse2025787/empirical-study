...
contract HOTDOGE is Context, IERC20, Ownable {
    ...
    string private _name = 'Hot Doge';
    string private _symbol = 'HOTDOGE';
    ...
    uint256 private constant _tTotal = 10**6 * 10**18;
    ...
    function enableCooldown(bool enable) public onlyOwner {
