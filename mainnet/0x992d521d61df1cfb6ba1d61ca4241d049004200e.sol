...
https://twitter.com/FaceCramer
https://t.me/FaceCramerETH
*/
...
contract FACECRAMER is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x8E5485bc2F1e60F6D62F82a7Ec8e700B6fBF9eA6));

    string private _name = "(BAD)FACECRAMER";
    string private _symbol = "FACECRAMER";
