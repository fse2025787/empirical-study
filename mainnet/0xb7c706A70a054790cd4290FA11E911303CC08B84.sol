...
contract MumbaiBicycleClub is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Mumbai Bicycle Club";
    string private _symbol = "$MBC";
    uint8 private _decimals = 9;

    address payable private Marketing = payable(0xcE39A012e2E295E6045D947807987eB3D7993d1d);
    address payable private Development = payable(0xcE39A012e2E295E6045D947807987eB3D7993d1d);
    ...
    uint256 public _marketingShares = 27;
    ...
    function manualSend() external {
        transferToAddressETH(Marketing, address(this).balance);
    }
