 ...
 * @title CYVOVesting
 */
contract CYVOVesting is Ownable, ReentrancyGuard {
        ...
        returns (bytes32)
    {
        require(
            ...
            "CYVOVesting: index out of bounds"
        );
    ...
    function createVestingSchedule(
        ...
        require(_duration > 0, "CYVOVesting: duration must be > 0");
        require(_amount > 0, "CYVOVesting: amount must be > 0");
        require(
            _slicePeriodSeconds >= 1,
            "CYVOVesting: slicePeriodSeconds must be >= 1"
        );
