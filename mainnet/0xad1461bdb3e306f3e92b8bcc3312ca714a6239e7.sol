...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable Kakuan = address(0xcd452Ad761BD624cb016d40CE9D232f180e55d73);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(Kakuan).transfer(shareholder, amount);
        }
    }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a KakuanBANK shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract BankOfKakuan is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address public immutable Kakuan = address(0xf0f9D895aCa5c8678f706FB8216fa22957685A13); //UNI

    string private constant  _name = "Bank Of Kakuan";
    string private constant _symbol = "BoK";
    ...
    address payable public marketingWallet = payable(0xE1f23B47CF02f198B1C4fc94F285c06F7999df88);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForKakuan(amountToSwap.div(2));

        uint256 dividends = IERC20(Kakuan).balanceOf(address(this));

        bool success = IERC20(Kakuan).transfer(address(distributor), dividends);
    ...
    function swapTokensForKakuan(uint256 tokenAmount) private {
