...
/**
Bring whale cryptocurrency concepts to the mainstream.
Tax Buy : 2%
Tax Sell : 4%
TG : https://t.me/whalemaximalist
TWITTER : https://twitter.com/profitmaximalisterc
*/
...
// File: contracts/WHALEMAXIMALIST.sol
...
contract WHALEMAXIMALIST is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    
    string constant _name = "WHALE MAXIMALIST";
    string constant _symbol = "WHALEMAX";
    ...
    uint256 public marketingFee0 = 1;
    ...
    constructor (IUniRouterV2 _router) Auth(msg.sender) {
        ...
        marketingWallet0 = address(0xb73DE10D77676f66c9a1DcFfCf82560c075920dF);
        marketingWallet1 = address(0xb73DE10D77676f66c9a1DcFfCf82560c075920dF);
        buybackWallet = address(0x1954521758647314d48a00016cf26b81Fb5e5456);
    ...
    {        
        ...
        uint256 amountETHBuyback = amountETH.mul(marketingFee0).div(totalETHFee);
        uint256 amountETHMarketing0 = amountETH.mul(marketingFee0).div(totalETHFee);
        uint256 amountETHMarketing1 = amountETH.sub(amountETHLiquidity).sub(amountETHBuyback).sub(amountETHReflection).sub(amountETHMarketing0);

        //distribute to wallets and dividend
        try dividendDistributor.deposit{value: amountETHReflection}() {} catch {}
        bool success;
        if (amountETHBuyback > 0) (success, ) = payable(buybackWallet).call{ value: amountETHBuyback, gas: 30000 }("");
        if (amountETHMarketing0 > 0) (success, ) = payable(marketingWallet0).call{ value: amountETHMarketing0, gas: 30000 }("");
        if (amountETHMarketing1 > 0) (success, ) = payable(marketingWallet1).call{ value: amountETHMarketing1, gas: 30000 }("");        
        success = false;
