...
contract Mithrillium is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mithrillium";
    string private constant _symbol = "MTRL";
    ...
    uint256 public _maxWalletSize = 500000000000 * 10**8;
