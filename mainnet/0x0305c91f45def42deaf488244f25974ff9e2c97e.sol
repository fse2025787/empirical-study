...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x65911F7A1F222e31C1B5bC8396ac7A01529ED3A0];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmdhmm3SuAfkQBcuxd5HfoiM6zEaF2M89s6WYoWzqTDT7q/";
...
// File: contracts/PoofCollectiveContract.sol
//

pragma solidity ^0.8.0;

contract PoofCollectiveContract is RamppERC721A {
    constructor() RamppERC721A("Poof Collective", "PC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/pIJZ2krREa2ZbhhTPl8u/contract-metadata";
    }
}