...
/** 
    ...
    Circulating supply is 500,000,000,000,000

    9% TOTAL FEES PER TRANSACTION
    - 3% is distributed to all holders proportionally
    - 4% is automatically add to the liquidity pool
    - 1% is sent to the dev/marketing wallet
    - 1% is burned forever
    This contract was written for and deployed on the Binance Smart Chain.
*/
...
contract HELLas is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0xdc0B82B762C0e7A64191E6631A5A987198965559;
    address private _burnAddress = 0x0000000000000000000000000000000000000001;

    string private _name = "HELLAS Token";
    string private _symbol = "HELLAS";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xdc0B82B762C0e7A64191E6631A5A987198965559);
