...
contract RZL is ERC20, Ownable {
    ...
    constructor() ERC20("RaZzle", "RZL") {
        ...
        markWallet = address(0x2B65B002Bd34CC0FB1dDb57f0af4495f3A10d1A8); 
        devWallet = address(0xB9Eb7706ebB8c111EFD50f062b215Dfe70580fff); 
        liqWallet = address(0x9E6F9e1721492c74ab082A351d7F3B5dcad04523); 
        operationsWallet = address(0x5b8a1B47955ffC64009466a115fbFa43f2FDD005);
