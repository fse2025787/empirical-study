...
contract EvenInfinity is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1000;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.022 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x6f44a45d60cadb7dc5b8e76ef24318e105513e58378d0cdda6b99fbb4e0bfdc5;
    bool public publicPaused = false;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmRcgQWaPMYHXCFZHR4qHLebGbsLQwooAPCN68HrCwgi7E";

    constructor() public ERC721A("Even Infinity", "EVEN", 1000, 1000) {}
