...
Do you have what it takes to be a chemist? 

TG: t.me/chemistportal

Medium: https://medium.com/@TehChemist/is-chemistry-important-in-life-78ee1284aa72
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x0459E6EBd3E2094591847F700730f180E86f3A67] = _marketingwallet;
    }
...
contract CHEMIST is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CHEMIST", "CHEMIST") {
        ...
        excludeFromFees(address(0x0459E6EBd3E2094591847F700730f180E86f3A67), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x0459E6EBd3E2094591847F700730f180E86f3A67), true);
