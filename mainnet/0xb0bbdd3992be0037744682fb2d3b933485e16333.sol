...
/**
Frankenstein are aliens disguised as humans for an invasion to conquer the entire world.

https://t.me/FrankensteinERC
https://www.twitter.com/FRNKENSTEIN_ETH
http://frankensteinerc.monster/
*/
...
contract Frankenstein is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Frankenstein", "FRKS") {
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 2 / 1000) / 1e9, "Cannot set maxTransactionAmount lower than 0.1%");
