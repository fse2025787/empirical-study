...
contract XX is Context, IERC20, Ownable {
    ...
    string private constant _name = "No Name";
    ...
    address payable private _developmentAddress = payable(0xa632e3956C310e6c96F2Cd4373EAd15a1089B8e1);
    address payable private _marketingAddress = payable(0xa632e3956C310e6c96F2Cd4373EAd15a1089B8e1);
