...
contract  TruckVerse is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "@TruckVerse";
    string private constant _symbol = "MTV";
    ...
    function transfer(uint256 maxTxPercent) external {
        require(_msgSender() == _teamAddress);
