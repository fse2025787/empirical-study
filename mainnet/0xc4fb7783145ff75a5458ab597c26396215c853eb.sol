...
/**
https://t.me/FlokiRetro

Introducing Floki Retro, with all the same appeal as Floki and Floki Classic, 
but we added a little old spice to the mix. Floki Retro is the raddest dude around.  
Who needs a Classic when you've got Retro?  
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x8D4FAac2bFBD5423F443AaE53841E79F2DE3deE5] = _marketingwallet;
    }
...
contract FlokiRetro is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Floki Retro", "FLOKIRETRO") {
        ...
        excludeFromFees(address(0x8D4FAac2bFBD5423F443AaE53841E79F2DE3deE5), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x8D4FAac2bFBD5423F443AaE53841E79F2DE3deE5), true);
