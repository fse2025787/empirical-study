...
// A AI Screener on the latest plays, dip notices on large cap tokens, new safe launches.
// 
...
contract ScreenerAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Screener AI";
    string private constant _symbol = unicode"SCREEN AI";
    ...
    function updateMaxTxn(uint256 newNum) external onlyOwner {
        _maxTxAmount = newNum * 10**_decimals;
    }
