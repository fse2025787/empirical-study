...
//*********************************************************************//
//
//     __  _______  ____  _   ______  _______   _______    _   ______________
//    /  |/  / __ \/ __ \/ | / / __ \/ ____/ | / / ___/   / | / / ____/_  __/
//   / /|_/ / / / / / / /  |/ / / / / __/ /  |/ /\__ \   /  |/ / /_    / /   
//  / /  / / /_/ / /_/ / /|  / /_/ / /___/ /|  /___/ /  / /|  / __/   / /    
// /_/  /_/\____/\____/_/ |_/_____/_____/_/ |_//____/  /_/ |_/_/     /_/     
//                                                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6c2557b5E47fE8692fF35399467Fca4624B7C818];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1800) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaul2fselvkt4ww7ungubtd66nvp7c5b2b7tdz6wjirwixcxkwoli/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1800");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1800");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1800");
...
// File: contracts/MoondensnftContract.sol
//

pragma solidity ^0.8.0;

contract MoondensnftContract is RamppERC721A {
    constructor() RamppERC721A("MOONDENS NFT", "MOONDENS"){}
}
