...
Token Name: Shibarium Inu Yacht Club
Ticker: SIYC
Supply: 1,000,000,000,000

$SIYC the first ever Shibarium community token for the upcoming Shibarium grand launch. 

At $SIYC our focused is to build community connections and networks for degens 
to massively hype and launch tokens under Shibarium. 
Building advantages to be known as a solid group dedicated for Shibarium. 

Taxes: 5/5 dedicated to buy $BONE in preparation of Shibarium launch. 

Holders with enough tier of tokens holdings will take advantage on Shibarium alpha plays.

Twitter: https://twitter.com/SIYCERC20
Telegram: https://t.me/SIYCERC20
...
contract SIYC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shibarium Inu Yacht Club";
    string private constant _symbol = unicode"SIYC";
