...
/*
    ...
    Telegram:
    https://t.me/Twitch_Inu

    Twitter:
    https://twitter.com/Twitch_Inu

    Discord: 
    https://discord.gg/sxBKK2zBhw
 */
...
contract TwitchInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Twitch Inu", "TWITCH") {
        ...
        operationsAddress = address(0x93f6BF05cCce1395C0dc2bD647ca9C3b45C3AE0f);

        _createInitialSupply(address(this), (totalSupply * 70) / 100); // Tokens for liquidity
        _createInitialSupply(address(0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045), (totalSupply * 30) / 100); // 30% to vitalik
