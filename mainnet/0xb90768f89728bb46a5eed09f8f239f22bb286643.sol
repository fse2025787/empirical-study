...
Run AI models with our cloud API.

No machine learning needed. Focus on building. We’ll take care of hosting. Just plug and play with our rest API.

TG: https://t.me/CloudAPI_AI

Website: https://cloud-api.org/
...
contract CloudAPIAI is ERC20, Ownable {

    address WBNB = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Cloud API AI"; // 
    string constant _symbol = "Cloud AI"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (4); // 4%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (4); // 4%
    uint256 public _maxWalletToken = _totalSupply / (100) * (4); // 4%

    // Fees receivers
    address public autoLiquidityReceiver = 0xb63B3eF766AC7241ACa9fc273d209AF61637e1fc;
    address public marketingFeeReceiver = 0xb63B3eF766AC7241ACa9fc273d209AF61637e1fc;
    address public devFeeReceiver = 0xb63B3eF766AC7241ACa9fc273d209AF61637e1fc;
    address public buybackFeeReceiver = 0xb63B3eF766AC7241ACa9fc273d209AF61637e1fc;
    ...
    uint256 public maxSwapSize = _totalSupply / 100 * 4; //4%
