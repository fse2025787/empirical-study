...
/**
Micro-Chain Capital: $MCC
- You buy on Ethereum, we farm on microple chains and return the profits to $MCC holders.

Tokenomics:
5% of each buy/sell goes to existing holders.
5% of each buy/sell goes into micro-chain farming to add to the treasury and buy back MCC tokens.

Website:
https://microchaincapital.eth.link

Telegram:
https://t.me/MicroChainCapital

Twitter:
https://twitter.com/MChainCapital

Medium:
https://microchaincapital.medium.com
*/
...
library SafeMath {
    ...
    /**
     * @dev Returns the microplication of two unsigned integers, with an overflow flag.
     *
     * _Available since v3.4._
     */
    ...
    /**
     * @dev Returns the microplication of two unsigned integers, reverting on
     * overflow.
     *
     * Counterpart to Solidity's `*` operator.
     *
     * Requirements:
     *
     * - Microplication cannot overflow.
     */
...
contract MicroChainCapital is Context, IERC20, Ownable {
  ...
  string private _name = 'MicroChainCapital';
  string private _symbol = 'MICRO';
