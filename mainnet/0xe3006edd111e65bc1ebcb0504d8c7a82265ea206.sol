...
contract UnipoolTokenDistributor is LPTokenWrapper, OwnableUpgradeable {
    ...
    function initialize(
        ...
        LPTokenWrapper.__LPTokenWrapper_initialize(_uni);
    ...
    function setUniAddress(IERC20Upgradeable _uni) external onlyOwner {
        uni = _uni;
    }
...
interface IDistro {
     ...
     */
    event CancelAssign(address indexed admin, address indexed distributor);
