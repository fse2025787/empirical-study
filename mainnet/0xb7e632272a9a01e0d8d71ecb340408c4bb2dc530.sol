...
contract FableOfAShadow is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fable Of A Shadow";
    string private constant _symbol = unicode"SEKIRO";
