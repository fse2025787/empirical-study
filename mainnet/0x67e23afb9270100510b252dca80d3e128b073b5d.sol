...
/** 
    ...
    https://chaininu.space/
    https://t.me/ChainInuEntry
    https://twitter.com/ChainInuETH
*/
...
contract ChainInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xF5DDC7fAdE07c101c88C0779904A962373E67bb1); // Marketing Address
    address payable public multiSigAddress = payable(0x9870f1047D62349d21D7C42b9ab92e444cd140Be); // Marketing Address
    address payable public devAddress = payable(0x9870f1047D62349d21D7C42b9ab92e444cd140Be); // Dev Address
    address payable public liquidityAddress = payable(0x9870f1047D62349d21D7C42b9ab92e444cd140Be); // Liquidity Address
    ...
    string private constant _name = "Chain Inu";
