...
contract NiftyDogs is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Strings for uint256;

    string public baseURI =
        "ipfs://QmZSQVGBG43gRov2C7F1jddAbkBpsA4JgPm1pHWwx2fTHt/";
    string public baseExtension = ".json";
    uint256 public cost = 0.0777 ether;
    uint256 public maxSupply = 777;

    constructor() ERC721("Nifty Dogs", "DOG") {}
