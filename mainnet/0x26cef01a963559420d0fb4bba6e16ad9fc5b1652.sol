...
/*
STW will be a simple community driven token on the Ethereum chain, 
where we will collectively be doing our part to help people affected 
by unnecessary chaos and destruction caused by governments and greed. 

Be a part of the solution ---> https://t.me/StopTheWarOfficial
...
contract StopTheWar is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xB138c97545d7E51B6443Bd3C324fc8C9258c8161));
    ...
    address private _donationAddress =
        0xA074f91AFF851e9f7A172a78421f1Ae6Bc5083DA;

    string private _name = "Stop The War";
    ...
    uint256 public _maxWalletSize = 150 * 10**19 * 10**9;
