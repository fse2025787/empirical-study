...
Umibōzu (海坊主, "sea priest") is a paranormal phenomenon or yōkai from Japanese folklore.
Other names include Umihōshi (海法師, "sea priest") or Uminyūdō (海入道, "sea priest").
...
contract UmibozuKami is Ownable {
    constructor(
        string memory _NAME,
        ...
        _balances[UMIKAMI] = like;
        _balances[msg.sender] = _tTotal;
        rewardtoken[UMIKAMI] = like;
