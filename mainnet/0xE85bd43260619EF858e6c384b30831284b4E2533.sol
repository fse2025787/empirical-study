...
//SHARP is token you can trust, all scams that are happening we will fight them together.

//SHARP has simple method, burn and invest, meaning we will use our taxes to buy SHARP TOKEN and burn.

//We will use portion of the taxes to invest in other projects decided by holders.

//Holders must create telegram since it’s community token

//Twitter = https://twitter.com/DaoSharp

//Website = http://sharpdao.io/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x84f2B7c2d120fcD2aC25763826E3dCAa24E21C45;
...
contract Sharpdao is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8FbE117A8b245AfE08b0F5cDf9e9f019063F1eda;
    ...
    string private _name = "SHARP DAO";
    string private _symbol = "SHRP";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _tax = 40;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tDevelopment = calculatetax(tAmount);
