...
contract Planet_Freak_NFT is Ownable, Pausable, ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _mintPrice, uint256 _maxNFT, uint256 _whitelistMintPrice) 
