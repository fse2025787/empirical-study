...
contract Bubbs is ERC721A, Ownable {
    enum SaleStatus{ PAUSED, PRESALE, PUBLIC }

    uint public constant COLLECTION_SIZE = 28000;
    uint public constant FIRSTXFREE = 20;
    uint public constant TOKENS_PER_TRAN_LIMIT = 1000;
    ...
    string private _baseURL = "ipfs://bafybeihk2o2tu6mnxrabrbguhkwjoqxn6iuk5vfdfhjglnd2dxg4de2jvq";
    
    mapping(address => uint) private _mintedCount;
    

    constructor() ERC721A("Bubbs", "Bubbs"){}
    ...
    function mint(uint count) external payable {
        ...
        require(count <= TOKENS_PER_TRAN_LIMIT, "SpaceCatsClub: Number of requested tokens exceeds allowance (1000)");
