...
Will reduce to 0/0 and renounce, community driven
...
contract TelegramCoin  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Telegram Coin";
    string private constant _symbol = "TGC";
    ...
    address payable private _developmentAddress = payable(0x0D9Fd144195Ae4212923507737D5491546143058); 
    address payable private _marketingAddress = payable(0x0D9Fd144195Ae4212923507737D5491546143058);
