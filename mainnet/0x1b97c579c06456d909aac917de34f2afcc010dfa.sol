...
contract B4B is Context, IERC20, Ownable {
    ...
    string private constant _name = "Biking 4 Biden";
    string private constant _symbol = "WhaTheFuk";
    ...
    constructor () {
        _feeAddrWallet = payable(msg.sender);
