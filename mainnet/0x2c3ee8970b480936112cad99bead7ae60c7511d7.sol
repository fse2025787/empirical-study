...
https://docs.perpetualyield.io/what-is-amplifi/the-first-decentralized-annuity/trading-pair-liquidity-and-tokenomics
...
contract AmpliFi  is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 300 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'AmpliFi  ';
    string private _symbol = 'AMPLIFI';
