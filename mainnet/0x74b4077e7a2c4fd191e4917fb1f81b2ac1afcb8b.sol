...
/**
Fuck Ape! Web3.0 is everyone's, not Ape's. 
Twitter:
https://twitter.com/Apesea_eth
...
contract APESEA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Apesea", "Apesea") {
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // 1% from total supply maxTransactionAmount
        ...
        marketingWallet = payable(0x132d564fca55e09A484D7300CAd56c58D109F5Cc);
        devWallet = payable(0x132d564fca55e09A484D7300CAd56c58D109F5Cc);
