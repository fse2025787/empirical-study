...
contract MONGOLINU is Context, IERC20, Ownable {
    ...
    string private _name = "MONGOL INU";
    string private _symbol = "MONGOL";
    ...
    address payable public marketingaddress = payable(0xE209ed2F23054dfA9E40F07b64ABbfCD2C05963a);
