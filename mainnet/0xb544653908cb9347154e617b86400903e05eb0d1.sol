...
contract Shingeki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shingeki";//
    string private constant _symbol = "SHINGEKI";//
    ...
    address payable private _developmentAddress = payable(0xB35f1F39368118B15C60B872d524152b7A4CC310);
    address payable private _marketingAddress = payable(0xB35f1F39368118B15C60B872d524152b7A4CC310);
