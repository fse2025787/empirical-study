...
// 
//
//  Breezly is a meme token that only rewards investors for holding, the number of rewards received will increase over time, literally. 
//  We are the safest place for long and short term investors to come together. If you missed Shiba Inu, don’t miss Breezly. The next to 1000x
//
//  Tokenomics:
...
contract Breezly is ERC20, Ownable {
    ...
    constructor() payable ERC20("Breezly", "BREEZLY") {
