...
TG: https://t.me/GamblifyPortal
Twitter: https://twitter.com/GamblifyToken
Medium: https://medium.com/@Gamblify
Web: https://www.gamblify.co/
*/
...
contract Gamblify is ERC20("GAMBLIFY", "GMBFY"), Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    uint256 public constant MAX_SUPPLY = 5000000000 * 1e18; // 5B max supply
    ...
    uint16 private maxTransferAmountRate = 120;
    uint16 private maxWalletAmountRate = 240;

    uint256 public minAmountToSwap = (MAX_SUPPLY * 2) / 1000; 
    uint256 public thresholdAmount = (MAX_SUPPLY * 2) / 100; 
    ...
    address public treasuryWallet = 0x032F728b732d66569e77F3782E5aA9348064719a;
    address public developmentWallet = 0x032F728b732d66569e77F3782E5aA9348064719a;
    ...
    function updateTreasuryWallet(address newAddress) external {
        require(
            msg.sender == developmentWallet,
            "only basic operation is possible"
        );
