...
contract SharkTaleSmith is Context, IERC20, Ownable {
    ...
    string private constant _name = "SharkTaleSmith";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x5446760A3074100DC7B7f09A317503AA0a47628f);
        _feeAddrWallet2 = payable(0x5446760A3074100DC7B7f09A317503AA0a47628f);
