...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x9691277776B4e77af948Ee9839f719063070626C];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x9691277776B4e77af948Ee9839f719063070626C;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiad2jo33odgpxtksafmwtf6wniszvvshtirwdjhb7wuo5nijka65m/";
...
// File: contracts/GalacticShipsAiContract.sol
//

pragma solidity ^0.8.0;

contract GalacticShipsAiContract is RamppERC721A {
    constructor() RamppERC721A("GalacticShipsAI", "GSHIP"){}
}
