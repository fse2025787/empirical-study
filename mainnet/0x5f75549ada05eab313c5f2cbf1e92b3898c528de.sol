...
/*
 ...
 30th August between  17:00 and 21:00 UTC Enjoy!
      __________________
    .-'  \ _.-''-._ /  '-.
  .-/\   .'.      .'.   /\-.
 _'/  \.'   '.  .'   './  \'_
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURITwo = _baseURITwo();
         if (tokenId % 2 == 0) return baseURI;
         else return baseURITwo;
    }
    ...
    function _baseURI() internal view virtual returns (string memory) {
     ...
     function _baseURITwo() internal view virtual returns (string memory) {
        return "";
    }
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
       ...
       if (_exists(tokenId)) {  //autosell
                uint256 payment = 95 * NFT_PRICE / 100;
...
contract EthDiamonds is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("EthDiamond", "EthDiamond") {
    }
    ...
    function _baseURITwo() internal view virtual override returns (string memory) {
        return URITwo;
    }
    ...
    function changeURI(string memory uri) external onlyOwner {
        URI = uri;
    }
    
    function changeURITwo(string memory uri) external onlyOwner {
        URITwo = uri;
    }
    
    function changeContractURI(string memory curi) external onlyOwner {
        contracturi = curi;
    }

   function mint(uint256 amountToMint) public payable {
        require(ROUND < maxRounds, "Max round reached");
        ...
        if (mintIndex == MAX_NFT_SUPPLY) {ROUND++; mintIndex=0;NFT_PRICE = NFT_PRICE * 2;}
   }
