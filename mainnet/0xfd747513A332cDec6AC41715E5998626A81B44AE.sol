...
contract ContractDeployer is ERC721, ERC721Burnable, ERC721Metadata, ERC721Queryable, ERC721Royalty, Mintable, Withdrawable {
    ...
    constructor() ERC721('Contract Deployer', 'deployer') ERC721Royalty(_msgSenderERC721A(), 1000) {
        setBaseURI('https://niftyvs.com/metadata/contract-deployer/json/');
        _setMintState(STATE_MINT_ALLOWLIST);

        _allowlistMerkleRoot = 0x1884d96bf2f73a5255483ce776d9d0254d1147d85ccf7af4fe3864005c7b18a5;
        _giveawayMerkleRoot = 0x1884d96bf2f73a5255483ce776d9d0254d1147d85ccf7af4fe3864005c7b18a5;
