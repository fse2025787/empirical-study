...
MAIN SITE     - https://starkware.co/
SOCIALS       - https://twitter.com/StarkWareLtd/
DOCUMENTATION - https://starknet.io/docs/
NEWS          - https://medium.com/starkware
DEVELOPMENT   - https://github.com/starkware-libs
*/
...
contract STARK is Context, IERC20, Ownable {
    ...
    string private _name = "STARKNET";
    string private _symbol = "STARK";
    uint256 private _tTotal = 10 * 10**9 * 10**uint256(_decimals);
    ...
    address payable public marketingWallet = payable(0x1e364D64Aa44F448B75B7C887633Cfb04C0188E3);
