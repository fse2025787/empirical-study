...
contract TinkerBellNFT is ERC20 {
    string public constant name = "Tinker Bell"; 
    string public constant symbol = "Fairy✨";
    uint8 public constant decimals = 18; 
    uint256 public constant initialSupply = 15000 * (10 ** uint256(decimals));
