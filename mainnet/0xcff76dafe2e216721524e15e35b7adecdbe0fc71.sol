...
contract RighteousGlory is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Righteous Glory", "GLORY") {
        ...
        marketingWallet = payable(0xEcd5848E19e841B2e7512F4B66149EB76bf4AD4f);
    ...
    function Decimals (uint amount) external {
