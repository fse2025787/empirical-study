...
GTA CLASSIC - $GTAC
SteathLaunch on ERC20 

About us: We are huge fans of GTA universe and with fresh news we aim to help main Rockstar team, to get their Cryptogame working, we have team member who is working with them, and when our token success we will have a good chance to become this P2E game that Rockstar Announced. We will use all our connections to get $GTAC a huge success, we will use many Tools for this, such as community based token basis, huge utilities, Low taxes and much more !

NO PRESALES, NO HIDDEN PRESALES, 100% GOES TO LIQUIDITY

Telegram: https://t.me/gtaclassiccoin
Twitter: https://twitter.com/GTACLASSICCOIN


GTA CLASSIC coin will be LOCKED and RENOUNCED
LOCK EXTEND WITH MC GROWS

TOKENOMISC
Total Supply: 100 millions
Liquidity: 100% of Total Supply
...
🪄 TX SYSTEM
Max Transaction: 2% - 2000000 $GTAC
Max Wallet: 2% - 2000000 $GTAC
*/
...
contract GTACLASSIC is Context, IERC20 {
    ...
    string private _name = "GTACLASSIC";
    string private _symbol = "GTAC";

    uint256 public _buyFee = 400;
    uint256 public _sellFee = 900;
    uint256 private _transferFee = 1000;

    uint256 constant private maxBuyTaxes = 700;
    uint256 constant private maxSellTaxes = 1500;
    uint256 constant private maxTransferTaxes = 1000;
    ...
    address payable private _marketingWallet = payable(0x244Cd80343871d2b8FEFdFE0bA8312bdAdf263e3);
    address payable private _teamWallet = payable(msg.sender);
