...
contract TRUMPET is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trumpet";//
    ...
    address payable private _developmentAddress = payable(0x0470dE8a0ff0C5DFA680A4533192ad300b4Efc60);//
    address payable private _marketingAddress = payable(0x4Dad3400E86A1EBFBaE40950225fCDc892052f58);//
