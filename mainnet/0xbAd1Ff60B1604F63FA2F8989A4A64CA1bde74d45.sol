...
contract DuckerPay is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ducker Pay";
    string private constant _symbol = "DUCKP";
    ...
    uint256 private constant _tTotal = 500000000000000000 * 1e10;
    ...
    address public immutable ducker;
    ...
    constructor() {
        ...
        ducker = address(0xa52bfFAD02B1FE3f86A543a4e81962d3B3bB01A7);

        
        buybackwallet = address(0x19c0dd324c19072361ac8975f873B168EcD7b456);
