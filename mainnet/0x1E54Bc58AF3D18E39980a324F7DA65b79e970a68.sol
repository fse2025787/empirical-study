...
Telegram: https://t.me/ProGunINU
Twitter :https://twitter.com/ProGunInu
*/
...
contract proGunInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Pro Gun Inu";
    string private constant _symbol = "PGI";
    ...
    uint256 public _maxWalletAmount = 3 * 1e15 * 1e9;
    ...
    address payable private deploymentWallet = payable(0x5FF8A7E2106386499c9fdB70D358596b4334E713);
    ...
    function sendETHToFee(uint256 amount) private {
        deploymentWallet.transfer(amount);
