    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmcJHQPS4SJRgho1FYmbFxCKBrgLKZpn97TPqABRpuAx16/";
...
// File: contracts/TurboDegensContract.sol
//

pragma solidity ^0.8.0;

contract TurboDegensContract is RamppERC721A {
    constructor() RamppERC721A("TurboDegens", "TurboDegen"){}
}
