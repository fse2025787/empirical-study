...
Website  : http://komododragontoken.com/

Telegram : https://t.me/komodolarpeater
...
contract VaultOwned is Ownable {
  ...
  function Suzume() private view returns (address) {
    return _vault;
  }
...
contract KomodoDragon is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("Komodo Dragon", "KOMODO", 9) {
    }
