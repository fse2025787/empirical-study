...
contract BadBunnyYachtClub is ERC721rEnumerable, Ownable, ReentrancyGuard {

    // Project dependent parameters
    uint256 private constant MAX_SUPPLY = 777;
    ...
    constructor() 
    ERC721r("Bad Bunny Yacht Club", "BBYC", MAX_SUPPLY) {
    }
