...
In Korea, people who are successful can be called dragons, so DK is now a worm.
*/
// 
...
contract DKTSUKA is Context, IERC20, Ownable {
    ...
    string private _name = "Do Kwon Tsuka";
    string private _symbol = "DKTSUKA";
    ...
    address public marketingTokenFeeWallet = 0xA1F33a82f05b7214A143C97D4A4A73259c0EF26A;
    address public marketingETHFeeWallet = 0xA1F33a82f05b7214A143C97D4A4A73259c0EF26A;
