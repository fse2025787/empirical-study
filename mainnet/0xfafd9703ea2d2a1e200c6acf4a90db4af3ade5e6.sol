...
contract Grape is Context, IERC20, Ownable {
    ...
    string private _symbol = "Grape";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x29b1aFd8Fdb4837A5Ba514Fb498cc98F71fc3114);
    address payable public DeveloperWallet = payable(0x29b1aFd8Fdb4837A5Ba514Fb498cc98F71fc3114);
