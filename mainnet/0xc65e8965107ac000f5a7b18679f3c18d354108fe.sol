...
//Telegram: https://t.me/PoseidonPortal
//Twitter: https://twitter.com/PoseidonErc
...
interface IUniswapV2Pair {
    ...
    contract Poseidon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "God of seas";
    string private _symbol = "POSEIDON";
    ...
    address payable public marketingWallet = payable(0x38b74625E3bcA74a819A4D1D089EBfaE6882293b);
