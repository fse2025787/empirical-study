...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA416758132b86dA93311D1D3cA9362f7dE9fD784];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmPVK7Uzg1Ac9VJFVVRUZVWY64xzuadMyS76kaLr1SyhmR/";
...
// File: contracts/GodLovesNfTeesOfficialContract.sol
//

pragma solidity ^0.8.0;

contract GodLovesNfTeesOfficialContract is RamppERC721A {
    constructor() RamppERC721A("God Loves NFTees Official", "GLNftees"){}
}
