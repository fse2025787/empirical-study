...
contract Nouned is IERC721A { 
    ...
    string private constant _name = "Nouned";
    string private constant _symbol = "NOUNED";
    string private _baseURI = "QmVSDckaATzPbaqqLhNrMRxdiK8drKGGMeyLnPx8oVaBJE";
