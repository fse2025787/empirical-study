...
contract CupHeadtoken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "CUPHEAD token";
    string private constant _symbol = "CUPHEAD";
    ...
    address payable public marketingWallet = payable(0x1390E07647F7ee507D70143591045B13f200e765);
    address payable public treasury = payable(0xbA25f48A3BAcBb31704e226393209101aCcb0E2c);
