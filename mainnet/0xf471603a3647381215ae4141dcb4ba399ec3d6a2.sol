...
contract IlkCurveCfg {
    ...
    function getIlkCfg() internal pure returns (SharedStructs.IlkDesc memory desc) {
        ...
        desc.ilk = "CRV_3POOL-B";
        desc.joinName = "MCD_JOIN_CRV_3POOL_B";
        desc.flipName = "MCD_FLIP_CRV_3POOL_B";
...
contract SpellActionMainnet is SpellAction, IlkCurveCfg {
    function execute() external {
        ...
        net.join = 0x6bd28e472eB7e4f751b0CC0b897fE91f7e13461d;
        net.flip = 0x02Cf9D6de480D1D152E997A27D3B825C9fFa24c0;
...
contract SpellActionKovan is SpellAction, IlkCurveCfg {
    function execute() external {
        ...
        net.join = 0x4d64655C98892288AeF165a1f40f1A2dEFbDb789;
        net.flip = 0x566f3de5D4042e5D99375E5F87095C998440cC28;
        net.pip = 0x9A4A1F58939A59AbE65f9D71d98EdD213b9Ab441;
        net.CHANGELOG = ChainlogAbstract(0x873396d69b017e3Ed499406892E1cd2f3EE1CFA7);


        execute(getIlkCfg(), net);

        net.CHANGELOG.setVersion("1.3.0");
    }
}
