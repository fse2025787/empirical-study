...
contract AkirameruTjuka is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Akirameru Tjuka", "$AT") {
        ...
        maxWallet = totalSupply * 2 / 100; // 4% maxWallet
    	...
    	marketingWallet = address(0x2171c82C3cF9FdD7Fe9ED2E6F3D7c886D8D73e7B); // set as marketing wallet
    	devWallet = address(0x2171c82C3cF9FdD7Fe9ED2E6F3D7c886D8D73e7B); // set as dev wallet
