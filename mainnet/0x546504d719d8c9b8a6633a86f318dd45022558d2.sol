...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xfB81eFe125A250B52ff1c40FFBD0a47B926Ff552];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRkxcrGAbAN23bn5ygSzPzqaPtZ3GE1EbC3XZnwHcw7Qc/";
...
// File: contracts/PepeTrumpsContract.sol
//

pragma solidity ^0.8.0;

contract PepeTrumpsContract is RamppERC721A {
    constructor() RamppERC721A("PepeTrumps", "PEPE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/5p8wFLjJ4VBgilnAfZAc/contract-metadata";
    }
}
