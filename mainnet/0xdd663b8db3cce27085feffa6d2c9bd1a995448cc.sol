...
contract Hdmoonbirds is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("HD Moon Birds", "HDMB") OperatorFilterer(address(OSlist), false) {
  ...
  function xtract() external onlyOwner{
