...
contract HapuNft is ERC721A, Ownable {
    uint256 MAX_MINTS = 30;
    uint256 MAX_SUPPLY = 11070;
    uint256 public mintRate = 0.00369 ether;
    bool public saleEnable = false;


    // Royalties address
    address public royaltyAddress = 0x505184CFBf416016e4EF0d2291C5097a48722fF0;
  ...
  uint256 private royaltyBasisPoints = 100; // 10%
    ...
    event MintedNft(uint256 indexed _quantity);

    string public baseURI ="ipfs://bafybeiafko3bin7mbzw5oa4zsx6zvneievqra6jkn424nmeaac5yukwwiq/";
