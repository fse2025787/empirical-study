...
contract PunksRocks is IERC721A { 
    ...
    uint256 public constant TEAM_MINT_SUPPLY = 5;
    ...
    string private constant _name = "Punks Rocks";
    string private constant _symbol = "PURO";
    string private constant _contractURI = "ipfs://QmYHj7xnZQ6R1bbYr9AjfRogfMQjHQmwv79Tm44RPZVzoV";
    string private _baseURI = "ipfs://QmVjEpGX2XYA8KtsSbkmQqW6F9mGP2SzD227Qa965c5ZcU/";
...
*/
    ...
    function mint(uint256 _amount) external payable{
        ...
        require(totalSupply() + _amount <= MAX_SUPPLY, "SoldOut");
        require(_amount <= MAX_BUY_PER_TX, "TxLimit");
