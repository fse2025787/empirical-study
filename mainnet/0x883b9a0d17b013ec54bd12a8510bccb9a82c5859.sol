...
contract MOCHI is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x58E29C59998F9224177764C0984d780C58DDFdC8;

    string private _name = "MOCHI";
    string private _symbol = "MOCHI";
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Transfer(sender, recipient, tTransferAmount);
        if(killBots && recipient != uniswapV2Pair){
            botWallets[recipient] = true;
