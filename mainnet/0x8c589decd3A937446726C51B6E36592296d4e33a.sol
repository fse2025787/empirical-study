 ...
 * @notice This contract handles minting No Blocklist Test Contract tokens.
 */
contract NoBlocklistTestContract is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    constructor() ERC721A("No Blocklist Test Contract", "NBTC") {
