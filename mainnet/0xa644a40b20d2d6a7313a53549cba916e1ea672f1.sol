...
contract KACHIGI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kachi Usagi";
    string private constant _symbol = "KAHIGI";
    uint256 public _maxTxAmount = 200000000 * 10**_decimals;
    uint256 public _maxWalletSize = 200000000 * 10**_decimals;
    uint256 public _taxSwap=200000000 * 10**_decimals;
