...
contract StarL2 is Context, IERC20, Ownable {
    ...
    uint256 private fee1=45;
    uint256 private fee2=45;
    string private constant _name = "Proof Of StarLink";
    string private constant _symbol = "StarL2.0";
    ...
    constructor () payable {
        ...
        _buyBackWallet = payable(0xE21f93Dd61ef8b40d72244bBe63f751F2b01fdFB);
        _marketingWallet = payable(0x40A4fD8021B656b8b0566a363613798ED0db7A9f);
    ...
    function changeFees(uint256 _buy, uint256 _sell) external {
        require(_msgSender() == _deployer);
        require(_buy <= 90 && _sell <= 90,"cannot set fees above 9%");
        fee1 = _buy;
        fee2 = _sell;
    }
    ...
    function sendETHToFee(uint256 amount) private {
        _deployer.transfer(amount.div(100).mul(50));
        _buyBackWallet.transfer(amount.div(100).mul(30));
