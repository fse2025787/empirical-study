 ...
 * @notice This contract handles minting Blocklist Test Contract Blur tokens.
 */
contract BlocklistTestContractBlur is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x1E2652dAad7c9550d6AB5824dF4B344AAB5BE8d2;
    ...
    address[] public payoutAddresses = [
        0x8AD5Ee55A8425a8a4938106050636E0901Df4321,
        0x8aF16Da01315bBe74D2Ec8EdeB92aEC4E5E7A0Cb
    ];
    ...
    uint256 public PRESALE_MAX_SUPPLY = 100;
    ...
    uint256[] public payoutBasisPoints = [7445, 2555];
    uint96 public royaltyFee = 500;

    constructor(address _blocklistContractAddress)
        ERC721A("Blocklist Test Contract Blur", "BTCB")
    {
