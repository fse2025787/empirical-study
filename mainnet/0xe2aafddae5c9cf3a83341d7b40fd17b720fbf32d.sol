...
contract LOWGAS is ERC721A, Owneable {

    string public baseURI = "https://ipfs.io/ipfs/QmUNDJuNKNmMQk1Z3GRoPsEdzZhktQKabFvP4RMyPFM5G2/";
    string public contractURI = "ipfs://QmaPefoxHsChiEDHV8kkhnEKZV9JQuKngk6dhu3AYmrv68/";
    string public constant baseExtension = "";
    address public constant proxyRegistryAddress = 0xa85f0FaFB318B4025De9Ac0c27a7c37a44dd9c3b;

    uint256 public constant MaxPerTxFree = 3;
    uint256 public constant FreeMaxSupply = 99;
    ...
    constructor() ERC721A("Dragon Z Apes Alfa Club", "DZA") {}
