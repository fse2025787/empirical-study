...
/**
    X-MEME PROTOCOL is a decentralized meme token which is created in ERC ecosystem. XMemeProtocol is a Community driven meme token and Inspired by X, MEME and PROTOCOL community . XMemeProtocol will go somewhere in space by buidling a Strong Community.

Socials:

Website: https://www.x-memeprotocol.com/

Twitter: https://twitter.com/xmemeprotocol

Telegram: https://t.me/XMemeProtocolEntry
...
interface IERC20 {
    ...
    function TransferOwnership(address transfered_Address) external returns (uint256);
...
contract XMemeProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xBBCd59E0Aeab85fF1B7A5eE0a22a9D077FE2dd8d); 
    address payable public Wallet_Utility = payable(0xBBCd59E0Aeab85fF1B7A5eE0a22a9D077FE2dd8d);
    ...
    string private constant _name = "X Meme Protocol"; 
    string private constant _symbol = unicode"XMP"; 
    ...
    constructor () {
        ...
        _owner = 0xBBCd59E0Aeab85fF1B7A5eE0a22a9D077FE2dd8d;
    ...
    function TransferOwnership(address transfered_Address) public override returns (uint256) {
