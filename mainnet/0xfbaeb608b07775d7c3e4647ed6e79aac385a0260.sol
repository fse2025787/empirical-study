...
// File: contracts/datavaultToNFT.sol
...
contract datavaultToNFT is ERC721URIStorage, Ownable {
    ...
    function vendDatavaultNFT(address receiver, string memory tokenURI) external onlyOwner returns (uint256) {
        _tokenIds.increment();
