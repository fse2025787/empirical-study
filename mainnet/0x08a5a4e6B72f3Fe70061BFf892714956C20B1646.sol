...
contract Etheriumerc is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Etherium";
    string private constant _symbol = unicode"ETHERIUM";
