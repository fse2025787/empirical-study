...
contract TIY is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "TRADE IT YOURSELF";
    string private constant tokenSymbol = "TIY";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xDc45C577f92a961CEEdDD3eCa41110B4fc00A59A);
        devAddress = payable(0xF44350698a4d0d881826aE8fC2bf7bDdD1D00dbf);
