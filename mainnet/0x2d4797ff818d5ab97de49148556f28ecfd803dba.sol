...
contract TWICETH is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TWICE ETHEREUM";
    ...
    address payable private _developmentAddress = payable(0xc610189a3f517577887151baD9DaCdF6D144A870); 
    address payable private _marketingAddress = payable(0xc610189a3f517577887151baD9DaCdF6D144A870);
