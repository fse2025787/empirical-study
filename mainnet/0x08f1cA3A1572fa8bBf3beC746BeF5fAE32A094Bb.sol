...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1040E0c82314c349032a78A3D6dB4F058BEbA95B];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 3666 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPrfjSjRweQ5a19mZZ8ykU5xCyWccjyMbwt4pRYkEyYzZ/";
...
// File: contracts/DevilmayCryContract.sol
//

pragma solidity ^0.8.0;

contract DevilmayCryContract is RamppERC721A {
    constructor() RamppERC721A("Devil may Cry", "Doom"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/jFbw79q3RifhXi2XZ76J/contract-metadata";
    }
}
