...
/**
"If you leave your game, stay safe, stay alert, and whatever you do, DON'T DIE, because if you die outside, your own, you don't regenerate ! EVER!Game over!"

https://twitter.com/elonmusk/status/1543046254397009922?s=28&t=2D2cGY-WOTv6Pp6Xk8FIWQ
Max buy：2%
Max wallet: 3%
Tax:8%
lock 7 days first, every 50 holdrs extend 7 days, 100 holders 4% Tax, 200 holdrs 0 Tax
https://twitter.com/Erc_DONTDIE
*/
...
contract WISEWORDS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Wise Words", "DONTDIE") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xAaeD4DeD01d716059fb4BF72d8A7ADD6A031c568); // marketing wallet
        devWallet = address(0xAaeD4DeD01d716059fb4BF72d8A7ADD6A031c568); // dev wallet
