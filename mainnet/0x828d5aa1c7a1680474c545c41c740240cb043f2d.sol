...
contract FOMO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSBwJAbeYfTBX9PgA1uHywtq6KERjqJrJseLnhUUjE76j";
    ...
    constructor(
    ) ERC721A("Genesis: FOMO Pass", "FOMO", 100, maxSupply) {
    }
