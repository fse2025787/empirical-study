...
contract WhiteList is Ownable, EIP712 {
    ...
    constructor() EIP712("CrockzWhiteList", "1") {}
...
contract PreSales is Ownable {
    ...
    constructor() {
        //22-11-23 11:00:00 EST == 22-11-23 13:00:00 GMT-3 at this site https://www.epochconverter.com/
        preSalesStartTime = 1669219200;
        //22-11-23 13:59:59 EST == 22-11-23 15:59:59 GMT-3 at this site https://www.epochconverter.com/
        preSalesEndTime = 1669229999;
    }
...
contract PublicSales is Ownable {
    ...
    constructor() {
        //22-11-23 14:00:00 EST == 22-11-23 16:00:00 GMT-3 at this site https://www.epochconverter.com/
        publicSalesStartTime = 1669230000;
    }
...
contract Crockz is Ownable, PublicSales, PreSales, WhiteList, ERC721A, PaymentSplitter, DefaultOperatorFilterer{

    //FOR PRODUCTION
    uint256 public constant TOTAL_MAX_QTY = 5555;
    uint256 public constant PRESALES_MAX_QTY = 5000;
    uint256 public constant GIFT_MAX_QTY = 25;

    uint256 public constant SALES_MAX_QTY = TOTAL_MAX_QTY - GIFT_MAX_QTY;
    uint256 public constant PRE_SALES_PRICE = 0.022 ether;
    uint256 public constant PUBLIC_SALES_PRICE = 0.033 ether;
    ...
    0x766Eae81E10E9c8D9945Eda44bFE7D1bC81989cC,
    0x02A8D960944aC47e655198171093E22570A48188
    ];

    uint256[] private shareList = [15,85];
    ...
    uint256 public custom_price = 0.033 ether;
    bool public customPriceWl = false;
    uint256 public custom_price_wl = 0.022 ether;

    string private baseTokenURI;
    string private notRevealedUri;

    constructor(string memory _notRevealedUri) ERC721A("Crockz", "CROCKZ") PaymentSplitter( addressList, shareList) {
