...
// 
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"Golly Ghosts", unicode"bOoOoOoOoOoOoOoOoOoOo", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/170266fe-dc37-48b8-8024-1c60040d186a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/170266fe-dc37-48b8-8024-1c60040d186a", "", 500, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");

        constructor() ERC721A(unicode"Golly Ghosts", unicode"BOO") {
            TIERS[0] = [4,7,18,19,21,27,46,48,62,72,88,88];
TIERS[1] = [79,104,128,189];
TIERS[2] = [16,32,35,84,99,107,127];
TIERS[3] = [8,17,27,61,72,91,109,115];
TIERS[4] = [16,30,37,62,71,87,90,107];
