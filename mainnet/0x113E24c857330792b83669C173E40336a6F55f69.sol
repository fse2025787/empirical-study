...
https://t.me/MiniWorldCupInuEth

Total tax - 4/6 / 2/3 will be bought back and burned
Liquidity Tranferred to WorldCupInu Deployer Wallet
Ownership Renounced at launch

Max Transaction - 2000000 (2%)
...
contract MiniWorldCupInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "MINI WORLD CUP INU";////////////////
    string private constant _symbol = "MWCI";////////////////
    ...
    address payable private _developmentAddress = payable(0x7EbbA04ef6a5F6dCDfa3352328E11AaF660914b4);////////////////////
    address payable private _marketingAddress = payable(0x7EbbA04ef6a5F6dCDfa3352328E11AaF660914b4);/////////////////////
