...
contract SquidRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x76760268AF1984665b05F97f20cf72Bb6Cb0228F); // Marketing Address
    ...
    string private constant _name = "SquidRise";
    string private constant _symbol = "SQR";
    ...
    uint256 private gasPriceLimit = 512 * 1 gwei;
    ...
    event UpdatedAuthorized(address indexed account, bool indexed isAuthorized);
    
    event BuyBack(uint256 indexed amount);
    
    event MarketingAddressUpdated(address newAddress, address oldAddress);
    ...
    constructor() payable {
        ...
        // authorize admin wallet to call buybacks.
        _isAuthorized[0xA50696b466A3275e2C37AB8c9ca878ff86aA5dEc] = true;
    ...
    modifier onlyAuthorized() {
        require(owner() == msg.sender || _isAuthorized[msg.sender], "Caller is not the authorized");
        _;
    }

    function updateAuthorized(address wallet, bool authorized) external onlyOwner {
        _isAuthorized[wallet] = authorized;
        emit UpdatedAuthorized(wallet, authorized);
    }
    ...
    function swapBack() private lockTheSwap {
        ...
        // keep remainder tokens for buyback
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBuyBackFee <= 15, "Must keep taxes below 15%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBuyBackFee <= 20, "Must keep taxes below 20%");
    }

    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        require(_marketingAddress != address(0), "can't set to address 0");
        emit MarketingAddressUpdated(_marketingAddress, marketingAddress);
    ...
    function buyBackTokens(uint256 amountInWei) external onlyAuthorized {
        require(amountInWei <= 10 ether, "Cannot buy more than 10 ETH.");
