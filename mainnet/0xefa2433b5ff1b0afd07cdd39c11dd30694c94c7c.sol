...
// 
/**
The Krasue is a nocturnal spirit of Southeast Asian folklore. It manifests itself as a woman, usually young and beautiful, with her viscera hanging down from the neck, trailing below the head. Thr Krasue consists of a floating head accompanied by a will-o'-the-wisp kind of glow. The explanations attempted about the origin of the glow include the presence of methane in marshy areas. The Krasue is often said to live in the same areas as Krahang, a male spirit of the Thai folklore.

https://t.me/KrasueKrahailueat
...
contract KRASUE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Krasue Krahailueat";
    string private constant _symbol = "KRASUE";
