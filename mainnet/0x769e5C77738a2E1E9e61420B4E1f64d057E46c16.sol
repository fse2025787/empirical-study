...
contract IyusdiCollectionsV3 is IyusdiCollectionsV3Base {
  ...
  constructor (address _protocol, uint256 _protocolMintPercent, uint256 _protocolBurnPercent, uint256 _curatorMintPercent, uint256 _curatorBurnPercent) {
    require(_protocol != address(0), '!protocol');
    require(_protocolMintPercent + _curatorMintPercent <= IyusdiCollectionsV3Base.PERCENT_BASE, '!mintPercent');
    require(_protocolBurnPercent + _curatorBurnPercent <= IyusdiCollectionsV3Base.PERCENT_BASE, '!burnPercent');
    owner = msg.sender;
    protocol = _protocol;
