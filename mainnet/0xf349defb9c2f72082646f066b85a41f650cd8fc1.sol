...
contract CryptBitAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CryptBitAI";
    ...
    address payable private _developmentAddress = payable(0x4819FE14EBbD8C937502A401c425764897B3526C); 
    address payable private _marketingAddress = payable(0x4819FE14EBbD8C937502A401c425764897B3526C);
