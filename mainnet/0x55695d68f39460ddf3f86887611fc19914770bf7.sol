...
contract AssetBackingCryptoCurrency is CappedToken(300000000000000000000000000) {
  string public name = "Asset Backing Crypto Currency";
  string public symbol = "ABCC";
  uint8 public decimals = 18;

  
  constructor() public {
    _mint(msg.sender, 75000000000000000000000000);
  }
  ...
  uint256 endDate = 1533024000;
  uint256 startDate = 1530518400;
  ...
  function buyTokens() public payable {
    ...
    uint256 bonusPercentage = 15;
    
    if (now > 1533024000) bonusPercentage = 0;
