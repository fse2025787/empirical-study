...
contract REPLACE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Replace";
    ...
    uint256 private _maxTxAmount = 20000 * 10**9;//2%
    uint256 private _maxWalletSize = 30000 * 10**9;//3%
