...
contract BeepBoopz is ERC721 , DefaultOperatorFilterer {
    uint256 public totalSupply;
    uint256 public cost = 0.0033 ether;
    uint256 public maxMints = 30;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidegi7xy3j33yhla3mgdq22ikzmyeptacz3o5tmpbmgdyvrkxgvka/", Strings.toString(tokenId), ".json")
            );
    }
