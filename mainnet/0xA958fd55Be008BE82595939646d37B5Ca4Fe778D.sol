...
contract KergomMace is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public whitelistAddressLimit = 4;
  uint256 public publicAddressLimit = 20;
  ...
  constructor() ERC721("Kergom of Olrend Mace", "SOA") {
    setHiddenMetadataUri("ipfs://QmaDNdLLUAW41YK6YNgVxZ3HvHWxj9JvNN6Kb8CoC7JBa7/kergom.json");
  }
