...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract HustlersMarketPass is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmU7jwNYtxSzfbNeAHtTaHwWnykqnwU11jtb5f1DunYppv/";
  string private uriSuffix = ".json";
 

  uint16 public constant maxSupply = 8000;
  ...
  bytes32 public whitelistMerkleRoot = 0x7e00bf1322941382c1009b87d1a7b45c9d2da6100a02cc608f41c183c7153a63;
  

  constructor() ERC721A("Hustlers MarketPass", "Hustlers MarketPass") {
  }
  ...
  function mint(uint8 _mintAmount) external  {
    ...
    uint8 _txPerAddress = NFTPerAddress[msg.sender];
     require (_txPerAddress + _mintAmount <= maxMintAmountPerWallet, "Exceeds max nft limit per address");
 ...
 function setMaxNftLimitPerAddress(uint8 _limit) external onlyOwner{
