...
THE ONLY OFFICIAL ZYZZ TOKEN! JOIN THE LEGACY!

LEGENDARY MEME. ICONIC LEGACY.

www.zyzztoken.io
www.twitter.com/ZYZZTOKEN
www.t.me/zyzztokenportal
...
contract ZYZZ is ERC20, Ownable {
    // -- Mappings --
    ...
    string constant _name = "ZYZZ";
    string constant _symbol = "$ZYZZ";
    ...
    address public treasuryReceiver = 0xd22c00a64eB61b264f6E342B37A0A504e6BfC7F2;
    address public marketingReceiver = 0xc5bA4C8442Bd2154F9e522D67c3D9BAB936B3a28;
    ...
    constructor () Ownable(msg.sender) {
        ...
        buyFee.liquidityFee = 20; buyFee.treasuryFee = 30; buyFee.marketingFee = 30;
        buyFee.total = buyFee.liquidityFee + buyFee.treasuryFee + buyFee.marketingFee;

        // Set Initial Sell Fees -- Base 1000 Set 10 for 1%
        sellFee.liquidityFee = 30; sellFee.treasuryFee = 110; sellFee.marketingFee = 110;
