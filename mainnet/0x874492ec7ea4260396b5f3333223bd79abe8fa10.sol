...
contract MundaneAI is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "ipfs://QmPbcf3S94dAxRADeyAnWPpADqt2DgukjxAJtRBwNn75te/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("MundaneAI", "mAI") {
        setHiddenMetadataUri("ipfs://__CD__/hidden.json");
    }
