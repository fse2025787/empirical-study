 ...
 * allowances. See {IERC20-approve}.
 */
contract ProofOfDefi is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Proof Of Defi";
    string private _symbol = "POD";
    uint8 private _decimals = 9;
    uint256 private _supply = 900000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 4;
    uint256 public maxTxAmount = 18000000 * 10**_decimals;
    uint256 public maxWalletAmount = 18000000 * 10**_decimals;
    address public marketingWallet = 0xb8a737C72D5850E60aA8bc52aAC5EE26ba04C8eD;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 8987649 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 4379385 * 10**_decimals;
