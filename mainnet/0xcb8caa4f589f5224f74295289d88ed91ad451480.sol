...
//momoMOMOmomo ERC721A CONTRACT
//3050 animated momoMOMOmomomomMOMOMOMOMOMOMOmomo, 0.03 ether per momo
/**
...
contract momoMOMOmomo is Ownable, ERC721A {

    uint256 public adoptionLimit =25;
    using Strings for uint256;

    mapping(uint256 => string) private _tokenURIs;
    bool public publicSaleOpen = false;
    string public baseURI = "ipfs://QmTBkfKXTrxJpC18YhCxorYtPYF2GqQ6dHvM3GWiXHzBQA/";
    string public _extension = ".json";
    uint256 public price = 0.03 ether;
    uint256 public maxSupply = 3050;

    constructor() ERC721A("momoMOMOmomo", "MOMO"){}
