...
https://t.me/ArtemisMoonMission 

Artemis  is another Moon goddess, and was thus regarded as one of the most prominent lunar deities in mythology Artemis has now joined to crypto space. Her missions aim to "land the first woman and first person of colour on the Moon".
...
contract ProjectArtemis is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Project Artemis ";
