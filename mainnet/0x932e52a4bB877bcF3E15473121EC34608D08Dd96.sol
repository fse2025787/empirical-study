...
// File contracts/TheRameniers.sol
...
contract TheRameniers is ERC721, Ownable {  
    using Address for address;
    ...
    // Price of each token
    uint256 public PRESALE_MINT_PRICE = 0.10 ether;
    ...
    uint256 private totalTeam;

    constructor () ERC721 ("The Rameniers", "WAGER") {
    }
    ...
    function mint() public payable {
        ...
        require(mintIndex < MAX_SUPPLY, "Sale sold out");
        require(msg.value >= MINT_PRICE, "Wrong amount of ETH sent.");
    ...
    // Presale minting
        ...
        uint256 mintIndex = _tokenSupply.current() ;
        require(mintIndex < MAX_PRESALE_SUPPLY, "Presale sold out");
        require(msg.value >= PRESALE_MINT_PRICE, "Wrong amount of ETH sent.");
    ...
    // Admin minting function to reserve tokens for the team, collabs, customs and giveaways
        function mintReserved() public onlyOwner {
        uint256 mintIndex = _tokenSupply.current() ;

        totalTeam = totalTeam+1;
        require(totalTeam <= RESERVED, "No more for the team");
...
// ============ OWNER-ONLY ADMIN FUNCTIONS ============
    ...
    // Set a different preprice in case ETH changes drastically
    function setPresalePrice(uint256 newPrice) public onlyOwner {
        PRESALE_MINT_PRICE = newPrice;
    }
