...
// File: contracts/DoodleRareApepeYC.sol
...
contract DoodleRareApepeYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2647;
  ...
  ) ERC721A("Doodle Rare Apepe YC", "DRAYC") {
