...
contract BigDegenCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Big Degen Capital DAO";
    string private constant _symbol = "BDC DAO";
    ...
    address payable public marketingWallet = payable(0xe9D69E42A78FEB8D5C336534E13b6dB2B7449152);
    address payable public treasury = payable(0x5C06b9BB656876c105C58723adD41c525819606B);
