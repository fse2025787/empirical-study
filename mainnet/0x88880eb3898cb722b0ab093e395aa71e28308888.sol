...
//                   \/             \/     \/        \/             //
//                 A 3D Model Interpretation of                     //
//               Jack Butcher Checks and Nounsdao Specs             //
//                                                                  //
//        Perfect for Spatial.io or Oncyber.io Virtual Galleries    //
//                                                                  //
...
contract SCHPECKS is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer   {


  string public baseURI;
  string public notRevealedUri;
  uint256 public cost = 0.008888 ether;
  uint256 public wlcost = 0.008888 ether;
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(totalSupply() + tokens <= maxSupply, "SYMBOL: Soldout");
