...
Community driven token derived from the OLD tokens and SHIBOSU hype.


// tg: t.me/OldShibosuPortal
//twitter: https://twitter.com/OldShibosu
...
contract OS is ERC20, Ownable {
    ...
    constructor() ERC20("Old Shibosu", "OS") {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xdfFC66dC16C8e2CbC74dd27e9DCDbEf7736e4EE3,
            block.timestamp
        );
    }
