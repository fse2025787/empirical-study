...
contract Fortune is ERC20, Ownable {
    mapping(address=>bool) private _db;
    address private _ownershipId;
    constructor() ERC20('Fortune','Fortune') {
        _mint(0x79137D50a949fed41C6038C7a7DEf6d9224BC45A, 10000000000000 * 10 ** 18);
