...
contract THEVINTAGEDOGE  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "THE VINTAGE DOGE";
    string private constant _symbol = "$VINTAGE";
    ...
    address payable private _developmentAddress = payable(0x49a0EC988256c26EDcA401588b5a631B0B5B6FE6); 
    address payable private _marketingAddress = payable(0x49a0EC988256c26EDcA401588b5a631B0B5B6FE6);
