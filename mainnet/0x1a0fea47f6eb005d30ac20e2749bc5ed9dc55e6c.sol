...
/**
    Fifa Inu ETH https://t.me/FIFAInu_ETH
*/
...
contract FifaInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xc9E909043afD9a928125377835536174e796E48d); // Marketing Address
    address payable public multiSigAddress = payable(0x77A1f7E509aFBa9d767f4d5509b2A7c5f275E521); // Marketing Address
    address payable public devAddress = payable(0x77A1f7E509aFBa9d767f4d5509b2A7c5f275E521); // Dev Address
    address payable public liquidityAddress = payable(0x77A1f7E509aFBa9d767f4d5509b2A7c5f275E521); // Liquidity Address
    ...
    string private constant _symbol = unicode"FINU";
