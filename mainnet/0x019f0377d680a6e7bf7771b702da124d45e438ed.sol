...
// https://t.me/Shiba_Enew

// When Shiba Inu was first introduced, there was much debate about how to spell "Inu" Many favored the more dominant E-New.
...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA E-NEW";
    string private _symbol = "SHIBA E-NEW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x815E94D014113d04C6B4b15F0d98F39f70471f10); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x08Aa387394aD6516855453886150110d853E8d5e); // BuyBack Address
