...
contract DogeDough is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeDough"; // 
    string private constant _symbol = unicode"DOUGH"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xFA65021F77726046e0DB4E5553F36c14a73eF67C).transfer(ethToSend); //marketing wallet
    }
