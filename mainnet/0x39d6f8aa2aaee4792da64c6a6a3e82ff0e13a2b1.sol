...
First 10 people in Telegram will receive all gas fees in eth.
...
contract GUZZI is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "GUZZI";
    string private _symbol = "GUZZI";
    ...
    uint256 private _totalSupply = (50000000 * 10**4) * 8**_decimals; //1T supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0x2F7c6aED7f696662fbb588016F67C97DE84020EC);
    ...
    uint256 GUZZITIMEcooldown = 0;
    bool private tradeEnabled = false;

    
    uint256 private sellliqFee = 3;
    uint256 private sellprevLiqFee = 6;
    ...
    function GUZZITIME() public onlyOwner{
         require(block.timestamp > GUZZITIMEcooldown, "You cant call GUZZITIME more than once per day");
    ...
    function GUZZITIMEOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         GUZZITIMEcooldown = block.timestamp + 86400;
    }
