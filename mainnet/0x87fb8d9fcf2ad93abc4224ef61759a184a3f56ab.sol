...
contract Floki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8f3D7E22cf1C170f4887bd829F847ef6eE9a1e10); // Marketing Address
    ...
    string private _name = "Floki Inu";
    ...
    uint256 private minimumTokensBeforeSwap = 2000 * 10**6 * 10**9; 
