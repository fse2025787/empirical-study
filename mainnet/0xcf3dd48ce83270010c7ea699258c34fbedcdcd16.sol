...
.)\)\\_(((\),:::::;
 `\`._,)))))::::::`,
   `.__/(((:::::::'
    ...
    A story (as for children) involving fantastic forces and beings. Let these creatures called fairies and wizards give us good fortune in the coins yet to come.
    A fairy called Elvenia has made sure to make this contract as safe as it could be by casting a magical spell.
        > Updating the maximum transaction amount/wallet has been removed for safety reasons.
        > The fees can't be changed or set higher (locked at a maximum of 10%).
        > Removed some blacklisting related functions so that can't be used on the pair/contract address.
...
contract PussInBoots is ERC20, Ownable {
    ...
    constructor() ERC20("Puss In Boots", "FAIRYTALE") {
    ...
    function StartFairytale(uint256 _percent) external onlyOwner payable {
    ...
    } // Won't be having any form of block ban
    ...
    function updateFees(uint256 marketingFee, uint256 liquidityFee) external onlyOwner {
        ...
        _liquidityFee = liquidityFee;
        totalFees = _marketingFee + _liquidityFee;
        require(totalFees <= 10, "Must keep fees at 10% or less"); // Basicly can't ever set the fees to more than 10%.
    }
