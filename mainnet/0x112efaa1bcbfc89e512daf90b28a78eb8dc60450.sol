...
contract WorldCupZilla is Context, IERC20, Ownable {
    ...
    string private constant _name = "World Cup Zilla";
    string private constant _symbol = "WCZ";
