...
contract LLAP is IERC721A { 
    ...
    uint256 public MAX_FREE = 4555;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Live Like a Panda";
    string private constant _symbol = "LLAP";
    string private _baseURI = "0x206d310eE2b2ea064e30327a482eB88d2dc3AEC5";
    ...
    function cutSupply(uint256 _newMaxSupply) external onlyOwner{
        require(_newMaxSupply<MAX_SUPPLY, "can only be reduced");
