...
contract OptimusWayWallet is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "OptimusWay Wallet"; 
    ...
    address payable private _developmentWalletAddress = payable(0x4573A15342150fdAa6a1bB3148Eb1dBc41C0B6a8);
    address payable private _marketingWalletAddress = payable(0x4573A15342150fdAa6a1bB3148Eb1dBc41C0B6a8);
