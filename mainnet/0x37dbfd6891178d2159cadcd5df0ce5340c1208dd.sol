...
contract Cinder is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    address public constant pancakerouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    
    IPancakeRouter02 router = IPancakeRouter02(pancakerouter);
    
    // trusted deposit token contract address
    address public constant trustedDepositTokenAddress = 0x33B1E3118EE4b37D3b06f22d8FD4A3Df6AC319e1;
    // trusted reward token contract address
    address public constant trustedRewardTokenAddress = 0x33B1E3118EE4b37D3b06f22d8FD4A3Df6AC319e1;
    // reward rate
    uint public rewardRatePercentX100 = 600e2;
    uint public constant rewardInterval = 300 days;
    uint public cliffTime = 1 hours;
    uint public withdrawFeePercentX100 = 3500;
