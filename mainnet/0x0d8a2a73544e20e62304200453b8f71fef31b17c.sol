...
contract FlowTokFlash is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function FlowTokFlash() {
        ...
        name = "FlowTokFlash";                                   // Set the name for display purposes (CHANGE THIS)
