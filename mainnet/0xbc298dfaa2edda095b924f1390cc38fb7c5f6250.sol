...
contract NezukoInu is Context, IERC20, Ownable {
    ...
    string private _name = "Nezuko Inu";
    string private _symbol = "NEZUKO";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 9; //(3% liquidityAddition + 2% rewardsDistribution + 3% devExpenses)
