...
contract HOP is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 20;
    ...
    constructor(string memory initBaseURI) ERC721A("HipHopools", "HOP") {
        baseURI = initBaseURI;
    }
