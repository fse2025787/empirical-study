    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function preMint() external onlyRole(DEFAULT_ADMIN_ROLE){
        require(isPreMinted == false, "Pina Dao: already minted");
        isPreMinted = true;

        // initial permanent LP, 10k
        mintToAccount(0x6E26579BB9b04eA358524F2AAefAf3a82dEFDaE5, 10000e18); // 10K pina

        // initial lp contributor rewards, 10k 
        mintToAccount(0x73f2e04F047931E85b62E4f2652B156199000E14, 1000e18); // 1K pina
        mintToAccount(0x4f714880A5847D335606bb37848CcAcbcD6d5836, 1000e18); // 1K pina
        mintToAccount(0xcD815B9302bC6a828294CE6aa7C353B206997A4e, 2500e18); // 2.5K pina
        mintToAccount(0xcf88FA6eE6D111b04bE9b06ef6fAD6bD6691B88c, 1000e18); // 1K pina
        mintToAccount(0x1Af26c320F1598A6f447256dD75C3F34d736079f, 1000e18); // 1K pina
        mintToAccount(0x2601016888f03371603BE1764dA00264599b42D3, 2500e18); // 2.5K pina
        mintToAccount(0xe8B07A320A0b7BF7eb6Cf8A0E6C72B53a4139236, 1000e18); // 1K pina

        // early suporters rewards, 1.2k total
        mintToAccount(0x4e8b694141d4dF9bF69Cb97788e21B6b3a58CeC5, 100e18); // 100 pina
        mintToAccount(0x419dc23983E1E7d3cC15AdC297e493262e667dF2, 100e18); // 100 pina
        mintToAccount(0x8c49C1D07579d778CAe5a567E77E5eE242169917, 100e18); // 100 pina
        mintToAccount(0xfBDDA7f8a0225eb20bE517349981795d6873b3d7, 100e18); // 100 pina
        mintToAccount(0x6761BcAF2b2156C058634D9772F07374D6eDeF1d, 100e18); // 100 pina
        mintToAccount(0x9488a609E2D3307ad25326A6aDF72e78804d5596, 100e18); // 100 pina
        mintToAccount(0x58024B6C1005dE40eAC2D4c06bC947ebf2a302Af, 100e18); // 100 pina
        mintToAccount(0xb3397A6FeEdff2b9fCe9Ca1086CB1Bdd617c16Bf, 100e18); // 100 pina
        mintToAccount(0x0E50dA617197bAAD40804c95C25A8B0172d25d5f, 100e18); // 100 pina
        mintToAccount(0x478c9BEF4702ca6758F3eD760a51677f74813DF5, 100e18); // 100 pina
        mintToAccount(0x5C25BCBA2339F4b0b5f89a61ec87Ec9831c09e45, 100e18); // 100 pina
        mintToAccount(0xBA29bF8046D46D687Dc00f09caddB0C83540CaEB, 100e18); // 100 pina
    }
