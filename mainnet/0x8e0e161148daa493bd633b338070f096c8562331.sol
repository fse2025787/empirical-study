...
XENGEM's goal is to connect experienced players from around the world and create a pool of gem minting, 
a cryptocurrency asset like no other. It will reward players with equity as they perform their tasks.
A fair starting point, we will launch today, a fair deal and it will gain unlimited participants in the cryptocurrency market.

https://t.me/xengemeth
...
contract XENGEM is Context, IERC20, Ownable { 
    ...
    string private constant _name = "XENGEM";
    string private constant _symbol = "XENGEM";
