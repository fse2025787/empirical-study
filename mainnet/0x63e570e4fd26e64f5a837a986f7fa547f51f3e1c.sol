...
contract TAKANOME is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Takanomē";
    string private constant _symbol = unicode"$TAKA";
    ...
    address payable private _developmentAddress = payable(0xcF4C85Eb370eD029287920d95Ef9Ec4184bb5962);
    address payable private _marketingAddress = payable(0xcF4C85Eb370eD029287920d95Ef9Ec4184bb5962);
