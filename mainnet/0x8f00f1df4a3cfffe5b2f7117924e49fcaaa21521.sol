...
controlling the ripening of crops which were worked by man. 
Because of the life-giving qualities of the sun the Egyptians worshiped the sun as a god. 
The creator of the universe and the giver of life, the sun or Ra represented life, warmth and growth. 
Since the people regarded Ra as a principal god, 
creator of the universe and the source of life, he had a strong influence on them, 
which led to him being one of the most worshiped of all the Egyptian gods and even considered King of the Gods.
...
contract MightOfRa is Context, IERC20, Ownable {
    ...
    string private constant _name = "Might of Ra";
    string private constant _symbol = "MORA";
    ...
    uint256 public _maxWalletSize = 4000000 * 10**8;
