...
contract ArtCircle is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmU2Yxjb93oVekV2KQysbUb9JyGXTsZoBpHkSH2E5f8eUY";
    ...
    constructor(
    ) ERC721A("Art circle", "ArtCircle", 100, maxSupply) {
    }
