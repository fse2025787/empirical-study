...
contract Meteor is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function updateBuyFees(uint256 _devFee, uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
        buyDevFee = _devFee;
    ...
    function updateSellFees(uint256 _devFee, uint256 _liquidityFee, uint256 _marketingFee, uint256 _earlySellLiquidityFee, uint256 _earlySellDevFee, uint256 _earlySellMarketingFee) external onlyOwner {
        sellDevFee = _devFee;
