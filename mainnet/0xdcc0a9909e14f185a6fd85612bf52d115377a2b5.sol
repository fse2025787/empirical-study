...
contract Phikuza is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant MAX_AMOUNT_PER_MINT = 25;

    constructor(string memory baseURI) ERC721A("Phikuza", "PKUZA") {
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount <= MAX_AMOUNT_PER_MINT, "Attemping to mint too many at a time");
