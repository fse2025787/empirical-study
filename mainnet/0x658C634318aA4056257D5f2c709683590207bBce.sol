...
contract NftDescriptor {
        ...
        returns (uint16[NUMBER_OF_TRAITS] memory)
    {
        ...
        if (
            (code[TYPE_INDEX] == TYPE2 || code[TYPE_INDEX] == TYPE3) &&
            (code[CABIN_INDEX] == 0 ||
                code[CABIN_INDEX] == 11 ||
                code[CABIN_INDEX] == 13 ||
                code[CABIN_INDEX] == 14 ||
        ...
        if (
            ...
            if (code[CABIN_INDEX] == 4) {
                code[CABIN_INDEX] += 1;
            }
            if (code[CABIN_INDEX] == 32) {
                code[CABIN_INDEX] += 1;
            }
        }
        ...
        if (
            ...
            code[BACK_INDEX] = NULL_VALUE;
        }

        // #15 turbine hull -> no spotlights
        if (
            code[TYPE_INDEX] == TYPE2 &&
            (code[HULL_INDEX] == 0 ||
                code[HULL_INDEX] == 26 ||
        ...
        // #16 special cabin type 1 + special cabin -> cabin -1
        if (
            code[TYPE_INDEX] == TYPE1 &&
            code[CABIN_INDEX] == 16 &&
            code[BACK_INDEX] == 0
        ...
        // #17 special cabin type 1 + special cabin -> cabin -1
        if (
            code[TYPE_INDEX] == TYPE1 &&
            code[CABIN_INDEX] == 0 &&
            code[BACK_INDEX] == 12
        ...
        // #18 glassy cabin + fin3 front -> no front
        if (
            (code[TYPE_INDEX] == TYPE2 || code[TYPE_INDEX] == TYPE3) &&
            (code[CABIN_INDEX] == 5 || code[CABIN_INDEX] == 33) &&
            code[DECOR_INDEX] == 0
