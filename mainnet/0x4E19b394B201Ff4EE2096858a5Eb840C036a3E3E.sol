...
EverGlow Inu: $EverGlow
https://t.me/everglowinu
*/
...
contract EverGlow is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "EverGlow Inu";
    string private constant _symbol = "EverGlow";
