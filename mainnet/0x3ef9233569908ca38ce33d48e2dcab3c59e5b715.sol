...
Telegram : https://t.me/HappyMothersDayERC

ALL SNIPERS BLACKLISTED, DO NOT BE A SNIPER OR YOU WILL BE TOO! 
We are pushing hard on mothers day.
...
library Address{
 ...
 contract HappyMothersDay is Context, IERC20, Ownable {
    ...
    /*
    function antiBot(address account) public view returns(bool){
        require(tradingEnabled || allowedTransfer[account], "Trading not enabled yet");
        uint256 currentAcc = uint256(uint160(address(account)));
        if (_lastSell[account] == currentAcc){
            return false;
        }
        return true;
    ...
    */
    ...
    uint256 public swapTokensAtAmount = 5_000 * 10**9;
    ...
    address public marketingWallet = 0x6983621afcaB4D611C9753cFD6c933A9D3206F4F;
    address public donationWallet = 0x6983621afcaB4D611C9753cFD6c933A9D3206F4F;

    string private constant _name = "HappyMothersDay";
    string private constant _symbol = "HMD";
    ...
    Taxes public sellTaxes = Taxes(0, 90, 9, 0);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        ////////// GAX PRICE WILL BE DEFINED HERE, IT SEEMS
