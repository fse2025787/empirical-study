...
contract TwitterKing is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Twitter King";//
    string private constant _symbol = "TK";//
    ...
    address payable private _developmentAddress = payable(0x3221b7d2e67aB4f83cb7335Da8771Eb1526f6A33);//
    address payable private _marketingAddress = payable(0x7aC5dbe1ec2c4fA0ACD2c02b0E57b7E9B3EAFb77);//
