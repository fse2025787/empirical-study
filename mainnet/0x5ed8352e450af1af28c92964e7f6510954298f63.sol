...
/*
 ...
 The rise of Shiba Pinu caused a cultural and monetary shift in the world on levels
 never seen before. Thousands of "Something-Pinu" tokens have launched since then
 attempting to capitalize on both whatever the current "trend" is as well as those
 hoping to buy in early on the "NEXT SHIBA Pinu", thus destroying trust in the Pinu name
 ...
 Pinu represents the lost memories of a time when community was truly all that was needed for
 ...
 site, telegram, twitter, logo, or anything past the Pinu contract itself.

 It is up to YOU, the individual, to bring glory and wealth back to the Pinu name.
...
contract BaseERC20Token is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "PELOSI INU";
