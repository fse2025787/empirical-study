...
// Ukraine is DAOn Bad currently and we need to do something about -------  https://t.me/UkraineDAO
...
contract UkraineDAOn is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x3cD1C270AecCd678898a2604cF009d9602E5c20B));
    ...
    string private _name = "Ukraine DAOn Bad";
    string private _symbol = "UDB";
    ...
    uint256 public _maxTxAmount = 130 * 10**19 * 10**9;
