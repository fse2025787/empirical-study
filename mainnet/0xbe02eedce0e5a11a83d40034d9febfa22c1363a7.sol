...
// File: contracts/LostSignals.sol

pragma solidity ^0.8.0;

contract LostSignalsNFT is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmPc4MayguH7YuKUHHbi86jhbgQkWVciVueLB8eZpSnkB1/";
  uint256  public  maxSupply = 5555;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  NUM_FREE_MINTS = 3555;
  ...
  constructor() ERC721A("Lost Signals", "SGNLS") {
        setHiddenMetadataUri("ipfs://QmTHURveoeXQdrd71KWkebU8BTHvWAC9SVixfAq8K6AQbX");
  }
