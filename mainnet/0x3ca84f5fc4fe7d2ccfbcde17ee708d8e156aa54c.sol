...
contract LetsMakeCryptoGreatAgain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lets Make Crypto Great Again";
    string private constant _symbol = "LMCGA";
