...
contract WorldCupFloki is ERC20, Ownable {
    ...
    constructor() payable ERC20("World Cup Floki", "WCF") {
        ...
        operationsAddress = address(0x91d194bA74E1d107342fF36a097c46474C031bBd);

        _createInitialSupply(address(this), (totalSupply * 65) / 100); // Tokens for liquidity
        _createInitialSupply(newOwner, (totalSupply * 35) / 100); // Staking
