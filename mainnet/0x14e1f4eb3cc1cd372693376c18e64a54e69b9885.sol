...
// Telegram : https://t.me/dofloinu
// Website : https://www.Dofloinu.org
...
contract Dofloinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Doflo Inu", "$DOFLO") {
        ...
        maxTransactionAmount = totalSupply * 40 / 1000; // 2%
        maxWallet = totalSupply * 40 / 1000; // 2% 
