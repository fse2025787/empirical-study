...
//  / / / / / / / __ `/ ___/ //_/  / / / / / / / ___/ //_/ ___/
// / /_/ / /_/ / /_/ / /__/ ,<    / /_/ / /_/ / /__/ ,< (__  ) 
// \___\_\__,_/\__,_/\___/_/|_|  /_____/\__,_/\___/_/|_/____/  
//                                                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0d2C67D86cE2E4D34fd65CE66fD6904311b76e85];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNcRpDTFqm1ptzuqYxqszHwgeWGVspq86Jxp6byyjrTVL/";
...
// File: contracts/QuackDucksContract.sol
//

pragma solidity ^0.8.0;

contract QuackDucksContract is RamppERC721A {
    constructor() RamppERC721A("Quack Ducks", "QUACKDUCKS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xL5Ccbb2k077zTPwpCJW/contract-metadata";
    }
}
