...
// File contracts/BOOMBAZNFTStaking.sol
...
contract BOOMBAZNFTStaking is ERC721Holder, Ownable  {
    ...
    // The block number when Rewards Token mining starts.
    ...
    // Update the given pool's Rewards Token allocation point. Can only be called by the owner.
    function set(
        uint256 _pid, 
        uint256 _allocPoint, 
        uint256 _nftLevel, 
    ...
    // Redeem currently pending rewards from a specific pool
    ...
    // Redeem all currently pending rewards
