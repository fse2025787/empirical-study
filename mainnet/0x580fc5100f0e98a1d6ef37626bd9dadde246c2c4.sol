...
// ETH token + NFT collection + BSC token
// Collect your own team of heroes to overcome the absolute power of Bitcoin and defeat all enemies in the upcoming token war!
// We plan to launch our own token in 2 networks: BSC and ETH and put up for sale top NFT cards that will be 100% unique and drawn by our designer. Promo videos can be viewed on our YouTube channel.
// 
// Website: https://itwcoin.com
// Youtube: https://www.youtube.com/channel/UCJu6X66hB9viyCXB7cKPjIg/videos
// Telegram: https://t.me/itw_coin
...
contract INFINITYTOKENWAR is Context, IERC20, Ownable {
    ...
    string private _name = 'INFINITY TOKEN WAR';
    string private _symbol = 'ITW';
