...
contract Twittoki is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "Twittoki";
    string private constant _symbol = "$TOKI";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x2AC039543a98B55f60E54673Cf27Da3c17bFb9aC);
