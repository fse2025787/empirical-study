...
contract NotOkayBeanz is ERC721A, Ownable {
    using Strings for uint256;
    ...
    address address1 = 0xa3D1fD49dec5a03646b4153d006083ea2EB91107;
    ...
    constructor() ERC721A("NotOkayBeanz", "NAB") {}
    ...
    function mint(uint256 _count) external payable {
        ...
        require(_count < 11, "Exceeds max per tx");
        if(supply > FREE_SUPPLY && msg.sender != owner())
        {
