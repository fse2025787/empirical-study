...
contract GameOfRisk is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmPZsrwwccGJHHmYCMGNLsVrBfWqoMuphjF5e4gihKk1Ji/";
  string  public  ANNEXATION = "00:01 UTC, if HighestOSVol=true ANNEX Country that LowestOSVol=True";
  string  public  STOP_TRADE = "if BlockVote = >10 on any one Country, BlockSale=true";
  string  public  INFLUENCE = "None = 1, Low = 1.25, Medium = 1.5, High = 2";
