...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x21854C8cef56c526dF20fDEaC823eBd41BC07e3F];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x21854C8cef56c526dF20fDEaC823eBd41BC07e3F;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmP7ce1evHMdyPVSjAGzg9mSTuwWwsJortUU3Zsd4jiWXG/";
...
// File: contracts/TheMagixContract.sol
//

pragma solidity ^0.8.0;

contract TheMagixContract is RamppERC721A {
    constructor() RamppERC721A("The Magix", "MGX"){}
}
