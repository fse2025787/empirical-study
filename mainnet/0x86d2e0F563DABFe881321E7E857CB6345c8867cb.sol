...
contract BlackWavesPassNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("Black Waves Pass NFT", "BWP") {}

    uint256 public collectionSize = 1005;
    ...
    uint256 public amountForAllowList = 5;
