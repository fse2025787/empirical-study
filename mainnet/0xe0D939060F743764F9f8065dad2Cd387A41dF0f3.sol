...
$DrogonRV is the first of three dragon tokens that we will use to build our utility.
May the Flames of the dragons be with you!

https://t.me/DrogonRVportal
...
contract DrogonRV is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DrogonRV";
    string private constant _symbol = unicode"DRV";
