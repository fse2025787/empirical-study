...
contract OdaNobunaga is Context, IERC20, Ownable {
    ...
    uint256 public defaultMarketingFee = 99;
    ...
    uint256 public _maxTxAmount = _tTotal.div(3).div(100);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x35Def575b0Bd0B1970323aF7F1A2b2c6FF6588dD);
