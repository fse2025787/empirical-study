...
contract DevIsBot is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Dev Is Bot"; 
    string private constant _symbol = "DIB"; 
    ...
    address payable private _developmentWalletAddress = payable(0xD369C18b2A00e01D45bd16170edf27092Cca0603);
    address payable private _marketingWalletAddress = payable(0xD369C18b2A00e01D45bd16170edf27092Cca0603);
