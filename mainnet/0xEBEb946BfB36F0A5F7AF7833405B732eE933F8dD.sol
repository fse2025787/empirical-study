...
contract ZomblinTownWTF is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("zomblintown.wtf", "ZMBL.WTF"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on zomblin");
    require(totalSupply() + amount < maxSupply + 1,"No more zomblin");
