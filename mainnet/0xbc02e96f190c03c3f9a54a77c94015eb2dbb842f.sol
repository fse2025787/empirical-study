...
contract ThePencilCaseProject is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 1111;
    uint256 public MAX_MINTS = 3;
    string public baseURI = "https://fhtucojhmgbqnogaiztc.supabase.co/storage/v1/object/public/pencils/metadata/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("The Pencil Case Project", "TPCP", MAX_MINTS, MAX_SUPPLY) {  
    }
