...
$PIQUE Retires from Barcelona FC!
...
contract PIQUE is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "PIQUE";
 string private _symbol = "PIQUE";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x22BDa35f0D350DfD621E49ed44F7E8e8E5923F8F);
 ...
 //Tokenomics related functions
  function PIQUEDay() public onlyOwner{
      require(block.timestamp > PIQUEDaycooldown, "You cant call PIQUECoinDay more than once a day");
 ...
 function PIQUECoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      PIQUEDaycooldown = block.timestamp + 86400;
 }
