 ...
 * @title WXWRP
 * @author Protofire
 * @dev Implementation of the WXWRP stablecoin.
 */
contract WXWRP is ERC20, AccessControl, Claimer {
    ...
    /**
     * @dev Sets {name} as "Wallex Wrap Token", {symbol} as "WXWRP" and {decimals} with 18.
    ...
    ) public ERC20("Wallex Wrap Token", "WXWRP") {
