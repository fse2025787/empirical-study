...
TG - https://t.me/BabyKakuan

BKAKUAN rewards KAKUAN token.
...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Claim KAKUAN shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract BabyKakuan is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Baby Kakuan";
    string private constant _symbol = "BKAKUAN";
    ...
    address payable public marketingWallet = payable(0xF0835Ed4Ca73b9b8a2584F7Bc711574bcCC76FaE);
