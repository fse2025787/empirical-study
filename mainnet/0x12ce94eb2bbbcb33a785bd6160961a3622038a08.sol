...
/**
https://t.me/BlackAIERC

Welcome to $BlackAi Degen

Official Links below
-https://twitter.com/BLACKAIERC
-https://www.blackaieth.com/
-https://black-ai.gitbook.io/black-ai/
...
contract  BlackAi is Context, IERC20, Ownable{
    ...
    string private _name = "Black Ai";
    string private _symbol = "BlackAi";
    ...
    constructor () {
        ...
        _feeAddrWallet2 = payable(address(0xA28394b42Eab5c7739645C14CCdf2EA592A9CCF3));

        _isExcludefromFee[owner()] = true;
        _isExcludefromFee[address(this)] = true;

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xA28394b42Eab5c7739645C14CCdf2EA592A9CCF3), _msgSender(), _totalSupply);
    }
