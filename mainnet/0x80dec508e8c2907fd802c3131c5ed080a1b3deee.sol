...
https://t.me/+DrmMsJsanBhlNjg0

Taxes 2/2 > goes to DEV, community decide what to do with it.
...
contract DOGEMERGE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "$mergedoge";
    string private constant _symbol = "DOMER";
    ...
    address payable private _developmentAddress = payable(0x81e32d04310dC527276776B8B6A7E3e7F1288D90); 
    address payable private _marketingAddress = payable(0x81e32d04310dC527276776B8B6A7E3e7F1288D90);
