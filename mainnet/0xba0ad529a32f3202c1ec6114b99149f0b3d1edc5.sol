...
contract UnicornFish is ERC721, ERC721URIStorage, Ownable {
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        ...
        existingURIs[uri] = 1;
        dailyNFTController[DateTime.getCurrentDate(block.timestamp)] =
            dailyNFTController[DateTime.getCurrentDate(block.timestamp)] +
            1;
    }
        ...
        returns (uint256)
    {
        ...
        if (
            DateTime.getDay(userMintTime[recipient]) ==
