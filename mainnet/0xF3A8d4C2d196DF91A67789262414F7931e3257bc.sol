...
/**
The BMDA protocol gives users complete control over their assets with 100% anonymity — That’s why privacy and anonymity, 
which should be universally available has been developed to be affordable for each user, regardless of their transaction size. 
Your on-chain privacy is our highest priority! If privacy is your priority, invest with Bermuda today!
TG：https://t.me/BermudaPortalERC
*/
...
contract Bermuda is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Bermuda Portal";
    string private _symbol = "BMDA";
    ...
    address payable public liquidityWallet = payable(0xC9655716d0538CE2A0f0316328765a08327E0D02);
    address payable public operationsWallet =  payable(0xC9655716d0538CE2A0f0316328765a08327E0D02);
