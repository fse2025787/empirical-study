...
contract MoonDoges is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSb7WLVZEZ5jCofa7F3BZ3m4TWGoeYhnTnAUfsynFcYuQ";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("MoonDoges", "MOONDOGE", 100, MAX_SUPPLY) {
    }
