...
contract KAZUMIINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4784b409D7D5137DFd1595e1d7515D646F20C7e4); 
    address payable public Wallet_Team = payable(0x41F289caA30165142a10e4cC1C82B0b266b9f0e4);
    ...
    string private constant _name = "KAZUMI INU"; 
    string private constant _symbol = unicode"$KAZUMI"; 
    ...
    constructor () {
        ...
        _owner = 0x41F289caA30165142a10e4cC1C82B0b266b9f0e4;
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4784b409D7D5137DFd1595e1d7515D646F20C7e4); // Testnet
