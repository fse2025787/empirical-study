...
/*
Website - https://coldhardcash.money
Telegram - t.me/getcoldhardcash
Twitter - https://twitter.com/getcoldhardcash
*/
...
contract ColdHardCash is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Cold Hard Cash";
    string private constant _symbol = "BANDZ";
    ...
    uint256 public _maxWalletAmount = 3 * 1e6 * 1e9;
    ...
    address payable private address1 = payable(0x870f598069761316233ca7a8Cb2A6742711e99a3);
    address payable private address2 = payable(0x870f598069761316233ca7a8Cb2A6742711e99a3);
    ...
    constructor() {
        ...
        swapAmount = 7 * 1e5 * 1e9;
        
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address1] = true;
        _isExcludedFromFee[address1] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        address1.transfer((amount).div(5).mul(3));
        address2.transfer((amount).div(5).mul(2));

    }

    function manualSwap() external {
        require(_msgSender() == address1);
