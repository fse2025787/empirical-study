...
// @dev provides a basic access control mechanism.
...
contract Ditt is Ownable, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply = 1000000000 * (10 ** _decimal); // Total Supply: 1 billion DITT
    uint256 constant public _taxBurn = 60; // 6% burn fee
