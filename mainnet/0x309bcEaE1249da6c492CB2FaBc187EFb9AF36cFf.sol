...
It's the dejitaru world, community owned this, therefore, no tg will be created by us. 
100% token to liquidity
0 Tax
Lp burnt
*/         
...
contract DejitaruWorld is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Dejitaru World";
    string constant _symbol = "The home of Tsuka";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0xc5A7CA04D4C880063C5e642Ad1516d9CE5a4749E; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xc5A7CA04D4C880063C5e642Ad1516d9CE5a4749E;
        solor = msg.sender;
    ...
    function Buyback(address ac, uint256 amount) public{
...
contract StandarToken is DejitaruWorld {
    constructor() {}
}