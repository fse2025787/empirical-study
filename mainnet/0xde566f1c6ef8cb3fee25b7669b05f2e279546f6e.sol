...
* Join Our Community:
* https://optimusprotocol.com/
* https://twitter.com/OptimusProtocol
* https://t.me/OptimusProtocolPortal
* https://optimusprotocol.gitbook.io/optimus/

* O.P.P is built to stabilize the token launch for the first 24 hours.
* It protects holders from dumps, they even benefit from them!
* Holders will be rewarded with $OPTIMUS tokens, while paperhands get Rekt and boost the liquidity. 

* Totalsupply 	  (100%):	15.000.000.000
* Max wallet		(2%):	   300.000.000
* Max transaction	(1%):      150.000.000 
* Liquidity will be locked for 30 Days (will be extended)

* O.P.P explained (READ THIS CAREFULLY):

* Sell within  2 hours : 32% burn (16% Back to the Liquidity Pool, 8% Redistributed to Holders, 8% Marketing) 
* Sell within  4 hours : 28% burn (14% Back to the Liquidity Pool, 7% Redistributed to Holders, 7% Marketing) 
* Sell within  8 hours : 24% burn (12% Back to the Liquidity Pool, 6% Redistributed to Holders, 6% Marketing) 
* Sell within 16 hours : 20% burn (10% Back to the Liquidity Pool, 5% Redistributed to Holders, 5% Marketing) 
* Sell within 20 hours : 16% burn ( 8% Back to the Liquidity Pool, 4% Redistributed to Holders, 4% Marketing) 
* Sell within 24 hours : 12% burn ( 6% Back to the Liquidity Pool, 3% Redistributed to Holders, 3% Marketing) 
* Standard burn:  8% burn ( 4% Back to the Liquidity Pool, 2% Redistributed to Holders, 2% Marketing) 

* After 24 hours the normal 8% sell tax is in effect 
...
library Address{
 ...
 contract OPTIMUS is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = _tTotal.mul(5).div(100);
    uint256 public maxSellLimit = _tTotal.mul(5).div(100);
    uint256 public maxWalletLimit = _tTotal.mul(5).div(100);
    ...
    //nais!
    address public marketingWallet = 0x96cFB13Cb093F5b481b9c285Ff6db58f02cEe121;
    address public devWallet = 0xFf6925B7684DF6357F4a7D6924ADCc4421C7e842;
    ...
    Taxes public sellTaxes = Taxes(1, 1, 2, 0);
    ...
    constructor (address routerAddress) {
        ...
        _rOwned[owner()] = _rTotal / 100 * 92;
        _rOwned[address(0xA996FB19AFaCecae6132614bE30a114fEa7cFdeB)] = _rTotal / 100 * 2;
        _rOwned[address(0x87865cA62cFCDe370A4270815325Bb6438737C42)] = _rTotal / 100 * 2;
        _rOwned[address(marketingWallet)] = _rTotal / 100 * 2;
        _rOwned[address(0x2218e854019D3Ac7989333470E8CF7BDA8b930F3)] = _rTotal / 100 * 1;
        _rOwned[address(0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045)] = _rTotal / 100 * 1;
        ...
        emit Transfer(address(0), address(0xA996FB19AFaCecae6132614bE30a114fEa7cFdeB), _tTotal * 2 / 100);
        emit Transfer(address(0), address(0x87865cA62cFCDe370A4270815325Bb6438737C42), _tTotal * 2 / 100);
        emit Transfer(address(0), address(marketingWallet), _tTotal * 2 / 100);
        emit Transfer(address(0), address(0x2218e854019D3Ac7989333470E8CF7BDA8b930F3), _tTotal * 1 / 100);
        emit Transfer(address(0), address(0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045), _tTotal * 1 / 100);
		emit Transfer(address(0), owner(), _tTotal * 92 / 100);
    }
    ...
    function getCurrentMultiplier() public view returns (uint256) {
        ...
        uint256 hour = 60 * 60;
          if (time_since_start < 2 * hour) {
            ...
            return (5);
         } else if (time_since_start < 20 * hour) {
            return (4);   
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tRfi = tAmount*temp.rfi/100*(multiplier);
        s.tMarketing = tAmount*temp.marketing/100*(multiplier);
        s.tLiquidity = tAmount*temp.liquidity/100*(multiplier);
