...
pragma solidity ^0.6.12;
    ...
    contract TERETHV2 is Context, IERC20, Ownable {
        ...
        string private _name = 'TERETH';
        string private _symbol = 'TRTH';
        uint8 private _decimals = 18;
    
        uint256 private _taxFee = 10; 
        uint256 private _MarketingPoolFee = 6;
        ...
        uint256 private _maxTxAmount = 1000000000 * 10**18;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForMarketingPool = 1 * 10**8 * 10**18;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 100000000 , 'maxTxAmount should be greater than 1000000000');
