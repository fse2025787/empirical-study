...
contract CRYPTOTWEET is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private _tTotal = 44000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tTotalDistributedToken;

    uint256 private maxBuyLimit = 440000000 * (10**18);
    uint256 public maxWallet = _tTotal.div(10000).mul(100);

    string private _name = "Crypto Tweet";
    ...
    uint256 private numTokensSellToAddToLiquidity = 4400000 * 10**18;
