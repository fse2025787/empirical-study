...
contract MRSPARKLE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Mr. Sparkle";
    string private constant tokenSymbol = "MRSPARKLE";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xC0aDeCC268B91aCA2aeD1f52d3bAaa8A95472D7b);
        devAddress = payable(0x6055eD4f23653eE1cd8360F23229b8578cf7180c);
