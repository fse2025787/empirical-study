...
contract HereBeDragons is ERC721A, Ownable {
     using Strings for uint256;

    uint256 public constant COST = 0.003 ether;
    uint32 public constant MAX_SUPPLY = 999;
    uint32 public constant MAX_PER_TX = 3;

    string private uriPrefix = "ipfs://bafybeifwnsf4tyn6txowymro4gadn5igppxjvudkdr4rck5cs4sls5ltzu/";
    ...
    constructor() ERC721A ("Here Be Dragons", "DRGNS") {}
