...
/**********************************************************
 * Main Contract: PreachersCompFiLqdt v1.0.5
 **********************************************************/
contract PreachersCompFiLqdt is Structs {
    ...
    function doCompFiLiquidate(
        ...
        // by 'callFunction'. Add 5% to cover swap fees
        flashAmount = flashAmount * 105;
        flashAmount = flashAmount / 100;
