...
//  /_  __/ /_  ___     /  |/  /___  ____  ____  ____  (_) / /___ ______
//   / / / __ \/ _ \   / /|_/ / __ \/ __ \/ __ \/_  / / / / / __ `/ ___/
//  / / / / / /  __/  / /  / / /_/ / /_/ / / / / / /_/ / / / /_/ (__  ) 
// /_/ /_/ /_/\___/  /_/  /_/\____/\____/_/ /_/ /___/_/_/_/\__,_/____/  
//                                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x4eD12bD043c3F206cfaC7fF64847614CE1EA34E0];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x4eD12bD043c3F206cfaC7fF64847614CE1EA34E0;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmU9e2a9S6kBFh4VGH9FgfJojw2GaYYyJ6kWxdyVi3Stwn/";
...
// File: contracts/TheMoonzillasContract.sol
//

pragma solidity ^0.8.0;

contract TheMoonzillasContract is RamppERC721A {
    constructor() RamppERC721A("The Moonzillas", "Moonzillas"){}
}
