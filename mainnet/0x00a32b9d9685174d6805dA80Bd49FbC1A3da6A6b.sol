...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.224 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUaHrmknfzM6wsEKaMvnbDLjAYbpDT8x5XbdCNJEFJ7Qe/";
...
// File: contracts/TienDaoCourse112Contract.sol
//

pragma solidity ^0.8.0;

contract TienDaoCourse112Contract is RamppERC721A {
    constructor() RamppERC721A("Tien Dao Course 112", "TDC"){}
}