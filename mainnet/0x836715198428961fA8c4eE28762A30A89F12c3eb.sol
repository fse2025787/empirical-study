...
GTAINU (Grand Theft Auto Inu)

For all the GTA lovers out there, we are aiming to build a strong community and host GTA online sessions and tournaments while making money by investing in $GTAINU 🔥

Tax🔒 4%
Max TXN🔒 1%


🔒 https://t.me/GTAinuErc
...
contract GTAInuERC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Grand Theft Auto Inu";
    string private constant _symbol = unicode"GTAINU";
