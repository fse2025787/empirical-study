...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(now > _lockTime , "Contract is locked until 3 days");
...
contract BoomBaby is Context, IERC20, Ownable {
    ...
    string private _name = "Reload America's Democracy Organisation";
    string private _symbol = "RADO";
    ...
    uint256 private numTokensSellToAddToLiquidity = 3000000 * 10**6 * 10**9;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3C14B6b8B29acD925029c61337AB5E7B9F668Dcf);
