...
contract Chinatown is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Chinatown";
    string private constant _symbol = "CIT";
    ...
    address payable private _developmentAddress = payable(0xB25cCc776d5a935024349409476F3B59C9874C8a);
    address payable private _marketingAddress = payable(0xB25cCc776d5a935024349409476F3B59C9874C8a);
