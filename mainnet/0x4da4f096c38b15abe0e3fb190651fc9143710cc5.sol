...
contract MetroGradGen2 is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("MetroGrad Gen. 2", "METROGRAD")
    {
        baseURI = _baseURI;
