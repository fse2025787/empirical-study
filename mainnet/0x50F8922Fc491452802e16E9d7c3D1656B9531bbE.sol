...
/**
           ...
           WhyPepe is a green anthropomorphic frog with humanoid body, we believe every frog should live a life free from fear and suffering. 
This is why we exist, to help those who can't help themselves.

          https://t.me/WhyPepePortal
*/
...
contract WhyPepe is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Why Pepe";
    string private  _symbol = "WHYPEPE";
