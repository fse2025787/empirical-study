...
// 
// File: contracts/TheDragonborn.sol
...
contract TheDragonborn is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5100;
    uint256 public MAX_MINTS = 4100;
    string public baseURI = "ipfs:///";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("The Dragonborn", "DRGBRN", MAX_MINTS, MAX_SUPPLY) {  
    }
