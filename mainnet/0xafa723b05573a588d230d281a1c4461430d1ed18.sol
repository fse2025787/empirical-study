...
// File: github/chiru-labs/ERC721A/contracts/FreeMint.sol
...
contract Samurai is ERC721A, Ownable {
  constructor() ERC721A("Samurai Clown ", "SC") {
    _defaultTokenURI = "ipfs://QmQegN2BDXv5jn2r2kfDAVfgsY8wAv6BzJuYEu3W8XWjKF";
  }
  using Strings for uint256;
  uint256 public constant MAX_SUPPLY = 3000;
  uint256 public constant MINT_MAX_QUANTITY = 50;
  ...
  function mint(uint256 quantity) external payable {
    ...
    require(walletMinted[msg.sender] + quantity <= MINT_MAX_QUANTITY, "Exceed whitelist max mint");
