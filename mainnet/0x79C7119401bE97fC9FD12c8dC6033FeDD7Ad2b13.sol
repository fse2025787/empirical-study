...
// contracts/bridge/MaticMint.sol
// 
    ...
    ContextMixin
{
    ...
    constructor()
        public
        ERC721("Matic Mike Club Ethereum Bridge", "MIKE")
    {
        _owner = msg.sender;
        _proxy = 0x932532aA4c0174b8453839A6E44eE09Cc615F2b7;

        _setupContractId("MMMintableERC721");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, _msgSender());
        _initializeEIP712("Matic Mike Club Ethereum Bridge");
    }
