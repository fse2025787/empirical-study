...
ERC-20 Play to Earn (P2E) token.
Blow off steam in the metaverse, own your NFT character and knock some teeth out to earn crypto.

BETA is live for holders to play. Battle Royale, select between; 1v1, 10v10, 20v20 game modes. 
Available to play on our website via wallet connect. (PC gameplay available, VR coming next)

Tokenomics: 4% (3% in-game rewards, 1% LP)

Liquidity locked 1 year

TG: https://t.me/BarFightTokenETH
 */
