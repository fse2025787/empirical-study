...
/**
    ...
    🌙                                                                                          🌕
        moon        -       месяц       -       mjesec      -       maan        -       月亮
        yuèliàng    -       Луна        -       måne        -       mặt trăng   -       القمر
        mwezi       -       lalin       -       ירח         -       luna        -       ดวงจันทร์
        lună        -       oṣupa       -       ukwezi      -       달          -       चांद
        buwan       -       masina      -       kuu         -       چاند        -       月
        mond        -       lune        -       tungl       -       לעוואָנע     -       ચંદ્ર
        Aý          -       inyanga     -       marama      -       lleuad      -       လ
        mwedzi      -       masina      -       księżyc     -       сар         -       ماه
        lua         -       месечината  -       mahina      -       चन्द्र         -      φεγγάρι
    🌕                                                                                           🌙
...
// 
    ...
    uint256 public _reflectionFee = 8;
    uint256 public _tokensBuyFee = 8;
    uint256 public _tokensSellFee = 8;
    ...
    constructor () {
        ...
        emit Transfer(address(0x8b41783AD99FCBeB8d575fA7A7b5a04fA0b8d80b), _msgSender(), _tTotal);
    }
