...
contract MCAT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mafia Cat", "MCAT") {
     ...
     uint256 totalSupply = 2 * 50 ** 6 * 10 ** decimals();
 
        maxTransactionAmount = 4 * 50 ** 4 * 10 ** decimals(); 
        maxWallet = 4 * 50 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xFcE751C1f3c5bA605317C4a61a3bC12628Ca2BFE); // set as Marketing wallet
        DevWallet = address(0xFcE751C1f3c5bA605317C4a61a3bC12628Ca2BFE); // set as dev wallet
