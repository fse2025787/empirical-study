...
Invest in a new ERC-20 token to help us build a rocket* that will send a bloody dictator far far away! :firecracker:

Taxes: 15% - 7% to marketing, 8% to Ukraine Relief Efforts
Website: https://www.putina.co
Launch: Stealth, 3/15/22
Contract: Locked and renounced

Putin: His ass getting sent straight to Jupiter
Donations: Will be sent directly to Ukraine’s official ETH wallet
Telegram: https://t.me/putina_token

*disclaimer: we’re not really building a rocket.
...
contract PUTINA is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 50; // 1% of supply
    uint256 public maxTxAmountSell = _tTotal / 50; // 1% of supply
    uint256 public maxWalletAmount = _tTotal / 50; // 1% of supply
    ...
    string private constant _name = "Putina Inu";
    string private constant _symbol = "PUTINA";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 200;
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 7, // dev team fee in %
            treasury: 8, // treasury fee in %
            lp: 1, // lp rate in %
            toSwap: 16 // treasury + dev + lp
        });
