...
contract UniqueFansToken is SignerRole, ERC1155Base {
    string public name;
    ...
    function mint(uint256 id, uint8 v, bytes32 r, bytes32 s, Fee[] memory fees, uint256 supply, string memory uri, address userWallet) public {
        address isValid = StringLibrary.getAddress(abi.encodePacked(this, id, userWallet), v, r, s);
        require(isSigner(isValid), "signer should sign tokenId");
        require(userWallet == msg.sender, "unauthorised minting");
