...
// https://twitter.com/ApeMasERC

// https://medium.com/@ApeMas
...
contract ApeMas is Ownable, IERC20 {
    ...
    string constant private _name = "APEMAS";
    string constant private _symbol = "$AM";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xaa693C41ccD41e9c4bF6a518d99e4e7D114BCb7e;
        devWallet = 0xaa693C41ccD41e9c4bF6a518d99e4e7D114BCb7e;
    ...
    function gudo(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extra) public authorized{
