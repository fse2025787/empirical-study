...
contract NFTskelly is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint public constant prizeMints = 420;
  ...
  function mintPrizes(uint amount) public onlyOwner {
    ...
    require(currentTotalSupply < prizeMints, "NFTSkelly: No more prizes.");

    if (currentTotalSupply + amount > prizeMints){
      amount = prizeMints - currentTotalSupply;
    }
