...
contract PepeUsagi is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 public _totalAmount = 100000000 * 10 ** 18;
    uint256 public _totalFee = 5;
    uint256 public _feeDenominator = 100;
    mapping(address => bool) private _blackList;
    string  _name = "Pepe Usagi";
    string  _symbol = unicode"$PEGI";
    address _marketingFeeReceiver = 0x1Ef910Db27e407Ea1FDBEa16b7A3b9b37CAF9B67;
    address _teamFeeReceiver = 0x1Ef910Db27e407Ea1FDBEa16b7A3b9b37CAF9B67;
