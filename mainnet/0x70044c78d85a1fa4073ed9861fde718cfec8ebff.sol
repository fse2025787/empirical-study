...
contract PunkUpYourWorld is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.007 ether;
    uint256 public maxSupply = 4242;
    uint256 public maxFree = 2121;
    uint256 public maxperAddressFreeLimit = 2;
    uint256 public maxperAddressPublicMint = 30;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("PunkUpYourWorld", "PUYW") {
        setBaseURI("");
