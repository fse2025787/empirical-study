 ...
 * Telegram- https://t.me/Memeworldeth
 * Twitter- https://twitter.com/MemeworldEth

 * For more links check out our telegram.  
...
contract MemeWorld is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "MemeWorld";
    string private constant _symbol = "M3M3";
    ...
    address payable private _developmentAddress = payable(0xb7cf5c462C70DFFedEf2368d014A5Ac527d929aD);
    address payable private _marketingAddress = payable(0x37b43b570e029C3F3B5E157C9b92BAe6EB421e9B);
    ...
    uint256 public _maxTxAmount = 8400000 * 10**9; //2%
    uint256 public _maxWalletSize = 8400000 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 42000 * 10**9; //0.01%
