...
Token Name: Degen Club Averaging
Ticker: DCA
Supply: 1,000,000,000,000,000

$DCA is the Degen Club Averaging in DEFI. 
Being a hodler of $DCA we apply the value and investing principles to our Farming as a service (FAAS).

TG : https://t.me/DCAERC20
TWITTER :https://twitter.com/DCAERC20
...
contract DCA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Degen Club Averaging";
    string private constant _symbol = unicode"DCA";
    uint256 public _maxTxAmount = 20000000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 20000000000000 * 10**_decimals;
    uint256 public _taxSwap=20000000000000 * 10**_decimals;
