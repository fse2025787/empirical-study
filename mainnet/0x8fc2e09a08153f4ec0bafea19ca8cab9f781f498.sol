...
/**
 Kuji-Kiri - The Nine Symbolic Cuts

 0/0 tax
 TG will be updated on Dev wallet
 LP BURN
 RENOUNCE
...
contract Kuji is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Kuji-kiri';
    string private constant _symbol = 'KUJI';
    ...
    uint256 private swapThreshold = ( _totalSupply * 50000 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10000 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0x059B52B35bCC2e7FD86b5e383c35a73f431d18F8; 
    address internal constant marketing_receiver = 0x059B52B35bCC2e7FD86b5e383c35a73f431d18F8;
    address internal constant liquidity_receiver = 0x059B52B35bCC2e7FD86b5e383c35a73f431d18F8;
