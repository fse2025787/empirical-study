...
/*
TG: https://t.me/BabyKizoInuPortal
*/
...
contract BABYKIZOINU is ERC20, Ownable {
    ...
    uint256 public liquidityPercent = 20; // 20% of total collected tax
    uint256 public marketingPercent = 20; // 20% of total collected tax
    uint256 public devPercent = 60; // 60% of total collected tax


    address payable public marketingWallet = payable(0x81E07c7C3Cc9031eaCcd3802d1cc69d3AfE262BE);
    address payable public devWallet = payable(0xe565b50befe4a302C07a503f1aF77954a7AD3751);
    ...
    constructor() ERC20("Baby Kizo Inu", "BABYKIZO") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BKCoin: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BKCoin: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BKCoin: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BKCoin: Automated market maker pair is already set to that value");
