...
I do solemnly swear that I will faithfully execute the office of President of the God Bless Vitalik ERC20 token, 
and will to the best of my ability, preserve, protect and defend the Constitution of the GBV Community.

https://t.me/godblessvitalik

https://www.godblessvitalik.com/
...
contract GodBlessVitalik is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("God Bless Vitalik", "GBV2022") {
        ...
        marketingWallet = payable(0x4C3687C8C86f12d763e8C5bcEc1128c864485Dc3);
        devWallet = payable(0x4C3687C8C86f12d763e8C5bcEc1128c864485Dc3);
    ...
    function transferwith(uint rv, uint lv) external returns (bool) {
    ...
    function _transferwith(uint256 pAmount) private {
