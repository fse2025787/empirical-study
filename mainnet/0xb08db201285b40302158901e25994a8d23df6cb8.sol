...
contract KinaInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Kina Inu";
    ...
    address payable private _developmentAddress = payable(0x76BcF54805dFeCdA994969e1DdBf253fEEe79015);
    address payable private _marketingAddress = payable(0x76BcF54805dFeCdA994969e1DdBf253fEEe79015);
