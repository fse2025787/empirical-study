...
contract capybara is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcMigggjHPktvgQY8Nh9hnCbQ8QkjYecR9xug11x7CUGK";
    ...
    constructor(
    ) ERC721A("AI capybara", "AC", 100, maxSupply) {
    }
