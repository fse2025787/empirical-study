...
contract TheChariot is ERC1155, Ownable {
    // editing section starts below here
    string public name = "The Chariot"; //name your NFT collection
    string public symbol = "CHAR"; //few letters to represent the symbol of your collection
    string private ipfsCID = "QmRrnVqtrk2d12vqb3moZ9cK9gYu6SSqzbryD5ZGvy3cRa"; // ipfs metadata folder CID as the starting or hidden NFT
    uint256 public collectionTotal = 1; // total number of NFTs to start your collection
    uint256 public cost = 0.05 ether;  // price per mint
    uint256 public maxMintAmount = 1; // max amount a user other than owner can mint at in one session
    uint256 public maxBatchMintAmount = 1;  // max batch amount a user other than owner can mint at in one session
    uint256 public whitelisterLimit = 1; // max amount a whitelisted user can mint during presale
    // editing section end
    ...
    //address public Elightreasury = 0xFfba559A9801d221B5bB50b2DD61e386b27Cb902;
    ...
    constructor() ERC1155(""){
        ...
        _mint(0xFfba559A9801d221B5bB50b2DD61e386b27Cb902, 1, 1, ""); //sends Owner, NFT id 1, amount 1
    }
