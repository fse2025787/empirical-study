...
contract LillipupInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Lillipup Inu";
    string private constant _symbol = "LPup";
    ...
    address payable private _marketingAddress = payable(0x88741E7d5a77bCaeAaf089037f672E4Fd7A97D01);
    ...
    uint256 public _maxWalletSize = 500000000000 * 10**9; // 0.5
