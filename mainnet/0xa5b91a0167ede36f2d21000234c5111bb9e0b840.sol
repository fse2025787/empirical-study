...
contract HEXIS is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "HEXIS";
    ...
    address payable private _developmentAddress = payable(0x3eBb5A7C72Cb92f3411AB49E8594BaB1D6F8dbED);
    address payable private _marketingAddress = payable(0x3eBb5A7C72Cb92f3411AB49E8594BaB1D6F8dbED);
