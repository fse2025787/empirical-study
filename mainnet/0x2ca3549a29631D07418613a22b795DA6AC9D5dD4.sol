...
2. AUTO BUY BACK AND BURN. This will be activated once a milestone is hit by the community.
    In every sell transaction, TheMergeDay automatically buys native token in Uniswap and burns it via dead wallet. 
...
This kaho and weth will be paired together and then directly added to the liquidity pool of the TheMergeDay Project. 
This will create more volume in LP and attract more whale apes. 


***DISCLAIMER: 
Smart Contract is encoded by cryptosurge.io for the TheMergeDay. 
Cryptosurge.io is not affiliated with the TheMergeDay Project. 
...
contract TheMergeDay is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Merge Day";
    string private constant _symbol = "15 SEPT";
    ...
    uint256 private constant _tTotal = 15151515 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x1eec53620B62e33D9582c52F26D97a563b9427f8);
    address payable private _marketingAddress = payable(0x1eec53620B62e33D9582c52F26D97a563b9427f8);
    ...
    uint256 public _maxTxAmount = 303030 * 10**9; //2%
    uint256 public _maxWalletSize = 454545 * 10**9; //3%
