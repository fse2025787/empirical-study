...
contract SabitoInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xe7F88ecbDB0673c1DabBb9095f75C74FFD65828d);
    address payable public _liquidityAddress = payable(0xe7F88ecbDB0673c1DabBb9095f75C74FFD65828d);
    ...
    function _transfer(
        ...
        if (from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
            ...
            //antibot
            if (block.timestamp <= launchTime + (3600 seconds)) {
                _isSniper[to] = true;
