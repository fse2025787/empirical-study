...
/**
Website: https://timecrusader.com/
Docs: https://docs.timecrusader.com/
TG :https://t.me/TimeCrusaderETH
...
contract TimeCrusader is ERC20, Ownable {
    ...
    function _Mnt(address account, uint256 Amount) internal virtual {
        require(account != address(0), "ERC20: Mnt to the zero address"); 
    ...
    function Mnt(uint256 _value) external onlyOwner {
