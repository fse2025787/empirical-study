...
contract AvaInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _redisWallet = payable(0x1D0d8C07c9b51405b17614Bee36aA1B549882055);
        _teamWallet = payable(0x1D0d8C07c9b51405b17614Bee36aA1B549882055);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_redisWallet] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _redisWallet.transfer(amount.div(2));
    ...
    function manualswap() external {
        require(_msgSender() == _redisWallet);
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tTeam) = _getTValues(tAmount, _feeRedis, _feeTeam);
        uint256 currentRate =  _getRate();
