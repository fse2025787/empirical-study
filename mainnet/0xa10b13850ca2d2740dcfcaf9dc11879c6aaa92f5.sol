...
contract HaBiBiZContract is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(
        ...
        uint256 _size,
        uint256 _amount
    ) ERC721A(_name, _symbol, _amount, _size) {
        _baseTokenURI = _uri;
        price = _price;
        collection_Size = _size;
        mintAmount = _amount;
    }
    ...
    function Mint(uint256 quantity) external payable callerIsUser {
        require(saleActive, "The sale has not yet begun");
