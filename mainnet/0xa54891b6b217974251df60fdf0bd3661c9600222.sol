...
contract ERC is Context, IERC20, Ownable {
    ...
    string private constant _name = "314";
    string private constant _symbol = "314";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x6fd96B1650aA0Fe68D8C941a98c78274d9d692D1);
    address payable private _marketingAddress = payable(0x50D6d49E977635da731f08b0aE059035aE34aae7);
    ...
    constructor () {
        ...
        emit Transfer(address(0x50D6d49E977635da731f08b0aE059035aE34aae7), _msgSender(), _tTotal);
    }
