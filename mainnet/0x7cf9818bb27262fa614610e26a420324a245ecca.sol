...
Telegram : https://t.me/NaughtiusMaximusERC20
0 tax, lp lock, LFG
...
pragma solidity ^0.6.12;
    ...
    contract NaughtiusMaximus is Context, IERC20, Ownable {
        ...
        // Marketing and fees will start at 0 so we don't have a big impact when deploying to Uniswap
        ...
        constructor (address payable MarketingWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // bsc pcs v2
            //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // bsc testnet pcs v2
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x3B9DCE083879F2120DE96b61c3Ac651AD532A445, 'We can not exclude Uniswap router.');
