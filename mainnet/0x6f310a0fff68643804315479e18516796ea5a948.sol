...
------------------------ www.BotFi.co ------------------------
--------------------- https://t.me/BotFiPortal ---------------

Transform the way to trade crypto with DAO Bots

The powerful Defi platform that connects bot creators and individuals by offering DAO Crypto Trading Bots Marketplace! 
...
contract BotFi is Context, IERC20, Ownable {
    ...
    string private constant _name = "BotFi";
    string private constant _symbol = "BOTFI";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xCe4Fa54c049B139336eA5cec2Dfdc77cD9F8f588);
