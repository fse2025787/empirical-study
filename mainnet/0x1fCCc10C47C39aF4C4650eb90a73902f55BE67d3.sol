 ...
 * {ERC721Enumerable}.
 */
contract ERC721SBT is ERC165, IERC721, IERC721Metadata {
    ...
    function totalMinted() public view virtual returns (uint256) {
        // Return currentIndex of totalMinted
     ...
     * @dev Returns the total number of tokens in existence.
     */
    function isEligibleToMint(address from) internal virtual {
        uint256 noOfMinted = _balances[from];
        require(noOfMinted < 1, "ERC721SBT - Only 1 per owner");
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721SBT.ownerOf(tokenId);
        ...
        require(msg.sender == address(0), "ERC721SBT is Soulbound");
    ...
    function _transfer(
        ...
        require(!_exists(tokenId), "ERC721SBT is Soulbound");
        require(ERC721SBT.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721SBT.ownerOf(tokenId), to, tokenId);
    }
    ...
    function _setApprovalForAll(
        ...
        require(owner == address(0), "ERC721SBT is Soulbound");
    ...
    /**
     * @dev Returns whether the address has minted.
     *
     * SBTs can only be tagged to a singular personnel.
     * Soulbound Tokens cannot be transferred, so this function returns `false`.
     *
     */
    function _minted(address owner) internal view virtual returns (bool) {
    ...
    function _beforeTokenTransfer(
        ...
        uint256 tokenId
         ...
         if(from != address(0)){
            require(false, "ERC721SBT is Soulbound");
        }
    }
