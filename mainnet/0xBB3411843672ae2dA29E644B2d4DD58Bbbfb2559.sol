...
contract MyFundStorage is VRFConsumerBaseV2 {
    ...
    FUNDING_STATE public funding_state;
   ...
   */
    ...
    function endFunding() public onlyOwner {
        funding_state = FUNDING_STATE.END_FUNDING;
