...
//    - Bart Simpson -
//
// » Safu contract. Can't rug! «
// » Liquidity locked before launch. «
// » 3/3 taxes. «
// » Renounce 10 mins after launch. «
//
//  Enjoin!!
//  Peace!!
...
contract Bartman is ERC20, Ownable {

    using SafeMath for uint256;

    //Contract functional variables
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 1e18;
    ...
    // Anti-bot
    mapping(address => uint256) public _lastTransferTimestamp;
    ...
    constructor() ERC20("The Bartman", "BART") {
        setupSwapRouter();
        ...
        _maxTransactionAmount = TOTAL_SUPPLY / 1000 * 5; // .5%
        _maxWallet = _maxTransactionAmount * 4; // 2%
        _swapTokensAtAmount = TOTAL_SUPPLY / 1000; // .1%
        ...
        marketingWallet = address(0x94A09b468878F894c537ec47f2b560CD467460d7);
    ...
    function setupSwapRouter() private {
