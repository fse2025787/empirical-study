...
//
// Website:  https://wagbo.io
// Twitter:  https://twitter.com/TeamWAGBO
// Telegram: https://t.me/WAGBOportal
//
...
contract WAGBO is Context, IERC20, Ownable {
    ...
    address payable public _NFTfundAddress =
        payable(address(0xE9340a8758aAFDf16C7D2968508Dc2Dc7B4bdf47));
    address payable public _devwallet =
        payable(address(0x05EE5e5650CF346ba4082b3e7Ef6AE84bC1490B8));
    address private _burnAddress =
        payable(address(0x000000000000000000000000000000000000dEaD));

    string private _name = "WAGBO";
    string private _symbol = "WAGBO";
    ...
    uint256 public _maxWalletSize = 20 * 10**6 * 10**18;
    ...
    constructor() {
        ...
        _isExcludedFromFee[_NFTfundAddress] = true;
        _isExcludedFromFee[_devwallet] = true;


        _isExcludedFromLimit[_NFTfundAddress] = true;
    ...
    function updateNFTfundWallet(address payable newAddress) external onlyOwner {
        _NFTfundAddress = newAddress;
    }
        ...
        )
    {
        ...
        uint256 tWallet = calculateNFTfundFee(tAmount) +
    ...
    function calculateNFTfundFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
        return _amount.mul(_NFTfundFee).div(10**2);
    }
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        // Send ETH to NFTfund
        uint256 NFTfundAmt = unitBalance *
            2 *
            (buyFee.NFTfund + sellFee.NFTfund);
        ...
        if (NFTfundAmt > 0) {
            payable(_NFTfundAddress).transfer(NFTfundAmt);
        }
    ...
    function claimTokens(address tokenAddress, uint256 tokenAmount) public virtual {
