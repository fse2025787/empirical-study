...
/**TODAY YOU JOIN THE UNDERWORLD
WELCOME TO THE WORLD OF OSIRIS!!!


Osiris , one of Egypt’s most important deities, 
was god of the underworld. He also symbolized death, resurrection, and the cycle 
of Nile floods that Egypt relied on for agricultural fertility.
According to the myth, Osiris was a king of Egypt who was murdered and dismembered 
by his brother Seth. His wife, Isis, reassembled his body and resurrected him, 
allowing them to conceive a son, the god Horus. He was represented as a mummified king,
...
contract EgyptianGOD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Egyptian God";
    string private _symbol = "Osiris";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x3398Eb95e0f7D2a66E60D0a8aBEBd62f1e765121);
    address payable private taxWallet2 = payable(0x3398Eb95e0f7D2a66E60D0a8aBEBd62f1e765121);
    ...
    uint256 public _marketingShares = 2;
    ...
    uint256 public _walletMax = 10000 * 10**6 * 10**9;
