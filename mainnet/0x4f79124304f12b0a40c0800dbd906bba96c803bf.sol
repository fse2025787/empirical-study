...
contract PAC is ERC721Enumerable, Ownable, PaymentSplitter {
    ...
    uint256 public _startTime = 1635033600;

    mapping(uint => string) private _owners;

    // Withdrawal addresses
    address t1 = 0x9ed3822542BA9D38a36767e6536769296c106C47;

    address[] addressList = [t1];
    uint256[] shareList = [100];

    constructor()
    ERC721("Painted Ape Club", "PAC")
    ...
    function mint(uint256 _count) public payable {
        ...
        require( supply + _count <= MAX_SUPPLY,        "Exceeds current Ape supply limit" );
    ...
    function mint(address _wallet, uint256 _count) public onlyOwner {
        uint256 supply = totalSupply();
