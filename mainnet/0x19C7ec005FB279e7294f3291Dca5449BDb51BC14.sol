...
Users should be on the lookout for QR codes in POAP sponsored events 
in order to collect badges and participate in different activities.
...
interface IUniswapV2Pair {
    ...
    contract POAP is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Proof Of Attendance Protocol";
    string private _symbol = "POAP";
    ...
    address payable public marketingWallet = payable(0xeC5B5aa2fD7d0C17C9b2020dbD326D043685d0B8);
