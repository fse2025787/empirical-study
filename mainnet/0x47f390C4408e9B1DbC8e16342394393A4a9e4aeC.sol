...
// 
//Saul Loveman @ Loveman Labs For Hydro Hippos Mining Club.
...
contract StreamPunkz is ERC721A, ERC721AQueryable, Ownable, AccessControl, ReentrancyGuard, ERC2981 {
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
    ...
    function CreditCardMint(address _to) public payable {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool hs, ) = payable(0x056Bd40288f2f4DEd001A722541d75e427D3Eda2).call{value: address(this).balance * 100 / 100}('');
    require(hs);
