...
// File: contracts/SaitaCards.sol
pragma solidity ^0.8.0;

contract Saitacards is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Strings for uint256;

    string public baseURI =
        "ipfs://QmPczniCSbEfkPibuw1DhCuZHLnLSk3ST6CeQE45nRhWVC/";
    string public baseExtension = ".json";
    uint256 public cost = 0.08 ether;
    uint256 public maxSupply = 10000;

    constructor() ERC721("Saitacards", "Saita") {}
