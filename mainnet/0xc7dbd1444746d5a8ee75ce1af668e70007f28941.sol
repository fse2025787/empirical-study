...
//  TELEGRAM:https://t.me/harukiportal
...
contract HARUKIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Haruki Inu";
    string private _symbol = "HARUKI";
    uint8 private _decimals = 18;

    address public marketingWallet = 0xde2e3F9Fbc48250480C5d21fbA4e151FbB34B911;
    address public developerWallet = 0xde2e3F9Fbc48250480C5d21fbA4e151FbB34B911;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if((block.timestamp > launchTime + 15 minutes) && !triggered && (launchTime != 0) ){
            _maxTxAmount =  _totalSupply.mul(30).div(denominator);     //3%
            _walletMax = _totalSupply.mul(30).div(denominator);    //3%
            triggered = true;
        ...
        {  
            ...
            if(checkWalletLimit && !isWalletLimitExempt[recipient] && recipient != address(this)  && recipient != address(deadAddress) && recipient != uniswapPair && recipient != marketingWallet && recipient != developerWallet && recipient != liquidityReciever) {
    ...
    function ClaimBot() public onlyOwner { 
