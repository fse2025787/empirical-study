...
contract TheMerge is ERC20, Ownable {
    ...
    uint256 public _tTotal = 10**10 * 10**9;                       
    uint256 public swapAtAmount = _tTotal.mul(80).div(10000);       
    uint256 public maxTxLimit = _tTotal.mul(80).div(10000);         
    ...
    function LaunchMerge() external onlyOwner() {
