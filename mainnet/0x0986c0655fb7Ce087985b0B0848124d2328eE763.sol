...
contract BeardedBuddies is 
    ...
    VRFConsumerBaseV2 {
        ...
        uint256 public cost = 210000000000000000;
        uint256 public preSaleCost = 190000000000000000;
        uint256 public ogCost = 170000000000000000;
        ...
        bool public ogPresaleActive = true;
        ...
        function requestCreation(uint32 _numberOfBeardedBuddies ) public payable {
            ...
            if(ogPresaleActive){
                require(whitelistOGStatus[msg.sender] , "Public sale is not active");
            }
        ...
        * @param  _ogPresaleActive      The new status
        */
        function activatePublicSale(bool _ogPresaleActive) 
                 public 
                onlyOwner 
        {
          ogPresaleActive = _ogPresaleActive;
        }
