...
contract Electra is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://Qmdv8FWKLiCVirtBC83P4QB9132pKM7QGwTwbosBGutdtY/hidden.json";
  string  public  STAGE_ONE = "True";
  string  public  STAGE_TWO = "False";
  string  public  EVOLUTION = "3 Days, 3 Hours, 33 Minutes, 33 Seconds";
  ...
  ) ERC721A("VELECTRA THE FUTURE", "VELECTRA") {
