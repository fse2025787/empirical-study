...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1f5E8C168E344A28D30E12752077f83D5481d19B];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x1f5E8C168E344A28D30E12752077f83D5481d19B;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifxvsofpbv3fgwtql3ybdtiu6rnxgos25vzgr6jjy353rfkcsoafu/";
...
// File: contracts/ThePatriotGenesisPassContract.sol
//

pragma solidity ^0.8.0;

contract ThePatriotGenesisPassContract is RamppERC721A {
    constructor() RamppERC721A("The Patriot Genesis PASS", "PATRIOT"){}
}
