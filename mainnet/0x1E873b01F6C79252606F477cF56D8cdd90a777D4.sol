...
contract DefiApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Defi Ape";
    string private constant _symbol = "$DefiApe";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xdb173AeabdC4cEDD603bA05cdc8bAbd542881bA5);
        _feeAddrWallet2 = payable(0xdb173AeabdC4cEDD603bA05cdc8bAbd542881bA5);
