...
/**
https://t.me/YokihashiERC
https://twitter.com/Yokihashi_Erc
*/
// 
...
contract Yokihashi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Yokihashi";
    string private _symbol = "YOKIHASHI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xEBc974C1aD359e2e3B7869eACc69BE06F21CEf77);
    address payable private taxWallet2 = payable(0xEBc974C1aD359e2e3B7869eACc69BE06F21CEf77);
    ...
    function setBuyTax(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
    ...
    function setSellTax(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
