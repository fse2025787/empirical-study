...
contract PepeSociety is ERC721A, Ownable {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmNrwJguL1Cf3oiKLV3yXqkVosJNmDegXrsxNfyyPod2iJ/";
    mapping(address => uint) private _walletMintedCount;

    constructor() ERC721A("Pepe Society", "PPS") {}
    ...
    function setReveal(bool _val) public onlyOwner {
        reveal = _val;
    }

    function setMintPrice(uint256 _val) public onlyOwner {
        mintPrice = _val;
    }
