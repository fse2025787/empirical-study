...
// File: finalfingers.sol

// File: FreeFingerstwo.sol
...
contract FreeFingers is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
string public uriPrefix = "https://www.freefingers.net/ipfs/Qmb2dJPKNbB2zSMjnVaZgVUnbSnVyaaJtmtN3PczuRYVYP/"; string public uriSuffix = ""; string public hiddenMetadataUri;
...
constructor() ERC721A("FreeFingersNFT", "FNGRS") {setHiddenMetadataUri("ipfs:///hidden.json");}
