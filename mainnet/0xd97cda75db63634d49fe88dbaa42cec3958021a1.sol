...
🟢Green Ape $GREENAPE
🟢Completely community owned. 
  There is no telegram or any socials or dev behind the project.
  Community decides where it goes and will have to work for their bags.
🟢13.5% tax to support LP and 1.5% to the deployer. 15% tax on buys and sells.
  The tax supports growth for the token. Your bags will also increase from AUTO LIQUIDITY
🟢Renounced and Locked to make it safu for anyone to invest.

   🟢Max wallet 2% = 200000 tokens
...
contract GREENAPE is Context, IERC20, Ownable {
    ...
    string private _symbol = "GREENAPE";
