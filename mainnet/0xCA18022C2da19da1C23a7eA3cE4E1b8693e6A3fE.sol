...
contract CarlaOfTheLGenerative is ERC721A, Ownable {
    ...
    function mint(uint256 tokens) external payable {
        ...
        require(price * tokens == msg.value, "Carla of the L: ETH amount is incorrect");
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0, "Carla of the L: Insufficient balance");
        _withdraw(owner(), address(this).balance);
    }

    function _withdraw(address _address, uint256 _amount) private {
        (bool success,) = _address.call{value : _amount}("");
        require(success, "Carla of the L: Failed to withdraw Ether");
    }
