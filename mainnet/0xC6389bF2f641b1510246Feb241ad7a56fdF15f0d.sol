...
contract BabyMoonBirds is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Baby MoonBirds", "Baby MoonBirds", maxBatchSize_, collectionSize_, collectionSizeFree_) {
  ...
  function wmint(uint256 quantity)
    external
    payable
    callerIsUser
  {
