...
contract DerpDerp is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmR2ojtyQZyg2NECKPvhPWGk7mQCkQ59ghQ6Yu9B6enuYG/";
    ...
    constructor(
    ) ERC721A("DerpDerp", "DerpDerp", 100, maxSupply) {
    }
