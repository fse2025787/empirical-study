...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd3228214C561147bcf5a2D9450edEaE6b60C3261];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmSiFmj2afv8mqb59eY4s25xyoHcLekTb9UrUgMBoWW5RW/";
...
// File: contracts/EtherBarsContract.sol
//

pragma solidity ^0.8.0;

contract EtherBarsContract is RamppERC721A {
    constructor() RamppERC721A("EtherBars", "BARS"){}
}
