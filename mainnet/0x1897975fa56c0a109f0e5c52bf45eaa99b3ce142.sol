...
contract Otoboshi is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Otoboshi";
    string private constant _symbol = "OTOBOSHI";
