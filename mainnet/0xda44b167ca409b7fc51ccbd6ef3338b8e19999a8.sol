...
We are PONPU, a mighty force to be reckoned with.

Launching on Ethereum with Liquidity locked and a Renounced Contract. 3% tax on buys & sells will be split up: 1% to LP and 2% to Marketing.

Soon, we will show the cryptosphere who we are.

TG:         https://t.me/ponpuportal
TWITTER:    https://twitter.com/ponpuerc
MEDIUM:     https://medium.com/@ponpuerc
...
contract PONPU is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Ponpu";
    string constant _symbol = "PONPU";
