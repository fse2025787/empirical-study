...
contract SBFDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SBFDOGE";
    string private _symbol = "SBFDOGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x471E0098712E292aecAad0A4017548d076A2D170);
    address payable private BuyBackAddress = payable(0x3f92778e35f190565e4a859886CfD349116BeC60);
    ...
    function SetBuyback(address newAddress) external onlyOwner() {
