...
contract ThePrototypes is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("The Prototypes", "PTTPS") OperatorFilterer(address(OSlist), false) {
