...
contract CA is ERC20, Ownable {
    ...
    string private _name = "Thomson Reuters";
    string private _symbol = "$CZ";
    ...
    function _setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver ) external onlyOwner {
