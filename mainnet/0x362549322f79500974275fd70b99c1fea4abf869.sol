...
contract SAUSAGEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sausage Gang";
    string private constant _symbol = "SGang";
        ...
        if (
            ...
            if (!_inSwap && from != _uniswapV2Pair) {
                if (contractTokenBalance > 0) {
                    ...
                    uint256 burnCount = contractTokenBalance.div(10);
