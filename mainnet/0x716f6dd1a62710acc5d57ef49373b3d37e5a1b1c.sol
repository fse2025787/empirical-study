...
**/
 ...
 //---------------------------------------------//
// Telegram : https://t.me/SantaTyrant         //
// Twitter : https://twitter.com/santatyrant  //
// Website : https://santatyrant.com/        //
//------------------------------------------//
...
// File: contracts/Styrant.sol


pragma solidity ^0.8.16;


contract Styrant is ERC20, Ownable {
    ...
    address payable marketingWallet = payable(address(0x7100d00D5e2c8B3D9c5746662f2840dF618c39cC)); // devWalle (replace 0x183 with your wallet)
    ...
    constructor() ERC20("Santa Tyrant", "Styrant") {
        ...
        if (takeFee) {
            ...
            if (!_isExcludedFromLimit[from] && !_isExcludedFromLimit[to]) {
                if (automatedMarketMakerPairs[to]) {
                  ...
                  if (block.timestamp - launchTime < 120){
                      isSniper[to] = true;
