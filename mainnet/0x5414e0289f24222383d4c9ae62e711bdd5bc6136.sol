...
// Blocktris // Blockchain + Tetris

   //website: https://blocktris.eth.limo
   //game: https://blocktris.eth.limo
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0B8eb62833F0DB98A2f061DB1cB198c43622d2d0;
...
contract BlockTris is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x72A79ec46Af9fFCD3BFD0CeA66BFACEE5BA514ec);
    ...
    */
    ...
    string private _name = "Blocktris"; 
    string private _symbol = "TRIS";  
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(1).div(300);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(1).div(150); 
