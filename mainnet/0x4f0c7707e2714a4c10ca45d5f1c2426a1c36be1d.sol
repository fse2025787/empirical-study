...
contract  TheAcidClownCollection  is ERC721Enumerable, Ownable {
    using SafeMath for uint256;


    uint public constant _TOTALSUPPLY =2202;
    uint public maxQuantity =3;
    uint256 public price = 0.0369 ether;
    uint256 public preSaleprice = 0.022 ether;
    bool public isPaused = true;
    bool public isPreSalePaused=true;
    uint public preSaleSupply=600;
    uint public reserve = 202;
    uint private tokenId=1;
    uint public preSaleMaxQuantity = 3;
    ...
    constructor(string memory baseURI) ERC721("TheAcidClownCollection", "ACID")  {
        setBaseURI(baseURI);
    }
    ...
    function preSalemint(bytes32[] calldata _merkleProof, bytes32 merkleRoot, uint quantity) public payable { 
