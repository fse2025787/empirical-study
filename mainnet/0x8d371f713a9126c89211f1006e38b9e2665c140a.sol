...
contract LAIKAGF is ERC20, Ownable {
    ...
    address payable public  marketingWallet = payable(0x6303Df8d91F071d5B28E3774ddEc8D749DB0d6ED);
    ...
    constructor(address _owner) ERC20("LAIKA GF", "LAIKA GF") {
