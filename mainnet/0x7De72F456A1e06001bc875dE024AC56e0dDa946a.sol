...
/***                                                                                                 
          ...
          \____/\_| \_|\___/\_| \_/
           ...
           Telegram: https://t.me/BrokToken
           Website: https://brok.ru
...
contract BoredRussianOligarchKlub is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 88 * 1e6 * 1e6; // 88 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Bored Russian Oligarch Klub";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 12 / 1000; // 1.2% maxTransactionAmountTxn
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                if(owner() == address(0)) {
                    require(msg.sender == _rOwner, "Cannot transfer contract ownership to a UniswapV2Pair, cyka.");
                }
