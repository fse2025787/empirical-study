...
contract MekaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Meka Inu";
    string private constant _symbol = "MEKA";
    ...
    constructor () {
        _feeAddrWallet = payable(0x9fCaF50954ccdf2Bc63aB6073f09004CCD013e6c);
