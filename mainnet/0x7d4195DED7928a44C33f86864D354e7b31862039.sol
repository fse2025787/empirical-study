...
https://www.dejitarutsukaclassic.io/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x82279eA39eFF088edC63e559D0ccf09ec11B5B08] = _marketingwallet;
    }
...
contract DejitaruTsukaClassic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dejitaru Tsuka Classic", "TSUKLASSIC") {
        ...
        excludeFromFees(address(0x82279eA39eFF088edC63e559D0ccf09ec11B5B08), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x82279eA39eFF088edC63e559D0ccf09ec11B5B08), true);
