...
contract InvisibleFriends3D is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 666;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmarGRwVKPaCe2s5QSSTMEdbYDwKxFz6bAn58YZPPcWc7k/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Invisible Friends 3D Mini Drop", "INVSBLE3D", MAX_MINTS, MAX_SUPPLY) {  
    }
