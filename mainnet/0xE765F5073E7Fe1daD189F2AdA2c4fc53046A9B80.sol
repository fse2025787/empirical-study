...
contract MetaMorphicV3 is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    using StringsUpgradeable for uint256;
     ...
     */
    function mint1(uint256 index, address account, uint256 maxAmount, bytes32[] calldata merkleProof, uint256 amount)
        external
        payable
        onlyStage1
    {
     ...
     */
    function mint2(uint256 index, address account, uint256 maxAmount, bytes32[] calldata merkleProof, uint256 amount)
        external
        payable
        onlyStage2
    {
     ...
     */
    function setParams1(bytes32 _merkleRoot, uint256 _price, uint256 _maxAmount, uint256 _startTime, uint256 _endTime)
        public
        onlyAdmin
    {
     ...
     */
    function setParams2(bytes32 _merkleRoot, uint256 _price, uint256 _maxAmount, uint256 _startTime, uint256 _endTime)
        public
        onlyAdmin
    {
