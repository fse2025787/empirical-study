...
contract Otherdeed_26 is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = " ";
  string public notRevealedUri;
  uint256 public cost = 0.026 ether;
  uint256 public wlcost = 0.026 ether;
  uint256 public maxSupply = 100000;
  uint256 public MaxperWallet = 500;
  uint256 public MaxperWalletWl = 500;
  ...
  constructor(
  ) ERC721A("Otherdeed 26", "OTHR26") {
    setBaseURI("https://api.otherside.xyz/lands/");
  }
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(supply + tokens <= maxSupply, "Whitelist MaxSupply exceeded");
