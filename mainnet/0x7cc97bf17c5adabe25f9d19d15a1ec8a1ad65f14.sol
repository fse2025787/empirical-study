...
to take this project to the moon.
*/
...
contract WOLVERINU is ERC20, Ownable {
    ...
    constructor() ERC20("WOLVERINU", "WOLVERINU") payable {
        ...
        uint256 totalSupply = 20 * 1e15 * 1e18;
    	...
    	marketingWallet = address(0x2a14e56d14E2615CB6626B9Dbc90A6f3940F8A4D); // set as marketing wallet
        devWallet = address(0xcF7DE4C751Ee826f65aed740602AED0EA068AE5f);
        ...
        excludeFromFees(0x2a14e56d14E2615CB6626B9Dbc90A6f3940F8A4D, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x2a14e56d14E2615CB6626B9Dbc90A6f3940F8A4D, true);
