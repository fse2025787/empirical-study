...
contract Fujinushi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Fujin Ushi";
    string private _symbol = "FUJINUSHI ";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xeD368D4a7FC428cBd91590547010d0dd0BAE5e25));
        marketingWalletAddress = payable(address(0xeD368D4a7FC428cBd91590547010d0dd0BAE5e25));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xeD368D4a7FC428cBd91590547010d0dd0BAE5e25), _msgSender(), _totalSupply);
    }
