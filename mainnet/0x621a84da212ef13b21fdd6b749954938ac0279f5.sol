...
contract Rambo is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x3EA8a6db96EcBbc032e5A52A89d9029AC8e9D0dA;
    address private feeTwo = 0x12B44aDa3F1ce86368884E0e2a341cD966738163;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "RAMBO";
    string private _symbol = "RAMBO";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 500_000 * 10 ** _decimals;
    uint256 public _maxWalletAmount = 10_000 * 10 ** _decimals;
