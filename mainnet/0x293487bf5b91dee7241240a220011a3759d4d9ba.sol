 ...
 * allowances. See {IERC20-approve}.
 */
contract TWI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "TWOGE INU";
    string private _symbol = "TWI";
    ...
    address public marketingWallet = 0xd867591298573194a501f959Db1b56F8C9fcaBb8;
    uint256 private _numTokensSellToAddToLiquidity = 80 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 80 * 10**_decimals;
    // TOKENOMICS END ============================================================>
