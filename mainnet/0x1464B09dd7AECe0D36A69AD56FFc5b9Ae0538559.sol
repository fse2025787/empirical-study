...
//Alpha Screener is a utility token. The team has built the TG bot that is helpful for traders.
//Alpha Screener bot shows top 10 tokens by VOLUME/NATR/FUNDING. 
...
contract AlphaScreener 
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Alpha Screener";
    string private _symbol = "ASR";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xf01Dd7A1A5BbdBd6Aa6338F70168A4ae298F0FaD));
