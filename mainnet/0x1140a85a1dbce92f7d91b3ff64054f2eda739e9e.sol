...
contract KramaNFT is AccessControlEnumerable, ERC721Enumerable {
  using Strings for uint256;
  ...
  constructor(
    ...
    address _admin = 0x7D1b56991dfe80bc8cbf02781AB3e70e54eD6D55;
  ...
  function setBaseURI(string memory baseURI_) external {
    require(
      ...
      "KramaNFT: must have DEFAULT_ADMIN_ROLE to set base URI"
    );
  ...
  {
    require(_exists(tokenId), "KramaNFT: URI query for nonexistent token");
  ...
  function mint(string memory _tokenURI, address _to) external {
    require(
      ...
      "KramaNFT: Must have MINTER_ROLE to mint"
  ...
  function _setTokenURI(uint256 tokenId, string memory _tokenURI)
    ...
    virtual
  {
    require(_exists(tokenId), "KramaNFT: URI set of nonexistent token");
