...
https://themadoffponzi.com
https://t.me/themadoffponzi 
...
contract MWS is ERC20, Ownable {
    ...
    constructor() ERC20("The Madoff Ponzi", "MWS") {
        ...
        marketingWallet = address(0x6EcFA264B6E64704f0B9D159977E9cF711aC3aa0); // set as madoff fund
        devWallet = address(0x5ea4FC4B9789637960098B51A6602e83587E64ef); // set as dev wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(0x6EcFA264B6E64704f0B9D159977E9cF711aC3aa0), true);
        excludeFromFees(address(0xdead), true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(0x6EcFA264B6E64704f0B9D159977E9cF711aC3aa0), true);
