...
contract FRuggers is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 _buyTheBankFee = 2;
    uint256 _buyLiqFee = 0;

    uint256 _sellTheBankFee = 2;
    ...
    constructor() ERC20("Fuck Ruggers", "FRuggers") {
        ...
        maxTx = 2500000000 * 1e18; // 0.25% of supply max transaction allowed at launch
        maxWallet = 4000000000 * 1e18; // 2% of supply max wallet
        ...
        theBank = payable(0x3f333c240a8Ec9A774cbA3688Eb49Cb05604c783); 
