...
abstract contract ReentrancyGuard {
    ...
    /**
    "This collection "Pudgy Warriors" is re-mastered version of Chibi Fighters 1.0" and it is
    THE DIGITAL COLLECTIBLE "Pudgy Warriors" IS INTENDED FOR CONSUMER ENJOYMENT, USE AND CONSUMPTION ONLY. IT IS NOT A “SECURITY,” AS DEFINED UNDER THE SECURITIES ACT OF 1933, AS AMENDED, THE SECURITIES EXCHANGE ACT OF 1934, AS AMENDED, THE INVESTMENT COMPANY ACT OF 1940, AS AMENDED, OR UNDER THE SECURITIES LAWS OF ANY U.S. STATE.
...
contract NyanPunks is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint   public totalFree         = 1069;
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 6900;
    uint256 public maxperAddressPublicMint = 50;
