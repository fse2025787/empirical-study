...
// File: contracts/BoredTrialApeClub.sol
...
contract BoredTrialApeClub is ERC721A, Ownable, ReentrancyGuard, Pausable{
    ...
    constructor (
        ...
        bytes32 _root
        ) ERC721A("Bored Trial Ape Club", "BTAC") {
    ...
    function whitelistMint(uint256 _quantity, bytes32[] memory proof) external payable whenNotPaused nonReentrant {
        ...
        if (totalFreeMints[msg.sender] == 0 && freeMax <= 1000) {
            require(freeMax <= 1000, "No more free apes left!");
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        payable(0x3e242C5CFfbF57cB3575Bc0e0327eaE8bD7f0252).transfer(address(this).balance * 15 / 100);
