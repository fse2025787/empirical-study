...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE2288837fd02d4F53c28125c5e85cda326D8aDC2];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUoRU9axHtQ6C3QfBwfUWj6hbwCcqQqy6v6bcjgHiieDk/";
...
// File: contracts/TheForgottenSamuraiContract.sol
//

pragma solidity ^0.8.0;

contract TheForgottenSamuraiContract is RamppERC721A {
    constructor() RamppERC721A("The Forgotten Samurai", "FRGTSMR"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/RbzpKFC2jFu9KR6qbVB6/contract-metadata";
    }
}
