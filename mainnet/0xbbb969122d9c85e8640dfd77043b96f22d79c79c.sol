...
contract ESOC is Context, IERC20, Ownable {
    ...
    string private _name = "Esoteric Capital";
    string private _symbol = "ESOC";
    ...
    address public marketingTokenFeeWallet = 0x13FF58d7f2a2BEd2E0632672d200542FFE56ED0D;
    address public marketingETHFeeWallet = 0x13FF58d7f2a2BEd2E0632672d200542FFE56ED0D;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 100 * 10**7 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
