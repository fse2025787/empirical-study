...
contract RickAndInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Rick and Inu";//
    ...
    address payable private _developmentAddress = payable(0x1b765EA8139A915fb7A1417558C97A722c3666a4);//
    address payable private _marketingAddress = payable(0x1b765EA8139A915fb7A1417558C97A722c3666a4);//
