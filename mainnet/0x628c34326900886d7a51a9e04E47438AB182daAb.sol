...
https://twitter.com/startofreal/status/1571182158483718149?s=20&t=H2y9_IF8oDN7-NSiMcIQaQ
...
contract Fourteen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Start of Something Real";
    string private _symbol = "14";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xBE2B796a6A697509F8C74E62196b8CC238076863);
    address payable private taxWallet2 = payable(0xBE2B796a6A697509F8C74E62196b8CC238076863);
    ...
    uint256 public _liquidityShares = 4;
    ...
    function adjustMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (10000 * 10**6 * 10**9), "Max wallet should be less or equal to 4% totalSupply");
