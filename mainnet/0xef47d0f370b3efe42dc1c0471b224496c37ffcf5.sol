 ...
 * Zatoichi - $ZATO 
 *
 * Medium: https://medium.com/@zatoichierc/zatoichi-the-blind-swordsman-7620266ef083
 *
 * TG: https://t.me/Zatoichieth

 * Max buy: 19999999999 7-10% slippage for first 24hrs then, 3-7% after. 
...
contract Zatoichi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Zatoichi";
    string private constant _symbol = "ZATO";
    ...
    address payable private _developmentAddress = payable(0xBB04B8c908a21E46D630EaaCa222657DF6b5bD47);
    address payable private _marketingAddress = payable(0xBB04B8c908a21E46D630EaaCa222657DF6b5bD47);
