...
contract THENP is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Nirvana Phoenix";
    string private constant _symbol = "THENP";
