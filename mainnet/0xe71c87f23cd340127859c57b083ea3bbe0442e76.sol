...
一色雫
    ...
    low slippage -> No Taxes.
    https://t.me/ShizukuIshiki
    https://medium.com/@ShizukuIsiki
    https://twitter.com/ShizukuETH

   Contract will be renounced and LP will be burned right after the launch!
...
contract SHIZUKU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("SHIZUKU ISHIKI", "SHIZUKU") {
        ...
        marketingWallet = payable(0x928C7736a9C95e644261ef50Ae8f6D2D39C42B91);
        devWallet = payable(0x928C7736a9C95e644261ef50Ae8f6D2D39C42B91);
