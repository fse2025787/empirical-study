 ...
 constructor () public ERC721Token('Cryptovoxels Parcel', 'CVPA') {
 creator = msg.sender;
 }
 ...
 function tokenURI(uint256 _tokenId) public view returns (string) {
 return (String.appendUintToString("https: }
 ...
 require(exists(_tokenId));
 return ( boundingBoxes[_tokenId].x1, boundingBoxes[_tokenId].y1, boundingBoxes[_tokenId].z1, boundingBoxes[_tokenId].x2, boundingBoxes[_tokenId].y2, boundingBoxes[_tokenId].z2 );
 }
