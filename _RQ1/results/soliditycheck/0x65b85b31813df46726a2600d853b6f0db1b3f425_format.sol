 ...
 event LogAPICallsMade( uint apiId, address indexed sellerAddress, address indexed buyerAddress, uint pricePerCall, uint numCalls, uint totalPrice, address reportingAddress );
 event LogAPICallsPaid( uint apiId, address indexed sellerAddress, uint totalPrice, uint rewardedTokens, uint networkFee );
 event LogSpendCredits( address indexed buyerAddress, uint apiId, uint amount, bool causedAnOverdraft );
 event LogDepositCredits( address indexed buyerAddress, uint amount );
 event LogWithdrawCredits( address indexed buyerAddress, uint amount );
 constructor() public {
 version = 1;
 ...
 emit LogAPICallsMade( apiId, sellerAddress, buyerAddress, pricePerCall, numCalls, totalPrice, msg.sender );
 }
 ...
 emit LogAPICallsPaid( apiId, sellerAddress, buyerPaid, tokenReward, fee );
 ...
 emit LogAPICallsPaid( apiId, sellerAddress, totalPayable, totalTokenReward, fee );
