 ...
 constructor( address _marketplace, address _bundleMarketplace, uint256 _mintFee, address payable _feeRecipient, uint256 _platformFee ) public {
 ...
 PiArtTradable nft = new PiArtTradable( _name, _symbol, mintFee, feeRecipient, marketplace, bundleMarketplace );
 ...
 contract PiArtTradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
 ...
 constructor( string memory _name, string memory _symbol, uint256 _platformFee, address payable _feeReceipient, address _marketplace, address _bundleMarketplace ) public {
 name = _name;
 symbol = _symbol;
 platformFee = _platformFee;
 ...
 function mint( address _to, uint256 _supply, string calldata _uri ) external payable {
 ...
 (bool success, ) = feeReceipient.call{
 value: msg.value}
 ("");
 require(success, "Transfer failed");
 }
