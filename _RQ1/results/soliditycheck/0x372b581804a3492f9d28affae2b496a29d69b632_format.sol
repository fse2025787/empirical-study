 ...
 require( _msgSender() == beneficiary, "RacaVesting: only beneficiary can release vested tokens" );
 ...
 function computeReleasableAmount(uint256 currentTime) public view returns (uint256) {
 ...
 require( token.balanceOf(address(this)) >= amount, "RacaVesting: not enough withdrawable funds" );
