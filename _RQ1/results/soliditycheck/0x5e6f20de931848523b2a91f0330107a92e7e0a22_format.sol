 ...
 constructor( IVerifier _verifier, IHasher _hasher, uint256 _denomination, uint32 _merkleTreeHeight ) White(_verifier, _hasher, _denomination, _merkleTreeHeight) {
 owner = msg.sender;
 }
 modifier onlyOwner() {
