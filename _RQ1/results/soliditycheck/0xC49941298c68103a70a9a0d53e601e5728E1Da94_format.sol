 ...
 function _calculateWithdrawAmountParts( StakeData memory stake_, uint256 amount ) internal pure returns (uint256 rewardsSubValue, uint256 totalStakedSubValue) {
 ...
 function getStakes( address account, uint256 offset, uint256 limit ) public view returns (StakeData[] memory stakeData) {
 ...
 constructor( address owner_, IERC20 stakingToken_, uint256 revenue_, uint256 intervalDuration_ ) public TwoStageOwnable(owner_) {
