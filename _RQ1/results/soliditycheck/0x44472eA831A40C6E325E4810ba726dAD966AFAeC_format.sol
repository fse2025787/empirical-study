 ...
 _setApprovals( _want, _crvethPool, _cvxethPool, _mim, _crv3, address(_convexVault), address(_stableSwap2Pool) );
 ...
 function _setApprovals( address _want, address _crvethPool, address _cvxethPool, address _mim, address _crv3, address _convexVault, address _stableSwap2Pool ) internal {
