 ...
 ( uint256[] memory genesisTokens, uint256 genesisClaimableCheeth, uint256[] memory babyTokens, uint256 babyClaimableCheeth ) = getClaimableData(msg.sender);
 ...
 function getClaimableData(address owner) public view returns ( uint256[] memory genesisTokens, uint256 genesisClaimableCheeth, uint256[] memory babyTokens, uint256 babyClaimableCheeth ) {
 ...
 function setAddresses( address _genesisAddress, address _babyAddress, address rewarderAddress ) external onlyOwner {
