 ...
 constructor( string memory _name, string memory _symbol, uint8 _decimals, uint256 _initial ) public ERC20(_name, _symbol) {
 ...
 require( IERC20(token).balanceOf(address(this)) >= amount, 'ERC20MintableRecoverable: token amount should be less or equal of balance' );
