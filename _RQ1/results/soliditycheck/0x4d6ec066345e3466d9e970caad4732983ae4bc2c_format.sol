 ...
 return _addresses[stringToBytes32(name)] != address(0x0) || _inTransfer[stringToBytes32(name)];
 }
 ...
 function setMyName(string newName) public payable onlyUniqueName(newName) limitedLength(newName) onlyPaid {
 ...
 function acceptNameTranfer() public limitedLength(pendingNameTransfers[msg.sender]) {
