 ...
 constructor( uint256 maxBatchSize_, uint256 collectionSize_, uint256 amountForDevs_ ) ERC721A("WitchyMFers", "WITCHMFS", maxBatchSize_, collectionSize_) {
 ...
 function setupNonAuctionSaleInfo( uint64 mintlistPriceWei, uint64 publicPriceWei, uint32 publicSaleStartTime ) external onlyOwner {
