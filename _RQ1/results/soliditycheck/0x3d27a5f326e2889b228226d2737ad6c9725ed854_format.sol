 ...
 Address.functionDelegateCall( 0x2d3fC875de7Fe7Da43AD0afa0E7023c9B91D06b1, abi.encodeWithSignature("initialize(string,string)", name, symbol) );
 }
 ...
 pragma solidity ^0.8.0;
 contract YW is ERC721Creator {
 constructor() ERC721Creator("YRWRLD", "YW") {
 }
 }
