 ...
 function _mcdManagerGenerate( IManager _mcdManager, uint256 _vaultId, uint256 _amount, uint256 _rate, uint256 _daiVatBalance ) internal {
 ...
 function _cropperGenerate( uint256 _vaultId, bytes32 _ilk, uint256 _amount, uint256 _rate, uint256 _daiVatBalance ) internal {
 address owner = ICdpRegistry(CDP_REGISTRY).owns(_vaultId);
