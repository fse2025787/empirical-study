 ...
 constructor(address oneTokenFactory_, string memory description_, address indexToken_) OracleCommon(oneTokenFactory_, description_, indexToken_) {
 }
 ...
 ( , int256 price_, , , ) = AggregatorV3Interface(chainlinkOracles[token]).latestRoundData();
 require(price_ > 0);
