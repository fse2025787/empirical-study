 ...
 constructor( string memory initBaseURI, address signer, uint256 _maxBatchSize, uint256 _collectionSize ) ERC721A("Puggy Squad", "Puggy", _maxBatchSize, _collectionSize) {
 baseURI = initBaseURI;
 _signer = signer;
 ...
 function preMint( uint256 amount, string calldata salt, bytes calldata token ) external payable {
