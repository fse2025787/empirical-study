 ...
 function doSwap( uint256 amountIn, uint256 minAmountOut, address spender, address target, address[] memory path ) external returns (uint256);
 }
 pragma solidity 0.6.12;
 ...
 function doSwap( uint256 amountIn, uint256 minAmountOut, address spender, address target, address[] memory path ) public override returns(uint256) {
 ...
 pragma solidity 0.6.12;
 contract SushiswapDex is UniBasedDex(0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F, 0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac) {
 }
