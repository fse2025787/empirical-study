 ...
 nonce: nonces[userAddress], from: userAddress, functionSignature: functionSignature }
 );
 ...
 constructor(address _proxyRegistryAddress) ERC721Tradable("HashGarageSpecials", "HGSp", _proxyRegistryAddress) {
 }
