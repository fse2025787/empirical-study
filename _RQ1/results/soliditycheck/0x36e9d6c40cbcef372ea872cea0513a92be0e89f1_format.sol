 ...
 uint256 public unitPrice = 0.0555 ether;
 ...
 require( totalSupply + _count <= maxSupply, "Count exceeds the maximum allowed supply." );
 totalSupply += _count;
 if (_count > 1) {
 ...
 address[4] memory addresses = [ 0xf0c174cBC9511f0102838DFd2Fb3b86147712bD6, 0xCF2FbB322643f4699751Bf9Cf2A5f070Fc85591c, 0x119F5c2ace3AB6BDEB7B2b4b5E5537379eEf31d8, 0x209a656954c60828400f641599768484beA4d5F3 ];
 uint32[4] memory shares = [ uint32(1000), uint32(4000), uint32(1000), uint32(4000) ];
