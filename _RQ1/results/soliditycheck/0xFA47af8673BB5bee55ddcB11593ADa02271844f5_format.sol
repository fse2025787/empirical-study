 ...
 function init( bytes32 _vaultName, address _token, address _strategy, address _owner ) external initializer {
 ...
 require( _networkFeePercentage[0] < 3000 && _networkFeePercentage[1] < 3000 && _networkFeePercentage[2] < 3000, "Network fee percentage cannot be more than 30%" );
