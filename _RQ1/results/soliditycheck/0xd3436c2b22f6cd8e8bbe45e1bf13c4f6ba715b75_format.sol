 ...
 string private baseURI = "ipfs: uint256 public constant MAX_MINTS_PER_TX = 5;
 ...
 constructor( ) ERC721A("Ether Lottery", "Lottery", 100, maxSupply) {
 }
 modifier isCorrectPayment(uint256 price, uint256 numberOfTokens) {
 require( (price * numberOfTokens) == msg.value, "Incorrect ETH value sent" );
 _;
 }
 function mint(uint256 numberOfTokens) external payable nonReentrant publicSaleActive isCorrectPayment(PUBLIC_SALE_PRICE, numberOfTokens) canMintNFTs(numberOfTokens) maxMintsPerTX(numberOfTokens) {
