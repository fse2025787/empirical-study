 ...
 function init( uint256 _plxTotalValue, uint256 _usdtHardCap, uint256 _usdtSoftCap, uint256 _userHardCap, uint256 _userSoftCap ) public {
 ...
 function initP2( uint256 _plxTotalValueP2, uint256 _usdtHardCapP2, uint256 _usdtSoftCapP2, uint256 _userHardCapP2, uint256 _userSoftCapP2 ) public {
 require(msg.sender == dev);
 ...
 require( usdtHardCap.sub(usdtTotalReciveAmount) >= userDepositAmountInt, "PLEXUS : The deposit amount exceeds the hardcap." );
 ...
 require( _userDepositAmount >= userSoftCap && user.amount <= userHardCap, "PLEXUS : The deposit amount exceeds the hardcap." );
 ...
 address depositUser = msg.sender;
 require( usdtHardCapP2.sub(usdtTotalReciveAmountP2) >= userDepositAmountInt, "PLEXUS : The deposit amount exceeds the hardcap." );
 ...
 require( _userDepositAmount >= userSoftCapP2 && user.amountP2 <= userHardCapP2, "PLEXUS : The deposit amount exceeds the hardcap." );
