 ...
 string[] private relation = [ "acceptance", "acquiescence", "bend", "cave", "condescend", "hold", "peace", "resignation", "settle", "tolerate", "yield to sth" ];
 string[] private characteristic = [ "capitulation", "compromise", "defer", "hold your nose", "philosophical", "resort", "surrender", "trade", "bend", "cave", "relent", "reconcile", "submit", "trade", "yield" ];
 string[] private feature = [ "resign", "accumulation", "production", "exchange", "market", "maximize", "value", "ownership", "labor", "investment", "money", "profit", "competition", "efficient", "factors", "production", "maximization", "process" ];
 string[] private presence = [ "sellers", "buyers", "hodlers", "speculators", "scammers", "developers", "marketers", "leaders" ];
 string[] private direction = [ "bulls", "bears" ];
 ...
 _owned = msg.sender;
 metadataURI = uri;
 for(uint i=0; i<=ARTIST_PRINTS; i++) _mintTo(msg.sender);
 }
 ...
 "trait_type":"Feature", "value": "', getFeature(tokenId), '"}
 ,{
 "trait_type":"Characteristic", "value": "', getCharacteristic(tokenId), '"}
 ,{
 "trait_type":"Direction", "value": "', getDirection(tokenId), '"}
 ,{
 "trait_type":"Type", "value": "', getRelation(tokenId), '"}
 ,{
 "trait_type":"Tribe", "value": "' ,getPresence(tokenId),'"}
 ]}
 '));
 return string( abi.encodePacked( 'data:application/json;
 base64,', Base64.encode( bytes( abi.encodePacked( '{
 "name":"', name, tokenName[tokenId], '", "description":"', description, '","image_data":"data:image/svg+xml;
 base64,', image, '","image":"data:image/svg+xml;
 base64,', image, attributes ) ) ) ) );
 }
 ...
 return string( abi.encodePacked( '<svg xmlns="http: '<style>.bl {
 ...
 </style>', '<rect width="100%" height="100%" fill="black"/>', '<text x="50%" y="40%" dominant-baseline="middle" text-anchor="middle" class="main">Sell your soul</text>', '<text x="20" y="210" dominant-baseline="middle" text-anchor="left" class="undr">Sign here: ...................................................................</text>', '<text x="10%" y="17%" dominant-baseline="middle" text-anchor="left" class="old" transform="scale(0.19 3)">', back, '</text>', '<text x="90" y="205" dominant-baseline="middle" text-anchor="right" class="sig" textLength="246" lengthAdjust="spacingAndGlyphs">',tokenName[tokenId],'</text>' '</svg>' ) );
 }
