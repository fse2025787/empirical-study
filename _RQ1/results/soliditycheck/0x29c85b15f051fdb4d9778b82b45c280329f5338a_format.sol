 ...
 function history(uint256 tokenId) public view virtual returns (string[] memory) {
 require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
 ...
 function mint(address recipient, string memory uri, address referal) public payable {
