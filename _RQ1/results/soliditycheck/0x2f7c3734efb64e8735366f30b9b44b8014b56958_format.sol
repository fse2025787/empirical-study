 ...
 Address.functionDelegateCall( 0xe4E4003afE3765Aca8149a82fc064C0b125B9e5a, abi.encodeWithSignature("initialize(string,string)", name, symbol) );
 }
 ...
 constructor() ERC721Creator("The Philippe Halsman Archive", "PH") {
 }
 }
