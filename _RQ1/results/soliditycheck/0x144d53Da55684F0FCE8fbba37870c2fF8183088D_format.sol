 ...
 function initialize( address _tos, address _paytoken, uint256 _cap, uint256 _saleStartBlock, uint256 _stakeStartBlock, address _stakefactory, uint256 _stakeType, address _defiAddr ) external;
 }
 pragma solidity ^0.7.6;
 ...
 require( _impl != address(0) && !pauseProxy, "StakeVaultProxy: impl OR proxy is false" );
 assembly {
 ...
 function initialize( address _tos, address _paytoken, uint256 _cap, uint256 _saleStartBlock, uint256 _stakeStartBlock, address _stakefactory, uint256 _stakeType, address _defiAddr ) external override onlyOwner {
 require(tos == address(0), "StakeVaultProxy: already initialized");
 require( _tos != address(0) && _stakefactory != address(0), "StakeVaultProxy: input is zero" );
 require(_cap > 0, "Stake1Vault: _cap is zero");
 require( _saleStartBlock < _stakeStartBlock && _stakeStartBlock > 0, "StakeVaultProxy: startBlock is unavailable" );
 tos = _tos;
 cap = _cap;
 paytoken = _paytoken;
