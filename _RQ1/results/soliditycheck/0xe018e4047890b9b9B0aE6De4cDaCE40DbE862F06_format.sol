 ...
 string public baseTokenURI = "ipfs: uint256 public maxSupply = 3333;
 ...
 constructor( ) ERC721A("AstarCats", "AstarCats") {
 }
 ...
 function treasuryMint(uint quantity, address user) public onlyOwner {
