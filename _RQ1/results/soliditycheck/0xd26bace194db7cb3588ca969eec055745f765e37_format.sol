 ...
 function increaseApproval(address _spender, uint _addedValue) public whenNotLockedOrAuthorized returns (bool success) {
 return super.increaseApproval(_spender, _addedValue);
 }
 function decreaseApproval(address _spender, uint _subtractedValue) public whenNotLockedOrAuthorized returns (bool success) {
 return super.decreaseApproval(_spender, _subtractedValue);
 }
 }
 library SafeMath {
