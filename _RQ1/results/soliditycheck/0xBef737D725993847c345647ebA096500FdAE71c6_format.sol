 ...
 pragma solidity ^0.7.6;
 contract PublicSaleProxy is PublicSaleStorage, AccessibleCommon, ProxyBase, IPublicSaleProxy {
 ...
 function initialize( address _saleTokenAddress, address _getTokenAddress, address _getTokenOwner, address _sTOS ) external override onlyOwner {
