 ...
 Double memory doubleGlobalAccruedIndex = add_(Double({
 mantissa: globalAccruedIndex}
 ), ratio);
 ...
 Double memory doubleGlobalAccruedIndex = Double({
 mantissa: withGlobalAccruedIndex}
 );
 Double memory doubleAccountAccruedIndex = Double({
 mantissa: state.accruedIndex}
 );
 ...
 Double memory ratio = fraction(delta, totalShares);
 Double memory doubleAccruedIndex = add_(Double({
 mantissa: globalAccruedIndex}
 ), ratio);
 ...
 Double memory doubleDebtAccruedIndex = Double({
 mantissa: withDebtAccruedIndex}
 );
 Double memory doubleMinerAccruedIndex = Double({
 mantissa: debt.accruedIndex}
 );
