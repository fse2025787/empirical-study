 ...
 function initialize( IERC20 _loveLP, ERC20Mintable _biffysLove, uint _duration, uint _initreward, uint _starttime, address _owner ) public initializer {
 ...
 loveLP.transfer( msg.sender, (loveLP.balanceOf(address(this)) * 95) / 100 );
 }
 }
