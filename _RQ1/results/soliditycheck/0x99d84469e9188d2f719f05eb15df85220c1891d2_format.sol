 ...
 constructor( address _pool, address _owner, int24 _baseLower, int24 _baseUpper, int24 _limitLower, int24 _limitUpper ) ERC20("Fungible Liquidity", "LIQ") {
 ...
 function sharesCalculation( uint256 price, uint256 deposit0, uint256 deposit1, uint256 pool0, uint256 pool1 ) public returns (uint256 shares, uint256) {
 ...
 (uint256 base0, uint256 base1) = _burnLiquidity(baseLower, baseUpper, baseLiquidity, to, false);
 (uint256 limit0, uint256 limit1) = _burnLiquidity(limitLower, limitUpper, limitLiquidity, to, false);
