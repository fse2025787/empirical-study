 ...
 contract Future is IERC20, Auth {
 using SafeMath for uint256;
 address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
 string constant _name = "Future";
 string constant _symbol = "REMAIN";
 ...
 marketingFeeReceiver = address(0xdC5f7Da162Dd4657DC2932400C5D76C2B6964D1C);
 teamFeeReceiver = address(0xdC5f7Da162Dd4657DC2932400C5D76C2B6964D1C);
 ...
 router.swapExactTokensForETHSupportingFeeOnTransferTokens( amountToSwap, 0, path, address(this), block.timestamp+360 );
 ...
 ( address(this), amountToLiquify, 0, 0, autoLiquidityReceiver, block.timestamp+360 );
 ...
 return launchedAt !=0 && launchedAt + 3 < block.number && launchedTime + 10 seconds >= block.timestamp ;
 }
