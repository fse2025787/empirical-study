 ...
 contract BitCreatures is ERC721A, Ownable, ReentrancyGuard {
 string public baseURI = "ipfs: string public baseExtension = ".json";
 uint public price = 0.005 ether;
 uint public maxPerTx = 10;
 uint public maxTxForFreeMints = 1;
 uint public totalFree = 100;
 uint public maxSupply = 800;
 uint public nextOwnerToExplicitlySet;
 bool public mintEnabled = true;
 constructor() ERC721A("BitCreatures", "BitCreatures"){
 }
 ...
 if (cost == 0) {
 require( amount <= maxTxForFreeMints, "Max per TX reached.");
 }
 else {
