 ...
 (_localVal[0], _localVal[1] , _localVal[2] ,_localVal[8],_localVal[10]) = _getTValues(tAmount);
 _localVal[3] = _getRate();
 ( _localVal[4] , _localVal[5] , _localVal[6] , _localVal[7] ,_localVal[9],_localVal[11]) = _getRValues(tAmount, _localVal[1], _localVal[3], _localVal[2],_localVal[8],_localVal[10]);
 ...
 _localVal[0] = tAmount.div(100).mul(0);
 _localVal[1] = tAmount.div(100).mul(0);
 _localVal[2] = tAmount.div(100).mul(1 );
 _localVal[3] = tAmount.div(100).mul(15);
 _localVal[4] = tAmount.sub(_localVal[2]).sub(_localVal[1]).sub(_localVal[0]).sub(_localVal[3]);
