 ...
 function award( uint256 _id, address _recipient, uint256 _amount, bytes32[] memory _proof ) public {
 require(_id <= airdropsCount, ERROR_INVALID);
 ...
 function awardFromMany( uint256[] memory _ids, address _recipient, uint256[] memory _amounts, bytes memory _proofs, uint256[] memory _proofLengths ) public {
 uint256 totalAmount;
 uint256 marker = 32;
 ...
 function extractProof( bytes memory _proofs, uint256 _marker, uint256 proofLength ) public pure returns (bytes32[] memory proof) {
