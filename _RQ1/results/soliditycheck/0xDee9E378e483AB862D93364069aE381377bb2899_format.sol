 ...
 function swap( address token, bytes memory path, bool send ) external onlyOwner {
 ...
 uint256 amountOut = router.exactInput( ISwapRouter.ExactInputParams( path, send ? recipient : address(this), block.timestamp + 10000, balance, 0 ) );
