 ...
 string private _name = "StrongInu";
 ...
 uint256 internal _tokenTotal = 1_000_000_000*(10**decimals());
 ...
 address liquidityWallet=0xf3E97352D135A7296351d725AfA484bCdaC5C83e;
 ...
 uint256 public maxTxAmount = 10_000_000*(10**decimals()) ;
 uint256 public minTokensBeforeSwap = 10_000*(10**decimals());
 ...
 require( account != address(uniswapV2Router), "ERC20: We can not exclude Uniswap router." );
 ...
 for (uint256 i = 0; i < _excluded.length; i++) {
 if ( _reflectionBalance[_excluded[i]] > reflectionSupply || _tokenBalance[_excluded[i]] > tokenSupply ) return _reflectionTotal.div(_tokenTotal);
