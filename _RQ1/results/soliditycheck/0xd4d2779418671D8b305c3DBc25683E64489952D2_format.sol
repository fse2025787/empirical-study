 ...
 function getTokenID(uint256 chainID, address tokenAddress) public view returns (address) {
 return _tokenIDMap[chainID][tokenAddress];
 }
 function getMultichainToken(address token, uint256 chainID) public view returns (address) {
 address tokenID;
 ...
 function getTokenConfig(address tokenID, uint256 chainID) public view returns (TokenConfig memory) {
 return _tokenConfig[tokenID][chainID];
 }
 function _setTokenConfig( address tokenID, uint256 chainID, TokenConfig memory config ) internal checkTokenConfig(config) returns (bool) {
 ...
 function setTokenConfig( address tokenID, uint256 chainID, address tokenAddress, uint8 tokenDecimals, uint256 maxSwap, uint256 minSwap, uint256 swapFee, uint256 maxSwapFee, uint256 minSwapFee ) external returns (bool) {
 ...
 function _setMultichainToken( address tokenID, uint256 chainID, address token ) internal {
 MultichainToken[] storage _mcTokens = _allMultichainTokens[tokenID];
 for (uint256 i = 0; i < _mcTokens.length; ++i) {
 if (_mcTokens[i].chainId == chainID) {
