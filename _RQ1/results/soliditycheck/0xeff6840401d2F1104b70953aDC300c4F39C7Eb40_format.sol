 ...
 function addCollateralBase( bytes32 _ilk, address _gem, address _join, address _clip, address _calc, address _pip ) public {
 }
 ...
 string public constant override description = "2021-11-26 MakerDAO Executive Spell | Hash: 0x7be806b3c9fa08603c0e25a1d73066384dcb0770407aeeb57668742321823d2c";
 ...
 _name: "Increase SB - 20211126", _target: DssExecLib.vow(), _what: "hump", _startTime: block.timestamp, _start: 60 * MILLION * RAD, _end: 90 * MILLION * RAD, _duration: 210 days }
 );
 DssExecLib.addNewCollateral( CollateralOpts({
 ilk: "WBTC-C", gem: WBTC, join: MCD_JOIN_WBTC_C, clip: MCD_CLIP_WBTC_C, calc: MCD_CLIP_CALC_WBTC_C, pip: PIP_WBTC, isLiquidatable: true, isOSM: true, whitelistOSM: true, ilkDebtCeiling: 100 * MILLION, minVaultAmount: 7500, maxLiquidationAmount: 25 * MILLION, liquidationPenalty: 1300, ilkStabilityFee: ONE_FIVE_PCT_RATE, startingPriceFactor: 12000, breakerTolerance: 5000, auctionDuration: 90 minutes, permittedDrop: 4000, liquidationRatio: 17500, kprFlatReward: 300, kprPctReward: 10 }
 ) );
 ...
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(RWF_WALLET, 1_860_000.00 * 10**18, JAN_01_2022, DEC_31_2022 - JAN_01_2022, 0, address(0)) );
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(COM_WALLET, 12_242.00 * 10**18, DEC_01_2021, DEC_31_2021 - DEC_01_2021, 0, address(0)) );
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(COM_WALLET, 257_500.00 * 10**18, JAN_01_2022, JUN_30_2022 - JAN_01_2022, 0, address(0)) );
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(SAS_WALLET, 1_130_393.00 * 10**18, DEC_01_2021, NOV_30_2022 - DEC_01_2021, 0, address(0)) );
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(IS_WALLET, 366_563.00 * 10**18, DEC_01_2021, AUG_01_2022 - DEC_01_2021, 0, address(0)) );
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(MKT_WALLET, 424_944.00 * 10**18, DEC_01_2021, APR_30_2022 - DEC_01_2021, 0, address(0)) );
 VestAbstract(MCD_VEST_DAI).restrict( VestAbstract(MCD_VEST_DAI).create(DECO_WALLET, 5_121_875.00 * 10**18, DEC_01_2021, SEP_01_2024 - DEC_01_2021, 0, address(0)) );
