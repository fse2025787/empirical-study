 ...
 function loanLogic( bool deficit, uint256 amountDAI, uint256 amount, CErc20I cToken ) public returns (bytes32) {
 bool isDai;
 ...
 function _normalDeleverage( uint256 maxDeleverage, uint256 lent, uint256 borrowed, uint256 collatRatio ) internal returns (uint256 deleveragedAmount) {
 ...
 function _normalLeverage( uint256 maxLeverage, uint256 lent, uint256 borrowed, uint256 collatRatio ) internal returns (uint256 leveragedAmount) {
 ...
 constructor( address _vault, address _cToken ) public {
 ...
 function cloneLevComp( address _vault, address _cToken ) external returns (address payable newStrategy) {
