 ...
 constructor (address _token) public ERC20Detailed( string(abi.encodePacked("bt:vault: ", ERC20Detailed(_token).name())), string(abi.encodePacked("b", ERC20Detailed(_token).symbol())), ERC20Detailed(_token).decimals() ) {
 token = IERC20(_token);
