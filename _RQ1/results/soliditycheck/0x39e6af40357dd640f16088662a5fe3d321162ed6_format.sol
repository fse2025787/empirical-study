 ...
 constructor(address _owner, address _minter) StandardToken( "Real Direct Token", "RDT", 18 ) HasOwner(_owner) MintableToken(_minter) public {
 }
 }
 ...
 token = new RealDirectToken( msg.sender, address(this) );
 initializeBasicFundraiser( 1534291200, 1544918340, 20000, 0xEcB3c79EB0A9f539340adE65e8823CE8d248fbad );
