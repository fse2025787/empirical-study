 ...
 contract PumpElon is Context, IERC20, Ownable {
 ...
 string private _name = "PUMP ELON PUMP";
 string private _symbol = "PUMPE";
 ...
 uint256 private numTokensSellToAddToLiquidity = 700 * 10**6 * 10**9;
