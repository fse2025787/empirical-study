 ...
 constructor( IBagBang _bagBang, IERC20 _rewardToken, address _feeAddress, uint256 _feeEndBlock, uint256 _rewardStartBlock, uint256 _rewardNumBlocks, uint256 _totalRewards ) public {
 ...
 function addPool( uint256 _allocPoint, address _stakingToken, uint16 _earlyWithdrawalFeeBP, bool _withUpdate ) public onlyOwner {
 ...
 stakingToken: _stakingToken, allocPoint: _allocPoint, lastRewardBlock: lastRewardBlock, accRewardPerShare: 0, earlyWithdrawalFeeBP: _earlyWithdrawalFeeBP }
 ) );
 }
 function setPool( uint256 _pid, uint256 _allocPoint, uint16 _earlyWithdrawalFeeBP ) public onlyOwner {
 ...
 if (block.number > pool.lastRewardBlock && lpSupply > 0 && pool.lastRewardBlock < rewardEndBlock ) {
