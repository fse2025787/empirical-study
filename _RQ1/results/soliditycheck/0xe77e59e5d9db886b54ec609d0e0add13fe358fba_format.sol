 ...
 contract x00ts is ERC721A, Owneable {
 string public baseURI = "ipfs: string public contractURI = "ipfs: string public baseExtension = ".json";
 ...
 constructor() ERC721A("x00ts", "x00ts") {
 }
