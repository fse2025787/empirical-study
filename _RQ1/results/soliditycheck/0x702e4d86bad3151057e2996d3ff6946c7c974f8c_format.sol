 ...
 uint256 public mintPerTx = 10;
 uint256 public maxSupply = 4444;
 uint256 public presaleCost = .1 ether;
 uint256 public publicCost = .1 ether;
 constructor(string memory _initBaseURI) ERC721A("Annoying Tiger Club", "ATC") {
 ...
 require( quantity <= maxWhitelist, "You're Not Allowed To Mint more than maxMint Amount" );
