 ...
 constructor() public ERC721("HodlTheVoid", "HTV") {
 tokenCounter = 0;
 ...
 return void.justice + void.codex.mul_outer(6) + void.oxygen.mul_outer(36) + void.energy.mul_outer(216) + void.mobility.mul_outer(1296);
 }
