 ...
 function setTokenWrapperAddress( address _tokenAddress, address _wrapperAddress ) external;
 function getTokenWrapperAddress(address _tokenAddress) external view returns (address);
 }
 pragma solidity 0.7.6;
 ...
 function setTokenLimit(address _tokenAddress, uint256 _newLimit) external override onlyOwner notZeroAddress(_tokenAddress) {
 ...
 function getTokenLimit(address _tokenAddress) external view override returns (uint256) {
 return tokenLimits[_tokenAddress];
 }
 function setTokenWrapperAddress(address _tokenAddress, address _wrapperAddress) external override onlyOwner notZeroAddress(_tokenAddress) {
 tokenWrappers[_tokenAddress] = _wrapperAddress;
 emit LogTokenWrapperChanged(_wrapperAddress, msg.sender);
 }
 function getTokenWrapperAddress(address _tokenAddress) external view override returns (address) {
