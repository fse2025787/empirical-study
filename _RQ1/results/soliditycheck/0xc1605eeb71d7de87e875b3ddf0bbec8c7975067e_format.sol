 ...
 pragma solidity ^0.8.0;
 contract NotpopoPOPOpopo is ERC721A, Ownable, ReentrancyGuard {
 using Address for address;
 using Strings for uint;
 string public baseTokenURI = "ipfs: uint256 public maxSupply = 3000;
 ...
 constructor( ) ERC721A("Not popoPOPOpopo", "NOTpoPO") {
 }
