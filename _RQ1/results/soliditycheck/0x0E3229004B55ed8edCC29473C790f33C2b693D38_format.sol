 ...
 NOOP, DEPOSIT, WITHDRAWAL, TRANSFER, SPOT_TRADE, ACCOUNT_UPDATE, AMM_UPDATE, SIGNATURE_VERIFICATION, NFT_MINT, NFT_DATA }
 enum NftType {
 ERC1155, ERC721 }
 struct Token {
 address token;
 ...
 function isNFT(uint16 tokenID) internal pure returns (bool) {
