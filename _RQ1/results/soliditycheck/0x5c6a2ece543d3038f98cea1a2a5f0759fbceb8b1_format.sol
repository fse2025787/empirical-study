 ...
 function batchTokensTransfer(IERC20Token _token, address[] _usersWithdrawalAccounts, uint256[] _amounts) public ownerOnly() {
 ...
 function transferToken(IERC20Token _token, address _userWithdrawalAccount, uint256 _amount) public ownerOnly() {
