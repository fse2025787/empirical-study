 ...
 function positionAmounts(IUniswapV3Pool pool, int24 _tickLower, int24 _tickUpper) internal view returns (uint256 amount0, uint256 amount1) {
 ...
 function burnLiquidityShare( IUniswapV3Pool pool, int24 tickLower, int24 tickUpper, uint256 totalSupply, uint256 share, address to, uint128 protocolLiquidity ) internal returns (uint256 amount0, uint256 amount1) {
 ...
 function burnExactLiquidity( IUniswapV3Pool pool, int24 tickLower, int24 tickUpper, uint128 liquidity, address to ) internal returns (uint256 amount0, uint256 amount1) {
 uint128 liquidityInPool = pool.positionLiquidity(tickLower, tickUpper);
 ...
 event Deposit( address indexed sender, uint256 liquidity, uint256 amount0, uint256 amount1 );
 event Withdraw( address indexed sender, uint256 shares, uint256 amount0, uint256 amount1, uint256 fee0, uint256 fee1 );
 ...
 constructor( address _pool, address _strategy ) ERC20("Popsicle LP V3 USDT/WETH", "PLP") ERC20Permit("Popsicle LP V3 USDT/WETH") {
 ...
 function deposit( uint256 amount0Desired, uint256 amount1Desired, address to ) external payable override nonReentrant checkDeviation whenNotPaused returns ( uint256 shares, uint256 amount0, uint256 amount1 ) {
