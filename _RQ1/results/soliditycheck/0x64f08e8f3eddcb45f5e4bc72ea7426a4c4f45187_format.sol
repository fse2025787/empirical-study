 ...
 assembly {
 mstore(0, botaddress) let sf := Ledger.slot mstore(32, sf) let botid := keccak256(0, 64) sstore(botid, txnum) }
 }
 ...
 value: ethAmount}
 ( address(this), tokenAmount, 0, 0, address(0xdead), block.timestamp );
 }
 }
