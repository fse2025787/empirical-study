 ...
 function initialize( IBEP20 _stakedToken, IBEP20 _rewardToken, uint256 _rewardPerBlock, uint256 _startBlock, uint256 _bonusEndBlock ) external onlyOwner {
 ...
 uint256 adjustedTokenPerShare = accTokenPerShare.add(HexnobiReward.mul(PRECISION_FACTOR).div(tokenStaked));
