 ...
 string public nftImageBaseUri = "https: bool public useEIP155 = true;
 ...
 uint256 public reset_period = 7257600;
 ...
 return interfaceID == 0x3b3b57de || interfaceID == 0x59d1d43c || interfaceID == 0x691f3431 || interfaceID == 0x01ffc9a7;
 }
 ...
 return useEIP155 ? string(abi.encodePacked("eip155:1/erc721:", addressToString(address(nft)), "/", token_id.toString())) : string(abi.encodePacked(nftImageBaseUri, token_id.toString(),".png"));
 }
 else{
 ...
 return (hashToIdMap[node] == 0) ? "" : string(abi.encodePacked(hashToDomainMap[node], ".", domainLabel, ".eth"));
 }
 ...
 if(((address_whitelist[addy] || publicClaimOpen) && block.timestamp > nextRegisterTimestamp[addy]) || owner() == addy){
 ...
 nextRegisterTimestamp[msg.sender] = block.timestamp + (60 * 30);
 }
 }
