 ...
 function exchange( uint256 from, uint256 to, uint256 _from_amount, uint256 _min_to_amount, bool use_eth ) external;
 ...
 using Address for address;
 using SafeMath for uint256;
 address public constant depositContract = 0xF403C135812408BFbE8713b5A23a04b3D48AAE31;
 ...
 ICurveFi public constant curve = ICurveFi(0x8301AE4fc9c624d1D396cbDAa1ed877821D7C511);
 ...
 constructor( address _vault, uint256 _pid, string memory _name ) public StrategyConvexBase(_vault) {
