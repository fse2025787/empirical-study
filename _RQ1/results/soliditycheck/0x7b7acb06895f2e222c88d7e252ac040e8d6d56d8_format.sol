 ...
 constructor( address payable[] memory recipients_, uint256[] memory percentages_ ) {
 ...
 require( msg.value > 0, "FlexPaymentDivider: Insufficient message value" );
 ...
 function _setupRecipients( address payable[] memory recipients_, uint256[] memory percentages_ ) internal {
 require( recipients_.length == percentages_.length, "FlexPaymentDivider: Unequal input lengths" );
 uint256 sum = 0;
 for (uint256 i = 0; i < recipients_.length; i++) {
 require( percentages_[i] > 0, "FlexPaymentDivider: Percentage must exceed 0" );
 require( percentages_[i] <= 100, "FlexPaymentDivider: Percentage must not exceed 100" );
 sum += percentages_[i];
 _recipientCount += 1;
 ...
 constructor( address payable[] memory payoutAccounts_, uint256[] memory payoutPercentages_ ) {
