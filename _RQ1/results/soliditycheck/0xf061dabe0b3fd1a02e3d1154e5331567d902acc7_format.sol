 ...
 constructor( address _collateralJoin, bytes32 _collateralIlk, address _collateral, uint256 _collateralDecimal, address _collateralOracle, uint256 _collateralPriceDecimal, bool _collateralPriceEth, address _want, address _governance, address _strategist, address _controller, address _timelock ) public StrategyBase(_want, _governance, _strategist, _controller, _timelock) {
 ...
 constructor(address _governance, address _strategist, address _controller, address _timelock) public StrategyMakerBase( wbtc_apt, wbtc_ilk, wbtc_collateral, wbtc_collateral_decimal, link_btc_usd, weth_price_decimal, wbtc_price_eth, wbtc_collateral, _governance, _strategist, _controller, _timelock ) {
 ...
 (, uint256 bal) = mulScalarTruncate(Exp({
 mantissa: exchangeRateStored}
 ), IERC20(fusePool).balanceOf(address(this)));
