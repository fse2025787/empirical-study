 ...
 function add( IERC20 _stakeToken, uint256 _startBlock, uint256 _rewardPerBlock, uint256 _totalReward, uint256 _claimableStartBlock, uint256 _lockedEndBlock ) public onlyOwner {
 ...
 emergencySwitch: true, stakeToken: _stakeToken, stakeTokenSupply: 0, startBlock: _startBlock, rewardPerBlock: _rewardPerBlock, totalReward: _totalReward, leftReward: _totalReward, claimableStartBlock: _claimableStartBlock, lockedEndBlock: _lockedEndBlock, lastRewardBlock: lastRewardBlock, rewardPerShare: 0 }
 ));
 }
