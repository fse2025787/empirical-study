 ...
 function accrueRevenue( address bank, address underlying, uint256 amount ) external;
 ...
 function safeTokenTransfer( address recipient, address token, uint256 amount ) internal returns (uint256) {
 if (amount == 0) {
 return 0;
 }
 ...
 event AccrueRevenue( address indexed bank, address indexed strategy, uint256 profitAmount, uint256 buybackAmount, uint256 managementAmount );
 ...
 function accrueRevenue( address bank, address underlying, uint256 amount ) external override onlyStrategy(bank, msg.sender) {
 ...
 function setLiquidator( address _liquidator, address _from, address _to ) external onlyGovernance {
