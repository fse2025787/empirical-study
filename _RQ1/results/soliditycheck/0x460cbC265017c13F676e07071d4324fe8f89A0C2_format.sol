 ...
 function settleAuctionWithBond( uint256[] calldata, address[] calldata, uint256[] calldata, address[] calldata, uint256[] calldata ) external;
 function settleAuctionWithoutBond( uint256[] calldata, address[] calldata, uint256[] calldata, address[] calldata, uint256[] calldata ) external;
 ...
 function settleAuctionWithBond( uint256[] memory bountyIDs, address[] memory inputTokens, uint256[] memory inputAmounts, address[] memory outputTokens, uint256[] memory outputAmounts ) public nonReentrant override {
 require(auctionOngoing);
 require(hasBonded);
 ...
 function settleAuctionWithoutBond( uint256[] memory bountyIDs, address[] memory inputTokens, uint256[] memory inputAmounts, address[] memory outputTokens, uint256[] memory outputAmounts ) public nonReentrant override {
 require(auctionOngoing);
 require(!hasBonded);
 require(inputTokens.length == inputAmounts.length);
 require(outputTokens.length == outputAmounts.length);
 ...
 function _settleAuction( uint256[] memory bountyIDs, address[] memory inputTokens, uint256[] memory inputAmounts, address[] memory outputTokens, uint256[] memory outputAmounts, uint256 newIbRatio ) internal {
