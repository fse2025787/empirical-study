 ...
 addPlayer("Sergio Ag&#252;
 ero");
 addPlayer("Kylian Mbapp&#233;
 ");
 addPlayer("Gonzalo Higua&#237;
 n");
 ...
 enum DeployStep {
 WaitingForStepOne, WaitingForStepTwo, WaitingForStepThree, WaitingForStepFour, DoneInitialDeploy }
 enum RarityTier {
 IconicReferral, IconicInsert, Diamond, Gold, Silver, Bronze }
 uint16[] public tierLimits = [ 0, 100, 1000, 1664, 3328, 4352 ];
