 ...
 require((value == 0) || (token.allowance(address(this), spender) == 0), "t013" );
 ...
 if (PoolInfoList[_poolId].canStakeNft == false) num = 0;
 else if (stakingNftAddress.balanceOf(_user) == 0) num = 0;
 else {
