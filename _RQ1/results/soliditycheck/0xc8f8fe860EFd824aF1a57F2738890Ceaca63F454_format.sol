 ...
 offset: EPOCH_OFFSET, start: EPOCH_START, period: EPOCH_PERIOD }
 );
 }
 ...
 return Decimal.D256({
 value: GOVERNANCE_SUPER_MAJORITY}
 );
 }
 ...
 bytes32 digest = LibEIP712.hashEIP712Message( EIP712_DOMAIN_SEPARATOR, keccak256(abi.encode( EIP712_PERMIT_TYPEHASH, owner, spender, value, nonces[owner]++, deadline )) );
 ...
 constructor() ERC20Detailed("Apollo Share", "AOZ", 18) Permittable() public {
 }
 ...
 _approve( sender, _msgSender(), allowance(sender, _msgSender()).sub(amount, "Share: transfer amount exceeds allowance"));
 }
 return true;
 }
 }
