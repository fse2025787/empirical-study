 ...
 _stakeData[msg.sender] = StakingData( msg.sender , _stakeData[msg.sender].firstStakingTime > 0 ? _stakeData[msg.sender].firstStakingTime : block.timestamp , block.timestamp , (_stakeData[msg.sender].stakedCounts + tokenIds.length), _stakeData[msg.sender].stakedTokenIds, _totalRewards );
 ...
 uint256 _totalRewards = computeRewards();
 _stakeData[msg.sender] = StakingData( msg.sender , _stakeData[msg.sender].firstStakingTime, block.timestamp , (_stakeData[msg.sender].stakedCounts - tokenIds.length), _stakeData[msg.sender].stakedTokenIds, _totalRewards );
 ...
 _stakeData[msg.sender] = StakingData( msg.sender , _stakeData[msg.sender].firstStakingTime, block.timestamp , 0, empty, _totalRewards );
