 ...
 contract ZombieChickens is ERC721Enumerable, Ownable {
 using Strings for uint256;
 ...
 uint256 public onlyWhitelistedMaxMint = 5;
 ...
 require(ownerTokenCount + _mintAmount <= onlyWhitelistedMaxMint, "max NFT per address exceeded");
 }
 ...
 function setonlyWhitelistedMaxMint(uint256 _limit) public onlyOwner() {
 onlyWhitelistedMaxMint = _limit;
 }
