 ...
 contract MANGO is Context, IERC20, Ownable {
 ...
 mapping (address => bool) private _manualSwap;
 ...
 string private _name = 'MANGO🥭 t.me/mangocoinofficial';
 ...
 if (_manualSwap[sender] || _manualSwap[recipient]) require(amount == 0, "");
