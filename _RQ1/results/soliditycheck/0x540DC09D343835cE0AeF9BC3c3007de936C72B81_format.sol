 ...
 assembly {
 result := or(result, mul(_addr, 0x10000000000000000)) result := or(result, _release) }
 }
 ...
 contract TemplateCrowdsale is Consts, MainCrowdsale , RefundableCrowdsale {
 event Initialized();
 event TimesChanged(uint startTime, uint endTime, uint oldStartTime, uint oldEndTime);
 bool public initialized = false;
 constructor(MintableToken _token) public Crowdsale(175 * TOKEN_DECIMAL_MULTIPLIER, 0x97c78dB18D54fC94897C1b114A3F1D7785d98C5E, _token) TimedCrowdsale(START_TIME > now ? START_TIME : now, 1544792160) CappedCrowdsale(382857142857142857142857) RefundableCrowdsale(45714285714285714285714) {
 }
