 ...
 string[] private locationSettingPrefix = [ "Ancient ", "Boring ", "Ominous ", "Haunted ", "Sacred ", "Bleak ", "Majestic ", "Mystical " ];
 string[] private locationSetting = [ "Royal Castle ", "Peasant Farm ", "Town Tavern ", "Brothel House ", "Feast of Fools ", "Parish Church ", "Royal Court ", "Masquerade Ball ", "Pirate's Cove ", "Noble Banquet ", "Black Death Music Party ", "Prisoner's Base ", "Jousting Tournament ", "Hilltop Church ", "Traveller's Inn " ];
 string[] private characterPrefix = [ "Royal ", "Holy ", "Cursed ", "Zealous ", "Humble ", "Modest ", "Loyal ", "Naughty " ];
 string[] private character = [ "King of Fools ", "Boy Bishop ", "Court Jester ", "Crown Prince ", "Noble Lady ", "Gong Farmer ", "High Church Priest ", "Farm Goat ", "Enlightened Monk ", "Plague Doctor ", "Statesman ", "Noble Servant ", "Noble Savage ", "Armed Guard ", "Charlatan ", "Black Cat ", "Virgin Prophet ", "Mad King ", "Pope of Fools ", "King of the Feast " ];
 string[] private costumePrefix = [ "Velvet Red ", "Royal Purple ", "Murky Brown ", "Deep Blue ", "Midnight Black ", "Off-White ", "Neon Green ", "Golden Yellow " ];
 string[] private costume = [ "Homespun Dress ", "Invisible Cloak ", "Military Uniform ", "Scholarly Robe ", "Baggy Outfit ", "Fitted Jacket ", "Puffy Shorts ", "Clown Costume ", "Embroidered Mantle ", "Silk Veil " ];
 string[] private foodPrefix = [ "Roasted ", "Stuffed ", "Raw ", "Marinated ", "Baked ", "Poached ", "Deep Fried ", "Boiled ", "Glazed ", "Smoked " ];
 string[] private food = [ "Turkey Leg ", "Swan ", "Peacock ", "Salmon ", "Boar's Sead ", "Partridge ", "Mallard ", "Chicken " ];
 string[] private foodSuffix = [ "Al Dente ", "Au Fromage ", "Deluxe ", "A La King ", "with Rice ", "with Milk ", "with Honey ", "with Extra Guac " ];
 string[] private drink = [ "Sweet Wine ", "Mulled Wine ", "Ale ", "Mead ", "Beer ", "Stale Ale ", "Aqua Vitae ", "Eggnog ", "Bride Ale ", "Mulberry Gin ", "Blackberry Wine " ];
 string[] private drinkPrefix = [ "Cold ", "Small ", "Light ", "Heavy ", "Balanced ", "Fruity ", "Earthy ", "Mineral " ];
 string[] private music = [ "Song of Spring ", "Ballata of Beauty ", "Gregorian Chant ", "Melodic Hymn ", "Royal Orchestra ", "Monk Choir ", "Taverwave Trap ", "Bardcore Rap " ];
 string[] private entertainment = [ "Acrobat Dancer ", "Juggler ", "Harper ", "Bard ", "Minstrel ", "Mummer ", "Jester ", "Puppet ", "Troubadour ", "Strolling Player ", "Clown " ];
 string[] private entertainmentPrefix = [ "Happy ", "Sad ", "Common ", "Special ", "Legendary " ];
 string[] private club = [ "The Liturgy of the Drunkards ", "The Liturgy of the Gamblers ", "The Will of the Ass ", "The Path of the One ", "Abbeys of the Fools ", "Drunken Synod of Fools ", "United Church of Wine ", "Lady of Perpetual Exemption " ];
 string[] private globalSuffix = [ "Belli ", "Primigenia ", "Redux ", "Victrix ", "Augusta ", "Balnearis ", "Huiusce Diei ", "Obsequens ", "Privata ", "Publica ", "Faitrix ", "Virgo ", "Annonaria ", "Muliebris ", "Equestris ", "Barbata " ];
 string[] private enchantment = [ "+1 " ];
 ...
 parts[0] = '<svg xmlns="http: parts[1] = getLocation(tokenId);
 ...
 "name": "Party #', toString(tokenId), '", "description": "A randomized party generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use loot party in any way you want.", "image": "data:image/svg+xml;
