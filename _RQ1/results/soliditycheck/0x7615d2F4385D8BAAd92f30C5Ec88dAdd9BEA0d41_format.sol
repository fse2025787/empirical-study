 ...
 event CedarInterfaceDeployed( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, string interfaceName );
 event CedarImplementationDeployed( address indexed implementationAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, string contractName );
 event CedarERC721PremintV0Deployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, address adminAddress, string name, string symbol, uint256 maxLimit, string userAgreement, string baseURI );
 ...
 event CedarERC1155DropV0Deployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, address defaultAdmin, string name, string symbol, string contractURI, address[] trustedForwarders, address saleRecipient, address royaltyRecipient, uint128 royaltyBps, uint128 platformFeeBps, address platformFeeRecipient );
 }
 ...
 event CedarERC721PremintV1Deployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, address adminAddress, string name, string symbol, uint256 maxLimit, string userAgreement, string baseURI );
 }
 pragma solidity ^0.8.0;
 ...
 function claim( address receiver, uint256 quantity, address currency, uint256 pricePerToken, bytes32[] calldata proofs, uint256 proofMaxQuantityPerTransaction ) external payable;
 }
 pragma solidity ^0.8.0;
 ...
 event CedarPaymentSplitterDeployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, address[] payees, uint256[] shares );
 }
 pragma solidity ^0.8.0;
 ...
 function claim( address receiver, uint256 tokenId, uint256 quantity, address currency, uint256 pricePerToken, bytes32[] calldata proofs, uint256 proofMaxQuantityPerTransaction ) external payable;
 ...
 event CedarERC721DropV1Deployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, address defaultAdmin, string name, string symbol, string contractURI, address[] trustedForwarders, address saleRecipient, address royaltyRecipient, uint128 royaltyBps, string userAgreement, address signatureVerifier, address greenlistManager );
 event CedarERC1155DropV1Deployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion, address defaultAdmin, string name, string symbol, string contractURI, address[] trustedForwarders, address saleRecipient, address royaltyRecipient, uint128 royaltyBps, uint128 platformFeeBps, address platformFeeRecipient );
 }
 pragma solidity ^0.8.0;
 ...
 interface ICedarERC721DropV3 is ICedarFeaturesV0, ICedarVersionedV0, IMulticallableV0, ICedarAgreementV0, ICedarNFTIssuanceV1, ICedarNFTLazyMintV1, IERC721V0, IRoyaltyV0, ICedarUpdateBaseURIV0, ICedarNFTMetadataV1, ICedarMetadataV0 {
 }
 pragma solidity ^0.8.0;
 ...
 event CedarERC721DropV2Deployment( address indexed contractAddress, uint256 indexed majorVersion, uint256 indexed minorVersion, uint256 patchVersion );
 }
 interface ICedarDeployerV0 is ICedarVersionedV0, ICedarDeployerEventsV0 {
 function deployCedarERC721PremintV0( address adminAddress, string memory _name, string memory _symbol, uint256 _maxLimit, string memory _userAgreement, string memory baseURI_ ) external returns (ICedarERC721PremintV0);
 function deployCedarERC721DropV0( address _defaultAdmin, string memory _name, string memory _symbol, string memory _contractURI, address[] memory _trustedForwarders, address _saleRecipient, address _royaltyRecipient, uint128 _royaltyBps, string memory _userAgreement ) external returns (ICedarERC721DropV0);
 function cedarERC721PremintVersion() external view returns ( uint256 major, uint256 minor, uint256 patch );
 function cedarERC721DropVersion() external view returns ( uint256 major, uint256 minor, uint256 patch );
 }
 ...
 function cedarERC1155DropVersion() external view returns ( uint256 major, uint256 minor, uint256 patch );
 ...
 function deployCedarERC721PremintV1( address adminAddress, string memory _name, string memory _symbol, uint256 _maxLimit, string memory _userAgreement, string memory baseURI_ ) external returns (ICedarERC721PremintV1);
 }
 interface ICedarDeployerAddedV3 {
 function deployCedarPaymentSplitterV0(address[] memory payees, uint256[] memory shares_) external returns (ICedarPaymentSplitterV0);
 function cedarPaymentSplitterVersion() external view returns ( uint256 major, uint256 minor, uint256 patch );
 ...
 function deployCedarERC721DropV1( address _defaultAdmin, string memory _name, string memory _symbol, string memory _contractURI, address[] memory _trustedForwarders, address _saleRecipient, address _royaltyRecipient, uint128 _royaltyBps, string memory _userAgreement ) external returns (ICedarERC721DropV1);
 }
 interface ICedarDeployerAddedV5 {
 function deployCedarERC1155DropV1( address _defaultAdmin, string memory _name, string memory _symbol, string memory _contractURI, address[] memory _trustedForwarders, address _saleRecipient, address _royaltyRecipient, uint128 _royaltyBps, uint128 _platformFeeBps, address _platformFeeRecipient ) external returns (ICedarERC1155DropV1);
 function deployCedarERC721DropV2( address _defaultAdmin, string memory _name, string memory _symbol, string memory _contractURI, address[] memory _trustedForwarders, address _saleRecipient, address _royaltyRecipient, uint128 _royaltyBps, string memory _userAgreement ) external returns (ICedarERC721DropV2);
 }
 ...
 emit CedarERC721DropV2Deployment( params.contractAddress, params.majorVersion, params.minorVersion, params.patchVersion );
 }
 function deploy( address _defaultAdmin, string memory _name, string memory _symbol, string memory _contractURI, address[] memory _trustedForwarders, address _saleRecipient, address _royaltyRecipient, uint128 _royaltyBps, string memory _userAgreement, uint128 _platformFeeBps, address _platformFeeRecipient ) external onlyOwner returns (CedarERC721Drop newClone) {
 ...
 newClone.initialize( _defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, input, _platformFeeBps, _platformFeeRecipient );
 ...
 function implementationVersion() external override view returns ( uint256 major, uint256 minor, uint256 patch ) {
 ...
 assembly {
 let ptr := mload(0x40) mstore(ptr, 0x3d602d80600a3d3981f3363d3d373d3d3d363d73000000000000000000000000) mstore(add(ptr, 0x14), shl(0x60, implementation)) mstore(add(ptr, 0x28), 0x5af43d82803e903d91602b57fd5bf30000000000000000000000000000000000) instance := create(0, ptr, 0x37) }
 require(instance != address(0), "ERC1167: create failed");
 }
 function cloneDeterministic(address implementation, bytes32 salt) internal returns (address instance) {
 assembly {
 let ptr := mload(0x40) mstore(ptr, 0x3d602d80600a3d3981f3363d3d373d3d3d363d73000000000000000000000000) mstore(add(ptr, 0x14), shl(0x60, implementation)) mstore(add(ptr, 0x28), 0x5af43d82803e903d91602b57fd5bf30000000000000000000000000000000000) instance := create2(0, ptr, 0x37, salt) }
 ...
 pragma solidity ^0.8.7;
 contract CedarERC721Drop is Initializable, IThirdwebContract, IOwnable, IPrimarySale, ReentrancyGuardUpgradeable, ERC2771ContextUpgradeable, MulticallUpgradeable, AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable, Agreement, Greenlist, IPlatformFee, BaseCedarERC721DropV3 {
 ...
 function supportsInterface(bytes4 interfaceId) public view override( AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable, BaseCedarERC721DropV3 ) returns (bool) {
 ...
 function multicall(bytes[] calldata data) external override(IMulticallableV0, MulticallUpgradeable) returns (bytes[] memory results) {
 ...
 function setPlatformFeeInfo(address _platformFeeRecipient, uint256 _platformFeeBps) external override onlyRole(DEFAULT_ADMIN_ROLE) {
 ...
 interface ICedarDeployerV4 is ICedarDeployerEventsV4, ICedarDeployerAddedV4, ICedarDeployerAddedV3, ICedarDeployerAddedV2, ICedarDeployerIntrospectionV0 {
 }
 ...
 interface ICedarDeployerV5 is ICedarDeployerEventsV4, ICedarDeployerAddedV5, ICedarDeployerAddedV3, ICedarDeployerAddedV2, ICedarDeployerIntrospectionV0 {
 }
 interface ICedarDeployerV6 is ICedarDeployerEventsV5, ICedarDeployerAddedV7, ICedarDeployerAddedV3, ICedarDeployerAddedV2, ICedarDeployerIntrospectionV0 {
 }
 pragma solidity ^0.8.4;
 ...
 constructor( string memory _url, string memory _message, string memory _name ) EIP712(_name, "1.0.0") {
 ...
 return _hashTypedDataV4( keccak256(abi.encode(MESSSAGE_HASH, keccak256(bytes(terms.url)), keccak256(bytes(terms.message)))) );
 }
 }
 pragma solidity ^0.8.0;
 ...
 function transferClaimedTokens( DataTypes.ClaimData storage claimData, uint256 _conditionId, uint256 _quantityBeingClaimed, address msgSender ) public returns (uint256[] memory tokens) {
 ...
 function executeClaim( DataTypes.ClaimData storage claimData, address _receiver, uint256 _quantity, address _currency, uint256 _pricePerToken, bytes32[] calldata _proofs, uint256 _proofMaxQuantityPerTransaction, address msgSender ) public returns (uint256[] memory) {
 ...
 (internalData.validMerkleProof, internalData.merkleProofIndex) = verifyClaimMerkleProof( claimData, internalData.activeConditionId, msgSender, _quantity, _proofs, _proofMaxQuantityPerTransaction );
 internalData.toVerifyMaxQuantityPerTransaction = _proofMaxQuantityPerTransaction == 0 || claimData.claimCondition.phases[internalData.activeConditionId].merkleRoot == bytes32(0);
 verifyClaim( claimData, internalData.activeConditionId, msgSender, _quantity, _currency, _pricePerToken, internalData.toVerifyMaxQuantityPerTransaction );
 ...
 function verifyClaimMerkleProof( DataTypes.ClaimData storage claimData, uint256 _conditionId, address _claimer, uint256 _quantity, bytes32[] calldata _proofs, uint256 _proofMaxQuantityPerTransaction ) public view returns (bool validMerkleProof, uint256 merkleProofIndex) {
 IDropClaimConditionV0.ClaimCondition memory currentClaimPhase = claimData.claimCondition.phases[_conditionId];
 if (currentClaimPhase.merkleRoot != bytes32(0)) {
 (validMerkleProof, merkleProofIndex) = MerkleProof.verify( _proofs, currentClaimPhase.merkleRoot, keccak256(abi.encodePacked(_claimer, _proofMaxQuantityPerTransaction)) );
 ...
 function verifyClaim( DataTypes.ClaimData storage claimData, uint256 _conditionId, address _claimer, uint256 _quantity, address _currency, uint256 _pricePerToken, bool verifyMaxQuantityPerTransaction ) public view {
 IDropClaimConditionV0.ClaimCondition memory currentClaimPhase = claimData.claimCondition.phases[_conditionId];
 ...
 function getClaimTimestamp( DataTypes.ClaimData storage claimData, uint256 _conditionId, address _claimer ) public view returns (uint256 lastClaimTimestamp, uint256 nextValidClaimTimestamp) {
 lastClaimTimestamp = claimData.claimCondition.limitLastClaimTimestamp[_conditionId][_claimer];
 unchecked {
 nextValidClaimTimestamp = lastClaimTimestamp + claimData.claimCondition.phases[_conditionId].waitTimeInSecondsBetweenClaims;
 if (nextValidClaimTimestamp < lastClaimTimestamp) {
 nextValidClaimTimestamp = type(uint256).max;
 }
 }
 }
 function collectClaimPrice( DataTypes.ClaimData storage claimData, uint256 _quantityToClaim, address _currency, uint256 _pricePerToken, address msgSender ) internal {
 if (_pricePerToken == 0) {
 return;
 }
 ...
 function setClaimConditions( DataTypes.ClaimData storage claimData, IDropClaimConditionV0.ClaimCondition[] calldata _phases, bool _resetClaimEligibility ) public {
 ...
 pragma solidity ^0.8.4;
 interface ICedarERC721DropV0 is ICedarFeaturesV0, ICedarVersionedV0, ICedarNFTIssuanceV0, ICedarNFTLazyMintV0, IMulticallableV0, IERC721V0 {
 }
 interface ICedarERC721DropV1 is ICedarFeaturesV0, ICedarVersionedV0, IMulticallableV0, ICedarAgreementV0, ICedarNFTIssuanceV1, ICedarNFTLazyMintV0, IERC721V0, IRoyaltyV0 {
 }
 interface ICedarERC721DropV2 is ICedarFeaturesV0, ICedarVersionedV0, IMulticallableV0, ICedarAgreementV0, ICedarNFTIssuanceV1, ICedarNFTLazyMintV1, IERC721V0, IRoyaltyV0, ICedarUpdateBaseURIV0, ICedarNFTMetadataV0, ICedarMetadataV0 {
 }
 pragma solidity ^0.8.0;
 library ECDSA {
 enum RecoverError {
 ...
 IWETH(_nativeTokenWrapper).deposit{
 value: _amount }
 ();
 }
 else {
 ...
 pragma solidity ^0.8.4;
 interface ICedarERC721PremintV0 is ICedarFeaturesV0, ICedarVersionedV0, ICedarPremintV0, ICedarAgreementV0, IMulticallableV0 {
 }
 interface ICedarERC721PremintV1 is ICedarFeaturesV0, ICedarVersionedV0, ICedarPremintV0, ICedarAgreementV0, IMulticallableV0, ICedarUpgradeBaseURIV0 {
 }
 pragma solidity ^0.8.4;
 interface ICedarERC1155DropV0 is ICedarFeaturesV0, IMulticallableV0, ICedarVersionedV0, ICedarSFTIssuanceV0, ICedarSFTLazyMintV0, ICedarUpdateBaseURIV0, IERC1155V0 {
 }
 interface ICedarERC1155DropV1 is ICedarFeaturesV0, ICedarVersionedV0, IMulticallableV0, ICedarSFTIssuanceV1, ICedarSFTLazyMintV0, ICedarUpdateBaseURIV0, IERC1155V0, IRoyaltyV0 {
 }
 pragma solidity ^0.8.4;
 ...
 function claim( uint256 quantity, address recipient, bytes32[] calldata proof ) external;
 struct ClaimRequest {
 ...
 function buy( uint256 quantity, address recipient, uint256 tokenId ) external payable;
 }
 pragma solidity ^0.8.4;
 interface ICedarERC20PayableV0 {
 function buy( address recipient, address erc20TokenContract, uint256 tokenId ) external;
 function buyAny( address recipient, address erc20TokenContract, uint256 quantity ) external;
 }
 pragma solidity ^0.8.0;
 interface ICedarIssuanceV0 {
 enum IssuanceMode {
 SpecificToken, AnyToken }
 enum PaymentType {
 None, Native, ERC20 }
 enum AuthType {
 TrustedSender, Merkle, Signature }
