 ...
 function setTokenDistribution(address[] memory _receivers, uint256[] memory _percentages) external onlyOwner {
 _setTokenDistribution(_receivers, _percentages);
 }
 ...
 function distributeWithPercentages(IERC20[] memory _tokens, uint256[] memory _percentages) external {
 for (uint256 i = 0; i < _tokens.length; i++) {
