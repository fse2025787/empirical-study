 ...
 constructor( address _fund, address _yVault, uint256 _tokenIndex ) public {
 fund = _fund;
 ...
 require( msg.sender == fund || msg.sender == governance(), "The sender has to be the governance or fund" );
 _;
 }
 ...
 function withdrawToFund(uint256 underlyingAmount) external override onlyFundOrGovernance {
 ...
 return underlyingAmount.mul(10**18).div(IYVaultV2(yVault).pricePerShare());
 }
 }
 ...
 address public constant yvusdc = address(0x5f18C75AbDAe578b483E5F43f12a39cF75b973a9);
 mapping(address => address) public yVaults;
 constructor(address _fund) public YearnV2StrategyBase(_fund, address(0), 0) {
 yVaults[dai] = yvdai;
 yVaults[usdc] = yvusdc;
