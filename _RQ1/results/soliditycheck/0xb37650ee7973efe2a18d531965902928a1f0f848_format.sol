 ...
 contract APESZN is Context, IERC20, Ownable {
 ...
 string private _name = "APESZN";
 string private _symbol = "Ape Season";
 ...
 require(liquidityFee >= 1 && liquidityFee <= 15, 'liquidityFee should be in 1 - 10');
