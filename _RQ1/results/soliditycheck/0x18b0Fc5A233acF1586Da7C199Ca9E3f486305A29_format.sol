 ...
 constructor( nTokenERC20 proxy_, uint16 currencyId_, string memory underlyingName_, string memory underlyingSymbol_ ) {
 proxy = proxy_;
 ...
 bool success = proxy.nTokenTransferFrom(currencyId, msg.sender, from, to, amount);
