 ...
 function initialize( address _ownerAddress, address _zoneTokenAddress, address _lpZoneEth, bool _usePoolPrice, uint256 _zoneReserveAmount, uint256 _ethReserveAmount ) public initializer {
 ...
 return (zoneToken == lpZoneEth.token1()) ? price0AverageLast.mul(_mintPriceInEth).decode144() : price1AverageLast.mul(_mintPriceInEth).decode144();
 }
 else {
